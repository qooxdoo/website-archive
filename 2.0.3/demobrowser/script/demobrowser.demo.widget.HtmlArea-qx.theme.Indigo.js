...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.HtmlArea-qx.theme.Indigo.7ae12ebc4975.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var q="demobrowser.demo.widget.HtmlArea",p="Set Text Color",o="Insert Table",n="qx/icon/Oxygen/16/actions/format-indent-more.png",m="As an application developer you can <b>use the same API.</b></p>",l="Comic Sans MS",k="Insert Ordered List",h="<p>This UI-level widget can be used at RIA (Rich ",g="qx/icon/Oxygen/16/actions/format-justify-left.png",f="Tahoma",bG="qx/icon/Oxygen/16/actions/format-text-italic.png",bF="Indent More",bE="qx/icon/Oxygen/16/actions/edit-undo.png",bD="Courier",bC="Courier New",bB="qx/icon/Oxygen/16/actions/format-justify-right.png",bA="solid",bz="Arial Black",by="Insert HTML Code",bx="qx/icon/Oxygen/16/actions/format-justify-center.png",x="Impact",y="http://",v="demobrowser/demo/icons/htmlarea/format-text-color.png",w="Change Font Size",t="<h1>HtmlArea UI-level widget</h1>",u="Insert Link",r="Align Center",s="Align Justify",F="Undo Last Change",G="qx/icon/Oxygen/16/actions/insert-link.png",Y="Align Left",U="demobrowser/demo/icons/htmlarea/format-fill-color.png",bh="The UI widget does use the low-level component internally ",bc="<p>You can play around with this widget by hitting the ",bt="12px ",bn="qx/icon/Oxygen/16/actions/format-indent-less.png",N="Redo Last Undo Step",bw="Times New Roman",bv="Remove Format",bu="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",L="qx/icon/Oxygen/16/actions/edit-clear.png",Q="demobrowser/demo/icons/htmlarea/format-list-unordered.png",S="HTML Code:",W="Set Text Background Color",ba="Format Bold",bd="Georgia",bj="qx/icon/Oxygen/16/actions/edit-redo.png",bp="Change Font Family",z="Lucida Console",A="Internet Applications) and inline applications.<br/>",P="Align Right",bg="border-main",bf="Cancel",be="Inserted Unordered List",bl="qx/icon/Oxygen/16/actions/format-text-bold.png",bk="right",bb="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",bi="main",a="Arial",bo="Insert Hyperlink",B="Format Italic",C="qx/icon/Oxygen/16/actions/format-justify-fill.png",V="qx/icon/Oxygen/16/actions/format-text-underline.png",b="Verdana",d="Indent Less",K="Insert Image",D="demobrowser/demo/icons/htmlarea/insert-table.png",E='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',I="blank.html",X="Format Strikethrough",br="demobrowser/demo/icons/htmlarea/insert-text.png",bq="Format Underline",R="qx/icon/Oxygen/16/actions/insert-image.png",bs="demobrowser/demo/icons/htmlarea/format-list-ordered.png",M="Insert Horizontal Ruler",bm="OK",H="so code-duplication is avoided.<br/>",J="buttons at the toolbar.</p>",c="changeSelection",T="execute",O="";qx.Class.define(q,{extend:qx.application.Standalone,members:{__LU:null,main:function(){qx.application.Standalone.prototype.main.call(this);var bN=t+h+A+bh+H+m+bc+J;var bI=new qx.ui.basic.Label(bN);bI.set({rich:true,marginBottom:10});var bM=E;var bL=this.getRoot();var bK=new qx.ui.decoration.Single(1,bA,bg);bK.setWidthTop(0);this.__LU=new qx.ui.embed.HtmlArea(bM,null,I);this.__LU.set({width:600,height:400,decorator:bK});var toolbar=this.__Mf();var bH=new qx.ui.layout.VBox(0);var bJ=new qx.ui.container.Composite(bH);bJ.add(bI);bJ.add(toolbar);bJ.add(this.__LU);bL.add(bJ,{left:20,top:20});}
,__LV:function(e){var bO=window.prompt("Color (Hex): ","#");this.setTextColor(bO);}
,__LW:function(e){var bP=window.prompt("BgColor (Hex): ","#");this.setTextBackgroundColor(bP);}
,__LX:function(e){var bQ={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};this.insertImage(bQ);}
,__LY:function(e){var bR="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";this.insertHtml(bR);}
,__Ma:function(e){var bT=new qx.ui.window.Window(bo);bT.setLayout(new qx.ui.layout.VBox(20));bT.set({width:400,showMaximize:false,showMinimize:false});var bX=new qx.ui.form.TextField(y);bT.add(bX);var bV=new qx.ui.layout.HBox(10);bV.setAlignX(bk);var bW=new qx.ui.container.Composite(bV);var bS=new qx.ui.form.Button(bm);bS.setWidth(60);bS.addListener(T,function(e){this.insertHyperLink(bX.getValue());bT.close();}
,this);bW.add(bS);var bU=new qx.ui.form.Button(bf);bU.setWidth(60);bU.addListener(T,function(e){bT.close();}
,this);bW.add(bU);bT.add(bW);bT.center();bT.open();this.saveRange();}
,__Mb:function(e){var bY=window.prompt(S,O);this.insertHtml(bY);}
,__Mc:function(){var cb=new qx.ui.form.SelectBox;cb.set({toolTipText:bp,focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});cb.add(new qx.ui.form.ListItem(O));var cc=[f,b,bw,a,bz,bC,bD,bd,x,l,z];var ca;for(var i=0,j=cc.length;i<j;i++){ca=new qx.ui.form.ListItem(cc[i]);ca.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString(bt+cc[i])});cb.add(ca);}
;cb.addListener(c,function(e){var cd=e.getData()[0].getLabel();if(cd!=O){this.setFontFamily(cd);cb.setSelection([cb.getChildren()[0]]);}
;}
,this.__LU);return cb;}
,__Md:function(){var cf=new qx.ui.form.SelectBox;cf.set({toolTipText:w,focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});cf.add(new qx.ui.form.ListItem(O));var ce;for(var i=1;i<=7;i++){ce=new qx.ui.form.ListItem(i+O);ce.set({focusable:false,keepFocus:true});cf.add(ce);}
;cf.addListener(c,function(e){var cg=e.getData()[0].getLabel();if(cg!=O){this.setFontSize(cg);cf.setSelection([cf.getChildren()[0]]);}
;}
,this.__LU);return cf;}
,__Me:function(){return [{bold:{text:ba,image:bl,action:this.__LU.setBold},italic:{text:B,image:bG,action:this.__LU.setItalic},underline:{text:bq,image:V,action:this.__LU.setUnderline},strikethrough:{text:X,image:bb,action:this.__LU.setStrikeThrough},removeFormat:{text:bv,image:L,action:this.__LU.removeFormat}},{alignLeft:{text:Y,image:g,action:this.__LU.setJustifyLeft},alignCenter:{text:r,image:bx,action:this.__LU.setJustifyCenter},alignRight:{text:P,image:bB,action:this.__LU.setJustifyRight},alignJustify:{text:s,image:C,action:this.__LU.setJustifyFull}},{fontFamily:{custom:this.__Mc},fontSize:{custom:this.__Md},fontColor:{text:p,image:v,action:this.__LV},textBackgroundColor:{text:W,image:U,action:this.__LW}},{indent:{text:bF,image:n,action:this.__LU.insertIndent},outdent:{text:d,image:bn,action:this.__LU.insertOutdent}},{insertImage:{text:K,image:R,action:this.__LX},insertTable:{text:o,image:D,action:this.__LY},insertLink:{text:u,image:G,action:this.__Ma},insertHTML:{text:by,image:br,action:this.__Mb},insertHR:{text:M,image:bu,action:this.__LU.insertHorizontalRuler}},{ol:{text:k,image:bs,action:this.__LU.insertOrderedList},ul:{text:be,image:Q,action:this.__LU.insertUnorderedList}},{undo:{text:F,image:bE,action:this.__LU.undo},redo:{text:N,image:bj,action:this.__LU.redo}}];}
,__Mf:function(){var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setDecorator(bi);var ch;var ci=this.__Me();for(var i=0,j=ci.length;i<j;i++){var cj=new qx.ui.toolbar.Part;toolbar.add(cj);for(var ck in ci[i]){var cl=ci[i][ck];if(cl.custom){ch=cl.custom.call(this);}
else {ch=new qx.ui.toolbar.Button(null,cl.image);ch.set({focusable:false,keepFocus:true,center:true,toolTipText:cl.text?cl.text:O});ch.addListener(T,cl.action,this.__LU);}
;cj.add(ch);}
;}
;return toolbar;}
}});}
...
(function(){var k="xhtml",j="_applyUseUndoRedo",i="_applyMessengerMode",h="url(",g=")",f="InsertParagraphOnLinebreak",d="repeat",c="div",b="Integer",a="NativeContextMenu",U="Function",T="Please use the method 'qx.dom.Node.isBlockNode' instead.",S="__DO",R="_applyInsertParagraphOnLinebreak",Q="PostProcess",P="_applyInsertLinebreakOnCtrlEnter",O="ContentType",N="px",M="DOMNodeRemoved",L="DefaultFontSize",r="htmlarea",s="MessengerMode",p="_applyDefaultFontSize",q="engine.name",n="UseUndoRedo",o="__Ci",l="_applyDefaultFontFamily",m="_applyContentType",t="qx.ui.embed.HtmlArea",u="mshtml",B="Verdana",z="block",F="DefaultFontFamily",D="InsertLinebreakOnCtrlEnter",H="qx/static/blank.gif",G="_applyPostProcess",w="absolute",K="mousedown",J="String",I="none",v="mouseup",x="losecapture",y="display",A="Boolean",C="qx.event.type.Event",E="qx.event.type.Data";qx.Class.define(t,{extend:qx.ui.core.Widget,construct:function(V,W,X){this.__DM={};qx.ui.core.Widget.call(this);this._setLayout(new qx.ui.layout.Grow);this.__DQ();this.__DN={content:V,styleInfo:W,source:X};qx.event.Registration.addListener(document.body,K,this.block,this,true);qx.event.Registration.addListener(document.body,v,this.release,this,true);qx.event.Registration.addListener(document.body,x,this.release,this,true);}
,events:{"loadingError":E,"messengerContent":E,"cursorContext":E,"ready":C,"readyAfterInvalid":C,"focused":C,"focusOut":C,"contextmenu":E,"undoRedoState":E},statics:{isBlockNode:function(Y){var ba=qx.ui.embed.HtmlArea.isBlockNode;var bb=T;qx.log.Logger.deprecatedMethodWarning(ba,bb);return qx.dom.Node.isBlockNode(Y);}
,isParagraphParent:function(bc){return qx.bom.htmlarea.HtmlArea.isParagraphParent(bc);}
},properties:{contentType:{check:J,init:k,apply:m},messengerMode:{check:A,init:false,apply:i},insertParagraphOnLinebreak:{check:A,init:true,apply:R},insertLinebreakOnCtrlEnter:{check:A,init:true,apply:P},postProcess:{check:U,nullable:true,init:null,apply:G},useUndoRedo:{check:A,init:true,apply:j},appearance:{refine:true,init:r},defaultFontFamily:{check:J,init:B,apply:l},defaultFontSize:{check:b,init:4,apply:p},focusable:{refine:true,init:true}},members:{__DO:null,__DM:null,__Ci:null,__DN:null,__DP:null,_initBlockerElement:function(){if(!this.__Ci){this.__Ci=this._createBlockerElement();}
;}
,_applyContentType:function(bd,be){if(this.__DO!=null){this.__DO.setContentType(bd);}
else {this.__DM[O]=bd;}
;}
,_applyMessengerMode:function(bf,bg){if(this.__DO!=null){this.__DO.setMessengerMode(bf);}
else {this.__DM[s]=bf;}
;}
,_applyInsertParagraphOnLinebreak:function(bh,bi){if(this.__DO!=null){this.__DO.setInsertParagraphOnLinebreak(bh);}
else {this.__DM[f]=bh;}
;}
,_applyInsertLinebreakOnCtrlEnter:function(bj,bk){if(this.__DO!=null){this.__DO.setInsertLinebreakOnCtrlEnter(bj);}
else {this.__DM[D]=bj;}
;}
,_applyPostProcess:function(bl,bm){if(this.__DO!=null){this.__DO.setPostProcess(bl);}
else {this.__DM[Q]=bl;}
;}
,_applyUseUndoRedo:function(bn,bo){if(this.__DO!=null){this.__DO.setUseUndoRedo(bn);}
else {this.__DM[n]=bn;}
;}
,_applyDefaultFontFamily:function(bp,bq){if(this.__DO!=null){this.__DO.setDefaultFontFamily(bp);}
else {this.__DM[F]=bp;}
;}
,_applyDefaultFontSize:function(br,bs){if(this.__DO!=null){this.__DO.setDefaultFontSize(br);}
else {this.__DM[L]=br;}
;}
,_applyNativeContextMenu:function(bt,bu){if(this.__DO!=null){this.__DO.setNativeContextMenu(bt);}
else {this.__DM[a]=bt;}
;}
,_createBlockerElement:function(){var bv=new qx.html.Element(c);bv.setStyles({zIndex:20,position:w,display:I});if((qx.core.Environment.get(q)==u)){bv.setStyles({backgroundImage:h+qx.util.ResourceManager.getInstance().toUri(H)+g,backgroundRepeat:d});}
;return bv;}
,__DQ:function(){this.addListenerOnce("appear",this.__DR);}
,__DR:function(){var bw=this.getContentElement().getDomElement();this.__DO=new qx.bom.htmlarea.HtmlArea(bw,this.__DN.content,this.__DN.styleInfo,this.__DN.source);this.__DS();this.__DT();if((qx.core.Environment.get("engine.name")=="gecko")){this.__DW();}
;this.addListener("appear",this.forceEditable);}
,__DS:function(){for(var bx in this.__DM){this.__DO["set"+bx](this.__DM[bx]);}
;}
,__DT:function(){this.__DO.addListener("ready",this.__DU,this);this.__DO.addListener("readyAfterInvalid",this.__DU,this);this.__DO.addListener("focused",this.__DU,this);this.__DO.addListener("focusOut",this.__DU,this);this.__DO.addListener("loadingError",this.__DV,this);this.__DO.addListener("cursorContext",this.__DV,this);this.__DO.addListener("contextmenu",this.__DV,this);this.__DO.addListener("undoRedoState",this.__DV,this);this.__DO.addListener("messengerContent",this.__DV,this);}
,__DU:function(e){var by=e.clone();this.fireEvent(by.getType());}
,__DV:function(e){var bz=e.clone();this.fireDataEvent(bz.getType(),e.getData());}
,__DW:function(){this.__DP=qx.lang.Function.bind(this.__DX,this);var bA=this.getContainerElement().getDomElement();qx.bom.Event.addNativeListener(bA,"DOMNodeRemoved",this.__DP);}
,__DX:qx.event.GlobalError.observeMethod(function(e){if(this.__DO&&!this.__DO.isDisposed()){this.__DO.invalidateEditor();}
;}
),renderLayout:function(bB,top,bC,bD){qx.ui.core.Widget.prototype.renderLayout.call(this,bB,top,bC,bD);var bF=N;var bE=this.getInsets();if(!this.__Ci){this._initBlockerElement();}
;this.__Ci.setStyles({left:bE.left+bF,top:bE.top+bF,width:(bC-bE.left-bE.right)+bF,height:(bD-bE.top-bE.bottom)+bF});}
...
,setValue:function(bG){if(this.__DO!=null){this.__DO.setValue(bG);}
else {this.__DN.content=bG;}
;}
,getValue:function(){if(this.__DO!=null){return this.__DO.getValue();}
else {return this.__DN.content;}
;}
,getComputedValue:function(bH){return this.__DO!=null?this.__DO.getHtml(bH):null;}
...
,getWords:function(bI){return this.__DO!=null?this.__DO.getWords(bI):null;}
...
,setEditable:function(bJ){if(this.__DO!=null){this.__DO.setEditable(bJ);}
;}
...
,insertHtml:function(bK){return this.__DO!=null?this.__DO.insertHtml(bK):false;}
...
,setFontSize:function(bL){return this.__DO!=null?this.__DO.setFontSize(bL):false;}
,setFontFamily:function(bM){return this.__DO!=null?this.__DO.setFontFamily(bM):false;}
,setTextColor:function(bN){return this.__DO!=null?this.__DO.setTextColor(bN):false;}
,setTextBackgroundColor:function(bO){return this.__DO!=null?this.__DO.setTextBackgroundColor(bO):false;}
...
,insertImage:function(bP){return this.__DO!=null?this.__DO.insertImage(bP):false;}
,insertHyperLink:function(bQ){return this.__DO!=null?this.__DO.insertHyperLink(bQ):false;}
,removeBackgroundColor:function(){return this.__DO!=null?this.__DO.removeBackgroundColor():false;}
,setBackgroundColor:function(bR){return this.__DO!=null?this.__DO.setBackgroundColor(bR):false;}
,removeBackgroundImage:function(){return this.__DO!=null?this.__DO.removeBackgroundImage():false;}
,setBackgroundImage:function(bS,bT,bU){return this.__DO!=null?this.__DO.setBackgroundImage(bS,bT,bU):false;}
...
;}
,getHtml:function(bV){return this.__DO!=null?this.__DO.getHtml(bV):null;}
...
,block:function(){if(!this.__Ci){this._initBlockerElement();}
;if(!this.getContainerElement().hasChild(this.__Ci)){this.getContainerElement().add(this.__Ci);}
;this.__Ci.setStyle(y,z);}
,release:function(){if(this.__Ci){this.__Ci.setStyle(y,I);}
;}
,focus:function(){qx.ui.core.Widget.prototype.focus.call(this);this.__DY();}
,tabFocus:function(){qx.ui.core.Widget.prototype.tabFocus.call(this);this.__DY();}
,__DY:function(){if(this.__DO!=null){qx.event.Timer.once(function(){this.__DO.focusContent();}
,this,0);}
;}
},destruct:function(){this.__DM=this.__DN=null;qx.event.Registration.removeListener(document.body,K,this.block,this,true);qx.event.Registration.removeListener(document.body,v,this.release,this,true);qx.event.Registration.removeListener(document.body,x,this.release,this,true);var bW=this.getContainerElement().getDomElement();if(bW){qx.bom.Event.removeNativeListener(bW,M,this.__DP);}
;this._disposeObjects(o,S);}
});}
)();
(function(){var dA="qx.blankpage",dz='</span>',dy="backgroundColor",dx="li",dw='undo',dv="Function",du="fontSize",dt="textcolor",ds="br",dr="home",ci="<",ch="focused",cg="fontFamily",cf="load",ce='document not available, try again...',cd='<font ',cc='id="__elementToFocus__"',cb="setUnderline",ca="backgroundPosition",bY="<!--",dH=' size="',dI='/www.w3.org/1999/xhtml" xml:lang="en" lang="en">',dF="'>",dG="insertimage",dD='bold',dE="&copy;",dB="bold",dC="mouseup",dJ="readyAfterInvalid",dK="styleWithCSS",cY="span",cX=" />",db="setBold",da="<P>&nbsp;</P>",dd="</",dc="textbackgroundcolor",df="&gt;",de='="',cW="can't extract style from elem. ",cV="paddingLeft",o="click",p="inserthorizontalrule",q='</head>',r='<p>',t='<head>',u='</font>',v="backgroundRepeat",w="a",x="&amp;",y="__Eb",dY="removeformat",dX="marginLeft",dW="ready",dV="<p>&nbsp;</p>",ed='DOCTYPE html PUBLIC "-/',ec="italic",eb="browser.version",ea='<body>',ef="insertorderedlist",ee='body { font-size:100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; background-color:transparent; overflow:visible; background-image:none; margin:0px; padding:5px; } ',bo="hideFocus",bp="keypress",bm="none",bn='/DTD XHTML 1.0 Transitional/',bs='<html xmlns="http:/',bt="outline",bq="setItalic",br="body",bk="marginBottom",bl="xhtml",R="focusOut",Q="justifyleft",T="handleMouse ",S='</p>',N="paddingTop",M="underline",P="Please use the method 'qx.dom.Node.isBlockNode' instead.",O='<title></title><meta http-equiv="Content-type" content="text/html; charset=UTF-8" />',L="Control",K='<span style="font-family:',by='/W3C/',bz="placeholder",bA='cant load HtmlArea. Document is not available. ',bB="backgroundImage",bu="marginTop",bv="> ",bw=" { ",bx='italic',bC='<!',bD='</style>',bd="\ufeff",bc="focus",bb="&quot;",ba="marginRight",Y="STYLE",X="justifyfull",W='underline',V="inserthyperlink",bh="<br />",bg='html { margin:0px; padding:0px; } ',bE='<style type="text/css">',bF="<br>",bG='/EN" "http:/',bH="justifycenter",bI="<br /><div id='placeholder'></div>",bJ="useCSS",bK="object",bL="strikethrough",bM="blur",bN="true",cr="1.9",cq='',cp=' style="',co="indent",cv="messengerContent",cu="Integer",ct="insertunorderedlist",cs="Text",cy="&lt;",cx="_moz_dirty",cR='<br _moz_editor_bogus_node="TRUE" _moz_dirty=""/>',cS='<br/><div class="placeholder"></div>',cP="selectall",cQ="transparent",cN=" SCRIPT STYLE DIV SPAN TR TD TBODY TABLE EM STRONG FONT A P B I U STRIKE H1 H2 H3 H4 H5 H6 ",cO="justifyright",cL='/www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">',cM="//text()[string-length(normalize-space(.))>0]",cT="outdent",cU="about:blank",dj="<body style='",di="qx.bom.htmlarea.HtmlArea",dl="paddingBottom",dk="keydown",dn="keyup",dm="Verdana",dq="focusout",dp="$",dh="-->",dg=" }",dR="paddingRight",dS='html { width:100%; height:100%; margin:0px; padding:0px; overflow-y:auto; overflow-x:auto; } ',dT="Off",dU='p { margin:0px; padding:0px; }',dN='body { font-size: 100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; width:100%; height:100%; background-color:transparent; overflow:auto; background-image:none; margin:0px; padding:5px; } ',dO="pageup",dP="backgroundcolor",dQ="Failed to enable rich edit functionality",dL="end",dM="div",n="right",m="redo",l="i",k="backspace",h="inserthtml",g="style",f="backgroundimage",d="100%",c="k",b=":",B='redo',C="y",z='">',A="down",F="g",G="left",D="fontsize",E="undo",I="pagedown",J="u",cz=" | ",cw="control",cG="up",cC="None",cl="'",cj="delete",U=">",cn="b",bf='</body></html>',be="String",bQ="z",bR=";",bS="fontfamily",bT="loadingError",bU="contextmenu",bV="engine.version",bW="old_id",bX="opera",bO="enter",bP="id",ck='"',cF="__elementToFocus__",cE="qx.bom.htmlarea.HtmlArea.debug",cD="qx.event.type.Data",cK="qx.event.type.Event",cJ=" ",cI="Boolean",cH="qx.debug",cB="webkit",cA="gecko",H="mshtml",bj="",bi="engine.name";qx.Class.define(di,{extend:qx.core.Object,construct:function(eg,eh,ei,ej){qx.core.Object.call(this);var ek=ej||qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(dA));this.__Es(eg);this.__Et();this._createAndAddIframe(ek);this._addIframeLoadListener();this.__Ea=qx.bom.htmlarea.HtmlArea.__Ec(ei);if(qx.lang.Type.isString(eh)){this.__vn=eh;}
;this.__Eb=this.__EF();}
,events:{"load":cK,"loadingError":cD,"messengerContent":cD,"cursorContext":cD,"ready":cK,"readyAfterInvalid":cK,"focused":cK,"focusOut":cK,"contextmenu":cD,"undoRedoState":cD},statics:{simpleLinebreak:bF,EMPTY_DIV:"<div></div>",GetWordsRegExp:/([^\u0000-\u0040\u005b-\u005f\u007b-\u007f]|['])+/g,CleanupWordsRegExp:/[\u0000-\u0040]/gi,hotkeyInfo:{bold:{method:db},italic:{method:bq},underline:{method:cb},undo:{method:E},redo:{method:m}},__Ec:function(em){if(em==null||em==bj){return bj;}
else if(typeof em==bK){var en=bj;for(var i in em){en+=i+bw+em[i]+dg;}
;return en;}
else {return em;}
;}
,__Ed:function(eo){var ep={};var a=eo.split(bR);var i;for(i=0;i<a.length;i++){var eq=a[i],er=eq.indexOf(b);if(er===-1){continue;}
;var name=qx.lang.String.trim(eq.substring(0,er));var es=qx.lang.String.trim(eq.substring(er+1,eq.length));if(name&&es){ep[name]=es;}
;}
;return ep;}
,__Ee:function(et,eu,ev,ew){var eC=[];switch(et.nodeType){case 1:case 11:var i;var eA=et.tagName.toLowerCase();var eE={};var ey={};var closed=(!(et.hasChildNodes()||qx.bom.htmlarea.HtmlArea.__Ef(et)));if(eu){if((qx.core.Environment.get(bi)==H)){if(eA==dM&&et.className&&et.className==bz){for(i=et.firstChild;i;i=i.nextSibling){eC.push(qx.bom.htmlarea.HtmlArea.__Ee(i,true,ev,ew));}
;return eC.join(bj);}
;}
;var eD=et.attributes;var eB=eD.length;var a;if((qx.core.Environment.get(bi)==cA)){if(eA==cY&&eB==1&&eD[0].name==cx&&et.childNodes.length==0){return bj;}
;}
;for(i=0;i<eB;i++){a=eD[i];if(!a.specified){continue;}
;var name=qx.dom.Node.getName(a);var eF=a.nodeValue;if(/(_moz|contenteditable)/.test(name)){continue;}
;if(name!=g){if(qx.core.Environment.get(bi)==H){if(name==bP&&et.getAttribute(bW)){eF=et.getAttribute(bW);}
else if(!isNaN(eF)){eF=et.getAttribute(name);}
else {eF=a.nodeValue;}
;}
else {eF=a.nodeValue;}
;}
else {eF=et.style.cssText;}
;if(/(_moz|^$)/.test(eF)){continue;}
;if(name==bW){continue;}
;if(!eF){continue;}
;if(name==bP&&eF==cF){continue;}
;if(name.charAt(0)===dp){continue;}
;eE[name]=eF;}
;if(eE.style!==undefined){ey=qx.bom.htmlarea.HtmlArea.__Ed(eE.style);delete eE.style;}
;if(ew){var ez={domElement:et,tag:eA,attributes:eE,styles:ey};ew(ez);ez.domElement=null;eA=ez.tag;}
;if(eA){eC.push(ci,eA);for(var name in eE){var eF=eE[name];eC.push(cJ,name,de,eF.toString().replace(new RegExp(ck,F),cl),ck);}
;if(!qx.lang.Object.isEmpty(ey)){eC.push(cp);for(var name in ey){var eF=ey[name];eC.push(name,b,eF.toString().replace(new RegExp(ck,F),cl),bR);}
;eC.push(ck);}
;eC.push(closed?cX:U);}
;}
;for(i=et.firstChild;i;i=i.nextSibling){eC.push(qx.bom.htmlarea.HtmlArea.__Ee(i,true,ev,ew));}
;if(eu&&!closed&&eA){eC.push(dd,eA,U);}
;break;case 3:eC.push(ev?et.data:qx.bom.htmlarea.HtmlArea.__Eg(et.data));break;case 8:eC.push(bY,et.data,dh);break;};return eC.join(bj);}
,closingTags:cN,__Ef:function(eG){return (qx.bom.htmlarea.HtmlArea.closingTags.indexOf(cJ+eG.tagName+cJ)!=-1);}
,__Eg:function(s){s=s.replace(/&/ig,x);s=s.replace(/</ig,cy);s=s.replace(/>/ig,df);s=s.replace(/\x22/ig,bb);s=s.replace(/\xA9/ig,dE);return s;}
,isBlockNode:function(eH){var eI=qx.bom.htmlarea.HtmlArea.isBlockNode;var eJ=P;qx.log.Logger.deprecatedMethodWarning(eI,eJ);return qx.dom.Node.isBlockNode(eH);}
,isParagraphParent:function(eK){if(!qx.dom.Node.isElement(eK)){return false;}
;eK=qx.dom.Node.getName(eK);return /^(body|td|th|caption|fieldset|div)$/.test(eK);}
,isHeadlineNode:function(eL){if(!qx.dom.Node.isElement(eL)){return false;}
;var eM=qx.dom.Node.getName(eL);return /^h[1-6]$/.test(eM);}
},properties:{contentType:{check:be,init:bl},messengerMode:{check:cI,init:false},insertParagraphOnLinebreak:{check:cI,init:true},insertLinebreakOnCtrlEnter:{check:cI,init:true},postProcess:{check:dv,nullable:true,init:null},useUndoRedo:{check:cI,init:true},nativeContextMenu:{check:cI,init:false},defaultFontFamily:{check:be,init:dm},defaultFontSize:{check:cu,init:4}},members:{__fM:null,__dc:false,__Eh:false,__Ei:false,__Ej:false,__Ek:false,__Eb:null,__El:null,__Em:null,__En:null,__vY:null,__Ea:null,__Eo:null,__Ep:null,__Eq:false,__Er:false,__Es:function(eN){if(qx.dom.Node.isElement(eN)&&qx.dom.Node.isNodeName(eN,dM)){this.__fM=eN;}
;}
,_createAndAddIframe:function(eO){this.__vY=qx.bom.Iframe.create();qx.bom.Iframe.setSource(this.__vY,eO);if((qx.core.Environment.get(bi)==H)){qx.bom.element.Attribute.set(this.__vY,bo,bN);}
else {qx.bom.element.Style.set(this.__vY,bt,bm);}
;qx.bom.element.Style.setStyles(this.__vY,{width:d,height:d});qx.dom.Element.insertBegin(this.__vY,this.__fM);}
,_getIframeDocument:function(){return qx.bom.Iframe.getDocument(this.__vY);}
,_getIframeWindow:function(){return qx.bom.Iframe.getWindow(this.__vY);}
,_addIframeLoadListener:function(){qx.event.Registration.addListener(this.__vY,cf,this._loaded,this);}
,__Et:function(){this.__Eo={"xhtml":{doctype:bC+ed+by+bn+bG+cL,html:bs+dI,meta:O,style:qx.core.Environment.select(bi,{"mshtml":bg+dN,"default":dS+ee}),contentStyle:dU,body:ea,footer:bf}};}
,__vn:bj,getIframeObject:function(){return this.__vY;}
,getCommandManager:function(){return this.__Eb;}
,setValue:function(eP){if(qx.lang.Type.isString(eP)){this.__vn=eP;var eQ=this._getIframeDocument();if(eQ&&eQ.body){eQ.body.innerHTML=this.__Eu(eP);}
;}
;}
,__Eu:function(eR){var eU=bj;if((qx.core.Environment.get(bi)==cA)){if(qx.core.Environment.get(eb)<=2){eU+=cR;}
;}
;var eV=eR.length==0?bd:bj;var eT=qx.core.Environment.get(bi)==cA||qx.core.Environment.get(bi)==cB?cc:cq;var eS=r+K+this.getDefaultFontFamily()+z+cd+eT+dH+this.getDefaultFontSize()+z+eU+eR+eV+u+dz+S;return eS;}
,getValue:function(){return this.__vn;}
,getComputedValue:function(eW){return this.getHtml(eW);}
,getCompleteHtml:function(){var eY=this.__Eo[this.getContentType()];var eX=eY.html+t+eY.meta+bE+eY.contentStyle+bD+q;eX+=dj+this.__Ev()+dF;eX+=this.getHtml()+bf;return eX;}
,__Ev:function(){var fc=[dy,bB,v,ca,cg,du,bu,bk,dX,ba,N,dl,cV,dR];var fb=qx.bom.element.Style;var fa=this.getContentBody();var ff={};var fe,fg;var fd=qx.core.Environment.get(bi)==H?2:1;for(var i=0,j=fc.length;i<j;i++){fe=fc[i];fg=fb.get(fa,fe,fd);if(fg!==undefined&&fg!=bj){ff[fe]=fg;}
;}
;return qx.bom.element.Style.compile(ff);}
,getContentDocument:function(){if(this.__dc){return this._getIframeDocument();}
;}
,getContentBody:function(){if(this.__dc){return this._getIframeDocument().body;}
;}
,getContentWindow:function(){if(this.__dc){return this._getIframeWindow();}
;}
,getWords:function(fh){if(!fh){fh=this.getContentBody();}
;if(!fh){return [];}
;var fj=fh.cloneNode(true);var fl=fj.innerHTML;fl=fl.replace(/>/gi,bv);fl=fl.replace(/\n/gi,cJ);fl=fl.replace(/<!--.*-->/gi,bj);fj.innerHTML=fl;var fi=qx.core.Environment.get(bi)==H||qx.core.Environment.get(bi)==bX?fj.innerText:fj.textContent;var fk=fi.match(qx.bom.htmlarea.HtmlArea.GetWordsRegExp);return !fk?[]:fk;}
,getWordsWithElement:function(){var fn=this.getTextNodes();var fr={};var i,j,fs,fo,fm;for(var i=0,fq=fn.length;i<fq;++i){fo=fn[i];fs=fo.nodeValue.split(cJ);for(var j=0,fp=fs.length;j<fp;++j){fm=this._cleanupWord(fs[j]);if(fm!=null&&fm.length>1){if(!fr[fm]){fr[fm]=[];}
;fr[fm].push(fo);}
;}
;}
;return fr;}
,_cleanupWord:function(ft){if(!ft){return null;}
;return ft.replace(qx.bom.htmlarea.HtmlArea.CleanupWordsRegExp,bj);}
,getTextNodes:function(){return this._fetchTextNodes(this.getContentBody());}
,_fetchTextNodes:function(fu){var fw=[];var fv;if(fu.hasChildNodes){for(var i=0;i<fu.childNodes.length;i++){fv=this._fetchTextNodes(fu.childNodes[i]);qx.lang.Array.append(fw,fv);}
;}
;if(fu.nodeType==3){if(fu.nodeValue.length>1){fw.push(fu);}
;}
;return fw;}
,__Ew:0,__Ex:function(){var fx=this._getIframeDocument();if(!fx){this.__Ew++;if(this.__Ew>5){this.error(bA+fx);this.fireDataEvent(bT);}
else {if(qx.core.Environment.get(cH)){this.error(ce);}
;qx.event.Timer.once(function(){this.__Ex();}
,this,0);}
;}
else {this.__Ew=0;this._onDocumentIsReady();}
;}
,_loaded:function(e){if(this.__Ei){return;}
;if(this.__Eh){this.__Ey();return;}
;if((qx.core.Environment.get(bi)==H)){this.__Ex();}
else {this._onDocumentIsReady();}
;}
,isReady:function(){return this.__dc;}
,_onDocumentIsReady:function(){var fy=new qx.bom.htmlarea.manager.Command(this);if(this.getUseUndoRedo()){fy=new qx.bom.htmlarea.manager.UndoRedo(fy,this);}
;this.__Ei=true;if((qx.core.Environment.get(bi)==H)){this.setEditable(true);}
;this.__EB();if(!(qx.core.Environment.get(bi)==bX)){this.__Dv();}
;if(!(qx.core.Environment.get(bi)==H)){this.setEditable(true);}
;this.__dc=true;this.__Eb=fy;fy.setContentDocument(this._getIframeDocument());this.__EG();if((qx.core.Environment.get(bi)==bX)){this.__Dv();}
;this.fireEvent(dW);}
,forceEditable:qx.core.Environment.select(bi,{"gecko":function(){var fz=this._getIframeDocument();if(fz){if(parseFloat(qx.core.Environment.get(bV))>=cr){fz.designMode=dT;fz.body.contentEditable=false;fz.body.contentEditable=true;}
else {fz.body.contentEditable=true;this.__EH(true);}
;}
;}
,"default":qx.lang.Function.empty}),invalidateEditor:qx.core.Environment.select(bi,{"gecko":function(){this.__Ei=false;this.__dc=false;this.__Eh=true;}
,"default":function(){}
}),__Ey:qx.core.Environment.select(bi,{"gecko":function(){this.__EB();this.__Dv();this.__Eb.setContentDocument(this._getIframeDocument());this.setEditable(true);this.forceEditable();this.__Ei=true;this.__dc=true;this.__Eh=false;this.fireEvent(dJ);}
,"default":function(){}
}),__Ez:function(fA){var fC=bj;if(!fA){return fC;}
;try{var fB=fA.getAttribute(g);if(!fB){return fC;}
;if((qx.core.Environment.get(bi)==H)){fC=fB.cssText;}
else {fC=fB;}
;}
catch(fD){this.error(cW);}
;return fC;}
,__EA:function(fE){var fF=qx.core.Environment.get("engine.name")=="gecko"?" html, body {overflow-x: visible; } ":"";var fG=this.__Eo[this.getContentType()];var fH='<head>'+fG.meta+'<style type="text/css">'+fF+fG.style+fG.contentStyle+this.__Ea+'</style>'+'</head>';var content=fG.body+fE;return fG.html+fH+content+fG.footer;}
,__EB:function(){var fJ=this.__Eu(this.getValue());if(qx.lang.Type.isString(fJ)){var fI=this._getIframeDocument();try{fI.open("text/html",true);fI.write(this.__EA(fJ));fI.close();}
catch(e){this.error("cant open document on source '"+qx.bom.Iframe.queryCurrentUrl(this.__vY)+"'",e);this.fireDataEvent("loadingError",e);}
;}
;}
,__Dv:function(){this.__EC();this.__EE();this.__ED();}
,__EC:function(){var fL=qx.event.Registration;var fK=this._getIframeDocument();fL.addListener(fK.body,"keypress",this._handleKeyPress,this);fL.addListener(fK.body,"keyup",this._handleKeyUp,this);fL.addListener(fK.body,"keydown",this._handleKeyDown,this);}
,__ED:function(){var fO=qx.event.Registration;var fM=this._getIframeDocument();var fN=qx.core.Environment.get("engine.name")=="webkit"?this._getIframeWindow():fM.body;fO.addListener(fN,"focus",this._handleFocusEvent,this);fO.addListener(fN,"blur",this._handleBlurEvent,this);fO.addListener(fM,"focusout",this._handleFocusOutEvent,this);}
,__EE:function(){var fR=qx.event.Registration;var fQ=this._getIframeDocument();var fP=qx.core.Environment.get("engine.name")=="mshtml"?"click":"mouseup";fR.addListener(fQ.body,fP,this._handleMouseUpOnBody,this);fR.addListener(fQ.documentElement,fP,this._handleMouseUpOnDocument,this);fR.addListener(fQ.documentElement,"contextmenu",this._handleContextMenuEvent,this);}
,__EF:function(){if(this.__El==null){this.__El={execute:function(fS,fT){this.stackedCommands=true;this.commandStack.push({command:fS,value:fT});}
,commandStack:[],stackedCommands:false};}
;this.__El.stackedCommands=false;return this.__El;}
,__EG:function(){var fU=this.__El;if(fU!=null&&fU.stackedCommands){var fV=fU.commandStack;if(fV!=null){for(var i=0,j=fV.length;i<j;i++){this.__Eb.execute(fV[i].command,fV[i].value);}
;}
;}
;}
,__EH:function(fW){var fX=this._getIframeDocument();if(this.__Ei&&fX){try{if((qx.core.Environment.get("engine.name")=="gecko")){fX.designMode=(fW!==false)?'Off':'On';}
;fX.designMode=(fW!==false)?'On':'Off';}
catch(e){}
;}
;}
,setEditable:function(fY){if(this.__Ei){this.__EH(true);if((qx.core.Environment.get(bi)==cA)){try{var ga=this._getIframeDocument();ga.execCommand(dK,false,true);}
catch(gb){try{var ga=this._getIframeDocument();ga.execCommand(bJ,false,false);}
catch(gc){if(!this.__dc){this.error(dQ);this.fireDataEvent(bT,gc);}
...
;this.__Ej=fY;}
;}
,getEditable:function(){return this.__Ej;}
,isEditable:function(){return this.__Ej;}
,__EI:false,_handleKeyUp:function(e){var gd=e.getKeyIdentifier().toLowerCase();this.__Em=e;if((qx.core.Environment.get(cH))&&qx.core.Environment.get(cE)){this.debug(e.getType()+cz+gd);}
;if(qx.core.Environment.get(bi)==H||qx.core.Environment.get(bi)==cB){if(this.__EI){switch(gd){case bO:if(this.getInsertLinebreakOnCtrlEnter()){if((qx.core.Environment.get(bi)==cB)){this.__EJ();e.preventDefault();e.stopPropagation();}
else {var ge=this.__ET(this.getSelection());if(ge){ge.collapse(true);ge.pasteHTML(cS);}
;}
;this.__EO();}
;break;case cw:this.__EI=false;return;break;};}
;}
else if((qx.core.Environment.get(bi)==cA)){switch(gd){case G:case n:case cG:case A:case dO:case I:case cj:case dL:case k:this.__Ek=(this.getFocusNode()==this.getContentBody().firstChild);break;};}
;}
,__EJ:function(){var gf=this.getSelection();var gg="";if(gf&&(gf.focusNode.textContent==""||gf.focusNode.parentElement.tagName=="LI")){gg="<br class='webkit-block-placeholder' />";}
;this.__Eb.execute("inserthtml",gg+qx.bom.htmlarea.HtmlArea.simpleLinebreak);}
,_handleKeyDown:qx.core.Environment.select(bi,{"mshtml|webkit":function(e){var gh=e.getKeyIdentifier().toLowerCase();if((qx.core.Environment.get(cH))&&qx.core.Environment.get(cE)){}
;if(this.__EI&&(gh==bQ||gh==C||gh==cn||gh==J||gh==l||gh==c)){e.preventDefault();e.stopPropagation();}
;if(gh==cw){this.__EI=true;}
;}
,"default":function(e){}
}),_handleKeyPress:function(e){var gm=this.getContentDocument();var gi=e.getKeyIdentifier().toLowerCase();var gk=e.isCtrlPressed();var gl=e.isShiftPressed();this.__Em=e;if((qx.core.Environment.get(cH))&&qx.core.Environment.get(cE)){this.debug(e.getType()+cz+gi);}
;if(this.__Eq){var gs=!((qx.core.Environment.get(bi)==H)&&gi==bO)||!((qx.core.Environment.get(bi)==cA)&&gi==bO);if(gs){this.__EO();this.__Eq=false;}
;}
;switch(gi){case bO:if(!gl&&!gk&&this.getMessengerMode()){e.preventDefault();e.stopPropagation();this.fireDataEvent(cv,this.getComputedValue());this.resetHtml();}
;if(gk){if(!this.getInsertLinebreakOnCtrlEnter()){return;}
;e.preventDefault();e.stopPropagation();if((qx.core.Environment.get(bi)==cA)){if(this.__ER()){this.insertHtml(bh);this.__EO();return;}
;this.insertHtml(bI);}
else if((qx.core.Environment.get(bi)==bX)){var gr=this.getSelection();var gn=this.__ET(gr);if(gr&&gn){var go=gm.createElement(ds);gn.collapse(true);gn.insertNode(go);gn.collapse(true);gn.selectNode(go);gr.addRange(gn);gn.collapse(true);}
;}
;this.__EO();}
;if((qx.core.Environment.get(bi)==H)){if(!this.getInsertParagraphOnLinebreak()){if(this.__Eb.execute(h,qx.bom.htmlarea.HtmlArea.simpleLinebreak)){this.__EO();e.preventDefault();e.stopPropagation();}
;}
;}
else if((qx.core.Environment.get(bi)==cA)){if(this.getInsertParagraphOnLinebreak()&&!gl&&!gk){var gr=this.getSelection();if(gr){var gj=gr.focusNode;if(this.__ER()){this.__EO();return;}
;if(this.__ES()){this.__EO();return;}
;while(!qx.dom.Node.isNodeName(gj,br)){if(qx.dom.Node.isNodeName(gj,dx)){this.__EO();return;}
;gj=gj.parentNode;}
;}
;this.__Eb.insertParagraphOnLinebreak();e.preventDefault();e.stopPropagation();this.__EO();this.__Eq=true;}
;}
else if((qx.core.Environment.get(bi)==cB)){if(this.getInsertParagraphOnLinebreak()&&gl){this.__EJ();e.preventDefault();e.stopPropagation();this.__EO();}
;}
;;break;case cG:if(qx.core.Environment.get(bi)==cA&&qx.core.Environment.get(bV)<1.9&&gl){var gr=this.getSelection();if(gr&&gr.focusNode==gm.body.firstChild){if(this.__Ek){if(gr.focusOffset!=0){gr.extend(gr.focusNode,0);}
;}
;}
;}
;this.__EO();break;case dr:if(qx.core.Environment.get(bi)==cA&&qx.core.Environment.get(bV)<1.9){if(gk){var gr=this.getSelection();if(gl){if(gr&&(gr.focusOffset!=0)||(gr.focusNode!=gm.body.firstChild)){gr.extend(gm.body.firstChild,0);}
;}
else {var gp=null;var gq;if(gm){gp=gm.evaluate(cM,gm.body,null,XPathResult.ANY_TYPE,null);}
;if(gp&&gr){while(gq=gp.iterateNext()){if(gq&&gq.parentNode&&gq.parentNode.tagName!=Y){try{gr.extend(gq,0);if(!this.isSelectionCollapsed()){gr.collapseToStart();}
;}
catch(e){}
;break;}
;}
...
;}
;}
;this.__EO();break;case G:case n:case A:case dO:case I:case cj:case dL:case k:this.__EO();break;case cn:if(gk){this.__EK(dD,true);}
;break;case l:case c:if(gk){this.__EK(bx,true);}
;break;case J:if(gk){this.__EK(W,true);}
;break;case bQ:if(gk&&!gl){this.__EK(dw,true);}
else if(gk&&gl){this.__EK(B,true);}
;break;case C:if(gk){this.__EK(B,true);}
;break;case w:if(gk){this.selectAll();}
;break;};this.__Em=null;}
,__EK:function(gt,gu){var gw=null;var gv=qx.bom.htmlarea.HtmlArea.hotkeyInfo;if(gv[gt]){gw=gv[gt].method;}
;if(gw!=null&&this[gw]){this[gw]();if(gu){this.__Em.preventDefault();this.__Em.stopPropagation();}
;if(this.isSelectionCollapsed()){this.__Eq=true;}
;this.__EO();}
;}
,_handleFocusEvent:function(e){this.__En=null;if(qx.core.Environment.get(bi)==cA||qx.core.Environment.get(bi)==cB){var gx=this.getContentDocument().getElementById(cF);if(gx){qx.bom.element.Attribute.reset(gx,bP);}
;}
;this.fireEvent(ch);}
,_handleBlurEvent:function(e){this.__vn=this.getComputedValue();}
,_handleFocusOutEvent:function(e){this.__EI=false;if(this.__En==null){this.__En=this.getSelectedHtml();}
;this.fireEvent(R);}
,_handleMouseUpOnBody:function(e){if((qx.core.Environment.get(cH))&&qx.core.Environment.get(cE)){this.debug(T+e.getType());}
;this.__Er=true;this.__EO();}
,_handleMouseUpOnDocument:qx.core.Environment.select(bi,{"mshtml":qx.lang.Function.empty,"default":function(e){if(!this.__Er){qx.bom.Element.activate(this.getContentBody());}
;this.__Er=false;}
}),_handleContextMenuEvent:function(e){if(!this.getNativeContextMenu()){var gA=e.getViewportLeft();var gz=e.getViewportTop();var gB=qx.bom.element.Location.getLeft(this.__fM)+gA;var gC=qx.bom.element.Location.getTop(this.__fM)+gz;var gy={x:gB,y:gC,relX:gA,relY:gz,target:e.getTarget()};e.preventDefault();e.stopPropagation();qx.event.Timer.once(function(){this.fireDataEvent(bU,gy);}
,this,0);}
;}
,isLoaded:function(){return this.__Ei;}
,insertHtml:function(gD){return this.__Eb.execute(h,gD);}
,removeFormat:function(){var gE=this.__Eb.execute(dY);this.__Eb.execute(D,this.getDefaultFontSize());this.__Eb.execute(bS,this.getDefaultFontFamily());return gE;}
,setBold:function(){return this.__Eb.execute(dB);}
,setItalic:function(){return this.__Eb.execute(ec);}
,setUnderline:function(){return this.__Eb.execute(M);}
,setStrikeThrough:function(){return this.__Eb.execute(bL);}
,setFontSize:function(gF){return this.__Eb.execute(D,gF);}
,setFontFamily:function(gG){return this.__Eb.execute(bS,gG);}
,setTextColor:function(gH){return this.__Eb.execute(dt,gH);}
,setTextBackgroundColor:function(gI){return this.__Eb.execute(dc,gI);}
,setJustifyLeft:function(){return this.__Eb.execute(Q);}
,setJustifyCenter:function(){return this.__Eb.execute(bH);}
,setJustifyRight:function(){return this.__Eb.execute(cO);}
,setJustifyFull:function(){return this.__Eb.execute(X);}
,insertIndent:function(){return this.__Eb.execute(co);}
,insertOutdent:function(){return this.__Eb.execute(cT);}
,insertOrderedList:function(){return this.__Eb.execute(ef);}
,insertUnorderedList:function(){return this.__Eb.execute(ct);}
,insertHorizontalRuler:function(){return this.__Eb.execute(p);}
,insertImage:function(gJ){return this.__Eb.execute(dG,gJ);}
,insertHyperLink:function(gK){return this.__Eb.execute(V,gK);}
,removeBackgroundColor:function(){this.__Eb.execute(dP,cQ);}
,setBackgroundColor:function(gL){this.__Eb.execute(dP,gL);}
,removeBackgroundImage:function(){this.__Eb.execute(f);}
,setBackgroundImage:function(gM,gN,gO){return this.__Eb.execute(f,[gM,gN,gO]);}
,selectAll:function(){return this.__Eb.execute(cP);}
,undo:function(){if(this.getUseUndoRedo()){return this.__Eb.execute(E);}
else {return true;}
;}
,redo:function(){if(this.getUseUndoRedo()){return this.__Eb.execute(m);}
else {return true;}
;}
,resetHtml:function(){var gP=this._getIframeDocument();while(gP.body.firstChild){gP.body.removeChild(gP.body.firstChild);}
;if(qx.core.Environment.get(bi)==cA){gP.body.innerHTML=dV;}
else if(qx.core.Environment.get(bi)==cB){var gQ=this.getSelection();var gR=gP.createRange();if(gR&&gQ){gQ.addRange(gR);}
;}
;}
,getHtml:function(gS){var gT=this._getIframeDocument();if(gT==null){return null;}
;return qx.bom.htmlarea.HtmlArea.__Ee(gT.body,false,gS,this.getPostProcess());}
,containsOnlyPlaceholder:qx.core.Environment.select(bi,{"mshtml":function(){var gU=this._getIframeDocument();return (gU.body.innerHTML==da);}
,"default":qx.lang.Function.returnFalse}),_selectElement:function(gV){var gX=this.getContentWindow().getSelection();var gW=this.getContentDocument().createRange();gW.setStart(gV,0);gX.removeAllRanges();gX.addRange(gW);}
,focusContent:qx.core.Environment.select(bi,{"gecko":function(){var ha=this.getContentDocument();var gY=ha.getElementById(cF);this.getContentWindow().focus();qx.bom.Element.focus(this.getContentBody());if(gY){this._selectElement(gY);}
else {this.__EL();}
;}
,"webkit":function(){qx.bom.Element.focus(this.getContentWindow());qx.bom.Element.focus(this.getContentBody());var hb=this.getContentDocument().getElementById(cF);if(hb){qx.bom.element.Attribute.reset(hb,bP);}
;this.__EL();}
,"opera":function(){qx.bom.Element.focus(this.getContentWindow());qx.bom.Element.focus(this.getContentBody());this.__EL();}
,"default":function(){qx.bom.Element.focus(this.getContentBody());this.__EL();}
}),__EL:function(){if(!this.__EM()){this.__EN();}
;}
,__EM:qx.core.Environment.select("engine.name",{"gecko":function(){var hc=this.getContentBody().childNodes;if(hc.length==0){return false;}
else if(hc.length==1){return !(hc[0]&&qx.dom.Node.isNodeName(hc[0],"br")&&qx.bom.element.Attribute.get(hc[0],"_moz_dirty")!=null);}
else {return true;}
;}
,"webkit":function(){var hd=this.getContentBody().childNodes;if(hd.length==0){return false;}
else if(hd.length==1){return !(hd[0]&&qx.dom.Node.isNodeName(hd[0],"br"));}
else {return true;}
;}
,"default":function(){var he=this.getContentBody().childNodes;if(he.length==0){return false;}
else if(he.length==1){return !(he[0]&&qx.dom.Node.isNodeName(he[0],"p")&&he[0].firstChild==null);}
else {return true;}
;}
}),__EN:qx.core.Environment.select("engine.name",{"gecko|webkit":function(){this.getContentDocument().body.innerHTML=this.__Eu("");var hf=this.getContentDocument().getElementById("__elementToFocus__");qx.bom.element.Attribute.reset(hf,"id");this._selectElement(hf);}
,"default":function(){var hg=qx.dom.Hierarchy.getFirstDescendant(this.getContentBody());if(qx.dom.Node.isNodeName(hg,"p")){qx.bom.element.Style.set(hg,"font-family",this.getDefaultFontFamily());qx.bom.element.Style.set(hg,"font-size",this.getDefaultFontSize());}
;}
}),getContextInformation:function(){return this.__EP();}
,__EO:function(){qx.event.Timer.once(function(e){var hh=this.__EP();this.fireDataEvent("cursorContext",hh);}
,this,200);}
,__EP:function(){if(this._processingExamineCursorContext||this.getEditable()==false){return;}
;this._processingExamineCursorContext=true;if(!this.__EM()){this.__EN();}
;var hl=this.getFocusNode();if(hl==null){return;}
;if(qx.dom.Node.isText(hl)){hl=hl.parentNode;}
;var hp=this._getIframeDocument();var hy=(qx.core.Environment.get("engine.name")=="mshtml")?hl.currentStyle:hp.defaultView.getComputedStyle(hl,null);var hs=false;var hi=false;var hn=false;var hm=false;var ht=false;var hx=false;var ho=false;var hz=false;var hk=false;var hv=false;var hw=null;var hA=null;var hr=null;if(hy!=null){if((qx.core.Environment.get("engine.name")=="mshtml")){hi=hy.fontStyle=="italic";hn=hy.textDecoration.indexOf("underline")!==-1;hm=hy.textDecoration.indexOf("line-through")!==-1;hw=hy.fontSize;hr=hy.fontFamily;ho=hy.textAlign=="left";hz=hy.textAlign=="center";hk=hy.textAlign=="right";hv=hy.textAlign=="justify";}
else {hi=hy.getPropertyValue("font-style")=="italic";hn=hy.getPropertyValue("text-decoration").indexOf("underline")!==-1;hm=hy.getPropertyValue("text-decoration").indexOf("line-through")!==-1;hw=hy.getPropertyValue("font-size");hr=hy.getPropertyValue("font-family");ho=hy.getPropertyValue("text-align")=="left";hz=hy.getPropertyValue("text-align")=="center";hk=hy.getPropertyValue("text-align")=="right";hv=hy.getPropertyValue("text-align")=="justify";}
;if(qx.core.Environment.get("engine.name")=="mshtml"||qx.core.Environment.get("engine.name")=="opera"){hs=hy.fontWeight==700;}
else {hs=hy.getPropertyValue("font-weight")=="bold"||qx.dom.Node.isNodeName(hl,"b");}
;}
;var hj=hl;if(hj!=null&&hj.parentNode!=null&&!qx.dom.Node.isDocument(hj.parentNode)){while(hj!=null&&!qx.dom.Node.isNodeName(hj,"body")){var hq=qx.dom.Node.getName(hj);if(hq=="ol"){hx=true;break;}
else if(hq=="ul"){ht=true;break;}
;if(hA==null||hA==""){hA=qx.bom.element.Attribute.get(hj,'size');}
;hj=hj.parentNode;}
;}
;var hu={bold:hs?1:0,italic:hi?1:0,underline:hn?1:0,strikethrough:hm?1:0,fontSize:(hA==null)?hw:hA,fontFamily:hr,insertUnorderedList:ht?1:0,insertOrderedList:hx?1:0,justifyLeft:ho?1:0,justifyCenter:hz?1:0,justifyRight:hk?1:0,justifyFull:hv?1:0};this._processingExamineCursorContext=false;return hu;}
,getSelection:qx.core.Environment.select(bi,{"mshtml":function(){return this._getIframeDocument()?this._getIframeDocument().selection:null;}
,"default":function(){return this._getIframeWindow()?this._getIframeWindow().getSelection():null;}
}),isSelectionCollapsed:qx.core.Environment.select(bi,{"mshtml":function(){return this.getSelection()&&this.getSelection().type==cC;}
,"default":function(){return this.getSelection()&&this.getSelection().isCollapsed;}
}),getSelectedText:qx.core.Environment.select(bi,{"mshtml":function(){return this.getRange()?this.getRange().text:bj;}
,"default":function(){return this.getRange()?this.getRange().toString():bj;}
}),getSelectedHtml:function(){if(this.__En!=null){return this.__En;}
;var hB=this.getRange();if(!hB){return bj;}
else {return this.__EQ(hB);}
;}
,__EQ:qx.core.Environment.select("engine.name",{"mshtml":function(hC){if(!hC){return "";}
;return hC.item?hC.item(0).outerHTML:hC.htmlText;}
,"default":function(hD){var hE=this._getIframeDocument();if(hE&&hD){try{var hF=hE.createElement("body");hF.appendChild(hD.cloneContents());return hF.innerHTML;}
catch(hG){}
;return hD+"";}
;return "";}
}),clearSelection:qx.core.Environment.select(bi,{"mshtml":function(){var hH=this.getSelection();if(hH){hH.empty();}
;}
,"default":function(){var hI=this.getSelection();if(hI){hI.collapseToStart();}
;}
}),__ER:qx.core.Environment.select("engine.name",{"gecko":function(){var hJ=this.getSelection();var hK=this.getFocusNode();return hJ&&this.isSelectionCollapsed()&&hK!=null&&qx.dom.Node.isText(hK)&&hJ.anchorOffset<hK.length;}
,"default":function(){return false;}
}),__ES:qx.core.Environment.select("engine.name",{"gecko":function(){return qx.dom.Node.isElement(this.getFocusNode());}
,"default":function(){return false;}
}),getRange:function(){return this.__ET(this.getSelection());}
,__ET:qx.core.Environment.select("engine.name",{"mshtml":function(hL){var hM=this._getIframeDocument();if(hL){try{return hL.createRange();}
catch(hN){return hM?hM.body.createTextRange():null;}
;}
else {return hM?hM.body.createTextRange():null;}
;}
,"default":function(hO){var hP=this._getIframeDocument();if(hO){try{return hO.getRangeAt(0);}
catch(hQ){return hP?hP.createRange():null;}
;}
else {return hP?hP.createRange():null;}
;}
}),saveRange:qx.core.Environment.select(bi,{"mshtml":function(){this.__Ep=this.getRange();}
,"default":function(){}
}),getSavedRange:qx.core.Environment.select(bi,{"mshtml":function(){return this.__Ep;}
,"default":function(){}
}),resetSavedRange:qx.core.Environment.select(bi,{"mshtml":function(){this.__Ep=null;}
,"default":function(){}
}),getFocusNode:qx.core.Environment.select(bi,{"mshtml":function(){var hR=this.getSelection();var hS;switch(hR.type){case cs:case cC:hS=this.__ET(hR);if(hS){hS.collapse(false);return hS.parentElement();}
else {return null;}
;break;case L:hS=this.__ET(hR);if(hS){try{hS.collapse(false);}
catch(hT){}
;return hS.item(0);}
else {return null;}
;break;default:return this._getIframeDocument().body;};}
,"default":function(){var hU=this.getSelection();if(hU&&hU.focusNode){return hU.focusNode;}
;return this._getIframeDocument().body;}
})},environment:{"qx.bom.htmlarea.HtmlArea.debug":false},destruct:function(){try{var hW=this._getIframeDocument();var hY=qx.event.Registration;hY.removeListener(hW.body,bp,this._handleKeyPress,this);hY.removeListener(hW.body,dn,this._handleKeyUp,this);hY.removeListener(hW.body,dk,this._handleKeyDown,this);var hX=qx.core.Environment.get(bi)==cB?this._getIframeWindow():hW.body;hY.removeListener(hX,bc,this._handleFocusEvent);hY.removeListener(hX,bM,this._handleBlurEvent);hY.removeListener(hW,dq,this._handleFocusOutEvent);var hV=qx.core.Environment.get(bi)==H?o:dC;hY.removeListener(hW.body,hV,this._handleMouseUpOnBody,this);hY.removeListener(hW.documentElement,hV,this._handleMouseUpOnDocument,this);hY.removeListener(hW.documentElement,bU,this._handleContextMenuEvent,this);if((qx.core.Environment.get(bi)==H)){qx.bom.Iframe.setSource(this.__vY,cU);}
;}
catch(ia){}
;if(this.__Eb instanceof qx.core.Object){this._disposeObjects(y);}
else {this.__Eb=null;}
;this.__Eo=this.__vY=this.__fM=this.__El=null;}
});}
)();
...
(function(){var cw="_moz",cv="formatBlock",cu="insertParagraph",ct=" succeded",cs="li",cr='<span style="',cq="__Fq",cp=' <a href="',co="FONT",cn="inserthyperlink failed!",bx="__placeholder__",bw="JustifyCenter",bv="__Fo",bu="Cut",bt="outdent",bs='</a> ',br="InsertImage",bq="__resetHtml",bp="FontName",bo="blockquote",cD="__FD",cE="style",cB="__FE",cC="The method '",cz="qx.bom.htmlarea.manager.Command",cA="'><br class='webkit-block-placeholder' />",cx="a",cy='"',cF="<span></span>",cG="type",bV="CreateLink",bU="__FB",bX="':'",bW="' you calling to execute the command '",ca="qx_link",bY="__FJ",cc='"></span>',cb="Italic",bT=" failed",bS="InsertUnorderedList",a="body",b="OL",c='text-align:',d="__FC",f="Bold",g="ForeColor",h='" ',m="repeat repeat-x repeat-y no-repeat",n='</p>',o="<hr />",cK="editor not ready! '",cJ='<font style="',cI="__FK",cH="Command ",cO="IMG",cN='<p id="',cM="JustifyRight",cL="LI",cQ="__getHtml",cP='>',N='font-family:',O="__Fr",L='" size="',M="Indent",R="br",S="Copy",P="</span>",Q="Paste",J="none",K="__FH",w="__Fz",v="RemoveFormat",y="StrikeThrough",x="__FA",s='',r="__Fh",u='style="',t="'",q="' is not available!",p="_moz_dirty",X="color",Y="JustifyLeft",ba="__FI",bb=" is currently not supported!",T="Underline",U="SelectAll",V="<p style='",W="href",bc='<span id="',bd="UL",G="JustifyFull",F="Outdent",E="indent",D="selectall",C="InsertOrderedList",B="__FF",A="/>",z="<img ",I="</font>",H="font-size",be="background-color",bf="font",bg=":",bh="='",bi=" with value ",bj="__Fm",bk=";",bl="px",bm="Control",bn="__paragraph__",bB=':',bA="qx.bom.htmlarea.HtmlArea.debug",bz="size",by="' ",bF="webkit",bE="execCommand ",bD="transparent",bC="BODY",bH="undefined",bG="text-align",bO="p",bP="id",bM="InsertHtml",bN='">',bK="font-family",bL="child",bI="gecko",bJ='text-decoration',bQ="FontSize",bR="qx.debug",cg=';',cf="__Fl",ci="span",ch='color',ck="text-decoration",cj="inserthtml",cm="mshtml",cl="",ce="legacy-font-size",cd="engine.name";qx.Class.define(cz,{extend:qx.core.Object,construct:function(cR){qx.core.Object.call(this);this.__EU=cR;this.__oc=null;this._commands=null;this.__Fc();this.__EV={"Bold":true,"Italic":true,"Underline":true,"StrikeThrough":true};this.__EW=[10,12,16,18,24,32,48];this.__EX=0;}
,statics:{__EY:"|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",__Fa:m},members:{__oc:null,__EU:null,__Fb:false,__EV:null,__EW:null,__EX:null,setContentDocument:function(cS){this.__oc=cS;}
,getCommandObject:function(cT){if(this._commands[cT]){return this._commands[cT];}
else {return null;}
;}
,__Fc:function(){this._commands={bold:{useBuiltin:false,identifier:f,method:K},italic:{useBuiltin:false,identifier:cb,method:ba},underline:{useBuiltin:false,identifier:T,method:bY},strikethrough:{useBuiltin:false,identifier:y,method:cI},fontfamily:{useBuiltin:true,identifier:bp,method:null},fontsize:{useBuiltin:false,identifier:bQ,method:w},textcolor:{useBuiltin:true,identifier:g,method:null},textbackgroundcolor:{useBuiltin:false,identifier:null,method:x},backgroundcolor:{useBuiltin:false,identifier:null,method:bU},backgroundimage:{useBuiltin:false,identifier:null,method:d},justifyleft:{useBuiltin:false,identifier:Y,method:cf},justifyright:{useBuiltin:false,identifier:cM,method:cf},justifycenter:{useBuiltin:false,identifier:bw,method:cf},justifyfull:{useBuiltin:false,identifier:G,method:cf},indent:{useBuiltin:true,identifier:M,method:null},outdent:{useBuiltin:true,identifier:F,method:null},copy:{useBuiltin:true,identifier:S,method:null},cut:{useBuiltin:true,identifier:bu,method:null},paste:{useBuiltin:true,identifier:Q,method:null},insertorderedlist:{useBuiltin:false,identifier:C,method:bj},insertunorderedlist:{useBuiltin:false,identifier:bS,method:bj},inserthorizontalrule:{useBuiltin:false,identifier:bM,method:O},insertimage:{useBuiltin:false,identifier:br,method:bv},inserthyperlink:{useBuiltin:false,identifier:bV,method:cq},selectall:{useBuiltin:false,identifier:U,method:cD},selectedtext:{useBuiltin:false,identifier:null,method:cB},selectedhtml:{useBuiltin:false,identifier:null,method:B},inserthtml:{useBuiltin:false,identifier:bM,method:r},resethtml:{useBuiltin:false,identifier:null,method:bq},gethtml:{useBuiltin:false,identifier:null,method:cQ},removeformat:{useBuiltin:true,identifier:v,method:null}};}
,execute:function(cU,cV){if(!this.__EU.isReady()){this.error(cK+cU+bX+cV+t);return false;}
;cU=cU.toLowerCase();cV=cV!=null?cV:null;if(this._commands[cU]){var cW;var cX=this._commands[cU];if(!((qx.core.Environment.get(cd)==bF)&&(cU==E||cU==bt))){if(this.__Fd()){this.__Fe();}
;}
;if(cX.useBuiltin){cW=this.__Ff(cX.identifier,false,cV);}
else {if(cX.method!=null&&this[cX.method]){cW=this[cX.method].call(this,cV,cX);}
else {this.error(cC+cX.method+bW+cU+q);}
;}
;this.__EU.resetSavedRange();return cW;}
else {this.error(cH+cU+bb);}
;}
,__Fd:function(){var Node=qx.dom.Node;var cY=this.__EU.getFocusNode();var dc=false;var da=false;if(cY){if(Node.isText(cY)){var db=qx.dom.Hierarchy.getAncestors(cY);for(var i=0,j=db.length;i<j;i++){if(Node.isNodeName(db[i],bO)||qx.bom.htmlarea.HtmlArea.isHeadlineNode(db[i])){dc=true;break;}
;}
;}
else if(Node.isNodeName(cY,a)){da=true;}
;}
;return da||!dc;}
,__Fe:function(){this.__Ff(cv,false,bO);}
,__Ff:function(dd,de,df){try{var di=this.__oc;var dg=false;var dh=this.__EU.getRange();this.__oc.body.focus();if((qx.core.Environment.get(cd)==cm)){if(dd!=D){dh.select();if(((dh.text)&&(dh.text.length>0))||((dh.length==1)&&(dh.item(0))&&(dh.item(0).tagName==cO))){di=dh;}
else {di=this.__oc;}
;}
;if(((qx.core.Environment.get(cd)==cm))&&(this.__EV[dd])){if(dh.text==cl){dg=true;}
;}
;}
;var dj=di.execCommand(dd,de,df);if(dg&&dh.text!=cl){dh.collapse();}
;if((qx.core.Environment.get(bR))&&qx.core.Environment.get(bA)){this.debug(bE+dd+bi+df+ct);}
;this.__Fb=false;}
catch(dk){if((qx.core.Environment.get(bR))&&qx.core.Environment.get(bA)){this.debug(bE+dd+bi+df+bT);}
;return false;}
;return dj;}
,__Fg:qx.core.Environment.select(cd,{"mshtml":function(){var dm=this.__EU;var dl=dm.getSavedRange()!=null?dm.getSavedRange():dm.getRange();return dl;}
,"default":function(){return this.__EU.getRange();}
}),__Fh:qx.core.Environment.select(cd,{"mshtml":function(dn,dp){var ds;if(dn==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__Fk();}
else {this.__oc.body.focus();var dr=this.__EU.getSelection();var dq=this.__Fg();if(dq&&dr&&dr.type!=bm){try{dq.pasteHTML(dn);dq.collapse(false);dq.select();ds=true;}
catch(e){}
;}
else {ds=false;}
;this.__EU.resetSavedRange();return ds;}
;}
,"default":function(dt,du){this.__oc.body.focus();return this.__oc.execCommand(du.identifier,false,dt);}
}),insertParagraphOnLinebreak:qx.core.Environment.select(cd,{"gecko":function(){var dC=this.__Fu();var dG=this.__Fi(dC);var dy=this.__Fs(dC);var dD=bx+Date.parse(new Date());var dE=bn+Date.parse(new Date());var dw=s;var dA=bc+dD+cc;dw+=dA;dw+=cN+dE+h+dG+cP;dw+=dy+n;this.__EU.getCommandManager().addUndoStep(cj,cu,this.getCommandObject(cj));this.execute(cj,dw);this.__Fj();qx.bom.element.Attribute.reset(this.__oc.getElementById(dD),bP);var dB=this.__oc.getElementById(dE);if(dB.previousSibling.innerHTML==dA){var dv=this.__Ft();var dz=this.__oc.createElement(R);var dx=this.__oc.createAttribute(p);dx.nodeValue=cl;dz.setAttributeNode(dx);var dF=this.__oc.createAttribute(cG);dF.nodeValue=cw;dz.setAttributeNode(dF);dB.previousSibling.appendChild(dv);dB.previousSibling.appendChild(dz);}
;qx.bom.element.Attribute.reset(dB,bP);return true;}
,"webkit":function(){var dH=this.getCurrentStyles();var dI=cl;var dK={"background-color":true,"text-align":true};for(var dJ in dH){if(dK[dJ]){dI+=dJ+bg+dH[dJ]+bk;}
;}
;this.__EU.insertHtml(V+dI+cA);}
,"default":qx.lang.Function.empty}),__Fi:qx.core.Environment.select(cd,{"gecko":function(dL){var dQ=u;var dP=dL.child;if(dP[bG]){dQ+=c+dP[bG]+cg;delete dL.child[bG];}
;if(dP[bK]){dQ+=N+dP[bK]+cg;delete dL.child[bK];}
;var dO={"padding-top":true,"padding-bottom":true,"padding-left":true,"padding-right":true};var dM={"margin-top":true,"margin-bottom":true,"margin-left":true,"margin-right":true};for(var dN in dP){if(dO[dN]||dM[dN]){dQ+=dN+bB+dP[dN]+cg;delete dL.child[dN];}
;}
;dQ+=cy;return dQ;}
,"default":function(){return cl;}
}),__Fj:qx.core.Environment.select(cd,{"gecko":function(){var dY=this.__EU.getSelection();if(!dY||!dY.focusNode){return;}
;var dR=dY.focusNode;var dW=dY.focusNode;while(!qx.dom.Node.isNodeName(dW,bO)){dW=dW.parentNode;}
;var dV=dW.previousSibling.id;var ea=dW.nextSibling?dW.nextSibling.id:null;if(qx.lang.String.startsWith(dV,bn)&&dV==ea){var dX=dW.nextSibling;var dT=this.__EU.getRange();dT.selectNode(dX);dY.addRange(dT);var dS=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;this.__EU.getCommandManager().addUndoStep(cj,dS,this.getCommandObject(cj));this.execute(cj,dS);var dU=this.__EU.getRange();if(dR){while(dR&&dR.firstChild&&qx.dom.Node.isElement(dR.firstChild)){dR=dR.firstChild;}
;}
;dU.selectNode(dR);dY.addRange(dU);dU.collapse(true);}
;}
,"default":qx.lang.Function.empty}),__Fk:qx.core.Environment.select(cd,{"mshtml":function(){var eb=this.__EU.getRange();if(eb&&!qx.dom.Node.isNodeName(eb.parentElement(),cs)){eb.pasteHTML(qx.bom.htmlarea.HtmlArea.simpleLinebreak);eb.collapse(false);eb.select();return true;}
;return false;}
,"default":function(){return false;}
}),__Fl:function(ec,ed){var ee=(qx.core.Environment.get(cd)==cm)?this.__EU.getRange():this.__oc;return ee.execCommand(ed.identifier,false,ec);}
,__Fm:function(ef,eg){if((qx.core.Environment.get(cd)==cm)){var eh=this.__EU.getFocusNode();this.__Fn(eh);}
;this.__oc.body.focus();var ei=this.__oc.execCommand(eg.identifier,false,ef);if((qx.core.Environment.get(cd)==bF)){var eh=this.__EU.getFocusNode();this.__Fn(eh.parentNode);}
;return ei;}
,__Fn:function(ej){var ek=[];var parent=ej.parentNode;while(qx.dom.Node.isNodeName(parent,bo)){ek.push(parent);parent=parent.parentNode;}
;if(ek.length>0){parent.appendChild(ej);parent.removeChild(ek[ek.length-1]);}
;}
,__Fo:qx.core.Environment.select(cd,{"gecko":function(el,em){if(el.src){this.__oc.execCommand(em.identifier,false,el.src);delete el.src;var eA=this.__EU.getSelection();if(eA){var ez=eA.anchorNode;var et=eA.anchorOffset;var eq=ez.childNodes[et-1];var ew;for(var es in el){ew=this.__oc.createAttribute(es);ew.nodeValue=el[es];eq.setAttributeNode(ew);}
...
;var ep=this.__oc.createDocumentFragment();var eB;if(ev&&eo!=null){var er=this.__Fp(eo);ep.appendChild(er.root);eB=er.inline;}
else {eB=this.__oc.createElement(ci);ep.appendChild(eB);}
;var ey=this.__oc.createTextNode(cl);eB.appendChild(ey);var eu=eq.parentNode;if(eq==eu.lastChild){eu.appendChild(ep);}
else {eu.insertBefore(ep,eq.nextSibling);}
;var en=this.__EU.getRange();en.selectNodeContents(eB);}
;return true;}
else {return false;}
;}
,"mshtml":function(eC,eD){var eH=false;var eI=z;for(var eE in eC){eI+=eE+bh+eC[eE]+by;}
;eI+=A;var eF=this.__EU.getSelection();var eG=this.__Fg();if(eF&&eF.type!=bm){try{eG.select();eG.pasteHTML(eI);eH=true;}
catch(e){}
;}
;this.__EU.resetSavedRange();return eH;}
,"default":function(eJ,eK){if(eJ.src){var eM=z;for(var eL in eJ){eM+=eL+bh+eJ[eL]+by;}
;eM+=A;return this.__oc.execCommand(bM,false,eM);}
else {return false;}
;}
}),__Fp:function(eN){while(eN.firstChild&&eN.firstChild.nodeType==1){eN=eN.firstChild;}
;var eR=this.__Fu(eN);var eV,eP,eT;var eO=cl;var parent=null;var eU=null;var eS=eR.child;while(eS){eU=this.__oc.createElement(eS[ce]?bf:ci);eP=this.__oc.createAttribute(cE);eU.setAttributeNode(eP);for(var eQ in eS){if(eQ!=bL&&eQ!=ce){eO+=eQ+bg+eS[eQ]+bk;}
else if(eQ==ce){eT=this.__oc.createAttribute(bz);eT.nodeValue=eS[eQ];eU.setAttributeNode(eT);}
;}
;eP.nodeValue=eO;if(parent!=null){parent.appendChild(eU);}
else {eV=eU;}
;parent=eU;eS=eS.child;eO=cl;}
;return {root:eV,inline:eU};}
,__Fq:qx.core.Environment.select(cd,{"gecko|opera":function(eW,eX){var fe=this.__EU.getSelection();var fb=this.__EU.getRange();if(fe.isCollapsed){var fa=ca+(++this.__EX);var ff=this.__oc.createElement(cx);var fc=this.__oc.createAttribute(W);var eY=this.__oc.createAttribute(bP);var fd=this.__oc.createTextNode(eW);eY.nodeValue=fa;ff.setAttributeNode(eY);fc.nodeValue=eW;ff.setAttributeNode(fc);ff.appendChild(fd);fb.insertNode(ff);fb.selectNode(ff);fe.collapseToEnd();return true;}
else {return this.__oc.execCommand(eX.identifier,false,eW);}
;}
,"mshtml":function(fg,fh){try{var fj;var fi=this.__Fg();var fk=this.__EU;var fi=fk.getSavedRange()!=null?fk.getSavedRange():fk.getRange();if(fi!=null&&fi.text!=cl){fj=fi.execCommand(fh.identifier,false,fg);}
else {fj=this.__Fh(cp+fg+bN+fg+bs,fh);}
;this.__EU.resetSavedRange();return fj;}
catch(e){if(qx.core.Environment.get(bR)){this.error(cn);}
;return false;}
;}
,"default":function(fl,fm){return this.__oc.execCommand(fm.identifier,false,fl);}
}),__Fr:function(fn,fo){var fp=o;if((qx.core.Environment.get(cd)==bI)){fp+=this.__Fs();}
;return this.__Fh(fp,fo);}
,__Fs:function(fq){var fu=cl;var ft=cr;var fs=[];var fx=typeof fq!==bH?fq:this.__Fu();var fv=fx.child;var fw=false;if(qx.lang.Object.isEmpty(fv)){return cl;}
;while(fv){fw=fv[ce]!=null;fu+=fw?cJ:ft;for(var fr in fv){fu+=(fr!=bL&&fr!=ce)?fr+bB+fv[fr]+cg:cl;}
;fu+=fw?L+fv[ce]+bN:bN;fs.unshift(fw?I:P);fv=fv.child;}
;if(fs.length==1&&fs[0]==I){fu+=cF;}
;for(var i=0,j=fs.length;i<j;i++){fu+=fs[i];}
;return fu;}
,__Ft:function(){var fz=this.__oc.createDocumentFragment();var fE=this.__Fu();var parent=fz;var fC=fE.child;var fA;var fD=false;while(fC){fD=fC[ce]!=null;fA=this.__oc.createElement(fD?bf:ci);parent.appendChild(fA);for(var fy in fC){if(fy!=bL&&fy!=ce){qx.bom.element.Style.set(fA,fy,fC[fy]);}
;}
;if(fD){var fB=this.__oc.createAttribute(bz);fB.nodeValue=fC[ce];fA.setAttributeNode(fB);}
;parent=fA;fC=fC.child;}
;return fz;}
,__Fu:function(fF){var fH={};var fI=null;var fJ=this.getCurrentStyles(fF);fI=fH.child={};for(var fG in fJ){if(fG!=ck){fI[fG]=fJ[fG];}
;}
;if(fJ[ck]){var fK=fJ[ck];for(var i=0,j=fK.length;i<j;i++){if(fI==null){fI=fH.child={};}
else {fI=fI.child={};}
;fI[ch]=fK[i][ch];fI[bJ]=fK[i][bJ];}
;}
;if(fJ[ch]&&fJ[bJ]){fI=fI.child={};fI[ch]=fJ[ch];}
;return fH;}
,getCurrentStyles:function(fL){if(fL==null){var fN=this.__EU.getSelection();if(!fN||fN.focusNode==null){return {};}
;fL=(fN.focusNode.nodeType==3)?fN.focusNode.parentNode:fN.focusNode;}
;var fO=qx.dom.Hierarchy.getAncestors(fL);var fQ=qx.lang.Array.insertBefore(fO,fL,fO[0]);var fM=this.__Fv(fQ);var fP=this.__Fw(fM,fQ);return fP;}
,__Fv:function(fR){var fU={};var fS,fT;for(var i=0,j=fR.length;i<j;i++){fT=fR[i];for(var k=0,l=fT.style.length;k<l;k++){fS=fT.style[k];if(fS.length>0&&typeof fU[fS]===bH){fU[fS]=fT.style.getPropertyValue(fS);}
;}
;if(fT.tagName.toUpperCase()==co&&fT.size&&fU[ce]===undefined){fU[ce]=fT.size;}
;}
;if(fU[ce]&&fU[H]){delete fU[H];}
;return fU;}
,__Fw:function(fV,fW){var gc=fW[0];var ga=this.__EU.getContentWindow().getComputedStyle(gc,null);var fX;var gb={};for(var fY in fV){if(fY!=ce){fX=ga.getPropertyValue(fY);}
else {fX=fV[fY];}
;if(fY==be&&fX==bD){gb[fY]=this.__Fy(fW);}
else if(fY==ck){gb[fY]=this.__Fx(fW);}
else {gb[fY]=fX;}
;}
;return gb;}
,__Fx:function(gd){var gg,gi,ge;var gh=[];var gf=this.__EU.getContentWindow();for(var i=0,j=gd.length;i<j;i++){ge=gf.getComputedStyle(gd[i],null);gg=ge.getPropertyValue(ck);gi=ge.getPropertyValue(X);if(gg!=J){gh.push({'text-decoration':gg,'color':gi});}
;}
;return gh;}
,__Fy:function(gj){var gl,gk,gm;for(var i=0;i<gj.length;i++){gl=gj[i];gk=this.__EU.getContentWindow().getComputedStyle(gl,null);gm=gk.getPropertyValue(be);if(gm!=bD){return gm;}
;}
;}
,__Fz:function(gn,go){var gA=this.__EU.getSelection();var gv=((qx.core.Environment.get(cd)==cm))?this.__EU.getRange():gv=gA.getRangeAt(0);var gw=[];var gz;var gu=[b,bd];var gp,i,j,gx;gx=((qx.core.Environment.get(cd)==cm))?gv.parentElement():gv.commonAncestorContainer;if(gx.tagName==bC){for(var i=0;i<gu.length;i++){gp=gx.getElementsByTagName(gu[i]);for(var j=0;j<gp.length;j++){if(gp[j]){gw.push(gp[j]);}
;}
;}
;}
else if(qx.lang.Array.contains(gu,gx.tagName)){gw.push(gx);}
;if(gw.length>0){for(var i=0;i<gw.length;i++){var gr=gw[i];gz=((qx.core.Environment.get(cd)==cm))?((gr==gx)||(gx.tagName==bC)):gA.containsNode(gr,false);for(j=0;j<gr.childNodes.length;j++){var gt=gr.childNodes[j];if(gz||(gA.focusNode.nodeValue&&qx.dom.Hierarchy.contains(gt,gA.focusNode)&&(gA.focusOffset==gA.focusNode.nodeValue.length))||(qx.dom.Hierarchy.contains(gt,gA.anchorNode)&&(gA.anchorOffset==0))||(gA.containsNode(gt,false))){gt.style.fontSize=(this.__EW[gn]||gn)+bl;}
;}
;}
;}
else {var gs=((qx.core.Environment.get(cd)==cm))?gx:gA.focusNode;var gy=qx.dom.Hierarchy.getAncestors(gs);for(i=0;i<gy.length;i++){if(gy[i].tagName==cL){if((((qx.core.Environment.get(cd)==bI))&&((gA.anchorOffset==0)&&(gA.focusNode.nodeValue&&(gA.focusOffset==gA.focusNode.nodeValue.length))&&qx.dom.Hierarchy.contains(gy[i].firstChild,gA.anchorNode)&&qx.dom.Hierarchy.contains(gy[i].lastChild,gA.focusNode)))||(((qx.core.Environment.get(cd)==cm))&&(gv.htmlText==gy[i].innerHTML))){gy[i].style.fontSize=(this.__EW[gn]||gn)+bl;}
;break;}
;}
;}
;if((qx.core.Environment.get(cd)==cm)){this.__oc.body.focus();this.__EU.getRange().select();return this.__oc.execCommand(bQ,false,gn);}
else if((qx.core.Environment.get(cd)==bI)){var parent=gv.commonAncestorContainer;if(parent.nodeType===1){var gq=parent.getElementsByTagName(ci);for(i=0;i<gq.length;i++){if(gq[i].style.fontSize){gq[i].style.fontSize=null;}
;}
;}
;}
;return this.__oc.execCommand(bQ,false,gn);}
,__FA:qx.core.Environment.select("engine.name",{"mshtml":function(gB,gC){this.__oc.body.focus();return this.__oc.execCommand("BackColor",false,gB);}
,"gecko|opera":function(gD,gE){this.__oc.body.focus();return this.__oc.execCommand("HiliteColor",false,gD);}
,"webkit":function(gF,gG){var gH=this.__EU.getSelection();var gI=this.__EU.getRange();if(!gH||!gH.isCollapsed){this.__oc.body.focus();this.__oc.execCommand("BackColor",false,gF);if(gH){gH.collapseToEnd();}
;return true;}
else {var gK=gH.anchorOffset;var gL=gH.anchorOffset;var gI=gH.getRangeAt(0);var gJ=gH.anchorNode;while(gL>0){if(gJ.nodeValue.charCodeAt(gL)==160||gJ.nodeValue.charCodeAt(gL)==32){break;}
else {gL--;}
;}
;while(gK<gJ.nodeValue.length){if(gJ.nodeValue.charCodeAt(gK)==160||gJ.nodeValue.charCodeAt(gK)==32){break;}
else {gK++;}
;}
;gI.setStart(gH.anchorNode,gH.anchorNode.nodeValue.charAt(gL)==" "?gL+1:gL);gI.setEnd(gH.anchorNode,gK);gH.addRange(gI);this.__oc.body.focus();this.__oc.execCommand("BackColor",false,gF);gH.collapseToEnd();return true;}
;}
}),__FB:function(gM,gN){gM=gM!=null&&typeof gM=="string"?gM:"transparent";qx.bom.element.Style.set(this.__oc.body,"backgroundColor",gM);return true;}
,__FC:function(gO,gP){var gQ,gS,gR;var gT=qx.bom.htmlarea.manager.Command;if(gO==null){gQ=null;}
else {gQ=gO[0];gS=gO[1];gR=gO[2];}
;if(gQ==null||typeof gQ!="string"){qx.bom.element.Style.set(this.__oc.body,"backgroundImage","");qx.bom.element.Style.set(this.__oc.body,"backgroundRepeat","");qx.bom.element.Style.set(this.__oc.body,"backgroundPosition","");return true;}
else {if(gQ.search(/^url.*\(/)==-1){gQ="url("+gQ+")";}
;}
;if(gS!=null&&!qx.lang.String.contains(gT.__Fa,gS)){if(qx.core.Environment.get("qx.debug")){this.error("The value '"+gS+"' is not allowed for parameter 'repeat'. Possible values are '"+gT.__Fa+"'");}
;return false;}
else {gS="no-repeat";}
;if(gR!=null){if(qx.lang.Type.isString(gR)&&!qx.lang.String.contains(gT.__EY,'|'+gR+'|')){if(qx.core.Environment.get("qx.debug")){this.error("The value '"+gR+"' is not allowed for parameter 'position'. Possible values are '"+gT.__EY+"'");}
;return false;}
else {if(qx.lang.Type.isArray(gR)&&gR.length==2){gR=gR[0]+" "+gR[1];}
...
;qx.bom.element.Style.set(this.__oc.body,"backgroundImage",gQ);qx.bom.element.Style.set(this.__oc.body,"backgroundRepeat",gS);qx.bom.element.Style.set(this.__oc.body,"backgroundPosition",gR);return true;}
,__FD:qx.core.Environment.select("engine.name",{"mshtml":function(gU,gV){var gW=this.__oc.body.createTextRange();gW.select();return true;}
,"default":function(gX,gY){return this.__Ff(gY.identifier,false,gX);}
}),__FE:function(){return this.__EU.getSelectedText();}
,__FF:function(){return this.__EU.getSelectedHtml();}
,__FG:function(ha,hb){var hf=this.__EU.getFocusNode();if(hf.textContent==""){var hd=qx.dom.Hierarchy.getAncestors(hf);hd.unshift(hf);var Node=qx.dom.Node;var hc=qx.bom.element.Style;var he=hd.shift();while(hd.length>0){if(Node.getName(he)=="p"||Node.getName(he)=="body"){break;}
;if(hc.get(he,ha,hc.LOCAL_MODE)==hb){hc.reset(he,ha);return true;}
;he=hd.shift();}
;}
;return false;}
,__FH:qx.core.Environment.select("engine.name",{"gecko":function(hg,hh){if(this.__FG("fontWeight","bold")){return true;}
else {return this.__Ff(hh.identifier,false,hg);}
;}
,"default":function(hi,hj){return this.__Ff(hj.identifier,false,hi);}
}),__FI:qx.core.Environment.select("engine.name",{"gecko":function(hk,hl){if(this.__FG("fontStyle","italic")){return true;}
else {return this.__Ff(hl.identifier,false,hk);}
;}
,"default":function(hm,hn){return this.__Ff(hn.identifier,false,hm);}
}),__FJ:qx.core.Environment.select("engine.name",{"gecko":function(ho,hp){if(this.__FG("textDecoration","underline")){return true;}
else {return this.__Ff(hp.identifier,false,ho);}
;}
,"default":function(hq,hr){return this.__Ff(hr.identifier,false,hq);}
}),__FK:qx.core.Environment.select("engine.name",{"gecko":function(hs,ht){if(this.__FG("textDecoration","line-through")){return true;}
else {return this.__Ff(ht.identifier,false,hs);}
;}
,"default":function(hu,hv){return this.__Ff(hv.identifier,false,hu);}
})},destruct:function(){this.__oc=this.__EU=this._commands=null;this.__EV=this.__EW=null;}
});}
)();
(function(){var n="undo",m="backgroundColor",l="pageup",k="home",h="shift",g="end",f="insertorderedlist",d="control",c="b",b="insertunorderedlist",bm="__Eb",bl="Undo",bk="pagedown",bj="ADD TO UNDO STACK",bi="backgroundImage",bh="backgroundRepeat",bg="a",bf="y",be="backgroundPosition",bd="justifyright",u="redo",v="k",s="qx.bom.htmlarea.manager.UndoRedo",t="left",q="i",r="Redo",o="u",p="inserthyperlink",z="right",A="enter",I="execCommand failed! Details: ",G="ADD TO REDO STACK",Q="insertimage",L="z",Y="undoRedoState",V="down",C="up",bc="body",bb="actionType ",ba="mousedown",B="backgroundcolor",E="backgroundimage",F=" is not managed! Please provide a handler method!",H="table",J="td",M="img",S="p",X="mouseup",w="keypress",x="qx.bom.htmlarea.HtmlArea.debug",D="inserthtml",P="gecko",O="qx.debug",N="webkit",U="Content",T=" ",K="Internal",R="Custom",a="Command",W="mshtml",y="engine.name";qx.Class.define(s,{extend:qx.core.Object,construct:function(bn,bo){qx.core.Object.call(this);this.__Eb=bn;this.__EU=bo;this.__FL=[];this.__FM=[];this._commands=null;this.__oc=null;this.__FN={};this.__FO={command:true,content:true,custom:true};this.__Fc();this.__FP=qx.lang.Function.bind(this._handleKeyPress,this);this.__FQ=qx.lang.Function.bind(this._handleMouseUp,this);if((qx.core.Environment.get(y)==W)){this.__FR=qx.lang.Function.bind(this._handleMouseDown,this);}
;}
,members:{__FS:false,__FT:false,__FU:false,__FO:null,__FN:null,__Eb:null,__oc:null,__FL:null,__FM:null,__EU:null,__FP:null,__FQ:null,__FR:null,__FV:null,setContentDocument:function(bp){this.__oc=bp;this.__Eb.setContentDocument(bp);qx.event.Registration.addListener(bp.body,w,this.__FP,this);qx.event.Registration.addListener(bp.body,X,this.__FQ,this);if((qx.core.Environment.get(y)==W)){qx.event.Registration.addListener(bp.body,ba,this.__FR,this,true);}
;}
,insertParagraphOnLinebreak:function(){return this.__Eb.insertParagraphOnLinebreak();}
,execute:function(bq,br){var bs;bq=bq.toLowerCase();if(this._commands[bq]){if(this._commands[bq].passthrough){bs=this.__Eb.execute(bq,br);}
else {bs=this[bq].call(this);}
;}
else {if((qx.core.Environment.get(y)==W)||(qx.core.Environment.get(y)==N)){this.__Gn(bq,br,this.__Eb.getCommandObject(bq));bs=this.__Eb.execute(bq,br);if(!bs){this.__FL.pop();}
;}
else {bs=this.__Eb.execute(bq,br);if(bs){this.__Gn(bq,br,this.__Eb.getCommandObject(bq));}
;}
;if(bq==n&&this.__FL.length==0){this.__FT=false;this.__Gv();}
else if(bq==u&&this.__FM.length==0){this.__FS=false;this.__Gv();}
;}
;this.__FU=false;return bs;}
,addUndoStep:function(bt,bu,bv){this.__Gn(bt,bu,bv);}
,registerHandler:function(bw,bx,by,bz){this.__FN[bw]={undo:bx,redo:by,context:bz};}
,isUndoPossible:function(){return this.__FT;}
,undo:function(){var bC;if(this.__FU){this.__Gp();}
;if(this.__FL.length>0){var bB=this.__FL.pop();if(this.__FO[bB.actionType.toLowerCase()]){switch(bB.actionType){case a:bC=this.__FX(bB);break;case U:bC=this.__Gc(bB);break;case K:bC=this.__Gb(bB);break;case R:bC=this.__FW(bB);break;};}
else if(this.__FN[bB.actionType]){var bA=this.__FN[bB.actionType];bC=bA.undo.call(bA.context?bA.context:this,bB);this.__Gr(bB);}
else {this.error(bb+bB.actionType+F);}
;this.__FS=true;this.__Gv();return bC;}
;}
,__FW:qx.core.Environment.select("engine.name",{"mshtml|webkit":function(bD){var bE=this.__oc.body.innerHTML;var bG=bD.content;this.__oc.body.innerHTML=bG;var bF=bD;bF.content=bE;this.__Gr(bF);return true;}
,"default":function(bH){var bL=bH;var bK=qx.bom.element.Style;switch(bH.command){case "backgroundcolor":bL.parameter=[bK.get(this.__oc.body,"backgroundColor")];break;case "backgroundimage":bL.parameter=[bK.get(this.__oc.body,"backgroundImage"),bK.get(this.__oc.body,"backgroundRepeat"),bK.get(this.__oc.body,"backgroundPosition")];break;};this.__Gr(bL);if(bH.command=="inserthyperlink"){if((qx.core.Environment.get("engine.name")=="gecko")){var bJ="qx_link"+this.__Eb.__hyperLinkId;var bI=this.__oc.getElementById(bJ);if(bI){bI.parentNode.removeChild(bI);return true;}
else {return false;}
;}
;}
else {return this.__Eb.execute(bH.command,bH.value);}
;}
}),__FX:qx.core.Environment.select("engine.name",{"mshtml|webkit":function(bM){}
,"default":function(bN){this.__Gr(bN);if((qx.core.Environment.get("engine.name")=="gecko")){if(bN.command=="inserthtml"&&bN.value==qx.bom.htmlarea.HtmlArea.EMPTY_DIV&&this.__FY("inserthtml","insertParagraph")){this.__Ga();}
;}
;return this.__Gd();}
}),__FY:function(bO,bP){if(this.__FL.length>0){var bQ=this.__FL[this.__FL.length-1];return (bQ.command==bO&&bQ.value==bP);}
;return false;}
,__Ga:function(){this.__Gd();if(this.__FL.length>0){var bR=this.__FL.pop();this.__Gr(bR);}
;}
,__Gb:function(bS){this.__Gr(bS);return this.__Gd();}
,__Gc:qx.core.Environment.select(y,{"gecko":function(bT){this.__Gr(bT);try{return this.__Gd();}
catch(bU){if(qx.core.Environment.get(O)){this.error(I+bU);}
;}
;}
,"mshtml|webkit":function(bV){}
,"default":function(bW){this.__Gr(bW);return this.__Gd();}
}),__Gd:function(){try{return this.__oc.execCommand(bl,false,null);}
catch(e){return false;}
;}
,isRedoPossible:function(){return this.__FS;}
,redo:function(){if(this.__FS){var bY;if(this.__FM.length>0){var ca=this.__FM.pop();if(this.__FO[ca.actionType.toLowerCase()]){switch(ca.actionType){case a:bY=this.__Gf(ca);break;case U:bY=this.__Gl(ca);break;case K:bY=this.__Gk(ca);break;case R:bY=this.__Ge(ca);break;};}
else if(this.__FN[ca.actionType]){var bX=this.__FN[ca.actionType];bY=bX.redo.call(bX.context?bX.context:this,ca);this.__Gq(ca);}
else {this.error(bb+ca.actionType+F);}
;this.__FT=true;this.__Gv();}
;return bY;}
;}
,__Ge:qx.core.Environment.select(y,{"mshtml|webkit":function(cb){var cc=this.__oc.body.innerHTML;var ce=cb.content;this.__oc.body.innerHTML=ce;var cd=cb;cd.content=cc;this.__Gq(cd);return true;}
,"default":function(cf){this.__Gq(cf);return this.__Gm();}
}),__Gf:qx.core.Environment.select(y,{"mshtml|webkit":function(cg){}
,"default":function(ch){this.__Gq(ch);var ci=this.__Gm();if((qx.core.Environment.get(y)==P)){if(this.__Gg(D,qx.bom.htmlarea.HtmlArea.EMPTY_DIV)){var cj=this.__Gh();this.__Gi();if(cj!=null){this.__Gj(cj);}
;}
;}
;return ci;}
}),__Gg:function(ck,cl){if(this.__FM.length>0){var cm=this.__FM[this.__FM.length-1];return (cm.command==ck&&cm.value==cl);}
;return false;}
,__Gh:function(){if(this.__EU==null){return null;}
;var cn=this.__EU.getSelection();var co=cn?cn.focusNode:null;if(co==null){return null;}
;try{while(co.nodeName.toLowerCase()!=S){co=co.parentNode;if(!co||qx.dom.Node.isNodeName(co,bc)){return null;}
;}
;}
catch(cp){return null;}
;if(co!=null&&qx.dom.Node.isNodeName(co,S)){return co;}
else {return null;}
;}
,__Gi:function(){var cq=this.__FM.pop();this.__Gq(cq);this.__Gm();}
,__Gj:qx.core.Environment.select(y,{"gecko":function(cr){if(cr==this.__EU.getContentBody().lastChild){return;}
;var cu=cr.firstChild;while(cu.firstChild){cu=cu.firstChild;}
;var cs=this.__EU.getSelection();var ct=this.__EU.getRange();if(cs&&ct){ct.selectNode(cu);cs.addRange(ct);ct.collapse(true);}
;}
,"default":qx.lang.Function.empty}),__Gk:function(cv){this.__Gq(cv);return this.__Gm();}
,__Gl:qx.core.Environment.select(y,{"mshtml|webkit":function(cw){}
,"default":function(cx){this.__Gq(cx);return this.__Gm();}
}),__Gm:function(){try{return this.__oc.execCommand(r,false,null);}
catch(e){return false;}
;}
,__Fc:function(){this._commands={undo:{passthrough:false},redo:{passthrough:false}};this.__Eb.getCommandObject(B).customUndo=true;this.__Eb.getCommandObject(E).customUndo=true;if((qx.core.Environment.get(y)==P)){}
;}
,__Gn:qx.core.Environment.select(y,{"mshtml|webkit":function(cy,cz,cA){var cB=this.getUndoRedoObject();cB.commandObject=cA;cB.command=cy;cB.value=cz;cB.actionType=R;cB.content=this.__oc.body.innerHTML;this.__Go(cB);}
,"default":function(cC,cD,cE){if(this.__EU==null){return;}
;var cG=this.getUndoRedoObject();cG.commandObject=cE;cG.command=cC;cG.value=cD;cG.actionType=R;var cF=this.__EU.getSelection();if(cE.customUndo){var cH=[];switch(cC){case B:cH.push(qx.bom.element.Style.get(this.__oc.body,m));break;case E:cH.push(qx.bom.element.Style.get(this.__oc.body,bi),qx.bom.element.Style.get(this.__oc.body,bh),qx.bom.element.Style.get(this.__oc.body,be));break;case p:if(cF&&!cF.isCollapsed){cG.actionType=a;}
;break;};cG.parameter=cH;}
else {if((qx.core.Environment.get(y)==P)){if(cF&&cF.isCollapsed){switch(cC){case f:case b:case bd:case D:case Q:cG.actionType=a;break;default:return;};}
else {cG.actionType=a;}
;}
else {cG.actionType=a;}
;}
;this.__Go(cG);}
}),__Go:function(cI){if(this.__FU){this.__Gp();}
;this.__Gq(cI);this.__FS=false;this.__FM=[];this.__Gv();}
,__Gp:function(){var cJ=this.__FL[this.__FL.length-1];if(cJ==null||cJ.actionType!=U){var cK=this.getUndoRedoObject();cK.actionType=U;if((qx.core.Environment.get(y)==W)||(qx.core.Environment.get(y)==N)){cK.content=this.__FV;cK.actionType=R;this.__FV=null;}
;this.__Gq(cK);this.__FU=false;}
;}
...
,__Gq:function(cL){if((qx.core.Environment.get(O))&&qx.core.Environment.get(x)){this.debug(bj);this.debug(cL.actionType+T+cL.command+T+cL.value);}
;this.__FL.push(cL);}
,__Gr:function(cM){if((qx.core.Environment.get(O))&&qx.core.Environment.get(x)){this.debug(G);this.debug(cM.actionType+T+cM.command+T+cM.value);}
;this.__FM.push(cM);}
,_handleKeyPress:function(e){var cN=e.getKeyIdentifier().toLowerCase();var cO=e.isCtrlPressed();switch(cN){case d:case h:case t:case z:case C:case V:case l:case bk:case k:case g:case A:break;case bg:case c:case q:case o:case v:case bf:case L:if(!cO){this.__Gs();}
;break;default:this.__FS=false;this.__FM=[];this.__Gs();};}
,__Gs:function(){if(!this.__FU){this.__FU=true;this.__FT=true;if((qx.core.Environment.get(y)==W)||(qx.core.Environment.get(y)==N)){this.__FV=this.__oc.body.innerHTML;}
;this.__Gv();}
;}
,__Gt:null,_handleMouseDown:qx.core.Environment.select(y,{"mshtml":function(e){var cP=e.getOriginalTarget();if(qx.dom.Node.isElement(cP)&&(qx.dom.Node.isNodeName(cP,M)||qx.dom.Node.isNodeName(cP,H))){this.__Gt={node:cP,content:cP.outerHTML};}
else {this.__Gt=null;}
;}
,"default":function(e){return true;}
}),_handleMouseUp:qx.core.Environment.select(y,{"gecko":function(e){if(this.__EU==null){return;}
;var cR=this.__EU.getSelection();if(!cR){this.__Gt=null;return;}
;var cQ=cR.anchorNode;var cS=cQ.childNodes[cR.anchorOffset];if(qx.dom.Node.isNodeName(cS,M)){if(this.__Gt==null){this.__Gt=cS.cloneNode(true);}
else {if(this.__Gt.style.width!=cS.style.width||this.__Gt.style.height!=cS.style.height){this.__Gu();this.__Gt=cS.cloneNode(true);}
;}
;}
else if(qx.dom.Node.isNodeName(cQ,J)||qx.dom.Node.isNodeName(cQ.parentNode,J)){var cT=cQ.parentNode;while(qx.dom.Node.isNodeName(cT,H)){cT=cT.parentNode;}
;if(this.__Gt==null){this.__Gt=cT.cloneNode(true);}
else {qx.event.Timer.once(function(){if(cT.style.width!=this.__Gt.style.width||cT.style.height!=this.__Gt.style.height||cT.innerHTML!=this.__Gt.innerHTML){this.__Gu();this.__Gt=cT.cloneNode(true);}
;}
,this,0);}
;}
else {this.__Gt=null;}
;}
,"default":function(e){var cU=qx.bom.Event.getTarget(e);if(this.__Gt!=null){if(cU.nodeType==1){if(cU==this.__Gt.node){if(cU.outerHTML!=this.__Gt.content){this.__Gt.content=cU.outerHTML;this.__Gu();}
;}
else {for(var i=0,j=cU.childNodes.length;i<j;i++){if(cU.childNodes[i]==this.__Gt.node){if(cU.childNodes[i].outerHTML!=this.__Gt.content){this.__Gt.content=cU.childNodes[i].outerHTML;this.__Gu();}
;}
;}
;}
;}
...
;}
;}
}),__Gu:qx.core.Environment.select(y,{"mshtml|webkit":function(){this.__Gn(K,null,null);}
,"default":function(){var cV=this.getUndoRedoObject();cV.actionType=K;this.__Gq(cV);}
}),__Gv:function(){qx.event.Timer.once(function(e){if(this.__EU!=null){var cW={undo:this.isUndoPossible()?0:-1,redo:this.isRedoPossible()?0:-1};this.__EU.fireDataEvent(Y,cW);}
;}
,this,200);}
},destruct:function(){try{qx.event.Registration.removeListener(this.__oc.body,w,this.__FP);qx.event.Registration.removeListener(this.__oc,X,this.__FQ);if((qx.core.Environment.get(y)==W)){qx.event.Registration.removeListener(this.__oc,ba,this.__FR);}
;}
catch(e){}
;this._disposeObjects(bm);this.__EU=this.__FL=this.__FM=this._commands=this.__oc=null;this.__FO=this.__FN=null;}
});}
)();
