...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Dock_Margin","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Dock_Margin-qx.theme.Classic.bb6e65020e91.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="x",o="demobrowser.demo.layout.Dock_Margin",n="y",m="east",l="yellow",k="center",j="red",i="bottom",h="north",g="south",c="west",f="green",e="fuchsia",b="orange",a="blue",d="main";qx.Class.define(o,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var r=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(r);var q=new qx.ui.container.Composite(new qx.ui.layout.Dock(3,10)).set({decorator:d,backgroundColor:l,allowGrowX:false});var x=new qx.ui.core.Widget().set({decorator:d,backgroundColor:j});var w=new qx.ui.core.Widget().set({decorator:d,backgroundColor:a,marginLeft:20});var v=new qx.ui.core.Widget().set({decorator:d,backgroundColor:b,marginTop:20});var u=new qx.ui.core.Widget().set({decorator:d,backgroundColor:f,maxHeight:20,alignY:i});var t=new qx.ui.core.Widget().set({decorator:d,backgroundColor:e});q.add(x,{edge:h});q.add(w,{edge:c});q.add(v,{edge:g});q.add(u,{edge:m});q.add(t,{edge:k});r.add(q);var s=new qx.ui.layout.Dock(3,10);s.setSort(n);var q=(new qx.ui.container.Composite(s)).set({decorator:d,backgroundColor:l,allowGrowX:false});var x=new qx.ui.core.Widget().set({decorator:d,backgroundColor:j});var w=new qx.ui.core.Widget().set({decorator:d,backgroundColor:a,marginLeft:20});var v=new qx.ui.core.Widget().set({decorator:d,backgroundColor:b,marginTop:20});var u=new qx.ui.core.Widget().set({decorator:d,backgroundColor:f,maxHeight:20,alignY:i});var t=new qx.ui.core.Widget().set({decorator:d,backgroundColor:e});q.add(x,{edge:h});q.add(w,{edge:c});q.add(v,{edge:g});q.add(u,{edge:m});q.add(t,{edge:k});r.add(q);var s=new qx.ui.layout.Dock(3,10);s.setSort(p);var q=(new qx.ui.container.Composite(s)).set({decorator:d,backgroundColor:l,allowGrowX:false});var x=new qx.ui.core.Widget().set({decorator:d,backgroundColor:j});var w=new qx.ui.core.Widget().set({decorator:d,backgroundColor:a,marginLeft:20});var v=new qx.ui.core.Widget().set({decorator:d,backgroundColor:b,marginTop:20});var u=new qx.ui.core.Widget().set({decorator:d,backgroundColor:f,maxHeight:20,alignY:i});var t=new qx.ui.core.Widget().set({decorator:d,backgroundColor:e});q.add(x,{edge:h});q.add(w,{edge:c});q.add(v,{edge:g});q.add(u,{edge:m});q.add(t,{edge:k});r.add(q);}
}});}
)();
