...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Label","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Label-qx.theme.Indigo.2b8ba67dea4f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var q="Preferred Label2 Size (HeightForWidth): ",p="Preferred Label2 Size: ",o="foo bar",n="hello <b>world</b>",m="foo <i>bar</i>",l="Runtime to measure 500 html blocks: ",k="hello world",j="demobrowser.demo.bom.Label",h="Preferred Label1 Size: ",g="Runtime to measure 500 text blocks: ",c="80px",f="ms",e="Quite a long label text",b="1px solid red",a="This is <b>bold</b> text",d="x";qx.Class.define(j,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var s=qx.bom.Label.create(e);s.style.border=b;s.style.width=c;document.body.appendChild(s);var u=qx.bom.Label.getTextSize(e);this.debug(h+u.width+d+u.height);var t=qx.bom.Label.create(a,true);t.style.border=b;t.style.width=c;document.body.appendChild(t);var u=qx.bom.Label.getHtmlSize(a);this.debug(p+u.width+d+u.height);var u=qx.bom.Label.getHtmlSize(a,null,80);this.debug(q+u.width+d+u.height);var z=k;var v=o;var x=qx.bom.Label;var y=new Date;for(var i=0;i<500;i++){x.getTextSize(i%2?z:v);}
;var stop=new Date;this.debug(g+(stop-y)+f);var r=n;var w=m;var x=qx.bom.Label;var y=new Date;for(var i=0;i<500;i++){x.getHtmlSize(i%2?r:w);}
;var stop=new Date;this.debug(l+(stop-y)+f);}
}});}
)();
