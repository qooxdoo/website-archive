...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline-qx.theme.Modern.b47eac62ddb9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{model:{nullable:true,event:c,apply:a}},members:{_storage:null,__dk:null,_applyModel:function(j,k){if(k){k.removeListenerById(this.__dk);k.dispose();this.__dk=null;}
;if(j){this.__dk=j.addListener(b,this.__dl,this);this.__dl();}
else {this._storage.removeItem(this._key);}
;}
,__dl:function(){var l=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,l);}
