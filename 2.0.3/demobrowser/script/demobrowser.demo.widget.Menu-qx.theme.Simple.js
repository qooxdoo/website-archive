...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Menu","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu-qx.theme.Simple.ec7ae32a64c4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var cn="Online Forum",cm="icon/16/actions/format-justify-fill.png",cl="Search in files",ck="C",cj="__QM",ci="Left aligned",ch="Perl",cg="View",cf="C Dialect",ce="Info...",bu="Save as...",bt="Show line numbers",bs="Quickstart",br="icon/16/actions/contact-new.png",bq="Ctrl+N",bp="Actions",bo="Show console",bn="Search",bm="Help",bl="Show status bar",cu="icon/16/actions/format-justify-left.png",cv="ANSI to OEM",cs="Centered",ct="Website 3",cq="Edit",cr="icon/16/actions/format-justify-center.png",co="Ctrl+O",cp="icon/16/actions/go-previous.png",cw="C Sharp",cx="Close",bS="Split Button",bR="Website 2",bU="icon/16/actions/document-save-as.png",bT="Python",bW="icon/16/apps/utilities-help.png",bV="Show tree",bY="Options",bX="Spaces to tabs",bQ="Right aligned",bP="Action 1",a="OEM to ANSI",b="Line 431",c="JavaScript",d="icon",f="Action 2",g="Folder ",h="XML",j="Line 313",k="Paragraph",l="demobrowser.demo.widget.Menu",cB="icon/16/actions/application-exit.png",cA="C Plus Plus",cz="Line 26",cy="Item ",cF="ASCII table",cE="Option 1",cD="Search next...",cC="Line 12",cH="Action 3",cG="Replace in files",K="Uppercase",L="Ctrl+P",I="Topics",J="Panes",O="Justified",P="Ctrl+X",M="__QN",N="__Gf",G="__QQ",H="Search previous...",t="Change selection: ",s="Back",v="main",u=" = ",p="Execute command: ",o="Show ruler",r="icon/16/actions/format-justify-right.png",q="__QP",n="icon/16/actions/go-next.png",m="Ctrl+Z",U="command ",V="Option 3",W="Next",X="Ctrl+R",Q="Show macros",R="Show tags",S="Capitals",T="__QO",Y="Execute button: ",ba="Format",D="File",C="Change checked: ",B="__FX",A="Show tabs",z="Tabs to spaces",y="Search...",x="Line 1039",w="Option 2",F="Objective C",E="Exit",bb="move to",bc="Ctrl+S",bd="Syntax",be="__QL",bf="Ctrl+C",bg="Website 1",bh="Menu Button",bi="Line 30",bj="Lowercase",bk="Replace",by="HTML",bx="New",bw="Undo",bv="icon/16/actions/document-save.png",bC="Redo",bB="icon/22/apps/preferences-users.png",bA="icon/16/actions/document-print.png",bz="icon/16/actions/document-open.png",bE="icon/16/actions/edit-undo.png",bD="Save",bL="icon/16/actions/edit-redo.png",bM="Print",bJ="Open",bK="icon/16/actions/document-new.png",bH="icon/16/actions/edit-cut.png",bI="changeSelection",bF="icon/16/actions/edit-paste.png",bG="Copy",bN="Paste",bO="icon/16/actions/edit-copy.png",cb="Cut",ca="icon/16/actions/system-search.png",cd="changeValue",cc="execute";qx.Class.define(l,{extend:qx.application.Standalone,members:{__QL:null,__QM:null,__QN:null,__FX:null,__Gf:null,__QO:null,__QP:null,__QQ:null,main:function(){qx.application.Standalone.prototype.main.call(this);var cJ=new qx.ui.container.Scroll();var cI=new qx.ui.container.Composite(new qx.ui.layout.Canvas);cI.setPadding(20);cI.setAllowStretchX(false);cJ.add(cI);this.getRoot().add(cJ,{edge:0});this.createCommands();cI.add(this.getMenuButton(),{left:20,top:20});cI.add(this.getSplitButton(),{left:150,top:20});cI.add(this.getMenuBar(),{left:20,top:100});cI.add(this.getList(),{left:20,top:200});this.getRoot().setContextMenu(this.getRootContextMenu());}
,getRootContextMenu:function(){var cK=new qx.ui.menu.Menu();var cL=new qx.ui.menu.Menu();for(var i=0;i<30;i++){cL.add(new qx.ui.menu.Button(g+(i+1)));}
;cK.add(new qx.ui.menu.Button(bb,null,null,cL));cK.add(new qx.ui.menu.Separator());for(var i=0;i<7;i++){cK.add(new qx.ui.menu.Button(U+(i+1)));}
;return cK;}
,debugRadio:function(e){this.debug(t+e.getData()[0].getLabel());}
,debugCommand:function(e){this.debug(p+this.getShortcut());}
,debugButton:function(e){this.debug(Y+this.getLabel());}
,debugCheckBox:function(e){this.debug(C+this.getLabel()+u+e.getData());}
,createCommands:function(){this.__QL=new qx.ui.core.Command(bq);this.__QL.addListener(cc,this.debugCommand);this.__QM=new qx.ui.core.Command(co);this.__QM.addListener(cc,this.debugCommand);this.__QN=new qx.ui.core.Command(bc);this.__QN.addListener(cc,this.debugCommand);this.__FX=new qx.ui.core.Command(m);this.__FX.addListener(cc,this.debugCommand);this.__Gf=new qx.ui.core.Command(X);this.__Gf.addListener(cc,this.debugCommand);this.__QO=new qx.ui.core.Command(P);this.__QO.addListener(cc,this.debugCommand);this.__QP=new qx.ui.core.Command(bf);this.__QP.addListener(cc,this.debugCommand);this.__QQ=new qx.ui.core.Command(L);this.__QQ.addListener(cc,this.debugCommand);this.__QQ.setEnabled(false);}
,getMenuButton:function(){var cM=new qx.ui.menu.Menu;cM.add(new qx.ui.menu.RadioButton(cE));cM.add(new qx.ui.menu.RadioButton(w));cM.add(new qx.ui.menu.RadioButton(V));var cU=new qx.ui.menu.Menu;cU.add(new qx.ui.menu.RadioButton(bP));cU.add(new qx.ui.menu.RadioButton(f));cU.add(new qx.ui.menu.RadioButton(cH));var cT=new qx.ui.form.RadioGroup;cT.add.apply(cT,cM.getChildren());cT.addListener(bI,this.debugRadio);var cR=new qx.ui.form.RadioGroup;cR.add.apply(cR,cU.getChildren());cR.addListener(bI,this.debugRadio);var cP=new qx.ui.menu.Menu();var cS=new qx.ui.menu.Button(bw,bE,this.__FX);var da=new qx.ui.menu.Button(bC,bL,this.__Gf);var cO=new qx.ui.menu.Button(cb,bH,this.__QO);var cW=new qx.ui.menu.Button(bG,bO,this.__QP);var cQ=new qx.ui.menu.Button(bN,bF,this.__QQ);var cN=new qx.ui.menu.Button(bY,ca,null,cM);var cX=new qx.ui.menu.Button(bp,br,null,cU);var cV=new qx.ui.menu.Button(bM,bA);cS.addListener(cc,this.debugButton);da.addListener(cc,this.debugButton);cO.addListener(cc,this.debugButton);cW.addListener(cc,this.debugButton);cQ.addListener(cc,this.debugButton);cN.addListener(cc,this.debugButton);cX.addListener(cc,this.debugButton);cV.addListener(cc,this.debugButton);cP.add(cS);cP.add(da);cP.addSeparator();cP.add(cO);cP.add(cW);cP.add(cQ);cP.addSeparator();cP.add(cN);cP.add(cX);cP.addSeparator();cP.add(cV);var cY=new qx.ui.form.MenuButton(bh,bB,cP);return cY;}
...
,getMenuBar:function(){var dk=new qx.ui.container.Composite(new qx.ui.layout.Grow);dk.setDecorator(v);var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setWidth(600);dk.add(toolbar);var du=new qx.ui.toolbar.Part;var dj=new qx.ui.toolbar.Part;var dn=new qx.ui.toolbar.Part;toolbar.add(du);toolbar.add(dj);toolbar.addSpacer();toolbar.add(dn);var dt=new qx.ui.toolbar.SplitButton(s,cp,this.getBackMenu());var dq=new qx.ui.toolbar.SplitButton(W,n,this.getForwardMenu());var di=new qx.ui.toolbar.Button(bx,bK,this.__QL);var dm=new qx.ui.toolbar.Button(bJ,bz,this.__QM);var ds=new qx.ui.toolbar.Button(bD,bv,this.__QN);dt.addListener(cc,this.debugButton);dq.addListener(cc,this.debugButton);di.addListener(cc,this.debugButton);dm.addListener(cc,this.debugButton);ds.addListener(cc,this.debugButton);du.add(dt);du.add(dq);du.addSeparator();du.add(di);du.add(dm);du.add(ds);du.setShow(d);var dl=new qx.ui.toolbar.MenuButton(D);var dh=new qx.ui.toolbar.MenuButton(cq);var dg=new qx.ui.toolbar.MenuButton(bn);var dv=new qx.ui.toolbar.MenuButton(cg);var dr=new qx.ui.toolbar.MenuButton(ba);dl.setMenu(this.getFileMenu());dh.setMenu(this.getEditMenu());dg.setMenu(this.getSearchMenu());dv.setMenu(this.getViewMenu());dr.setMenu(this.getFormatMenu());dj.add(dl);dj.add(dh);dj.add(dg);dj.add(dv);dj.add(dr);var dp=new qx.ui.toolbar.MenuButton(bm);dp.setMenu(this.getHelpMenu());dn.add(dp);return dk;}
,getBackMenu:function(){var dx=new qx.ui.menu.Menu;var dy=new qx.ui.menu.Button(j);var dA=new qx.ui.menu.Button(x);var dw=new qx.ui.menu.Button(cC);var dz=new qx.ui.menu.Button(cz);dy.addListener(cc,this.debugButton);dA.addListener(cc,this.debugButton);dw.addListener(cc,this.debugButton);dz.addListener(cc,this.debugButton);dx.add(dy);dx.add(dA);dx.add(dw);dx.add(dz);return dx;}
...
,getFileMenu:function(){var dG=new qx.ui.menu.Menu;var dE=new qx.ui.menu.Button(bx,bK,this.__QL);var dI=new qx.ui.menu.Button(bJ,bz,this.__QM);var dH=new qx.ui.menu.Button(cx);var dL=new qx.ui.menu.Button(bD,bv,this.__QN);var dK=new qx.ui.menu.Button(bu,bU);var dJ=new qx.ui.menu.Button(bM,bA);var dF=new qx.ui.menu.Button(E,cB);dE.addListener(cc,this.debugButton);dI.addListener(cc,this.debugButton);dH.addListener(cc,this.debugButton);dL.addListener(cc,this.debugButton);dK.addListener(cc,this.debugButton);dJ.addListener(cc,this.debugButton);dF.addListener(cc,this.debugButton);dG.add(dE);dG.add(dI);dG.add(dH);dG.add(dL);dG.add(dK);dG.add(dJ);dG.add(dF);return dG;}
,getEditMenu:function(){var dN=new qx.ui.menu.Menu;var dQ=new qx.ui.menu.Button(bw,bE,this.__FX);var dP=new qx.ui.menu.Button(bC,bL,this.__Gf);var dM=new qx.ui.menu.Button(cb,bH,this.__QO);var dR=new qx.ui.menu.Button(bG,bO,this.__QP);var dO=new qx.ui.menu.Button(bN,bF,this.__QQ);dQ.addListener(cc,this.debugButton);dP.addListener(cc,this.debugButton);dM.addListener(cc,this.debugButton);dR.addListener(cc,this.debugButton);dO.addListener(cc,this.debugButton);dN.add(dQ);dN.add(dP);dN.addSeparator();dN.add(dM);dN.add(dR);dN.add(dO);return dN;}
,getSearchMenu:function(){var dV=new qx.ui.menu.Menu;var dT=new qx.ui.menu.Button(y,ca);var dY=new qx.ui.menu.Button(cD);var dU=new qx.ui.menu.Button(H);var dX=new qx.ui.menu.Button(bk);var dS=new qx.ui.menu.Button(cl,ca);var dW=new qx.ui.menu.Button(cG);dU.setEnabled(false);dT.addListener(cc,this.debugButton);dY.addListener(cc,this.debugButton);dU.addListener(cc,this.debugButton);dX.addListener(cc,this.debugButton);dS.addListener(cc,this.debugButton);dW.addListener(cc,this.debugButton);dV.add(dT);dV.add(dY);dV.add(dU);dV.add(dX);dV.addSeparator();dV.add(dS);dV.add(dW);return dV;}
,getViewMenu:function(){var ea=new qx.ui.menu.Menu;var ec=new qx.ui.menu.Button(J,null,null,this.getPanesMenu());var ef=new qx.ui.menu.Button(bd,null,null,this.getSyntaxMenu());var ee=new qx.ui.menu.CheckBox(o);var ed=new qx.ui.menu.CheckBox(bt);var eb=new qx.ui.menu.Button(cF);ee.addListener(cd,this.debugCheckBox);ed.addListener(cd,this.debugCheckBox);eb.addListener(cc,this.debugButton);ea.add(ec);ea.add(ef);ea.addSeparator();ea.add(ee);ea.add(ed);ea.addSeparator();ea.add(eb);return ea;}
,getPanesMenu:function(){var eh=new qx.ui.menu.Menu;var ej=new qx.ui.menu.CheckBox(A);var el=new qx.ui.menu.CheckBox(bl);var em=new qx.ui.menu.CheckBox(bV);var ei=new qx.ui.menu.CheckBox(Q);var ek=new qx.ui.menu.CheckBox(R);var eg=new qx.ui.menu.CheckBox(bo);ej.setValue(true);el.setValue(true);ei.setValue(true);ej.addListener(cd,this.debugCheckBox);el.addListener(cd,this.debugCheckBox);em.addListener(cd,this.debugCheckBox);ei.addListener(cd,this.debugCheckBox);ek.addListener(cd,this.debugCheckBox);eg.addListener(cd,this.debugCheckBox);eh.add(el);eh.add(ej);eh.addSeparator();eh.add(em);eh.add(ei);eh.add(ek);eh.add(eg);return eh;}
,getSyntaxMenu:function(){var er=new qx.ui.menu.Menu;var en=new qx.ui.menu.RadioButton(by);var ep=new qx.ui.menu.RadioButton(h);var eo=new qx.ui.menu.RadioButton(c);var eq=new qx.ui.menu.Button(cf,null,null,this.getSyntaxCMenu());var eu=new qx.ui.menu.RadioButton(ch);var es=new qx.ui.menu.RadioButton(bT);er.add(en);er.add(ep);er.add(eo);er.add(eq);er.add(eu);er.add(es);var et=new qx.ui.form.RadioGroup;et.add(en,ep,eo,eu,es);et.add.apply(et,eq.getMenu().getChildren());et.addListener(bI,this.debugRadio);return er;}
,getSyntaxCMenu:function(){var ew=new qx.ui.menu.Menu;var ev=new qx.ui.menu.RadioButton(ck);var ez=new qx.ui.menu.RadioButton(cw);var ey=new qx.ui.menu.RadioButton(F);var ex=new qx.ui.menu.RadioButton(cA);ew.add(ev);ew.add(ez);ew.add(ey);ew.add(ex);return ew;}
,getFormatMenu:function(){var eD=new qx.ui.menu.Menu;var eC=new qx.ui.menu.Button(k,null,null,this.getParagraphMenu());var eF=new qx.ui.menu.Button(z);var eG=new qx.ui.menu.Button(bX);var eB=new qx.ui.menu.Button(K);var eE=new qx.ui.menu.Button(bj);var eA=new qx.ui.menu.Button(S);var eI=new qx.ui.menu.Button(a);var eH=new qx.ui.menu.Button(cv);eF.addListener(cc,this.debugButton);eG.addListener(cc,this.debugButton);eB.addListener(cc,this.debugButton);eE.addListener(cc,this.debugButton);eA.addListener(cc,this.debugButton);eI.addListener(cc,this.debugButton);eH.addListener(cc,this.debugButton);eD.add(eC);eD.add(eF);eD.add(eG);eD.addSeparator();eD.add(eB);eD.add(eE);eD.add(eA);eD.addSeparator();eD.add(eI);eD.add(eH);return eD;}
,getParagraphMenu:function(){var eJ=new qx.ui.menu.Menu;var eM=new qx.ui.menu.Button(ci,cu);var eN=new qx.ui.menu.Button(bQ,r);var eK=new qx.ui.menu.Button(cs,cr);var eL=new qx.ui.menu.Button(O,cm);eM.addListener(cc,this.debugButton);eN.addListener(cc,this.debugButton);eK.addListener(cc,this.debugButton);eL.addListener(cc,this.debugButton);eJ.add(eM);eJ.add(eN);eJ.add(eK);eJ.add(eL);return eJ;}
,getHelpMenu:function(){var eO=new qx.ui.menu.Menu;var eQ=new qx.ui.menu.Button(I,bW);var eS=new qx.ui.menu.Button(bs);var eR=new qx.ui.menu.Button(cn);var eP=new qx.ui.menu.Button(ce);eQ.addListener(cc,this.debugButton);eS.addListener(cc,this.debugButton);eR.addListener(cc,this.debugButton);eP.addListener(cc,this.debugButton);eO.add(eQ);eO.add(eS);eO.addSeparator();eO.add(eR);eO.addSeparator();eO.add(eP);return eO;}
,getList:function(){var eT=new qx.ui.form.List;eT.setContextMenu(this.getContextMenu());for(var i=0;i<20;i++){eT.add(new qx.ui.form.ListItem(cy+i));}
;return eT;}
,getContextMenu:function(){var eU=new qx.ui.menu.Menu;var eW=new qx.ui.menu.Button(cb,bH,this.__QO);var eX=new qx.ui.menu.Button(bG,bO,this.__QP);var eV=new qx.ui.menu.Button(bN,bF,this.__QQ);eW.addListener(cc,this.debugButton);eX.addListener(cc,this.debugButton);eV.addListener(cc,this.debugButton);eU.add(eW);eU.add(eX);eU.add(eV);return eU;}
},destruct:function(){this._disposeObjects(be,cj,M,B,N,T,q,G);}
});}
)();
