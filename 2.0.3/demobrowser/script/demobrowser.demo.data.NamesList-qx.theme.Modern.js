...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.NamesList","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.NamesList-qx.theme.Modern.49e44bbd8c5a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="persons.json</a> and bind the items to the list widget. In the ",o="converter for the label, the names will be set to both, the first ",n="model.persons",m="Loading...",l="' target='_blank'>",k="demobrowser/demo/data/persons.json",j="model",i="no model...",h="state",g="and last name.",c="value",f="demobrowser.demo.data.NamesList",e="firstname",b="<b>List bound to data in a json file</b><br/>",a=", ",d="Loading the json file <a href='";qx.Class.define(f,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var s=new qx.ui.form.List();this.getRoot().add(s,{left:10,top:80});var t=new qx.data.controller.List(null,s);t.setLabelPath(e);t.setLabelOptions({converter:function(v,w){return w?w.getLastname()+a+v:i;}
});var r=qx.util.ResourceManager.getInstance().toUri(k);var u=new qx.data.store.Json(r);var status=new qx.ui.basic.Label(m);this.getRoot().add(status,{left:120,top:80});u.bind(n,t,j);u.bind(h,status,c);var q=new qx.ui.basic.Label();q.setRich(true);q.setWidth(470);q.setValue(b+d+r+l+p+o+g);this.getRoot().add(q,{left:10,top:10});}
}});}
)();
