...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Tokenizer-qx.theme.Indigo.666db345c5e4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="js",h="",g="demobrowser.demo.test.Tokenizer",f="input",e="btn",d="html",c="output",b="</pre>",a="<pre>";qx.Class.define(g,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var k=document.getElementById(f);var n=document.getElementById(c);document.getElementById(e).onclick=function(){var o=qx.dev.Tokenizer.tokenizeJavaScript(k.value);n.innerHTML=qx.bom.String.escape(qx.lang.Json.stringify(o,true));}
;var m=function(){var p=qx.dev.Tokenizer.tokenizeJavaScript(k.value);var q=[];for(var i=0;i<p.length;i++){q[i]=p[i].value;}
;n.innerHTML=a+qx.bom.String.escape(q.join(h))+b;}
;document.getElementById(j).onclick=m;var l=function(){n.innerHTML=a+qx.dev.Tokenizer.javaScriptToHtml(k.value)+b;}
;document.getElementById(d).onclick=l;l();}
}});}
)();
