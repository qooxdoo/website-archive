...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Columns-qx.theme.Classic.7de8f5ee3f39.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="source",o="changeLeadIcon",n="changeSize",m="changeMode",l="changeDate",k="changeChecked",j="icon/16/places/user-desktop.png",i="size",h="leadIcon",g="date",c="mode",f="demobrowser.demo.virtual.tree.TreeItem",e="Boolean",b="checked",a="String",d="value";qx.Class.define(f,{extend:qx.ui.tree.VirtualTreeItem,properties:{leadIcon:{check:a,event:o,nullable:true},checked:{check:e,event:k,nullable:true},size:{check:a,event:n,nullable:true},date:{check:a,event:l,nullable:true},mode:{check:a,event:m,nullable:true}},members:{__QD:null,__QE:null,__QF:null,__QG:null,__gX:null,_addWidgets:function(){var q=this.__QD=new qx.ui.basic.Image();this.bind(h,q,p);q.setWidth(16);this.addWidget(q);this.addSpacer();this.addOpenButton();this.addIcon();this.setIcon(j);var r=this.__QE=new qx.ui.form.CheckBox();this.bind(b,r,d);r.bind(d,this,b);r.setFocusable(false);r.setTriState(true);r.setMarginRight(4);this.addWidget(r);this.addLabel();this.addWidget(new qx.ui.core.Spacer(),{flex:1});var s=this.__QF=new qx.ui.basic.Label();this.bind(i,s,d);s.setWidth(50);this.addWidget(s);s=this.__QG=new qx.ui.basic.Label();this.bind(g,s,d);s.setWidth(150);this.addWidget(s);s=this.__gX=new qx.ui.basic.Label();this.bind(c,s,d);s.setWidth(80);this.addWidget(s);}
}});}
)();
