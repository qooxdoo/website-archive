...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Tree_Columns","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tree_Columns-qx.theme.Classic.f801c6f9a578.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="Windows (C:)",j="Documents (D:)",h="Family",g="TINC",f="Development",e="Inbox",d="Desktop",c="Announce",b="Personal",a="Products",S="-rw-r--r--",R="Presets",Q="Competition",P="Network",O="Questions",N="Sent",M="Spam",L="Files",K="icon/16/status/dialog-information.png",J="Bugs",r="Projects",s="Company",p="Devel",q="Workspace",n="Holiday",o="icon/16/places/user-trash.png",l="Chat",m=" 2005",t="Big",u="Press",B="Data",z="Internal",D="demobrowser.demo.widget.Tree_Columns",C="May ",F="Root",E="icon/16/places/user-desktop.png",w="kb",I="Pustefix",H="Relations",G="Lists",v="Item ",x="Edit",y="icon/16/devices/drive-harddisk.png",A="Trash";qx.Class.define(D,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var Y=new qx.ui.container.Scroll();var bj=new qx.ui.container.Composite(new qx.ui.layout.Basic());bj.setAllowGrowX(false);bj.setAllowStretchX(false);Y.add(bj);this.getRoot().add(Y,{edge:0});var bE=new qx.ui.tree.Tree().set({width:600,height:500});bj.add(bE,{left:20,top:48});var bF=this.configureTreeItem(new qx.ui.tree.TreeFolder(),F);bF.setOpen(true);bE.setRoot(bF);var bx=this.configureTreeItem(new qx.ui.tree.TreeFolder(),d);bF.add(bx);var ba=this.configureTreeItem(new qx.ui.tree.TreeFolder(),L);var W=this.configureTreeItem(new qx.ui.tree.TreeFolder(),q);var X=this.configureTreeItem(new qx.ui.tree.TreeFolder(),P);var V=this.configureTreeItem(new qx.ui.tree.TreeFolder(),A);bx.add(ba,W,X,V);var bD=this.configureTreeItem(new qx.ui.tree.TreeFile(),k,y);var bC=this.configureTreeItem(new qx.ui.tree.TreeFile(),j,y);W.add(bD,bC);var by=this.configureTreeItem(new qx.ui.tree.TreeFolder(),e);var bb=this.configureTreeItem(new qx.ui.tree.TreeFolder(),R);var be=this.configureTreeItem(new qx.ui.tree.TreeFolder(),N);var bd=this.configureTreeItem(new qx.ui.tree.TreeFolder(),A,o);var bg=this.configureTreeItem(new qx.ui.tree.TreeFolder(),B);var bf=this.configureTreeItem(new qx.ui.tree.TreeFolder(),x);var bt=this.configureTreeItem(new qx.ui.tree.TreeFolder(),l);var bs=this.configureTreeItem(new qx.ui.tree.TreeFolder(),I);var br=this.configureTreeItem(new qx.ui.tree.TreeFolder(),g);var bB=this.configureTreeItem(new qx.ui.tree.TreeFolder(),c);var bA=this.configureTreeItem(new qx.ui.tree.TreeFolder(),p);br.add(bB,bA);bf.add(bt,bs,br);var bi=this.configureTreeItem(new qx.ui.tree.TreeFolder(),G);var bo=this.configureTreeItem(new qx.ui.tree.TreeFolder(),H);var bp=this.configureTreeItem(new qx.ui.tree.TreeFolder(),s);var bq=this.configureTreeItem(new qx.ui.tree.TreeFolder(),O);var bk=this.configureTreeItem(new qx.ui.tree.TreeFolder(),z);var bl=this.configureTreeItem(new qx.ui.tree.TreeFolder(),a);var bm=this.configureTreeItem(new qx.ui.tree.TreeFolder(),u);var bn=this.configureTreeItem(new qx.ui.tree.TreeFolder(),f);var bu=this.configureTreeItem(new qx.ui.tree.TreeFolder(),Q);bi.add(bo,bp,bq,bk,bl,bm,bn,bu);var bh=this.configureTreeItem(new qx.ui.tree.TreeFolder(),b);var bv=this.configureTreeItem(new qx.ui.tree.TreeFolder(),J);var bz=this.configureTreeItem(new qx.ui.tree.TreeFolder(),h);var bw=this.configureTreeItem(new qx.ui.tree.TreeFolder(),r);var bc=this.configureTreeItem(new qx.ui.tree.TreeFolder(),n);bh.add(bv,bz,bw,bc);var U=this.configureTreeItem(new qx.ui.tree.TreeFolder(),t);for(var i=0;i<50;i++){U.add(this.configureTreeItem(new qx.ui.tree.TreeFolder(),v+i));}
;var T=this.configureTreeItem(new qx.ui.tree.TreeFolder(),M);by.add(bb,be,bd,bg,bf,bi,bh,U,T);bF.add(by);}
,configureTreeItem:function(bG,bH,bI){if(Math.floor(Math.random()*4)==0){var bL=new qx.ui.basic.Image(K);bG.addWidget(bL);}
else {bG.addWidget(new qx.ui.core.Spacer(16,16));}
;bG.addSpacer();if(bG instanceof qx.ui.tree.TreeFolder){bG.addOpenButton();}
;bG.addIcon();bG.setIcon(arguments.length>=3?bI:E);var bK=new qx.ui.form.CheckBox();bK.setFocusable(false);bG.addWidget(bK);bG.addLabel(bH);bG.addWidget(new qx.ui.core.Spacer(),{flex:1});var bJ=new qx.ui.basic.Label(Math.round(Math.random()*100)+w);bJ.setWidth(50);bG.addWidget(bJ);bJ=new qx.ui.basic.Label(C+Math.round(Math.random()*30+1)+m);bJ.setWidth(150);bG.addWidget(bJ);bJ=new qx.ui.basic.Label(S);bJ.setWidth(80);bG.addWidget(bJ);return bG;}
}});}
)();
