...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.io_ImageLoader","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.io_ImageLoader-qx.theme.Classic.03012c332a37.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h=")",g="http://resources.qooxdoo.org/images/logo.gif",f="img",e="x",d="demobrowser.demo.test.io_ImageLoader",c="Image loaded (",b="absolute",a="100px";qx.Class.define(d,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);qx.io.ImageLoader.load(g,function(i,j){qx.log.Logger.debug(c+j.width+e+j.height+h);var k=document.createElement(f);k.src=i;k.width=Math.round(j.width*1.5);k.height=Math.round(j.height*1.5);k.style.position=b;k.style.left=a;k.style.top=a;document.body.appendChild(k);}
);}
}});}
)();
