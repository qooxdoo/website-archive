...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.UIDeclaration-qx.theme.Classic.632ed21f50e4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,addFromDefinition:function(F){var G=this.getRoot();this.__om(G,F);}
,__om:function(H,I){var J=new I.clazz();var N=qx.lang.Object.clone(I);delete N.clazz;delete N.layout;delete N.children;delete N.id;delete N.listeners;J.set(N);if(I.id!=null){this[I.id]=J;}
;if(I.layout!=null){var K=new I.layout.clazz();var N=qx.lang.Object.clone(I.layout);delete N.clazz;K.set(N);J.setLayout(K);}
;var M=I.children;if(M!=null){for(var i=0;i<M.length;i++){if(J instanceof qx.ui.form.Form){this.__Qh(J,M[i]);}
else {this.__om(J,M[i]);}
;}
;}
...
;}
;}
,__Qh:function(O,P){if(P.type===q){O.addGroupHeader(P.label);return;}
