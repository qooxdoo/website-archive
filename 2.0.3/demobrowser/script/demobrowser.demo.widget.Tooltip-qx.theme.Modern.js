...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Tooltip","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip-qx.theme.Modern.89cfc69b4ef7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="Button #2 (Shared ToolTip)",j="Short timeout ToolTip",i="demobrowser.demo.widget.Tooltip",h="Hello World #3",g="Button with ToolTipText and ToolTipIcon",f="ToolTip with icon and label",d="Shared tool tip of button #",c="ToolTip with icon and rich text",b="Such a great tooltip with a (show) timeout of 50ms.",a="Icon only ToolTip",y="Button #1 (Shared ToolTip)",x="container",w="This also may contain <b style='color:red'>rich HTML</b> markup ",v="appear",u="2",t="Shared ToolTip",s="1",r="Button with ToolTipText",q="A long label text with auto-wrapping. ",p="Button with ToolTipIcon",n="and with a (show) timeout of 50ms.",o="Tooltip text",l="icon/32/actions/help-about.png",m="icon/16/actions/help-about.png";qx.Class.define(i,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var A=new qx.ui.container.Scroll();this.getRoot().add(A,{edge:0});var z=new qx.ui.layout.Grid(10,10);this.container=new qx.ui.container.Composite(z).set({padding:20});A.add(this.container);this.createSharedToolTip();this.createIconToolTip();this.createToolTip();this.createShortTimeoutToolTip();this.createRichToolTip();this.createToolTipText();this.createToolTipIcon();this.createToolTipTextIcon();}
,__QS:4,__QT:0,add:function(B){this.container.add(B,{row:Math.floor(this.__QT/this.__QS),column:this.__QT%this.__QS});this.__QT+=1;}
,createSharedToolTip:function(){var E=new qx.ui.tooltip.ToolTip(t);E.addListener(v,function(e){var F=d;if(this.getOpener()==D){F+=s;}
else {F+=u;}
;E.setLabel(F);}
);var D=new qx.ui.form.Button(y);D.setToolTip(E);this.add(D);var C=new qx.ui.form.Button(k);C.setToolTip(E);this.add(C);}
,createIconToolTip:function(){var G=new qx.ui.form.Button(a).set({toolTip:new qx.ui.tooltip.ToolTip(null,m)});this.add(G);}
,createToolTip:function(){var H=new qx.ui.form.Button(f).set({toolTip:new qx.ui.tooltip.ToolTip(h,m)});this.add(H);}
,createShortTimeoutToolTip:function(){var J=new qx.ui.tooltip.ToolTip(b,l);J.setShowTimeout(50);var I=new qx.ui.form.Button(j);this.add(I);I.setToolTip(J);}
,createRichToolTip:function(){var L=new qx.ui.tooltip.ToolTip(q+w+n,l);L.setWidth(200);L.setRich(true);L.setShowTimeout(50);var K=new qx.ui.form.Button(c);this.add(K);K.setToolTip(L);}
,createToolTipText:function(){var M=new qx.ui.form.Button(r).set({toolTipText:o});this.add(M);}
,createToolTipIcon:function(){var N=new qx.ui.form.Button(p).set({toolTipIcon:m});this.add(N);}
,createToolTipTextIcon:function(){var O=new qx.ui.form.Button(g).set({toolTipText:o,toolTipIcon:m});this.add(O);}
