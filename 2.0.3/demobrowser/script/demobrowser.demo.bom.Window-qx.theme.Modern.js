...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Window","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window-qx.theme.Modern.8b2458fe063e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var q="Open Native Window",p="Open Native Modal Window",o="demobrowser.demo.bom.Window",n="Modal Window closed?",m="http://sourceforge.net",l="window1",k="window3",j="http://slashdot.org",i="Window closed?",h="http://qooxdoo.org",c="demobrowser/demo/html/ModalWindow.html",g="Open Faked Native Modal Window",f="window2",b="#eee",a="click",d="button";qx.Class.define(o,{extend:qx.application.Native,members:{__mV:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__mV=[h,m,j,r.toUri(c)];var u=qx.bom.Input.create(d);qx.bom.Input.setValue(u,q);document.body.appendChild(u);qx.event.Registration.addListener(u,a,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__mV[0],l,x);}
...
,this);var s=qx.bom.Input.create(d);qx.bom.Input.setValue(s,p);document.body.appendChild(s);qx.event.Registration.addListener(s,a,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__mV[3],f,y,true);}
...
,this);var v=qx.bom.Input.create(d);qx.bom.Input.setValue(v,g);document.body.appendChild(v);qx.event.Registration.addListener(v,a,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(b);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__mV[0],k,A,true,false);}
,this);}
...
(function(){var g="Cross-Domain Scripting problem: Could not move window!",f="qx.bom.Window",e="interval",d="Cross-Domain Scripting problem: Could not resize window!",c="javascript:/",b="qxNativeWindow",a='load';qx.Class.define(f,{statics:{__nF:null,__KS:null,__lm:null,__KT:{"top":"dialogTop",left:"dialogLeft",width:"dialogWidth",height:"dialogHeight",scrollbars:"scroll",resizable:"resizable"},__KU:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__KV:function(){return window.showModalDialog!=null;}
,open:function(h,name,i,j,k,l,self){var p=null;if(h==null){h=c;}
;if(name==null){name=b+new Date().getTime();}
;if(k==null){k=true;}
;var m=this.__KW(i,j&&k);if(j){if(this.__KV()&&k){p=window.showModalDialog(h,[window.self],m);}
else {this.getBlocker().block();if(this.__lm==null){this.__lm=new qx.event.Timer(500);this.__lm.addListener(e,this.__KX,this);}
;this.__KS=window.open(h,name,m);this.__lm.restart();p=this.__KS;}
;}
else {p=window.open(h,name,m);}
;if(p&&l&&(l instanceof Function)){var o=self||p;var n=qx.lang.Function.bind(l,o);qx.bom.Event.addNativeListener(p,a,function(){n();qx.bom.Event.removeNativeListener(p,a,arguments.callee);}
);}
;return p;}
,__KW:function(q,r){var s;var v;var t=[];if(r&&this.__KV()){for(var u in q){if(qx.bom.Window.__KT[u]){var w="";if(u!="scrollbars"&&u!="resizable"){w="px";}
;v=qx.bom.Window.__KT[u]+":"+q[u]+w;t.push(v);}
else {qx.log.Logger.warn("Option '"+u+"' is not supported for modal windows.");}
;}
;s=t.join(";");}
else {for(var u in q){if(qx.bom.Window.__KU[u]){if(qx.lang.Type.isBoolean(q[u])){v=u+"="+(q[u]?"yes":"no");}
else {v=u+"="+q[u];}
;t.push(v);}
else {qx.log.Logger.warn("Option '"+u+"' is not supported for native windows.");}
;}
;s=t.join(",");}
;return s;}
,__KX:function(){if(this.isClosed(this.__KS)){this.getBlocker().unblock();this.__lm.stop();}
;}
,getBlocker:function(){if(this.__nF==null){this.__nF=new qx.bom.Blocker;}
;return this.__nF;}
,close:function(x){if(x){return x.close();}
;}
,isClosed:function(y){var closed=true;if(y){try{closed=y.closed;}
catch(z){}
;}
;return closed;}
,moveTo:function(A,top,B){if(!qx.bom.Window.isClosed(A)){try{A.moveTo(B,top);}
catch(C){qx.log.Logger.error(g,C);}
;}
;}
,resizeTo:function(D,E,F){if(!qx.bom.Window.isClosed(D)){try{D.resizeTo(E,F);}
catch(G){qx.log.Logger.error(d,G);}
;}
;}
}});}
)();
