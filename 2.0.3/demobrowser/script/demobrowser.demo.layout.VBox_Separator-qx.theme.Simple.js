...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox_Separator-qx.theme.Simple.ed2cd6f53180.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="center",g="demobrowser.demo.layout.VBox_Separator",f="left",e="right",d="separator-vertical",c="yellow",b="green",a="main";qx.Class.define(g,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var i=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});scroll.add(i);i.add(this.getBox1());i.add(this.getBox2());i.add(this.getBox3());}
,getBox1:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,d)).set({decorator:a,backgroundColor:c,allowGrowY:false});j.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));j.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));j.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));return j;}
,getBox2:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,d)).set({decorator:a,backgroundColor:c,minWidth:60,allowGrowY:false});k.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxWidth:40,alignX:f}));k.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxWidth:40,alignX:h}));k.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxWidth:40,alignX:e}));return k;}
,getBox3:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,d)).set({decorator:a,backgroundColor:c,allowGrowY:false});var o=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,marginBottom:10});var n=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,marginBottom:10,marginTop:20});var l=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,marginBottom:10});m.add(o);m.add(n);m.add(l);return m;}
}});}
)();
