...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.HtmlArea-qx.theme.Classic.6b45913c43f1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var bL="clear:both",bK="Insert Table",bJ="Georgia",bI="<p>This low-level widget can be used separately at ",bH="http://",bG="Indent More",bF="Change font family",bE="demobrowser/demo/icons/htmlarea/format-fill-color.png",bD="Align Right",bC="Format Italic",br="qx/icon/Oxygen/16/actions/format-text-underline.png",bq="350px",bp='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',bo="white",bn="buttons at the toolbar.</p>",bm="demobrowser/demo/icons/htmlarea/format-list-ordered.png",bl="qx/icon/Oxygen/16/actions/format-indent-more.png",bk="Comic Sans MS",bj="Tahoma",bi="20px 20px",bS="float",bT="<h1>HtmlArea low-level widget</h1>",bQ="Align Left",bR="qx/icon/Oxygen/16/actions/format-justify-center.png",bO="input",bP="Align Justify",bM="demobrowser/demo/icons/htmlarea/insert-text.png",bN="Insert Horizontal Ruler",bU="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",bV="demobrowser/demo/icons/htmlarea/format-list-unordered.png",bv="HTML Code:",bu="Set Text Background Color",bx="Insert Link",bw="You can play around with this widget by hitting the ",bz="Undo Last Change",by="Set Text Color",bB="demobrowser/demo/icons/htmlarea/format-text-color.png",bA="traditional web pages / single-page applications.<br/> ",bt="demobrowser/demo/icons/htmlarea/insert-table.png",bs="qx/icon/Oxygen/16/actions/edit-undo.png",a="qx/icon/Oxygen/16/actions/edit-clear.png",b="Arial Black",c="Impact",d="Change font size",f="Link: ",g="Redo Last Undo Step",h="Format Bold",k="off",l="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",m="br",ca="marginRight",bY="image",bX="<option qxKeepFocus='on' qxSelectable='off'",bW="click",ce="<option qxKeepFocus='on' qxSelectable='off' ",cd="Remove Format",cc="blank.html",cb="qx/icon/Oxygen/16/actions/insert-image.png",cg="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",cf="on",L="Insert HTML Code",M="qx/icon/Oxygen/16/actions/insert-link.png",J="Insert Ordered List",K="demobrowser.demo.bom.HtmlArea",P="qx/icon/Oxygen/16/actions/format-justify-left.png",Q="Courier",N="Courier New",O="4px",H="qx/icon/Oxygen/16/actions/format-justify-right.png",I="qx/icon/Oxygen/16/actions/format-text-bold.png",u="Insert Image",t="qx/icon/Oxygen/16/actions/format-indent-less.png",w="Times New Roman",v="Align Center",q="qx/icon/Oxygen/16/actions/edit-redo.png",p="Lucida Console",s="innerHTML",r="qx/icon/Oxygen/16/actions/format-text-italic.png",o="Arial",n="qx/icon/Oxygen/16/actions/format-justify-fill.png",V="Verdana",W="Indent Less",X="Format Strikethrough",Y="Format Underline",R="Inserted Unordered List",S="FontSize: ",T="It is the foundation for the UI widget component.</p>",U="<option value=''></option>",ba="1px solid #AAA",bb="'>",E="value='",D="</option>",C="change",B="select",A="",z="840px",y="left",x="16px",G="outline",F="mshtml",bc="hideFocus",bd="none",be="engine.name",bf="true",bg="div",bh="0px";qx.Class.define(K,{extend:qx.application.Native,members:{__up:null,__Oi:null,__Oj:null,__LU:null,__fM:null,main:function(){qx.application.Native.prototype.main.call(this);this.__up=qx.dom.Element.create(bg);qx.bom.element.Style.setStyles(this.__up,{margin:bi});var cj=qx.dom.Element.create(bg);qx.bom.element.Style.setStyles(cj,{width:z,padding:bh,margin:bh});var ci=bT+bI+bA+T+cg+bw+bn;qx.bom.element.Attribute.set(cj,s,ci);this.__Oi=qx.dom.Element.create(bg);qx.bom.element.Style.setStyles(this.__Oi,{width:z,padding:bh,margin:bh,lineHeight:bh,border:ba});this.__Oj=qx.dom.Element.create(bg);qx.bom.element.Style.setStyles(this.__Oj,{width:z,height:bq,border:ba,borderTop:bh,backgroundColor:bo});qx.dom.Element.insertEnd(this.__Oj,this.__up);var ch=bp;this.__LU=new qx.bom.htmlarea.HtmlArea(this.__Oj,ch,null,cc);this.__Mf();qx.dom.Element.insertBegin(this.__Oi,this.__up);qx.dom.Element.insertBegin(cj,this.__up);qx.dom.Element.insertBegin(this.__up,document.body);}
,__Ok:function(e){var ck=window.prompt(S,A);this.setFontSize(parseInt(ck));}
,__LV:function(e){var cl=window.prompt("Color (Hex): ","#");this.setTextColor(cl);}
,__LW:function(e){var cm=window.prompt("BgColor (Hex): ","#");this.setTextBackgroundColor(cm);}
,__LX:function(e){var cn={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};this.insertImage(cn);}
,__LY:function(e){var co="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";this.insertHtml(co);}
,__Ma:function(e){var cp=window.prompt(f,bH);this.insertHyperLink(cp);}
,__Mb:function(e){var cq=window.prompt(bv,A);this.insertHtml(cq);}
,__Mc:function(){var cs=qx.dom.Element.create(bg);qx.bom.element.Style.setStyles(cs,{"float":y});var cu;var ct=qx.dom.Element.create(B,{title:bF});if(qx.core.Environment.get(be)==F){qx.bom.element.Attribute.set(ct,bc,bf);}
else {qx.bom.element.Style.set(ct,G,bd);}
;cu=qx.bom.Collection.html(U);qx.dom.Element.insertEnd(cu[0],ct);var cv=[bj,V,w,o,b,N,Q,bJ,c,bk,p];var cr;var cw;for(var i=0,j=cv.length;i<j;i++){cr=bX+E+cv[i]+bb+cv[i]+D;cw=qx.bom.Collection.html(cr);if(qx.core.Environment.get(be)==F){qx.bom.element.Attribute.set(cw[0],bc,bf);}
else {qx.bom.element.Style.set(cw[0],G,bd);}
;qx.dom.Element.insertEnd(cw[0],ct);}
;qx.event.Registration.addListener(ct,C,function(e){var cx=e.getTarget();var cy=cx.selectedIndex;if(cy!=0){this.setFontFamily(cx.options[cy].value);cx.options[0].selected=true;}
;}
,this.__LU);qx.dom.Element.insertBegin(ct,cs);return cs;}
,__Md:function(){var cA=qx.dom.Element.create(bg);qx.bom.element.Style.setStyles(cA,{"marginRight":x,"float":y});var cC;var cB=qx.dom.Element.create(B,{title:d});if(qx.core.Environment.get(be)==F){qx.bom.element.Attribute.set(cB,bc,bf);}
else {qx.bom.element.Style.set(cB,G,bd);}
;cC=qx.bom.Collection.html(U);qx.dom.Element.insertEnd(cC[0],cB);var cD;var cz;for(var i=1;i<=7;i++){cz=ce+E+i+bb+i+D;cD=qx.bom.Collection.html(cz);if(qx.core.Environment.get(be)==F){qx.bom.element.Attribute.set(cD[0],bc,bf);}
else {qx.bom.element.Style.set(cD[0],G,bd);}
;qx.dom.Element.insertEnd(cD[0],cB);}
;qx.event.Registration.addListener(cB,C,function(e){var cE=e.getTarget();var cF=cE.selectedIndex;if(cF!=0){this.setFontSize(cE.options[cF].value);cE.options[0].selected=true;}
;}
,this.__LU);qx.dom.Element.insertBegin(cB,cA);return cA;}
,__Mf:function(){var cH=[{bold:{text:h,image:I,action:this.__LU.setBold},italic:{text:bC,image:r,action:this.__LU.setItalic},underline:{text:Y,image:br,action:this.__LU.setUnderline},strikethrough:{text:X,image:l,action:this.__LU.setStrikeThrough},removeFormat:{text:cd,image:a,action:this.__LU.removeFormat}},{alignLeft:{text:bQ,image:P,action:this.__LU.setJustifyLeft},alignCenter:{text:v,image:bR,action:this.__LU.setJustifyCenter},alignRight:{text:bD,image:H,action:this.__LU.setJustifyRight},alignJustify:{text:bP,image:n,action:this.__LU.setJustifyFull}},{fontFamily:{custom:this.__Mc},fontSize:{custom:this.__Md},fontColor:{text:by,image:bB,action:this.__LV},textBackgroundColor:{text:bu,image:bE,action:this.__LW}},{indent:{text:bG,image:bl,action:this.__LU.insertIndent},outdent:{text:W,image:t,action:this.__LU.insertOutdent}},{insertImage:{text:u,image:cb,action:this.__LX},insertTable:{text:bK,image:bt,action:this.__LY},insertLink:{text:bx,image:M,action:this.__Ma},insertHTML:{text:L,image:bM,action:this.__Mb},insertHR:{text:bN,image:bU,action:this.__LU.insertHorizontalRuler}},{ol:{text:J,image:bm,action:this.__LU.insertOrderedList},ul:{text:R,image:bV,action:this.__LU.insertUnorderedList}},{undo:{text:bz,image:bs,action:this.__LU.undo},redo:{text:g,image:q,action:this.__LU.redo}}];var cJ,cN,cG,cL;for(var i=0,j=cH.length;i<j;i++){cN={};cN[ca]=i==j-1?bh:x;cN[bS]=y;cJ=qx.dom.Element.create(bg);qx.bom.element.Style.setStyles(cJ,cN);for(var cK in cH[i]){var cM=cH[i][cK];if(cM.custom){cG=cM.custom.call(this);}
else {var cI=qx.util.AliasManager.getInstance().resolve(cM.image);cL={type:bY,src:qx.util.ResourceManager.getInstance().toUri(cI),title:cM.text,qxKeepFocus:cf,qxSelectable:k};cG=qx.dom.Element.create(bO,cL);qx.bom.element.Style.setStyles(cG,{width:x,height:x,padding:O});if(qx.core.Environment.get(be)==F){qx.bom.element.Attribute.set(cG,bc,bf);}
else {qx.bom.element.Style.set(cG,G,bd);}
;qx.event.Registration.addListener(cG,bW,cM.action,this.__LU);}
;qx.dom.Element.insertEnd(cG,cJ);}
;qx.dom.Element.insertEnd(cJ,this.__Oi);}
;qx.dom.Element.insertEnd(qx.dom.Element.create(m,{style:bL}),this.__Oi);}
}});}
)();
