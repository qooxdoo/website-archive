...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Canvas_MinMaxSizes","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Canvas_MinMaxSizes-qx.theme.Modern.c654364afba0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="black",o="teal",n="red",m="maxHeight=300",l="minWidth=400",k="green",j="yellow",i="orange",h="solid",g="blue",c="demobrowser.demo.layout.Canvas_MinMaxSizes",f="12%",e="6%",b="3%",a="9%",d="20%";qx.Class.define(c,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var x=new qx.ui.decoration.Single(3,h,p);var w=new qx.ui.core.Widget().set({backgroundColor:n,decorator:x});var v=new qx.ui.core.Widget().set({backgroundColor:g,decorator:x});var u=new qx.ui.basic.Label(m).set({backgroundColor:k,decorator:x,padding:5,maxHeight:300,allowStretchX:true,allowStretchY:true});var t=new qx.ui.core.Widget().set({backgroundColor:j,decorator:x});var s=new qx.ui.core.Widget().set({backgroundColor:i,decorator:x});var r=new qx.ui.basic.Label(l).set({backgroundColor:o,decorator:x,padding:5,minWidth:400,allowStretchX:true,allowStretchY:true});var q=new qx.ui.container.Composite(new qx.ui.layout.Canvas());q.add(w,{left:b,top:b,right:b,bottom:b,width:d,height:d});q.add(v,{left:e,top:e,right:e,width:d,height:d});q.add(u,{left:a,top:a,bottom:a,width:d,height:d});q.add(t,{left:f,top:f,width:d,height:d});q.add(s,{top:a,right:a,width:d,height:d});q.add(r,{right:a,bottom:a,width:d,height:d});this.getRoot().add(q,{edge:0});}
}});}
)();
