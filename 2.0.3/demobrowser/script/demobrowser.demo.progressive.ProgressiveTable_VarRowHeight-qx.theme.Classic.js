...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_VarRowHeight-qx.theme.Classic.cef010152e5b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="demobrowser.demo.progressive.ProgressiveTable_VarRowHeight",k="format-justify-left.png",h="end",g="Found [",f="Id",e="No attributes specified.",d="TALL ICON",c="1*",b=", end=",a="This, too, is small.",C="This, too, is tall.",B="",A="Searching for [",z="]",y=" not found",x="small icon",w="demobrowser/demo/icons/",v="I am small.",u="red",t="Image data for ",q="I am tall.",s="].  loadCount=",o="multimedia-player.png",p="Image",m="Note variable row heights in this table.",n="row";qx.Class.define(l,{extend:qx.application.Standalone,members:{__PO:null,main:function(){qx.application.Standalone.prototype.main.call(this);var H=w;this.imageData=[{url:H+k,height:4,tooltip:x},{url:H+o,height:4,tooltip:d},B];this.__PO=0;var F=qx.util.AliasManager.getInstance();var E=qx.util.ResourceManager.getInstance();var D;var G;for(var i=0;i<this.imageData.length;i++){if(!this.imageData[i]){continue;}
;D=F.resolve(this.imageData[i].url);G=E.toUri(D);this.imageData[i].url=G;++this.__PO;qx.io.ImageLoader.load(G,function(I,J){this.info(A+I+z);for(var j=0;j<this.imageData.length;j++){if(this.imageData[j].url==I){this.imageData[j].height=J.height;--this.__PO;this.debug(g+this.imageData[j].url+s+this.__PO+b+this.imageData.length);if(this.__PO==0){this.doLoad();}
;return;}
;}
;throw new Error(t+I+y);}
,this);}
;if(this.__PO==0){this.doLoad();}
;}
...
(function(){var c="qx.ui.progressive.renderer.table.cell.Image",b="string",a="";qx.Class.define(c,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(d,e){qx.ui.progressive.renderer.table.cell.Icon.call(this);if(d===undefined){this.__CV=d;}
else {this.__CV=16;}
;if(e===undefined){this.__CW=e;}
else {this.__CW=16;}
;}
,members:{__CV:null,__CW:null,_identifyImage:function(f){var j={imageWidth:this.__CV,imageHeight:this.__CW};var k;if(typeof (f.cellData)==b){j.url=f.cellData;}
