...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.ToolBar","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ToolBar-qx.theme.Classic.b266804d426b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="icon/16/actions/format-justify-right.png",k="Label only",j="enabled",h="22px",g="icon/22/actions/format-justify-center.png",f="icon/16/actions/edit-cut.png",d="icon/22/actions/format-text-underline.png",c="32px",b="icon/22/actions/edit-cut.png",a="icon/22/actions/format-justify-left.png",X="showItem",W="48px",V="Show:",U="icon/22/actions/edit-paste.png",T="demobrowser.demo.widget.ToolBar",S="icon/22/actions/document-new.png",R="visible",Q="icon/16/actions/edit-copy.png",P="More...",O="icon/22/actions/help-contents.png",s="icon/16/actions/format-justify-center.png",t="icon/22/actions/edit-copy.png",q="icon",r="icon/22/actions/format-justify-right.png",o="icon/16/actions/edit-paste.png",p="on",m="Help",n="icon/16/actions/format-justify-left.png",u="label",v="Label and Icon",C="overflowHandling",A="both",G="Icon Size:",E="icon/16/actions/document-new.png",K="Toggle",I="Icon only",x="Overflow handling:",N="hideItem",M="excluded",L="Left",w="New",y="value",z="changeSelection",B="Cut",D="Center",F="Copy",H="Paste",J="Right";qx.Class.define(T,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var bu=new qx.ui.container.Composite(new qx.ui.layout.VBox(20));bu.setPadding(20);this.getRoot().add(bu,{edge:0});toolbar=new qx.ui.toolbar.ToolBar();toolbar.setSpacing(5);bu.add(toolbar);var bA=new qx.ui.toolbar.Part();var bd=new qx.ui.toolbar.Button(w,S);var bq=new qx.ui.toolbar.Button(F,t);var be=new qx.ui.toolbar.Button(B,b);var bx=new qx.ui.toolbar.Button(H,U);bA.add(bd);bA.add(new qx.ui.toolbar.Separator());bA.add(bq);bA.add(be);bA.add(bx);toolbar.add(bA);var bB=new qx.ui.toolbar.Part();var br=new qx.ui.toolbar.CheckBox(K,d);bB.add(br);toolbar.add(bB);var bC=new qx.ui.toolbar.Part();var bp=new qx.ui.toolbar.RadioButton(L,a);var bo=new qx.ui.toolbar.RadioButton(D,g);var bn=new qx.ui.toolbar.RadioButton(J,r);bC.add(bp);bC.add(bo);bC.add(bn);toolbar.add(bC);var bD=new qx.ui.form.RadioGroup(bp,bo,bn);bD.setAllowEmptySelection(true);toolbar.addSpacer();var bs=new qx.ui.toolbar.MenuButton(P);toolbar.add(bs);toolbar.setOverflowIndicator(bs);var Y=new qx.ui.toolbar.Button(m,O);toolbar.add(Y);var bh=[bd,bq,be,bx,br,bp,bo,bn,Y];toolbar.setRemovePriority(bA,4);toolbar.setRemovePriority(bC,3);toolbar.setRemovePriority(bB,2);var ba=new qx.ui.menu.Menu();bs.setMenu(ba);var bd=new qx.ui.menu.Button(w,E);var bi=new qx.ui.menu.Separator();var bq=new qx.ui.menu.Button(F,Q);var be=new qx.ui.menu.Button(B,f);var bx=new qx.ui.menu.Button(H,o);ba.add(bd);ba.add(bi);ba.add(bq);ba.add(be);ba.add(bx);var bj=new qx.ui.menu.Separator();var bp=new qx.ui.menu.RadioButton(L);var bo=new qx.ui.menu.RadioButton(D);var bn=new qx.ui.menu.RadioButton(J);bp.setIcon(n);bo.setIcon(s);bn.setIcon(l);ba.add(bj);ba.add(bp);ba.add(bo);ba.add(bn);var bb=ba.getChildren();for(var i=0;i<bb.length;i++){bb[i].setVisibility(M);}
;var bc=function(bF,bG){var bH=[];if(bF==bA){bH.push(bd,bi,bq,be,bx);}
else if(bF==bC){bH.push(bj,bp,bo,bn);}
;for(var i=0;i<bH.length;i++){bH[i].setVisibility(bG);}
;}
;toolbar.addListener(X,function(e){bc(e.getData(),M);}
,this);toolbar.addListener(N,function(e){bc(e.getData(),R);}
,this);var bk=new qx.ui.layout.Grid();bk.setSpacing(10);var bw=new qx.ui.container.Composite(bk);bu.add(bw);var bm=new qx.ui.form.RadioButton(h);bm.setValue(true);var bE=new qx.ui.form.RadioButton(c);var bl=new qx.ui.form.RadioButton(W);var bt=new qx.ui.form.RadioGroup();bt.add(bm,bE,bl);bw.add(new qx.ui.basic.Label(G),{row:0,column:0});bw.add(bm,{row:0,column:1});bw.add(bE,{row:0,column:2});bw.add(bl,{row:0,column:3});bt.addListener(z,function(e){var bK=e.getData()[0];var bJ,bL,bI;for(var i=0;i<bh.length;i++){bJ=bh[i];bI=bJ.getIcon();if(bK==bm){bL=22;}
else if(bK==bE){bL=32;}
else if(bK==bl){bL=48;}
;;bI=bI.replace(/22|32|48/g,bL);bJ.setIcon(bI);}
;}
,this);var bg=new qx.ui.form.RadioButton(v);bg.setValue(true);var bz=new qx.ui.form.RadioButton(I);var bf=new qx.ui.form.RadioButton(k);var bv=new qx.ui.form.RadioGroup();bv.add(bg,bz,bf);bw.add(new qx.ui.basic.Label(V),{row:1,column:0});bw.add(bg,{row:1,column:1});bw.add(bz,{row:1,column:2});bw.add(bf,{row:1,column:3});bv.addListener(z,function(e){if(e.getData()[0]==bg){toolbar.setShow(A);}
else if(e.getData()[0]==bz){toolbar.setShow(q);}
else if(e.getData()[0]==bf){toolbar.setShow(u);}
;;}
,this);var by=new qx.ui.form.CheckBox(p);bw.add(new qx.ui.basic.Label(x),{row:2,column:0});bw.add(by,{row:2,column:1});by.bind(y,toolbar,C);by.bind(y,bv,j,{converter:function(bM){return !bM;}
});}
}});}
)();
