...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Pane_Row","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Pane_Row-qx.theme.Indigo.58bf7a18afa4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="demobrowser.demo.virtual.Pane_Row",g="Even/Odd Colors",f="Custom Colors",e="Even/Odd & Custom Colors",d="white",c="#EEE",b="bold",a="table-scroller-header";qx.Class.define(h,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var l=new qx.ui.layout.Grid(5,0);l.setRowFlex(1,1);l.setColumnFlex(0,1);l.setColumnFlex(1,1);l.setColumnFlex(2,1);var j=new qx.ui.container.Composite(l);this.getRoot().add(j,{edge:0});j.add(new qx.ui.basic.Label(g).set({font:b,decorator:a,padding:3,allowGrowX:true}),{row:0,column:0});var m=new qx.ui.virtual.core.Scroller(100,10000,60,100);m.getPane().addLayer(new qx.ui.virtual.layer.Row(d,c));j.add(m,{row:1,column:0});j.add(new qx.ui.basic.Label(f).set({font:b,decorator:a,padding:3,allowGrowX:true}),{row:0,column:1});var m=new qx.ui.virtual.core.Scroller(100,10000,60,100);var k=new qx.ui.virtual.layer.Row();for(var i=0;i<10000;i++){k.setColor(i,qx.util.ColorUtil.randomColor());}
;m.getPane().addLayer(k);j.add(m,{row:1,column:1});j.add(new qx.ui.basic.Label(e).set({font:b,decorator:a,padding:3,allowGrowX:true}),{row:0,column:2});var m=new qx.ui.virtual.core.Scroller(100,10000,60,100);var k=new qx.ui.virtual.layer.Row(d,c);for(var i=0;i<10000;i++){if(Math.random()>0.7){k.setColor(i,qx.util.ColorUtil.randomColor());}
;}
;m.getPane().addLayer(k);j.add(m,{row:1,column:2});}
}});}
)();
