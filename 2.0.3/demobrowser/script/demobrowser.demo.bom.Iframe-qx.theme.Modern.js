...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Iframe","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Iframe-qx.theme.Modern.cca576efa0c8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="demobrowser.demo.bom.Iframe",g="http://www.qooxdoo.org",f="",d="testFrame",c="load",b="Content loaded.",a="dummy";qx.Class.define(h,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var i=qx.bom.Iframe.create({name:d,src:g});qx.bom.Element.addListener(i,c,function(e){this.debug(b);}
,this);document.body.appendChild(i);document.getElementById(a).innerHTML=f;}
}});}
)();
