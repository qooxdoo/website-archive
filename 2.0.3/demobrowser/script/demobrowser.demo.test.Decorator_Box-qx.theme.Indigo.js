...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Decorator_Box","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Decorator_Box-qx.theme.Indigo.f957c6bea992.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var d="demobrowser/demo/theme/tag-hor.png",c="demobrowser/demo/theme/tag-vert.png",b="demobrowser.demo.test.Decorator_Box",a="HBox/VBox Decorator Demo";qx.Class.define(b,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var e=new qx.ui.window.Window(a);e.setLayout(new qx.ui.layout.Canvas());e.moveTo(20,20);e.open();var f=new qx.ui.decoration.HBox(d);var h=new qx.ui.core.Widget().set({decorator:f,height:12});e.add(h,{left:10,top:10,right:0});var g=new qx.ui.decoration.VBox(c);var i=new qx.ui.core.Widget().set({decorator:g,width:12});e.add(i,{left:10,top:60,bottom:0});}
}});}
)();
...
(function(){var n="sliceBottom",m="horizontal",l="qx.debug.dispose",k="qx.ui.decoration.AbstractBox",j="sliceLeft",i="_applyBaseImage",h="sliceRight",g="_applyFill",f="shorthand",e="String",b="sliceTop",d="set",c="Number",a="_applySlices";qx.Class.define(k,{extend:qx.ui.decoration.Abstract,implement:[qx.ui.decoration.IDecorator],construct:function(o,p,q){qx.ui.decoration.Abstract.call(this);this._setOrientation(q);if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__dt=new qx.ui.decoration.css3.BorderImage();if(o){this.__AS(o,q);}
;if(p!=null){this.__dt.setInsets(p);}
;}
else {this.__dt=new qx.ui.decoration.BoxDiv(o,p,q);}
;if(qx.core.Environment.get(l)){this.__dt.$$ignoreDisposeWarning=true;}
;}
,properties:{baseImage:{check:e,nullable:true,apply:i},sliceLeft:{check:c,nullable:true,apply:a},sliceRight:{check:c,nullable:true,apply:a},sliceBottom:{check:c,nullable:true,apply:a},sliceTop:{check:c,nullable:true,apply:a},slices:{group:[b,h,n,j],mode:f},fill:{apply:g}},members:{__dt:null,_isHorizontal:null,_setOrientation:function(r){this._isHorizontal=r==m;}
,getMarkup:function(){return this.__dt.getMarkup();}
,resize:function(s,t,u){this.__dt.resize(s,t,u);}
,tint:function(v,w){}
,getInsets:function(){return this.__dt.getInsets();}
,_applyInsets:function(x,y,name){var z=d+qx.lang.String.firstUp(name);this.__dt[z](x);}
,_applySlices:function(A,B,name){var C=d+qx.lang.String.firstUp(name);if(this.__dt[C]){this.__dt[C](A);}
;}
,_applyFill:function(D,E,name){if(this.__dt.setFill){this.__dt.setFill(D);}
;}
,_applyBaseImage:function(F,G){if(this.__dt instanceof qx.ui.decoration.BoxDiv){this.__dt.setBaseImage(F);}
else {this.__AS(F);}
;}
,__AS:function(H){this.__dt.setBorderImage(H);var N=qx.util.AliasManager.getInstance().resolve(H);var O=/(.*)(\.[a-z]+)$/.exec(N);var L=O[1];var M=O[2];var K=qx.util.ResourceManager.getInstance();if(qx.core.Environment.get("qx.debug")){if(!K.has(N)){this.warn("The border image '"+N+"' is not available!");}
;}
;if(this._isHorizontal){var Q=K.getImageWidth(L+"-l"+M);var I=K.getImageWidth(L+"-r"+M);if(I&&Q){this.__dt.setSlice([0,I,0,Q]);}
;}
else {var J=K.getImageHeight(L+"-b"+M);var P=K.getImageHeight(L+"-t"+M);if(P&&J){this.__dt.setSlice([P,0,J,0]);}
;}
;}
},destruct:function(){this.__AR=this.__GO=this.__pw=null;this.__dt.dispose();}
});}
)();
...
(function(){var j="-l",i='</div>',h="-t",g="browser.quirksmode",f="-r",e='<div style="position:absolute;top:0;left:0;overflow:hidden;font-size:0;line-height:0;">',d="qx.debug",c="_applyBaseImage",b="-b",a="repeat-y",x="String",w="",v="qx.ui.decoration.BoxDiv",u="-c",t="mshtml",s="engine.name",r="horizontal",q="This decorator is already in-use. Modification is not possible anymore!",p="repeat-x",o="engine.version",m="0",n="-1px",k="no-repeat",l="px";qx.Class.define(v,{extend:qx.ui.decoration.Abstract,construct:function(y,z,A){qx.ui.decoration.Abstract.call(this);this._setOrientation(A);if(y!=null){this.setBaseImage(y);}
;if(z!=null){this.setInsets(z);}
;}
,properties:{baseImage:{check:x,nullable:true,apply:c}},members:{__AR:null,__GO:null,__pw:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};}
,_isInitialized:function(){return !!this.__AR;}
,_setOrientation:function(B){this._isHorizontal=B==r;}
,getMarkup:function(){if(this.__AR){return this.__AR;}
;var C=qx.bom.element.Decoration;var D=this.__GO;var E=this.__pw;var F=[];F.push(e);if(this._isHorizontal){F.push(C.create(D.l,k,{top:0,left:0}));F.push(C.create(D.c,p,{top:0,left:E.left+l}));F.push(C.create(D.r,k,{top:0,right:0}));}
else {F.push(C.create(D.t,k,{top:0,left:0}));F.push(C.create(D.c,a,{top:E.top+l,left:E.left+l}));F.push(C.create(D.b,k,{bottom:0,left:0}));}
;F.push(i);return this.__AR=F.join(w);}
,resize:function(G,H,I){G.style.width=H+l;G.style.height=I+l;var J=this.__pw;if(this._isHorizontal){var innerWidth=H-J.left-J.right;innerWidth=innerWidth<0?0:innerWidth;G.childNodes[1].style.width=innerWidth+l;}
else {var innerHeight=I-J.top-J.bottom;innerHeight=innerHeight<0?0:innerHeight;G.childNodes[1].style.height=innerHeight+l;}
;if((qx.core.Environment.get(s)==t)){if(parseFloat(qx.core.Environment.get(o))<7||(qx.core.Environment.get(g)&&parseFloat(qx.core.Environment.get(o))<8)){if(this._isHorizontal){G.childNodes[2].style.marginRight=(H%2==1)?n:m;}
else {G.childNodes[2].style.marginBottom=(I%2==1)?n:m;}
;}
;}
;}
,tint:function(K,L){}
,_applyBaseImage:function(M,N){if(qx.core.Environment.get(d)){if(this.__AR){throw new Error(q);}
;}
;var O=qx.util.ResourceManager.getInstance();if(M){var Q=qx.util.AliasManager.getInstance();var S=Q.resolve(M);var T=/(.*)(\.[a-z]+)$/.exec(S);var R=T[1];var P=T[2];var U=this.__GO={t:R+h+P,b:R+b+P,c:R+u+P,l:R+j+P,r:R+f+P};this.__pw={top:O.getImageHeight(U.t),bottom:O.getImageHeight(U.b),left:O.getImageWidth(U.l),right:O.getImageWidth(U.r)};}
;}
},destruct:function(){this.__AR=this.__GO=this.__pw=null;}
});}
)();
(function(){var b="horizontal",a="qx.ui.decoration.HBox";qx.Class.define(a,{extend:qx.ui.decoration.AbstractBox,construct:function(c,d){qx.ui.decoration.AbstractBox.call(this,c,d,b);}
});}
)();
(function(){var b="qx.ui.decoration.VBox",a="vertical";qx.Class.define(b,{extend:qx.ui.decoration.AbstractBox,construct:function(c,d){qx.ui.decoration.AbstractBox.call(this,c,d,a);}
});}
)();
