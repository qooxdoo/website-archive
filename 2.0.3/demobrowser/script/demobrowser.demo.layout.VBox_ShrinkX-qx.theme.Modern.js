...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.VBox_ShrinkX","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox_ShrinkX-qx.theme.Modern.366d79472f0e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var d="demobrowser.demo.layout.VBox_ShrinkX",c="yellow",b="green",a="main";qx.Class.define(d,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var e=new qx.ui.layout.VBox();var g=(new qx.ui.container.Composite(e)).set({decorator:a,backgroundColor:c,maxWidth:100});e.setSpacing(5);var i=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var h=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var f=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});i.setWidth(200);h.setWidth(300);f.setWidth(400);g.add(i);g.add(h);g.add(f);this.getRoot().add(g,{left:10,top:10});}
}});}
)();
