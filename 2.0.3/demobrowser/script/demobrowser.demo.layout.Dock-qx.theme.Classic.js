...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Dock","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Dock-qx.theme.Classic.655014a48126.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="demobrowser.demo.layout.Dock",n="x",m="y",l="east",k="yellow",j="west",i="red",h="center",g="north",f="south",c="green",e="fuchsia",d="orange",b="blue",a="main";qx.Class.define(o,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var q=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(q);var p=new qx.ui.container.Composite(new qx.ui.layout.Dock()).set({decorator:a,backgroundColor:k,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:a,backgroundColor:i});var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var u=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d});var t=new qx.ui.core.Widget().set({decorator:a,backgroundColor:c});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:e});p.add(w,{edge:g});p.add(v,{edge:j});p.add(u,{edge:f});p.add(t,{edge:l});p.add(s,{edge:h});q.add(p);var r=new qx.ui.layout.Dock();r.setSort(m);var p=(new qx.ui.container.Composite(r)).set({decorator:a,backgroundColor:k,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:a,backgroundColor:i});var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var u=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d});var t=new qx.ui.core.Widget().set({decorator:a,backgroundColor:c});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:e});p.add(w,{edge:g});p.add(v,{edge:j});p.add(u,{edge:f});p.add(t,{edge:l});p.add(s,{edge:h});q.add(p);var r=new qx.ui.layout.Dock();r.setSort(n);var p=(new qx.ui.container.Composite(r)).set({decorator:a,backgroundColor:k,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:a,backgroundColor:i});var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var u=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d});var t=new qx.ui.core.Widget().set({decorator:a,backgroundColor:c});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:e});p.add(w,{edge:g});p.add(v,{edge:j});p.add(u,{edge:f});p.add(t,{edge:l});p.add(s,{edge:h});q.add(p);}
}});}
)();
