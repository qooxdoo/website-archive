...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.CellEvents","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents-qx.theme.Simple.b4144a0111a7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_onCellClick:function(e){var q=m+e.getRow()+b+e.getColumn()+c;this.__Qt(q);}
,_onContextMenu:function(e){var r=j+e.getRow()+b+e.getColumn()+c;this.__Qt(r);}
,_onDblclickPane:function(e){var s=i+e.getRow()+b+e.getColumn()+c;this.__Qt(s);}
,__Qt:function(t){this.logger.setHtml(this.logger.getHtml()+t);}
