...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Context_Menu-qx.theme.Indigo.0b8ffa7cdb28.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var k=this.__KQ[l];var i=this.getTableModel();g=new qx.ui.menu.Menu();g.addListener(f,function(e){e.preventDefault();}
...
,this);this.__KP=[];this.__KQ=[];}
,members:{__KP:null,__KQ:null,setContextMenuHandler:function(m,n,o){this.__KP[m]=n;this.__KQ[m]=o||this;}
,getContextMenuHandler:function(p){return this.__KP[p];}
},destruct:function(){this.__KP=null;this.__KQ=null;}
});}
)();
