...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Destructor","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor-qx.theme.Indigo.ead31cca2387.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="Window: ",h="__lm",g="interval",f="Done! (Registry: ",e="Label: ",d=" (Registry: ",c="demobrowser.demo.test.Destructor",b="Round: ",a=")";qx.Class.define(c,{extend:qx.application.Standalone,members:{__cR:null,__PY:0,__lm:null,main:function(){qx.application.Standalone.prototype.main.call(this);this.__cR=[];this.currentTest=this.testWindows;this.__lm=new qx.event.Timer(1000);this.__lm.addListener(g,this.runTest,this);this.__lm.start();}
,runTest:function(){this.__PY++;var m=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug(b+this.__PY+d+m+a);this.currentTest();qx.ui.core.queue.Manager.flush();var k=this.__cR;for(var i=0,l=k.length;i<l;i++){k[i].destroy();}
;k.length=0;qx.ui.core.queue.Manager.flush();var m=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug(f+m+a);}
,testLabels:function(){for(var i=0;i<250;i++){var n=new qx.ui.basic.Label(e+i);this.getRoot().add(n,{left:50,top:50+i*20});this.__cR.push(n);}
;}
,testWindows:function(){for(var i=0;i<5;i++){var o=new qx.ui.window.Window(j+i);o.open();this.__cR.push(o);}
;}
