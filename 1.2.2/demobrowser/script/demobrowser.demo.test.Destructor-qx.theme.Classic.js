...
(function(){var e="Window: ",d="interval",c="Label: ",b="__LI",a="demobrowser.demo.test.Destructor";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__LG:null,__LH:0,__LI:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__LG=[];
...
this.__LG.push(g);
}},testWindows:function(){for(var i=0;i<5;i++){var f=new qx.ui.window.Window(e+i);
f.open();
this.__LG.push(f);
