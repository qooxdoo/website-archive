...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Slider","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Slider-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ea2f9aef83cd"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
},_createHorizontalLayout:function(){var r=[];
r.push(this._createSliderGroup(new qx.ui.form.Slider().set({maximum:1000,value:100})));
r.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-100,maximum:100,singleStep:5,pageStep:20,value:0})));
r.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-600,maximum:-200,singleStep:10,pageStep:50,value:-300})));
r.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:25,maximum:75,singleStep:5,pageStep:10,value:25})));
var s=new qx.ui.layout.Grid();
var q=new qx.ui.container.Composite(s);
q.setPadding(20);
q.setWidth(400);
q.setHeight(400);
s.setSpacing(5);
...
s.setColumnFlex(1,1);
s.setColumnFlex(2,1);
s.setColumnAlign(0,n,m);
s.setColumnAlign(1,l,m);
s.setColumnAlign(2,b,m);
var u=0;

for(var i=0;i<r.length;i++){var t=r[i];
t.slider.setOrientation(g);
t.value.setWidth(100);
t.value.setTextAlign(l);
q.add(t.minimum,{row:u,column:0});
q.add(t.value,{row:u,column:1});
q.add(t.maximum,{row:u,column:2});
q.add(t.slider,{row:u+1,column:0,colSpan:3,rowSpan:1});
s.setRowHeight(u+2,20);
u+=3;
}return q;
},_createSliderGroup:function(o){var p={slider:o,minimum:new qx.ui.basic.Label(a+o.getMinimum().toString()),maximum:new qx.ui.basic.Label(j+o.getMaximum().toString()),value:new qx.ui.basic.Label(o.getValue().toString())};
o.addListener(h,function(e){p.value.setValue(o.getValue().toString());
});
return p;
}}});
})();
