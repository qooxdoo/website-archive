...
for(var d in f){b.add(new qx.ui.basic.Label(d).set({rich:true,wrap:true,decorator:d,padding:5,height:80,width:80}),{row:Math.floor(i/g),column:i%g});
i+=1;
}return b;
}}});
})();
