...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.HBox_Margin","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.HBox_Margin-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"1ae97e4f3639"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
u.add(this.getBox4());
u.add(this.getBox5());
},getBox1:function(){var p=new qx.ui.layout.HBox();
var r=new qx.ui.container.Composite(p).set({decorator:e,backgroundColor:c,allowGrowX:false});
p.setSpacing(5);
...
t.setMarginTop(20);
q.setMarginBottom(30);
return r;
},getBox2:function(){var A=new qx.ui.layout.HBox();
var C=new qx.ui.container.Composite(A).set({decorator:e,backgroundColor:c,allowGrowX:false});
A.setSpacing(5);
...
return C;
},getBox3:function(){var v=new qx.ui.layout.HBox();
...
x.add(y);
x.add(w);
z.setAllowGrowY(false);
y.setAllowGrowY(false);
w.setAllowGrowY(false);
z.setMarginTop(20);
w.setMarginBottom(30);
return x;
},getBox4:function(){var k=new qx.ui.layout.HBox();
var m=new qx.ui.container.Composite(k).set({decorator:e,backgroundColor:c,height:100,allowGrowX:false});
k.setSpacing(5);
k.setAlignY(b);
...
l.setMarginTop(5);
l.setMinHeight(50);
l.setMarginBottom(20);
return m;
},getBox5:function(){var f=new qx.ui.layout.HBox();
var h=new qx.ui.container.Composite(f).set({decorator:e,backgroundColor:c,height:100,allowGrowX:false});
f.setSpacing(5);
f.setAlignY(b);
