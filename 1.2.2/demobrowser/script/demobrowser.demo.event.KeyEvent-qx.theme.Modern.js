...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.event.KeyEvent-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"0bb3310380d6"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var n="keyinput",m="",l="logger",k="keypress",j="Char code",h="Ctrl",g="Key identifier",f="demobrowser.demo.event.KeyEvent",e="Shift",d="keydown",a="Event",c="Alt",b="keyup";
...
this._initLogger([a,g,j,e,h,c],document.getElementById(l),50);
var q=[d,k,b,n];

for(var i=0;i<q.length;i++){qx.bom.Element.addListener(document.documentElement,q[i],this.logKeyEvent,this);
}},logKeyEvent:function(o){var p=o.getType();
this._log([p,p!==n?o.getKeyIdentifier():m,p==n?o.getCharCode():m,o.isShiftPressed(),o.isAltPressed(),o.isCtrlPressed()]);
o.preventDefault();
}}});
})();
