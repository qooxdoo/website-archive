...
(function(){var j="main",i="green",h="33%",g="yellow",f="50%",e="demobrowser.demo.layout.HBox_Percent";
...
s.add(this.getBox5());
s.add(this.getBox6());
},getBox1:function(){var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,width:500,allowGrowX:false});
var E=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var D=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var B=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
C.add(E,{width:f});
C.add(D,{flex:1});
C.add(B,{flex:1});
return C;
},getBox2:function(){var p=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,width:500,allowGrowX:false});
var r=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var q=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var o=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
p.add(r,{width:h});
p.add(q,{width:h});
p.add(o,{width:h,flex:1});
return p;
},getBox3:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,allowGrowX:false});
var d=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var c=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var a=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
b.add(d,{width:f});
b.add(c,{flex:1});
b.add(a,{flex:1});
return b;
},getBox4:function(){var u=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,allowGrowX:false});
var w=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var v=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var t=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
u.add(w,{width:h,flex:1});
u.add(v,{width:h,flex:1});
u.add(t,{width:h,flex:1});
return u;
},getBox5:function(){var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,width:200,allowGrowX:false});
var A=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var z=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var x=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
y.add(A,{width:h,flex:1});
y.add(z,{width:h,flex:1});
y.add(x,{width:h,flex:1});
return y;
},getBox6:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,width:500,allowGrowX:false});
var n=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var m=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var k=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
l.add(n,{width:h,flex:1});
l.add(m,{width:h,flex:1});
l.add(k,{width:h,flex:1});
return l;
}}});
})();
