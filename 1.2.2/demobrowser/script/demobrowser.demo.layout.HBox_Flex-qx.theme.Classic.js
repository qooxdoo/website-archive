...
o.setSpacing(5);
p.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:1});
p.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
p.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:3});
return p;
},getBox2:function(){var k=new qx.ui.layout.HBox();
var l=new qx.ui.container.Composite(k).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
k.setSpacing(5);
l.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:30}),{flex:1});
l.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
l.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:150}),{flex:3});
return l;
...
var n=new qx.ui.container.Composite(m).set({width:600,minWidth:600,decorator:d,backgroundColor:b,allowGrowX:false});
m.setSpacing(5);
n.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:1});
n.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:2});
n.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:3});
return n;
},getBox5:function(){var e=new qx.ui.layout.HBox();
var f=new qx.ui.container.Composite(e).set({width:300,minWidth:0,decorator:d,backgroundColor:b,allowGrowX:false});
e.setSpacing(5);
...
return f;
},getBox6:function(){var h=new qx.ui.layout.HBox();
var j=new qx.ui.container.Composite(h).set({width:300,decorator:d,backgroundColor:b,allowGrowX:false});
h.setSpacing(5);
j.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:1});
j.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:2});
j.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:3});
return j;
}}});
})();
