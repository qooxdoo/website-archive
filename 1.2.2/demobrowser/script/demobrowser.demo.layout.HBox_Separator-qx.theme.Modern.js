...
var m=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(m);
m.add(this.getBox1());
m.add(this.getBox2());
m.add(this.getBox3());
},getBox1:function(){var n=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,e)).set({decorator:h,backgroundColor:f,allowGrowX:false});
n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
return n;
},getBox2:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,e)).set({decorator:h,backgroundColor:f,minHeight:60,allowGrowX:false});
o.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:c}));
o.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:a}));
o.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:b}));
return o;
},getBox3:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,e)).set({decorator:h,backgroundColor:f,allowGrowX:false});
var l=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g});
var k=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g});
var i=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g});
j.add(l);
j.add(k);
j.add(i);
l.setMarginRight(10);
