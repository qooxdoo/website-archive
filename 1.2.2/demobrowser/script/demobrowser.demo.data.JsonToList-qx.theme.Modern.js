...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.JsonToList","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.JsonToList-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"395abf4ad137"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var p="icon/16/mimetypes/",o="name",n="model.items",m="Loading...",l=" will be created by a converter which converts the type to an icon url.",k=".png",j="model",i="state",h="json/list.json",g="type",c="list.json</a> and bind the items to the list widget. The icons ",f="' target='_blank'>",e="demobrowser.demo.data.JsonToList",b="<b>List bound to data in a json file</b><br/>",a="Loading the json file <a href='",d="value";
...
u.setLabelPath(o);
u.setIconOptions({converter:function(q){return p+q+k;
}});
u.setIconPath(g);
var s=h;
