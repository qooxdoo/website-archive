...
var o=new qx.ui.container.Composite(m).set({decorator:k,backgroundColor:h,height:300,allowGrowY:false});
m.setSpacing(5);
...
var c=new qx.ui.container.Composite(a).set({decorator:k,backgroundColor:h,allowGrowY:false});
a.setSpacing(5);
var e=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
...
var I=new qx.ui.container.Composite(G).set({decorator:k,backgroundColor:h,height:100,allowGrowY:false});
G.setSpacing(5);
...
I.add(K,{height:i,flex:1});
I.add(J,{height:i,flex:1});
I.add(H,{height:i,flex:1});
return I;
