...
qx.Class.define(c,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
...
}function q(v,w){return parseInt(qx.bom.element.Style.get(v,w,qx.bom.element.Style.COMPUTED_MODE,false),10);
}var s=this.href;
var u=s.substr(s.indexOf(j)+1);
var r=document.getElementById(u);
var location=qx.bom.element.Location.get(r,document.getElementById(h).value);
var t=document.getElementById(n);
t.style.left=location.left+o;
t.style.top=location.top+o;

if(qx.bom.client.Feature.BORDER_BOX){t.style.width=(location.right-location.left)+o;
t.style.height=(location.bottom-location.top)+o;
}else{t.style.width=(location.right-location.left-q(t,f)-q(t,b))+o;
t.style.height=(location.bottom-location.top-q(t,g)-q(t,m))+o;
}return false;
