...
(function(){var D="execute",C="dd.MM.yyyy",B="MM/dd/yyyy",A="MM-yyyy",z="With date formater",y="demobrowser.demo.widget.DateField",x="",w="Set current date",v="Default",u="Set data",r="en",t="changeValue",s="Get data",q="Reset",p="Get date";
...
this.getRoot().add(new qx.ui.basic.Label(v),{top:20,left:20});
var b=new qx.ui.form.DateField();
this.getRoot().add(b,{top:35,left:20});
b.setValue(new Date());
b.addListener(t,function(e){this.debug("Change Value: "+e.getData());
});
this.getRoot().add(new qx.ui.basic.Label(z),{top:20,left:150});
var d=new qx.ui.form.DateField();
this.getRoot().add(d,{top:35,left:150});
d.setValue(new Date());
var l=new qx.util.format.DateFormat(A);
var m=new qx.util.format.DateFormat(B);
var n=new qx.util.format.DateFormat(C);
d.setDateFormat(m);
var k=new qx.ui.form.Button(A);
k.setWidth(120);
this.getRoot().add(k,{top:60,left:150});
k.addListener(D,function(e){d.setDateFormat(l);
});
var f=new qx.ui.form.Button(B);
f.setWidth(120);
this.getRoot().add(f,{top:88,left:150});
f.addListener(D,function(e){d.setDateFormat(m);
});
var g=new qx.ui.form.Button(C);
g.setWidth(120);
this.getRoot().add(g,{top:116,left:150});
g.addListener(D,function(e){d.setDateFormat(n);
});
this.getRoot().add(new qx.ui.basic.Label(u),{top:20,left:280});
var c=new qx.ui.form.DateField();
this.getRoot().add(c,{top:35,left:280});
var o=new qx.ui.form.Button(w);
o.setWidth(120);
this.getRoot().add(o,{top:60,left:280});
o.addListener(D,function(e){c.setValue(new Date());
});
var h=new qx.ui.form.Button(q);
h.setWidth(120);
this.getRoot().add(h,{top:88,left:280});
h.addListener(D,function(e){c.resetValue();
});
this.getRoot().add(new qx.ui.basic.Label(s),{top:20,left:410});
var j=new qx.ui.form.DateField();
this.getRoot().add(j,{top:35,left:410});
var i=new qx.ui.basic.Label();
this.getRoot().add(i,{left:410,top:88});
var a=new qx.ui.form.Button(p);
a.setWidth(120);
this.getRoot().add(a,{left:410,top:60});
a.addListener(D,function(e){i.setValue(j.getValue()+x);
});
}}});
})();
