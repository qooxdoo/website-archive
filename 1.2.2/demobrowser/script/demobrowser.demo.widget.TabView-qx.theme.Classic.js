...
(function(){var n="Page #",m="execute",l="icon/32/apps/utilities-terminal.png",k="icon/16/apps/utilities-terminal.png",j="icon/16/apps/utilities-calculator.png",h="demobrowser.demo.widget.TabView",g="bottom",f="Notes",d="Remove first page",c="Layout",D="icon/16/apps/utilities-help.png",C="Add new page",B="changeSelection",A="Calculator...",z="icon/16/apps/utilities-notes.png",y="Bar Position",x="top",w="Calculator",v="right",u="Help",s="Help...",t="Notes...",q="Layout-Settings",r="Remove last page",o="left",p=" with close button.";
...
},getTabView1:function(){var G=new qx.ui.tabview.TabView();
G.setWidth(500);
var K=new qx.ui.tabview.Page(c,k);
K.setLayout(new qx.ui.layout.VBox());
K.add(new qx.ui.basic.Label(q));
G.add(K);
var I=new qx.ui.tabview.Page(f,z);
I.setLayout(new qx.ui.layout.VBox());
I.add(new qx.ui.basic.Label(t));
G.add(I);
var J=new qx.ui.tabview.Page(w,j);
J.setLayout(new qx.ui.layout.VBox());
J.add(new qx.ui.basic.Label(A));
G.add(J);
var H=new qx.ui.tabview.Page(u,D);
H.setLayout(new qx.ui.layout.VBox());
H.add(new qx.ui.basic.Label(s));
G.add(H);
return G;
},getTabView2:function(){var E=new qx.ui.tabview.TabView();
E.setWidth(500);

for(var i=1;i<=20;i++){var F=new qx.ui.tabview.Page(n+i,k);
F.setLayout(new qx.ui.layout.VBox());
F.setShowCloseButton(true);
F.add(new qx.ui.basic.Label(n+i+p));
E.add(F);
}return E;
...
for(var i=1;i<=3;i++){var W=new qx.ui.tabview.Page(n+i,l);
W.setLayout(new qx.ui.layout.VBox(4));
N.add(W);
W.add(new qx.ui.basic.Label(n+i));
}var P=N.getChildren()[0];
var U=new qx.ui.basic.Label(y);
var S=new qx.ui.form.RadioButton(x);
var M=new qx.ui.form.RadioButton(g);
var R=new qx.ui.form.RadioButton(o);
...
V.addListener(B,function(e){this.setBarPosition(e.getData()[0].getLabel());
},N);
R.setValue(true);
var O=new qx.ui.form.Button(C);
var Q=new qx.ui.form.Button(d);
var L=new qx.ui.form.Button(r);
P.add(new qx.ui.core.Spacer(10,10));
P.add(O);
P.add(Q);
P.add(L);
O.addListener(m,function(e){var X=N.getChildren().length+1;
var Y=new qx.ui.tabview.Page(n+X,l);
N.add(Y);
});
Q.addListener(m,function(e){var bb=N.getChildren();

if(bb.length>0){N.remove(bb[0]);
}});
L.addListener(m,function(e){var ba=N.getChildren();

if(ba.length>0){N.remove(ba[ba.length-1]);
}});
return N;
}}});
})();
