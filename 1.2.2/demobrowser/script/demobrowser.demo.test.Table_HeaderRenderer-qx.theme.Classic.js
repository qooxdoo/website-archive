...
r.setToolTip(g);
var p={name:[i],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var q=this._getNewHeaderContainer();
qx.util.Permutation.permute(p,function(j){var k=r.createHeaderCell(j);
q.add(k);
r.updateHeaderCell(j,k);
});
},testIconRenderer:function(){var o=new qx.ui.table.headerrenderer.Icon(f);
o.setToolTip(g);
var m={name:[i],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
...
},_getNewHeaderContainer:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
l.addListener(d,function(e){e.getTarget().addState(h);
});
l.addListener(a,function(e){e.getTarget().removeState(h);
});
