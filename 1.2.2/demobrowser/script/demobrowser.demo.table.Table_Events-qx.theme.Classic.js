...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.table.Table_Events-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"13c81fb4b0d0"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var o="px",n="Cell ",m="x",l="demobrowser.demo.table.MUtil",k="500px",j="Column #",h="#FFE",g="div",f="absolute";
qx.Mixin.define(l,{construct:function(){this._tableLeft=10;
},members:{getTableMock:function(){var s=this.getColumnModelMock();
var q=this.getModelMock();
var r=new qx.ui.table.selection.Model();
var t=new qx.ui.table.selection.Manager();
t.setSelectionModel(r);
var p={getTableModel:function(){return q;
},getTableColumnModel:function(){return s;
},getRowHeight:function(){return 20;
},getForceLineHeight:function(){return true;
},getSelectionModel:function(){return r;
},getDataRowRenderer:function(){return new qx.ui.table.rowrenderer.Default(p);
},updateContent:function(){},setFocusedCell:function(u,v){},getKeepFirstVisibleRowComplete:function(){return true;
},_updateScrollBarVisibility:function(){},getSelectionManager:function(){return t;
},getNewTablePaneHeader:function(K){return function(M){var N=new qx.ui.table.pane.Header(M);
return N;
};
...
},getColumnWidth:function(b){return 100;
},setColumnWidth:function(E,F){},getVisibleX:function(x){return x;
},getHeaderCellRenderer:function(O){return new qx.ui.table.headerrenderer.Default();
...
},getColumnLeft:function(a){return a*100;
},getTotalWidth:function(){return 4*100;
}};
return P;
},getModelMock:function(){return {getSortColumnIndex:function(){return 0;
},isSortAscending:function(){return true;
},isColumnSortable:function(z){return true;
},getColumnName:function(e){return j+e;
...
for(var i=0;i<4;i++){B.push(n+i+m+A);
}return B;
},getValue:function(Q,R){return n+Q+m+R;
}};
},getPaneMock:function(){return {getFirstVisibleRow:function(){return 0;
}};
},getScrollerMock:function(){var I=this.getTableMock();
var H=this.getPaneModelMock();
var J=this.getPaneMock();
return {getTable:function(){return I;
},getTablePaneModel:function(){return H;
},getTablePane:function(){return J;
}};
},_getNewTableDiv:function(w){var y=qx.bom.Element.create(g);
qx.bom.element.Style.setStyles(y,{position:f,left:this._tableLeft+o,width:(w||150)+o,top:20+o,height:k,backgroundColor:h});
this._tableLeft+=(w||150)+20;
...
qx.Class.define(c,{extend:qx.application.Standalone,include:demobrowser.demo.table.MUtil,members:{__MO:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
},showDialog:function(m){if(!this.__MO){var p=this.__MO=new qx.ui.window.Window().set({modal:true,showMinimize:false,showMaximize:false,width:180,contentPadding:[10,10,10,10]});
p.moveTo(315,100);
...
}this.__MO.getChildren()[1].setValue(m);
this.__MO.open();
this.__MO.getChildren()[2].focus();
...
var S=this._eventsWin=new qx.ui.window.Window(l).set({height:400,width:290,showClose:false,showMinimize:false,contentPadding:0});
S.setLayout(new qx.ui.layout.Canvas());
S.open();
this.getRoot().add(S,{left:670,top:10});
this._events=new qx.ui.table.model.Simple();
this._events.setColumns([q,w,d]);
this._events.setData([]);
var R=new qx.ui.table.Table(this._events);
R.getTableColumnModel().setColumnWidth(0,150);
R.getTableColumnModel().setColumnWidth(1,60);
R.getTableColumnModel().setColumnWidth(2,60);
S.add(R,{edge:0});
},createTable:function(){var O=this.createRandomRows(50);
var K=this._tableModel=new qx.ui.table.model.Simple();
K.setColumns([x,g,v,i]);
K.setData(O);
K.setColumnEditable(1,true);
K.setColumnEditable(2,true);
var P=new qx.ui.table.Table(K);
P.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var L=P.getTableColumnModel();
L.setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
var Q=function(e){this._events.addRows([[e.getType(),k,k,k]],0);
};
var N=function(e){this._events.addRows([[e.getType(),e.getRow(),e.getColumn()]],0);
};
var M=function(e){var J=e.getData();
this._events.addRows([[e.getType(),J.ascending?B:n,J.columnIndex]],0);
};
P.addListener(z,Q,this);
P.addListener(j,Q,this);
P.addListener(b,Q,this);
P.addListener(a,Q,this);
P.addListener(m,N,this);
P.addListener(r,N,this);
P.addListener(G,N,this);
K.addListener(c,M,this);
K.addListener(t,Q,this);
P.setContextMenu(this.getContextMenu());
return P;
},createControls:function(){var ba=new qx.ui.toolbar.ToolBar();
var X,Y;
Y=new qx.ui.toolbar.Part();
ba.add(Y);
X=new qx.ui.toolbar.CheckBox(y,H).set({value:true});
Y.add(X);
X.addListener(f,function(e){if(X.isValue()){this._events.setData([]);
this._eventsWin.open();
}else{this._eventsWin.close();
}},this);
return ba;
},getContextMenu:function(){var T=new qx.ui.menu.Menu();
var V=new qx.ui.menu.Button(E,h);
var W=new qx.ui.menu.Button(p,I);
var U=new qx.ui.menu.Button(o,A);
T.add(V);
T.add(W);
T.add(U);
return T;
