...
(function(){var C="changeValue",B="I am a box",A=" invalidate all shown widgets. Try the invalid focus and tooltip.",z="root",y="RadioGroup 2",x=")",w="disable tooltips",v="RadioGroup 1",u="Invalid (",t="File 3",o="demobrowser.demo.ui.FormInvalids",s="disabled",r="<b>Validation</b><br/>Press the button to",n="File 1",m="Item ",q="File 2",p="invalid";
...
var k=[];
k.push(new qx.ui.form.Spinner());
this.getRoot().add(k[0],{left:20,top:70});
k.push(new qx.ui.form.Slider());
k[1].setWidth(200);
this.getRoot().add(k[1],{left:20,top:100});
k.push(new qx.ui.form.TextField());
this.getRoot().add(k[2],{left:20,top:130});
k.push(new qx.ui.form.TextArea());
this.getRoot().add(k[3],{left:20,top:160});
k.push(new qx.ui.form.PasswordField());
this.getRoot().add(k[4],{left:20,top:240});
k.push(new qx.ui.form.ComboBox());
this.getRoot().add(k[5],{left:20,top:270});
k.push(new qx.ui.form.SelectBox());
this.getRoot().add(k[6],{left:20,top:300});
k.push(new qx.ui.form.CheckBox());
this.getRoot().add(k[7],{left:20,top:330});
k.push(new qx.ui.form.RadioButton());
this.getRoot().add(k[8],{left:20,top:350});
k.push(new qx.ui.groupbox.GroupBox(B));
this.getRoot().add(k[9],{left:240,top:70});
k.push(new qx.ui.groupbox.RadioGroupBox(B));
this.getRoot().add(k[10],{left:240,top:170});
k.push(new qx.ui.groupbox.CheckGroupBox(B));
this.getRoot().add(k[11],{left:240,top:270});
k.push(new qx.ui.form.List());
this.getRoot().add(k[12],{left:390,top:70});

for(var i=0;i<10;i++){k[12].add(new qx.ui.form.ListItem(m+(i+1)));
}k.push(new qx.ui.form.DateField());
this.getRoot().add(k[13],{left:390,top:280});
k.push(new qx.ui.control.DateChooser());
this.getRoot().add(k[14],{left:530,top:70});
var g=new qx.ui.form.RadioGroup();
var a=new qx.ui.form.RadioButton(v);
g.add(a);
this.getRoot().add(a,{left:530,top:250});
var b=new qx.ui.form.RadioButton(y);
g.add(b);
this.getRoot().add(b,{left:530,top:270});
k.push(g);
var f=new qx.ui.tree.Tree();
k.push(f);
this.getRoot().add(f,{left:530,top:300});
var l=new qx.ui.tree.TreeFolder(z);
l.setOpen(true);
f.setRoot(l);
l.add(new qx.ui.tree.TreeFile(n));
l.add(new qx.ui.tree.TreeFile(q));
l.add(new qx.ui.tree.TreeFile(t));
var d=new qx.ui.form.ToggleButton(p);
this.getRoot().add(d,{left:260,top:20});
d.addListener(C,function(e){for(var i=0;i<k.length;i++){k[i].setInvalidMessage(u+i+x);
k[i].setValid(!e.getData());
}},this);
var h=new qx.ui.form.ToggleButton(s);
this.getRoot().add(h,{left:330,top:20});
h.addListener(C,function(e){for(var i=0;i<k.length;i++){k[i].setEnabled(!e.getData());
}},this);
var c=new qx.ui.form.ToggleButton(w);
this.getRoot().add(c,{left:410,top:20});
c.addListener(C,function(e){qx.ui.tooltip.Manager.getInstance().setShowInvalidToolTips(!e.getData());
},this);
var j=new qx.ui.basic.Label();
j.setRich(true);
j.setWidth(250);
j.setValue(r+A);
this.getRoot().add(j,{left:20,top:10});
}}});
})();
...
qx.Class.define(b,{extend:qx.ui.groupbox.GroupBox,implement:[qx.ui.form.IExecutable,qx.ui.form.IBooleanForm,qx.ui.form.IModel],include:[qx.ui.form.MModelProperty],properties:{appearance:{refine:true,init:d}},events:{"changeValue":a,"execute":c},members:{_createChildControlImpl:function(l){var m;
