...
(function(){var d="test1",c="demobrowser.demo.bom.Clip";
...
qx.log.Logger.debug("Clip init: "+h.left+","+h.top+"  "+h.width+","+h.height);
},set0:function(){var i=document.getElementById(d);
...
},set1:function(){var m=document.getElementById(d);
...
},set2:function(){var a=document.getElementById(d);
qx.log.Logger.debug("Setting to: 20,20  120,null");
qx.bom.element.Clip.set(a,{left:20,top:20,width:120});
var b=qx.bom.element.Clip.get(a)||{};
qx.log.Logger.debug("Clip after: "+b.left+","+b.top+"  "+b.width+","+b.height);
},set3:function(){var k=document.getElementById(d);
...
},set4:function(){var e=document.getElementById(d);
...
},reset:function(){var o=document.getElementById(d);
