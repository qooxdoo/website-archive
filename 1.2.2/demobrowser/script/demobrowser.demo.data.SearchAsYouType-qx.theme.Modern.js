...
this.__MX=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__MX:null,__MW:null,_applySearchString:function(f,g){var h=qx.util.TimerManager.getInstance();
if(this.__MX!=null){h.stop(this.__MX);
this.__MX=null;
}this.__MX=h.start(function(){this.__MW.update();
this.__MX=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__MW=null;
}});
})();
