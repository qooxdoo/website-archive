...
var k=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(k);
k.add(this.getBox1());
k.add(this.getBox2());
k.add(this.getBox3());
...
k.add(this.getBox5());
k.add(this.getBox6());
},getBox1:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,allowGrowY:false});
l.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:1});
l.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:2});
l.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:3});
return l;
},getBox2:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,allowGrowY:false});
g.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:30}),{flex:1});
g.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:2});
g.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:100}),{flex:3});
return g;
},getBox3:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,allowGrowY:false});

for(var i=0;i<25;i++){h.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,height:5}),{flex:1});
}return h;
},getBox4:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,minHeight:300,allowGrowY:false});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:60}),{flex:1});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:60}),{flex:2});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:60}),{flex:3});
return a;
},getBox5:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,minHeight:0,decorator:e,backgroundColor:c,allowGrowY:false});
...
return j;
},getBox6:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,decorator:e,backgroundColor:c,allowGrowY:false});
