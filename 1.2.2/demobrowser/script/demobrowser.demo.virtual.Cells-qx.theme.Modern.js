...
(function(){var n="",m="' ",l="<b>HTML</b>",k="px;",j="Juhu",i="testImageCell",h="qx.theme",g="</div>",f="<div ",e="testNumberCell",H="class='",G="width:",F="testHtmlCell",E="testDateCell",D=">",C="height:",B="testStringCell",A="testBooleanCellCustomImage",z="demobrowser.demo.virtual.Cells",y="testBooleanCell",u="foobar!",v="qx.theme.Modern",s="icon/32/apps/utilities-notes.png",t="medium",q="main",r="icon/16/emotes/face-sad.png",o="icon/16/apps/internet-feed-reader.png",p="icon/16/emotes/face-smile.png",w="This is a feed reader!",x="style='";
...
var bb=new qx.ui.layout.HBox(5);
this.topContainer=new qx.ui.container.Composite(bb);
this.runTest(B);
this.runTest(e);
this.runTest(E);
this.runTest(F);
if(qx.core.Setting.get(h)==v){this.runTest(i);
this.runTest(y);
this.runTest(A);
}this.getRoot().add(this.topContainer,{edge:5});
},runTest:function(O){this.setUp();
this[O]();
...
},testStringCell:function(){var bo={value:[j,l,n,null],states:[{},{selected:1}]};
var bn=new qx.ui.virtual.cell.String;
qx.util.Permutation.permute(bo,function(Y){var ba=this.__Mw(bn,Y.value,Y.states);
this.container.add(ba);
},this);
},testNumberCell:function(){var br={value:[-1.666666,0,null],format:[null,new qx.util.format.NumberFormat().set({maximumFractionDigits:2})],states:[{},{selected:1}]};
var bs=new qx.ui.virtual.cell.Number();
qx.util.Permutation.permute(br,function(bv){if(bv.format){bs.setNumberFormat(bv.format);
}else{bs.resetNumberFormat();
}var bw=this.__Mw(bs,bv.value,bv.states);
this.container.add(bw);
},this);
},testDateCell:function(){var U={value:[new Date(),null],format:[null,new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(t))],states:[{},{selected:1}]};
var V=new qx.ui.virtual.cell.Date();
qx.util.Permutation.permute(U,function(K){if(K.format){V.setDateFormat(K.format);
}else{V.resetDateFormat();
}var L=this.__Mw(V,K.value,K.states);
this.container.add(L);
},this);
},testHtmlCell:function(){var bt={value:[j,l,n,null],states:[{},{selected:1}]};
var bu=new qx.ui.virtual.cell.Html;
qx.util.Permutation.permute(bt,function(I){var J=this.__Mw(bu,I.value,I.states);
this.container.add(J);
},this);
},testImageCell:function(){var bc={value:[{url:o,tooltip:w},{url:s,tooltip:u},null],states:[{},{selected:1}]};
var bd=new qx.ui.virtual.cell.Image;
qx.util.Permutation.permute(bc,function(a){var b=this.__Mw(bd,a.value,a.states);
this.container.add(b);
},this);
},testBooleanCell:function(){var bp={value:[true,false,null],states:[{},{selected:1}]};
var bq=new qx.ui.virtual.cell.Boolean;
qx.util.Permutation.permute(bp,function(c){var d=this.__Mw(bq,c.value,c.states);
...
N.setIconFalse(r);
N.setIconTrue(p);
qx.util.Permutation.permute(M,function(W){var X=this.__Mw(N,W.value,W.states);
this.container.add(X);
},this);
},__Mw:function(be,bf,bg){var bk=100;
var bi=30;
var bm=new qx.ui.embed.Html().set({width:bk,height:bi,decorator:bg.selected?null:q});
var bh=be.getCellProperties(bf,bg);
var bj=bh.insets;
var bl=[f,x,this._getCellSizeStyle(bk,bi,bj[0],bj[1]),bh.style,m,H,bh.classes,m,bh.attributes,D,bh.content,g].join(n);
bm.setHtml(bl);
return bm;
},_getCellSizeStyle:function(P,Q,R,S){var T=n;
...
},members:{__yJ:16,__yK:16,_aliasManager:null,__yL:function(u){var x=qx.util.ResourceManager.getInstance();
...
},__yM:function(I){if(typeof (I)==h){I={url:I};
...
var C=this.__yM(this._identifyImage(z));
var G=qx.bom.client.Engine.GECKO&&qx.bom.client.Engine.VERSION<1.9;
var D=C.tooltip?m+C.tooltip+o:s;
var B={width:C.width+r,height:C.height+r,display:G?a:i,verticalAlign:b,position:c};
...
this.__DL=qx.util.AliasManager.getInstance();
},properties:{appearance:{refine:true,init:b},iconTrue:{check:f,themeable:true,apply:c},iconFalse:{check:f,themeable:true,apply:e}},members:{__DM:null,__DN:null,__DL:null,_applyIconTrue:function(h){this.__DM=this.__DL.resolve(h);
},_applyIconFalse:function(a){this.__DN=this.__DL.resolve(a);
},_identifyImage:function(g){return g==true?this.__DM:this.__DN;
}}});
})();
