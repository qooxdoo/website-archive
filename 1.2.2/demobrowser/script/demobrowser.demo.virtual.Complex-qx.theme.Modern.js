...
(function(){var i=" / ",h="row",g="foobar!",f="column",e="",d="demobrowser.demo.virtual.DemoLayer",c="mouseover",b="changeValue",a="qx.ui.basic.Atom";
...
this.__My=[];
},members:{_pool:null,__My:null,getCellData:function(t,u){if(!this.__My[t]){this.__My[t]=[];
}
if(!this.__My[t][u]){this.__My[t][u]={label:this.__Mz(),icon:this.__MA()};
}return this.__My[t][u];
},getCellWidget:function(l,m){var n;

if(m%2==0){n=this._pool.atom.pop();

if(!n){n=new qx.ui.basic.Atom();
n.addListener(c,function(){var k=this.__MA();
n.setIcon(k);
this.__My[l][m].icon=k;
},this);
}n.set(this.getCellData(l,m));
}else{n=this._pool.checkbox.pop();

if(!n){n=new qx.ui.form.CheckBox();
n.addListener(b,function(){this.setLabel(this.getLabel()==g?n.getUserData(h)+i+n.getUserData(f):g);
},n);
}n.set({value:l%2==0,label:l+i+m});
}n.setUserData(h,l);
n.setUserData(f,m);
return n;
},poolCellWidget:function(o){if(o.classname==a){this._pool.atom.push(o);
}else{this._pool.checkbox.push(o);
}},__Mz:function(){var name=e;

for(var j=0;j<10;j++){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);
}return name;
},__MA:function(){var p="icon/";
var r="places/";
var s=["folder.png","user-trash.png","network-server.png","network-workgroup.png","user-desktop.png"];
var q=Math.floor(Math.random()*4);
return (p+16+"/"+r+s[q]);
}},destruct:function(){this._pool=this.__My=null;
}});
})();
