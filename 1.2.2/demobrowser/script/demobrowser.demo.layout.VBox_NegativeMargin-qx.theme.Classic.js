...
var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(y);
y.add(this.getBox1());
y.add(this.getBox2());
y.add(this.getBox3());
...
y.add(this.getBox6());
y.add(this.getBox7());
},getBox1:function(){var t=new qx.ui.layout.VBox();
var v=new qx.ui.container.Composite(t).set({decorator:i,backgroundColor:h,width:140,allowGrowY:false});
var x=new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,maxWidth:100,alignX:c});
var w=new qx.ui.core.Widget().set({decorator:i,backgroundColor:d,maxWidth:100,alignX:e});
var u=new qx.ui.core.Widget().set({decorator:i,backgroundColor:g,maxWidth:100,alignX:b});
v.add(x);
v.add(w);
v.add(u);
w.setMarginTop(-10);
...
F.setMarginTop(-10);
return G;
},getBox3:function(){var z=new qx.ui.layout.VBox();
...
A.setMarginTop(-10);
return B;
},getBox4:function(){var J=new qx.ui.layout.VBox();
...
K.setMarginTop(-10);
return L;
},getBox5:function(){var o=new qx.ui.layout.VBox();
var q=new qx.ui.container.Composite(o).set({decorator:i,backgroundColor:h,width:140,height:300,allowGrowY:false});
