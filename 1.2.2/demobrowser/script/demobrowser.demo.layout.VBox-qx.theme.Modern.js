...
a.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
return a;
},getBox2:function(){var D=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:j,backgroundColor:h,minWidth:60,allowGrowY:false});
D.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxWidth:40,alignX:c}));
D.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxWidth:40,alignX:d}));
D.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxWidth:40,alignX:b}));
return D;
...
var r=new qx.ui.container.Composite(q).set({decorator:j,backgroundColor:h,height:300,allowGrowY:false});
q.setSpacing(5);
q.setAlignY(g);
r.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
r.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
r.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
return r;
...
var n=new qx.ui.container.Composite(l).set({decorator:j,backgroundColor:h,height:300,allowGrowY:false});
l.setSpacing(5);
l.setAlignY(f);
var p=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,marginBottom:10});
var o=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,marginBottom:10,marginTop:20});
var m=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,marginBottom:10});
n.add(p);
n.add(o);
n.add(m);
return n;
},getBox7:function(){var s=new qx.ui.layout.VBox();
