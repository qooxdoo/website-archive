...
(function(){var q="execute",p="appear",o="changeSelection",n="Trash",m="mode",l="Windows (C:)",k="Documents (D:)",j="Add before",h="Add after",g="Add at begin",Q="Inbox",P="Desktop",O="Show open button:",N="New tree item name: ",M="auto",L="Hello",K="Presets",J="Data 123213234325345234523453453245",I="demobrowser.demo.animation.Tree_Highlight",H="Network",x="Control",y="Sent",v="Files",w="Remove tree item",t="Add file",u="Workspace",r="Junk #",s="Tree",z="never",A="Add folder",C="Root",B="always",E="Move to parent",D="Reset tree",G="Edit",F="Remove all children";
...
var bA=new qx.ui.groupbox.GroupBox(s).set({contentPadding:[4,4,4,4]});
bA.setLayout(new qx.ui.layout.Canvas());
this._container.add(bA);
this._treeGroup=bA;
var bB=this.getTree();
bA.add(bB,{edge:0});
this._tree=bB;
this._container.add(this.getCommandFrame());
},getTree:function(){var bh=new qx.ui.tree.Tree().set({width:200,height:400});
var bm=new qx.ui.tree.TreeFolder(C);
bm.setOpen(true);
bh.setRoot(bm);
var bk=new qx.ui.tree.TreeFolder(P);
bk.setOpen(true);
bm.add(bk);
var bc=new qx.ui.tree.TreeFolder(v);
var ba=new qx.ui.tree.TreeFolder(u);
var bb=new qx.ui.tree.TreeFolder(H);
var Y=new qx.ui.tree.TreeFolder(n);
bk.add(bc,ba,bb,Y);
var bi=new qx.ui.tree.TreeFile(l);
var X=new qx.ui.tree.TreeFile(k);
ba.add(bi,X);
var bl=new qx.ui.tree.TreeFolder(Q);
var bd=new qx.ui.tree.TreeFolder(K);
var bg=new qx.ui.tree.TreeFolder(y);
var bf=new qx.ui.tree.TreeFolder(n);

for(var i=0;i<100;i++){bf.add(new qx.ui.tree.TreeFile(r+i));
}var bj=new qx.ui.tree.TreeFolder(J);
var be=new qx.ui.tree.TreeFolder(G);
bl.add(bd,bg,bf,bj,be);
bm.add(bl);
return bh;
},getCommandFrame:function(){var bv=new qx.ui.groupbox.GroupBox(x);
bv.setLayout(new qx.ui.layout.Grid(3,5));
var bx=0;
bv.add(new qx.ui.basic.Label(N).set({paddingTop:4}),{row:bx,column:0});
this.inputItemName=new qx.ui.form.TextField(L);
bv.add(this.inputItemName,{row:bx++,column:1});
this.btnAddFolder=new qx.ui.form.Button(A);
this.btnAddFolder.addListener(q,this._addFolder,this);
bv.add(this.btnAddFolder,{row:bx++,column:0,colSpan:2});
this.btnAddFile=new qx.ui.form.Button(t);
this.btnAddFile.addListener(q,this._addFile,this);
bv.add(this.btnAddFile,{row:bx++,column:0,colSpan:2});
this.btnAddAfter=new qx.ui.form.Button(h);
this.btnAddAfter.addListener(q,this._addAfter,this);
bv.add(this.btnAddAfter,{row:bx++,column:0,colSpan:2});
this.btnAddBefore=new qx.ui.form.Button(j);
this.btnAddBefore.addListener(q,this._addBefore,this);
bv.add(this.btnAddBefore,{row:bx++,column:0,colSpan:2});
this.btnAddBegin=new qx.ui.form.Button(g);
this.btnAddBegin.addListener(q,this._addBegin,this);
bv.add(this.btnAddBegin,{row:bx++,column:0,colSpan:2});
bv.add(new qx.ui.core.Spacer(5,5),{row:bx++,column:0});
this.btnRemove=new qx.ui.form.Button(w);
this.btnRemove.addListener(q,this._removeTreeItem,this);
bv.add(this.btnRemove,{row:bx++,column:0,colSpan:2});
this.btnRemoveAll=new qx.ui.form.Button(F);
this.btnRemoveAll.addListener(q,this._removeAll,this);
bv.add(this.btnRemoveAll,{row:bx++,column:0,colSpan:2});
bv.add(new qx.ui.core.Spacer(5,5),{row:bx++,column:0});
this.btnMoveToParent=new qx.ui.form.Button(E);
this.btnMoveToParent.addListener(q,this._moveToParent,this);
bv.add(this.btnMoveToParent,{row:bx++,column:0,colSpan:2});
bv.add(new qx.ui.core.Spacer(5,5),{row:bx++,column:0});
bv.add(new qx.ui.basic.Label(O),{row:bx,column:0});
var bt=[B,z,M];
this.showOpenButtons={};
this.mgrShowRootOpen=new qx.ui.form.RadioGroup();

for(var i=0;i<bt.length;i++){var bw=bt[i];
var bu=new qx.ui.form.RadioButton(bw).set({value:bw==this._tree.getRootOpenClose()});
bu.setUserData(m,bw);
this.showOpenButtons[bw]=bu;
this.mgrShowRootOpen.add(bu);
bv.add(bu,{row:bx++,column:1});
}this.mgrShowRootOpen.addListener(o,this._onChangeShowOpen,this);
bv.add(new qx.ui.core.Spacer(5,5),{row:bx++,column:0});
this.btnReset=new qx.ui.form.Button(D);
this.btnReset.addListener(q,this._resetTree,this);
bv.add(this.btnReset,{row:bx++,column:0,colSpan:2});
this._tree.addListener(o,this._updateControls,this);
this._updateControls();
return bv;
},_addFolder:function(){var V=this._tree.getSelection()[0];
var W=new qx.ui.tree.TreeFolder(this.inputItemName.getValue());
W.addListenerOnce(p,function(){var bs=new qx.fx.effect.core.Highlight(W.getContainerElement().getDomElement());
bs.start();
},this);
V.setOpen(true);
V.add(W);
},_addFile:function(){var by=this._tree.getSelection()[0];
var bz=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bz.addListenerOnce(p,function(){var bo=new qx.fx.effect.core.Highlight(bz.getContainerElement().getDomElement());
bo.start();
},this);
by.setOpen(true);
by.add(bz);
},_addBefore:function(){var a=this._tree.getSelection()[0];
var b=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
b.addListenerOnce(p,function(){var bD=new qx.fx.effect.core.Highlight(b.getContainerElement().getDomElement());
bD.start();
},this);
a.getParent().addBefore(b,a);
},_addAfter:function(){var S=this._tree.getSelection()[0];
var T=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
T.addListenerOnce(p,function(){var bC=new qx.fx.effect.core.Highlight(T.getContainerElement().getDomElement());
bC.start();
},this);
S.getParent().addAfter(T,S);
},_addBegin:function(){var bE=this._tree.getSelection()[0];
var bF=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bF.addListenerOnce(p,function(){var U=new qx.fx.effect.core.Highlight(bF.getContainerElement().getDomElement());
U.start();
},this);
bE.getParent().addAtBegin(bF);
},_removeTreeItem:function(){var bp=this._tree.getSelection()[0];
var parent=bp.getParent();
parent.remove(bp);
},_removeAll:function(){var bn=this._tree.getSelection()[0];
bn.removeAll();
},_moveToParent:function(){var R=this._tree.getSelection()[0];
var parent=R.getParent();
parent.remove(R);
parent.getParent().add(R);
this._updateControls();
},_onChangeShowOpen:function(){var bq=this._tree.getSelection()[0];

if(bq!=null){var br=this.mgrShowRootOpen.getSelection()[0].getUserData(m);
bq.setOpenSymbolMode(br);
}},_resetTree:function(){this._treeGroup.remove(this._tree);
this._tree=this.getTree();
this._treeGroup.add(this._tree,{edge:0});
this._tree.addListenerOnce(p,function(){this._tree.addListener(o,this._updateControls,this);
},this);
},_updateControls:function(){var c=this._tree.getSelection()[0];

if(!c){this.btnAddFolder.setEnabled(false);
...
var d=f==-1;
var e=c instanceof qx.ui.tree.TreeFolder;
this.btnAddFolder.setEnabled(e);
this.btnAddFile.setEnabled(e);
this.btnAddBefore.setEnabled(!d);
this.btnAddAfter.setEnabled(!d);
this.btnAddBegin.setEnabled(!d);
this.btnRemove.setEnabled(!d);
this.btnRemoveAll.setEnabled(true);
this.mgrShowRootOpen.setEnabled(e);
this.showOpenButtons[c.getOpenSymbolMode()].setValue(true);
this.btnMoveToParent.setEnabled(f>0);
