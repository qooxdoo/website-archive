...
qx.Class.define(i,{extend:qx.application.Native,members:{__NH:null,main:function(){qx.application.Native.prototype.main.call(this);
var r=qx.util.ResourceManager.getInstance();
this.__NH=["http://qooxdoo.org","http://sourceforge.net","http://slashdot.org",r.toUri("demobrowser/demo/html/ModalWindow.html")];
var u=qx.bom.Input.create(l);
qx.bom.Input.setValue(u,k);
document.body.appendChild(u);
qx.event.Registration.addListener(u,m,function(e){var n={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};
this.window1=qx.bom.Window.open(this.__NH[0],g,n);
},this);
var t=qx.bom.Input.create(l);
qx.bom.Input.setValue(t,f);
document.body.appendChild(t);
qx.event.Registration.addListener(t,m,function(e){alert(qx.bom.Window.isClosed(this.window1));
},this);
var s=qx.bom.Input.create(l);
qx.bom.Input.setValue(s,j);
document.body.appendChild(s);
qx.event.Registration.addListener(s,m,function(e){var q={width:400,height:200,top:200,left:100,scrollbars:false};
this.window2=qx.bom.Window.open(this.__NH[3],a,q,true);
},this);
var w=qx.bom.Input.create(l);
qx.bom.Input.setValue(w,h);
document.body.appendChild(w);
qx.event.Registration.addListener(w,m,function(e){alert(qx.bom.Window.isClosed(this.window2));
},this);
var v=qx.bom.Input.create(l);
qx.bom.Input.setValue(v,d);
document.body.appendChild(v);
qx.event.Registration.addListener(v,m,function(e){var p={width:800,height:600,top:200,left:100,scrollbars:false};
var o=qx.bom.Window.getBlocker();
o.setBlockerColor(b);
o.setBlockerOpacity(0.5);
this.window3=qx.bom.Window.open(this.__NH[0],c,p,true,false);
},this);
...
qx.Class.define(m,{statics:{__It:null,__Iu:null,__Iv:null,__Iw:{"top":c,left:e,width:k,height:r,scrollbars:i,resizable:t},__Ix:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Iy:function(){return window.showModalDialog!=null;
},open:function(C,name,D,E,F){if(C==null){C=j;
}
if(name==null){name=g+new Date().getTime();
}
if(F==null){F=true;
}var G=this.__Iz(D,E&&F);

if(E){if(this.__Iy()&&F){return window.showModalDialog(C,[window.self],G);
}else{this.getBlocker().block();

if(this.__Iv==null){this.__Iv=new qx.event.Timer(500);
this.__Iv.addListener(l,this.__IA,this);
}this.__Iu=window.open(C,name,G);
this.__Iv.restart();
return this.__Iu;
}}else{return window.open(C,name,G);
}},__Iz:function(v,w){var x;
var A;
var y=[];

if(w&&this.__Iy()){for(var z in v){if(qx.bom.Window.__Iw[z]){var B=o;

if(z!=f&&z!=t){B=n;
}A=qx.bom.Window.__Iw[z]+h+v[z]+B;
y.push(A);
}else{qx.log.Logger.warn("Option '"+z+"' is not supported for modal windows.");
}}x=y.join(d);
}else{for(var z in v){if(qx.bom.Window.__Ix[z]){if(qx.lang.Type.isBoolean(v[z])){A=z+s+(v[z]?p:q);
}else{A=z+s+v[z];
}y.push(A);
}else{qx.log.Logger.warn("Option '"+z+"' is not supported for native windows.");
}}x=y.join(b);
}return x;
},__IA:function(){if(this.isClosed(this.__Iu)){this.getBlocker().unblock();
this.__Iv.stop();
}},getBlocker:function(){if(this.__It==null){this.__It=new qx.bom.Blocker;
}return this.__It;
},close:function(u){if(u){return u.close();
}},isClosed:function(a){var closed=true;

if(a){try{closed=a.closed;
}catch(H){}}return closed;
},moveTo:function(K,top,L){if(!qx.bom.Window.isClosed(K)){try{K.moveTo(L,top);
