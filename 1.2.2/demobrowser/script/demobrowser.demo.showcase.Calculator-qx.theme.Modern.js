...
(function(){var k="execute",j="-",i="+",h="n",g="/",f="*",d="=",c="sans-serif",b="Verdana",a=".",I="black",H="Del",G="C",F="5",E="7",D="__Nf",C="demobrowser.demo.showcase.Calculator",B="CE",A="solid",z="icon/22/apps/utilities-calculator.png",r="3",s="0",p="__Ng",q="8",n="6",o="4",l="Calculator",m="right",t="2",u="1",w="demobrowser.demo.showcase.CalculatorLogic",v="white",y="+/-",x="9";
qx.Class.define(C,{extend:qx.application.Standalone,members:{__Nf:null,__Ng:null,main:function(){qx.application.Standalone.prototype.main.call(this);
{};
this.__Ng=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var K=new qx.ui.window.Window(l,z);
K.setLayout(new qx.ui.layout.VBox(16));
var M=new qx.ui.decoration.Single(1,A,I);
var U=new qx.ui.container.Composite().set({minWidth:180,minHeight:280,padding:3,allowGrowX:true,allowGrowY:true});
var bf=new qx.ui.layout.Grid(5,5);
U.setLayout(bf);
this.__Nf=new qx.ui.basic.Label(this.__Ng.getCurrentValue().toString()).set({decorator:M,backgroundColor:v,allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:[b,c],bold:true}),textAlign:m});
this.__Nf.setEnabled(false);
var bg=new qx.bom.Font().set({size:14,family:[b,c],bold:true});
var ba=new qx.ui.form.Button(s).set({font:bg,minWidth:40});
var Y=new qx.ui.form.Button(u).set({font:bg,minWidth:40});
var X=new qx.ui.form.Button(t).set({font:bg,minWidth:40});
var W=new qx.ui.form.Button(r).set({font:bg,minWidth:40});
var be=new qx.ui.form.Button(o).set({font:bg,minWidth:40});
var bd=new qx.ui.form.Button(F).set({font:bg,minWidth:40});
var bc=new qx.ui.form.Button(n).set({font:bg,minWidth:40});
var bb=new qx.ui.form.Button(E).set({font:bg,minWidth:40});
var bi=new qx.ui.form.Button(q).set({font:bg,minWidth:40});
var bh=new qx.ui.form.Button(x).set({font:bg,minWidth:40});
var J=new qx.ui.form.Button(G).set({font:bg,minWidth:40});
var L=new qx.ui.form.Button(B).set({font:bg,minWidth:40});
var Q=new qx.ui.form.Button(H).set({font:bg,minWidth:40});
var P=new qx.ui.form.Button(y).set({font:bg,minWidth:40});
var S=new qx.ui.form.Button(a).set({font:bg,minWidth:40});
var O=new qx.ui.form.Button(i).set({font:bg,minWidth:40});
var V=new qx.ui.form.Button(j).set({font:bg,minWidth:40});
var T=new qx.ui.form.Button(f).set({font:bg,minWidth:40});
var R=new qx.ui.form.Button(g).set({font:bg,minWidth:40});
var N=new qx.ui.form.Button(d).set({font:bg,minWidth:40});
bf.setColumnFlex(0,1);
bf.setColumnFlex(1,1);
bf.setColumnFlex(2,1);
bf.setColumnFlex(3,1);
bf.setRowFlex(1,1);
bf.setRowFlex(2,1);
bf.setRowFlex(3,1);
bf.setRowFlex(4,1);
bf.setRowFlex(5,1);
bf.setRowFlex(6,1);
U.add(this.__Nf,{row:0,column:0,rowSpan:0,colSpan:4});
U.add(J,{row:1,column:2,rowSpan:1,colSpan:2});
U.add(L,{row:1,column:1});
U.add(Q,{row:1,column:0});
U.add(bb,{row:2,column:0});
U.add(bi,{row:2,column:1});
U.add(bh,{row:2,column:2});
U.add(R,{row:2,column:3});
U.add(be,{row:3,column:0});
U.add(bd,{row:3,column:1});
U.add(bc,{row:3,column:2});
U.add(T,{row:3,column:3});
U.add(Y,{row:4,column:0});
U.add(X,{row:4,column:1});
U.add(W,{row:4,column:2});
U.add(V,{row:4,column:3});
U.add(ba,{row:5,column:0});
U.add(P,{row:5,column:1});
U.add(S,{row:5,column:2});
U.add(O,{row:5,column:3});
U.add(N,{row:6,column:0,rowSpan:1,colSpan:4});
K.setWidth(260);
K.setMinWidth(260);
K.setHeight(260);
K.open();
...
K.add(U,{flex:1});
J.addListener(k,function(e){this.__Ng.cleanDisplay();
this.__Nf.setValue(this.__Ng.getCurrentValue().toString());
},this);
L.addListener(k,function(e){this.__Ng.clearEntry();

if(this.__Ng.getResult()!=null){this.__Nf.setValue(this.__Ng.getCurrentValue().toString());
}},this);
Q.addListener(k,function(e){this.__Ng.deleteNumber();
this.__Nf.setValue(this.__Ng.getCurrentValue().toString());
},this);
P.addListener(k,function(e){this.__Ng.setSign();

if(this.__Ng.getResult()!=null){this.__Nf.setValue(this.__Ng.getResult().toString());
}},this);
ba.addListener(k,function(e){this.__Ng.setCurrentValue(0);
this.__Nf.setValue(this.__Ng.getCurrentValue().toFixed(this.__Ng.getZeroCounter()).toString());
},this);
Y.addListener(k,function(e){this.__Ng.setCurrentValue(1);
this.__Nf.setValue(this.__Ng.getCurrentValue().toString());
},this);
X.addListener(k,function(e){this.__Ng.setCurrentValue(2);
this.__Nf.setValue(this.__Ng.getCurrentValue().toString());
},this);
W.addListener(k,function(e){this.__Ng.setCurrentValue(3);
this.__Nf.setValue(this.__Ng.getCurrentValue().toString());
},this);
be.addListener(k,function(e){this.__Ng.setCurrentValue(4);
this.__Nf.setValue(this.__Ng.getCurrentValue().toString());
},this);
bd.addListener(k,function(e){this.__Ng.setCurrentValue(5);
this.__Nf.setValue(this.__Ng.getCurrentValue().toString());
},this);
bc.addListener(k,function(e){this.__Ng.setCurrentValue(6);
this.__Nf.setValue(this.__Ng.getCurrentValue().toString());
},this);
bb.addListener(k,function(e){this.__Ng.setCurrentValue(7);
this.__Nf.setValue(this.__Ng.getCurrentValue().toString());
},this);
bi.addListener(k,function(e){this.__Ng.setCurrentValue(8);
this.__Nf.setValue(this.__Ng.getCurrentValue().toString());
},this);
bh.addListener(k,function(e){this.__Ng.setCurrentValue(9);
this.__Nf.setValue(this.__Ng.getCurrentValue().toString());
},this);
O.addListener(k,function(e){this.__Ng.calculate(i);

if(this.__Ng.getResult()!=null){this.__Nf.setValue(this.__Ng.getResult().toString());
}this.__Ng.resetCurrentValue();
},this);
V.addListener(k,function(e){this.__Ng.calculate(j);

if(this.__Ng.getResult()!=null){this.__Nf.setValue(this.__Ng.getResult().toString());
}this.__Ng.resetCurrentValue();
},this);
T.addListener(k,function(e){this.__Ng.calculate(f);

if(this.__Ng.getResult()!=null){this.__Nf.setValue(this.__Ng.getResult().toString());
}this.__Ng.resetCurrentValue();
},this);
R.addListener(k,function(e){this.__Ng.calculate(g);

if(this.__Ng.getResult()!=null){this.__Nf.setValue(this.__Ng.getResult().toString());
}this.__Ng.resetCurrentValue();
},this);
N.addListener(k,function(e){this.__Ng.calculate(d);

if(this.__Ng.getResult()!=null){this.__Nf.setValue(this.__Ng.getResult().toString());
}this.__Ng.resetCurrentValue();
},this);
S.addListener(k,function(e){this.__Ng.setComma();
},this);
...
},members:{__Nh:0,__Ni:0,__Nj:h,__Nk:0,__Nl:0,__Nm:0,__Nn:false,__No:1,__Np:0,__Nq:false,__Nr:0,setCurrentValue:function(bj){if(this.__Nn){this.__No*=10;
this.__Nh=this.__Nh+(bj/this.__No);

if(bj==0){this.__Np++;
}}else{this.__Nn=false;

if(this.__Nh<0){this.__Nh=this.__Nh*10-bj;
}else{this.__Nh=this.__Nh*10+bj;
}}},getZeroCounter:function(){return this.__Np;
},setComma:function(){this.__Nn=true;
},getCurrentValue:function(){return this.__Nh;
},resetCurrentValue:function(){this.__Nh=null;
},cleanDisplay:function(){this.__Nr=0;
this.__Nl=0;
this.__Nj=h;
this.__Np=0;
this.__No=1;
...
this.__Ni=0;
this.__Nq=false;
},setResult:function(bq){this.__Ni=bq;
},getResult:function(){return Math.round(this.__Ni*10000000)/10000000;
},setCurrentOperation:function(bl){this.__Nj=bl;
},getCurrentOperation:function(){return this.__Nj;
},clearEntry:function(){this.__Nq=false;
this.__Np=0;
this.__No=1;
this.__Nn=false;
this.__Nm++;
...
if(this.__Nm<2){this.__Nl=this.__Ni;
}
if(this.__Nk>=2){this.__Ni=0;
this.__Nk=0;
}},setSign:function(){this.__Nr++;

if(this.__Nr%2==0){this.__Nq=false;
}else{this.__Nq=true;
}
if(this.__Nh==null){this.__Nh=this.__Ni;
}this.__Nh=this.__Nh*(-1);

if(this.__Ni==0){this.__Ni=this.__Nh;
}
if(this.__Ni!=0){this.__Nl=this.__Ni;
this.__Ni=this.__Nh;
}},deleteNumber:function(){var bm=false;
var bp=false;

if(this.__Nh<0){this.__Nh=this.__Nh*(-1);
bp=true;
}
if(this.__Nh!=null){if(this.__Nh.toString().lastIndexOf(a)!=-1){this.__Nh=this.__Nh*this.__No;
bm=true;
}}var bn=this.__Nh%10;
var bo=bn/10;
this.__Nh=this.__Nh/10;
this.__Nh=this.__Nh-bo;

if(bm){this.__No/=10;
this.__Nh=this.__Nh/(this.__No);
bm=false;
}
if(bp){this.__Nh=this.__Nh*(-1);
bp=false;
}},calculate:function(bk){if(bk==i||bk==f||bk==g||bk==j||bk==d){this.__Nn=false;
this.__No=1;
this.__Np=0;

if(this.__Nj!=h){if(this.__Nj==i){if(this.__Ni==null){this.__Ni=this.__Nl;
}
if(this.__Nq){this.__Ni=this.__Nl+this.__Nh;
}else{this.__Ni=this.__Ni+this.__Nh;
}this.__Nh=this.__Ni;
this.__Nl=this.__Ni;
}
if(this.__Nj==j){if(this.__Ni==0){this.__Ni=this.__Nh;
this.__Nh=0;
}
if(this.__Ni==null){this.__Ni=this.__Nl;
}
if(this.__Nq){this.__Ni=this.__Nl-this.__Nh;
}else{this.__Ni=this.__Ni-this.__Nh;
}this.__Nh=this.__Ni;
...
if(this.__Nj==g){if(this.__Ni==0){this.__Ni=this.__Nh;
this.__Nh=1;
}
if(this.__Ni==null){this.__Ni=this.__Nl;
}
if(this.__Nh!=null){if(this.__Nh!=0){if(this.__Nq){this.__Ni=this.__Nl/this.__Nh;
}else{this.__Ni=this.__Ni/this.__Nh;
}}else{alert("You can't divide by 0!");
}}this.__Nh=this.__Ni;
this.__Nl=this.__Ni;
}
if(this.__Nj==f){if(this.__Ni==0){this.__Ni=1;
}
if(this.__Nh==null){this.__Nh=1;
}
if(this.__Ni==null){this.__Ni=this.__Nl;
}
if(this.__Nq){this.__Ni=this.__Nl*this.__Nh;
...
this.__Nl=this.__Ni;
}}else{this.__Ni=this.__Nh;
}
if(bk!=d){this.__Nj=bk;
}else{this.__Nk++;
this.__Ni=this.__Nl;
this.__Nj=h;
}this.__Nq=false;
