...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.virtual.CellEvents","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.CellEvents-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"cbce23e0b5fc"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var r=new qx.ui.virtual.core.Scroller(20,20,40,40).set({width:400,height:300});
this.layer=new qx.test.ui.virtual.layer.LayerSimple(this);
var q=r.getPane();
q.addListener(i,this._onCellClick,this);
q.addListener(c,this._onContextMenu,this);
q.addListener(a,this._onDblclickPane,this);
q.addLayer(this.layer);
...
},_onCellClick:function(e){var o=k+e.getRow()+m+e.getColumn()+n;
this.__Mx(o);
},_onContextMenu:function(e){var p=h+e.getRow()+m+e.getColumn()+n;
this.__Mx(p);
},_onDblclickPane:function(e){var s=g+e.getRow()+m+e.getColumn()+n;
this.__Mx(s);
},__Mx:function(t){this.logger.setHtml(this.logger.getHtml()+t);
