...
},_addEditor:function(n,o){o=qx.lang.Object.clone(o);
var p=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
var t=n.createCellEditor(o);
var u=new qx.ui.container.Composite().set({width:200,height:20});
t.setUserBounds(0,0,200,20);
u.add(t);
p.add(u);
var r=new qx.ui.form.Button(d);
p.add(r);
r.addListener(h,function(){s.setValue(n.getCellEditorValue(t)+m);
});
var q=new qx.ui.form.Button(e);
p.add(q);
q.addListener(h,function(){t.destroy();
qx.ui.core.queue.Manager.flush();
t=n.createCellEditor(o);
t.setUserBounds(0,0,200,20);
u.add(t);
qx.ui.core.queue.Manager.flush();
});
...
r.execute();
},testCheckBoxEditor:function(){var x={value:[true,false]};
qx.util.Permutation.permute(x,function(a){this._addEditor(new qx.ui.table.celleditor.CheckBox(),a);
},this);
},testComboBoxEditor:function(){var I={value:[m,l,g,2],table:[this.getTableMock()]};
var J=new qx.ui.table.celleditor.ComboBox();
J.setListData([i,l,j]);
qx.util.Permutation.permute(I,function(w){this._addEditor(J,w);
},this);
},testSelectBoxEditor:function(){var B={value:[m,l],table:[this.getTableMock()]};
var C=new qx.ui.table.celleditor.SelectBox();
C.setListData([i,l,j]);
qx.util.Permutation.permute(B,function(v){this._addEditor(C,v);
},this);
},testPasswordEditor:function(){var D={value:[null,10,k]};
qx.util.Permutation.permute(D,function(E){this._addEditor(new qx.ui.table.celleditor.PasswordField(),E);
},this);
},testTextfieldEditor:function(){var A={value:[null,10,k]};
qx.util.Permutation.permute(A,function(F){this._addEditor(new qx.ui.table.celleditor.TextField(),F);
},this);
},testTextfieldEditorDynamic:function(){var G={value:[true,k]};
var H=new qx.ui.table.celleditor.Dynamic();
H.setCellEditorFactoryFunction(function(y){if(typeof y.value==c){return new qx.ui.table.celleditor.CheckBox();
}else{return new qx.ui.table.celleditor.TextField();
}});
qx.util.Permutation.permute(G,function(z){this._addEditor(H,z);
},this);
