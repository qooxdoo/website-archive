...
(function(){var l="value",k="horizontal",j="first",h="both",g="Trash",f="second",d="main",c="Show first pane",b="Documents (D:)",a="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",H="Windows (C:)",G="Toggle Splitpane Orientation",F="Inbox",E="Desktop",D="_container1",C="execute",B="Presets",A="Network",z="changeSelection",y="Sent",s="/",t="Files",q="_container2",r="vertical",o="Workspace",p="Junk #",m="__Ms",n="Data",u="Show both panes",v="Show second pane",x="demobrowser.demo.widget.SplitPane",w="Edit";
qx.Class.define(x,{extend:qx.application.Standalone,members:{__Ms:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
var W=new qx.ui.form.RadioButton(v);
var T=new qx.ui.form.RadioButton(u);
V.setUserData(l,j);
W.setUserData(l,f);
T.setUserData(l,h);
T.setValue(true);
...
N.focus();
},_toggle:function(){var J=this.__Ms.getOrientation();
this.__Ms.setOrientation(J==k?r:k);
},_changeVisiblity:function(e){var I=e.getData()[0].getUserData(l);

if(I==h){this._container1.show();
this._container2.show();
}else if(I==j){this._container1.show();
this._container2.exclude();
}else if(I==f){this._container1.exclude();
this._container2.show();
}},__Mt:function(){var bi=new qx.ui.tree.Tree();
...
}var bk=new qx.ui.tree.TreeFolder(n);
var bf=new qx.ui.tree.TreeFolder(w);
bm.add(be,bh,bg,bk,bf);
bn.add(bm);
return bi;
}},destruct:function(){this._disposeObjects(m,D,q);
}});
})();
