...
p.setWrap(true);
o.add(p,2);
},addSplitPaneTwoFlexWithOneMin:function(){var x=new qx.ui.splitpane.Pane(m);
x.setWidth(400);
x.setHeight(60);
x.setDecorator(l);
this.getRoot().add(x,{left:20,top:100});
var w=new qx.ui.form.TextArea(j);
w.setDecorator(null);
w.setWrap(true);
w.setMinWidth(250);
x.add(w,1);
var y=new qx.ui.form.TextArea(h);
y.setDecorator(null);
y.setWrap(true);
x.add(y,2);
},addSplitPaneTwoFlexWithOneMax:function(){var A=new qx.ui.splitpane.Pane(m);
A.setWidth(400);
A.setHeight(60);
A.setDecorator(l);
this.getRoot().add(A,{left:20,top:180});
var z=new qx.ui.form.TextArea(k);
z.setDecorator(null);
z.setWrap(true);
A.add(z,1);
...
B.setMaxWidth(100);
A.add(B,2);
},addSplitPaneTwoFlexWithTwoMin:function(){var J=new qx.ui.splitpane.Pane(m);
J.setWidth(400);
J.setHeight(60);
J.setDecorator(l);
this.getRoot().add(J,{left:20,top:260});
var I=new qx.ui.form.TextArea(j);
I.setDecorator(null);
I.setWrap(true);
I.setMinWidth(250);
J.add(I,1);
var K=new qx.ui.form.TextArea(a);
K.setDecorator(null);
K.setWrap(true);
K.setMinWidth(250);
J.add(K,2);
},addSplitPaneTwoFlexWithTwoMax:function(){var G=new qx.ui.splitpane.Pane(m);
G.setWidth(400);
G.setHeight(60);
G.setDecorator(l);
this.getRoot().add(G,{left:20,top:340});
var F=new qx.ui.form.TextArea(e);
F.setDecorator(null);
F.setWrap(true);
F.setMaxWidth(100);
G.add(F,1);
var H=new qx.ui.form.TextArea(f);
H.setDecorator(null);
H.setWrap(true);
H.setMaxWidth(100);
G.add(H,2);
},addSplitPaneOneFlexSimple:function(){var u=new qx.ui.splitpane.Pane(m);
u.setWidth(400);
u.setHeight(60);
u.setDecorator(l);
this.getRoot().add(u,{left:500,top:20});
var t=new qx.ui.form.TextArea(g);
t.setDecorator(null);
t.setWrap(true);
u.add(t,0);
var v=new qx.ui.form.TextArea(k);
v.setDecorator(null);
v.setWrap(true);
u.add(v);
},addSplitPaneOneFlexSimpleWithMax:function(){var r=new qx.ui.splitpane.Pane(m);
r.setWidth(400);
r.setHeight(60);
r.setDecorator(l);
this.getRoot().add(r,{left:500,top:100});
var q=new qx.ui.form.TextArea(g);
q.setDecorator(null);
q.setWrap(true);
r.add(q,0);
var s=new qx.ui.form.TextArea(d);
s.setDecorator(null);
s.setWrap(true);
s.setMaxWidth(200);
r.add(s);
},addSplitPaneOneFlexSimpleWithMin:function(){var M=new qx.ui.splitpane.Pane(m);
M.setWidth(400);
M.setHeight(60);
M.setDecorator(l);
this.getRoot().add(M,{left:500,top:180});
var L=new qx.ui.form.TextArea(c);
L.setDecorator(null);
L.setWrap(true);
L.setMinWidth(350);
M.add(L,0);
...
N.setWrap(true);
M.add(N);
},addSplitPaneAuto:function(){var D=new qx.ui.splitpane.Pane(m);
D.setDecorator(l);
...
C.setWrap(true);
D.add(C,0);
var E=new qx.ui.form.TextArea(i);
E.setDecorator(null);
E.setWrap(true);
D.add(E);
}}});
