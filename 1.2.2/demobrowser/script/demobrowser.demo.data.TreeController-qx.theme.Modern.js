...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.TreeController","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.TreeController-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"9b8d33d1d4be"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
for(var i=0;i<50;i++){A[i]=new demobrowser.demo.data.model.Node();
A[i].setName(o+i);
A[i].setName2(p+i);
if(i!=0){A[parseInt(Math.random()*i)].getChildren().push(A[i]);
}}var u=new qx.ui.tree.Tree();
u.setSelectionMode(c);
this.getRoot().add(u,{left:10,top:100});
u.setWidth(250);
u.setHeight(300);
var C=new qx.data.controller.Tree(A[0],u,e,r);
u.getRoot().setOpen(true);
var v=new qx.ui.form.List();
v.setHeight(300);
this.getRoot().add(v,{left:270,top:100});
new qx.data.controller.List(C.getSelection(),v,q);
var B=new qx.ui.form.Button(f);
B.setWidth(180);
this.getRoot().add(B,{left:390,top:100});
B.addListener(s,function(){var t=new demobrowser.demo.data.model.Node();
t.setName(o+u.getItems(true).length);
t.setName2(p+u.getItems(true).length);
A[0].getChildren().push(t);
},this);
var w=new qx.ui.form.Button(l);
w.setWidth(180);
this.getRoot().add(w,{left:390,top:135});
w.addListener(s,function(){A[0].getChildren().pop();
},this);
var x=new qx.ui.form.Button(n);
x.setWidth(180);
this.getRoot().add(x,{left:390,top:170});
x.addListener(s,function(){if(C.getLabelPath()==r){C.setLabelPath(q);
}else{C.setLabelPath(r);
}},this);
var y=new qx.ui.form.Button(m);
y.setWidth(180);
this.getRoot().add(y,{left:390,top:205});
y.addListener(s,function(){this.info(A[0].toString());
},this);
...
D.setWidth(100);
D.setValue(b+j);
this.getRoot().add(D,{left:270,top:10});
}}});
})();
...
(function(){var q="qx.data.Array",p="demobrowser.demo.data.model.Node",o="String",n="changeNames",m="changeName",l="__MV",k="- ",j="",h="changeChild",g="changeColor",c="Marge",f="AFFE",e="Homer",b="\n",a="changeName2",d="changeChildren";
qx.Class.define(p,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.setChildren(new qx.data.Array());
},properties:{children:{check:q,event:d},child:{check:p,event:h,nullable:true},names:{check:q,event:n,init:new qx.data.Array(e,c)},name:{check:o,init:f,event:m},name2:{check:o,event:a},number:{init:10,validate:l},color:{event:g,nullable:true}},members:{__MV:function(t){if(!isNaN(parseFloat(t))){if(/^\d+$/.test(t)){return;
