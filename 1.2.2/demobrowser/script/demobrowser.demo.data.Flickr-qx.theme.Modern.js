...
(function(){var m="qooxdoo",l="/",k=".static.flickr.com/",j="http://api.flickr.com/services/rest/?tags=",i="",h="_",g="http://farm",f="Enter",d="keydown",c="model.photos.photo",I=".jpg",H="loaded",G="execute",F="source",E="selection[0]",D="_s.jpg",C="<span style='font-size: 20px'>Flickr</span>",B="failed",A="loading",z="value",t="demobrowser.demo.data.store.Flickr",u="demobrowser.demo.data.Flickr",r="title",s="icon",p="state",q="completed",n="Search",o="receiving",v="horizontal",w="model",y="&method=flickr.photos.search&api_key=63a8042eead205f7e0040f488c02afd9&format=json",x="id";
...
var X=new demobrowser.demo.data.store.Flickr(m);
var P=new qx.ui.form.TextField(m);
this.getRoot().add(P,{left:30,top:50});
var Q=new qx.ui.form.Button(n);
this.getRoot().add(Q,{left:140,top:49});
Q.addListener(G,function(){X.searchForTag(P.getValue());
},this);
P.addListener(d,function(e){if(e.getKeyIdentifier()==f){X.searchForTag(P.getValue());
}},this);
var status=new qx.ui.basic.Label(A);
...
V.setLabelPath(r);
V.setDelegate({configureItem:function(L){L.setShow(s);
}});
var R={converter:function(a,b){return (g+b.getFarm()+k+b.getServer()+l+a+h+b.getSecret()+D);
}};
V.setIconOptions(R);
V.setIconPath(x);
X.bind(c,V,w);
...
var W={converter:function(J){if(J){return (g+J.getFarm()+k+J.getServer()+l+J.getId()+h+J.getSecret()+I);
}return i;
}};
V.bind(E,S,F,W);
...
qx.Class.define(t,{extend:qx.data.store.Json,statics:{RESULT:null},construct:function(ba){jsonFlickrApi=function(Y){demobrowser.demo.data.store.Flickr.RESULT=Y;
};
var bb=j+ba;
qx.data.store.Json.call(this,bb);
},members:{searchForTag:function(bc){if(bc!=i){this.setUrl(j+bc);
}},_createRequest:function(N){var O=new qx.io.ScriptLoader();
this.setState(o);
N+=y;
O.load(N,function(K){this.__Ne();
},this);
},__Ne:function(){this.setState(q);
var M=demobrowser.demo.data.store.Flickr.RESULT;

if(M==undefined){this.setState(B);
return;
