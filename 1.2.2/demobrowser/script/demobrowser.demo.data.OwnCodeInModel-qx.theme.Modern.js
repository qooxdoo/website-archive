...
x.setLabelPath(p);
x.setIconOptions({converter:function(C){return q+C+l;
}});
x.setIconPath(j);
var y={getModelMixins:function(s){if(s==h){return demobrowser.demo.data.ItemsMixin;
}}};
var t=k;
var A=new qx.data.store.Json(t,y);
A.bind(n,x,o);
var z=new qx.ui.form.Button(f);
z.setWidth(120);
this.getRoot().add(z,{left:130,top:80});
z.addListener(r,function(){A.getModel().sortByType();
},this);
var w=new qx.ui.form.Button(e);
w.setWidth(120);
this.getRoot().add(w,{left:130,top:110});
w.addListener(r,function(){A.getModel().sortByName();
},this);
...
qx.Mixin.define(c,{members:{sortByType:function(){var B=this.getItems();
B.sort(function(a,b){if(a.getType()>b.getType()){return 1;
