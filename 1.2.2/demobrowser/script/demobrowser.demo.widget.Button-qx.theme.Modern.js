...
},addNormalButtons:function(x){var y=new qx.ui.form.Button(l,f);
x.add(y);
var z=new qx.ui.form.Button(i,d);
z.setEnabled(false);
x.add(z);
...
},addRepeatButton:function(u){var v=new qx.ui.form.RepeatButton(null,j);
u.add(v);
var w=new qx.ui.basic.Label(p);
w.setDecorator(n);
w.setPadding(2,4);
w.setBackgroundColor(o);
u.add(w);
v.addListener(m,function(){var r=parseInt(w.getValue())+1;
w.setValue(r.toString());
});
},addHoverButton:function(A){var B=new qx.ui.form.HoverButton(c).set({padding:10,backgroundColor:k});
A.add(B);
var C=new qx.ui.basic.Label(p);
C.setDecorator(n);
C.setPadding(2,4);
C.setBackgroundColor(o);
A.add(C);
B.addListener(m,function(){var q=parseInt(C.getValue())+1;
C.setValue(q.toString());
});
}}});
})();
