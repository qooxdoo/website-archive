...
k.add(this.getBox4());
k.add(this.getBox5());
},getBox1:function(){var v=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,allowGrowY:false});
...
u.setMarginRight(30);
return v;
},getBox2:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,allowGrowY:false});
...
l.setMarginRight(30);
return m;
},getBox3:function(){var p=new qx.ui.layout.VBox();
