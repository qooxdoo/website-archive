...
(function(){var bx="",bw="Hello",bv="icon/16/actions/go-down.png",bu="World",bt="bold",bs="Juhu",br="</div>",bq="waiting",bp="icon/16/actions/go-next.png",bo="http://resources.qooxdoo.org/images/logo.gif",cc="$ ",cb="string",ca="border: 1px dotted green",bY="inactive",bX="decoration",bW="multi<br>line",bV="between",bU="<",bT="<div style='position:absolute;height:20px;width:",bS="px;top:",bE="qx/decoration/Modern",bF="icon/16/actions/go-previous.png",bC="icon",bD="number",bA="px'>",bB="<i>italic</i>",by="0$",bz="qx/icon/Tango",bG="<b>bold</b>",bH="icon/16/actions/go-up.png",bK="boolean",bJ="demobrowser.demo.test.Table_CellRenderer",bM="tooltip",bL="red",bO="icon/16/emotes/face-sad.png",bN="icon/16/emotes/face-smile.png",bI="left",bR=">=",bQ="active",bP="object";
qx.Class.define(bJ,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Native.prototype.main.call(this);
this.setUp();
...
qx.util.AliasManager.getInstance().add(bX,bE);
qx.util.AliasManager.getInstance().add(bC,bz);
},__Lr:function(X,top,Y,ba,bb){var bc=[bT,Y,bS,top,bA];
ba.createDataCellHtml(bb,bc);
bc.push(br);
X.innerHTML+=bc.join(bx);
},testDefaultRenderer:function(S){var T=100;
var V={value:[null,bs,32,new Date()],styleLeft:[0],styleWidth:[T],styleHeight:[20],style:[bx]};
var U=this._getNewTableDiv(T);
var top=0;
qx.util.Permutation.permute(V,function(cd){this.__Lr(U,top,T,S,cd);
top+=20;
},this);
},testBooleanRenderer:function(){var cm=70;
var cl=30;
var cn=new qx.ui.table.cellrenderer.Boolean();
var cj={value:[null,true,false],styleLeft:[0],styleWidth:[cm],styleHeight:[cl],style:[bx]};
var ck=this._getNewTableDiv(cm);
var top=0;
qx.util.Permutation.permute(cj,function(y){this.__Lr(ck,top,cm,cn,y);
top+=cl;
},this);
cn.setIconFalse(bO);
cn.setIconTrue(bN);
qx.util.Permutation.permute(cj,function(bd){this.__Lr(ck,top,cm,cn,bd);
top+=cl;
},this);
},testDateRenderer:function(){var N=180;
var O=new qx.ui.table.cellrenderer.Date();
var Q={value:new Date(),styleLeft:[0],styleWidth:[N],styleHeight:[20],style:[bx]};
var M=qx.util.format.DateFormat;
var P=[M.getDateTimeInstance(),M.getDateInstance()];
var K=this._getNewTableDiv(N);
var top=0;

for(var i=0;i<P.length;i++){var L=P[i];
O.setDateFormat(L);
this.__Lr(K,top,N,O,Q);
top+=20;
}},testNumberRenderer:function(){var bj=new qx.ui.table.cellrenderer.Number();
var bi=100;
var bl={value:Math.PI,styleLeft:[0],styleWidth:[bi],styleHeight:[20],style:[bx]};
var bh=qx.util.format.NumberFormat;
var bk=[bh.getIntegerInstance(),new bh().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:cc})];
var bf=this._getNewTableDiv(bi);
var top=0;

for(var i=0;i<bk.length;i++){var bg=bk[i];
bj.setNumberFormat(bg);
this.__Lr(bf,top,bi,bj,bl);
top+=20;
}},testImageRenderer:function(){var q=new qx.ui.table.cellrenderer.Image();
var o=50;
var r={value:[null,bv,bH,bF,bp,bo],styleLeft:[0],styleWidth:[o],styleHeight:[20],style:[bx],tooltip:[bx,bM]};
var p=this._getNewTableDiv(o);
var top=0;
qx.util.Permutation.permute(r,function(J){this.__Lr(p,top,o,q,J);
top+=20;
},this);
},testStringRenderer:function(){var D=new qx.ui.table.cellrenderer.String();
var C=100;
var B=20;
var z={value:[null,bw,bu],styleLeft:[0],styleWidth:[C],styleHeight:[B],style:[bx]};
var A=this._getNewTableDiv(C);
var top=0;
qx.util.Permutation.permute(z,function(be){this.__Lr(A,top,C,D,be);
top+=20;
},this);
},testPasswordRenderer:function(){var w=new qx.ui.table.cellrenderer.Password();
var v=100;
var u=20;
var s={value:[null,bw,bu],styleLeft:[0],styleWidth:[v],styleHeight:[u],style:[bx]};
var t=this._getNewTableDiv(v);
var top=0;
qx.util.Permutation.permute(s,function(x){this.__Lr(t,top,v,w,x);
top+=20;
},this);
},testHtmlRenderer:function(){var I=new qx.ui.table.cellrenderer.Html();
var H=100;
var G=50;
var E={value:[null,bG,bB,bW],styleLeft:[0],styleWidth:[H],styleHeight:[G],style:[bx]};
var F=this._getNewTableDiv(H);
var top=0;
qx.util.Permutation.permute(E,function(bn){this.__Lr(F,top,H,I,bn);
top+=20;
},this);
},testConditionalRenderer:function(){var e=new qx.ui.table.cellrenderer.Conditional();
e.addNumericCondition(bU,0,null,bL,null,null);
e.addNumericCondition(bR,100,bI,null,null,null);
e.addBetweenCondition(bV,0,2,null,null,null,bt,null);
e.addRegex(by,null,null,bt,ca);
var d=100;
var c=20;
var a={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[d],table:[this.tableMock],styleHeight:[c],style:[bx]};
var b=this._getNewTableDiv(d);
var top=0;
qx.util.Permutation.permute(a,function(W){this.__Lr(b,top,d,e,W);
top+=20;
},this);
},testDynamicRenderer:function(){var ci=new qx.ui.table.cellrenderer.Dynamic();
ci.setCellRendererFactoryFunction(function(f){var h=f.value;
var g=qx.ui.table.cellrenderer;

switch(typeof h){case cb:if(h.match(/^icon\//)){return new g.Image();
}else{return new g.String();
}case bK:return new g.Boolean();
case bD:return new g.Number();
case bP:if(h instanceof Date){return new g.Date();
}return new g.Default();
}});
var ch=100;
var cg=20;
var ce={value:[null,bs,new Date(),30,bv,false],styleLeft:[0],styleWidth:[ch],styleHeight:[cg],table:[this.tableMock],style:[bx]};
var cf=this._getNewTableDiv(ch);
var top=0;
qx.util.Permutation.permute(ce,function(bm){this.__Lr(cf,top,ch,ci,bm);
top+=20;
},this);
},testReplaceRenderer:function(){var n=new qx.ui.table.cellrenderer.Replace();
n.setReplaceMap({1:bQ,2:bY,3:bq});
n.addReversedReplaceMap();
var m=100;
var l=20;
var j={value:[1,2,3],styleLeft:[0],styleWidth:[m],table:[this.tableMock],styleHeight:[l],style:[bx]};
var k=this._getNewTableDiv(m);
var top=0;
qx.util.Permutation.permute(j,function(R){this.__Lr(k,top,m,n,R);
top+=20;
},this);
