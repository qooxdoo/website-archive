...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.table.Table_Huge","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.table.Table_Huge-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"7b315d54f210"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
},COL_COUNT:50,ROW_COUNT:10000,createRandomRows:function(l){var n=[];

for(var o=0;o<l;o++){var m=[];

for(var i=0;i<this.COL_COUNT;i++){m.push(d+i+f+o);
}n.push(m);
}return n;
},createTable:function(){var h=this.createRandomRows(this.ROW_COUNT);
var g=this._tableModel=new qx.ui.table.model.Simple();
var k=[];

for(var i=0;i<this.COL_COUNT;i++){k.push(a+i);
}g.setColumns(k);
g.setData(h);
var j=new qx.ui.table.Table(g);
return j;
