...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.ui.Cursor-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"e9901aaca8ad"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var t="nw-resize",s="main",r="#DDD",q="w-resize",p="text",o="#555",n="se-resize",m="crosshair",l="sw-resize",k="n-resize",d="default",j="s-resize",g="pointer",c="help ",b="demobrowser.demo.ui.Cursor",f="move",e="ne-resize",h="e-resize",a="wait";
...
var w=new qx.ui.container.Scroll();
var u=new qx.ui.layout.HBox();
u.setSpacing(10);
var v=new qx.ui.container.Composite(u);
v.setPadding(20);
w.add(v);
this.getRoot().add(w,{edge:0});
v.add(this.getGrid1());
},getGrid1:function(){var y=new qx.ui.container.Composite().set({textColor:r});
var x=new qx.ui.layout.Grid();
x.setSpacing(20);
y.setLayout(x);
var z=[d,m,g,f,k,e,h,n,j,l,q,t,p,a,c];
var i=0;

for(var i=0;i<15;i++){y.add(new qx.ui.basic.Label(z[i]).set({decorator:s,backgroundColor:o,cursor:z[i],padding:5,height:100,width:100}),{row:Math.floor(i/5),column:i%5});
}return y;
}}});
})();
