...
(function(){var k="execute",j="Flash Player Version",i="__LU",h="__LS",g="__LW",f="right",d="Message from Flash:",c="Simple demo with FlashVars",b="bgcolor",a="demobrowser.demo.widget.Flash",y="demobrowser/demo/flash/FlashVersion.swf",x="Flash:",w="<b>qooxdoo:</b>",v="__LT",u="demobrowser.demo.widget.Flash.sendMessage",t="__LV",s="demobrowser.demo.widget.Flash.flashReady",r="demobrowser/demo/flash/fo_tester.swf",q="this is passed in via FlashVars",p="Two way communication (ActionScript <-> JavaScript)",n="Message to Flash:",o="Show Flash Player version",l="noscale",m="#FF6600";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__LS:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var G=new qx.ui.tabview.TabView();
G.setContentPadding([8,8,8,8]);
var J=this.getRoot();
J.add(G,{edge:0});
var H=new qx.ui.tabview.Page(c);
H.setLayout(new qx.ui.layout.Canvas());
H.add(this.createFlashDemo1(),{edge:0});
G.add(H);
var I=new qx.ui.tabview.Page(p);
I.setLayout(new qx.ui.layout.Canvas());
I.add(this.createFlashDemo2(),{edge:0});
G.add(I);
this.__LS=this.createWindow();
J.add(this.__LS,{top:20,left:20});
},createWindow:function(){var z=new qx.ui.window.Window(j).set({width:300,height:200,contentPadding:[0,0,0,0]});
z.setLayout(new qx.ui.layout.Canvas());
z.add(new qx.ui.embed.Flash(y),{edge:0});
return z;
...
M.getContentElement().setParam(b,m);
N.add(M,{flex:1});
var O=new qx.ui.form.Button(o);
O.addListener(k,function(){this.__LS.open();
},this);
N.add(O);
return N;
},__LT:null,__LU:null,__LV:null,__LW:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);
var E=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
var D=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
E.add(D,{flex:1});
D.add(new qx.ui.basic.Label(w).set({rich:true}));
D.add(new qx.ui.basic.Label(d));
this.__LU=new qx.ui.form.TextArea("No message.");
this.__LU.setEnabled(false);
D.add(this.__LU,{flex:1});
D.add(new qx.ui.basic.Label(n));
this.__LV=new qx.ui.form.TextArea("qooxdoo is the best!");
D.add(this.__LV,{flex:1});
var F=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,f));
this.__LW=new qx.ui.form.Button("Send to Flash");
this.__LW.setEnabled(false);
this.__LW.addListener(k,function(e){this.__LT.getFlashElement().sendMessage(this.__LV.getValue());
},this);
F.add(this.__LW);
D.add(F);
var C=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
E.add(C,{flex:1});
C.add(new qx.ui.basic.Label(x).set({rich:true}));
this.__LT=new qx.ui.embed.Flash("demobrowser/demo/flash/TestFlash.swf");
this.__LT.setVariables({init:s});
C.add(this.__LT,{flex:1});
return E;
},sendMessage:function(A){this.__LU.setValue(A);
},initFlash:function(){if(this.__LT.getFlashElement().setup){this.__LT.getFlashElement().setup(u);
this.__LW.setEnabled(true);
...
}}},statics:{__LX:null,setCallBackInstance:function(K){demobrowser.demo.widget.Flash.__LX=K;
},sendMessage:function(B){demobrowser.demo.widget.Flash.__LX.sendMessage(B);
},flashReady:function(){demobrowser.demo.widget.Flash.__LX.initFlash();
}},destruct:function(){this._disposeObjects(i,t,g,v,h);
}});
})();
...
qx.Class.define(p,{extend:qx.ui.core.Widget,construct:function(bi,bj){qx.ui.core.Widget.call(this);
{};
this.setSource(bi);
...
qx.ui.core.queue.Layout.add(this);
},_applyId:function(V,W){this.getContentElement().setId(V);
qx.ui.core.queue.Layout.add(this);
},_applyVariables:function(T,U){this.getContentElement().setVariables(T);
qx.ui.core.queue.Layout.add(this);
},_applyMayScript:function(bm,bn){this.getContentElement().setAttribute(z,bm?k:false);
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(bv,bw){this.__Eb(e,bv);
},_applyScale:function(bt,bu){this.__Eb(a,bt);
},_applyWmode:function(bc,bd){this.__Eb(O,bc);
},_applyPlay:function(be,bf){this.__Eb(s,be);
},_applyLoop:function(X,Y){this.__Eb(J,X);
},_applyMenu:function(bo,bp){this.__Eb(L,bo);
},_applyAllowScriptAccess:function(bg,bh){this.__Eb(I,bg);
},_applyLiveConnect:function(ba,bb){this.__Eb(o,ba);
},__Eb:function(bk,bl){this.getContentElement().setParam(bk,bl);
qx.ui.core.queue.Layout.add(this);
}}});
})();
...
this.__Db={};
this.__Dc={};
},members:{__Da:null,__Dc:null,__Db:null,__Dd:null,_createDomElement:function(){return qx.bom.Element.create(d);
},createFlash:function(){this.__Dd=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__Db,this.__Da);
},setSource:function(j){{};

if(this.__Dd){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(c,j);
},setId:function(e){{};

if(this.__Dd){throw new Error("The id cannot be modified after initial creation");
}this.setAttribute(b,e);
},getVariables:function(){return this.__Db;
},setVariables:function(k){{};

if(this.__Dd){throw new Error("The variables cannot be modified after initial creation");
}this.__Db=k;
},getAttributes:function(){return this.__Dc;
},setAttribute:function(h,i){{};

if(this.__Dd){throw new Error("The attributes cannot be modified after initial creation");
}
if(i===null||i===undefined){delete this.__Dc[h];
}else{this.__Dc[h]=i;
}},getParams:function(){return this.__Da;
},setParam:function(f,g){{};

if(this.__Dd){throw new Error("The params cannot be modified after initial creation");
}
if(g===null||g===undefined){delete this.__Da[f];
}else{this.__Da[f]=g;
}},getFlashElement:function(){return this.__Dd;
}},destruct:function(){if(this.__Dd){qx.bom.Flash.destroy(this.__Dd);
