...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.Grid_Simple","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.Grid_Simple-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"6e74d45ad0cd"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var p=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(p);
p.add(this.getGrid1());
p.add(this.getGrid2());
p.add(this.getGrid3());
},getGrid1:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,20)).set({decorator:k,backgroundColor:i,allowGrowX:false,allowGrowY:false});
q.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:0,column:0});
q.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:0,column:1});
q.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:1,column:0});
q.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:1,column:1});
return q;
},getGrid2:function(){var n=new qx.ui.layout.Grid();
n.setColumnAlign(1,f,d);
n.setColumnAlign(0,b,c);
n.setSpacing(5);
var m=new qx.ui.container.Composite(n).set({decorator:k,backgroundColor:i,allowGrowX:false});
m.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,width:150}),{row:0,column:0});
var l=new qx.ui.basic.Label(h).set({decorator:k,backgroundColor:j,allowGrowX:false,width:50,height:50});
m.add(l,{row:0,column:1});
m.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,maxHeight:60,allowGrowX:false}),{row:1,column:0});
m.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,height:80}),{row:1,column:1});
m.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:2,column:0});
m.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:2,column:1});
var o=10;
l.addListener(g,function(e){l.setWidth(50+o);
o=-o;
});
return m;
