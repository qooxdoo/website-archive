...
var g=new qx.ui.table.pane.Scroller(this.getTableMock());
this.add(g,{edge:0});
var f=new qx.ui.table.pane.Model(this.getColumnModelMock());
g.setTablePaneModel(f);
g._onPaneModelChanged();
g.getTablePane().setVisibleRowCount(20);
g.getTablePane()._updateAllRows();
}});
})();
