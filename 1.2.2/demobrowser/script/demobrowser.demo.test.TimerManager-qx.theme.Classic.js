...
(function(){var h="Stopping recurrent 2-second timer",g="Recurrent 2-second timer with limit 3:",f="__LJ",e="One-shot 1-second timer: ",d="demobrowser.demo.test.TimerManager",c="Recurrent 5-second timer: ",b="Start timers",a="execute";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__LJ:null,startTimers:function(){var i=qx.util.TimerManager.getInstance();
i.start(function(q,r){this.__LK(c+r);
},5000,this,null,0);
i.start(function(s,t){this.__LK(e+t);
},0,this,null,1000);
i.start(function(k,l){this.__LK(g+l);

if(++k.count==3){this.__LK(h);
i.stop(l);
}},2000,this,{count:0},2000);
},__LK:function(j){j=Date.parse(new Date)+" "+j+"\n";
this.__LJ.setValue(this.__LJ.getValue()+j);
...
o.set({allowGrowX:false,allowGrowY:false});
o.addListener(a,function(){o.setEnabled(false);
this.startTimers();
},this);
var p=new qx.ui.form.TextArea();
p.set({width:400,height:300});
this.__LJ=p;
m.add(p);
m.add(o);
