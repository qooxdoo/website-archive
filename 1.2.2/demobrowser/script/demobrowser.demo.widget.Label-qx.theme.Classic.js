...
(function(){var A="value",z="main",y="Verdana",x="sans-serif",w="selectable",v="rich",u="Big Long Label Cutted",t="My First Long Label Cutted",s="rich label",r="top",k="native context menu",q="text label",n="configure rich label",j="demobrowser.demo.widget.Label",i="nativeContextMenu",m="right",l="configure text label",o="A long label text with auto-wrapping. This also may contain <b style='color:red'>rich HTML</b> markup.",h="Big Long Label",p="execute";
...
this.getRoot().add(B);
var C=new qx.ui.basic.Label(q).set({decorator:z,width:200});
B.add(C);
this.getRoot().add(this.createConfigureButton(C,l),{left:240,top:20});
var D=new qx.ui.basic.Label(s).set({decorator:z,rich:true});
B.add(D);
this.getRoot().add(this.createConfigureButton(D,n),{left:240,top:60});
var E=new qx.ui.basic.Label(t).set({decorator:z,width:80});
B.add(E);
var F=new qx.ui.basic.Label().set({value:o,decorator:z,rich:true,width:120});
B.add(F);
var G=new qx.ui.basic.Label(h).set({decorator:z,font:new qx.bom.Font(28,[y,x])});
B.add(G);
var H=new qx.ui.basic.Label(u).set({decorator:z,font:new qx.bom.Font(28,[y,x]),width:150});
B.add(H);
},createConfigureButton:function(I,J){var L=new qx.ui.form.Button(J);
var K;
L.addListener(p,function(){if(!K){K=this.createEditDialog(I,J);
}K.open();
},this);
return L;
},createEditDialog:function(a,b){var c=new qx.ui.window.Window(b).set({allowMinimize:false,showMinimize:false,allowMaximize:false,showMaximize:false});
c.moveTo(350,20);
var e=new qx.ui.layout.Grid(10,10);
e.setColumnFlex(1,1);
e.setColumnAlign(0,m,r);
c.setLayout(e);
var d=new qx.data.controller.Object(a);
c.add(new qx.ui.basic.Label(A).set({paddingTop:5}),{row:0,column:0});
var f=new qx.ui.form.TextArea().set({liveUpdate:true});
d.addTarget(f,A,A,true);
c.add(f,{row:0,column:1});
c.add(new qx.ui.basic.Label(w),{row:1,column:0});
var g=new qx.ui.form.CheckBox();
d.addTarget(g,A,w,true);
c.add(g,{row:1,column:1});
c.add(new qx.ui.basic.Label(k),{row:2,column:0});
var g=new qx.ui.form.CheckBox();
d.addTarget(g,A,i,true);
c.add(g,{row:2,column:1});
c.add(new qx.ui.basic.Label(v),{row:3,column:0});
var g=new qx.ui.form.CheckBox().set({enabled:false});
d.addTarget(g,A,v);
c.add(g,{row:3,column:1});
return c;
}}});
})();
