...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.bom.Cookie","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.bom.Cookie-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"bad0d6b4a144"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(d,{extend:qx.application.Standalone,statics:{COOKIE_KEY:"TextFieldContent"},members:{main:function(){qx.application.Standalone.prototype.main.call(this);
