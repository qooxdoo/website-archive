...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.VSplit","qx.theme":"qx.theme.Classic"};
...
},getSplitPaneTwoFlexSimple:function(){var H=new qx.ui.splitpane.Pane(m);
H.setHeight(400);
H.setDecorator(l);
var G=new qx.ui.form.TextArea(k);
G.setDecorator(null);
G.setWrap(true);
H.add(G,1);
var I=new qx.ui.form.TextArea(h);
I.setDecorator(null);
I.setWrap(true);
H.add(I,2);
return H;
},getSplitPaneTwoFlexWithOneMin:function(){var N=new qx.ui.splitpane.Pane(m);
N.setHeight(400);
N.setDecorator(l);
var M=new qx.ui.form.TextArea(j);
M.setDecorator(null);
M.setWrap(true);
M.setMinHeight(250);
N.add(M,1);
var O=new qx.ui.form.TextArea(h);
O.setDecorator(null);
O.setWrap(true);
N.add(O,2);
return N;
...
v.add(w,2);
return v;
},getSplitPaneTwoFlexWithTwoMin:function(){var E=new qx.ui.splitpane.Pane(m);
E.setHeight(400);
E.setDecorator(l);
var D=new qx.ui.form.TextArea(j);
D.setDecorator(null);
D.setWrap(true);
D.setMinHeight(250);
E.add(D,1);
var F=new qx.ui.form.TextArea(a);
F.setDecorator(null);
F.setWrap(true);
F.setMinHeight(250);
E.add(F,2);
return E;
},getSplitPaneTwoFlexWithTwoMax:function(){var K=new qx.ui.splitpane.Pane(m);
K.setHeight(400);
K.setDecorator(l);
var J=new qx.ui.form.TextArea(e);
J.setDecorator(null);
J.setWrap(true);
J.setMaxHeight(100);
K.add(J,1);
var L=new qx.ui.form.TextArea(f);
L.setDecorator(null);
L.setWrap(true);
L.setMaxHeight(100);
K.add(L,2);
return K;
},getSplitPaneOneFlexSimple:function(){var s=new qx.ui.splitpane.Pane(m);
s.setHeight(400);
s.setDecorator(l);
var r=new qx.ui.form.TextArea(g);
r.setDecorator(null);
r.setWrap(true);
s.add(r,0);
...
s.add(t);
return s;
},getSplitPaneOneFlexSimpleWithMax:function(){var y=new qx.ui.splitpane.Pane(m);
y.setHeight(400);
y.setDecorator(l);
var x=new qx.ui.form.TextArea(g);
x.setDecorator(null);
x.setWrap(true);
y.add(x,0);
var z=new qx.ui.form.TextArea(d);
z.setDecorator(null);
z.setWrap(true);
z.setMaxHeight(200);
y.add(z);
return y;
},getSplitPaneOneFlexSimpleWithMin:function(){var B=new qx.ui.splitpane.Pane(m);
B.setHeight(400);
B.setDecorator(l);
var A=new qx.ui.form.TextArea(c);
A.setDecorator(null);
A.setWrap(true);
A.setMinHeight(350);
B.add(A,0);
...
B.add(C);
return B;
},getSplitPaneAuto:function(){var p=new qx.ui.splitpane.Pane(m);
p.setDecorator(l);
var o=new qx.ui.form.TextArea(i);
o.setDecorator(null);
o.setWrap(true);
p.add(o,0);
var q=new qx.ui.form.TextArea(i);
q.setDecorator(null);
q.setWrap(true);
p.add(q);
return p;
