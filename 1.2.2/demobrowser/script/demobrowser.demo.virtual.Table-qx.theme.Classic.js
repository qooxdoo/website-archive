...
(function(){var g=" / ",f="horizontal",e="demobrowser.demo.virtual.Table",d="white",c="__MB",b="#EEE",a="vertical";
qx.Class.define(e,{extend:qx.application.Standalone,members:{__MB:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
k.getPane().addLayer(new qx.ui.virtual.layer.Row(d,b));
...
this.__MB=new qx.ui.virtual.cell.Cell();
},getCellProperties:function(h,j){return this.__MB.getCellProperties(h+g+j);
