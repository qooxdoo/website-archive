...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.HBox_NegativeMargin","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.HBox_NegativeMargin-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"4a9130325516"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var v=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(v);
v.add(this.getBox1());
v.add(this.getBox2());
v.add(this.getBox3());
...
v.add(this.getBox6());
v.add(this.getBox7());
},getBox1:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:i,backgroundColor:h,height:80,allowGrowX:false});
var m=new qx.ui.core.Widget().set({decorator:i,backgroundColor:b,maxHeight:50,alignY:e});
var l=new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,maxHeight:50,alignY:c});
var j=new qx.ui.core.Widget().set({decorator:i,backgroundColor:g,maxHeight:50,alignY:d});
k.add(m);
k.add(l);
k.add(j);
l.setMarginLeft(-10);
j.setMarginLeft(-10);
return k;
},getBox2:function(){var J=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:i,backgroundColor:h,height:80,allowGrowX:false});
...
I.setMarginLeft(-10);
return J;
},getBox3:function(){var B=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:i,backgroundColor:h,height:80,width:500,allowGrowX:false});
...
A.setMarginLeft(-10);
return B;
},getBox4:function(){var s=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:i,backgroundColor:h,height:80,width:500,allowGrowX:false});
var u=new qx.ui.core.Widget().set({decorator:i,backgroundColor:b,maxHeight:50,alignY:e});
var t=new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,maxHeight:50,alignY:c});
var r=new qx.ui.core.Widget().set({decorator:i,backgroundColor:g,maxHeight:50,alignY:d});
s.add(u,{flex:1});
s.add(t,{flex:2});
s.add(r,{flex:3});
t.setMarginLeft(-10);
r.setMarginLeft(-10);
return s;
},getBox5:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:i,backgroundColor:h,height:80,width:500,allowGrowX:false});
var q=new qx.ui.core.Widget().set({decorator:i,backgroundColor:b,maxHeight:50,alignY:e});
var p=new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,maxHeight:50,alignY:c});
var n=new qx.ui.core.Widget().set({decorator:i,backgroundColor:g,maxHeight:50,alignY:d});
o.add(q,{flex:1});
o.add(p,{flex:2});
o.add(n,{flex:3});
p.setMarginLeft(-10);
...
n.setWidth(0);
return o;
},getBox6:function(){var x=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:i,backgroundColor:h,height:80,width:200,allowGrowX:false});
...
w.setMarginLeft(-10);
return x;
},getBox7:function(){var F=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:i,backgroundColor:h,height:80,width:200,allowGrowX:false});
