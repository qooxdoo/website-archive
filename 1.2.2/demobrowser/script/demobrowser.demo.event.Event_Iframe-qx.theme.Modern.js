...
},bindIFrameEvents:function(){var s=window.document.getElementById(m);
var r=qx.bom.Iframe.getDocument(s);
this._juhu=r.getElementById(h);
this._inner=r.getElementById(k);
...
qx.event.Registration.addListener(r.getElementById(f),c,this._onkeydown,this);

for(var i=1;i<10;i++){var q=r.getElementById(j+i);
qx.event.Registration.addListener(q,n,this._cascadeCapture,this,true);
qx.event.Registration.addListener(q,n,this._cascadeBubble,this,false);
}qx.event.Registration.addListener(r.getElementById(l),l,this._scroll,this);
},_onkeydown:function(e){this.debug("keydown: "+e.getKeyIdentifier());
},_scroll:function(e){this.debug("scroll");
},_cascadeCapture:function(e){var t=e.getCurrentTarget();
this.debug("capture: "+t.id+" "+e.getEventPhase());
