...
(function(){var bH="",bG="execute",bF="<tr>",bE="changeSelection",bD="#",bC="qooxdoo logo",bB="</tr>",bA="qx/icon/Oxygen/16/actions/format-indent-more.png",bz="Color (Hex): ",by="Georgia",bn="http://",bm="Change Font Size",bl="BgColor (Hex): ",bk="Indent More",bj="<p>You can play around with this widget by hitting the ",bi="Inserted Unordered List",bh="Align Right",bg="Format Italic",bf="qx/icon/Oxygen/16/actions/format-text-underline.png",be='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',bO="OK",bP="buttons at the toolbar.</p>",bM="demobrowser.demo.widget.HtmlArea",bN="demobrowser/demo/icons/htmlarea/format-list-ordered.png",bK="Comic Sans MS",bL="<p>This UI-level widget can be used at RIA (Rich ",bI="Tahoma",bJ="<td>First Row, First cell</td>",bQ="solid",bR="demobrowser/demo/icons/htmlarea/qooxdoo_logo.png",br="qx/icon/Oxygen/16/actions/format-justify-center.png",bq="Align Justify",bt="demobrowser/demo/icons/htmlarea/format-fill-color.png",bs="demobrowser/demo/icons/htmlarea/insert-text.png",bv="Insert Horizontal Ruler",bu="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",bx="demobrowser/demo/icons/htmlarea/format-list-unordered.png",bw="HTML Code:",bp="Set Text Background Color",bo="Internet Applications) and inline applications.<br/>",h="Insert Link",k="<td>Second Row, First cell</td>",l="</tbody>",m="Set Text Color",n="Insert Table",o="Cancel",p="As an application developer you can <b>use the same API.</b></p>",q="demobrowser/demo/icons/htmlarea/format-text-color.png",r="demobrowser/demo/icons/htmlarea/insert-table.png",s="qx/icon/Oxygen/16/actions/edit-undo.png",bV="qx/icon/Oxygen/16/actions/edit-clear.png",bU="Arial Black",bT="Impact",bS="Undo Last Change",ca="Redo Last Undo Step",bY="Format Bold",bX="Change Font Family",bW="right",cc="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",cb="main",N="Insert Hyperlink",O="Remove Format",L="blank.html",M="qx/icon/Oxygen/16/actions/insert-image.png",R="so code-duplication is avoided.<br/>",S="</table>",P="12px ",Q="<td>First Row, Second cell</td>",J="Insert HTML Code",K="qx/icon/Oxygen/16/actions/insert-link.png",A="Insert Ordered List",z="qx/icon/Oxygen/16/actions/format-justify-left.png",C="Courier",B="Courier New",w="qx/icon/Oxygen/16/actions/format-justify-right.png",v="qx/icon/Oxygen/16/actions/format-text-bold.png",y="<td>Second Row, Second cell</td>",x="Insert Image",u="<h1>HtmlArea UI-level widget</h1>",t="Align Left",X="<table border='1'>",Y="The UI widget does use the low-level component internally ",ba="qx/icon/Oxygen/16/actions/format-indent-less.png",bb="<tbody>",T="Times New Roman",U="Align Center",V="qx/icon/Oxygen/16/actions/edit-redo.png",W="Lucida Console",bc="border-main",bd="qx/icon/Oxygen/16/actions/format-text-italic.png",I="Arial",H="qx/icon/Oxygen/16/actions/format-justify-fill.png",G="Verdana",F="Indent Less",E="Format Strikethrough",D="Format Underline";
qx.Class.define(bM,{extend:qx.application.Standalone,members:{__Mh:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var cA=u+bL+bo+Y+R+p+bj+bP;
var cv=new qx.ui.basic.Label(cA);
cv.set({rich:true,marginBottom:10});
var cz=be;
var cy=this.getRoot();
var cx=new qx.ui.decoration.Single(1,bQ,bc);
cx.setWidthTop(0);
this.__Mh=new qx.ui.embed.HtmlArea(cz,null,L);
this.__Mh.set({width:600,height:400,decorator:cx});
var toolbar=this.__Mr();
var cu=new qx.ui.layout.VBox(0);
var cw=new qx.ui.container.Composite(cu);
cw.add(cv);
cw.add(toolbar);
cw.add(this.__Mh);
cy.add(cw,{left:20,top:20});
},__Mi:function(e){var cm=window.prompt(bz,bD);
this.setTextColor(cm);
},__Mj:function(e){var co=window.prompt(bl,bD);
this.setTextBackgroundColor(co);
},__Mk:function(e){var ci={src:qx.util.ResourceManager.getInstance().toUri(bR),border:0,title:bC,alt:bC};
this.insertImage(ci);
},__Ml:function(e){var cq=X+bb+bF+bJ+Q+bB+bF+k+y+bB+l+S;
this.insertHtml(cq);
},__Mm:function(e){var b=new qx.ui.window.Window(N);
b.setLayout(new qx.ui.layout.VBox(20));
b.set({width:400,showMaximize:false,showMinimize:false});
var g=new qx.ui.form.TextField(bn);
b.add(g);
var d=new qx.ui.layout.HBox(10);
d.setAlignX(bW);
var f=new qx.ui.container.Composite(d);
var a=new qx.ui.form.Button(bO);
a.setWidth(60);
a.addListener(bG,function(e){this.insertHyperLink(g.getValue());
b.close();
},this);
f.add(a);
var c=new qx.ui.form.Button(o);
c.setWidth(60);
c.addListener(bG,function(e){b.close();
},this);
f.add(c);
b.add(f);
b.center();
b.open();
this.saveRange();
},__Mn:function(e){var cn=window.prompt(bw,bH);
this.insertHtml(cn);
},__Mo:function(){var ck=new qx.ui.form.SelectBox;
ck.set({toolTipText:bX,focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});
ck.add(new qx.ui.form.ListItem(bH));
var cl=[bI,G,T,I,bU,B,C,by,bT,bK,W];
var cj;

for(var i=0,j=cl.length;i<j;i++){cj=new qx.ui.form.ListItem(cl[i]);
cj.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString(P+cl[i])});
ck.add(cj);
}ck.addListener(bE,function(e){var cp=e.getData()[0].getLabel();

if(cp!=bH){this.setFontFamily(cp);
ck.setSelection([ck.getChildren()[0]]);
}},this.__Mh);
return ck;
},__Mp:function(){var ct=new qx.ui.form.SelectBox;
ct.set({toolTipText:bm,focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});
ct.add(new qx.ui.form.ListItem(bH));
var cs;

for(var i=1;i<=7;i++){cs=new qx.ui.form.ListItem(i+bH);
cs.set({focusable:false,keepFocus:true});
ct.add(cs);
}ct.addListener(bE,function(e){var cr=e.getData()[0].getLabel();

if(cr!=bH){this.setFontSize(cr);
ct.setSelection([ct.getChildren()[0]]);
}},this.__Mh);
return ct;
},__Mq:function(){return [{bold:{text:bY,image:v,action:this.__Mh.setBold},italic:{text:bg,image:bd,action:this.__Mh.setItalic},underline:{text:D,image:bf,action:this.__Mh.setUnderline},strikethrough:{text:E,image:cc,action:this.__Mh.setStrikeThrough},removeFormat:{text:O,image:bV,action:this.__Mh.removeFormat}},{alignLeft:{text:t,image:z,action:this.__Mh.setJustifyLeft},alignCenter:{text:U,image:br,action:this.__Mh.setJustifyCenter},alignRight:{text:bh,image:w,action:this.__Mh.setJustifyRight},alignJustify:{text:bq,image:H,action:this.__Mh.setJustifyFull}},{fontFamily:{custom:this.__Mo},fontSize:{custom:this.__Mp},fontColor:{text:m,image:q,action:this.__Mi},textBackgroundColor:{text:bp,image:bt,action:this.__Mj}},{indent:{text:bk,image:bA,action:this.__Mh.insertIndent},outdent:{text:F,image:ba,action:this.__Mh.insertOutdent}},{insertImage:{text:x,image:M,action:this.__Mk},insertTable:{text:n,image:r,action:this.__Ml},insertLink:{text:h,image:K,action:this.__Mm},insertHTML:{text:J,image:bs,action:this.__Mn},insertHR:{text:bv,image:bu,action:this.__Mh.insertHorizontalRuler}},{ol:{text:A,image:bN,action:this.__Mh.insertOrderedList},ul:{text:bi,image:bx,action:this.__Mh.insertUnorderedList}},{undo:{text:bS,image:s,action:this.__Mh.undo},redo:{text:ca,image:V,action:this.__Mh.redo}}];
},__Mr:function(){var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setDecorator(cb);
var cd;
var ce=this.__Mq();

for(var i=0,j=ce.length;i<j;i++){var cf=new qx.ui.toolbar.Part;
toolbar.add(cf);

for(var cg in ce[i]){var ch=ce[i][cg];

if(ch.custom){cd=ch.custom.call(this);
}else{cd=new qx.ui.toolbar.Button(null,ch.image);
cd.set({focusable:false,keepFocus:true,center:true,toolTipText:ch.text?ch.text:bH});
cd.addListener(bG,ch.action,this.__Mh);
}cf.add(cd);
}}return toolbar;
}}});
})();
