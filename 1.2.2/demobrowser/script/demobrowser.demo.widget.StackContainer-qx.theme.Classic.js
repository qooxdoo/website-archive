...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.StackContainer","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.StackContainer-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"159a592de146"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var s="execute",r="yellow",q="teal",p="gray",o="red",n="Next",m="Previous",l="green",k="icon/22/actions/go-next.png",j="changeSelection",d="icon/22/actions/go-previous.png",h="orange",g="main",c="blue",b="resize",f="demobrowser.demo.widget.StackContainer";
...
},addSimpleStack:function(){var C=new qx.ui.container.Stack();
C.setDecorator(g);
C.setWidth(200);
C.setHeight(120);
this.getRoot().add(C,{left:20,top:20});
var A=new qx.ui.container.Composite((new qx.ui.layout.HBox).set({spacing:4}));
var F=new qx.ui.form.Button(m,d);
var D=new qx.ui.form.Button(n,k);
A.add(F);
A.add(D);
this.getRoot().add(A,{left:20,top:150});
F.addListener(s,C.previous,C);
D.addListener(s,C.next,C);
var E=[o,p,c,h,q,r,l];
var B;

for(var i=0;i<E.length;i++){B=new qx.ui.core.Widget;
B.setBackgroundColor(E[i]);
C.add(B);
}C.addListener(j,function(e){this.debug("Selected: "+e.getData()[0].getBackgroundColor());
});
},addDynamicStack:function(){var v=new qx.ui.container.Stack();
v.setDecorator(g);
v.setDynamic(true);
this.getRoot().add(v,{left:250,top:20});
var t=new qx.ui.container.Composite((new qx.ui.layout.HBox).set({spacing:4}));
var y=new qx.ui.form.Button(m,d);
var w=new qx.ui.form.Button(n,k);
t.add(y);
t.add(w);
this.getRoot().add(t,{left:250,top:150});
y.addListener(s,v.previous,v);
w.addListener(s,v.next,v);
var x=[o,p,c,h,q,r,l];
var u;

for(var i=0;i<x.length;i++){u=new qx.ui.core.Widget;
u.setBackgroundColor(x[i]);
u.setWidth((Math.round(i/2)+1)*50);
u.setHeight((Math.round(i/3)+1)*40);
v.add(u);
}v.addListener(j,function(e){var a=e.getData()[0];
this.debug("Selected: "+a.getBackgroundColor()+" ("+a.getWidth()+"x"+a.getHeight()+")");
});
v.addListener(b,function(e){var z=this.getBounds();
this.debug("Resize to: "+z.width+"x"+z.height);
});
}}});
})();
