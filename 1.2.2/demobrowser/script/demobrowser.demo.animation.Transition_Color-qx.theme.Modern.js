...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.animation.Transition_Color","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.animation.Transition_Color-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"cc567521051c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var v="Name",u="Alternates between start and end. Looks only nice on color effects.",t="EaseInQuad will accelerate exponentially.",s="#7CFC00",r="Description",q="changeSelection",p="Linear is the default transition for many effects.",o="Wobble will bounce the element forwards and backwards.",n="demobrowser.demo.animation.Transition_Color",m="execute",f="appear",l="Duration",i="Alternates rapidly between start end target. Looks only nice on color effects.",c="Spring will overshoot the target and then move back.",b="Show it!",h="EaseOutQuad will slow down exponentially.",g="test",j="sinodial transition will accelerate sinusoidal.",a="Reverse behaves like linear, but in the opposite direction.",k="#134275",d='<span style="color:white;">Welcome to <br><b style="color:#F3FFB3;">qooxdoo</b> animations!</span>';
...
var z=this.getRoot();
var I=new qx.ui.embed.Html();
I.setHtml(d);
I.setCssClass(g);
z.add(I);
var F={linear:p,easeInQuad:t,easeOutQuad:h,sinodial:j,reverse:a,wobble:o,spring:c,flicker:i,pulse:u};
var x=new qx.ui.form.SelectBox();
var H=new qx.ui.form.Button(b);
var B=new qx.ui.basic.Label(v);
var C=new qx.ui.basic.Label(r);
var G=new qx.ui.basic.Label(l);
var C=new qx.ui.basic.Label(F.linear);
var D=new qx.ui.form.Spinner;

for(var A in F){x.add(new qx.ui.form.ListItem(A));
}x.addListener(q,function(e){C.setValue(F[C.setValue(e.getData()[0].getLabel())]);
});
D.set({maximum:10.0,minimum:0.1,value:1.0});
var y;
I.addListenerOnce(f,function(){y=new qx.fx.effect.core.Highlight(I.getContentElement().getDomElement());
y.set({startColor:k,endColor:s});
},this);
var E=new qx.util.format.NumberFormat();
E.setMaximumFractionDigits(2);
D.setNumberFormat(E);
H.addListener(m,function(){var w=x.getSelection()[0].getLabel();
y.set({transition:w,duration:D.getValue()});
y.start();
});
z.add(B,{left:25,top:50});
z.add(C,{left:25,top:75});
z.add(G,{left:25,top:25});
z.add(x,{left:90,top:50});
z.add(C,{left:90,top:75});
z.add(D,{left:90,top:25});
z.add(H,{left:23,top:100});
}}});
})();
...
qx.Class.define(d,{extend:qx.fx.Base,properties:{startColor:{init:c,check:f},endColor:{init:a,check:f},restoreBackground:{init:true,check:h},keepBackgroundImage:{init:false,check:h}},members:{__xE:null,__xF:null,__xG:null,__xH:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var o=this._getElement();
this.__xE={backgroundImage:qx.bom.element.Style.get(o,g),backgroundColor:qx.bom.element.Style.get(o,i)};

if(!this.getKeepBackgroundImage()){qx.bom.element.Style.set(o,g,e);
}this.__xF=qx.util.ColorUtil.cssStringToRgb(this.getStartColor());
this.__xG=qx.util.ColorUtil.cssStringToRgb(this.getEndColor());
this.__xH=[this.__xG[0]-this.__xF[0],this.__xG[1]-this.__xF[1],this.__xG[2]-this.__xF[2]];
},update:function(j){qx.fx.Base.prototype.update.call(this);
var k=[this.__xF[0]+Math.round(this.__xH[0]*j),this.__xF[1]+Math.round(this.__xH[1]*j),this.__xF[2]+Math.round(this.__xH[2]*j)];
...
for(var m in this.__xE){qx.bom.element.Style.set(n,m,this.__xE[m]);
}}},destruct:function(){this.__xF=this.__xG=this.__xH=null;
}});
})();
