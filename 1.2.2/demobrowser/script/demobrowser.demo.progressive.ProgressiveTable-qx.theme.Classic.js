...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.progressive.ProgressiveTable","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.progressive.ProgressiveTable-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"6fd7db700918"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var B=0;
var x=function(n){var q=[];
var p=new Date().getTime();
var r=400*24*60*60*1000;

for(var s=0;s<n;s++){var o=new Date(p+Math.random()*r-r/2);
q.push({renderer:m,location:s==n-1?j:a,data:[B++,Math.random()*10000,o]});
}return q;
};
...
A.setWidth(2,300);
var v=[b,h,c];
var w=new qx.ui.progressive.headfoot.TableHeading(A,v);
var u=new qx.ui.progressive.headfoot.Progress(A,v);
var D=new qx.ui.progressive.structure.Default(w,u);
var t=new qx.ui.progressive.Progressive(D);
var C=new qx.ui.basic.Atom(f+l+e+d+i);
C.setRich(true);
C.setHeight(16);
t.add(C);
...
z.addElements(y);
t.setDataModel(z);
var E=new qx.ui.progressive.renderer.table.Row(A);
t.addRenderer(m,E);
t.set({width:500,maxWidth:500});
this.getRoot().add(t,{left:50,top:50,bottom:50});
t.render();
}}});
})();
