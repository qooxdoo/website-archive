...
this.createCommands();
cz.add(this.getMenuBar(),{left:20,top:20});
...
},getMenuBar:function(){var cJ=new qx.ui.container.Composite(new qx.ui.layout.Grow);
var menubar=new qx.ui.menubar.MenuBar;
menubar.setWidth(600);
cJ.add(menubar);
var cI=new qx.ui.menubar.Button(m,null,this.getFileMenu());
var cH=new qx.ui.menubar.Button(bn,null,this.getEditMenu());
var cK=new qx.ui.menubar.Button(bH,null,this.getSearchMenu());
var cN=new qx.ui.menubar.Button(bf,null,this.getViewMenu());
var cM=new qx.ui.menubar.Button(p,null,this.getFormatMenu());
var cL=new qx.ui.menubar.Button(bE,null,this.getHelpMenu());
menubar.add(cI);
menubar.add(cH);
menubar.add(cK);
menubar.add(cN);
...
var dn=new qx.ui.menu.Button(bx,A,this._newCommand);
var ds=new qx.ui.menu.Button(O,bo,this._openCommand);
var dr=new qx.ui.menu.Button(bj);
var dv=new qx.ui.menu.Button(bP,S,this._saveCommand);
var du=new qx.ui.menu.Button(bc,bi);
var dt=new qx.ui.menu.Button(R,bp);
var dp=new qx.ui.menu.Button(V,bM);
dn.addListener(bB,this.debugButton);
ds.addListener(bB,this.debugButton);
dr.addListener(bB,this.debugButton);
...
dq.add(dp);
return dq;
},getEditMenu:function(){var cC=new qx.ui.menu.Menu;
var cF=new qx.ui.menu.Button(bs,bq,this._undoCommand);
var cE=new qx.ui.menu.Button(bC,o,this._redoCommand);
var cB=new qx.ui.menu.Button(X,bw,this._cutCommand);
var cG=new qx.ui.menu.Button(D,T,this._copyCommand);
var cD=new qx.ui.menu.Button(E,v,this._pasteCommand);
cF.addListener(bB,this.debugButton);
cE.addListener(bB,this.debugButton);
cB.addListener(bB,this.debugButton);
cG.addListener(bB,this.debugButton);
cD.addListener(bB,this.debugButton);
cC.add(cF);
cC.add(cE);
cC.addSeparator();
cC.add(cB);
...
cC.add(cD);
return cC;
},getSearchMenu:function(){var cR=new qx.ui.menu.Menu;
var cP=new qx.ui.menu.Button(U,bz);
var cU=new qx.ui.menu.Button(bQ);
var cQ=new qx.ui.menu.Button(ba);
var cT=new qx.ui.menu.Button(x);
var cO=new qx.ui.menu.Button(bv,bz);
var cS=new qx.ui.menu.Button(bU);
cQ.setEnabled(false);
cP.addListener(bB,this.debugButton);
...
cR.add(cS);
return cR;
},getViewMenu:function(){var cl=new qx.ui.menu.Menu;
var cn=new qx.ui.menu.Button(G,null,null,this.getPanesMenu());
var cq=new qx.ui.menu.Button(C,null,null,this.getSyntaxMenu());
var cp=new qx.ui.menu.CheckBox(K);
var co=new qx.ui.menu.CheckBox(bb);
var cm=new qx.ui.menu.Button(y);
cp.addListener(bA,this.debugCheckBox);
co.addListener(bA,this.debugCheckBox);
...
var dj=new qx.ui.menu.CheckBox(l);
var dl=new qx.ui.menu.CheckBox(bD);
var dm=new qx.ui.menu.CheckBox(c);
var di=new qx.ui.menu.CheckBox(J);
var dk=new qx.ui.menu.CheckBox(n);
var dg=new qx.ui.menu.CheckBox(bG);
dj.setValue(true);
dl.setValue(true);
di.setValue(true);
dj.addListener(bA,this.debugCheckBox);
dl.addListener(bA,this.debugCheckBox);
dm.addListener(bA,this.debugCheckBox);
di.addListener(bA,this.debugCheckBox);
dk.addListener(bA,this.debugCheckBox);
dg.addListener(bA,this.debugCheckBox);
dh.add(dl);
dh.add(dj);
dh.addSeparator();
dh.add(dm);
...
dh.add(dg);
return dh;
},getSyntaxMenu:function(){var cv=new qx.ui.menu.Menu;
var cr=new qx.ui.menu.RadioButton(w);
var ct=new qx.ui.menu.RadioButton(k);
var cs=new qx.ui.menu.RadioButton(h);
var cu=new qx.ui.menu.Button(be,null,null,this.getSyntaxCMenu());
var cy=new qx.ui.menu.RadioButton(H);
var cw=new qx.ui.menu.RadioButton(a);
cv.add(cr);
cv.add(ct);
cv.add(cs);
cv.add(cu);
cv.add(cy);
cv.add(cw);
var cx=new qx.ui.form.RadioGroup;
cx.add(cr,ct,cs,cy,cw);
cx.add.apply(cx,cu.getMenu().getChildren());
cx.addListener(bd,this.debugRadio);
return cv;
},getSyntaxCMenu:function(){var ch=new qx.ui.menu.Menu;
var cg=new qx.ui.menu.RadioButton(bJ);
var ck=new qx.ui.menu.RadioButton(br);
var cj=new qx.ui.menu.RadioButton(Q);
var ci=new qx.ui.menu.RadioButton(bT);
ch.add(cg);
ch.add(ck);
ch.add(cj);
ch.add(ci);
...
var bY=new qx.ui.menu.Button(bk,null,null,this.getParagraphMenu());
var cc=new qx.ui.menu.Button(z);
var cd=new qx.ui.menu.Button(d);
var bX=new qx.ui.menu.Button(bg);
var cb=new qx.ui.menu.Button(bR);
var bW=new qx.ui.menu.Button(bN);
var cf=new qx.ui.menu.Button(g);
var ce=new qx.ui.menu.Button(bL);
cc.addListener(bB,this.debugButton);
cd.addListener(bB,this.debugButton);
bX.addListener(bB,this.debugButton);
cb.addListener(bB,this.debugButton);
bW.addListener(bB,this.debugButton);
cf.addListener(bB,this.debugButton);
ce.addListener(bB,this.debugButton);
ca.add(bY);
ca.add(cc);
...
var cY=new qx.ui.menu.Button(bt,bK);
var da=new qx.ui.menu.Button(f,r);
var cW=new qx.ui.menu.Button(bl,N);
var cX=new qx.ui.menu.Button(L,bu);
cY.addListener(bB,this.debugButton);
da.addListener(bB,this.debugButton);
cW.addListener(bB,this.debugButton);
cX.addListener(bB,this.debugButton);
cV.add(cY);
cV.add(da);
cV.add(cW);
cV.add(cX);
return cV;
},getHelpMenu:function(){var db=new qx.ui.menu.Menu;
var dd=new qx.ui.menu.Button(F,b);
var df=new qx.ui.menu.Button(Y);
var de=new qx.ui.menu.Button(by);
var dc=new qx.ui.menu.Button(q);
dd.addListener(bB,this.debugButton);
df.addListener(bB,this.debugButton);
de.addListener(bB,this.debugButton);
