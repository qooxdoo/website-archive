...
},__LQ:4,__LR:0,add:function(J){this.container.add(J,{row:Math.floor(this.__LR/this.__LQ),column:this.__LR%this.__LQ});
this.__LR+=1;
},createSharedToolTip:function(){var G=new qx.ui.tooltip.ToolTip(q);
G.addListener(s,function(e){var M=a;

if(this.getOpener()==F){M+=p;
}else{M+=r;
}G.setLabel(M);
});
var F=new qx.ui.form.Button(v);
F.setToolTip(G);
this.add(F);
var E=new qx.ui.form.Button(h);
E.setToolTip(G);
this.add(E);
},createIconToolTip:function(){var L=new qx.ui.form.Button(w).set({toolTip:new qx.ui.tooltip.ToolTip(null,k)});
this.add(L);
},createToolTip:function(){var z=new qx.ui.form.Button(b).set({toolTip:new qx.ui.tooltip.ToolTip(d,k)});
this.add(z);
},createShortTimeoutToolTip:function(){var D=new qx.ui.tooltip.ToolTip(x,i);
D.setShowTimeout(50);
var C=new qx.ui.form.Button(g);
this.add(C);
C.setToolTip(D);
},createRichToolTip:function(){var B=new qx.ui.tooltip.ToolTip(o+t+m,i);
B.setWidth(200);
B.setRich(true);
B.setShowTimeout(50);
var A=new qx.ui.form.Button(y);
this.add(A);
A.setToolTip(B);
},createToolTipText:function(){var O=new qx.ui.form.Button(n).set({toolTipText:j});
this.add(O);
},createToolTipIcon:function(){var K=new qx.ui.form.Button(l).set({toolTipIcon:k});
this.add(K);
},createToolTipTextIcon:function(){var N=new qx.ui.form.Button(c).set({toolTipText:j,toolTipIcon:k});
this.add(N);
