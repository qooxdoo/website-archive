...
},_createDefaultExample:function(){var A=new qx.ui.basic.Label(c);
A.setFont(t);
this.getRoot().add(A,{left:20,top:25});
var y=new qx.ui.form.ComboBox();
for(var i=1;i<31;i++){var z=new qx.ui.form.ListItem(g+i+s+Math.pow(2,i));
y.add(z);
}y.addListener(j,function(e){this.debug("ChangeValue: "+e.getData());
});
this.getRoot().add(y,{left:20,top:40});
},_createIconExample:function(){var G=new qx.ui.basic.Label(k);
G.setFont(t);
this.getRoot().add(G,{left:160,top:25});
var E=new qx.ui.form.ComboBox();
for(var i=1;i<31;i++){var F=new qx.ui.form.ListItem(i+l,f);
E.add(F);
}this.getRoot().add(E,{left:160,top:40});
