...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Table_Header","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Table_Header-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"28ef25a029ca"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
