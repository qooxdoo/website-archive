...
p.setMaxListHeight(null);

for(var i=0;i<300;i++){var q=new qx.ui.form.ListItem(j+i);
p.add(q);
}this.container.add(p,{left:20,top:40});
},addBox2:function(){this.container.add(new qx.ui.basic.Label(h),{left:25,bottom:45});
var x=new qx.ui.form.SelectBox();
var s=new qx.bom.Font(12,[e]);
var t=new qx.bom.Font(15,[a]);
var r=new qx.bom.Font(18,[d]);
var v=new qx.bom.Font(21,[m]);
var u=[s,t,r,v];

for(var i=0;i<u.length;i++){var w=new qx.ui.form.ListItem(f+(i+1));
w.setFont(u[i]);
x.add(w);
}this.container.add(x,{left:20,bottom:20});
