...
(function(){var E="execute",D="- Use the cursors keys to move the selection.",C="- Double-click or enter/space-key will fire an execute event.",B="bold",A="- Page-keys / shift + page-keys switch months/years.",z="Description",y="select a date",x="Show January 1981",w="Set current date",v="Execute: ",q="Change: ",u="center",t="en",p="changeValue",o="demobrowser.demo.widget.DateChooser",s="Remove the selection",r="- Escape will remove the selection.";
...
qx.locale.Manager.getInstance().setLocale(t);
var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
var m=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
var n=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
var h=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
var b=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
n.add(b);
n.add(l);
g.add(n);
g.add(h);
...
var d=new qx.ui.control.DateChooser();
m.addBefore(d,g);
var k=new qx.ui.basic.Label(y);
j.add(k);
d.addListener(p,function(e){k.setValue(q+e.getData());
},this);
d.addListener(E,function(e){var F=d.getValue();
k.setValue(v+F);
},this);
var f=new qx.ui.form.Button(w);
f.setAlignX(u);
b.add(f);
f.addListener(E,function(e){d.setValue(new Date());
});
var i=new qx.ui.form.Button(x);
b.add(i);
i.addListener(E,function(e){d.showMonth(0,1981);
});
var c=new qx.ui.form.Button(s);
b.add(c);
c.addListener(E,function(e){d.setValue(null);
});
var a=new qx.ui.basic.Label(z);
a.setFont(B);
l.add(a);
l.add(new qx.ui.basic.Label(D));
l.add(new qx.ui.basic.Label(A));
l.add(new qx.ui.basic.Label(C));
l.add(new qx.ui.basic.Label(r));
}}});
})();
