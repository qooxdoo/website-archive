...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.Form","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.Form-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"927a49982637"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var u={converter:function(P){return P===1;
}};
var x={converter:function(M){return M?1:0;
}};
...
K.add(I);
K.setValidator(function(N){var O=E.getSelection()[0]!==F;
E.setValid(O);
return O;
});
var C=function(s){if(s instanceof qx.ui.form.ListItem){return s.getLabel();
}};
