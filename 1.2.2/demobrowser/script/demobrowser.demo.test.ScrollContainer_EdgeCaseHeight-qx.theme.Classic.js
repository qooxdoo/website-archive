...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.ScrollContainer_EdgeCaseHeight","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.ScrollContainer_EdgeCaseHeight-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"1ce261df8047"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
C.set({width:200,height:300});
this.getRoot().add(C,{left:10,top:10});
C.add(this.generateBox());
var E=new qx.ui.form.Button(g);
var H=true;
E.addListener(r,function(){C.setWidth(H?300:200);
H=!H;
});
this.getRoot().add(E,{left:330,top:20});
var D=new qx.ui.form.Button(o);
var G=true;
D.addListener(r,function(){C.getChildren()[0].setWidth(G?100:300);
G=!G;
});
this.getRoot().add(D,{left:430,top:20});
var F=this.generateScrollbarConfig(q,100);
var B=this.generateScrollbarConfig(p,120);
F.addListener(s,function(e){C.setScrollbarX(e.getData()[0].getUserData(t));
});
B.addListener(s,function(e){C.setScrollbarY(e.getData()[0].getUserData(t));
});
},generateScrollbarConfig:function(v,top){var z=new qx.ui.container.Composite(new qx.ui.layout.HBox(6));
var v=new qx.ui.basic.Label(v);
v.setMarginRight(20);
var w=new qx.ui.form.RadioButton(i);
var y=new qx.ui.form.RadioButton(c);
var x=new qx.ui.form.RadioButton(d);
w.setUserData(t,l);
y.setUserData(t,a);
x.setUserData(t,h);
w.setValue(true);
var A=new qx.ui.form.RadioGroup(w,y,x);
z.add(v);
z.add(w);
z.add(y);
z.add(x);
this.getRoot().add(z,{left:330,top:top});
return A;
