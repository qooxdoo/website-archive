...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Validation","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Validation-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"4bbcca479c7e"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var m="<br>",l="new name: ",k="new gender: ",j="male",i="female",h="new age: ",g="demobrowser.demo.test.Validation",f="<b>Setting the age ",e="property to 27</b><br>",d="- name: Name is validated to a minimum length of two.<br/>",S="<br>old name: ",R=")",Q="age:",P="fmale",O="<br><b>Setting the name to 'Hans'</b><br>",N="property to 'female'</b><br>",M="<br><b>Setting the gender ",L="must be longer than one characters. (",K="<b>Testing the gender ",J="<br>old gender: ",t="<br><b>Setting the age ",u="- age: Age is validated to be a number.<br/>",r="<b>Initial property values</b><br>",s="",p="<b>Setting the name to ''</b><br>",q="demobrowser.demo.test.Person",n="property to 'true'</b><br>",o="- gender: Gender is validated to be either male or female.",v="property to 'fmale'</b><br>",w="<font color='red'>GENDER NOT SET</font>",B="gender:",A="<br>old age: ",D="Hans",C="The demo creates an internal class containing three properties:<br/>",F="Validation Error: Name ",E="<font color='red'>AGE NOT SET</font>",y="My name",I="__Ls",H="<font color='red'>NAME NOT SET</font>",G="white",x="name:",z="<b>Description</b><br/>";
...
var a=new demobrowser.demo.test.Person();
var b=new qx.ui.embed.Html();
b.setBackgroundColor(G);
b.set({padding:10,width:250,height:360});
this.getRoot().add(b,{left:10,top:10});
b.setHtml(r);
b.setHtml(b.getHtml()+x+a.getName()+m);
b.setHtml(b.getHtml()+Q+a.getAge()+m);
b.setHtml(b.getHtml()+B+a.getGender()+m);
b.setHtml(b.getHtml()+O);
a.setName(D);
b.setHtml(b.getHtml()+l+a.getName()+m);
b.setHtml(b.getHtml()+p);
try{a.setName(s);
b.setHtml(b.getHtml()+l+a.getName()+m);
}catch(U){b.setHtml(b.getHtml()+H+S+a.getName()+m);
}b.setHtml(b.getHtml()+t+e);
a.setAge(27);
b.setHtml(b.getHtml()+h+a.getAge()+m);
b.setHtml(b.getHtml()+f+n);
try{a.setAge(true);
b.setHtml(b.getHtml()+h+a.getAge()+m);
}catch(W){b.setHtml(b.getHtml()+E+A+a.getAge()+m);
}b.setHtml(b.getHtml()+M+N);
a.setGender(i);
b.setHtml(b.getHtml()+k+a.getGender()+m);
b.setHtml(b.getHtml()+K+v);
try{a.setAge(P);
b.setHtml(b.getHtml()+k+a.getGender()+m);
}catch(V){b.setHtml(b.getHtml()+w+J+a.getGender()+m);
}var c=new qx.ui.basic.Label();
c.setRich(true);
c.setWidth(250);
c.setValue(z+C+d+u+o);
this.getRoot().add(c,{left:280,top:10});
}}});
qx.Class.define(q,{extend:qx.core.Object,properties:{name:{init:y,validate:I},age:{init:18,validate:qx.util.Validate.number()},gender:{init:j,validate:qx.util.Validate.inArray([j,i])}},members:{__Ls:function(T){if(T.length<2){throw new qx.core.ValidationError(F+L+T+R);
}}}});
})();
