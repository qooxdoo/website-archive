...
return e;
},getGrid2:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:d,backgroundColor:b,allowGrowX:false,allowGrowY:false});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:0});
f.add(new qx.ui.core.Spacer(10,0),{row:0,column:2});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:3});
f.add(new qx.ui.core.Spacer(30,0),{row:1,column:4});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:5});
f.add(new qx.ui.core.Spacer(0,5),{row:1,column:0});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:0});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:3});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:5});
return f;
}}});
})();
