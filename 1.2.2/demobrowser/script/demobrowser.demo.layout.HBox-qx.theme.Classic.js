...
j.add(this.getBox6());
j.add(this.getBox7());
},getBox1:function(){var p=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:i,backgroundColor:g,allowGrowX:false});
p.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
p.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
p.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return p;
},getBox2:function(){var v=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:i,backgroundColor:g,minHeight:60,allowGrowX:false});
v.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:c}));
v.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:a}));
v.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:b}));
return v;
},getBox3:function(){var w=new qx.ui.layout.HBox();
var x=new qx.ui.container.Composite(w).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
w.setSpacing(5);
w.setAlignX(e);
x.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
x.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
x.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return x;
},getBox4:function(){var C=new qx.ui.layout.HBox();
...
D.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return D;
},getBox5:function(){var z=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:i,backgroundColor:g,allowGrowX:false});
...
var m=new qx.ui.container.Composite(k).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
k.setSpacing(5);
k.setAlignX(e);
...
l.setMarginRight(10);
return m;
},getBox7:function(){var q=new qx.ui.layout.HBox();
var s=new qx.ui.container.Composite(q).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
q.setSpacing(5);
q.setAlignX(f);
var u=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
