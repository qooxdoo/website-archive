...
S.add(new qx.ui.basic.Label(p));
var U=[j,c,h,x,n,a,d,m,E,F,r,t,C,u,z,s,A,k,g];
var V=l;
var R=new qx.ui.form.SelectBox();

for(var i=0;i<U.length;i++){var T=new qx.ui.form.ListItem(U[i].substr(0,U[i].indexOf(y)),V+U[i]);
R.add(T);
}S.add(R);
return S;
},createBox4:function(){var L=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
L.add(new qx.ui.basic.Label(b));
var K=new qx.ui.form.SelectBox();
K.add(new qx.ui.form.ListItem(D));

for(var i=0;i<10;i++){K.add(new qx.ui.form.ListItem(q+(i+1)));
}L.add(K);
return L;
}}});
})();
