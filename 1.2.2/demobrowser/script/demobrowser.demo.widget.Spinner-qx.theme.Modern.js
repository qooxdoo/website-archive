...
qx.Class.define(m,{extend:qx.application.Standalone,members:{addSimpleSpinner:function(B,C){var D=new qx.ui.form.Spinner();
B.add(new qx.ui.basic.Label(f),{column:0,row:C});
B.add(new qx.ui.basic.Label(s),{column:1,row:C});
B.add(D,{column:2,row:C});
B.add(new qx.ui.basic.Label(q),{column:3,row:C});
D.addListener(b,function(e){this.debug("ChangeValue: "+e.getData());
});
},addNonEditableSpinner:function(v,w){var x=new qx.ui.form.Spinner(0,50,100);
x.setEditable(false);
v.add(new qx.ui.basic.Label(n),{column:0,row:w});
v.add(new qx.ui.basic.Label(s),{column:1,row:w});
v.add(x,{column:2,row:w});
v.add(new qx.ui.basic.Label(q),{column:3,row:w});
},addWrappingSpinner:function(y,z){var A=new qx.ui.form.Spinner(-30,30,30);
A.setWrap(true);
y.add(new qx.ui.basic.Label(k),{column:0,row:z});
y.add(new qx.ui.basic.Label(a),{column:1,row:z});
y.add(A,{column:2,row:z});
y.add(new qx.ui.basic.Label(c),{column:3,row:z});
...
},addFormattedSpinner:function(E,F){var G=new qx.ui.form.Spinner(0,200,300);
G.setSingleStep(0.5);
G.setWidth(70);
...
G.setNumberFormat(H);
E.add(new qx.ui.basic.Label(d),{column:0,row:F});
E.add(new qx.ui.basic.Label(s),{column:1,row:F});
E.add(G,{column:2,row:F});
E.add(new qx.ui.basic.Label(i),{column:3,row:F++});
},main:function(){qx.application.Standalone.prototype.main.call(this);
var u=new qx.ui.layout.Grid(10,8);
u.setColumnAlign(0,p,r);
u.setColumnAlign(1,h,r);
u.setColumnAlign(2,p,r);
u.setColumnAlign(3,p,r);
var t=new qx.ui.container.Composite(u);
t.setPadding(10);
this.getRoot().add(t,{left:0,top:0});
this.addSimpleSpinner(t,0);
this.addNonEditableSpinner(t,1);
this.addWrappingSpinner(t,2);
this.addSteppedSpinner(t,3);
this.addDisabledSpinner(t,4);
this.addFormattedSpinner(t,5);
}}});
})();
