...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.table.Table_Resize_Columns","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.table.Table_Resize_Columns-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"8341b9f4043b"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
},createTable:function(){var H=this.createRandomRows(50);
var F=this._tableModel=this._tableModel=new qx.ui.table.model.Simple();
F.setColumns([g,m,c,f]);
F.setData(H);
var E={tableColumnModel:function(v){return new qx.ui.table.columnmodel.Resize(v);
}};
var I=this._table=new qx.ui.table.Table(F,E);
I.set({width:600,height:400});
I.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var G=I.getTableColumnModel();
var D=G.getBehavior();
D.set(0,{width:k,minWidth:40,maxWidth:80});
D.setWidth(1,i);
D.setMinWidth(1,100);
D.setMaxWidth(1,320);
var G=I.getTableColumnModel();
...
return I;
},createControls:function(){var z=new qx.ui.toolbar.ToolBar();
var x,y,A;
y=new qx.ui.toolbar.Part();
z.add(y);
x=new qx.ui.toolbar.Button(q,j);
x.addListener(r,function(s){var t=this.createRandomRows(10);
this._tableModel.addRows(t);
this.info("10 rows added");
},this);
y.add(x);
x=new qx.ui.toolbar.Button(p,d);
x.addListener(r,function(B){var C=this._tableModel.getRowCount();
this._tableModel.removeRows(C-10,10);
...
z.add(y);
var w=this._table;
A=new qx.ui.toolbar.CheckBox(e);
A.set({value:w.getKeepFirstVisibleRowComplete(),toolTip:new qx.ui.tooltip.ToolTip(o+b)});
A.addListener(h,function(u){w.setKeepFirstVisibleRowComplete(this.getValue());
},A);
y.add(A);
return z;
