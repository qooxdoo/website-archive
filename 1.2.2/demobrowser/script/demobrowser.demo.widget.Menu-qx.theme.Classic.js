...
(function(){var cK="execute",cJ="changeValue",cI="icon/16/actions/edit-cut.png",cH="changeSelection",cG="icon/16/actions/edit-paste.png",cF="Copy",cE="Paste",cD="icon/16/actions/edit-copy.png",cC="Cut",cB="icon/16/actions/system-search.png",bX="New",bW="Undo",bV="icon/16/actions/document-save.png",bU="Redo",bT="icon/22/apps/preferences-users.png",bS="icon/16/actions/document-print.png",bR="icon/16/actions/document-open.png",bQ="icon/16/actions/edit-undo.png",bP="Save",bO="icon/16/actions/edit-redo.png",cR="Print",cS="Open",cP="icon/16/actions/document-new.png",cQ="Online Forum",cN="icon/16/actions/format-justify-fill.png",cO="Search in files",cL="C",cM="Left aligned",cT="__Me",cU="Perl",cu="View",ct="C Dialect",cw="Info...",cv="Save as...",cy="Show line numbers",cx="Quickstart",cA="icon/16/actions/contact-new.png",cz="__Mc",cs="Actions",cr="Show console",F="Search",G="Help",H="__Md",I="Show status bar",J="icon/16/actions/format-justify-left.png",K="ANSI to OEM",L="Centered",M="Website 3",N="Edit",O="icon/16/actions/format-justify-center.png",cY="Ctrl+O",cX="icon/16/actions/go-previous.png",cW="C Sharp",cV="Close",dd="Split Button",dc="__LY",db="Website 2",da="icon/16/actions/document-save-as.png",df="Python",de="icon/16/apps/utilities-help.png",bo="Show tree",bp="Options",bm="Spaces to tabs",bn="Right aligned",bs="Action 1",bt="OEM to ANSI",bq="Line 431",br="JavaScript",bk="icon",bl="Action 2",W="__Ma",V="Folder ",Y="XML",X="Line 313",S="Paragraph",R="demobrowser.demo.widget.Menu",U="icon/16/actions/application-exit.png",T="C Plus Plus",Q="Line 26",P="Item ",by="ASCII table",bz="Option 1",bA="Search next...",bB="Line 12",bu="Action 3",bv="Replace in files",bw="Uppercase",bx="Ctrl+P",bC="Topics",bD="Panes",bh="Justified",bg="Ctrl+X",bf="Show macros",be="Search previous...",bd="Back",bc="__Mg",bb="main",ba="Show ruler",bj="icon/16/actions/format-justify-right.png",bi="icon/16/actions/go-next.png",bE="Ctrl+Z",bF="__Mb",bG="command ",bH="Option 3",bI="Next",bJ="Ctrl+R",bK="Show tags",bL="Capitals",bM="Format",bN="__Mf",cc="File",cb="Show tabs",ca="Tabs to spaces",bY="Search...",cg="Line 1039",cf="Option 2",ce="Objective C",cd="Exit",ci="move to",ch="Ctrl+S",cp="Syntax",cq="Ctrl+C",cn="Website 1",co="Menu Button",cl="Line 30",cm="Lowercase",cj="Replace",ck="HTML";
qx.Class.define(R,{extend:qx.application.Standalone,members:{__LY:null,__Ma:null,__Mb:null,__Mc:null,__Md:null,__Me:null,__Mf:null,__Mg:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var dD=new qx.ui.container.Scroll();
var dC=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
dC.setPadding(20);
dC.setAllowStretchX(false);
dD.add(dC);
this.getRoot().add(dD,{edge:0});
this.createCommands();
dC.add(this.getMenuButton(),{left:20,top:20});
dC.add(this.getSplitButton(),{left:150,top:20});
dC.add(this.getMenuBar(),{left:20,top:100});
dC.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var dl=new qx.ui.menu.Menu();
var dm=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){dm.add(new qx.ui.menu.Button(V+(i+1)));
}dl.add(new qx.ui.menu.Button(ci,null,null,dm));
dl.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){dl.add(new qx.ui.menu.Button(bG+(i+1)));
}return dl;
...
},createCommands:function(){this.__LY=new qx.ui.core.Command("Ctrl+N");
this.__LY.addListener(cK,this.debugCommand);
this.__Ma=new qx.ui.core.Command(cY);
this.__Ma.addListener(cK,this.debugCommand);
this.__Mb=new qx.ui.core.Command(ch);
this.__Mb.addListener(cK,this.debugCommand);
this.__Mc=new qx.ui.core.Command(bE);
this.__Mc.addListener(cK,this.debugCommand);
this.__Md=new qx.ui.core.Command(bJ);
this.__Md.addListener(cK,this.debugCommand);
this.__Me=new qx.ui.core.Command(bg);
this.__Me.addListener(cK,this.debugCommand);
this.__Mf=new qx.ui.core.Command(cq);
this.__Mf.addListener(cK,this.debugCommand);
this.__Mg=new qx.ui.core.Command(bx);
this.__Mg.addListener(cK,this.debugCommand);
this.__Mg.setEnabled(false);
},getMenuButton:function(){var r=new qx.ui.menu.Menu;
r.add(new qx.ui.menu.RadioButton(bz));
r.add(new qx.ui.menu.RadioButton(cf));
r.add(new qx.ui.menu.RadioButton(bH));
var z=new qx.ui.menu.Menu;
z.add(new qx.ui.menu.RadioButton(bs));
z.add(new qx.ui.menu.RadioButton(bl));
z.add(new qx.ui.menu.RadioButton(bu));
var y=new qx.ui.form.RadioGroup;
y.add.apply(y,r.getChildren());
y.addListener(cH,this.debugRadio);
var w=new qx.ui.form.RadioGroup;
w.add.apply(w,z.getChildren());
w.addListener(cH,this.debugRadio);
var u=new qx.ui.menu.Menu();
var x=new qx.ui.menu.Button(bW,bQ,this.__Mc);
var E=new qx.ui.menu.Button(bU,bO,this.__Md);
var t=new qx.ui.menu.Button(cC,cI,this.__Me);
var B=new qx.ui.menu.Button(cF,cD,this.__Mf);
var v=new qx.ui.menu.Button(cE,cG,this.__Mg);
var s=new qx.ui.menu.Button(bp,cB,null,r);
var C=new qx.ui.menu.Button(cs,cA,null,z);
var A=new qx.ui.menu.Button(cR,bS);
x.addListener(cK,this.debugButton);
E.addListener(cK,this.debugButton);
t.addListener(cK,this.debugButton);
B.addListener(cK,this.debugButton);
v.addListener(cK,this.debugButton);
s.addListener(cK,this.debugButton);
C.addListener(cK,this.debugButton);
A.addListener(cK,this.debugButton);
u.add(x);
u.add(E);
u.addSeparator();
u.add(t);
...
u.addSeparator();
u.add(A);
var D=new qx.ui.form.MenuButton(co,bT,u);
return D;
},getSplitButton:function(){var dg=new qx.ui.menu.Menu;
var dk=new qx.ui.menu.Button(cn);
var di=new qx.ui.menu.Button(db);
var dj=new qx.ui.menu.Button(M);
dg.setMinWidth(120);
dk.addListener(cK,this.debugButton);
di.addListener(cK,this.debugButton);
dj.addListener(cK,this.debugButton);
dg.add(dk);
dg.add(di);
dg.add(dj);
var dh=new qx.ui.form.SplitButton(dd,bT,dg);
dh.addListener(cK,this.debugButton);
return dh;
...
toolbar.addSpacer();
toolbar.add(eE);
var eJ=new qx.ui.toolbar.SplitButton(bd,cX,this.getBackMenu());
var eG=new qx.ui.toolbar.SplitButton(bI,bi,this.getForwardMenu());
var ez=new qx.ui.toolbar.Button(bX,cP,this.__LY);
var eD=new qx.ui.toolbar.Button(cS,bR,this.__Ma);
var eI=new qx.ui.toolbar.Button(bP,bV,this.__Mb);
eJ.addListener(cK,this.debugButton);
eG.addListener(cK,this.debugButton);
ez.addListener(cK,this.debugButton);
eD.addListener(cK,this.debugButton);
eI.addListener(cK,this.debugButton);
eK.add(eJ);
eK.add(eG);
eK.addSeparator();
eK.add(ez);
...
var ey=new qx.ui.toolbar.MenuButton(N);
var ex=new qx.ui.toolbar.MenuButton(F);
var eL=new qx.ui.toolbar.MenuButton(cu);
var eH=new qx.ui.toolbar.MenuButton(bM);
...
eA.add(eL);
eA.add(eH);
var eF=new qx.ui.toolbar.MenuButton(G);
eF.setMenu(this.getHelpMenu());
eE.add(eF);
return eB;
},getBackMenu:function(){var dp=new qx.ui.menu.Menu;
var dq=new qx.ui.menu.Button(X);
var ds=new qx.ui.menu.Button(cg);
var dn=new qx.ui.menu.Button(bB);
var dr=new qx.ui.menu.Button(Q);
dq.addListener(cK,this.debugButton);
ds.addListener(cK,this.debugButton);
dn.addListener(cK,this.debugButton);
dr.addListener(cK,this.debugButton);
dp.add(dq);
dp.add(ds);
dp.add(dn);
dp.add(dr);
return dp;
},getForwardMenu:function(){var eo=new qx.ui.menu.Menu;
var ep=new qx.ui.menu.Button(bq);
var eq=new qx.ui.menu.Button(cl);
ep.addListener(cK,this.debugButton);
eq.addListener(cK,this.debugButton);
eo.add(ep);
eo.add(eq);
return eo;
},getFileMenu:function(){var ei=new qx.ui.menu.Menu;
var eg=new qx.ui.menu.Button(bX,cP,this.__LY);
var ek=new qx.ui.menu.Button(cS,bR,this.__Ma);
var ej=new qx.ui.menu.Button(cV);
var en=new qx.ui.menu.Button(bP,bV,this.__Mb);
var em=new qx.ui.menu.Button(cv,da);
var el=new qx.ui.menu.Button(cR,bS);
var eh=new qx.ui.menu.Button(cd,U);
eg.addListener(cK,this.debugButton);
ek.addListener(cK,this.debugButton);
ej.addListener(cK,this.debugButton);
en.addListener(cK,this.debugButton);
em.addListener(cK,this.debugButton);
el.addListener(cK,this.debugButton);
eh.addListener(cK,this.debugButton);
ei.add(eg);
ei.add(ek);
ei.add(ej);
ei.add(en);
...
var dU=new qx.ui.menu.Button(bW,bQ,this.__Mc);
var dT=new qx.ui.menu.Button(bU,bO,this.__Md);
var dQ=new qx.ui.menu.Button(cC,cI,this.__Me);
var dV=new qx.ui.menu.Button(cF,cD,this.__Mf);
var dS=new qx.ui.menu.Button(cE,cG,this.__Mg);
dU.addListener(cK,this.debugButton);
dT.addListener(cK,this.debugButton);
dQ.addListener(cK,this.debugButton);
dV.addListener(cK,this.debugButton);
dS.addListener(cK,this.debugButton);
dR.add(dU);
dR.add(dT);
dR.addSeparator();
...
dR.add(dS);
return dR;
},getSearchMenu:function(){var dH=new qx.ui.menu.Menu;
var dF=new qx.ui.menu.Button(bY,cB);
var dK=new qx.ui.menu.Button(bA);
var dG=new qx.ui.menu.Button(be);
var dJ=new qx.ui.menu.Button(cj);
var dE=new qx.ui.menu.Button(cO,cB);
var dI=new qx.ui.menu.Button(bv);
dG.setEnabled(false);
dF.addListener(cK,this.debugButton);
dK.addListener(cK,this.debugButton);
dG.addListener(cK,this.debugButton);
dJ.addListener(cK,this.debugButton);
dE.addListener(cK,this.debugButton);
dI.addListener(cK,this.debugButton);
dH.add(dF);
dH.add(dK);
dH.add(dG);
...
dH.add(dI);
return dH;
},getViewMenu:function(){var er=new qx.ui.menu.Menu;
var et=new qx.ui.menu.Button(bD,null,null,this.getPanesMenu());
var ew=new qx.ui.menu.Button(cp,null,null,this.getSyntaxMenu());
var ev=new qx.ui.menu.CheckBox(ba);
var eu=new qx.ui.menu.CheckBox(cy);
var es=new qx.ui.menu.Button(by);
ev.addListener(cJ,this.debugCheckBox);
eu.addListener(cJ,this.debugCheckBox);
es.addListener(cK,this.debugButton);
er.add(et);
er.add(ew);
er.addSeparator();
er.add(ev);
...
var p=new qx.ui.menu.CheckBox(I);
var q=new qx.ui.menu.CheckBox(bo);
var m=new qx.ui.menu.CheckBox(bf);
var o=new qx.ui.menu.CheckBox(bK);
var k=new qx.ui.menu.CheckBox(cr);
n.setValue(true);
p.setValue(true);
m.setValue(true);
n.addListener(cJ,this.debugCheckBox);
p.addListener(cJ,this.debugCheckBox);
q.addListener(cJ,this.debugCheckBox);
m.addListener(cJ,this.debugCheckBox);
o.addListener(cJ,this.debugCheckBox);
k.addListener(cJ,this.debugCheckBox);
l.add(p);
l.add(n);
l.addSeparator();
l.add(q);
...
var a=new qx.ui.menu.RadioButton(ck);
var c=new qx.ui.menu.RadioButton(Y);
var b=new qx.ui.menu.RadioButton(br);
var d=new qx.ui.menu.Button(ct,null,null,this.getSyntaxCMenu());
var j=new qx.ui.menu.RadioButton(cU);
var g=new qx.ui.menu.RadioButton(df);
f.add(a);
f.add(c);
f.add(b);
f.add(d);
...
h.addListener(cH,this.debugRadio);
return f;
},getSyntaxCMenu:function(){var ec=new qx.ui.menu.Menu;
var eb=new qx.ui.menu.RadioButton(cL);
var ef=new qx.ui.menu.RadioButton(cW);
var ee=new qx.ui.menu.RadioButton(ce);
var ed=new qx.ui.menu.RadioButton(T);
ec.add(eb);
ec.add(ef);
ec.add(ee);
ec.add(ed);
return ec;
},getFormatMenu:function(){var dw=new qx.ui.menu.Menu;
var dv=new qx.ui.menu.Button(S,null,null,this.getParagraphMenu());
var dy=new qx.ui.menu.Button(ca);
var dz=new qx.ui.menu.Button(bm);
var du=new qx.ui.menu.Button(bw);
var dx=new qx.ui.menu.Button(cm);
var dt=new qx.ui.menu.Button(bL);
var dB=new qx.ui.menu.Button(bt);
var dA=new qx.ui.menu.Button(K);
dy.addListener(cK,this.debugButton);
dz.addListener(cK,this.debugButton);
du.addListener(cK,this.debugButton);
dx.addListener(cK,this.debugButton);
dt.addListener(cK,this.debugButton);
dB.addListener(cK,this.debugButton);
dA.addListener(cK,this.debugButton);
dw.add(dv);
dw.add(dy);
dw.add(dz);
dw.addSeparator();
...
dw.add(dA);
return dw;
},getParagraphMenu:function(){var eM=new qx.ui.menu.Menu;
var eP=new qx.ui.menu.Button(cM,J);
var eQ=new qx.ui.menu.Button(bn,bj);
var eN=new qx.ui.menu.Button(L,O);
var eO=new qx.ui.menu.Button(bh,cN);
eP.addListener(cK,this.debugButton);
eQ.addListener(cK,this.debugButton);
eN.addListener(cK,this.debugButton);
eO.addListener(cK,this.debugButton);
eM.add(eP);
eM.add(eQ);
eM.add(eN);
eM.add(eO);
return eM;
},getHelpMenu:function(){var dL=new qx.ui.menu.Menu;
var dN=new qx.ui.menu.Button(bC,de);
var dP=new qx.ui.menu.Button(cx);
var dO=new qx.ui.menu.Button(cQ);
var dM=new qx.ui.menu.Button(cw);
dN.addListener(cK,this.debugButton);
dP.addListener(cK,this.debugButton);
dO.addListener(cK,this.debugButton);
dM.addListener(cK,this.debugButton);
dL.add(dN);
dL.add(dP);
dL.addSeparator();
dL.add(dO);
...
for(var i=0;i<20;i++){eR.add(new qx.ui.form.ListItem(P+i));
}return eR;
},getContextMenu:function(){var dW=new qx.ui.menu.Menu;
var dY=new qx.ui.menu.Button(cC,cI,this.__Me);
var ea=new qx.ui.menu.Button(cF,cD,this.__Mf);
var dX=new qx.ui.menu.Button(cE,cG,this.__Mg);
dY.addListener(cK,this.debugButton);
ea.addListener(cK,this.debugButton);
dX.addListener(cK,this.debugButton);
dW.add(dY);
dW.add(ea);
dW.add(dX);
return dW;
}},destruct:function(){this._disposeObjects(dc,W,bF,cz,H,cT,bN,bc);
}});
})();
