...
(function(){var o="main",n="green",m="yellow",l="center",k="right",j="demobrowser.demo.layout.HBox",i="top",h="bottom",g="middle";
...
p.add(this.getBox6());
p.add(this.getBox7());
},getBox1:function(){var s=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:o,backgroundColor:m,allowGrowX:false});
s.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}));
s.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}));
s.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}));
return s;
},getBox2:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:o,backgroundColor:m,minHeight:60,allowGrowX:false});
f.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,maxHeight:40,alignY:i}));
f.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,maxHeight:40,alignY:g}));
f.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,maxHeight:40,alignY:h}));
return f;
},getBox3:function(){var q=new qx.ui.layout.HBox();
var r=new qx.ui.container.Composite(q).set({decorator:o,backgroundColor:m,width:500,allowGrowX:false});
q.setSpacing(5);
q.setAlignX(k);
...
var D=new qx.ui.container.Composite(C).set({decorator:o,backgroundColor:m,width:500,allowGrowX:false});
C.setSpacing(5);
C.setAlignX(l);
...
D.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}));
return D;
},getBox5:function(){var u=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:o,backgroundColor:m,allowGrowX:false});
...
t.setMarginRight(10);
return u;
},getBox6:function(){var x=new qx.ui.layout.HBox();
var z=new qx.ui.container.Composite(x).set({decorator:o,backgroundColor:m,width:500,allowGrowX:false});
x.setSpacing(5);
x.setAlignX(k);
...
var y=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
z.add(B);
z.add(A);
z.add(y);
B.setMarginRight(10);
...
y.setMarginRight(10);
return z;
},getBox7:function(){var a=new qx.ui.layout.HBox();
var c=new qx.ui.container.Composite(a).set({decorator:o,backgroundColor:m,width:500,allowGrowX:false});
a.setSpacing(5);
a.setAlignX(l);
