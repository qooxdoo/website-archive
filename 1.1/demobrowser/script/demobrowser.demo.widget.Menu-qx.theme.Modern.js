...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Menu","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Menu-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"6d740af03c89"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var dn="execute",dm="changeValue",dl="icon/16/actions/edit-cut.png",dk="changeSelection",dj="icon/16/actions/edit-paste.png",di="Copy",dh="Paste",dg="icon/16/actions/edit-copy.png",df="Cut",de="icon/16/actions/system-search.png",cz="New",cy="Undo",cx="icon/16/actions/document-save.png",cw="Redo",cv="icon/22/apps/preferences-users.png",cu="icon/16/actions/document-print.png",ct="icon/16/actions/document-open.png",cs="icon/16/actions/edit-undo.png",cr="Save",cq="icon/16/actions/edit-redo.png",dv="Print",dw="Open",dt="icon/16/actions/document-new.png",du="Online Forum",dr="icon/16/actions/format-justify-fill.png",ds="Search in files",dp="C",dq="__Nd",dx="Left aligned",dy="Perl",cW="View",cV="C Dialect",cY="Info...",cX="Save as...",db="Show line numbers",da="Quickstart",dd="icon/16/actions/contact-new.png",dc="Ctrl+N",cU="Actions",cT="__Ni",bh="Show console",bi="Search",bj="Help",bk="Show status bar",bl="icon/16/actions/format-justify-left.png",bm="ANSI to OEM",bn="Centered",bo="Website 3",bp="Edit",bq="icon/16/actions/format-justify-center.png",dC="Ctrl+O",dB="icon/16/actions/go-previous.png",dA="C Sharp",dz="Close",dG="Split Button",dF="Website 2",dE="icon/16/actions/document-save-as.png",dD="Python",dI="icon/16/apps/utilities-help.png",dH="Show tree",bP="Options",bQ="Spaces to tabs",bN="Right aligned",bO="Action 1",bT="OEM to ANSI",bU="Line 431",bR="JavaScript",bS="icon",bL="Action 2",bM="Folder ",by="__Nc",bx="XML",bA="Line 313",bz="Paragraph",bu="demobrowser.demo.widget.Menu",bt="icon/16/actions/application-exit.png",bw="C Plus Plus",bv="Line 26",bs="Item ",br="ASCII table",ca="Option 1",cb="Search next...",cc="__Ng",cd="Line 12",bV="Action 3",bW="Replace in files",bX="Uppercase",bY="Ctrl+P",ce="Topics",cf="Panes",bI="Justified",bH="Ctrl+X",bG="Search previous...",bF="Back",bE="main",bD="Show ruler",bC="__Ne",bB="__Nh",bK="icon/16/actions/format-justify-right.png",bJ="icon/16/actions/go-next.png",cg="Ctrl+Z",ch="command ",ci="Option 3",cj="Next",ck="Ctrl+R",cl="Show macros",cm="__Nf",cn="Show tags",co="Capitals",cp="Format",cD="__Nj",cC="File",cB="Show tabs",cA="Tabs to spaces",cH="Search...",cG="Line 1039",cF="Option 2",cE="Objective C",cJ="Exit",cI="move to",cQ="Ctrl+S",cR="Syntax",cO="Ctrl+C",cP="Website 1",cM="Menu Button",cN="Line 30",cK="Lowercase",cL="Replace",cS="HTML";
qx.Class.define(bu,{extend:qx.application.Standalone,members:{__Nc:null,__Nd:null,__Ne:null,__Nf:null,__Ng:null,__Nh:null,__Ni:null,__Nj:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var eE=new qx.ui.container.Scroll();
var eD=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
eD.setPadding(20);
eD.setAllowStretchX(false);
eE.add(eD);
this.getRoot().add(eE,{edge:0});
this.createCommands();
eD.add(this.getMenuButton(),{left:20,top:20});
eD.add(this.getSplitButton(),{left:150,top:20});
eD.add(this.getMenuBar(),{left:20,top:100});
eD.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var dY=new qx.ui.menu.Menu();
var ea=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){ea.add(new qx.ui.menu.Button(bM+(i+1)));
}dY.add(new qx.ui.menu.Button(cI,null,null,ea));
dY.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){dY.add(new qx.ui.menu.Button(ch+(i+1)));
}return dY;
},debugRadio:function(e){this.debug("Change selection: "+e.getData()[0].getLabel());
...
},createCommands:function(){this.__Nc=new qx.ui.core.Command(dc);
this.__Nc.addListener(dn,this.debugCommand);
this.__Nd=new qx.ui.core.Command(dC);
this.__Nd.addListener(dn,this.debugCommand);
this.__Ne=new qx.ui.core.Command(cQ);
this.__Ne.addListener(dn,this.debugCommand);
this.__Nf=new qx.ui.core.Command(cg);
this.__Nf.addListener(dn,this.debugCommand);
this.__Ng=new qx.ui.core.Command(ck);
this.__Ng.addListener(dn,this.debugCommand);
this.__Nh=new qx.ui.core.Command(bH);
this.__Nh.addListener(dn,this.debugCommand);
this.__Ni=new qx.ui.core.Command(cO);
this.__Ni.addListener(dn,this.debugCommand);
this.__Nj=new qx.ui.core.Command(bY);
this.__Nj.addListener(dn,this.debugCommand);
this.__Nj.setEnabled(false);
},getMenuButton:function(){var N=new qx.ui.menu.Menu;
N.add(new qx.ui.menu.RadioButton(ca));
N.add(new qx.ui.menu.RadioButton(cF));
N.add(new qx.ui.menu.RadioButton(ci));
var V=new qx.ui.menu.Menu;
V.add(new qx.ui.menu.RadioButton(bO));
V.add(new qx.ui.menu.RadioButton(bL));
V.add(new qx.ui.menu.RadioButton(bV));
var U=new qx.ui.form.RadioGroup;
U.add.apply(U,N.getChildren());
U.addListener(dk,this.debugRadio);
var S=new qx.ui.form.RadioGroup;
S.add.apply(S,V.getChildren());
S.addListener(dk,this.debugRadio);
var Q=new qx.ui.menu.Menu();
var T=new qx.ui.menu.Button(cy,cs,this.__Nf);
var bb=new qx.ui.menu.Button(cw,cq,this.__Ng);
var P=new qx.ui.menu.Button(df,dl,this.__Nh);
var X=new qx.ui.menu.Button(di,dg,this.__Ni);
var R=new qx.ui.menu.Button(dh,dj,this.__Nj);
var O=new qx.ui.menu.Button(bP,de,null,N);
var Y=new qx.ui.menu.Button(cU,dd,null,V);
var W=new qx.ui.menu.Button(dv,cu);
T.addListener(dn,this.debugButton);
bb.addListener(dn,this.debugButton);
P.addListener(dn,this.debugButton);
X.addListener(dn,this.debugButton);
R.addListener(dn,this.debugButton);
O.addListener(dn,this.debugButton);
Y.addListener(dn,this.debugButton);
W.addListener(dn,this.debugButton);
Q.add(T);
Q.add(bb);
Q.addSeparator();
Q.add(P);
...
Q.addSeparator();
Q.add(W);
var ba=new qx.ui.form.MenuButton(cM,cv,Q);
return ba;
},getSplitButton:function(){var d=new qx.ui.menu.Menu;
var j=new qx.ui.menu.Button(cP);
var g=new qx.ui.menu.Button(dF);
var h=new qx.ui.menu.Button(bo);
d.setMinWidth(120);
j.addListener(dn,this.debugButton);
g.addListener(dn,this.debugButton);
h.addListener(dn,this.debugButton);
d.add(j);
d.add(g);
d.add(h);
var f=new qx.ui.form.SplitButton(dG,cv,d);
f.addListener(dn,this.debugButton);
return f;
},getMenuBar:function(){var dN=new qx.ui.container.Composite(new qx.ui.layout.Grow);
dN.setDecorator(bE);
var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setWidth(600);
dN.add(toolbar);
var dW=new qx.ui.toolbar.Part;
var dM=new qx.ui.toolbar.Part;
var dQ=new qx.ui.toolbar.Part;
toolbar.add(dW);
toolbar.add(dM);
toolbar.addSpacer();
toolbar.add(dQ);
var dV=new qx.ui.toolbar.SplitButton(bF,dB,this.getBackMenu());
var dS=new qx.ui.toolbar.SplitButton(cj,bJ,this.getForwardMenu());
var dL=new qx.ui.toolbar.Button(cz,dt,this.__Nc);
var dP=new qx.ui.toolbar.Button(dw,ct,this.__Nd);
var dU=new qx.ui.toolbar.Button(cr,cx,this.__Ne);
dV.addListener(dn,this.debugButton);
dS.addListener(dn,this.debugButton);
dL.addListener(dn,this.debugButton);
dP.addListener(dn,this.debugButton);
dU.addListener(dn,this.debugButton);
dW.add(dV);
dW.add(dS);
dW.addSeparator();
dW.add(dL);
...
dW.add(dU);
dW.setShow(bS);
var dO=new qx.ui.toolbar.MenuButton(cC);
var dK=new qx.ui.toolbar.MenuButton(bp);
var dJ=new qx.ui.toolbar.MenuButton(bi);
var dX=new qx.ui.toolbar.MenuButton(cW);
var dT=new qx.ui.toolbar.MenuButton(cp);
dO.setMenu(this.getFileMenu());
dK.setMenu(this.getEditMenu());
dJ.setMenu(this.getSearchMenu());
dX.setMenu(this.getViewMenu());
dT.setMenu(this.getFormatMenu());
dM.add(dO);
dM.add(dK);
dM.add(dJ);
dM.add(dX);
dM.add(dT);
var dR=new qx.ui.toolbar.MenuButton(bj);
dR.setMenu(this.getHelpMenu());
dQ.add(dR);
return dN;
},getBackMenu:function(){var et=new qx.ui.menu.Menu;
var eu=new qx.ui.menu.Button(bA);
var ew=new qx.ui.menu.Button(cG);
var es=new qx.ui.menu.Button(cd);
var ev=new qx.ui.menu.Button(bv);
eu.addListener(dn,this.debugButton);
ew.addListener(dn,this.debugButton);
es.addListener(dn,this.debugButton);
ev.addListener(dn,this.debugButton);
et.add(eu);
et.add(ew);
et.add(es);
et.add(ev);
return et;
},getForwardMenu:function(){var a=new qx.ui.menu.Menu;
var b=new qx.ui.menu.Button(bU);
var c=new qx.ui.menu.Button(cN);
b.addListener(dn,this.debugButton);
c.addListener(dn,this.debugButton);
a.add(b);
a.add(c);
return a;
},getFileMenu:function(){var t=new qx.ui.menu.Menu;
var r=new qx.ui.menu.Button(cz,dt,this.__Nc);
var v=new qx.ui.menu.Button(dw,ct,this.__Nd);
var u=new qx.ui.menu.Button(dz);
var y=new qx.ui.menu.Button(cr,cx,this.__Ne);
var x=new qx.ui.menu.Button(cX,dE);
var w=new qx.ui.menu.Button(dv,cu);
var s=new qx.ui.menu.Button(cJ,bt);
r.addListener(dn,this.debugButton);
v.addListener(dn,this.debugButton);
u.addListener(dn,this.debugButton);
y.addListener(dn,this.debugButton);
x.addListener(dn,this.debugButton);
w.addListener(dn,this.debugButton);
s.addListener(dn,this.debugButton);
t.add(r);
t.add(v);
t.add(u);
t.add(y);
...
t.add(s);
return t;
},getEditMenu:function(){var eO=new qx.ui.menu.Menu;
var eR=new qx.ui.menu.Button(cy,cs,this.__Nf);
var eQ=new qx.ui.menu.Button(cw,cq,this.__Ng);
var eN=new qx.ui.menu.Button(df,dl,this.__Nh);
var eS=new qx.ui.menu.Button(di,dg,this.__Ni);
var eP=new qx.ui.menu.Button(dh,dj,this.__Nj);
eR.addListener(dn,this.debugButton);
eQ.addListener(dn,this.debugButton);
eN.addListener(dn,this.debugButton);
eS.addListener(dn,this.debugButton);
eP.addListener(dn,this.debugButton);
eO.add(eR);
eO.add(eQ);
eO.addSeparator();
eO.add(eN);
...
eO.add(eP);
return eO;
},getSearchMenu:function(){var en=new qx.ui.menu.Menu;
var el=new qx.ui.menu.Button(cH,de);
var eq=new qx.ui.menu.Button(cb);
var em=new qx.ui.menu.Button(bG);
var ep=new qx.ui.menu.Button(cL);
var ek=new qx.ui.menu.Button(ds,de);
var eo=new qx.ui.menu.Button(bW);
em.setEnabled(false);
el.addListener(dn,this.debugButton);
eq.addListener(dn,this.debugButton);
em.addListener(dn,this.debugButton);
ep.addListener(dn,this.debugButton);
ek.addListener(dn,this.debugButton);
eo.addListener(dn,this.debugButton);
en.add(el);
en.add(eq);
en.add(em);
en.add(ep);
...
en.add(eo);
return en;
},getViewMenu:function(){var ex=new qx.ui.menu.Menu;
var ez=new qx.ui.menu.Button(cf,null,null,this.getPanesMenu());
var eC=new qx.ui.menu.Button(cR,null,null,this.getSyntaxMenu());
var eB=new qx.ui.menu.CheckBox(bD);
var eA=new qx.ui.menu.CheckBox(db);
var ey=new qx.ui.menu.Button(br);
eB.addListener(dm,this.debugCheckBox);
eA.addListener(dm,this.debugCheckBox);
ey.addListener(dn,this.debugButton);
ex.add(ez);
ex.add(eC);
ex.addSeparator();
ex.add(eB);
...
ex.add(ey);
return ex;
},getPanesMenu:function(){var l=new qx.ui.menu.Menu;
var n=new qx.ui.menu.CheckBox(cB);
var p=new qx.ui.menu.CheckBox(bk);
var q=new qx.ui.menu.CheckBox(dH);
var m=new qx.ui.menu.CheckBox(cl);
var o=new qx.ui.menu.CheckBox(cn);
var k=new qx.ui.menu.CheckBox(bh);
n.setValue(true);
p.setValue(true);
m.setValue(true);
n.addListener(dm,this.debugCheckBox);
p.addListener(dm,this.debugCheckBox);
q.addListener(dm,this.debugCheckBox);
m.addListener(dm,this.debugCheckBox);
o.addListener(dm,this.debugCheckBox);
k.addListener(dm,this.debugCheckBox);
l.add(p);
l.add(n);
l.addSeparator();
l.add(q);
...
l.add(k);
return l;
},getSyntaxMenu:function(){var eJ=new qx.ui.menu.Menu;
var eF=new qx.ui.menu.RadioButton(cS);
var eH=new qx.ui.menu.RadioButton(bx);
var eG=new qx.ui.menu.RadioButton(bR);
var eI=new qx.ui.menu.Button(cV,null,null,this.getSyntaxCMenu());
var eM=new qx.ui.menu.RadioButton(dy);
var eK=new qx.ui.menu.RadioButton(dD);
eJ.add(eF);
eJ.add(eH);
eJ.add(eG);
eJ.add(eI);
eJ.add(eM);
eJ.add(eK);
var eL=new qx.ui.form.RadioGroup;
eL.add(eF,eH,eG,eM,eK);
eL.add.apply(eL,eI.getMenu().getChildren());
eL.addListener(dk,this.debugRadio);
return eJ;
},getSyntaxCMenu:function(){var J=new qx.ui.menu.Menu;
var I=new qx.ui.menu.RadioButton(dp);
var M=new qx.ui.menu.RadioButton(dA);
var L=new qx.ui.menu.RadioButton(cE);
var K=new qx.ui.menu.RadioButton(bw);
J.add(I);
J.add(M);
J.add(L);
J.add(K);
return J;
},getFormatMenu:function(){var ee=new qx.ui.menu.Menu;
var ed=new qx.ui.menu.Button(bz,null,null,this.getParagraphMenu());
var eg=new qx.ui.menu.Button(cA);
var eh=new qx.ui.menu.Button(bQ);
var ec=new qx.ui.menu.Button(bX);
var ef=new qx.ui.menu.Button(cK);
var eb=new qx.ui.menu.Button(co);
var ej=new qx.ui.menu.Button(bT);
var ei=new qx.ui.menu.Button(bm);
eg.addListener(dn,this.debugButton);
eh.addListener(dn,this.debugButton);
ec.addListener(dn,this.debugButton);
ef.addListener(dn,this.debugButton);
eb.addListener(dn,this.debugButton);
ej.addListener(dn,this.debugButton);
ei.addListener(dn,this.debugButton);
ee.add(ed);
ee.add(eg);
ee.add(eh);
ee.addSeparator();
...
ee.add(ei);
return ee;
},getParagraphMenu:function(){var z=new qx.ui.menu.Menu;
var C=new qx.ui.menu.Button(dx,bl);
var D=new qx.ui.menu.Button(bN,bK);
var A=new qx.ui.menu.Button(bn,bq);
var B=new qx.ui.menu.Button(bI,dr);
C.addListener(dn,this.debugButton);
D.addListener(dn,this.debugButton);
A.addListener(dn,this.debugButton);
B.addListener(dn,this.debugButton);
z.add(C);
z.add(D);
z.add(A);
z.add(B);
return z;
},getHelpMenu:function(){var bc=new qx.ui.menu.Menu;
var be=new qx.ui.menu.Button(ce,dI);
var bg=new qx.ui.menu.Button(da);
var bf=new qx.ui.menu.Button(du);
var bd=new qx.ui.menu.Button(cY);
be.addListener(dn,this.debugButton);
bg.addListener(dn,this.debugButton);
bf.addListener(dn,this.debugButton);
bd.addListener(dn,this.debugButton);
bc.add(be);
bc.add(bg);
bc.addSeparator();
bc.add(bf);
...
bc.add(bd);
return bc;
},getList:function(){var er=new qx.ui.form.List;
er.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){er.add(new qx.ui.form.ListItem(bs+i));
}return er;
},getContextMenu:function(){var E=new qx.ui.menu.Menu;
var G=new qx.ui.menu.Button(df,dl,this.__Nh);
var H=new qx.ui.menu.Button(di,dg,this.__Ni);
var F=new qx.ui.menu.Button(dh,dj,this.__Nj);
G.addListener(dn,this.debugButton);
H.addListener(dn,this.debugButton);
F.addListener(dn,this.debugButton);
E.add(G);
...
E.add(F);
return E;
}},destruct:function(){this._disposeObjects(by,dq,bC,cm,cc,bB,cT,cD);
}});
})();
...
this._addAt(m,1);
break;
}return m||qx.ui.form.SplitButton.prototype._createChildControlImpl.call(this,l);
}}});
})();
