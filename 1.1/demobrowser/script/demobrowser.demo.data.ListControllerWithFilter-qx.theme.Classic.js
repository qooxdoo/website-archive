...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.ListControllerWithFilter","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.ListControllerWithFilter-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"44329a547bbb"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var s="execute",r="Show all numbers.",q="Write data to log",p="Add an item",o="Remove an item",n="Show only even numbers.",m="Odd / Even filter",l="Remove filter",k="<b>Filtered List</b><br/>",j="Reverse order",e="demobrowser.demo.data.ListControllerWithFilter",h="Show only odd numbers.",g="value",d="init",c="delegate",f="List showing numbered items, bound to a data array.";
...
var z={};
z.filter=function(b){return parseInt(b)%2==0;
};
var D=new qx.ui.basic.Label(d);
this.getRoot().add(D,{left:10,top:290});
var H={converter:function(a){if(a==z){return n;
}else if(a==x){return h;
}return r;
}};
B.bind(c,D,g,H);
var A=new qx.ui.form.Button(p);
A.setWidth(120);
this.getRoot().add(A,{left:130,top:80});
A.addListener(s,function(){G.push(G.length);
},this);
var F=new qx.ui.form.Button(o);
F.setWidth(120);
this.getRoot().add(F,{left:130,top:115});
F.addListener(s,function(){G.pop();
},this);
var C=new qx.ui.form.Button(q);
C.setWidth(120);
this.getRoot().add(C,{left:130,top:150});
C.addListener(s,function(){qx.log.appender.Console.show();
this.info(G.toString());
},this);
var v=new qx.ui.form.Button(m);
v.setWidth(120);
this.getRoot().add(v,{left:130,top:185});
v.addListener(s,function(){B.getDelegate()==x?B.setDelegate(z):B.setDelegate(x);
},this);
var u=new qx.ui.form.Button(l);
u.setWidth(120);
this.getRoot().add(u,{left:130,top:220});
u.addListener(s,function(){B.setDelegate(null);
},this);
var I=new qx.ui.form.Button(j);
I.setWidth(120);
this.getRoot().add(I,{left:130,top:255});
I.addListener(s,function(){G.reverse();
},this);
