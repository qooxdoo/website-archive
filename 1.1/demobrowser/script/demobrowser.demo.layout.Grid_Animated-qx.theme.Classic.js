...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.Grid_Animated","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.Grid_Animated-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"d296ffa7b62c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var j="green",i="sinodial",h="click",g="yellow",f="width",d="height",c="demobrowser.demo.layout.Grid_Animated",b="orange",a="main";
...
m.add(this.getAnimGrid(),{row:0,column:0});
},getNewWidget:function(){var o=new qx.ui.core.Widget().set({width:50,height:50,backgroundColor:j});
o.addListener(h,function(e){if(this._active==o){return;
}var r=[];
var p=0.3;

if(this._active){this._active.set({backgroundColor:j,width:50,height:50});
}o.set({backgroundColor:b});
var s=o.getBounds();
r.push(new demobrowser.demo.layout.Grid_Animated_Property(o,f).set({from:s.width,to:200,duration:p,transition:i}));
r.push(new demobrowser.demo.layout.Grid_Animated_Property(o,d).set({from:s.height,to:200,duration:p,transition:i}));
var q=new qx.fx.effect.core.Parallel(r[0],r[1]);
q.start();
this._active=o;
},this);
return o;
},getAnimGrid:function(){var k=new qx.ui.container.Composite().set({decorator:a,backgroundColor:g,width:500,height:500});
var l=new qx.ui.layout.Grid();
l.setSpacing(3);
k.setLayout(l);
this._active=null;

for(var x=0;x<7;x++){l.setColumnFlex(x,1);
l.setRowFlex(x,1);

for(var y=0;y<7;y++){k.add(this.getNewWidget(),{row:y,column:x});
}}return k;
}}});
})();
...
qx.Class.define(a,{extend:qx.fx.Base,construct:function(d,e){this._propName=e;
qx.fx.Base.call(this,d);
},members:{update:function(b){var c={};
c[this._propName]=Math.round(b);
this._getElement().set(c);
}}});
})();
...
(function(){var b="qx.fx.effect.core.Parallel",a="__Dd";
qx.Class.define(b,{extend:qx.fx.Base,construct:function(g){qx.fx.Base.call(this);
this.__Dd=arguments;
},members:{__Dd:null,finish:function(){qx.fx.Base.prototype.finish.call(this);
var f=this.__Dd;
