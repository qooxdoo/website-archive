...
(function(){var h=" / ",g="horizontal",f="demobrowser.demo.virtual.Table",e="__NF",d="white",c="#EEE",b="vertical";
qx.Class.define(f,{extend:qx.application.Standalone,members:{__NF:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var a=new qx.ui.virtual.core.Scroller(10000,10000,20,100);
for(var i=0;i<10000;i++){a.getPane().getRowConfig().setItemSize(i,20+Math.round(Math.random()*40));
a.getPane().getColumnConfig().setItemSize(i,50+Math.round(Math.random()*80));
}this.getRoot().add(a,{edge:20});
a.getPane().addLayer(new qx.ui.virtual.layer.Row(d,c));
a.getPane().addLayer(new qx.ui.virtual.layer.GridLines(g));
a.getPane().addLayer(new qx.ui.virtual.layer.GridLines(b));
a.getPane().addLayer(new qx.ui.virtual.layer.HtmlCell(this));
this.__NF=new qx.ui.virtual.cell.Cell();
},getCellProperties:function(j,k){return this.__NF.getCellProperties(j+h+k);
