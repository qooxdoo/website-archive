...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.CheckBox","qx.theme":"qx.theme.Modern"};
...
(function(){var u="",t=", ",s="demobrowser.demo.widget.CheckBox",r="Bathing togs",q="_checkBoxes",p="OK",o="Towel",n="Sun Oil",m="Beer",l="What do you need for the beach?",k="execute";
...
c.setSpacing(10);
var b=new qx.ui.container.Composite(c);
b.setPadding(20);
this.getRoot().add(b,{left:0,top:0});
b.add(f);
var a=new qx.ui.form.CheckBox(n);
var j=new qx.ui.form.CheckBox(o);
var g=new qx.ui.form.CheckBox(m);
var h=new qx.ui.form.CheckBox(r);
this._checkBoxes=[a,j,g,h];
b.add(a);
b.add(j);
b.add(g);
b.add(h);
var d=new qx.ui.form.Button(p);
d.addListener(k,this._onExecute,this);
d.setAllowGrowX(false);
b.add(d);
