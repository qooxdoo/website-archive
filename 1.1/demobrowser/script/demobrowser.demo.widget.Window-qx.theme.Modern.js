...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Window","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Window-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"968362eb9a0f"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var l="changeValue",k="execute",j="icon/16/apps/office-calendar.png",h="right",g="demobrowser.demo.widget.Window",f="Yes",d="Second Window",c="Page 1",b="bottom",a="Use move frame",bb="Show Statusbar",ba="icon/16/actions/dialog-cancel.png",Y="icon/32/status/dialog-error.png",X="Show Close",W="Third Window",V="icon/22/apps/utilities-calculator.png",U="Show Maximize",T="Allow Close",S="Use resize frame",R="No",s="resizable",t="Allow Maximize",q="value",r="The second window",o="Page 3",p="move",m="Resizable ",n="First Window",w="resize",x="Moveable",F="Demo loaded",D="Allow Minimize",J="Resizable",H="Open Modal Dialog 2",N="Open Modal Dialog 1",L="First Modal Dialog",z="top",Q="Movable",P="icon/32/apps/office-address-book.png",O="Basics",y="Modal",B="Do you want to fly to Berlin?",C="Welcome to your first own Window.<br/>Have fun!",E="Application is ready",G="icon/16/apps/internet-feed-reader.png",I="Second Modal Dialog",K="icon/16/actions/dialog-ok.png",M="Page 2",u="left",v="icon/16/apps/internet-telephony.png",A="Show Minimize";
...
this.createWindow2();
this.createWindow3();
},createWindow1:function(){var bh=new qx.ui.window.Window(n,j);
bh.setLayout(new qx.ui.layout.VBox(10));
bh.setShowStatusbar(true);
bh.setStatus(F);
bh.open();
this.getRoot().add(bh,{left:20,top:20});
bh.addListener(p,function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
},this);
bh.addListener(w,function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
},this);
var bg=new qx.ui.basic.Atom(C,P);
bg.setRich(true);
bh.add(bg);
var bf=new qx.ui.tabview.TabView;
bh.add(bf,{flex:1});
var bk=new qx.ui.tabview.Page(c);
bf.add(bk);
var bi=new qx.ui.tabview.Page(M);
bf.add(bi);
var bj=new qx.ui.tabview.Page(o);
bf.add(bj);
},createWindow2:function(){var br=new qx.ui.window.Window(d,G);
br.setLayout(new qx.ui.layout.VBox(10));
br.setStatus(E);
br.open();
this.getRoot().add(br,{left:350,top:120});
var bB=new qx.ui.basic.Atom(r,V);
br.add(bB);
var bl=new qx.ui.container.Composite;
bl.setLayout(new qx.ui.layout.HBox(10));
br.add(bl,{flex:1});
var bu=new qx.ui.groupbox.GroupBox(O);
bu.setLayout(new qx.ui.layout.VBox(4));
bl.add(bu,{flex:1});
var bo=new qx.ui.form.CheckBox(X);
bo.setValue(true);
bo.addListener(l,function(e){br.setShowClose(e.getData());
});
bu.add(bo);
var bA=new qx.ui.form.CheckBox(U);
bA.setValue(true);
bA.addListener(l,function(e){br.setShowMaximize(e.getData());
});
bu.add(bA);
var bt=new qx.ui.form.CheckBox(A);
bt.setValue(true);
bt.addListener(l,function(e){br.setShowMinimize(e.getData());
});
bu.add(bt);
var bw=new qx.ui.form.CheckBox(T);
bw.setValue(true);
bw.addListener(l,function(e){br.setAllowClose(e.getData());
});
bu.add(bw);
var bC=new qx.ui.form.CheckBox(t);
bC.setValue(true);
bC.addListener(l,function(e){br.setAllowMaximize(e.getData());
});
bu.add(bC);
var bq=new qx.ui.form.CheckBox(D);
bq.setValue(true);
bq.addListener(l,function(e){br.setAllowMinimize(e.getData());
});
bu.add(bq);
var bm=new qx.ui.form.CheckBox(bb);
bm.setValue(false);
bm.addListener(l,function(e){br.setShowStatusbar(e.getData());
});
bu.add(bm);
var bD=new qx.ui.groupbox.GroupBox(J);
bD.setLayout(new qx.ui.layout.VBox(4));
bl.add(bD,{flex:1});
var by=new qx.ui.form.CheckBox(S);
by.setValue(true);
by.addListener(l,function(e){br.setUseResizeFrame(e.getData());
});
bD.add(by);
var bz=[z,h,b,u];

for(var i=0;i<bz.length;i++){var bx=bz[i];
var bp=new qx.ui.form.CheckBox(m+bx).set({value:true});
bp.bind(q,br,s+qx.lang.String.firstUp(bx));
bD.add(bp);
}var bn=new qx.ui.groupbox.GroupBox(x);
bn.setLayout(new qx.ui.layout.VBox(4));
bl.add(bn,{flex:1});
var bv=new qx.ui.form.CheckBox(Q);
bv.setValue(true);
bv.addListener(l,function(e){br.setMovable(e.getData());
});
bn.add(bv);
var bs=new qx.ui.form.CheckBox(a);
bs.addListener(l,function(e){br.setUseMoveFrame(e.getData());
});
bn.add(bs);
},createWindow3:function(){var bc=new qx.ui.window.Window(W,v);
bc.setLayout(new qx.ui.layout.VBox);
bc.setMaxWidth(450);
bc.setMaxHeight(400);
bc.setAllowMaximize(false);
bc.open();
this.getRoot().add(bc,{left:100,top:250});
var bd=this.getModalWindow1();
var be=new qx.ui.form.Button(N,j);
be.addListener(k,bd.open,bd);
bc.add(be);
},getModalWindow1:function(){var bK=new qx.ui.window.Window(L);
bK.setLayout(new qx.ui.layout.VBox(10));
bK.setModal(true);
bK.moveTo(150,150);
this.getRoot().add(bK);
var bJ=this.getModalWindow2();
var bM=new qx.ui.form.Button(H,j);
bM.addListener(k,bJ.open,bJ);
bK.add(bM);
var bL=new qx.ui.form.CheckBox(y);
bL.setValue(true);
bK.add(bL);
bL.addListener(l,function(e){bK.setModal(e.getData());
});
return bK;
},getModalWindow2:function(){var bF=new qx.ui.window.Window(I);
bF.setLayout(new qx.ui.layout.VBox(10));
bF.setModal(true);
bF.setShowClose(false);
bF.moveTo(300,300);
this.getRoot().add(bF);
var bE=new qx.ui.basic.Atom(B,Y);
bF.add(bE);
var bH=new qx.ui.container.Composite;
bH.setLayout(new qx.ui.layout.HBox(10,h));
bF.add(bH);
var bI=new qx.ui.form.Button(f,K);
bI.addListener(k,function(e){bF.close();
});
bH.add(bI);
var bG=new qx.ui.form.Button(R,ba);
bG.addListener(k,function(e){alert("Sorry, please click 'Yes'!");
});
bH.add(bG);
return bF;
}}});
...
(function(){var A="pane",z="lastTab",y="bar",x="page",w="firstTab",v="right",u="bottom",t="button",s="changeSelection",r="close",O="top",N="left",M="qx.event.type.Data",L="barRight",K="beforeChangeSelection",J="tabview",I="vertical",H="_applyBarPosition",G="barLeft",F="horizontal",D="qx.ui.tabview.TabView",E="__Fb",B="barTop",C="barBottom";
qx.Class.define(D,{extend:qx.ui.core.Widget,implement:qx.ui.core.ISingleSelection,include:[qx.ui.core.MContentPadding],construct:function(p){qx.ui.core.Widget.call(this);
this.__Fa={top:B,right:L,bottom:C,left:G};
this._createChildControl(y);
this._createChildControl(A);
var q=this.__Fb=new qx.ui.form.RadioGroup;
q.setWrap(false);
q.addListener(s,this._onChangeSelection,this);
if(p!=null){this.setBarPosition(p);
}else{this.initBarPosition();
}},events:{"changeSelection":M},properties:{appearance:{refine:true,init:J},barPosition:{check:[N,v,O,u],init:O,apply:H}},members:{__Fb:null,_createChildControlImpl:function(bh){var bi;

switch(bh){case y:bi=new qx.ui.container.SlideBar();
bi.setZIndex(10);
this._add(bi);
break;
case A:bi=new qx.ui.container.Stack;
bi.setZIndex(5);
this._add(bi,{flex:1});
break;
...
var bc=bb.getButton();
var bd=this.getChildControl(y);
var bf=this.getChildControl(A);
bb.exclude();
bd.add(bc);
bf.add(bb);
this.__Fb.add(bc);
bb.addState(this.__Fa[this.getBarPosition()]);
bb.addState(z);
var be=this.getChildren();

if(be[0]==bb){bb.addState(w);
}else{be[be.length-2].removeState(z);
}bb.addListener(r,this._onPageClose,this);
},remove:function(c){var j=this.getChildControl(A);
var g=this.getChildControl(y);
var f=c.getButton();
var h=j.getChildren();
if(this.getSelection()[0]==c){var d=h.indexOf(c);

if(d==0){if(h[1]){this.setSelection([h[1]]);
}else{this.resetSelection();
}}else{this.setSelection([h[d-1]]);
}}g.remove(f);
j.remove(c);
this.__Fb.remove(f);
c.removeState(this.__Fa[this.getBarPosition()]);
if(c.hasState(w)){c.removeState(w);

if(h[0]){h[0].addState(w);
}}
if(c.hasState(z)){c.removeState(z);

if(h.length>0){h[h.length-1].addState(z);
}}c.removeListener(r,this._onPageClose,this);
},getChildren:function(){return this.getChildControl(A).getChildren();
},indexOf:function(P){return this.getChildControl(A).indexOf(P);
},__Fa:null,_applyBarPosition:function(Q,R){var S=this.getChildControl(y);
var X=Q==N||Q==v;
var V=Q==v||Q==u;
...
S.setOrientation(X?I:F);
var Y=this.getChildren();
if(R){var T=this.__Fa[R];
S.removeState(T);
for(var i=0,l=Y.length;i<l;i++){Y[i].removeState(T);
}}
if(Q){var U=this.__Fa[Q];
S.addState(U);
for(var i=0,l=Y.length;i<l;i++){Y[i].addState(U);
}}},getSelection:function(){var bj=this.__Fb.getSelection();
var bk=[];

for(var i=0;i<bj.length;i++){bk.push(bj[i].getUserData(x));
}return bk;
},setSelection:function(bl){var bm=[];

for(var i=0;i<bl.length;i++){bm.push(bl[i].getChildControl(t));
}this.__Fb.setSelection(bm);
},resetSelection:function(){this.__Fb.resetSelection();
},isSelected:function(a){var b=a.getChildControl(t);
return this.__Fb.isSelected(b);
},isSelectionEmpty:function(){return this.__Fb.isSelectionEmpty();
},getSelectables:function(){var bn=this.__Fb.getSelectables();
var bo=[];

for(var i=0;i<bn.length;i++){bo.push(bn[i].getUserData(x));
}return bo;
},_onChangeSelection:function(e){var o=this.getChildControl(A);
var k=e.getData()[0];

if(k){o.setSelection([k.getUserData(x)]);
k.focus();
this.scrollChildIntoView(k,null,null,false);
}else{o.resetSelection();
}var n=o.getSelection();
var m=e.getOldData();
this.fireDataEvent(s,n,m);
},_onBeforeChangeSelection:function(e){if(!this.fireNonBubblingEvent(K,qx.event.type.Event,[false,true])){e.preventDefault();
}},_onRadioChangeSelection:function(e){var bg=e.getData()[0];

if(bg){this.setSelection([bg.getUserData(x)]);
}else{this.resetSelection();
...
qx.Class.define(e,{extend:qx.ui.container.Composite,construct:function(a,b){qx.ui.container.Composite.call(this);
this._createChildControl(n);
if(a!=null){this.setLabel(a);
}
if(b!=null){this.setIcon(b);
}},events:{"close":h},properties:{appearance:{refine:true,init:f},label:{check:k,init:m,apply:c},icon:{check:k,init:m,apply:j},showCloseButton:{check:d,init:false,apply:g}},members:{_forwardStates:{barTop:1,barRight:1,barBottom:1,barLeft:1,firstTab:1,lastTab:1},_applyIcon:function(q,r){this.getChildControl(n).setIcon(q);
},_applyLabel:function(o,p){this.getChildControl(n).setLabel(o);
},_applyEnabled:function(u,v){qx.ui.container.Composite.prototype._applyEnabled.call(this,u,v);
var w=this.getChildControl(n);
u==null?w.resetEnabled():w.setEnabled(u);
},_createChildControlImpl:function(s){var t;

switch(s){case n:t=new qx.ui.tabview.TabButton;
t.setAllowGrowX(true);
t.setAllowGrowY(true);
t.setUserData(i,this);
t.addListener(l,this._onButtonClose,this);
break;
}return t||qx.ui.container.Composite.prototype._createChildControlImpl.call(this,s);
},_applyShowCloseButton:function(x,y){this.getChildControl(n).setShowCloseButton(x);
...
qx.Class.define(i,{extend:qx.ui.form.RadioButton,implement:qx.ui.form.IRadioItem,construct:function(){qx.ui.form.RadioButton.call(this);
...
},events:{"close":d},properties:{showCloseButton:{check:k,init:false,apply:h}},members:{_forwardStates:{focused:true,checked:true},_applyIconPosition:function(w,x){var y={icon:this.getChildControl(o),label:this.getChildControl(n),closeButton:this.getShowCloseButton()?this.getChildControl(r):null};
for(var z in y){if(y[z]){this._remove(y[z]);
}}
switch(w){case g:this._add(y.label,{row:3,column:2});
this._add(y.icon,{row:1,column:2});

if(y.closeButton){this._add(y.closeButton,{row:0,column:4});
}break;
case j:this._add(y.label,{row:1,column:2});
this._add(y.icon,{row:3,column:2});

if(y.closeButton){this._add(y.closeButton,{row:0,column:4});
}break;
case p:this._add(y.label,{row:0,column:2});
this._add(y.icon,{row:0,column:0});

if(y.closeButton){this._add(y.closeButton,{row:0,column:4});
}break;
case m:this._add(y.label,{row:0,column:0});
...
switch(b){case n:var c=new qx.ui.basic.Label(this.getLabel());
c.setAnonymous(true);
this._add(c,{row:0,column:2});
this._getLayout().setColumnFlex(2,1);
break;
case o:c=new qx.ui.basic.Image(this.getIcon());
c.setAnonymous(true);
this._add(c,{row:0,column:0});
break;
case r:c=new qx.ui.form.Button();
c.addListener(l,this._onCloseButtonClick,this);
this._add(c,{row:0,column:4});

if(!this.getShowCloseButton()){c.exclude();
}break;
}return c||qx.ui.form.RadioButton.prototype._createChildControlImpl.call(this,b);
...
if(u){v.setColumnAlign(2,f,q);
}else{v.setColumnAlign(2,p,q);
}}}});
})();
