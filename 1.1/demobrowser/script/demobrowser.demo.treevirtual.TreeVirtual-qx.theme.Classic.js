...
(function(){var w="Trash",v="Windows (C:)",u="Data",t="Documents (D:)",s="background-color: cyan;",r="demobrowser.demo.treevirtual.TreeVirtual",q="Edit",p="Workspace",o="Network",n="Spam Message #",h="Inbox",m="Desktop",l="Sent",g="background-color: red; color: white;",f="Files",k="Tree",j="Spam";
...
var a=new qx.ui.treevirtual.TreeVirtual(k);
a.set({width:400});
a.setColumnWidth(0,400);
a.setAlwaysShowOpenCloseSymbol(true);
this.getRoot().add(a,{left:10,top:30,bottom:30});
var e=a.getDataModel();
var b=e.addBranch(null,m,true);
a.nodeSetLabelStyle(b,g);
var d;
e.addBranch(b,f,true);
d=e.addBranch(b,p,true);
e.addLeaf(d,v);
e.addLeaf(d,t);
e.addBranch(b,o,true);
d=e.addBranch(b,w,true);
a.nodeSetCellStyle(d,s);
var c=e.addBranch(null,h,true);
d=e.addBranch(c,j,false);

for(var i=1;i<3000;i++){e.addLeaf(d,n+i);
}e.addBranch(c,l,true);
e.addBranch(c,w,true);
e.addBranch(c,u,true);
e.addBranch(c,q,true);
e.setData();
}}});
})();
