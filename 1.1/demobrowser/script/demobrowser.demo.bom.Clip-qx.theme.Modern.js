...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.bom.Clip-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"928fe72adc8e"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var f="test1",e="demobrowser.demo.bom.Clip";
...
qx.log.Logger.debug("Clip init: "+l.left+","+l.top+"  "+l.width+","+l.height);
},set0:function(){var i=document.getElementById(f);
qx.log.Logger.debug("Setting to: 20,20  120,40");
qx.bom.element.Clip.set(i,{left:20,top:20,width:120,height:40});
var j=qx.bom.element.Clip.get(i)||{};
qx.log.Logger.debug("Clip after: "+j.left+","+j.top+"  "+j.width+","+j.height);
},set1:function(){var c=document.getElementById(f);
qx.log.Logger.debug("Setting to: 20,20  null,40");
qx.bom.element.Clip.set(c,{left:20,top:20,height:40});
var d=qx.bom.element.Clip.get(c)||{};
qx.log.Logger.debug("Clip after: "+d.left+","+d.top+"  "+d.width+","+d.height);
},set2:function(){var g=document.getElementById(f);
qx.log.Logger.debug("Setting to: 20,20  120,null");
qx.bom.element.Clip.set(g,{left:20,top:20,width:120});
var h=qx.bom.element.Clip.get(g)||{};
qx.log.Logger.debug("Clip after: "+h.left+","+h.top+"  "+h.width+","+h.height);
},set3:function(){var m=document.getElementById(f);
qx.log.Logger.debug("Setting to: null,20  120,40");
qx.bom.element.Clip.set(m,{top:20,width:120,height:40});
var n=qx.bom.element.Clip.get(m)||{};
qx.log.Logger.debug("Clip after: "+n.left+","+n.top+"  "+n.width+","+n.height);
},set4:function(){var a=document.getElementById(f);
qx.log.Logger.debug("Setting to: 20,null  120,40");
qx.bom.element.Clip.set(a,{left:20,width:120,height:40});
var b=qx.bom.element.Clip.get(a)||{};
qx.log.Logger.debug("Clip after: "+b.left+","+b.top+"  "+b.width+","+b.height);
},reset:function(){var o=document.getElementById(f);
