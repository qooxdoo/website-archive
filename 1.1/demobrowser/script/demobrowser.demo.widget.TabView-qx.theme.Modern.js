...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.TabView","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.TabView-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"f668b299b0b8"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var q="Page #",p="execute",o="icon/32/apps/utilities-terminal.png",n="icon/16/apps/utilities-terminal.png",m="icon/16/apps/utilities-calculator.png",l="demobrowser.demo.widget.TabView",k="bottom",j="Notes",h="Remove first page",g="Layout",G="icon/16/apps/utilities-help.png",F="Add new page",E="changeSelection",D="Calculator...",C="icon/16/apps/utilities-notes.png",B="Bar Position",A="top",z="Calculator",y="right",x="Help",v="Help...",w="Notes...",t="Layout-Settings",u="Remove last page",r="left",s=" with close button.";
...
var d=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
d.setPadding(20);
d.setAllowStretchX(false);
f.add(d);
this.getRoot().add(f,{edge:0});
d.add(this.getTabView1());
d.add(this.getTabView2());
d.add(this.getTabView3());
},getTabView1:function(){var H=new qx.ui.tabview.TabView();
H.setWidth(500);
var L=new qx.ui.tabview.Page(g,n);
L.setLayout(new qx.ui.layout.VBox());
L.add(new qx.ui.basic.Label(t));
H.add(L);
var J=new qx.ui.tabview.Page(j,C);
J.setLayout(new qx.ui.layout.VBox());
J.add(new qx.ui.basic.Label(w));
H.add(J);
var K=new qx.ui.tabview.Page(z,m);
K.setLayout(new qx.ui.layout.VBox());
K.add(new qx.ui.basic.Label(D));
H.add(K);
var I=new qx.ui.tabview.Page(x,G);
I.setLayout(new qx.ui.layout.VBox());
I.add(new qx.ui.basic.Label(v));
H.add(I);
return H;
},getTabView2:function(){var N=new qx.ui.tabview.TabView();
N.setWidth(500);

for(var i=1;i<=20;i++){var O=new qx.ui.tabview.Page(q+i,n);
O.setLayout(new qx.ui.layout.VBox());
O.setShowCloseButton(true);
O.add(new qx.ui.basic.Label(q+i+s));
N.add(O);
}return N;
},getTabView3:function(){var R=new qx.ui.tabview.TabView();
R.setWidth(500);
R.setHeight(300);

for(var i=1;i<=3;i++){var bb=new qx.ui.tabview.Page(q+i,o);
bb.setLayout(new qx.ui.layout.VBox(4));
R.add(bb);
bb.add(new qx.ui.basic.Label(q+i));
}var T=R.getChildren()[0];
var Y=new qx.ui.basic.Label(B);
var W=new qx.ui.form.RadioButton(A);
var Q=new qx.ui.form.RadioButton(k);
var V=new qx.ui.form.RadioButton(r);
var X=new qx.ui.form.RadioButton(y);
T.add(new qx.ui.core.Spacer(10,10));
T.add(Y);
T.add(W);
T.add(Q);
T.add(V);
T.add(X);
var ba=new qx.ui.form.RadioGroup(W,Q,V,X);
ba.addListener(E,function(e){this.setBarPosition(e.getData()[0].getLabel());
},R);
V.setValue(true);
var S=new qx.ui.form.Button(F);
var U=new qx.ui.form.Button(h);
var P=new qx.ui.form.Button(u);
T.add(new qx.ui.core.Spacer(10,10));
T.add(S);
T.add(U);
T.add(P);
S.addListener(p,function(e){var a=R.getChildren().length+1;
var b=new qx.ui.tabview.Page(q+a,o);
R.add(b);
});
U.addListener(p,function(e){var c=R.getChildren();

if(c.length>0){R.remove(c[0]);
}});
P.addListener(p,function(e){var M=R.getChildren();

if(M.length>0){R.remove(M[M.length-1]);
}});
return R;
}}});
})();
