...
(function(){var W="",V="Hello",U="icon/16/actions/go-down.png",T="World",S="bold",R="Juhu",Q="waiting",P="icon/16/actions/go-next.png",O="http://resources.qooxdoo.org/images/logo.gif",N="$ ",bx="string",bw="border: 1px dotted green",bv="decoration",bu="multi<br>line",bt="between",bs="<",br="inactive",bq="qx/decoration/Modern",bp="icon/16/actions/go-previous.png",bo="icon",be="number",bf="<i>italic</i>",bc="0$",bd="qx/icon/Tango",ba="<b>bold</b>",bb="icon/16/actions/go-up.png",X="boolean",Y="demobrowser.demo.test.Table_CellRenderer",bg="tooltip",bh="red",bj="icon/16/emotes/face-sad.png",bi="icon/16/emotes/face-smile.png",bl="left",bk=">=",bn="active",bm="object";
qx.Class.define(Y,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Native.prototype.main.call(this);
this.setUp();
...
qx.util.AliasManager.getInstance().add(bv,bq);
qx.util.AliasManager.getInstance().add(bo,bd);
},__MJ:function(u,top,v,w,x){var y=["<div style='position:absolute;height:20px;width:",v,"px;top:",top,"px'>"];
w.createDataCellHtml(x,y);
y.push("</div>");
u.innerHTML+=y.join("");
},testDefaultRenderer:function(D){var E=100;
var G={value:[null,R,32,new Date()],styleLeft:[0],styleWidth:[E],styleHeight:[20],style:[W]};
var F=this._getNewTableDiv(E);
var top=0;
qx.util.Permutation.permute(G,function(z){this.__MJ(F,top,E,D,z);
top+=20;
},this);
},testBooleanRenderer:function(){var s=70;
var r=30;
var t=new qx.ui.table.cellrenderer.Boolean();
var p={value:[null,true,false],styleLeft:[0],styleWidth:[s],styleHeight:[r],style:[W]};
var q=this._getNewTableDiv(s);
var top=0;
qx.util.Permutation.permute(p,function(bG){this.__MJ(q,top,s,t,bG);
top+=r;
},this);
t.setIconFalse(bj);
t.setIconTrue(bi);
qx.util.Permutation.permute(p,function(cj){this.__MJ(q,top,s,t,cj);
top+=r;
},this);
},testDateRenderer:function(){var bC=180;
var bD=new qx.ui.table.cellrenderer.Date();
var bF={value:new Date(),styleLeft:[0],styleWidth:[bC],styleHeight:[20],style:[W]};
var bB=qx.util.format.DateFormat;
var bE=[bB.getDateTimeInstance(),bB.getDateInstance()];
var bz=this._getNewTableDiv(bC);
var top=0;

for(var i=0;i<bE.length;i++){var bA=bE[i];
bD.setDateFormat(bA);
this.__MJ(bz,top,bC,bD,bF);
top+=20;
}},testNumberRenderer:function(){var bQ=new qx.ui.table.cellrenderer.Number();
var bP=100;
var bS={value:Math.PI,styleLeft:[0],styleWidth:[bP],styleHeight:[20],style:[W]};
var bO=qx.util.format.NumberFormat;
var bR=[bO.getIntegerInstance(),new bO().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:N})];
var bM=this._getNewTableDiv(bP);
var top=0;

for(var i=0;i<bR.length;i++){var bN=bR[i];
bQ.setNumberFormat(bN);
this.__MJ(bM,top,bP,bQ,bS);
top+=20;
}},testImageRenderer:function(){var ch=new qx.ui.table.cellrenderer.Image();
var cf=50;
var ci={value:[null,U,bb,bp,P,O],styleLeft:[0],styleWidth:[cf],styleHeight:[20],style:[W],tooltip:[W,bg]};
var cg=this._getNewTableDiv(cf);
var top=0;
qx.util.Permutation.permute(ci,function(A){this.__MJ(cg,top,cf,ch,A);
top+=20;
},this);
},testStringRenderer:function(){var L=new qx.ui.table.cellrenderer.String();
var K=100;
var J=20;
var H={value:[null,V,T],styleLeft:[0],styleWidth:[K],styleHeight:[J],style:[W]};
var I=this._getNewTableDiv(K);
var top=0;
qx.util.Permutation.permute(H,function(by){this.__MJ(I,top,K,L,by);
top+=20;
},this);
},testPasswordRenderer:function(){var n=new qx.ui.table.cellrenderer.Password();
var m=100;
var l=20;
var j={value:[null,V,T],styleLeft:[0],styleWidth:[m],styleHeight:[l],style:[W]};
var k=this._getNewTableDiv(m);
var top=0;
qx.util.Permutation.permute(j,function(C){this.__MJ(k,top,m,n,C);
top+=20;
},this);
},testHtmlRenderer:function(){var bL=new qx.ui.table.cellrenderer.Html();
var bK=100;
var bJ=50;
var bH={value:[null,ba,bf,bu],styleLeft:[0],styleWidth:[bK],styleHeight:[bJ],style:[W]};
var bI=this._getNewTableDiv(bK);
var top=0;
qx.util.Permutation.permute(bH,function(o){this.__MJ(bI,top,bK,bL,o);
top+=20;
},this);
},testConditionalRenderer:function(){var ce=new qx.ui.table.cellrenderer.Conditional();
ce.addNumericCondition(bs,0,null,bh,null,null);
ce.addNumericCondition(bk,100,bl,null,null,null);
ce.addBetweenCondition(bt,0,2,null,null,null,S,null);
ce.addRegex(bc,null,null,S,bw);
var cd=100;
var cc=20;
var ca={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[cd],table:[this.tableMock],styleHeight:[cc],style:[W]};
var cb=this._getNewTableDiv(cd);
var top=0;
qx.util.Permutation.permute(ca,function(B){this.__MJ(cb,top,cd,ce,B);
top+=20;
},this);
},testDynamicRenderer:function(){var h=new qx.ui.table.cellrenderer.Dynamic();
h.setCellRendererFactoryFunction(function(a){var c=a.value;
var b=qx.ui.table.cellrenderer;

switch(typeof c){case bx:if(c.match(/^icon\//)){return new b.Image();
}else{return new b.String();
}case X:return new b.Boolean();
case be:return new b.Number();
case bm:if(c instanceof Date){return new b.Date();
}return new b.Default();
}});
var g=100;
var f=20;
var d={value:[null,R,new Date(),30,U,false],styleLeft:[0],styleWidth:[g],styleHeight:[f],table:[this.tableMock],style:[W]};
var e=this._getNewTableDiv(g);
var top=0;
qx.util.Permutation.permute(d,function(bT){this.__MJ(e,top,g,h,bT);
top+=20;
},this);
},testReplaceRenderer:function(){var bY=new qx.ui.table.cellrenderer.Replace();
bY.setReplaceMap({1:bn,2:br,3:Q});
bY.addReversedReplaceMap();
var bX=100;
var bW=20;
var bU={value:[1,2,3],styleLeft:[0],styleWidth:[bX],table:[this.tableMock],styleHeight:[bW],style:[W]};
var bV=this._getNewTableDiv(bX);
var top=0;
qx.util.Permutation.permute(bU,function(M){this.__MJ(bV,top,bX,bY,M);
top+=20;
},this);
...
(function(){var D="",C="==",B=">",A="between",z="<",y="regex",x="!between",w=">=",v="!=",u="<=",o="font-weight",t=";",r="text-align",n='g',m=":",q="qx.ui.table.cellrenderer.Conditional",p="color",s="font-style";
qx.Class.define(q,{extend:qx.ui.table.cellrenderer.Default,construct:function(E,F,G,H){qx.ui.table.cellrenderer.Default.call(this);
this.numericAllowed=[C,v,B,z,w,u];
this.betweenAllowed=[A,x];
this.conditions=[];
this.__we=E||D;
this.__wf=F||D;
this.__wg=G||D;
this.__wh=H||D;
},members:{__we:null,__wf:null,__wg:null,__wh:null,__wi:function(k,l){if(k[1]!=null){l[r]=k[1];
}
if(k[2]!=null){l[p]=k[2];
}
if(k[3]!=null){l[s]=k[3];
...
if(k[4]!=null){l[o]=k[4];
}},addNumericCondition:function(P,Q,R,S,T,U,V){var W=null;

if(qx.lang.Array.contains(this.numericAllowed,P)){if(Q!=null){W=[P,R,S,T,U,Q,V];
}}
...
}},addRegex:function(I,J,K,L,M,N){if(I!=null){var O=[y,J,K,L,M,I,N];
}
if(O!=null){this.conditions.push(O);
}else{throw new Error("regex cannot be null!");
}},_getCellStyle:function(X){if(!this.conditions.length){return X.style||D;
}var bd=X.table.getTableModel();
var i;
var bf;
var Y;
var bb={"text-align":this.__we,"color":this.__wf,"font-style":this.__wg,"font-weight":this.__wh};
...
switch(this.conditions[i][0]){case C:if(Y==this.conditions[i][5]){bf=true;
}break;
case v:if(Y!=this.conditions[i][5]){bf=true;
}break;
case B:if(Y>this.conditions[i][5]){bf=true;
}break;
case z:if(Y<this.conditions[i][5]){bf=true;
}break;
...
switch(this.conditions[i][0]){case A:if(Y>=this.conditions[i][5]&&Y<=this.conditions[i][6]){bf=true;
}break;
case x:if(Y<this.conditions[i][5]&&Y>this.conditions[i][6]){bf=true;
}break;
}}else if(this.conditions[i][0]==y){if(this.conditions[i][6]==null){Y=X.value;
}else{Y=bd.getValueById(this.conditions[i][6],X.row);
}var ba=new RegExp(this.conditions[i][5],n);
bf=ba.test(Y);
}if(bf==true){this.__wi(this.conditions[i],bb);
}}var be=[];

for(var bc in bb){if(bb[bc]){be.push(bc,m,bb[bc],t);
}}return be.join(D);
...
qx.Class.define(d,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(a,b){qx.ui.table.cellrenderer.AbstractImage.call(this);

if(a){this.__ps=a;
}
if(b){this.__pt=b;
}this.__pu=qx.util.AliasManager.getInstance();
},members:{__pu:null,__pt:16,__ps:16,_identifyImage:function(e){var f={imageWidth:this.__ps,imageHeight:this.__pt};

if(e.value==c){f.url=null;
}else{f.url=this.__pu.resolve(e.value);
}f.tooltip=e.tooltip;
return f;
...
(function(){var c="Function",b="qx.ui.table.cellrenderer.Dynamic";
qx.Class.define(b,{extend:qx.ui.table.cellrenderer.Default,construct:function(a){qx.ui.table.cellrenderer.Default.call(this);

if(a){this.setCellRendererFactoryFunction(a);
}},properties:{cellRendererFactoryFunction:{check:c,nullable:true,init:null}},members:{createDataCellHtml:function(d,e){var g=this.getCellRendererFactoryFunction();
