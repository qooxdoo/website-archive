...
(function(){var B="horizontal",A="main",z="Flex:1",y="Flex:1; Min:250",x="Auto",w="Flex:2",v="Flex:0",u="Flex:2; Max:100",t="Flex:1; Max:100",s="Flex:1; Max:200",p="Flex:2; Min:250",r="Flex:0; Min:350",q="demobrowser.demo.layout.HSplit";
...
},addSplitPaneTwoFlexSimple:function(){var G=new qx.ui.splitpane.Pane(B);
G.setWidth(400);
G.setHeight(60);
G.setDecorator(A);
this.getRoot().add(G,{left:20,top:20});
var F=new qx.ui.form.TextArea(z);
F.setDecorator(null);
F.setWrap(true);
G.add(F,1);
var H=new qx.ui.form.TextArea(w);
H.setDecorator(null);
H.setWrap(true);
G.add(H,2);
},addSplitPaneTwoFlexWithOneMin:function(){var M=new qx.ui.splitpane.Pane(B);
M.setWidth(400);
M.setHeight(60);
M.setDecorator(A);
this.getRoot().add(M,{left:20,top:100});
var L=new qx.ui.form.TextArea(y);
L.setDecorator(null);
L.setWrap(true);
L.setMinWidth(250);
M.add(L,1);
var N=new qx.ui.form.TextArea(w);
N.setDecorator(null);
N.setWrap(true);
M.add(N,2);
},addSplitPaneTwoFlexWithOneMax:function(){var n=new qx.ui.splitpane.Pane(B);
n.setWidth(400);
n.setHeight(60);
n.setDecorator(A);
this.getRoot().add(n,{left:20,top:180});
var m=new qx.ui.form.TextArea(z);
m.setDecorator(null);
m.setWrap(true);
n.add(m,1);
var o=new qx.ui.form.TextArea(u);
o.setDecorator(null);
o.setWrap(true);
o.setMaxWidth(100);
n.add(o,2);
},addSplitPaneTwoFlexWithTwoMin:function(){var h=new qx.ui.splitpane.Pane(B);
h.setWidth(400);
h.setHeight(60);
h.setDecorator(A);
this.getRoot().add(h,{left:20,top:260});
var g=new qx.ui.form.TextArea(y);
g.setDecorator(null);
g.setWrap(true);
g.setMinWidth(250);
h.add(g,1);
var i=new qx.ui.form.TextArea(p);
i.setDecorator(null);
i.setWrap(true);
i.setMinWidth(250);
h.add(i,2);
},addSplitPaneTwoFlexWithTwoMax:function(){var e=new qx.ui.splitpane.Pane(B);
e.setWidth(400);
e.setHeight(60);
e.setDecorator(A);
this.getRoot().add(e,{left:20,top:340});
var d=new qx.ui.form.TextArea(t);
d.setDecorator(null);
d.setWrap(true);
d.setMaxWidth(100);
e.add(d,1);
var f=new qx.ui.form.TextArea(u);
f.setDecorator(null);
f.setWrap(true);
f.setMaxWidth(100);
e.add(f,2);
},addSplitPaneOneFlexSimple:function(){var D=new qx.ui.splitpane.Pane(B);
D.setWidth(400);
D.setHeight(60);
D.setDecorator(A);
this.getRoot().add(D,{left:500,top:20});
var C=new qx.ui.form.TextArea(v);
C.setDecorator(null);
C.setWrap(true);
D.add(C,0);
var E=new qx.ui.form.TextArea(z);
E.setDecorator(null);
E.setWrap(true);
D.add(E);
},addSplitPaneOneFlexSimpleWithMax:function(){var k=new qx.ui.splitpane.Pane(B);
k.setWidth(400);
k.setHeight(60);
k.setDecorator(A);
this.getRoot().add(k,{left:500,top:100});
var j=new qx.ui.form.TextArea(v);
j.setDecorator(null);
j.setWrap(true);
k.add(j,0);
var l=new qx.ui.form.TextArea(s);
l.setDecorator(null);
l.setWrap(true);
l.setMaxWidth(200);
k.add(l);
},addSplitPaneOneFlexSimpleWithMin:function(){var J=new qx.ui.splitpane.Pane(B);
J.setWidth(400);
J.setHeight(60);
J.setDecorator(A);
this.getRoot().add(J,{left:500,top:180});
var I=new qx.ui.form.TextArea(r);
I.setDecorator(null);
I.setWrap(true);
I.setMinWidth(350);
J.add(I,0);
var K=new qx.ui.form.TextArea(z);
K.setDecorator(null);
K.setWrap(true);
J.add(K);
},addSplitPaneAuto:function(){var b=new qx.ui.splitpane.Pane(B);
b.setDecorator(A);
this.getRoot().add(b,{left:500,top:340});
var a=new qx.ui.form.TextArea(x);
a.setDecorator(null);
a.setWrap(true);
b.add(a,0);
var c=new qx.ui.form.TextArea(x);
c.setDecorator(null);
c.setWrap(true);
b.add(c);
}}});
