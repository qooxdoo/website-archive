...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Tree_Columns","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Tree_Columns-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"42f01142857e"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="icon/16/devices/drive-harddisk.png",j="Trash",h="Windows (C:)",g="Documents (D:)",f="Family",e="TINC",d="Development",c="Inbox",b="Desktop",a="Announce",S="Personal",R="Products",Q="-rw-r--r--",P="Presets",O="Competition",N="Network",M="Questions",L="Sent",K="Spam",J="Files",r="icon/16/status/dialog-information.png",s="Bugs",p="Projects",q="Company",n="Devel",o="Workspace",l="Holiday",m="icon/16/places/user-trash.png",t="Chat",u=" 2005",B="Big",z="Press",D="Data",C="Internal",F="demobrowser.demo.widget.Tree_Columns",E="May ",w="Root",I="icon/16/places/user-desktop.png",H="kb",G="Pustefix",v="Relations",x="Lists",y="Item ",A="Edit";
...
var bf=new qx.ui.container.Scroll();
var bp=new qx.ui.container.Composite(new qx.ui.layout.Basic());
bp.setAllowGrowX(false);
bp.setAllowStretchX(false);
bf.add(bp);
this.getRoot().add(bf,{edge:0});
var bK=new qx.ui.tree.Tree().set({width:600,height:500});
bp.add(bK,{left:20,top:48});
var bL=this.configureTreeItem(new qx.ui.tree.TreeFolder(),w);
bL.setOpen(true);
bK.setRoot(bL);
var bD=this.configureTreeItem(new qx.ui.tree.TreeFolder(),b);
bL.add(bD);
var bg=this.configureTreeItem(new qx.ui.tree.TreeFolder(),J);
var bd=this.configureTreeItem(new qx.ui.tree.TreeFolder(),o);
var be=this.configureTreeItem(new qx.ui.tree.TreeFolder(),N);
var bc=this.configureTreeItem(new qx.ui.tree.TreeFolder(),j);
bD.add(bg,bd,be,bc);
var bJ=this.configureTreeItem(new qx.ui.tree.TreeFile(),h,k);
var bI=this.configureTreeItem(new qx.ui.tree.TreeFile(),g,k);
bd.add(bJ,bI);
var bE=this.configureTreeItem(new qx.ui.tree.TreeFolder(),c);
var bh=this.configureTreeItem(new qx.ui.tree.TreeFolder(),P);
var bk=this.configureTreeItem(new qx.ui.tree.TreeFolder(),L);
var bj=this.configureTreeItem(new qx.ui.tree.TreeFolder(),j,m);
var bm=this.configureTreeItem(new qx.ui.tree.TreeFolder(),D);
var bl=this.configureTreeItem(new qx.ui.tree.TreeFolder(),A);
var bz=this.configureTreeItem(new qx.ui.tree.TreeFolder(),t);
var by=this.configureTreeItem(new qx.ui.tree.TreeFolder(),G);
var bx=this.configureTreeItem(new qx.ui.tree.TreeFolder(),e);
var bH=this.configureTreeItem(new qx.ui.tree.TreeFolder(),a);
var bG=this.configureTreeItem(new qx.ui.tree.TreeFolder(),n);
bx.add(bH,bG);
bl.add(bz,by,bx);
var bo=this.configureTreeItem(new qx.ui.tree.TreeFolder(),x);
var bu=this.configureTreeItem(new qx.ui.tree.TreeFolder(),v);
var bv=this.configureTreeItem(new qx.ui.tree.TreeFolder(),q);
var bw=this.configureTreeItem(new qx.ui.tree.TreeFolder(),M);
var bq=this.configureTreeItem(new qx.ui.tree.TreeFolder(),C);
var br=this.configureTreeItem(new qx.ui.tree.TreeFolder(),R);
var bs=this.configureTreeItem(new qx.ui.tree.TreeFolder(),z);
var bt=this.configureTreeItem(new qx.ui.tree.TreeFolder(),d);
var bA=this.configureTreeItem(new qx.ui.tree.TreeFolder(),O);
bo.add(bu,bv,bw,bq,br,bs,bt,bA);
var bn=this.configureTreeItem(new qx.ui.tree.TreeFolder(),S);
var bB=this.configureTreeItem(new qx.ui.tree.TreeFolder(),s);
var bF=this.configureTreeItem(new qx.ui.tree.TreeFolder(),f);
var bC=this.configureTreeItem(new qx.ui.tree.TreeFolder(),p);
var bi=this.configureTreeItem(new qx.ui.tree.TreeFolder(),l);
bn.add(bB,bF,bC,bi);
var bb=this.configureTreeItem(new qx.ui.tree.TreeFolder(),B);

for(var i=0;i<50;i++){bb.add(this.configureTreeItem(new qx.ui.tree.TreeFolder(),y+i));
}var ba=this.configureTreeItem(new qx.ui.tree.TreeFolder(),K);
bE.add(bh,bk,bj,bm,bl,bo,bn,bb,ba);
bL.add(bE);
},configureTreeItem:function(T,U,V){if(Math.floor(Math.random()*4)==0){var Y=new qx.ui.basic.Image(r);
T.addWidget(Y);
}else{T.addWidget(new qx.ui.core.Spacer(16,16));
}T.addSpacer();

if(T instanceof qx.ui.tree.TreeFolder){T.addOpenButton();
}T.addIcon();
T.setIcon(arguments.length>=3?V:I);
var X=new qx.ui.form.CheckBox();
X.setFocusable(false);
T.addWidget(X);
T.addLabel(U);
T.addWidget(new qx.ui.core.Spacer(),{flex:1});
var W=new qx.ui.basic.Label(Math.round(Math.random()*100)+H);
W.setWidth(50);
T.addWidget(W);
W=new qx.ui.basic.Label(E+Math.round(Math.random()*30+1)+u);
W.setWidth(150);
T.addWidget(W);
W=new qx.ui.basic.Label(Q);
W.setWidth(80);
T.addWidget(W);
return T;
}}});
