...
c.setSpacing(20);
var d=new qx.ui.container.Composite(c).set({padding:20});
this.getRoot().add(d);
d.add(this._getPopupButton1());
d.add(this._getPopupButton2());
...
return o;
},_getPopupButton2:function(){var a=new qx.ui.form.Button(i);
var b=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:j,padding:[2,4],offset:3,position:h});
b.add(new qx.ui.basic.Atom(l,m));
a.addListener(n,function(e){b.placeToMouse(e);
b.show();
},this);
return a;
}}});
