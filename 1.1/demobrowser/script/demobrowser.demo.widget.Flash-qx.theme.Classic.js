...
(function(){var q="execute",p="__MW",o="Flash Player Version",n="right",m="__MY",l="Message from Flash:",k="__Na",j="__MX",i="Simple demo with FlashVars",h="bgcolor",F="demobrowser.demo.widget.Flash",E="Send to Flash",D="demobrowser/demo/flash/FlashVersion.swf",C="Flash:",B="<b>qooxdoo:</b>",A="__MV",z="demobrowser.demo.widget.Flash.sendMessage",y="demobrowser.demo.widget.Flash.flashReady",x="demobrowser/demo/flash/fo_tester.swf",w="this is passed in via FlashVars",u="Two way communication (ActionScript <-> JavaScript)",v="Message to Flash:",s="Show Flash Player version",t="noscale",r="#FF6600";
qx.Class.define(F,{extend:qx.application.Standalone,members:{__MV:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var a=new qx.ui.tabview.TabView();
a.setContentPadding([8,8,8,8]);
var d=this.getRoot();
d.add(a,{edge:0});
var b=new qx.ui.tabview.Page(i);
b.setLayout(new qx.ui.layout.Canvas());
b.add(this.createFlashDemo1(),{edge:0});
a.add(b);
var c=new qx.ui.tabview.Page(u);
c.setLayout(new qx.ui.layout.Canvas());
c.add(this.createFlashDemo2(),{edge:0});
a.add(c);
this.__MV=this.createWindow();
d.add(this.__MV,{top:20,left:20});
},createWindow:function(){var K=new qx.ui.window.Window(o).set({width:300,height:200,contentPadding:[0,0,0,0]});
K.setLayout(new qx.ui.layout.Canvas());
K.add(new qx.ui.embed.Flash(D),{edge:0});
return K;
},createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var L={flashVarText:w};
var M=new qx.ui.embed.Flash(x).set({scale:t,variables:L});
M.getContentElement().setParam(h,r);
N.add(M,{flex:1});
var O=new qx.ui.form.Button(s);
O.addListener(q,function(){this.__MV.open();
},this);
N.add(O);
return N;
},__MW:null,__MX:null,__MY:null,__Na:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);
var I=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
var H=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
I.add(H,{flex:1});
H.add(new qx.ui.basic.Label(B).set({rich:true}));
H.add(new qx.ui.basic.Label(l));
this.__MX=new qx.ui.form.TextArea("No message.");
this.__MX.setEnabled(false);
H.add(this.__MX,{flex:1});
H.add(new qx.ui.basic.Label(v));
this.__MY=new qx.ui.form.TextArea("qooxdoo is the best!");
H.add(this.__MY,{flex:1});
var J=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,n));
this.__Na=new qx.ui.form.Button(E);
this.__Na.setEnabled(false);
this.__Na.addListener(q,function(e){this.__MW.getFlashElement().sendMessage(this.__MY.getValue());
},this);
J.add(this.__Na);
H.add(J);
var G=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
I.add(G,{flex:1});
G.add(new qx.ui.basic.Label(C).set({rich:true}));
this.__MW=new qx.ui.embed.Flash("demobrowser/demo/flash/TestFlash.swf");
this.__MW.setVariables({init:y});
G.add(this.__MW,{flex:1});
return I;
},sendMessage:function(f){this.__MX.setValue(f);
},initFlash:function(){if(this.__MW.getFlashElement().setup){this.__MW.getFlashElement().setup(z);
this.__Na.setEnabled(true);
...
}}},statics:{__Nb:null,setCallBackInstance:function(P){demobrowser.demo.widget.Flash.__Nb=P;
},sendMessage:function(g){demobrowser.demo.widget.Flash.__Nb.sendMessage(g);
},flashReady:function(){demobrowser.demo.widget.Flash.__Nb.initFlash();
}},destruct:function(){this._disposeObjects(j,m,k,p,A);
}});
})();
...
qx.Class.define(r,{extend:qx.ui.core.Widget,construct:function(bj,bk){qx.ui.core.Widget.call(this);
{};
this.setSource(bj);
...
},properties:{source:{check:i,apply:C},id:{check:i,apply:o},quality:{check:[e,z,I,E,p,h],init:h,nullable:true,apply:F},scale:{check:[S,t,P,y],nullable:true,apply:J},wmode:{check:[w,j,n],init:j,nullable:true,apply:s},play:{check:l,nullable:true,apply:M},loop:{check:l,nullable:true,apply:d},mayScript:{check:l,nullable:false,apply:G},menu:{check:l,nullable:true,apply:O},allowScriptAccess:{check:[k,H,x],init:k,nullable:true,apply:T},liveConnect:{check:l,init:true,nullable:true,apply:v},variables:{init:{},check:R,apply:f}},members:{getFlashElement:function(){var bg=this.getContentElement();

if(bg){return bg.getFlashElement();
}else{return null;
}},_createContentElement:function(){return new qx.html.Flash();
},_applySource:function(Y,ba){var bb=qx.util.ResourceManager.getInstance().toUri(Y);
this.getContentElement().setSource(bb);
qx.ui.core.queue.Layout.add(this);
},_applyId:function(bl,bm){this.getContentElement().setId(bl);
qx.ui.core.queue.Layout.add(this);
},_applyVariables:function(bp,bq){this.getContentElement().setVariables(bp);
qx.ui.core.queue.Layout.add(this);
},_applyMayScript:function(bh,bi){this.getContentElement().setAttribute(B,bh?m:false);
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(bc,bd){this.__GQ(g,bc);
},_applyScale:function(bt,bu){this.__GQ(c,bt);
},_applyWmode:function(a,b){this.__GQ(Q,a);
},_applyPlay:function(W,X){this.__GQ(u,W);
},_applyLoop:function(U,V){this.__GQ(L,U);
},_applyMenu:function(be,bf){this.__GQ(N,be);
},_applyAllowScriptAccess:function(br,bs){this.__GQ(K,br);
},_applyLiveConnect:function(bn,bo){this.__GQ(q,bn);
},__GQ:function(bv,bw){this.getContentElement().setParam(bv,bw);
qx.ui.core.queue.Layout.add(this);
}}});
})();
(function(){var h="div",g="movie",f="id",e="qx.html.Flash";
qx.Class.define(e,{extend:qx.html.Element,construct:function(c,d){qx.html.Element.call(this,h,c,d);
this.__Gg={};
this.__Gh={};
this.__Gi={};
},members:{__Gg:null,__Gi:null,__Gh:null,__Gj:null,_createDomElement:function(){return qx.bom.Element.create(h);
},createFlash:function(){this.__Gj=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__Gh,this.__Gg);
},setSource:function(a){{};

if(this.__Gj){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(g,a);
},setId:function(k){{};

if(this.__Gj){throw new Error("The id cannot be modified after initial creation");
}this.setAttribute(f,k);
},getVariables:function(){return this.__Gh;
},setVariables:function(b){{};

if(this.__Gj){throw new Error("The variables cannot be modified after initial creation");
}this.__Gh=b;
},getAttributes:function(){return this.__Gi;
},setAttribute:function(i,j){{};

if(this.__Gj){throw new Error("The attributes cannot be modified after initial creation");
}
if(j===null||j===undefined){delete this.__Gi[i];
}else{this.__Gi[i]=j;
}},getParams:function(){return this.__Gg;
},setParam:function(l,m){{};

if(this.__Gj){throw new Error("The params cannot be modified after initial creation");
}
if(m===null||m===undefined){delete this.__Gg[l];
}else{this.__Gg[l]=m;
}},getFlashElement:function(){return this.__Gj;
}},destruct:function(){if(this.__Gj){qx.bom.Flash.destroy(this.__Gj);
}this.__Gg=this.__Gh=this.__Gi=null;
}});
})();
