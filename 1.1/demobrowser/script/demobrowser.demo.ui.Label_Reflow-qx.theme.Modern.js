...
var d=false;
f.addListener(s,function(){var v=h.getChildren()[0];
v.setValue(d?t:q);
d=!d;
});
...
},getPane:function(){var z=new qx.ui.container.Composite(new qx.ui.layout.VBox(14)).set({backgroundColor:o,width:600,decorator:u,padding:10});
var w=new qx.ui.basic.Label().set({rich:true,value:t});
z.add(w);
var x=new qx.ui.basic.Label().set({rich:true,value:n});
z.add(x);
var y=new qx.ui.basic.Label().set({rich:true,value:p});
z.add(y);
return z;
}}});
})();
