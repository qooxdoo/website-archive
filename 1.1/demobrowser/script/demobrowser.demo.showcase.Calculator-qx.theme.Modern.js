...
(function(){var n="execute",m="-",l="+",k="n",j="/",i="*",h="=",g="sans-serif",f="Verdana",d=".",L="black",K="Del",J="C",I="5",H="7",G="demobrowser.demo.showcase.Calculator",F="CE",E="solid",D="icon/22/apps/utilities-calculator.png",C="3",u="0",v="__Oc",s="8",t="6",q="4",r="Calculator",o="right",p="2",w="1",x="demobrowser.demo.showcase.CalculatorLogic",z="__Ob",y="white",B="+/-",A="9";
qx.Class.define(G,{extend:qx.application.Standalone,members:{__Ob:null,__Oc:null,main:function(){qx.application.Standalone.prototype.main.call(this);
{};
this.__Oc=new demobrowser.demo.showcase.CalculatorLogic();
...
bd.setLayout(bn);
this.__Ob=new qx.ui.basic.Label(this.__Oc.getCurrentValue().toString()).set({decorator:U,backgroundColor:y,allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:[f,g],bold:true}),textAlign:o});
...
var bh=new qx.ui.form.Button(w).set({font:bo,minWidth:40});
...
bn.setRowFlex(5,1);
bn.setRowFlex(6,1);
bd.add(this.__Ob,{row:0,column:0,rowSpan:0,colSpan:4});
...
S.add(bd,{flex:1});
R.addListener(n,function(e){this.__Oc.cleanDisplay();
this.__Ob.setValue(this.__Oc.getCurrentValue().toString());
},this);
T.addListener(n,function(e){this.__Oc.clearEntry();

if(this.__Oc.getResult()!=null){this.__Ob.setValue(this.__Oc.getCurrentValue().toString());
}},this);
Y.addListener(n,function(e){this.__Oc.deleteNumber();
this.__Ob.setValue(this.__Oc.getCurrentValue().toString());
},this);
X.addListener(n,function(e){this.__Oc.setSign();

if(this.__Oc.getResult()!=null){this.__Ob.setValue(this.__Oc.getResult().toString());
}},this);
bi.addListener(n,function(e){this.__Oc.setCurrentValue(0);
this.__Ob.setValue(this.__Oc.getCurrentValue().toFixed(this.__Oc.getZeroCounter()).toString());
},this);
bh.addListener(n,function(e){this.__Oc.setCurrentValue(1);
this.__Ob.setValue(this.__Oc.getCurrentValue().toString());
},this);
bg.addListener(n,function(e){this.__Oc.setCurrentValue(2);
this.__Ob.setValue(this.__Oc.getCurrentValue().toString());
},this);
bf.addListener(n,function(e){this.__Oc.setCurrentValue(3);
this.__Ob.setValue(this.__Oc.getCurrentValue().toString());
},this);
bm.addListener(n,function(e){this.__Oc.setCurrentValue(4);
this.__Ob.setValue(this.__Oc.getCurrentValue().toString());
},this);
bl.addListener(n,function(e){this.__Oc.setCurrentValue(5);
this.__Ob.setValue(this.__Oc.getCurrentValue().toString());
},this);
bk.addListener(n,function(e){this.__Oc.setCurrentValue(6);
this.__Ob.setValue(this.__Oc.getCurrentValue().toString());
},this);
bj.addListener(n,function(e){this.__Oc.setCurrentValue(7);
this.__Ob.setValue(this.__Oc.getCurrentValue().toString());
},this);
bq.addListener(n,function(e){this.__Oc.setCurrentValue(8);
this.__Ob.setValue(this.__Oc.getCurrentValue().toString());
},this);
bp.addListener(n,function(e){this.__Oc.setCurrentValue(9);
this.__Ob.setValue(this.__Oc.getCurrentValue().toString());
},this);
W.addListener(n,function(e){this.__Oc.calculate(l);

if(this.__Oc.getResult()!=null){this.__Ob.setValue(this.__Oc.getResult().toString());
}this.__Oc.resetCurrentValue();
},this);
be.addListener(n,function(e){this.__Oc.calculate(m);

if(this.__Oc.getResult()!=null){this.__Ob.setValue(this.__Oc.getResult().toString());
}this.__Oc.resetCurrentValue();
},this);
bc.addListener(n,function(e){this.__Oc.calculate(i);

if(this.__Oc.getResult()!=null){this.__Ob.setValue(this.__Oc.getResult().toString());
}this.__Oc.resetCurrentValue();
},this);
ba.addListener(n,function(e){this.__Oc.calculate(j);

if(this.__Oc.getResult()!=null){this.__Ob.setValue(this.__Oc.getResult().toString());
}this.__Oc.resetCurrentValue();
},this);
V.addListener(n,function(e){this.__Oc.calculate(h);

if(this.__Oc.getResult()!=null){this.__Ob.setValue(this.__Oc.getResult().toString());
}this.__Oc.resetCurrentValue();
},this);
bb.addListener(n,function(e){this.__Oc.setComma();
},this);
}},destruct:function(){this._disposeObjects(v,z);
}});
qx.Class.define(x,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
},members:{__Od:0,__Oe:0,__Of:k,__Og:0,__Oh:0,__Oi:0,__Oj:false,__Ok:1,__Ol:0,__Om:false,__On:0,setCurrentValue:function(M){if(this.__Oj){this.__Ok*=10;
this.__Od=this.__Od+(M/this.__Ok);

if(M==0){this.__Ol++;
}}else{this.__Oj=false;

if(this.__Od<0){this.__Od=this.__Od*10-M;
}else{this.__Od=this.__Od*10+M;
}}},getZeroCounter:function(){return this.__Ol;
},setComma:function(){this.__Oj=true;
},getCurrentValue:function(){return this.__Od;
},resetCurrentValue:function(){this.__Od=null;
},cleanDisplay:function(){this.__On=0;
this.__Oh=0;
this.__Of=k;
this.__Ol=0;
this.__Ok=1;
...
this.__Oe=0;
this.__Om=false;
},setResult:function(a){this.__Oe=a;
},getResult:function(){return Math.round(this.__Oe*10000000)/10000000;
},setCurrentOperation:function(c){this.__Of=c;
},getCurrentOperation:function(){return this.__Of;
},clearEntry:function(){this.__Om=false;
this.__Ol=0;
this.__Ok=1;
this.__Oj=false;
this.__Oi++;
...
if(this.__Oi<2){this.__Oh=this.__Oe;
}
if(this.__Og>=2){this.__Oe=0;
this.__Og=0;
}},setSign:function(){this.__On++;

if(this.__On%2==0){this.__Om=false;
}else{this.__Om=true;
}
if(this.__Od==null){this.__Od=this.__Oe;
}this.__Od=this.__Od*(-1);

if(this.__Oe==0){this.__Oe=this.__Od;
}
if(this.__Oe!=0){this.__Oh=this.__Oe;
this.__Oe=this.__Od;
}},deleteNumber:function(){var N=false;
var Q=false;

if(this.__Od<0){this.__Od=this.__Od*(-1);
Q=true;
}
if(this.__Od!=null){if(this.__Od.toString().lastIndexOf(d)!=-1){this.__Od=this.__Od*this.__Ok;
N=true;
}}var O=this.__Od%10;
var P=O/10;
this.__Od=this.__Od/10;
this.__Od=this.__Od-P;

if(N){this.__Ok/=10;
this.__Od=this.__Od/(this.__Ok);
N=false;
}
if(Q){this.__Od=this.__Od*(-1);
Q=false;
}},calculate:function(b){if(b==l||b==i||b==j||b==m||b==h){this.__Oj=false;
this.__Ok=1;
this.__Ol=0;

if(this.__Of!=k){if(this.__Of==l){if(this.__Oe==null){this.__Oe=this.__Oh;
}
if(this.__Om){this.__Oe=this.__Oh+this.__Od;
}else{this.__Oe=this.__Oe+this.__Od;
}this.__Od=this.__Oe;
this.__Oh=this.__Oe;
}
if(this.__Of==m){if(this.__Oe==0){this.__Oe=this.__Od;
this.__Od=0;
}
if(this.__Oe==null){this.__Oe=this.__Oh;
}
if(this.__Om){this.__Oe=this.__Oh-this.__Od;
}else{this.__Oe=this.__Oe-this.__Od;
}this.__Od=this.__Oe;
...
if(this.__Of==j){if(this.__Oe==0){this.__Oe=this.__Od;
this.__Od=1;
}
if(this.__Oe==null){this.__Oe=this.__Oh;
}
if(this.__Od!=null){if(this.__Od!=0){if(this.__Om){this.__Oe=this.__Oh/this.__Od;
}else{this.__Oe=this.__Oe/this.__Od;
}}else{alert("You can't divide by 0!");
}}this.__Od=this.__Oe;
this.__Oh=this.__Oe;
}
if(this.__Of==i){if(this.__Oe==0){this.__Oe=1;
}
if(this.__Od==null){this.__Od=1;
}
if(this.__Oe==null){this.__Oe=this.__Oh;
}
if(this.__Om){this.__Oe=this.__Oh*this.__Od;
