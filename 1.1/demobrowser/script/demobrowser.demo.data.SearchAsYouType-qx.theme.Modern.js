...
(function(){var f="_applySearchString",e="demobrowser.demo.data.filter.SearchAsYouTypeFilter",d="String",c="";
qx.Class.define(e,{extend:qx.core.Object,construct:function(b){qx.core.Object.call(this);
this.__Mr=b;
this.filter=qx.lang.Function.bind(function(a){return a.search(this.getSearchString())!=-1;
},this);
this.__Ms=null;
},properties:{searchString:{check:d,apply:f,init:c}},members:{__Ms:null,__Mr:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();
if(this.__Ms!=null){i.stop(this.__Ms);
this.__Ms=null;
}this.__Ms=i.start(function(){this.__Mr.update();
this.__Ms=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__Mr=null;
}});
})();
