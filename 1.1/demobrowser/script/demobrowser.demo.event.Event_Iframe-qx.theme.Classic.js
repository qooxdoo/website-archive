...
(function(){var r="click",q="iframe",p="scroll",o="inner",n="div",m="juhu",l="contextmenu",k="input",j="load",h="keydown",f="demobrowser.demo.event.Event_Iframe",g="data/Event_2_frame.html";
qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
var t=qx.bom.Iframe.create({name:q,src:g});
t.id=q;
document.body.appendChild(t);
qx.event.Registration.addListener(t,j,this.bindIFrameEvents,this);
},bindIFrameEvents:function(){var c=window.document.getElementById(q);
var b=qx.bom.Iframe.getDocument(c);
this._juhu=b.getElementById(m);
this._inner=b.getElementById(o);
qx.event.Registration.addListener(this._juhu,l,this._preventDefault,this);
qx.event.Registration.addListener(this._inner,r,this._stopPropagation,this);
qx.event.Registration.addListener(this._juhu,r,this._onclick1,this);
qx.event.Registration.addListener(this._juhu,r,this._onclick2,this);
qx.event.Registration.addListener(b.getElementById(k),h,this._onkeydown,this);

for(var i=1;i<10;i++){var a=b.getElementById(n+i);
qx.event.Registration.addListener(a,r,this._cascadeCapture,this,true);
qx.event.Registration.addListener(a,r,this._cascadeBubble,this,false);
}qx.event.Registration.addListener(b.getElementById(p),p,this._scroll,this);
},_onkeydown:function(e){this.debug("keydown: "+e.getKeyIdentifier());
},_scroll:function(e){this.debug("scroll");
},_cascadeCapture:function(e){var d=e.getCurrentTarget();
this.debug("capture: "+d.id+" "+e.getEventPhase());
},_cascadeBubble:function(e){var s=e.getCurrentTarget();
this.debug("bubble: "+s.id+" "+e.getEventPhase());
...
qx.event.Registration.removeListener(this._juhu,r,this._onclick1);
