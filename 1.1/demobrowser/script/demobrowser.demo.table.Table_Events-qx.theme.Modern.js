...
(function(){var n="",m="columnVisibilityMenuCreateEnd",l="Boolean",k="icon/16/actions/edit-cut.png",j="A number",i="changeValue",h="Column",g="sorted",f="tableWidthChanged",d="verticalScrollBarChanged",L="icon/16/actions/edit-copy.png",K="icon/22/actions/media-record.png",J="cellContextmenu",I="_events",H="Cut",G="_tableModel",F="Table",E="asc",D="icon/16/actions/edit-paste.png",C="columnVisibilityMenuCreateStart",u="cellDblclick",v="_eventsWin",s="Copy",t="Name",q="desc",r="Paste",o="Event log",p="cellClick",w="metaDataChanged",x="demobrowser.demo.table.Table_Events",z="Row",y="A date",B="Capture events",A="ID";
qx.Class.define(x,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return F;
},main:function(){demobrowser.demo.table.TableDemo.prototype.main.call(this);
var Y=this._eventsWin=new qx.ui.window.Window(o).set({height:400,width:290,showClose:false,showMinimize:false,contentPadding:0});
Y.setLayout(new qx.ui.layout.Canvas());
Y.open();
this.getRoot().add(Y,{left:670,top:10});
this._events=new qx.ui.table.model.Simple();
this._events.setColumns([t,z,h]);
this._events.setData([]);
var X=new qx.ui.table.Table(this._events);
X.getTableColumnModel().setColumnWidth(0,150);
X.getTableColumnModel().setColumnWidth(1,60);
X.getTableColumnModel().setColumnWidth(2,60);
Y.add(X,{edge:0});
},createTable:function(){var U=this.createRandomRows(50);
var Q=this._tableModel=new qx.ui.table.model.Simple();
Q.setColumns([A,j,y,l]);
Q.setData(U);
Q.setColumnEditable(1,true);
Q.setColumnEditable(2,true);
var V=new qx.ui.table.Table(Q);
V.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var R=V.getTableColumnModel();
R.setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
var W=function(e){this._events.addRows([[e.getType(),n,n,n]],0);
};
var T=function(e){this._events.addRows([[e.getType(),e.getRow(),e.getColumn()]],0);
};
var S=function(e){var ba=e.getData();
this._events.addRows([[e.getType(),ba.ascending?E:q,ba.columnIndex]],0);
};
V.addListener(C,W,this);
V.addListener(m,W,this);
V.addListener(f,W,this);
V.addListener(d,W,this);
V.addListener(p,T,this);
V.addListener(u,T,this);
V.addListener(J,T,this);
Q.addListener(g,S,this);
Q.addListener(w,W,this);
V.setContextMenu(this.getContextMenu());
return V;
},createControls:function(){var c=new qx.ui.toolbar.ToolBar();
var a,b;
b=new qx.ui.toolbar.Part();
c.add(b);
a=new qx.ui.toolbar.CheckBox(B,K).set({value:true});
b.add(a);
a.addListener(i,function(e){if(a.isValue()){this._events.setData([]);
this._eventsWin.open();
}else{this._eventsWin.close();
}},this);
return c;
},getContextMenu:function(){var M=new qx.ui.menu.Menu();
var O=new qx.ui.menu.Button(H,k);
var P=new qx.ui.menu.Button(s,L);
var N=new qx.ui.menu.Button(r,D);
M.add(O);
M.add(P);
M.add(N);
return M;
}},destruct:function(){this._disposeObjects(G,v,I);
}});
})();
