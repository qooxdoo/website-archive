...
(function(){var r="",q="cat",p="Juhu",o="mouse",n="dog",m="execute",l="rat",k="demobrowser.demo.test.Table_CellEditor",j="Add/Remove editor",i="Get value",g="_container",h="boolean";
...
C.add(E);
E.addListener(m,function(){F.setValue(A.getCellEditorValue(G)+r);
});
var D=new qx.ui.form.Button(j);
C.add(D);
D.addListener(m,function(){G.destroy();
...
qx.util.Permutation.permute(I,function(a){this._addEditor(new qx.ui.table.celleditor.CheckBox(),a);
},this);
},testComboBoxEditor:function(){var y={value:[r,q,l,2],table:[this.getTableMock()]};
var z=new qx.ui.table.celleditor.ComboBox();
z.setListData([n,q,o]);
qx.util.Permutation.permute(y,function(b){this._addEditor(z,b);
},this);
},testSelectBoxEditor:function(){var e={value:[r,q],table:[this.getTableMock()]};
var f=new qx.ui.table.celleditor.SelectBox();
f.setListData([n,q,o]);
qx.util.Permutation.permute(e,function(v){this._addEditor(f,v);
},this);
},testPasswordEditor:function(){var J={value:[null,10,p]};
qx.util.Permutation.permute(J,function(s){this._addEditor(new qx.ui.table.celleditor.PasswordField(),s);
},this);
},testTextfieldEditor:function(){var u={value:[null,10,p]};
qx.util.Permutation.permute(u,function(t){this._addEditor(new qx.ui.table.celleditor.TextField(),t);
},this);
},testTextfieldEditorDynamic:function(){var w={value:[true,p]};
var x=new qx.ui.table.celleditor.Dynamic();
x.setCellEditorFactoryFunction(function(d){if(typeof d.value==h){return new qx.ui.table.celleditor.CheckBox();
}else{return new qx.ui.table.celleditor.TextField();
}});
qx.util.Permutation.permute(w,function(c){this._addEditor(x,c);
},this);
