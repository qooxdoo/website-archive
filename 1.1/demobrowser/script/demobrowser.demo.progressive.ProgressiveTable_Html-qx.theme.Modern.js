...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.progressive.ProgressiveTable_Html","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.progressive.ProgressiveTable_Html-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"80c400ab7cd4"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var B=function(p,q){var s={renderer:m,location:h,data:[p,p]};
return s;
};
var A=new qx.ui.progressive.renderer.table.Widths(2);
A.setWidth(0,l);
A.setWidth(1,k);
var v=[g,a];
var x=new qx.ui.progressive.headfoot.TableHeading(A,v);
var u=new qx.ui.progressive.headfoot.Progress(A,v);
var D=new qx.ui.progressive.structure.Default(x,u);
var t=new qx.ui.progressive.Progressive(D);
