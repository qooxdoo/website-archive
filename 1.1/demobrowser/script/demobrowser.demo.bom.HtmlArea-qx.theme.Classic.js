...
(function(){var cr="0px",cq="outline",cp="mshtml",co="hideFocus",cn="none",cm="true",cl="qx.client",ck="div",cj="16px",ci="840px",bM="left",bL="<tr>",bK="<option value=''></option>",bJ="1px solid #AAA",bI="'>",bH="value='",bG="#",bF="</option>",bE="qooxdoo logo",bD="change",cy="select",cz="</tr>",cw="",cx="clear:both",cu="Insert Table",cv="Color (Hex): ",cs="Georgia",ct="<p>This low-level widget can be used separately at ",cA="http://",cB="BgColor (Hex): ",cb="Indent More",ca="Change font family",cd="demobrowser/demo/icons/htmlarea/format-fill-color.png",cc="Align Right",cf="Format Italic",ce="qx/icon/Oxygen/16/actions/format-text-underline.png",ch="350px",cg='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',bY="white",bX="buttons at the toolbar.</p>",u="demobrowser/demo/icons/htmlarea/format-list-ordered.png",v="qx/icon/Oxygen/16/actions/format-indent-more.png",w="Comic Sans MS",x="Tahoma",y="20px 20px",z="float",A="<h1>HtmlArea low-level widget</h1>",B="<td>First Row, First cell</td>",C="demobrowser/demo/icons/htmlarea/qooxdoo_logo.png",D="Align Left",cF="qx/icon/Oxygen/16/actions/format-justify-center.png",cE="input",cD="Align Justify",cC="demobrowser/demo/icons/htmlarea/insert-text.png",cJ="Insert Horizontal Ruler",cI="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",cH="demobrowser/demo/icons/htmlarea/format-list-unordered.png",cG="HTML Code:",cL="Set Text Background Color",cK="Insert Link",bd="on",be="You can play around with this widget by hitting the ",bb="<td>Second Row, First cell</td>",bc="</tbody>",bh="Set Text Color",bi="demobrowser/demo/icons/htmlarea/format-text-color.png",bf="traditional web pages / single-page applications.<br/> ",bg="demobrowser/demo/icons/htmlarea/insert-table.png",Y="qx/icon/Oxygen/16/actions/edit-undo.png",ba="qx/icon/Oxygen/16/actions/edit-clear.png",L="Arial Black",K="Impact",N="Change font size",M="Link: ",H="Redo Last Undo Step",G="Format Bold",J="off",I="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",F="br",E="marginRight",bn="image",bo="<option qxKeepFocus='on' qxSelectable='off'",bp="click",bq="<option qxKeepFocus='on' qxSelectable='off' ",bj="Remove Format",bk="qx/icon/Oxygen/16/actions/insert-image.png",bl="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",bm="</table>",br="<td>First Row, Second cell</td>",bs="Insert HTML Code",V="qx/icon/Oxygen/16/actions/insert-link.png",U="Insert Ordered List",T="demobrowser.demo.bom.HtmlArea",S="qx/icon/Oxygen/16/actions/format-justify-left.png",R="Courier",Q="Courier New",P="4px",O="qx/icon/Oxygen/16/actions/format-justify-right.png",X="qx/icon/Oxygen/16/actions/format-text-bold.png",W="<td>Second Row, Second cell</td>",bt="Insert Image",bu="qx/icon/Oxygen/16/actions/format-indent-less.png",bv="<tbody>",bw="Times New Roman",bx="Align Center",by="qx/icon/Oxygen/16/actions/edit-redo.png",bz="Lucida Console",bA="innerHTML",bB="Undo Last Change",bC="qx/icon/Oxygen/16/actions/format-text-italic.png",bQ="Arial",bP="qx/icon/Oxygen/16/actions/format-justify-fill.png",bO="Verdana",bN="Indent Less",bU="Format Strikethrough",bT="Format Underline",bS="<table border='1'>",bR="Inserted Unordered List",bW="FontSize: ",bV="It is the foundation for the UI widget component.</p>";
qx.Class.define(T,{extend:qx.application.Native,members:{__LU:null,__LV:null,__LW:null,__LX:null,__LY:null,main:function(){qx.application.Native.prototype.main.call(this);
this.__LU=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__LU,{margin:y});
var cQ=qx.bom.Element.create(ck);
qx.bom.element.Style.setStyles(cQ,{width:ci,padding:cr,margin:cr});
var cP=A+ct+bf+bV+bl+be+bX;
qx.bom.element.Attribute.set(cQ,bA,cP);
this.__LV=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__LV,{width:ci,padding:cr,margin:cr,lineHeight:cr,border:bJ});
this.__LW=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__LW,{width:ci,height:ch,border:bJ,borderTop:cr,backgroundColor:bY});
qx.dom.Element.insertEnd(this.__LW,this.__LU);
var cO=cg;
this.__LX=new qx.bom.htmlarea.HtmlArea(this.__LW,cO,null,"blank.html");
this.__Mj();
qx.dom.Element.insertBegin(this.__LV,this.__LU);
qx.dom.Element.insertBegin(cQ,this.__LU);
qx.dom.Element.insertBegin(this.__LU,document.body);
},__Ma:function(e){var cN=window.prompt(bW,cw);
this.setFontSize(parseInt(cN));
},__Mb:function(e){var da=window.prompt(cv,bG);
this.setTextColor(da);
},__Mc:function(e){var cR=window.prompt(cB,bG);
this.setTextBackgroundColor(cR);
},__Md:function(e){var db={src:qx.util.ResourceManager.getInstance().toUri(C),border:0,title:bE,alt:bE};
this.insertImage(db);
},__Me:function(e){var dc=bS+bv+bL+B+br+cz+bL+bb+W+cz+bc+bm;
this.insertHtml(dc);
},__Mf:function(e){var cS=window.prompt(M,cA);
this.insertHyperLink(cS);
},__Mg:function(e){var cM=window.prompt(cG,cw);
this.insertHtml(cM);
},__Mh:function(){var cU=qx.bom.Element.create(ck);
qx.bom.element.Style.setStyles(cU,{"float":bM});
var cW;
var cV=qx.bom.Element.create(cy,{title:ca});

if(qx.core.Variant.isSet(cl,cp)){qx.bom.element.Attribute.set(cV,co,cm);
}else{qx.bom.element.Style.set(cV,cq,cn);
}cW=qx.bom.Collection.html(bK);
qx.dom.Element.insertEnd(cW[0],cV);
var cX=[x,bO,bw,bQ,L,Q,R,cs,K,w,bz];
var cT;
var cY;

for(var i=0,j=cX.length;i<j;i++){cT=bo+bH+cX[i]+bI+cX[i]+bF;
cY=qx.bom.Collection.html(cT);

if(qx.core.Variant.isSet(cl,cp)){qx.bom.element.Attribute.set(cY[0],co,cm);
}else{qx.bom.element.Style.set(cY[0],cq,cn);
}qx.dom.Element.insertEnd(cY[0],cV);
}qx.event.Registration.addListener(cV,bD,function(e){var g=e.getTarget();
var h=g.selectedIndex;

if(h!=0){this.setFontFamily(g.options[h].value);
g.options[0].selected=true;
}},this.__LX);
qx.dom.Element.insertBegin(cV,cU);
return cU;
},__Mi:function(){var b=qx.bom.Element.create(ck);
qx.bom.element.Style.setStyles(b,{"marginRight":cj,"float":bM});
var d;
var c=qx.bom.Element.create(cy,{title:N});

if(qx.core.Variant.isSet(cl,cp)){qx.bom.element.Attribute.set(c,co,cm);
}else{qx.bom.element.Style.set(c,cq,cn);
}d=qx.bom.Collection.html(bK);
qx.dom.Element.insertEnd(d[0],c);
var f;
var a;

for(var i=1;i<=7;i++){a=bq+bH+i+bI+i+bF;
f=qx.bom.Collection.html(a);

if(qx.core.Variant.isSet(cl,cp)){qx.bom.element.Attribute.set(f[0],co,cm);
}else{qx.bom.element.Style.set(f[0],cq,cn);
}qx.dom.Element.insertEnd(f[0],c);
}qx.event.Registration.addListener(c,bD,function(e){var k=e.getTarget();
var l=k.selectedIndex;

if(l!=0){this.setFontSize(k.options[l].value);
k.options[0].selected=true;
}},this.__LX);
qx.dom.Element.insertBegin(c,b);
return b;
},__Mj:function(){var n=[{bold:{text:G,image:X,action:this.__LX.setBold},italic:{text:cf,image:bC,action:this.__LX.setItalic},underline:{text:bT,image:ce,action:this.__LX.setUnderline},strikethrough:{text:bU,image:I,action:this.__LX.setStrikeThrough},removeFormat:{text:bj,image:ba,action:this.__LX.removeFormat}},{alignLeft:{text:D,image:S,action:this.__LX.setJustifyLeft},alignCenter:{text:bx,image:cF,action:this.__LX.setJustifyCenter},alignRight:{text:cc,image:O,action:this.__LX.setJustifyRight},alignJustify:{text:cD,image:bP,action:this.__LX.setJustifyFull}},{fontFamily:{custom:this.__Mh},fontSize:{custom:this.__Mi},fontColor:{text:bh,image:bi,action:this.__Mb},textBackgroundColor:{text:cL,image:cd,action:this.__Mc}},{indent:{text:cb,image:v,action:this.__LX.insertIndent},outdent:{text:bN,image:bu,action:this.__LX.insertOutdent}},{insertImage:{text:bt,image:bk,action:this.__Md},insertTable:{text:cu,image:bg,action:this.__Me},insertLink:{text:cK,image:V,action:this.__Mf},insertHTML:{text:bs,image:cC,action:this.__Mg},insertHR:{text:cJ,image:cI,action:this.__LX.insertHorizontalRuler}},{ol:{text:U,image:u,action:this.__LX.insertOrderedList},ul:{text:bR,image:cH,action:this.__LX.insertUnorderedList}},{undo:{text:bB,image:Y,action:this.__LX.undo},redo:{text:H,image:by,action:this.__LX.redo}}];
var p,t,m,r;

for(var i=0,j=n.length;i<j;i++){t={};
t[E]=i==j-1?cr:cj;
t[z]=bM;
p=qx.bom.Element.create(ck);
qx.bom.element.Style.setStyles(p,t);

for(var q in n[i]){var s=n[i][q];

if(s.custom){m=s.custom.call(this);
}else{var o=qx.util.AliasManager.getInstance().resolve(s.image);
r={type:bn,src:qx.util.ResourceManager.getInstance().toUri(o),title:s.text,qxKeepFocus:bd,qxSelectable:J};
m=qx.bom.Element.create(cE,r);
qx.bom.element.Style.setStyles(m,{width:cj,height:cj,padding:P});

if(qx.core.Variant.isSet(cl,cp)){qx.bom.element.Attribute.set(m,co,cm);
}else{qx.bom.element.Style.set(m,cq,cn);
}qx.event.Registration.addListener(m,bp,s.action,this.__LX);
}qx.dom.Element.insertEnd(m,p);
}qx.dom.Element.insertEnd(p,this.__LV);
}qx.dom.Element.insertEnd(qx.bom.Element.create(F,{style:cx}),this.__LV);
}}});
})();
