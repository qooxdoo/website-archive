...
(function(){var g='Welcome to <br><b style="color:#F3FFB3;">qooxdoo</b> animations!',f="demobrowser.demo.test.Style",e="testDiv",d='div',c='font-size:12pt;text-align:center;font-family:"Trebuchet MS","Lucida Grande",Verdana,sans-serif;color:white;left:90px;top:90px;position:absolute;width:200px;height:55px;border:2px #E5E5E5 solid;background-color:#134275;z-Index:10;';
qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
var a=c;
var b=qx.bom.Element.create(d,{style:a});
