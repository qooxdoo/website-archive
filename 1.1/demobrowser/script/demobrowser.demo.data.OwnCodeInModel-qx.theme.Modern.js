...
(function(){var t="execute",s="icon/16/mimetypes/",r="name",q="model",p="model.items",o="demobrowser.demo.data.OwnCodeInModel",n=".png",m="json/list.json",l="type",k="Using the delegation to bring two sort function to the root model ",g="Sort By Name",j="items",i="class of this demo. The buttons just calling those sort functions.",f="<b>Adding own code to the model</b><br/>",e="demobrowser.demo.data.ItemsMixin",h="Sort By Type";
...
z.setLabelPath(r);
z.setIconOptions({converter:function(d){return s+d+n;
}});
z.setIconPath(l);
var A={getModelMixins:function(c){if(c==j){return demobrowser.demo.data.ItemsMixin;
}}};
var v=m;
...
B.addListener(t,function(){C.getModel().sortByType();
},this);
var y=new qx.ui.form.Button(g);
y.setWidth(120);
this.getRoot().add(y,{left:130,top:110});
y.addListener(t,function(){C.getModel().sortByName();
},this);
...
qx.Mixin.define(e,{members:{sortByType:function(){var u=this.getItems();
