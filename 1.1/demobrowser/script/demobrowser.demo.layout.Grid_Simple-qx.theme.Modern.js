...
r.add(this.getGrid2());
r.add(this.getGrid3());
},getGrid1:function(){var s=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,20)).set({decorator:q,backgroundColor:o,allowGrowX:false,allowGrowY:false});
...
return d;
},getGrid3:function(){var b=new qx.ui.container.Composite().set({decorator:q,backgroundColor:o,width:400,height:300,allowShrinkX:false,allowShrinkY:false});
