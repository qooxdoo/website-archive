...
qx.Class.define(o,{extend:qx.application.Standalone,members:{__NU:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var y=this.getRoot();
this.__NU=["bottom-left","bottom-right","top-left","top-right","right-top","right-bottom","left-top","left-bottom"];
y.add(this.createTestField(g),{left:20,top:20});
y.add(this.createTestField(j),{right:20,top:20});
y.add(this.createTestField(k),{right:20,bottom:20});
y.add(this.createTestField(f),{left:20,bottom:20});
y.add(this.createTestField(h),{left:20,top:250});
y.add(this.createTestField(c),{right:20,top:250});
y.add(this.createDomClick(),{left:200,top:100});
},createTestField:function(r){var v=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var t=new qx.ui.popup.Popup(new qx.ui.layout.Grow);
t.add(new qx.ui.basic.Atom(l));
t.setPadding(20);
var s=new qx.ui.form.SelectBox;
var w=null;

for(var i=0;i<this.__NU.length;i++){var u=new qx.ui.form.ListItem(this.__NU[i]);
s.add(u);

if(this.__NU[i]==r){w=u;
}}v.add(s);
s.addListener(p,function(e){t.setPosition(e.getData()[0].getLabel());
});
s.setSelection([w]);
var x=new qx.ui.form.Button(m);
v.add(x);
x.addListener(q,function(e){t.placeToWidget(x);
t.show();
});
return v;
...
for(var i=0;i<this.__NU.length;i++){z.add(new qx.ui.form.ListItem(this.__NU[i]));
}B.add(z);
