...
var A={converter:function(a){return a?1:0;
}};
...
N.add(L);
N.setValidator(function(t){var u=H.getSelection()[0]!==I;
H.setValid(u);
return u;
});
var F=function(v){if(v instanceof qx.ui.form.ListItem){return v.getLabel();
}};
