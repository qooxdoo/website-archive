...
(function(){var n="execute",m="Add modal window",l="demobrowser.demo.root.Inline_Window",k="Add window",j="Window #",i="isle",h="Modal Window #",g="white",f="main";
qx.Class.define(l,{extend:qx.application.Inline,members:{main:function(){qx.application.Inline.prototype.main.call(this);
var d=new qx.ui.root.Inline(document.getElementById(i)).set({decorator:f,padding:10,backgroundColor:g});
d.setLayout(new qx.ui.layout.HBox(10));
var a=new qx.ui.form.Button(k);
var c=1;
a.addListener(n,function(e){var o=new qx.ui.window.Window(j+c++).set({width:200,height:150});
o.moveTo(c*15,c*15);
o.open();
});
d.add(a);
var b=new qx.ui.form.Button(m);
b.addListener(n,this.newModalWindow,this);
d.add(b);
},cModWin:1,newModalWindow:function(){var p=new qx.ui.window.Window(h+this.cModWin++).set({modal:true});
p.moveTo(300+this.cModWin*15,this.cModWin*15);
p.setLayout(new qx.ui.layout.HBox());
var q=new qx.ui.form.Button(m);
q.addListener(n,this.newModalWindow,this);
p.add(q);
p.open();
}}});
})();
