...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.virtual.Cells","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.Cells-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"532db3293102"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var W="",V="<b>HTML</b>",U="px;",T="Juhu",S="testImageCell",R="qx.theme",Q="testNumberCell",P="width:",O="testHtmlCell",N="testDateCell",bk="height:",bj="testStringCell",bi="testBooleanCellCustomImage",bh="demobrowser.demo.virtual.Cells",bg="testBooleanCell",bf="foobar!",be="qx.theme.Modern",bd="icon/32/apps/utilities-notes.png",bc="medium",bb="icon/16/emotes/face-sad.png",Y="icon/16/apps/internet-feed-reader.png",ba="icon/16/emotes/face-smile.png",X="This is a feed reader!";
qx.Class.define(bh,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);
var B=new qx.ui.layout.HBox(5);
this.topContainer=new qx.ui.container.Composite(B);
this.runTest(bj);
this.runTest(Q);
this.runTest(N);
this.runTest(O);
if(qx.core.Setting.get(R)==be){this.runTest(S);
this.runTest(bg);
this.runTest(bi);
}this.getRoot().add(this.topContainer,{edge:5});
},runTest:function(bp){this.setUp();
this[bp]();
...
},testStringCell:function(){var K={value:[T,V,W,null],states:[{},{selected:1}]};
var J=new qx.ui.virtual.cell.String;
qx.util.Permutation.permute(K,function(L){var M=this.__NP(J,L.value,L.states);
this.container.add(M);
},this);
},testNumberCell:function(){var g={value:[-1.666666,0,null],format:[null,new qx.util.format.NumberFormat().set({maximumFractionDigits:2})],states:[{},{selected:1}]};
var h=new qx.ui.virtual.cell.Number();
qx.util.Permutation.permute(g,function(H){if(H.format){h.setNumberFormat(H.format);
}else{h.resetNumberFormat();
}var I=this.__NP(h,H.value,H.states);
this.container.add(I);
},this);
},testDateCell:function(){var a={value:[new Date(),null],format:[null,new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(bc))],states:[{},{selected:1}]};
var b=new qx.ui.virtual.cell.Date();
qx.util.Permutation.permute(a,function(bn){if(bn.format){b.setDateFormat(bn.format);
}else{b.resetDateFormat();
}var bo=this.__NP(b,bn.value,bn.states);
this.container.add(bo);
},this);
},testHtmlCell:function(){var z={value:[T,V,W,null],states:[{},{selected:1}]};
var A=new qx.ui.virtual.cell.Html;
qx.util.Permutation.permute(z,function(i){var j=this.__NP(A,i.value,i.states);
this.container.add(j);
},this);
},testImageCell:function(){var m={value:[{url:Y,tooltip:X},{url:bd,tooltip:bf},null],states:[{},{selected:1}]};
var n=new qx.ui.virtual.cell.Image;
qx.util.Permutation.permute(m,function(o){var p=this.__NP(n,o.value,o.states);
this.container.add(p);
},this);
},testBooleanCell:function(){var e={value:[true,false,null],states:[{},{selected:1}]};
var f=new qx.ui.virtual.cell.Boolean;
qx.util.Permutation.permute(e,function(bl){var bm=this.__NP(f,bl.value,bl.states);
this.container.add(bm);
},this);
},testBooleanCellCustomImage:function(){var k={value:[true,false,null],states:[{},{selected:1}]};
var l=new qx.ui.virtual.cell.Boolean;
l.setIconFalse(bb);
l.setIconTrue(ba);
qx.util.Permutation.permute(k,function(c){var d=this.__NP(l,c.value,c.states);
this.container.add(d);
},this);
},__NP:function(q,r,s){var w=100;
var u=30;
var y=new qx.ui.embed.Html().set({width:w,height:u,decorator:s.selected?null:"main"});
var t=q.getCellProperties(r,s);
var v=t.insets;
var x=["<div ","style='",this._getCellSizeStyle(w,u,v[0],v[1]),t.style,"' ","class='",t.classes,"' ",t.attributes,">",t.content,"</div>"].join("");
y.setHtml(x);
return y;
},_getCellSizeStyle:function(C,D,E,F){var G=W;
...
qx.Class.define(e,{extend:qx.ui.virtual.cell.Cell,construct:function(a){qx.ui.virtual.cell.Cell.call(this);
...
qx.Class.define(a,{extend:qx.ui.virtual.cell.Cell,construct:function(g){qx.ui.virtual.cell.Cell.call(this);
...
(function(){var J="",I="px",H='" ',G="no-repeat",F='"',E='" style="',D='title="',C='<div style="',B='></div>',A="qx.ui.virtual.cell.AbstractImage",u='/>',z="img",x="inline-block",t="static",s="top",w='<img src="',v="abstract",y="string",r="-moz-inline-box";
qx.Class.define(A,{extend:qx.ui.virtual.cell.Cell,type:v,construct:function(){qx.ui.virtual.cell.Cell.call(this);
this._aliasManager=qx.util.AliasManager.getInstance();
},members:{__Eo:16,__Ep:16,_aliasManager:null,__Eq:function(m){var p=qx.util.ResourceManager.getInstance();
var o=qx.io.ImageLoader;
var n,q;
if(p.has(m)){n=p.getImageWidth(m),q=p.getImageHeight(m);
}else if(o.isLoaded(m)){n=o.getWidth(m);
q=o.getHeight(m);
}else{n=this.__Eo;
q=this.__Ep;
}return {width:n,height:q};
},__Er:function(j){if(typeof (j)==y){j={url:j};
...
},_identifyImage:function(K){throw new Error("_identifyImage is abstract");
},getContent:function(a,b){if(a===null){return J;
}var content=J;
var d=this.__Er(this._identifyImage(a));
var h=qx.bom.client.Engine.GECKO&&qx.bom.client.Engine.VERSION<1.9;
var e=d.tooltip?D+d.tooltip+F:J;
var c={width:d.width+I,height:d.height+I,display:h?r:x,verticalAlign:s,position:t};
var f=qx.bom.element.Decoration.getTagName(G,d.url);
var g=qx.bom.element.Decoration.getAttributes(d.url,G,c);
var i=qx.bom.element.Style.compile(g.style);

if(f===z){content=w+g.src+E+i+H;
content+=e+u;
}else{content=C+i+H;
content+=e+B;
}return content;
...
qx.Class.define(d,{extend:qx.ui.virtual.cell.AbstractImage,construct:function(){qx.ui.virtual.cell.AbstractImage.call(this);
this.__Hl=qx.util.AliasManager.getInstance();
},properties:{appearance:{refine:true,init:b},iconTrue:{check:f,themeable:true,apply:c},iconFalse:{check:f,themeable:true,apply:e}},members:{__Hm:null,__Hn:null,__Hl:null,_applyIconTrue:function(g){this.__Hm=this.__Hl.resolve(g);
},_applyIconFalse:function(a){this.__Hn=this.__Hl.resolve(a);
},_identifyImage:function(h){return h==true?this.__Hm:this.__Hn;
}}});
})();
