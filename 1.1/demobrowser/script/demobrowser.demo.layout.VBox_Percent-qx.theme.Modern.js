...
(function(){var k="main",j="green",i="33%",h="yellow",g="50%",f="demobrowser.demo.layout.VBox_Percent";
...
var c=new qx.ui.container.Composite(a).set({decorator:k,backgroundColor:h,height:300,allowGrowY:false});
a.setSpacing(5);
var e=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var d=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var b=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
c.add(e,{height:g});
c.add(d,{flex:1});
c.add(b,{flex:1});
return c;
},getBox2:function(){var B=new qx.ui.layout.VBox();
var D=new qx.ui.container.Composite(B).set({decorator:k,backgroundColor:h,height:300,allowGrowY:false});
B.setSpacing(5);
var F=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var E=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var C=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
D.add(F,{height:i});
D.add(E,{height:i});
D.add(C,{height:i,flex:1});
return D;
},getBox3:function(){var G=new qx.ui.layout.VBox();
var I=new qx.ui.container.Composite(G).set({decorator:k,backgroundColor:h,allowGrowY:false});
G.setSpacing(5);
var K=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var J=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var H=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
I.add(K,{height:g});
I.add(J,{flex:1});
I.add(H,{flex:1});
return I;
},getBox4:function(){var r=new qx.ui.layout.VBox();
var t=new qx.ui.container.Composite(r).set({decorator:k,backgroundColor:h,allowGrowY:false});
r.setSpacing(5);
var v=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var u=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var s=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
t.add(v,{height:i,flex:1});
t.add(u,{height:i,flex:1});
t.add(s,{height:i,flex:1});
return t;
},getBox5:function(){var m=new qx.ui.layout.VBox();
var o=new qx.ui.container.Composite(m).set({decorator:k,backgroundColor:h,height:100,allowGrowY:false});
m.setSpacing(5);
var q=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var p=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var n=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
o.add(q,{height:i,flex:1});
o.add(p,{height:i,flex:1});
o.add(n,{height:i,flex:1});
return o;
},getBox6:function(){var w=new qx.ui.layout.VBox();
var y=new qx.ui.container.Composite(w).set({decorator:k,backgroundColor:h,height:300,allowGrowY:false});
w.setSpacing(5);
var A=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var z=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var x=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
y.add(A,{height:i,flex:1});
y.add(z,{height:i,flex:1});
y.add(x,{height:i,flex:1});
return y;
}}});
})();
