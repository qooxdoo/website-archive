...
var c=new qx.ui.core.scroll.ScrollBar(f).set({height:200,maximum:500});
c.addListener(j,function(e){a.setPosition(e.getData());
});
b.add(c,{row:0,column:1});
var a=new qx.ui.core.scroll.NativeScrollBar(h).set({width:300,maximum:500});
a.addListener(j,function(e){c.setPosition(e.getData());
d.setValue(i+e.getData());
});
