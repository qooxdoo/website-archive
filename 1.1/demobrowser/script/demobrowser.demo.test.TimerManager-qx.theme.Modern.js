...
(function(){var j="Stopping recurrent 2-second timer",i="Recurrent 2-second timer with limit 3:",h="One-shot 1-second timer: ",g="__MK",f="demobrowser.demo.test.TimerManager",e="Recurrent 5-second timer: ",d="Start timers",c="execute";
qx.Class.define(f,{extend:qx.application.Standalone,members:{__MK:null,startTimers:function(){var r=qx.util.TimerManager.getInstance();
r.start(function(s,t){this.__ML(e+t);
},5000,this,null,0);
r.start(function(a,b){this.__ML(h+b);
},0,this,null,1000);
r.start(function(k,l){this.__ML(i+l);

if(++k.count==3){this.__ML(j);
r.stop(l);
}},2000,this,{count:0},2000);
},__ML:function(m){m=Date.parse(new Date)+" "+m+"\n";
this.__MK.setValue(this.__MK.getValue()+m);
},main:function(){qx.application.Standalone.prototype.main.call(this);
var o=new qx.ui.layout.VBox(5);
var n=new qx.ui.container.Composite(o);
var p=new qx.ui.form.Button(d);
p.set({allowGrowX:false,allowGrowY:false});
p.addListener(c,function(){p.setEnabled(false);
this.startTimers();
},this);
var q=new qx.ui.form.TextArea();
q.set({width:400,height:300});
this.__MK=q;
n.add(q);
n.add(p);
