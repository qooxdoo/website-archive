...
(function(){var H="value",G="changeSelection",F="execute",E="ScrollbarX:",D="ScrollbarY:",C="Toggle content",B="blue",A="black",z="auto",y="Off",s="white",x="demobrowser.demo.test.ScrollContainer_EdgeCaseWidth",v="off",r="On",q="Content size: 300x300",u="Toggle pane",t="solid",w="Auto",p="on";
...
i.set({width:300,height:200});
this.getRoot().add(i,{left:10,top:10});
i.add(this.generateBox());
var k=new qx.ui.form.Button(u);
var n=true;
k.addListener(F,function(){i.setHeight(n?300:200);
n=!n;
});
this.getRoot().add(k,{left:330,top:20});
var j=new qx.ui.form.Button(C);
var m=true;
j.addListener(F,function(){i.getChildren()[0].setHeight(m?100:300);
m=!m;
});
this.getRoot().add(j,{left:430,top:20});
var l=this.generateScrollbarConfig(E,100);
var h=this.generateScrollbarConfig(D,120);
l.addListener(G,function(e){i.setScrollbarX(e.getData()[0].getUserData(H));
});
h.addListener(G,function(e){i.setScrollbarY(e.getData()[0].getUserData(H));
});
...
a.setMarginRight(20);
var b=new qx.ui.form.RadioButton(w);
...
return g;
},generateBox:function(){var o=new qx.ui.basic.Label(q).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:B,textColor:s,padding:10,decorator:new qx.ui.decoration.Single(4,t,A)});
return o;
},__MD:null}});
})();
