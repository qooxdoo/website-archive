...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.SplitPane","qx.theme":"qx.theme.Modern"};
...
(function(){var t="value",s="horizontal",r="first",q="second",p="both",o="main",n="Show first pane",m="demobrowser.demo.widget.SplitPane",l="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",k="Show both panes",c="__MR",j="Toggle Splitpane Orientation",g="Show second pane",b="vertical",a="_container2",f="changeSelection",d="_container1",h="execute";
qx.Class.define(m,{extend:qx.application.Standalone,members:{__MR:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var w=new qx.ui.container.Scroll();
var v=new qx.ui.container.Composite(new qx.ui.layout.Basic());
v.setAllowStretchX(false);
w.add(v);
var C=new qx.ui.splitpane.Pane(s).set({width:450,height:300});
this.__MR=C;
var F=new qx.ui.container.Composite(new qx.ui.layout.Grow).set({width:200,height:100,decorator:o});
var I=new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({padding:10,maxWidth:450,decorator:o});
var z=this.__MS();
var y=new qx.ui.form.Button(j).set({allowGrowX:false,allowGrowY:false});
y.addListener(h,this._toggle,this);
var A=new qx.ui.basic.Label(l);
A.setRich(true);
F.add(z);
I.add(y);
I.add(A);
...
C.add(F,0);
C.add(I,1);
v.add(C,{left:20,top:40});
this.getRoot().add(w,{edge:0});
var x=new qx.ui.layout.VBox(5);
var D=new qx.ui.container.Composite(x);
var G=new qx.ui.form.RadioButton(n);
var H=new qx.ui.form.RadioButton(g);
var E=new qx.ui.form.RadioButton(k);
G.setUserData(t,r);
H.setUserData(t,q);
E.setUserData(t,p);
E.setValue(true);
...
D.add(H);
D.add(E);
var B=new qx.ui.form.RadioGroup(G,H,E);
B.addListener(f,this._changeVisiblity,this);
v.add(D,{left:490,top:42});
y.focus();
},_toggle:function(){var J=this.__MR.getOrientation();
this.__MR.setOrientation(J==s?b:s);
},_changeVisiblity:function(e){var u=e.getData()[0].getUserData(t);

if(u==p){this._container1.show();
this._container2.show();
}else if(u==r){this._container1.show();
this._container2.exclude();
}else if(u==q){this._container1.exclude();
this._container2.show();
}},__MS:function(){var T=new qx.ui.tree.Tree();
T.setDecorator(null);
var Y=new qx.ui.tree.TreeFolder("/");
Y.setOpen(true);
T.setRoot(Y);
var W=new qx.ui.tree.TreeFolder("Desktop");
W.setOpen(true);
Y.add(W);
var O=new qx.ui.tree.TreeFolder("Files");
var M=new qx.ui.tree.TreeFolder("Workspace");
var N=new qx.ui.tree.TreeFolder("Network");
var L=new qx.ui.tree.TreeFolder("Trash");
W.add(O,M,N,L);
var U=new qx.ui.tree.TreeFile("Windows (C:)");
var K=new qx.ui.tree.TreeFile("Documents (D:)");
M.add(U,K);
var X=new qx.ui.tree.TreeFolder("Inbox");
var P=new qx.ui.tree.TreeFolder("Presets");
var S=new qx.ui.tree.TreeFolder("Sent");
var R=new qx.ui.tree.TreeFolder("Trash");

for(var i=0;i<100;i++){R.add(new qx.ui.tree.TreeFile("Junk #"+i));
}var V=new qx.ui.tree.TreeFolder("Data");
var Q=new qx.ui.tree.TreeFolder("Edit");
X.add(P,S,R,V,Q);
Y.add(X);
return T;
}},destruct:function(){this._disposeObjects(c,d,a);
}});
})();
