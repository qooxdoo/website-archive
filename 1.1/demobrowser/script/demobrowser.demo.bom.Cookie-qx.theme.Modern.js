...
(function(){var m="",l="execute",k="demobrowser.demo.bom.Cookie",j="Save",i="Restore",h="Delete";
qx.Class.define(k,{extend:qx.application.Standalone,statics:{COOKIE_KEY:"TextFieldContent"},members:{main:function(){qx.application.Standalone.prototype.main.call(this);
...
d.add(a);
a.addListener(l,function(e){if(b.getValue()!=m){qx.bom.Cookie.set(demobrowser.demo.bom.Cookie.COOKIE_KEY,b.getValue());
b.setValue(m);
}},this);
var c=new qx.ui.form.Button(i);
d.add(c);
c.addListener(l,function(e){var g=qx.bom.Cookie.get(demobrowser.demo.bom.Cookie.COOKIE_KEY);
b.setValue(g!=null?g:m);
},this);
var f=new qx.ui.form.Button(h);
d.add(f);
f.addListener(l,function(e){qx.bom.Cookie.del(demobrowser.demo.bom.Cookie.COOKIE_KEY);
b.setValue(m);
},this);
}}});
})();
