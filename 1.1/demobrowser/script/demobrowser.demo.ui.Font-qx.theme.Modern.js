...
(function(){var v="execute",u="demobrowser.demo.ui.Font",t="24px sans-serif",s="red",r="Serif, 16px",q="24px serif",p="16px serif",o="Hello World",n="Sans Serif, 24px",m="Sans Serif, 16px",j="Sans Serif, 24px bold",l="24px sans-serif bold",k="solid",i="Serif, 24px",h="16px sans-serif";
...
var b=new qx.ui.basic.Label(o).set({decorator:new qx.ui.decoration.Single(1,k,s)});
this.getRoot().add(b,{left:20,top:20});
var a=new qx.ui.container.Composite(new qx.ui.layout.VBox().set({spacing:10}));
this.getRoot().add(a,{left:200,top:20});
var e=new qx.ui.form.Button(r);
a.add(e);
var f=new qx.ui.form.Button(i);
a.add(f);
var g=new qx.ui.form.Button(m);
a.add(g);
var c=new qx.ui.form.Button(n);
a.add(c);
var d=new qx.ui.form.Button(j);
a.add(d);
e.addListener(v,function(){b.setFont(qx.bom.Font.fromString(p));
});
f.addListener(v,function(){b.setFont(qx.bom.Font.fromString(q));
});
g.addListener(v,function(){b.setFont(qx.bom.Font.fromString(h));
});
c.addListener(v,function(){b.setFont(qx.bom.Font.fromString(t));
});
d.addListener(v,function(){b.setFont(qx.bom.Font.fromString(l));
});
}}});
})();
