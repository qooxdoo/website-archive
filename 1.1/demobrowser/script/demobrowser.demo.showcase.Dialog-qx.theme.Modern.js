...
(function(){var w="right",v="top",u="Last Name",t="Notes",s="male",r="First Name",q="default",p="Cancel",o="Sex",n="Reading",K="Smith",J="Swimming",I="City",H="demobrowser.demo.showcase.Dialog",G="Hobbies",F="icon/22/actions/dialog-apply.png",E="John",D="female",C="Page",B="icon/22/actions/dialog-cancel.png",z="Country",A="OK",x="USA",y="New York";
...
var j=new qx.ui.layout.Grid(9,5);
j.setColumnAlign(0,w,v);
j.setColumnAlign(2,w,v);
j.setColumnWidth(1,160);
j.setColumnWidth(2,72);
j.setColumnWidth(3,108);
var c=new qx.ui.tabview.TabView;
var m=new qx.ui.tabview.Page(C);
m.setLayout(j);
m.setPadding(10);
c.add(m);
this.getRoot().add(c,{left:40,top:40});
var f=[r,u,I,z,t];

for(var i=0;i<f.length;i++){m.add(new qx.ui.basic.Label(f[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}var a=[E,K,y,x];

for(var i=0;i<a.length;i++){m.add(new qx.ui.form.TextField(a[i]),{row:i,column:1});
}m.add(new qx.ui.form.TextArea().set({height:250}),{row:4,column:1,colSpan:3});
m.add(new qx.ui.basic.Label(o).set({allowShrinkX:false,paddingTop:3}),{row:0,column:2});
var h=new qx.ui.form.RadioButton(D);
var l=new qx.ui.form.RadioButton(s);
var g=new qx.ui.form.RadioGroup();
g.add(h,l);
m.add(h,{row:0,column:3});
m.add(l,{row:1,column:3});
l.setValue(true);
m.add(new qx.ui.basic.Label(G).set({allowShrinkX:false,paddingTop:3}),{row:2,column:2});
m.add(new qx.ui.form.CheckBox(n),{row:2,column:3});
m.add(new qx.ui.form.CheckBox(J).set({enabled:false}),{row:3,column:3});
var k=new qx.ui.layout.HBox().set({spacing:4,alignX:w});
var b=new qx.ui.container.Composite(k).set({paddingTop:11});
m.add(b,{row:5,column:0,colSpan:4});
var d=new qx.ui.form.Button(A,F);
d.addState(q);
b.add(d);
var e=new qx.ui.form.Button(p,B);
b.add(e);
}}});
})();
