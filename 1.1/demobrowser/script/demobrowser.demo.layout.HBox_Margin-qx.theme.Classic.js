...
qx.Class.define(p,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);
...
var h=new qx.ui.container.Composite(f).set({decorator:t,backgroundColor:r,allowGrowX:false});
f.setSpacing(5);
...
var x=new qx.ui.container.Composite(v).set({decorator:t,backgroundColor:r,height:100,allowGrowX:false});
v.setSpacing(5);
v.setAlignY(q);
var z=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
var y=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
var w=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
x.add(z);
x.add(y);
x.add(w);
...
var C=new qx.ui.container.Composite(A).set({decorator:t,backgroundColor:r,height:100,allowGrowX:false});
A.setSpacing(5);
A.setAlignY(q);
