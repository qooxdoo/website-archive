...
(function(){var w="black",v="execute",u="The tree has bound its label to the name of the modeln and its ",t="name",s="Write data to log",r="demobrowser.demo.data.ExtendedTree",q="textColor to some random colors.",p="gray",o="red",n="<b>A tree configures with bindItem</b><br/>",g="all boring black",m="textColor",k="label",f="green",e="children",j="yellow",h="Item ",l="color",d="blue";
...
z.setWidth(250);
z.setHeight(300);
var D=new qx.data.controller.Tree(C[0],z,e);
D.setDelegate({bindItem:function(a,b,c){a.bindProperty(t,k,null,b,c);
a.bindProperty(l,m,null,b,c);
}});
z.getRoot().setOpen(true);
var y=new qx.ui.form.Button(g);
y.setWidth(120);
this.getRoot().add(y,{left:280,top:80});
y.addListener(v,function(){for(var i=0;i<C.length;i++){C[i].setColor(w);
}},this);
var B=new qx.ui.form.Button(s);
B.setWidth(120);
this.getRoot().add(B,{left:280,top:115});
B.addListener(v,function(){this.info(C[0].toString());
},this);
