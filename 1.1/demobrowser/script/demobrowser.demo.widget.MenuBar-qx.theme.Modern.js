...
(function(){var bV="execute",bU="changeValue",bT="icon/16/actions/system-search.png",bS="Online Forum",bR="New",bQ="icon/16/actions/edit-cut.png",bP="Search in files",bO="icon/16/actions/format-justify-fill.png",bN="Left aligned",bM="Undo",bB="_openCommand",bA="Uppercase",bz="View",by="C Dialect",bx="changeSelection",bw="Save as...",bv="Show line numbers",bu="Search previous...",bt="Quickstart",bs="Cut",cd="Ctrl+N",ce="C",cb="Show console",cc="Search",bY="Help",ca="_redoCommand",bW="Redo",bX="Show status bar",cf="icon/16/actions/format-justify-left.png",cg="ANSI to OEM",bF="Centered",bE="Paragraph",bH="Edit",bG="Ctrl+O",bJ="icon/16/actions/document-print.png",bI="icon/16/actions/document-open.png",bL="C Sharp",bK="icon/16/actions/edit-undo.png",bD="Close",bC="icon/16/actions/document-save-as.png",v="Python",w="icon/16/apps/utilities-help.png",x="Show tree",y="Spaces to tabs",z="Right aligned",A="OEM to ANSI",B="JavaScript",C="demobrowser.demo.widget.MenuBar",D="_copyCommand",E="Topics",ck="Save",cj="_undoCommand",ci="Capitals",ch="icon/16/actions/application-exit.png",co="C Plus Plus",cn="_saveCommand",cm="Lowercase",cl="Search next...",cq="_newCommand",cp="Replace in files",bc="Perl",bd="Ctrl+P",ba="XML",bb="Panes",bg="Justified",bh="Ctrl+X",be="Show macros",bf="Show ruler",X="Copy",Y="Paste",M="_pasteCommand",L="icon/16/actions/format-justify-right.png",O="Ctrl+Z",N="Ctrl+R",I="icon/16/actions/edit-redo.png",H="Show tags",K="Info...",J="Format",G="File",F="Show tabs",bm="Print",bn="icon/16/actions/document-save.png",bo="icon/16/actions/edit-copy.png",bp="Search...",bi="icon/16/actions/format-justify-center.png",bj="Open",bk="_cutCommand",bl="Objective C",bq="Exit",br="Ctrl+S",W="Syntax",V="Ctrl+C",U="icon/16/actions/document-new.png",T="Tabs to spaces",S="ASCII table",R="Replace",Q="HTML",P="icon/16/actions/edit-paste.png";
...
this.createCommands();
cw.add(this.getMenuBar(),{left:20,top:20});
...
},createCommands:function(){this._newCommand=new qx.ui.core.Command(cd);
this._newCommand.addListener(bV,this.debugCommand);
this._openCommand=new qx.ui.core.Command(bG);
this._openCommand.addListener(bV,this.debugCommand);
this._saveCommand=new qx.ui.core.Command(br);
this._saveCommand.addListener(bV,this.debugCommand);
this._undoCommand=new qx.ui.core.Command(O);
this._undoCommand.addListener(bV,this.debugCommand);
this._redoCommand=new qx.ui.core.Command(N);
this._redoCommand.addListener(bV,this.debugCommand);
this._cutCommand=new qx.ui.core.Command(bh);
this._cutCommand.addListener(bV,this.debugCommand);
this._copyCommand=new qx.ui.core.Command(V);
this._copyCommand.addListener(bV,this.debugCommand);
this._pasteCommand=new qx.ui.core.Command(bd);
this._pasteCommand.addListener(bV,this.debugCommand);
this._pasteCommand.setEnabled(false);
},getMenuBar:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.Grow);
var menubar=new qx.ui.menubar.MenuBar;
menubar.setWidth(600);
q.add(menubar);
var p=new qx.ui.menubar.Button(G,null,this.getFileMenu());
var o=new qx.ui.menubar.Button(bH,null,this.getEditMenu());
var r=new qx.ui.menubar.Button(cc,null,this.getSearchMenu());
var u=new qx.ui.menubar.Button(bz,null,this.getViewMenu());
var t=new qx.ui.menubar.Button(J,null,this.getFormatMenu());
var s=new qx.ui.menubar.Button(bY,null,this.getHelpMenu());
menubar.add(p);
menubar.add(o);
menubar.add(r);
menubar.add(u);
...
var g=new qx.ui.menu.Button(bR,U,this._newCommand);
var k=new qx.ui.menu.Button(bj,bI,this._openCommand);
var j=new qx.ui.menu.Button(bD);
var n=new qx.ui.menu.Button(ck,bn,this._saveCommand);
var m=new qx.ui.menu.Button(bw,bC);
var l=new qx.ui.menu.Button(bm,bJ);
var h=new qx.ui.menu.Button(bq,ch);
g.addListener(bV,this.debugButton);
k.addListener(bV,this.debugButton);
j.addListener(bV,this.debugButton);
n.addListener(bV,this.debugButton);
m.addListener(bV,this.debugButton);
l.addListener(bV,this.debugButton);
h.addListener(bV,this.debugButton);
i.add(g);
i.add(k);
i.add(j);
i.add(n);
...
i.add(h);
return i;
},getEditMenu:function(){var dj=new qx.ui.menu.Menu;
var dm=new qx.ui.menu.Button(bM,bK,this._undoCommand);
var dl=new qx.ui.menu.Button(bW,I,this._redoCommand);
var di=new qx.ui.menu.Button(bs,bQ,this._cutCommand);
var dn=new qx.ui.menu.Button(X,bo,this._copyCommand);
var dk=new qx.ui.menu.Button(Y,P,this._pasteCommand);
dm.addListener(bV,this.debugButton);
dl.addListener(bV,this.debugButton);
di.addListener(bV,this.debugButton);
dn.addListener(bV,this.debugButton);
dk.addListener(bV,this.debugButton);
dj.add(dm);
dj.add(dl);
dj.addSeparator();
dj.add(di);
...
dj.add(dk);
return dj;
},getSearchMenu:function(){var cB=new qx.ui.menu.Menu;
var cz=new qx.ui.menu.Button(bp,bT);
var cE=new qx.ui.menu.Button(cl);
var cA=new qx.ui.menu.Button(bu);
var cD=new qx.ui.menu.Button(R);
var cy=new qx.ui.menu.Button(bP,bT);
var cC=new qx.ui.menu.Button(cp);
cA.setEnabled(false);
cz.addListener(bV,this.debugButton);
cE.addListener(bV,this.debugButton);
cA.addListener(bV,this.debugButton);
cD.addListener(bV,this.debugButton);
cy.addListener(bV,this.debugButton);
cC.addListener(bV,this.debugButton);
cB.add(cz);
cB.add(cE);
cB.add(cA);
cB.add(cD);
...
cB.add(cC);
return cB;
},getViewMenu:function(){var cF=new qx.ui.menu.Menu;
var cH=new qx.ui.menu.Button(bb,null,null,this.getPanesMenu());
var cK=new qx.ui.menu.Button(W,null,null,this.getSyntaxMenu());
var cJ=new qx.ui.menu.CheckBox(bf);
var cI=new qx.ui.menu.CheckBox(bv);
var cG=new qx.ui.menu.Button(S);
cJ.addListener(bU,this.debugCheckBox);
cI.addListener(bU,this.debugCheckBox);
cG.addListener(bV,this.debugButton);
cF.add(cH);
cF.add(cK);
cF.addSeparator();
cF.add(cJ);
...
cF.add(cG);
return cF;
},getPanesMenu:function(){var dq=new qx.ui.menu.Menu;
var ds=new qx.ui.menu.CheckBox(F);
var du=new qx.ui.menu.CheckBox(bX);
var dv=new qx.ui.menu.CheckBox(x);
var dr=new qx.ui.menu.CheckBox(be);
var dt=new qx.ui.menu.CheckBox(H);
var dp=new qx.ui.menu.CheckBox(cb);
ds.setValue(true);
du.setValue(true);
dr.setValue(true);
ds.addListener(bU,this.debugCheckBox);
du.addListener(bU,this.debugCheckBox);
dv.addListener(bU,this.debugCheckBox);
dr.addListener(bU,this.debugCheckBox);
dt.addListener(bU,this.debugCheckBox);
dp.addListener(bU,this.debugCheckBox);
dq.add(du);
dq.add(ds);
dq.addSeparator();
dq.add(dv);
...
dq.add(dp);
return dq;
},getSyntaxMenu:function(){var cY=new qx.ui.menu.Menu;
var cU=new qx.ui.menu.RadioButton(Q);
var cW=new qx.ui.menu.RadioButton(ba);
var cV=new qx.ui.menu.RadioButton(B);
var cX=new qx.ui.menu.Button(by,null,null,this.getSyntaxCMenu());
var dc=new qx.ui.menu.RadioButton(bc);
var da=new qx.ui.menu.RadioButton(v);
cY.add(cU);
cY.add(cW);
cY.add(cV);
cY.add(cX);
cY.add(dc);
cY.add(da);
var db=new qx.ui.form.RadioGroup;
db.add(cU,cW,cV,dc,da);
db.add.apply(db,cX.getMenu().getChildren());
db.addListener(bx,this.debugRadio);
return cY;
},getSyntaxCMenu:function(){var b=new qx.ui.menu.Menu;
var a=new qx.ui.menu.RadioButton(ce);
var f=new qx.ui.menu.RadioButton(bL);
var d=new qx.ui.menu.RadioButton(bl);
...
b.add(c);
return b;
},getFormatMenu:function(){var cO=new qx.ui.menu.Menu;
var cN=new qx.ui.menu.Button(bE,null,null,this.getParagraphMenu());
var cQ=new qx.ui.menu.Button(T);
var cR=new qx.ui.menu.Button(y);
var cM=new qx.ui.menu.Button(bA);
var cP=new qx.ui.menu.Button(cm);
var cL=new qx.ui.menu.Button(ci);
var cT=new qx.ui.menu.Button(A);
var cS=new qx.ui.menu.Button(cg);
cQ.addListener(bV,this.debugButton);
cR.addListener(bV,this.debugButton);
cM.addListener(bV,this.debugButton);
cP.addListener(bV,this.debugButton);
cL.addListener(bV,this.debugButton);
cT.addListener(bV,this.debugButton);
cS.addListener(bV,this.debugButton);
cO.add(cN);
cO.add(cQ);
cO.add(cR);
cO.addSeparator();
...
cO.add(cS);
return cO;
},getParagraphMenu:function(){var cr=new qx.ui.menu.Menu;
var cu=new qx.ui.menu.Button(bN,cf);
var cv=new qx.ui.menu.Button(z,L);
var cs=new qx.ui.menu.Button(bF,bi);
var ct=new qx.ui.menu.Button(bg,bO);
cu.addListener(bV,this.debugButton);
cv.addListener(bV,this.debugButton);
cs.addListener(bV,this.debugButton);
ct.addListener(bV,this.debugButton);
cr.add(cu);
cr.add(cv);
...
var df=new qx.ui.menu.Button(E,w);
var dh=new qx.ui.menu.Button(bt);
var dg=new qx.ui.menu.Button(bS);
var de=new qx.ui.menu.Button(K);
df.addListener(bV,this.debugButton);
dh.addListener(bV,this.debugButton);
dg.addListener(bV,this.debugButton);
de.addListener(bV,this.debugButton);
dd.add(df);
dd.add(dh);
dd.addSeparator();
dd.add(dg);
...
dd.add(de);
return dd;
}},destruct:function(){this._disposeObjects(cq,bB,cn,cj,ca,bk,D,M);
}});
})();
