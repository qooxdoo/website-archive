...
(function(){var p="left",o="bottom",n="center",m="vertical",l="Max: ",k="changeValue",j="horizontal",h="top",g="middle",f="demobrowser.demo.widget.Slider",c="Min: ",d="right";
...
s.setColumnFlex(1,1);
s.setColumnFlex(2,1);
s.setColumnAlign(0,p,o);
s.setColumnAlign(1,n,o);
s.setColumnAlign(2,d,o);
var u=0;

for(var i=0;i<r.length;i++){var t=r[i];
t.slider.setOrientation(j);
t.value.setWidth(100);
t.value.setTextAlign(n);
...
},_createSliderGroup:function(a){var b={slider:a,minimum:new qx.ui.basic.Label(c+a.getMinimum().toString()),maximum:new qx.ui.basic.Label(l+a.getMaximum().toString()),value:new qx.ui.basic.Label(a.getValue().toString())};
a.addListener(k,function(e){b.value.setValue(a.getValue().toString());
});
return b;
}}});
})();
