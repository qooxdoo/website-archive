...
(function(){var p="keyinput",o="",n="logger",m="keypress",l="Char code",k="Ctrl",j="Key identifier",h="demobrowser.demo.event.KeyEvent",g="Shift",f="keydown",c="Event",e="Alt",d="keyup";
...
this._initLogger([c,j,l,g,k,e],document.getElementById(n),50);
var q=[f,m,d,p];

for(var i=0;i<q.length;i++){qx.bom.Element.addListener(document.documentElement,q[i],this.logKeyEvent,this);
}},logKeyEvent:function(a){var b=a.getType();
this._log([b,b!==p?a.getKeyIdentifier():o,b==p?a.getCharCode():o,a.isShiftPressed(),a.isAltPressed(),a.isCtrlPressed()]);
a.preventDefault();
}}});
})();
