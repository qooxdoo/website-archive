...
j.add(this.getBox6());
j.add(this.getBox7());
},getBox1:function(){var u=new qx.ui.layout.VBox();
...
A.setMarginTop(-10);
return B;
},getBox5:function(){var k=new qx.ui.layout.VBox();
var m=new qx.ui.container.Composite(k).set({decorator:i,backgroundColor:h,width:140,height:300,allowGrowY:false});
...
l.setHeight(0);
return m;
},getBox6:function(){var E=new qx.ui.layout.VBox();
var G=new qx.ui.container.Composite(E).set({decorator:i,backgroundColor:h,width:140,height:100,allowGrowY:false});
