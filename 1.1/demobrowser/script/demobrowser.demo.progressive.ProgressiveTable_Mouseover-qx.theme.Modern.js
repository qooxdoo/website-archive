...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.progressive.ProgressiveTable_Mouseover","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.progressive.ProgressiveTable_Mouseover-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"9ccb17aae04d"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var x="row",w="rgb(255, 0, 0)",v="celldata",u="",t="Number",s="red",r="1*",q="celldata='",p="' ",o="<br>",i="demobrowser.demo.progressive.ProgressiveTable_Mouseover",n="end",l="Date",h="Move your mouse over the Date field",g="demobrowser.demo.progressive.DateCellRenderer",k="onmouseover='demobrowser.demo.progressive.DateCellRenderer.onmouseover(this);' ",j="Id",m="onmouseout='demobrowser.demo.progressive.DateCellRenderer.onmouseout(this);' ";
...
var H=0;
var D=function(a){var d=[];
var c=new Date().getTime();
var e=400*24*60*60*1000;

for(var f=0;f<a;f++){var b=new Date(c+Math.random()*e-e/2);
d.push({renderer:x,location:n,data:[H++,Math.random()*10000,b]});
}return d;
};
var G=new qx.ui.progressive.renderer.table.Widths(3);
G.setWidth(0,100);
G.setWidth(1,r);
G.setWidth(2,300);
var A=[j,t,l];
var C=new qx.ui.progressive.headfoot.TableHeading(G,A);
var z=new qx.ui.progressive.headfoot.Progress(G,A);
var J=new qx.ui.progressive.structure.Default(C,z);
var y=new qx.ui.progressive.Progressive(J);
var I=new qx.ui.basic.Atom(h);
I.setTextColor(s);
I.setHeight(16);
I.setRich(true);
y.add(I);
var F=new qx.ui.progressive.model.Default();
var E=D(500);
F.addElements(E);
y.setDataModel(F);
var B=new qx.ui.progressive.renderer.table.Row(G);
y.addRenderer(x,B);
B.addRenderer(2,new demobrowser.demo.progressive.DateCellRenderer());
this.getRoot().add(y,{edge:50});
y.render();
}}});
qx.Class.define(g,{extend:qx.ui.progressive.renderer.table.cell.Default,statics:{onmouseover:function(L){L.__MP=qx.bom.element.Style.get(L,"color");
L.style.color=w;
L.parentNode.style.height=32;
L.__MQ=L.innerHTML;
var N=Date.parse(L.attributes.getNamedItem(v).nodeValue);
var M=new Date(N);
L.innerHTML=M.toUTCString()+o+M.toString();
},onmouseout:function(K){K.style.color=K.__MP;
K.parentNode.style.height=16;
K.innerHTML=K.__MQ;
...
P.push(q+O.cellData.toUTCString()+p);
P.push(k,m);
return P.join(u);
}}});
})();
