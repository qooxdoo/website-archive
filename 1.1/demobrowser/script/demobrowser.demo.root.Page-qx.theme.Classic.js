...
(function(){var k="main",j="demobrowser.demo.root.Page",i="yellow",h="red",g="green",f="blue";
qx.Class.define(j,{extend:qx.application.Inline,members:{main:function(){qx.application.Inline.prototype.main.call(this);
var a=new qx.ui.container.Composite(new qx.ui.layout.HBox());
var e=new qx.ui.core.Widget().set({backgroundColor:h,decorator:k,padding:10});
var d=new qx.ui.core.Widget().set({backgroundColor:f,decorator:k});
var c=new qx.ui.core.Widget().set({backgroundColor:g,decorator:k});
var b=new qx.ui.core.Widget().set({backgroundColor:i,decorator:k});
a.add(e);
a.add(d);
a.add(c);
a.add(b);
this.getRoot().add(a,{left:30,top:120});
}}});
})();
