...
(function(){var C="change",B="option",A="select",z="VAL",y="Value ",x="checkbox",w="radio1",v="input",u="radio",t="val1",q="text",s="file",r="val2",p="demobrowser.demo.bom.Input",o="textarea";
qx.Class.define(p,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
var j=qx.bom.Input.create(q);
qx.event.Registration.addListener(j,v,function(e){this.debug("Input (Single): "+e.getData());
},this);
qx.event.Registration.addListener(j,C,function(e){this.debug("Change (Single): "+e.getData());
},this);
var c=qx.bom.Input.create(o);
qx.event.Registration.addListener(c,v,function(e){this.debug("Input (Multi): "+e.getData());
},this);
qx.event.Registration.addListener(c,C,function(e){this.debug("Change (Multi): "+e.getData());
},this);
document.body.appendChild(j);
document.body.appendChild(c);
var h=qx.bom.Input.create(x);
var m=qx.bom.Input.create(x,{checked:true});
qx.event.Registration.addListener(h,C,function(e){this.debug("Changed checkbox 1: "+e.getData());
},this);
qx.event.Registration.addListener(m,C,function(e){this.debug("Changed checkbox 2: "+e.getData());
},this);
document.body.appendChild(h);
document.body.appendChild(m);
var l=qx.bom.Input.create(u,{name:w,value:t,checked:true});
var n=qx.bom.Input.create(u,{name:w,value:r});
function b(e){this.debug("Changed radio: "+e.getTarget().name+" = "+e.getData());
}qx.event.Registration.addListener(l,C,b,this);
qx.event.Registration.addListener(n,C,b,this);
document.body.appendChild(l);
document.body.appendChild(n);
var a=qx.bom.Input.create(A);
var k;

for(var i=0;i<10;i++){k=document.createElement(B);
k.value=z+i;
k.appendChild(document.createTextNode(y+i));
a.appendChild(k);
}qx.event.Registration.addListener(a,C,function(e){this.debug("Changed selectbox1: "+e.getData());
},this);
document.body.appendChild(a);
var f=qx.bom.Input.create(A,{size:3});
var k;
...
k.appendChild(document.createTextNode(y+i));
f.appendChild(k);
}qx.event.Registration.addListener(f,C,function(e){this.debug("Changed selectbox2: "+e.getData());
},this);
document.body.appendChild(f);
var g=qx.bom.Input.create(A,{size:3,multiple:true});
var k;
...
k.appendChild(document.createTextNode(y+i));
g.appendChild(k);
}qx.event.Registration.addListener(g,C,function(e){this.debug("Changed selectbox3: "+e.getData());
},this);
document.body.appendChild(g);
var d=qx.bom.Input.create(s);
qx.event.Registration.addListener(d,C,function(e){this.debug("Changed file select: "+e.getData());
},this);
