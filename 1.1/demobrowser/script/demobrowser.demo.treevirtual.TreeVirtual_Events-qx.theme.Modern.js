...
var G=e.getData();
y.nodeSetHideOpenClose(G,true);
});
y.addListener(j,function(e){var E=k;
var F=e.getData();

for(i=0;i<F.length;i++){E+=t+F[i].label;
