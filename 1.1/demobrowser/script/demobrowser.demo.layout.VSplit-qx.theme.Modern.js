...
},getSplitPaneTwoFlexSimple:function(){var A=new qx.ui.splitpane.Pane(v);
A.setHeight(400);
A.setDecorator(u);
...
A.add(B,2);
return A;
},getSplitPaneTwoFlexWithOneMin:function(){var e=new qx.ui.splitpane.Pane(v);
e.setHeight(400);
e.setDecorator(u);
...
e.add(f,2);
return e;
},getSplitPaneTwoFlexWithOneMax:function(){var D=new qx.ui.splitpane.Pane(v);
D.setHeight(400);
D.setDecorator(u);
var C=new qx.ui.form.TextArea(t);
C.setDecorator(null);
C.setWrap(true);
D.add(C,1);
var E=new qx.ui.form.TextArea(o);
E.setDecorator(null);
E.setWrap(true);
E.setMaxHeight(100);
D.add(E,2);
...
N.add(O,2);
return N;
},getSplitPaneTwoFlexWithTwoMax:function(){var G=new qx.ui.splitpane.Pane(v);
G.setHeight(400);
G.setDecorator(u);
...
G.add(H,2);
return G;
},getSplitPaneOneFlexSimple:function(){var h=new qx.ui.splitpane.Pane(v);
h.setHeight(400);
h.setDecorator(u);
var g=new qx.ui.form.TextArea(p);
g.setDecorator(null);
g.setWrap(true);
h.add(g,0);
...
b.add(c);
return b;
},getSplitPaneOneFlexSimpleWithMin:function(){var x=new qx.ui.splitpane.Pane(v);
x.setHeight(400);
x.setDecorator(u);
var w=new qx.ui.form.TextArea(l);
w.setDecorator(null);
w.setWrap(true);
w.setMinHeight(350);
x.add(w,0);
