...
(function(){var f="Window: ",e="__MG",d="interval",c="Label: ",b="demobrowser.demo.test.Destructor";
qx.Class.define(b,{extend:qx.application.Standalone,members:{__ME:null,__MF:0,__MG:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__ME=[];
this.currentTest=this.testWindows;
this.__MG=new qx.event.Timer(1000);
this.__MG.addListener(d,this.runTest,this);
this.__MG.start();
},runTest:function(){this.__MF++;
var h=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__MF+" (Registry: "+h+")");
this.currentTest();
qx.ui.core.queue.Manager.flush();
var g=this.__ME;

for(var i=0,l=g.length;i<l;i++){g[i].destroy();
}g.length=0;
qx.ui.core.queue.Manager.flush();
var h=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Done! (Registry: "+h+")");
},testLabels:function(){for(var i=0;i<250;i++){var a=new qx.ui.basic.Label(c+i);
this.getRoot().add(a,{left:50,top:50+i*20});
this.__ME.push(a);
}},testWindows:function(){for(var i=0;i<5;i++){var j=new qx.ui.window.Window(f+i);
j.open();
this.__ME.push(j);
