...
(function(){var v="0",u="middle",t="100",s="left",r="Disabled",q="Not Editable",p="demobrowser.demo.widget.Spinner",o="Stepped",n="Wrap",m="-3000",g="30",l="300",j="3000",f="changeValue",d="-30",i="Simple",h="Number format",k="right";
qx.Class.define(p,{extend:qx.application.Standalone,members:{addSimpleSpinner:function(w,x){var y=new qx.ui.form.Spinner();
w.add(new qx.ui.basic.Label(i),{column:0,row:x});
w.add(new qx.ui.basic.Label(v),{column:1,row:x});
w.add(y,{column:2,row:x});
w.add(new qx.ui.basic.Label(t),{column:3,row:x});
y.addListener(f,function(e){this.debug("ChangeValue: "+e.getData());
});
},addNonEditableSpinner:function(L,M){var N=new qx.ui.form.Spinner(0,50,100);
N.setEditable(false);
L.add(new qx.ui.basic.Label(q),{column:0,row:M});
L.add(new qx.ui.basic.Label(v),{column:1,row:M});
L.add(N,{column:2,row:M});
L.add(new qx.ui.basic.Label(t),{column:3,row:M});
},addWrappingSpinner:function(z,A){var B=new qx.ui.form.Spinner(-30,30,30);
B.setWrap(true);
z.add(new qx.ui.basic.Label(n),{column:0,row:A});
z.add(new qx.ui.basic.Label(d),{column:1,row:A});
z.add(B,{column:2,row:A});
z.add(new qx.ui.basic.Label(g),{column:3,row:A});
},addSteppedSpinner:function(a,b){var c=new qx.ui.form.Spinner(-3000,0,3000).set({singleStep:25});
a.add(new qx.ui.basic.Label(o),{column:0,row:b});
a.add(new qx.ui.basic.Label(m),{column:1,row:b});
a.add(c,{column:2,row:b});
a.add(new qx.ui.basic.Label(j),{column:3,row:b});
},addDisabledSpinner:function(C,D){var E=new qx.ui.form.Spinner;
E.setEnabled(false);
C.add(new qx.ui.basic.Label(r),{column:0,row:D});
C.add(new qx.ui.basic.Label(v),{column:1,row:D});
C.add(E,{column:2,row:D});
C.add(new qx.ui.basic.Label(t),{column:3,row:D++});
},addFormattedSpinner:function(F,G){var H=new qx.ui.form.Spinner(0,200,300);
H.setSingleStep(0.5);
H.setWidth(70);
...
H.setNumberFormat(I);
F.add(new qx.ui.basic.Label(h),{column:0,row:G});
F.add(new qx.ui.basic.Label(v),{column:1,row:G});
F.add(H,{column:2,row:G});
F.add(new qx.ui.basic.Label(l),{column:3,row:G++});
},main:function(){qx.application.Standalone.prototype.main.call(this);
var K=new qx.ui.layout.Grid(10,8);
K.setColumnAlign(0,s,u);
K.setColumnAlign(1,k,u);
K.setColumnAlign(2,s,u);
K.setColumnAlign(3,s,u);
