...
(function(){var y="execute",x="value",w="online",v="Jack",u="kiss",t="demobrowser.demo.data.ExtendedList",s="Jim",r="sad",q="<b>Displaying Checkboxes in a list</b><br/>",p="plain",N="surprise",M="embarrassed",L="name",K="Write data to log",J="Jakob",I="Dan",H="Tim",G="Karl",F="Online <> Offline",E="This list display a set of persons in a list as checkbox. Every ",C="label",D="Dustin",A="angel",B="Max",z="person does have a name as label and an online status as checkbox.";
...
var l=[B,J,H,v,I,D,G,s];
var d=[M,u,p,r,N,A];
var j=[];

for(var i=0;i<20;i++){var f=new demobrowser.demo.data.model.Person();
f.setName(l[i%l.length]);
f.setEmote(d[i%d.length]);
f.setOnline(i%3==0);
j.push(f);
}var k=new qx.data.Array(j);
var c=new qx.ui.form.List();
c.setWidth(150);
this.getRoot().add(c,{left:10,top:80});
var g=new qx.data.controller.List(null,c);
var b={configureItem:function(O){O.setPadding(3);
},createItem:function(){return new qx.ui.form.CheckBox();
},bindItem:function(m,n,o){m.bindProperty(L,C,null,n,o);
m.bindProperty(w,x,null,n,o);
m.bindPropertyReverse(w,x,null,n,o);
}};
g.setDelegate(b);
g.setModel(k);
var a=new qx.ui.form.Button(F);
a.setWidth(120);
this.getRoot().add(a,{left:180,top:80});
a.addListener(y,function(){for(var i=0;i<k.length;i++){k.getItem(i).toggleOnline();
}},this);
var h=new qx.ui.form.Button(K);
h.setWidth(120);
this.getRoot().add(h,{left:180,top:115});
h.addListener(y,function(){qx.log.appender.Console.show();
this.info(k.toString());
},this);
