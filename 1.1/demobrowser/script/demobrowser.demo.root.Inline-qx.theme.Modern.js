...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.root.Inline","qx.theme":"qx.theme.Modern"};
...
(function(){var n="main",m="black",l="red",k="demobrowser.demo.root.Inline",j="isle",i="green",h="white",g="yellow",f="blue";
qx.Class.define(k,{extend:qx.application.Inline,members:{main:function(){qx.application.Inline.prototype.main.call(this);
var c=new qx.ui.root.Inline(document.getElementById(j)).set({decorator:n,padding:10,textColor:m,backgroundColor:h});
var d=new qx.ui.core.Widget().set({backgroundColor:l,decorator:n,padding:10});
var e=new qx.ui.core.Widget().set({backgroundColor:f,decorator:n});
var b=new qx.ui.core.Widget().set({backgroundColor:i,decorator:n});
var a=new qx.ui.core.Widget().set({backgroundColor:g,decorator:n});
c.add(d);
c.add(e);
c.add(b);
c.add(a);
