...
t.setToolTip(i);
var r={name:[k],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var s=this._getNewHeaderContainer();
qx.util.Permutation.permute(r,function(a){var b=t.createHeaderCell(a);
s.add(b);
t.updateHeaderCell(a,b);
});
},testIconRenderer:function(){var o=new qx.ui.table.headerrenderer.Icon(h);
o.setToolTip(i);
var m={name:[k],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
...
l.addListener(g,function(e){e.getTarget().addState(j);
});
l.addListener(c,function(e){e.getTarget().removeState(j);
});
