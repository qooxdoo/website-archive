...
this.getRoot().add(a);
var b=new qx.ui.basic.Label(q).set({decorator:z,width:200});
a.add(b);
this.getRoot().add(this.createConfigureButton(b,l),{left:240,top:20});
var c=new qx.ui.basic.Label(s).set({decorator:z,rich:true});
a.add(c);
this.getRoot().add(this.createConfigureButton(c,n),{left:240,top:60});
var d=new qx.ui.basic.Label(t).set({decorator:z,width:80});
a.add(d);
var e=new qx.ui.basic.Label().set({value:o,decorator:z,rich:true,width:120});
a.add(e);
var f=new qx.ui.basic.Label(h).set({decorator:z,font:new qx.bom.Font(28,[y,x])});
a.add(f);
var g=new qx.ui.basic.Label(u).set({decorator:z,font:new qx.bom.Font(28,[y,x]),width:150});
a.add(g);
},createConfigureButton:function(B,C){var E=new qx.ui.form.Button(C);
var D;
E.addListener(p,function(){if(!D){D=this.createEditDialog(B,C);
}D.open();
},this);
return E;
...
J.setColumnFlex(1,1);
J.setColumnAlign(0,m,r);
H.setLayout(J);
var I=new qx.data.controller.Object(F);
H.add(new qx.ui.basic.Label(A).set({paddingTop:5}),{row:0,column:0});
var K=new qx.ui.form.TextArea().set({liveUpdate:true});
I.addTarget(K,A,A,true);
H.add(K,{row:0,column:1});
H.add(new qx.ui.basic.Label(w),{row:1,column:0});
var L=new qx.ui.form.CheckBox();
I.addTarget(L,A,w,true);
H.add(L,{row:1,column:1});
H.add(new qx.ui.basic.Label(k),{row:2,column:0});
var L=new qx.ui.form.CheckBox();
I.addTarget(L,A,i,true);
H.add(L,{row:2,column:1});
H.add(new qx.ui.basic.Label(v),{row:3,column:0});
