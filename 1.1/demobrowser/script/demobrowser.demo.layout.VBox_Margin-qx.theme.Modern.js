...
p.setMarginRight(30);
return q;
},getBox2:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:j,backgroundColor:h,allowGrowY:false});
...
var l=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
m.add(o);
m.add(n);
m.add(l);
o.setMarginLeft(20);
