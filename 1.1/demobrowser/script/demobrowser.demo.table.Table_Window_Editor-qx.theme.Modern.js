...
var q={tableColumnModel:function(A){return new qx.ui.table.columnmodel.Resize(A);
}};
...
z.moveTo(300,250);
z.addListener(f,function(e){z.__MN.focus();
z.__MN.setTextSelection(0,z.__MN.getValue().length);
});
z.__MN=new qx.ui.form.TextField(w.value+"").set({allowGrowY:true});
z.add(z.__MN);
...
return z;
},getCellEditorValue:function(v){return parseFloat(v.__MN.getValue());
}}});
})();
