...
(function(){var bE="",bD="execute",bC="<tr>",bB="changeSelection",bA="#",bz="qooxdoo logo",by="</tr>",bx="qx/icon/Oxygen/16/actions/format-indent-more.png",bw="Color (Hex): ",bv="Georgia",bk="http://",bj="Change Font Size",bi="BgColor (Hex): ",bh="Indent More",bg="<p>You can play around with this widget by hitting the ",bf="Inserted Unordered List",be="Align Right",bd="Format Italic",bc="qx/icon/Oxygen/16/actions/format-text-underline.png",bb='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',bL="OK",bM="buttons at the toolbar.</p>",bJ="demobrowser.demo.widget.HtmlArea",bK="demobrowser/demo/icons/htmlarea/format-list-ordered.png",bH="Comic Sans MS",bI="<p>This UI-level widget can be used at RIA (Rich ",bF="Tahoma",bG="<td>First Row, First cell</td>",bN="solid",bO="demobrowser/demo/icons/htmlarea/qooxdoo_logo.png",bo="qx/icon/Oxygen/16/actions/format-justify-center.png",bn="Align Justify",bq="demobrowser/demo/icons/htmlarea/format-fill-color.png",bp="demobrowser/demo/icons/htmlarea/insert-text.png",bs="Insert Horizontal Ruler",br="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",bu="demobrowser/demo/icons/htmlarea/format-list-unordered.png",bt="HTML Code:",bm="Set Text Background Color",bl="Internet Applications) and inline applications.<br/>",d="Insert Link",f="<td>Second Row, First cell</td>",g="</tbody>",h="Set Text Color",k="Insert Table",l="Cancel",m="As an application developer you can <b>use the same API.</b></p>",n="demobrowser/demo/icons/htmlarea/format-text-color.png",o="demobrowser/demo/icons/htmlarea/insert-table.png",p="qx/icon/Oxygen/16/actions/edit-undo.png",bS="qx/icon/Oxygen/16/actions/edit-clear.png",bR="Arial Black",bQ="Impact",bP="Undo Last Change",bW="Redo Last Undo Step",bV="Format Bold",bU="Change Font Family",bT="right",bY="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",bX="main",K="Insert Hyperlink",L="Remove Format",I="blank.html",J="qx/icon/Oxygen/16/actions/insert-image.png",O="so code-duplication is avoided.<br/>",P="</table>",M="12px ",N="<td>First Row, Second cell</td>",G="Insert HTML Code",H="qx/icon/Oxygen/16/actions/insert-link.png",x="Insert Ordered List",w="qx/icon/Oxygen/16/actions/format-justify-left.png",z="Courier",y="Courier New",t="qx/icon/Oxygen/16/actions/format-justify-right.png",s="qx/icon/Oxygen/16/actions/format-text-bold.png",v="<td>Second Row, Second cell</td>",u="Insert Image",r="<h1>HtmlArea UI-level widget</h1>",q="Align Left",U="<table border='1'>",V="The UI widget does use the low-level component internally ",W="qx/icon/Oxygen/16/actions/format-indent-less.png",X="<tbody>",Q="Times New Roman",R="Align Center",S="qx/icon/Oxygen/16/actions/edit-redo.png",T="Lucida Console",Y="border-main",ba="qx/icon/Oxygen/16/actions/format-text-italic.png",F="Arial",E="qx/icon/Oxygen/16/actions/format-justify-fill.png",D="Verdana",C="Indent Less",B="Format Strikethrough",A="Format Underline";
qx.Class.define(bJ,{extend:qx.application.Standalone,members:{__Nk:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var ck=r+bI+bl+V+O+m+bg+bM;
var cf=new qx.ui.basic.Label(ck);
cf.set({rich:true,marginBottom:10});
var cj=bb;
var ci=this.getRoot();
var ch=new qx.ui.decoration.Single(1,bN,Y);
ch.setWidthTop(0);
this.__Nk=new qx.ui.embed.HtmlArea(cj,null,I);
this.__Nk.set({width:600,height:400,decorator:ch});
var toolbar=this.__Nu();
var ce=new qx.ui.layout.VBox(0);
var cg=new qx.ui.container.Composite(ce);
cg.add(cf);
cg.add(toolbar);
cg.add(this.__Nk);
ci.add(cg,{left:20,top:20});
},__Nl:function(e){var cd=window.prompt(bw,bA);
this.setTextColor(cd);
},__Nm:function(e){var ca=window.prompt(bi,bA);
this.setTextBackgroundColor(ca);
},__Nn:function(e){var cb={src:qx.util.ResourceManager.getInstance().toUri(bO),border:0,title:bz,alt:bz};
this.insertImage(cb);
},__No:function(e){var a=U+X+bC+bG+N+by+bC+f+v+by+g+P;
this.insertHtml(a);
},__Np:function(e){var cn=new qx.ui.window.Window(K);
cn.setLayout(new qx.ui.layout.VBox(20));
cn.set({width:400,showMaximize:false,showMinimize:false});
var cr=new qx.ui.form.TextField(bk);
cn.add(cr);
var cp=new qx.ui.layout.HBox(10);
cp.setAlignX(bT);
var cq=new qx.ui.container.Composite(cp);
var cm=new qx.ui.form.Button(bL);
cm.setWidth(60);
cm.addListener(bD,function(e){this.insertHyperLink(cr.getValue());
cn.close();
},this);
cq.add(cm);
var co=new qx.ui.form.Button(l);
co.setWidth(60);
co.addListener(bD,function(e){cn.close();
},this);
cq.add(co);
cn.add(cq);
cn.center();
cn.open();
this.saveRange();
},__Nq:function(e){var cl=window.prompt(bt,bE);
this.insertHtml(cl);
},__Nr:function(){var cz=new qx.ui.form.SelectBox;
cz.set({toolTipText:bU,focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});
cz.add(new qx.ui.form.ListItem(bE));
var cA=[bF,D,Q,F,bR,y,z,bv,bQ,bH,T];
var cy;

for(var i=0,j=cA.length;i<j;i++){cy=new qx.ui.form.ListItem(cA[i]);
cy.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString(M+cA[i])});
cz.add(cy);
}cz.addListener(bB,function(e){var cx=e.getData()[0].getLabel();

if(cx!=bE){this.setFontFamily(cx);
cz.setSelection([cz.getChildren()[0]]);
}},this.__Nk);
return cz;
},__Ns:function(){var c=new qx.ui.form.SelectBox;
c.set({toolTipText:bj,focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});
c.add(new qx.ui.form.ListItem(bE));
var b;

for(var i=1;i<=7;i++){b=new qx.ui.form.ListItem(i+bE);
b.set({focusable:false,keepFocus:true});
c.add(b);
}c.addListener(bB,function(e){var cc=e.getData()[0].getLabel();

if(cc!=bE){this.setFontSize(cc);
c.setSelection([c.getChildren()[0]]);
}},this.__Nk);
return c;
},__Nt:function(){return [{bold:{text:bV,image:s,action:this.__Nk.setBold},italic:{text:bd,image:ba,action:this.__Nk.setItalic},underline:{text:A,image:bc,action:this.__Nk.setUnderline},strikethrough:{text:B,image:bY,action:this.__Nk.setStrikeThrough},removeFormat:{text:L,image:bS,action:this.__Nk.removeFormat}},{alignLeft:{text:q,image:w,action:this.__Nk.setJustifyLeft},alignCenter:{text:R,image:bo,action:this.__Nk.setJustifyCenter},alignRight:{text:be,image:t,action:this.__Nk.setJustifyRight},alignJustify:{text:bn,image:E,action:this.__Nk.setJustifyFull}},{fontFamily:{custom:this.__Nr},fontSize:{custom:this.__Ns},fontColor:{text:h,image:n,action:this.__Nl},textBackgroundColor:{text:bm,image:bq,action:this.__Nm}},{indent:{text:bh,image:bx,action:this.__Nk.insertIndent},outdent:{text:C,image:W,action:this.__Nk.insertOutdent}},{insertImage:{text:u,image:J,action:this.__Nn},insertTable:{text:k,image:o,action:this.__No},insertLink:{text:d,image:H,action:this.__Np},insertHTML:{text:G,image:bp,action:this.__Nq},insertHR:{text:bs,image:br,action:this.__Nk.insertHorizontalRuler}},{ol:{text:x,image:bK,action:this.__Nk.insertOrderedList},ul:{text:bf,image:bu,action:this.__Nk.insertUnorderedList}},{undo:{text:bP,image:p,action:this.__Nk.undo},redo:{text:bW,image:S,action:this.__Nk.redo}}];
},__Nu:function(){var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setDecorator(bX);
var cs;
var ct=this.__Nt();

for(var i=0,j=ct.length;i<j;i++){var cu=new qx.ui.toolbar.Part;
toolbar.add(cu);

for(var cv in ct[i]){var cw=ct[i][cv];

if(cw.custom){cs=cw.custom.call(this);
}else{cs=new qx.ui.toolbar.Button(null,cw.image);
cs.set({focusable:false,keepFocus:true,center:true,toolTipText:cw.text?cw.text:bE});
cs.addListener(bD,cw.action,this.__Nk);
}cu.add(cs);
}}return toolbar;
}}});
})();
