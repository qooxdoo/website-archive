...
(function(){var u="0",t="white",s="main",r="execute",q="Button A",p="#AAA",o="icon/22/actions/list-add.png",n="Button B",m="demobrowser.demo.widget.Button",l="icon/22/apps/internet-web-browser.png",i="Hover",k="icon/22/apps/media-video-player.png",j="icon/22/apps/internet-mail.png",h="changeValue",g="Toggle Button";
...
},addNormalButtons:function(v){var w=new qx.ui.form.Button(q,k);
v.add(w);
var x=new qx.ui.form.Button(n,j);
x.setEnabled(false);
v.add(x);
},addToggleButton:function(d){var f=new qx.ui.form.ToggleButton(g,l);
f.focus();
d.add(f);
f.addListener(h,function(e){this.debug("Checked: "+e.getData());
},this);
},addRepeatButton:function(B){var C=new qx.ui.form.RepeatButton(null,o);
B.add(C);
var D=new qx.ui.basic.Label(u);
D.setDecorator(s);
D.setPadding(2,4);
D.setBackgroundColor(t);
B.add(D);
C.addListener(r,function(){var E=parseInt(D.getValue())+1;
D.setValue(E.toString());
});
},addHoverButton:function(y){var z=new qx.ui.form.HoverButton(i).set({padding:10,backgroundColor:p});
y.add(z);
var A=new qx.ui.basic.Label(u);
A.setDecorator(s);
A.setPadding(2,4);
A.setBackgroundColor(t);
y.add(A);
z.addListener(r,function(){var c=parseInt(A.getValue())+1;
A.setValue(c.toString());
});
}}});
})();
