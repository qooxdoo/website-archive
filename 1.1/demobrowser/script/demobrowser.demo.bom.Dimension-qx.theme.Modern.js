...
(function(){var k="x",j="Block ",h="demobrowser.demo.bom.Dimension",g="block",f=": Box=",e="; Content=";
qx.Class.define(h,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);

for(var i=1;i<1000;i++){var a=document.getElementById(g+i);

if(!a){break;
}var d=j+i+f+b(a)+e+c(a);
this.debug(d);
}function b(l){var m=qx.bom.element.Dimension;
return m.getWidth(l)+k+m.getHeight(l);
}function c(n){var o=qx.bom.element.Dimension;
return o.getContentWidth(n)+k+o.getContentHeight(n);
}}}});
})();
