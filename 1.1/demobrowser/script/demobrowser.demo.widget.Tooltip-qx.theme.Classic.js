...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Tooltip","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Tooltip-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"af48f7f2205e"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var p="icon/16/actions/help-about.png",o="Tooltip text",n="icon/32/actions/help-about.png",m="Button #2 (Shared ToolTip)",l="Short timeout ToolTip",k="demobrowser.demo.widget.Tooltip",j="Hello World #3",i="Button with ToolTipText and ToolTipIcon",h="ToolTip with icon and label",g="Shared tool tip of button #",D="ToolTip with icon and rich text",C="Such a great tooltip with a (show) timeout of 50ms.",B="Icon only ToolTip",A="Button #1 (Shared ToolTip)",z="container",y="This also may contain <b style='color:red'>rich HTML</b> markup ",x="appear",w="2",v="Shared ToolTip",u="1",s="Button with ToolTipText",t="A long label text with auto-wrapping. ",q="Button with ToolTipIcon",r="and with a (show) timeout of 50ms.";
...
var N=new qx.ui.layout.Grid(10,10);
this.container=new qx.ui.container.Composite(N).set({padding:20});
O.add(this.container);
...
},__MT:4,__MU:0,add:function(I){this.container.add(I,{row:Math.floor(this.__MU/this.__MT),column:this.__MU%this.__MT});
this.__MU+=1;
},createSharedToolTip:function(){var G=new qx.ui.tooltip.ToolTip(v);
G.addListener(x,function(e){var f=g;

if(this.getOpener()==F){f+=u;
}else{f+=w;
}G.setLabel(f);
});
...
F.setToolTip(G);
this.add(F);
var E=new qx.ui.form.Button(m);
E.setToolTip(G);
this.add(E);
},createIconToolTip:function(){var J=new qx.ui.form.Button(B).set({toolTip:new qx.ui.tooltip.ToolTip(null,p)});
this.add(J);
},createToolTip:function(){var d=new qx.ui.form.Button(h).set({toolTip:new qx.ui.tooltip.ToolTip(j,p)});
this.add(d);
},createShortTimeoutToolTip:function(){var c=new qx.ui.tooltip.ToolTip(C,n);
c.setShowTimeout(50);
var b=new qx.ui.form.Button(l);
this.add(b);
b.setToolTip(c);
},createRichToolTip:function(){var M=new qx.ui.tooltip.ToolTip(t+y+r,n);
M.setWidth(200);
M.setRich(true);
M.setShowTimeout(50);
...
this.add(L);
L.setToolTip(M);
},createToolTipText:function(){var a=new qx.ui.form.Button(s).set({toolTipText:o});
this.add(a);
},createToolTipIcon:function(){var H=new qx.ui.form.Button(q).set({toolTipIcon:p});
this.add(H);
},createToolTipTextIcon:function(){var K=new qx.ui.form.Button(i).set({toolTipText:o,toolTipIcon:p});
this.add(K);
