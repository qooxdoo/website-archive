...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.ColorPopup","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.ColorPopup-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"79bbaecb7a52"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var l="Selected Color",k="changeGreen",j="Open Popup",i="changeBlue",h="en",g="changeValue",f="changeRed",d="main",c="#23F3C1",b="demobrowser.demo.widget.ColorPopup",a="execute";
...
var o=new qx.ui.control.ColorPopup();
o.exclude();
o.setValue(c);
var p=new qx.ui.form.Button(j);
p.addListener(a,function(e){o.placeToWidget(p);
o.show();
});
var n=new qx.ui.basic.Label(l).set({marginLeft:10,padding:[3,6],decorator:d});
m.add(n,{left:100,top:20});
m.add(p,{left:20,top:20});
m.add(o,{left:100,top:100});
o.addListener(g,function(e){this.debug("Value Listener: "+e.getData());
n.setBackgroundColor(e.getData());
});
o.addListener(f,function(e){this.debug("Red Listener: "+e.getData());
});
o.addListener(k,function(e){this.debug("Green Listener: "+e.getData());
});
o.addListener(i,function(e){this.debug("Blue Listener: "+e.getData());
});
}}});
})();
