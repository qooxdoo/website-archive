...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.Spacer_HBox-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"75d3970ba65a"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
},getSpacerWithoutFlex:function(){var l=new qx.ui.container.Composite().set({decorator:g,backgroundColor:e,allowGrowX:false});
var m=new qx.ui.layout.HBox();
m.setSpacing(5);
l.setLayout(m);
l.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}));
l.add(new qx.ui.core.Spacer(30,40));
l.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}));
l.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}));
return l;
},getSpacerWithFlex:function(){var n=new qx.ui.container.Composite().set({decorator:g,backgroundColor:e,height:100,width:400});
var o=new qx.ui.layout.HBox();
o.setSpacing(5);
n.setLayout(o);
n.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:d}));
n.add(new qx.ui.core.Spacer(30,40),{flex:1});
n.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:b}));
n.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:c}));
return n;
},getAddRemoveSpacer:function(){var i=new qx.ui.container.Composite().set({decorator:g,backgroundColor:e});
var k=new qx.ui.layout.HBox();
k.setSpacing(5);
i.setLayout(k);
i.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:d}));
i.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:b}));
var j=new qx.ui.core.Spacer(30,40);
i.add(j,{flex:1});
i.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:c}));
i.remove(j);
return i;
}}});
})();
