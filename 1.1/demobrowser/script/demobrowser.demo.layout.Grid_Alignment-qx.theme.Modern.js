...
(function(){var q="main",p="yellow",o="bottom",n="top",m="left",l="right",k="center",j="middle",h="orange",g="gray",e="green",f="demobrowser.demo.layout.Grid_Alignment";
...
},getNewWidget:function(){var v=new qx.ui.core.Widget().set({decorator:q,backgroundColor:e,allowGrowX:false,allowGrowY:false,height:Math.round((Math.random()*30)+30),width:Math.round((Math.random()*30)+30)});
return v;
},getColumnAlignGrid:function(){var r=new qx.ui.container.Composite().set({decorator:q,backgroundColor:p,allowGrowX:false,allowGrowY:false});
var s=new qx.ui.layout.Grid();
s.setSpacing(3);
s.setColumnAlign(0,m,n);
s.setColumnAlign(1,k,j);
s.setColumnAlign(2,l,o);
r.setLayout(s);

for(var x=0;x<3;x++){for(var y=0;y<6;y++){r.add(this.getNewWidget(),{row:y,column:x});
}}return r;
},getRowAlignGrid:function(){var t=new qx.ui.container.Composite().set({decorator:q,backgroundColor:p,allowGrowX:false,allowGrowY:false});
...
for(var x=0;x<6;x++){for(var y=0;y<3;y++){t.add(this.getNewWidget(),{row:y,column:x});
}}return t;
},getCellAlignGrid:function(){var w=new qx.ui.container.Composite().set({decorator:q,backgroundColor:p,allowGrowX:false,allowGrowY:false});
var A=new qx.ui.layout.Grid();
A.setSpacing(3);
w.setLayout(A);

for(var x=0;x<5;x++){A.setColumnAlign(x,k,j);

for(var y=0;y<5;y++){w.add(this.getNewWidget(),{row:y,column:x});
}}var z=A.getCellWidget(0,0);
z.set({alignX:m,alignY:n});
z.set({backgroundColor:h,width:20,height:20});
var z=A.getCellWidget(4,4);
z.set({alignX:l,alignY:o});
z.set({backgroundColor:h,width:20,height:20});
return w;
},getRowColumnAlignGrid:function(){var b=new qx.ui.container.Composite().set({decorator:q,backgroundColor:p,allowGrowX:false,allowGrowY:false});
var d=new qx.ui.layout.Grid();
d.setSpacing(3);
b.setLayout(d);

for(var x=0;x<5;x++){for(var y=0;y<5;y++){b.add(this.getNewWidget(),{row:y,column:x});
}}d.setColumnAlign(2,m,n);
d.setRowAlign(2,l,o);

for(var i=0;i<5;i++){d.getCellWidget(2,i).setBackgroundColor(g);
d.getCellWidget(i,2).setBackgroundColor(g);
}var c=d.getCellWidget(2,2);
c.set({backgroundColor:h,width:20,height:20});
return b;
}}});
})();
