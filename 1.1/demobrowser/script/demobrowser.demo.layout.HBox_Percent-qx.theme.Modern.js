...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.HBox_Percent","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.HBox_Percent-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"cd4b23c34115"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var r="main",q="green",p="33%",o="yellow",n="50%",m="demobrowser.demo.layout.HBox_Percent";
qx.Class.define(m,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);
...
E.add(this.getBox5());
E.add(this.getBox6());
},getBox1:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:r,backgroundColor:o,width:500,allowGrowX:false});
var l=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
var k=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
var i=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
j.add(l,{width:n});
j.add(k,{flex:1});
j.add(i,{flex:1});
return j;
},getBox2:function(){var t=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:r,backgroundColor:o,width:500,allowGrowX:false});
var v=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
var u=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
var s=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
t.add(v,{width:p});
t.add(u,{width:p});
t.add(s,{width:p,flex:1});
return t;
},getBox3:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:r,backgroundColor:o,allowGrowX:false});
var d=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
var c=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
var a=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
b.add(d,{width:n});
b.add(c,{flex:1});
b.add(a,{flex:1});
return b;
},getBox4:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:r,backgroundColor:o,allowGrowX:false});
var h=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
var g=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
var e=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
f.add(h,{width:p,flex:1});
f.add(g,{width:p,flex:1});
f.add(e,{width:p,flex:1});
return f;
},getBox5:function(){var B=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:r,backgroundColor:o,width:200,allowGrowX:false});
var D=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
var C=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
var A=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
B.add(D,{width:p,flex:1});
B.add(C,{width:p,flex:1});
B.add(A,{width:p,flex:1});
return B;
},getBox6:function(){var x=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:r,backgroundColor:o,width:500,allowGrowX:false});
var z=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
var y=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
var w=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q});
x.add(z,{width:p,flex:1});
x.add(y,{width:p,flex:1});
x.add(w,{width:p,flex:1});
return x;
}}});
})();
