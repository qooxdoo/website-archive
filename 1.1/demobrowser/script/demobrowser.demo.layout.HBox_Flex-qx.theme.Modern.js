...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.HBox_Flex","qx.theme":"qx.theme.Modern"};
...
(function(){var l="main",k="green",j="yellow",h="demobrowser.demo.layout.HBox_Flex";
...
g.add(this.getBox5());
g.add(this.getBox6());
},getBox1:function(){var c=new qx.ui.layout.HBox();
var d=new qx.ui.container.Composite(c).set({width:500,decorator:l,backgroundColor:j,allowGrowX:false});
c.setSpacing(5);
d.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k}),{flex:1});
d.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k}),{flex:2});
d.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k}),{flex:3});
return d;
},getBox2:function(){var r=new qx.ui.layout.HBox();
var s=new qx.ui.container.Composite(r).set({width:500,decorator:l,backgroundColor:j,allowGrowX:false});
r.setSpacing(5);
s.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,maxWidth:30}),{flex:1});
s.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k}),{flex:2});
s.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,maxWidth:150}),{flex:3});
return s;
},getBox3:function(){var m=new qx.ui.layout.HBox();
var o=new qx.ui.container.Composite(m).set({width:500,decorator:l,backgroundColor:j,allowGrowX:false});
m.setSpacing(5);

for(var i=0;i<25;i++){var n=new qx.ui.core.Widget();
n.set({decorator:l,backgroundColor:k,width:5});
o.add(n,{flex:1});
}return o;
},getBox4:function(){var a=new qx.ui.layout.HBox();
var b=new qx.ui.container.Composite(a).set({width:600,minWidth:600,decorator:l,backgroundColor:j,allowGrowX:false});
a.setSpacing(5);
b.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,maxWidth:120}),{flex:1});
b.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,maxWidth:120}),{flex:2});
b.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,maxWidth:120}),{flex:3});
return b;
},getBox5:function(){var e=new qx.ui.layout.HBox();
var f=new qx.ui.container.Composite(e).set({width:300,minWidth:0,decorator:l,backgroundColor:j,allowGrowX:false});
e.setSpacing(5);
f.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,minWidth:120}),{flex:1});
f.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,minWidth:120}),{flex:2});
f.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,minWidth:120}),{flex:3});
return f;
},getBox6:function(){var p=new qx.ui.layout.HBox();
var q=new qx.ui.container.Composite(p).set({width:300,decorator:l,backgroundColor:j,allowGrowX:false});
p.setSpacing(5);
q.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,minWidth:120}),{flex:1});
q.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,minWidth:120}),{flex:2});
q.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,minWidth:120}),{flex:3});
return q;
}}});
})();
