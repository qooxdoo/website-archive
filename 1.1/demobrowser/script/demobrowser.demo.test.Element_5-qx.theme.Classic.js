...
(function(){var z="left",y="float",x="2px",w="row",v="12px",u="id",t="backgroundColor",s="col",r="fontSize",q="width",h="red",p="height",m="marginBottom",g="1px",f="demobrowser.demo.test.Element_5",l="marginRight",k="clear",n="test",e="2px solid black",o="border";
qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
var a=new qx.html.Root(document.getElementById(n));
...
for(var i=0;i<40;i++){d=new qx.html.Element;
d.setAttribute(u,w+i);
d.setStyle(m,x);
d.setStyle(y,z);
d.setStyle(k,z);
b.add(d);

for(var j=0;j<40;j++){c=new qx.html.Element;
c.setAttribute(u,w+i+s+j);
c.setStyle(l,x);
c.setStyle(y,z);
c.setStyle(q,v);
c.setStyle(p,v);
