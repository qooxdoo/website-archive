...
(function(){var s="execute",r="- Use the cursors keys to move the selection.",q="- Double-click or enter/space-key will fire an execute event.",p="bold",o="- Page-keys / shift + page-keys switch months/years.",n="Description",m="select a date",l="Show January 1981",k="Set current date",j="Execute: ",d="Change: ",i="center",h="en",c="changeValue",b="demobrowser.demo.widget.DateChooser",g="Remove the selection",f="- Escape will remove the selection.";
...
B.add(C);
w.addListener(c,function(e){C.setValue(d+e.getData());
},this);
