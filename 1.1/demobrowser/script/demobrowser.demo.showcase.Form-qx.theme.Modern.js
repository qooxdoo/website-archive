...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.showcase.Form","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.showcase.Form-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"7d9cdc244f47"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var l="placeholder",k="Button",j="CheckBox:",h="TextArea:",g="Boolean",f="RepeatButton:",e="execute",d="Website 2",c="Text",b="ToggleButton",T="password",S="RadioButton 3",R="Button:",Q="ComboBox:",P="ToggleButton:",O="Options",N="RadioButton",M="0",L="MenuButton:",K="demobrowser.demo.showcase.Form",s="PasswordField:",t="SplitButton",q="Buttons",r="",o="RadioButtons:",p="dd.mm.YYYY",m="List:",n="SplitButton:",u="Option",v="RadioButton 1",C="Spinner:",A="Selection",E="DateField:",D="RadioButton 2",G="Number",F="CheckBox",x="SelectBox:",J="Website 3",I="MenuButton",H="Website 1",w="Slider:",y="TextField:",z="Item ",B="RadioButtonGroup:";
qx.Class.define(K,{extend:qx.application.Standalone,statics:{ITEM_SIZE:5},members:{main:function(){qx.application.Standalone.prototype.main.call(this);
var U=new qx.ui.groupbox.GroupBox(c);
U.setLayout(new qx.ui.layout.Grid(8,8));
U.setWidth(290);
this.getRoot().add(U,{left:20,top:10});
var br=new qx.ui.form.TextField();
br.setPlaceholder(l);
var bd=new qx.ui.basic.Label(y);
bd.setBuddy(br);
U.add(bd,{row:0,column:0});
U.add(br,{row:0,column:1});
var bb=new qx.ui.form.PasswordField();
bb.setPlaceholder(T);
bd=new qx.ui.basic.Label(s);
bd.setBuddy(bb);
U.add(bd,{row:1,column:0});
U.add(bb,{row:1,column:1});
var V=new qx.ui.form.TextArea();
V.setPlaceholder(l);
bd=new qx.ui.basic.Label(h);
bd.setBuddy(V);
U.add(bd,{row:2,column:0});
U.add(V,{row:2,column:1});
var W=new qx.ui.form.ComboBox();
W.setPlaceholder(l);
bd=new qx.ui.basic.Label(Q);
bd.setBuddy(W);
U.add(bd,{row:3,column:0});
U.add(W,{row:3,column:1});
this.createItems(W);
var bk=new qx.ui.form.DateField();
bk.setPlaceholder(p);
bd=new qx.ui.basic.Label(E);
bd.setBuddy(bk);
U.add(bd,{row:4,column:0});
U.add(bk,{row:4,column:1});
var bc=new qx.ui.groupbox.GroupBox(A);
bc.setLayout(new qx.ui.layout.Grid(8,8));
bc.setWidth(290);
this.getRoot().add(bc,{left:20,top:250});
var bl=new qx.ui.form.SelectBox();
bd=new qx.ui.basic.Label(x);
bd.setBuddy(bl);
bc.add(bd,{row:0,column:0});
bc.add(bl,{row:0,column:1});
this.createItems(bl);
var bq=new qx.ui.form.List();
bq.setHeight(60);
bq.setWidth(155);
bd=new qx.ui.basic.Label(m);
bd.setBuddy(bq);
bc.add(bd,{row:1,column:0});
bc.add(bq,{row:1,column:1});
this.createItems(bq);
var bj=new qx.ui.form.RadioButtonGroup();
bj.add(new qx.ui.form.RadioButton(v));
bj.add(new qx.ui.form.RadioButton(D));
bj.add(new qx.ui.form.RadioButton(S));
bd=new qx.ui.basic.Label(B);
bd.setBuddy(bj);
bc.add(bd,{row:2,column:0});
bc.add(bj,{row:2,column:1});
var bo=new qx.ui.groupbox.GroupBox(q);
bo.setLayout(new qx.ui.layout.Grid(8,8));
bo.setWidth(210);
this.getRoot().add(bo,{left:330,top:10});
var bp=new qx.ui.form.Button(k);
bd=new qx.ui.basic.Label(R);
bd.setBuddy(bp);
bo.add(bd,{row:0,column:0});
bo.add(bp,{row:0,column:1});
var Y=new qx.ui.form.ToggleButton(b);
bd=new qx.ui.basic.Label(P);
bd.setBuddy(Y);
bo.add(bd,{row:1,column:0});
bo.add(Y,{row:1,column:1});
var bg=new qx.ui.form.RepeatButton(M);
bd=new qx.ui.basic.Label(f);
bd.setBuddy(bg);
bo.add(bd,{row:2,column:0});
bo.add(bg,{row:2,column:1});
var bh=new qx.ui.form.MenuButton(I,null,this.createMenuForMenuButton());
bd=new qx.ui.basic.Label(L);
bd.setBuddy(bh);
bo.add(bd,{row:3,column:0});
bo.add(bh,{row:3,column:1});
var ba=new qx.ui.form.SplitButton(t,null,this.createMenuForSplitButton());
bd=new qx.ui.basic.Label(n);
bd.setBuddy(ba);
bo.add(bd,{row:4,column:0});
bo.add(ba,{row:4,column:1});
bg.addListener(e,function(){var a=parseInt(bg.getLabel())+1;
bg.setLabel(a.toString());
});
var X=new qx.ui.groupbox.GroupBox(g);
X.setLayout(new qx.ui.layout.Grid(8,8));
X.setWidth(210);
this.getRoot().add(X,{left:330,top:210});
var bm=new qx.ui.form.CheckBox(F);
bd=new qx.ui.basic.Label(j);
bd.setBuddy(bm);
X.add(bd,{row:0,column:0});
X.add(bm,{row:0,column:1});
var bf=new qx.ui.form.RadioButton(N);
X.add(new qx.ui.basic.Label(o),{row:1,column:0});
X.add(bf,{row:1,column:1});
var bn=new qx.ui.groupbox.GroupBox(G);
bn.setLayout(new qx.ui.layout.Grid(8,8));
bn.setWidth(210);
this.getRoot().add(bn,{left:330,top:310});
var be=new qx.ui.form.Spinner(0,50,100);
bd=new qx.ui.basic.Label(C);
bd.setBuddy(be);
bn.add(bd,{row:0,column:0});
bn.add(be,{row:0,column:1});
var bi=new qx.ui.form.Slider();
bi.setWidth(130);
bd=new qx.ui.basic.Label(w);
bd.setBuddy(bi);
bn.add(bd,{row:1,column:0});
bn.add(bi,{row:1,column:1});
},createItems:function(bB){for(var i=0;i<this.self(arguments).ITEM_SIZE;i++){var bC=new qx.ui.form.ListItem(z+i);
bB.add(bC);
}},createMenuForMenuButton:function(){var bw=new qx.ui.menu.Menu;

for(var i=0;i<3;i++){bw.add(new qx.ui.menu.RadioButton(u+i));
}var bz=new qx.ui.form.RadioGroup;
bz.add.apply(bz,bw.getChildren());
var by=new qx.ui.menu.Menu();

for(var i=0;i<3;i++){var bA=new qx.ui.menu.Button(k+i);
by.add(bA);
}var bx=new qx.ui.menu.Button(O,r,null,bw);
by.addSeparator();
by.add(bx);
return by;
},createMenuForSplitButton:function(){var bs=new qx.ui.menu.Menu;
var bv=new qx.ui.menu.Button(H);
var bt=new qx.ui.menu.Button(d);
var bu=new qx.ui.menu.Button(J);
bs.add(bv);
bs.add(bt);
bs.add(bu);
return bs;
...
(function(){var u="Boolean",t="changeSelection",s="__wt",r="_applyValid",q="",p="changeRequired",o="changeValid",n="changeInvalidMessage",m="_applyInvalidMessage",l="String",j="qx.ui.form.RadioButtonGroup",k="qx.event.type.Data";
qx.Class.define(j,{extend:qx.ui.core.Widget,include:[qx.ui.core.MLayoutHandling,qx.ui.form.MModelSelection],implement:[qx.ui.form.IForm,qx.ui.core.ISingleSelection,qx.ui.form.IModelSelection],construct:function(y){qx.ui.core.Widget.call(this);
if(y==null){this.setLayout(new qx.ui.layout.VBox(4));
}else{this.setLayout(y);
}this.__wt=new qx.ui.form.RadioGroup();
this.__wt.addListener(t,function(e){this.fireDataEvent(t,e.getData(),e.getOldData());
},this);
},properties:{valid:{check:u,init:true,apply:r,event:o},required:{check:u,init:false,event:p},invalidMessage:{check:l,init:q,event:n,apply:m}},events:{"changeSelection":k},members:{__wt:null,_applyInvalidMessage:function(f,g){var h=this._getChildren();

for(var i=0;i<h.length;i++){h[i].setInvalidMessage(f);
}},_applyValid:function(a,b){var c=this._getChildren();

for(var i=0;i<c.length;i++){c[i].setValid(a);
}},getRadioGroup:function(){return this.__wt;
},getChildren:function(){return this._getChildren();
},add:function(v,w){this.__wt.add(v);
this._add(v,w);
},remove:function(z){this.__wt.remove(z);
this._remove(z);
},removeAll:function(){var x=this.__wt.getItems();

for(var i=0;i<x.length;i++){this.__wt.remove(x[i]);
}this._removeAll();
},getSelection:function(){return this.__wt.getSelection();
},setSelection:function(d){return this.__wt.setSelection(d);
},resetSelection:function(){return this.__wt.resetSelection();
},isSelected:function(A){return this.__wt.isSelected(A);
},isSelectionEmpty:function(){return this.__wt.isSelectionEmpty();
},getSelectables:function(){return this.__wt.getSelectables();
...
},properties:{group:{check:f,nullable:true,apply:d},value:{check:m,nullable:true,event:j,apply:k,init:false},appearance:{refine:true,init:h},allowGrowX:{refine:true,init:false}},members:{_applyValue:function(t,u){t?this.addState(o):this.removeState(o);

if(t&&this.getFocusable()){this.focus();
}},_applyGroup:function(q,r){if(r){r.remove(this);
}
if(q){q.add(this);
