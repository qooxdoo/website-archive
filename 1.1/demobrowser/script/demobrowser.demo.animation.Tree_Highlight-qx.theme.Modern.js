...
(function(){var be="execute",bd="appear",bc="changeSelection",bb="Trash",ba="mode",Y="Windows (C:)",X="Documents (D:)",W="Add before",V="Add after",U="Add at begin",bE="Inbox",bD="Desktop",bC="Show open button:",bB="New tree item name: ",bA="auto",bz="Hello",by="Presets",bx="Data 123213234325345234523453453245",bw="demobrowser.demo.animation.Tree_Highlight",bv="Network",bl="Control",bm="Sent",bj="Files",bk="Remove tree item",bh="Add file",bi="Workspace",bf="Junk #",bg="Tree",bn="never",bo="Add folder",bq="Root",bp="always",bs="Move to parent",br="Reset tree",bu="Edit",bt="Remove all children";
...
var R=new qx.ui.groupbox.GroupBox(bg).set({contentPadding:[4,4,4,4]});
...
},getTree:function(){var q=new qx.ui.tree.Tree().set({width:200,height:400});
var v=new qx.ui.tree.TreeFolder(bq);
v.setOpen(true);
q.setRoot(v);
var t=new qx.ui.tree.TreeFolder(bD);
t.setOpen(true);
v.add(t);
var l=new qx.ui.tree.TreeFolder(bj);
var j=new qx.ui.tree.TreeFolder(bi);
var k=new qx.ui.tree.TreeFolder(bv);
var h=new qx.ui.tree.TreeFolder(bb);
t.add(l,j,k,h);
var r=new qx.ui.tree.TreeFile(Y);
var g=new qx.ui.tree.TreeFile(X);
j.add(r,g);
var u=new qx.ui.tree.TreeFolder(bE);
var m=new qx.ui.tree.TreeFolder(by);
var p=new qx.ui.tree.TreeFolder(bm);
var o=new qx.ui.tree.TreeFolder(bb);

for(var i=0;i<100;i++){o.add(new qx.ui.tree.TreeFile(bf+i));
}var s=new qx.ui.tree.TreeFolder(bx);
var n=new qx.ui.tree.TreeFolder(bu);
u.add(m,p,o,s,n);
v.add(u);
return q;
},getCommandFrame:function(){var I=new qx.ui.groupbox.GroupBox(bl);
I.setLayout(new qx.ui.layout.Grid(3,5));
var K=0;
I.add(new qx.ui.basic.Label(bB).set({paddingTop:4}),{row:K,column:0});
this.inputItemName=new qx.ui.form.TextField(bz);
I.add(this.inputItemName,{row:K++,column:1});
this.btnAddFolder=new qx.ui.form.Button(bo);
this.btnAddFolder.addListener(be,this._addFolder,this);
I.add(this.btnAddFolder,{row:K++,column:0,colSpan:2});
this.btnAddFile=new qx.ui.form.Button(bh);
this.btnAddFile.addListener(be,this._addFile,this);
I.add(this.btnAddFile,{row:K++,column:0,colSpan:2});
this.btnAddAfter=new qx.ui.form.Button(V);
this.btnAddAfter.addListener(be,this._addAfter,this);
I.add(this.btnAddAfter,{row:K++,column:0,colSpan:2});
this.btnAddBefore=new qx.ui.form.Button(W);
this.btnAddBefore.addListener(be,this._addBefore,this);
I.add(this.btnAddBefore,{row:K++,column:0,colSpan:2});
this.btnAddBegin=new qx.ui.form.Button(U);
this.btnAddBegin.addListener(be,this._addBegin,this);
I.add(this.btnAddBegin,{row:K++,column:0,colSpan:2});
I.add(new qx.ui.core.Spacer(5,5),{row:K++,column:0});
this.btnRemove=new qx.ui.form.Button(bk);
this.btnRemove.addListener(be,this._removeTreeItem,this);
I.add(this.btnRemove,{row:K++,column:0,colSpan:2});
this.btnRemoveAll=new qx.ui.form.Button(bt);
this.btnRemoveAll.addListener(be,this._removeAll,this);
I.add(this.btnRemoveAll,{row:K++,column:0,colSpan:2});
I.add(new qx.ui.core.Spacer(5,5),{row:K++,column:0});
this.btnMoveToParent=new qx.ui.form.Button(bs);
this.btnMoveToParent.addListener(be,this._moveToParent,this);
I.add(this.btnMoveToParent,{row:K++,column:0,colSpan:2});
I.add(new qx.ui.core.Spacer(5,5),{row:K++,column:0});
I.add(new qx.ui.basic.Label(bC),{row:K,column:0});
var G=[bp,bn,bA];
this.showOpenButtons={};
this.mgrShowRootOpen=new qx.ui.form.RadioGroup();

for(var i=0;i<G.length;i++){var J=G[i];
var H=new qx.ui.form.RadioButton(J).set({value:J==this._tree.getRootOpenClose()});
H.setUserData(ba,J);
this.showOpenButtons[J]=H;
this.mgrShowRootOpen.add(H);
I.add(H,{row:K++,column:1});
}this.mgrShowRootOpen.addListener(bc,this._onChangeShowOpen,this);
I.add(new qx.ui.core.Spacer(5,5),{row:K++,column:0});
this.btnReset=new qx.ui.form.Button(br);
this.btnReset.addListener(be,this._resetTree,this);
I.add(this.btnReset,{row:K++,column:0,colSpan:2});
this._tree.addListener(bc,this._updateControls,this);
this._updateControls();
return I;
},_addFolder:function(){var y=this._tree.getSelection()[0];
var z=new qx.ui.tree.TreeFolder(this.inputItemName.getValue());
z.addListenerOnce(bd,function(){var T=new qx.fx.effect.core.Highlight(z.getContainerElement().getDomElement());
T.start();
},this);
y.setOpen(true);
y.add(z);
},_addFile:function(){var c=this._tree.getSelection()[0];
var d=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
d.addListenerOnce(bd,function(){var bF=new qx.fx.effect.core.Highlight(d.getContainerElement().getDomElement());
bF.start();
},this);
c.setOpen(true);
c.add(d);
...
E.addListenerOnce(bd,function(){var b=new qx.fx.effect.core.Highlight(E.getContainerElement().getDomElement());
b.start();
},this);
D.getParent().addBefore(E,D);
},_addAfter:function(){var A=this._tree.getSelection()[0];
var B=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
B.addListenerOnce(bd,function(){var e=new qx.fx.effect.core.Highlight(B.getContainerElement().getDomElement());
e.start();
},this);
A.getParent().addAfter(B,A);
},_addBegin:function(){var L=this._tree.getSelection()[0];
var M=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
M.addListenerOnce(bd,function(){var a=new qx.fx.effect.core.Highlight(M.getContainerElement().getDomElement());
a.start();
},this);
L.getParent().addAtBegin(M);
},_removeTreeItem:function(){var C=this._tree.getSelection()[0];
var parent=C.getParent();
parent.remove(C);
},_removeAll:function(){var F=this._tree.getSelection()[0];
F.removeAll();
},_moveToParent:function(){var f=this._tree.getSelection()[0];
var parent=f.getParent();
parent.remove(f);
parent.getParent().add(f);
this._updateControls();
},_onChangeShowOpen:function(){var w=this._tree.getSelection()[0];

if(w!=null){var x=this.mgrShowRootOpen.getSelection()[0].getUserData(ba);
w.setOpenSymbolMode(x);
}},_resetTree:function(){this._treeGroup.remove(this._tree);
this._tree=this.getTree();
this._treeGroup.add(this._tree,{edge:0});
this._tree.addListenerOnce(bd,function(){this._tree.addListener(bc,this._updateControls,this);
},this);
