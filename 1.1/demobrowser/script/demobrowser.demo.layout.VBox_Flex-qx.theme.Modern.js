...
(function(){var g="main",f="green",e="yellow",d="demobrowser.demo.layout.VBox_Flex";
...
l.add(this.getBox5());
l.add(this.getBox6());
},getBox1:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:g,backgroundColor:e,height:300,allowGrowY:false});
b.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}),{flex:1});
b.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}),{flex:2});
b.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}),{flex:3});
return b;
},getBox2:function(){var c=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:g,backgroundColor:e,height:300,allowGrowY:false});
c.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:30}),{flex:1});
c.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}),{flex:2});
c.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:100}),{flex:3});
return c;
},getBox3:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:g,backgroundColor:e,height:300,allowGrowY:false});

for(var i=0;i<25;i++){k.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,height:5}),{flex:1});
}return k;
},getBox4:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:g,backgroundColor:e,height:300,minHeight:300,allowGrowY:false});
j.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:60}),{flex:1});
j.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:60}),{flex:2});
j.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:60}),{flex:3});
return j;
},getBox5:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,minHeight:0,decorator:g,backgroundColor:e,allowGrowY:false});
h.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,minHeight:60}),{flex:1});
h.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,minHeight:60}),{flex:2});
h.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,minHeight:60}),{flex:3});
return h;
},getBox6:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,decorator:g,backgroundColor:e,allowGrowY:false});
a.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,minHeight:60}),{flex:1});
a.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,minHeight:60}),{flex:2});
a.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,minHeight:60}),{flex:3});
return a;
}}});
})();
