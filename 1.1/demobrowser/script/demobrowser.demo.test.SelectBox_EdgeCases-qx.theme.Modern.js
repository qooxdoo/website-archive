...
for(var i=0;i<300;i++){var y=new qx.ui.form.ListItem(l+i);
x.add(y);
...
var q=new qx.bom.Font(12,[g]);
var r=new qx.bom.Font(15,[c]);
var p=new qx.bom.Font(18,[f]);
var t=new qx.bom.Font(21,[o]);
var s=[q,r,p,t];

for(var i=0;i<s.length;i++){var u=new qx.ui.form.ListItem(h+(i+1));
u.setFont(s[i]);
v.add(u);
