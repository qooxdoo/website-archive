...
this.__Nv(p);
},_onContextMenu:function(e){var a=i+e.getRow()+n+e.getColumn()+o;
this.__Nv(a);
},_onDblclickPane:function(e){var s=h+e.getRow()+n+e.getColumn()+o;
this.__Nv(s);
},__Nv:function(t){this.logger.setHtml(this.logger.getHtml()+t);
