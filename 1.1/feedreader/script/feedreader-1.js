...
(function(){var G="language",F="execute",E="icon/16/apps/preferences-locale.png",D="Français",C="icon/16/apps/preferences-theme.png",B="feedreader.view.PreferenceWindow",A="English",z="Nederlands",y="Italiano",x="Language",r="icon/16/actions/dialog-cancel.png",w="icon/16/actions/dialog-ok.png",u="Svenska",q="Preferences",p="Cancel",t="right",s="Deutsch",v="OK",o="Espanol";
qx.Class.define(B,{extend:qx.ui.window.Window,construct:function(){qx.ui.window.Window.call(this,this.tr(q),C);
this.set({modal:true,showMinimize:false,showMaximize:false,allowMaximize:false});
this._addContent();
},members:{_addContent:function(){var h,i;
var f=new qx.ui.layout.VBox(10);
this.setLayout(f);
this.setMinWidth(350);
var l=new qx.ui.groupbox.GroupBox(this.tr(x),E);
l.setMinWidth(150);
l.setLayout(new qx.ui.layout.VBox());
this.add(l);
var n=new qx.ui.form.RadioGroup();
var j={"en":A,"de":s,"es":o,"fr":D,"it":y,"nl":z,"sv":u};
var m=qx.locale.Manager.getInstance();
{};
var k;

for(var a in j){k=new qx.ui.form.RadioButton(j[a]);
k.setUserData(G,a);
n.add(k);
l.add(k);
if(m.getLanguage()==a){n.setSelection([k]);
}}var d=new qx.ui.layout.HBox(10,t);
var b=new qx.ui.container.Composite(d);
var g=new qx.ui.form.Button(this.tr(p),r);
g.addListener(F,this.close,this);
var c=new qx.ui.form.Button(this.tr(v),w);
c.addListener(F,function(e){var H=n.getSelection()[0].getUserData(G);
