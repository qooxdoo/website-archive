...
(function(){var s="",r="Add",q="Title:",p="__zy",o="Add a feed",n="feedreader.view.AddFeedWindow",m="__zw",l="user",k="URL:",j="icon/16/actions/document-new.png",g="icon/16/actions/dialog-apply.png",i="right",h="__zx",f="Feed Information",d="execute";
qx.Class.define(n,{extend:qx.ui.window.Window,construct:function(c){qx.ui.window.Window.call(this,this.tr(o),j);
this.__zw=c;
this.set({modal:true,showMinimize:false,showMaximize:false,allowMaximize:false});
this._addContent();
},members:{__zx:null,__zy:null,__zw:null,_addContent:function(){this.setLayout(new qx.ui.layout.VBox(10));
...
var t=this.__zy=new qx.ui.form.TextField();
var y=new qx.ui.basic.Label(this.tr(k));
var z=this.__zx=new qx.ui.form.TextField();
...
w.set({alignX:i,allowGrowX:false});
this.add(w);
w.addListener(d,this._addFeed,this);
},_addFeed:function(e){var b=this.__zy.getValue();

if(b==null||b==s){alert(this.tr("Please enter a title."));
return;
}var a=this.__zx.getValue();

if(a==null||b==s){alert(this.tr("Please enter a url."));
return;
}this.__zw.addFeed(b,a,l);
this.__zy.setValue(s);
this.__zx.setValue(s);
this.close();
}},destruct:function(){this.__zz=null;
this._disposeObjects(m,p,h);
}});
})();
