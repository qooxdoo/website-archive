...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Style.777d61bf394f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a='Welcome to <br><b style="color:#F3FFB3;">qooxdoo</b> animations!',b="demobrowser.demo.test.Style",c="testDiv",d='div',e='font-size:12pt;text-align:center;font-family:"Trebuchet MS","Lucida Grande",Verdana,sans-serif;color:white;left:90px;top:90px;position:absolute;width:200px;height:55px;border:2px #E5E5E5 solid;background-color:#134275;z-Index:10;';qx.Class.define(b,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var f=e;var g=qx.dom.Element.create(d,{style:f});document.body.appendChild(g);g.id=c;g.innerHTML=a;}
}});}
)();
