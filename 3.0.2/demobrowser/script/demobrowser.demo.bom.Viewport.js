...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Viewport.4ad85788030b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Document Dimension: ",b="Viewport Dimension: ",c="click",d="Viewport Scroll: ",e="x",f="demobrowser.demo.bom.Viewport";qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);qx.bom.Element.addListener(document.body,c,function(){this.debug(a+qx.bom.Document.getWidth()+e+qx.bom.Document.getHeight());this.debug(b+qx.bom.Viewport.getWidth()+e+qx.bom.Viewport.getHeight());this.debug(d+qx.bom.Viewport.getScrollLeft()+e+qx.bom.Viewport.getScrollTop());}
,this);}
}});}
)();
