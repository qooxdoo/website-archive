...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.DragDrop.eadd6df94088.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
);var N=new qx.ui.basic.Label(m);I.add(N,{left:600,top:20});var G=this.__LQ=new qx.ui.form.List();G.setDraggable(true);G.setDroppable(true);G.setSelectionMode(u);I.add(G,{left:600,top:40});for(var i=0;i<20;i++ ){G.add(new qx.ui.form.ListItem(D+i,h));}
...
);G.addListener(c,function(e){var bd=e.getOriginalTarget();if(bd instanceof qx.ui.form.ListItem){qx.core.Init.getApplication().__SC=bd;}
...
;}
);G.addListener(g,function(e){this.__SD(e.getOriginalTarget());}
,this);H.addListener(g,function(e){this.__SD(this.__SC);}
,this);}
,__SD:function(bf){if(bf.classname!=n){return;}
;var be=this.__LQ.getSortedSelection();for(var i=0,l=be.length;i<l;i++ ){this.__LQ.addBefore(be[i],bf);this.__LQ.addToSelection(be[i]);}
;}
