...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SplitPane.ab767203ebb5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,__Tf:function(){var bo=new qx.ui.tree.Tree();bo.setDecorator(null);var bt=new qx.ui.tree.TreeFolder(w);bt.setOpen(true);bo.setRoot(bt);var br=new qx.ui.tree.TreeFolder(j);br.setOpen(true);bt.add(br);var bj=new qx.ui.tree.TreeFolder(y);var bh=new qx.ui.tree.TreeFolder(B);var bi=new qx.ui.tree.TreeFolder(r);var bg=new qx.ui.tree.TreeFolder(k);br.add(bj,bh,bi,bg);var bp=new qx.ui.tree.TreeFile(f);var bf=new qx.ui.tree.TreeFile(c);bh.add(bp,bf);var bs=new qx.ui.tree.TreeFolder(h);var bk=new qx.ui.tree.TreeFolder(p);var bn=new qx.ui.tree.TreeFolder(u);var bm=new qx.ui.tree.TreeFolder(k);for(var i=0;i<100;i++ ){bm.add(new qx.ui.tree.TreeFile(C+i));}
;var bq=new qx.ui.tree.TreeFolder(F);var bl=new qx.ui.tree.TreeFolder(K);bs.add(bk,bn,bm,bq,bl);bt.add(bs);return bo;}
},destruct:function(){this._disposeObjects(q,m,z);}
});}
)();
...
,properties:{appearance:{refine:true,init:q},offset:{check:g,init:6,apply:p},orientation:{init:w,check:[w,m],apply:o}},members:{__sa:null,__sb:false,__sc:null,__sd:null,__mV:null,__se:null,__sf:null,__fq:null,__la:null,_createChildControlImpl:function(H,G){var F;switch(H){case a:F=new qx.ui.splitpane.Slider(this);F.exclude();this._add(F,{type:H});break;case c:F=new qx.ui.splitpane.Splitter(this);this._add(F,{type:H});F.addListener(j,this.__sg,this);break;};return F||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,H);}
...
,this);}
,getBlocker:function(){return this.__la;}
,_applyOrientation:function(Q,N){var R=this.getChildControl(a);var M=this.getChildControl(c);this.__mV=Q===w;if(!this.__la){this.__sh(Q);}
...
;if(this.__mV){var X=null;if(V){X=V.width;}
...
;this.__fq.push(be);}
,remove:function(bf){this._remove(bf);qx.lang.Array.remove(this.__fq,bf);}
,getChildren:function(){return this.__fq;}
,_onMouseDown:function(e){if(!e.isLeftPressed()){return;}
;var bg=this.getChildControl(c);var bj=bg.getContentLocation();var bh=this.getContentLocation();this.__sa=this.__mV?e.getDocumentLeft()-bj.left+bh.left:e.getDocumentTop()-bj.top+bh.top;var bi=this.getChildControl(a);var bk=bg.getBounds();bi.setUserBounds(bk.left,bk.top,bk.width,bk.height);bi.setZIndex(bg.getZIndex()+1);bi.show();this.__sb=true;this.__la.capture();e.stop();}
,_onMouseMove:function(e){this._setLastMousePosition(e.getDocumentLeft(),e.getDocumentTop());if(this.__sb){this.__sj();var bl=this.getChildControl(a);var bm=this.__se;if(this.__mV){bl.setDomLeft(bm);this.__la.setStyle(C,(bm-this.getOffset())+d);}
...
else {if(this.__mV){bs.setWidth(br);bq.setWidth(bo);}
else {bs.setHeight(br);bq.setHeight(bo);}
;}
;}
,__sj:function(){if(this.__mV){var bx=z,bE=n,by=D,bC=this.__sc;}
