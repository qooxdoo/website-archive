...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_3.131841c5acd7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="text",b="blur",c="demobrowser.demo.test.Element_3",d="Element blurred",f="Element focused",g="FocusIn: ",h="focus",i="type",j="test",k="input",l="focusin";qx.Class.define(c,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var m=new qx.html.Root(document.getElementById(j));var n=new qx.html.Element(k);n.setAttribute(i,a);n.focus();n.addListener(h,function(e){qx.log.Logger.debug(f);}
);n.addListener(b,function(e){qx.log.Logger.debug(d);}
);qx.bom.Element.addListener(document.documentElement,l,function(e){qx.log.Logger.debug(g,e.getTarget());}
