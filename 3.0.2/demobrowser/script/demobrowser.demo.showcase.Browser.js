...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.showcase.Browser.cd4a1d9c81ac.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this._getIframeElement().addListener(h,this.__Fi,this);}
...
,__Fi:function(e){var r=e.getData();if(r){this.setSource(r);}
;this.fireDataEvent(h,r);}
}});}
)();
(function(){var a="no",b="mousedown",c="Boolean",d="px",f="event.help",g="gecko",h="__vV",i="auto",j="_applyScrollbar",k="Unable to set 'nativeHelp' property, possibly due to security restrictions",l="qx.debug",m="DOMNodeInserted",n="load",o="_applyNativeHelp",p="yes",q="scrolling",r="/",s="help",t="appear",u="engine.name",v="mouseup",w="block",x="qx.ui.embed.Iframe",y="losecapture",z="contextmenu",A="none",B="iframe",C="display";qx.Class.define(x,{extend:qx.ui.embed.AbstractIframe,construct:function(D){if(D!=null){this.__Fl=D;}
;qx.ui.embed.AbstractIframe.call(this,D);qx.event.Registration.addListener(document.body,b,this.block,this,true);qx.event.Registration.addListener(document.body,v,this.release,this,true);qx.event.Registration.addListener(document.body,y,this.release,this,true);this.__vV=this._createBlockerElement();if((qx.core.Environment.get(u)==g)){this.addListenerOnce(t,function(e){var E=this.getContentElement().getDomElement();qx.bom.Event.addNativeListener(E,m,this._onDOMNodeInserted);}
);this._onDOMNodeInserted=qx.lang.Function.listener(this._syncSourceAfterDOMMove,this);}
;}
,properties:{appearance:{refine:true,init:B},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:c,init:false,apply:o},scrollbar:{check:[i,a,p],nullable:true,themeable:true,apply:j}},members:{__Fl:null,__vV:null,renderLayout:function(J,top,H,F){qx.ui.embed.AbstractIframe.prototype.renderLayout.call(this,J,top,H,F);var I=d;var G=this.getInsets();this.__vV.setStyles({"left":(J+G.left)+I,"top":(top+G.top)+I,"width":(H-G.left-G.right)+I,"height":(F-G.top-G.bottom)+I});}
,_createContentElement:function(){var K=new qx.html.Iframe(this.__Fl);K.addListener(n,this._onIframeLoad,this);return K;}
...
,block:function(){this.__vV.setStyle(C,w);}
,release:function(){this.__vV.setStyle(C,A);}
...
,setLayoutParent:function(parent){qx.ui.embed.AbstractIframe.prototype.setLayoutParent.call(this,parent);if(parent){this.getLayoutParent().getContentElement().add(this.__vV);}
;}
},destruct:function(){if(this.getLayoutParent()&&this.__vV.getParent()){this.getLayoutParent().getContentElement().remove(this.__vV);}
...
(function(){var a="source",b="element",c="name",d="qx.event.type.Event",f="iframe",g="qx.html.Iframe",h="navigate",i="qx.event.type.Data";qx.Class.define(g,{extend:qx.html.Element,construct:function(j,k,l){qx.html.Element.call(this,f,k,l);this.setSource(j);this.addListener(h,this.__Fi,this);qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(b);}
...
;}
,__Fi:function(e){var v=e.getData();if(v){this.setSource(v);}
;}
}});}
)();
