...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents.adc25e6a812b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_onCellClick:function(e){var q=b+e.getRow()+i+e.getColumn()+h;this.__SG(q);}
,_onContextMenu:function(e){var r=f+e.getRow()+i+e.getColumn()+h;this.__SG(r);}
,_onDblclickPane:function(e){var s=g+e.getRow()+i+e.getColumn()+h;this.__SG(s);}
,__SG:function(t){this.logger.setHtml(this.logger.getHtml()+t);}
