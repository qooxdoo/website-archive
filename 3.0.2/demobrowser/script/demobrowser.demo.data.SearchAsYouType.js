...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.a42983aefc3e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,this);this.__ui=null;}
,properties:{searchString:{check:c,apply:a,init:d}},members:{__ui:null,__tz:null,_applySearchString:function(h,g){var i=qx.util.TimerManager.getInstance();if(this.__ui!=null){i.stop(this.__ui);this.__ui=null;}
;this.__ui=i.start(function(){this.__tz.update();this.__ui=null;}
,0,this,null,200);}
