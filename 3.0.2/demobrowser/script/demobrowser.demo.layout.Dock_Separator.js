...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Dock_Separator","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Dock_Separator.b079ca3c7f4a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="separator-vertical",b="demobrowser.demo.layout.Dock_Separator",c="yellow",d="center",e="red",f="north",g="south",h="separator-horizontal",i="west",j="east",k="x",l="green",m="fuchsia",n="orange",o="main",p="y",q="blue";qx.Class.define(b,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var s=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(s);var t=new qx.ui.layout.Dock();t.setSeparatorX(h);t.setSeparatorY(a);t.setSpacingX(5);t.setSpacingY(5);var r=new qx.ui.container.Composite(t).set({decorator:o,backgroundColor:c,allowGrowX:false});var y=new qx.ui.core.Widget().set({decorator:o,backgroundColor:e});var x=new qx.ui.core.Widget().set({decorator:o,backgroundColor:q});var w=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});var v=new qx.ui.core.Widget().set({decorator:o,backgroundColor:l});var u=new qx.ui.core.Widget().set({decorator:o,backgroundColor:m});r.add(y,{edge:f});r.add(x,{edge:i});r.add(w,{edge:g});r.add(v,{edge:j});r.add(u,{edge:d});s.add(r);var t=new qx.ui.layout.Dock();t.setSort(p);t.setSeparatorX(h);t.setSeparatorY(a);t.setSpacingX(5);t.setSpacingY(5);var r=(new qx.ui.container.Composite(t)).set({decorator:o,backgroundColor:c,allowGrowX:false});var y=new qx.ui.core.Widget().set({decorator:o,backgroundColor:e});var x=new qx.ui.core.Widget().set({decorator:o,backgroundColor:q});var w=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});var v=new qx.ui.core.Widget().set({decorator:o,backgroundColor:l});var u=new qx.ui.core.Widget().set({decorator:o,backgroundColor:m});r.add(y,{edge:f});r.add(x,{edge:i});r.add(w,{edge:g});r.add(v,{edge:j});r.add(u,{edge:d});s.add(r);var t=new qx.ui.layout.Dock();t.setSort(k);t.setSeparatorX(h);t.setSeparatorY(a);t.setSpacingX(5);t.setSpacingY(5);var r=(new qx.ui.container.Composite(t)).set({decorator:o,backgroundColor:c,allowGrowX:false});var y=new qx.ui.core.Widget().set({decorator:o,backgroundColor:e});var x=new qx.ui.core.Widget().set({decorator:o,backgroundColor:q});var w=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});var v=new qx.ui.core.Widget().set({decorator:o,backgroundColor:l});var u=new qx.ui.core.Widget().set({decorator:o,backgroundColor:m});r.add(y,{edge:f});r.add(x,{edge:i});r.add(w,{edge:g});r.add(v,{edge:j});r.add(u,{edge:d});s.add(r);var t=new qx.ui.layout.Dock();t.setSeparatorX(h);t.setSeparatorY(a);t.setSpacingX(5);t.setSpacingY(5);t.setConnectSeparators(true);var r=new qx.ui.container.Composite(t).set({decorator:o,backgroundColor:c,allowGrowX:false});var y=new qx.ui.core.Widget().set({decorator:o,backgroundColor:e});var x=new qx.ui.core.Widget().set({decorator:o,backgroundColor:q});var w=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});var v=new qx.ui.core.Widget().set({decorator:o,backgroundColor:l});var u=new qx.ui.core.Widget().set({decorator:o,backgroundColor:m});r.add(y,{edge:f});r.add(x,{edge:i});r.add(w,{edge:g});r.add(v,{edge:j});r.add(u,{edge:d});s.add(r);}
}});}
)();
