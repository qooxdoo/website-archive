...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.Github","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Github.d05f4663a468.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Method must be string for route '",b="'",c=") already exists",d="error",f="Error",g=" ms. Throttling.",h="qx.io.rest.Resource",i="interval",j="qx.event.type.Rest",k=" times subsequently, each within ",l="Received successful response more than ",m="get",n="URL must be string for route '",o="Method with name of action (",p="Success",q="undefined",r="success",s="qx.debug";qx.Class.define(h,{extend:qx.core.Object,construct:function(t){qx.core.Object.call(this);this.__Jn={};this.__Jo={};this.__Jp={};this._resource=this._tailorResource(this._getResource());try{if(typeof t!==q){if(qx.core.Environment.get(s)){qx.core.Assert.assertMap(t);}
;this.__Jr(t);}
;}
catch(e){this.dispose();throw e;}
;}
,events:{"success":j,"actionSuccess":j,"error":j,"actionError":j},statics:{POLL_THROTTLE_LIMIT:100,POLL_THROTTLE_COUNT:30,REQUIRED:true,placeholdersFromUrl:function(u){return qx.bom.rest.Resource.placeholdersFromUrl(u);}
},members:{_resource:null,__Jn:null,__Jo:null,__Jp:null,_getResource:function(v){return new qx.bom.rest.Resource(v);}
,_tailorResource:function(w){w.setRequestFactory(this._getRequest);w.setRequestHandler({onsuccess:{callback:function(y,x){return function(){var z=[y.getResponse(),null,false,y,x,y.getPhase()];this.fireEvent(x+p,qx.event.type.Rest,z);this.fireEvent(r,qx.event.type.Rest,z);}
;}
,context:this},onfail:{callback:function(B,A){return function(){var C=[B.getResponse(),null,false,B,A,B.getPhase()];this.fireEvent(A+f,qx.event.type.Rest,C);this.fireEvent(d,qx.event.type.Rest,C);}
;}
,context:this},onloadend:{callback:function(E,D){return function(){E.dispose();}
;}
,context:this}});return w;}
,configureRequest:function(F){this._resource.configureRequest(F);}
,_getRequest:function(){return new qx.io.request.Xhr();}
,map:function(G,I,H,J){this.__Jq(G,I,H,J);this._resource.map(G,I,H,J);}
,__Jq:function(L,N,K,M){this.__Jp[L]=[N,K,M];if(L==m){this[L]=undefined;}
;if(typeof this[L]!==q&&this[L]!==null&&this[L].action!==true){throw new Error(o+L+c);}
;this.__Js(L+p);this.__Js(L+f);this[L]=qx.lang.Function.bind(function(){Array.prototype.unshift.call(arguments,L);return this.invoke.apply(this,arguments);}
,this);this[L].action=true;}
,invoke:function(O,P,Q){var P=(P==null)?{}:P;this.__Jp[O].params=P;return this._resource.invoke(O,P,Q);}
,setBaseUrl:function(R){this._resource.setBaseUrl(R);}
,abort:function(S){this._resource.abort(S);}
,refresh:function(T){this._resource.refresh(T);}
,poll:function(Y,U,X,ba){if(this.__Jo[Y]){this.__Jo[Y].dispose();}
;if(typeof X==q){X=this.__Jp[Y].params;}
;if(ba){this.invoke(Y,X);}
;var W=function(){var bc=this.getRequestsByAction(Y),bb=(bc)?bc[0]:null;if(!ba&&!bb){this.invoke(Y,X);return;}
;if(bb&&(bb.isDone()||bb.isDisposed())){this.refresh(Y);}
;}
;var V=this.__Jo[Y]=new qx.event.Timer(U);V.addListener(i,W,this._resource);V.start();return V;}
,longPoll:function(bh){var be=this,bg,bi=0;function bd(){var bj=bg&&((new Date())-bg)<be._getThrottleLimit();if(bj){bi+=1;if(bi>be._getThrottleCount()){if(qx.core.Environment.get(s)){be.debug(l+be._getThrottleCount()+k+be._getThrottleLimit()+g);}
;return true;}
;}
;if(!bj){bi=0;}
;return false;}
;var bf=this.__Jn[bh]=this.addListener(bh+p,function bk(){if(be.isDisposed()){return;}
;if(!bd()){bg=new Date();be.refresh(bh);}
;}
);this.invoke(bh);return bf;}
,_getRequestConfig:function(bl,bm){return this._resource._getRequestConfig(bl,bm);}
...
,__Jr:function(bn){Object.keys(bn).forEach(function(bp){var bq=bn[bp],bs=bq.method,bo=bq.url,br=bq.check;if(qx.core.Environment.get(s)){qx.core.Assert.assertString(bs,a+bp+b);qx.core.Assert.assertString(bo,n+bp+b);}
;this.map(bp,bs,bo,br);}
,this);}
,__Js:function(bt){if(!this.constructor.$$events){this.constructor.$$events={};}
;if(!this.constructor.$$events[bt]){this.constructor.$$events[bt]=j;}
;}
},destruct:function(){var bu;if(this.__Jo){for(bu in this.__Jo){var bw=this.__Jo[bu];bw.stop();bw.dispose();}
;}
;if(this.__Jn){for(bu in this.__Jn){var bv=this.__Jn[bu];this.removeListenerById(bv);}
;}
;this._resource.destruct();this._resource=this.__Jp=this.__Jo=this.__Jn=null;}
});}
)();
...
(function(){var a="function",b="Received successful response more than ",c="=?(\\w+)?}",d="' is invalid",f=" ms. Throttling.",g="loadEnd",h=" times subsequently, each within ",i="Parameter '",j="GET",k="Disposing ",l="URL must be string for route '",m="Method with name of action (",n="Missing destruct definition for '",o="'",p="object",q="error",r="qx.debug",s="fail",t="rv:1.8.1",u="get",v="{",w="success",x=") doesn't support other HTTP methods than 'GET'",y=") already exists",z="Error",A="",B="]",C="qx.bom.rest.Resource",D="Request (",E="Missing parameter '",F="[",G="Success",H="' in ",I="Method must be string for route '",J="]: ",K="Content-Type",L="qx.debug.dispose.level",M="Check must be object with params as keys",N="undefined",O="MSIE 6.0",P="No route for action ";qx.Bootstrap.define(C,{extend:qx.event.Emitter,construct:function(Q){this.__Jt={};this.__Jp={};this.__Jo={};this.__Jn={};try{if(typeof Q!==N){if(qx.core.Environment.get(r)){qx.core.Assert.assertMap(Q);}
;this.__Jr(Q);}
;}
catch(e){this.dispose();throw e;}
;}
,events:{"success":C,"actionSuccess":C,"error":C,"actionError":C},statics:{POLL_THROTTLE_LIMIT:100,POLL_THROTTLE_COUNT:30,REQUIRED:true,placeholdersFromUrl:function(R){var T=/\{(\w+)(=\w+)?\}/g,U,S=[];while((U=T.exec(R))){S.push(U[1]);}
;return S;}
},members:{__Jt:null,__Jp:null,__Ju:null,__Jo:null,__Jn:null,__Jv:null,__Jw:null,__Jx:null,setRequestFactory:function(V){this.__Jx=V;}
,setRequestHandler:function(W){this.__Jw=W;}
,_getRequestHandler:function(){return (this.__Jw===null)?{onsuccess:{callback:function(Y,X){return function(){var ba={"id":parseInt(Y.toHashCode(),10),"response":Y.getResponse(),"request":Y,"action":X};this.emit(X+G,ba);this.emit(w,ba);}
;}
,context:this},onfail:{callback:function(bc,bb){return function(){var bd={"id":parseInt(bc.toHashCode(),10),"response":bc.getResponse(),"request":bc,"action":bb};this.emit(bb+z,bd);this.emit(q,bd);}
;}
,context:this},onloadend:{callback:function(bf,be){return function(){bf.dispose();}
;}
,context:this}}:this.__Jw;}
,getRequestsByAction:function(bg){var bh=(this.__Jt!==null&&bg in this.__Jt);return bh?this.__Jt[bg]:null;}
,configureRequest:function(bi){this.__Jv=bi;}
,_getRequest:function(){return (this.__Jx===null)?new qx.bom.request.SimpleXhr():this.__Jx();}
,__Jy:function(bj){var bk=this._getRequest();if(!qx.lang.Type.isArray(this.__Jt[bj])){this.__Jt[bj]=[];}
;this.__Jt[bj].push(bk);return bk;}
,map:function(bm,bo,bl,bn){this.__Jp[bm]=[bo,bl,bn];this.__Jt[bm]=[];if(bm==u){this[bm]=undefined;}
;if(typeof this[bm]!==N&&this[bm]!==null&&this[bm].action!==true){throw new Error(m+bm+y);}
;this.__Js(bm+G);this.__Js(bm+z);this[bm]=qx.lang.Function.bind(function(){Array.prototype.unshift.call(arguments,bm);return this.invoke.apply(this,arguments);}
,this);this[bm].action=true;}
,invoke:function(bt,br,bp){var bq=this.__Jy(bt),br=br==null?{}:br,bu=this._getRequestConfig(bt,br);this.__Jp[bt].params=br;this.__Jz(br,bu.check);this.__FY(bq,bu,bp);if(this.__Jv){this.__Jv.call(this,bq,bt,br,bp);}
;this.__JA(bq,bu,bp);var bs=this._getRequestHandler();bq.addListenerOnce(w,bs.onsuccess.callback(bq,bt),bs.onsuccess.context);bq.addListenerOnce(s,bs.onfail.callback(bq,bt),bs.onfail.context);bq.addListenerOnce(g,bs.onloadend.callback(bq,bt),bs.onloadend.context);bq.send();return parseInt(bq.toHashCode(),10);}
,setBaseUrl:function(bv){this.__Ju=bv;}
,__Jz:function(bw,bx){if(typeof bx!==N){if(qx.core.Environment.get(r)){qx.core.Assert.assertObject(bx,M);}
;Object.keys(bx).forEach(function(by){if(qx.core.Environment.get(r)){if(bx[by]!==true){if(qx.core.Environment.get(r)){qx.core.Assert.assertRegExp(bx[by]);}
;}
;}
;if(bx[by]===qx.bom.rest.Resource.REQUIRED&&typeof bw[by]===N){throw new Error(E+by+o);}
;if(!(bx[by]&&typeof bx[by].test==a)){return;}
;if(!bx[by].test(bw[by])){throw new Error(i+by+d);}
;}
);}
;}
,__FY:function(bA,bz,bB){bA.setUrl(bz.url);if(!bA.setMethod&&bz.method!==j){throw new Error(D+bA.classname+x);}
;if(bA.setMethod){bA.setMethod(bz.method);}
;if(bB){bA.setRequestData(bB);}
;}
,__JA:function(bE,bC,bD){if(bD){var bF=bE.getRequestHeader(K);if(bE.getMethod&&qx.util.Request.methodAllowsRequestBody(bE.getMethod())){if((/application\/.*\+?json/).test(bF)){bD=qx.lang.Json.stringify(bD);bE.setRequestData(bD);}
;}
;}
;}
,abort:function(bI){if(qx.lang.Type.isNumber(bI)){var bL=bI;var bK=qx.core.ObjectRegistry.getPostId();var bG=qx.core.ObjectRegistry.fromHashCode(bL+bK);if(bG){bG.abort();}
;}
else {var bJ=bI;var bH=this.__Jt[bJ];if(this.__Jt[bJ]){bH.forEach(function(bM){bM.abort();}
);}
;}
;}
,refresh:function(bN){this.invoke(bN,this.__Jp[bN].params);}
,poll:function(bO,bQ,bR,bP){if(this.__Jo[bO]){this.stopPollByAction(bO);}
;if(typeof bR==N){bR=this.__Jp[bO].params;}
;if(bP){this.invoke(bO,bR);}
;var bS=(function(bT){return function(){var bU=bT.__Jt[bO][0];if(!bP&&!bU){bT.invoke(bO,bR);return;}
;if(bU.isDone()||bU.isDisposed()){bT.refresh(bO);}
;}
;}
)(this);this._startPoll(bO,bS,bQ);}
,_startPoll:function(bV,bW,bX){this.__Jo[bV]={"id":window.setInterval(bW,bX),"interval":bX,"listener":bW};}
,stopPollByAction:function(bY){if(bY in this.__Jo){var ca=this.__Jo[bY].id;window.clearInterval(ca);}
;}
,restartPollByAction:function(cb){if(cb in this.__Jo){var cc=this.__Jo[cb];this.stopPollByAction(cb);this._startPoll(cb,cc.listener,cc.interval);}
;}
,longPoll:function(ch){var ce=this,cg,ci=0;function cd(){var cj=cg&&((new Date())-cg)<ce._getThrottleLimit();if(cj){ci+=1;if(ci>ce._getThrottleCount()){if(qx.core.Environment.get(r)){qx.Bootstrap.debug(b+ce._getThrottleCount()+h+ce._getThrottleLimit()+f);}
;return true;}
;}
;if(!cj){ci=0;}
;return false;}
;var cf=this.__Jn[ch]=this.addListener(ch+G,function ck(){if(ce.isDisposed()){return;}
;if(!cd()){cg=new Date();ce.refresh(ch);}
;}
);this.invoke(ch);return cf;}
,_getRequestConfig:function(cp,co){var cm=this.__Jp[cp];var co=qx.lang.Object.clone(co);if(!qx.lang.Type.isArray(cm)){throw new Error(P+cp);}
;var cn=cm[0],cl=this.__Ju!==null?this.__Ju+cm[1]:cm[1],cr=cm[2],cq=qx.bom.rest.Resource.placeholdersFromUrl(cl);co=co||{};cq.forEach(function(cu){var cs=new RegExp(v+cu+c),ct=cl.match(cs)[1];if(typeof co[cu]===N){if(ct){co[cu]=ct;}
else {co[cu]=A;}
;}
;cl=cl.replace(cs,co[cu]);}
);return {method:cn,url:cl,check:cr};}
...
,__Jr:function(cv){Object.keys(cv).forEach(function(cx){var cy=cv[cx],cA=cy.method,cw=cy.url,cz=cy.check;if(qx.core.Environment.get(r)){qx.core.Assert.assertString(cA,I+cx+o);qx.core.Assert.assertString(cw,l+cx+o);}
;this.map(cx,cA,cw,cz);}
,this);}
,__Js:function(cB){if(!this.constructor.$$events){this.constructor.$$events={};}
;if(!this.constructor.$$events[cB]){this.constructor.$$events[cB]=C;}
;}
,isDisposed:function(){return this.$$disposed||false;}
,dispose:function(){if(this.$$disposed){return;}
;this.$$disposed=true;if(qx.core.Environment.get(r)){if(qx.core.Environment.get(L)>2){qx.Bootstrap.debug(this,k+this.classname+F+this.toHashCode()+B);}
;}
;this.destruct();if(qx.core.Environment.get(r)){if(qx.core.Environment.get(L)>0){var cC,cE;for(cC in this){cE=this[cC];if(cE!==null&&typeof cE===p&&!(qx.Bootstrap.isString(cE))){if(this.constructor.prototype[cC]!=null){continue;}
;var cD=navigator.userAgent.indexOf(t)!=-1;var cF=navigator.userAgent.indexOf(O)!=-1;if(cD||cF){if(cE instanceof qx.core.Object||qx.core.Environment.get(L)>1){qx.Bootstrap.warn(this,n+cC+H+this.classname+F+this.toHashCode()+J+cE);delete this[cC];}
;}
else {if(qx.core.Environment.get(L)>1){qx.Bootstrap.warn(this,n+cC+H+this.classname+F+this.toHashCode()+J+cE);delete this[cC];}
;}
;}
;}
;}
;}
;}
,destruct:function(){var cG;for(cG in this.__Jt){if(this.__Jt[cG]){this.__Jt[cG].forEach(function(cI){cI.dispose();}
);}
;}
;if(this.__Jo){for(cG in this.__Jo){this.stopPollByAction(cG);}
;}
;if(this.__Jn){for(cG in this.__Jn){var cH=this.__Jn[cG];this.removeListenerById(cH);}
;}
;this.__Jt=this.__Jp=this.__Jo=null;}
}});}
)();
(function(){var a="'",b="loadEnd",c="Fire readyState: ",d="",f="Request completed with HTTP status: ",g="abort",h="error",i="application/x-www-form-urlencoded",j="Cache-Control",k="Content-Type",l="fail",m="GET",n="qx.debug.io",o="success",p="undefined",q="POST",r="timeout",s="qx.bom.request.SimpleXhr",t="Response is of type: '";qx.Bootstrap.define(s,{extend:Object,construct:function(u,v){if(u!==undefined){this.setUrl(u);}
;this.useCaching(true);this.setMethod((v!==undefined)?v:m);this._transport=this._registerTransportListener(this._createTransport());qx.core.ObjectRegistry.register(this);this.__rE={};this.__tX=this._createResponseParser();}
,members:{setRequestHeader:function(w,x){this.__rE[w]=x;return this;}
,getRequestHeader:function(y){return this.__rE[y];}
,setUrl:function(z){if(qx.lang.Type.isString(z)){this.__ue=z;}
;return this;}
,getUrl:function(){return this.__ue;}
,setMethod:function(A){if(qx.util.Request.isMethod(A)){this.__JB=A;}
;return this;}
,getMethod:function(){return this.__JB;}
,setRequestData:function(B){if(qx.lang.Type.isString(B)||qx.lang.Type.isObject(B)){this.__JC=B;}
;return this;}
,getRequestData:function(){return this.__JC;}
,getResponse:function(){if(this.__tQ!==null){return this.__tQ;}
...
,setParser:function(C){return this.__tX.setParser(C);}
,setTimeout:function(D){if(qx.lang.Type.isNumber(D)){this.__eS=D;}
;return this;}
,getTimeout:function(){return this.__eS;}
,useCaching:function(E){if(qx.lang.Type.isBoolean(E)){this.__d=E;}
;return this;}
...
,send:function(){var K=this.getTimeout(),H=(this.getRequestData()!==null),I=this.__rE.hasOwnProperty(j),F=qx.util.Request.methodAllowsRequestBody(this.getMethod()),L=this.getRequestHeader(k),G=this._serializeData(this.getRequestData(),L);if(this.getMethod()===m&&H){this.setUrl(qx.util.Uri.appendParamsToUrl(this.getUrl(),G));}
;if(this.isCaching()===false&&!I){this.setUrl(qx.util.Uri.appendParamsToUrl(this.getUrl(),{nocache:new Date().valueOf()}));}
;if(K){this._transport.timeout=K;}
;this._transport.open(this.getMethod(),this.getUrl(),true);for(var J in this.__rE){this._transport.setRequestHeader(J,this.__rE[J]);}
;if(!F){this._transport.send();}
else {if(typeof L===p){this._transport.setRequestHeader(k,i);}
;this._transport.send(G);}
;}
,abort:function(){this._transport.abort();return this;}
,dispose:function(){if(this._transport.dispose()){this.__tX=null;this.__uj=true;return true;}
;return false;}
,_transport:null,_createTransport:function(){return new qx.bom.request.Xhr();}
,_registerTransportListener:function(M){M.onreadystatechange=qx.lang.Function.bind(this._onReadyStateChange,this);M.onloadend=qx.lang.Function.bind(this._onLoadEnd,this);M.ontimeout=qx.lang.Function.bind(this._onTimeout,this);M.onerror=qx.lang.Function.bind(this._onError,this);M.onabort=qx.lang.Function.bind(this._onAbort,this);return M;}
,_createResponseParser:function(){return new qx.util.ResponseParser();}
,_setResponse:function(N){this.__tQ=N;}
,_serializeData:function(R,Q){var O=this.getMethod()===q,P=(/application\/.*\+?json/).test(Q);if(!R){return null;}
;if(qx.lang.Type.isString(R)){return R;}
;if(P&&(qx.lang.Type.isObject(R)||qx.lang.Type.isArray(R))){return qx.lang.Json.stringify(R);}
;if(qx.lang.Type.isObject(R)){return qx.util.Uri.toParameter(R,O);}
;return null;}
,__rE:null,__JC:null,__JB:d,__ue:d,__tQ:null,__tX:null,__d:null,__eS:null,__uj:null,addListenerOnce:function(name,S,T){this._transport._emitter.once(name,S,T);return this;}
,_onReadyStateChange:function(){if(qx.core.Environment.get(n)){qx.Bootstrap.debug(c+this._transport.readyState);}
;if(this.isDone()){this.__tV();}
;}
,__tV:function(){if(qx.core.Environment.get(n)){qx.Bootstrap.debug(f+this._transport.status);}
;var V=this._transport.responseText;var U=this._transport.getResponseHeader(k);if(qx.util.Request.isSuccessful(this._transport.status)){if(qx.core.Environment.get(n)){qx.Bootstrap.debug(t+this.getResponseContentType()+a);}
;this._setResponse(this.__tX.parse(V,U));this._transport._emit(o);}
else {try{this._setResponse(this.__tX.parse(V,U));}
catch(e){}
;if(this._transport.status!==0){this._transport._emit(l);}
;}
;}
,_onLoadEnd:function(){this._transport._emit(b);}
,_onAbort:function(){this._transport._emit(g);}
,_onTimeout:function(){this._transport._emit(r);this._transport._emit(l);}
,_onError:function(){this._transport._emit(h);this._transport._emit(l);}
}});}
)();
...
(function(){var a="Number",b="qx.io.request.AbstractRequest",c="qx.event.type.Rest",d="String";qx.Class.define(c,{extend:qx.event.type.Data,properties:{request:{check:b},action:{check:d},phase:{check:d},id:{check:a}},members:{init:function(j,e,g,f,h,i){qx.event.type.Data.prototype.init.call(this,j,e,g);this.setRequest(f);this.setAction(h);this.setPhase(i);this.setId(parseInt(f.toHashCode(),10));return this;}
...
(function(){var a="changeModel",b="model.user.avatar_url",c="application/json",d="github.view.Gist",e="model.description",f="west",g="GET",h="/gists/{id}",i="Description",j="https://api.github.com",k="demobrowser.demo.data.Github",l="source",m="/gists",n="change",o="Content",p="center",q="value",r="get",s="#fff",t="Authorization",u="html",v="",w="model.user.login",x="model.files",y="north",z="Gists",A="Accept",B="token ",C="bold",D="model",E="github.rest.Resource",F="description",G="undefined",H="</pre>",I="<pre>";qx.Class.define(k,{extend:qx.application.Standalone,members:{__PJ:null,__PK:null,__PL:null,__PM:null,__LQ:null,__PN:null,main:function(){if(typeof GITHUB==G){return;}
;qx.application.Standalone.prototype.main.call(this);this._setUpResources();this._setUpStores();this._createGui();this._setUpBinding();this.__PJ.get();this.__LQ.addListener(a,function(K){var J=K.getData();this.__LQ.getSelection().push(J.getItem(0));}
,this);this.__LQ.getSelection().addListener(n,function(L){var M=this.__LQ.getSelection().getItem(0).getId();this.__PK.get({id:M});}
,this);}
,_setUpResources:function(){this.__PJ=new github.rest.Resource({"get":{method:g,url:m}});this.__PK=new github.rest.Resource({"get":{method:g,url:h}});}
,_setUpStores:function(){this.__PL=new qx.data.store.Rest(this.__PJ,r);this.__PM=new qx.data.store.Rest(this.__PK,r);}
,_createGui:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.Dock());N.setPadding(10);var O=new qx.ui.basic.Label(z);O.setFont(C);O.setPaddingBottom(10);N.add(O,{edge:y});this.__LQ=new qx.ui.list.List();this.__LQ.setWidth(200);this.__PN=new github.view.Gist();N.add(this.__LQ,{edge:f});N.add(this.__PN,{edge:p});this.getRoot().add(N,{edge:0});}
,_setUpBinding:function(){var Q=this.__LQ,P=this.__PL,R=this.__PM;Q.setLabelPath(F);Q.setLabelOptions({converter:function(W,U,T,V){if(W===null||!W.length){return U.getId();}
;return W;}
});P.bind(D,Q,D);var S=this.__PN;R.bind(e,S.getDescription(),q);R.bind(w,S.getUsername(),q);R.bind(b,S.getGravatar(),l);R.bind(x,S.getContent(),u,{converter:function(Y){var X=qx.Class.getProperties(Y.constructor);var content=Y.get(X[0]).getContent();content=qx.bom.String.escape(content);return I+content+H;}
});}
}});qx.Class.define(E,{extend:qx.io.rest.Resource,construct:function(ba){qx.io.rest.Resource.call(this,ba);this.configureRequest(function(bb){bb.setRequestHeader(A,c);bb.setRequestHeader(t,B+GITHUB.access_token);}
);this.setBaseUrl(j);}
});qx.Class.define(d,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);var bc=new qx.ui.layout.Grid(5,5);bc.setColumnFlex(0,1);bc.setRowFlex(2,1);this.setLayout(bc);this.setPadding(0,10);var bd;var bf=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));bd=new qx.ui.basic.Label(i);bd.setFont(C);this.__Cy=new qx.ui.basic.Label();bf.add(bd);bf.add(this.__Cy);this.add(bf,{row:0,column:0});var be=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));this.__PO=new qx.ui.basic.Image();this.__PO.set({width:40,height:40,scale:true,backgroundColor:s});this.__PP=new qx.ui.basic.Label();be.add(this.__PO);be.add(this.__PP);this.add(be,{row:0,column:1});bd=new qx.ui.basic.Label(o);bd.setFont(C);var scroll=new qx.ui.container.Scroll();this.__no=new qx.ui.embed.Html();this.__no.setMinHeight(1000);scroll.add(this.__no);this.add(bd,{row:1,column:0});this.add(scroll,{row:2,column:0,colSpan:2});}
,members:{__Cy:v,__PO:v,__PP:v,__no:v,getDescription:function(){return this.__Cy;}
,getGravatar:function(){return this.__PO;}
,getUsername:function(){return this.__PP;}
,getContent:function(){return this.__no;}
}});}
)();
(function(){var a="changeModel",b="function",c="qx.io.rest.Resource",d="Success",f="String",g="qx.data.store.Rest";qx.Class.define(g,{extend:qx.core.Object,construct:function(i,h,j){qx.core.Object.call(this);try{this.setResource(i);this.setActionName(h);}
catch(e){this.dispose();throw e;}
;this._delegate=j;this._marshaler=new qx.data.marshal.Json(j);if(j&&qx.lang.Type.isFunction(j.configureRequest)){this.__FY();}
;this.__FX=qx.lang.Function.bind(this.__Ga,this);this.__xx();}
,properties:{resource:{check:c},actionName:{check:f},model:{nullable:true,event:a}},members:{_marshaler:null,_delegate:null,__FX:null,__FY:function(){var k=this.getResource(),l=this._delegate;k.configureRequest(l.configureRequest);}
,__xx:function(){var n=this.getResource(),m=this.getActionName();if(n&&m){n.addListener(this.getActionName()+d,this.__FX);}
;}
,__Ga:function(e){var r=e.getData(),q=this._marshaler,s,o=this.getModel(),p=this._delegate;if(r){if(p&&p.manipulateData){r=p.manipulateData(r);}
;q.toClass(r,true);s=q.toModel(r);if(s){this.setModel(s);}
;}
;if(o&&o.dispose){o.dispose();}
;}
},destruct:function(){var t=this.getModel();if(t&&typeof t.dispose===b){t.dispose();}
