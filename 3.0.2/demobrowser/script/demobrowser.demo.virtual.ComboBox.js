...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.ComboBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.ComboBox.0c0749abbfa8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var c=" = ",d="... &gt; (as literal HTML entity)",f="... &gt; (as Richtext)",g="ChangeValue: ",h="bold",j="icon",k="<u>Underlined Text</u>",l="label",m="'s Icon",n="demobrowser.demo.virtual.ComboBox",o="With icons",p="Default",q="changeValue",r="2^ ",s="<i>Italic Text</i>",t="<b>Bold Text</b>",u="HTML entities: &laquo; &lt; &amp; &gt; &raquo;",v="Item ",w="Sorted and filtered model",x="With HTML (rich) text",y="icon/16/places/folder.png";qx.Class.define(n,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);this._createDefaultExample();this._createIconExample();this._createWideExample();this._createHtmlExample();}
,_createDefaultExample:function(){var C=new qx.ui.basic.Label(p);C.setFont(h);this.getRoot().add(C,{left:20,top:20});var z=new qx.ui.form.VirtualComboBox();var B=[];for(var i=1;i<401;i++ ){B.push(r+i+c+Math.pow(2,i));}
;var A=qx.data.marshal.Json.createModel(B);z.setModel(A);z.addListener(q,function(e){this.debug(g+e.getData());}
);this.getRoot().add(z,{left:20,top:40});}
,_createIconExample:function(){var G=new qx.ui.basic.Label(o);G.setFont(h);this.getRoot().add(G,{left:160,top:20});var D=new qx.ui.form.VirtualComboBox();var F=[];for(var i=1;i<31;i++ ){F.push({label:i+m,icon:y});}
;var E=qx.data.marshal.Json.createModel(F);D.setModel(E);D.setLabelPath(l);D.setIconPath(j);this.getRoot().add(D,{left:160,top:40});}
,_createHtmlExample:function(){var L=new qx.ui.basic.Label(x);L.setFont(h);this.getRoot().add(L,{left:300,top:20});var H=new qx.ui.form.VirtualComboBox().set({width:200});var J=[d,f,t,k,s,u];var I=qx.data.marshal.Json.createModel(J);H.setModel(I);var K={configureItem:function(M){M.setRich(true);}
};H.setDelegate(K);H.setDefaultFormat(function(N){if(N){N=qx.lang.String.stripTags(N);N=qx.bom.String.unescape(N);}
;return N;}
);this.getRoot().add(H,{left:300,top:40});}
,_createWideExample:function(){var P=new qx.ui.basic.Label(w);P.setFont(h);this.getRoot().add(P,{left:20,top:280});var O=new qx.ui.form.VirtualComboBox();var S=[];for(var i=1;i<100;i++ ){S.push(v+i);}
;var R=qx.data.marshal.Json.createModel(S);O.setModel(R);var Q={sorter:function(a,b){return a<b?1:a>b?-1:0;}
,filter:function(T){var U=parseInt(/([0-9]+)/.exec(T)[1],10);return U%2?true:false;}
};O.setDelegate(Q);this.getRoot().add(O,{left:20,top:300});}
}});}
)();
...
(function(){var a="Enter",b="qx.ui.form.VirtualComboBox",c="changeValue",d="button",f="execute",g="Function",h="inner",j="list",k="change",m="virtual-combobox",n="value",o="select",p="String",q="",r="textfield",s="dropdown",t="single",u="focusin",v="converter",w="click",x="focusout",y="_applyPlaceholder";qx.Class.define(b,{extend:qx.ui.form.core.AbstractVirtualBox,implement:[qx.ui.form.IStringForm],construct:function(z){qx.ui.form.core.AbstractVirtualBox.call(this,z);var A=this._createChildControl(r);this._createChildControl(d);var B=this.getChildControl(s);B.getChildControl(j).setSelectionMode(t);this.__eX=B.getSelection();this.__eX.addListener(k,this.__As,this);this.bind(n,A,n);A.bind(n,this,n);this.addListener(u,function(e){A.fireNonBubblingEvent(u,qx.event.type.Focus);}
,this);this.addListener(x,function(e){A.fireNonBubblingEvent(x,qx.event.type.Focus);}
,this);}
,properties:{appearance:{refine:true,init:m},width:{refine:true,init:120},value:{nullable:true,event:c},placeholder:{check:p,nullable:true,apply:y},defaultFormat:{check:g,init:null,nullable:true}},members:{__Ap:null,__Aq:null,__eX:null,__Ar:null,getTextSelection:function(){return this.getChildControl(r).getTextSelection();}
...
,tabFocus:function(){var E=this.getChildControl(r);E.getFocusElement().focus();E.selectAllText();}
,focus:function(){qx.ui.form.core.AbstractVirtualBox.prototype.focus.call(this);this.getChildControl(r).getFocusElement().focus();}
,_createChildControlImpl:function(H,G){var F;switch(H){case r:F=new qx.ui.form.TextField();F.setFocusable(qx.event.handler.MouseEmulation.ON);F.addState(h);this._add(F,{flex:1});break;case d:F=new qx.ui.form.Button();F.setFocusable(false);F.setKeepActive(true);F.addState(h);F.addListener(f,this.toggle,this);this._add(F);break;};return F||qx.ui.form.core.AbstractVirtualBox.prototype._createChildControlImpl.call(this,H,G);}
,_beforeOpen:function(){this.__At();}
,_handleKeyboard:function(event){var I=this._getAction(event);switch(I){case o:this.setValue(this.getChildControl(r).getValue());break;default:qx.ui.form.core.AbstractVirtualBox.prototype._handleKeyboard.call(this,event);break;};}
,_getAction:function(event){var J=event.getKeyIdentifier();var L=this.getChildControl(s).isVisible();var K=this._isModifierPressed(event);if(!L&&!K&&J===a){return o;}
else {return qx.ui.form.core.AbstractVirtualBox.prototype._getAction.call(this,event);}
;}
,_handleMouse:function(event){qx.ui.form.core.AbstractVirtualBox.prototype._handleMouse.call(this,event);var M=event.getType();if(M!==w){return;}
;this.close();}
,__As:function(event){if(this.__Ar==true){return;}
;var N=this.__eX.getItem(0);if(N){N=this.__bn(N);this.setValue(N);}
;}
,_applyPlaceholder:function(P,O){this.getChildControl(r).setPlaceholder(P);}
,__At:function(){var S=this.getValue();var R=this.getChildControl(s);var Q=R.getSelection();if(this.__bn(Q.getItem(0))!==S){this.__Ar=true;Q.removeAll();this.__Ar=false;if(S==null||S==q){return;}
;var W=this.getModel();var V=R.getChildControl(j)._getLookupTable();for(var i=0,l=V.length;i<l;i++ ){var T=W.getItem(V[i]);var U=this.__bn(T);if(U&&U.indexOf(S)==0){R.setPreselected(T);break;}
;}
;}
;}
,__bn:function(ba){var Y=this.getLabelOptions();var bc=this.getDefaultFormat();var bd=this.getLabelPath();var bb=null;if(bd!=null){bb=qx.data.SingleValueBinding.resolvePropertyChain(ba,bd);}
...
;var cn=this.getContentElement();if(ci&&this.__nz){if(this.__nz){var ck=this.getInsets();this._getPlaceholderElement().setStyles({paddingTop:ck.top+cp,paddingRight:ck.right+cp,paddingBottom:ck.bottom+cp,paddingLeft:ck.left+cp});}
;}
;if(cm||co.margin){if(this.__nz){var ck=this.getInsets();this._getPlaceholderElement().setStyles({"width":(innerWidth-ck.left-ck.right)+cp,"height":(innerHeight-ck.top-ck.bottom)+cp});}
;cn.setStyles({"width":innerWidth+cp,"height":innerHeight+cp});this._renderContentElement(innerHeight,cn);}
;if(co.position){if(this.__nz){this._getPlaceholderElement().setStyles({"left":cq+cp,"top":top+cp});}
;}
;}
...
;return cs;}
,_applyEnabled:function(cv,cu){qx.ui.core.Widget.prototype._applyEnabled.call(this,cv,cu);this.getContentElement().setEnabled(cv);if(this.__nz){if(cv){this._showPlaceholder();}
else {this._removePlaceholder();}
;}
else {var ct=this.getContentElement();ct.setAttribute(A,cv?this.getPlaceholder():P);}
;}
,__nB:{width:16,height:16},_getContentHint:function(){return {width:this.__nB.width*10,height:this.__nB.height||16};}
,_applyFont:function(cy,cx){if(cx&&this.__mr&&this.__mv){this.__mr.removeListenerById(this.__mv);this.__mv=null;}
;var cw;if(cy){this.__mr=qx.theme.manager.Font.getInstance().resolve(cy);if(this.__mr instanceof qx.bom.webfonts.WebFont){this.__mv=this.__mr.addListener(z,this._onWebFontStatusChange,this);}
;cw=this.__mr.getStyles();}
...
;if(this.__nz){delete cw[r];this._getPlaceholderElement().setStyles(cw);}
;if(cy){this.__nB=qx.bom.Label.getTextSize(m,cw);}
else {delete this.__nB;}
;qx.ui.core.queue.Layout.add(this);}
...
,_getTextSize:function(){return this.__nB;}
,_onHtmlInput:function(e){var cF=e.getData();var cE=true;this.__nA=false;if(this.__hH&&this.__hH===cF){cE=false;}
...
;}
;if(cE){this.fireDataEvent(q,cF,this.__hH);this.__hH=cF;if(this.getLiveUpdate()){this.__nC(cF);}
;}
;}
,_onWebFontStatusChange:function(cJ){if(cJ.getData().valid===true){var cI=this.__mr.getStyles();this.__nB=qx.bom.Label.getTextSize(m,cI);qx.ui.core.queue.Layout.add(this);}
;}
,__nC:function(cL){var cK=this.__hG;this.__hG=cL;if(cK!=cL){this.fireNonBubblingEvent(bR,qx.event.type.Data,[cL,cK]);}
;}
,setValue:function(cP){if(cP===null){if(this.__nA){return cP;}
;cP=P;this.__nA=true;}
else {this.__nA=false;if(this.__nz){this._removePlaceholder();}
;}
;if(qx.lang.Type.isString(cP)){var cO=this.getContentElement();if(cO.getValue()!=cP){var cM=cO.getValue();cO.setValue(cP);var cN=this.__nA?null:cP;this.__hG=cM;this.__nC(cN);this.__hH=this.__hG;}
;if(this.__nz){this._showPlaceholder();}
;return cP;}
;throw new Error(l+cP);}
,getValue:function(){var cQ=this.getContentElement().getValue();return this.__nA?null:cQ;}
,resetValue:function(){this.setValue(null);}
,_onChangeContent:function(e){this.__nA=e.getData()===null;this.__nC(e.getData());}
...
,setLayoutParent:function(parent){qx.ui.core.Widget.prototype.setLayoutParent.call(this,parent);if(this.__nz){if(parent){this.getLayoutParent().getContentElement().add(this._getPlaceholderElement());}
...
.bind(this),0);}
,_removePlaceholder:function(){if(this.hasState(v)){if(this.__nz){this._getPlaceholderElement().setStyle(R,bY);}
;this.removeState(v);}
;}
,_syncPlaceholder:function(){if(this.hasState(v)&&this.__nz){this._getPlaceholderElement().setStyle(R,E);}
;}
...
;if(!this.__nz&&qx.ui.form.AbstractField.__ea){qx.bom.Stylesheet.removeSheet(qx.ui.form.AbstractField.__ea);qx.ui.form.AbstractField.__ea=null;qx.ui.form.AbstractField.__ny();}
;}
,_applyPlaceholder:function(cY,cX){if(this.__nz){this._getPlaceholderElement().setValue(cY);if(cY!=null){this.addListener(u,this._removePlaceholder,this);this.addListener(bK,this._showPlaceholder,this);this._showPlaceholder();}
...
;this._placeholder=this.__mr=null;if(qx.core.Environment.get(bH)){qx.locale.Manager.getInstance().removeListener(bT,this._onChangeLocale,this);}
;if(this.__mr&&this.__mv){this.__mr.removeListenerById(this.__mv);}
...
;qx.html.Element.call(this,t,q,r);this.__nD=s;}
,members:{__nD:null,__nE:null,__nF:null,_createDomElement:function(){return qx.bom.Input.create(this.__nD);}
...
;}
,setEnabled:function(w){this.__nF=w;this.setAttribute(l,w===false);if(qx.core.Environment.get(a)==g){if(!w){this.setStyles({"userModify":m,"userSelect":d});}
else {this.setStyles({"userModify":null,"userSelect":this.__nE?null:d});}
;}
;}
,setSelectable:qx.core.Environment.select(a,{"webkit":function(x){this.__nE=x;qx.html.Element.prototype.setSelectable.call(this,this.__nF&&x);}
...
,setWrap:function(C,D){if(this.__nD===n){this._setProperty(c,C,D);}
else {throw new Error(e);}
;return this;}
,getWrap:function(){if(this.__nD===n){return this._getProperty(c);}
else {throw new Error(e);}
;}
}});}
)();
...
(function(){var a="&",b='X',c="",d='#',e="&#",f=";",g="qx.util.StringEscape";qx.Class.define(g,{statics:{escape:function(o,m){var j,n=c;for(var i=0,l=o.length;i<l;i++ ){var k=o.charAt(i);var h=k.charCodeAt(0);if(m[h]){j=a+m[h]+f;}
