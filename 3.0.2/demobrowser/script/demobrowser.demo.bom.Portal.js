...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Portal.e7e196618df4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="groupBoxes",b="demobrowser.demo.bom.portal.box.Manager",c="boxData",d="qx.event.type.Event",e="boxes",f="demobrowser.demo.bom.portal.box.Box",g="_applyActiveBox",h="loaded",m="singleton";qx.Class.define(b,{type:m,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__QJ=[];this.__QK=[];this.__QL={};}
,statics:{dataKeyRoot:c,dataKeyGroupBoxes:a,dataKeyBoxes:e},events:{"loaded":d},properties:{activeBox:{init:null,check:f,apply:g}},members:{__QJ:null,__QK:null,__QL:null,_applyActiveBox:function(o,n){if(n!=null){n.setActive(false);}
;o.setActive(true);}
,load:function(){this.__dq(window[demobrowser.demo.bom.portal.box.Manager.dataKeyRoot]);qx.event.Registration.fireEvent(this,h);}
,__dq:function(t){var s,w,u,v,x,t;var p=t[demobrowser.demo.bom.portal.box.Manager.dataKeyGroupBoxes];var r=t[demobrowser.demo.bom.portal.box.Manager.dataKeyBoxes];for(var w in p){s=p[w];u=s.boxes;w=s.id;v={id:w,element:document.getElementById(w)};this.__QK.push(v);this.__QL[w]=[];for(var k=0,l=u.length;k<l;k++ ){t=r[u[k]];var q=document.getElementById(t.id);var x=new demobrowser.demo.bom.portal.box.Box(t,q,null,w);this.__QJ.push(x);this.__QL[w].push(x);}
;}
;}
,getBoxes:function(){return this.__QJ;}
,getGroupBoxes:function(){return this.__QK;}
,updateGroupBoxMembers:function(A,B,y){var z=qx.dom.Hierarchy.getElementIndex(y.getElement());qx.lang.Array.remove(this.__QL[B],y);qx.lang.Array.insertAt(this.__QL[A],y,z);}
,getGroupBoxDataOfBox:function(C){for(var i=0,j=this.__QK.length,D;i<j;i++ ){D=this.__QL[this.__QK[i].id];for(var k=0,l=D.length;k<l;k++ ){if(D[k].getId()===C){return this.__QK[i];}
;}
;}
;return null;}
},destruct:function(){this.__QJ=this.__QK=this.__QL=null;}
});}
)();
(function(){var a="click",b="Boolean",c="1px solid #444444",d="height",f="position",g="zIndex",h="_applyActive",i="width",j="box_content",k=" It does contain no UI widget code at all.",l="<br/><br/>",m="relative",n="demobrowser.demo.bom.portal.box.Box",o="1px solid orange",p="This is a demo application showing the low-level capabilities.",q="div",r="String",s="border";qx.Class.define(n,{extend:qx.core.Object,construct:function(v,x,t,u){qx.core.Object.call(this);this.__QM=v;this.__co=v.id;if(x!=null){qx.bom.element.Style.set(x,i,v.width);qx.bom.element.Style.set(x,d,v.height);this.__QP(x,t);}
;this.setElement(x);this.setGroupBoxId(u);this.__QN=null;this.__QO=null;if(v.resizable){this.setResizable(true);var w={minWidth:parseInt(v.minWidth),minHeight:parseInt(v.minHeight),maxWidth:parseInt(v.maxWidth),maxHeight:parseInt(v.maxHeight),handles:v.resizeHandles};this.__QN=new demobrowser.demo.bom.portal.box.Resizable(this,w);}
;if(v.draggable){this.setDraggable(true);this.__QO=new demobrowser.demo.bom.portal.box.Draggable(this);}
;this.__QQ();}
,properties:{element:{init:null},groupBoxId:{init:null,check:r},active:{check:b,init:false,apply:h},resizable:{check:b,init:false},draggable:{check:b,init:false}},members:{__co:null,__QM:null,__QO:null,__QN:null,_applyActive:function(z,y){if(z){qx.bom.element.Style.set(this.getElement(),s,o);}
else {qx.bom.element.Style.set(this.getElement(),s,c);}
;}
,getId:function(){return this.getElement()?this.getElement().id:null;}
,getData:function(){return this.__QM;}
,getDraggableComponent:function(){return this.__QO;}
,getResizableComponent:function(){return this.__QN;}
,__QP:function(C,A){if(A){for(var B in A){qx.bom.element.Style.set(B,A[B]);}
;}
;qx.bom.element.Style.set(C,f,m);qx.bom.element.Style.set(C,g,0);qx.bom.Element.addListener(C,a,this.__QR,this,true);}
,__QQ:function(){var E=p+k;E=E+l+E+l+E;var D=qx.dom.Element.create(q,{"class":j});D.innerHTML=E;qx.dom.Element.insertEnd(D,this.getElement());}
,__QR:function(e){demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this);}
},destruct:function(){this.resetElement();this.__QM=this.__QN=this.__QO=null;}
});}
)();
...
(function(){var a="south",b="mouseup",c="mousedown",d='px',f="width",g="visibility",h="_",i="height",j="mouseover",k="mouseout",l="px",m="east",n="visible",o="hidden",p="mousemove",q="div",r="orientation",s="demobrowser.demo.bom.portal.box.Resizable",t="southeast",u="Handle";qx.Class.define(s,{extend:qx.core.Object,construct:function(v,w){qx.core.Object.call(this);this.__QS=v;this.__fe=this.__QS.getElement();this.__QT={};this.__QU=false;this.__QV={orientation:null,lastCoord:{left:null,top:null}};this.__QW={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};for(var name in this.__QW){if(w[name]){this.__QW[name]=w[name];}
;}
;this.__QP();}
,members:{__QV:null,__QS:null,__fe:null,__QT:null,__QW:null,__QU:false,getBox:function(){return this.__QS;}
,__QP:function(){switch(this.__QW.handles){case 1:this.__QT.east=null;break;case 2:this.__QT.south=null;break;case 3:this.__QT.south=null;this.__QT.southeast=null;this.__QT.east=null;break;};for(var y in this.__QT){var x=this.__QT[y]=qx.dom.Element.create(q);qx.bom.element.Attribute.set(x,r,y);qx.dom.Element.insertEnd(x,this.__fe);if(this.__fe.id){x.id=this.__fe.id+h+y;}
;this.__QX(y);this.__QY(y);}
;}
,__QX:function(z){qx.bom.element.Class.add(this.__QT[z],z+u);qx.bom.element.Style.set(this.__QT[z],g,this.__QW.autoHide?o:n);}
,__QY:function(B){var C=qx.event.Registration;var A=this.__QT[B];C.addListener(A,c,this.__Rc,this);C.addListener(document,b,this.__Rd,this);if(this.__QW.autoHide){C.addListener(this.__QS.getElement(),j,this.__Ra,this);C.addListener(this.__QS.getElement(),k,this.__Rb,this);}
;}
,__Ra:function(e){for(var D in this.__QT){qx.bom.element.Style.set(this.__QT[D],g,n);}
;}
,__Rb:function(e){if(!this.__QU){for(var E in this.__QT){qx.bom.element.Style.set(this.__QT[E],g,o);}
;}
;}
,__Rc:function(e){e.stopPropagation();if(e.isLeftPressed()){qx.event.Registration.addListener(document,p,this.__Re,this,true);this.__QU=true;var F=e.getTarget();this.__QV.orientation=qx.bom.element.Attribute.get(F,r);this.__QV.lastCoord.left=e.getDocumentLeft();this.__QV.lastCoord.top=e.getDocumentTop();demobrowser.demo.bom.portal.box.Util.bringToFront(this.__fe);}
;}
,__Rd:function(e){e.stopPropagation();if(this.__QU){qx.event.Registration.removeListener(document,p,this.__Re,this,true);demobrowser.demo.bom.portal.box.Util.sendToBack(this.__fe);if(this.__QW.autoHide){for(var G in this.__QT){qx.bom.element.Style.set(this.__QT[G],g,o);}
;}
;this.__QU=false;qx.bom.Selection.clear(document.body);}
;}
,__Re:function(e){e.stopPropagation();if(this.__QU){var H={left:null,top:null};switch(this.__QV.orientation){case a:H.top=e.getDocumentTop();break;case t:H.top=e.getDocumentTop();H.left=e.getDocumentLeft();break;case m:H.left=e.getDocumentLeft();break;};this.__Rf(H,this.__QV.lastCoord);this.__QV.lastCoord.left=e.getDocumentLeft();this.__QV.lastCoord.top=e.getDocumentTop();}
;}
,__Rf:function(K,L){var Q=qx.bom.element.Dimension;var N=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__QS.getId());var P=Q.getContentSize(N.element);if(K.left){var M=K.left-L.left;if(M!==0){var J=Q.getContentWidth(this.__fe)+M;var O=Q.getWidth(this.__fe)+M;if((this.__QW.minWidth==null||J>this.__QW.minWidth)&&(this.__QW.maxWidth==null||J<=this.__QW.maxWidth)){if(P.width>=O){qx.bom.element.Style.set(this.__fe,f,J+d);this.__QS.getData().width=J;}
;}
;}
;}
;if(K.top){var M=K.top-L.top;if(M!==0){var I=Q.getContentHeight(this.__fe)+M;if((this.__QW.minHeight==null||I>this.__QW.minHeight)&&(this.__QW.maxHeight==null||I<=this.__QW.maxHeight)){qx.bom.element.Style.set(this.__fe,i,I+l);}
;}
;}
;}
},destruct:function(){if(this.__QW.autoHide){qx.event.Registration.removeListener(this.__QS.getElement(),j,this.__Ra,this);qx.event.Registration.removeListener(this.__QS.getElement(),k,this.__Rb,this);}
;this.__QS=this.__QW=this.__fe=this.__QT=null;this.__QV=null;}
});}
)();
...
(function(){var a="zIndex",b="auto",c="demobrowser.demo.bom.portal.box.Util";qx.Class.define(c,{statics:{__Rg:1000,bringToFront:function(e){var d=qx.bom.element.Style.get(e,a);d=d==b?0:d;qx.bom.element.Style.set(e,a,d+this.__Rg);}
,sendToBack:function(g){var f=qx.bom.element.Style.get(g,a);qx.bom.element.Style.set(g,a,f-this.__Rg);}
}});}
)();
...
(function(){var a="mousemove",b="engine.name",c="mouseup",d="mousedown",f="dragstart",g="mouseover",h="drag",i="dragend",j="div",k="move",l="dragHandle",m="demobrowser.demo.bom.portal.box.Draggable",n="cursor",o="html";qx.Class.define(m,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);this.__QS=p;this.__fe=p.getElement();this.__Rh=null;this.__Ri=null;this.__QP();}
,members:{__QS:null,__fe:null,__Rh:null,__Ri:null,getBox:function(){return this.__QS;}
,getElement:function(){return this.__fe;}
,__QP:function(){this.__Rj();this.__QY();}
,__Rj:function(){this.__Rh=qx.dom.Element.create(j);qx.bom.element.Class.add(this.__Rh,l);qx.dom.Element.insertBegin(this.__Rh,this.__fe);}
,__QY:function(){qx.bom.Element.addListener(this.__Rh,d,this.__po,this);qx.bom.Element.addListener(this.__Rh,g,function(e){qx.bom.element.Style.set(this,n,k);}
,this.__Rh);qx.bom.Element.addListener(this.__Rh,f,this.__tH,this);qx.bom.Element.addListener(this.__Rh,i,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance());qx.bom.Element.addListener(this.__Rh,h,this.__Rm,this);}
,__po:function(e){if(e.isLeftPressed()){this.__Ri={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__fe),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__fe)};qx.bom.Element.addListener(document.body,c,this.__Rl,this,true);this.__Rk();qx.event.Registration.fireEvent(this.__Rh,f,qx.event.type.Event);}
;}
,__Rk:qx.core.Environment.select(b,{"mshtml":function(){var r=this;var q=qx.lang.Function.bind(this.__Rl,r);document.getElementsByTagName(o)[0].onmouseleave=q;}
,"default":(function(){}
)}),__Rl:function(e){try{e.stopPropagation();}
catch(s){}
;if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,a,this.__Rm,this,true);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession();}
;qx.bom.Element.removeListener(document.body,c,this.__Rl,this,true);}
,__tH:function(e){if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){return;}
;demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this.__QS);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().startSession(this.__QS);qx.event.Registration.addListener(document.body,a,this.__Rm,this,true);}
,__Rm:function(e){e.stopPropagation();var t=e.getDocumentLeft()-this.__Ri.left;var top=e.getDocumentTop()-this.__Ri.top;qx.event.Timer.once(function(){this.checkGroupBox(t,parseInt(this.getActiveBox().getData().width));this.onDragMove(top,t);}
,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance(),0);}
},destruct:function(){this.__QS=this.__Rh=this.__fe=this.__Ri=null;}
});}
)();
(function(){var a="width:",b="top",c="Boolean",d="px",f="border",g="left",h="demobrowser.demo.bom.portal.dragdrop.Manager",k="height:",l="paddingTop",m="opacity:0.5;margin:0;position:absolute;",n="end",o="left:",p="div",q="demobrowser.demo.bom.portal.box.Box",r="px;",s="paddingBottom",t="1px dashed red",u="ease-out",v="singleton",w="top:";qx.Class.define(h,{type:v,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__Rn={top:null,height:null};this.__Ro={top:0,left:0};}
,properties:{activeBox:{check:q,init:null,nullable:true},sessionActive:{check:c,init:false}},members:{__Rn:null,__Rp:null,__Rq:false,__Ro:null,__Rr:null,__Rs:null,startSession:function(y){this.setSessionActive(true);this.setActiveBox(y);this.__Rp=y.getGroupBoxId();this.__Rt();if(this.__Rr==null){this.__Rr={};var x=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxes();for(var i=0,j=x.length;i<j;i++ ){this.__Rr[x[i].element.id]={left:qx.bom.element.Location.getLeft(x[i].element),right:qx.bom.element.Location.getLeft(x[i].element)+qx.bom.element.Dimension.getWidth(x[i].element)};}
;}
;}
,__Rt:function(){if(!this.__Rs){this.__Rs=qx.dom.Element.create(p);}
;var B=this.getActiveBox().getElement();var z=qx.bom.element.Dimension.getContentSize(B);this.__Ru(B,this.__Rs);qx.bom.element.Class.add(this.__Rs,qx.bom.element.Class.get(B));var A=m+w+qx.bom.element.Location.getTop(B)+r+o+qx.bom.element.Location.getLeft(B)+r+a+z.width+r+k+z.height+d;qx.bom.element.Style.setCss(this.__Rs,A);qx.bom.element.Style.set(B,f,t);qx.dom.Node.getBodyElement(B).appendChild(this.__Rs);demobrowser.demo.bom.portal.box.Util.bringToFront(this.__Rs);}
,__Ru:function(C,D){while(C.firstChild){D.appendChild(C.firstChild);}
;}
,stopSession:function(e){this.setSessionActive(false);var I=this.getActiveBox();var G=I.getElement();demobrowser.demo.bom.portal.box.Manager.getInstance().updateGroupBoxMembers(I.getGroupBoxId(),this.__Rp,I);I.setGroupBoxId(this.__Rp);var F={left:qx.bom.element.Location.getLeft(this.__Rs)+d,top:qx.bom.element.Location.getTop(this.__Rs)+d};var H={left:qx.bom.element.Location.getLeft(G)+d,top:qx.bom.element.Location.getTop(G)+d};var J={timing:u,duration:300,keep:100,keyFrames:{'0':F,'100':H}};var E=qx.bom.element.Animation.animate(this.__Rs,J);E.addListener(n,function(){this.__Ru(this.__Rs,G);qx.bom.element.Style.reset(G,f);this.__Rs.parentNode.removeChild(this.__Rs);if(I.isActive()){I._applyActive(true);}
else {demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(I);}
;}
,this);}
,onDragMove:function(top,M){if(this.__Ro.left!=M){qx.bom.element.Style.set(this.__Rs,g,M+d);}
;if(this.__Ro.top!=top){qx.bom.element.Style.set(this.__Rs,b,top+d);}
;var K=this.getActiveBox().getElement();if(this.__Rn.top==null){this.__Rn.top=qx.bom.element.Location.getTop(K);}
;if(this.__Rn.height==null){this.__Rn.height=qx.bom.element.Dimension.getHeight(K);}
;if(this.__Rq==false&&top>=this.__Rn.top&&top<=(this.__Rn.top+this.__Rn.height)){return;}
;var L;if(this.__Rq){L=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__Rp));while(L!=null){if(this.__Rv(true,top,K,L)){this.__Rq=false;return;}
;L=qx.dom.Hierarchy.getNextElementSibling(L);}
;}
else {L=K;}
;if(top-this.__Ro.top>0){L=qx.dom.Hierarchy.getNextElementSibling(L);while(L!=null){if(L){if(this.__Rv(true,top,K,L)){return;}
;}
;L=qx.dom.Hierarchy.getNextElementSibling(L);}
;}
else {var L=qx.dom.Hierarchy.getPreviousElementSibling(L);while(L!=null){if(L){if(this.__Rv(false,top,K,L)){return;}
;}
;L=qx.dom.Hierarchy.getPreviousElementSibling(L);}
;}
;this.__Ro.left=M;this.__Ro.top=top;}
,__Rv:function(P,top,S,Q){var O=qx.bom.element.Location.getTop(Q);var T=parseInt(qx.bom.element.Style.get(Q,l));var N=parseInt(qx.bom.element.Style.get(Q,s));var U=qx.bom.element.Dimension.getContentHeight(Q)+N+T;var R;if(P){if(top>=(O+(U/3))){R=qx.dom.Hierarchy.getNextElementSibling(Q);if(R!=S||R==null){qx.dom.Element.insertAfter(S,Q);this.__Rn.top=qx.bom.element.Location.getTop(S);}
;return true;}
;}
else {if(top<=(O+U*2/3)){R=qx.dom.Hierarchy.getPreviousElementSibling(Q);if(R!=S||R==null){qx.dom.Element.insertBefore(S,Q);this.__Rn.top=qx.bom.element.Location.getTop(S);}
;return true;}
;}
;return false;}
,checkGroupBox:function(X,W){if(this.__Rr[this.__Rp].left<=X&&this.__Rr[this.__Rp].right>=X){return;}
;for(var V in this.__Rr){if(V!=this.__Rp){if(this.__Rr[V].left<=X+W&&this.__Rr[V].right>=X){this.__Rp=V;this.__Rq=true;return;}
;}
;}
;}
},destruct:function(){this.__Rn=this.__Ro=this.__Rp=null;this.__Rw=this.__Rs=this.__Rr=null;}
});}
)();
