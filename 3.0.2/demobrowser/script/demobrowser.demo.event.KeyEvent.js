...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.KeyEvent.009401468a26.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="logger",b="keyinput",c="keypress",d="",e="Char code",f="Ctrl",g="Key identifier",h="demobrowser.demo.event.KeyEvent",j="Shift",k="keydown",l="Event",m="Alt",n="keyup";qx.Class.define(h,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this._initLogger([l,g,e,j,f,m],document.getElementById(a),50);var o=[k,c,n,b];for(var i=0;i<o.length;i++ ){qx.bom.Element.addListener(document.documentElement,o[i],this.logKeyEvent,this);}
;}
,logKeyEvent:function(q){var p=q.getType();this._log([p,p!==b?q.getKeyIdentifier():d,p==b?q.getCharCode():d,q.isShiftPressed(),q.isCtrlPressed(),q.isAltPressed()]);q.preventDefault();}
}});}
)();
