...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage.c567bad58076.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var G=qx.util.ResourceManager.getInstance().toUri(x);var D={"width":j,"height":v,"position":C,"left":s,"top":s,"background":d+G+f};this.__Gd=new qx.html.Element(h,D);this.__Gd.addListener(a,this.__gH,this);this.__Gd.addListener(p,this.__gI,this);F.add(this.__Gd);}
,__gH:function(e){if(e.isMultiTouch()){this.__Mj=e.getRotation()+this.__Mi;this.__Mk=e.getScale()*this.__Mh;this.__Gd.setStyle(o,z+this.__Mj+i+this.__Mk+f);}
else {var I=parseInt(e.getDocumentLeft())-(parseInt(this.__Gd.getStyle(q))/2);var top=parseInt(e.getDocumentTop())-(parseInt(this.__Gd.getStyle(b))/2);this.__Gd.setStyles({"left":I+c,"top":top+c});}
;}
,__gI:function(e){if(e.isMultiTouch()){this.__Mi=this.__Mj;this.__Mh=this.__Mk;}
;}
}});}
)();
