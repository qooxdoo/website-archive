...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Validation.1baad4caa4d6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}});qx.Class.define(x,{extend:qx.core.Object,properties:{name:{init:J,validate:M},age:{init:18,validate:qx.util.Validate.number()},gender:{init:q,validate:qx.util.Validate.inArray([q,u])}},members:{__Sv:function(W){if(W.length<2){throw new qx.core.ValidationError(H+n+W+f);}
;}
}});}
)();
