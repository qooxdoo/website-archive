...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.726bf225981f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{model:{nullable:true,event:d,apply:g}},members:{_storage:null,__Gh:null,_applyModel:function(k,j){if(j){j.removeListenerById(this.__Gh);j.dispose();this.__Gh=null;}
;if(k){this.__Gh=k.addListener(f,this.__Gi,this);this.__Gi();}
else {this._storage.removeItem(this._key);}
;}
,__Gi:function(){var l=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,l);}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__Gj:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__Gk:null,__Gl:null,getLocal:function(){if(this.__Gk){return this.__Gk;}
;return this.__Gk=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__Gl){return this.__Gl;}
;return this.__Gl=new qx.bom.storage.Web(b);}
},construct:function(g){this.__nD=g;}
,members:{__nD:null,getStorage:function(){return window[this.__nD+c];}
,getLength:function(){return this.getStorage(this.__nD).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__nD).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__nD).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__nD).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__nD);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__nD).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__Gk:null,__Gl:null,__co:0,getLocal:function(){if(this.__Gk){return this.__Gk;}
;return this.__Gk=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__Gl){return this.__Gl;}
;return this.__Gl=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__Gm=document.createElement(f);this.__Gm.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__Gm);this.__Gm.addBehavior(j);this.__Gn=m;this.__Gm.load(this.__Gn);this.__eh={};this.__Go={};var l=this.__Gm.getAttribute(d+qx.bom.storage.UserData.__co);while(l!=undefined){l=qx.lang.Json.parse(l);this.__eh[l.key]=l.value;this.__Go[l.key]=d+qx.bom.storage.UserData.__co;qx.bom.storage.UserData.__co++ ;l=this.__Gm.getAttribute(d+qx.bom.storage.UserData.__co);}
;}
,members:{__Gm:null,__Gn:h,__eh:null,__Go:null,getStorage:function(){return this.__eh;}
,getLength:function(){return Object.keys(this.__eh).length;}
,setItem:function(n,p){if(this.__Go[n]){var o=this.__Go[n];}
else {var o=d+qx.bom.storage.UserData.__co;qx.bom.storage.UserData.__co++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__Gm.setAttribute(o,q);this.__Gm.save(this.__Gn);this.__eh[n]=p;this.__Go[n]=o;}
,getItem:function(r){return this.__eh[r]||null;}
,removeItem:function(v){var u=this.__Go[v];if(u==undefined){return;}
;this.__Gm.removeAttribute(u);qx.bom.storage.UserData.__co-- ;delete this.__eh[v];delete this.__Go[v];var t=d+qx.bom.storage.UserData.__co;if(this.__Gm.getAttribute(t)){var w=this.__Gm.getAttribute(d+qx.bom.storage.UserData.__co);this.__Gm.removeAttribute(t);this.__Gm.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__Go[s]=u;}
;this.__Gm.save(this.__Gn);}
,clear:function(){for(var x in this.__Go){this.__Gm.removeAttribute(this.__Go[x]);}
;this.__Gm.save(this.__Gn);this.__eh={};this.__Go={};}
,getKey:function(y){return Object.keys(this.__eh)[y];}
,forEach:function(z,B){var length=this.getLength();for(var i=0;i<length;i++ ){var A=this.getKey(i);z.call(B,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__Gk:null,__Gl:null,getLocal:function(){if(this.__Gk){return this.__Gk;}
;return this.__Gk=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__Gl){return this.__Gl;}
;return this.__Gl=new qx.bom.storage.Memory();}
},construct:function(){this.__eh={};}
,members:{__eh:null,getStorage:function(){return this.__eh;}
,getLength:function(){return Object.keys(this.__eh).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__eh[b]=c;}
,getItem:function(e){var d=this.__eh[e];if(qx.lang.Type.isString(d)){d=qx.lang.Json.parse(d);}
;return d;}
,removeItem:function(f){delete this.__eh[f];}
,clear:function(){this.__eh={};}
,getKey:function(h){var g=Object.keys(this.__eh);return g[h];}
