...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.2077acf7bfdb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="icon/",b=" / ",c="",d="folder.png",e="places/",f="demobrowser.demo.virtual.DemoLayer",g="network-server.png",h="row",i="mouseover",k="user-trash.png",l="foobar!",m="changeValue",n="column",o="network-workgroup.png",p="qx.ui.basic.Atom",q="/",r="user-desktop.png";qx.Class.define(f,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){qx.ui.virtual.layer.WidgetCell.call(this,this);this._pool={atom:[],checkbox:[]};this.__na=[];}
,members:{_pool:null,__na:null,getCellData:function(t,s){if(!this.__na[t]){this.__na[t]=[];}
;if(!this.__na[t][s]){this.__na[t][s]={label:this.__SI(),icon:this.__SJ()};}
;return this.__na[t][s];}
,getCellWidget:function(w,u){var v;if(u%2==0){v=this._pool.atom.pop();if(!v){v=new qx.ui.basic.Atom();v.addListener(i,function(){var x=this.__SJ();v.setIcon(x);this.__na[w][u].icon=x;}
,this);}
...
;}
,__SI:function(){var name=c;for(var j=0;j<10;j++ ){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);}
;return name;}
,__SJ:function(){var z=a;var B=e;var A=[d,k,g,o,r];var C=Math.floor(Math.random()*4);return (z+16+q+B+A[C]);}
},destruct:function(){this._pool=this.__na=null;}
});}
)();
