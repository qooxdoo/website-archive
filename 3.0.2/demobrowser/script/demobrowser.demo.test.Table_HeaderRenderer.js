...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_HeaderRenderer.83e12f1ebf0a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Name",b="hovered",c="tool tip",d="icon/16/apps/internet-feed-reader.png",f="mouseover",g="demobrowser.demo.test.Table_HeaderRenderer",h="_container",i="mouseout";qx.Class.define(g,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Standalone.prototype.main.call(this);this.setUp();this.testDefaultRenderer();this.testIconRenderer();}
...
,testDefaultRenderer:function(){var l=new qx.ui.table.headerrenderer.Default();l.setToolTip(c);var j={name:[a],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};var k=this._getNewHeaderContainer();qx.util.Permutation.permute(j,function(n){var m=l.createHeaderCell(n);k.add(m);l.updateHeaderCell(n,m);}
);}
,testIconRenderer:function(){var q=new qx.ui.table.headerrenderer.Icon(d);q.setToolTip(c);var o={name:[a],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};var p=this._getNewHeaderContainer();qx.util.Permutation.permute(o,function(s){var r=q.createHeaderCell(s);p.add(r);q.updateHeaderCell(s,r);}
);}
,_getNewHeaderContainer:function(){var t=new qx.ui.container.Composite(new qx.ui.layout.HBox(5));t.addListener(f,function(e){e.getTarget().addState(b);}
);t.addListener(i,function(e){e.getTarget().removeState(b);}
...
(function(){var a="qx.ui.table.headerrenderer.Icon",b="String",c="";qx.Class.define(a,{extend:qx.ui.table.headerrenderer.Default,construct:function(d,e){qx.ui.table.headerrenderer.Default.call(this);if(d==null){d=c;}
