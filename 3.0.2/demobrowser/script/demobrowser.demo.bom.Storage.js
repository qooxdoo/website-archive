...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Storage.c5a48d21bbf7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="<em>no content</em>",b="Memory Storage",c="click",d="html.storage.userdata",e="",f="list",g="save",h="value",i="Web Storage",j="demobrowser.demo.bom.Storage",k="<br>",l="userData Storage",m="clear",n="html.storage.local",o=":",p="using",q="remove",r="key";qx.Class.define(j,{extend:qx.application.Native,members:{__eh:null,main:function(){qx.application.Native.prototype.main.call(this);this.setUsing();this.__eh=qx.bom.Storage.getLocal();var u=document.getElementById(g);var s=document.getElementById(m);var t=document.getElementById(q);var self=this;qx.bom.Event.addNativeListener(u,c,function(){var v=qx.bom.Input.getValue(document.getElementById(r));var w=qx.bom.Input.getValue(document.getElementById(h));self.__eh.setItem(v,w);self.updateList();}
);qx.bom.Event.addNativeListener(s,c,function(){self.__eh.clear();self.updateList();}
);qx.bom.Event.addNativeListener(t,c,function(){self.__eh.removeItem(self.__eh.getKey(0));self.updateList();}
);this.updateList();}
,updateList:function(){var x=document.getElementById(f);x.innerHTML=e;this.__eh.forEach(function(y,z){x.innerHTML+=y+o+z+k;}
