...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.628fb0b9ac81.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="touchmove",b="black",c="#333",d="px",f="border-left",g="green",h="div",i="100%",j="demobrowser.demo.mobile.PingPong",k="0",l="200px",m="30px",n="qx.debug",o="interval",p="0px",q="12px",r="15em",s="center",t="100px",u="1px solid white",v='Lucida Grande',w="innerHTML",z="top",A="right",B="Arial",C="50%",D="<b>This demo is supposed to be run in a WebKit-based browser.</b>",E="engine.name",F="20px",G="webkit",H="none",I="border-right",J="white",K="left",L="absolute";qx.Class.define(j,{extend:qx.application.Native,members:{__RI:null,__RJ:null,__RK:null,__RL:null,__RM:5,__RN:1,__RO:1,__RP:null,__RQ:null,__RR:null,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(n)){qx.log.appender.Native;qx.log.appender.Console;}
...
;var M=this.__RV(K);R.add(M);var N=this.__RV(A);R.add(N);this.__RJ=this.__RW(K);M.add(this.__RJ);M.addListener(a,qx.lang.Function.bind(this.__gH,this,this.__RJ),this);this.__RI=this.__RW(A);N.add(this.__RI);N.addListener(a,qx.lang.Function.bind(this.__gH,this,this.__RI),this);this.__RK=this.__RX();R.add(this.__RK);this.__RQ=this.__RY();M.add(this.__RQ);this.__RR=this.__RY();N.add(this.__RR);this.__RP=[0,0];this.__RS();}
,__RS:function(){this.__RK.setStyles({"left":l,"top":l});this.__RL=new qx.event.Timer(40);this.__RL.addListener(o,function(){var x=(parseInt(this.__RK.getStyle(K))+this.__RM*this.__RN);var y=(parseInt(this.__RK.getStyle(z))+this.__RM*this.__RO);this.__RK.setStyle(K,x+d);this.__RK.setStyle(z,y+d);this.__RU();}
,this);this.__RL.start();}
,__RT:function(S){this.__RL.stop();this.__RL.dispose();this.__RM=5;this.__RP[S]=this.__RP[S]+1;this.__RQ.setAttribute(w,this.__RP[0]);this.__RR.setAttribute(w,this.__RP[1]);this.__RS();}
,__RU:function(){var U=this.getBoundsFor(this.__RK);if(U.top<=0){this.__RO=1;}
;if(U.bottom>=window.innerHeight-5){this.__RO=-1;}
;if(U.left<=0||U.right>=window.innerWidth){this.__RT(U.left<=0?1:0);}
;var V=this.getBoundsFor(this.__RJ);if(U.left<=V.right&&U.bottom>=V.top&&U.top<=V.bottom){this.__RN=1;this.__RM=Math.min(this.__RM+1,20);}
;var T=this.getBoundsFor(this.__RI);if(U.right>=T.left&&U.bottom>=T.top&&U.top<=T.bottom){this.__RN=-1;this.__RM=Math.min(this.__RM+1,20);}
;}
,__gH:function(W,e){W.setStyles({"top":(e.getDocumentTop()-50)+d});}
,getBoundsFor:function(X){return qx.bom.element.Location.get(X.getDomElement());}
,__RV:function(ba){var Y={"width":C,"height":i,"position":L,"backgroundColor":b};if(ba==K){Y[I]=u;}
else {Y[K]=C;Y[f]=u;}
;return new qx.html.Element(h,Y);}
,__RW:function(bc){var bb={"width":m,"height":t,"top":t,"position":L,"backgroundColor":J};bb[bc]=F;return new qx.html.Element(h,bb);}
,__RX:function(){var bd={"width":F,"height":F,"position":L,"backgroundColor":J,"userSelect":H};return new qx.html.Element(h,bd);}
,__RY:function(){var be={"width":i,"height":i,"textAlign":s,"fontSize":r,"color":c,"fontFamily":B};var bf=new qx.html.Element(h,be);bf.setAttribute(w,k);return bf;}
}});}
)();
