...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.UIDeclaration.73a6e1d55736.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,addFromDefinition:function(F){var G=this.getRoot();this.__Bt(G,F);}
,__Bt:function(M,H){var I=new H.clazz();var L=qx.lang.Object.clone(H);delete L.clazz;delete L.layout;delete L.children;delete L.id;delete L.listeners;I.set(L);if(H.id!=null){this[H.id]=I;}
;if(H.layout!=null){var J=new H.layout.clazz();var L=qx.lang.Object.clone(H.layout);delete L.clazz;J.set(L);I.setLayout(J);}
;var N=H.children;if(N!=null){for(var i=0;i<N.length;i++ ){if(I instanceof qx.ui.form.Form){this.__Su(I,N[i]);}
else {this.__Bt(I,N[i]);}
;}
;}
...
;}
;}
,__Su:function(Q,O){if(O.type===v){Q.addGroupHeader(O.label);return;}
