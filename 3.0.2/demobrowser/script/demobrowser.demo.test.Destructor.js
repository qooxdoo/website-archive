...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor.8ba1ba0a6944.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Window: ",b="interval",c=")",d="Done! (Registry: ",e="Label: ",f=" (Registry: ",g="__ik",h="demobrowser.demo.test.Destructor",j="Round: ";qx.Class.define(h,{extend:qx.application.Standalone,members:{__cN:null,__Sm:0,__ik:null,main:function(){qx.application.Standalone.prototype.main.call(this);this.__cN=[];this.currentTest=this.testWindows;this.__ik=new qx.event.Timer(1000);this.__ik.addListener(b,this.runTest,this);this.__ik.start();}
,runTest:function(){this.__Sm++ ;var m=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug(j+this.__Sm+f+m+c);this.currentTest();qx.ui.core.queue.Manager.flush();var k=this.__cN;for(var i=0,l=k.length;i<l;i++ ){k[i].destroy();}
;k.length=0;qx.ui.core.queue.Manager.flush();var m=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug(d+m+c);}
,testLabels:function(){for(var i=0;i<250;i++ ){var n=new qx.ui.basic.Label(e+i);this.getRoot().add(n,{left:50,top:50+i*20});this.__cN.push(n);}
;}
,testWindows:function(){for(var i=0;i<5;i++ ){var o=new qx.ui.window.Window(a+i);o.open();this.__cN.push(o);}
;}
