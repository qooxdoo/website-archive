...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.ScrollContainer_EdgeCaseWidth","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.ScrollContainer_EdgeCaseWidth.7d393d3baa06.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="ScrollbarX:",b="ScrollbarY:",c="Toggle content",d="blue",f="changeSelection",g="black",h="auto",i="value",j="Off",k="white",l="demobrowser.demo.test.ScrollContainer_EdgeCaseWidth",m="off",n="On",o="Content size: 300x300",p="Toggle pane",q="solid",r="Auto",s="execute",t="on";qx.Class.define(l,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var v=new qx.ui.container.Scroll();v.set({width:300,height:200});this.getRoot().add(v,{left:10,top:10});v.add(this.generateBox());var x=new qx.ui.form.Button(p);var A=true;x.addListener(s,function(){v.setHeight(A?300:200);A=!A;}
);this.getRoot().add(x,{left:330,top:20});var w=new qx.ui.form.Button(c);var z=true;w.addListener(s,function(){v.getChildren()[0].setHeight(z?100:300);z=!z;}
);this.getRoot().add(w,{left:430,top:20});var y=this.generateScrollbarConfig(a,100);var u=this.generateScrollbarConfig(b,120);y.addListener(f,function(e){v.setScrollbarX(e.getData()[0].getUserData(i));}
);u.addListener(f,function(e){v.setScrollbarY(e.getData()[0].getUserData(i));}
);}
,generateScrollbarConfig:function(F,top){var E=new qx.ui.container.Composite(new qx.ui.layout.HBox(6));var F=new qx.ui.basic.Label(F);F.setMarginRight(20);var B=new qx.ui.form.RadioButton(r);var D=new qx.ui.form.RadioButton(n);var C=new qx.ui.form.RadioButton(j);B.setUserData(i,h);D.setUserData(i,t);C.setUserData(i,m);B.setValue(true);var G=new qx.ui.form.RadioGroup(B,D,C);E.add(F);E.add(B);E.add(D);E.add(C);this.getRoot().add(E,{left:330,top:top});return G;}
,generateBox:function(){var H=new qx.ui.basic.Label(o).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:d,textColor:k,padding:10,decorator:new qx.ui.decoration.Decorator().set({width:4,style:q,color:g})});return H;}
,__Hz:null}});}
)();
