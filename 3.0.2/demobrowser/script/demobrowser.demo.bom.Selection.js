...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Selection.e200f4e8f459.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="text",b="getEnd",c="margin: 4px 0px",d="demobrowser.demo.bom.Selection",f="getEndSelectionDocument",g="div",h="getSelectionInput",i="this is a test",j="button",k="setSelectionInput",l="results",m="width:300px;height:250px",n="getStartSelectionDocument",o="setSelectionDocument",p="textarea",q="margin-right: 8px",r="border:1px solid darkgrey;",s="test\ntest2\ntest3\ntest4\ntest5",t="<strong>Results</strong>",u="background-color: lightgrey",v="getStart",w="test test2 test3 test4 test5 test6",x="container",y="textfield",z="areaContainer",A="position:relative;padding:20px",B="width:20%;margin-right:10px",C="margin-bottom:20px",D="width:500px;height:200px;",E="click",F="textContainer",G="test text",H="setSelectionTextarea",I="inputContainer",J="width:100%;margin-bottom:20px",K="<br/>",L="plaintext",M="getSelectionDocument",N="getSelectionTextarea",O="textBlock",P="margin: 4px";qx.Class.define(d,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var T=qx.dom.Element.create(g,{id:x,style:A});var bj=qx.dom.Element.create(g,{id:F,style:J});qx.dom.Element.insertEnd(bj,T);var bd=qx.dom.Element.create(g,{id:O,style:C});bd.innerHTML=w;qx.dom.Element.insertEnd(bd,bj);var bg=qx.bom.Input.create(j,{value:M,style:P});qx.bom.Element.addListener(bg,E,this._getSelection,document);qx.dom.Element.insertEnd(bg,bj);var W=qx.bom.Input.create(j,{value:o,style:P});qx.bom.Element.addListener(W,E,function(e){qx.bom.Selection.set(document.getElementById(L).firstChild,0,4);this.debug(qx.bom.Selection.getLength(document));}
,this);qx.dom.Element.insertEnd(W,bj);var X=qx.bom.Input.create(j,{value:n,style:P});qx.bom.Element.addListener(X,E,this._getStart,document);qx.dom.Element.insertEnd(X,bj);var R=qx.bom.Input.create(j,{value:f,style:P});qx.bom.Element.addListener(R,E,this._getEnd,document);qx.dom.Element.insertEnd(R,bj);var V=qx.dom.Element.create(g,{id:I,style:J});qx.dom.Element.insertEnd(V,T);this._input=qx.bom.Input.create(a,{id:y,value:G,style:B});qx.dom.Element.insertEnd(this._input,V);var ba=qx.bom.Input.create(j,{value:h,style:q});qx.bom.Element.addListener(ba,E,this._getSelection,this._input);qx.dom.Element.insertEnd(ba,V);var bh=qx.bom.Input.create(j,{value:k,style:q});qx.bom.Element.addListener(bh,E,this._setSelection,this._input);qx.dom.Element.insertEnd(bh,V);var be=qx.bom.Input.create(j,{value:v,style:q});qx.bom.Element.addListener(be,E,this._getStart,this._input);qx.dom.Element.insertEnd(be,V);var bk=qx.bom.Input.create(j,{value:b,style:q});qx.bom.Element.addListener(bk,E,this._getEnd,this._input);qx.dom.Element.insertEnd(bk,V);var S=qx.dom.Element.create(g,{id:z,style:J});qx.dom.Element.insertEnd(S,T);this._textArea=qx.bom.Input.create(p,{id:p,rows:7,cols:20,value:s,style:m});qx.dom.Element.insertEnd(this._textArea,S);var bf=qx.bom.Input.create(j,{value:N,style:q});qx.bom.Element.addListener(bf,E,this._getSelection,this._textArea);qx.dom.Element.insertEnd(bf,S);var Y=qx.bom.Input.create(j,{value:H,style:q});qx.bom.Element.addListener(Y,E,this._setSelection,this._textArea);qx.dom.Element.insertEnd(Y,S);var Q=qx.bom.Input.create(j,{value:v,style:q});qx.bom.Element.addListener(Q,E,this._getStart,this._textArea);qx.dom.Element.insertEnd(Q,S);var bi=qx.bom.Input.create(j,{value:b,style:q});qx.bom.Element.addListener(bi,E,this._getEnd,this._textArea);qx.dom.Element.insertEnd(bi,S);var bb=qx.dom.Element.create(g,{style:c});bb.innerHTML=t;var U=qx.dom.Element.create(g,{id:l,style:D+r+u});qx.dom.Element.insertEnd(bb,T);qx.dom.Element.insertEnd(U,T);var bc=qx.dom.Element.create(g,{id:L});bc.innerHTML=i;qx.dom.Element.insertEnd(bc,document.body);qx.dom.Element.insertEnd(T,document.body);}
,_getSelection:function(e){document.getElementById(l).innerHTML=qx.bom.Selection.get(this)+K+qx.bom.Selection.getLength(this);}
