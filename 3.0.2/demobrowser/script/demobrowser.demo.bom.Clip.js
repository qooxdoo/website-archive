...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Clip","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Clip.0562576797f3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Setting to: 20,null  120,40",b="Setting to: 20,20  120,40",c="Setting to: null,20  120,40",d="Clip init: ",e="test1",f="demobrowser.demo.bom.Clip",g="Clip after: ",h="  ",i="Resetting",j="Setting to: 20,20  null,40",k="Setting to: 20,20  120,null",l=",";qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);window.APPLICATION=this;var m=document.getElementById(e);var n=qx.bom.element.Clip.get(m)||{};qx.log.Logger.debug(d+n.left+l+n.top+h+n.width+l+n.height);}
,set0:function(){var o=document.getElementById(e);qx.log.Logger.debug(b);qx.bom.element.Clip.set(o,{left:20,top:20,width:120,height:40});var p=qx.bom.element.Clip.get(o)||{};qx.log.Logger.debug(g+p.left+l+p.top+h+p.width+l+p.height);}
,set1:function(){var q=document.getElementById(e);qx.log.Logger.debug(j);qx.bom.element.Clip.set(q,{left:20,top:20,height:40});var r=qx.bom.element.Clip.get(q)||{};qx.log.Logger.debug(g+r.left+l+r.top+h+r.width+l+r.height);}
,set2:function(){var s=document.getElementById(e);qx.log.Logger.debug(k);qx.bom.element.Clip.set(s,{left:20,top:20,width:120});var t=qx.bom.element.Clip.get(s)||{};qx.log.Logger.debug(g+t.left+l+t.top+h+t.width+l+t.height);}
,set3:function(){var u=document.getElementById(e);qx.log.Logger.debug(c);qx.bom.element.Clip.set(u,{top:20,width:120,height:40});var v=qx.bom.element.Clip.get(u)||{};qx.log.Logger.debug(g+v.left+l+v.top+h+v.width+l+v.height);}
,set4:function(){var w=document.getElementById(e);qx.log.Logger.debug(a);qx.bom.element.Clip.set(w,{left:20,width:120,height:40});var x=qx.bom.element.Clip.get(w)||{};qx.log.Logger.debug(g+x.left+l+x.top+h+x.width+l+x.height);}
,reset:function(){var y=document.getElementById(e);qx.log.Logger.debug(i);qx.bom.element.Clip.reset(y);var z=qx.bom.element.Clip.get(y)||{};qx.log.Logger.debug(g+z.left+l+z.top+h+z.width+l+z.height);}
}});}
)();
