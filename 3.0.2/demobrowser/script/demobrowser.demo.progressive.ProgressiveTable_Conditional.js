...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Conditional.5f8db260d78d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="regex cannot be null!",b="font-weight",c="==",d="Condition not recognized or value1/value2 is null!",e="Condition not recognized or value is null!",f="",g=">",h="text-align",j="between",k="regex",l="<",m='g',n="qx.ui.progressive.renderer.table.cell.Conditional",o=":",p=";",q="!between",r=">=",s="color",t="font-style",u="!=",v="<=";qx.Class.define(n,{extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(y,w,x,z){qx.ui.progressive.renderer.table.cell.Abstract.call(this);this.__EX=[c,u,g,l,r,v];this.__EY=[j,q];this.__Fa=[];this.__yS=y||f;this.__yT=w||f;this.__yU=x||f;this.__yV=z||f;}
,members:{__EX:null,__EY:null,__Fa:null,__yS:null,__yT:null,__yU:null,__yV:null,__yW:function(B,A){if(B.align){A[h]=B.align;}
;if(B.color){A[s]=B.color;}
;if(B.style){A[t]=B.style;}
;if(B.weight){A[b]=B.weight;}
;}
,addNumericCondition:function(I,H,G,F,C,E,D){if(!qx.lang.Array.contains(this.__EX,I)||H==null){throw new Error(e);}
;this.__Fa.push({condition:I,align:G,color:F,style:C,weight:E,value1:H,target:D});}
,addBetweenCondition:function(Q,P,O,N,M,J,L,K){if(!qx.lang.Array.contains(this.__EY,Q)||P==null||O==null){throw new Error(d);}
;this.__Fa.push({condition:Q,align:N,color:M,style:J,weight:L,value1:P,value2:O,target:K});}
,addRegex:function(R,W,V,S,U,T){if(!R){throw new Error(a);}
;this.__Fa.push({condition:k,align:W,color:V,style:S,weight:U,regex:R,target:T});}
,_getCellStyle:function(bb){if(this.__Fa.length==0){return bb.style||f;}
;var i;var bc;var X;var ba={"text-align":this.__yS,"color":this.__yT,"font-style":this.__yU,"font-weight":this.__yV};for(i=0;i<this.__Fa.length;i++ ){var bf=this.__Fa[i];bc=false;if(qx.lang.Array.contains(this.__EX,bf.condition)){if(bf.target==null){X=bb.cellData;}
...
;break;};}
else if(qx.lang.Array.contains(this.__EY,bf.condition)){if(bf.target==null){X=bb.cellData;}
else {X=bb.element.data[bf.target];}
...
;if(bc){this.__yW(bf,ba);}
;var bd=[];for(var be in ba){if(ba[be]){bd.push(be,o,ba[be],p);}
;}
;}
;return bd.join(f);}
},destruct:function(){this.__EX=this.__EY=this.__Fa=null;}
});}
)();
