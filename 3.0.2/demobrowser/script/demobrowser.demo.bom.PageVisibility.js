...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.2875db3f181c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__sJ=document||window.document;this.__JH();var self=this;qx.bom.Event.addNativeListener(this.__sJ,this.__JG,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__sJ:null,__JE:null,__JF:null,__JG:null,__JH:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__sJ[m]!=undefined){this.__JE=m;this.__JG=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__sJ[m]!=undefined){this.__JF=m;break;}
;}
;if(this.__JE==null){this.__JE=k;this.__JG=c;}
;if(this.__JF==null){this.__JF=b;}
;}
,isHidden:function(){return !!this.__sJ[this.__JE];}
,getVisibilityState:function(){return this.__sJ[this.__JF]||d;}
}});}
)();
