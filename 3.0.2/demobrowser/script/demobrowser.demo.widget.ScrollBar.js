...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ScrollBar.dc9b006581c7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="horizontal",b="demobrowser.demo.widget.ScrollBar",c="vertical",d="scroll",f="Value: ";qx.Class.define(b,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({padding:20});this.getRoot().add(h,{edge:0});var j=new qx.ui.basic.Label(f).set({padding:30});h.add(j,{row:0,column:0});var i=new qx.ui.core.scroll.ScrollBar(c).set({height:200,maximum:500});i.addListener(d,function(e){g.setPosition(e.getData());}
);h.add(i,{row:0,column:1});var g=new qx.ui.core.scroll.NativeScrollBar(a).set({width:300,maximum:500});g.addListener(d,function(e){i.setPosition(e.getData());j.setValue(f+e.getData());}
