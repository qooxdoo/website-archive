...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.SelectBox.ef9d8aef66ab.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="qx.debug.databinding",b=". Error message: ",c="Boolean",d="Data after conversion: ",f="set",g="deepBinding",h=")",k=") to the object '",l="item",m="Can not remove the bindings for null object!",n="Please use only one array at a time: ",p="Binding executed from ",q="Integer",r="reset",s=" of object ",t="qx.event.type.Data",u="qx.data.SingleValueBinding",v="No number or 'last' value hast been given",w="Binding property ",x="Failed so set value ",y="change",z="qx.debug",A="Binding could not be found!",B="get",C="^",D=" does not work.",E="String",F=" to ",G="Binding from '",H="",I=" (",J="PositiveNumber",K="Data before conversion: ",L="]",M="[",N=".",O="PositiveInteger",P="' (",Q=" on ",R="Binding does not exist!",S="Number",T=" in an array binding: ",U=" is not an data (qx.event.type.Data) event on ",V=").",W=" by ",X="Date",Y=" not possible: No event available. ",bb="last";qx.Class.define(u,{statics:{__bc:{},bind:function(bf,bs,bq,bh,bp){var bt=this.__be(bf,bs,bq,bh,bp);var bj=bs.split(N);var be=this.__bk(bj);var bn=[];var bi=[];var bk=[];var bo=[];var bg=bf;try{for(var i=0;i<bj.length;i++ ){if(be[i]!==H){bo.push(y);}
else {bo.push(this.__bf(bg,bj[i]));}
;bn[i]=bg;if(i==bj.length-1){if(be[i]!==H){var bv=be[i]===bb?bg.length-1:be[i];var bd=bg.getItem(bv);this.__bj(bd,bq,bh,bp,bf);bk[i]=this.__bl(bg,bo[i],bq,bh,bp,be[i]);}
else {if(bj[i]!=null&&bg[B+qx.lang.String.firstUp(bj[i])]!=null){var bd=bg[B+qx.lang.String.firstUp(bj[i])]();this.__bj(bd,bq,bh,bp,bf);}
;bk[i]=this.__bl(bg,bo[i],bq,bh,bp);}
;}
else {var bc={index:i,propertyNames:bj,sources:bn,listenerIds:bk,arrayIndexValues:be,targetObject:bq,targetPropertyChain:bh,options:bp,listeners:bi};var bm=qx.lang.Function.bind(this.__bd,this,bc);bi.push(bm);bk[i]=bg.addListener(bo[i],bm);}
...
;}
;throw bw;}
;var bu={type:g,listenerIds:bk,sources:bn,targetListenerIds:bt.listenerIds,targets:bt.targets};this.__bm(bu,bf,bs,bq,bh);return bu;}
,__bd:function(bD){if(bD.options&&bD.options.onUpdate){bD.options.onUpdate(bD.sources[bD.index],bD.targetObject);}
...
;this.__bh(bD.targetObject,bD.targetPropertyChain,bF);}
else {this.__bg(bD.targetObject,bD.targetPropertyChain);}
;break;}
;if(j==bD.propertyNames.length-1){if(qx.Class.implementsInterface(bB,qx.data.IListData)){var bG=bD.arrayIndexValues[j]===bb?bB.length-1:bD.arrayIndexValues[j];var by=bB.getItem(bG);this.__bj(by,bD.targetObject,bD.targetPropertyChain,bD.options,bD.sources[bD.index]);bD.listenerIds[j]=this.__bl(bB,y,bD.targetObject,bD.targetPropertyChain,bD.options,bD.arrayIndexValues[j]);}
else {if(bD.propertyNames[j]!=null&&bB[B+qx.lang.String.firstUp(bD.propertyNames[j])]!=null){var by=bB[B+qx.lang.String.firstUp(bD.propertyNames[j])]();this.__bj(by,bD.targetObject,bD.targetPropertyChain,bD.options,bD.sources[bD.index]);}
;var bz=this.__bf(bB,bD.propertyNames[j]);bD.listenerIds[j]=this.__bl(bB,bz,bD.targetObject,bD.targetPropertyChain,bD.options);}
;}
else {if(bD.listeners[j]==null){var bA=qx.lang.Function.bind(this.__bd,this,bD);bD.listeners.push(bA);}
;if(qx.Class.implementsInterface(bB,qx.data.IListData)){var bz=y;}
else {var bz=this.__bf(bB,bD.propertyNames[j]);}
;bD.listenerIds[j]=bB.addListener(bz,bD.listeners[j]);}
;}
;}
,__be:function(bI,bQ,bU,bM,bO){var bL=bM.split(N);var bJ=this.__bk(bL);var bT=[];var bS=[];var bN=[];var bR=[];var bK=bU;for(var i=0;i<bL.length-1;i++ ){if(bJ[i]!==H){bR.push(y);}
else {try{bR.push(this.__bf(bK,bL[i]));}
catch(e){break;}
;}
...
else {try{var bW=qx.data.SingleValueBinding.__bf(bX,bL[j]);}
catch(e){break;}
;}
...
,updateTarget:function(ca,cd,cf,cb,ce){var cc=this.resolvePropertyChain(ca,cd);cc=qx.data.SingleValueBinding.__bn(cc,cf,cb,ce,ca);this.__bh(cf,cb,cc);}
,resolvePropertyChain:function(o,cj){var ci=this.__bi(o,cj);var ck;if(ci!=null){var cm=cj.substring(cj.lastIndexOf(N)+1,cj.length);if(cm.charAt(cm.length-1)==L){var cg=cm.substring(cm.lastIndexOf(M)+1,cm.length-1);var ch=cm.substring(0,cm.lastIndexOf(M));var cl=ci[B+qx.lang.String.firstUp(ch)]();if(cg==bb){cg=cl.length-1;}
;if(cl!=null){ck=cl.getItem(cg);}
;}
else {ck=ci[B+qx.lang.String.firstUp(cm)]();}
;}
;return ck;}
,__bf:function(co,cp){var cn=this.__bo(co,cp);if(cn==null){if(qx.Class.supportsEvent(co.constructor,cp)){cn=cp;}
...
;}
;return cn;}
,__bg:function(cs,cq){var cr=this.__bi(cs,cq);if(cr!=null){var ct=cq.substring(cq.lastIndexOf(N)+1,cq.length);if(ct.charAt(ct.length-1)==L){this.__bh(cs,cq,null);return;}
;if(cr[r+qx.lang.String.firstUp(ct)]!=undefined){cr[r+qx.lang.String.firstUp(ct)]();}
else {cr[f+qx.lang.String.firstUp(ct)](null);}
;}
;}
,__bh:function(cA,cw,cx){var cv=this.__bi(cA,cw);if(cv!=null){var cB=cw.substring(cw.lastIndexOf(N)+1,cw.length);if(cB.charAt(cB.length-1)==L){var cu=cB.substring(cB.lastIndexOf(M)+1,cB.length-1);var cy=cB.substring(0,cB.lastIndexOf(M));var cz=cA;if(!qx.Class.implementsInterface(cz,qx.data.IListData)){cz=cv[B+qx.lang.String.firstUp(cy)]();}
...
;}
;}
,__bi:function(cH,cE){var cG=cE.split(N);var cD=cH;for(var i=0;i<cG.length-1;i++ ){try{var cF=cG[i];if(cF.indexOf(L)==cF.length-1){var cC=cF.substring(cF.indexOf(M)+1,cF.length-1);cF=cF.substring(0,cF.indexOf(M));}
...
;}
;return cD;}
,__bj:function(cN,cJ,cL,cM,cK){cN=this.__bn(cN,cJ,cL,cM,cK);if(cN===undefined){this.__bg(cJ,cL);}
;if(cN!==undefined){try{this.__bh(cJ,cL,cN);if(cM&&cM.onUpdate){cM.onUpdate(cK,cJ,cN);}
;}
...
;}
;}
,__bk:function(cO){var cP=[];for(var i=0;i<cO.length;i++ ){var name=cO[i];if(qx.lang.String.endsWith(name,L)){var cQ=name.substring(name.indexOf(M)+1,name.indexOf(L));if(name.indexOf(L)!=name.length-1){throw new Error(n+name+D);}
...
;}
;return cP;}
,__bl:function(cR,cU,da,cX,cV,cT){if(qx.core.Environment.get(z)){var cS=qx.Class.getEventType(cR.constructor,cU);qx.core.Assert.assertEquals(t,cS,cU+U+cR+N);}
;var cW=function(dd,e){if(dd!==H){if(dd===bb){dd=cR.length-1;}
;var de=cR.getItem(dd);if(de===undefined){qx.data.SingleValueBinding.__bg(da,cX);}
...
;de=qx.data.SingleValueBinding.__bn(de,da,cX,cV,cR);if(qx.core.Environment.get(a)){qx.log.Logger.debug(d+de);}
;try{if(de!==undefined){qx.data.SingleValueBinding.__bh(da,cX,de);}
else {qx.data.SingleValueBinding.__bg(da,cX);}
...
,__bm:function(dk,dg,dj,dh,di){if(this.__bc[dg.toHashCode()]===undefined){this.__bc[dg.toHashCode()]=[];}
;this.__bc[dg.toHashCode()].push([dk,dg,dj,dh,di]);}
,__bn:function(dp,du,dn,dq,dl){if(dq&&dq.converter){var dr;if(du.getModel){dr=du.getModel();}
;return dq.converter(dp,dr,dl,du);}
else {var dm=this.__bi(du,dn);var dv=dn.substring(dn.lastIndexOf(N)+1,dn.length);if(dm==null){return dp;}
;var ds=qx.Class.getPropertyDefinition(dm.constructor,dv);var dt=ds==null?H:ds.check;return this.__bp(dp,dt);}
;}
,__bo:function(dw,dy){var dx=qx.Class.getPropertyDefinition(dw.constructor,dy);if(dx==null){return null;}
;return dx.event;}
,__bp:function(dB,dA){var dz=qx.lang.Type.getClass(dB);if((dz==S||dz==E)&&(dA==q||dA==O)){dB=parseInt(dB,10);}
...
;var dD=this.__bc[dC.toHashCode()];if(dD!=undefined){for(var i=0;i<dD.length;i++ ){if(dD[i][0]==dE){qx.lang.Array.remove(dD,dD[i]);return;}
;}
;}
;throw new Error(A);}
,removeAllBindingsForObject:function(dG){if(qx.core.Environment.get(z)){qx.core.Assert.assertNotNull(dG,m);}
;var dF=this.__bc[dG.toHashCode()];if(dF!=undefined){for(var i=dF.length-1;i>=0;i-- ){this.removeBindingFromObject(dG,dF[i][0]);}
;}
;}
,getAllBindingsForObject:function(dH){if(this.__bc[dH.toHashCode()]===undefined){this.__bc[dH.toHashCode()]=[];}
;return this.__bc[dH.toHashCode()];}
,removeAllBindings:function(){for(var dJ in this.__bc){var dI=qx.core.ObjectRegistry.fromHashCode(dJ);if(dI==null){delete this.__bc[dJ];continue;}
;this.removeAllBindingsForObject(dI);}
;this.__bc={};}
,getAllBindings:function(){return this.__bc;}
,showBindingInLog:function(dL,dN){var dM;for(var i=0;i<this.__bc[dL.toHashCode()].length;i++ ){if(this.__bc[dL.toHashCode()][i][0]==dN){dM=this.__bc[dL.toHashCode()][i];break;}
;}
;if(dM===undefined){var dK=R;}
else {var dK=G+dM[1]+P+dM[2]+k+dM[3]+P+dM[4]+V;}
;qx.log.Logger.debug(dK);}
,showAllBindingsInLog:function(){for(var dP in this.__bc){var dO=qx.core.ObjectRegistry.fromHashCode(dP);for(var i=0;i<this.__bc[dP].length;i++ ){this.showBindingInLog(dO,this.__bc[dP][i][0]);}
;}
;}
}});}
)();
...
,__bw:function(){return window.controllers&&window.navigator.product===j&&window.navigator.userAgent.indexOf(k)==-1&&window.navigator.userAgent.indexOf(m)==-1;}
...
(function(){var a="qx.core.BaseInit",b="engine.name",c="Main runtime: ",d="",f="qx.application",g="os.name",h="engine.version",i="Missing application class: ",j="Load runtime: ",k="ms",l="Could not detect engine!",m="Finalize runtime: ",n="Could not detect operating system!",o="Could not detect the version of the engine!";qx.Class.define(a,{statics:{__kr:null,getApplication:function(){return this.__kr||null;}
,ready:function(){if(this.__kr){return;}
...
;qx.log.Logger.debug(this,j+(new Date-qx.Bootstrap.LOADSTART)+k);var q=qx.core.Environment.get(f);var r=qx.Class.getByName(q);if(r){this.__kr=new r;var p=new Date;this.__kr.main();qx.log.Logger.debug(this,c+(new Date-p)+k);var p=new Date;this.__kr.finalize();qx.log.Logger.debug(this,m+(new Date-p)+k);}
else {qx.log.Logger.warn(i+q);}
;}
,__ks:function(e){var s=this.__kr;if(s){s.close();}
;}
,__kt:function(){var t=this.__kr;if(t){t.terminate();}
...
;return M;}
,__dt:{"Windows NT 6.3":K,"Windows NT 6.2":H,"Windows NT 6.1":m,"Windows NT 6.0":G,"Windows NT 5.2":g,"Windows NT 5.1":W,"Windows NT 5.0":J,"Windows 2000":J,"Windows NT 4.0":bn,"Win 9x 4.90":z,"Windows CE":l,"Windows 98":E,"Win98":E,"Windows 95":t,"Win95":t,"Mac OS X 10_9":q,"Mac OS X 10.9":q,"Mac OS X 10_8":v,"Mac OS X 10.8":v,"Mac OS X 10_7":f,"Mac OS X 10.7":f,"Mac OS X 10_6":P,"Mac OS X 10.6":P,"Mac OS X 10_5":o,"Mac OS X 10.5":o,"Mac OS X 10_4":S,"Mac OS X 10.4":S,"Mac OS X 10_3":d,"Mac OS X 10.3":d,"Mac OS X 10_2":A,"Mac OS X 10.2":A,"Mac OS X 10_1":b,"Mac OS X 10.1":b,"Mac OS X 10_0":R,"Mac OS X 10.0":R},getVersion:function(){var bw=qx.bom.client.OperatingSystem.__du(navigator.userAgent);if(bw==null){bw=qx.bom.client.OperatingSystem.__dv(navigator.userAgent);}
;if(bw!=null){return bw;}
else {return M;}
;}
,__du:function(bx){var bA=[];for(var bz in qx.bom.client.OperatingSystem.__dt){bA.push(bz);}
;var bB=new RegExp(L+bA.join(r).replace(/\./g,w)+h,bo);var by=bB.exec(bx);if(by&&by[1]){return qx.bom.client.OperatingSystem.__dt[by[1]];}
;return null;}
,__dv:function(bF){var bG=bF.indexOf(C)!=-1;var bC=bF.match(/(iPad|iPhone|iPod)/i)?true:false;if(bG){var bE=new RegExp(/ Android (\d+(?:\.\d+)+)/i);var bH=bE.exec(bF);if(bH&&bH[1]){return bH[1];}
;}
...
(function(){var a="ready",b="mshtml",c="engine.name",d="qx.event.handler.Application",f="complete",g="webkit",h="gecko",i="load",j="unload",k="opera",l="left",m="DOMContentLoaded",n="shutdown",o="browser.documentmode";qx.Class.define(d,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(p){qx.core.Object.call(this);this._window=p.getWindow();this.__ku=false;this.__kv=false;this.__eg=false;this.__kw=false;this._initObserver();qx.event.handler.Application.$$instance=this;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{ready:1,shutdown:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true,onScriptLoaded:function(){var q=qx.event.handler.Application.$$instance;if(q){q.__kx();}
;}
},members:{canHandleEvent:function(s,r){}
,registerEvent:function(v,u,t){}
,unregisterEvent:function(y,x,w){}
,__eg:null,__ku:null,__kv:null,__kw:null,__kx:function(){if(!this.__eg&&this.__ku&&qx.$$loader.scriptLoaded){if((qx.core.Environment.get(c)==b)){if(qx.event.Registration.hasListener(this._window,a)){this.__eg=true;qx.event.Registration.fireEvent(this._window,a);}
;}
else {this.__eg=true;qx.event.Registration.fireEvent(this._window,a);}
;}
;}
,isApplicationReady:function(){return this.__eg;}
,_initObserver:function(){if(qx.$$domReady||document.readyState==f||document.readyState==a){this.__ku=true;this.__kx();}
...
,_onNativeLoad:qx.event.GlobalError.observeMethod(function(){this.__ku=true;this.__kx();}
),_onNativeUnload:qx.event.GlobalError.observeMethod(function(){if(!this.__kw){this.__kw=true;try{qx.event.Registration.fireEvent(this._window,n);}
catch(e){throw e;}
...
;}
;return name;}
,getVersion:function(){var Q=navigator.userAgent;var R=new RegExp(A+qx.bom.client.Browser.__dw+l);var O=Q.match(R);if(!O){return y;}
...
;}
,__dw:{"webkit":v,"gecko":n,"mshtml":o,"opera":F}[qx.bom.client.Engine.getName()]},defer:function(S){qx.core.Environment.add(i,S.getName),qx.core.Environment.add(B,S.getVersion),qx.core.Environment.add(H,S.getDocumentMode),qx.core.Environment.add(h,S.getQuirksMode);}
});}
)();
(function(){var a="ready",b="shutdown",c="beforeunload",d="qx.core.Init";qx.Class.define(d,{statics:{getApplication:qx.core.BaseInit.getApplication,ready:qx.core.BaseInit.ready,__ks:function(e){var f=this.getApplication();if(f){e.setReturnValue(f.close());}
;}
,__kt:function(){var g=this.getApplication();if(g){g.terminate();}
;}
},defer:function(h){qx.event.Registration.addListener(window,a,h.ready,h);qx.event.Registration.addListener(window,b,h.__kt,h);qx.event.Registration.addListener(window,c,h.__ks,h);}
});}
)();
...
(function(){var a="Could not parse color: ",b="_applyTheme",c="qx.theme.manager.Color",d="Theme",e="changeTheme",f="string",g="singleton";qx.Class.define(c,{type:g,extend:qx.util.ValueManager,properties:{theme:{check:d,nullable:true,apply:b,event:e}},members:{_applyTheme:function(j){var h={};if(j){var i=j.colors;for(var name in i){h[name]=this.__dh(i,name);}
;}
;this._setDynamic(h);}
,__dh:function(l,name){var k=l[name];if(typeof k===f){if(!qx.util.ColorUtil.isCssString(k)){if(l[k]!=undefined){return this.__dh(l,k);}
;throw new Error(a+k);}
;return k;}
...
else if(this.isRgbaString(y)){return this.__dj(y);}
else if(this.isRgbString(y)){return this.__di();}
else if(this.isHex3String(y)){return this.__dk();}
else if(this.isHex6String(y)){return this.__dl();}
;throw new Error(a+y);}
,cssStringToRgb:function(z){if(this.isNamedColor(z)){return this.NAMED[z];}
else if(this.isSystemColor(z)){throw new Error(e+z);}
else if(this.isRgbString(z)){return this.__di();}
else if(this.isRgbaString(z)){return this.__dj();}
else if(this.isHex3String(z)){return this.__dk();}
else if(this.isHex6String(z)){return this.__dl();}
;throw new Error(a+z);}
...
,__di:function(){var L=parseInt(RegExp.$1,10);var K=parseInt(RegExp.$2,10);var J=parseInt(RegExp.$3,10);return [L,K,J];}
,__dj:function(){var P=parseInt(RegExp.$1,10);var O=parseInt(RegExp.$2,10);var M=parseInt(RegExp.$3,10);var N=parseInt(RegExp.$4,10);if(P===0&&O===0&M===0&&N===0){return [-1,-1,-1];}
;return [P,O,M];}
,__dk:function(){var S=parseInt(RegExp.$1,16)*17;var R=parseInt(RegExp.$2,16)*17;var Q=parseInt(RegExp.$3,16)*17;return [S,R,Q];}
,__dl:function(){var V=(parseInt(RegExp.$1,16)*16)+parseInt(RegExp.$2,16);var U=(parseInt(RegExp.$3,16)*16)+parseInt(RegExp.$4,16);var T=(parseInt(RegExp.$5,16)*16)+parseInt(RegExp.$6,16);return [V,U,T];}
,hex3StringToRgb:function(W){if(this.isHex3String(W)){return this.__dk(W);}
;throw new Error(m+W);}
,hex3StringToHex6String:function(X){if(this.isHex3String(X)){return this.rgbToHexString(this.hex3StringToRgb(X));}
;return X;}
,hex6StringToRgb:function(Y){if(this.isHex6String(Y)){return this.__dl(Y);}
;throw new Error(q+Y);}
,hexStringToRgb:function(ba){if(this.isHex3String(ba)){return this.__dk(ba);}
;if(this.isHex6String(ba)){return this.__dl(ba);}
...
(function(){var a="mshtml",b="engine.name",c="_applyTheme",d="",e="'.",f="qx-",g="Unable to resolve decorator '",h="singleton",j=";",k="__iW",l="qx.theme.manager.Decoration",m=".",n="Theme",o="object",p="changeTheme",q="string",r="browser.documentmode",s=":";qx.Class.define(l,{type:h,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__en=[];this.__iV=(qx.core.Environment.get(b)==a&&qx.core.Environment.get(r)<9);}
,properties:{theme:{check:n,nullable:true,apply:c,event:p}},members:{__iW:null,__en:null,__iV:false,getCssClassName:function(t){if(qx.lang.Type.isString(t)){return f+t;}
...
;if(!A){throw new Error(g+y+e);}
;var F=d;var u=A.getStyles(true);for(var C in u){if(qx.Bootstrap.isObject(u[C])){var w=d;var E=u[C];var B=false;for(var x in E){B=true;w+=x+s+E[x]+j;}
;var D=this.__iV?z:z+(B?s:d);this.__en.push(D+C);v.addRule(D+C,w);continue;}
;F+=C+s+u[C]+j;}
;if(F){v.addRule(z,F);this.__en.push(z);}
;return y;}
,resolve:function(J){if(!J){return null;}
;if(typeof J===o){return J;}
;var K=this.getTheme();if(!K){return null;}
;var H=this.__iW;if(!H){H=this.__iW={};}
...
,isCached:function(R){return !this.__iW?false:qx.lang.Object.contains(this.__iW,R);}
,_applyTheme:function(U,S){var T=qx.util.AliasManager.getInstance();for(var i=0;i<this.__en.length;i++ ){var V=this.__en[i];qx.ui.style.Stylesheet.getInstance().removeRule(V);}
;this.__en=[];if(S){for(var W in S.aliases){T.remove(W);}
;}
;if(U){for(var W in U.aliases){T.add(W,U.aliases[W]);}
;}
;this._disposeMap(k);this.__iW={};}
},destruct:function(){this._disposeMap(k);}
});}
)();
(function(){var a="qx.ui.style.Stylesheet",b="singleton";qx.Class.define(a,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__el=qx.bom.Stylesheet.createElement();this.__en=[];}
,members:{__en:null,__el:null,addRule:function(d,c){if(this.hasRule(d)){return;}
;qx.bom.Stylesheet.addRule(this.__el,d,c);this.__en.push(d);}
,hasRule:function(e){return this.__en.indexOf(e)!=-1;}
,removeRule:function(f){delete this.__en[this.__en.indexOf(f)];qx.bom.Stylesheet.removeRule(this.__el,f);}
},destruct:function(){qx.bom.Stylesheet.removeSheet(this.__el);}
});}
)();
...
,__dU:{},__dV:{},_allowCreationWithMarkup:function(Q){if(!Q){Q=window;}
;var R=Q.location.href;if(qx.dom.Element.__dV[R]==undefined){try{Q.document.createElement(g);qx.dom.Element.__dV[R]=true;}
catch(e){qx.dom.Element.__dV[R]=false;}
;}
;return qx.dom.Element.__dV[R];}
,getHelperElement:function(S){if(!S){S=window;}
;var T=S.location.href;if(!qx.dom.Element.__dU[T]){var U=qx.dom.Element.__dU[T]=S.document.createElement(n);if(qx.core.Environment.get(a)==j){U.style.display=f;S.document.body.appendChild(U);}
;}
;return qx.dom.Element.__dU[T];}
,create:function(name,bc,W){if(!W){W=window;}
;if(!name){throw new Error(k);}
;var Y=this.__dT;var X=d;for(var bb in bc){if(Y[bb]){X+=bb+b+bc[bb]+p;}
;}
...
(function(){var b="function",c="html.video.h264",d="html.element.contains",f='video/ogg; codecs="theora, vorbis"',g="qxtest",h="html.console",i="html.xul",j="http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul",k="html.video.ogg",l="http://www.w3.org/TR/SVG11/feature#BasicStructure",m="html.storage.local",n="div",o="qx.bom.client.Html",p="getSelection",q='audio',r='video/mp4; codecs="avc1.42E01E, mp4a.40.2"',s="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==",t="html.audio",u="video",w="url(#default#VML)",x="head",y="audio",z="audio/mpeg",A="org.w3c.dom.svg",B="html.classlist",C="html.svg",D="html.video",E="html.geolocation",F="DOMTokenList",G="html.storage.session",H="1.1",I="html.history.state",J="object",K="html.image.naturaldimensions",L="html.audio.aif",M="audio/x-wav",N='<v:shape id="vml_flag1" adj="1" />',O="html.canvas",P="audio/ogg",Q="",R="html.storage.userdata",S="number",T="html.element.compareDocumentPosition",U="audio/x-aiff",V="html.audio.au",W="img",X="html.selection",Y="selection",bC="html.xpath",bD="$qx_check",bE="test",by='video',bz="span",bA="html.element.textcontent",bB="geolocation",bJ="html.audio.mp3",bK="html.vml",bR="undefined",bU="html.audio.ogg",bF="none",bG="label",bH='video/webm; codecs="vp8, vorbis"',bI="html.dataurl",bN="html.webworker",bV="html.dataset",bO="1.0",bP="html.audio.wav",bS="html.filereader",bL="audio/basic",bT="display",bM="html.video.webm",bQ="#default#userdata";qx.Bootstrap.define(o,{statics:{getWebWorker:function(){return window.Worker!=null;}
,getFileReader:function(){return window.FileReader!=null;}
,getGeoLocation:function(){return bB in navigator;}
,getAudio:function(){return !!document.createElement(q).canPlayType;}
,getAudioOgg:function(){if(!qx.bom.client.Html.getAudio()){return Q;}
;var a=document.createElement(y);return a.canPlayType(P);}
,getAudioMp3:function(){if(!qx.bom.client.Html.getAudio()){return Q;}
;var a=document.createElement(y);return a.canPlayType(z);}
,getAudioWav:function(){if(!qx.bom.client.Html.getAudio()){return Q;}
;var a=document.createElement(y);return a.canPlayType(M);}
,getAudioAu:function(){if(!qx.bom.client.Html.getAudio()){return Q;}
;var a=document.createElement(y);return a.canPlayType(bL);}
,getAudioAif:function(){if(!qx.bom.client.Html.getAudio()){return Q;}
;var a=document.createElement(y);return a.canPlayType(U);}
,getVideo:function(){return !!document.createElement(by).canPlayType;}
,getVideoOgg:function(){if(!qx.bom.client.Html.getVideo()){return Q;}
;var v=document.createElement(u);return v.canPlayType(f);}
,getVideoH264:function(){if(!qx.bom.client.Html.getVideo()){return Q;}
;var v=document.createElement(u);return v.canPlayType(r);}
,getVideoWebm:function(){if(!qx.bom.client.Html.getVideo()){return Q;}
;var v=document.createElement(u);return v.canPlayType(bH);}
,getLocalStorage:function(){try{var bW=window.localStorage!=null;if(bW){window.sessionStorage.setItem(bD,bE);window.sessionStorage.removeItem(bD);}
;return bW;}
catch(bX){return false;}
;}
,getSessionStorage:function(){try{var bY=window.sessionStorage!=null;if(bY){window.sessionStorage.setItem(bD,bE);window.sessionStorage.removeItem(bD);}
;return bY;}
catch(ca){return false;}
;}
,getUserDataStorage:function(){var cb=document.createElement(n);cb.style[bT]=bF;document.getElementsByTagName(x)[0].appendChild(cb);var cc=false;try{cb.addBehavior(bQ);cb.load(g);cc=true;}
catch(e){}
...
,getXul:function(){try{document.createElementNS(j,bG);return true;}
catch(e){return false;}
;}
,getSvg:function(){return document.implementation&&document.implementation.hasFeature&&(document.implementation.hasFeature(A,bO)||document.implementation.hasFeature(l,H));}
...
,getContains:function(){return (typeof document.documentElement.contains!==bR);}
,getCompareDocumentPosition:function(){return (typeof document.documentElement.compareDocumentPosition===b);}
,getTextContent:function(){var ch=document.createElement(bz);return (typeof ch.textContent!==bR);}
,getConsole:function(){return typeof window.console!==bR;}
,getNaturalDimensions:function(){var ci=document.createElement(W);return typeof ci.naturalHeight===S&&typeof ci.naturalWidth===S;}
,getHistoryState:function(){return (typeof window.onpopstate!==bR&&typeof window.history.replaceState!==bR&&typeof window.history.pushState!==bR);}
,getSelection:function(){if(typeof window.getSelection===b){return p;}
;if(typeof document.selection===J){return Y;}
;return null;}
},defer:function(cj){qx.core.Environment.add(bN,cj.getWebWorker);qx.core.Environment.add(bS,cj.getFileReader);qx.core.Environment.add(E,cj.getGeoLocation);qx.core.Environment.add(t,cj.getAudio);qx.core.Environment.add(bU,cj.getAudioOgg);qx.core.Environment.add(bJ,cj.getAudioMp3);qx.core.Environment.add(bP,cj.getAudioWav);qx.core.Environment.add(V,cj.getAudioAu);qx.core.Environment.add(L,cj.getAudioAif);qx.core.Environment.add(D,cj.getVideo);qx.core.Environment.add(k,cj.getVideoOgg);qx.core.Environment.add(c,cj.getVideoH264);qx.core.Environment.add(bM,cj.getVideoWebm);qx.core.Environment.add(m,cj.getLocalStorage);qx.core.Environment.add(G,cj.getSessionStorage);qx.core.Environment.add(R,cj.getUserDataStorage);qx.core.Environment.add(B,cj.getClassList);qx.core.Environment.add(bC,cj.getXPath);qx.core.Environment.add(i,cj.getXul);qx.core.Environment.add(O,cj.getCanvas);qx.core.Environment.add(C,cj.getSvg);qx.core.Environment.add(bK,cj.getVml);qx.core.Environment.add(bV,cj.getDataset);qx.core.Environment.addAsync(bI,cj.getDataUrl);qx.core.Environment.add(d,cj.getContains);qx.core.Environment.add(T,cj.getCompareDocumentPosition);qx.core.Environment.add(bA,cj.getTextContent);qx.core.Environment.add(h,cj.getConsole);qx.core.Environment.add(K,cj.getNaturalDimensions);qx.core.Environment.add(I,cj.getHistoryState);qx.core.Environment.add(X,cj.getSelection);}
});}
)();
(function(){var a="readOnly",b="accessKey",c="qx.bom.element.Attribute",d="rowSpan",e="vAlign",f="className",g="textContent",h="'",i="htmlFor",j="longDesc",k="cellSpacing",l="frameBorder",m="='",n="",o="useMap",p="innerText",q="innerHTML",r="tabIndex",s="dateTime",t="maxLength",u="html.element.textcontent",v="mshtml",w="engine.name",x="cellPadding",y="browser.documentmode",z="colSpan",A="undefined";qx.Bootstrap.define(c,{statics:{__dW:{names:{"class":f,"for":i,html:q,text:qx.core.Environment.get(u)?g:p,colspan:z,rowspan:d,valign:e,datetime:s,accesskey:b,tabindex:r,maxlength:t,readonly:a,longdesc:j,cellpadding:x,cellspacing:k,frameborder:l,usemap:o},runtime:{"html":1,"text":1},bools:{compact:1,nowrap:1,ismap:1,declare:1,noshade:1,checked:1,disabled:1,readOnly:1,multiple:1,selected:1,noresize:1,defer:1,allowTransparency:1},property:{$$html:1,$$widget:1,disabled:1,checked:1,readOnly:1,multiple:1,selected:1,value:1,maxLength:1,className:1,innerHTML:1,innerText:1,textContent:1,htmlFor:1,tabIndex:1},qxProperties:{$$widget:1,$$html:1},propertyDefault:{disabled:false,checked:false,readOnly:false,multiple:false,selected:false,value:n,className:n,innerHTML:n,innerText:n,textContent:n,htmlFor:n,tabIndex:0,maxLength:qx.core.Environment.select(w,{"mshtml":2147483647,"webkit":524288,"default":-1})},removeableProperties:{disabled:1,multiple:1,maxLength:1},original:{href:1,src:1,type:1}},compile:function(B){var C=[];var E=this.__dW.runtime;for(var D in B){if(!E[D]){C.push(D,m,B[D],h);}
;}
;return C.join(n);}
,get:function(H,name){var F=this.__dW;var G;name=F.names[name]||name;if(qx.core.Environment.get(w)==v&&parseInt(qx.core.Environment.get(y),10)<8&&F.original[name]){G=H.getAttribute(name,2);}
...
;var I=this.__dW;name=I.names[name]||name;if(I.bools[name]){J=!!J;}
...
,toParameter:function(O,S){var R,Q=[];for(R in O){if(O.hasOwnProperty(R)){var P=O[R];if(P instanceof Array){for(var i=0;i<P.length;i++ ){this.__dX(R,P[i],Q,S);}
;}
else {this.__dX(R,P,Q,S);}
;}
;}
;return Q.join(y);}
,__dX:function(W,X,V,U){var T=window.encodeURIComponent;if(U){V.push(T(W).replace(/%20/g,b)+E+T(X).replace(/%20/g,b));}
else {V.push(T(W)+E+T(X));}
;}
,getAbsolute:function(ba){var Y=document.createElement(e);Y.innerHTML=B+ba+x;return Y.firstChild.href;}
}});}
)();
(function(){var a="qx.bom.client.Stylesheet",b="html.stylesheet.deleterule",c="html.stylesheet.insertrule",d="function",e="html.stylesheet.createstylesheet",f="html.stylesheet.addimport",g="html.stylesheet.removeimport",h="object";qx.Bootstrap.define(a,{statics:{__dY:function(){if(!qx.bom.client.Stylesheet.__ea){qx.bom.client.Stylesheet.__ea=qx.bom.Stylesheet.createElement();}
;return qx.bom.client.Stylesheet.__ea;}
,getCreateStyleSheet:function(){return typeof document.createStyleSheet===h;}
,getInsertRule:function(){return typeof qx.bom.client.Stylesheet.__dY().insertRule===d;}
,getDeleteRule:function(){return typeof qx.bom.client.Stylesheet.__dY().deleteRule===d;}
,getAddImport:function(){return (typeof qx.bom.client.Stylesheet.__dY().addImport===h);}
,getRemoveImport:function(){return (typeof qx.bom.client.Stylesheet.__dY().removeImport===h);}
...
(function(){var a="abstract",b="Abstract method called.",c="qx.ui.decoration.Abstract";qx.Class.define(c,{extend:qx.core.Object,implement:[qx.ui.decoration.IDecorator],type:a,members:{__iX:null,_getDefaultInsets:function(){throw new Error(b);}
,_isInitialized:function(){throw new Error(b);}
,_resetInsets:function(){this.__iX=null;}
,getInsets:function(){if(this.__iX){return this.__iX;}
...
(function(){var a="0",b="qx/static",c="http://",d="https://",e="file://",f="qx.util.AliasManager",g="singleton",h=".",i="/",j="static";qx.Class.define(f,{type:g,extend:qx.util.ValueManager,construct:function(){qx.util.ValueManager.call(this);this.__iY={};this.add(j,b);}
,members:{__iY:null,_preprocess:function(n){var m=this._getDynamic();if(m[n]===false){return n;}
else if(m[n]===undefined){if(n.charAt(0)===i||n.charAt(0)===h||n.indexOf(c)===0||n.indexOf(d)===a||n.indexOf(e)===0){m[n]=false;return n;}
;if(this.__iY[n]){return this.__iY[n];}
;var l=n.substring(0,n.indexOf(i));var k=this.__iY[l];if(k!==undefined){m[n]=k+n.substring(l.length);}
;}
;return n;}
,add:function(o,q){this.__iY[o]=q;var p=this._getDynamic();for(var r in p){if(r.substring(0,r.indexOf(i))===o){p[r]=q+r.substring(o.length);}
;}
;}
,remove:function(s){delete this.__iY[s];}
,resolve:function(t){var u=this._getDynamic();if(t!=null){t=this._preprocess(t);}
;return u[t]||t;}
,getAliases:function(){var v={};for(var w in this.__iY){v[w]=this.__iY[w];}
;return v;}
},destruct:function(){this.__iY=null;}
});}
)();
(function(){var a="singleton",b="qx.util.LibraryManager";qx.Class.define(b,{extend:qx.core.Object,type:a,statics:{__ja:qx.$$libraries||{}},members:{has:function(c){return !!this.self(arguments).__ja[c];}
,get:function(d,e){return this.self(arguments).__ja[d][e]?this.self(arguments).__ja[d][e]:null;}
,set:function(f,g,h){this.self(arguments).__ja[f][g]=h;}
}});}
)();
...
,statics:{__bI:qx.$$resources||{},__jb:{}},members:{has:function(r){return !!this.self(arguments).__bI[r];}
,getData:function(s){return this.self(arguments).__bI[s]||null;}
,getImageWidth:function(u){var t=this.self(arguments).__bI[u];return t?t[0]:null;}
,getImageHeight:function(w){var v=this.self(arguments).__bI[w];return v?v[1]:null;}
,getImageFormat:function(y){var x=this.self(arguments).__bI[y];return x?x[2]:null;}
,getCombinedFormat:function(D){var A=e;var C=this.self(arguments).__bI[D];var z=C&&C.length>4&&typeof (C[4])==i&&this.constructor.__bI[C[4]];if(z){var E=C[4];var B=this.constructor.__bI[E];A=B[2];}
;return A;}
,toUri:function(I){if(I==null){return I;}
;var F=this.self(arguments).__bI[I];if(!F){return I;}
;if(typeof F===i){var H=F;}
else {var H=F[3];if(!H){return I;}
;}
;var G=e;if((qx.core.Environment.get(b)==a)&&qx.core.Environment.get(d)){G=this.self(arguments).__jb[H];}
;return G+qx.util.LibraryManager.getInstance().get(H,n)+m+I;}
,toDataUri:function(L){var K=this.constructor.__bI[L];var N=this.constructor.__bI[K[4]];var M;if(N){var J=N[4][L];M=k+J[j]+l+J[f]+q+J[h];}
else {M=this.toUri(L);}
;return M;}
...
else {P.__jb[Q]=e;continue;}
;if(O.match(/^\/\//)!=null){P.__jb[Q]=window.location.protocol;}
else if(O.match(/^\//)!=null){P.__jb[Q]=window.location.protocol+c+window.location.host;}
else if(O.match(/^\.\//)!=null){var S=document.URL;P.__jb[Q]=S.substring(0,S.lastIndexOf(m)+1);}
else if(O.match(/^http/)!=null){P.__jb[Q]=e;}
else {var R=window.location.href.indexOf(g);var T;if(R==-1){T=window.location.href;}
else {T=window.location.href.substring(0,R);}
;P.__jb[Q]=T.substring(0,T.lastIndexOf(m)+1);}
;}
;}
;}
;}
...
,getLinearGradient:function(){qx.bom.client.Css.__dy=false;var cb=N;var bX=document.createElement(n);var bY=qx.bom.Style.getAppliedStyle(bX,G,cb);if(!bY){cb=by;var bY=qx.bom.Style.getAppliedStyle(bX,G,cb,false);if(bY){qx.bom.client.Css.__dy=true;}
;}
;if(!bY){return null;}
;var ca=/(.*?)\(/.exec(bY);return ca?ca[1]:null;}
,getFilterGradient:function(){return qx.bom.client.Css.__dz(bC,bR);}
...
,getFilterTextShadow:function(){return qx.bom.client.Css.__dz(I,T);}
,__dz:function(cn,cl){var cm=false;var co=bF+cn+W+cl+bB;var ck=document.createElement(n);document.body.appendChild(ck);ck.style.filter=co;if(ck.filters&&ck.filters.length>0&&ck.filters.item(cn).enabled==true){cm=true;}
...
else if(qx.core.Environment.get(S)&&!qx.core.Environment.get(O)&&qx.core.Environment.get(e)){if(!this.__jg){this.__jg=document.createElement(M);}
;var bq=this.getOrientation()==G;var bw=this.__jh();var bt=bq?200:1;var bv=bq?1:200;this.__jg.width=bv;this.__jg.height=bt;var br=this.__jg.getContext(X);if(bq){var bC=br.createLinearGradient(0,0,0,bt);}
else {var bC=br.createLinearGradient(0,0,bv,0);}
;bC.addColorStop(this.getStartColorPosition()/100,bw.start);bC.addColorStop(this.getEndColorPosition()/100,bw.end);br.fillStyle=bC;br.fillRect(0,0,bv,bt);var bs=v+this.__jg.toDataURL()+g;bm[h]=bs;bm[l]=B;}
else if(qx.core.Environment.get(S)&&!qx.core.Environment.get(O)){var bw=this.__jh();var bB=this.getOrientation()==T?1:0;var bA=bw.start;var bu=bw.end;if(!qx.util.ColorUtil.isHex6String(bA)){bA=qx.util.ColorUtil.stringToRgb(bA);bA=qx.util.ColorUtil.rgbToHexString(bA);}
...
;}
;}
,__jh:function(){if(qx.core.Environment.get(A)){var bF=qx.theme.manager.Color.getInstance();var bH=bF.resolve(this.getStartColor());var bG=bF.resolve(this.getEndColor());}
else {var bH=this.getStartColor();var bG=this.getEndColor();}
;return {start:bH,end:bG};}
,_getContent:function(){if(qx.core.Environment.get(S)&&!qx.core.Environment.get(O)){var bK=this.__jh();var bN=this.getOrientation()==T?1:0;var bM=qx.util.ColorUtil.hex3StringToHex6String(bK.start);var bJ=qx.util.ColorUtil.hex3StringToHex6String(bK.end);bM=bM.substring(1,bM.length);bJ=bJ.substring(1,bJ.length);var bL=H;if(this.classname.indexOf(D)!=-1){var bI={};this._styleBoxShadow(bI);bL=j+qx.bom.element.Style.compile(bI)+n;}
...
;if(qx.bom.Document.isStandardMode(qx.dom.Node.getWindow(p))){if(!this.__dB(p)){return i;}
;}
;return b;}
...
(function(){var a="css.float",b="px",c="Cascaded styles are not supported in this browser!",d="css.appearance",e="pixelRight",f="float",g="css.userselect",h="css.boxsizing",i="css.textoverflow",j="qx.debug",k="pixelHeight",l=":",m="pixelTop",n="browser.documentmode",o="css.borderimage",p="Invalid argument 'name'",q="pixelLeft",r="engine.name",s="css.usermodify",t="mshtml",u="qx.bom.element.Style",v="Invalid argument 'smart'",w="",x="pixelBottom",y="Invalid argument 'styles'",z="pixelWidth",A=";",B="Invalid argument 'element'",C="style";qx.Bootstrap.define(u,{statics:{__dC:null,__dD:null,__dE:function(){var E={"appearance":qx.core.Environment.get(d),"userSelect":qx.core.Environment.get(g),"textOverflow":qx.core.Environment.get(i),"borderImage":qx.core.Environment.get(o),"float":qx.core.Environment.get(a),"userModify":qx.core.Environment.get(s),"boxSizing":qx.core.Environment.get(h)};this.__dD={};for(var D in qx.lang.Object.clone(E)){if(!E[D]){delete E[D];}
else {this.__dD[D]=D==f?f:qx.bom.Style.getCssName(E[D]);}
;}
;this.__dC=E;}
,__dF:function(name){var F=qx.bom.Style.getPropertyName(name);if(F){this.__dC[name]=F;}
;return F;}
,__dG:{width:z,height:k,left:q,right:e,top:m,bottom:x},__dH:{clip:qx.bom.element.Clip,cursor:qx.bom.element.Cursor,opacity:qx.bom.element.Opacity,boxSizing:qx.bom.element.BoxSizing},compile:function(G){var J=[];var K=this.__dH;var I=this.__dD;var name,H;for(name in G){H=G[name];if(H==null){continue;}
;name=this.__dC[name]||this.__dF(name)||name;if(K[name]){J.push(K[name].compile(H));}
...
;}
,isPropertySupported:function(O){return (this.__dH[O]||this.__dC[O]||O in document.documentElement.style);}
...
;}
;name=this.__dC[name]||this.__dF(name)||name;if(P!==false&&this.__dH[name]){this.__dH[name].set(R,Q);}
...
;}
;var V=this.__dC;var ba=this.__dH;var T=Y.style;for(var X in S){var U=S[X];var name=V[X]||this.__dF(X)||X;if(U===undefined){if(W!==false&&ba[name]){ba[name].reset(Y);}
else {T[name]=w;}
;}
...
;}
;}
,reset:function(bc,name,bb){name=this.__dC[name]||this.__dF(name)||name;if(bb!==false&&this.__dH[name]){this.__dH[name].reset(bc);}
else {bc.style[name]=w;}
;}
,get:qx.core.Environment.select(r,{"mshtml":function(bf,name,bg,bj){name=this.__dC[name]||this.__dF(name)||name;if(bj!==false&&this.__dH[name]){return this.__dH[name].get(bf,bg);}
...
;var bi=this.__dG[name];if(bi){var be=bf.style[name];bf.style[name]=bh||0;var bd=bf.style[bi]+b;bf.style[name]=be;return bd;}
;return bh;};}
,"default":function(bm,name,bn,bo){name=this.__dC[name]||this.__dF(name)||name;if(bo!==false&&this.__dH[name]){return this.__dH[name].get(bm,bn);}
...
(function(){var a="qx.ui.decoration.Decorator",b="_style",c="_getDefaultInsetsFor",d="bottom",e="top",f="left",g="right";qx.Class.define(a,{extend:qx.ui.decoration.Abstract,implement:[qx.ui.decoration.IDecorator],include:[qx.ui.decoration.MBackgroundColor,qx.ui.decoration.MBorderRadius,qx.ui.decoration.MBoxShadow,qx.ui.decoration.MDoubleBorder,qx.ui.decoration.MLinearBackgroundGradient,qx.ui.decoration.MBorderImage],members:{__ji:false,getPadding:function(){var k=this.getInset();var h=this._getDefaultInsetsForBorderImage();var n=k.top-(h.top?h.top:this.getWidthTop());var m=k.right-(h.right?h.right:this.getWidthRight());var j=k.bottom-(h.bottom?h.bottom:this.getWidthBottom());var l=k.left-(h.left?h.left:this.getWidthLeft());return {top:k.top?n:this.getInnerWidthTop(),right:k.right?m:this.getInnerWidthRight(),bottom:k.bottom?j:this.getInnerWidthBottom(),left:k.left?l:this.getInnerWidthLeft()};}
...
,_isInitialized:function(){return this.__ji;}
}});}
)();
...
;var j=this.getTheme();if(j!==null&&j.fonts[l]){var m=this.__kz(j.fonts[l]);return k[l]=(new m).set(j.fonts[l]);}
;return l;}
,isDynamic:function(q){var p=this._dynamic;if(q&&(q instanceof qx.bom.Font||p[q]!==undefined)){return true;}
;var o=this.getTheme();if(o!==null&&q&&o.fonts[q]){var n=this.__kz(o.fonts[q]);p[q]=(new n).set(o.fonts[q]);return true;}
;return false;}
,__ky:function(s,r){if(s[r].include){var t=s[s[r].include];s[r].include=null;delete s[r].include;s[r]=qx.lang.Object.mergeWith(s[r],t,false);this.__ky(s,r);}
;}
,_applyTheme:function(y){var u=this._dynamic;for(var x in u){if(u[x].themed){u[x].dispose();delete u[x];}
;}
;if(y){var v=y.fonts;for(var x in v){if(v[x].include&&v[v[x].include]){this.__ky(v,x);}
;var w=this.__kz(v[x]);u[x]=(new w).set(v[x]);u[x].themed=true;}
;}
;this._setDynamic(u);}
,__kz:function(z){if(z.sources){return qx.bom.webfonts.WebFont;}
;return qx.bom.Font;}
},destruct:function(){this._disposeMap(c);}
});}
)();
(function(){var a="Boolean",b="px",c="_applyItalic",d="_applyBold",e="underline",f="_applyTextShadow",g="Integer",h="_applyFamily",j="_applyLineHeight",k='"',m="Array",n="line-through",o="overline",p="Color",q="String",r="",s="italic",t="normal",u="qx.bom.Font",v="bold",w="Number",x="_applyDecoration",y=" ",z="_applySize",A=",",B="_applyColor";qx.Class.define(u,{extend:qx.core.Object,construct:function(D,C){qx.core.Object.call(this);this.__kA={fontFamily:r,fontSize:null,fontWeight:null,fontStyle:null,textDecoration:null,lineHeight:null,color:null,textShadow:null};if(D!==undefined){this.setSize(D);}
...
,__kB:{fontFamily:r,fontSize:r,fontWeight:r,fontStyle:r,textDecoration:r,lineHeight:1.2,color:r,textShadow:r},getDefaultStyles:function(){return this.__kB;}
},properties:{size:{check:g,nullable:true,apply:z},lineHeight:{check:w,nullable:true,apply:j},family:{check:m,nullable:true,apply:h},bold:{check:a,nullable:true,apply:d},italic:{check:a,nullable:true,apply:c},decoration:{check:[e,n,o],nullable:true,apply:x},color:{check:p,nullable:true,apply:B},textShadow:{nullable:true,check:q,apply:f}},members:{__kA:null,_applySize:function(M,L){this.__kA.fontSize=M===null?null:M+b;}
,_applyLineHeight:function(O,N){this.__kA.lineHeight=O===null?null:O;}
,_applyFamily:function(P,Q){var R=r;for(var i=0,l=P.length;i<l;i++ ){if(P[i].indexOf(y)>0){R+=k+P[i]+k;}
else {R+=P[i];}
;if(i!==l-1){R+=A;}
;}
;this.__kA.fontFamily=R;}
,_applyBold:function(T,S){this.__kA.fontWeight=T==null?null:T?v:t;}
,_applyItalic:function(V,U){this.__kA.fontStyle=V==null?null:V?s:t;}
,_applyDecoration:function(X,W){this.__kA.textDecoration=X==null?null:X;}
,_applyColor:function(ba,Y){this.__kA.color=null;if(ba){this.__kA.color=qx.theme.manager.Color.getInstance().resolve(ba);}
;}
,_applyTextShadow:function(bc,bb){this.__kA.textShadow=bc==null?null:bc;}
,getStyles:function(){return this.__kA;}
}});}
)();
(function(){var a="qx.bom.webfonts.WebFont",b="",c="qx.debug",d="changeStatus",e="_applySources",f="qx.event.type.Data",g=" was not applied, perhaps the source file could not be loaded.",h="WebFont ";qx.Class.define(a,{extend:qx.bom.Font,events:{"changeStatus":f},properties:{sources:{nullable:true,apply:e}},members:{__kC:null,_applySources:function(m,o){var j=[];for(var i=0,l=m.length;i<l;i++ ){var k=this._quoteFontFamily(m[i].family);j.push(k);var n=m[i].source;qx.bom.webfonts.Manager.getInstance().require(k,n,this._onWebFontChangeStatus,this);}
...
(function(){var a="m",b="os.name",c=")",d="os.version",e="qx.bom.webfonts.Manager",f="svg",g="chrome",h="browser.name",k="singleton",n=",\n",o="src: ",p="mobileSafari",q="'eot)",r="');",s="qx.debug",t="interval",u="#",v="firefox",w="!",y="eot",z="ios",A="changeStatus",B="\.(",C="}\n",D="font-family: ",E="browser.documentmode",F="mobile safari",G="safari",H="@font-face.*?",I="",J="ttf",K=";\n",L="') format('svg')",M="') format('woff')",N="('embedded-opentype')",O="browser.version",P="opera",Q="engine.version",R="Couldn't create @font-face rule for WebFont ",S="mshtml",T="engine.name",U="url('",V="src: url('",W="('embedded-opentype)",X="\nfont-style: normal;\nfont-weight: normal;",Y="?#iefix') format('embedded-opentype')",bl="woff",bm="ie",bn=";",bh="'eot')",bi="Error while adding @font-face rule:",bj="@font-face {",bk="') format('truetype')";qx.Class.define(e,{extend:qx.core.Object,type:k,construct:function(){qx.core.Object.call(this);this.__kD=[];this.__kE={};this.__dm=[];this.__kF=this.getPreferredFormats();}
,statics:{FONT_FORMATS:[y,bl,J,f],VALIDATION_TIMEOUT:5000},members:{__kD:null,__kG:null,__kE:null,__kF:null,__dm:null,__kH:null,require:function(bq,br,bs,bu){var bp=[];for(var i=0,l=br.length;i<l;i++ ){var bt=br[i].split(u);var bo=qx.util.ResourceManager.getInstance().toUri(bt[0]);if(bt.length>1){bo=bo+u+bt[1];}
;bp.push(bo);}
;if(qx.core.Environment.get(T)==S&&(parseInt(qx.core.Environment.get(Q))<9)||qx.core.Environment.get(E)<9){if(!this.__kH){this.__kH=new qx.event.Timer(100);this.__kH.addListener(t,this.__kJ,this);}
;if(!this.__kH.isEnabled()){this.__kH.start();}
;this.__dm.push([bq,bp,bs,bu]);}
else {this.__kI(bq,bp,bs,bu);}
;}
,remove:function(bw){var bv=null;for(var i=0,l=this.__kD.length;i<l;i++ ){if(this.__kD[i]==bw){bv=i;this.__kP(bw);break;}
;}
;if(bv){qx.lang.Array.removeAt(this.__kD,bv);}
;if(bw in this.__kE){this.__kE[bw].dispose();delete this.__kE[bw];}
;}
...
;return bx;}
,removeStyleSheet:function(){this.__kD=[];if(this.__kG){qx.bom.Stylesheet.removeSheet(this.__kG);}
;this.__kG=null;}
,__kI:function(bE,bG,bD,bH){if(!qx.lang.Array.contains(this.__kD,bE)){var bI=this.__kL(bG);var bF=this.__kM(bE,bI);if(!bF){throw new Error(R+bE+w);}
;if(!this.__kG){this.__kG=qx.bom.Stylesheet.createElement();}
;try{this.__kO(bF);}
catch(bJ){if(qx.core.Environment.get(s)){this.warn(bi,bJ.message);return;}
;}
;this.__kD.push(bE);}
;if(!this.__kE[bE]){this.__kE[bE]=new qx.bom.webfonts.Validator(bE);this.__kE[bE].setTimeout(qx.bom.webfonts.Manager.VALIDATION_TIMEOUT);this.__kE[bE].addListenerOnce(A,this.__kK,this);}
;if(bD){var bC=bH||window;this.__kE[bE].addListenerOnce(A,bD,bC);}
;this.__kE[bE].validate();}
,__kJ:function(){if(this.__dm.length==0){this.__kH.stop();return;}
;var bK=this.__dm.shift();this.__kI.apply(this,bK);}
,__kK:function(bL){var bM=bL.getData();if(bM.valid===false){qx.event.Timer.once(function(){this.remove(bM.family);}
,this,250);}
;}
,__kL:function(bN){var bP=qx.bom.webfonts.Manager.FONT_FORMATS;var bO={};for(var i=0,l=bN.length;i<l;i++ ){var bQ=null;for(var x=0;x<bP.length;x++ ){var bR=new RegExp(B+bP[x]+c);var bS=bR.exec(bN[i]);if(bS){bQ=bS[1];}
;}
;if(bQ){bO[bQ]=bN[i];}
;}
;return bO;}
,__kM:function(bV,bY){var bX=[];var bT=this.__kF.length>0?this.__kF:qx.bom.webfonts.Manager.FONT_FORMATS;for(var i=0,l=bT.length;i<l;i++ ){var bU=bT[i];if(bY[bU]){bX.push(this.__kN(bU,bY[bU]));}
;}
;var bW=o+bX.join(n)+bn;bW=D+bV+K+bW;bW=bW+X;return bW;}
,__kN:function(cb,ca){switch(cb){case y:return U+ca+r+V+ca+Y;case bl:return U+ca+M;case J:return U+ca+bk;case f:return U+ca+L;default:return null;};}
,__kO:function(cd){var cc=bj+cd+C;if(qx.core.Environment.get(h)==bm&&qx.core.Environment.get(E)<9){var ce=this.__kQ(this.__kG.cssText);ce+=cc;this.__kG.cssText=ce;}
else {this.__kG.insertRule(cc,this.__kG.cssRules.length);}
;}
,__kP:function(cf){var ci=new RegExp(H+cf,a);for(var i=0,l=document.styleSheets.length;i<l;i++ ){var cg=document.styleSheets[i];if(cg.cssText){var ch=cg.cssText.replace(/\n/g,I).replace(/\r/g,I);ch=this.__kQ(ch);if(ci.exec(ch)){ch=ch.replace(ci,I);}
;cg.cssText=ch;}
else if(cg.cssRules){for(var j=0,m=cg.cssRules.length;j<m;j++ ){var ch=cg.cssRules[j].cssText.replace(/\n/g,I).replace(/\r/g,I);if(ci.exec(ch)){this.__kG.deleteRule(j);return;}
;}
;}
;}
;}
,__kQ:function(cj){return cj.replace(q,bh).replace(W,N);}
},destruct:function(){delete this.__kD;this.removeStyleSheet();for(var ck in this.__kE){this.__kE[ck].dispose();}
...
;var self=this;this.__il=function(){self._oninterval.call(self);}
;}
...
;var p=new qx.event.Timer(o);p.__im=m;p.addListener(c,function(e){p.stop();m.call(n,e);p.dispose();n=null;}
,n);p.start();return p;}
},properties:{enabled:{init:true,check:f,apply:k},interval:{check:i,init:1000,apply:b}},members:{__in:null,__il:null,_applyInterval:function(r,q){if(this.getEnabled()){this.restart();}
;}
,_applyEnabled:function(t,s){if(s){window.clearInterval(this.__in);this.__in=null;}
else if(t){this.__in=window.setInterval(this.__il,this.getInterval());}
;}
...
;}
)},destruct:function(){if(this.__in){window.clearInterval(this.__in);}
;this.__in=this.__il=null;}
});}
)();
(function(){var a="sans-serif",b="changeStatus",c="Integer",d="auto",e="qx.event.type.Data",f="0",g="qx.bom.webfonts.Validator",h="interval",i="Georgia",j="WEei",k="__kU",l="Times New Roman",m="Arial",n="normal",o="Helvetica",p="350px",q="_applyFontFamily",r="-1000px",s="hidden",t="serif",u="span",v="absolute",w=",";qx.Class.define(g,{extend:qx.core.Object,construct:function(x){qx.core.Object.call(this);if(x){this.setFontFamily(x);}
;this.__kR=this._getRequestedHelpers();}
,statics:{COMPARISON_FONTS:{sans:[m,o,a],serif:[l,i,t]},HELPER_CSS:{position:v,margin:f,padding:f,top:r,left:r,fontSize:p,width:d,height:d,lineHeight:n,fontVariant:n,visibility:s},COMPARISON_STRING:j,__kS:null,__kT:null,removeDefaultHelperElements:function(){var y=qx.bom.webfonts.Validator.__kT;if(y){for(var z in y){document.body.removeChild(y[z]);}
;}
;delete qx.bom.webfonts.Validator.__kT;}
},properties:{fontFamily:{nullable:true,init:null,apply:q},timeout:{check:c,init:5000}},events:{"changeStatus":e},members:{__kR:null,__kU:null,__kV:null,validate:function(){this.__kV=new Date().getTime();if(this.__kU){this.__kU.restart();}
else {this.__kU=new qx.event.Timer(100);this.__kU.addListener(h,this.__kW,this);qx.event.Timer.once(function(){this.__kU.start();}
,this,0);}
;}
,_reset:function(){if(this.__kR){for(var B in this.__kR){var A=this.__kR[B];document.body.removeChild(A);}
;this.__kR=null;}
;}
,_isFontValid:function(){if(!qx.bom.webfonts.Validator.__kS){this.__dq();}
;if(!this.__kR){this.__kR=this._getRequestedHelpers();}
;var D=qx.bom.element.Dimension.getWidth(this.__kR.sans);var C=qx.bom.element.Dimension.getWidth(this.__kR.serif);var E=qx.bom.webfonts.Validator;if(D!==E.__kS.sans&&C!==E.__kS.serif){return true;}
;return false;}
...
;}
,__dq:function(){var M=qx.bom.webfonts.Validator;if(!M.__kT){M.__kT={sans:this._getHelperElement(M.COMPARISON_FONTS.sans),serif:this._getHelperElement(M.COMPARISON_FONTS.serif)};}
;M.__kS={sans:qx.bom.element.Dimension.getWidth(M.__kT.sans),serif:qx.bom.element.Dimension.getWidth(M.__kT.serif)};}
,__kW:function(){if(this._isFontValid()){this.__kU.stop();this._reset();this.fireDataEvent(b,{family:this.getFontFamily(),valid:true});}
else {var N=new Date().getTime();if(N-this.__kV>=this.getTimeout()){this.__kU.stop();this._reset();this.fireDataEvent(b,{family:this.getFontFamily(),valid:false});}
;}
;}
},destruct:function(){this._reset();this.__kU.stop();this.__kU.removeListener(h,this.__kW,this);this._disposeObjects(k);}
});}
)();
...
,__dM:{visible:true,hidden:true},getContentWidth:function(u){var r=qx.bom.element.Style;var s=qx.bom.element.Style.get(u,k);var t=parseInt(r.get(u,g)||d,10);var x=parseInt(r.get(u,e)||d,10);if(this.__dM[s]){var w=u.clientWidth;if((qx.core.Environment.get(b)==h)||qx.dom.Node.isBlockNode(u)){w=w-t-x;}
...
;}
;}
,getContentHeight:function(D){var y=qx.bom.element.Style;var A=qx.bom.element.Style.get(D,l);var B=parseInt(y.get(D,j)||d,10);var z=parseInt(y.get(D,i)||d,10);if(this.__dM[A]){return D.clientHeight-B-z;}
...
(function(){var a="'.",b="Missing appearance: ",c="_applyTheme",d="qx.debug",e="string",f="Cannot find a matching appearance for '",g="Hint: This may be an issue with nested child controls and a missing alias definition in the appearance theme.",h="qx.theme.manager.Appearance",j=":",k="Theme",l="undefined",m="changeTheme",n="/",o="singleton";qx.Class.define(h,{type:o,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__dd={};this.__de={};}
,properties:{theme:{check:k,nullable:true,event:m,apply:c}},members:{__df:{},__dd:null,__de:null,_applyTheme:function(){this.__de={};this.__dd={};}
,__dg:function(D,z,q,u){var w=z.appearances;var r=w[D];if(!r){var C=n;var s=[];var v=D.split(C);var B=qx.lang.Array.clone(v);var y;while(!r&&v.length>0){s.unshift(v.pop());var t=v.join(C);r=w[t];if(r){y=r.alias||r;if(typeof y===e){var A=y+C+s.join(C);return this.__dg(A,z,q,B);}
;}
;}
;for(var i=0;i<s.length-1;i++ ){s.shift();var x=s.join(C);var p=this.__dg(x,z,null,B);if(p){return p;}
;}
;if(q!=null){return this.__dg(q,z,null,B);}
;if(qx.core.Environment.get(d)){if(typeof u!==l){this.debug(f+u.join(n)+a);if(u.length>1){this.info(g);}
;}
;}
;return null;}
else if(typeof r===e){return this.__dg(r,z,q,B);}
else if(r.include&&!r.style){return this.__dg(r.include,z,q,B);}
;return D;}
,styleFrom:function(W,O,P,F){if(!P){P=this.getTheme();}
;var M=this.__de;var E=M[W];if(!E){E=M[W]=this.__dg(W,P,F);}
...
;if(J>0){U+=j+J;}
;}
;var K=this.__dd;if(K[U]!==undefined){return K[U];}
;if(!O){O=this.__df;}
...
;return K[U]=R||null;}
},destruct:function(){this.__dd=this.__de=null;}
});}
)();
...
;W.include=this.__sm(W.include);W.patch=this.__sm(W.patch);if(qx.core.Environment.get(q)){this.__j(name,W);}
;var V={$$type:Q,name:name,title:W.title,toString:this.genericToString};if(W.extend){V.supertheme=W.extend;}
;V.basename=qx.Bootstrap.createNamespace(name,V);this.__sp(V,W);this.__sn(V,W);this.$$registry[name]=V;for(var i=0,a=W.include,l=a.length;i<l;i++ ){this.include(V,a[i]);}
...
;}
,__sn:function(Y,ba){var bb=ba.aliases||{};if(ba.extend&&ba.extend.aliases){qx.Bootstrap.objectMergeWith(bb,ba.extend.aliases,false);}
;Y.aliases=bb;}
...
,__so:function(bd){for(var i=0,bc=this.__sq,l=bc.length;i<l;i++ ){if(bd[bc[i]]){return bc[i];}
;}
;}
,__sp:function(bi,bj){var bf=this.__so(bj);if(bj.extend&&!bf){bf=bj.extend.type;}
...
,$$registry:{},__sq:[N,u,n,d,j,s,e,R],__i:qx.core.Environment.select(q,{"true":{"title":m,"aliases":U,"type":m,"extend":U,"colors":U,"borders":U,"decorations":U,"fonts":U,"icons":U,"widgets":U,"appearances":U,"meta":U,"include":U,"patch":U},"default":null}),__sr:qx.core.Environment.select(q,{"true":{"color":U,"border":U,"decoration":U,"font":U,"icon":U,"appearance":U,"widget":U},"default":null}),__j:qx.core.Environment.select(q,{"true":function(name,bq){var bp=this.__i;for(var bo in bq){if(bp[bo]===undefined){throw new Error(f+bo+M+name+h);}
...
;}
;if(bq.meta){var bm;for(var bo in bq.meta){bm=bq.meta[bo];if(this.__sr[bo]===undefined){throw new Error(C+bo+S);}
;if(typeof bm!==this.__sr[bo]){throw new Error(I+bo+L);}
...
;}
,"default":function(){}
}),patch:function(bu,bs){this.__ss(bs);var bw=this.__so(bs);if(bw!==this.__so(bu)){throw new Error(w+bu.name+v+bs.name+b);}
;var bt=bs[bw];var br=bu.$$clazz.prototype;for(var bv in bt){br[bv]=bt[bv];}
;}
,include:function(bA,by){this.__ss(by);var bC=by.type;if(bC!==bA.type){throw new Error(w+bA.name+v+by.name+b);}
;var bz=by[bC];var bx=bA.$$clazz.prototype;for(var bB in bz){if(bx[bB]!==undefined){continue;}
;bx[bB]=bz[bB];}
;}
,__ss:function(bD){if(typeof bD===H||bD==null){var bF=new Error(g);if(qx.core.Environment.get(q)){var bE=qx.dev.StackTrace.getStackTraceFromError(bF);qx.Bootstrap.error(this,bE);}
;throw bF;}
;}
}});}
)();
(function(){var a="widget",b="qx.ui.tooltip.ToolTip",c="Boolean",d="",f="__sw",g="interval",h="mouseover",i="_applyCurrent",j="mouseout",k="qx.ui.tooltip.Manager",l="mousemove",m="__sy",n="focusout",o="tooltip-error",p="singleton",q="__sv";qx.Class.define(k,{type:p,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);qx.event.Registration.addListener(document.body,h,this.__sD,this,true);this.__sv=new qx.event.Timer();this.__sv.addListener(g,this.__sA,this);this.__sw=new qx.event.Timer();this.__sw.addListener(g,this.__sB,this);this.__sx={left:0,top:0};}
,properties:{current:{check:b,nullable:true,apply:i},showInvalidToolTips:{check:c,init:true},showToolTips:{check:c,init:true}},members:{__sx:null,__sw:null,__sv:null,__sy:null,__sz:null,getSharedTooltip:function(){if(!this.__sy){this.__sy=new qx.ui.tooltip.ToolTip().set({rich:true});}
;return this.__sy;}
,getSharedErrorTooltip:function(){if(!this.__sz){this.__sz=new qx.ui.tooltip.ToolTip().set({appearance:o,rich:true});this.__sz.setLabel(d);this.__sz.syncAppearance();}
;return this.__sz;}
,_applyCurrent:function(t,s){if(s&&qx.ui.core.Widget.contains(s,t)){return;}
;if(s){if(!s.isDisposed()){s.exclude();}
;this.__sv.stop();this.__sw.stop();}
;var u=qx.event.Registration;var r=document.body;if(t){this.__sv.startWith(t.getShowTimeout());u.addListener(r,j,this.__sE,this,true);u.addListener(r,n,this.__sF,this,true);u.addListener(r,l,this.__sC,this,true);}
else {u.removeListener(r,j,this.__sE,this,true);u.removeListener(r,n,this.__sF,this,true);u.removeListener(r,l,this.__sC,this,true);}
;}
,__sA:function(e){var v=this.getCurrent();if(v&&!v.isDisposed()){this.__sw.startWith(v.getHideTimeout());if(v.getPlaceMethod()==a){v.placeToWidget(v.getOpener());}
else {v.placeToPoint(this.__sx);}
;v.show();}
;this.__sv.stop();}
,__sB:function(e){var w=this.getCurrent();if(w&&!w.isDisposed()){w.exclude();}
;this.__sw.stop();this.resetCurrent();}
,__sC:function(e){var x=this.__sx;x.left=Math.round(e.getDocumentLeft());x.top=Math.round(e.getDocumentTop());}
,__sD:function(e){var y=qx.ui.core.Widget.getWidgetByElement(e.getTarget());this.showToolTip(y);}
...
,__sE:function(e){var E=qx.ui.core.Widget.getWidgetByElement(e.getTarget());if(!E){return;}
...
;}
,__sF:function(e){var H=qx.ui.core.Widget.getWidgetByElement(e.getTarget());if(!H){return;}
;var I=this.getCurrent();if(I&&I==H.getToolTip()){this.setCurrent(null);}
;}
},destruct:function(){qx.event.Registration.removeListener(document.body,h,this.__sD,this,true);this._disposeObjects(q,f,m);this.__sx=null;}
});}
)();
...
;}
;}
,"false":null}),__cU:null,__cV:null,__cW:null,__cX:null,__cY:null,__da:null,__db:null,getBounds:function(){return this.__da||this.__cV||null;}
...
;if(P!=null&&P!==this.__cU){this.__cU=P;qx.ui.core.queue.Layout.add(this);return null;}
;var O=this.__cV;if(!O){O=this.__cV={};}
;var T={};if(U!==O.left||top!==O.top){T.position=true;O.left=U;O.top=top;}
;if(R!==O.width||Q!==O.height){T.size=true;O.width=R;O.height=Q;}
;if(this.__cW){T.local=true;delete this.__cW;}
;if(this.__cY){T.margin=true;delete this.__cY;}
;return T;}
,isExcluded:function(){return false;}
,hasValidLayout:function(){return !this.__cW;}
,scheduleLayoutUpdate:function(){qx.ui.core.queue.Layout.add(this);}
,invalidateLayoutCache:function(){this.__cW=true;this.__cX=null;}
,getSizeHint:function(V){var W=this.__cX;if(W){return W;}
;if(V===false){return null;}
;W=this.__cX=this._computeSizeHint();if(this._hasHeightForWidth()&&this.__cU&&this.getHeight()==null){W.height=this.__cU;}
...
,_applyMargin:function(){this.__cY=true;var parent=this.$$parent;if(parent){parent.updateLayoutProperties();}
;}
...
,setUserBounds:function(bi,top,bh,bj){this.__da={left:bi,top:top,width:bh,height:bj};qx.ui.core.queue.Layout.add(this);}
,resetUserBounds:function(){delete this.__da;qx.ui.core.queue.Layout.add(this);}
,__dc:{},setLayoutProperties:function(bm){if(bm==null){return;}
;var bk=this.__db;if(!bk){bk=this.__db={};}
...
;return null;}
,clone:function(){var bq=qx.core.Object.prototype.clone.call(this);var br=this.__db;if(br){bq.__db=qx.lang.Object.clone(br);}
;return bq;}
...
;this.$$parent=this.$$subparent=this.__db=this.__cV=this.__da=this.__cX=null;}
});}
)();
...
(function(){var a="qx.ui.core.queue.Layout",b="layout";qx.Class.define(a,{statics:{__dm:{},__dn:{},remove:function(c){delete this.__dm[c.$$hash];}
,add:function(d){this.__dm[d.$$hash]=d;qx.ui.core.queue.Manager.scheduleFlush(b);}
,isScheduled:function(e){return !!this.__dm[e.$$hash];}
,flush:function(){var f=this.__dp();for(var i=f.length-1;i>=0;i-- ){var g=f[i];if(g.hasValidLayout()){continue;}
...
;}
;}
,getNestingLevel:function(l){var k=this.__dn;var n=0;var parent=l;while(true){if(k[parent.$$hash]!=null){n+=k[parent.$$hash];break;}
;if(!parent.$$parent){break;}
;parent=parent.$$parent;n+=1;}
;var m=n;while(l&&l!==parent){k[l.$$hash]=m-- ;l=l.$$parent;}
;return n;}
,__do:function(){var t=qx.ui.core.queue.Visibility;this.__dn={};var s=[];var r=this.__dm;var o,q;for(var p in r){o=r[p];if(t.isVisible(o)){q=this.getNestingLevel(o);if(!s[q]){s[q]={};}
;s[q][p]=o;delete r[p];}
;}
;return s;}
,__dp:function(){var x=[];var z=this.__do();for(var w=z.length-1;w>=0;w-- ){if(!z[w]){continue;}
...
(function(){var a="Method '",b="qxWeb",c="' already available as static method.",d="qx.debug",e="' already available.";qx.Bootstrap.define(b,{extend:qx.type.BaseArray,statics:{__dq:[],$$qx:qx,$init:function(j){var h=[];for(var i=0;i<j.length;i++ ){var g=!!(j[i]&&(j[i].nodeType===1||j[i].nodeType===9));if(g){h.push(j[i]);continue;}
;var f=!!(j[i]&&j[i].history&&j[i].location&&j[i].document);if(f){h.push(j[i]);}
;}
;var k=qx.lang.Array.cast(h,qxWeb);for(var i=0;i<qxWeb.__dq.length;i++ ){qxWeb.__dq[i].call(k);}
;return k;}
...
;qxWeb[name]=n[name];}
;}
,$attachInit:function(o){this.__dq.push(o);}
...
else {var L=qxWeb.getDocument(K[0]);O=qx.module.Css.__ds(K[0].tagName,L);}
;K.setStyle(d,O);K[0].$$qPrevDisp=a;}
;}
);return this;}
,__dr:{},__ds:function(T,Q){var S=qx.module.Css.__dr;if(!S[T]){var U=Q||document;var R=qxWeb(U.createElement(T)).appendTo(Q.body);S[T]=R.getStyle(d);R.remove();}
;return S[T]||c;}
...
;return A.className;}
,"default":function(C,E){var D={};var F;var B=C.className;if(B){F=B.split(this.__dK);for(var i=0,l=F.length;i<l;i++ ){D[F[i]]=true;}
...
;return P.className;}
,"default":function(S,Q){var R=new RegExp(v+Q.join(g)+v,s);return S.className=S.className.replace(R,f).replace(this.__dL,f).replace(this.__dK,p);}
...
(function(){var a="borderBottomWidth",b="scroll",c="qx.bom.element.Location",d="engine.version",e="paddingLeft",f="borderRightWidth",g="auto",h="static",i="borderTopWidth",j="borderLeftWidth",k="marginBottom",l="marginTop",m="overflowY",n="marginLeft",o="border-box",p="padding",q="paddingBottom",r="paddingTop",s="gecko",t="marginRight",u="browser.quirksmode",v="mshtml",w="engine.name",x="position",y="margin",z="paddingRight",A="BODY",B="overflowX",C="border",D="browser.documentmode";qx.Bootstrap.define(c,{statics:{__dN:function(F,E){return qx.bom.element.Style.get(F,E,qx.bom.element.Style.COMPUTED_MODE,false);}
,__dO:function(H,G){return parseInt(qx.bom.element.Style.get(H,G,qx.bom.element.Style.COMPUTED_MODE,false),10)||0;}
,__dP:function(J){var K=0,top=0;var I=qx.dom.Node.getWindow(J);K-=qx.bom.Viewport.getScrollLeft(I);top-=qx.bom.Viewport.getScrollTop(I);return {left:K,top:top};}
,__dQ:qx.core.Environment.select(w,{"mshtml":function(N){var M=qx.dom.Node.getDocument(N);var L=M.body;var O=0;var top=0;O-=L.clientLeft+M.documentElement.clientLeft;top-=L.clientTop+M.documentElement.clientTop;if(!qx.core.Environment.get(u)){O+=this.__dO(L,j);top+=this.__dO(L,i);}
;return {left:O,top:top};}
,"webkit":function(R){var Q=qx.dom.Node.getDocument(R);var P=Q.body;var S=P.offsetLeft;var top=P.offsetTop;if(parseFloat(qx.core.Environment.get(d))<530.17){S+=this.__dO(P,j);top+=this.__dO(P,i);}
;return {left:S,top:top};}
,"gecko":function(U){var T=qx.dom.Node.getDocument(U).body;var V=T.offsetLeft;var top=T.offsetTop;if(parseFloat(qx.core.Environment.get(d))<1.9){V+=this.__dO(T,n);top+=this.__dO(T,l);}
;if(qx.bom.element.BoxSizing.get(T)!==o){V+=this.__dO(T,j);top+=this.__dO(T,i);}
;return {left:V,top:top};}
,"default":function(X){var W=qx.dom.Node.getDocument(X).body;var Y=W.offsetLeft;var top=W.offsetTop;return {left:Y,top:top};}
}),__dR:function(ba){var bb=ba.getBoundingClientRect();return {left:Math.round(bb.left),top:Math.round(bb.top)};}
,get:function(bg,bh){if(bg.tagName==A){var location=this.__dS(bg);var bk=location.left;var top=location.top;}
else {var bc=this.__dQ(bg);var bf=this.__dR(bg);var scroll=this.__dP(bg);var bk=bf.left+bc.left-scroll.left;var top=bf.top+bc.top-scroll.top;}
;var bd=bk+bg.offsetWidth;var be=top+bg.offsetHeight;if(bh){if(bh==p||bh==b){var bj=qx.bom.element.Style.get(bg,B);if(bj==b||bj==g){bd+=bg.scrollWidth-bg.offsetWidth+this.__dO(bg,j)+this.__dO(bg,f);}
;var bi=qx.bom.element.Style.get(bg,m);if(bi==b||bi==g){be+=bg.scrollHeight-bg.offsetHeight+this.__dO(bg,i)+this.__dO(bg,a);}
;}
;switch(bh){case p:bk+=this.__dO(bg,e);top+=this.__dO(bg,r);bd-=this.__dO(bg,z);be-=this.__dO(bg,q);case b:bk-=bg.scrollLeft;top-=bg.scrollTop;bd-=bg.scrollLeft;be-=bg.scrollTop;case C:bk+=this.__dO(bg,j);top+=this.__dO(bg,i);bd-=this.__dO(bg,f);be-=this.__dO(bg,a);break;case y:bk-=this.__dO(bg,n);top-=this.__dO(bg,l);bd+=this.__dO(bg,t);be+=this.__dO(bg,k);break;};}
;return {left:bk,top:top,right:bd,bottom:be};}
,__dS:function(bl){var top=bl.offsetTop;var bm=bl.offsetLeft;if(qx.core.Environment.get(w)!==v||!((parseFloat(qx.core.Environment.get(d))<8||qx.core.Environment.get(D)<8)&&!qx.core.Environment.get(u))){top+=this.__dO(bl,l);bm+=this.__dO(bl,n);}
;if(qx.core.Environment.get(w)===s){top+=this.__dO(bl,j);bm+=this.__dO(bl,i);}
...
(function(){var a="mshtml",b="engine.name",c="*",d="load",e="left",f="qx.module.Event",g="undefined",h="DOMContentLoaded",n="browser.documentmode",o="complete";qx.Bootstrap.define(f,{statics:{__eb:{},__ec:{on:{},off:{}},on:function(w,t,u){for(var i=0;i<this.length;i++ ){var p=this[i];var q=u||qxWeb(p);var v=qx.module.Event.__ec.on;var s=v[c]||[];if(v[w]){s=s.concat(v[w]);}
;for(var j=0,m=s.length;j<m;j++ ){s[j](p,w,t,u);}
;var r=function(event){var B=qx.module.Event.__eb;var A=B[c]||[];if(B[w]){A=A.concat(B[w]);}
...
;if(!p.__ed){p.__ed=new qx.event.Emitter();}
;var z=p.__ed.on(w,r,q);if(!p.__ee){p.__ee={};}
;if(!p.__ee[w]){p.__ee[w]={};}
;p.__ee[w][z]=r;if(!u){if(!p.__ef){p.__ef={};}
;p.__ef[z]=q;}
;}
;return this;}
,off:function(L,D,I){var H=(D===null&&I===null);for(var j=0;j<this.length;j++ ){var C=this[j];if(!C.__ee){continue;}
;var N=[];if(L!==null){N.push(L);}
else {for(var F in C.__ee){N.push(F);}
;}
;for(var i=0,l=N.length;i<l;i++ ){for(var G in C.__ee[N[i]]){var K=C.__ee[N[i]][G];if(H||K==D||K.original==D){var E=typeof C.__ef!==g&&C.__ef[G];var O;if(!I&&E){O=C.__ef[G];}
;C.__ed.off(N[i],K,O||I);if(H||K.original==D){qx.bom.Event.removeNativeListener(C,N[i],K);}
;delete C.__ee[N[i]][G];if(E){delete C.__ef[G];}
;}
;}
;var J=qx.module.Event.__ec.off;var M=J[c]||[];if(J[L]){M=M.concat(J[L]);}
;for(var k=0,m=M.length;k<m;k++ ){M[k](C,L,D,I);}
;}
;}
;return this;}
,allOff:function(P){return this.off(P||null,null,null);}
,emit:function(Q,R){for(var j=0;j<this.length;j++ ){var S=this[j];if(S.__ed){S.__ed.emit(Q,R);}
;}
;return this;}
,once:function(U,T,W){var self=this;var V=function(X){self.off(U,V,W);T.call(this,X);}
;this.on(U,V,W);return this;}
,hasListener:function(Y){if(!this[0]||!this[0].__ed||!this[0].__ed.getListeners()[Y]){return false;}
;return this[0].__ed.getListeners()[Y].length>0;}
...
;}
;bf.forEach(function(bh){bh.__ed=null;}
);for(var i=0;i<be.length;i++ ){var ba=be[i];if(!ba.__ed){continue;}
;var bc=ba.__ed.getListeners();for(var name in bc){for(var j=bc[name].length-1;j>=0;j-- ){var bd=bc[name][j].listener;if(bd.original){bd=bd.original;}
;qxWeb(bf[i]).on(name,bd,bc[name][j].ctx);}
;}
;}
;}
,__eg:false,ready:function(bi){if(document.readyState===o){window.setTimeout(bi,1);return;}
;var bj=function(){qx.module.Event.__eg=true;bi();}
...
else {var bl=function(){if(qx.module.Event.__eg){return;}
...
;var bo=qx.module.Event.__eb;for(var i=0,l=bq.length;i<l;i++ ){var bp=bq[i];if(qx.lang.Type.isFunction(bn)){if(!bo[bp]){bo[bp]=[];}
;bo[bp].push(bn);}
;}
;}
,$unregisterNormalization:function(bu,br){if(!qx.lang.Type.isArray(bu)){bu=[bu];}
;var bs=qx.module.Event.__eb;for(var i=0,l=bu.length;i<l;i++ ){var bt=bu[i];if(bs[bt]){qx.lang.Array.remove(bs[bt],br);}
;}
;}
,$getRegistry:function(){return qx.module.Event.__eb;}
,$registerEventHook:function(bA,bx,bw){if(!qx.lang.Type.isArray(bA)){bA=[bA];}
;var by=qx.module.Event.__ec.on;for(var i=0,l=bA.length;i<l;i++ ){var bz=bA[i];if(qx.lang.Type.isFunction(bx)){if(!by[bz]){by[bz]=[];}
;by[bz].push(bx);}
;}
;if(!bw){return;}
;var bv=qx.module.Event.__ec.off;for(var i=0,l=bA.length;i<l;i++ ){var bz=bA[i];if(qx.lang.Type.isFunction(bw)){if(!bv[bz]){bv[bz]=[];}
;bv[bz].push(bw);}
;}
;}
,$unregisterEventHook:function(bG,bD,bC){if(!qx.lang.Type.isArray(bG)){bG=[bG];}
;var bE=qx.module.Event.__ec.on;for(var i=0,l=bG.length;i<l;i++ ){var bF=bG[i];if(bE[bF]){qx.lang.Array.remove(bE[bF],bD);}
;}
;if(!bC){return;}
;var bB=qx.module.Event.__ec.off;for(var i=0,l=bG.length;i<l;i++ ){var bF=bG[i];if(bB[bF]){qx.lang.Array.remove(bB[bF],bC);}
;}
;}
,$getHookRegistry:function(){return qx.module.Event.__ec;}
...
(function(){var a="qx.event.Emitter",b="*";qx.Bootstrap.define(a,{extend:Object,statics:{__eh:[]},members:{__ee:null,__ei:null,on:function(name,c,d){var e=qx.event.Emitter.__eh.length;this.__ej(name).push({listener:c,ctx:d,id:e});qx.event.Emitter.__eh.push({name:name,listener:c,ctx:d});return e;}
,once:function(name,f,g){var h=qx.event.Emitter.__eh.length;this.__ej(name).push({listener:f,ctx:g,once:true,id:h});qx.event.Emitter.__eh.push({name:name,listener:f,ctx:g});return h;}
,off:function(name,l,j){var k=this.__ej(name);for(var i=k.length-1;i>=0;i-- ){var m=k[i];if(m.listener==l&&m.ctx==j){k.splice(i,1);qx.event.Emitter.__eh[m.id]=null;return m.id;}
;}
;return null;}
,offById:function(o){var n=qx.event.Emitter.__eh[o];if(n){this.off(n.name,n.listener,n.ctx);}
;return null;}
...
,emit:function(name,y){var x=this.__ej(name);for(var i=0;i<x.length;i++ ){var w=x[i];w.listener.call(w.ctx,y);if(w.once){x.splice(i,1);i-- ;}
;}
;x=this.__ej(b);for(var i=x.length-1;i>=0;i-- ){var w=x[i];w.listener.call(w.ctx,y);}
;}
,getListeners:function(){return this.__ee;}
,__ej:function(name){if(this.__ee==null){this.__ee={};}
;if(this.__ee[name]==null){this.__ee[name]=[];}
;return this.__ee[name];}
}});}
)();
...
(function(){var a="css.animation",b="translate",c="rotate",d="skew",e="scale",f="qx.bom.element.Animation";qx.Bootstrap.define(f,{statics:{animate:function(h,k,g){var j=qx.bom.element.Animation.__ek(h,k.keyFrames);if(qx.core.Environment.get(a)&&j){return qx.bom.element.AnimationCss.animate(h,k,g);}
else {return qx.bom.element.AnimationJs.animate(h,k,g);}
;}
,animateReverse:function(m,o,l){var n=qx.bom.element.Animation.__ek(m,o.keyFrames);if(qx.core.Environment.get(a)&&n){return qx.bom.element.AnimationCss.animateReverse(m,o,l);}
else {return qx.bom.element.AnimationJs.animateReverse(m,o,l);}
;}
,__ek:function(p,t){var r=[];for(var v in t){var s=t[v];for(var u in s){if(r.indexOf(u)==-1){r.push(u);}
;}
;}
...
;if(this.__ep!=null){var name=this.__ew(S,R);var Q=name+E+V+C+W.repeat+E+W.timing+E+(W.delay?W.delay+C:t)+(W.alternate?k:t);qx.bom.Event.addNativeListener(P,this.__ep[y],this.__eq);qx.bom.Event.addNativeListener(P,this.__ep[s],this.__er);qx.bom.Event.addNativeListener(P,this.__ep[A],this.__es);P.style[qx.lang.String.camelCase(this.__ep[r])]=Q;if(T&&T==100&&this.__ep[a]){P.style[this.__ep[a]]=w;}
;}
...
;if(this.__ep==null){window.setTimeout(function(){qx.bom.element.AnimationCss.__es({target:P});}
,0);}
;return U;}
,__eq:function(e){e.target.$$animation.emit(f,e.target);}
,__er:function(e){if(e.target!=null&&e.target.$$animation!=null){e.target.$$animation.emit(z,e.target);}
;}
,__es:function(e){var X=e.target;var Y=X.$$animation;if(!Y){return;}
;var bb=Y.desc;if(qx.bom.element.AnimationCss.__ep!=null){var ba=qx.lang.String.camelCase(qx.bom.element.AnimationCss.__ep[r]);X.style[ba]=t;qx.bom.Event.removeNativeListener(X,qx.bom.element.AnimationCss.__ep[r],qx.bom.element.AnimationCss.__es);}
;if(bb.origin!=null){qx.bom.element.Transform.setOrigin(X,t);}
;qx.bom.element.AnimationCss.__et(X,bb.keyFrames[Y.keep]);X.$$animation=null;Y.el=null;Y.ended=true;Y.emit(g,X);}
,__et:function(bc,bd){var bf;for(var be in bd){if(be in qx.bom.element.AnimationCss.__eo){if(!bf){bf={};}
;bf[be]=bd[be];}
else {bc.style[qx.lang.String.camelCase(be)]=bd[be];}
;}
;if(bf){qx.bom.element.Transform.transform(bc,bf);}
;}
,__eu:function(bg){if(!bg.hasOwnProperty(k)){bg.alternate=false;}
...
;}
,__ev:qx.core.Environment.select(l,{"true":function(bi){var bh=[u,n,m,i,p,c,d,k];for(var name in bi){if(!(bh.indexOf(name)!=-1)){qx.Bootstrap.warn(v+name+x);}
;}
...
;}
;}
,"default":null}),__ew:function(frames,bl){var bo=t;for(var bs in frames){bo+=(bl?-(bs-100):bs)+D;var bn=frames[bs];var bq;for(var bk in bn){if(bk in this.__eo){if(!bq){bq={};}
;bq[bk]=bn[bk];}
...
;bo+=q;}
;if(this.__en[bo]){return this.__en[bo];}
;var name=this.__em+this.__co++ ;var bp=this.__ep[I]+E+name;qx.bom.Stylesheet.addRule(this.__el,bp,bo);this.__en[bo]=name;return name;}
}});}
)();
(function(){var a="css.animation",b="Element",c="",d="qx.bom.element.AnimationHandle",e="play-state",f="paused",g="running";qx.Bootstrap.define(d,{extend:qx.event.Emitter,construct:function(){var h=qx.core.Environment.get(a);this.__ex=h&&h[e];this.__ey=true;}
,events:{"start":b,"end":b,"iteration":b},members:{__ex:null,__ey:false,__ez:false,isPlaying:function(){return this.__ey;}
,isEnded:function(){return this.__ez;}
,isPaused:function(){return this.el.style[this.__ex]==f;}
,pause:function(){if(this.el){this.el.style[this.__ex]=f;this.el.$$animation.__ey=false;if(this.animationId&&qx.bom.element.AnimationJs){qx.bom.element.AnimationJs.pause(this);}
;}
;}
,play:function(){if(this.el){this.el.style[this.__ex]=g;this.el.$$animation.__ey=true;if(this.i!=undefined&&qx.bom.element.AnimationJs){qx.bom.element.AnimationJs.play(this);}
;}
;}
,stop:function(){if(this.el&&qx.core.Environment.get(a)&&!this.jsAnimation){this.el.style[this.__ex]=c;this.el.style[qx.core.Environment.get(a).name]=c;this.el.$$animation.__ey=false;this.el.$$animation.__ez=true;}
else if(this.jsAnimation){this.stopped=true;qx.bom.element.AnimationJs.stop(this);}
;}
}});}
)();
(function(){var c="cm",d="mm",e="0",f="pt",g="pc",h="",k="%",l="em",m="qx.bom.element.AnimationJs",n="infinite",o="#",p="in",q="px",r="start",s="end",t="ex",u="undefined",v="iteration",w="string";qx.Bootstrap.define(m,{statics:{__eA:30,__eB:[k,p,c,d,l,t,f,g,q],animate:function(y,z,x){return this._animate(y,z,x,false);}
...
;var I=N.keyFrames;var G=this.__eH(I);var H=this.__eG(M,G);var K=parseInt(M/H,10);this.__eC(I,D);var L=this.__eD(K,H,G,I,M,N.timing);var E=new qx.bom.element.AnimationHandle();E.jsAnimation=true;if(F){L.reverse();E.reverse=true;}
;E.desc=N;E.el=D;E.delta=L;E.stepTime=H;E.steps=K;D.$$animation=E;E.i=0;E.initValues={};E.repeatSteps=this.__eE(K,N.repeat);var J=N.delay||0;var self=this;E.delayId=window.setTimeout(function(){E.delayId=null;self.play(E);}
,J);return E;}
,__eC:function(S,O){var V={};for(var R in S){for(var name in S[R]){var P=qx.bom.Style.getPropertyName(name);if(P&&P!=name){var U=qx.bom.Style.getCssName(P);S[R][U]=S[R][name];delete S[R][name];name=U;}
;if(V[name]==undefined){var T=S[R][name];if(typeof T==w){V[name]=T.substring((parseFloat(T)+h).length,T.length);}
else {V[name]=h;}
;}
;}
;}
...
;if(Q[name]===h&&this.__eB.indexOf(V[name])!=-1){Q[name]=e+V[name];}
;}
;}
;}
;}
,__eD:function(bg,ba,Y,bc,bk,be){var bb=new Array(bg);var bm=1;bb[0]=bc[0];var X=bc[0];var bd=bc[Y[bm]];for(var i=1;i<bb.length;i++ ){if(i*ba/bk*100>Y[bm]){X=bd;bm++ ;bd=bc[Y[bm]];}
...
else if(!isNaN(parseFloat(bh))){var bl=bh.substring((parseFloat(bh)+h).length,bh.length);var bf=parseFloat(bh)-parseFloat(X[name]);bb[i][name]=(parseFloat(X[name])+bf*qx.bom.AnimationFrame.calculateTiming(be,i/bg))+bl;}
...
;}
;}
;qx.bom.element.AnimationJs.__eF(bn.el,bp);bn.i++ ;if(bn.i%bn.steps==0){bn.emit(v,bn.el);if(bn.desc.alternate){bn.delta.reverse();}
;}
...
;this.__eF(br,bt.keyFrames[bv]);}
else {this.__eF(br,bs);}
;br.$$animation=null;bu.el=null;bu.ended=true;bu.animationId=null;bu.emit(s,br);return bu;}
,__eE:function(bx,bw){if(bw==undefined){return bx;}
;if(bw==n){return Number.MAX_VALUE;}
;return bx*bw;}
,__eF:function(bz,by){for(var bA in by){if(by[bA]===undefined){continue;}
;if(typeof bz.style[bA]===u&&bA in bz){bz[bA]=by[bA];continue;}
;var name=qx.bom.Style.getPropertyName(bA)||bA;if(qx.bom.element.Style){qx.bom.element.Style.set(bz,name,by[bA]);}
else {bz.style[name]=by[bA];}
;}
;}
,__eG:function(bD,bB){var bE=100;for(var i=0;i<bB.length-1;i++ ){bE=Math.min(bE,bB[i+1]-bB[i]);}
;var bC=bD*bE/100;while(bC>this.__eA){bC=bC/2;}
;return Math.round(bC);}
,__eH:function(bG){var bF=Object.keys(bG);for(var i=0;i<bF.length;i++ ){bF[i]=parseInt(bF[i],10);}
...
,getCss:function(J){var K=this.__eM(J);if(this.__eL!=null){var I=this.__eL[b];return qx.bom.Style.getCssName(I)+v+K+o;}
;return f;}
,setOrigin:function(L,M){if(this.__eL!=null){L.style[this.__eL[t]]=M;}
;}
,getOrigin:function(N){if(this.__eL!=null){return N.style[this.__eL[t]];}
;return f;}
,setStyle:function(O,P){if(this.__eL!=null){O.style[this.__eL[u]]=P;}
;}
,getStyle:function(Q){if(this.__eL!=null){return Q.style[this.__eL[u]];}
;return f;}
,setPerspective:function(R,S){if(this.__eL!=null){R.style[this.__eL[c]]=S+h;}
;}
,getPerspective:function(T){if(this.__eL!=null){return T.style[this.__eL[c]];}
;return f;}
,setPerspectiveOrigin:function(U,V){if(this.__eL!=null){U.style[this.__eL[p]]=V;}
;}
,getPerspectiveOrigin:function(W){if(this.__eL!=null){var X=W.style[this.__eL[p]];if(X!=f){return X;}
else {var ba=W.style[this.__eL[p]+r];var Y=W.style[this.__eL[p]+s];if(ba!=f){return ba+k+Y;}
;}
;}
;return f;}
,setBackfaceVisibility:function(bb,bc){if(this.__eL!=null){bb.style[this.__eL[a]]=bc?e:m;}
;}
,getBackfaceVisibility:function(bd){if(this.__eL!=null){return bd.style[this.__eL[a]]==e;}
;return true;}
,__eM:function(bg){var bh=f;for(var be in bg){var bf=bg[be];if(qx.Bootstrap.isArray(bf)){for(var i=0;i<bf.length;i++ ){if(bf[i]==undefined||(i==2&&!qx.core.Environment.get(d))){continue;}
;bh+=be+this.__eK[i]+g;bh+=bf[i];bh+=q;}
;}
...
(function(){var a="qx.util.DeferredCall",b="The context object '",c="qx.debug",d="'is already disposed.",e="' of the defered call '";qx.Class.define(a,{extend:qx.core.Object,construct:function(f,g){qx.core.Object.call(this);this.__by=f;this.__bA=g||null;this.__eT=qx.util.DeferredCallManager.getInstance();}
,members:{__by:null,__bA:null,__eT:null,cancel:function(){this.__eT.cancel(this);}
,schedule:function(){this.__eT.schedule(this);}
,call:function(){if(qx.core.Environment.get(c)){var h=this.__bA;if(h&&h.isDisposed&&h.isDisposed()){this.warn(b+h+e+this+d);}
;}
;this.__bA?this.__by.apply(this.__bA):this.__by();}
},destruct:function(){this.cancel();this.__bA=this.__by=this.__eT=null;}
});}
)();
(function(){var a="Child is already in: ",b="text",c="|bubble|",d="qx.html.Element",f="': ",g="|capture|",h="scroll",j="Invalid capture flag.",k="focus",m="Failed to add event listener for type '",n="Flushing elements...",o="class",p="blur",q="div",r="Flush: ",s="deactivate",t="'",u="css.userselect",v="animationEnd",w="Synced DOM with ",z=" from the target '",A="qx.debug",B="capture",C="visible",D="Root elements could not be inserted into other ones.",E="Has no children!",F="off",G="Invalid callback function",H="releaseCapture",I="Could not move to same index!",J="Invalid context for callback.",K="element",L="",M="Flush invisible element",N="Failed to remove event listener for type '",O="qxSelectable",P="tabIndex",Q="Has no child at this position!",R="__fq",S="Invalid event type.",T="qx.html.Iframe",U="activate",V="Has no parent to remove from.",W=" to the target '",X="mshtml",Y="engine.name",bp=" operations",bq="Flush rendered element",br="none",bl="Has no child: ",bm="css.userselect.none",bn=" ",bo="hidden",bs="on",bt="Switching visibility to: ",bu="id",bv="Could not overwrite existing element!";qx.Class.define(d,{extend:qx.core.Object,construct:function(by,bw,bx){qx.core.Object.call(this);this.__eU=by||q;this.__eV=bw||null;this.__eW=bx||null;}
,statics:{DEBUG:false,_modified:{},_visibility:{},_scroll:{},_actions:[],__eX:{},__eY:null,__fa:null,_scheduleFlush:function(bz){qx.html.Element.__fB.schedule();}
,flush:function(){var bL;if(qx.core.Environment.get(A)){if(this.DEBUG){qx.log.Logger.debug(this,n);}
;}
;var bD=this.__fb();var bB=bD.getFocus();if(bB&&this.__fd(bB)){bD.blur(bB);}
;var bS=bD.getActive();if(bS&&this.__fd(bS)){qx.bom.Element.deactivate(bS);}
;var bG=this.__fc();if(bG&&this.__fd(bG)){qx.bom.Element.releaseCapture(bG);}
;var bM=[];var bN=this._modified;for(var bK in bN){bL=bN[bK];if(bL.__fu()||bL.classname==T){if(bL.__fe&&qx.dom.Hierarchy.isRendered(bL.__fe)){bM.push(bL);}
...
;}
;bL.__ft();}
;var bI=this._visibility;for(var bK in bI){bL=bI[bK];var bO=bL.__fe;if(!bO){delete bI[bK];continue;}
;if(qx.core.Environment.get(A)){if(this.DEBUG){qx.log.Logger.debug(this,bt+bL.__fg);}
;}
;if(!bL.$$disposed){bO.style.display=bL.__fg?L:br;if((qx.core.Environment.get(Y)==X)){if(!(document.documentMode>=8)){bO.style.visibility=bL.__fg?C:bo;}
;}
;}
;delete bI[bK];}
;var scroll=this._scroll;for(var bK in scroll){bL=scroll[bK];var bC=bL.__fe;if(bC&&bC.offsetWidth){var bF=true;if(bL.__fj!=null){bL.__fe.scrollLeft=bL.__fj;delete bL.__fj;}
;if(bL.__fk!=null){bL.__fe.scrollTop=bL.__fk;delete bL.__fk;}
;var bP=bL.__fh;if(bP!=null){var bJ=bP.element.getDomElement();if(bJ&&bJ.offsetWidth){qx.bom.element.Scroll.intoViewX(bJ,bC,bP.align);delete bL.__fh;}
else {bF=false;}
;}
;var bQ=bL.__fi;if(bQ!=null){var bJ=bQ.element.getDomElement();if(bJ&&bJ.offsetWidth){qx.bom.element.Scroll.intoViewY(bJ,bC,bQ.align);delete bL.__fi;}
else {bF=false;}
;}
;if(bF){delete scroll[bK];}
;}
;}
;var bE={"releaseCapture":1,"blur":1,"deactivate":1};for(var i=0;i<this._actions.length;i++ ){var bR=this._actions[i];var bO=bR.element.__fe;if(!bO||!bE[bR.type]&&!bR.element.__fu()){continue;}
;var bH=bR.args;bH.unshift(bO);qx.bom.Element[bR.type].apply(qx.bom.Element,bH);}
;this._actions=[];for(var bK in this.__eX){var bA=this.__eX[bK];var bC=bA.element.__fe;if(bC){qx.bom.Selection.set(bC,bA.start,bA.end);delete this.__eX[bK];}
;}
;qx.event.handler.Appear.refresh();}
,__fb:function(){if(!this.__eY){var bT=qx.event.Registration.getManager(window);this.__eY=bT.getHandler(qx.event.handler.Focus);}
;return this.__eY;}
,__fc:function(){if(!this.__fa){var bU=qx.event.Registration.getManager(window);this.__fa=bU.getDispatcher(qx.event.dispatch.MouseCapture);}
;return this.__fa.getCaptureElement();}
,__fd:function(bV){var bW=qx.core.ObjectRegistry.fromHashCode(bV.$$element);return bW&&!bW.__fu();}
},members:{__eU:null,__fe:null,__a:false,__ff:true,__fg:true,__fh:null,__fi:null,__fj:null,__fk:null,__fl:null,__fm:null,__fn:null,__eV:null,__eW:null,__fo:null,__fp:null,__fq:null,__fr:null,__fs:null,_scheduleChildrenUpdate:function(){if(this.__fr){return;}
;this.__fr=true;qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
,_createDomElement:function(){return qx.dom.Element.create(this.__eU);}
,__ft:function(){if(qx.core.Environment.get(A)){if(this.DEBUG){this.debug(r+this.getAttribute(bu));}
;}
;var length;var bX=this.__fq;if(bX){length=bX.length;var bY;for(var i=0;i<length;i++ ){bY=bX[i];if(bY.__fg&&bY.__ff&&!bY.__fe){bY.__ft();}
;}
;}
;if(!this.__fe){this.__fe=this._createDomElement();this.__fe.$$element=this.$$hash;this._copyData(false);if(bX&&length>0){this._insertChildren();}
;}
else {this._syncData();if(this.__fr){this._syncChildren();}
;}
;delete this.__fr;}
,_insertChildren:function(){var ca=this.__fq;var length=ca.length;var cc;if(length>2){var cb=document.createDocumentFragment();for(var i=0;i<length;i++ ){cc=ca[i];if(cc.__fe&&cc.__ff){cb.appendChild(cc.__fe);}
;}
;this.__fe.appendChild(cb);}
else {var cb=this.__fe;for(var i=0;i<length;i++ ){cc=ca[i];if(cc.__fe&&cc.__ff){cb.appendChild(cc.__fe);}
;}
;}
;}
,_syncChildren:function(){var cm=qx.core.ObjectRegistry;var cd=this.__fq;var ck=cd.length;var ce;var ci;var cg=this.__fe;var cl=cg.childNodes;var cf=0;var cj;if(qx.core.Environment.get(A)){var ch=0;}
;for(var i=cl.length-1;i>=0;i-- ){cj=cl[i];ci=cm.fromHashCode(cj.$$element);if(!ci||!ci.__ff||ci.__fs!==this){cg.removeChild(cj);if(qx.core.Environment.get(A)){ch++ ;}
;}
;}
;for(var i=0;i<ck;i++ ){ce=cd[i];if(ce.__ff){ci=ce.__fe;cj=cl[cf];if(!ci){continue;}
...
;}
;}
,_copyData:function(co){var cq=this.__fe;var cs=this.__eW;if(cs){var cp=qx.bom.element.Attribute;for(var cr in cs){cp.set(cq,cr,cs[cr]);}
;}
;var cs=this.__eV;if(cs){var cn=qx.bom.element.Style;if(co){cn.setStyles(cq,cs);}
else {cn.setCss(cq,cn.compile(cs));}
;}
;var cs=this.__fo;if(cs){for(var cr in cs){this._applyProperty(cr,cs[cr]);}
;}
;var cs=this.__fp;if(cs){qx.event.Registration.getManager(cq).importListeners(cq,cs);delete this.__fp;}
;}
,_syncData:function(){var cx=this.__fe;var cw=qx.bom.element.Attribute;var cu=qx.bom.element.Style;var cv=this.__fm;if(cv){var cA=this.__eW;if(cA){var cy;for(var cz in cv){cy=cA[cz];if(cy!==undefined){cw.set(cx,cz,cy);}
else {cw.reset(cx,cz);}
;}
;}
;this.__fm=null;}
;var cv=this.__fl;if(cv){var cA=this.__eV;if(cA){var ct={};for(var cz in cv){ct[cz]=cA[cz];}
;cu.setStyles(cx,ct);}
;this.__fl=null;}
;var cv=this.__fn;if(cv){var cA=this.__fo;if(cA){var cy;for(var cz in cv){this._applyProperty(cz,cA[cz]);}
;}
;this.__fn=null;}
;}
,__fu:function(){var cB=this;while(cB){if(cB.__a){return true;}
;if(!cB.__ff||!cB.__fg){return false;}
;cB=cB.__fs;}
;return false;}
,__fv:function(cC){if(cC.__fs===this){throw new Error(a+cC);}
;if(cC.__a){throw new Error(D);}
;if(cC.__fs){cC.__fs.remove(cC);}
;cC.__fs=this;if(!this.__fq){this.__fq=[];}
;if(this.__fe){this._scheduleChildrenUpdate();}
;}
,__fw:function(cD){if(cD.__fs!==this){throw new Error(bl+cD);}
;if(this.__fe){this._scheduleChildrenUpdate();}
;delete cD.__fs;}
,__fx:function(cE){if(cE.__fs!==this){throw new Error(bl+cE);}
;if(this.__fe){this._scheduleChildrenUpdate();}
;}
,getChildren:function(){return this.__fq||null;}
,getChild:function(cF){var cG=this.__fq;return cG&&cG[cF]||null;}
,hasChildren:function(){var cH=this.__fq;return cH&&cH[0]!==undefined;}
,indexOf:function(cJ){var cI=this.__fq;return cI?cI.indexOf(cJ):-1;}
,hasChild:function(cL){var cK=this.__fq;return cK&&cK.indexOf(cL)!==-1;}
,add:function(cM){if(arguments[1]){for(var i=0,l=arguments.length;i<l;i++ ){this.__fv(arguments[i]);}
;this.__fq.push.apply(this.__fq,arguments);}
else {this.__fv(cM);this.__fq.push(cM);}
;return this;}
,addAt:function(cO,cN){this.__fv(cO);qx.lang.Array.insertAt(this.__fq,cO,cN);return this;}
,remove:function(cP){var cQ=this.__fq;if(!cQ){return this;}
;if(arguments[1]){var cR;for(var i=0,l=arguments.length;i<l;i++ ){cR=arguments[i];this.__fw(cR);qx.lang.Array.remove(cQ,cR);}
;}
else {this.__fw(cP);qx.lang.Array.remove(cQ,cP);}
;return this;}
,removeAt:function(cS){var cT=this.__fq;if(!cT){throw new Error(E);}
;var cU=cT[cS];if(!cU){throw new Error(Q);}
;this.__fw(cU);qx.lang.Array.removeAt(this.__fq,cS);return this;}
,removeAll:function(){var cV=this.__fq;if(cV){for(var i=0,l=cV.length;i<l;i++ ){this.__fw(cV[i]);}
;cV.length=0;}
;return this;}
,getParent:function(){return this.__fs||null;}
,insertInto:function(parent,cW){parent.__fv(this);if(cW==null){parent.__fq.push(this);}
else {qx.lang.Array.insertAt(this.__fq,this,cW);}
;return this;}
,insertBefore:function(cX){var parent=cX.__fs;parent.__fv(this);qx.lang.Array.insertBefore(parent.__fq,this,cX);return this;}
,insertAfter:function(cY){var parent=cY.__fs;parent.__fv(this);qx.lang.Array.insertAfter(parent.__fq,this,cY);return this;}
,moveTo:function(da){var parent=this.__fs;parent.__fx(this);var dc=parent.__fq.indexOf(this);if(dc===da){throw new Error(I);}
else if(dc<da){da-- ;}
;qx.lang.Array.removeAt(parent.__fq,dc);qx.lang.Array.insertAt(parent.__fq,this,da);return this;}
,moveBefore:function(dd){var parent=this.__fs;return this.moveTo(parent.__fq.indexOf(dd));}
,moveAfter:function(de){var parent=this.__fs;return this.moveTo(parent.__fq.indexOf(de)+1);}
,free:function(){var parent=this.__fs;if(!parent){throw new Error(V);}
;if(!parent.__fq){return this;}
;parent.__fw(this);qx.lang.Array.remove(parent.__fq,this);return this;}
,getDomElement:function(){return this.__fe||null;}
,getNodeName:function(){return this.__eU;}
,setNodeName:function(name){this.__eU=name;}
,setRoot:function(df){this.__a=df;}
,useMarkup:function(dg){if(this.__fe){throw new Error(bv);}
;if(qx.core.Environment.get(Y)==X){var dh=document.createElement(q);}
else {var dh=qx.dom.Element.getHelperElement();}
;dh.innerHTML=dg;this.useElement(dh.firstChild);return this.__fe;}
,useElement:function(di){if(this.__fe){throw new Error(bv);}
;this.__fe=di;this.__fe.$$element=this.$$hash;this._copyData(true);}
,isFocusable:function(){var dk=this.getAttribute(P);if(dk>=1){return true;}
;var dj=qx.event.handler.Focus.FOCUSABLE_ELEMENTS;if(dk>=0&&dj[this.__eU]){return true;}
;return false;}
...
;}
,isNativelyFocusable:function(){return !!qx.event.handler.Focus.FOCUSABLE_ELEMENTS[this.__eU];}
,include:function(){if(this.__ff){return this;}
;delete this.__ff;if(this.__fs){this.__fs._scheduleChildrenUpdate();}
;return this;}
,exclude:function(){if(!this.__ff){return this;}
;this.__ff=false;if(this.__fs){this.__fs._scheduleChildrenUpdate();}
;return this;}
,isIncluded:function(){return this.__ff===true;}
,fadeIn:function(dn){var dp=qxWeb(this.__fe);if(dp.isPlaying()){dp.stop();}
;if(!this.__fe){this.__ft();dp.push(this.__fe);}
;if(this.__fe){dp.fadeIn(dn);return dp.getAnimationHandles()[0];}
;}
,fadeOut:function(dq){var dr=qxWeb(this.__fe);if(dr.isPlaying()){dr.stop();}
;if(this.__fe){dr.fadeOut(dq).once(v,function(){this.hide();qx.html.Element.flush();}
,this);return dr.getAnimationHandles()[0];}
;}
,show:function(){if(this.__fg){return this;}
;if(this.__fe){qx.html.Element._visibility[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;if(this.__fs){this.__fs._scheduleChildrenUpdate();}
;delete this.__fg;return this;}
,hide:function(){if(!this.__fg){return this;}
;if(this.__fe){qx.html.Element._visibility[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;this.__fg=false;return this;}
,isVisible:function(){return this.__fg===true;}
,scrollChildIntoViewX:function(dv,dt,dw){var ds=this.__fe;var du=dv.getDomElement();if(dw!==false&&ds&&ds.offsetWidth&&du&&du.offsetWidth){qx.bom.element.Scroll.intoViewX(du,ds,dt);}
else {this.__fh={element:dv,align:dt};qx.html.Element._scroll[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;delete this.__fj;}
,scrollChildIntoViewY:function(dA,dy,dB){var dx=this.__fe;var dz=dA.getDomElement();if(dB!==false&&dx&&dx.offsetWidth&&dz&&dz.offsetWidth){qx.bom.element.Scroll.intoViewY(dz,dx,dy);}
else {this.__fi={element:dA,align:dy};qx.html.Element._scroll[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;delete this.__fk;}
,scrollToX:function(x,dC){var dD=this.__fe;if(dC!==true&&dD&&dD.offsetWidth){dD.scrollLeft=x;delete this.__fj;}
else {this.__fj=x;qx.html.Element._scroll[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;delete this.__fh;}
,getScrollX:function(){var dE=this.__fe;if(dE){return dE.scrollLeft;}
;return this.__fj||0;}
,scrollToY:function(y,dG){var dF=this.__fe;if(dG!==true&&dF&&dF.offsetWidth){dF.scrollTop=y;delete this.__fk;}
else {this.__fk=y;qx.html.Element._scroll[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;delete this.__fi;}
,getScrollY:function(){var dH=this.__fe;if(dH){return dH.scrollTop;}
;return this.__fk||0;}
,disableScrolling:function(){this.enableScrolling();this.scrollToX(0);this.scrollToY(0);this.addListener(h,this.__fz,this);}
,enableScrolling:function(){this.removeListener(h,this.__fz,this);}
,__fy:null,__fz:function(e){if(!this.__fy){this.__fy=true;this.__fe.scrollTop=0;this.__fe.scrollLeft=0;delete this.__fy;}
;}
,getTextSelection:function(){var dI=this.__fe;if(dI){return qx.bom.Selection.get(dI);}
;return null;}
,getTextSelectionLength:function(){var dJ=this.__fe;if(dJ){return qx.bom.Selection.getLength(dJ);}
;return null;}
,getTextSelectionStart:function(){var dK=this.__fe;if(dK){return qx.bom.Selection.getStart(dK);}
;return null;}
,getTextSelectionEnd:function(){var dL=this.__fe;if(dL){return qx.bom.Selection.getEnd(dL);}
;return null;}
,setTextSelection:function(dM,dN){var dO=this.__fe;if(dO){qx.bom.Selection.set(dO,dM,dN);return;}
;qx.html.Element.__eX[this.toHashCode()]={element:this,start:dM,end:dN};qx.html.Element._scheduleFlush(K);}
,clearTextSelection:function(){var dP=this.__fe;if(dP){qx.bom.Selection.clear(dP);}
;delete qx.html.Element.__eX[this.toHashCode()];}
,__fA:function(dQ,dR){var dS=qx.html.Element._actions;dS.push({type:dQ,element:this,args:dR||[]});qx.html.Element._scheduleFlush(K);}
,focus:function(){this.__fA(k);}
,blur:function(){this.__fA(p);}
,activate:function(){this.__fA(U);}
,deactivate:function(){this.__fA(s);}
,capture:function(dT){this.__fA(B,[dT!==false]);}
,releaseCapture:function(){this.__fA(H);}
,setStyle:function(dU,dV,dW){if(!this.__eV){this.__eV={};}
;if(this.__eV[dU]==dV){return this;}
;if(dV==null){delete this.__eV[dU];}
else {this.__eV[dU]=dV;}
;if(this.__fe){if(dW){qx.bom.element.Style.set(this.__fe,dU,dV);return this;}
;if(!this.__fl){this.__fl={};}
;this.__fl[dU]=true;qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;return this;}
,setStyles:function(dY,eb){var ea=qx.bom.element.Style;if(!this.__eV){this.__eV={};}
;if(this.__fe){if(!this.__fl){this.__fl={};}
;for(var dX in dY){var ec=dY[dX];if(this.__eV[dX]==ec){continue;}
;if(ec==null){delete this.__eV[dX];}
else {this.__eV[dX]=ec;}
;if(eb){ea.set(this.__fe,dX,ec);continue;}
;this.__fl[dX]=true;}
;qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
else {for(var dX in dY){var ec=dY[dX];if(this.__eV[dX]==ec){continue;}
;if(ec==null){delete this.__eV[dX];}
else {this.__eV[dX]=ec;}
;}
;}
...
,getStyle:function(ef){return this.__eV?this.__eV[ef]:null;}
,getAllStyles:function(){return this.__eV||null;}
,setAttribute:function(eg,eh,ei){if(!this.__eW){this.__eW={};}
;if(this.__eW[eg]==eh){return this;}
;if(eh==null){delete this.__eW[eg];}
else {this.__eW[eg]=eh;}
;if(this.__fe){if(ei){qx.bom.element.Attribute.set(this.__fe,eg,eh);return this;}
;if(!this.__fm){this.__fm={};}
;this.__fm[eg]=true;qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;return this;}
...
,getAttribute:function(ep){return this.__eW?this.__eW[ep]:null;}
...
,_setProperty:function(et,eu,ev){if(!this.__fo){this.__fo={};}
;if(this.__fo[et]==eu){return this;}
;if(eu==null){delete this.__fo[et];}
else {this.__fo[et]=eu;}
;if(this.__fe){if(ev){this._applyProperty(et,eu);return this;}
;if(!this.__fn){this.__fn={};}
;this.__fn[et]=true;qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;return this;}
,_removeProperty:function(ex,ew){return this._setProperty(ex,null,ew);}
,_getProperty:function(ez){var ey=this.__fo;if(!ey){return null;}
...
;}
;if(this.__fe){return qx.event.Registration.addListener(this.__fe,eF,eC,self,eB);}
;if(!this.__fp){this.__fp={};}
;if(eB==null){eB=false;}
;var eE=qx.event.Manager.getNextUniqueId();var eG=eF+(eB?g:c)+eE;this.__fp[eG]={type:eF,listener:eC,self:self,capture:eB,unique:eE};return eG;}
,removeListener:function(eN,eI,self,eH){if(this.$$disposed){return null;}
;if(qx.core.Environment.get(A)){var eL=N+eN+t+z+this+f;this.assertString(eN,eL+S);this.assertFunction(eI,eL+G);if(self!==undefined){this.assertObject(self,J);}
;if(eH!==undefined){this.assertBoolean(eH,j);}
;}
;if(this.__fe){qx.event.Registration.removeListener(this.__fe,eN,eI,self,eH);}
else {var eJ=this.__fp;var eM;if(eH==null){eH=false;}
...
;if(this.__fe){qx.event.Registration.removeListenerById(this.__fe,eO);}
else {delete this.__fp[eO];}
;return this;}
,hasListener:function(eQ,eP){if(this.$$disposed){return false;}
;if(this.__fe){return qx.event.Registration.hasListener(this.__fe,eQ,eP);}
;var eR=this.__fp;var eT;if(eP==null){eP=false;}
;for(var eS in eR){eT=eR[eS];if(eT.capture===eP&&eT.type===eQ){return true;}
;}
;return false;}
,getListeners:function(){if(this.$$disposed){return null;}
;if(this.__fe){return qx.event.Registration.getManager(this.__fe).serializeListeners(this.__fe);}
;var eU=[];for(var eW in this.__fp){var eV=this.__fp[eW];eU.push({type:eV.type,handler:eV.listener,self:eV.self,capture:eV.capture});}
;return eU;}
},defer:function(eX){eX.__fB=new qx.util.DeferredCall(eX.flush,eX);}
,destruct:function(){var eY=this.__fe;if(eY){qx.event.Registration.getManager(eY).removeAllListeners(eY);eY.$$element=L;}
;if(!qx.core.ObjectRegistry.inShutDown){var parent=this.__fs;if(parent&&!parent.$$disposed){parent.remove(this);}
;}
;this._disposeArray(R);this.__eW=this.__eV=this.__fp=this.__fo=this.__fm=this.__fl=this.__fn=this.__fe=this.__fs=this.__fh=this.__fi=null;}
});}
)();
(function(){var a="qx.event.handler.Appear",b="engine.name",c="mshtml",d="disappear",e="appear",f="browser.documentmode";qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);this.__eT=g;this.__fC={};qx.event.handler.Appear.__fD[this.$$hash]=this;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{appear:true,disappear:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:true,__fD:{},refresh:function(){var h=this.__fD;for(var i in h){h[i].refresh();}
;}
},members:{__eT:null,__fC:null,canHandleEvent:function(k,j){}
,registerEvent:function(o,p,m){var n=qx.core.ObjectRegistry.toHashCode(o)+p;var l=this.__fC;if(l&&!l[n]){l[n]=o;o.$$displayed=o.offsetWidth>0;}
;}
,unregisterEvent:function(t,u,r){var s=qx.core.ObjectRegistry.toHashCode(t)+u;var q=this.__fC;if(!q){return;}
;if(q[s]){delete q[s];}
;}
,refresh:function(){var A=this.__fC;var x;var y=qx.core.Environment.get(b)==c&&qx.core.Environment.get(f)<9;for(var v in A){x=A[v];var w=x.offsetWidth>0;if(!w&&y){w=x.offsetWidth>0;}
;if((!!x.$$displayed)!==w){x.$$displayed=w;var z=qx.event.Registration.createEvent(w?e:d);this.__eT.dispatchEvent(x,z);}
;}
;}
},destruct:function(){this.__eT=this.__fC=null;delete qx.event.handler.Appear.__fD[this.$$hash];}
,defer:function(B){qx.event.Registration.addHandler(B);}
});}
)();
...
(function(){var a="qx.event.handler.UserAction";qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(b){qx.core.Object.call(this);this.__eT=b;this.__cx=b.getWindow();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{useraction:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__eT:null,__cx:null,canHandleEvent:function(d,c){}
,registerEvent:function(g,f,e){}
,unregisterEvent:function(j,i,h){}
},destruct:function(){this.__eT=this.__cx=null;}
,defer:function(k){qx.event.Registration.addHandler(k);}
});}
)();
(function(){var a="os.name",b="mousedown",c="mouseout",d="gecko",e="dblclick",f="useraction",g="mousewheel",h="event.touch",j="mousemove",k="ios",l="mouseover",m="qx.event.handler.Mouse",n="click",o="on",p="engine.version",q="engine.name",r="mouseup",s="contextmenu",t="qx.emulatemouse",u="webkit",v="DOMMouseScroll",w="device.touch",x="event.mspointer";qx.Class.define(m,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(y){qx.core.Object.call(this);this.__eT=y;this.__cx=y.getWindow();this.__a=this.__cx.document;if(!(qx.core.Environment.get(h)&&qx.event.handler.MouseEmulation.ON)){this._initButtonObserver();this._initMoveObserver();this._initWheelObserver();}
;if(qx.core.Environment.get(t)){qx.event.handler.MouseEmulation;}
;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{mousemove:1,mouseover:1,mouseout:1,mousedown:1,mouseup:1,click:1,dblclick:1,contextmenu:1,mousewheel:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE+qx.event.IEventHandler.TARGET_DOCUMENT+qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__fE:null,__fF:null,__fG:null,__fH:null,__fI:null,__eT:null,__cx:null,__a:null,__fJ:null,canHandleEvent:function(A,z){}
...
:(function(){return null;}
),__fK:function(H,I,J){if(!J){J=qx.bom.Event.getTarget(H);}
...
,__fL:function(){var M=[this.__cx,this.__a,this.__a.body];var L=this.__cx;var K=v;for(var i=0;i<M.length;i++ ){if(qx.bom.Event.supportsEvent(M[i],g)){K=g;L=M[i];break;}
;}
;return {type:K,target:L};}
,preventNextClick:function(){this.__fJ=true;}
,_initButtonObserver:function(){this.__fE=qx.lang.Function.listener(this._onButtonEvent,this);var Event=qx.bom.Event;Event.addNativeListener(this.__a,b,this.__fE);Event.addNativeListener(this.__a,r,this.__fE);if(!(qx.event.handler.MouseEmulation.ON&&qx.core.Environment.get(x)&&qx.core.Environment.get(w))){Event.addNativeListener(this.__a,n,this.__fE);}
;Event.addNativeListener(this.__a,e,this.__fE);Event.addNativeListener(this.__a,s,this.__fE);}
,_initMoveObserver:function(){this.__fF=qx.lang.Function.listener(this._onMoveEvent,this);var Event=qx.bom.Event;Event.addNativeListener(this.__a,j,this.__fF);Event.addNativeListener(this.__a,l,this.__fF);Event.addNativeListener(this.__a,c,this.__fF);}
,_initWheelObserver:function(){this.__fG=qx.lang.Function.listener(this._onWheelEvent,this);var N=this.__fL();qx.bom.Event.addNativeListener(N.target,N.type,this.__fG);}
,_stopButtonObserver:function(){var Event=qx.bom.Event;Event.removeNativeListener(this.__a,b,this.__fE);Event.removeNativeListener(this.__a,r,this.__fE);if(!(qx.event.handler.MouseEmulation.ON&&qx.core.Environment.get(x)&&qx.core.Environment.get(w))){Event.removeNativeListener(this.__a,n,this.__fE);}
;Event.removeNativeListener(this.__a,e,this.__fE);Event.removeNativeListener(this.__a,s,this.__fE);}
,_stopMoveObserver:function(){var Event=qx.bom.Event;Event.removeNativeListener(this.__a,j,this.__fF);Event.removeNativeListener(this.__a,l,this.__fF);Event.removeNativeListener(this.__a,c,this.__fF);}
,_stopWheelObserver:function(){var O=this.__fL();qx.bom.Event.removeNativeListener(O.target,O.type,this.__fG);}
,_onMoveEvent:qx.event.GlobalError.observeMethod(function(P){this.__fK(P);}
),_onButtonEvent:qx.event.GlobalError.observeMethod(function(S){var R=S.type;var T=qx.bom.Event.getTarget(S);if(R==n&&this.__fJ){delete this.__fJ;return;}
;if(qx.core.Environment.get(q)==d||qx.core.Environment.get(q)==u){if(T&&T.nodeType==3){T=T.parentNode;}
;}
;var Q=qx.event.handler.DragDrop&&this.__eT.getHandler(qx.event.handler.DragDrop).isSessionActive();if(Q&&R==n){return;}
;if(this.__fM){this.__fM(S,R,T);}
;if(this.__fO){this.__fO(S,R,T);}
;this.__fK(S,R,T);if(this.__fN){this.__fN(S,R,T);}
;if(this.__fP&&!Q){this.__fP(S,R,T);}
;this.__fH=R;}
),_onWheelEvent:qx.event.GlobalError.observeMethod(function(U){this.__fK(U,g);}
),__fM:qx.core.Environment.select(q,{"webkit":function(W,V,X){if(parseFloat(qx.core.Environment.get(p))<530){if(V==s){this.__fK(W,r,X);}
;}
;}
,"default":null}),__fN:qx.core.Environment.select(q,{"opera":function(Y,ba,bb){if(ba==r&&Y.button==2){this.__fK(Y,s,bb);}
;}
,"default":null}),__fO:qx.core.Environment.select(q,{"mshtml":function(bc,bd,be){if(bc.target!==undefined){return;}
;if(bd==r&&this.__fH==n){this.__fK(bc,b,be);}
else if(bd==e){this.__fK(bc,n,be);}
;}
,"default":null}),__fP:qx.core.Environment.select(q,{"mshtml":null,"default":function(bg,bf,bh){switch(bf){case b:this.__fI=bh;break;case r:if(bh!==this.__fI){var bi=qx.dom.Hierarchy.getCommonParent(bh,this.__fI);if(bi){this.__fK(bg,n,bi);}
;}
;};}
...
;this.__eT=this.__cx=this.__a=this.__fI=null;}
...
,isMultiTouch:function(){return this.__fR().length>1;}
,getScale:function(){return this._native.scale;}
,getRotation:function(){return this._native.rotation;}
,getDocumentLeft:function(f){return this.__fQ(f).pageX;}
,getDocumentTop:function(g){return this.__fQ(g).pageY;}
,getScreenLeft:function(h){return this.__fQ(h).screenX;}
,getScreenTop:function(j){return this.__fQ(j).screenY;}
,getViewportLeft:function(k){return this.__fQ(k).clientX;}
,getViewportTop:function(l){return this.__fQ(l).clientY;}
,getIdentifier:function(m){return this.__fQ(m).identifier;}
,__fQ:function(n){n=n==null?0:n;return this.__fR()[n];}
,__fR:function(){var o=(this._isTouchEnd()?this.getChangedTargetTouches():this.getTargetTouches());return o;}
...
;var t=document.createElement(q);var s=t.style;s.height=s.width=m;s.overflow=w;document.body.appendChild(t);var c=z(t);this.__fS=c;document.body.removeChild(t);return this.__fS;}
...
(function(){var a="resize",b="os.name",c="qx.event.handler.Orientation",d="landscape",e="android",f="portrait",g="orientationchange";qx.Class.define(c,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(h){qx.core.Object.call(this);this.__eT=h;this.__cx=h.getWindow();this._initObserver();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{orientationchange:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__eT:null,__cx:null,__fT:null,_currentOrientation:null,__fU:null,canHandleEvent:function(j,i){}
,registerEvent:function(m,l,k){}
,unregisterEvent:function(p,o,n){}
,_initObserver:function(){this.__fU=qx.lang.Function.listener(this._onNative,this);this.__fT=qx.bom.Event.supportsEvent(this.__cx,g)?g:a;var Event=qx.bom.Event;Event.addNativeListener(this.__cx,this.__fT,this.__fU);}
,_stopObserver:function(){var Event=qx.bom.Event;Event.removeNativeListener(this.__cx,this.__fT,this.__fU);}
...
;}
},destruct:function(){this._stopObserver();this.__eT=this.__cx=null;}
,defer:function(w){qx.event.Registration.addHandler(w);}
});}
)();
(function(){var a="landscape",b="qx.event.type.Orientation",c="portrait";qx.Class.define(b,{extend:qx.event.type.Event,members:{__fV:null,__fW:null,init:function(d,e){qx.event.type.Event.prototype.init.call(this,false,false);this.__fV=d;this.__fW=e;return this;}
,clone:function(f){var g=qx.event.type.Event.prototype.clone.call(this,f);g.__fV=this.__fV;g.__fW=this.__fW;return g;}
,getOrientation:function(){return this.__fV;}
,isLandscape:function(){return this.__fW==a;}
,isPortrait:function(){return this.__fW==c;}
}});}
)();
(function(){var a="touchmove",b="os.name",c="MSPointerDown",d="swipe",e="android",f="pointercancel",g="qx.event.handler.TouchCore",h="event.mspointer",j="MSPointerCancel",k="y",l="pointer-events",m="longtap",n="pointerup",o="touchend",p="pointerdown",q="MSPointerUp",r="right",s="engine.name",t="x",u="touchcancel",v="MSPointerMove",w="webkit",z="none",A="left",B="tap",C="pointermove",D="down",E="undefined",F="up",G="touchstart";qx.Bootstrap.define(g,{extend:Object,statics:{TAP_MAX_DISTANCE:qx.core.Environment.get(b)!=e?10:40,SWIPE_DIRECTION:{x:[A,r],y:[F,D]},SWIPE_MIN_DISTANCE:qx.core.Environment.get(b)!=e?11:41,SWIPE_MIN_VELOCITY:0,LONGTAP_TIME:500},construct:function(H,I){this.__fX=H;this.__ed=I;this._initTouchObserver();}
,members:{__fX:null,__ed:null,__fY:null,__ga:null,__gb:null,__gc:null,__gd:null,__ge:null,__gf:null,__gg:null,__gh:null,__gi:null,__gj:null,_initTouchObserver:function(){this.__fY=qx.lang.Function.listener(this._onTouchEvent,this);var Event=qx.bom.Event;Event.addNativeListener(this.__fX,G,this.__fY);Event.addNativeListener(this.__fX,a,this.__fY);Event.addNativeListener(this.__fX,o,this.__fY);Event.addNativeListener(this.__fX,u,this.__fY);if(qx.core.Environment.get(h)){Event.addNativeListener(this.__fX,c,this.__fY);Event.addNativeListener(this.__fX,v,this.__fY);Event.addNativeListener(this.__fX,q,this.__fY);Event.addNativeListener(this.__fX,j,this.__fY);Event.addNativeListener(this.__fX,p,this.__fY);Event.addNativeListener(this.__fX,C,this.__fY);Event.addNativeListener(this.__fX,n,this.__fY);Event.addNativeListener(this.__fX,f,this.__fY);}
;}
,_stopTouchObserver:function(){var Event=qx.bom.Event;Event.removeNativeListener(this.__fX,G,this.__fY);Event.removeNativeListener(this.__fX,a,this.__fY);Event.removeNativeListener(this.__fX,o,this.__fY);Event.removeNativeListener(this.__fX,u,this.__fY);if(qx.core.Environment.get(h)){Event.removeNativeListener(this.__fX,c,this.__fY);Event.removeNativeListener(this.__fX,v,this.__fY);Event.removeNativeListener(this.__fX,q,this.__fY);Event.removeNativeListener(this.__fX,j,this.__fY);Event.removeNativeListener(this.__fX,p,this.__fY);Event.removeNativeListener(this.__fX,C,this.__fY);Event.removeNativeListener(this.__fX,n,this.__fY);Event.removeNativeListener(this.__fX,f,this.__fY);}
;}
,_onTouchEvent:function(J){this._commonTouchEventHandler(J);}
,_getScalingDistance:function(L,K){return (Math.sqrt(Math.pow(L.pageX-K.pageX,2)+Math.pow(L.pageY-K.pageY,2)));}
,_getRotationAngle:function(N,M){var x=N.pageX-M.pageX;var y=N.pageY-M.pageY;return (Math.atan2(y,x)*180/Math.PI);}
,_commonTouchEventHandler:function(Q,O){var O=O||Q.type;if(qx.core.Environment.get(h)){Q.changedTouches=[Q];Q.targetTouches=[Q];Q.touches=[Q];O=this._mapPointerEvent(O);}
;if(O==G){this.__ga=this._getTarget(Q);this.__gf=true;if(Q.touches&&Q.touches.length>1){this.__gh=this._getScalingDistance(Q.touches[0],Q.touches[1]);this.__gi=this._getRotationAngle(Q.touches[0],Q.touches[1]);}
;}
;if(O==a){if(typeof Q.scale==E&&Q.targetTouches.length>1){var R=this._getScalingDistance(Q.targetTouches[0],Q.targetTouches[1]);Q.scale=R/this.__gh;}
;if(typeof Q.rotation==E&&Q.targetTouches.length>1){var P=this._getRotationAngle(Q.targetTouches[0],Q.targetTouches[1]);Q.rotation=P-this.__gi;}
;if(this.__gf){this.__gf=this._isBelowTapMaxDistance(Q.changedTouches[0]);}
;}
;this._fireEvent(Q,O);this.__gl(Q,O);}
,_mapPointerEvent:function(S){S=S.toLowerCase();if(S.indexOf(p)!==-1){return G;}
else if(S.indexOf(n)!==-1){return o;}
else if(S.indexOf(C)!==-1){if(this.__gg===true){return a;}
;}
else if(S.indexOf(f)!==-1){return u;}
;return S;}
,_isBelowTapMaxDistance:function(T){var U={x:T.screenX-this.__gb,y:T.screenY-this.__gc};var V=qx.event.handler.TouchCore;return (Math.abs(U.x)<=V.TAP_MAX_DISTANCE&&Math.abs(U.y)<=V.TAP_MAX_DISTANCE);}
,_getTarget:function(X){var Y=qx.bom.Event.getTarget(X);if(qx.core.Environment.get(s)==w){if(Y&&Y.nodeType==3){Y=Y.parentNode;}
;}
else if(qx.core.Environment.get(h)){var W=this.__gk(X);if(W){Y=W;}
;}
;return Y;}
,__gk:function(bc){if(bc&&bc.touches){var ba=bc.touches[0].clientX;var bb=bc.touches[0].clientY;}
;var be=document.msElementsFromPoint(ba,bb);if(be){for(var i=0;i<be.length;i++ ){var bf=be[i];var bd=qx.bom.element.Style.get(bf,l,3);if(bd!=z){return bf;}
;}
;}
;return null;}
,_fireEvent:function(bg,bh,bi){if(!bi){bi=this._getTarget(bg);}
;var bh=bh||bg.type;if(bi&&bi.nodeType&&this.__ed){this.__ed.emit(bh,bg);}
;}
,__gl:function(bj,bk,bl){if(!bl){bl=this._getTarget(bj);}
;var bk=bk||bj.type;if(bk==G){this.__gm(bj,bl);}
else if(bk==a){this.__gn(bj,bl);}
else if(bk==o){this.__go(bj,bl);}
;}
,__gm:function(bn,bo){var bm=bn.changedTouches[0];this.__gg=true;this.__gb=bm.screenX;this.__gc=bm.screenY;this.__gd=new Date().getTime();this.__ge=bn.targetTouches.length===1;if(this.__ge){this.__gj=window.setTimeout(this.__gq.bind(this,bn,bo),qx.event.handler.TouchCore.LONGTAP_TIME);}
else {this.__gr();}
;}
,__gn:function(bp,bq){if(this.__ge&&bp.changedTouches.length>1){this.__ge=false;}
;if(!this._isBelowTapMaxDistance(bp.changedTouches[0])){this.__gr();}
;}
,__go:function(br,bs){this.__gg=false;this.__gr();if(this.__ge){var bv=br.changedTouches[0];var bw={x:bv.screenX-this.__gb,y:bv.screenY-this.__gc};var bt;if(this.__ga==bs&&this.__gf){if(qx.event&&qx.event.type&&qx.event.type.Tap){bt=qx.event.type.Tap;}
;this._fireEvent(br,B,bs,bt);}
else {var bu=this.__gp(br,bs,bw);if(bu){if(qx.event&&qx.event.type&&qx.event.type.Swipe){bt=qx.event.type.Swipe;}
;br.swipe=bu;this._fireEvent(br,d,bs,bt);}
;}
;}
;}
,__gp:function(bz,bA,bF){var bC=qx.event.handler.TouchCore;var bD=new Date().getTime()-this.__gd;var bG=(Math.abs(bF.x)>=Math.abs(bF.y))?t:k;var bx=bF[bG];var by=bC.SWIPE_DIRECTION[bG][bx<0?0:1];var bE=(bD!==0)?bx/bD:0;var bB=null;if(Math.abs(bE)>=bC.SWIPE_MIN_VELOCITY&&Math.abs(bx)>=bC.SWIPE_MIN_DISTANCE){bB={startTime:this.__gd,duration:bD,axis:bG,direction:by,distance:bx,velocity:bE};}
;return bB;}
,__gq:function(bH,bI){this._fireEvent(bH,m,bI,qx.event.type.Tap);this.__gj=null;this.__gf=false;}
,__gr:function(){if(this.__gj){window.clearTimeout(this.__gj);this.__gj=null;}
;}
,dispose:function(){this._stopTouchObserver();this.__ga=this.__fX=this.__ed=this.__gh=this.__gi=null;this.__gr();}
}});}
)();
(function(){var a="touchmove",b="engine.name",c="mouseup",d="qx.event.handler.Touch",f="useraction",g="touchend",h="mshtml",i="event.mspointer",j="qx.mobile.nativescroll",k="dispose",l="qx.mobile.emulatetouch",m="event.touch",n="touchstart",o="mousedown",p="mousemove";qx.Class.define(d,{extend:qx.event.handler.TouchCore,implement:qx.event.IEventHandler,construct:function(q){this.__eT=q;this.__cx=q.getWindow();this.__a=this.__cx.document;qx.event.handler.TouchCore.apply(this,[this.__a]);if(!qx.core.Environment.get(i)){this._initMouseObserver();}
;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{touchstart:1,touchmove:1,touchend:1,touchcancel:1,tap:1,longtap:1,swipe:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE+qx.event.IEventHandler.TARGET_DOCUMENT,IGNORE_CAN_HANDLE:true,MOUSE_TO_TOUCH_MAPPING:{"mousedown":n,"mousemove":a,"mouseup":g}},members:{__gs:null,__eT:null,__cx:null,__a:null,__gt:false,canHandleEvent:function(s,r){}
,registerEvent:function(v,u,t){}
,unregisterEvent:function(y,x,w){}
...
,__gu:qx.core.Environment.select(l,{"true":function(E){var D=E.type;var F=qx.event.handler.Touch.MOUSE_TO_TOUCH_MAPPING;if(F[D]){D=F[D];if(D==n&&this.__gv(E)){this.__gt=true;}
else if(D==g){this.__gt=false;}
;var H=this.__gw(E);var G=(D==g?[]:[H]);E.touches=G;E.targetTouches=G;E.changedTouches=[H];}
;return D;}
,"default":(function(){}
)}),__gv:qx.core.Environment.select(l,{"true":function(J){if((qx.core.Environment.get(b)==h)){var I=1;}
else {var I=0;}
;return J.button==I;}
,"default":(function(){}
)}),__gw:qx.core.Environment.select(l,{"true":function(K){var L=this._getTarget(K);return {clientX:K.clientX,clientY:K.clientY,screenX:K.screenX,screenY:K.screenY,pageX:K.pageX,pageY:K.pageY,identifier:1,target:L};}
,"default":(function(){}
)}),_initMouseObserver:qx.core.Environment.select(l,{"true":function(){if(!qx.core.Environment.get(m)){this.__gs=qx.lang.Function.listener(this._onMouseEvent,this);var Event=qx.bom.Event;Event.addNativeListener(this.__a,o,this.__gs);Event.addNativeListener(this.__a,p,this.__gs);Event.addNativeListener(this.__a,c,this.__gs);}
;}
,"default":(function(){}
)}),_stopMouseObserver:qx.core.Environment.select(l,{"true":function(){if(!qx.core.Environment.get(m)){var Event=qx.bom.Event;Event.removeNativeListener(this.__a,o,this.__gs);Event.removeNativeListener(this.__a,p,this.__gs);Event.removeNativeListener(this.__a,c,this.__gs);}
;}
,"default":(function(){}
)}),_onTouchEvent:qx.event.GlobalError.observeMethod(function(M){this._commonTouchEventHandler(M);}
),_onMouseEvent:qx.core.Environment.select(l,{"true":qx.event.GlobalError.observeMethod(function(O){if(!qx.core.Environment.get(m)){if(O.type==p&&!this.__gt){return;}
;var N=this.__gu(O);this._commonTouchEventHandler(O,N);}
;}
),"default":(function(){}
)}),dispose:function(){this.__gx(k);this._stopMouseObserver();this.__eT=this.__cx=this.__a=null;}
,__gx:function(Q,P){qx.event.handler.TouchCore.prototype[Q].apply(this,P||[]);}
...
(function(){var a="ipod",b="pc",c="ps3",d=")",e="iPhone",f="psp",g="wii",h="xbox",i="\.",j="ipad",k="ds",l="(",m="mobile",n="device.type",o="tablet",p="ontouchstart",q="g",r="|",s="qx.bom.client.Device",t="desktop",u="device.name",v="device.touch",w="undefined",x="device.pixelRatio";qx.Bootstrap.define(s,{statics:{__dt:{"iPod":a,"iPad":j,"iPhone":e,"PSP":f,"PLAYSTATION 3":c,"Nintendo Wii":g,"Nintendo DS":k,"XBOX":h,"Xbox":h},getName:function(){var A=[];for(var z in this.__dt){A.push(z);}
;var B=new RegExp(l+A.join(r).replace(/\./g,i)+d,q);var y=B.exec(navigator.userAgent);if(y&&y[1]){return qx.bom.client.Device.__dt[y[1]];}
;return b;}
...
(function(){var a="touchmove",b="os.name",c="mouseup",d="mousedown",f="touchend",g="win",h="none",i="qx.event.handler.MouseEmulation",j="event.mspointer",k="qx.emulatemouse",l="longtap",m="click",n="event.touch",o="touchstart",p="contextmenu",q="tap",r="device.touch",s="mousewheel",t="touch",u="mousemove";qx.Class.define(i,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(v){qx.core.Object.call(this);this.__eT=v;this.__cx=v.getWindow();this.__a=this.__cx.document;if(qx.event.handler.MouseEmulation.ON){this._initObserver();document.documentElement.style.msTouchAction=h;}
;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST,SUPPORTED_TYPES:{mousedown:1,mouseup:1,mousemove:1,click:1,contextmenu:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE+qx.event.IEventHandler.TARGET_DOCUMENT+qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true,ON:qx.core.Environment.get(k)&&((qx.core.Environment.get(j)&&qx.core.Environment.get(r))||(qx.core.Environment.get(n)&&qx.core.Environment.get(b)!==g))},members:{__eT:null,__cx:null,__a:null,__gy:null,__gz:null,__gA:null,__gB:null,canHandleEvent:function(x,w){}
,registerEvent:function(A,z,y){}
,unregisterEvent:function(D,C,B){}
,__fK:function(E,F,G){var H=F==s?new qx.event.type.MouseWheel():new qx.event.type.Mouse();H.init(E,G,null,true,true);H.setType(F);return qx.event.Registration.getManager(G).dispatchEvent(G,H);}
,__gC:function(I,J,K,L){var M=this.__gL(L,K);M.wheelDelta=I;M.wheelDeltaY=J;M.wheelDeltaX=I;this.__fK(M,s,L);}
,__gD:function(O,P,R,N,S){this.__gA=null;this.__gB=null;if(O==0&&P==0){return;}
;var T=parseInt((S||20)/10);if(O>0){O=Math.max(0,O-T);}
else {O=Math.min(0,O+T);}
;if(P>0){P=Math.max(0,P-T);}
else {P=Math.min(0,P+T);}
;var Q=+(new Date());this.__gB=qx.bom.AnimationFrame.request(qx.lang.Function.bind(function(U,V,Y,X,W){this.__gD(U,V,Y,X,W-Q);}
,this,O,P,R,N));this.__gC(O,P,R,N);}
,__gE:function(ba){var bc={x:ba.screenX,y:ba.screenY};var bb=false;var bd=20;if(Math.abs(bc.x-this.__gy.x)>bd){bb=true;}
;if(Math.abs(bc.y-this.__gy.y)>bd){bb=true;}
;return bb;}
,_initObserver:function(){qx.event.Registration.addListener(this.__a,o,this.__gG,this);qx.event.Registration.addListener(this.__a,a,this.__gH,this);qx.event.Registration.addListener(this.__a,f,this.__gI,this);qx.event.Registration.addListener(this.__a,q,this.__gJ,this);qx.event.Registration.addListener(this.__a,l,this.__gK,this);qx.bom.Event.addNativeListener(this.__cx,a,this.__gF);}
,_stopObserver:function(){qx.event.Registration.removeListener(this.__a,o,this.__gG,this);qx.event.Registration.removeListener(this.__a,a,this.__gH,this);qx.event.Registration.removeListener(this.__a,f,this.__gI,this);qx.event.Registration.removeListener(this.__a,q,this.__gJ,this);qx.event.Registration.removeListener(this.__a,l,this.__gK,this);qx.bom.Event.removeNativeListener(this.__cx,a,this.__gF);}
,__gF:function(e){var be=e.target;while(be){if(be.style&&be.style.WebkitOverflowScrolling==t){return;}
;be=be.parentNode;}
;e.preventDefault();}
,__gG:function(e){var bg=e.getTarget();var bf=this.__gL(bg,e.getAllTouches()[0]);if(qx.core.Environment.get(n)){if(!this.__fK(bf,d,bg)){e.preventDefault();}
;}
;this.__gz={x:bf.screenX,y:bf.screenY};this.__gy={x:bf.screenX,y:bf.screenY};if(this.__gB&&window.cancelAnimationFrame){window.cancelAnimationFrame(this.__gB);this.__gB=null;}
;}
,__gH:function(e){var bh=e.getTarget();var bk=this.__gL(bh,e.getChangedTargetTouches()[0]);if(qx.core.Environment.get(n)){if(!this.__fK(bk,u,bh)){e.preventDefault();}
;}
;var bj=-parseInt(this.__gz.y-bk.screenY);var bi=-parseInt(this.__gz.x-bk.screenX);this.__gz={x:bk.screenX,y:bk.screenY};if(e.getNativeEvent().pointerType!=4){var bl=e.getChangedTargetTouches()[0];this.__gC(bi,bj,bl,bh);if(this.__gA){clearTimeout(this.__gA);this.__gA=null;}
;this.__gA=setTimeout(qx.lang.Function.bind(function(bm,bn,bo,bp){this.__gD(bm,bn,bo,bp);}
,this,bi,bj,bl,bh),100);}
;}
,__gI:function(e){var br=e.getTarget();var bq=this.__gL(br,e.getChangedTargetTouches()[0]);if(qx.core.Environment.get(n)){if(!this.__fK(bq,c,br)){e.preventDefault();}
;}
;}
,__gJ:function(e){var bt=e.getTarget();var bs=this.__gL(bt,e.getChangedTargetTouches()[0]);if(!this.__gE(bs)){this.__fK(bs,m,bt);}
;}
,__gK:function(e){var bv=e.getTarget();var bu=this.__gL(bv,e.getChangedTargetTouches()[0]);this.__fK(bu,p,bv);}
,__gL:function(bx,by){var bw={};bw.button=0;bw.wheelDelta=0;bw.wheelDeltaX=0;bw.wheelDeltaY=0;bw.wheelX=0;bw.wheelY=0;bw.target=bx;bw.clientX=by.clientX;bw.clientY=by.clientY;bw.pageX=by.pageX;bw.pageY=by.pageY;bw.screenX=by.screenX;bw.screenY=by.screenY;bw.shiftKey=false;bw.ctrlKey=false;bw.altKey=false;bw.metaKey=false;return bw;}
},destruct:function(){if(qx.event.handler.MouseEmulation.ON){this._stopObserver();}
;this.__eT=this.__cx=this.__a=null;}
...
,__gM:{'0':g,'2':h,'1':b},__gN:{'1':g,'2':h,'4':b},stop:function(){this.stopPropagation();}
...
;default:if(this._native.target!==undefined){return this.__gM[this._native.button]||c;}
else {return this.__gN[this._native.button]||c;}
;};}
...
,__gO:function(p){var m=Math.abs(p);if(qx.event.type.MouseWheel.MINSCROLL==null||qx.event.type.MouseWheel.MINSCROLL>m){qx.event.type.MouseWheel.MINSCROLL=m;this.__gP();}
;if(qx.event.type.MouseWheel.MAXSCROLL==null||qx.event.type.MouseWheel.MAXSCROLL<m){qx.event.type.MouseWheel.MAXSCROLL=m;this.__gP();}
...
,__gP:function(){var q=qx.event.type.MouseWheel.MAXSCROLL||0;var t=qx.event.type.MouseWheel.MINSCROLL||q;if(q<=t){return;}
...
;}
;return this.__gQ(v);}
;if(u===b){var x=0;if(e.wheelDelta!==undefined){if(e.wheelDeltaX!==undefined){x=e.wheelDeltaX?this.__gQ(-e.wheelDeltaX):0;}
;}
else {if(e.axis&&e.axis==e.HORIZONTAL_AXIS){x=this.__gQ(e.detail);}
;}
;return x;}
;if(u===l){var y=0;if(e.wheelDelta!==undefined){if(e.wheelDeltaY!==undefined){y=e.wheelDeltaY?this.__gQ(-e.wheelDeltaY):0;}
else {y=this.__gQ(-e.wheelDelta);}
;}
else {if(!(e.axis&&e.axis==e.HORIZONTAL_AXIS)){y=this.__gQ(e.detail);}
;}
;return y;}
;return 0;}
,__gQ:function(z){if(qx.event.handler.MouseEmulation.ON){return z;}
else if(qx.core.Environment.get(g)){return this.__gO(z);}
...
(function(){var a="mshtml",b="engine.name",c="keypress",d="useraction",e="win",f="text",g="keyinput",h="os.name",i="webkit",j="input",k="gecko",l="off",m="keydown",n="autoComplete",o="keyup",p="qx.event.handler.Keyboard";qx.Class.define(p,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(q){qx.core.Object.call(this);this.__eT=q;this.__cx=q.getWindow();if((qx.core.Environment.get(b)==k)){this.__a=this.__cx;}
else {this.__a=this.__cx.document.documentElement;}
;this.__gR={};this._initKeyObserver();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{keyup:1,keydown:1,keypress:1,keyinput:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:true},members:{__gS:null,__eT:null,__cx:null,__a:null,__gR:null,__gT:null,__gU:null,__gV:null,canHandleEvent:function(s,r){}
,registerEvent:function(v,u,t){}
,unregisterEvent:function(y,x,w){}
,_fireInputEvent:function(A,z){var B=this.__gW();if(B&&B.offsetWidth!=0){var event=qx.event.Registration.createEvent(g,qx.event.type.KeyInput,[A,B,z]);this.__eT.dispatchEvent(B,event);}
;if(this.__cx){qx.event.Registration.fireEvent(this.__cx,d,qx.event.type.Data,[g]);}
;}
,_fireSequenceEvent:function(D,F,C){var E=this.__gW();var G=D.keyCode;var event=qx.event.Registration.createEvent(F,qx.event.type.KeySequence,[D,E,C]);this.__eT.dispatchEvent(E,event);if(qx.core.Environment.get(b)==a||qx.core.Environment.get(b)==i){if(F==m&&event.getDefaultPrevented()){if(!qx.event.util.Keyboard.isNonPrintableKeyCode(G)&&!this._emulateKeyPress[G]){this._fireSequenceEvent(D,c,C);}
;}
;}
;if(this.__cx){qx.event.Registration.fireEvent(this.__cx,d,qx.event.type.Data,[F]);}
;}
,__gW:function(){var H=this.__eT.getHandler(qx.event.handler.Focus);var I=H.getActive();if(!I||I.offsetWidth==0){I=H.getFocus();}
;if(!I||I.offsetWidth==0){I=this.__eT.getWindow().document.body;}
;return I;}
,_initKeyObserver:function(){this.__gS=qx.lang.Function.listener(this.__gX,this);this.__gV=qx.lang.Function.listener(this.__ha,this);var Event=qx.bom.Event;Event.addNativeListener(this.__a,o,this.__gS);Event.addNativeListener(this.__a,m,this.__gS);Event.addNativeListener(this.__a,c,this.__gV);}
,_stopKeyObserver:function(){var Event=qx.bom.Event;Event.removeNativeListener(this.__a,o,this.__gS);Event.removeNativeListener(this.__a,m,this.__gS);Event.removeNativeListener(this.__a,c,this.__gV);for(var K in (this.__gU||{})){var J=this.__gU[K];Event.removeNativeListener(J.target,c,J.callback);}
;delete (this.__gU);}
,__gX:qx.event.GlobalError.observeMethod(qx.core.Environment.select(b,{"mshtml":function(N){N=window.event||N;var O=N.keyCode;var M=0;var L=N.type;if(!(this.__gR[O]==m&&L==m)){this._idealKeyHandler(O,M,L,N);}
;if(L==m){if(qx.event.util.Keyboard.isNonPrintableKeyCode(O)||this._emulateKeyPress[O]){this._idealKeyHandler(O,M,c,N);}
;}
;this.__gR[O]=L;}
,"gecko":function(Q){var S=0;var U=Q.keyCode;var T=Q.type;var R=qx.event.util.Keyboard;if(qx.core.Environment.get(h)==e){var P=U?R.keyCodeToIdentifier(U):R.charCodeToIdentifier(S);if(!(this.__gR[P]==m&&T==m)){this._idealKeyHandler(U,S,T,Q);}
;this.__gR[P]=T;}
else {this._idealKeyHandler(U,S,T,Q);}
;this.__gY(Q.target,T,U);}
...
;}
;this.__gR[Y]=V;}
,"opera":function(ba){this.__gT=ba.keyCode;this._idealKeyHandler(ba.keyCode,0,ba.type,ba);}
})),__gY:qx.core.Environment.select(b,{"gecko":function(bc,be,bf){if(be===m&&(bf==33||bf==34||bf==38||bf==40)&&bc.type==f&&bc.tagName.toLowerCase()===j&&bc.getAttribute(n)!==l){if(!this.__gU){this.__gU={};}
;var bb=qx.core.ObjectRegistry.toHashCode(bc);if(this.__gU[bb]){return;}
;var self=this;this.__gU[bb]={target:bc,callback:function(bg){qx.bom.Event.stopPropagation(bg);self.__ha(bg);}
};var bd=qx.event.GlobalError.observeMethod(this.__gU[bb].callback);qx.bom.Event.addNativeListener(bc,c,bd);}
;}
,"default":null}),__ha:qx.event.GlobalError.observeMethod(qx.core.Environment.select(b,{"mshtml":function(bh){bh=window.event||bh;if(this._charCode2KeyCode[bh.keyCode]){this._idealKeyHandler(this._charCode2KeyCode[bh.keyCode],0,bh.type,bh);}
...
;}
,"opera":function(bm){var bo=bm.keyCode;var bn=bm.type;if(bo!=this.__gT){this._idealKeyHandler(0,this.__gT,bn,bm);}
...
},destruct:function(){this._stopKeyObserver();this.__gT=this.__eT=this.__cx=this.__a=this.__gR=null;}
...
;}
,__fK:function(ba,bc,bf,be){var bd=qx.event.Registration;var bb=bd.createEvent(bf,qx.event.type.Focus,[ba,bc,be]);bd.dispatchEvent(ba,bb);}
,_windowFocused:true,__hn:function(){if(this._windowFocused){this._windowFocused=false;this.__fK(this._window,null,b,false);}
;}
,__ho:function(){if(!this._windowFocused){this._windowFocused=true;this.__fK(this._window,null,d,false);}
;}
,_initObserver:qx.core.Environment.select(w,{"gecko":function(){this.__hd=qx.lang.Function.listener(this.__hu,this);this.__he=qx.lang.Function.listener(this.__hv,this);this.__hf=qx.lang.Function.listener(this.__ht,this);this.__hg=qx.lang.Function.listener(this.__hs,this);this.__hh=qx.lang.Function.listener(this.__hp,this);qx.bom.Event.addNativeListener(this._document,this.__hb,this.__hd,true);qx.bom.Event.addNativeListener(this._document,this.__hc,this.__he,true);qx.bom.Event.addNativeListener(this._window,d,this.__hf,true);qx.bom.Event.addNativeListener(this._window,b,this.__hg,true);qx.bom.Event.addNativeListener(this._window,D,this.__hh,true);}
,"mshtml":function(){this.__hd=qx.lang.Function.listener(this.__hu,this);this.__he=qx.lang.Function.listener(this.__hv,this);this.__hj=qx.lang.Function.listener(this.__hq,this);this.__hk=qx.lang.Function.listener(this.__hr,this);this.__hi=qx.lang.Function.listener(this.__hx,this);qx.bom.Event.addNativeListener(this._document,this.__hb,this.__hd);qx.bom.Event.addNativeListener(this._document,this.__hc,this.__he);qx.bom.Event.addNativeListener(this._document,u,this.__hj);qx.bom.Event.addNativeListener(this._document,z,this.__hk);qx.bom.Event.addNativeListener(this._document,a,this.__hi);}
,"webkit":function(){this.__hd=qx.lang.Function.listener(this.__hu,this);this.__he=qx.lang.Function.listener(this.__hv,this);this.__hk=qx.lang.Function.listener(this.__hr,this);this.__hf=qx.lang.Function.listener(this.__ht,this);this.__hg=qx.lang.Function.listener(this.__hs,this);this.__hi=qx.lang.Function.listener(this.__hx,this);qx.bom.Event.addNativeListener(this._document,this.__hb,this.__hd,true);qx.bom.Event.addNativeListener(this._document,this.__hc,this.__he,true);qx.bom.Event.addNativeListener(this._document,a,this.__hi,false);qx.bom.Event.addNativeListener(this._window,y,this.__hk,true);qx.bom.Event.addNativeListener(this._window,d,this.__hf,true);qx.bom.Event.addNativeListener(this._window,b,this.__hg,true);}
,"opera":function(){this.__hd=qx.lang.Function.listener(this.__hu,this);this.__he=qx.lang.Function.listener(this.__hv,this);this.__hj=qx.lang.Function.listener(this.__hq,this);this.__hk=qx.lang.Function.listener(this.__hr,this);qx.bom.Event.addNativeListener(this._document,this.__hb,this.__hd,true);qx.bom.Event.addNativeListener(this._document,this.__hc,this.__he,true);qx.bom.Event.addNativeListener(this._window,g,this.__hj,true);qx.bom.Event.addNativeListener(this._window,y,this.__hk,true);}
}),_stopObserver:qx.core.Environment.select(w,{"gecko":function(){qx.bom.Event.removeNativeListener(this._document,this.__hb,this.__hd,true);qx.bom.Event.removeNativeListener(this._document,this.__hc,this.__he,true);qx.bom.Event.removeNativeListener(this._window,d,this.__hf,true);qx.bom.Event.removeNativeListener(this._window,b,this.__hg,true);qx.bom.Event.removeNativeListener(this._window,D,this.__hh,true);}
,"mshtml":function(){qx.bom.Event.removeNativeListener(this._document,this.__hb,this.__hd);qx.bom.Event.removeNativeListener(this._document,this.__hc,this.__he);qx.bom.Event.removeNativeListener(this._document,u,this.__hj);qx.bom.Event.removeNativeListener(this._document,z,this.__hk);qx.bom.Event.removeNativeListener(this._document,a,this.__hi);}
,"webkit":function(){qx.bom.Event.removeNativeListener(this._document,this.__hb,this.__hd,true);qx.bom.Event.removeNativeListener(this._document,this.__hc,this.__he,true);qx.bom.Event.removeNativeListener(this._document,a,this.__hi,false);qx.bom.Event.removeNativeListener(this._window,y,this.__hk,true);qx.bom.Event.removeNativeListener(this._window,d,this.__hf,true);qx.bom.Event.removeNativeListener(this._window,b,this.__hg,true);}
,"opera":function(){qx.bom.Event.removeNativeListener(this._document,this.__hb,this.__hd,true);qx.bom.Event.removeNativeListener(this._document,this.__hc,this.__he,true);qx.bom.Event.removeNativeListener(this._window,g,this.__hj,true);qx.bom.Event.removeNativeListener(this._window,y,this.__hk,true);}
...
;this.tryActivate(bk);}
,"opera":function(bl){var bm=qx.bom.Event.getTarget(bl);if(bm==this._document||bm==this._window){this.__ho();if(this.__hl){this.setFocus(this.__hl);delete this.__hl;}
...
;}
,"opera":function(br){var bs=qx.bom.Event.getTarget(br);if(bs==this._document){this.__hn();this.__hl=this.getFocus();this.__hm=this.getActive();this.resetFocus();this.resetActive();}
else {if(bs===this.getFocus()){this.resetFocus();}
;if(bs===this.getActive()){this.resetActive();}
;}
;}
,"default":null})),__hs:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"gecko":function(bt){var bu=qx.bom.Event.getTarget(bt);if(bu===this._window||bu===this._document){this.__hn();this.resetActive();this.resetFocus();}
;}
,"webkit":function(bv){var bw=qx.bom.Event.getTarget(bv);if(bw===this._window||bw===this._document){this.__hn();this.__hl=this.getFocus();this.__hm=this.getActive();this.resetActive();this.resetFocus();}
;}
,"default":null})),__ht:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"gecko":function(bx){var by=qx.bom.Event.getTarget(bx);if(by===this._window||by===this._document){this.__ho();by=this._body;}
;this.setFocus(by);this.tryActivate(by);}
,"webkit":function(bz){var bA=qx.bom.Event.getTarget(bz);if(bA===this._window||bA===this._document){this.__ho();if(this.__hl){this.setFocus(this.__hl);delete this.__hl;}
;if(this.__hm){this.setActive(this.__hm);delete this.__hm;}
;}
else {this.setFocus(bA);this.tryActivate(bA);}
;}
,"default":null})),__hu:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"mshtml":function(bC){var bD=qx.bom.Event.getTarget(bC);var bB=this.__hz(bD);if(bB){if(!this.__hB(bD)){bD.unselectable=B;try{document.selection.empty();}
catch(bE){}
;try{bB.focus();}
catch(bF){}
;}
;}
else {qx.bom.Event.preventDefault(bC);if(!this.__hB(bD)){bD.unselectable=B;}
;}
;}
,"webkit|gecko":function(bH){var bI=qx.bom.Event.getTarget(bH);var bG=this.__hz(bI);if(bG){this.setFocus(bG);if(qx.core.Environment.get(n)&&qx.event.handler.MouseEmulation.ON){qx.event.GlobalError.observeMethod(window.setTimeout(function(){try{if(document.activeElement==bG){bG.blur();}
;bG.focus();}
catch(bJ){}
;}
,200));}
...
;}
,"opera":function(bM){var bN=qx.bom.Event.getTarget(bM);var bK=this.__hz(bN);if(!this.__hB(bN)){qx.bom.Event.preventDefault(bM);if(bK){var bL=this.getFocus();if(bL&&bL.selectionEnd){bL.selectionStart=0;bL.selectionEnd=0;bL.blur();}
;if(bK){this.setFocus(bK);}
;}
;}
else if(bK){this.setFocus(bK);}
;}
,"default":null})),__hv:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"mshtml":function(bO){var bP=qx.bom.Event.getTarget(bO);if(bP.unselectable){bP.unselectable=r;}
;this.tryActivate(this.__hw(bP));}
...
;}
,"webkit|opera":function(bS){var bT=qx.bom.Event.getTarget(bS);this.tryActivate(this.__hw(bT));}
,"default":null})),__hw:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"mshtml|webkit":function(bU){var bV=this.getFocus();if(bV&&bU!=bV&&(bV.nodeName.toLowerCase()===m||bV.nodeName.toLowerCase()===i)){bU=bV;}
;return bU;}
,"default":function(bW){return bW;}
})),__hx:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"mshtml|webkit":function(bX){var bY=qx.bom.Event.getTarget(bX);if(!this.__hB(bY)){qx.bom.Event.preventDefault(bX);}
;}
,"default":null})),__hy:function(ca){var cb=qx.bom.element.Attribute.get(ca,q);if(cb>=1){return true;}
;var cc=qx.event.handler.Focus.FOCUSABLE_ELEMENTS;if(cb>=0&&cc[ca.tagName]){return true;}
;return false;}
,__hz:function(cd){while(cd&&cd.nodeType===1){if(cd.getAttribute(A)==B){return null;}
;if(this.__hy(cd)){return cd;}
;cd=cd.parentNode;}
;return this._body;}
,__hA:function(ce){var cf=ce;while(ce&&ce.nodeType===1){if(ce.getAttribute(C)==B){return null;}
;ce=ce.parentNode;}
;return cf;}
,__hB:function(cg){while(cg&&cg.nodeType===1){var ch=cg.getAttribute(p);if(ch!=null){return ch===B;}
;cg=cg.parentNode;}
;return true;}
,_applyActive:function(cj,ci){if(ci){this.__fK(ci,cj,h,true);}
;if(cj){this.__fK(cj,ci,t,true);}
;}
,_applyFocus:function(cl,ck){if(ck){this.__fK(ck,cl,z,true);}
;if(cl){this.__fK(cl,ck,u,true);}
;if(ck){this.__fK(ck,cl,b,false);}
;if(cl){this.__fK(cl,ck,d,false);}
;}
},destruct:function(){this._stopObserver();this._manager=this._window=this._document=this._root=this._body=this.__hC=null;}
...
;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{input:1,change:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__hE:false,__hF:null,__hG:null,__hH:null,canHandleEvent:function(D,C){var B=D.tagName.toLowerCase();if(C===n&&(B===n||B===g)){return true;}
;if(C===m&&(B===n||B===g||B===q)){return true;}
;return false;}
,registerEvent:function(I,H,F){if(qx.core.Environment.get(w)==v&&(qx.core.Environment.get(c)<9||(qx.core.Environment.get(c)>=9&&qx.core.Environment.get(r)<9))){if(!I.__hI){var G=I.tagName.toLowerCase();var E=I.type;if(E===a||E===h||G===g||E===y||E===f){qx.bom.Event.addNativeListener(I,j,this._onPropertyWrapper);}
...
}),unregisterEvent:function(R,Q){if(qx.core.Environment.get(w)==v&&qx.core.Environment.get(c)<9&&qx.core.Environment.get(r)<9){if(R.__hI){var P=R.tagName.toLowerCase();var O=R.type;if(O===a||O===h||P===g||O===y||O===f){qx.bom.Event.removeNativeListener(R,j,this._onPropertyWrapper);}
...
;}
;}
,__hK:qx.core.Environment.select(w,{"mshtml":function(T){if(qx.core.Environment.get(c)>=9&&qx.core.Environment.get(r)>=9){qx.bom.Event.removeNativeListener(T,n,this._onInputWrapper);if(T.type===a||T.type===h||T.type===g){qx.bom.Event.removeNativeListener(T,u,this._inputFixWrapper);}
;}
;}
...
}),_onKeyPress:qx.core.Environment.select(w,{"mshtml|opera":function(e,Y){if(e.keyCode===13){if(Y.value!==this.__hG){this.__hG=Y.value;qx.event.Registration.fireEvent(Y,m,qx.event.type.Data,[Y.value]);}
;}
;}
,"default":null}),_inputFix:qx.core.Environment.select(w,{"mshtml":function(e,ba){if(e.keyCode===46||e.keyCode===8){if(ba.value!==this.__hH){this.__hH=ba.value;qx.event.Registration.fireEvent(ba,n,qx.event.type.Data,[ba.value]);}
;}
;}
,"default":null}),_onKeyDown:qx.core.Environment.select(w,{"opera":function(e){if(e.keyCode===13){this.__hE=true;}
;}
,"default":null}),_onKeyUp:qx.core.Environment.select(w,{"opera":function(e){if(e.keyCode===13){this.__hE=false;}
;}
,"default":null}),_onBlur:qx.core.Environment.select(w,{"opera":function(e){if(this.__hF&&qx.core.Environment.get(s)<10.6){window.clearTimeout(this.__hF);}
;}
,"default":null}),_onInput:qx.event.GlobalError.observeMethod(function(e){var bc=qx.bom.Event.getTarget(e);var bb=bc.tagName.toLowerCase();if(!this.__hE||bb!==n){if((qx.core.Environment.get(w)==t)&&qx.core.Environment.get(s)<10.6){this.__hF=window.setTimeout(function(){qx.event.Registration.fireEvent(bc,n,qx.event.type.Data,[bc.value]);}
,0);}
...
(function(){var a="blur",b="mousedown",c="qxDraggable",d="mouseout",f="Escape",g="drag",h="keydown",i="Unsupported data type: ",j="drop",k="qxDroppable",l="qx.event.handler.DragDrop",m="This method must not be used outside the drop event listener!",n="Control",o="Shift",p="!",q="mousemove",r="move",s="droprequest",t="copy",u="dragstart",v="alias",w="mouseover",x="dragchange",y="Alt",z="keyup",A="mouseup",B="keypress",C="dragleave",D="dragend",E="dragover",F="left",G="Please use a droprequest listener to the drag source to fill the manager with data!",H="on";qx.Class.define(l,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(I){qx.core.Object.call(this);this.__eT=I;this.__a=I.getWindow().document.documentElement;this.__eT.addListener(this.__a,b,this._onMouseDown,this);this.__hV();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{dragstart:1,dragend:1,dragover:1,dragleave:1,drop:1,drag:1,dragchange:1,droprequest:1},IGNORE_CAN_HANDLE:true},members:{__eT:null,__a:null,__hL:null,__hM:null,__hN:null,__hO:null,__hP:null,__d:null,__hQ:null,__hR:null,__hS:false,__hT:0,__hU:0,canHandleEvent:function(K,J){}
,registerEvent:function(N,M,L){}
,unregisterEvent:function(Q,P,O){}
,addType:function(R){this.__hN[R]=true;}
,addAction:function(S){this.__hO[S]=true;}
,supportsType:function(T){return !!this.__hN[T];}
,supportsAction:function(U){return !!this.__hO[U];}
,getData:function(V){if(!this.__ic||!this.__hL){throw new Error(m);}
;if(!this.__hN[V]){throw new Error(i+V+p);}
;if(!this.__d[V]){this.__hQ=V;this.__fK(s,this.__hM,this.__hL,false);}
...
,__hV:function(){this.__hN={};this.__hO={};this.__hP={};this.__d={};}
,__hW:function(){if(this.__hM==null){return;}
;var bc=this.__hO;var Y=this.__hP;var ba=null;if(this.__ic){if(Y.Shift&&Y.Control&&bc.alias){ba=v;}
...
;}
;var bb=this.__hR;if(ba!=bb){if(this.__hL){this.__hR=ba;this.__hX=this.__fK(x,this.__hL,this.__hM,true);if(!this.__hX){ba=null;}
;}
;if(ba!=bb){this.__hR=ba;this.__fK(x,this.__hM,this.__hL,false);}
;}
;}
,__fK:function(bi,be,bf,bg,bj){var bh=qx.event.Registration;var bd=bh.createEvent(bi,qx.event.type.Drag,[bg,bj]);if(be!==bf){bd.setRelatedTarget(bf);}
;return bh.dispatchEvent(be,bd);}
,__hY:function(bk){while(bk&&bk.nodeType==1){if(bk.getAttribute(c)==H){return bk;}
;bk=bk.parentNode;}
;return null;}
,__ia:function(bl){while(bl&&bl.nodeType==1){if(bl.getAttribute(k)==H){return bl;}
;bl=bl.parentNode;}
;return null;}
,__ib:function(){this.__hM=null;this.__eT.removeListener(this.__a,q,this._onMouseMove,this,true);this.__eT.removeListener(this.__a,A,this._onMouseUp,this,true);qx.event.Registration.removeListener(window,a,this._onWindowBlur,this);this.__hV();}
,clearSession:function(){if(this.__hS){this.__eT.removeListener(this.__a,w,this._onMouseOver,this,true);this.__eT.removeListener(this.__a,d,this._onMouseOut,this,true);this.__eT.removeListener(this.__a,h,this._onKeyDown,this,true);this.__eT.removeListener(this.__a,z,this._onKeyUp,this,true);this.__eT.removeListener(this.__a,B,this._onKeyPress,this,true);this.__fK(D,this.__hM,this.__hL,false);this.__hS=false;}
;this.__ic=false;this.__hL=null;this.__ib();}
,__ic:false,__hX:false,_onWindowBlur:function(e){this.clearSession();}
,_onKeyDown:function(e){var bm=e.getKeyIdentifier();switch(bm){case y:case n:case o:if(!this.__hP[bm]){this.__hP[bm]=true;this.__hW();}
;};}
,_onKeyUp:function(e){var bn=e.getKeyIdentifier();switch(bn){case y:case n:case o:if(this.__hP[bn]){this.__hP[bn]=false;this.__hW();}
;};}
,_onKeyPress:function(e){var bo=e.getKeyIdentifier();switch(bo){case f:this.clearSession();};}
,_onMouseDown:function(e){if(this.__hS||e.getButton()!==F){return;}
;var bp=this.__hY(e.getTarget());if(bp){this.__hT=e.getDocumentLeft();this.__hU=e.getDocumentTop();this.__hM=bp;this.__eT.addListener(this.__a,q,this._onMouseMove,this,true);this.__eT.addListener(this.__a,A,this._onMouseUp,this,true);qx.event.Registration.addListener(window,a,this._onWindowBlur,this);}
;}
,_onMouseUp:function(e){if(this.__ic&&this.__hX){this.__fK(j,this.__hL,this.__hM,false,e);}
;if(this.__hS&&e.getTarget()==this.__hM){e.stopPropagation();this.__fJ();}
;this.clearSession();}
,_onMouseMove:function(e){if(this.__hS){if(!this.__fK(g,this.__hM,this.__hL,true,e)){this.clearSession();}
;}
else {if(Math.abs(e.getDocumentLeft()-this.__hT)>3||Math.abs(e.getDocumentTop()-this.__hU)>3){if(this.__fK(u,this.__hM,this.__hL,true,e)){this.__hS=true;this.__eT.addListener(this.__a,w,this._onMouseOver,this,true);this.__eT.addListener(this.__a,d,this._onMouseOut,this,true);this.__eT.addListener(this.__a,h,this._onKeyDown,this,true);this.__eT.addListener(this.__a,z,this._onKeyUp,this,true);this.__eT.addListener(this.__a,B,this._onKeyPress,this,true);var bq=this.__hP;bq.Control=e.isCtrlPressed();bq.Shift=e.isShiftPressed();bq.Alt=e.isAltPressed();this.__hW();}
else {this.__fK(D,this.__hM,this.__hL,false);this.__ib();}
;}
;}
;}
...
;var bu=this.__ia(bt);if(bu&&bu!=this.__hL){this.__ic=this.__fK(E,bu,this.__hM,true,e);this.__hL=bu;this.__hW();}
;}
...
;var by=this.__ia(e.getTarget());var bx=this.__ia(e.getRelatedTarget());if(by&&by!==bx&&by==this.__hL){this.__fK(C,this.__hL,bx,false,e);this.__hL=null;this.__ic=false;qx.event.Timer.once(this.__hW,this,0);}
;}
,__fJ:function(){var bz=qx.event.Registration.getManager(window).getHandler(qx.event.handler.Mouse);bz.preventNextClick();}
},destruct:function(){this.__hM=this.__hL=this.__eT=this.__a=this.__hN=this.__hO=this.__hP=this.__d=null;}
...
(function(){var a="best-fit",b="placementRight",c="Boolean",d="bottom-right",e="' ",f="widget",g="placementLeft",h="qx.ui.core.MPlacement",i="left-top",j="Integer",k="left-middle",l="right-middle",m="top-center",n="[qx.ui.core.MPlacement.setMoveDirection()], the value was '",o="offsetRight",p="mouse",q="interval",r="keep-align",s="bottom-left",t="direct",u="shorthand",v="Invalid value for the parameter 'direction' ",w="offsetLeft",x="top-left",y="appear",z="offsetBottom",A="top",B="top-right",C="offsetTop",D="but 'top' or 'left' are allowed.",E="right-bottom",F="disappear",G="right-top",H="bottom-center",I="left-bottom",J="left";qx.Mixin.define(h,{statics:{__fg:null,__id:J,setVisibleElement:function(K){this.__fg=K;}
,getVisibleElement:function(){return this.__fg;}
,setMoveDirection:function(L){if(L===A||L===J){this.__id=L;}
else {throw new Error(v+n+L+e+D);}
;}
,getMoveDirection:function(){return this.__id;}
},properties:{position:{check:[x,m,B,s,H,d,i,k,I,G,l,E],init:s,themeable:true},placeMethod:{check:[f,p],init:p,themeable:true},domMove:{check:c,init:false},placementModeX:{check:[t,r,a],init:r,themeable:true},placementModeY:{check:[t,r,a],init:r,themeable:true},offsetLeft:{check:j,init:0,themeable:true},offsetTop:{check:j,init:0,themeable:true},offsetRight:{check:j,init:0,themeable:true},offsetBottom:{check:j,init:0,themeable:true},offset:{group:[C,o,z,w],mode:u,themeable:true}},members:{__ie:null,__if:null,__ig:null,getLayoutLocation:function(N){var P,O,R,top;O=N.getBounds();if(!O){return null;}
...
;}
,placeToWidget:function(bc,ba){if(ba){this.__ih();this.__ie=qx.lang.Function.bind(this.placeToWidget,this,bc,false);qx.event.Idle.getInstance().addListener(q,this.__ie);this.__ig=function(){this.__ih();}
;this.addListener(F,this.__ig,this);}
;var bb=bc.getContentLocation()||this.getLayoutLocation(bc);if(bb!=null){this.__ij(bb);return true;}
else {return false;}
;}
,__ih:function(){if(this.__ie){qx.event.Idle.getInstance().removeListener(q,this.__ie);this.__ie=null;}
;if(this.__ig){this.removeListener(F,this.__ig,this);this.__ig=null;}
;}
,placeToMouse:function(event){var be=Math.round(event.getDocumentLeft());var top=Math.round(event.getDocumentTop());var bd={left:be,top:top,right:be,bottom:top};this.__ij(bd);}
,placeToElement:function(bh,bf){var location=qx.bom.element.Location.get(bh);var bg={left:location.left,top:location.top,right:location.left+bh.offsetWidth,bottom:location.top+bh.offsetHeight};if(bf){this.__ie=qx.lang.Function.bind(this.placeToElement,this,bh,false);qx.event.Idle.getInstance().addListener(q,this.__ie);this.addListener(F,function(){if(this.__ie){qx.event.Idle.getInstance().removeListener(q,this.__ie);this.__ie=null;}
;}
,this);}
;this.__ij(bg);}
,placeToPoint:function(bj){var bi={left:bj.left,top:bj.top,right:bj.left,bottom:bj.top};this.__ij(bi);}
,_getPlacementOffsets:function(){return {left:this.getOffsetLeft(),top:this.getOffsetTop(),right:this.getOffsetRight(),bottom:this.getOffsetBottom()};}
,__ii:function(bk){var bl=null;if(this._computePlacementSize){var bl=this._computePlacementSize();}
else if(this.isVisible()){var bl=this.getBounds();}
;if(bl==null){this.addListenerOnce(y,function(){this.__ii(bk);}
,this);}
else {bk.call(this,bl);}
;}
,__ij:function(bm){this.__ii(function(bo){var bn=qx.util.placement.Placement.compute(bo,this.getLayoutParent().getBounds(),bm,this._getPlacementOffsets(),this.getPosition(),this.getPlacementModeX(),this.getPlacementModeY());this.removeState(g);this.removeState(b);this.addState(bm.left<bn.left?b:g);this.moveTo(bn.left,bn.top);}
);}
},destruct:function(){this.__ih();}
});}
)();
(function(){var a="Number",b="interval",c="_applyTimeoutInterval",d="qx.event.type.Event",e="qx.event.Idle",f="singleton";qx.Class.define(e,{extend:qx.core.Object,type:f,construct:function(){qx.core.Object.call(this);var g=new qx.event.Timer(this.getTimeoutInterval());g.addListener(b,this._onInterval,this);g.start();this.__ik=g;}
,events:{"interval":d},properties:{timeoutInterval:{check:a,init:100,apply:c}},members:{__ik:null,_applyTimeoutInterval:function(h){this.__ik.setInterval(h);}
,_onInterval:function(){this.fireEvent(b);}
},destruct:function(){if(this.__ik){this.__ik.stop();}
;this.__ik=null;}
});}
)();
(function(){var a="-",b="best-fit",c="size",d="edge-start",e="target.bottom",f="offsets",g="size.width",h="bottom",i="offsets.bottom",j="qx.util.placement.Placement",k="Please use '",l="qx.debug",m="keep-align",n="center",o='__io',p="target.right",q="direct",r="offsets.right",s="middle",t="target",u="align-start",v="Invalid 'mode' argument!'",w="left",x="align-end",y="Class",z="offsets.left",A="top",B="area",C="right",D="edge-end",E="target.top",F="area.height",G="target.left",H="align-center",I="area.width",J="' instead!",K="size.height",L="offsets.top";qx.Class.define(j,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__io=qx.util.placement.DirectAxis;}
,properties:{axisX:{check:y},axisY:{check:y},edge:{check:[A,C,h,w],init:A},align:{check:[A,C,h,w,n,s],init:C}},statics:{__ip:null,compute:function(W,P,M,N,V,Q,R){this.__ip=this.__ip||new qx.util.placement.Placement();var T=V.split(a);var S=T[0];var O=T[1];if(qx.core.Environment.get(l)){if(O===n||O===s){var U=s;if(S===A||S===h){U=n;}
;qx.core.Assert.assertEquals(U,O,k+S+a+U+J);}
;}
;this.__ip.set({axisX:this.__it(Q),axisY:this.__it(R),edge:S,align:O});return this.__ip.compute(W,P,M,N);}
,__iq:null,__ir:null,__is:null,__it:function(X){switch(X){case q:this.__iq=this.__iq||qx.util.placement.DirectAxis;return this.__iq;case m:this.__ir=this.__ir||qx.util.placement.KeepAlignAxis;return this.__ir;case b:this.__is=this.__is||qx.util.placement.BestFitAxis;return this.__is;default:throw new Error(v);};}
},members:{__io:null,compute:function(be,bb,Y,ba){if(qx.core.Environment.get(l)){this.assertObject(be,c);this.assertNumber(be.width,g);this.assertNumber(be.height,K);this.assertObject(bb,B);this.assertNumber(bb.width,I);this.assertNumber(bb.height,F);this.assertObject(Y,t);this.assertNumber(Y.top,E);this.assertNumber(Y.right,p);this.assertNumber(Y.bottom,e);this.assertNumber(Y.left,G);this.assertObject(ba,f);this.assertNumber(ba.top,L);this.assertNumber(ba.right,r);this.assertNumber(ba.bottom,i);this.assertNumber(ba.left,z);}
;var bc=this.getAxisX()||this.__io;var bf=bc.computeStart(be.width,{start:Y.left,end:Y.right},{start:ba.left,end:ba.right},bb.width,this.__iu());var bd=this.getAxisY()||this.__io;var top=bd.computeStart(be.height,{start:Y.top,end:Y.bottom},{start:ba.top,end:ba.bottom},bb.height,this.__iv());return {left:bf,top:top};}
,__iu:function(){var bh=this.getEdge();var bg=this.getAlign();if(bh==w){return d;}
else if(bh==C){return D;}
else if(bg==w){return u;}
else if(bg==n){return H;}
else if(bg==C){return x;}
;}
,__iv:function(){var bj=this.getEdge();var bi=this.getAlign();if(bj==A){return d;}
...
(function(){var a="backgroundColor",b="drag",c="_applyNativeContextMenu",d="div",f="_applyBackgroundColor",g="qx.event.type.Data",h="object",j="_applyFocusable",k=" requires a layout, but no one was defined!",m="qx.event.type.KeyInput",n="focused",o="disabled",p="move",q="createChildControl",r="Unsupported control: ",s="dragstart",t="Invalid left decorator inset detected: ",u="Font",v="qx.dynlocale",w="dragchange",x="Invalid layout data: ",y="Could not add widget to itself: ",z="_applyEnabled",A="_applySelectable",B="Number",C="_applyKeepActive",D="dragend",E="__iB",F="_applyVisibility",G="The 'before' widget is not a child of this widget!",H="Child control '",I="qxDraggable",J="syncAppearance",K='" while styling ',L="paddingLeft",M="' of widget ",N="qx.event.type.Mouse",O="Wrong 'left' argument. ",P="_applyPadding",Q="#",R="'Child' must be an instance of qx.ui.core.LayoutItem!",S="Remove Error: ",T="visible",U="qx.event.type.Event",V="qx.event.type.MouseWheel",W="_applyCursor",X="changeVisibility",Y="__iA",cX="_applyDraggable",cY="resize",da="Decorator",cT="At least one child in control ",cU="zIndex",cV="changeTextColor",cW="$$widget",df="changeContextMenu",dg="on",dh="paddingTop",di="opacity",db="This widget has no children!",dc="The 'after' widget is not a child of this widget!",dd="changeSelectable",de="Invalid top decorator inset detected: ",dm="none",dO="outline",eO="hidden",dn="Please use 'getContentElement' instead.",dj="_applyAppearance",dk=" returned an invalid size hint!",eK="hovered",dl="_applyOpacity",dp="Boolean",dq="px",dr="qx.ui.core.Widget",dw="default",dx="minHeight is larger than maxHeight!",dy="TabIndex property must be between 1 and 32000",ds="_applyFont",dt="__iw",du="cursor",dv="qxDroppable",dC="' already created!",dD="changeZIndex",dE=": ",dF="Color",dz="changeEnabled",dA="Please use 'getContentLocation' instead.",eL="Abstract method call: _getContentHeightForWidth()!",dB="changeFont",dJ="qx.event.type.Focus",dK="_applyDecorator",eN="_applyZIndex",dL="_applyTextColor",dG=' has no themeable property "',dH="Widget is not focusable!",eM="qx.ui.menu.Menu",dI="engine.name",dM="qx.event.type.Drag",dN="Invalid right decorator inset detected: ",ea="Invalid widget to add: ",dY="qx.event.type.KeySequence",dX="excluded",ee="DOM element is not yet created!",ed="_applyToolTipText",ec="The layout of the widget",eb="Exception while creating child control '",dS="_applyDroppable",dR=" is not a child of this widget!",dQ="widget",dP="Wrong 'top' argument. ",dW="qxClass",dV="changeDecorator",dU="qx.event.type.Tap",dT="Integer",em="changeBackgroundColor",ek="_applyTabIndex",ej="Invalid bottom decorator inset detected: ",ei="changeAppearance",eq="qx.debug",ep="shorthand",eo="/",en="String",eh="__iD",eg="border-box",ef="",eB="_applyContextMenu",eA="changeToolTipText",ez="padding",eF="tabIndex",eE="paddingBottom",eD="beforeContextmenuOpen",eC="changeNativeContextMenu",eu="undefined",et="qx.ui.tooltip.ToolTip",es="contextmenu",er="_applyKeepFocus",ey="paddingRight",ex="minWidth is larger than maxWidth!",ew="changeLocale",ev="qxKeepFocus",eJ="opera",eI="qx.event.type.Touch",eH="qxKeepActive",eG="absolute";qx.Class.define(dr,{extend:qx.ui.core.LayoutItem,include:[qx.locale.MTranslation],construct:function(){qx.ui.core.LayoutItem.call(this);this.__iw=this.__iC();this.initFocusable();this.initSelectable();this.initNativeContextMenu();}
,events:{appear:U,disappear:U,createChildControl:g,resize:g,move:g,syncAppearance:g,mousemove:N,mouseover:N,mouseout:N,mousedown:N,mouseup:N,click:N,dblclick:N,contextmenu:N,beforeContextmenuOpen:g,mousewheel:V,touchstart:eI,touchend:eI,touchmove:eI,touchcancel:eI,tap:dU,longtap:dU,swipe:eI,keyup:dY,keydown:dY,keypress:dY,keyinput:m,focus:dJ,blur:dJ,focusin:dJ,focusout:dJ,activate:dJ,deactivate:dJ,capture:U,losecapture:U,drop:dM,dragleave:dM,dragover:dM,drag:dM,dragstart:dM,dragend:dM,dragchange:dM,droprequest:dM},properties:{paddingTop:{check:dT,init:0,apply:P,themeable:true},paddingRight:{check:dT,init:0,apply:P,themeable:true},paddingBottom:{check:dT,init:0,apply:P,themeable:true},paddingLeft:{check:dT,init:0,apply:P,themeable:true},padding:{group:[dh,ey,eE,L],mode:ep,themeable:true},zIndex:{nullable:true,init:10,apply:eN,event:dD,check:dT,themeable:true},decorator:{nullable:true,init:null,apply:dK,event:dV,check:da,themeable:true},backgroundColor:{nullable:true,check:dF,apply:f,event:em,themeable:true},textColor:{nullable:true,check:dF,apply:dL,event:cV,themeable:true,inheritable:true},font:{nullable:true,apply:ds,check:u,event:dB,themeable:true,inheritable:true,dereference:true},opacity:{check:B,apply:dl,themeable:true,nullable:true,init:null},cursor:{check:en,apply:W,themeable:true,inheritable:true,nullable:true,init:null},toolTip:{check:et,nullable:true},toolTipText:{check:en,nullable:true,event:eA,apply:ed},toolTipIcon:{check:en,nullable:true,event:eA},blockToolTip:{check:dp,init:false},visibility:{check:[T,eO,dX],init:T,apply:F,event:X},enabled:{init:true,check:dp,inheritable:true,apply:z,event:dz},anonymous:{init:false,check:dp},tabIndex:{check:dT,nullable:true,apply:ek},focusable:{check:dp,init:false,apply:j},keepFocus:{check:dp,init:false,apply:er},keepActive:{check:dp,init:false,apply:C},draggable:{check:dp,init:false,apply:cX},droppable:{check:dp,init:false,apply:dS},selectable:{check:dp,init:false,event:dd,apply:A},contextMenu:{check:eM,apply:eB,nullable:true,event:df},nativeContextMenu:{check:dp,init:false,themeable:true,event:eC,apply:c},appearance:{check:en,init:dQ,apply:dj,event:ei}},statics:{DEBUG:false,getWidgetByElement:function(eS,eQ){while(eS){var eP=eS.$$widget;if(eP!=null){var eR=qx.core.ObjectRegistry.fromHashCode(eP);if(!eQ||!eR.getAnonymous()){return eR;}
;}
...
;return false;}
,__ix:new qx.util.ObjectPool()},members:{__iw:null,__iy:null,__iz:null,__iA:null,_getLayout:function(){return this.__iA;}
,_setLayout:function(eU){if(qx.core.Environment.get(eq)){if(eU){this.assertInstance(eU,qx.ui.layout.Abstract);}
;}
;if(this.__iA){this.__iA.connectToWidget(null);}
;if(eU){eU.connectToWidget(this);}
;this.__iA=eU;qx.ui.core.queue.Layout.add(this);}
,setLayoutParent:function(parent){if(this.$$parent===parent){return;}
...
;if(fg||fd.local||fd.margin){if(this.__iA&&this.hasLayoutChildren()){var fb=this.getInsets();var innerWidth=eY-fb.left-fb.right;var innerHeight=eW-fb.top-fb.bottom;var ff=this.getDecorator();var fa={left:0,right:0,top:0,bottom:0};if(ff){ff=qx.theme.manager.Decoration.getInstance().resolve(ff);fa=ff.getPadding();}
;var eX={top:this.getPaddingTop()+fa.top,right:this.getPaddingRight()+fa.right,bottom:this.getPaddingBottom()+fa.bottom,left:this.getPaddingLeft()+fa.left};this.__iA.renderLayout(innerWidth,innerHeight,eX);}
else if(this.hasLayoutChildren()){throw new Error(cT+this._findTopControl()+k);}
;}
;if(fd.position&&this.hasListener(p)){this.fireDataEvent(p,this.getBounds());}
;if(fd.size&&this.hasListener(cY)){this.fireDataEvent(cY,this.getBounds());}
;delete this._updateInsets;return fd;}
,__iB:null,clearSeparators:function(){var fi=this.__iB;if(!fi){return;}
;var fj=qx.ui.core.Widget.__ix;var content=this.getContentElement();var fh;for(var i=0,l=fi.length;i<l;i++ ){fh=fi[i];fj.poolObject(fh);content.remove(fh.getContentElement());}
;fi.length=0;}
,renderSeparator:function(fl,fm){var fk=qx.ui.core.Widget.__ix.getObject(qx.ui.core.Widget);fk.set({decorator:fl});var fo=fk.getContentElement();this.getContentElement().add(fo);var fn=fo.getDomElement();if(fn){fn.style.top=fm.top+dq;fn.style.left=fm.left+dq;fn.style.width=fm.width+dq;fn.style.height=fm.height+dq;}
else {fo.setStyles({left:fm.left+dq,top:fm.top+dq,width:fm.width+dq,height:fm.height+dq});}
;if(!this.__iB){this.__iB=[];}
;this.__iB.push(fk);}
,_computeSizeHint:function(){var fv=this.getWidth();var fp=this.getMinWidth();var fq=this.getMaxWidth();var ft=this.getHeight();var fr=this.getMinHeight();var fs=this.getMaxHeight();if(qx.core.Environment.get(eq)){if(fp!==null&&fq!==null){this.assert(fp<=fq,ex);}
...
,invalidateLayoutCache:function(){qx.ui.core.LayoutItem.prototype.invalidateLayoutCache.call(this);if(this.__iA){this.__iA.invalidateLayoutCache();}
;}
,_getContentHint:function(){var fA=this.__iA;if(fA){if(this.hasLayoutChildren()){var fB=fA.getSizeHint();if(qx.core.Environment.get(eq)){var fz=ec+this.toString()+dk;this.assertInteger(fB.width,O+fz);this.assertInteger(fB.height,dP+fz);}
;return fB;}
...
,getInsets:function(){var top=this.getPaddingTop();var fL=this.getPaddingRight();var fM=this.getPaddingBottom();var fP=this.getPaddingLeft();if(this.getDecorator()){var fO=qx.theme.manager.Decoration.getInstance().resolve(this.getDecorator());var fN=fO.getInsets();if(qx.core.Environment.get(eq)){this.assertNumber(fN.top,de+fN.top);this.assertNumber(fN.right,dN+fN.right);this.assertNumber(fN.bottom,ej+fN.bottom);this.assertNumber(fN.left,t+fN.left);}
...
;return false;}
,__iC:function(){var fW=this._createContentElement();fW.setAttribute(cW,this.toHashCode());if(qx.core.Environment.get(eq)){fW.setAttribute(dW,this.classname);}
...
,getContainerElement:function(){if(qx.core.Environment.get(eq)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,dn);}
;return this.__iw;}
,getContentElement:function(){return this.__iw;}
,__iD:null,getLayoutChildren:function(){var fY=this.__iD;if(!fY){return this.__iE;}
...
;return ga||fY;}
,scheduleLayoutUpdate:function(){qx.ui.core.queue.Layout.add(this);}
,invalidateLayoutChildren:function(){var gb=this.__iA;if(gb){gb.invalidateChildrenCache();}
;qx.ui.core.queue.Layout.add(this);}
,hasLayoutChildren:function(){var gd=this.__iD;if(!gd){return false;}
;var gc;for(var i=0,l=gd.length;i<l;i++ ){gc=gd[i];if(!gc.hasUserBounds()&&!gc.isExcluded()){return true;}
;}
;return false;}
,getChildrenContainer:function(){return this;}
,__iE:[],_getChildren:function(){return this.__iD||this.__iE;}
,_indexOf:function(gf){var ge=this.__iD;if(!ge){return -1;}
;return ge.indexOf(gf);}
,_hasChildren:function(){var gg=this.__iD;return gg!=null&&(!!gg[0]);}
,addChildrenToQueue:function(gh){var gi=this.__iD;if(!gi){return;}
;var gj;for(var i=0,l=gi.length;i<l;i++ ){gj=gi[i];gh.push(gj);gj.addChildrenToQueue(gh);}
;}
,_add:function(gl,gk){if(qx.core.Environment.get(eq)){this.assertInstance(gl,qx.ui.core.LayoutItem.constructor,R);}
;if(gl.getLayoutParent()==this){qx.lang.Array.remove(this.__iD,gl);}
;if(this.__iD){this.__iD.push(gl);}
else {this.__iD=[gl];}
;this.__iF(gl,gk);}
,_addAt:function(gp,gm,go){if(!this.__iD){this.__iD=[];}
;if(gp.getLayoutParent()==this){qx.lang.Array.remove(this.__iD,gp);}
;var gn=this.__iD[gm];if(gn===gp){gp.setLayoutProperties(go);}
;if(gn){qx.lang.Array.insertBefore(this.__iD,gp,gn);}
else {this.__iD.push(gp);}
;this.__iF(gp,go);}
,_addBefore:function(gq,gs,gr){if(qx.core.Environment.get(eq)){this.assertInArray(gs,this._getChildren(),G);}
;if(gq==gs){return;}
;if(!this.__iD){this.__iD=[];}
;if(gq.getLayoutParent()==this){qx.lang.Array.remove(this.__iD,gq);}
;qx.lang.Array.insertBefore(this.__iD,gq,gs);this.__iF(gq,gr);}
,_addAfter:function(gv,gt,gu){if(qx.core.Environment.get(eq)){this.assertInArray(gt,this._getChildren(),dc);}
;if(gv==gt){return;}
;if(!this.__iD){this.__iD=[];}
;if(gv.getLayoutParent()==this){qx.lang.Array.remove(this.__iD,gv);}
;qx.lang.Array.insertAfter(this.__iD,gv,gt);this.__iF(gv,gu);}
,_remove:function(gw){if(!this.__iD){throw new Error(db);}
;qx.lang.Array.remove(this.__iD,gw);this.__iG(gw);}
,_removeAt:function(gx){if(!this.__iD){throw new Error(db);}
;var gy=this.__iD[gx];qx.lang.Array.removeAt(this.__iD,gx);this.__iG(gy);return gy;}
,_removeAll:function(){if(!this.__iD){return [];}
;var gz=this.__iD.concat();this.__iD.length=0;for(var i=gz.length-1;i>=0;i-- ){this.__iG(gz[i]);}
;qx.ui.core.queue.Layout.add(this);return gz;}
,_afterAddChild:null,_afterRemoveChild:null,__iF:function(gB,gA){if(qx.core.Environment.get(eq)){this.assertInstance(gB,qx.ui.core.LayoutItem,ea+gB);this.assertNotIdentical(gB,this,y+gB);if(gA!=null){this.assertType(gA,h,x+gA);}
;}
...
;}
,__iG:function(gC){if(qx.core.Environment.get(eq)){this.assertNotUndefined(gC);}
;if(gC.getLayoutParent()!==this){throw new Error(S+gC+dR);}
;gC.setLayoutParent(null);if(this.__iA){this.__iA.invalidateChildrenCache();}
...
,_applyPadding:function(gF,gE,name){this._updateInsets=true;qx.ui.core.queue.Layout.add(this);this.__iH(name,gF);}
,__iH:function(gG,gJ){var content=this.getContentElement();var gH=this.getDecorator();gH=qx.theme.manager.Decoration.getInstance().resolve(gH);if(gH){var gI=qx.Bootstrap.firstLow(gG.replace(ez,ef));gJ+=gH.getPadding()[gI]||0;}
...
;}
,_applyToolTipText:function(gO,gN){if(qx.core.Environment.get(v)){if(this.__iz){return;}
;var gM=qx.locale.Manager.getInstance();this.__iz=gM.addListener(ew,function(){var gP=this.getToolTipText();if(gP&&gP.translate){this.setToolTipText(gP.translate());}
;}
,this);}
;}
,_applyTextColor:function(gR,gQ){}
,_applyZIndex:function(gT,gS){this.getContentElement().setStyle(cU,gT==null?0:gT);}
,_applyVisibility:function(gV,gU){var content=this.getContentElement();if(gV===T){content.show();}
else {content.hide();}
;var parent=this.$$parent;if(parent&&(gU==null||gV==null||gU===dX||gV===dX)){parent.invalidateLayoutChildren();}
;qx.ui.core.queue.Visibility.add(this);}
,_applyOpacity:function(gX,gW){this.getContentElement().setStyle(di,gX==1?null:gX);}
,_applyCursor:function(ha,gY){if(ha==null&&!this.isSelectable()){ha=dw;}
;this.getContentElement().setStyle(du,ha,qx.core.Environment.get(dI)==eJ);}
...
;}
,__iI:null,$$stateChanges:null,_forwardStates:null,hasState:function(hj){var hi=this.__iI;return !!hi&&!!hi[hj];}
,addState:function(hn){var hm=this.__iI;if(!hm){hm=this.__iI={};}
;if(hm[hn]){return;}
;this.__iI[hn]=true;if(hn===eK){this.syncAppearance();}
else if(!qx.ui.core.queue.Visibility.isVisible(this)){this.$$stateChanges=true;}
else {qx.ui.core.queue.Appearance.add(this);}
;var forward=this._forwardStates;var hl=this.__iL;if(forward&&forward[hn]&&hl){var hk;for(var ho in hl){hk=hl[ho];if(hk instanceof qx.ui.core.Widget){hl[ho].addState(hn);}
;}
;}
;}
,removeState:function(hs){var hr=this.__iI;if(!hr||!hr[hs]){return;}
;delete this.__iI[hs];if(hs===eK){this.syncAppearance();}
else if(!qx.ui.core.queue.Visibility.isVisible(this)){this.$$stateChanges=true;}
else {qx.ui.core.queue.Appearance.add(this);}
;var forward=this._forwardStates;var hq=this.__iL;if(forward&&forward[hs]&&hq){for(var ht in hq){var hp=hq[ht];if(hp instanceof qx.ui.core.Widget){hp.removeState(hs);}
;}
;}
;}
,replaceState:function(hv,hy){var hx=this.__iI;if(!hx){hx=this.__iI={};}
;if(!hx[hy]){hx[hy]=true;}
;if(hx[hv]){delete hx[hv];}
;if(!qx.ui.core.queue.Visibility.isVisible(this)){this.$$stateChanges=true;}
else {qx.ui.core.queue.Appearance.add(this);}
;var forward=this._forwardStates;var hw=this.__iL;if(forward&&forward[hy]&&hw){for(var hz in hw){var hu=hw[hz];if(hu instanceof qx.ui.core.Widget){hu.replaceState(hv,hy);}
;}
;}
;}
,__iJ:null,__iK:null,syncAppearance:function(){var hE=this.__iI;var hD=this.__iJ;var hF=qx.theme.manager.Appearance.getInstance();var hB=qx.core.Property.$$method.setThemed;var hJ=qx.core.Property.$$method.resetThemed;if(this.__iK){delete this.__iK;if(hD){var hA=hF.styleFrom(hD,hE,null,this.getAppearance());hD=null;}
;}
;if(!hD){var hC=this;var hG=[];do {hG.push(hC.$$subcontrol||hC.getAppearance());}
while(hC=hC.$$subparent);hD=hG.reverse().join(eo).replace(/#[0-9]+/g,ef);this.__iJ=hD;}
;var hI=hF.styleFrom(hD,hE,null,this.getAppearance());if(hI){if(hA){for(var hH in hA){if(hI[hH]===undefined){this[hJ[hH]]();}
;}
;}
;if(qx.core.Environment.get(eq)){for(var hH in hI){if(!this[hB[hH]]){throw new Error(this.classname+dG+hH+K+hD);}
;}
;}
...
;}
;this.fireDataEvent(J,this.__iI);}
,_applyAppearance:function(hL,hK){this.updateAppearance();}
,checkAppearanceNeeds:function(){if(!this.__iy){qx.ui.core.queue.Appearance.add(this);this.__iy=true;}
else if(this.$$stateChanges){qx.ui.core.queue.Appearance.add(this);delete this.$$stateChanges;}
;}
,updateAppearance:function(){this.__iK=true;qx.ui.core.queue.Appearance.add(this);var hO=this.__iL;if(hO){var hM;for(var hN in hO){hM=hO[hN];if(hM instanceof qx.ui.core.Widget){hM.updateAppearance();}
;}
;}
;}
...
;}
;}
,_applyKeepFocus:function(hX){var hW=this.getFocusElement();hW.setAttribute(ev,hX?dg:null);}
,_applyKeepActive:function(ia){var hY=this.getContentElement();hY.setAttribute(eH,ia?dg:null);}
...
;this.getContentElement().setAttribute(I,io?dg:null);}
,_applyDroppable:function(iq,ip){if(!this.isEnabled()&&iq===true){iq=false;}
;this.getContentElement().setAttribute(dv,iq?dg:null);}
...
,hasChildControl:function(iF){if(!this.__iL){return false;}
;return !!this.__iL[iF];}
,__iL:null,_getCreatedChildControls:function(){return this.__iL;}
,getChildControl:function(iI,iH){if(!this.__iL){if(iH){return null;}
;this.__iL={};}
;var iG=this.__iL[iI];if(iG){return iG;}
...
;delete iP.$$subcontrol;delete iP.$$subparent;var iQ=this.__iI;var forward=this._forwardStates;if(iQ&&forward&&iP instanceof qx.ui.core.Widget){for(var iR in iQ){if(forward[iR]){iP.removeState(iR);}
;}
;}
;delete this.__iL[iS];return iP;}
,_createChildControl:function(iX){if(!this.__iL){this.__iL={};}
else if(this.__iL[iX]){throw new Error(H+iX+dC);}
...
;}
catch(iY){iY.message=eb+iX+M+this.toString()+dE+iY.message;throw iY;}
;if(!iT){throw new Error(r+iX);}
;iT.$$subcontrol=iX;iT.$$subparent=this;var iV=this.__iI;var forward=this._forwardStates;if(iV&&forward&&iT instanceof qx.ui.core.Widget){for(var iW in iV){if(forward[iW]){iT.addState(iW);}
;}
;}
;this.fireDataEvent(q,iT);return this.__iL[iX]=iT;}
,_createChildControlImpl:function(jb,ja){return null;}
,_disposeChildControls:function(){var jf=this.__iL;if(!jf){return;}
...
;jg=jg.$$subparent;}
;return null;}
,getContainerLocation:function(jh){if(qx.core.Environment.get(eq)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,dA);}
...
;}
;return jq;}
},destruct:function(){if(!qx.core.ObjectRegistry.inShutDown){if(qx.core.Environment.get(v)){if(this.__iz){qx.locale.Manager.getInstance().removeListenerById(this.__iz);}
;}
;var js=this.getContentElement();if(js){js.setAttribute(cW,null,true);}
...
;if(!qx.core.ObjectRegistry.inShutDown){this.clearSeparators();this.__iB=null;}
else {this._disposeArray(E);}
;this._disposeArray(eh);this.__iI=this.__iL=null;this._disposeObjects(Y,dt);}
});}
)();
...
,statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST,SUPPORTED_TYPES:{mousemove:1,mouseover:1,mouseout:1,mousedown:1,mouseup:1,click:1,dblclick:1,contextmenu:1,mousewheel:1,keyup:1,keydown:1,keypress:1,keyinput:1,capture:1,losecapture:1,focusin:1,focusout:1,focus:1,blur:1,activate:1,deactivate:1,appear:1,disappear:1,dragstart:1,dragend:1,dragover:1,dragleave:1,drop:1,drag:1,dragchange:1,droprequest:1,touchstart:1,touchend:1,touchmove:1,touchcancel:1,tap:1,longtap:1,swipe:1},IGNORE_CAN_HANDLE:false},members:{__eT:null,__iM:{focusin:1,focusout:1,focus:1,blur:1},__iN:{mouseover:1,mouseout:1,appear:1,disappear:1},canHandleEvent:function(f,e){return f instanceof qx.ui.core.Widget;}
...
;if(this.__iM[h.getType()]){m=m&&m.getFocusTarget();if(!m){return;}
;}
...
;if(u){if(this.__iM[h.getType()]){u=u.getFocusTarget();}
;if(u===m){return;}
;}
;}
;var q=h.getCurrentTarget();var s=qx.ui.core.Widget.getWidgetByElement(q);if(!s||s.isAnonymous()){return;}
;if(this.__iM[h.getType()]){s=s.getFocusTarget();}
;var t=h.getType();if(!s||!(s.isEnabled()||this.__iN[t])){return;}
;var g=h.getEventPhase()==qx.event.type.Event.CAPTURING_PHASE;var p=this.__eT.getListeners(s,t,g);if(!p||p.length===0){return;}
...
(function(){var a="Missing renderLayout() implementation!",b="abstract",c="Missing getHeightForWidth() implementation!",d="qx.debug",e="It is not possible to manually set the connected widget.",f="qx.ui.layout.Abstract";qx.Class.define(f,{type:b,extend:qx.core.Object,members:{__cX:null,_invalidChildrenCache:null,__lH:null,invalidateLayoutCache:function(){this.__cX=null;}
,renderLayout:function(h,i,g){this.warn(a);}
,getSizeHint:function(){if(this.__cX){return this.__cX;}
;return this.__cX=this._computeSizeHint();}
...
,"false":null}),_clearSeparators:function(){var m=this.__lH;if(m instanceof qx.ui.core.LayoutItem){m.clearSeparators();}
;}
,_renderSeparator:function(n,o){this.__lH.renderSeparator(n,o);}
,connectToWidget:function(p){if(p&&this.__lH){throw new Error(e);}
;this.__lH=p;this.invalidateChildrenCache();}
...
},destruct:function(){this.__lH=this.__cX=null;}
});}
)();
(function(){var a="qx.ui.core.queue.Visibility",b="visibility";qx.Class.define(a,{statics:{__dm:[],__cN:{},remove:function(c){delete this.__cN[c.$$hash];qx.lang.Array.remove(this.__dm,c);}
,isVisible:function(d){return this.__cN[d.$$hash]||false;}
,__iO:function(f){var h=this.__cN;var g=f.$$hash;var e;if(f.isExcluded()){e=false;}
else {var parent=f.$$parent;if(parent){e=this.__iO(parent);}
else {e=f.isRootWidget();}
;}
;return h[g]=e;}
,add:function(k){var j=this.__dm;if(qx.lang.Array.contains(j,k)){return;}
;j.unshift(k);qx.ui.core.queue.Manager.scheduleFlush(b);}
,flush:function(){var o=this.__dm;var p=this.__cN;for(var i=o.length-1;i>=0;i-- ){var n=o[i].$$hash;if(p[n]!=null){o[i].addChildrenToQueue(o);}
;}
;var l={};for(var i=o.length-1;i>=0;i-- ){var n=o[i].$$hash;l[n]=p[n];p[n]=null;}
;for(var i=o.length-1;i>=0;i-- ){var m=o[i];var n=m.$$hash;o.splice(i,1);if(p[n]==null){this.__iO(m);}
;if(p[n]&&p[n]!=l[n]){m.checkAppearanceNeeds();}
;}
;this.__dm=[];}
}});}
)();
(function(){var a=" due to exceptions in user code. The application has to be reloaded!",b="Error in the 'Appearance' queue:",c="Error in the 'Widget' queue:",d="\n",f="Error in the 'Layout' queue:",g="Error in the 'Visibility' queue:",h="qx.debug",i="useraction",j="qx.debug.ui.queue",k="Error while layout flush: ",l="Error in the 'Dispose' queue:",m="Stack trace: \n",n="event.touch",o="qx.ui.core.queue.Manager",p=" times in a row",q="Fatal Error: Flush terminated ";qx.Class.define(o,{statics:{__iP:false,__eI:false,__iQ:{},__iR:0,MAX_RETRIES:10,scheduleFlush:function(r){var self=qx.ui.core.queue.Manager;self.__iQ[r]=true;if(!self.__iP){self.__eI=false;qx.bom.AnimationFrame.request(function(){if(self.__eI){self.__eI=false;return;}
;self.flush();}
,self);self.__iP=true;}
;}
,flush:function(){var self=qx.ui.core.queue.Manager;if(self.__iS){return;}
;self.__iS=true;self.__eI=true;var s=self.__iQ;self.__iT(function(){while(s.visibility||s.widget||s.appearance||s.layout||s.element){if(s.widget){delete s.widget;if(qx.core.Environment.get(j)){try{qx.ui.core.queue.Widget.flush();}
...
;}
;}
,function(){self.__iP=false;}
);self.__iT(function(){if(s.dispose){delete s.dispose;if(qx.core.Environment.get(j)){try{qx.ui.core.queue.Dispose.flush();}
catch(e){qx.log.Logger.error(l+e);}
;}
else {qx.ui.core.queue.Dispose.flush();}
;}
;}
,function(){self.__iS=false;}
);self.__iR=0;}
,__iT:qx.core.Environment.select(h,{"true":function(t,u){t();u();}
...
;self.__iP=false;self.__iS=false;self.__iR+=1;if(self.__iR<=self.MAX_RETRIES){self.scheduleFlush();}
else {throw new Error(q+(self.__iR-1)+p+a);}
;throw e;}
finally{w();}
;}
}),__iU:function(e){qx.ui.core.queue.Manager.flush();}
},defer:function(x){qx.html.Element._scheduleFlush=x.scheduleFlush;qx.event.Registration.addListener(window,i,qx.core.Environment.get(n)?x.__iU:x.flush);}
});}
)();
(function(){var a="qx.ui.core.queue.Widget",b="widget",c="$$default";qx.Class.define(a,{statics:{__dm:[],__iQ:{},remove:function(e,g){var d=this.__dm;if(!qx.lang.Array.contains(d,e)){return;}
;var f=e.$$hash;if(g==null){qx.lang.Array.remove(d,e);delete this.__iQ[f];return;}
;if(this.__iQ[f]){delete this.__iQ[f][g];if(qx.lang.Object.getLength(this.__iQ[f])==0){qx.lang.Array.remove(d,e);}
;}
;}
,add:function(j,l){var h=this.__dm;if(!qx.lang.Array.contains(h,j)){h.unshift(j);}
;if(l==null){l=c;}
;var k=j.$$hash;if(!this.__iQ[k]){this.__iQ[k]={};}
;this.__iQ[k][l]=true;qx.ui.core.queue.Manager.scheduleFlush(b);}
,flush:function(){var m=this.__dm;var n,o;for(var i=m.length-1;i>=0;i-- ){n=m[i];o=this.__iQ[n.$$hash];m.splice(i,1);n.syncWidget(o);}
;if(m.length!=0){return;}
;this.__dm=[];this.__iQ={};}
}});}
)();
(function(){var a="appearance",b="qx.ui.core.queue.Appearance";qx.Class.define(b,{statics:{__dm:[],remove:function(c){qx.lang.Array.remove(this.__dm,c);}
,add:function(e){var d=this.__dm;if(qx.lang.Array.contains(d,e)){return;}
;d.unshift(e);qx.ui.core.queue.Manager.scheduleFlush(a);}
,has:function(f){return qx.lang.Array.contains(this.__dm,f);}
,flush:function(){var j=qx.ui.core.queue.Visibility;var g=this.__dm;var h;for(var i=g.length-1;i>=0;i-- ){h=g[i];g.splice(i,1);if(j.isVisible(h)){h.syncAppearance();}
else {h.$$stateChanges=true;}
;}
;}
}});}
)();
(function(){var a="dispose",b="qx.ui.core.queue.Dispose";qx.Class.define(b,{statics:{__dm:[],add:function(d){var c=this.__dm;if(qx.lang.Array.contains(c,d)){return;}
;c.unshift(d);qx.ui.core.queue.Manager.scheduleFlush(a);}
,isEmpty:function(){return this.__dm.length==0;}
,flush:function(){var e=this.__dm;for(var i=e.length-1;i>=0;i-- ){var f=e[i];e.splice(i,1);f.dispose();}
;if(e.length!=0){return;}
;this.__dm=[];}
}});}
)();
(function(){var a='indexOf',b='slice',c='concat',d='toLocaleLowerCase',e="qx.type.BaseString",f="",g='trim',h='match',j="qx.debug",k='search',m='replace',n='toLowerCase',o='charCodeAt',p='split',q='substring',r='lastIndexOf',s='substr',t='toLocaleUpperCase',u='toUpperCase',v='charAt';qx.Class.define(e,{extend:Object,construct:function(w){var w=w||f;this.__jj=w;this.length=w.length;}
,members:{$$isString:true,length:0,__jj:null,toString:function(){return this.__jj;}
...
(function(){var a="qx.locale.LocalizedString";qx.Class.define(a,{extend:qx.type.BaseString,construct:function(b,d,c){qx.type.BaseString.call(this,b);this.__jk=d;this.__jl=c;}
,members:{__jk:null,__jl:null,translate:function(){return qx.locale.Manager.getInstance().translate(this.__jk,this.__jl);}
}});}
)();
(function(){var a="locale",b="_applyLocale",c="",d="changeLocale",e="_",f="Locale: ",g="C",h="locale.variant",j="qx.dynlocale",k=" not available.",l="qx.locale.Manager",m="String",n="singleton",o="qx.debug";qx.Class.define(l,{type:n,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__jm=qx.$$translations||{};this.__jn=qx.$$locales||{};var p=qx.core.Environment.get(a);var q=qx.core.Environment.get(h);if(q!==c){p+=e+q;}
;this.__jo=p;this.setLocale(p||this.__jp);}
...
},properties:{locale:{check:m,nullable:true,apply:b,event:d}},members:{__jp:g,__jq:null,__jr:null,__jm:null,__jn:null,__jo:null,getLanguage:function(){return this.__jr;}
,getTerritory:function(){return this.getLocale().split(e)[1]||c;}
,getAvailableLocales:function(F){var G=[];for(var E in this.__jn){if(E!=this.__jp){if(this.__jn[E]===null&&!F){continue;}
;G.push(E);}
;}
;return G;}
,__js:function(H){var J;if(H==null){return null;}
;var I=H.indexOf(e);if(I==-1){J=H;}
else {J=H.substring(0,I);}
;return J;}
,_applyLocale:function(L,K){if(qx.core.Environment.get(o)){if(!(L in this.__jn||L==this.__jo)){qx.log.Logger.warn(f+L+k);}
;}
;this.__jq=L;this.__jr=this.__js(L);}
,addTranslation:function(M,P){var N=this.__jm;if(N[M]){for(var O in P){N[M][O]=P[O];}
;}
else {N[M]=P;}
;}
,addLocale:function(T,R){var Q=this.__jn;if(Q[T]){for(var S in R){Q[T][S]=R[S];}
;}
else {Q[T]=R;}
;}
,translate:function(X,W,U){var V=this.__jm;return this.__jt(V,X,W,U);}
,localize:function(bc,bb,Y){var ba=this.__jn;return this.__jt(ba,bc,bb,Y);}
,__jt:function(bh,bi,bf,bg){if(qx.core.Environment.get(o)){this.assertObject(bh);this.assertString(bi);this.assertArray(bf);}
;var bd;if(!bh){return bi;}
;if(bg){var be=this.__js(bg);}
else {bg=this.__jq;be=this.__jr;}
;if(!bd&&bh[bg]){bd=bh[bg][bi];}
;if(!bd&&bh[be]){bd=bh[be][bi];}
;if(!bd&&bh[this.__jp]){bd=bh[this.__jp][bi];}
;if(!bd){bd=bi;}
...
(function(){var a="qx.bom.client.Locale",b="-",c="locale",d="",e="android",f="locale.variant";qx.Bootstrap.define(a,{statics:{getLocale:function(){var g=qx.bom.client.Locale.__ju();var h=g.indexOf(b);if(h!=-1){g=g.substr(0,h);}
;return g;}
,getVariant:function(){var i=qx.bom.client.Locale.__ju();var k=d;var j=i.indexOf(b);if(j!=-1){k=i.substr(j+1);}
;return k;}
,__ju:function(){var l=(navigator.userLanguage||navigator.language||d);if(qx.bom.client.OperatingSystem.getName()==e){var m=/(\w{2})-(\w{2})/i.exec(navigator.userAgent);if(m){l=m[0];}
;}
;return l.toLowerCase();}
},defer:function(n){qx.core.Environment.add(c,n.getLocale);qx.core.Environment.add(f,n.getVariant);}
});}
)();
(function(){var a="Image could not be loaded: ",b="Boolean",c="px",d="http",e=".png",f="background-image",g="engine.version",h="scale",i="changeSource",j="div",k="__jv",l="nonScaled",m="qx.ui.basic.Image",n="loaded",o="0 0",p=", no-repeat",q="qx.debug",r="replacement",s="backgroundImage",t="backgroundRepeat",u="-disabled.$1",v="class",w="qx.event.type.Event",x="loadingFailed",y="css.alphaimageloaderneeded",z="String",A="browser.documentmode",B="backgroundPosition",C="border-box",D="left",E="_applySource",F="$$widget",G="data:image/",H="top",I="scaled",J=", ",K="image",L="mshtml",M="engine.name",N=", 0 0",O="_applyScale",P="try to load an unmanaged relative image: ",Q="position",R="img",S="no-repeat",T="background-position",U="hidden",V="alphaScaled",W=",",X="absolute";qx.Class.define(m,{extend:qx.ui.core.Widget,construct:function(Y){this.__jv={};qx.ui.core.Widget.call(this);if(Y){this.setSource(Y);}
;}
,properties:{source:{check:z,init:null,nullable:true,event:i,apply:E,themeable:true},scale:{check:b,init:false,themeable:true,apply:O},appearance:{refine:true,init:K},allowShrinkX:{refine:true,init:false},allowShrinkY:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false}},events:{loadingFailed:w,loaded:w},members:{__jw:null,__jx:null,__fW:null,__jv:null,__jy:null,__jz:null,_onChangeTheme:function(){qx.ui.core.Widget.prototype._onChangeTheme.call(this);this._styleSource();}
,getContentElement:function(){return this.__jD();}
,_createContentElement:function(){return this.__jD();}
,_getContentHint:function(){return {width:this.__jw||0,height:this.__jx||0};}
,_applyDecorator:function(bc,bb){qx.ui.core.Widget.prototype._applyDecorator.call(this,bc,bb);var bd=this.getSource();bd=qx.util.AliasManager.getInstance().resolve(bd);var ba=this.getContentElement();if(this.__jz){ba=ba.getChild(0);}
;this.__jJ(ba,bd);}
,_applyPadding:function(bf,be,name){qx.ui.core.Widget.prototype._applyPadding.call(this,bf,be,name);var bg=this.getContentElement();if(this.__jz){bg.getChild(0).setStyles({top:this.getPaddingTop()||0,left:this.getPaddingLeft()||0});}
else {bg.setPadding(this.getPaddingLeft()||0,this.getPaddingTop()||0);}
;}
,renderLayout:function(bj,top,bh,bk){qx.ui.core.Widget.prototype.renderLayout.call(this,bj,top,bh,bk);var bi=this.getContentElement();if(this.__jz){bi.getChild(0).setStyles({width:bh-(this.getPaddingLeft()||0)-(this.getPaddingRight()||0),height:bk-(this.getPaddingTop()||0)-(this.getPaddingBottom()||0),top:this.getPaddingTop()||0,left:this.getPaddingLeft()||0});}
;}
...
,__jA:function(bp){this.__fW=bp;}
,__jB:function(){if(this.__fW==null){var br=this.getSource();var bq=false;if(br!=null){bq=qx.lang.String.endsWith(br,e);}
;if(this.getScale()&&bq&&qx.core.Environment.get(y)){this.__fW=V;}
else if(this.getScale()){this.__fW=I;}
else {this.__fW=l;}
;}
;return this.__fW;}
,__jC:function(bu){var bt;var bs;if(bu==V){bt=true;bs=j;}
else if(bu==l){bt=false;bs=j;}
else {bt=true;bs=R;}
;var bw=new qx.html.Image(bs);bw.setAttribute(F,this.toHashCode());bw.setScale(bt);bw.setStyles({"overflowX":U,"overflowY":U,"boxSizing":C});if(qx.core.Environment.get(y)){var bv=this.__jz=new qx.html.Element(j);bv.setAttribute(F,this.toHashCode());bv.setStyle(Q,X);bv.add(bw);return bv;}
;return bw;}
,__jD:function(){if(this.$$disposed){return null;}
;var bx=this.__jB();if(this.__jv[bx]==null){this.__jv[bx]=this.__jC(bx);}
;var by=this.__jv[bx];if(!this.__jy){this.__jy=by;}
;return by;}
,_styleSource:function(){var bz=qx.util.AliasManager.getInstance().resolve(this.getSource());var bC=this.getContentElement();if(this.__jz){bC=bC.getChild(0);}
;if(!bz){bC.resetSource();return;}
;this.__jE(bz);if((qx.core.Environment.get(M)==L)&&(parseInt(qx.core.Environment.get(g),10)<9||qx.core.Environment.get(A)<9)){var bA=this.getScale()?h:S;bC.tagNameHint=qx.bom.element.Decoration.getTagName(bA,bz);}
;var bB=this.__jy;if(this.__jz){bB=bB.getChild(0);}
;if(qx.util.ResourceManager.getInstance().has(bz)){this.__jG(bB,bz);}
else if(qx.io.ImageLoader.isLoaded(bz)){this.__jH(bB,bz);}
else {this.__jI(bB,bz);}
;}
,__jE:qx.core.Environment.select(M,{"mshtml":function(bE){var bF=qx.core.Environment.get(y);var bD=qx.lang.String.endsWith(bE,e);if(bF&&bD){if(this.getScale()&&this.__jB()!=V){this.__jA(V);}
else if(!this.getScale()&&this.__jB()!=l){this.__jA(l);}
;}
else {if(this.getScale()&&this.__jB()!=I){this.__jA(I);}
else if(!this.getScale()&&this.__jB()!=l){this.__jA(l);}
;}
;this.__jF(this.__jD());}
,"default":function(bG){if(this.getScale()&&this.__jB()!=I){this.__jA(I);}
else if(!this.getScale()&&this.__jB(l)){this.__jA(l);}
;this.__jF(this.__jD());}
}),__jF:function(bK){var bJ=this.__jy;if(bJ!=bK){if(bJ!=null){var bV=c;var bH={};var bP=this.getBounds();if(bP!=null){bH.width=bP.width+bV;bH.height=bP.height+bV;}
;var bQ=this.getInsets();bH.left=parseInt(bJ.getStyle(D)||bQ.left)+bV;bH.top=parseInt(bJ.getStyle(H)||bQ.top)+bV;bH.zIndex=10;var bN=this.__jz?bK.getChild(0):bK;bN.setStyles(bH,true);bN.setSelectable(this.getSelectable());if(!bJ.isVisible()){bK.hide();}
;if(!bJ.isIncluded()){bK.exclude();}
;var bS=bJ.getParent();if(bS){var bI=bS.getChildren().indexOf(bJ);bS.removeAt(bI);bS.addAt(bK,bI);}
;var bM=bN.getNodeName();bN.setSource(null);var bL=this.__jz?this.__jy.getChild(0):this.__jy;bN.tagNameHint=bM;bN.setAttribute(v,bL.getAttribute(v));qx.html.Element.flush();var bU=bL.getDomElement();var bT=bK.getDomElement();var bR=bJ.getListeners()||[];bR.forEach(function(bW){bK.addListener(bW.type,bW.handler,bW.self,bW.capture);}
);if(bU&&bT){var bO=bU.$$hash;bU.$$hash=bT.$$hash;bT.$$hash=bO;}
;this.__jy=bK;}
;}
;}
,__jG:function(bY,cb){var ca=qx.util.ResourceManager.getInstance();if(!this.getEnabled()){var bX=cb.replace(/\.([a-z]+)$/,u);if(ca.has(bX)){cb=bX;this.addState(r);}
else {this.removeState(r);}
;}
;if(bY.getSource()===cb){return;}
;this.__jJ(bY,cb);this.__jL(ca.getImageWidth(cb),ca.getImageHeight(cb));}
,__jH:function(cc,cg){var ce=qx.io.ImageLoader;this.__jJ(cc,cg);var cf=ce.getWidth(cg);var cd=ce.getHeight(cg);this.__jL(cf,cd);}
,__jI:function(ch,ck){var cl=qx.io.ImageLoader;if(qx.core.Environment.get(q)){var cj=ck.toLowerCase();var ci=qx.lang.String.startsWith;if(!ci(cj,d)&&!ci(cj,G)){var self=this.self(arguments);if(!self.__NO){self.__NO={};}
;if(!self.__NO[ck]){this.debug(P+ck);self.__NO[ck]=true;}
;}
;}
;if(!cl.isFailed(ck)){cl.load(ck,this.__jK,this);}
else {if(ch!=null){ch.resetSource();}
;}
;}
,__jJ:function(cm,cr){if(cm.getNodeName()==j){var cu=qx.theme.manager.Decoration.getInstance().resolve(this.getDecorator());if(cu){var cs=(cu.getStartColor()&&cu.getEndColor());var cq=cu.getBackgroundImage();if(cs||cq){var cn=this.getScale()?h:S;var co=qx.bom.element.Decoration.getAttributes(cr,cn);var cp=cu.getStyles(true);var ct={"backgroundImage":co.style.backgroundImage,"backgroundPosition":(co.style.backgroundPosition||o),"backgroundRepeat":(co.style.backgroundRepeat||S)};if(cq){ct[B]+=W+cp[T]||o;ct[t]+=J+cu.getBackgroundRepeat();}
;if(cs){ct[B]+=N;ct[t]+=p;}
;ct[s]+=W+cp[f];cm.setStyles(ct);return;}
;}
else {cm.setSource(null);}
;}
;cm.setSource(cr);}
,__jK:function(cv,cw){if(this.$$disposed===true){return;}
;if(cv!==qx.util.AliasManager.getInstance().resolve(this.getSource())){return;}
;if(cw.failed){this.warn(a+cv);this.fireEvent(x);}
else if(cw.aborted){return;}
else {this.fireEvent(n);}
;this._styleSource();}
,__jL:function(cx,cy){if(cx!==this.__jw||cy!==this.__jx){this.__jw=cx;this.__jx=cy;qx.ui.core.queue.Layout.add(this);}
;}
},destruct:function(){delete this.__jy;this._disposeMap(k);}
});}
)();
(function(){var a="source",b="engine.name",c="",d="mshtml",e="px",f="px ",g="no-repeat",h="backgroundImage",i="scale",j="webkit",k="div",l="qx.html.Image",m="qx/static/blank.gif",n="backgroundPosition";qx.Class.define(l,{extend:qx.html.Element,members:{__jM:null,__jN:null,tagNameHint:null,setPadding:function(o,p){this.__jN=o;this.__jM=p;if(this.getNodeName()==k){this.setStyle(n,o+f+p+e);}
;}
...
;var u=this._getProperty(a);var r=this._getProperty(i);var v=r?i:g;if(u!=null){u=u||null;q.paddingTop=this.__jM;q.paddingLeft=this.__jN;qx.bom.element.Decoration.update(s,u,v,q);}
;}
;}
...
;}
,getTagName:function(bh,bf){if(bf&&qx.core.Environment.get(r)&&this.__jP[bh]&&qx.lang.String.endsWith(bf,d)){return k;}
;return this.__jQ[bh];}
...
;}
;var bm;if(qx.core.Environment.get(r)&&this.__jP[bj]&&bk===A){var bn=this.__jS(bl);this.__jR(bi,bn.width,bn.height);bm=this.processAlphaFix(bi,bj,bl);}
else {delete bi.clip;if(bj===i){bm=this.__jT(bi,bj,bl);}
else if(bj===q||bj===Q){bm=this.__jU(bi,bj,bl);}
else {bm=this.__jX(bi,bj,bl);}
;}
;return bm;}
,__jR:function(bp,bo,bq){if(bp.width==null&&bo!=null){bp.width=bo+c;}
;if(bp.height==null&&bq!=null){bp.height=bq+c;}
;}
,__jS:function(br){var bs=qx.util.ResourceManager.getInstance().getImageWidth(br)||qx.io.ImageLoader.getWidth(br);var bt=qx.util.ResourceManager.getInstance().getImageHeight(br)||qx.io.ImageLoader.getHeight(br);return {width:bs,height:bt};}
...
,__jT:function(bA,bB,bz){var bC=qx.util.ResourceManager.getInstance().toUri(bz);var bD=this.__jS(bz);this.__jR(bA,bD.width,bD.height);return {src:bC,style:bA};}
,__jU:function(bE,bF,bH){var bG=qx.util.ResourceManager.getInstance();var bK=bG.getCombinedFormat(bH);var bM=this.__jS(bH);var bI;if(bK){var bL=bG.getData(bH);var bJ=bL[4];if(bK==I){bI=bG.toDataUri(bH);}
else {bI=bG.toUri(bJ);}
;if(bF===q){bE=this.__jV(bE,bL,bM.height);}
else {bE=this.__jW(bE,bL,bM.width);}
;return {src:bI,style:bE};}
else {if(qx.core.Environment.get(p)){this.__ka(bH);}
...
;}
,__jV:function(bN,bO,bQ){var bP=qx.util.ResourceManager.getInstance().getImageHeight(bO[4]);bN.clip={top:-bO[6],height:bQ};bN.height=bP+c;if(bN.top!=null){bN.top=(parseInt(bN.top,10)+bO[6])+c;}
else if(bN.bottom!=null){bN.bottom=(parseInt(bN.bottom,10)+bQ-bP-bO[6])+c;}
;return bN;}
,__jW:function(bS,bT,bR){var bU=qx.util.ResourceManager.getInstance().getImageWidth(bT[4]);bS.clip={left:-bT[5],width:bR};bS.width=bU+c;if(bS.left!=null){bS.left=(parseInt(bS.left,10)+bT[5])+c;}
else if(bS.right!=null){bS.right=(parseInt(bS.right,10)+bR-bU-bT[5])+c;}
;return bS;}
,__jX:function(bV,bW,ca){var bY=qx.util.ResourceManager.getInstance();var bX=bY.getCombinedFormat(ca);var ci=this.__jS(ca);if(bX&&bW!==b){var ch=bY.getData(ca);var cf=ch[4];if(bX==I){var cc=bY.toDataUri(ca);var cb=0;var cd=0;}
...
;return {style:bV};}
else {var top=bV.paddingTop||0;var cj=bV.paddingLeft||0;bV.backgroundPosition=cj+g+top+c;if(qx.core.Environment.get(p)){if(bW!==b){this.__ka(ca);}
;}
;this.__jR(bV,ci.width,ci.height);this.__jY(bV,ca,bW);return {style:bV};}
;}
,__jY:function(ck,cn,cl){var top=null;var cq=null;if(ck.backgroundPosition){var cm=ck.backgroundPosition.split(L);cq=parseInt(cm[0],10);if(isNaN(cq)){cq=cm[0];}
...
;}
,__ka:function(cr){if(this.DEBUG&&qx.util.ResourceManager.getInstance().has(cr)&&cr.indexOf(a)==-1){if(!this.__jO[cr]){qx.log.Logger.debug(l+cr);this.__jO[cr]=true;}
;}
;}
...
(function(){var a="load",b="html.image.naturaldimensions",c="qx.io.ImageLoader";qx.Bootstrap.define(c,{statics:{__cN:{},__kb:{width:null,height:null},__kc:/\.(png|gif|jpg|jpeg|bmp)\b/i,__kd:/^data:image\/(png|gif|jpg|jpeg|bmp)\b/i,isLoaded:function(d){var e=this.__cN[d];return !!(e&&e.loaded);}
,isFailed:function(f){var g=this.__cN[f];return !!(g&&g.failed);}
,isLoading:function(h){var j=this.__cN[h];return !!(j&&j.loading);}
,getFormat:function(o){var n=this.__cN[o];if(!n||!n.format){var k=this.__kd.exec(o);if(k!=null){var m=(n&&qx.lang.Type.isNumber(n.width)?n.width:this.__kb.width);var p=(n&&qx.lang.Type.isNumber(n.height)?n.height:this.__kb.height);n={loaded:true,format:k[1],width:m,height:p};}
;}
;return n?n.format:null;}
,getSize:function(q){var r=this.__cN[q];return r?{width:r.width,height:r.height}:this.__kb;}
...
;var w=new Image();var B=qx.lang.Function.listener(this.__ke,this,w,y);w.onload=B;w.onerror=B;w.src=y;A.element=w;}
;}
...
;}
;this.__cN[C]=null;}
,__ke:qx.event.GlobalError.observeMethod(function(event,H,G){var L=this.__cN[G];var I=function(M){return (M&&M.height!==0);}
;if(event.type===a&&I(H)){L.loaded=true;L.width=this.__kf(H);L.height=this.__kg(H);var J=this.__kc.exec(G);if(J!=null){L.format=J[1];}
;}
else {L.failed=true;}
...
;}
),__kf:function(N){return qx.core.Environment.get(b)?N.naturalWidth:N.width;}
,__kg:function(O){return qx.core.Environment.get(b)?O.naturalHeight:O.height;}
,dispose:function(){this.__cN={};}
}});}
)();
(function(){var a="')",b="gecko",c="background-image:url(",d="0",e=");",f="",g="px",h="number",i=")",j="background-repeat:",k="engine.version",l="data:",m=" ",n="qx.bom.element.Background",o=";",p="url(",q="background-position:",r="base64",s="url('",t="engine.name",u="'";qx.Class.define(n,{statics:{__kh:[c,null,e,q,null,o,j,null,o],__ki:{backgroundImage:null,backgroundPosition:null,backgroundRepeat:null},__kj:function(z,top){var v=qx.core.Environment.get(t);var x=qx.core.Environment.get(k);if(v==b&&x<1.9&&z==top&&typeof z==h){top+=0.01;}
;if(z){var y=(typeof z==h)?z+g:z;}
else {y=d;}
;if(top){var w=(typeof top==h)?top+g:top;}
else {w=d;}
;return y+m+w;}
,__kk:function(A){var String=qx.lang.String;var B=A.substr(0,50);return String.startsWith(B,l)&&String.contains(B,r);}
,compile:function(F,D,H,top){var G=this.__kj(H,top);var E=qx.util.ResourceManager.getInstance().toUri(F);if(this.__kk(E)){E=u+E+u;}
;var C=this.__kh;C[1]=E;C[4]=G;C[7]=D;return C.join(f);}
,getStyles:function(L,J,N,top){if(!L){return this.__ki;}
;var M=this.__kj(N,top);var K=qx.util.ResourceManager.getInstance().toUri(L);var O;if(this.__kk(K)){O=s+K+a;}
else {O=p+K+i;}
...
(function(){var a="offline",b="qx.event.handler.Offline",c="online";qx.Class.define(b,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(d){qx.core.Object.call(this);this.__eT=d;this.__cx=d.getWindow();this._initObserver();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{online:true,offline:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__eT:null,__cx:null,__fU:null,canHandleEvent:function(f,e){}
,registerEvent:function(i,h,g){}
,unregisterEvent:function(l,k,j){}
,_initObserver:function(){this.__fU=qx.lang.Function.listener(this._onNative,this);qx.bom.Event.addNativeListener(this.__cx,a,this.__fU);qx.bom.Event.addNativeListener(this.__cx,c,this.__fU);}
,_stopObserver:function(){qx.bom.Event.removeNativeListener(this.__cx,a,this.__fU);qx.bom.Event.removeNativeListener(this.__cx,c,this.__fU);}
...
,statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST},members:{__cz:null,__kl:null,__km:true,__cx:null,_getParent:function(l){return l.parentNode;}
,canDispatchEvent:function(n,event,m){return !!(this.__kl&&this.__kn[m]);}
...
;}
;if(this.__km||!qx.dom.Hierarchy.contains(this.__kl,p)){p=this.__kl;}
;qx.event.dispatch.AbstractBubbling.prototype.dispatchEvent.call(this,p,event,o);}
,__kn:{"mouseup":1,"mousedown":1,"click":1,"dblclick":1,"mousemove":1,"mouseout":1,"mouseover":1},activateCapture:function(r,q){var q=q!==false;if(this.__kl===r&&this.__km==q){return;}
;if(this.__kl){this.releaseCapture();}
...
;this.__km=q;this.__kl=r;this.__cz.fireEvent(r,h,qx.event.type.Event,[true,false]);}
,getCaptureElement:function(){return this.__kl;}
,releaseCapture:function(){var s=this.__kl;if(!s){return;}
;this.__kl=null;this.__cz.fireEvent(s,d,qx.event.type.Event,[true,false]);this.nativeReleaseCapture(s);}
...
,"default":(function(){}
)})},destruct:function(){this.__kl=this.__cx=this.__cz=null;}
...
;}
;return false;}
,__ko:{quicktime:{plugin:[k],control:f},wmv:{plugin:[t],control:J},divx:{plugin:[C],control:O},silverlight:{plugin:[c],control:D},pdf:{plugin:[r,g],control:K}},getQuicktimeVersion:function(){var T=qx.bom.client.Plugin.__ko[B];return qx.bom.client.Plugin.__kp(T.control,T.plugin);}
,getWindowsMediaVersion:function(){var U=qx.bom.client.Plugin.__ko[n];return qx.bom.client.Plugin.__kp(U.control,U.plugin);}
,getDivXVersion:function(){var V=qx.bom.client.Plugin.__ko[s];return qx.bom.client.Plugin.__kp(V.control,V.plugin);}
,getSilverlightVersion:function(){var W=qx.bom.client.Plugin.__ko[F];return qx.bom.client.Plugin.__kp(W.control,W.plugin);}
,getPdfVersion:function(){var X=qx.bom.client.Plugin.__ko[m];return qx.bom.client.Plugin.__kp(X.control,X.plugin);}
,getQuicktime:function(){var Y=qx.bom.client.Plugin.__ko[B];return qx.bom.client.Plugin.__kq(Y.control,Y.plugin);}
,getWindowsMedia:function(){var ba=qx.bom.client.Plugin.__ko[n];return qx.bom.client.Plugin.__kq(ba.control,ba.plugin);}
,getDivX:function(){var bb=qx.bom.client.Plugin.__ko[s];return qx.bom.client.Plugin.__kq(bb.control,bb.plugin);}
,getSilverlight:function(){var bc=qx.bom.client.Plugin.__ko[F];return qx.bom.client.Plugin.__kq(bc.control,bc.plugin);}
,getPdf:function(){var bd=qx.bom.client.Plugin.__ko[m];return qx.bom.client.Plugin.__kq(bd.control,bd.plugin);}
,__kp:function(bl,bh){var be=qx.bom.client.Plugin.__kq(bl,bh);if(!be){return u;}
...
;return u;}
;}
,__kq:function(bq,bo){if(qx.bom.client.Engine.getName()==v){var bn=window.ActiveXObject;if(!bn){return false;}
...
(function(){var a="blur",b="mousedown",c="qx.debug",d="qx.ui.popup.Manager",f="Object is no popup: ",g="__om",h="singleton";qx.Class.define(d,{type:h,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__om=[];qx.event.Registration.addListener(document.documentElement,b,this.__po,this,true);qx.bom.Element.addListener(window,a,this.hideAll,this);}
,members:{__om:null,add:function(j){if(qx.core.Environment.get(c)){if(!(j instanceof qx.ui.popup.Popup)){throw new Error(f+j);}
;}
;this.__om.push(j);this.__pn();}
,remove:function(k){if(qx.core.Environment.get(c)){if(!(k instanceof qx.ui.popup.Popup)){throw new Error(f+k);}
;}
;qx.lang.Array.remove(this.__om,k);this.__pn();}
,hideAll:function(){var l=this.__om.length,m={};while(l-- ){m=this.__om[l];if(m.getAutoHide()){m.exclude();}
;}
;}
,__pn:function(){var n=1e7;for(var i=0;i<this.__om.length;i++ ){this.__om[i].setZIndex(n++ );}
;}
,__po:function(e){var p=qx.ui.core.Widget.getWidgetByElement(e.getTarget());var q=this.__om;for(var i=0;i<q.length;i++ ){var o=q[i];if(!o.getAutoHide()||p==o||qx.ui.core.Widget.contains(o,p)){continue;}
;o.exclude();}
;}
},destruct:function(){qx.event.Registration.removeListener(document.documentElement,b,this.__po,this,true);this._disposeArray(g);}
});}
)();
...
;}
,properties:{alignX:{check:[o,j,p],init:o,apply:c},alignY:{check:[n,b,g],init:n,apply:c},spacing:{check:q,init:0,apply:c},separator:{check:a,nullable:true,apply:c},reversed:{check:k,init:false,apply:e}},members:{__mq:null,__lJ:null,__lK:null,__fq:null,_applyReversed:function(){this._invalidChildrenCache=true;this._applyLayoutChange();}
,__lL:function(){var B=this._getLayoutChildren();var length=B.length;var y=false;var w=this.__mq&&this.__mq.length!=length&&this.__lJ&&this.__mq;var z;var x=w?this.__mq:new Array(length);var A=w?this.__lJ:new Array(length);if(this.getReversed()){B=B.concat().reverse();}
...
;}
;if(!w){this.__mq=x;this.__lJ=A;}
;this.__lK=y;this.__fq=B;delete this._invalidChildrenCache;}
...
;}
,"false":null}),renderLayout:function(U,O,T){if(this._invalidChildrenCache){this.__lL();}
;var K=this.__fq;var length=K.length;var W=qx.ui.layout.Util;var S=this.getSpacing();var Y=this.getSeparator();if(Y){var H=W.computeHorizontalSeparatorGaps(K,S,Y);}
else {var H=W.computeHorizontalGaps(K,S,true);}
;var i,V,Q,P;var X=[];var L=H;for(i=0;i<length;i+=1){P=this.__mq[i];Q=P!=null?Math.floor((U-H)*P):K[i].getSizeHint().width;X.push(Q);L+=Q;}
;if(this.__lK&&L!=U){var N={};var R,F;for(i=0;i<length;i+=1){R=this.__lJ[i];if(R>0){M=K[i].getSizeHint();N[i]={min:M.minWidth,value:X[i],max:M.maxWidth,flex:R};}
;}
...
;var bs=qx.ui.layout.Util;var bf=this.__fq;var bk=0,bl=0,be=0;var bi=0,bj=0;var bp,bg,br;for(var i=0,l=bf.length;i<l;i+=1){bp=bf[i];bg=bp.getSizeHint();bl+=bg.width;var bo=this.__lJ[i];var bh=this.__mq[i];if(bo){bk+=bg.minWidth;}
...
},destruct:function(){this.__mq=this.__lJ=this.__fq=null;}
});}
)();
...
;}
,properties:{rich:{check:c,init:false,event:G,apply:I},wrap:{check:c,init:true,apply:i},value:{check:w,apply:r,event:j,nullable:true},buddy:{check:d,apply:u,nullable:true,init:null,dereference:true},textAlign:{check:[N,s,D,F],nullable:true,themeable:true,apply:b,event:h},appearance:{refine:true,init:L},selectable:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false},allowShrinkY:{refine:true,init:false}},members:{__mr:null,__ms:null,__mt:null,__mu:null,__mv:null,_getContentHint:function(){if(this.__ms){this.__mw=this.__mx();delete this.__ms;}
;return {width:this.__mw.width,height:this.__mw.height};}
...
;}
,__mw:{width:0,height:0},_applyFont:function(Y,X){if(X&&this.__mr&&this.__mv){this.__mr.removeListenerById(this.__mv);this.__mv=null;}
;var W;if(Y){this.__mr=qx.theme.manager.Font.getInstance().resolve(Y);if(this.__mr instanceof qx.bom.webfonts.WebFont){this.__mv=this.__mr.addListener(g,this._onWebFontStatusChange,this);}
;W=this.__mr.getStyles();}
else {this.__mr=null;W=qx.bom.Font.getDefaultStyles();}
;if(this.getTextColor()!=null){delete W[k];}
;this.getContentElement().setStyles(W);this.__ms=true;qx.ui.core.queue.Layout.add(this);}
,__mx:function(bc){var bb=qx.bom.Label;var be=this.getFont();var ba=be?this.__mr.getStyles():qx.bom.Font.getDefaultStyles();var content=this.getValue()||O;var bd=this.getRich();if(this.__mv){this.__my();}
;return bd?bb.getHtmlSize(content,ba,bc):bb.getTextSize(content,ba);}
,__my:function(){if(!this.getContentElement()){return;}
...
;}
;}
,_applyBuddy:function(bh,bg){if(bg!=null){bg.removeBinding(this.__mt);this.__mt=null;this.removeListenerById(this.__mu);this.__mu=null;}
;if(bh!=null){this.__mt=bh.bind(v,this,v);this.__mu=this.addListener(K,function(){if(bh.isFocusable()){bh.focus.apply(bh);}
;if(x in bh&&typeof bh.toggleValue===A){bh.toggleValue();}
;}
,this);}
;}
,_applyRich:function(bi){this.getContentElement().setRich(bi);this.__ms=true;qx.ui.core.queue.Layout.add(this);}
...
;}
,"false":null}),_onWebFontStatusChange:function(bm){if(bm.getData().valid===true){this.__ms=true;qx.ui.core.queue.Layout.add(this);}
;}
,_applyValue:function(bo,bn){this.getContentElement().setValue(bo);this.__ms=true;qx.ui.core.queue.Layout.add(this);}
},destruct:function(){if(qx.core.Environment.get(B)){qx.locale.Manager.getInstance().removeListener(M,this._onChangeLocale,this);}
;if(this.__mt!=null){var bp=this.getBuddy();if(bp!=null&&!bp.isDisposed()){bp.removeBinding(this.__mt);}
;}
;if(this.__mr&&this.__mv){this.__mr.removeListenerById(this.__mv);}
;this.__mr=this.__mt=null;}
});}
)();
(function(){var a="value",b="qx.html.Label",c="The label mode cannot be modified after initial creation";qx.Class.define(b,{extend:qx.html.Element,members:{__mz:null,_applyProperty:function(name,d){qx.html.Element.prototype._applyProperty.call(this,name,d);if(name==a){var e=this.getDomElement();qx.bom.Label.setValue(e,d);}
;}
,_createDomElement:function(){var g=this.__mz;var f=qx.bom.Label.create(this._content,g);return f;}
...
;i=!!i;if(this.__mz==i){return this;}
;this.__mz=i;return this;}
,setValue:function(k){this._setProperty(a,k);return this;}
,getValue:function(){return this._getProperty(a);}
}});}
)();
(function(){var a="text",b="px",c="http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul",d="crop",e="nowrap",f="gecko",g="end",h="div",i="browser.name",j="100%",k="auto",l="0",m="css.textoverflow",n="html.xul",o="chrome",p="value",q="visible",r="qx.bom.Label",s="safari",t="",u="ellipsis",v="browser.version",w="engine.version",x="normal",y="mshtml",z="engine.name",A="inherit",B="block",C="label",D="-1000px",E="hidden",F="absolute";qx.Bootstrap.define(r,{statics:{__mA:{fontFamily:1,fontSize:1,fontWeight:1,fontStyle:1,lineHeight:1},__mB:function(){var G=this.__mD(false);document.body.insertBefore(G,document.body.firstChild);return this._textElement=G;}
,__mC:function(){var H=this.__mD(true);document.body.insertBefore(H,document.body.firstChild);return this._htmlElement=H;}
,__mD:function(K){var I=qx.dom.Element.create(h);var J=I.style;J.width=J.height=k;J.left=J.top=D;J.visibility=E;J.position=F;J.overflow=q;J.display=B;if(K){J.whiteSpace=x;}
else {J.whiteSpace=e;if(!qx.core.Environment.get(m)&&qx.core.Environment.get(n)){var L=document.createElementNS(c,C);var J=L.style;J.padding=l;J.margin=l;J.width=k;for(var M in this.__mA){J[M]=A;}
;I.appendChild(L);}
;}
;return I;}
,__mE:function(O){var N={};if(O){N.whiteSpace=x;}
...
else if(!qx.core.Environment.get(m)&&qx.core.Environment.get(n)){var T=R.document.createElementNS(c,C);var Q=T.style;Q.cursor=A;Q.color=A;Q.overflow=E;Q.maxWidth=j;Q.padding=l;Q.margin=l;Q.width=k;for(var U in this.__mA){T.style[U]=A;}
;T.setAttribute(d,g);P.appendChild(T);}
else {qx.bom.element.Style.setStyles(P,this.__mE(S));}
...
;}
,getHtmlSize:function(content,Y,ba){var bb=this._htmlElement||this.__mC();bb.style.width=ba!=undefined?ba+b:k;bb.innerHTML=content;return this.__mF(bb,Y);}
,getTextSize:function(bd,bc){var be=this._textElement||this.__mB();if(!qx.core.Environment.get(m)&&qx.core.Environment.get(n)){be.firstChild.setAttribute(p,bd);}
else {qx.bom.element.Attribute.set(be,a,bd);}
;return this.__mF(be,bc);}
,__mF:function(bj,bf){var bg=this.__mA;if(!bf){bf={};}
...
(function(){var a="_applyActiveWindow",b="changeModal",c="changeVisibility",d="__eT",f="changeActive",g="qx.ui.window.MDesktop",h="__sG",i="qx.ui.window.Window";qx.Mixin.define(g,{properties:{activeWindow:{check:i,apply:a,init:null,nullable:true}},members:{__sG:null,__eT:null,getWindowManager:function(){if(!this.__eT){this.setWindowManager(new qx.ui.window.Window.DEFAULT_MANAGER_CLASS());}
;return this.__eT;}
,supportsMaximize:function(){return true;}
,setWindowManager:function(j){if(this.__eT){this.__eT.setDesktop(null);}
;j.setDesktop(this);this.__eT=j;}
...
,getWindows:function(){if(!this.__sG){this.__sG=[];}
;return this.__sG;}
},destruct:function(){this._disposeArray(h);this._disposeObjects(d);}
});}
)();
(function(){var a="indexOf",b="addAfter",c="add",d="addBefore",e="_",f="addAt",g="hasChildren",h="removeAt",i="removeAll",j="getChildren",k="remove",l="qx.ui.core.MRemoteChildrenHandling";qx.Mixin.define(l,{members:{__os:function(q,m,o,n){var p=this.getChildrenContainer();if(p===this){q=e+q;}
;return (p[q])(m,o,n);}
,getChildren:function(){return this.__os(j);}
,hasChildren:function(){return this.__os(g);}
,add:function(s,r){return this.__os(c,s,r);}
,remove:function(t){return this.__os(k,t);}
,removeAll:function(){return this.__os(i);}
,indexOf:function(u){return this.__os(a,u);}
,addAt:function(x,v,w){this.__os(f,x,v,w);}
,addBefore:function(y,A,z){this.__os(d,y,A,z);}
,addAfter:function(D,B,C){this.__os(b,D,B,C);}
,removeAt:function(E){return this.__os(h,E);}
}});}
)();
...
(function(){var a="__qp",b="qx.ui.window.Manager";qx.Class.define(b,{extend:qx.core.Object,implement:qx.ui.window.IWindowManager,members:{__qp:null,setDesktop:function(c){this.__qp=c;this.updateStack();}
,getDesktop:function(){return this.__qp;}
,changeActiveWindow:function(d,e){if(d){this.bringToFront(d);d.setActive(true);}
;if(e){e.resetActive();}
;}
,_minZIndex:1e5,updateStack:function(){qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(){this.__qp.forceUnblock();var h=this.__qp.getWindows();var g=this._minZIndex;var m=g+h.length*2;var j=g+h.length*4;var k=null;for(var i=0,l=h.length;i<l;i++ ){var f=h[i];if(!f.isVisible()){continue;}
;k=k||f;if(f.isModal()){f.setZIndex(j);this.__qp.blockContent(j-1);j+=2;k=f;}
else if(f.isAlwaysOnTop()){f.setZIndex(m);m+=2;}
else {f.setZIndex(g);g+=2;}
;if(!k.isModal()&&f.isActive()||f.getZIndex()>k.getZIndex()){k=f;}
;}
;this.__qp.setActiveWindow(k);}
,bringToFront:function(o){var n=this.__qp.getWindows();var p=qx.lang.Array.remove(n,o);if(p){n.push(o);this.updateStack();}
;}
,sendToBack:function(r){var q=this.__qp.getWindows();var s=qx.lang.Array.remove(q,r);if(s){q.unshift(r);this.updateStack();}
;}
},destruct:function(){this._disposeObjects(a);}
});}
)();
(function(){var a="mouseup",b="mousedown",c="Boolean",d="__qq",f="losecapture",g="mousewheel",h="qx.ui.core.MMovable",i="The move handle could not be redefined!",j="mousemove",k="move",l="maximized",m="__qr",n="move-frame";qx.Mixin.define(h,{properties:{movable:{check:c,init:true},useMoveFrame:{check:c,init:false}},members:{__qq:null,__qr:null,__qs:null,__qt:null,__qu:null,__qv:null,__qw:null,__qx:false,__qy:null,__qz:0,_activateMoveHandle:function(o){if(this.__qq){throw new Error(i);}
;this.__qq=o;o.addListener(b,this._onMoveMouseDown,this);o.addListener(a,this._onMoveMouseUp,this);o.addListener(j,this._onMoveMouseMove,this);o.addListener(f,this.__qD,this);if(qx.event.handler.MouseEmulation.ON){o.addListener(g,function(e){e.stopPropagation();}
,this);}
;}
,__qA:function(){var p=this.__qr;if(!p){p=this.__qr=new qx.ui.core.Widget();p.setAppearance(n);p.exclude();qx.core.Init.getApplication().getRoot().add(p);}
;return p;}
,__qB:function(){var location=this.getContentLocation();var r=this.getBounds();var q=this.__qA();q.setUserBounds(location.left,location.top,r.width,r.height);q.show();q.setZIndex(this.getZIndex()+1);}
,__qC:function(e){var t=this.__qs;var w=Math.max(t.left,Math.min(t.right,e.getDocumentLeft()));var s=Math.max(t.top,Math.min(t.bottom,e.getDocumentTop()));var u=this.__qt+w;var v=this.__qu+s;return {viewportLeft:parseInt(u,10),viewportTop:parseInt(v,10),parentLeft:parseInt(u-this.__qv,10),parentTop:parseInt(v-this.__qw,10)};}
,_onMoveMouseDown:function(e){if(!this.getMovable()||this.hasState(l)){return;}
;var parent=this.getLayoutParent();var x=parent.getContentLocation();var z=parent.getBounds();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(!parent.isBlocked()){this.__qy=parent.getBlockerColor();this.__qz=parent.getBlockerOpacity();parent.setBlockerColor(null);parent.setBlockerOpacity(1);parent.blockContent(this.getZIndex()-1);this.__qx=true;}
;}
;this.__qs={left:x.left,top:x.top,right:x.left+z.width,bottom:x.top+z.height};var y=this.getContentLocation();this.__qv=x.left;this.__qw=x.top;this.__qt=y.left-e.getDocumentLeft();this.__qu=y.top-e.getDocumentTop();this.addState(k);this.__qq.capture();if(this.getUseMoveFrame()){this.__qB();}
;e.stop();}
,_onMoveMouseMove:function(e){if(!this.hasState(k)){return;}
;var B=this.__qC(e);if(this.getUseMoveFrame()){this.__qA().setDomPosition(B.viewportLeft,B.viewportTop);}
...
;this.removeState(k);var parent=this.getLayoutParent();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(this.__qx){parent.unblock();parent.setBlockerColor(this.__qy);parent.setBlockerOpacity(this.__qz);this.__qy=null;this.__qz=0;this.__qx=false;}
;}
;this.__qq.releaseCapture();var D=this.__qC(e);var C=this.getLayoutParent().getInsets();this.setLayoutProperties({left:D.parentLeft-(C.left||0),top:D.parentTop-(C.top||0)});if(this.getUseMoveFrame()){this.__qA().exclude();}
;e.stopPropagation();}
,__qD:function(e){if(!this.hasState(k)){return;}
;this.removeState(k);if(this.getUseMoveFrame()){this.__qA().exclude();}
;}
},destruct:function(){this._disposeObjects(m,d);this.__qs=null;}
});}
)();
(function(){var a="resetPaddingRight",b="setPaddingTop",c="_applyContentPadding",d="setPaddingBottom",e="resetThemed",f="contentPaddingRight",g="Integer",h="contentPaddingLeft",i="setThemedPaddingLeft",j="resetPaddingTop",k="shorthand",l="setThemedPaddingRight",m="setThemed",n="setPaddingRight",o="contentPaddingBottom",p="resetPaddingBottom",q="qx.ui.core.MContentPadding",r="resetPaddingLeft",s="setThemedPaddingTop",t="setPaddingLeft",u="setThemedPaddingBottom",v="contentPaddingTop";qx.Mixin.define(q,{properties:{contentPaddingTop:{check:g,init:0,apply:c,themeable:true},contentPaddingRight:{check:g,init:0,apply:c,themeable:true},contentPaddingBottom:{check:g,init:0,apply:c,themeable:true},contentPaddingLeft:{check:g,init:0,apply:c,themeable:true},contentPadding:{group:[v,f,o,h],mode:k,themeable:true}},members:{__nl:{contentPaddingTop:b,contentPaddingRight:n,contentPaddingBottom:d,contentPaddingLeft:t},__nm:{contentPaddingTop:s,contentPaddingRight:l,contentPaddingBottom:u,contentPaddingLeft:i},__nn:{contentPaddingTop:j,contentPaddingRight:a,contentPaddingBottom:p,contentPaddingLeft:r},_applyContentPadding:function(z,w,name,y){var A=this._getContentPaddingTarget();if(z==null){var x=this.__nn[name];A[x]();}
else {if(y==m||y==e){var B=this.__nm[name];A[B](z);}
else {var B=this.__nl[name];A[B](z);}
;}
;}
}});}
)();
(function(){var a="mousedown",b="Boolean",c="w-resize",d="sw-resize",f="n-resize",g="resizableRight",h="ne-resize",i="se-resize",j="Integer",k="e-resize",l="resizableLeft",m="mousemove",n="move",o="shorthand",p="maximized",q="resize",r="nw-resize",s="mouseout",t="qx.ui.core.MResizable",u="mouseup",v="losecapture",w="resize-frame",x="resizableBottom",y="s-resize",z="resizableTop";qx.Mixin.define(t,{construct:function(){var content=this.getContentElement();content.addListener(a,this.__qQ,this,true);content.addListener(u,this.__qR,this);content.addListener(m,this.__qT,this);content.addListener(s,this.__qU,this);content.addListener(v,this.__qS,this);var A=content.getDomElement();if(A==null){A=window;}
;this.__qE=qx.event.Registration.getManager(A).getHandler(qx.event.handler.DragDrop);}
,properties:{resizableTop:{check:b,init:true},resizableRight:{check:b,init:true},resizableBottom:{check:b,init:true},resizableLeft:{check:b,init:true},resizable:{group:[z,g,x,l],mode:o},resizeSensitivity:{check:j,init:5},useResizeFrame:{check:b,init:true}},members:{__qE:null,__qF:null,__qG:null,__qH:null,__qI:null,__qJ:null,__qK:null,RESIZE_TOP:1,RESIZE_BOTTOM:2,RESIZE_LEFT:4,RESIZE_RIGHT:8,_getResizeFrame:function(){var B=this.__qF;if(!B){B=this.__qF=new qx.ui.core.Widget();B.setAppearance(w);B.exclude();qx.core.Init.getApplication().getRoot().add(B);}
;return B;}
,__qL:function(){var location=this.getContentLocation();var C=this._getResizeFrame();C.setUserBounds(location.left,location.top,location.right-location.left,location.bottom-location.top);C.show();C.setZIndex(this.getZIndex()+1);}
,__qM:function(e){var E=this.__qG;var D=this.getSizeHint();var H=this.__qK;var G=this.__qJ;var I=G.width;var F=G.height;var K=G.left;var top=G.top;var J;if((E&this.RESIZE_TOP)||(E&this.RESIZE_BOTTOM)){J=Math.max(H.top,Math.min(H.bottom,e.getDocumentTop()))-this.__qI;if(E&this.RESIZE_TOP){F-=J;}
else {F+=J;}
;if(F<D.minHeight){F=D.minHeight;}
else if(F>D.maxHeight){F=D.maxHeight;}
;if(E&this.RESIZE_TOP){top+=G.height-F;}
;}
;if((E&this.RESIZE_LEFT)||(E&this.RESIZE_RIGHT)){J=Math.max(H.left,Math.min(H.right,e.getDocumentLeft()))-this.__qH;if(E&this.RESIZE_LEFT){I-=J;}
else {I+=J;}
...
,__qN:{'1':f,'2':y,'4':c,'8':k,'5':r,'6':d,'9':h,'10':i},__qO:function(e){var location=this.getContentLocation();var N=this.getResizeSensitivity();var O=e.getDocumentLeft();var M=e.getDocumentTop();var L=this.__qP(location,O,M,N);if(L>0){L=L|this.__qP(location,O,M,N*2);}
;this.__qG=L;}
,__qP:function(location,S,R,P){var Q=0;if(this.getResizableTop()&&Math.abs(location.top-R)<P&&S>location.left-P&&S<location.right+P){Q+=this.RESIZE_TOP;}
...
;return Q;}
,__qQ:function(e){if(!this.__qG||!this.getEnabled()){return;}
;this.addState(q);this.__qH=e.getDocumentLeft();this.__qI=e.getDocumentTop();var location=this.getContentLocation();var U=this.getBounds();this.__qJ={top:location.top,left:location.left,width:location.right-location.left,height:location.bottom-location.top,bounds:qx.lang.Object.clone(U)};var parent=this.getLayoutParent();var V=parent.getContentLocation();var T=parent.getBounds();this.__qK={left:V.left,top:V.top,right:V.left+T.width,bottom:V.top+T.height};if(this.getUseResizeFrame()){this.__qL();}
;this.capture();e.stop();}
,__qR:function(e){if(!this.hasState(q)||!this.getEnabled()){return;}
;if(this.getUseResizeFrame()){this._getResizeFrame().exclude();}
;var W=this.__qM(e);this.setWidth(W.width);this.setHeight(W.height);if(this.getResizableLeft()||this.getResizableTop()){this.setLayoutProperties({left:W.parentLeft,top:W.parentTop});}
;this.__qG=0;this.removeState(q);this.resetCursor();this.getApplicationRoot().resetGlobalCursor();this.releaseCapture();e.stopPropagation();}
,__qS:function(e){if(!this.__qG){return;}
...
;}
,__qT:function(e){if(!this.getEnabled()){return;}
;if(this.hasState(q)){var Y=this.__qM(e);if(this.getUseResizeFrame()){var X=this._getResizeFrame();X.setUserBounds(Y.viewportLeft,Y.viewportTop,Y.width,Y.height);}
...
;}
;e.stopPropagation();}
else if(!this.hasState(p)&&!this.__qE.isSessionActive()){this.__qO(e);var bc=this.__qG;var bb=this.getApplicationRoot();if(bc){var ba=this.__qN[bc];this.setCursor(ba);bb.setGlobalCursor(ba);}
else if(this.getCursor()){this.resetCursor();bb.resetGlobalCursor();}
;}
;}
,__qU:function(e){if(this.getCursor()&&!this.hasState(q)){this.resetCursor();this.getApplicationRoot().resetGlobalCursor();}
;}
},destruct:function(){if(this.__qF!=null&&!qx.core.ObjectRegistry.inShutDown){this.__qF.destroy();this.__qF=null;}
;this.__qE=null;}
});}
)();
...
;var br=this.getLayoutProperties();this.__qW=br.left===undefined?0:br.left;this.__qV=br.top===undefined?0:br.top;this.setLayoutProperties({left:null,top:null,edge:0});this.addState(F);this._updateCaptionBar();this.fireEvent(Q);}
;}
;}
,minimize:function(){if(!this.isVisible()){return;}
;if(this.fireNonBubblingEvent(b,qx.event.type.Event,[false,true])){var bs=this.getLayoutProperties();this.__qW=bs.left===undefined?0:bs.left;this.__qV=bs.top===undefined?0:bs.top;this.removeState(F);this.hide();this.fireEvent(x);}
;}
...
;var bt=this.__qW;var top=this.__qV;this.setLayoutProperties({edge:null,left:bt,top:top});this.removeState(F);this._updateCaptionBar();this.fireEvent(S);}
;}
...
;this.__lK=x;this.__fq=B;delete this._invalidChildrenCache;}
...
;}
,"false":null}),renderLayout:function(V,N,Y){if(this._invalidChildrenCache){this.__lL();}
;var K=this.__fq;var length=K.length;var U=qx.ui.layout.Util;var T=this.getSpacing();var bb=this.getSeparator();if(bb){var H=U.computeVerticalSeparatorGaps(K,T,bb);}
else {var H=U.computeVerticalGaps(K,T,true);}
;var i,ba,G,O;var P=[];var W=H;for(i=0;i<length;i+=1){O=this.__lI[i];G=O!=null?Math.floor((N-H)*O):K[i].getSizeHint().height;P.push(G);W+=G;}
;if(this.__lK&&W!=N){var M={};var S,F;for(i=0;i<length;i+=1){S=this.__lJ[i];if(S>0){L=K[i].getSizeHint();M[i]={min:L.minHeight,value:P[i],max:L.maxHeight,flex:S};}
;}
...
;}
,_computeSizeHint:function(){if(this._invalidChildrenCache){this.__lL();}
;var be=qx.ui.layout.Util;var bs=this.__fq;var bh=0,bi=0,bq=0;var bj=0,bk=0;var bo,bf,br;for(var i=0,l=bs.length;i<l;i+=1){bo=bs[i];bf=bo.getSizeHint();bi+=bf.height;var bn=this.__lJ[i];var bg=this.__lI[i];if(bn){bh+=bf.minHeight;}
...
},destruct:function(){this.__lI=this.__lJ=this.__fq=null;}
});}
)();
(function(){var a="keypress",b="focusout",c="activate",d="Tab",f="singleton",g="__qX",h="deactivate",j="focusin",k="qx.ui.core.FocusHandler";qx.Class.define(k,{extend:qx.core.Object,type:f,construct:function(){qx.core.Object.call(this);this.__qX={};}
,members:{__qX:null,__qY:null,__ra:null,__rb:null,connectTo:function(m){m.addListener(a,this.__ha,this);m.addListener(j,this._onFocusIn,this,true);m.addListener(b,this._onFocusOut,this,true);m.addListener(c,this._onActivate,this,true);m.addListener(h,this._onDeactivate,this,true);}
,addRoot:function(n){this.__qX[n.$$hash]=n;}
,removeRoot:function(o){delete this.__qX[o.$$hash];}
,getActiveWidget:function(){return this.__qY;}
,isActive:function(p){return this.__qY==p;}
,getFocusedWidget:function(){return this.__ra;}
,isFocused:function(q){return this.__ra==q;}
,isFocusRoot:function(r){return !!this.__qX[r.$$hash];}
,_onActivate:function(e){var t=e.getTarget();this.__qY=t;var s=this.__rc(t);if(s!=this.__rb){this.__rb=s;}
;}
,_onDeactivate:function(e){var u=e.getTarget();if(this.__qY==u){this.__qY=null;}
;}
,_onFocusIn:function(e){var v=e.getTarget();if(v!=this.__ra){this.__ra=v;v.visualizeFocus();}
;}
,_onFocusOut:function(e){var w=e.getTarget();if(w==this.__ra){this.__ra=null;w.visualizeBlur();}
;}
,__ha:function(e){if(e.getKeyIdentifier()!=d){return;}
;if(!this.__rb){return;}
;e.stopPropagation();e.preventDefault();var x=this.__ra;if(!e.isShiftPressed()){var y=x?this.__rg(x):this.__re();}
else {var y=x?this.__rh(x):this.__rf();}
;if(y){y.tabFocus();}
;}
,__rc:function(z){var A=this.__qX;while(z){if(A[z.$$hash]){return z;}
;z=z.getLayoutParent();}
;return null;}
,__rd:function(I,H){if(I===H){return 0;}
...
;return 0;}
,__re:function(){return this.__rk(this.__rb,null);}
,__rf:function(){return this.__rl(this.__rb,null);}
,__rg:function(M){var N=this.__rb;if(N==M){return this.__re();}
;while(M&&M.getAnonymous()){M=M.getLayoutParent();}
;if(M==null){return [];}
;var O=[];this.__ri(N,M,O);O.sort(this.__rd);var P=O.length;return P>0?O[0]:this.__re();}
,__rh:function(Q){var R=this.__rb;if(R==Q){return this.__rf();}
;while(Q&&Q.getAnonymous()){Q=Q.getLayoutParent();}
;if(Q==null){return [];}
;var S=[];this.__rj(R,Q,S);S.sort(this.__rd);var T=S.length;return T>0?S[T-1]:this.__rf();}
,__ri:function(parent,U,V){var X=parent.getLayoutChildren();var W;for(var i=0,l=X.length;i<l;i++ ){W=X[i];if(!(W instanceof qx.ui.core.Widget)){continue;}
;if(!this.isFocusRoot(W)&&W.isEnabled()&&W.isVisible()){if(W.isTabable()&&this.__rd(U,W)<0){V.push(W);}
;this.__ri(W,U,V);}
;}
;}
,__rj:function(parent,Y,ba){var bc=parent.getLayoutChildren();var bb;for(var i=0,l=bc.length;i<l;i++ ){bb=bc[i];if(!(bb instanceof qx.ui.core.Widget)){continue;}
;if(!this.isFocusRoot(bb)&&bb.isEnabled()&&bb.isVisible()){if(bb.isTabable()&&this.__rd(Y,bb)>0){ba.push(bb);}
;this.__rj(bb,Y,ba);}
;}
;}
,__rk:function(parent,bd){var bf=parent.getLayoutChildren();var be;for(var i=0,l=bf.length;i<l;i++ ){be=bf[i];if(!(be instanceof qx.ui.core.Widget)){continue;}
;if(!this.isFocusRoot(be)&&be.isEnabled()&&be.isVisible()){if(be.isTabable()){if(bd==null||this.__rd(be,bd)<0){bd=be;}
;}
;bd=this.__rk(be,bd);}
;}
;return bd;}
,__rl:function(parent,bg){var bi=parent.getLayoutChildren();var bh;for(var i=0,l=bi.length;i<l;i++ ){bh=bi[i];if(!(bh instanceof qx.ui.core.Widget)){continue;}
;if(!this.isFocusRoot(bh)&&bh.isEnabled()&&bh.isVisible()){if(bh.isTabable()){if(bg==null||this.__rd(bh,bg)>0){bg=bh;}
;}
;bg=this.__rl(bh,bg);}
;}
;return bg;}
},destruct:function(){this._disposeMap(g);this.__ra=this.__qY=this.__rb=null;}
});}
)();
(function(){var a="' must be defined!",b="height",c="vAlign",d="hAlign",e="' is not supported by the Grid layout!",f="bottom",g="Invalid parameter 'column'",h="Integer",m="The property '",n="'",o="_applyLayoutChange",p="qx.debug",q="Value must be positive",r="center",s="qx.ui.layout.Grid",t="middle",u="maxHeight",v="Cannot add widget '",w="width",z=") for '",A="'!. ",B="top",C="minHeight",D="right",E="' in this cell (",F=", ",G="The layout properties 'row' and 'column' of the child widget '",H="minWidth",I="flex",J="left",K="maxWidth",L="Invalid parameter 'row'",M="There is already a widget '";qx.Class.define(s,{extend:qx.ui.layout.Abstract,construct:function(O,N){qx.ui.layout.Abstract.call(this);this.__na=[];this.__nb=[];if(O){this.setSpacingX(O);}
;if(N){this.setSpacingY(N);}
;}
,properties:{spacingX:{check:h,init:0,apply:o},spacingY:{check:h,init:0,apply:o}},members:{__nc:null,__na:null,__nb:null,__nd:null,__ne:null,__nf:null,__ng:null,__nh:null,__ni:null,verifyLayoutProperty:qx.core.Environment.select(p,{"true":function(P,name,Q){var R={"row":1,"column":1,"rowSpan":1,"colSpan":1};this.assert(R[name]==1,m+name+e);this.assertInteger(Q);this.assert(Q>=0,q);}
,"false":null}),__nj:function(){var Y=[];var T=[];var W=[];var V=-1;var S=-1;var X=this._getLayoutChildren();for(var i=0,l=X.length;i<l;i++ ){var ba=X[i];var bb=ba.getLayoutProperties();var bc=bb.row;var U=bb.column;bb.colSpan=bb.colSpan||1;bb.rowSpan=bb.rowSpan||1;if(bc==null||U==null){throw new Error(G+ba+a);}
...
;}
;this.__nc=Y;this.__nd=T;this.__ne=W;this.__nf=V;this.__ng=S;this.__nh=null;this.__ni=null;delete this._invalidChildrenCache;}
,_setRowData:function(bg,be,bf){var bd=this.__na[bg];if(!bd){this.__na[bg]={};this.__na[bg][be]=bf;}
else {bd[be]=bf;}
;}
,_setColumnData:function(bh,bj,bk){var bi=this.__nb[bh];if(!bi){this.__nb[bh]={};this.__nb[bh][bj]=bk;}
else {bi[bj]=bk;}
;}
...
,getColumnAlign:function(bp){var bq=this.__nb[bp]||{};return {vAlign:bq.vAlign||B,hAlign:bq.hAlign||J};}
...
,getRowAlign:function(bv){var bu=this.__na[bv]||{};return {vAlign:bu.vAlign||B,hAlign:bu.hAlign||J};}
,getCellWidget:function(bx,bw){if(this._invalidChildrenCache){this.__nj();}
;var bx=this.__nc[bx]||{};return bx[bw]||null;}
,getRowCount:function(){if(this._invalidChildrenCache){this.__nj();}
;return this.__nf+1;}
,getColumnCount:function(){if(this._invalidChildrenCache){this.__nj();}
;return this.__ng+1;}
,getCellAlign:function(bF,bz){var bE=B;var bC=J;var bD=this.__na[bF];var bA=this.__nb[bz];var by=this.__nc[bF][bz];if(by){var bB={vAlign:by.getAlignY(),hAlign:by.getAlignX()};}
else {bB={};}
...
,getColumnFlex:function(bI){var bJ=this.__nb[bI]||{};return bJ.flex!==undefined?bJ.flex:0;}
,setRowFlex:function(bL,bK){this._setRowData(bL,I,bK);this._applyLayoutChange();return this;}
,getRowFlex:function(bO){var bM=this.__na[bO]||{};var bN=bM.flex!==undefined?bM.flex:0;return bN;}
,setColumnMaxWidth:function(bP,bQ){this._setColumnData(bP,K,bQ);this._applyLayoutChange();return this;}
,getColumnMaxWidth:function(bR){var bS=this.__nb[bR]||{};return bS.maxWidth!==undefined?bS.maxWidth:Infinity;}
,setColumnWidth:function(bT,bU){this._setColumnData(bT,w,bU);this._applyLayoutChange();return this;}
,getColumnWidth:function(bV){var bW=this.__nb[bV]||{};return bW.width!==undefined?bW.width:null;}
,setColumnMinWidth:function(bX,bY){this._setColumnData(bX,H,bY);this._applyLayoutChange();return this;}
,getColumnMinWidth:function(ca){var cb=this.__nb[ca]||{};return cb.minWidth||0;}
,setRowMaxHeight:function(cd,cc){this._setRowData(cd,u,cc);this._applyLayoutChange();return this;}
,getRowMaxHeight:function(cf){var ce=this.__na[cf]||{};return ce.maxHeight||Infinity;}
,setRowHeight:function(cg,ch){this._setRowData(cg,b,ch);this._applyLayoutChange();return this;}
,getRowHeight:function(cj){var ci=this.__na[cj]||{};return ci.height!==undefined?ci.height:null;}
,setRowMinHeight:function(cl,ck){this._setRowData(cl,C,ck);this._applyLayoutChange();return this;}
,getRowMinHeight:function(cn){var cm=this.__na[cn]||{};return cm.minHeight||0;}
,__nk:function(cp){var co=cp.getSizeHint();var cr=cp.getMarginLeft()+cp.getMarginRight();var cq=cp.getMarginTop()+cp.getMarginBottom();var cs={height:co.height+cq,width:co.width+cr,minHeight:co.minHeight+cq,minWidth:co.minWidth+cr,maxHeight:co.maxHeight+cq,maxWidth:co.maxWidth+cr};return cs;}
,_fixHeightsRowSpan:function(cN){var cz=this.getSpacingY();for(var i=0,l=this.__ne.length;i<l;i++ ){var cF=this.__ne[i];var cC=this.__nk(cF);var cv=cF.getLayoutProperties();var cB=cv.row;var cK=cz*(cv.rowSpan-1);var ct=cK;var cw={};for(var j=0;j<cv.rowSpan;j++ ){var cA=cv.row+j;var cJ=cN[cA];var cL=this.getRowFlex(cA);if(cL>0){cw[cA]={min:cJ.minHeight,value:cJ.height,max:cJ.maxHeight,flex:cL};}
...
;}
;}
,_fixWidthsColSpan:function(cR){var cS=this.getSpacingX();for(var i=0,l=this.__nd.length;i<l;i++ ){var cO=this.__nd[i];var cQ=this.__nk(cO);var cU=cO.getLayoutProperties();var cP=cU.column;var db=cS*(cU.colSpan-1);var cT=db;var cV={};var cX;for(var j=0;j<cU.colSpan;j++ ){var cW=cU.column+j;var da=cR[cW];var cY=this.getColumnFlex(cW);if(cY>0){cV[cW]={min:da.minWidth,value:da.width,max:da.maxWidth,flex:cY};}
...
;}
;}
,_getRowHeights:function(){if(this.__nh!=null){return this.__nh;}
;var dm=[];var df=this.__nf;var de=this.__ng;for(var dn=0;dn<=df;dn++ ){var dg=0;var di=0;var dh=0;for(var dl=0;dl<=de;dl++ ){var dd=this.__nc[dn][dl];if(!dd){continue;}
;var dj=dd.getLayoutProperties().rowSpan||0;if(dj>1){continue;}
;var dk=this.__nk(dd);if(this.getRowFlex(dn)>0){dg=Math.max(dg,dk.minHeight);}
...
;if(this.__ne.length>0){this._fixHeightsRowSpan(dm);}
;this.__nh=dm;return dm;}
,_getColWidths:function(){if(this.__ni!=null){return this.__ni;}
;var dt=[];var dq=this.__ng;var ds=this.__nf;for(var dy=0;dy<=dq;dy++ ){var dw=0;var dv=0;var dr=Infinity;for(var dz=0;dz<=ds;dz++ ){var dp=this.__nc[dz][dy];if(!dp){continue;}
;var du=dp.getLayoutProperties().colSpan||0;if(du>1){continue;}
;var dx=this.__nk(dp);if(this.getColumnFlex(dy)>0){dv=Math.max(dv,dx.minWidth);}
...
;if(this.__nd.length>0){this._fixWidthsColSpan(dt);}
;this.__ni=dt;return dt;}
...
,renderLayout:function(ej,dO,ei){if(this._invalidChildrenCache){this.__nj();}
;var ed=qx.ui.layout.Util;var dQ=this.getSpacingX();var dW=this.getSpacingY();var eh=this._getColWidths();var ek=this._getColumnFlexOffsets(ej);var dR=[];var em=this.__ng;var dP=this.__nf;var el;for(var en=0;en<=em;en++ ){el=ek[en]?ek[en].offset:0;dR[en]=eh[en].width+el;}
...
;var er=0;for(var en=0;en<=em;en++ ){var top=0;for(var dX=0;dX<=dP;dX++ ){var ef=this.__nc[dX][en];if(!ef){top+=et[dX]+dW;continue;}
...
;er+=dR[en]+dQ;}
;}
,invalidateLayoutCache:function(){qx.ui.layout.Abstract.prototype.invalidateLayoutCache.call(this);this.__ni=null;this.__nh=null;}
,_computeSizeHint:function(){if(this._invalidChildrenCache){this.__nj();}
...
},destruct:function(){this.__nc=this.__na=this.__nb=this.__nd=this.__ne=this.__ni=this.__nh=null;}
});}
)();
(function(){var a="toolTipText",b="icon",c="label",d="qx.ui.core.MExecutable",f="value",g="qx.event.type.Event",h="execute",j="_applyCommand",k="enabled",l="menu",m="changeCommand",n="qx.ui.core.Command";qx.Mixin.define(d,{events:{"execute":g},properties:{command:{check:n,apply:j,event:m,nullable:true}},members:{__mG:null,__mH:false,__mI:null,_bindableProperties:[k,c,b,a,f,l],execute:function(){var o=this.getCommand();if(o){if(this.__mH){this.__mH=false;}
else {this.__mH=true;o.execute(this);}
;}
;this.fireEvent(h);}
,__mJ:function(e){if(this.__mH){this.__mH=false;return;}
;this.__mH=true;this.execute();}
,_applyCommand:function(r,p){if(p!=null){p.removeListenerById(this.__mI);}
;if(r!=null){this.__mI=r.addListener(h,this.__mJ,this);}
;var q=this.__mG;if(q==null){this.__mG=q={};}
...
;}
;}
},destruct:function(){this._applyCommand(null,this.getCommand());this.__mG=null;}
});}
)();
...
(function(){var a="_applyBlockerColor",b="Number",c="qx.debug",d="Please use 'isBlocked' instead.",e="Please use 'forceUnblock' instead.",f="__la",g="qx.ui.core.MBlocker",h="_applyBlockerOpacity",i="Please use 'unblock' instead.",j="Color";qx.Mixin.define(g,{construct:function(){this.__la=this._createBlocker();}
,properties:{blockerColor:{check:j,init:null,nullable:true,apply:a,themeable:true},blockerOpacity:{check:b,init:1,apply:h,themeable:true}},members:{__la:null,_createBlocker:function(){return new qx.ui.core.Blocker(this);}
,_applyBlockerColor:function(l,k){this.__la.setColor(l);}
,_applyBlockerOpacity:function(n,m){this.__la.setOpacity(n);}
,block:function(){this.__la.block();}
,isBlocked:function(){return this.__la.isBlocked();}
,unblock:function(){this.__la.unblock();}
,forceUnblock:function(){this.__la.forceUnblock();}
,blockContent:function(o){this.__la.blockContent(o);}
,isContentBlocked:function(){if(qx.core.Environment.get(c)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,d);}
;return this.__la.isBlocked();}
,unblockContent:function(){if(qx.core.Environment.get(c)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,i);}
;this.__la.unblock();}
,forceUnblockContent:function(){if(qx.core.Environment.get(c)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,e);}
;this.__la.forceUnblock();}
,getBlocker:function(){return this.__la;}
},destruct:function(){this._disposeObjects(f);}
});}
)();
(function(){var a="qx.dyntheme",b="backgroundColor",c="_applyOpacity",d="Boolean",f="px",g="keydown",h="deactivate",j="changeTheme",k="opacity",l="qx.debug",m="Please use 'isBlocked' instead.",n="Tab",o="qx.event.type.Event",p="move",q="Please use 'getBlockerElement' instead.",r="Please use 'unblock' instead.",s="Color",t="resize",u="zIndex",v="__la",w="Please use 'forceUnblock' instead.",x="appear",y="qx.ui.root.Abstract",z="keyup",A="keypress",B="Number",C="unblocked",D="qx.ui.core.Blocker",E="disappear",F="blocked",G="__ik",H="_applyColor";qx.Class.define(D,{extend:qx.core.Object,events:{blocked:o,unblocked:o},construct:function(I){qx.core.Object.call(this);this._widget=I;I.addListener(t,this.__lf,this);I.addListener(p,this.__lf,this);I.addListener(E,this.__lh,this);if(qx.Class.isDefined(y)&&I instanceof qx.ui.root.Abstract){this._isRoot=true;this.setKeepBlockerActive(true);}
;if(qx.core.Environment.get(a)){qx.theme.manager.Color.getInstance().addListener(j,this._onChangeTheme,this);}
;this.__lb=[];this.__lc=[];}
,properties:{color:{check:s,init:null,nullable:true,apply:H,themeable:true},opacity:{check:B,init:1,apply:c,themeable:true},keepBlockerActive:{check:d,init:false}},members:{__la:null,__ld:0,__lb:null,__lc:null,__ik:null,_widget:null,_isRoot:false,__le:null,__lf:function(e){var J=e.getData();if(this.isBlocked()){this._updateBlockerBounds(J);}
;}
,__lg:function(){this._updateBlockerBounds(this._widget.getBounds());if(this._widget.isRootWidget()){this._widget.getContentElement().add(this.getBlockerElement());}
else {this._widget.getLayoutParent().getContentElement().add(this.getBlockerElement());}
;}
,__lh:function(){if(this.isBlocked()){this.getBlockerElement().getParent().remove(this.getBlockerElement());this._widget.addListenerOnce(x,this.__lg,this);}
;}
...
,_applyColor:function(N,M){var L=qx.theme.manager.Color.getInstance().resolve(N);this.__li(b,L);}
,_applyOpacity:function(P,O){this.__li(k,P);}
,_onChangeTheme:qx.core.Environment.select(a,{"true":function(){this._applyColor(this.getColor());}
,"false":null}),__li:function(R,S){var Q=[];this.__la&&Q.push(this.__la);for(var i=0;i<Q.length;i++ ){Q[i].setStyle(R,S);}
;}
,_backupActiveWidget:function(){var T=qx.event.Registration.getManager(window).getHandler(qx.event.handler.Focus);this.__lb.push(T.getActive());this.__lc.push(T.getFocus());if(this._widget.isFocusable()){this._widget.focus();}
;}
,_restoreActiveWidget:function(){var W=this.__lb.length;if(W>0){var V=this.__lb[W-1];if(V){qx.bom.Element.activate(V);}
;this.__lb.pop();}
;var U=this.__lc.length;if(U>0){var V=this.__lc[U-1];if(V){qx.bom.Element.focus(this.__lc[U-1]);}
;this.__lc.pop();}
;}
,__lj:function(){return new qx.html.Blocker(this.getColor(),this.getOpacity());}
,getBlockerElement:function(X){if(!this.__la){this.__la=this.__lj();this.__la.setStyle(u,15);if(!X){if(this._isRoot){X=this._widget;}
else {X=this._widget.getLayoutParent();}
;}
;X.getContentElement().add(this.__la);this.__la.exclude();}
;return this.__la;}
,block:function(){this._block();}
,_block:function(Y,bb){if(!this._isRoot&&!this._widget.getLayoutParent()){this.__le=this._widget.addListenerOnce(x,this._block.bind(this,Y));return;}
;var parent;if(this._isRoot||bb){parent=this._widget;}
else {parent=this._widget.getLayoutParent();}
;var ba=this.getBlockerElement(parent);if(Y!=null){ba.setStyle(u,Y);}
;this.__ld++ ;if(this.__ld<2){this._backupActiveWidget();var bc=this._widget.getBounds();if(bc){this._updateBlockerBounds(bc);}
;ba.include();if(!bb){ba.activate();}
;ba.addListener(h,this.__lm,this);ba.addListener(A,this.__ll,this);ba.addListener(g,this.__ll,this);ba.addListener(z,this.__ll,this);this.fireEvent(F,qx.event.type.Event);}
;}
,isBlocked:function(){return this.__ld>0;}
,unblock:function(){if(this.__le){this._widget.removeListenerById(this.__le);}
;if(!this.isBlocked()){return;}
;this.__ld-- ;if(this.__ld<1){this.__lk();this.__ld=0;}
;}
,forceUnblock:function(){if(!this.isBlocked()){return;}
;this.__ld=0;this.__lk();}
,__lk:function(){this._restoreActiveWidget();var bd=this.getBlockerElement();bd.removeListener(h,this.__lm,this);bd.removeListener(A,this.__ll,this);bd.removeListener(g,this.__ll,this);bd.removeListener(z,this.__ll,this);bd.exclude();this.fireEvent(C,qx.event.type.Event);}
,getContentBlockerElement:function(){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,q);}
;return this.getBlockerElement();}
,blockContent:function(be){this._block(be,true);}
,isContentBlocked:function(){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,m);}
;return this.isBlocked();}
,unblockContent:function(){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,r);}
;this.unblock();}
,forceUnblockContent:function(){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,w);}
;this.forceUnblock();}
,__ll:function(e){if(e.getKeyIdentifier()==n){e.stop();}
;}
,__lm:function(){if(this.getKeepBlockerActive()){this.getBlockerElement().activate();}
;}
...
;this._widget.removeListener(t,this.__lf,this);this._widget.removeListener(p,this.__lf,this);this._widget.removeListener(x,this.__lg,this);this._widget.removeListener(E,this.__lh,this);if(this.__le){this._widget.removeListenerById(this.__le);}
;this._disposeObjects(v,G);this.__lb=this.__lc=this._widget=null;}
});}
)();
...
;qx.html.Element.call(this,q,x);this.addListener(f,this._stopPropagation,this);this.addListener(o,this._stopPropagation,this);this.addListener(s,this._stopPropagation,this);this.addListener(a,this._stopPropagation,this);this.addListener(p,this._stopPropagation,this);this.addListener(l,this._stopPropagation,this);this.addListener(m,this._stopPropagation,this);this.addListener(j,this._stopPropagation,this);this.addListener(r,this._stopPropagation,this);this.addListener(h,this.__ln,this);this.addListener(g,this.__ln,this);}
,members:{_stopPropagation:function(e){e.stopPropagation();}
,__ln:function(){var z=this.getStyle(u);this.setStyle(u,null,true);this.setStyle(u,z,true);}
}});}
)();
(function(){var a="changeGlobalCursor",b="engine.name",c="keypress",d="Boolean",f="root",g="help",h="",i="contextmenu",j=" !important",k="input",l="_applyGlobalCursor",m="Space",n="_applyNativeHelp",o=";",p="event.help",q="qx.ui.root.Abstract",r="abstract",s="textarea",t="String",u="*";qx.Class.define(q,{type:r,extend:qx.ui.core.Widget,include:[qx.ui.core.MChildrenHandling,qx.ui.core.MBlocker,qx.ui.window.MDesktop],construct:function(){qx.ui.core.Widget.call(this);qx.ui.core.FocusHandler.getInstance().addRoot(this);qx.ui.core.queue.Visibility.add(this);this.initNativeHelp();this.addListener(c,this.__sI,this);}
,properties:{appearance:{refine:true,init:f},enabled:{refine:true,init:true},focusable:{refine:true,init:true},globalCursor:{check:t,nullable:true,themeable:true,apply:l,event:a},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:d,init:false,apply:n}},members:{__sH:null,isRootWidget:function(){return true;}
,getLayout:function(){return this._getLayout();}
,_applyGlobalCursor:qx.core.Environment.select(b,{"mshtml":function(w,v){}
,"default":function(A,z){var y=qx.bom.Stylesheet;var x=this.__sH;if(!x){this.__sH=x=y.createElement();}
...
;e.preventDefault();}
,__sI:function(e){if(e.getKeyIdentifier()!==m){return;}
...
(function(){var a="resize",b="rgba(0,0,0,0)",c="paddingLeft",d="WebkitTapHighlightColor",f="qx.emulatemouse",g="engine.name",h="webkit",i="0px",j="-webkit-backface-visibility",k="The application could not be started due to a missing body tag in the HTML file!",l="$$widget",m="qx.ui.root.Application",n="event.touch",o="div",p="paddingTop",q="hidden",r="The root widget does not support 'left', or 'top' paddings!",s="100%",t="absolute";qx.Class.define(m,{extend:qx.ui.root.Abstract,construct:function(u){this.__cx=qx.dom.Node.getWindow(u);this.__sJ=u;if(qx.core.Environment.get(n)&&qx.core.Environment.get(f)){if(u.body){u.body.style[d]=b;}
;}
;qx.ui.root.Abstract.call(this);qx.event.Registration.addListener(this.__cx,a,this._onResize,this);this._setLayout(new qx.ui.layout.Canvas());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);this.getContentElement().disableScrolling();this.getContentElement().setStyle(j,q);}
,members:{__cx:null,__sJ:null,_createContentElement:function(){var v=this.__sJ;if((qx.core.Environment.get(g)==h)){if(!v.body){alert(k);}
;}
...
;}
,_computeSizeHint:function(){var A=qx.bom.Viewport.getWidth(this.__cx);var B=qx.bom.Viewport.getHeight(this.__cx);return {minWidth:A,width:A,maxWidth:A,minHeight:B,height:B,maxHeight:B};}
...
},destruct:function(){this.__cx=this.__sJ=null;}
});}
)();
...
(function(){var c="icon/16/devices/",d="printer",f="firstname",g=".png",h="media-optical",j="computer",k="Simple",l="Filtered",m="json/persons.json",n="camera-photo",o="Empty Item",p="network-wired",q="selection[0]",r="change",s="toolTipText",t="icon",u="Random Value ",v="Grouped with Persons",w="drive-harddisk",x="model.persons",y="Sorted",z="audio-card",A="",B="network-wireless",C="Change selection: ",D="drive-optical",E="camera-web",F="media-flash",G="input-mouse",H="Option ",I="pda",J="battery",K="model",L="label",M="audio-input-microphone",N="no model...",O="With icons",P="demobrowser.demo.virtual.SelectBox",Q="phone",R="input-keyboard",S=" ",T="multimedia-player",U="Item ",V="Long text",W="display";qx.Class.define(P,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var ba=new qx.ui.container.Scroll();var X=new qx.ui.container.Composite(new qx.ui.layout.Canvas());ba.add(X,{edge:0});var bb=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));bb.setPadding(20);var Y=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));Y.setPadding(20);bb.add(this.createBox1());bb.add(this.createBox2());bb.add(this.createBox3());bb.add(this.createBox4());Y.add(this.createBox5());Y.add(this.createBox6());Y.add(this.createBox7());X.add(bb,{left:20,top:20});X.add(Y,{left:20,top:200});this.getRoot().add(ba,{edge:0});}
,createBox1:function(){var bd=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));bd.add(new qx.ui.basic.Label(k));var bc=new qx.data.Array();for(var i=0;i<300;i++ ){bc.push(U+(i+1));}
;var be=new qx.ui.form.VirtualSelectBox(bc);bd.add(be);be.getSelection().push(bc.getItem(5));be.getSelection().addListener(r,function(e){this.debug(C,be.getSelection().getItem(0));}
);return bd;}
,createBox2:function(){var bh=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));bh.add(new qx.ui.basic.Label(V));var bf=new qx.data.Array();for(var i=0;i<300;i++ ){bf.push(u+Math.round(Math.random()*100000000));}
;var bg=new qx.ui.form.VirtualSelectBox(bf);bh.add(bg);bg.bind(q,bg,s,null);var bi={bindItem:function(bk,bj,bl){bk.bindDefaultProperties(bj,bl);bk.bindProperty(A,s,null,bj,bl);}
};bg.setDelegate(bi);return bh;}
,createBox3:function(){var bn=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));bn.add(new qx.ui.basic.Label(O));var bo=[z,M,J,n,E,j,W,w,D,R,G,F,h,T,p,B,I,Q,d];var bs=c;var bp=g;var bq=[];for(var i=0;i<bo.length;i++ ){bq.push({label:bo[i],icon:bs+bo[i]+bp});}
;var br=qx.data.marshal.Json.createModel(bq);var bm=new qx.ui.form.VirtualSelectBox(br).set({labelPath:L,iconPath:t});bn.add(bm);return bn;}
,createBox4:function(){var bu=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));bu.add(new qx.ui.basic.Label(o));var bt=new qx.data.Array();bt.push(A);for(var i=0;i<300;i++ ){bt.push(H+(i+1));}
;var bv=new qx.ui.form.VirtualSelectBox(bt);bu.add(bv);return bu;}
,createBox5:function(){var by=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));by.add(new qx.ui.basic.Label(y));var bw=new qx.data.Array();for(var i=0;i<300;i++ ){bw.push(U+i);}
;var bx=new qx.ui.form.VirtualSelectBox(bw);by.add(bx);var bz={sorter:function(a,b){return a<b?1:a>b?-1:0;}
};bx.setDelegate(bz);return by;}
,createBox6:function(){var bC=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));bC.add(new qx.ui.basic.Label(l));var bA=new qx.data.Array();for(var i=0;i<300;i++ ){bA.push(U+i);}
;var bB=new qx.ui.form.VirtualSelectBox(bA);bC.add(bB);var bD={filter:function(bE){return ((parseInt(bE.slice(5,bE.length),10))%2==1);}
};bB.setDelegate(bD);return bC;}
,createBox7:function(){var bH=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));bH.add(new qx.ui.basic.Label(v));var bG=new qx.ui.form.VirtualSelectBox();bG.setLabelPath(f);bG.setLabelOptions({converter:function(bL,bK){return bK?bL+S+bK.getLastname():N;}
});bH.add(bG);var bF=m;var bJ=new qx.data.store.Json(bF);bJ.bind(x,bG,K);var bI={sorter:function(a,b){a=a.getFirstname();b=b.getFirstname();return a>b?1:a<b?-1:0;}
,group:function(bM){return bM.getFirstname().charAt(0).toUpperCase();}
};bG.setDelegate(bI);return bH;}
}});}
)();
...
(function(){var a="mousedown",b="qx.ui.core.scroll.NativeScrollBar",c="px",d="PositiveNumber",f="frame",g="end",h="box-sizing",i="Integer",j="mousemove",k="_applyMaximum",l="vertical",m="_applyOrientation",n="scrollAnimationEnd",o="appear",p="content-box",q="PositiveInteger",r='qx.event.type.Event',s="mshtml",t="engine.name",u="mouseup",v="horizontal",w="__mW",x="Number",y="_applyPosition",z="scrollbar",A="hidden",B="native",C="scroll";qx.Class.define(b,{extend:qx.ui.core.Widget,implement:qx.ui.core.scroll.IScrollBar,construct:function(D){qx.ui.core.Widget.call(this);this.addState(B);this.getContentElement().addListener(C,this._onScroll,this);this.addListener(a,this._stopPropagation,this);this.addListener(u,this._stopPropagation,this);this.addListener(j,this._stopPropagation,this);this.addListener(o,this._onAppear,this);this.getContentElement().add(this._getScrollPaneElement());this.getContentElement().setStyle(h,p);if(D!=null){this.setOrientation(D);}
else {this.initOrientation();}
;}
,events:{scrollAnimationEnd:r},properties:{appearance:{refine:true,init:z},orientation:{check:[v,l],init:v,apply:m},maximum:{check:q,apply:k,init:100},position:{check:x,init:0,apply:y,event:C},singleStep:{check:i,init:20},knobFactor:{check:d,nullable:true}},members:{__mV:null,__mW:null,__mX:null,__mY:null,_getScrollPaneElement:function(){if(!this.__mW){this.__mW=new qx.html.Element();}
;return this.__mW;}
...
,_getContentHint:function(){var I=qx.bom.element.Scroll.getScrollbarWidth();return {width:this.__mV?100:I,maxWidth:this.__mV?null:I,minWidth:this.__mV?null:I,height:this.__mV?I:100,maxHeight:this.__mV?I:null,minHeight:this.__mV?I:null};}
...
,_applyPosition:function(M){var content=this.getContentElement();if(this.__mV){content.scrollToX(M);}
else {content.scrollToY(M);}
;}
,_applyOrientation:function(P,N){var O=this.__mV=P===v;this.set({allowGrowX:O,allowShrinkX:O,allowGrowY:!O,allowShrinkY:!O});if(O){this.replaceState(l,v);}
else {this.replaceState(v,l);}
;this.getContentElement().setStyles({overflowX:O?C:A,overflowY:O?A:C});qx.ui.core.queue.Layout.add(this);}
,_updateScrollBar:function(){var R=this.__mV;var S=this.getBounds();if(!S){return;}
;if(this.isEnabled()){var T=R?S.width:S.height;var Q=this.getMaximum()+T;}
else {Q=0;}
;if(qx.core.Environment.get(t)==s){var S=this.getBounds();this.getContentElement().setStyles({left:(R?S.left:(S.left-1))+c,top:(R?(S.top-1):S.top)+c,width:(R?S.width:S.width+1)+c,height:(R?S.height+1:S.height)+c});}
;this._getScrollPaneElement().setStyles({left:0,top:0,width:(R?Q:1)+c,height:(R?1:Q)+c});this.updatePosition(this.getPosition());}
,scrollTo:function(V,U){this.stopScrollAnimation();if(U){var W=this.getPosition();this.__mY=new qx.bom.AnimationFrame();this.__mY.on(f,function(Y){var X=parseInt(Y/U*(V-W)+W);this.updatePosition(X);}
,this);this.__mY.on(g,function(){this.setPosition(Math.max(0,Math.min(this.getMaximum(),V)));this.__mY=null;this.fireEvent(n);}
,this);this.__mY.startSequence(U);}
...
;}
,_onScroll:function(e){var bg=this.getContentElement();var bh=this.__mV?bg.getScrollX():bg.getScrollY();this.setPosition(bh);}
...
;}
,events:{"scrollAnimationEnd":k},properties:{appearance:{refine:true,init:z},orientation:{check:[w,q],init:w,apply:r},maximum:{check:v,apply:A,init:100},position:{check:h,init:0,apply:y,event:E},singleStep:{check:f,init:20},pageStep:{check:f,init:10,apply:t},knobFactor:{check:c,apply:i,nullable:true}},members:{__AF:2,__AG:0,_computeSizeHint:function(){var G=qx.ui.core.Widget.prototype._computeSizeHint.call(this);if(this.getOrientation()===w){this.__AG=G.minWidth;G.minWidth=0;}
else {this.__AG=G.minHeight;G.minHeight=0;}
;return G;}
,renderLayout:function(L,top,I,H){var K=qx.ui.core.Widget.prototype.renderLayout.call(this,L,top,I,H);var J=this.getOrientation()===w;if(this.__AG>=(J?I:H)){this.getChildControl(m).setVisibility(n);this.getChildControl(C).setVisibility(n);}
...
,_onResizeSlider:function(e){var bf=this.getChildControl(a).getChildControl(l);var bi=bf.getSizeHint();var bg=false;var bh=this.getChildControl(a).getInnerSize();if(this.getOrientation()==q){if(bh.height<bi.minHeight+this.__AF){bg=true;}
;}
else {if(bh.width<bi.minWidth+this.__AF){bg=true;}
;}
;if(bg){bf.exclude();}
else {bf.show();}
;}
...
(function(){var a="",b="qx.ui.form.MForm",c="Boolean",d="_applyValid",f="changeLocale",g="changeRequired",h="changeValid",i="qx.dynlocale",j="changeInvalidMessage",k="String",l="invalid";qx.Mixin.define(b,{construct:function(){if(qx.core.Environment.get(i)){qx.locale.Manager.getInstance().addListener(f,this.__lM,this);}
;}
...
,__lM:qx.core.Environment.select(i,{"true":function(e){var o=this.getInvalidMessage();if(o&&o.translate){this.setInvalidMessage(o.translate());}
;var p=this.getRequiredInvalidMessage();if(p&&p.translate){this.setRequiredInvalidMessage(p.translate());}
;}
,"false":null})},destruct:function(){if(qx.core.Environment.get(i)){qx.locale.Manager.getInstance().removeListener(f,this.__lM,this);}
;}
});}
)();
...
,_onMouseDown:function(e){if(this.__AK){return;}
;var bu=this.__mV;var bs=this.getChildControl(R);var bt=bu?H:N;var by=bu?e.getDocumentLeft():e.getDocumentTop();var bA=this.getDecorator();bA=qx.theme.manager.Decoration.getInstance().resolve(bA);if(bu){var bx=bA?bA.getInsets().left:0;var bw=(this.getPaddingLeft()||0)+bx;}
else {var bx=bA?bA.getInsets().top:0;var bw=(this.getPaddingTop()||0)+bx;}
;var bz=this.__AH=qx.bom.element.Location.get(this.getContentElement().getDomElement())[bt];bz+=bw;var bv=this.__AI=qx.bom.element.Location.get(bs.getContentElement().getDomElement())[bt];if(e.getTarget()===bs){this.__AK=true;if(!this.__AP){this.__AP=new qx.event.Timer(100);this.__AP.addListener(v,this._fireValue,this);}
;this.__AP.start();this.__AL=by+bz-bv;bs.addState(d);}
else {this.__AM=true;this.__AN=by<=bv?-1:1;this.__AT(e);this._onInterval();if(!this.__ik){this.__ik=new qx.event.Timer(100);this.__ik.addListener(v,this._onInterval,this);}
;this.__ik.start();}
;this.addListener(z,this._onMouseMove);this.capture();e.stopPropagation();}
,_onMouseUp:function(e){if(this.__AK){this.releaseCapture();delete this.__AK;this.__AP.stop();this._fireValue();delete this.__AL;this.getChildControl(R).removeState(d);if(e.getType()===U){var bC;var bD;var bB;if(this.__mV){bC=e.getDocumentLeft()-(this._valueToPosition(this.getValue())+this.__AH);bB=qx.bom.element.Location.get(this.getContentElement().getDomElement())[N];bD=e.getDocumentTop()-(bB+this.getChildControl(R).getBounds().top);}
else {bC=e.getDocumentTop()-(this._valueToPosition(this.getValue())+this.__AH);bB=qx.bom.element.Location.get(this.getContentElement().getDomElement())[H];bD=e.getDocumentLeft()-(bB+this.getChildControl(R).getBounds().left);}
;if(bD<0||bD>this.__AJ||bC<0||bC>this.__AJ){this.getChildControl(R).removeState(b);}
;}
;}
else if(this.__AM){this.__ik.stop();this.releaseCapture();delete this.__AM;delete this.__AN;delete this.__AO;}
;this.removeListener(z,this._onMouseMove);if(e.getType()===U){e.stopPropagation();}
;}
,_onMouseMove:function(e){if(this.__AK){var bF=this.__mV?e.getDocumentLeft():e.getDocumentTop();var bE=bF-this.__AL;this.slideTo(this._positionToValue(bE));}
else if(this.__AM){this.__AT(e);}
;e.stopPropagation();}
,_onInterval:function(e){var bG=this.getValue()+(this.__AN*this.getPageStep());if(bG<this.getMinimum()){bG=this.getMinimum();}
else if(bG>this.getMaximum()){bG=this.getMaximum();}
;var bH=this.__AN==-1;if((bH&&bG<=this.__AO)||(!bH&&bG>=this.__AO)){bG=this.__AO;}
;this.slideTo(bG);}
,_onUpdate:function(e){var bJ=this.getInnerSize();var bK=this.getChildControl(R).getBounds();var bI=this.__mV?F:A;this._updateKnobSize();this.__AS=bJ[bI]-bK[bI];this.__AJ=bK[bI];this._updateKnobPosition();}
,__mV:false,__AS:0,__AT:function(e){var bL=this.__mV;var bS=bL?e.getDocumentLeft():e.getDocumentTop();var bV=this.__AH;var bM=this.__AI;var bW=this.__AJ;var bT=bS-bV;if(bS>=bM){bT-=bW;}
;var bP=this._positionToValue(bT);var bN=this.getMinimum();var bO=this.getMaximum();if(bP<bN){bP=bN;}
else if(bP>bO){bP=bO;}
else {var bU=this.getValue();var bR=this.getPageStep();var bQ=this.__AN<0?K:S;bP=bU+(Math[bQ]((bP-bU)/bR)*bR);}
;if(this.__AO==null||(this.__AN==-1&&bP<=this.__AO)||(this.__AN==1&&bP>=this.__AO)){this.__AO=bP;}
;}
,_positionToValue:function(bY){var bX=this.__AS;if(bX==null||bX==0){return 0;}
;var cb=bY/bX;if(cb<0){cb=0;}
else if(cb>1){cb=1;}
;var ca=this.getMaximum()-this.getMinimum();return this.getMinimum()+Math.round(ca*cb);}
,_valueToPosition:function(cf){var cc=this.__AS;if(cc==null){return 0;}
...
,_setKnobPosition:function(ci){var cg=this.getChildControl(R);var ch=this.getDecorator();ch=qx.theme.manager.Decoration.getInstance().resolve(ch);var content=cg.getContentElement();if(this.__mV){if(ch&&ch.getPadding()){ci+=ch.getPadding().left;}
...
;if(this.__mV){this.getChildControl(R).setWidth(Math.round(ck*cj.width));}
...
,slideTo:function(cs,cr){this.stopSlideAnimation();if(cr){this.__AV(cs,cr);}
else {this.updatePosition(cs);}
;}
,updatePosition:function(ct){this.setValue(this.__AU(ct));}
,stopSlideAnimation:function(){if(this.__mY){this.__mY.cancelSequence();this.__mY=null;}
;}
,__AU:function(cu){if(cu<this.getMinimum()){cu=this.getMinimum();}
...
;return cu;}
,__AV:function(cw,cv){cw=this.__AU(cw);var cx=this.getValue();this.__mY=new qx.bom.AnimationFrame();this.__mY.on(j,function(cy){this.setValue(parseInt(cy/cv*(cw-cx)+cx));}
,this);this.__mY.on(l,function(){this.setValue(cw);this.__mY=null;this.fireEvent(Q);}
,this);this.__mY.startSequence(cv);}
,_applyOrientation:function(cB,cA){var cz=this.getChildControl(R);this.__mV=cB===V;if(this.__mV){this.removeState(D);cz.removeState(D);this.addState(V);cz.addState(V);cz.setLayoutProperties({top:0,right:null,bottom:0});}
...
else {if(this.__mV){this.getChildControl(R).resetWidth();}
else {this.getChildControl(R).resetHeight();}
;}
;}
,_applyValue:function(cF,cE){if(cF!=null){this._updateKnobPosition();if(this.__AK){this.__AR=[cF,cE];}
else {this.fireEvent(h,qx.event.type.Data,[cF,cE]);}
;}
else {this.resetValue();}
;}
,_fireValue:function(){if(!this.__AR){return;}
;var cG=this.__AR;this.__AR=null;this.fireEvent(h,qx.event.type.Data,cG);}
...
(function(){var a="press",b="hovered",c="qx.ui.form.RepeatButton",d="release",f="Enter",g="pressed",h="interval",i="qx.event.type.Event",j="Space",k="abandoned",l="__ik",m="Integer",n="execute";qx.Class.define(c,{extend:qx.ui.form.Button,construct:function(o,p){qx.ui.form.Button.call(this,o,p);this.__ik=new qx.event.AcceleratingTimer();this.__ik.addListener(h,this._onInterval,this);}
,events:{"execute":i,"press":i,"release":i},properties:{interval:{check:m,init:100},firstInterval:{check:m,init:500},minTimer:{check:m,init:20},timerDecrease:{check:m,init:2}},members:{__oz:null,__ik:null,press:function(){if(this.isEnabled()){if(!this.hasState(g)){this.__oA();}
;this.removeState(k);this.addState(g);}
;}
,release:function(q){if(!this.isEnabled()){return;}
;if(this.hasState(g)){if(!this.__oz){this.execute();}
;}
;this.removeState(g);this.removeState(k);this.__oB();}
,_applyEnabled:function(s,r){qx.ui.form.Button.prototype._applyEnabled.call(this,s,r);if(!s){this.removeState(g);this.removeState(k);this.__oB();}
;}
,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;if(this.hasState(k)){this.removeState(k);this.addState(g);this.__ik.start();}
;this.addState(b);}
,_onMouseOut:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.removeState(b);if(this.hasState(g)){this.removeState(g);this.addState(k);this.__ik.stop();}
;}
,_onMouseDown:function(e){if(!e.isLeftPressed()){return;}
;this.capture();this.__oA();e.stopPropagation();}
,_onMouseUp:function(e){this.releaseCapture();if(!this.hasState(k)){this.addState(b);if(this.hasState(g)&&!this.__oz){this.execute();}
;}
;this.__oB();e.stopPropagation();}
,_onKeyUp:function(e){switch(e.getKeyIdentifier()){case f:case j:if(this.hasState(g)){if(!this.__oz){this.execute();}
;this.removeState(g);this.removeState(k);e.stopPropagation();this.__oB();}
;};}
,_onKeyDown:function(e){switch(e.getKeyIdentifier()){case f:case j:this.removeState(k);this.addState(g);e.stopPropagation();this.__oA();};}
,_onInterval:function(e){this.__oz=true;this.fireEvent(n);}
,__oA:function(){this.fireEvent(a);this.__oz=false;this.__ik.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();this.removeState(k);this.addState(g);}
,__oB:function(){this.fireEvent(d);this.__ik.stop();this.removeState(k);this.removeState(g);}
},destruct:function(){this._disposeObjects(l);}
});}
)();
(function(){var a="Integer",b="__ik",c="interval",d="qx.event.type.Event",e="qx.event.AcceleratingTimer";qx.Class.define(e,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__ik=new qx.event.Timer(this.getInterval());this.__ik.addListener(c,this._onInterval,this);}
,events:{"interval":d},properties:{interval:{check:a,init:100},firstInterval:{check:a,init:500},minimum:{check:a,init:20},decrease:{check:a,init:2}},members:{__ik:null,__oC:null,start:function(){this.__ik.setInterval(this.getFirstInterval());this.__ik.start();}
,stop:function(){this.__ik.stop();this.__oC=null;}
,_onInterval:function(){this.__ik.stop();if(this.__oC==null){this.__oC=this.getInterval();}
;this.__oC=Math.max(this.getMinimum(),this.__oC-this.getDecrease());this.__ik.setInterval(this.__oC);this.__ik.start();this.fireEvent(c);}
...
;this.__cO[bn]=e[m+bj]();bl.scrollBy(bm);if(this.__gA[bn]){clearTimeout(this.__gA[bn]);this.__gA[bn]=null;}
;this.__gA[bn]=setTimeout(qx.lang.Function.bind(function(bo){this.__gD(bo,bn);}
,this,bm),100);}
;}
,__gD:function(bp,br){this.__gA[br]=null;var bs=this._isChildControlVisible(n+br);if(bp==0||!bs){return;}
;if(bp>0){bp=Math.max(0,bp-3);}
else {bp=Math.min(0,bp+3);}
;this.__gA[br]=setTimeout(qx.lang.Function.bind(function(bu,bt){this.__gD(bu,bt);}
...
,events:{update:m,scrollAnimationEnd:m},properties:{scrollX:{check:j,apply:g,event:f,init:0},scrollY:{check:l,apply:h,event:b,init:0}},members:{__mM:null,add:function(r){var s=this._getChildren()[0];if(s){this._remove(s);s.removeListener(a,this._onUpdate,this);}
...
;this.stopScrollAnimation();if(L){var N=this.getScrollX();this.__mM=new qx.bom.AnimationFrame();this.__mM.on(o,function(){this.setScrollX(O);this.__mM=null;this.fireEvent(c);}
,this);this.__mM.on(i,function(Q){var P=parseInt(Q/L*(O-N)+N);this.setScrollX(P);}
,this);this.__mM.startSequence(L);}
else {this.setScrollX(O);}
;}
,scrollToY:function(U,R){var S=this.getScrollMaxY();if(U<0){U=0;}
else if(U>S){U=S;}
;this.stopScrollAnimation();if(R){var T=this.getScrollY();this.__mM=new qx.bom.AnimationFrame();this.__mM.on(o,function(){this.setScrollY(U);this.__mM=null;this.fireEvent(c);}
,this);this.__mM.on(i,function(W){var V=parseInt(W/R*(U-T)+T);this.setScrollY(V);}
,this);this.__mM.startSequence(R);}
...
,stopScrollAnimation:function(){if(this.__mM){this.__mM.cancelSequence();this.__mM=null;}
;}
...
;}
else if(typeof u==q){this.__mS=new Array(u);}
else if(u instanceof Array){this.__mS=qx.lang.Array.clone(u);}
else {this.__mS=[];this.dispose();throw new Error(l);}
;for(var i=0;i<this.__mS.length;i++ ){this._applyEventPropagation(this.__mS[i],null,i);}
;this.__mT();if(qx.core.Environment.get(k)){this[0]=h;}
;}
,properties:{autoDisposeItems:{check:e,init:false}},events:{"change":t,"changeLength":t},members:{__mS:null,concat:function(v){if(v){var w=this.__mS.concat(v);}
else {var w=this.__mS.concat();}
;return new qx.data.Array(w);}
,join:function(x){return this.__mS.join(x);}
,pop:function(){var y=this.__mS.pop();this.__mT();this._registerEventChaining(null,y,this.length-1);this.fireDataEvent(r,{value:[],name:this.length+f,old:[y],item:this});this.fireDataEvent(o,{start:this.length-1,end:this.length-1,type:g,items:[y],removed:[y],added:[]},null);return y;}
,push:function(z){for(var i=0;i<arguments.length;i++ ){this.__mS.push(arguments[i]);this.__mT();this._registerEventChaining(arguments[i],null,this.length-1);this.fireDataEvent(r,{value:[arguments[i]],name:(this.length-1)+f,old:[],item:this});this.fireDataEvent(o,{start:this.length-1,end:this.length-1,type:b,items:[arguments[i]],added:[arguments[i]],removed:[]},null);}
;return this.length;}
,reverse:function(){if(this.length==0){return;}
;var A=this.__mS.concat();this.__mS.reverse();this.__mU(0,this.length);this.fireDataEvent(o,{start:0,end:this.length-1,type:c,items:null,added:[],removed:[]},null);this.fireDataEvent(r,{value:this.__mS,name:n+(this.__mS.length-1),old:A,item:this});}
,shift:function(){if(this.length==0){return;}
;var B=this.__mS.shift();this.__mT();this._registerEventChaining(null,B,this.length-1);this.__mU(0,this.length);this.fireDataEvent(r,{value:[],name:p,old:[B],item:this});this.fireDataEvent(o,{start:0,end:this.length-1,type:g,items:[B],removed:[B],added:[]},null);return B;}
,slice:function(D,C){return new qx.data.Array(this.__mS.slice(D,C));}
,splice:function(J,L,N){var Q=this.__mS.length;var M=this.__mS.splice.apply(this.__mS,arguments);if(this.__mS.length!=Q){this.__mT();}
else if(L==arguments.length-2){var E=qx.lang.Array.fromArguments(arguments,2);for(var i=0;i<E.length;i++ ){if(E[i]!==M[i]){break;}
;if(i==E.length-1){return new qx.data.Array();}
;}
;}
;var O=L>0;var G=arguments.length>2;var I=null;if(O||G){var E=qx.lang.Array.fromArguments(arguments,2);if(M.length==0){var P=b;var H=J+E.length;I=E;}
else if(E.length==0){var P=g;var H=this.length-1;I=M;}
else {var P=d;var H=J+Math.abs(E.length-M.length);}
;this.fireDataEvent(o,{start:J,end:H,type:P,items:I,added:E,removed:M},null);}
;for(var i=0;i<M.length;i++ ){this._registerEventChaining(null,M[i],i);}
;for(var i=2;i<arguments.length;i++ ){this._registerEventChaining(arguments[i],null,J+(i-2));}
;this.__mU(J+(arguments.length-2)-L,this.length);var K=[];for(var i=2;i<arguments.length;i++ ){K[i-2]=arguments[i];}
;var F=(J+Math.max(arguments.length-3,L-1));var name=J==F?F:J+a+F;this.fireDataEvent(r,{value:K,name:name+f,old:M,item:this});return (new qx.data.Array(M));}
,sort:function(S){if(this.length==0){return;}
;var R=this.__mS.concat();this.__mS.sort.apply(this.__mS,arguments);if(qx.lang.Array.equals(this.__mS,R)===true){return;}
;this.__mU(0,this.length);this.fireDataEvent(o,{start:0,end:this.length-1,type:c,items:null,added:[],removed:[]},null);this.fireDataEvent(r,{value:this.__mS,name:n+(this.length-1),old:R,item:this});}
,unshift:function(T){for(var i=arguments.length-1;i>=0;i-- ){this.__mS.unshift(arguments[i]);this.__mT();this.__mU(0,this.length);this.fireDataEvent(r,{value:[this.__mS[0]],name:p,old:[this.__mS[1]],item:this});this.fireDataEvent(o,{start:0,end:this.length-1,type:b,items:[arguments[i]],added:[arguments[i]],removed:[]},null);}
;return this.length;}
,toArray:function(){return this.__mS;}
,getItem:function(U){return this.__mS[U];}
,setItem:function(V,X){var W=this.__mS[V];if(W===X){return;}
;this.__mS[V]=X;this._registerEventChaining(X,W,V);if(this.length!=this.__mS.length){this.__mT();}
;this.fireDataEvent(r,{value:[X],name:V+f,old:[W],item:this});this.fireDataEvent(o,{start:V,end:V,type:d,items:[X],added:[X],removed:[W]},null);}
,getLength:function(){return this.length;}
,indexOf:function(Y){return this.__mS.indexOf(Y);}
,lastIndexOf:function(ba){return this.__mS.lastIndexOf(ba);}
,toString:function(){if(this.__mS!=null){return this.__mS.toString();}
;return f;}
,contains:function(bb){return this.__mS.indexOf(bb)!==-1;}
...
;var bo=this.getLength();var bn=this.__mS.concat();this.__mS.length=0;this.__mT();this.fireDataEvent(r,{value:[],name:n+(bo-1),old:bn,item:this});this.fireDataEvent(o,{start:0,end:bo-1,type:g,items:bn,removed:bn,added:[]},null);return bn;}
...
;Array.prototype.push.apply(this.__mS,bp);for(var i=0;i<bp.length;i++ ){this._registerEventChaining(bp[i],null,this.__mS.length+i);}
;var bq=this.length;this.__mT();var name=bq==(this.length-1)?bq:bq+a+(this.length-1);this.fireDataEvent(r,{value:bp,name:name+f,old:[],item:this});this.fireDataEvent(o,{start:bq,end:this.length-1,type:b,items:bp,added:bp,removed:[]},null);}
...
,forEach:function(bx,by){for(var i=0;i<this.__mS.length;i++ ){bx.call(by,this.__mS[i],i,this);}
;}
,filter:function(bz,self){return new qx.data.Array(this.__mS.filter(bz,self));}
,map:function(bA,self){return new qx.data.Array(this.__mS.map(bA,self));}
,some:function(bB,self){return this.__mS.some(bB,self);}
,every:function(bC,self){return this.__mS.every(bC,self);}
,reduce:function(bE,bD){return this.__mS.reduce(bE,bD);}
,reduceRight:function(bG,bF){return this.__mS.reduceRight(bG,bF);}
,__mT:function(){var bH=this.length;this.length=this.__mS.length;this.fireDataEvent(s,this.length,bH);}
,__mU:function(bJ,bI){for(var i=bJ;i<bI;i++ ){this._registerEventChaining(this.__mS[i],this.__mS[i],i);}
;}
},destruct:function(){for(var i=0;i<this.__mS.length;i++ ){var bK=this.__mS[i];this._applyEventPropagation(null,bK,i);if(this.isAutoDisposeItems()&&bK&&bK instanceof qx.core.Object){bK.dispose();}
;}
;this.__mS=null;}
});}
)();
(function(){var a="changeModel",b="changeLabelOptions",c="_applyLabelOptions",d="_applyDelegate",e="_applyLabelPath",f="popupOpen",g="qx.data.Array",h="qx.ui.form.core.AbstractVirtualBox",i="changeIconOptions",j="blur",k="Down",l="Integer",m="_applyModel",n="open",o="Up",p="",q="_applyMaxListHeight",r="visible",s="middle",t="_applyIconPath",u="resize",v="list",w="changeDelegate",x="changeVisibility",y="close",z="changeLabelPath",A="dropdown",B="keypress",C="changeIconPath",D="_applyRowHeight",E="click",F="abstract",G="Number",H="String",I="Escape",J="_applyIconOptions",K=".",L="[0]";qx.Class.define(h,{extend:qx.ui.core.Widget,include:qx.ui.form.MForm,implement:qx.ui.form.IForm,type:F,construct:function(M){qx.ui.core.Widget.call(this);var N=new qx.ui.layout.HBox();this._setLayout(N);N.setAlignY(s);this.addListener(B,this._handleKeyboard,this);this.addListener(E,this._handleMouse,this);this.addListener(j,this._onBlur,this);this.addListener(u,this._onResize,this);this._createChildControl(A);if(M!=null){this.initModel(M);}
else {this.__zX=new qx.data.Array();this.initModel(this.__zX);}
;}
,properties:{focusable:{refine:true,init:true},width:{refine:true,init:120},model:{check:g,apply:m,event:a,nullable:false,deferredInit:true},delegate:{apply:d,event:w,init:null,nullable:true},labelPath:{check:H,apply:e,event:z,nullable:true},labelOptions:{apply:c,event:b,nullable:true},iconPath:{check:H,event:C,apply:t,nullable:true},iconOptions:{apply:J,event:i,nullable:true},itemHeight:{check:l,init:25,apply:D,themeable:true},maxListHeight:{check:G,apply:q,nullable:true,init:200}},members:{__zX:null,_forwardStates:{focused:true,invalid:true},refresh:function(){this.getChildControl(A).getChildControl(v).refresh();qx.ui.core.queue.Widget.add(this);}
,open:function(){this._beforeOpen();this.getChildControl(A).open();}
,close:function(){this._beforeClose();this.getChildControl(A).close();}
,toggle:function(){var O=this.getChildControl(A);if(O.isVisible()){this.close();}
else {this.open();}
;}
,_createChildControlImpl:function(R,Q){var P;switch(R){case A:P=new qx.ui.form.core.VirtualDropDownList(this);P.addListener(x,this._onPopupChangeVisibility,this);break;};return P||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,R,Q);}
,_beforeOpen:function(){}
,_beforeClose:function(){}
,_getAction:function(event){var S=event.getKeyIdentifier();var U=this.getChildControl(A).isVisible();var T=this._isModifierPressed(event);if(!U&&!T&&(S===k||S===o)){return n;}
else if(U&&!T&&S===I){return y;}
else {return null;}
;}
,_getBindPath:function(W,X){var V=W+L;if(X!=null&&X!=p){V+=K+X;}
;return V;}
,_isModifierPressed:function(event){var bc=event.isAltPressed();var bb=event.isCtrlOrCommandPressed();var Y=event.isShiftPressed();var ba=event.isMetaPressed();return (bc||bb||Y||ba);}
,_onBlur:function(event){this.close();}
,_handleKeyboard:function(event){var bd=this._getAction(event);var be=this.getChildControl(A).isVisible();switch(bd){case n:this.open();break;case y:this.close();break;default:if(be){this.getChildControl(A)._handleKeyboard(event);}
;break;};}
,_handleMouse:function(event){}
,_onResize:function(event){this.getChildControl(A).setMinWidth(event.getData().width);}
,_onPopupChangeVisibility:function(event){event.getData()==r?this.addState(f):this.removeState(f);}
,_applyModel:function(bg,bf){this.getChildControl(A).getChildControl(v).setModel(bg);qx.ui.core.queue.Widget.add(this);}
,_applyDelegate:function(bi,bh){this.getChildControl(A).getChildControl(v).setDelegate(bi);}
,_applyLabelPath:function(bk,bj){this.getChildControl(A).getChildControl(v).setLabelPath(bk);qx.ui.core.queue.Widget.add(this);}
,_applyLabelOptions:function(bm,bl){this.getChildControl(A).getChildControl(v).setLabelOptions(bm);qx.ui.core.queue.Widget.add(this);}
,_applyIconPath:function(bo,bn){this.getChildControl(A).getChildControl(v).setIconPath(bo);qx.ui.core.queue.Widget.add(this);}
,_applyIconOptions:function(bq,bp){this.getChildControl(A).getChildControl(v).setIconOptions(bq);qx.ui.core.queue.Widget.add(this);}
,_applyRowHeight:function(bs,br){this.getChildControl(A).getChildControl(v).setItemHeight(bs);}
,_applyMaxListHeight:function(bu,bt){this.getChildControl(A).getChildControl(v).setMaxHeight(bu);}
},destruct:function(){if(this.__zX){this.__zX.dispose();}
;}
});}
)();
(function(){var a="changeModel",b="click",c="one",d="Enter",e="list",f="changeDelegate",g="change",h="qx.data.Array",j="changeVisibility",k="qx.ui.form.core.VirtualDropDownList",l="_applySelection",m="changeSelection",n="Invalid parameter 'target'!",o="qx.event.type.Data";qx.Class.define(k,{extend:qx.ui.popup.Popup,construct:function(p){qx.core.Assert.assertNotNull(p,n);qx.core.Assert.assertNotUndefined(p,n);qx.core.Assert.assertInterface(p,qx.ui.form.core.AbstractVirtualBox,n);qx.ui.popup.Popup.call(this,new qx.ui.layout.VBox());this._target=p;this._createChildControl(e);this.addListener(j,this.__Ad,this);this.__Aa=new qx.data.Array();this.initSelection(this.__Aa);}
,properties:{autoHide:{refine:true,init:false},keepActive:{refine:true,init:true},selection:{check:h,event:m,apply:l,nullable:false,deferredInit:true}},events:{"changeSelection":o},members:{_target:null,_preselected:null,__Ab:false,__Ac:false,__Aa:null,open:function(){this.placeToWidget(this._target,true);this.show();}
,close:function(){this.hide();}
,setPreselected:function(q){this._preselected=q;this.__Ac=true;var s=this.getChildControl(e).getSelection();var r=new qx.data.Array([q]);this.__Af(r,s);r.dispose();this.__Ac=false;}
,_createChildControlImpl:function(v,u){var t;switch(v){case e:t=new qx.ui.list.List().set({focusable:false,keepFocus:true,height:null,width:null,maxHeight:this._target.getMaxListHeight(),selectionMode:c,quickSelection:true});t.getSelection().addListener(g,this._onListChangeSelection,this);t.addListener(b,this._handleMouse,this);t.addListener(a,this._onChangeModel,this);t.addListener(f,this._onChangeDelegate,this);this.add(t,{flex:1});break;};return t||qx.ui.popup.Popup.prototype._createChildControlImpl.call(this,v,u);}
,_handleKeyboard:function(event){if(this.isVisible()&&event.getKeyIdentifier()===d){this.__Ae();return;}
;var w=event.clone();w.setTarget(this.getChildControl(e));w.setBubbles(false);this.getChildControl(e).dispatchEvent(w);}
,_handleMouse:function(event){this.__Ae();}
,__nN:function(event){if(this.__Ab){return;}
;var x=this.getSelection();var y=this.getChildControl(e).getSelection();this.__Ac=true;this.__Af(x,y);this.__Ac=false;this.__Ab=true;this.__Af(y,x);this.__Ab=false;}
,_onListChangeSelection:function(event){if(this.__Ac){return;}
;var z=this.getChildControl(e).getSelection();if(this.isVisible()){this.setPreselected(z.getItem(0));}
else {this.__Ab=true;this.__Af(z,this.getSelection());this.__Ab=false;}
;}
,__Ad:function(event){if(this.isVisible()){if(this._preselected==null){var A=this.getSelection();var B=this.getChildControl(e).getSelection();this.__Af(A,B);}
;this.__Ag();}
...
,_applySelection:function(D,C){D.addListener(g,this.__nN,this);if(C!=null){C.removeListener(g,this.__nN,this);}
;this.__Af(D,this.getChildControl(e).getSelection(D));}
,__Ae:function(){if(this._preselected!=null){var E=this.getSelection();E.splice(0,1,this._preselected);this._preselected=null;this.close();}
;}
,__Af:function(F,H){if(F.equals(H)){return;}
;if(F.getLength()<=0){H.removeAll();}
else {var G=H.toArray();qx.lang.Array.removeAll(G);for(var i=0;i<F.getLength();i++ ){G.push(F.getItem(i));}
;H.length=G.length;H.fireDataEvent(g,{});}
;}
,__Ag:function(){this.__Ah();this.__Ai();}
,__Ah:function(){var I=this._target.getBounds().width;this.setWidth(I);}
,__Ai:function(){var J=this.__Aj();var L=this._target.getMaxListHeight();var K=this.getChildControl(e);var M=K.getPane().getRowConfig().getTotalSize();if(L==null||M<L){L=M;}
;if(L>J){K.setMaxHeight(J);}
else if(L<J){K.setMaxHeight(L);}
;}
,__Aj:function(){var N=this.getLayoutLocation(this._target);var Q=qx.bom.Viewport.getHeight();var P=N.top;var O=Q-N.bottom;return P>O?P:O;}
},destruct:function(){if(this.__Aa){this.__Aa.dispose();}
;}
});}
)();
(function(){var a="scrollY",b="The method 'getItemRight' is not implemented!",c="update",d="scrollX",f="The method 'getItemLeft' is not implemented!",g="The method 'getItemBottom' is not implemented!",h="The method 'getItemTop' is not implemented!",i="pane",j="os.scrollBarOverlayed",k="qx.ui.virtual.core.Scroller";qx.Class.define(k,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(o,l,n,m){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__Ay=new qx.ui.virtual.core.Pane(o,l,n,m);this.__Ay.addListener(c,this._computeScrollbars,this);this.__Ay.addListener(d,this._onScrollPaneX,this);this.__Ay.addListener(a,this._onScrollPaneY,this);if(qx.core.Environment.get(j)){this._add(this.__Ay,{edge:0});}
...
,_createChildControlImpl:function(q,p){if(q==i){return this.__Ay;}
else {return qx.ui.core.scroll.AbstractScrollArea.prototype._createChildControlImpl.call(this,q);}
;}
,getItemTop:function(r){throw new Error(h);}
,getItemBottom:function(s){throw new Error(g);}
,getItemLeft:function(t){throw new Error(f);}
,getItemRight:function(u){throw new Error(b);}
...
(function(){var a="scrollY",b="mousedown",c="__zK",d="__zR",f="qx.event.type.Data",g="dblclick",h="change",j="qx.debug",k="qx.event.type.Event",l="cellContextmenu",m="resize",n="scrollX",o="__zS",p="appear",q="qx.ui.virtual.core.CellEvent",r="cellDblclick",s="__zL",t="qx.ui.virtual.core.Pane",u="click",v="update",w="cellClick",x="contextmenu";qx.Class.define(t,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__zK=new qx.ui.virtual.core.Axis(A,B);this.__zL=new qx.ui.virtual.core.Axis(z,y);this.__zM=0;this.__zN=0;this.__zO=0;this.__zP=0;this.__zQ={};this.__iQ={};this.__zR=new qx.ui.container.Composite();this.__zR.setUserBounds(0,0,0,0);this._add(this.__zR);this.__zS=[];this.__zK.addListener(h,this.fullUpdate,this);this.__zL.addListener(h,this.fullUpdate,this);this.addListener(m,this._onResize,this);this.addListenerOnce(p,this._onAppear,this);this.addListener(b,this._onMouseDown,this);this.addListener(u,this._onClick,this);this.addListener(g,this._onDblclick,this);this.addListener(x,this._onContextmenu,this);}
,events:{cellClick:q,cellContextmenu:q,cellDblclick:q,update:k,scrollX:f,scrollY:f},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__zK:null,__zL:null,__zM:null,__zN:null,__zO:null,__zP:null,__zQ:null,__iQ:null,__zR:null,__zS:null,__zT:null,__ox:null,__zJ:null,__zU:null,getRowConfig:function(){return this.__zK;}
,getColumnConfig:function(){return this.__zL;}
,getChildren:function(){return [this.__zR];}
,addLayer:function(C){if(qx.core.Environment.get(j)){this.assertInterface(C,qx.ui.virtual.core.ILayer);}
;this.__zS.push(C);C.setUserBounds(0,0,0,0);this.__zR.add(C);}
,getLayers:function(){return this.__zS;}
,getVisibleLayers:function(){var D=[];for(var i=0;i<this.__zS.length;i++ ){var E=this.__zS[i];if(E.isVisible()){D.push(E);}
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__zL.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__zK.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(J){var H=this.getScrollMaxY();if(J<0){J=0;}
else if(J>H){J=H;}
;if(this.__zM!==J){var I=this.__zM;this.__zM=J;this._deferredUpdateScrollPosition();this.fireDataEvent(a,J,I);}
;}
,getScrollY:function(){return this.__zM;}
,setScrollX:function(M){var K=this.getScrollMaxX();if(M<0){M=0;}
else if(M>K){M=K;}
;if(M!==this.__zN){var L=this.__zN;this.__zN=M;this._deferredUpdateScrollPosition();this.fireDataEvent(n,M,L);}
;}
,getScrollX:function(){return this.__zN;}
,getScrollSize:function(){return {width:this.__zL.getTotalSize(),height:this.__zK.getTotalSize()};}
,scrollRowIntoView:function(P){var Q=this.getBounds();if(!Q){this.addListenerOnce(p,function(){qx.event.Timer.once(function(){this.scrollRowIntoView(P);}
,this,0);}
,this);return;}
;var R=this.__zK.getItemPosition(P);var O=R+this.__zK.getItemSize(P);var N=this.getScrollY();if(R<N){this.setScrollY(R);}
else if(O>N+Q.height){this.setScrollY(O-Q.height);}
;}
,scrollColumnIntoView:function(S){var V=this.getBounds();if(!V){this.addListenerOnce(p,function(){qx.event.Timer.once(function(){this.scrollColumnIntoView(S);}
,this,0);}
,this);return;}
;var U=this.__zL.getItemPosition(S);var T=U+this.__zL.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
else if(T>W+V.width){this.setScrollX(T-V.width);}
;}
,scrollCellIntoView:function(X,ba){var Y=this.getBounds();if(!Y){this.addListenerOnce(p,function(){qx.event.Timer.once(function(){this.scrollCellIntoView(X,ba);}
,this,0);}
,this);return;}
;this.scrollColumnIntoView(X);this.scrollRowIntoView(ba);}
,getCellAtPosition:function(bb,bc){var bf,be;var bd=this.getContentLocation();if(!bd||bc<bd.top||bc>=bd.bottom||bb<bd.left||bb>=bd.right){return null;}
;bf=this.__zK.getItemAtPosition(this.getScrollY()+bc-bd.top);be=this.__zL.getItemAtPosition(this.getScrollX()+bb-bd.left);if(!bf||!be){return null;}
;return {row:bf.index,column:be.index};}
,prefetchX:function(bj,bm,bk,bi){var bg=this.getVisibleLayers();if(bg.length==0){return;}
;var bl=this.getBounds();if(!bl){return;}
;var bn=this.__zN+bl.width;var bo=this.__zP-bn;if(this.__zN-this.__zQ.left<Math.min(this.__zN,bj)||this.__zQ.right-bn<Math.min(bo,bk)){var bp=Math.min(this.__zN,bm);var bh=Math.min(bo,bi);this._setLayerWindow(bg,this.__zN-bp,this.__zM,bl.width+bp+bh,bl.height,false);}
;}
,prefetchY:function(bz,bv,br,bu){var bq=this.getVisibleLayers();if(bq.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bs=this.__zM+bw.height;var bt=this.__zO-bs;if(this.__zM-this.__zQ.top<Math.min(this.__zM,bz)||this.__zQ.bottom-bs<Math.min(bt,br)){var by=Math.min(this.__zM,bv);var bx=Math.min(bt,bu);this._setLayerWindow(bq,this.__zN,this.__zM-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContentElement().getDomElement()){this.__zT=true;this._updateScrollPosition();this.__zT=null;this.fireEvent(v);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onMouseDown:function(e){this.__zU=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onClick:function(e){this.__zV(e,w);}
,_onContextmenu:function(e){this.__zV(e,l);}
,_onDblclick:function(e){this.__zV(e,r);}
,__zV:function(e,bC){var bB=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bB){return;}
;var bA=this.__zU;if(bA==null||bA.row!==bB.row||bA.column!==bB.column){return;}
;this.fireNonBubblingEvent(bC,qx.ui.virtual.core.CellEvent,[this,e,bB.row,bB.column]);}
,syncWidget:function(bD){if(this.__iQ._fullUpdate){this._fullUpdate();}
else if(this.__iQ._updateScrollPosition){this._updateScrollPosition();}
;this.__iQ={};}
,_setLayerWindow:function(bE,bT,top,bP,bL,bV){var bK=this.__zK.getItemAtPosition(top);if(bK){var bN=bK.index;var bR=this.__zK.getItemSizes(bN,bL+bK.offset);var bM=qx.lang.Array.sum(bR);var bU=top-bK.offset;var bQ=top-bK.offset+bM;}
else {var bN=0;var bR=[];var bM=0;var bU=0;var bQ=0;}
;var bF=this.__zL.getItemAtPosition(bT);if(bF){var bJ=bF.index;var bH=this.__zL.getItemSizes(bJ,bP+bF.offset);var bO=qx.lang.Array.sum(bH);var bS=bT-bF.offset;var bI=bT-bF.offset+bO;}
else {var bJ=0;var bH=[];var bO=0;var bS=0;var bI=0;}
;this.__zQ={top:bU,bottom:bQ,left:bS,right:bI};this.__zR.setUserBounds((this.getPaddingLeft()||0)+(this.__zQ.left-this.__zN),(this.getPaddingTop()||0)+(this.__zQ.top-this.__zM),bO,bM);this.__ox=bH;this.__zJ=bR;for(var i=0;i<this.__zS.length;i++ ){var bG=this.__zS[i];bG.setUserBounds(0,0,bO,bM);if(bV){bG.fullUpdate(bN,bJ,bR,bH);}
else {bG.updateLayerWindow(bN,bJ,bR,bH);}
;}
;}
,__zW:function(){if(this.__zT){return;}
;var bW=this.getScrollSize();if(this.__zO!==bW.height||this.__zP!==bW.width){this.__zO=bW.height;this.__zP=bW.width;this.fireEvent(v);}
;}
,fullUpdate:function(){this.__iQ._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__iQ._fullUpdate;}
,_fullUpdate:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__zW();return;}
;var bY=this.getBounds();if(!bY){return;}
;this._setLayerWindow(bX,this.__zN,this.__zM,bY.width,bY.height,true);this.__zW();}
,_deferredUpdateScrollPosition:function(){this.__iQ._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__zW();return;}
;var cc=this.getBounds();if(!cc){return;}
;var cb={top:this.__zM,bottom:this.__zM+cc.height,left:this.__zN,right:this.__zN+cc.width};if(this.__zQ.top<=cb.top&&this.__zQ.bottom>=cb.bottom&&this.__zQ.left<=cb.left&&this.__zQ.right>=cb.right){this.__zR.setUserBounds((this.getPaddingLeft()||0)+(this.__zQ.left-cb.left),(this.getPaddingTop()||0)+(this.__zQ.top-cb.top),this.__zQ.right-this.__zQ.left,this.__zQ.bottom-this.__zQ.top);}
else {this._setLayerWindow(ca,this.__zN,this.__zM,cc.width,cc.height,false);}
;this.__zW();}
},destruct:function(){this._disposeArray(o);this._disposeObjects(c,s,d);this.__zQ=this.__iQ=this.__ox=this.__zJ=null;}
});}
)();
(function(){var c="change",d="qx.debug",e="qx.event.type.Event",f="'size' must be 'null' or an integer larger than 0.",g="qx.ui.virtual.core.Axis";qx.Class.define(g,{extend:qx.core.Object,construct:function(h,j){qx.core.Object.call(this);this.itemCount=j;this.defaultItemSize=h;this.customSizes={};}
,events:{"change":e},members:{__Au:null,getDefaultItemSize:function(){return this.defaultItemSize;}
...
;}
,setItemSize:function(m,n){if(qx.core.Environment.get(d)){this.assertArgumentsCount(arguments,2,2);this.assert(n>0||n===null,f);}
...
;var s=this.defaultItemSize;var q=this.itemCount;var y=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<q){y.push(p);}
;}
;if(y.length==0){var u=[{startIndex:0,endIndex:q-1,firstItemSize:s,rangeStart:0,rangeEnd:q*s-1}];this.__Au=u;return u;}
;y.sort(function(a,b){return a>b?1:-1;}
);var u=[];var r=0;for(var i=0;i<y.length;i++ ){var p=y[i];if(p>=q){break;}
;var x=this.customSizes[p];var t=p*s+r;r+=x-s;u[i]={startIndex:p,firstItemSize:x,rangeStart:t};if(i>0){u[i-1].rangeEnd=t-1;u[i-1].endIndex=p-1;}
;}
;if(u[0].rangeStart>0){u.unshift({startIndex:0,endIndex:u[0].startIndex-1,firstItemSize:s,rangeStart:0,rangeEnd:u[0].rangeStart-1});}
;var z=u[u.length-1];var w=(q-z.startIndex-1)*s;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=q-1;this.__Au=u;return u;}
,__Aw:function(F){var B=this.__Au||this.__Av();var C=0;var A=B.length-1;while(true){var E=C+((A-C)>>1);var D=B[E];if(D.rangeEnd<F){C=E+1;}
else if(D.rangeStart>F){A=E-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(K){if(K<0||K>=this.getTotalSize()){return null;}
;var J=this.__Aw(K);var L=J.rangeStart;var G=J.startIndex;var I=J.firstItemSize;if(L+I>K){return {index:G,offset:K-L};}
else {var H=this.defaultItemSize;return {index:G+1+Math.floor((K-L-I)/H),offset:(K-L-I)%H};}
;}
,__Ax:function(M){var O=this.__Au||this.__Av();var P=0;var N=O.length-1;while(true){var R=P+((N-P)>>1);var Q=O[R];if(Q.endIndex<M){P=R+1;}
else if(Q.startIndex>M){N=R-1;}
else {return Q;}
;}
;}
...
,getItemSizes:function(bb,V){var ba=this.customSizes;var Y=this.defaultItemSize;var X=0;var W=[];var i=0;while(X<V){var bc=ba[bb++ ]||Y;X+=bc;W[i++ ]=bc;if(bb>=this.itemCount){break;}
;}
;return W;}
},destruct:function(){this.customSizes=this.__Au=null;}
});}
)();
(function(){var a="qx.ui.virtual.core.ILayer";qx.Interface.define(a,{members:{fullUpdate:function(d,e,c,b){this.assertArgumentsCount(arguments,6,6);this.assertPositiveInteger(d);this.assertPositiveInteger(e);this.assertArray(c);this.assertArray(b);}
,updateLayerWindow:function(h,i,g,f){this.assertArgumentsCount(arguments,6,6);this.assertPositiveInteger(h);this.assertPositiveInteger(i);this.assertArray(g);this.assertArray(f);}
,updateLayerData:function(){}
}});}
)();
(function(){var a="qx.ui.virtual.core.CellEvent",b="Integer";qx.Class.define(a,{extend:qx.event.type.Mouse,properties:{row:{check:b,nullable:true},column:{check:b,nullable:true}},members:{init:function(e,c,f,d){c.clone(this);this.setBubbles(false);this.setRow(f);this.setColumn(d);}
}});}
)();
...
,properties:{selection:{check:d,event:n,apply:h,nullable:false,deferredInit:true},selectionMode:{check:[l,f,p,a],init:l,apply:o},dragSelection:{check:b,init:false,apply:k},quickSelection:{check:b,init:false,apply:m}},events:{"changeSelection":q},members:{_manager:null,__Ar:false,__Az:false,__Aa:null,_initSelectionManager:function(){var self=this;var r={isItemSelectable:function(s){return self._provider.isSelectable(s);}
,styleSelectable:function(t,u,v){if(u!=g){return;}
;if(v){self._provider.styleSelectabled(t);}
else {self._provider.styleUnselectabled(t);}
;}
};this._manager=new qx.ui.virtual.selection.Row(this.getPane(),r);this._manager.attachMouseEvents(this.getPane());this._manager.attachKeyEvents(this);this._manager.addListener(n,this._onManagerChangeSelection,this);}
,_updateSelection:function(){if(this._manager==null){return;}
;this._onChangeSelection();}
,_applySelection:function(x,w){x.addListener(j,this._onChangeSelection,this);if(w!=null){w.removeListener(j,this._onChangeSelection,this);}
;this._onChangeSelection();}
,_applySelectionMode:function(z,y){this._manager.setMode(z);}
,_applyDragSelection:function(B,A){this._manager.setDrag(B);}
,_applyQuickSelection:function(D,C){this._manager.setQuick(D);}
,_onChangeSelection:function(e){if(this.__Az==true){return;}
...
;this.__Az=true;this.__Af();this.__Az=false;}
,__Af:function(){if(this.__AB()){return;}
;var L=this._manager.getSelection();var M=[];for(var i=0;i<L.length;i++ ){var N=this._getDataFromRow(L[i]);if(N!=null){M.push(N);}
;}
;this.__AA(M);}
,__AA:function(Q){var P=this.getSelection();if(Q.length>0){var O=[0,P.getLength()];O=O.concat(Q);var R=P.splice.apply(P,O);R.dispose();}
else {P.removeAll();}
;}
,__AB:function(){var T=this.getSelection();var V=this._manager.getSelection();if(T.getLength()!==V.length){return false;}
...
;throw new Error(n);}
,getSelection:function(){return qx.lang.Object.getValues(this.__eX);}
,getSortedSelection:function(){var bS=this.getSelectables();var bR=qx.lang.Object.getValues(this.__eX);bR.sort(function(a,b){return bS.indexOf(a)-bS.indexOf(b);}
);return bR;}
,isItemSelected:function(bT){var bU=this._selectableToHashCode(bT);return this.__eX[bU]!==undefined;}
,isSelectionEmpty:function(){return qx.lang.Object.isEmpty(this.__eX);}
...
;this._fireChange();}
,_setLeadItem:function(bY){var bX=this.__me;if(bX!==null){this._styleSelectable(bX,u,false);}
;if(bY!==null){this._styleSelectable(bY,u,true);}
;this.__me=bY;}
,getLeadItem:function(){return this.__me!==null?this.__me:null;}
,_setAnchorItem:function(cb){var ca=this.__mf;if(ca!=null){this._styleSelectable(ca,G,false);}
;if(cb!=null){this._styleSelectable(cb,G,true);}
;this.__mf=cb;}
,_getAnchorItem:function(){return this.__mf!==null?this.__mf:null;}
...
,getSelectables:function(cn){throw new Error(bs);}
...
;this._fireChange();}
,handleMouseOver:function(event){if(this.__mh!=null&&this.__mh!=this._getScroll().top){this.__mh=null;return;}
...
;var cy=event.isCtrlPressed()||(qx.core.Environment.get(c)==D&&event.isMetaPressed());var cz=event.isShiftPressed();if(this.isItemSelected(cB)&&!cz&&!cy&&!this.getDrag()){this.__mg=cB;this._userInteraction=false;return;}
else {this.__mg=null;}
...
;break;};var cC=this.getMode();if(this.getDrag()&&cC!==X&&cC!==h&&!cz&&!cy){this.__lT=this._getLocation();this.__lQ=this._getScroll();this.__lU=event.getDocumentLeft()+this.__lQ.left;this.__lV=event.getDocumentTop()+this.__lQ.top;this.__lW=true;this._capture();}
;this._fireChange(bp);this._userInteraction=false;}
,handleMouseUp:function(event){this._userInteraction=true;var cG=event.isCtrlPressed()||(qx.core.Environment.get(c)==D&&event.isMetaPressed());var cD=event.isShiftPressed();if(!cG&&!cD&&this.__mg!=null){var cE=this._getSelectableFromMouseEvent(event);if(cE===null||!this.isItemSelected(cE)){this._userInteraction=false;return;}
...
,handleMouseMove:function(event){if(!this.__lW){return;}
;this.__lX=event.getDocumentLeft();this.__lY=event.getDocumentTop();this._userInteraction=true;var cH=this.__lX+this.__lQ.left;if(cH>this.__lU){this.__ma=1;}
else if(cH<this.__lU){this.__ma=-1;}
else {this.__ma=0;}
;var cI=this.__lY+this.__lQ.top;if(cI>this.__lV){this.__mb=1;}
else if(cI<this.__lV){this.__mb=-1;}
else {this.__mb=0;}
;var location=this.__lT;if(this.__lX<location.left){this.__lN=this.__lX-location.left;}
else if(this.__lX>location.right){this.__lN=this.__lX-location.right;}
else {this.__lN=0;}
;if(this.__lY<location.top){this.__lO=this.__lY-location.top;}
else if(this.__lY>location.bottom){this.__lO=this.__lY-location.bottom;}
else {this.__lO=0;}
;if(!this.__lP){this.__lP=new qx.event.Timer(100);this.__lP.addListener(E,this._onInterval,this);}
;this.__lP.start();this._autoSelect();event.stopPropagation();this._userInteraction=false;}
,handleAddItem:function(e){var cJ=e.getData();if(this.getMode()===h&&this.isSelectionEmpty()){this.addItem(cJ);}
;}
,handleRemoveItem:function(e){this.removeItem(e.getData());}
,_cleanup:function(){if(!this.getDrag()&&this.__lW){return;}
;if(this.__mc){this._fireChange(bp);}
;delete this.__lW;delete this.__lR;delete this.__lS;this._releaseCapture();if(this.__lP){this.__lP.stop();}
;}
,_onInterval:function(e){this._scrollBy(this.__lN,this.__lO);this.__lQ=this._getScroll();this._autoSelect();}
,_autoSelect:function(){var cS=this._getDimension();var cL=Math.max(0,Math.min(this.__lX-this.__lT.left,cS.width))+this.__lQ.left;var cK=Math.max(0,Math.min(this.__lY-this.__lT.top,cS.height))+this.__lQ.top;if(this.__lR===cL&&this.__lS===cK){return;}
;this.__lR=cL;this.__lS=cK;var cP=this._getAnchorItem();var cN=cP;var cQ=this.__ma;var cT,cM;while(cQ!==0){cT=cQ>0?this._getRelatedSelectable(cN,t):this._getRelatedSelectable(cN,T);if(cT!==null){cM=this._getSelectableLocationX(cT);if((cQ>0&&cM.left<=cL)||(cQ<0&&cM.right>=cL)){cN=cT;continue;}
;}
;break;}
;var cR=this.__mb;var cU,cO;while(cR!==0){cU=cR>0?this._getRelatedSelectable(cN,bA):this._getRelatedSelectable(cN,by);if(cU!==null){cO=this._getSelectableLocationY(cU);if((cR>0&&cO.top<=cK)||(cR<0&&cO.bottom>=cK)){cN=cU;continue;}
;}
;break;}
...
;this._fireChange(bB);}
,__mi:{Home:1,Down:1,Right:1,PageDown:1,End:1,Up:1,Left:1,PageUp:1},handleKeyPress:function(event){this._userInteraction=true;var dc,db;var de=event.getKeyIdentifier();var dd=this.getMode();var cX=event.isCtrlPressed()||(qx.core.Environment.get(c)==D&&event.isMetaPressed());var cY=event.isShiftPressed();var da=false;if(de===z&&cX){if(dd!==X&&dd!==h){this._selectAllItems();da=true;}
;}
...
;da=true;}
;}
else if(this.__mi[de]){da=true;if(dd===X||dd==h){dc=this._getSelectedItem();}
else {dc=this.getLeadItem();}
;if(dc!==null){switch(de){case V:db=this._getFirstSelectable();break;case N:db=this._getLastSelectable();break;case x:db=this._getRelatedSelectable(dc,by);break;case v:db=this._getRelatedSelectable(dc,bA);break;case k:db=this._getRelatedSelectable(dc,T);break;case Y:db=this._getRelatedSelectable(dc,t);break;case bv:db=this._getPage(dc,true);break;case B:db=this._getPage(dc,false);break;};}
else {switch(de){case V:case v:case Y:case B:db=this._getFirstSelectable();break;case N:case x:case k:case bv:db=this._getLastSelectable();break;};}
...
;}
;break;};this.__mh=this._getScroll().top;this._scrollItemIntoView(db);}
;}
...
;}
,_clearSelection:function(){var dh=this.__eX;for(var di in dh){this._removeFromSelection(dh[di]);}
;this.__eX={};}
,_selectItemRange:function(dj,dn,dl){var dp=this._getSelectableRange(dj,dn);if(!dl){var dm=this.__eX;var dq=this.__mj(dp);for(var dk in dm){if(!dq[dk]){this._removeFromSelection(dm[dk]);}
;}
;}
...
;}
,__mj:function(dv){var dw={};var du;for(var i=0,l=dv.length;i<l;i++ ){du=dv[i];dw[this._selectableToHashCode(du)]=du;}
;return dw;}
,_getSelectedItem:function(){for(var dx in this.__eX){return this.__eX[dx];}
;return null;}
,_setSelectedItem:function(dz){if(this._isSelectable(dz)){var dy=this.__eX;var dA=this._selectableToHashCode(dz);if(!dy[dA]||(dy.length>=2)){this._clearSelection();this._addToSelection(dz);}
;}
;}
,_addToSelection:function(dB){var dC=this._selectableToHashCode(dB);if(this.__eX[dC]==null&&this._isSelectable(dB)){this.__eX[dC]=dB;this._styleSelectable(dB,P,true);this.__mc=true;}
;}
,_toggleInSelection:function(dD){var dE=this._selectableToHashCode(dD);if(this.__eX[dE]==null){this.__eX[dE]=dD;this._styleSelectable(dD,P,true);}
else {delete this.__eX[dE];this._styleSelectable(dD,P,false);}
;this.__mc=true;}
,_removeFromSelection:function(dF){var dG=this._selectableToHashCode(dF);if(this.__eX[dG]!=null){delete this.__eX[dG];this._styleSelectable(dF,P,false);this.__mc=true;}
;}
...
;}
;var dO=dJ[0];var dH=dN;var dL=this.__eX;for(var dM in dL){if(dI[dM]){delete dI[dM];}
...
;if(!dK){return false;}
;this._scrollItemIntoView(dH);this._setLeadItem(dO);this._setAnchorItem(dO);this.__mc=true;this._fireChange();}
,_fireChange:function(dP){if(this.__mc){this.__md=dP||null;this.fireDataEvent(br,this.getSelection());delete this.__mc;}
;}
...
;return dR;}
;return null;}
},destruct:function(){this._disposeObjects(bt);this.__eX=this.__mg=this.__mf=null;this.__me=null;}
});}
)();
(function(){var a="qx.ui.virtual.selection.Abstract",b="mouseup",c="mousedown",d="losecapture",e="qx.debug",f="mouseover",g="mousemove",h="removeItem",i="keypress",j="addItem";qx.Class.define(a,{extend:qx.ui.core.selection.Abstract,construct:function(l,k){qx.ui.core.selection.Abstract.call(this);if(qx.core.Environment.get(e)){this.assertInstance(l,qx.ui.virtual.core.Pane);}
;this._pane=l;this._delegate=k||{};}
...
;}
,attachMouseEvents:function(){var q=this._pane.getContentElement();q.addListener(c,this.handleMouseDown,this);q.addListener(b,this.handleMouseUp,this);q.addListener(f,this.handleMouseOver,this);q.addListener(g,this.handleMouseMove,this);q.addListener(d,this.handleLoseCapture,this);}
,detatchMouseEvents:function(){var r=this._pane.getContentElement();r.removeListener(c,this.handleMouseDown,this);r.removeListener(b,this.handleMouseUp,this);r.removeListener(f,this.handleMouseOver,this);r.removeListener(g,this.handleMouseMove,this);r.removeListener(d,this.handleLoseCapture,this);}
,attachKeyEvents:function(s){s.addListener(i,this.handleKeyPress,this);}
,detachKeyEvents:function(t){t.removeListener(i,this.handleKeyPress,this);}
,attachListEvents:function(u){u.addListener(j,this.handleAddItem,this);u.addListener(h,this.handleRemoveItem,this);}
,detachListEvents:function(v){v.removeListener(j,this.handleAddItem,this);v.removeListener(h,this.handleRemoveItem,this);}
...
,getSelectables:function(f){var e=[];for(var i=0,l=this._getItemCount();i<l;i++ ){if(this._isSelectable(i)){e.push(i);}
;}
;return e;}
,_getSelectableRange:function(j,k){var m=[];var g=Math.min(j,k);var h=Math.max(j,k);for(var i=g;i<=h;i++ ){if(this._isSelectable(i)){m.push(i);}
;}
;return m;}
...
;}
;return null;}
,_getRelatedSelectable:function(q,s){if(s==b){var r=q-1;var p=0;var t=-1;}
else if(s==c){var r=q+1;var p=this._getItemCount()-1;var t=1;}
else {return null;}
;for(var i=r;i!==p+t;i+=t){if(this._isSelectable(i)){return i;}
;}
;return null;}
,_getPage:function(v,u){if(u){return this._getFirstSelectable();}
...
(function(){var c="changeModel",d="resize",f="_applyLabelOptions",g="_applyLabelPath",h="qx.data.Array",j="_applyGroupLabelOptions",m="changeLength",n="Integer",o="_applyModel",p="changeGroups",q="Boolean",r="GroupingTypeError: You can't mix 'Objects' and 'Strings' as",s="sorter",t="row-layer",u="group",v="_applyIconPath",w="_applyDelegate",x="changeDelegate",y=" group identifier!",z="???",A="_applyRowHeight",B="qx.data.IListData",C="filter",D="virtual-list",E="String",F="_applyGroupLabelPath",G="_applyIconOptions",H="qx.ui.list.List";qx.Class.define(H,{extend:qx.ui.virtual.core.Scroller,include:[qx.ui.virtual.selection.MModel],implement:qx.data.controller.ISelection,construct:function(I){qx.ui.virtual.core.Scroller.call(this,0,1,20,100);this._init();this.__zq=new qx.data.Array();this.initGroups(this.__zq);if(I!=null){this.initModel(I);}
;this.initItemHeight();}
,properties:{appearance:{refine:true,init:D},focusable:{refine:true,init:true},width:{refine:true,init:100},height:{refine:true,init:200},model:{check:B,apply:o,event:c,nullable:true,deferredInit:true},itemHeight:{check:n,init:25,apply:A,themeable:true},labelPath:{check:E,apply:g,nullable:true},iconPath:{check:E,apply:v,nullable:true},groupLabelPath:{check:E,apply:F,nullable:true},labelOptions:{apply:f,nullable:true},iconOptions:{apply:G,nullable:true},groupLabelOptions:{apply:j,nullable:true},delegate:{apply:w,event:x,init:null,nullable:true},autoGrouping:{check:q,init:true},groups:{check:h,event:p,nullable:false,deferredInit:true}},members:{_background:null,_provider:null,_layer:null,__zr:null,__zs:null,__zt:null,__zu:false,__zv:false,__zw:false,__zq:null,refresh:function(){this.__zy();}
,_createChildControlImpl:function(L,K){var J;switch(L){case t:J=new qx.ui.virtual.layer.Row(null,null);break;};return J||qx.ui.virtual.core.Scroller.prototype._createChildControlImpl.call(this,L);}
,_init:function(){this._provider=new qx.ui.list.provider.WidgetProvider(this);this.__zr=[];this.__zs=[];this.__zt={};this.__zu=false;this.__zv=false;this.__zw=false;this.getPane().addListener(d,this._onResize,this);this._initBackground();this._initLayer();}
,_initBackground:function(){this._background=this.getChildControl(t);this.getPane().addLayer(this._background);}
,_initLayer:function(){this._layer=this._provider.createLayer();this.getPane().addLayer(this._layer);}
,_getDataFromRow:function(O){var N=null;var M=this.getModel();if(M==null){return null;}
;if(this._isGroup(O)){N=this.getGroups().getItem(this._lookupGroup(O));}
else {N=M.getItem(this._lookup(O));}
;if(N!=null){return N;}
else {return null;}
;}
,_getLookupTable:function(){return this.__zr;}
,_lookup:function(P){return this.__zr[P];}
,_lookupGroup:function(Q){return this.__zs.indexOf(Q);}
,_reverseLookup:function(R){if(R<0){return -1;}
;return this.__zr.indexOf(R);}
,_isGroup:function(S){return this._lookup(S)==-1;}
,_getSelectables:function(){return this.getModel();}
,_applyModel:function(U,T){if(U!=null){U.addListener(m,this._onModelChange,this);}
;if(T!=null){T.removeListener(m,this._onModelChange,this);}
;this._provider.removeBindings();this._onModelChange();}
,_applyRowHeight:function(W,V){this.getPane().getRowConfig().setDefaultItemSize(W);}
,_applyLabelPath:function(Y,X){this._provider.setLabelPath(Y);}
,_applyIconPath:function(bb,ba){this._provider.setIconPath(bb);}
,_applyGroupLabelPath:function(bd,bc){this._provider.setGroupLabelPath(bd);}
,_applyLabelOptions:function(bf,be){this._provider.setLabelOptions(bf);}
,_applyIconOptions:function(bh,bg){this._provider.setIconOptions(bh);}
,_applyGroupLabelOptions:function(bj,bi){this._provider.setGroupLabelOptions(bj);}
,_applyDelegate:function(bl,bk){this._provider.setDelegate(bl);this.__zy();}
,_onResize:function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);}
,_onModelChange:function(e){this.__zy();this._applyDefaultSelection();}
,__zx:function(){this.getPane().getRowConfig().setItemCount(this.__zr.length);this.getPane().fullUpdate();}
,__zy:function(){this.__zr=[];this.__zs=[];this.__zt={};if(this.isAutoGrouping()){this.getGroups().removeAll();}
;var bm=this.getModel();if(bm!=null){this._runDelegateFilter(bm);this._runDelegateSorter(bm);this._runDelegateGroup(bm);}
;this._updateSelection();this.__zx();}
,_runDelegateFilter:function(bo){var bn=qx.util.Delegate.getMethod(this.getDelegate(),C);for(var i=0,l=bo.length;i<l; ++i){if(bn==null||bn(bo.getItem(i))){this.__zr.push(i);}
;}
;}
,_runDelegateSorter:function(bp){if(this.__zr.length==0){return;}
;var bq=qx.util.Delegate.getMethod(this.getDelegate(),s);if(bq!=null){this.__zr.sort(function(a,b){return bq(bp.getItem(a),bp.getItem(b));}
);}
;}
,_runDelegateGroup:function(bu){var bv=qx.util.Delegate.getMethod(this.getDelegate(),u);if(bv!=null){for(var i=0,l=this.__zr.length;i<l; ++i){var br=this.__zr[i];var bt=this.getModel().getItem(br);var bs=bv(bt);this.__zz(bs,br);}
;this.__zr=this.__zA();}
;}
,__zz:function(bx,bw){if(bx==null){this.__zw=true;bx=z;}
;var name=this.__zB(bx);if(this.__zt[name]==null){this.__zt[name]=[];if(this.isAutoGrouping()){this.getGroups().push(bx);}
;}
;this.__zt[name].push(bw);}
,__zA:function(){this.__zC();var bB=[];var bD=0;var bz=this.getGroups();for(var i=0;i<bz.getLength();i++ ){var by=bz.getItem(i);bB.push(-1);this.__zs.push(bD);bD++ ;var bC=this.__zB(by);var bA=this.__zt[bC];if(bA!=null){for(var k=0;k<bA.length;k++ ){bB.push(bA[k]);bD++ ;}
;}
;}
;return bB;}
,__zB:function(bF){var name=null;if(!qx.lang.Type.isString(bF)){var bE=this.getGroups().indexOf(bF);this.__zv=true;name=u;if(bE==-1){name+=this.getGroups().getLength();}
else {name+=bE;}
;}
else {this.__zu=true;var name=bF;}
;return name;}
,__zC:function(){if(this.__zv&&this.__zw||this.__zv&&this.__zu){throw new Error(r+y);}
;}
},destruct:function(){var bG=this.getModel();if(bG!=null){bG.removeListener(m,this._onModelChange,this);}
;var bH=this.getPane();if(bH!=null){bH.removeListener(d,this._onResize,this);}
;this._background.dispose();this._provider.dispose();this._layer.dispose();this._background=this._provider=this._layer=this.__zr=this.__zs=this.__zt=null;if(this.__zq){this.__zq.dispose();}
;}
});}
)();
(function(){var a="qx.ui.virtual.layer.Abstract",b="abstract",c="Abstract method '_fullUpdate' called!";qx.Class.define(a,{extend:qx.ui.core.Widget,type:b,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__iQ={};}
,properties:{anonymous:{refine:true,init:true}},members:{__iQ:null,__bG:null,__zH:null,__zI:null,__zJ:null,__ox:null,getFirstRow:function(){return this.__zH;}
,getFirstColumn:function(){return this.__zI;}
,getRowSizes:function(){return this.__zJ||[];}
,getColumnSizes:function(){return this.__ox||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__iQ.fullUpdate||this.__iQ.updateLayerWindow&&this.__iQ.updateLayerData){this._fullUpdate.apply(this,this.__bG);}
else if(this.__iQ.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bG);}
else if(this.__iQ.updateLayerData&&this.__zJ){this._updateLayerData();}
;if(this.__iQ.fullUpdate||this.__iQ.updateLayerWindow){var d=this.__bG;this.__zH=d[0];this.__zI=d[1];this.__zJ=d[2];this.__ox=d[3];}
;this.__iQ={};}
,_updateLayerData:function(){this._fullUpdate(this.__zH,this.__zI,this.__zJ,this.__ox);}
,_fullUpdate:function(g,i,h,f){throw new Error(c);}
,_updateLayerWindow:function(k,m,l,j){this._fullUpdate(k,m,l,j);}
,updateLayerData:function(){this.__iQ.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(p,q,o,n){this.__bG=arguments;this.__iQ.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bG=arguments;this.__iQ.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__iQ=this.__bG=this.__zJ=this.__ox=null;}
});}
)();
(function(){var a="_applyColorOdd",b="_applyColorEven",c="Color",d="qx.ui.virtual.layer.AbstractBackground";qx.Class.define(d,{extend:qx.ui.virtual.layer.Abstract,construct:function(e,f){qx.ui.virtual.layer.Abstract.call(this);if(e){this.setColorEven(e);}
;if(f){this.setColorOdd(f);}
;this.__Ak={};this.__Al={};}
,properties:{colorEven:{nullable:true,check:c,apply:b,themeable:true},colorOdd:{nullable:true,check:c,apply:a,themeable:true}},members:{__Am:null,__An:null,__Ak:null,__Al:null,setColor:function(h,g){if(g){this.__Ak[h]=qx.theme.manager.Color.getInstance().resolve(g);}
else {delete (this.__Ak[h]);}
;}
,clearCustomColors:function(){this.__Ak={};this.updateLayerData();}
,getColor:function(i){var j=this.__Ak[i];if(j){return j;}
else {return i%2==0?this.__Am:this.__An;}
;}
,_applyColorEven:function(l,k){if(l){this.__Am=qx.theme.manager.Color.getInstance().resolve(l);}
else {this.__Am=null;}
;this.updateLayerData();}
,_applyColorOdd:function(n,m){if(n){this.__An=qx.theme.manager.Color.getInstance().resolve(n);}
else {this.__An=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__Al[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__Al[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__Al[q];}
},destruct:function(){this.__Ak=this.__Al=null;}
});}
)();
(function(){var a="left: 0;",b="width:",c="background-color:",d="qx.ui.virtual.layer.Row",e="",f="block",g="position: absolute;",h="</div>",i="height:",j="row-layer",k="<div style='",l="'>",m=";",n="px;",o="none",p="top:";qx.Class.define(d,{extend:qx.ui.virtual.layer.AbstractBackground,properties:{appearance:{refine:true,init:j}},members:{_fullUpdate:function(x,u,t,w){var A=[];var z=qx.lang.Array.sum(w);var top=0;var D=x;var s=0;for(var y=0;y<t.length;y++ ){var v=this.getColor(D);var B=v?c+v+m:e;var C=this.getBackground(D);var q=C?qx.bom.element.Style.compile(C.getStyles()):e;A.push(k,g,a,p,top,n,i,t[y],n,b,z,n,B,q,l,h);s++ ;top+=t[y];D+=1;}
;var r=this.getContentElement().getDomElement();r.style.display=o;r.innerHTML=A.join(e);r.style.display=f;this._width=z;}
,_updateLayerWindow:function(G,H,F,E){if(G!==this.getFirstRow()||F.length!==this.getRowSizes().length||this._width<qx.lang.Array.sum(E)){this._fullUpdate(G,H,F,E);}
;}
,setColor:function(J,I){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,I);if(this.__AC(J)){this.updateLayerData();}
;}
,setBackground:function(K,L){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,K,L);if(this.__AC(K)){this.updateLayerData();}
;}
,__AC:function(M){var O=this.getFirstRow();var N=O+this.getRowSizes().length-1;return M>=O&&M<=N;}
}});}
)();
...
(function(){var a="qx.ui.virtual.core.IWidgetCellProvider";qx.Interface.define(a,{members:{getCellWidget:function(c,b){}
,poolCellWidget:function(d){}
}});}
)();
(function(){var a="cell.type",b="model[",c="groups[",d="model",f="",g="changeDelegate",h="label",i="qx.ui.list.core.MWidgetController",j="icon",k="]",l="value",m="BindingIds",n=".",o="group",p="String";qx.Mixin.define(i,{construct:function(){this.__zD=[];}
,properties:{labelPath:{check:p,nullable:true},iconPath:{check:p,nullable:true},groupLabelPath:{check:p,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},groupLabelOptions:{nullable:true},delegate:{event:g,init:null,nullable:true}},members:{__zD:null,bindDefaultProperties:function(q,r){if(q.getUserData(a)!=o){this.bindProperty(f,d,null,q,r);this.bindProperty(this.getLabelPath(),h,this.getLabelOptions(),q,r);if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),j,this.getIconOptions(),q,r);}
;}
else {this.bindProperty(this.getGroupLabelPath(),l,this.getGroupLabelOptions(),q,r);}
;}
,bindProperty:function(u,x,v,t,s){var y=t.getUserData(a);var w=this.__zE(s,u,y);if(v){v.ignoreConverter=d;}
;var z=this._list.bind(w,t,x,v);this.__zF(t,z);}
,bindPropertyReverse:function(D,B,E,F,A){var G=F.getUserData(a);var C=this.__zE(A,D,G);var H=F.bind(B,this._list,C,E);this.__zF(F,H);}
,removeBindings:function(){while(this.__zD.length>0){var I=this.__zD.pop();this._removeBindingsFrom(I);}
;}
...
;}
,_bindItem:function(N,P){var O=this.getDelegate();if(O!=null&&O.bindItem!=null){O.bindItem(this,N,P);}
else {this.bindDefaultProperties(N,P);}
;}
,_bindGroupItem:function(Q,S){var R=this.getDelegate();if(R!=null&&R.bindGroupItem!=null){R.bindGroupItem(this,Q,S);}
else {this.bindDefaultProperties(Q,S);}
;}
,_removeBindingsFrom:function(T){var U=this.__zG(T);while(U.length>0){var V=U.pop();try{this._list.removeBinding(V);}
catch(e){T.removeBinding(V);}
;}
;if(qx.lang.Array.contains(this.__zD,T)){qx.lang.Array.remove(this.__zD,T);}
;}
,__zE:function(X,ba,Y){var W=b+X+k;if(Y==o){W=c+X+k;}
;if(ba!=null&&ba!=f){W+=n+ba;}
;return W;}
,__zF:function(bc,bd){var bb=this.__zG(bc);if(!qx.lang.Array.contains(bb,bd)){bb.push(bd);}
;if(!qx.lang.Array.contains(this.__zD,bc)){this.__zD.push(bc);}
;}
,__zG:function(be){var bf=be.getUserData(m);if(bf==null){bf=[];be.setUserData(m,bf);}
;return bf;}
...
,members:{_itemRenderer:null,_groupRenderer:null,getCellWidget:function(n,l){var m=null;if(!this._list._isGroup(n)){m=this._itemRenderer.getCellWidget();m.setUserData(a,g);this._bindItem(m,this._list._lookup(n));if(this._list._manager.isItemSelected(n)){this._styleSelectabled(m);}
else {this._styleUnselectabled(m);}
;}
else {m=this._groupRenderer.getCellWidget();m.setUserData(a,j);this._bindGroupItem(m,this._list._lookupGroup(n));}
;return m;}
,poolCellWidget:function(o){this._removeBindingsFrom(o);if(o.getUserData(a)==g){this._itemRenderer.pool(o);}
else if(o.getUserData(a)==j){this._groupRenderer.pool(o);}
;this._onPool(o);}
,createLayer:function(){return new qx.ui.virtual.layer.WidgetCell(this);}
,createItemRenderer:function(){var p=qx.util.Delegate.getMethod(this.getDelegate(),d);if(p==null){p=function(){return new qx.ui.form.ListItem();}
;}
;var q=new qx.ui.virtual.cell.WidgetCell();q.setDelegate({createWidget:p});return q;}
,createGroupRenderer:function(){var r=qx.util.Delegate.getMethod(this.getDelegate(),h);if(r==null){r=function(){var t=new qx.ui.basic.Label();t.setAppearance(e);return t;}
;}
;var s=new qx.ui.virtual.cell.WidgetCell();s.setDelegate({createWidget:r});return s;}
,styleSelectabled:function(v){var u=this.__zo(v);this._styleSelectabled(u);}
,styleUnselectabled:function(x){var w=this.__zo(x);this._styleUnselectabled(w);}
,isSelectable:function(z){if(this._list._isGroup(z)){return false;}
;var y=this._list._layer.getRenderedCellWidget(z,0);if(y!=null){return y.isEnabled();}
else {return true;}
;}
,_styleSelectabled:function(A){this.__zp(A,{selected:1});}
,_styleUnselectabled:function(B){this.__zp(B,{});}
...
,_onChangeDelegate:function(event){this._itemRenderer.dispose();this._itemRenderer=this.createItemRenderer();this._itemRenderer.addListener(i,this._onItemCreated,this);this._groupRenderer.dispose();this._groupRenderer=this.createGroupRenderer();this._groupRenderer.addListener(i,this._onGroupItemCreated,this);this.removeBindings();this._list.getPane().fullUpdate();}
,__zo:function(G){return this._list._layer.getRenderedCellWidget(G,0);}
,__zp:function(I,H){if(I==null){return;}
;this._itemRenderer.updateStates(I,H);}
},destruct:function(){this._itemRenderer.dispose();this._groupRenderer.dispose();this._itemRenderer=this._groupRenderer=null;}
});}
)();
(function(){var a="cell.column",b="qx.debug",c="qx.event.type.Event",d="qx.ui.virtual.layer.WidgetCell",e="cell.row",f="updated",g="cell.empty";qx.Class.define(d,{extend:qx.ui.virtual.layer.Abstract,include:[qx.ui.core.MChildrenHandling],construct:function(h){qx.ui.virtual.layer.Abstract.call(this);this.setZIndex(12);if(qx.core.Environment.get(b)){this.assertInterface(h,qx.ui.virtual.core.IWidgetCellProvider);}
;this._cellProvider=h;this.__zY=[];}
,properties:{anonymous:{refine:true,init:false}},events:{updated:c},members:{__zY:null,getRenderedCellWidget:function(q,n){var j=this.getColumnSizes().length;var p=this.getRowSizes().length;var o=this.getFirstRow();var m=this.getFirstColumn();if(q<o||q>=o+p||n<m||n>=m+j){return null;}
;var l=(n-m)+(q-o)*j;var k=this._getChildren()[l];if(k.getUserData(g)){return null;}
else {return k;}
;}
,_getSpacer:function(){var r=this.__zY.pop();if(!r){r=new qx.ui.core.Spacer();r.setUserData(g,1);}
;return r;}
,_activateNotEmptyChild:function(s){var t=qx.ui.core.FocusHandler.getInstance().getActiveWidget();if(t==s||qx.ui.core.Widget.contains(s,t)){var u=this._getChildren();for(var i=u.length-1;i>=0;i-- ){if(!u[i].getUserData(g)){u[i].activate();break;}
;}
;}
;}
,_fullUpdate:function(A,v,D,z){var B=this._cellProvider;var G=this._getChildren();for(var i=0;i<G.length;i++ ){var E=G[i];if(E.getUserData(g)){this.__zY.push(E);}
else {this._activateNotEmptyChild(E);B.poolCellWidget(E);}
;}
;this._removeAll();var top=0;var F=0;for(var y=0;y<D.length;y++ ){for(var x=0;x<z.length;x++ ){var H=A+y;var w=v+x;var C=B.getCellWidget(H,w)||this._getSpacer();C.setUserBounds(F,top,z[x],D[y]);C.setUserData(e,H);C.setUserData(a,w);this._add(C);F+=z[x];}
;top+=D[y];F=0;}
;this.fireEvent(f);}
,_updateLayerWindow:function(U,I,L,X){if(qx.core.Environment.get(b)){this.assertPositiveInteger(U);this.assertPositiveInteger(I);this.assertArray(L);this.assertArray(X);}
;var M=U+L.length-1;var V=I+X.length-1;var K={firstRow:Math.max(U,this.getFirstRow()),lastRow:Math.min(M,this._lastRow),firstColumn:Math.max(I,this.getFirstColumn()),lastColumn:Math.min(V,this._lastColumn)};this._lastColumn=V;this._lastRow=M;if(K.firstRow>K.lastRow||K.firstColumn>K.lastColumn){return this._fullUpdate(U,I,L,X);}
;var N=this._getChildren();var P=this.getColumnSizes().length;var S=[];var W={};for(var O=U;O<=M;O++ ){S[O]=[];for(var Y=I;Y<=V;Y++ ){if(O>=K.firstRow&&O<=K.lastRow&&Y>=K.firstColumn&&Y<=K.lastColumn){var x=Y-this.getFirstColumn();var y=O-this.getFirstRow();var Q=y*P+x;S[O][Y]=N[Q];W[Q]=true;}
;}
;}
;var J=this._cellProvider;var N=this._getChildren();for(var i=0;i<N.length;i++ ){if(!W[i]){var T=N[i];if(T.getUserData(g)){this.__zY.push(T);}
else {this._activateNotEmptyChild(T);J.poolCellWidget(T);}
;}
;}
;this._removeAll();var top=0;var ba=0;for(var y=0;y<L.length;y++ ){for(var x=0;x<X.length;x++ ){var O=U+y;var Y=I+x;var R=S[O][Y]||J.getCellWidget(O,Y)||this._getSpacer();R.setUserBounds(ba,top,X[x],L[y]);R.setUserData(e,O);R.setUserData(a,Y);this._add(R);ba+=X[x];}
;top+=L[y];ba=0;}
;this.fireEvent(f);}
},destruct:function(){var bb=this._getChildren();for(var i=0;i<bb.length;i++ ){bb[i].dispose();}
;this._cellProvider=this.__zY=null;}
});}
)();
...
;return null;}
,containsMethod:function(e,f){var d=qx.lang.Type;if(d.isObject(e)){return d.isFunction(e[f]);}
;return false;}
}});}
)();
(function(){var a="qx.ui.virtual.cell.IWidgetCell";qx.Interface.define(a,{members:{getCellWidget:function(c,b){}
,pool:function(d){}
,updateStates:function(f,e){}
,updateData:function(g,h){}
}});}
)();
(function(){var a="created",b="qx.ui.virtual.cell.AbstractWidget",c="cell.states",d="abstract method call",e="qx.event.type.Data";qx.Class.define(b,{extend:qx.core.Object,implement:[qx.ui.virtual.cell.IWidgetCell],construct:function(){qx.core.Object.call(this);this.__cM=[];}
,events:{"created":e},members:{__cM:null,_createWidget:function(){throw new Error(d);}
,updateData:function(f,g){throw new Error(d);}
,updateStates:function(j,h){var k=j.getUserData(c);if(k){var i=h||{};for(var l in k){if(!i[l]){j.removeState(l);}
;}
;}
else {k={};}
;if(h){for(var l in h){if(!k.state){j.addState(l);}
;}
;}
;j.setUserData(c,h);}
,getCellWidget:function(o,m){var n=this.__Ao();this.updateStates(n,m);this.updateData(n,o);return n;}
,pool:function(p){this.__cM.push(p);}
,_cleanupPool:function(){var q=this.__cM.pop();while(q){q.destroy();q=this.__cM.pop();}
;}
,__Ao:function(){var r=this.__cM.pop();if(r==null){r=this._createWidget();this.fireDataEvent(a,r);}
;return r;}
},destruct:function(){this._cleanupPool();this.__cM=null;}
});}
)();
(function(){var a="_applyDelegate",b="qx.ui.virtual.cell.WidgetCell",c="Can't update data! The key '",d="' is not a Property!";qx.Class.define(b,{extend:qx.ui.virtual.cell.AbstractWidget,properties:{delegate:{apply:a,init:null,nullable:true}},members:{_applyDelegate:function(f,e){this._cleanupPool();}
...
else {throw new Error(c+j+d);}
;}
;}
}});}
)();
(function(){var a="changeModel",b="qx.ui.form.MModelProperty";qx.Mixin.define(b,{properties:{model:{nullable:true,event:a,dereference:true}}});}
)();
...
(function(){var a="hovered",b="Enter",c="pressed",d="qx.data.Array",e="mouseout",f="Space",g="abandoned",h="qx.event.type.Data",j="open",k="list",l="interval",m="qx.ui.form.VirtualSelectBox",n="arrow",o="changeSelection",p="selection",q="search",r="_applySelection",s="",t="icon",u="spacer",v="mouseover",w="dropdown",x="converter",y="click",z="model",A="label",B=" ",C="virtual-selectbox",D="atom";qx.Class.define(m,{extend:qx.ui.form.core.AbstractVirtualBox,implement:qx.data.controller.ISelection,construct:function(E){qx.ui.form.core.AbstractVirtualBox.call(this,E);this._createChildControl(D);this._createChildControl(u);this._createChildControl(n);this.addListener(v,this._onMouseOver,this);this.addListener(e,this._onMouseOut,this);this.__bc=[];this.initSelection(this.getChildControl(w).getSelection());this.__vc=new qx.event.Timer(500);this.__vc.addListener(l,this.__ve,this);}
,properties:{appearance:{refine:true,init:C},width:{refine:true,init:120},selection:{check:d,event:o,apply:r,nullable:false,deferredInit:true}},events:{"changeSelection":h},members:{__vd:s,__vc:null,__bc:null,syncWidget:function(F){this._removeBindings();this._addBindings();}
,_createChildControlImpl:function(I,H){var G;switch(I){case u:G=new qx.ui.core.Spacer();this._add(G,{flex:1});break;case D:G=new qx.ui.form.ListItem(s);G.setCenter(false);G.setAnonymous(true);this._add(G,{flex:1});break;case n:G=new qx.ui.basic.Image();G.setAnonymous(true);this._add(G);break;};return G||qx.ui.form.core.AbstractVirtualBox.prototype._createChildControlImpl.call(this,I,H);}
,_getAction:function(event){var J=event.getKeyIdentifier();var L=this.getChildControl(w).isVisible();var K=this._isModifierPressed(event);if(!L&&!K&&(J===b||J===f)){return j;}
else if(L&&event.isPrintable()){return q;}
else {return qx.ui.form.core.AbstractVirtualBox.prototype._getAction.call(this,event);}
;}
,_addBindings:function(){var N=this.getChildControl(D);var P=this._getBindPath(p,s);var M=this.bind(P,N,z,null);this.__bc.push(M);var O=this._getBindPath(p,this.getLabelPath());M=this.bind(O,N,A,this.getLabelOptions());this.__bc.push(M);if(this.getIconPath()!=null){var Q=this._getBindPath(p,this.getIconPath());M=this.bind(Q,N,t,this.getIconOptions());this.__bc.push(M);}
;}
,_removeBindings:function(){while(this.__bc.length>0){var R=this.__bc.pop();this.removeBinding(R);}
;}
,_handleMouse:function(event){qx.ui.form.core.AbstractVirtualBox.prototype._handleMouse.call(this,event);var S=event.getType();if(S===y){this.toggle();}
;}
,_handleKeyboard:function(event){var T=this._getAction(event);switch(T){case q:this.__vd+=this.__vf(event.getKeyIdentifier());this.__vc.restart();break;default:qx.ui.form.core.AbstractVirtualBox.prototype._handleKeyboard.call(this,event);break;};}
,_onMouseOver:function(event){if(!this.isEnabled()||event.getTarget()!==this){return;}
;if(this.hasState(g)){this.removeState(g);this.addState(c);}
;this.addState(a);}
,_onMouseOut:function(event){if(!this.isEnabled()||event.getTarget()!==this){return;}
;this.removeState(a);if(this.hasState(c)){this.removeState(c);this.addState(g);}
;}
,_applySelection:function(V,U){this.getChildControl(w).setSelection(V);qx.ui.core.queue.Widget.add(this);}
,__ve:function(){this.__vc.stop();var Y=this.__vd;if(Y==null||Y==s){return;}
;var bg=this.getModel();var bb=this.getChildControl(w).getChildControl(k);var W=bb.getSelection();var length=bb._getLookupTable().length;var bf=bg.indexOf(W.getItem(0));var bd=bb._reverseLookup(bf);for(var i=1;i<=length;i++ ){var bh=(i+bd)%length;var be=bg.getItem(bb._lookup(bh));var bc=be;if(this.getLabelPath()!=null){bc=qx.data.SingleValueBinding.resolvePropertyChain(be,this.getLabelPath());var ba=this.getLabelOptions();if(ba!=null){var X=qx.util.Delegate.getMethod(ba,x);if(X!=null){bc=X(bc,be);}
;}
;}
;if(qx.lang.String.startsWith(bc.toLowerCase(),Y.toLowerCase())){W.push(be);break;}
;}
;this.__vd=s;}
,__vf:function(bi){if(bi===f){return B;}
else {return bi;}
;}
},destruct:function(){this._removeBindings();this.__vc.removeListener(l,this.__ve,this);this.__vc.dispose();this.__vc=null;}
});}
)();
...
(function(){var a='"',b="The model contained an illegal name: '",c="",d="qx.debug.databinding",e="change",f="qx.data.marshal.Json",g="Array",h="Unsupported type!",j="_validate",k="'.",l="'. Replaced it with '",m="set",n="' is not a valid JavaScript identifier.",o="_applyEventPropagation",p="qx.data.model.",q="qx.debug",r="The key '";qx.Class.define(f,{extend:qx.core.Object,implement:[qx.data.marshal.IMarshaler],construct:function(s){qx.core.Object.call(this);this.__tr=s;}
...
},members:{__tr:null,__ts:function(v){return Object.keys(v).sort().join(a);}
,toClass:function(w,x){this.__tt(w,x,null,0);}
,__tt:function(J,E,y,G){if(!qx.lang.Type.isObject(J)||!!J.$$isString||J instanceof qx.core.Object){if(J instanceof Array||qx.Bootstrap.getClass(J)==g){for(var i=0;i<J.length;i++ ){this.__tt(J[i],E,null,G+1);}
;}
;return;}
;var A=this.__ts(J);if(this.__tx(A,y,G)){return;}
;for(var I in J){this.__tt(J[I],E,I,G+1);}
;if(qx.Class.isDefined(p+A)){return;}
;if(this.__tr&&this.__tr.getModelClass&&this.__tr.getModelClass(A,J)!=null){return;}
;var K={};var B={__tu:this.__tu};for(var I in J){if(this.__tr&&this.__tr.getPropertyMapping){I=this.__tr.getPropertyMapping(I,A);}
;I=I.replace(/-|\.|\s+/g,c);if(qx.core.Environment.get(q)){this.assertTrue((/^[$0-9A-Za-z_]*$/).test(I),r+I+n);}
;K[I]={};K[I].nullable=true;K[I].event=e+qx.lang.String.firstUp(I);if(E){K[I].apply=o;}
;if(this.__tr&&this.__tr.getValidationRule){var D=this.__tr.getValidationRule(A,I);if(D){K[I].validate=j+I;B[j+I]=D;}
;}
;}
;if(this.__tr&&this.__tr.getModelSuperClass){var H=this.__tr.getModelSuperClass(A)||qx.core.Object;}
else {var H=qx.core.Object;}
;var C=[];if(this.__tr&&this.__tr.getModelMixins){var F=this.__tr.getModelMixins(A);if(!qx.lang.Type.isArray(F)){if(F!=null){C=[F];}
;}
else {C=F;}
;}
;if(E){C.push(qx.data.marshal.MEventBubbling);}
;var z={extend:H,include:C,properties:K,members:B,destruct:this.__tv};qx.Class.define(p+A,z);}
,__tv:function(){var L=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var M in L){this.__tu(this.get(L[M].name));}
;}
,__tu:function(N){if(!(N instanceof qx.core.Object)){return;}
;if(N.isDisposed()){return;}
;N.dispose();}
,__tw:function(P,O){var Q;if(this.__tr&&this.__tr.getModelClass){Q=this.__tr.getModelClass(P,O);}
;if(Q!=null){return (new Q());}
else {var R=qx.Class.getByName(p+P);return (new R());}
;}
,__tx:function(S,V,T){var U=this.__tr;return U&&U.ignore&&U.ignore(S,V,T);}
,toModel:function(W){return this.__ty(W,null,0);}
,__ty:function(bh,Y,be){var bd=qx.lang.Type.isObject(bh);var X=bh instanceof Array||qx.Bootstrap.getClass(bh)==g;if((!bd&&!X)||!!bh.$$isString||bh instanceof qx.core.Object){return bh;}
else if(this.__tx(this.__ts(bh),Y,be)){return bh;}
else if(X){var bi=new qx.data.Array();bi.setAutoDisposeItems(true);for(var i=0;i<bh.length;i++ ){bi.push(this.__ty(bh[i],null,be+1));}
;return bi;}
else if(bd){var ba=this.__ts(bh);var bg=this.__tw(ba,bh);for(var bf in bh){var bb=bf;if(this.__tr&&this.__tr.getPropertyMapping){bb=this.__tr.getPropertyMapping(bf,ba);}
;var bj=bb.replace(/-|\.|\s+/g,c);if((qx.core.Environment.get(q))&&qx.core.Environment.get(d)){if(bj!=bb){this.warn(b+bf+l+bb+k);}
;}
;bb=bj;var bc=m+qx.lang.String.firstUp(bb);if(bg[bc]){bg[bc](this.__ty(bh[bf],bf,be+1));}
;}
;return bg;}
;throw new Error(h);}
...
(function(){var a="changeModel",b="application/json",c="json",d="aborted",e="loaded",f="qx.event.type.Data",g="error",h="fail",i="receiving",j="queued",k="changeState",l="__rU",m="success",n="String",o="changePhase",p="sending",q="_marshaler",r="completed",s="failed",t="qx.data.store.Json",u="configured",v="changeUrl",w="timeout",x="_applyUrl";qx.Class.define(t,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);this._marshaler=new qx.data.marshal.Json(z);this._delegate=z;if(y!=null){this.setUrl(y);}
;}
,events:{"loaded":f,"error":f},properties:{model:{nullable:true,event:a},state:{check:[u,j,p,i,r,d,w,s],init:u,event:k},url:{check:n,apply:x,event:v,nullable:true}},members:{_marshaler:null,_delegate:null,__rU:null,_applyUrl:function(B,A){if(B!=null){B=qx.util.AliasManager.getInstance().resolve(B);B=qx.util.ResourceManager.getInstance().toUri(B);this._createRequest(B);}
;}
,_getRequest:function(){return this.__rU;}
,_setRequest:function(C){this.__rU=C;}
,_createRequest:function(D){if(this.__rU){this.__rU.dispose();this.__rU=null;}
;var E=new qx.io.request.Xhr(D);this._setRequest(E);E.setAccept(b);E.setParser(c);E.addListener(m,this._onSuccess,this);var F=this._delegate;if(F&&qx.lang.Type.isFunction(F.configureRequest)){this._delegate.configureRequest(E);}
;E.addListener(o,this._onChangePhase,this);E.addListener(h,this._onFail,this);E.send();}
,_onChangePhase:function(I){var G=I.getData(),J={},H;J={"opened":u,"sent":p,"loading":i,"success":r,"abort":d,"timeout":w,"statusError":s};H=J[G];if(H){this.setState(H);}
;}
,_onFail:function(K){var L=K.getTarget();this.fireDataEvent(g,L);}
,_onSuccess:function(Q){if(this.isDisposed()){return;}
;var N=Q.getTarget(),M=N.getResponse();var O=this._delegate;if(O&&qx.lang.Type.isFunction(O.manipulateData)){M=this._delegate.manipulateData(M);}
;this._marshaler.toClass(M,true);var P=this.getModel();this.setModel(this._marshaler.toModel(M));if(P&&P.dispose){P.dispose();}
;this.fireDataEvent(e,this.getModel());if(this.__rU){this.__rU.dispose();this.__rU=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__rU!=null){this._disposeObjects(l);}
;this._disposeSingletonObjects(q);this._delegate=null;}
});}
)();
(function(){var a="loadEnd",b="qx.io.request.AbstractRequest",c="changePhase",d="Open low-level request with method: ",f="qx.debug.io",g="sent",h="Abort request",i="qx.event.type.Data",j="'",k="qx.io.request.authentication.IAuthentication",l="error",m="qx.debug",n="fail",o="Send low-level request",p="loading",q="load",r="qx.event.type.Event",s="abort",t=", url: ",u="String",v="",w="opened",x="Response is of type: '",y="POST",z="success",A="Request completed with HTTP status: ",B="Fire readyState: ",C="statusError",D="readyStateChange",E="Abstract method call",F="abstract",G="unsent",H="changeResponse",I="Number",J="Content-Type",K="timeout",L="undefined",M=", async: ",N="GET";qx.Class.define(b,{type:F,extend:qx.core.Object,construct:function(O){qx.core.Object.call(this);if(O!==undefined){this.setUrl(O);}
;this.__rE={};var P=this._transport=this._createTransport();this._setPhase(G);this.__tK=qx.lang.Function.bind(this._onReadyStateChange,this);this.__tL=qx.lang.Function.bind(this._onLoad,this);this.__tM=qx.lang.Function.bind(this._onLoadEnd,this);this.__tN=qx.lang.Function.bind(this._onAbort,this);this.__tO=qx.lang.Function.bind(this._onTimeout,this);this.__tP=qx.lang.Function.bind(this._onError,this);P.onreadystatechange=this.__tK;P.onload=this.__tL;P.onloadend=this.__tM;P.onabort=this.__tN;P.ontimeout=this.__tO;P.onerror=this.__tP;}
,events:{"readyStateChange":r,"success":r,"load":r,"loadEnd":r,"abort":r,"timeout":r,"error":r,"statusError":r,"fail":r,"changeResponse":i,"changePhase":i},properties:{url:{check:u},timeout:{check:I,nullable:true,init:0},requestData:{check:function(Q){return qx.lang.Type.isString(Q)||qx.Class.isSubClassOf(Q.constructor,qx.core.Object)||qx.lang.Type.isObject(Q);}
,nullable:true},authentication:{check:k,nullable:true}},members:{__tK:null,__tL:null,__tM:null,__tN:null,__tO:null,__tP:null,__tQ:null,__tR:null,__tS:null,__rE:null,__tT:null,_transport:null,_createTransport:function(){throw new Error(E);}
,_getConfiguredUrl:function(){}
,_getConfiguredRequestHeaders:function(){}
,_getParsedResponse:function(){throw new Error(E);}
,_getMethod:function(){return N;}
,_isAsync:function(){return true;}
,send:function(){var V=this._transport,R,U,S,T;R=this._getConfiguredUrl();if(/\#/.test(R)){R=R.replace(/\#.*/,v);}
;V.timeout=this.getTimeout();U=this._getMethod();S=this._isAsync();if(qx.core.Environment.get(f)){this.debug(d+U+t+R+M+S);}
;V.open(U,R,S);this._setPhase(w);T=this._serializeData(this.getRequestData());this._setRequestHeaders();if(qx.core.Environment.get(f)){this.debug(o);}
;U==N?V.send():V.send(T);this._setPhase(g);}
,abort:function(){if(qx.core.Environment.get(f)){this.debug(h);}
;this.__tR=true;this.__tS=s;this._transport.abort();}
,_setRequestHeaders:function(){var X=this._transport,W=this._getAllRequestHeaders();for(var Y in W){X.setRequestHeader(Y,W[Y]);}
;}
,_getAllRequestHeaders:function(){var ba={};qx.lang.Object.mergeWith(ba,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(ba,this.__tU());qx.lang.Object.mergeWith(ba,this.__tT);qx.lang.Object.mergeWith(ba,this.__rE);return ba;}
,__tU:function(){var bc=this.getAuthentication(),bb={};if(bc){bc.getAuthHeaders().forEach(function(bd){bb[bd.key]=bd.value;}
);return bb;}
;}
,setRequestHeader:function(be,bf){this.__rE[be]=bf;}
,getRequestHeader:function(bg){return this.__rE[bg];}
,removeRequestHeader:function(bh){if(this.__rE[bh]){delete this.__rE[bh];}
;}
,getTransport:function(){return this._transport;}
,getReadyState:function(){return this._transport.readyState;}
,getPhase:function(){return this.__tS;}
...
,getResponseHeader:function(bi){return this._transport.getResponseHeader(bi);}
,getResponseContentType:function(){return this.getResponseHeader(J);}
,isDone:function(){return this.getReadyState()===4;}
,getResponse:function(){return this.__tQ;}
,_setResponse:function(bk){var bj=bk;if(this.__tQ!==bk){this.__tQ=bk;this.fireEvent(H,qx.event.type.Data,[this.__tQ,bj]);}
;}
,_onReadyStateChange:function(){var bl=this.getReadyState();if(qx.core.Environment.get(f)){this.debug(B+bl);}
;this.fireEvent(D);if(this.__tR){return;}
;if(bl===3){this._setPhase(p);}
;if(this.isDone()){this.__tV();}
;}
,__tV:function(){if(qx.core.Environment.get(f)){this.debug(A+this.getStatus());}
;this._setPhase(q);if(qx.util.Request.isSuccessful(this.getStatus())){if(qx.core.Environment.get(f)){this.debug(x+this.getResponseContentType()+j);}
;this._setResponse(this._getParsedResponse());this._fireStatefulEvent(z);}
else {try{this._setResponse(this._getParsedResponse());}
catch(e){}
;if(this.getStatus()!==0){this._fireStatefulEvent(C);this.fireEvent(n);}
;}
;}
,_onLoad:function(){this.fireEvent(q);}
,_onLoadEnd:function(){this.fireEvent(a);}
,_onAbort:function(){this._fireStatefulEvent(s);}
,_onTimeout:function(){this._fireStatefulEvent(K);this.fireEvent(n);}
,_onError:function(){this.fireEvent(l);this.fireEvent(n);}
,_fireStatefulEvent:function(bm){if(qx.core.Environment.get(m)){qx.core.Assert.assertString(bm);}
;this._setPhase(bm);this.fireEvent(bm);}
,_setPhase:function(bn){var bo=this.__tS;if(qx.core.Environment.get(m)){qx.core.Assert.assertString(bn);qx.core.Assert.assertMatch(bn,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__tS=bn;this.fireDataEvent(c,bn,bo);}
,_serializeData:function(br){var bp=typeof this.getMethod!==L&&this.getMethod()==y,bq=(/application\/.*\+?json/).test(this.getRequestHeader(J));if(!br){return null;}
;if(qx.lang.Type.isString(br)){return br;}
;if(qx.Class.isSubClassOf(br.constructor,qx.core.Object)){return qx.util.Serializer.toUriParameter(br);}
;if(bq&&(qx.lang.Type.isObject(br)||qx.lang.Type.isArray(br))){return qx.lang.Json.stringify(br);}
;if(qx.lang.Type.isObject(br)){return qx.util.Uri.toParameter(br,bp);}
;}
},environment:{"qx.debug.io":false},destruct:function(){var bt=this._transport,bs=function(){}
;if(this._transport){bt.onreadystatechange=bt.onload=bt.onloadend=bt.onabort=bt.ontimeout=bt.onerror=bs;bt.dispose();}
;}
});}
)();
...
(function(){var a="qx.util.Serializer",b='\\\\',c='\\f',d='"',e="null",f='\\"',g="}",h="get",j="{",k='\\r',l="",m='\\t',n="]",o="Class",p="Interface",q="[",r="Mixin",s='":',t="&",u='\\b',v="=",w='\\n',x=",";qx.Class.define(a,{statics:{toUriParameter:function(z,C,y){var E=l;var B=qx.util.PropertyUtil.getAllProperties(z.constructor);for(var name in B){if(B[name].group!=undefined){continue;}
;var A=z[h+qx.lang.String.firstUp(name)]();if(qx.lang.Type.isArray(A)){var D=qx.data&&qx.data.IListData&&qx.Class.hasInterface(A&&A.constructor,qx.data.IListData);for(var i=0;i<A.length;i++ ){var F=D?A.getItem(i):A[i];E+=this.__tW(name,F,C);}
;}
else if(qx.lang.Type.isDate(A)&&y!=null){E+=this.__tW(name,y.format(A),C);}
else {E+=this.__tW(name,A,C);}
;}
;return E.substring(0,E.length-1);}
,__tW:function(name,I,G){if(I&&I.$$type==o){I=I.classname;}
;if(I&&(I.$$type==p||I.$$type==r)){I=I.name;}
;if(I instanceof qx.core.Object&&G!=null){var H=encodeURIComponent(G(I));if(H===undefined){var H=encodeURIComponent(I);}
;}
else {var H=encodeURIComponent(I);}
;return encodeURIComponent(name)+v+H+t;}
,toNativeObject:function(L,N,K){var O;if(L==null){return null;}
;if(qx.data&&qx.data.IListData&&qx.Class.hasInterface(L.constructor,qx.data.IListData)){O=[];for(var i=0;i<L.getLength();i++ ){O.push(qx.util.Serializer.toNativeObject(L.getItem(i),N,K));}
;return O;}
;if(qx.lang.Type.isArray(L)){O=[];for(var i=0;i<L.length;i++ ){O.push(qx.util.Serializer.toNativeObject(L[i],N,K));}
;return O;}
;if(L.$$type==o){return L.classname;}
;if(L.$$type==p||L.$$type==r){return L.name;}
;if(L instanceof qx.core.Object){if(N!=null){var J=N(L);if(J!=undefined){return J;}
;}
;O={};var Q=qx.util.PropertyUtil.getAllProperties(L.constructor);for(var name in Q){if(Q[name].group!=undefined){continue;}
;var M=L[h+qx.lang.String.firstUp(name)]();O[name]=qx.util.Serializer.toNativeObject(M,N,K);}
;return O;}
;if(qx.lang.Type.isDate(L)&&K!=null){return K.format(L);}
;if(qx.locale&&qx.locale.LocalizedString&&L instanceof qx.locale.LocalizedString){return L.toString();}
;if(qx.lang.Type.isObject(L)){O={};for(var P in L){O[P]=qx.util.Serializer.toNativeObject(L[P],N,K);}
;return O;}
;return L;}
,toJson:function(T,V,S){var W=l;if(T==null){return e;}
;if(qx.data&&qx.data.IListData&&qx.Class.hasInterface(T.constructor,qx.data.IListData)){W+=q;for(var i=0;i<T.getLength();i++ ){W+=qx.util.Serializer.toJson(T.getItem(i),V,S)+x;}
;if(W!=q){W=W.substring(0,W.length-1);}
;return W+n;}
;if(qx.lang.Type.isArray(T)){W+=q;for(var i=0;i<T.length;i++ ){W+=qx.util.Serializer.toJson(T[i],V,S)+x;}
;if(W!=q){W=W.substring(0,W.length-1);}
;return W+n;}
;if(T.$$type==o){return d+T.classname+d;}
;if(T.$$type==p||T.$$type==r){return d+T.name+d;}
;if(T instanceof qx.core.Object){if(V!=null){var R=V(T);if(R!=undefined){return d+R+d;}
;}
;W+=j;var Y=qx.util.PropertyUtil.getAllProperties(T.constructor);for(var name in Y){if(Y[name].group!=undefined){continue;}
;var U=T[h+qx.lang.String.firstUp(name)]();W+=d+name+s+qx.util.Serializer.toJson(U,V,S)+x;}
;if(W!=j){W=W.substring(0,W.length-1);}
;return W+g;}
;if(qx.locale&&qx.locale.LocalizedString&&T instanceof qx.locale.LocalizedString){T=T.toString();}
;if(qx.lang.Type.isDate(T)&&S!=null){return d+S.format(T)+d;}
;if(qx.lang.Type.isObject(T)){W+=j;for(var X in T){W+=d+X+s+qx.util.Serializer.toJson(T[X],V,S)+x;}
;if(W!=j){W=W.substring(0,W.length-1);}
;return W+g;}
;if(qx.lang.Type.isString(T)){T=T.replace(/([\\])/g,b);T=T.replace(/(["])/g,f);T=T.replace(/([\r])/g,k);T=T.replace(/([\f])/g,c);T=T.replace(/([\n])/g,w);T=T.replace(/([\t])/g,m);T=T.replace(/([\b])/g,u);return d+T+d;}
...
(function(){var a="Retry open native request with method: ",b="activex",c="No XHR support available.",d="If-None-Match",f="xhr",g="If-Modified-Since",h="engine.version",i="onunload",j="GET",k="-1",l="qx.debug.io",m="Open native request with method: ",n="error",o="loadend",p="load",q="Received native readyState: ",r="abort",s=", url: ",t="browser.documentmode",u="",v="readystatechange",w="Microsoft.XMLHTTP",x="Already disposed",y="browser.version",z="opera",A="qx.bom.request.Xhr",B="on",C="gecko",D="If-Match",E="mshtml",F="engine.name",G="Microsoft.XMLDOM",H="file:",I="Send native request",J="If-Range",K="Content-Type",L="io.xhr",M="Not enough arguments",N="timeout",O="undefined",P=", async: ";qx.Bootstrap.define(A,{extend:Object,construct:function(){var Q=qx.Bootstrap.bind(this.__um,this);if(qx.event&&qx.event.GlobalError&&qx.event.GlobalError.observeMethod){this.__tY=qx.event.GlobalError.observeMethod(Q);}
else {this.__tY=Q;}
;this.__ua=qx.Bootstrap.bind(this.__ul,this);this.__tO=qx.Bootstrap.bind(this.__uq,this);this.__uk();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__ub=qx.Bootstrap.bind(this.__ut,this);window.attachEvent(i,this.__ub);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":A,"error":A,"loadend":A,"timeout":A,"abort":A,"load":A},members:{readyState:0,responseText:u,responseXML:null,status:0,statusText:u,timeout:0,open:function(V,R,S,U,T){this.__uv();if(typeof R===O){throw new Error(M);}
else if(typeof V===O){V=j;}
;this.__tR=false;this.__uc=false;this.__ud=false;this.__ue=R;if(typeof S==O){S=true;}
;this.__uf=S;if(!this.__uu()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__uk();}
;this.__uh.onreadystatechange=this.__tY;try{if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,m+V+s+R+P+S);}
;this.__uh.open(V,R,S,U,T);}
catch(W){if(!qx.util.Request.isCrossDomain(R)){throw W;}
;if(!this.__uf){this.__ug=W;}
;if(this.__uf){if(window.XDomainRequest){this.readyState=4;this.__uh=new XDomainRequest();this.__uh.onerror=qx.Bootstrap.bind(function(){this._emit(v);this._emit(n);this._emit(o);}
,this);if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,a+V+s+R+P+S);}
;this.__uh.open(V,R,S,U,T);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__uj){return;}
;this.readyState=4;this._emit(v);this._emit(n);this._emit(o);}
,this));}
;}
;if(qx.core.Environment.get(F)===E&&qx.core.Environment.get(t)<9&&this.__uh.readyState>0){this.__uh.setRequestHeader(g,k);}
;if(qx.core.Environment.get(F)===C&&parseInt(qx.core.Environment.get(h),10)<2&&!this.__uf){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(v);}
;}
,setRequestHeader:function(X,Y){this.__uv();if(X==D||X==g||X==d||X==J){this.__ud=true;}
;this.__uh.setRequestHeader(X,Y);return this;}
,send:function(ba){this.__uv();if(!this.__uf&&this.__ug){throw this.__ug;}
;if(qx.core.Environment.get(F)===z&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__ui=window.setTimeout(this.__tO,this.timeout);}
;ba=typeof ba==O?null:ba;try{if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,I);}
;this.__uh.send(ba);}
catch(bc){if(!this.__uf){throw bc;}
;if(this._getProtocol()===H){this.readyState=2;this.__un();var bb=this;window.setTimeout(function(){if(bb.__uj){return;}
;bb.readyState=3;bb.__un();bb.readyState=4;bb.__un();}
);}
;}
;if(qx.core.Environment.get(F)===C&&!this.__uf){this.__um();}
;this.__uc=true;return this;}
,abort:function(){this.__uv();this.__tR=true;this.__uh.abort();if(this.__uh){this.readyState=this.__uh.readyState;}
;return this;}
,_emit:function(event){if(this[B+event]){this[B+event]();}
...
,onabort:function(){}
,ontimeout:function(){}
,on:function(name,bd,be){this._emitter.on(name,bd,be);return this;}
,getResponseHeader:function(bf){this.__uv();return this.__uh.getResponseHeader(bf);}
,getAllResponseHeaders:function(){this.__uv();return this.__uh.getAllResponseHeaders();}
,getRequest:function(){return this.__uh;}
,dispose:function(){if(this.__uj){return false;}
;window.clearTimeout(this.__ui);if(window.detachEvent){window.detachEvent(i,this.__ub);}
;try{this.__uh.onreadystatechange;}
catch(bh){return false;}
;var bg=function(){}
;this.__uh.onreadystatechange=bg;this.__uh.onload=bg;this.__uh.onerror=bg;this.abort();this.__uh=null;this.__uj=true;return true;}
,isDisposed:function(){return !!this.__uj;}
,_createNativeXhr:function(){var bi=qx.core.Environment.get(L);if(bi===f){return new XMLHttpRequest();}
;if(bi==b){return new window.ActiveXObject(w);}
;qx.Bootstrap.error(this,c);}
,_getProtocol:function(){var bj=this.__ue;var bk=/^(\w+:)\/\//;if(bj!==null&&bj.match){var bl=bj.match(bk);if(bl&&bl[1]){return bl[1];}
;}
;return window.location.protocol;}
,__uh:null,__uf:null,__tY:null,__ua:null,__ub:null,__tO:null,__uc:null,__ue:null,__tR:null,__eS:null,__uj:null,__ui:null,__ug:null,__ud:null,__uk:function(){this.__uh=this._createNativeXhr();this.__uh.onreadystatechange=this.__tY;if(this.__uh.onabort){this.__uh.onabort=this.__ua;}
;this.__uj=this.__uc=this.__tR=false;}
,__ul:function(){if(!this.__tR){this.abort();}
;}
,__um:function(){var bm=this.__uh,bn=true;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,q+bm.readyState);}
;if(this.readyState==bm.readyState){return;}
;this.readyState=bm.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__tR&&!this.__uc){return;}
;if(!this.__uf&&(bm.readyState==2||bm.readyState==3)){return;}
;this.status=0;this.statusText=this.responseText=u;this.responseXML=null;if(this.readyState>=qx.bom.request.Xhr.HEADERS_RECEIVED){try{this.status=bm.status;this.statusText=bm.statusText;this.responseText=bm.responseText;this.responseXML=bm.responseXML;}
catch(bo){bn=false;}
;if(bn){this.__ur();this.__us();}
;}
;this.__un();if(this.readyState==qx.bom.request.Xhr.DONE){if(bm){bm.onreadystatechange=function(){}
;}
;}
;}
,__un:function(){var bp=this;if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__ui);}
;if(qx.core.Environment.get(F)==E&&qx.core.Environment.get(t)<8){if(this.__uf&&!this.__uc&&this.readyState>=qx.bom.request.Xhr.LOADING){if(this.readyState==qx.bom.request.Xhr.LOADING){return;}
;if(this.readyState==qx.bom.request.Xhr.DONE){window.setTimeout(function(){if(bp.__uj){return;}
;bp.readyState=3;bp._emit(v);bp.readyState=4;bp._emit(v);bp.__uo();}
);return;}
;}
;}
;this._emit(v);if(this.readyState===qx.bom.request.Xhr.DONE){this.__uo();}
;}
,__uo:function(){if(this.__eS){this._emit(N);if(qx.core.Environment.get(F)===z){this._emit(n);}
;this.__eS=false;}
else {if(this.__tR){this._emit(r);}
else {if(this.__up()){this._emit(n);}
else {this._emit(p);}
;}
;}
;this._emit(o);}
,__up:function(){var bq;if(this._getProtocol()===H){bq=!this.responseText;}
else {bq=!this.statusText;}
;return bq;}
,__uq:function(){var br=this.__uh;this.readyState=qx.bom.request.Xhr.DONE;this.__eS=true;br.abort();this.responseText=u;this.responseXML=null;this.__un();}
,__ur:function(){var bs=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===H&&this.status===0&&bs){if(!this.__up()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(F)===z){if(bs&&this.__ud&&!this.__tR&&this.status===0){this.status=304;}
;}
;}
,__us:function(){if(qx.core.Environment.get(F)==E&&(this.getResponseHeader(K)||u).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bt=new window.ActiveXObject(G);bt.async=false;bt.validateOnParse=false;bt.loadXML(this.responseText);this.responseXML=bt;}
;}
,__ut:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__uu:function(){var name=qx.core.Environment.get(F);var bu=qx.core.Environment.get(y);return !(name==E&&bu<9||name==C&&bu<3.5);}
,__uv:function(){if(this.__uj){throw new Error(x);}
;}
...
;}
,statics:{PARSER:{json:qx.lang.Json.parse,xml:qx.xml.Document.fromString}},members:{__tX:null,parse:function(h,g){var f=this._getParser(g);if(typeof f===a){if(h!==c){return f.call(this,h);}
;}
;return h;}
,setParser:function(i){if(typeof qx.util.ResponseParser.PARSER[i]===a){return this.__tX=qx.util.ResponseParser.PARSER[i];}
;if(qx.core.Environment.get(d)){qx.core.Assert.assertFunction(i);}
;return this.__tX=i;}
,_getParser:function(k){var j=this.__tX,m=c,l=c;if(j){return j;}
;m=k||c;l=m.replace(/;.*$/,c);if((/^application\/(\w|\.)*\+?json$/).test(l)){j=qx.util.ResponseParser.PARSER.json;}
;if((/^application\/xml$/).test(l)){j=qx.util.ResponseParser.PARSER.xml;}
;if((/[^\/]+\/[^\+]+\+xml$/).test(m)){j=qx.util.ResponseParser.PARSER.xml;}
;return j;}
}});}
)();
...
;return Y+ba;}
,escapeHTML:function(bd){return String(bd).replace(/[<>&"']/g,this.__FN);}
,__FN:function(bf){var be={"<":m,">":e,"&":s,"'":t,'"':D};return be[bf]||L;}
