...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_VarRowHeight.376ba99a8793.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.progressive.ProgressiveTable_VarRowHeight",b="format-justify-left.png",c="end",d="Found [",e="Id",f="No attributes specified.",g="TALL ICON",h="1*",k=", end=",l="This, too, is small.",m="This, too, is tall.",n="",o="row",p="Searching for [",q="]",s=" not found",t="small icon",u="demobrowser/demo/icons/",v="I am small.",w="red",x="Image data for ",y="I am tall.",z="].  loadCount=",A="multimedia-player.png",B="Image",C="Note variable row heights in this table.";qx.Class.define(a,{extend:qx.application.Standalone,members:{__Sc:null,main:function(){qx.application.Standalone.prototype.main.call(this);var H=u;this.imageData=[{url:H+b,height:4,tooltip:t},{url:H+A,height:4,tooltip:g},n];this.__Sc=0;var F=qx.util.AliasManager.getInstance();var E=qx.util.ResourceManager.getInstance();var D;var G;for(var i=0;i<this.imageData.length;i++ ){if(!this.imageData[i]){continue;}
;D=F.resolve(this.imageData[i].url);G=E.toUri(D);this.imageData[i].url=G; ++this.__Sc;qx.io.ImageLoader.load(G,function(I,J){this.info(p+I+q);for(var j=0;j<this.imageData.length;j++ ){if(this.imageData[j].url==I){this.imageData[j].height=J.height; --this.__Sc;this.debug(d+this.imageData[j].url+z+this.__Sc+k+this.imageData.length);if(this.__Sc==0){this.doLoad();}
;return;}
;}
;throw new Error(x+I+s);}
,this);}
;if(this.__Sc==0){this.doLoad();}
;}
,doLoad:function(){var L=this;var R=function(W,Y){var X={renderer:o,location:c,data:[Y,L.imageData[W]]};return X;}
;var S=new qx.ui.progressive.renderer.table.Widths(2);S.setWidth(0,200);S.setWidth(1,h);var N=[e,B];var O=new qx.ui.progressive.headfoot.TableHeading(S,N);var M=new qx.ui.progressive.headfoot.Progress(S,N);var Q=new qx.ui.progressive.structure.Default(O,M);var K=new qx.ui.progressive.Progressive(Q);var T=new qx.ui.basic.Atom(C);T.setHeight(16);T.setTextColor(w);K.add(T);var V=new qx.ui.progressive.model.Default();var P=[];P.push(R(0,v));P.push(R(1,y));P.push(R(0,l));P.push(R(1,m));P.push(R(2,f));V.addElements(P);K.setDataModel(V);var U=new qx.ui.progressive.renderer.table.Row(S);K.addRenderer(o,U);var r=new qx.ui.progressive.renderer.table.cell.Image();U.addRenderer(1,r);K.set({width:400,maxWidth:400});this.getRoot().add(K,{left:50,top:50,bottom:50});K.render();}
}});}
)();
(function(){var a="Column number out of range",b="Unrecognized key: ",c="qx.ui.progressive.renderer.table.Widths",d="minWidth",e="width",f="maxWidth";qx.Class.define(c,{extend:qx.core.Object,construct:function(g){qx.core.Object.call(this);this.__JP=[];for(var i=0;i<g;i++ ){this.__JP[i]=new qx.ui.core.ColumnData();}
;}
,members:{__JP:null,getData:function(){return this.__JP;}
...
;}
,setWidth:function(l,m){if(l>this.__JP.length-1||l<0){throw new Error(a);}
;this.__JP[l].setColumnWidth(m);}
,setMinWidth:function(n,o){if(n>this.__JP.length-1||n<0){throw new Error(a);}
;this.__JP[n].setMinWidth(o);}
,setMaxWidth:function(p,q){if(p>this.__JP.length-1||p<0){throw new Error(a);}
;this.__JP[p].setMaxWidth(q);}
}});}
)();
...
,members:{__rx:null,renderLayout:function(g,top,f,h){this.__rx=f;}
,getComputedWidth:function(){return this.__rx;}
...
,members:{__Hu:null,join:function(c){this.__Hu=c;}
},destruct:function(){this.__Hu=null;}
});}
)();
(function(){var a="progressive-table-header-cell",b="resize",c="progressive-table-header",d="_layout",f="qx.ui.progressive.headfoot.TableHeading";qx.Class.define(f,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(l,k){qx.ui.progressive.headfoot.Abstract.call(this);this.__HE=l;var j=l.getData();this.__HF=[];for(var i=0;i<j.length;i++ ){var g=new qx.ui.basic.Atom(k[i]);g.setAppearance(a);this.add(g);this.__HF[i]=g;}
;var h=new qx.ui.core.Widget();h.set({height:16,appearance:a,minWidth:0,width:0});this.add(h,{flex:1});this.addListener(b,this._resizeColumns,this);this.__rz=new qx.ui.layout.HBox();this.__rz.connectToWidget(this);}
,properties:{appearance:{refine:true,init:c}},members:{__HE:null,__HG:null,__HF:null,__rz:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);}
,getLayoutChildren:function(){if(this.__HG){return this.__HE.getData();}
else {return qx.ui.progressive.headfoot.Abstract.prototype.getLayoutChildren.call(this);}
;}
,_resizeColumns:function(e){var p=this.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();this.__HG=true;var n={top:this.getPaddingTop(),right:this.getPaddingRight(),bottom:this.getPaddingBottom(),left:this.getPaddingLeft()};this.__rz.renderLayout(p,100,n);this.__HG=false;var o=this.__HE.getData();for(var i=0;i<o.length;i++ ){this.__HF[i].setWidth(o[i].getComputedWidth());}
;}
},destruct:function(){this.__HE=this.__HF=null;this._disposeObjects(d);}
});}
)();
(function(){var a="progressive-progressbar-indicator-undone",b="progress",c="%",d="progressive-progressbar-indicator-done",f="progressive-progressbar-percent-text",g="renderStart",h="progressive-progressbar-background",i="0%",j="qx.ui.progressive.headfoot.Progress",k="__Jj",l="progressive-progressbar-percent-background",m="renderEnd",n="__Jk";qx.Class.define(j,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(o,q){qx.ui.progressive.headfoot.Abstract.call(this);this.setHeight(16);this.setPadding(0);this.__Ij={};this.__In();this.set({backgroundColor:this.__Ij.background});this.__Jj=new qx.ui.core.Widget();this.__Jj.set({width:0,backgroundColor:this.__Ij.indicatorDone});this.add(this.__Jj);var p=new qx.ui.core.Widget();p.set({backgroundColor:this.__Ij.indicatorUndone});this.add(p,{flex:1});this.__Jk=new qx.ui.basic.Atom(i);this.__Jk.set({width:100,backgroundColor:this.__Ij.percentBackground,textColor:this.__Ij.percentText});this.add(this.__Jk);this.exclude();}
,members:{__Jl:null,__Ij:null,__Jj:null,__Jk:null,_onChangeTheme:function(){qx.ui.progressive.headfoot.Abstract.prototype._onChangeTheme.call(this);this.__In();}
,__In:function(){var r=qx.theme.manager.Color.getInstance();this.__Ij.background=r.resolve(h);this.__Ij.indicatorDone=r.resolve(d);this.__Ij.indicatorUndone=r.resolve(a);this.__Ij.percentBackground=r.resolve(l);this.__Ij.percentText=r.resolve(f);}
,join:function(s){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,s);s.addListener(g,function(e){this.__Jl=e.getData().initial;this.show();}
,this);s.addListener(b,function(e){var u=1.0-(e.getData().remaining/this.__Jl);var w=this.getBounds();if(w){var v=Math.floor((w.width-this.__Jk.getBounds().width)*u);var t=Math.floor(u*100)+c;if(!isNaN(v)){this.__Jj.setMinWidth(v);this.__Jk.setLabel(t);}
;}
;}
,this);s.addListener(m,function(e){this.exclude();}
,this);}
},destruct:function(){this.__Ij=null;this._disposeObjects(k,n);}
});}
)();
(function(){var a="applyStructure() is abstract",b="abstract",c="qx.ui.progressive.structure.Abstract",d="overflowY",e="auto";qx.Class.define(c,{type:b,extend:qx.core.Object,construct:function(f){qx.core.Object.call(this);if(!f){this.__Hq=new qx.ui.core.Widget();this.__Ay=this.__Hq;}
else {this.__Hq=null;this.__Ay=f;}
;this.__Ay.getContentElement().setStyle(d,e);}
,members:{__Hq:null,__Ay:null,applyStructure:function(g){throw new Error(a);}
,getPane:function(){return this.__Ay;}
},destruct:function(){if(this.__Hq){this.__Hq.dispose();}
;this.__Hq=this.__Ay=null;}
});}
)();
(function(){var a="qx.ui.progressive.structure.Default";qx.Class.define(a,{extend:qx.ui.progressive.structure.Abstract,construct:function(b,d,c){qx.ui.progressive.structure.Abstract.call(this,c);if(!b){this.__Hr=new qx.ui.progressive.headfoot.Null();this.__pI=this.__Hr;}
else {this.__Hr=null;this.__pI=b;}
;if(!d){this.__Hs=new qx.ui.progressive.headfoot.Null();this.__Ht=this.__Hs;}
else {this.__Hs=null;this.__Ht=d;}
;}
,members:{__pI:null,__Ht:null,__Hr:null,__Hs:null,applyStructure:function(e){this.__pI.join(e);this.__Ht.join(e);e.add(this.__pI);e.add(this.getPane(),{flex:1});e.add(this.__Ht);}
,getHeader:function(){return this.__pI;}
,getFooter:function(){return this.__Ht;}
},destruct:function(){if(this.__Hr){this.__Hr.dispose();this.__Hr=null;}
;if(this.__Hs){this.__Hs.dispose();this.__Hs=null;}
;this.__pI=this.__Ht=null;}
});}
)();
...
(function(){var a="dataAvailable",b="_applyDataModel",c="Boolean",d="Render time: ",f="qx.ui.progressive.model.Abstract",g="renderStart",h="ms",j="progress",k="white",l="No existing renderer named ",m="qx.ui.progressive.Progressive",n="progressDetail",o="Integer",p="renderEnd",q="qx.event.type.Data";qx.Class.define(m,{extend:qx.ui.container.Composite,construct:function(r){qx.ui.container.Composite.call(this,new qx.ui.layout.VBox());this.__Io={};this.set({backgroundColor:k});if(!r){r=new qx.ui.progressive.structure.Default();}
;this.__Ip=r;r.applyStructure(this);this.__Iq=false;this.__Ir=false;this.__Is=0;}
,events:{"renderStart":q,"renderEnd":q,"progress":q,"progressDetail":q},properties:{dataModel:{check:f,apply:b},batchSize:{check:o,init:20},flushWidgetQueueAfterBatch:{check:c,init:false},interElementTimeout:{check:o,init:0}},members:{__Io:null,__Ir:null,__It:null,__Is:null,__Iq:null,__Ip:null,getStructure:function(){return this.__Ip;}
,addRenderer:function(name,s){this.__Io[name]=s;s.join(this,name);}
,removeRenderer:function(name){if(!this.__Io[name]){throw new Error(l+name);}
;delete this.__Io[name];}
,render:function(){if(this.__Ir){return;}
;this.__Ir=true;var t=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__Ip.getPane(),batchSize:this.getBatchSize(),rendererData:this.__Iv(),userData:{}});this.__It=new Date();if(this.__Iq){this.__Is=t.getModel().getElementCount();this.fireDataEvent(g,{state:t,initial:this.__Is});this.__Iu(t);}
else {qx.event.Timer.once(function(){this.__Is=t.getModel().getElementCount();this.fireDataEvent(g,{state:t,initial:this.__Is});this.__Iu(t);this.__Iq=true;}
,this,10);}
;}
,_applyDataModel:function(v,u){if(u){u.removeListener(a,this.__Iw,this);u.dispose();}
;v.addListener(a,this.__Iw,this);}
,__Iu:function(x){var w;var z;var y;for(var i=x.getBatchSize();i>0;i-- ){w=x.getModel().getNextElement();if(!w){this.debug(d+(new Date()-this.__It)+h);this.__Ir=false;this.fireDataEvent(p,x);x.dispose();return;}
;z=w.element;y=this.__Io[z.renderer];y.render(x,z);this.fireDataEvent(n,{initial:this.__Is,remaining:w.remaining,element:z});}
;this.fireDataEvent(j,{initial:this.__Is,remaining:w.remaining});if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();}
;qx.event.Timer.once(function(){this.__Iu(x);}
,this,this.getInterElementTimeout());}
,__Iv:function(){var A={};for(var name in this.__Io){A[name]={};}
;return A;}
,__Iw:function(e){this.__Is=e.getData();this.render();}
},destruct:function(){for(var name in this.__Io){this.__Io[name].dispose();}
;this.__It=this.__Io=this.__Ip=null;}
});}
)();
...
(function(){var a="dataAvailable",b="qx.ui.progressive.model.Default";qx.Class.define(b,{extend:qx.ui.progressive.model.Abstract,construct:function(){qx.ui.progressive.model.Abstract.call(this);this.__CC=[];}
,members:{__CC:null,addElements:function(c){this.__CC=this.__CC.concat(c);this.fireDataEvent(a,this.__CC.length);}
,addElement:function(d){this.__CC.push(d);this.fireDataEvent(a,this.__CC.length);}
,getElementCount:function(){return this.__CC.length;}
,getNextElement:function(){if(this.__CC.length>0){return ({element:this.__CC.shift(),remaining:this.__CC.length});}
;return null;}
...
(function(){var a="resize",b="content",c="px",d="  font-size: 11px;",f=")",g="px ",h=';',j='',k="padding: ",l="end",m="div",n="  position: absolute;",o="qx.tableResizeDebug",p="changeTheme",q="-col-",r="__columnData",s="css.userselect",t="Renderer is already joined to a Progressive.",u="__Ii",v="css.boxmodel",w="css.textoverflow",x="  top: 0px;",y="  width : 100%;",z="  overflow:hidden;",A=" {",B="}",C="  border-right:1px solid #f2f2f2;",D="Invalid location: ",E="  cursor:default;",F="  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;",G="-row {",H="__rz",I="-row",J="qx.debug",K="qx.dyntheme",L="start",M="relative",N="",O=": width=",P=':ellipsis;',Q=':',R="  white-space:nowrap;",S="  padding : 0px 6px 0px 6px;",T="qx.ui.progressive.renderer.table.Row",U="width: ",V=" out of range (max: ",W="px;",X="0px ",Y="progressive-table-row-background-odd",bo=".qx-progressive-",bp="  height: 100%;",bq="qx-progressive-",bk="progressive-table-row-background-even",bl="col ",bm="  border-bottom:1px solid #eeeeee;",bn="left: ",br="No existing renderer for column ",bs="css.userselect.none",bt="Column ";qx.Class.define(T,{extend:qx.ui.progressive.renderer.Abstract,construct:function(bu){qx.ui.progressive.renderer.Abstract.call(this);this.__HE=bu;this.__Ih={};this.__Ii=new qx.ui.progressive.renderer.table.cell.Default();this.__Hu=null;this.__Ij={};this.__In();this.__rz=new qx.ui.layout.HBox();this.__rz.connectToWidget(this);if(qx.core.Environment.get(K)){qx.theme.manager.Color.getInstance().addListener(p,this.__In,this);}
;}
,statics:{__oP:null,__Ik:6,__Il:n+x+bp+z+(qx.core.Environment.get(w)?qx.bom.Style.getCssName(qx.core.Environment.get(w))+P:N)+R+C+bm+S+E+d+F+(qx.core.Environment.get(s)?qx.bom.Style.getCssName(qx.core.Environment.get(s))+Q+qx.core.Environment.get(bs)+h:j)},properties:{defaultRowHeight:{init:16}},members:{__Hu:null,__BK:null,__Im:null,__HE:null,__Ih:null,__Ii:null,__Ij:null,__rz:null,__In:function(){var bv=qx.theme.manager.Color.getInstance();this.__Ij.bgcol=[];this.__Ij.bgcol[0]=bv.resolve(bk);this.__Ij.bgcol[1]=bv.resolve(Y);}
,join:function(bx,name){if(this.__Hu){throw new Error(t);}
;this.__Hu=bx;this.__BK=name;var by=qx.ui.progressive.renderer.table.Row;if(!by.__oP){by.__oP={};}
;var bw=bx.toHashCode();if(!by.__oP[bw]){by.__oP[bw]={rowstylesheet:null,cellstylesheet:[]};var bz=bo+bw+G+y+B;by.__oP[bw].rowstylesheet=qx.bom.Stylesheet.createElement(bz);var bA=this.__HE.getData();for(var i=0;i<bA.length;i++ ){var bz=bo+bw+q+i+A+by.__Il+B;by.__oP[bw].cellstylesheet[i]=qx.bom.Stylesheet.createElement(bz);}
;this.__Im=bw;var bB=bx.getStructure().getPane();bB.addListener(a,this._resizeColumns,this);}
;}
,addRenderer:function(bC,bE){var bD=this.__HE.getData();if(bC<0||bC>=bD.length){throw new Error(bt+bC+V+(bD.length-1)+f);}
;this.__Ih[bC]=bE;}
,removeRenderer:function(bF){var bG=this.__HE.getData();if(bF<0||bF>=bG.length){throw new Error(bt+bF+V+(bG.length-1)+f);}
;if(!this.__Ih[bF]){throw new Error(br+bF);}
;delete this.__Ih[bF];}
,render:function(bI,bR){var bS=bR.data;var bM=[];var bO;var bN;var bK=0;if(bI.getRendererData()[this.__BK].end===undefined){bI.getRendererData()[this.__BK]={end:0,start:1,rows:0,totalHeight:0};}
;var bQ=document.createElement(m);for(var i=0;i<bS.length;i++ ){var bL=bq+this.__Im+q+i;bN=this.__Ih[i]||this.__Ii;bO={state:bI,rowDiv:bQ,stylesheet:bL,element:bR,dataIndex:i,cellData:bS[i],height:bK};bM.push(bN.render(bO));if(bO.height>bK){bK=bO.height;}
;}
;bK=(bK>0?bK:this.getDefaultRowHeight());var bP=bI.getRendererData()[this.__BK];bP.totalHeight+=bK;bQ.style.position=M;bQ.style.height=bK+c;bQ.className=bq+this.__Im+I;bQ.innerHTML=bM.join(N);switch(bR.location){case l:var bH=bP.end||0;bQ.style.backgroundColor=this.__Ij.bgcol[bH];bP.end=(bH==0?1:0);bI.getPane().getContentElement().getDomElement().appendChild(bQ);break;case L:var bJ=bI.getPane().getContentElement().getDomElement();var bT=bJ.childNodes;if(bT.length>0){var bH=bP.start;bQ.style.backgroundColor=this.__Ij.bgcol[bH];bP.start=(bH==0?1:0);bJ.insertBefore(bQ,bT[0]);break;}
else {bJ.appendChild(bQ);}
;break;default:throw new Error(D+bR.location);}; ++bP.rows;}
,getLayoutChildren:function(){return this.__HE.getData();}
,_resizeColumns:function(e){var cc=this.__Hu.getStructure().getPane();var bY=cc.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();var bW=bo+this.__Im+I;var bV=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bV.__oP[this.__Im].rowstylesheet,bW);var bX=U+bY+W;qx.bom.Stylesheet.addRule(bV.__oP[this.__Im].rowstylesheet,bW,bX);this.__rz.renderLayout(bY,100,{top:0,right:0,bottom:0,left:0});var cb=this.__HE.getData();for(var i=0,ce=0;i<cb.length;i++ ,ce+=bY){var bW=bo+this.__Im+q+i;var bV=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bV.__oP[this.__Im].cellstylesheet[i],bW);bY=cb[i].getComputedWidth();if(qx.core.Environment.get(J)){if(qx.core.Environment.get(o)){this.debug(bl+i+O+bY);}
;}
;var ca;if(qx.core.Environment.get(v)==b){ca=qx.ui.progressive.renderer.table.Row.__Ik*2;}
else {ca=-1;}
;var cf=(bY-ca)+W;var cd=X+qx.ui.progressive.renderer.table.Row.__Ik+g+X+qx.ui.progressive.renderer.table.Row.__Ik+W;var bU=ce+W;var bX=bV.__Il+U+cf+bn+bU+k+cd;qx.bom.Stylesheet.addRule(bV.__oP[this.__Im].cellstylesheet[i],bW,bX);}
;}
},destruct:function(){qx.theme.manager.Color.getInstance().removeListener(p,this.__In,this);var name;for(name in this.__Ih){this.__Ih[name]=null;}
;var ch=qx.ui.progressive.renderer.table.Row;var cg=this.__Hu.toHashCode();if(ch.__oP&&ch.__oP[cg]){if(ch.__oP[cg].rowstylesheet){var cj=bo+this.__Im+I;var ch=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(ch.__oP[this.__Im].rowstylesheet,cj);}
;if(ch.__oP[cg].cellstylesheet){for(var i=ch.__oP[cg].cellstylesheet.length-1;i>=0;i-- ){var cj=bo+this.__Im+q+i;var ci=ch.__oP[this.__Im].cellstylesheet[i];var ch=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(ci,cj);}
;}
;}
;if(this.__Hu&&this.__Hu.getRendererData){var ck=this.__Hu.getRendererData();if(ck&&ck[this.__BK]&&ck[this.__BK].end!==undefined){ck[this.__BK]=null;}
;}
;this.__Ij=this.__Ih=this.__Hu=this.__HE=null;this._disposeObjects(H,u,r);}
});}
)();
...
,_getContentHtml:function(C){var D=[];var E=this.__Fw(C);D.push(f);if(qx.core.Environment.get(h)&&/\.png$/i.test(E.url)){D.push(n,this.__Fv,q,e,E.url,v,a);}
...
,__Fw:function(F){var G=this._identifyImage(F);if(G==null||typeof G==c){G={url:G,tooltip:null};}
;if(G.url==null){G.url=this.__Fv;}
;return G;}
}});}
)();
(function(){var a="qx.ui.progressive.renderer.table.cell.Image",b="string",c="";qx.Class.define(a,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(d,e){qx.ui.progressive.renderer.table.cell.Icon.call(this);if(d===undefined){this.__rs=d;}
else {this.__rs=16;}
;if(e===undefined){this.__rt=e;}
else {this.__rt=16;}
;}
,members:{__rs:null,__rt:null,_identifyImage:function(k){var h={imageWidth:this.__rs,imageHeight:this.__rt};var j;if(typeof (k.cellData)==b){h.url=k.cellData;}
else {h.url=k.cellData.url;h.tooltip=k.cellData.tooltip;j=k.cellData.height;}
;if(h.url==c){h.url=this._imageBlank;}
else {var i=qx.util.AliasManager.getInstance();var g=qx.util.ResourceManager.getInstance();var f=i.resolve(h.url);h.url=g.toUri(f);}
;if(j){k.height=j;}
;return h;}
}});}
)();
