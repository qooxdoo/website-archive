...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.0c732c2ad8c4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="__cx",c="Flash Player Version",d="__SV",f="right",g="qooxdoo is the best!",h="Message from Flash:",i="execute",j="Simple demo with FlashVars",k="bgcolor",l="demobrowser.demo.widget.Flash",m="demobrowser/demo/flash/TestFlash.swf",n="1) no pop-up or advertising blocker is activated.\n",o="Send to Flash",p="demobrowser/demo/flash/FlashVersion.swf",q="No message.",r="Flash:",s="<b>qooxdoo:</b>",t="__SW",u="__HM",v="__SU",w="demobrowser.demo.widget.Flash.sendMessage",x="demobrowser.demo.widget.Flash.flashReady",y="Couldn't connect to Flash Player! Please make sure that:\n",z="demobrowser/demo/flash/fo_tester.swf",A="this is passed in via FlashVars",B="Two way communication (ActionScript <-> JavaScript)",C="Message to Flash:",D="Show Flash Player version",E="noscale",F="#FF6600";qx.Class.define(l,{extend:qx.application.Standalone,members:{__cx:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(j);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(B);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cx=this.createWindow();G.add(this.__cx,{top:20,left:20});}
...
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:A};var M=new qx.ui.embed.Flash(z).set({scale:E,variables:L});M.getContentElement().setParam(k,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(D);O.addListener(i,function(){this.__cx.open();}
,this);N.add(O);return N;}
,__HM:null,__SU:null,__SV:null,__SW:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(s).set({rich:true}));Q.add(new qx.ui.basic.Label(h));this.__SU=new qx.ui.form.TextArea(q);this.__SU.setEnabled(false);Q.add(this.__SU,{flex:1});Q.add(new qx.ui.basic.Label(C));this.__SV=new qx.ui.form.TextArea(g);Q.add(this.__SV,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,f));this.__SW=new qx.ui.form.Button(o);this.__SW.setEnabled(false);this.__SW.addListener(i,function(e){this.__HM.getFlashElement().sendMessage(this.__SV.getValue());}
,this);S.add(this.__SW);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(r).set({rich:true}));this.__HM=new qx.ui.embed.Flash(m);this.__HM.setVariables({init:x});P.add(this.__HM,{flex:1});return R;}
,sendMessage:function(T){this.__SU.setValue(T);}
,initFlash:function(){if(this.__HM.getFlashElement().setup){this.__HM.getFlashElement().setup(w);this.__SW.setEnabled(true);}
else {alert(y+n+a);}
;}
},statics:{__SX:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__SX=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__SX.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__SX.initFlash();}
},destruct:function(){this._disposeObjects(v,d,t,u,b);}
});}
)();
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__HH){this.__HH=new Date().getTime();}
;var bp=new Date().getTime()-this.__HH;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__HH=null;}
;}
else {this.fireEvent(p);this.__HH=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__HI(c,bB);}
,_applyScale:function(bD,bC){this.__HI(h,bD);}
,_applyWmode:function(bF,bE){this.__HI(m,bF);}
,_applyPlay:function(bH,bG){this.__HI(I,bH);}
,_applyLoop:function(bJ,bI){this.__HI(s,bJ);}
,_applyMenu:function(bL,bK){this.__HI(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__HI(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__HI(z,bP);}
,__HI:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__HJ={};this.__HK={};this.__HL={};}
,members:{__HJ:null,__HL:null,__HK:null,__HM:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__HM=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__HK,this.__HJ);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__HM){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__HM){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__HK;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__HM){throw new Error(d);}
;this.__HK=t;}
,getAttributes:function(){return this.__HL;}
...
else if(this.__HM){throw new Error(j);}
;if(v===null||v===undefined){delete this.__HL[u];}
else {this.__HL[u]=v;}
;}
,getParams:function(){return this.__HJ;}
...
;}
;}
;if(this.__HM){throw new Error(l);}
;if(x===null||x===undefined){delete this.__HJ[w];}
else {this.__HJ[w]=x;}
;}
,getFlashElement:function(){return this.__HM;}
},destruct:function(){if(this.__HM){qx.bom.Flash.destroy(this.__HM);}
