...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.ListController","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ListController.5b16d15d655e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Remove an item",b="Write data to log",c="Add an item",d="",e="selection[0]",f="<b>Multi selection List</b><br/>",g="multi",h="value",j="<b>Selection Label</b><br/>",k="white",l="<b>Selection List</b><br/>",m="Bound to the selection of the list to the left.",n="Item ",o="main",p="demobrowser.demo.data.ListController",q="Bound to the same data and share the selection.",r="execute";qx.Class.define(p,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var C=[];for(var i=0;i<10;i++ ){C.push(n+i);}
;var F=new qx.data.Array(C);var u=new qx.ui.form.List();u.setSelectionMode(g);var x=new qx.ui.form.List();x.setSelectionMode(g);var w=new qx.ui.form.List();this.getRoot().add(u,{left:10,top:110});this.getRoot().add(x,{left:130,top:110});this.getRoot().add(w,{left:250,top:110});var A=new qx.data.controller.List(F,u);var z=new qx.data.controller.List(F,x);var y=new qx.data.controller.List(A.getSelection(),w);z.setSelection(A.getSelection());var D=new qx.ui.basic.Label(d);this.getRoot().add(D,{left:370,top:110});y.bind(e,D,h);D.setWidth(120);D.setDecorator(o);D.setBackgroundColor(k);var G=new qx.ui.form.Button(c);G.setWidth(120);this.getRoot().add(G,{left:370,top:140});G.addListener(r,function(){F.push(n+F.length);}
,this);var v=new qx.ui.form.Button(a);v.setWidth(120);this.getRoot().add(v,{left:370,top:175});v.addListener(r,function(){F.pop();}
,this);var t=new qx.ui.form.Button(b);t.setWidth(120);this.getRoot().add(t,{left:370,top:210});t.addListener(r,function(){qx.log.appender.Console.show();this.info(F.toString());}
,this);var E=new qx.ui.basic.Label();E.setRich(true);E.setWidth(200);E.setValue(f+q);this.getRoot().add(E,{left:20,top:10});var s=new qx.ui.basic.Label();s.setRich(true);s.setWidth(100);s.setValue(l+m);this.getRoot().add(s,{left:260,top:10});var B=new qx.ui.basic.Label();B.setRich(true);B.setWidth(100);B.setValue(j+m);this.getRoot().add(B,{left:380,top:10});}
}});}
)();
...
(function(){var a="qx.ui.form.List",b="text",c="Boolean",d="one",f="addChildWidget",g="_applySpacing",h="Enter",j="Integer",k="action",m="keyinput",n="qx.event.type.Data",o="addItem",p="vertical",q="removeChildWidget",r="",s="_applyOrientation",t="__no",u="single",v="keypress",w="list",x="horizontal",y="label",z="pane",A="removeItem";qx.Class.define(a,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IForm,qx.ui.form.IModelSelection],include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MMultiSelectionHandling,qx.ui.form.MForm,qx.ui.form.MModelSelection],construct:function(B){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__no=this._createListItemContainer();this.__no.addListener(f,this._onAddChild,this);this.__no.addListener(q,this._onRemoveChild,this);this.getChildControl(z).add(this.__no);if(B){this.setOrientation(x);}
else {this.initOrientation();}
;this.addListener(v,this._onKeyPress);this.addListener(m,this._onKeyInput);this.__Bi=r;}
,events:{addItem:n,removeItem:n},properties:{appearance:{refine:true,init:w},focusable:{refine:true,init:true},orientation:{check:[x,p],init:p,apply:s},spacing:{check:j,init:0,apply:g,themeable:true},enableInlineFind:{check:c,init:true}},members:{__Bi:null,__Bj:null,__no:null,SELECTION_MANAGER:qx.ui.core.selection.ScrollArea,getChildrenContainer:function(){return this.__no;}
...
;if(((new Date).valueOf()-this.__Bj)>1000){this.__Bi=r;}
;this.__Bi+=e.getChar();var K=this.findItemByLabelFuzzy(this.__Bi);if(K){this.setSelection([K]);}
;this.__Bj=(new Date).valueOf();}
...
;if(this.getSelection()==null){this.__By=new qx.data.Array();this.setSelection(this.__By);}
;}
,properties:{selection:{check:b,event:f,apply:d,init:null}},events:{"changeSelection":h},members:{_modifingSelection:0,__Bz:null,__BA:null,__By:null,_applySelection:function(k,j){if(this.__BA!=undefined&&j!=undefined){j.removeListenerById(this.__BA);}
;this.__BA=k.addListener(a,this.__BB,this);this._updateSelection();}
,__BB:function(){this._updateSelection();}
,_changeTargetSelection:function(){if(this.getTarget()==null){return;}
;if(!this.__BC()&&!this.__BD()){return;}
;if(this._inSelectionModification()){return;}
;var m=this.getTarget().getSelection();var l=this.getSelection();if(l==null){l=new qx.data.Array();this.__By=l;this.setSelection(l);}
...
,_addChangeTargetListener:function(p,o){if(this.__Bz!=undefined&&o!=undefined){o.removeListenerById(this.__Bz);}
;if(p!=null){if(this.__BC()||this.__BD()){this.__Bz=p.addListener(f,this._changeTargetSelection,this);}
;}
;}
,_updateSelection:function(){if(!this.getTarget()){return;}
;this._startSelectionModification();if(this.__BC()){var s=[];for(var i=0;i<this.getSelection().length;i++ ){var t=this.getSelection().getItem(i);var u=this.__BE(t);if(u!=null){s.push(u);}
;}
...
;}
;}
else if(this.__BD()){var r=this.getSelection().getItem(this.getSelection().length-1);if(r!==undefined){this.__sR(r);this.getSelection().splice(0,this.getSelection().getLength()-1).dispose();}
else {this.getTarget().resetSelection();}
;}
;this._endSelectionModification();}
,__BC:function(){var v=this.getTarget().constructor;return qx.Class.implementsInterface(v,qx.ui.core.IMultiSelection);}
,__BD:function(){var w=this.getTarget().constructor;return qx.Class.implementsInterface(w,qx.ui.core.ISingleSelection);}
,__sR:function(x){var y=this.__BE(x);if(y==null){return;}
;if(this.__BC()){this.getTarget().addToSelection(y);}
else if(this.__BD()){this.getTarget().setSelection([y]);}
;}
,__BE:function(z){var A=this.getTarget().getSelectables(true);for(var i=0;i<A.length;i++ ){if(A[i].getModel()==z){return A[i];}
;}
;return null;}
...
},destruct:function(){if(this.__By){this.__By.dispose();}
;}
});}
)();
...
(function(){var a="changeModel",b="_applyLabelOptions",c="_applyLabelPath",d="changeTarget",e="_applyModel",f="change",g="icon",h="ReverseBindingId",k="qx.data.controller.List",m="_applyIconPath",n="BindingId",o="_applyDelegate",p="",q="changeDelegate",r="_applyTarget",s="]",t="qx.data.IListData",u="model[",v="model",w="label",x="String",y="_applyIconOptions",z=".";qx.Class.define(k,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(A,B,C){qx.core.Object.call(this);this.__zr=[];this.__Bk=[];this.__Bl=[];this.__Bm={};if(C!=null){this.setLabelPath(C);}
;if(A!=null){this.setModel(A);}
;if(B!=null){this.setTarget(B);}
;}
,properties:{model:{check:t,apply:e,event:a,nullable:true,dereference:true},target:{apply:r,event:d,nullable:true,init:null,dereference:true},labelPath:{check:x,apply:c,nullable:true},iconPath:{check:x,apply:m,nullable:true},labelOptions:{apply:b,nullable:true},iconOptions:{apply:y,nullable:true},delegate:{apply:o,event:q,init:null,nullable:true}},members:{__Bn:null,__zr:null,__Bm:null,__Bk:null,__Bl:null,__Bo:null,__Bp:null,update:function(){this.__Br();this.__Bv();this._updateSelection();}
,_applyDelegate:function(E,D){this._setConfigureItem(E,D);this._setFilter(E,D);this._setCreateItem(E,D);this._setBindItem(E,D);}
,_applyIconOptions:function(G,F){this.__Bv();}
,_applyLabelOptions:function(I,H){this.__Bv();}
,_applyIconPath:function(K,J){this.__Bv();}
,_applyLabelPath:function(M,L){this.__Bv();}
,_applyModel:function(P,N){if(N!=undefined){if(this.__Bn!=undefined){N.removeListenerById(this.__Bn);}
;}
;if(this.getSelection()!=undefined&&this.getSelection().length>0){this.getSelection().splice(0,this.getSelection().length).dispose();}
;if(P!=null){this.__Bn=P.addListener(f,this.__Bq,this);this.__zy();this.__Br();if(N==null){this._changeTargetSelection();}
else {this.__Bo=true;qx.ui.core.queue.Widget.add(this);}
;}
else {var O=this.getTarget();if(O!=null){var length=O.getChildren().length;for(var i=0;i<length;i++ ){this.__Bu();}
;}
;}
;}
...
;if(S!=null){if(this.getModel()!=null){for(var i=0;i<this.__zr.length;i++ ){this.__Bt(this.__Bx(i));}
;}
;}
;}
,__Bq:function(){this.__Bp=true;qx.ui.core.queue.Widget.add(this);if(this.__zr.length!=this.getModel().getLength()){this.update();}
;}
,syncWidget:function(){if(this.__Bo){this._changeTargetSelection();}
;if(this.__Bp){this._updateSelection();}
;this.__Bp=this.__Bo=null;}
,__Br:function(){if(this.getTarget()==null){return;}
;this.__zy();var U=this.__zr.length;var T=this.getTarget().getChildren().length;if(U>T){for(var j=T;j<U;j++ ){this.__Bt(this.__Bx(j));}
;}
else if(U<T){for(var j=T;j>U;j-- ){this.__Bu();}
;}
;this.__Bo=true;qx.ui.core.queue.Widget.add(this);}
,__Bs:function(){var V=this.getModel();if(V!=null){V.removeListenerById(this.__Bn);this.__Bn=V.addListener(f,this.__Bq,this);}
;}
...
;return W;}
,__Bt:function(Y){var ba=this._createItem();this._bindListItem(ba,Y);this.getTarget().add(ba);}
,__Bu:function(){this._startSelectionModification();var bc=this.getTarget().getChildren();var bb=bc.length-1;var bd=bc[bb];this._removeBindingsFrom(bd);this.getTarget().removeAt(bb);bd.destroy();this._endSelectionModification();}
...
;}
,bindProperty:function(bo,br,bp,bn,bm){if(bp!=null){var bp=qx.lang.Object.clone(bp);this.__Bm[br]=bp.onUpdate;delete bp.onUpdate;}
else {bp={};this.__Bm[br]=null;}
;bp.onUpdate=qx.lang.Function.bind(this._onBindingSet,this,bm);bp.ignoreConverter=v;var bq=u+bm+s;if(bo!=null&&bo!=p){bq+=z+bo;}
;var bs=this.bind(bq,bn,br,bp);bn.setUserData(br+n,bs);if(!qx.lang.Array.contains(this.__Bk,br)){this.__Bk.push(br);}
;}
,bindPropertyReverse:function(by,bv,bw,bx,bt){var bu=u+bt+s;if(by!=null&&by!=p){bu+=z+by;}
;var bz=bx.bind(bv,this,bu,bw);bx.setUserData(by+h,bz);if(!qx.lang.Array.contains(this.__Bl,by)){this.__Bl.push(by);}
;}
,_onBindingSet:function(bA,bB,bC){if(this.getModel()==null||this._inSelectionModification()){return;}
;for(var i=0;i<this.__Bk.length;i++ ){if(this.__Bm[this.__Bk[i]]!=null){this.__Bm[this.__Bk[i]]();}
;}
;}
,_removeBindingsFrom:function(bD){for(var i=0;i<this.__Bk.length;i++ ){var bE=bD.getUserData(this.__Bk[i]+n);if(bE!=null){this.removeBinding(bE);}
;}
;for(var i=0;i<this.__Bl.length;i++ ){var bE=bD.getUserData(this.__Bl[i]+h);if(bE!=null){bD.removeBinding(bE);}
;}
;}
,__Bv:function(){if(this.getTarget()==null||this.getModel()==null){return;}
;var bF=this.getTarget().getChildren();for(var i=0;i<bF.length;i++ ){this._removeBindingsFrom(bF[i]);this._bindListItem(bF[i],this.__Bx(i));}
;this.__Bs();}
...
,_setFilter:function(bR,bP){if((bR==null||bR.filter==null)&&(bP!=null&&bP.filter!=null)){this.__Bw();}
...
;var bQ=this.__zr;this.__zy();if(bQ.length>this.__zr.length){for(var j=bQ.length;j>this.__zr.length;j-- ){this.getTarget().removeAt(j-1).destroy();}
;}
else if(bQ.length<this.__zr.length){for(var j=bQ.length;j<this.__zr.length;j++ ){var bT=this._createItem();this.getTarget().add(bT);}
;}
;var bS=this.getTarget().getChildren();for(var i=0;i<bS.length;i++ ){this._bindListItem(bS[i],this.__Bx(i));}
;this.__Bs();this._endSelectionModification();this._updateSelection();}
,__Bw:function(){this.__zy();this.__Br();this.__Bv();this.__Bp=true;qx.ui.core.queue.Widget.add(this);}
...
;}
;}
,__Bx:function(bY){return this.__zr[bY];}
},destruct:function(){this.__zr=this.__Bm=this.__Bk=null;this.__Bl=null;qx.ui.core.queue.Widget.remove(this);}
});}
)();
