...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.HtmlArea.adc0bfc0aa4f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
;var ba,bc=[];for(var i=0,l=X.length;i<l;i++ ){ba=X[i];if(typeof ba===k){ba=this.__CF(ba,be);}
...
,appendTo:function(parent){parent=qx.module.Manipulating.__CI(parent);for(var i=0,l=parent.length;i<l;i++ ){this._forEachElement(function(q,j){if(i==0){qx.dom.Element.insertEnd(this[j],parent[i]);}
else {qx.dom.Element.insertEnd(this.eq(j).clone(true)[0],parent[i]);}
;}
);}
;return this;}
,insertBefore:function(r){r=qx.module.Manipulating.__CI(r);for(var i=0,l=r.length;i<l;i++ ){this._forEachElement(function(s,t){if(i==0){qx.dom.Element.insertBefore(s,r[i]);}
else {qx.dom.Element.insertBefore(this.eq(t).clone(true)[0],r[i]);}
;}
);}
;return this;}
,insertAfter:function(u){u=qx.module.Manipulating.__CI(u);for(var i=0,l=u.length;i<l;i++ ){for(var j=this.length-1;j>=0;j-- ){if(!this[j]||this[j].nodeType!==1){continue;}
;if(i==0){qx.dom.Element.insertAfter(this[j],u[i]);}
else {qx.dom.Element.insertAfter(this.eq(j).clone(true)[0],u[i]);}
;}
;}
;return this;}
,__CI:function(w){if(!qx.lang.Type.isArray(w)){var v=qxWeb(w);w=v.length>0?v:[w];}
;return w.filter(function(x){return (x&&x.nodeType===1);}
);}
,wrap:function(y){y=qx.module.Manipulating.__CJ(y);if(y.length==0){return this;}
;this._forEachElement(function(z){var A=y.eq(0).clone(true);qx.dom.Element.insertAfter(A[0],z);var B=qx.module.Manipulating.__CK(A[0]);qx.dom.Element.insertEnd(z,B);}
);return this;}
,__CJ:function(E){var C;if(qx.lang.Type.isArray(E)){C=qxWeb(E);}
else {var D=qx.bom.Html.clean([E]);if(D.length>0&&qx.dom.Node.isElement(D[0])){C=qxWeb(D);}
else {C=qxWeb(E);}
;}
;return C;}
,__CK:function(F){if(F.childNodes.length==0){return F;}
;for(var i=0,l=F.childNodes.length;i<l;i++ ){if(F.childNodes[i].nodeType===1){return this.__CK(F.childNodes[i]);}
;}
;return F;}
...
;return T.scrollTop;}
,_animationDescription:{scrollLeft:{duration:700,timing:c,keep:100,keyFrames:{'0':{},'100':{scrollLeft:1}}},scrollTop:{duration:700,timing:c,keep:100,keyFrames:{'0':{},'100':{scrollTop:1}}}},__CL:function(V,W,U){var X=qx.lang.Object.clone(qx.module.Manipulating._animationDescription[V],true);X.keyFrames[100][V]=W;return this.animate(X,U);}
,setScrollLeft:function(ba,bb){var Node=qx.dom.Node;if(bb&&qx.bom.element&&qx.bom.element.AnimationJs){qx.module.Manipulating.__CL.bind(this,a,ba,bb)();}
...
;}
;return this;}
,setScrollTop:function(bd,be){var Node=qx.dom.Node;if(be&&qx.bom.element&&qx.bom.element.AnimationJs){qx.module.Manipulating.__CL.bind(this,d,bd,be)();}
...
;}
,this.__yF);qx.dom.Element.insertBegin(ei,eh);return eh;}
,__yN:function(){var ep=qx.dom.Element.create(c);qx.bom.element.Style.setStyles(ep,{"marginRight":cA,"float":di});var er;var eq=qx.dom.Element.create(cN,{title:cQ});if(qx.core.Environment.get(cU)==cD){qx.bom.element.Attribute.set(eq,cx,dT);}
...
;}
,this.__yF);qx.dom.Element.insertBegin(eq,ep);return ep;}
,__yP:function(){var ew=[{bold:{text:cO,image:dq,action:this.__yF.setBold},italic:{text:u,image:dz,action:this.__yF.setItalic},underline:{text:dI,image:w,action:this.__yF.setUnderline},strikethrough:{text:dJ,image:cS,action:this.__yF.setStrikeThrough},removeFormat:{text:cX,image:cH,action:this.__yF.removeFormat}},{alignLeft:{text:K,image:dp,action:this.__yF.setJustifyLeft},alignCenter:{text:dw,image:L,action:this.__yF.setJustifyCenter},alignRight:{text:t,image:dl,action:this.__yF.setJustifyRight},alignJustify:{text:O,image:dx,action:this.__yF.setJustifyFull}},{fontFamily:{custom:this.__yM},fontSize:{custom:this.__yN},fontColor:{text:cJ,image:cL,action:this.__yG},textBackgroundColor:{text:V,image:s,action:this.__yH}},{indent:{text:m,image:C,action:this.__yF.insertIndent},outdent:{text:dK,image:dH,action:this.__yF.insertOutdent}},{insertImage:{text:dD,image:dg,action:this.__yI},insertTable:{text:b,image:cF,action:this.__yJ},insertLink:{text:X,image:de,action:this.__yK},insertHTML:{text:dR,image:Q,action:this.__yL},insertHR:{text:R,image:S,action:this.__yF.insertHorizontalRuler}},{ol:{text:dm,image:B,action:this.__yF.insertOrderedList},ul:{text:dO,image:T,action:this.__yF.insertUnorderedList}},{undo:{text:dA,image:cG,action:this.__yF.undo},redo:{text:dQ,image:dv,action:this.__yF.redo}}];var ey,eC,ev,ez;for(var i=0,j=ew.length;i<j;i++ ){eC={};eC[cY]=i==j-1?dC:cA;eC[G]=di;ey=qx.dom.Element.create(c);qx.bom.element.Style.setStyles(ey,eC);for(var eA in ew[i]){var eB=ew[i][eA];if(eB.custom){ev=eB.custom.call(this);}
...
;qx.event.Registration.addListener(ev,cV,eB.action,this.__yF);}
;qx.dom.Element.insertEnd(ev,ey);}
;qx.dom.Element.insertEnd(ey,this.__QG);}
;qx.dom.Element.insertEnd(qx.dom.Element.create(cT,{style:a}),this.__QG);}
}});}
)();
(function(){var b="qx.blankpage",c='</span>',d="backgroundColor",f="li",g="pageup",h='undo',k="engine.version",l="backgroundcolor",m="Failed to enable rich edit functionality",n="end",o="<br class='webkit-block-placeholder' />",p="div",q="right",r="qx.event.type.Data",t="Function",u='On',v="fontSize",w="textcolor",x="cant open document on source '",y="home",z="<",A="focused",B="fontFamily",C="load",D='document not available, try again...',E='<font ',F='id="__elementToFocus__"',G="setUnderline",H="backgroundPosition",I="redo",J="<!--",K=' size="',L="i",M='/www.w3.org/1999/xhtml" xml:lang="en" lang="en">',N="'>",O='underline',P="opera",Q='bold',R="&copy;",S="ul",T="backspace",U="cursorContext",V="bold",W="mouseup",X="enter",Y="y",gd="readyAfterInvalid",fU="inserthtml",ge="styleWithCSS",ga="span",gb=" />",fI="id",gc="style",gi="setBold",gj="<P>&nbsp;</P>",gp="</",gk="textbackgroundcolor",gf="&gt;",gg='="',fY="can't extract style from elem. ",gh="paddingLeft",go="backgroundimage",gT='size',gq="100%",gr="inserthorizontalrule",gl='</head>',gm='<p>',hT='"',gn='<head>',gs="k",gt="backgroundRepeat",gu="insertimage",gz="qx.event.type.Event",gA=":",gB='redo',gv="a",gw="&amp;",gx='Off',gy="removeformat",gG="marginLeft",gH="ready",gI="<p>&nbsp;</p>",gJ="about:blank",gC='DOCTYPE html PUBLIC "-/',gD="italic",gE='">',gF="browser.version",gO=" html, body {overflow-x: visible; } ",gP='<body>',ib="insertorderedlist",gQ="down",gK='body { font-size:100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; background-color:transparent; overflow:visible; background-image:none; margin:0px; padding:5px; } ',gL="font-family",gM="mshtml",gN="g",gR="hideFocus",gS="keypress",he="none",hd="left",hc='/DTD XHTML 1.0 Transitional/',hi='<html xmlns="http:/',hh=" ",hg="outline",hf="fontsize",gX="setItalic",gW="font-style",gV="body",gU="marginBottom",hb="undo",ha="xhtml",gY="Boolean",hp="focusOut",ho="text-decoration",hn="justifyleft",hm="handleMouse ",ht='</p>',hs="gecko",hr="paddingTop",hq="underline",hl="br",hk='</font>',hj='<title></title><meta http-equiv="Content-type" content="text/html; charset=UTF-8" />',hE="Control",hD="pagedown",hC='<span style="font-family:',hI='/W3C/',hH="text-align",hG="placeholder",hF='cant load HtmlArea. Document is not available. ',hx="justify",hw="backgroundImage",hv="center",hu="marginTop",hB="> ",hA=" { ",hz="font-weight",hy="LI",hO="p",hN='italic',hM='<!',hL='</style>',hS="\ufeff",hR="u",hQ=" | ",hP="focus",hK="&quot;",hJ="marginRight",eO="STYLE",eN="__elementToFocus__",ic="justifyfull",eL="control",eM="engine.name",eK="click",ia="inserthyperlink",eI="<br />",eJ='html { margin:0px; padding:0px; } ',eH='<style type="text/css">',hX="qx.bom.htmlarea.HtmlArea.debug",eF="old_id",eG="<br>",eE='/EN" "http:/',eX="justifycenter",eY="<br /><div id='placeholder'></div>",eV="up",eW="useCSS",eT="object",eU="strikethrough",eS="blur",eD="font-size",eQ="None",eR="text/html",eP="true",fm="1.9",fk='',fl=' style="',fi="indent",fj="messengerContent",fh="Integer",hW="insertunorderedlist",ff="Text",fg="'",fe="delete",hY="&lt;",fc="_moz_dirty",fd=">",fa="qx.debug",fb='<br _moz_editor_bogus_node="TRUE" _moz_dirty=""/>',fu="b",fv='</body></html>',fs='<br/><div class="placeholder"></div>',ft="selectall",fq="transparent",fr="line-through",fp="String",hV=" SCRIPT STYLE DIV SPAN TR TD TBODY TABLE EM STRONG FONT A P B I U STRIKE H1 H2 H3 H4 H5 H6 ",fn="z",fo="justifyright",fH='/www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">',hU="ol",fJ=";",fE="",fD="//text()[string-length(normalize-space(.))>0]",fG="outdent",fF="<div></div>",fA="fontfamily",fz="<body style='",fC="qx.bom.htmlarea.HtmlArea",fB="paddingBottom",fw="keydown",fy="keyup",fx="__wh",fR="loadingError",fQ="Verdana",fT="contextmenu",fS="focusout",fN="$",fM="-->",fP=" }",fO="webkit",fK="paddingRight",fL='html { width:100%; height:100%; margin:0px; padding:0px; overflow-y:auto; overflow-x:auto; } ',fV="Off",fX='p { margin:0px; padding:0px; }',fW='body { font-size: 100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; width:100%; height:100%; background-color:transparent; overflow:auto; background-image:none; margin:0px; padding:5px; } ';qx.Class.define(fC,{extend:qx.core.Object,construct:function(ie,ih,ii,id){qx.core.Object.call(this);var ig=id||qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(b));this.__xn(ie);this.__xo();this._createAndAddIframe(ig);this._addIframeLoadListener();this.__wU=qx.bom.htmlarea.HtmlArea.__wW(ii);if(qx.lang.Type.isString(ih)){this.__wV=ih;}
;this.__wh=this.__xB();}
,events:{"load":gz,"loadingError":r,"messengerContent":r,"cursorContext":r,"ready":gz,"readyAfterInvalid":gz,"focused":gz,"focusOut":gz,"contextmenu":r,"undoRedoState":r},statics:{simpleLinebreak:eG,EMPTY_DIV:fF,GetWordsRegExp:/([^\u0000-\u0040\u005b-\u005f\u007b-\u007f]|['])+/g,CleanupWordsRegExp:/[\u0000-\u0040]/gi,hotkeyInfo:{bold:{method:gi},italic:{method:gX},underline:{method:G},undo:{method:hb},redo:{method:I}},__wW:function(ik){if(ik==null||ik==fE){return fE;}
else if(typeof ik==eT){var ij=fE;for(var i in ik){ij+=i+hA+ik[i]+fP;}
;return ij;}
else {return ik;}
;}
,__wX:function(iq){var il={};var a=iq.split(fJ);var i;for(i=0;i<a.length;i++ ){var im=a[i],io=im.indexOf(gA);if(io===-1){continue;}
;var name=im.substring(0,io).trim();var ip=im.substring(io+1,im.length).trim();if(name&&ip){il[name]=ip;}
;}
;return il;}
,__wY:function(iC,is,iz,iy){var iu=[];switch(iC.nodeType){case 1:case 11:var i;var it=iC.tagName.toLowerCase();var iA={};var ir={};var closed=(!(iC.hasChildNodes()||qx.bom.htmlarea.HtmlArea.__xa(iC)));if(is){if((qx.core.Environment.get(eM)==gM)){if(it==p&&iC.className&&iC.className==hG){for(i=iC.firstChild;i;i=i.nextSibling){iu.push(qx.bom.htmlarea.HtmlArea.__wY(i,true,iz,iy));}
;return iu.join(fE);}
;}
;var ix=iC.attributes;var iv=ix.length;var a;if((qx.core.Environment.get(eM)==hs)){if(it==ga&&iv==1&&ix[0].name==fc&&iC.childNodes.length==0){return fE;}
;}
...
;if(name!=gc){if(qx.core.Environment.get(eM)==gM){if(name==fI&&iC.getAttribute(eF)){iB=iC.getAttribute(eF);}
...
;if(name==eF){continue;}
;if(!iB){continue;}
;if(name==fI&&iB==eN){continue;}
;if(name.charAt(0)===fN){continue;}
;iA[name]=iB;}
;if(iA.style!==undefined){ir=qx.bom.htmlarea.HtmlArea.__wX(iA.style);delete iA.style;}
;if(iy){var iw={domElement:iC,tag:it,attributes:iA,styles:ir};iy(iw);iw.domElement=null;it=iw.tag;}
;if(it){iu.push(z,it);for(var name in iA){var iB=iA[name];iu.push(hh,name,gg,iB.toString().replace(new RegExp(hT,gN),fg),hT);}
;if(!qx.lang.Object.isEmpty(ir)){iu.push(fl);for(var name in ir){var iB=ir[name];iu.push(name,gA,iB.toString().replace(new RegExp(hT,gN),fg),fJ);}
;iu.push(hT);}
;iu.push(closed?gb:fd);}
;}
;for(i=iC.firstChild;i;i=i.nextSibling){iu.push(qx.bom.htmlarea.HtmlArea.__wY(i,true,iz,iy));}
;if(is&&!closed&&it){iu.push(gp,it,fd);}
;break;case 3:iu.push(iz?iC.data:qx.bom.htmlarea.HtmlArea.__xb(iC.data));break;case 8:iu.push(J,iC.data,fM);break;};return iu.join(fE);}
,closingTags:hV,__xa:function(iD){return (qx.bom.htmlarea.HtmlArea.closingTags.indexOf(hh+iD.tagName+hh)!=-1);}
,__xb:function(s){s=s.replace(/&/ig,gw);s=s.replace(/</ig,hY);s=s.replace(/>/ig,gf);s=s.replace(/\x22/ig,hK);s=s.replace(/\xA9/ig,R);return s;}
...
},properties:{contentType:{check:fp,init:ha},messengerMode:{check:gY,init:false},insertParagraphOnLinebreak:{check:gY,init:true},insertLinebreakOnCtrlEnter:{check:gY,init:true},postProcess:{check:t,nullable:true,init:null},useUndoRedo:{check:gY,init:true},nativeContextMenu:{check:gY,init:false},defaultFontFamily:{check:fp,init:fQ},defaultFontSize:{check:fh,init:4}},members:{__lH:null,__eg:false,__xc:false,__xd:false,__xe:false,__xf:false,__wh:null,__xg:null,__xh:null,__xi:null,__sW:null,__wU:null,__xj:null,__xk:null,__xl:false,__xm:false,__xn:function(iH){if(qx.dom.Node.isElement(iH)&&qx.dom.Node.isNodeName(iH,p)){this.__lH=iH;}
;}
,_createAndAddIframe:function(iI){this.__sW=qx.bom.Iframe.create();qx.bom.Iframe.setSource(this.__sW,iI);if((qx.core.Environment.get(eM)==gM)){qx.bom.element.Attribute.set(this.__sW,gR,eP);}
else {qx.bom.element.Style.set(this.__sW,hg,he);}
;qx.bom.element.Style.setStyles(this.__sW,{width:gq,height:gq});qx.dom.Element.insertBegin(this.__sW,this.__lH);}
,_getIframeDocument:function(){return qx.bom.Iframe.getDocument(this.__sW);}
,_getIframeWindow:function(){return qx.bom.Iframe.getWindow(this.__sW);}
,_addIframeLoadListener:function(){qx.event.Registration.addListener(this.__sW,C,this._loaded,this);}
,__xo:function(){this.__xj={"xhtml":{doctype:hM+gC+hI+hc+eE+fH,html:hi+M,meta:hj,style:qx.core.Environment.select(eM,{"mshtml":eJ+fW,"default":fL+gK}),contentStyle:fX,body:gP,footer:fv}};}
,__wV:fE,getIframeObject:function(){return this.__sW;}
,getCommandManager:function(){return this.__wh;}
,setValue:function(iK){if(qx.lang.Type.isString(iK)){this.__wV=iK;var iJ=this._getIframeDocument();if(iJ&&iJ.body){iJ.body.innerHTML=this.__xp(iK);}
;}
;}
,__xp:function(iO){var iN=fE;if((qx.core.Environment.get(eM)==hs)){if(qx.core.Environment.get(gF)<=2){iN+=fb;}
;}
;var iP=iO.length==0?hS:fE;var iM=qx.core.Environment.get(eM)==hs||qx.core.Environment.get(eM)==fO?F:fk;var iL=gm+hC+this.getDefaultFontFamily()+gE+E+iM+K+this.getDefaultFontSize()+gE+iN+iO+iP+hk+c+ht;return iL;}
,getValue:function(){return this.__wV;}
,getComputedValue:function(iQ){return this.getHtml(iQ);}
,getCompleteHtml:function(){var iS=this.__xj[this.getContentType()];var iR=iS.html+gn+iS.meta+eH+iS.contentStyle+hL+gl;iR+=fz+this.__xq()+N;iR+=this.getHtml()+fv;return iR;}
,__xq:function(){var iW=[d,hw,gt,H,B,v,hu,gU,gG,hJ,hr,fB,gh,fK];var iU=qx.bom.element.Style;var iT=this.getContentBody();var iY={};var iV,ja;var iX=qx.core.Environment.get(eM)==gM?2:1;for(var i=0,j=iW.length;i<j;i++ ){iV=iW[i];ja=iU.get(iT,iV,iX);if(ja!==undefined&&ja!=fE){iY[iV]=ja;}
;}
;return qx.bom.element.Style.compile(iY);}
,getContentDocument:function(){if(this.__eg){return this._getIframeDocument();}
;}
,getContentBody:function(){if(this.__eg){return this._getIframeDocument().body;}
;}
,getContentWindow:function(){if(this.__eg){return this._getIframeWindow();}
;}
,getWords:function(jb){if(!jb){jb=this.getContentBody();}
;if(!jb){return [];}
;var jd=jb.cloneNode(true);var jf=jd.innerHTML;jf=jf.replace(/>/gi,hB);jf=jf.replace(/\n/gi,hh);jf=jf.replace(/<!--.*-->/gi,fE);jd.innerHTML=jf;var jc=qx.core.Environment.get(eM)==gM||qx.core.Environment.get(eM)==P?jd.innerText:jd.textContent;var je=jc.match(qx.bom.htmlarea.HtmlArea.GetWordsRegExp);return !je?[]:je;}
,getWordsWithElement:function(){var jh=this.getTextNodes();var jl={};var i,j,jm,ji,jg;for(var i=0,jk=jh.length;i<jk; ++i){ji=jh[i];jm=ji.nodeValue.split(hh);for(var j=0,jj=jm.length;j<jj; ++j){jg=this._cleanupWord(jm[j]);if(jg!=null&&jg.length>1){if(!jl[jg]){jl[jg]=[];}
;jl[jg].push(ji);}
;}
;}
;return jl;}
,_cleanupWord:function(jn){if(!jn){return null;}
;return jn.replace(qx.bom.htmlarea.HtmlArea.CleanupWordsRegExp,fE);}
...
;}
;return jp;}
,__xr:0,__xs:function(){var jr=this._getIframeDocument();if(!jr){this.__xr++ ;if(this.__xr>5){this.error(hF+jr);this.fireDataEvent(fR);}
else {if(qx.core.Environment.get(fa)){this.error(D);}
;qx.event.Timer.once(function(){this.__xs();}
,this,0);}
;}
else {this.__xr=0;this._onDocumentIsReady();}
;}
,_loaded:function(e){if(this.__xd){return;}
;if(this.__xc){this.__xt();return;}
;if((qx.core.Environment.get(eM)==gM)){this.__xs();}
else {this._onDocumentIsReady();}
;}
,isReady:function(){return this.__eg;}
...
;this.__xd=true;if((qx.core.Environment.get(eM)==gM)){this.setEditable(true);}
;this.__xw();if(!(qx.core.Environment.get(eM)==P)){this.__xx();}
;if(!(qx.core.Environment.get(eM)==gM)){this.setEditable(true);}
;this.__eg=true;this.__wh=js;js.setContentDocument(this._getIframeDocument());this.__xC();if((qx.core.Environment.get(eM)==P)){this.__xx();}
;this.fireEvent(gH);}
,forceEditable:qx.core.Environment.select(eM,{"gecko":function(){var jt=this._getIframeDocument();if(jt){if(parseFloat(qx.core.Environment.get(k))>=fm){jt.designMode=fV;jt.body.contentEditable=false;jt.body.contentEditable=true;}
else {jt.body.contentEditable=true;this.__xD(true);}
;}
;}
,"default":(function(){}
)}),invalidateEditor:qx.core.Environment.select(eM,{"gecko":function(){this.__xd=false;this.__eg=false;this.__xc=true;}
,"default":function(){}
}),__xt:qx.core.Environment.select(eM,{"gecko":function(){this.__xw();this.__xx();this.__wh.setContentDocument(this._getIframeDocument());this.setEditable(true);this.forceEditable();this.__xd=true;this.__eg=true;this.__xc=false;this.fireEvent(gd);}
,"default":function(){}
}),__xu:function(jw){var jv=fE;if(!jw){return jv;}
;try{var ju=jw.getAttribute(gc);if(!ju){return jv;}
;if((qx.core.Environment.get(eM)==gM)){jv=ju.cssText;}
else {jv=ju;}
;}
catch(jx){this.error(fY);}
;return jv;}
,__xv:function(jB){var jA=qx.core.Environment.get(eM)==hs?gO:fE;var jz=this.__xj[this.getContentType()];var jy=gn+jz.meta+eH+jA+jz.style+jz.contentStyle+this.__wU+hL+gl;var content=jz.body+jB;return jz.html+jy+content+jz.footer;}
,__xw:function(){var jD=this.__xp(this.getValue());if(qx.lang.Type.isString(jD)){var jC=this._getIframeDocument();try{jC.open(eR,true);jC.write(this.__xv(jD));jC.close();}
catch(e){this.error(x+qx.bom.Iframe.queryCurrentUrl(this.__sW)+fg,e);this.fireDataEvent(fR,e);}
;}
;}
,__xx:function(){this.__xy();this.__xA();this.__xz();}
,__xy:function(){var jF=qx.event.Registration;var jE=this._getIframeDocument();jF.addListener(jE.body,gS,this._handleKeyPress,this);jF.addListener(jE.body,fy,this._handleKeyUp,this);jF.addListener(jE.body,fw,this._handleKeyDown,this);}
,__xz:function(){var jI=qx.event.Registration;var jG=this._getIframeDocument();var jH=qx.core.Environment.get(eM)==fO?this._getIframeWindow():jG.body;jI.addListener(jH,hP,this._handleFocusEvent,this);jI.addListener(jH,eS,this._handleBlurEvent,this);jI.addListener(jG,fS,this._handleFocusOutEvent,this);}
,__xA:function(){var jL=qx.event.Registration;var jK=this._getIframeDocument();var jJ=qx.core.Environment.get(eM)==gM?eK:W;jL.addListener(jK.body,jJ,this._handleMouseUpOnBody,this);jL.addListener(jK.documentElement,jJ,this._handleMouseUpOnDocument,this);jL.addListener(jK.documentElement,fT,this._handleContextMenuEvent,this);}
,__xB:function(){if(this.__xg==null){this.__xg={execute:function(jM,jN){this.stackedCommands=true;this.commandStack.push({command:jM,value:jN});}
,commandStack:[],stackedCommands:false};}
;this.__xg.stackedCommands=false;return this.__xg;}
,__xC:function(){var jO=this.__xg;if(jO!=null&&jO.stackedCommands){var jP=jO.commandStack;if(jP!=null){for(var i=0,j=jP.length;i<j;i++ ){this.__wh.execute(jP[i].command,jP[i].value);}
;}
;}
;}
,__xD:function(jQ){var jR=this._getIframeDocument();if(this.__xd&&jR){try{if((qx.core.Environment.get(eM)==hs)){jR.designMode=(jQ!==false)?gx:u;}
;jR.designMode=(jQ!==false)?u:gx;}
catch(e){}
;}
;}
,setEditable:function(jT){if(this.__xd){this.__xD(true);if((qx.core.Environment.get(eM)==hs)){try{var jS=this._getIframeDocument();jS.execCommand(ge,false,true);}
catch(jU){try{var jS=this._getIframeDocument();jS.execCommand(eW,false,false);}
catch(jV){if(!this.__eg){this.error(m);this.fireDataEvent(fR,jV);}
...
;this.__xe=jT;}
;}
,getEditable:function(){return this.__xe;}
,isEditable:function(){return this.__xe;}
,__xE:false,_handleKeyUp:function(e){var jW=e.getKeyIdentifier().toLowerCase();this.__xh=e;if((qx.core.Environment.get(fa))&&qx.core.Environment.get(hX)){this.debug(e.getType()+hQ+jW);}
;if(qx.core.Environment.get(eM)==gM||qx.core.Environment.get(eM)==fO){if(this.__xE){switch(jW){case X:if(this.getInsertLinebreakOnCtrlEnter()){if((qx.core.Environment.get(eM)==fO)){this.__xF();e.preventDefault();e.stopPropagation();}
else {var jX=this.__xP(this.getSelection());if(jX){jX.collapse(true);jX.pasteHTML(fs);}
;}
;this.__xK();}
;break;case eL:this.__xE=false;return;break;};}
;}
else if((qx.core.Environment.get(eM)==hs)){switch(jW){case hd:case q:case eV:case gQ:case g:case hD:case fe:case n:case T:this.__xf=(this.getFocusNode()==this.getContentBody().firstChild);break;};}
;}
,__xF:function(){var jY=this.getSelection();var ka=fE;if(jY&&(jY.focusNode.textContent==fE||jY.focusNode.parentElement.tagName==hy)){ka=o;}
;this.__wh.execute(fU,ka+qx.bom.htmlarea.HtmlArea.simpleLinebreak);}
,_handleKeyDown:qx.core.Environment.select(eM,{"mshtml|webkit":function(e){var kb=e.getKeyIdentifier().toLowerCase();if((qx.core.Environment.get(fa))&&qx.core.Environment.get(hX)){}
;if(this.__xE&&(kb==fn||kb==Y||kb==fu||kb==hR||kb==L||kb==gs)){e.preventDefault();e.stopPropagation();}
;if(kb==eL){this.__xE=true;}
;}
,"default":function(e){}
}),_handleKeyPress:function(e){var kg=this.getContentDocument();var kc=e.getKeyIdentifier().toLowerCase();var ke=e.isCtrlPressed();var kf=e.isShiftPressed();this.__xh=e;if((qx.core.Environment.get(fa))&&qx.core.Environment.get(hX)){this.debug(e.getType()+hQ+kc);}
;if(this.__xl){var km=!((qx.core.Environment.get(eM)==gM)&&kc==X)||!((qx.core.Environment.get(eM)==hs)&&kc==X);if(km){this.__xK();this.__xl=false;}
;}
;switch(kc){case X:if(!kf&&!ke&&this.getMessengerMode()){e.preventDefault();e.stopPropagation();this.fireDataEvent(fj,this.getComputedValue());this.resetHtml();}
;if(ke){if(!this.getInsertLinebreakOnCtrlEnter()){return;}
;e.preventDefault();e.stopPropagation();if((qx.core.Environment.get(eM)==hs)){if(this.__xN()){this.insertHtml(eI);this.__xK();return;}
;this.insertHtml(eY);}
else if((qx.core.Environment.get(eM)==P)){var kj=this.getSelection();var kh=this.__xP(kj);if(kj&&kh){var ki=kg.createElement(hl);kh.collapse(true);kh.insertNode(ki);kh.collapse(true);kh.selectNode(ki);kj.addRange(kh);kh.collapse(true);}
;}
;this.__xK();}
;if((qx.core.Environment.get(eM)==gM)){if(!this.getInsertParagraphOnLinebreak()){if(this.__wh.execute(fU,qx.bom.htmlarea.HtmlArea.simpleLinebreak)){this.__xK();e.preventDefault();e.stopPropagation();}
;}
;}
else if((qx.core.Environment.get(eM)==hs)){if(this.getInsertParagraphOnLinebreak()&&!kf&&!ke){var kj=this.getSelection();if(kj){var kl=kj.focusNode;if(this.__xN()){this.__xK();return;}
;if(this.__xO()){this.__xK();return;}
;while(!qx.dom.Node.isNodeName(kl,gV)){if(qx.dom.Node.isNodeName(kl,f)){this.__xK();return;}
;kl=kl.parentNode;}
;}
;this.__wh.insertParagraphOnLinebreak();e.preventDefault();e.stopPropagation();this.__xK();this.__xl=true;}
;}
else if((qx.core.Environment.get(eM)==fO)){if(this.getInsertParagraphOnLinebreak()&&kf){this.__xF();e.preventDefault();e.stopPropagation();this.__xK();}
;}
;break;case eV:if(qx.core.Environment.get(eM)==hs&&qx.core.Environment.get(k)<1.9&&kf){var kj=this.getSelection();if(kj&&kj.focusNode==kg.body.firstChild){if(this.__xf){if(kj.focusOffset!=0){kj.extend(kj.focusNode,0);}
;}
;}
;}
;this.__xK();break;case y:if(qx.core.Environment.get(eM)==hs&&qx.core.Environment.get(k)<1.9){if(ke){var kj=this.getSelection();if(kf){if(kj&&(kj.focusOffset!=0)||(kj.focusNode!=kg.body.firstChild)){kj.extend(kg.body.firstChild,0);}
;}
else {var kd=null;var kk;if(kg){kd=kg.evaluate(fD,kg.body,null,XPathResult.ANY_TYPE,null);}
;if(kd&&kj){while(kk=kd.iterateNext()){if(kk&&kk.parentNode&&kk.parentNode.tagName!=eO){try{kj.extend(kk,0);if(!this.isSelectionCollapsed()){kj.collapseToStart();}
;}
catch(kn){}
;break;}
;}
...
;}
;}
;this.__xK();break;case hd:case q:case gQ:case g:case hD:case fe:case n:case T:this.__xK();break;case fu:if(ke){this.__xG(Q,true);}
;break;case L:case gs:if(ke){this.__xG(hN,true);}
;break;case hR:if(ke){this.__xG(O,true);}
;break;case fn:if(ke&&!kf){this.__xG(h,true);}
else if(ke&&kf){this.__xG(gB,true);}
;break;case Y:if(ke){this.__xG(gB,true);}
;break;case gv:if(ke){this.selectAll();}
;break;};this.__xh=null;}
,__xG:function(ko,kr){var kq=null;var kp=qx.bom.htmlarea.HtmlArea.hotkeyInfo;if(kp[ko]){kq=kp[ko].method;}
;if(kq!=null&&this[kq]){this[kq]();if(kr){this.__xh.preventDefault();this.__xh.stopPropagation();}
;if(this.isSelectionCollapsed()){this.__xl=true;}
;this.__xK();}
;}
,_handleFocusEvent:function(e){this.__xi=null;if(qx.core.Environment.get(eM)==hs||qx.core.Environment.get(eM)==fO){var ks=this.getContentDocument().getElementById(eN);if(ks){qx.bom.element.Attribute.reset(ks,fI);}
;}
;this.fireEvent(A);}
,_handleBlurEvent:function(e){this.__wV=this.getComputedValue();}
,_handleFocusOutEvent:function(e){this.__xE=false;if(this.__xi==null){this.__xi=this.getSelectedHtml();}
;this.fireEvent(hp);}
,_handleMouseUpOnBody:function(e){if((qx.core.Environment.get(fa))&&qx.core.Environment.get(hX)){this.debug(hm+e.getType());}
;this.__xm=true;this.__xK();}
,_handleMouseUpOnDocument:qx.core.Environment.select(eM,{"mshtml":(function(){}
),"default":function(e){if(!this.__xm){qx.bom.Element.activate(this.getContentBody());}
;this.__xm=false;}
}),_handleContextMenuEvent:function(e){if(!this.getNativeContextMenu()){var ku=e.getViewportLeft();var kt=e.getViewportTop();var kv=qx.bom.element.Location.getLeft(this.__lH)+ku;var kw=qx.bom.element.Location.getTop(this.__lH)+kt;var kx={x:kv,y:kw,relX:ku,relY:kt,target:e.getTarget()};e.preventDefault();e.stopPropagation();qx.event.Timer.once(function(){this.fireDataEvent(fT,kx);}
,this,0);}
;}
,isLoaded:function(){return this.__xd;}
,insertHtml:function(ky){return this.__wh.execute(fU,ky);}
,removeFormat:function(){var kz=this.__wh.execute(gy);this.__wh.execute(hf,this.getDefaultFontSize());this.__wh.execute(fA,this.getDefaultFontFamily());return kz;}
,setBold:function(){return this.__wh.execute(V);}
,setItalic:function(){return this.__wh.execute(gD);}
,setUnderline:function(){return this.__wh.execute(hq);}
,setStrikeThrough:function(){return this.__wh.execute(eU);}
,setFontSize:function(kA){return this.__wh.execute(hf,kA);}
,setFontFamily:function(kB){return this.__wh.execute(fA,kB);}
,setTextColor:function(kC){return this.__wh.execute(w,kC);}
,setTextBackgroundColor:function(kD){return this.__wh.execute(gk,kD);}
,setJustifyLeft:function(){return this.__wh.execute(hn);}
,setJustifyCenter:function(){return this.__wh.execute(eX);}
,setJustifyRight:function(){return this.__wh.execute(fo);}
,setJustifyFull:function(){return this.__wh.execute(ic);}
,insertIndent:function(){return this.__wh.execute(fi);}
,insertOutdent:function(){return this.__wh.execute(fG);}
,insertOrderedList:function(){return this.__wh.execute(ib);}
,insertUnorderedList:function(){return this.__wh.execute(hW);}
,insertHorizontalRuler:function(){return this.__wh.execute(gr);}
,insertImage:function(kE){return this.__wh.execute(gu,kE);}
,insertHyperLink:function(kF){return this.__wh.execute(ia,kF);}
,removeBackgroundColor:function(){return this.__wh.execute(l,fq);}
,setBackgroundColor:function(kG){return this.__wh.execute(l,kG);}
,removeBackgroundImage:function(){return this.__wh.execute(go);}
,setBackgroundImage:function(kH,kJ,kI){return this.__wh.execute(go,[kH,kJ,kI]);}
,selectAll:function(){return this.__wh.execute(ft);}
,undo:function(){if(this.getUseUndoRedo()){return this.__wh.execute(hb);}
else {return true;}
;}
,redo:function(){if(this.getUseUndoRedo()){return this.__wh.execute(I);}
else {return true;}
;}
,resetHtml:function(){var kK=this._getIframeDocument();while(kK.body.firstChild){kK.body.removeChild(kK.body.firstChild);}
;if(qx.core.Environment.get(eM)==hs){kK.body.innerHTML=gI;}
else if(qx.core.Environment.get(eM)==fO){var kL=this.getSelection();var kM=kK.createRange();if(kM&&kL){kL.addRange(kM);}
;}
;}
,getHtml:function(kN){var kO=this._getIframeDocument();if(kO==null){return null;}
;return qx.bom.htmlarea.HtmlArea.__wY(kO.body,false,kN,this.getPostProcess());}
,containsOnlyPlaceholder:qx.core.Environment.select(eM,{"mshtml":function(){var kP=this._getIframeDocument();return (kP.body.innerHTML==gj);}
...
,focusContent:qx.core.Environment.select(eM,{"gecko":function(){var kU=this.getContentDocument();var kT=kU.getElementById(eN);this.getContentWindow().focus();qx.bom.Element.focus(this.getContentBody());if(kT){this._selectElement(kT);}
else {this.__xH();}
;}
,"webkit":function(){qx.bom.Element.focus(this.getContentWindow());qx.bom.Element.focus(this.getContentBody());var kV=this.getContentDocument().getElementById(eN);if(kV){qx.bom.element.Attribute.reset(kV,fI);}
;this.__xH();}
,"opera":function(){qx.bom.Element.focus(this.getContentWindow());qx.bom.Element.focus(this.getContentBody());this.__xH();}
,"default":function(){qx.bom.Element.focus(this.getContentBody());this.__xH();}
}),__xH:function(){if(!this.__xI()){this.__xJ();}
;}
,__xI:qx.core.Environment.select(eM,{"gecko":function(){var kW=this.getContentBody().childNodes;if(kW.length==0){return false;}
else if(kW.length==1){return !(kW[0]&&qx.dom.Node.isNodeName(kW[0],hl)&&qx.bom.element.Attribute.get(kW[0],fc)!=null);}
else {return true;}
;}
,"webkit":function(){var kX=this.getContentBody().childNodes;if(kX.length==0){return false;}
else if(kX.length==1){return !(kX[0]&&qx.dom.Node.isNodeName(kX[0],hl));}
else {return true;}
;}
,"default":function(){var kY=this.getContentBody().childNodes;if(kY.length==0){return false;}
else if(kY.length==1){return !(kY[0]&&qx.dom.Node.isNodeName(kY[0],hO)&&kY[0].firstChild==null);}
else {return true;}
;}
}),__xJ:qx.core.Environment.select(eM,{"gecko|webkit":function(){this.getContentDocument().body.innerHTML=this.__xp(fE);var la=this.getContentDocument().getElementById(eN);qx.bom.element.Attribute.reset(la,fI);this._selectElement(la);}
,"default":function(){var lb=qx.dom.Hierarchy.getFirstDescendant(this.getContentBody());if(qx.dom.Node.isNodeName(lb,hO)){qx.bom.element.Style.set(lb,gL,this.getDefaultFontFamily());qx.bom.element.Style.set(lb,eD,this.getDefaultFontSize());}
;}
}),getContextInformation:function(){return this.__xL();}
,__xK:function(){qx.event.Timer.once(function(e){var lc=this.__xL();this.fireDataEvent(U,lc);}
,this,200);}
,__xL:function(){if(this._processingExamineCursorContext||this.getEditable()==false){return null;}
;this._processingExamineCursorContext=true;if(!this.__xI()){this.__xJ();}
;var lg=this.getFocusNode();if(lg==null){return null;}
;if(qx.dom.Node.isText(lg)){lg=lg.parentNode;}
;var lk=this._getIframeDocument();var lt=(qx.core.Environment.get(eM)==gM)?lg.currentStyle:lk.defaultView.getComputedStyle(lg,null);var lm=false;var ld=false;var li=false;var lh=false;var ll=false;var ls=false;var lj=false;var lu=false;var lf=false;var lp=false;var lq=null;var lr=null;var ln=null;if(lt!=null){if((qx.core.Environment.get(eM)==gM)){ld=lt.fontStyle==gD;li=lt.textDecoration.indexOf(hq)!==-1;lh=lt.textDecoration.indexOf(fr)!==-1;lq=lt.fontSize;ln=lt.fontFamily;lj=lt.textAlign==hd;lu=lt.textAlign==hv;lf=lt.textAlign==q;lp=lt.textAlign==hx;}
else {ld=lt.getPropertyValue(gW)==gD;li=lt.getPropertyValue(ho).indexOf(hq)!==-1;lh=lt.getPropertyValue(ho).indexOf(fr)!==-1;lq=lt.getPropertyValue(eD);ln=lt.getPropertyValue(gL);lj=lt.getPropertyValue(hH)==hd;lu=lt.getPropertyValue(hH)==hv;lf=lt.getPropertyValue(hH)==q;lp=lt.getPropertyValue(hH)==hx;}
;if(qx.core.Environment.get(eM)==gM||qx.core.Environment.get(eM)==P){lm=lt.fontWeight==700;}
else {lm=lt.getPropertyValue(hz)==V||qx.dom.Node.isNodeName(lg,fu);}
;}
;var le=lg;if(le!=null&&le.parentNode!=null&&!qx.dom.Node.isDocument(le.parentNode)){while(le!=null&&!qx.dom.Node.isNodeName(le,gV)){var lv=qx.dom.Node.getName(le);if(lv==hU){ls=true;break;}
else if(lv==S){ll=true;break;}
;if(lr==null||lr==fE){lr=qx.bom.element.Attribute.get(le,gT);}
;le=le.parentNode;}
;}
...
,getSelection:qx.core.Environment.select(eM,{"mshtml":function(){return this._getIframeDocument()?this._getIframeDocument().selection:null;}
,"default":function(){return this._getIframeWindow()?this._getIframeWindow().getSelection():null;}
}),isSelectionCollapsed:qx.core.Environment.select(eM,{"mshtml":function(){return this.getSelection()&&this.getSelection().type==eQ;}
,"default":function(){return this.getSelection()&&this.getSelection().isCollapsed;}
}),getSelectedText:qx.core.Environment.select(eM,{"mshtml":function(){return this.getRange()?this.getRange().text:fE;}
,"default":function(){return this.getRange()?this.getRange().toString():fE;}
}),getSelectedHtml:function(){if(this.__xi!=null){return this.__xi;}
;var lw=this.getRange();if(!lw){return fE;}
else {return this.__xM(lw);}
;}
,__xM:qx.core.Environment.select(eM,{"mshtml":function(lx){if(!lx){return fE;}
;return lx.item?lx.item(0).outerHTML:lx.htmlText;}
,"default":function(lz){var ly=this._getIframeDocument();if(ly&&lz){try{var lA=ly.createElement(gV);lA.appendChild(lz.cloneContents());return lA.innerHTML;}
catch(lB){}
;return lz+fE;}
;return fE;}
}),clearSelection:qx.core.Environment.select(eM,{"mshtml":function(){var lC=this.getSelection();if(lC){lC.empty();}
;}
,"default":function(){var lD=this.getSelection();if(lD){lD.collapseToStart();}
;}
}),__xN:qx.core.Environment.select(eM,{"gecko":function(){var lE=this.getSelection();var lF=this.getFocusNode();return lE&&this.isSelectionCollapsed()&&lF!=null&&qx.dom.Node.isText(lF)&&lE.anchorOffset<lF.length;}
,"default":function(){return false;}
}),__xO:qx.core.Environment.select(eM,{"gecko":function(){return qx.dom.Node.isElement(this.getFocusNode());}
,"default":function(){return false;}
}),getRange:function(){return this.__xP(this.getSelection());}
,__xP:qx.core.Environment.select(eM,{"mshtml":function(lH){var lG=this._getIframeDocument();if(lH){try{return lH.createRange();}
...
;}
}),saveRange:qx.core.Environment.select(eM,{"mshtml":function(){this.__xk=this.getRange();}
,"default":function(){}
}),getSavedRange:qx.core.Environment.select(eM,{"mshtml":function(){return this.__xk;}
,"default":function(){}
}),resetSavedRange:qx.core.Environment.select(eM,{"mshtml":function(){this.__xk=null;}
,"default":function(){}
}),getFocusNode:qx.core.Environment.select(eM,{"mshtml":function(){var lM=this.getSelection();var lN;switch(lM.type){case ff:case eQ:lN=this.__xP(lM);if(lN){lN.collapse(false);return lN.parentElement();}
else {return null;}
;break;case hE:lN=this.__xP(lM);if(lN){try{lN.collapse(false);}
catch(lO){}
;return lN.item(0);}
else {return null;}
...
})},environment:{"qx.bom.htmlarea.HtmlArea.debug":false},destruct:function(){try{var lR=this._getIframeDocument();var lT=qx.event.Registration;lT.removeListener(lR.body,gS,this._handleKeyPress,this);lT.removeListener(lR.body,fy,this._handleKeyUp,this);lT.removeListener(lR.body,fw,this._handleKeyDown,this);var lS=qx.core.Environment.get(eM)==fO?this._getIframeWindow():lR.body;lT.removeListener(lS,hP,this._handleFocusEvent);lT.removeListener(lS,eS,this._handleBlurEvent);lT.removeListener(lR,fS,this._handleFocusOutEvent);var lQ=qx.core.Environment.get(eM)==gM?eK:W;lT.removeListener(lR.body,lQ,this._handleMouseUpOnBody,this);lT.removeListener(lR.documentElement,lQ,this._handleMouseUpOnDocument,this);lT.removeListener(lR.documentElement,fT,this._handleContextMenuEvent,this);if((qx.core.Environment.get(eM)==gM)){qx.bom.Iframe.setSource(this.__sW,gJ);}
;}
catch(lU){}
;if(this.__wh instanceof qx.core.Object){this._disposeObjects(fx);}
else {this.__wh=null;}
;this.__xj=this.__sW=this.__lH=this.__xg=null;}
});}
)();
...
(function(){var a="backgroundColor",b="_moz",c="top",d="/>",f="formatBlock",g=';',h="insertParagraph",m=" succeded",n="li",o='<span style="',p="underline",q="__yC",r="<img ",s="' is not allowed for parameter 'position'. Possible values are '",t="no-repeat",u="</font>",v=' <a href="',w="FONT",x="inserthyperlink failed!",y="__yi",z="backgroundPosition",A="|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",B="__placeholder__",C="JustifyCenter",D="transparent",E="Cut",F="outdent",G='</a> ',H="InsertImage",I="font-size",J="__resetHtml",K="FontName",L="p",M="bold",N="__yy",O="blockquote",P="If an array is provided for parameter 'position' it has to define two elements!",Q="inserthtml",R="span",S='|',T="id",U="style",V='color',W="The method '",X="qx.bom.htmlarea.manager.Command",Y="'><br class='webkit-block-placeholder' />",dM="string",dH="a",dN="__yx",dJ="<span></span>",dK="href",dG="background-color",dL="backgroundRepeat",dR="type",dS="font",dT="CreateLink",dU=":",dO="InsertHtml",dP="__yg",dI="':'",dQ="='",dY=" with value ",eD="italic",ea='">',eb="' you calling to execute the command '",dV="font-family",dW="mshtml",fE="qx_link",dX="none",ec="__yw",ed='"></span>',ee="Italic",ej="fontStyle",ek=" ",el=";",ef=" failed",eg="InsertUnorderedList",eh="body",ei="__yf",eq="OL",er='text-align:',es="Bold",et="ForeColor",em="child",en="px",eo="url(",ep='" ',ey="repeat repeat-x repeat-y no-repeat",ez='</p>',fI="gecko",eA="<hr />",eu="legacy-font-size",ev="backgroundImage",fG="editor not ready! '",ew='<font style="',eB="text-align",eC="Command ",eO="__yv",eN="Control",eM="IMG",eS="__paragraph__",eR='<p id="',eQ="JustifyRight",eP='text-decoration',eH="LI",eG="__getHtml",eF='>',eE="BackColor",eL='font-family:',eK='" size="',eJ="Indent",eI=':',fa="HiliteColor",eY="__yE",eX="br",eW="fontWeight",fe="Copy",fd="</span>",fc="engine.name",fb="Paste",eV="The value '",eU="__yu",eT="qx.bom.htmlarea.HtmlArea.debug",fp="__yl",fo="RemoveFormat",fn="text-decoration",ft="StrikeThrough",fs="size",fr="FontSize",fq="' is not allowed for parameter 'repeat'. Possible values are '",fi="' ",fh='',fg="__yB",ff="webkit",fm='style="',fl="execCommand ",fk="'",fj="' is not available!",fz="_moz_dirty",fy="__yk",fx="color",fw="qx.debug",fD="JustifyLeft",fC="textDecoration",fB=" is currently not supported!",fA="Underline",fv="SelectAll",fu="__yt",dC="<p style='",dB="line-through",fJ="BODY",dz=")",dA="__yb",dy="",fH='"',dw='<span id="',dx="UL",dv="__yz",fF="JustifyFull",dt="__yD",du="Outdent",ds="indent",dE="selectall",dF="InsertOrderedList",dD="undefined";qx.Class.define(X,{extend:qx.core.Object,construct:function(fK){qx.core.Object.call(this);this.__wi=fK;this.__sJ=null;this._commands=null;this.__wK();this.__xQ={"Bold":true,"Italic":true,"Underline":true,"StrikeThrough":true};this.__xR=[10,12,16,18,24,32,48];this.__xS=0;}
,statics:{__xT:A,__xU:ey},members:{__sJ:null,__wi:null,__xV:false,__xQ:null,__xR:null,__xS:null,setContentDocument:function(fL){this.__sJ=fL;}
,getCommandObject:function(fM){if(this._commands[fM]){return this._commands[fM];}
else {return null;}
;}
,__wK:function(){this._commands={bold:{useBuiltin:false,identifier:es,method:fg},italic:{useBuiltin:false,identifier:ee,method:q},underline:{useBuiltin:false,identifier:fA,method:dt},strikethrough:{useBuiltin:false,identifier:ft,method:eY},fontfamily:{useBuiltin:true,identifier:K,method:null},fontsize:{useBuiltin:false,identifier:fr,method:fu},textcolor:{useBuiltin:true,identifier:et,method:null},textbackgroundcolor:{useBuiltin:false,identifier:null,method:eU},backgroundcolor:{useBuiltin:false,identifier:null,method:eO},backgroundimage:{useBuiltin:false,identifier:null,method:ec},justifyleft:{useBuiltin:false,identifier:fD,method:ei},justifyright:{useBuiltin:false,identifier:eQ,method:ei},justifycenter:{useBuiltin:false,identifier:C,method:ei},justifyfull:{useBuiltin:false,identifier:fF,method:ei},indent:{useBuiltin:true,identifier:eJ,method:null},outdent:{useBuiltin:true,identifier:du,method:null},copy:{useBuiltin:true,identifier:fe,method:null},cut:{useBuiltin:true,identifier:E,method:null},paste:{useBuiltin:true,identifier:fb,method:null},insertorderedlist:{useBuiltin:false,identifier:dF,method:dP},insertunorderedlist:{useBuiltin:false,identifier:eg,method:dP},inserthorizontalrule:{useBuiltin:false,identifier:dO,method:fp},insertimage:{useBuiltin:false,identifier:H,method:y},inserthyperlink:{useBuiltin:false,identifier:dT,method:fy},selectall:{useBuiltin:false,identifier:fv,method:dN},selectedtext:{useBuiltin:false,identifier:null,method:N},selectedhtml:{useBuiltin:false,identifier:null,method:dv},inserthtml:{useBuiltin:false,identifier:dO,method:dA},resethtml:{useBuiltin:false,identifier:null,method:J},gethtml:{useBuiltin:false,identifier:null,method:eG},removeformat:{useBuiltin:true,identifier:fo,method:null}};}
,execute:function(fN,fP){if(!this.__wi.isReady()){this.error(fG+fN+dI+fP+fk);return false;}
;fN=fN.toLowerCase();fP=fP!=null?fP:null;if(this._commands[fN]){var fO;var fQ=this._commands[fN];if(!((qx.core.Environment.get(fc)==ff)&&(fN==ds||fN==F))){if(this.__xW()){this.__xX();}
;}
;if(fQ.useBuiltin){fO=this.__xY(fQ.identifier,false,fP);}
else {if(fQ.method!=null&&this[fQ.method]){fO=this[fQ.method].call(this,fP,fQ);}
else {this.error(W+fQ.method+eb+fN+fj);}
;}
;this.__wi.resetSavedRange();return fO;}
else {this.error(eC+fN+fB);}
;}
,__xW:function(){var Node=qx.dom.Node;var fR=this.__wi.getFocusNode();var fU=false;var fS=false;if(fR){if(Node.isText(fR)){var fT=qx.dom.Hierarchy.getAncestors(fR);for(var i=0,j=fT.length;i<j;i++ ){if(Node.isNodeName(fT[i],L)||qx.bom.htmlarea.HtmlArea.isHeadlineNode(fT[i])){fU=true;break;}
;}
;}
else if(Node.isNodeName(fR,eh)){fS=true;}
;}
;return fS||!fU;}
,__xX:function(){this.__xY(f,false,L);}
,__xY:function(gc,ga,fX){try{var fW=this.__sJ;var fV=false;var fY=this.__wi.getRange();this.__sJ.body.focus();if((qx.core.Environment.get(fc)==dW)){if(gc!=dE){fY.select();if(((fY.text)&&(fY.text.length>0))||((fY.length==1)&&(fY.item(0))&&(fY.item(0).tagName==eM))){fW=fY;}
else {fW=this.__sJ;}
;}
;if(((qx.core.Environment.get(fc)==dW))&&(this.__xQ[gc])){if(fY.text==dy){fV=true;}
;}
;}
;var gb=fW.execCommand(gc,ga,fX);if(fV&&fY.text!=dy){fY.collapse();}
;if((qx.core.Environment.get(fw))&&qx.core.Environment.get(eT)){this.debug(fl+gc+dY+fX+m);}
;this.__xV=false;}
catch(gd){if((qx.core.Environment.get(fw))&&qx.core.Environment.get(eT)){this.debug(fl+gc+dY+fX+ef);}
;return false;}
;return gb;}
,__ya:qx.core.Environment.select(fc,{"mshtml":function(){var gf=this.__wi;var ge=gf.getSavedRange()!=null?gf.getSavedRange():gf.getRange();return ge;}
,"default":function(){return this.__wi.getRange();}
}),__yb:qx.core.Environment.select(fc,{"mshtml":function(gj,gk){var gi;if(gj==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__ye();}
else {this.__sJ.body.focus();var gh=this.__wi.getSelection();var gg=this.__ya();if(gg&&gh&&gh.type!=eN){try{gg.pasteHTML(gj);gg.collapse(false);gg.select();gi=true;}
catch(e){}
;}
else {gi=false;}
;this.__wi.resetSavedRange();return gi;}
;}
,"default":function(gl,gm){this.__sJ.body.focus();return this.__sJ.execCommand(gm.identifier,false,gl);}
}),insertParagraphOnLinebreak:qx.core.Environment.select(fc,{"gecko":function(){var gu=this.__yo();var gy=this.__yc(gu);var gq=this.__ym(gu);var gv=B+Date.parse(new Date());var gw=eS+Date.parse(new Date());var go=fh;var gs=dw+gv+ed;go+=gs;go+=eR+gw+ep+gy+eF;go+=gq+ez;this.__wi.getCommandManager().addUndoStep(Q,h,this.getCommandObject(Q));this.execute(Q,go);this.__yd();qx.bom.element.Attribute.reset(this.__sJ.getElementById(gv),T);var gt=this.__sJ.getElementById(gw);if(gt.previousSibling.innerHTML==gs){var gn=this.__yn();var gr=this.__sJ.createElement(eX);var gp=this.__sJ.createAttribute(fz);gp.nodeValue=dy;gr.setAttributeNode(gp);var gx=this.__sJ.createAttribute(dR);gx.nodeValue=b;gr.setAttributeNode(gx);gt.previousSibling.appendChild(gn);gt.previousSibling.appendChild(gr);}
;qx.bom.element.Attribute.reset(gt,T);return true;}
,"webkit":function(){var gz=this.getCurrentStyles();var gA=dy;var gC={"background-color":true,"text-align":true};for(var gB in gz){if(gC[gB]){gA+=gB+dU+gz[gB]+el;}
;}
;this.__wi.insertHtml(dC+gA+Y);}
,"default":(function(){}
)}),__yc:qx.core.Environment.select(fc,{"gecko":function(gG){var gI=fm;var gD=gG.child;if(gD[eB]){gI+=er+gD[eB]+g;delete gG.child[eB];}
;if(gD[dV]){gI+=eL+gD[dV]+g;delete gG.child[dV];}
;var gH={"padding-top":true,"padding-bottom":true,"padding-left":true,"padding-right":true};var gF={"margin-top":true,"margin-bottom":true,"margin-left":true,"margin-right":true};for(var gE in gD){if(gH[gE]||gF[gE]){gI+=gE+eI+gD[gE]+g;delete gG.child[gE];}
;}
;gI+=fH;return gI;}
,"default":function(){return dy;}
}),__yd:qx.core.Environment.select(fc,{"gecko":function(){var gQ=this.__wi.getSelection();if(!gQ||!gQ.focusNode){return;}
;var gJ=gQ.focusNode;var gO=gQ.focusNode;while(!qx.dom.Node.isNodeName(gO,L)){gO=gO.parentNode;}
;var gN=gO.previousSibling.id;var gR=gO.nextSibling?gO.nextSibling.id:null;if(qx.lang.String.startsWith(gN,eS)&&gN==gR){var gP=gO.nextSibling;var gL=this.__wi.getRange();gL.selectNode(gP);gQ.addRange(gL);var gK=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;this.__wi.getCommandManager().addUndoStep(Q,gK,this.getCommandObject(Q));this.execute(Q,gK);var gM=this.__wi.getRange();if(gJ){while(gJ&&gJ.firstChild&&qx.dom.Node.isElement(gJ.firstChild)){gJ=gJ.firstChild;}
;}
;gM.selectNode(gJ);gQ.addRange(gM);gM.collapse(true);}
;}
,"default":(function(){}
)}),__ye:qx.core.Environment.select(fc,{"mshtml":function(){var gS=this.__wi.getRange();if(gS&&!qx.dom.Node.isNodeName(gS.parentElement(),n)){gS.pasteHTML(qx.bom.htmlarea.HtmlArea.simpleLinebreak);gS.collapse(false);gS.select();return true;}
;return false;}
,"default":function(){return false;}
}),__yf:function(gU,gV){var gT=(qx.core.Environment.get(fc)==dW)?this.__wi.getRange():this.__sJ;return gT.execCommand(gV.identifier,false,gU);}
,__yg:function(gY,ha){if((qx.core.Environment.get(fc)==dW)){var gX=this.__wi.getFocusNode();this.__yh(gX);}
;this.__sJ.body.focus();var gW=this.__sJ.execCommand(ha.identifier,false,gY);if((qx.core.Environment.get(fc)==ff)){var gX=this.__wi.getFocusNode();this.__yh(gX.parentNode);}
;return gW;}
,__yh:function(hb){var hc=[];var parent=hb.parentNode;while(qx.dom.Node.isNodeName(parent,O)){hc.push(parent);parent=parent.parentNode;}
;if(hc.length>0){parent.appendChild(hb);parent.removeChild(hc[hc.length-1]);}
;}
,__yi:qx.core.Environment.select(fc,{"gecko":function(hs,hm){if(hs.src){this.__sJ.execCommand(hm.identifier,false,hs.src);delete hs.src;var hf=this.__wi.getSelection();if(hf){var he=hf.anchorNode;var hn=hf.anchorOffset;var hg=he.childNodes[hn-1];var hp;for(var hi in hs){hp=this.__sJ.createAttribute(hi);hp.nodeValue=hs[hi];hg.setAttributeNode(hp);}
...
;var hq=this.__sJ.createDocumentFragment();var hr;if(hl&&hd!=null){var hh=this.__yj(hd);hq.appendChild(hh.root);hr=hh.inline;}
else {hr=this.__sJ.createElement(R);hq.appendChild(hr);}
;var ho=this.__sJ.createTextNode(dy);hr.appendChild(ho);var hk=hg.parentNode;if(hg==hk.lastChild){hk.appendChild(hq);}
else {hk.insertBefore(hq,hg.nextSibling);}
;var hj=this.__wi.getRange();hj.selectNodeContents(hr);}
;return true;}
else {return false;}
;}
,"mshtml":function(hx,hu){var hw=false;var ht=r;for(var hv in hx){ht+=hv+dQ+hx[hv]+fi;}
;ht+=d;var hy=this.__wi.getSelection();var hz=this.__ya();if(hy&&hy.type!=eN){try{hz.select();hz.pasteHTML(ht);hw=true;}
catch(e){}
;}
;this.__wi.resetSavedRange();return hw;}
,"default":function(hB,hD){if(hB.src){var hC=r;for(var hA in hB){hC+=hA+dQ+hB[hA]+fi;}
;hC+=d;return this.__sJ.execCommand(dO,false,hC);}
else {return false;}
;}
}),__yj:function(hF){while(hF.firstChild&&hF.firstChild.nodeType==1){hF=hF.firstChild;}
;var hI=this.__yo(hF);var hM,hG,hK;var hE=dy;var parent=null;var hL=null;var hJ=hI.child;while(hJ){hL=this.__sJ.createElement(hJ[eu]?dS:R);hG=this.__sJ.createAttribute(U);hL.setAttributeNode(hG);for(var hH in hJ){if(hH!=em&&hH!=eu){hE+=hH+dU+hJ[hH]+el;}
else if(hH==eu){hK=this.__sJ.createAttribute(fs);hK.nodeValue=hJ[hH];hL.setAttributeNode(hK);}
;}
;hG.nodeValue=hE;if(parent!=null){parent.appendChild(hL);}
else {hM=hL;}
;parent=hL;hJ=hJ.child;hE=dy;}
;return {root:hM,inline:hL};}
,__yk:qx.core.Environment.select(fc,{"gecko|opera":function(hN,hR){var hU=this.__wi.getSelection();var hP=this.__wi.getRange();if(hU.isCollapsed){var hO=fE+( ++this.__xS);var hV=this.__sJ.createElement(dH);var hQ=this.__sJ.createAttribute(dK);var hS=this.__sJ.createAttribute(T);var hT=this.__sJ.createTextNode(hN);hS.nodeValue=hO;hV.setAttributeNode(hS);hQ.nodeValue=hN;hV.setAttributeNode(hQ);hV.appendChild(hT);hP.insertNode(hV);hP.selectNode(hV);hU.collapseToEnd();return true;}
else {return this.__sJ.execCommand(hR.identifier,false,hN);}
;}
,"mshtml":function(hW,ib){try{var ia;var hX=this.__ya();var hY=this.__wi;var hX=hY.getSavedRange()!=null?hY.getSavedRange():hY.getRange();if(hX!=null&&hX.text!=dy){ia=hX.execCommand(ib.identifier,false,hW);}
else {ia=this.__yb(v+hW+ea+hW+G,ib);}
;this.__wi.resetSavedRange();return ia;}
catch(e){if(qx.core.Environment.get(fw)){this.error(x);}
;return false;}
;}
,"default":function(ic,id){return this.__sJ.execCommand(id.identifier,false,ic);}
}),__yl:function(ig,ih){var ie=eA;if((qx.core.Environment.get(fc)==fI)){ie+=this.__ym();}
;return this.__yb(ie,ih);}
,__ym:function(ij){var im=dy;var il=o;var ik=[];var iq=typeof ij!==dD?ij:this.__yo();var io=iq.child;var ip=false;if(qx.lang.Object.isEmpty(io)){return dy;}
;while(io){ip=io[eu]!=null;im+=ip?ew:il;for(var ii in io){im+=(ii!=em&&ii!=eu)?ii+eI+io[ii]+g:dy;}
;im+=ip?eK+io[eu]+ea:ea;ik.unshift(ip?u:fd);io=io.child;}
;if(ik.length==1&&ik[0]==u){im+=dJ;}
;for(var i=0,j=ik.length;i<j;i++ ){im+=ik[i];}
;return im;}
,__yn:function(){var is=this.__sJ.createDocumentFragment();var ix=this.__yo();var parent=is;var iv=ix.child;var it;var iw=false;while(iv){iw=iv[eu]!=null;it=this.__sJ.createElement(iw?dS:R);parent.appendChild(it);for(var ir in iv){if(ir!=em&&ir!=eu){qx.bom.element.Style.set(it,ir,iv[ir]);}
;}
;if(iw){var iu=this.__sJ.createAttribute(fs);iu.nodeValue=iv[eu];it.setAttributeNode(iu);}
;parent=it;iv=iv.child;}
;return is;}
,__yo:function(iz){var iA={};var iB=null;var iC=this.getCurrentStyles(iz);iB=iA.child={};for(var iy in iC){if(iy!=fn){iB[iy]=iC[iy];}
;}
;if(iC[fn]){var iD=iC[fn];for(var i=0,j=iD.length;i<j;i++ ){if(iB==null){iB=iA.child={};}
else {iB=iB.child={};}
;iB[V]=iD[i][V];iB[eP]=iD[i][eP];}
;}
;if(iC[V]&&iC[eP]){iB=iB.child={};iB[V]=iC[V];}
;return iA;}
,getCurrentStyles:function(iG){if(iG==null){var iJ=this.__wi.getSelection();if(!iJ||iJ.focusNode==null){return {};}
;iG=(iJ.focusNode.nodeType==3)?iJ.focusNode.parentNode:iJ.focusNode;}
;var iH=qx.dom.Hierarchy.getAncestors(iG);var iE=qx.lang.Array.insertBefore(iH,iG,iH[0]);var iI=this.__yp(iE);var iF=this.__yq(iI,iE);return iF;}
,__yp:function(iN){var iM={};var iK,iL;for(var i=0,j=iN.length;i<j;i++ ){iL=iN[i];for(var k=0,l=iL.style.length;k<l;k++ ){iK=iL.style[k];if(iK.length>0&&typeof iM[iK]===dD){iM[iK]=iL.style.getPropertyValue(iK);}
;}
;if(iL.tagName.toUpperCase()==w&&iL.size&&iM[eu]===undefined){iM[eu]=iL.size;}
;}
;if(iM[eu]&&iM[I]){delete iM[I];}
;return iM;}
,__yq:function(iT,iP){var iR=iP[0];var iS=this.__wi.getContentWindow().getComputedStyle(iR,null);var iU;var iQ={};for(var iO in iT){if(iO!=eu){iU=iS.getPropertyValue(iO);}
else {iU=iT[iO];}
;if(iO==dG&&iU==D){iQ[iO]=this.__ys(iP);}
else if(iO==fn){iQ[iO]=this.__yr(iP);}
else {iQ[iO]=iU;}
;}
;return iQ;}
,__yr:function(iX){var iY,jb,iV;var ja=[];var iW=this.__wi.getContentWindow();for(var i=0,j=iX.length;i<j;i++ ){iV=iW.getComputedStyle(iX[i],null);iY=iV.getPropertyValue(fn);jb=iV.getPropertyValue(fx);if(iY!=dX){ja.push({'text-decoration':iY,'color':jb});}
;}
;return ja;}
,__ys:function(jd){var je,jc,jf;for(var i=0;i<jd.length;i++ ){je=jd[i];jc=this.__wi.getContentWindow().getComputedStyle(je,null);jf=jc.getPropertyValue(dG);if(jf!=D){return jf;}
;}
;}
,__yt:function(jm,jn){var jh=this.__wi.getSelection();var jl=((qx.core.Environment.get(fc)==dW))?this.__wi.getRange():jl=jh.getRangeAt(0);var jp=[];var jt;var jk=[eq,dx];var jg,i,j,jr;jr=((qx.core.Environment.get(fc)==dW))?jl.parentElement():jl.commonAncestorContainer;if(jr.tagName==fJ){for(var i=0;i<jk.length;i++ ){jg=jr.getElementsByTagName(jk[i]);for(var j=0;j<jg.length;j++ ){if(jg[j]){jp.push(jg[j]);}
;}
;}
;}
else if(qx.lang.Array.contains(jk,jr.tagName)){jp.push(jr);}
;if(jp.length>0){for(var i=0;i<jp.length;i++ ){var js=jp[i];jt=((qx.core.Environment.get(fc)==dW))?((js==jr)||(jr.tagName==fJ)):jh.containsNode(js,false);for(j=0;j<js.childNodes.length;j++ ){var jj=js.childNodes[j];if(jt||(jh.focusNode.nodeValue&&qx.dom.Hierarchy.contains(jj,jh.focusNode)&&(jh.focusOffset==jh.focusNode.nodeValue.length))||(qx.dom.Hierarchy.contains(jj,jh.anchorNode)&&(jh.anchorOffset==0))||(jh.containsNode(jj,false))){jj.style.fontSize=(this.__xR[jm]||jm)+en;}
;}
;}
;}
else {var ji=((qx.core.Environment.get(fc)==dW))?jr:jh.focusNode;var jo=qx.dom.Hierarchy.getAncestors(ji);for(i=0;i<jo.length;i++ ){if(jo[i].tagName==eH){if((((qx.core.Environment.get(fc)==fI))&&((jh.anchorOffset==0)&&(jh.focusNode.nodeValue&&(jh.focusOffset==jh.focusNode.nodeValue.length))&&qx.dom.Hierarchy.contains(jo[i].firstChild,jh.anchorNode)&&qx.dom.Hierarchy.contains(jo[i].lastChild,jh.focusNode)))||(((qx.core.Environment.get(fc)==dW))&&(jl.htmlText==jo[i].innerHTML))){jo[i].style.fontSize=(this.__xR[jm]||jm)+en;}
;break;}
;}
;}
;if((qx.core.Environment.get(fc)==dW)){this.__sJ.body.focus();this.__wi.getRange().select();return this.__sJ.execCommand(fr,false,jm);}
else if((qx.core.Environment.get(fc)==fI)){var parent=jl.commonAncestorContainer;if(parent.nodeType===1){var jq=parent.getElementsByTagName(R);for(i=0;i<jq.length;i++ ){if(jq[i].style.fontSize){jq[i].style.fontSize=null;}
;}
;}
;}
;return this.__sJ.execCommand(fr,false,jm);}
,__yu:qx.core.Environment.select(fc,{"mshtml":function(ju,jv){this.__sJ.body.focus();return this.__sJ.execCommand(eE,false,ju);}
,"gecko|opera":function(jw,jx){this.__sJ.body.focus();return this.__sJ.execCommand(fa,false,jw);}
,"webkit":function(jA,jB){var jC=this.__wi.getSelection();var jz=this.__wi.getRange();if(!jC||!jC.isCollapsed){this.__sJ.body.focus();this.__sJ.execCommand(eE,false,jA);if(jC){jC.collapseToEnd();}
;return true;}
...
;}
;jz.setStart(jC.anchorNode,jC.anchorNode.nodeValue.charAt(jE)==ek?jE+1:jE);jz.setEnd(jC.anchorNode,jy);jC.addRange(jz);this.__sJ.body.focus();this.__sJ.execCommand(eE,false,jA);jC.collapseToEnd();return true;}
;}
}),__yv:function(jF,jG){jF=jF!=null&&typeof jF==dM?jF:D;qx.bom.element.Style.set(this.__sJ.body,a,jF);return true;}
,__yw:function(jJ,jK){var jI,jH,jM;var jL=qx.bom.htmlarea.manager.Command;if(jJ==null){jI=null;}
else {jI=jJ[0];jH=jJ[1];jM=jJ[2];}
;if(jI==null||typeof jI!=dM){qx.bom.element.Style.set(this.__sJ.body,ev,dy);qx.bom.element.Style.set(this.__sJ.body,dL,dy);qx.bom.element.Style.set(this.__sJ.body,z,dy);return true;}
else {if(jI.search(/^url.*\(/)==-1){jI=eo+jI+dz;}
;}
;if(jH!=null&&!qx.lang.String.contains(jL.__xU,jH)){if(qx.core.Environment.get(fw)){this.error(eV+jH+fq+jL.__xU+fk);}
;return false;}
else {jH=t;}
;if(jM!=null){if(qx.lang.Type.isString(jM)&&!qx.lang.String.contains(jL.__xT,S+jM+S)){if(qx.core.Environment.get(fw)){this.error(eV+jM+s+jL.__xT+fk);}
;return false;}
else {if(qx.lang.Type.isArray(jM)&&jM.length==2){jM=jM[0]+ek+jM[1];}
else {if(qx.core.Environment.get(fw)){this.error(P);}
;return false;}
;}
;}
else {jM=c;}
;qx.bom.element.Style.set(this.__sJ.body,ev,jI);qx.bom.element.Style.set(this.__sJ.body,dL,jH);qx.bom.element.Style.set(this.__sJ.body,z,jM);return true;}
,__yx:qx.core.Environment.select(fc,{"mshtml":function(jO,jP){var jN=this.__sJ.body.createTextRange();jN.select();return true;}
,"default":function(jQ,jR){return this.__xY(jR.identifier,false,jQ);}
}),__yy:function(){return this.__wi.getSelectedText();}
,__yz:function(){return this.__wi.getSelectedHtml();}
,__yA:function(jV,jW){var jU=this.__wi.getFocusNode();if(jU.textContent==dy){var jT=qx.dom.Hierarchy.getAncestors(jU);jT.unshift(jU);var Node=qx.dom.Node;var jS=qx.bom.element.Style;var jX=jT.shift();while(jT.length>0){if(Node.getName(jX)==L||Node.getName(jX)==eh){break;}
;if(jS.get(jX,jV,jS.LOCAL_MODE)==jW){jS.reset(jX,jV);return true;}
;jX=jT.shift();}
;}
;return false;}
,__yB:qx.core.Environment.select(fc,{"gecko":function(jY,ka){if(this.__yA(eW,M)){return true;}
else {return this.__xY(ka.identifier,false,jY);}
;}
,"default":function(kb,kc){return this.__xY(kc.identifier,false,kb);}
}),__yC:qx.core.Environment.select(fc,{"gecko":function(kd,ke){if(this.__yA(ej,eD)){return true;}
else {return this.__xY(ke.identifier,false,kd);}
;}
,"default":function(kf,kg){return this.__xY(kg.identifier,false,kf);}
}),__yD:qx.core.Environment.select(fc,{"gecko":function(kh,ki){if(this.__yA(fC,p)){return true;}
else {return this.__xY(ki.identifier,false,kh);}
;}
,"default":function(kj,kk){return this.__xY(kk.identifier,false,kj);}
}),__yE:qx.core.Environment.select(fc,{"gecko":function(kl,km){if(this.__yA(fC,dB)){return true;}
else {return this.__xY(km.identifier,false,kl);}
;}
,"default":function(kn,ko){return this.__xY(ko.identifier,false,kn);}
})},destruct:function(){this.__sJ=this.__wi=this._commands=null;this.__xQ=this.__xR=null;}
});}
)();
(function(){var a="undo",b="backgroundColor",c="actionType ",d="mousedown",f="pageup",g="ADD TO UNDO STACK",h="backgroundimage",k="control",l="shift",m="end",n="right",o="qx_link",p="b",q="insertunorderedlist",r="Command",s=" ",t="Undo",u="pagedown",v="k",w="home",x="qx.debug",y="Content",z="Redo",A=" is not managed! Please provide a handler method!",B="table",C="backgroundImage",D="backgroundRepeat",E="p",F="a",G="insertorderedlist",H="__wh",I="y",J="backgroundPosition",K="justifyright",L="redo",M="insertParagraph",N="qx.bom.htmlarea.manager.UndoRedo",O="left",P="i",Q="backgroundcolor",R="td",S="img",T="Internal",U="u",V="inserthyperlink",W="gecko",X="enter",Y="mshtml",bu="engine.name",bv="mouseup",bw="keypress",bq="execCommand failed! Details: ",br="ADD TO REDO STACK",bs="qx.bom.htmlarea.HtmlArea.debug",bt="webkit",bA="insertimage",bB="inserthtml",bC="z",bD="Custom",bx="undoRedoState",by="down",bz="up",bp="body";qx.Class.define(N,{extend:qx.core.Object,construct:function(bF,bE){qx.core.Object.call(this);this.__wh=bF;this.__wi=bE;this.__wj=[];this.__wk=[];this._commands=null;this.__sJ=null;this.__wl={};this.__wm={command:true,content:true,custom:true};this.__wK();this.__wn=qx.lang.Function.bind(this._handleKeyPress,this);this.__wo=qx.lang.Function.bind(this._handleMouseUp,this);if((qx.core.Environment.get(bu)==Y)){this.__wp=qx.lang.Function.bind(this._handleMouseDown,this);}
;}
,members:{__wq:false,__wr:false,__ws:false,__wm:null,__wl:null,__wh:null,__sJ:null,__wj:null,__wk:null,__wi:null,__wn:null,__wo:null,__wp:null,__wt:null,setContentDocument:function(bG){this.__sJ=bG;this.__wh.setContentDocument(bG);qx.event.Registration.addListener(bG.body,bw,this.__wn,this);qx.event.Registration.addListener(bG.body,bv,this.__wo,this);if((qx.core.Environment.get(bu)==Y)){qx.event.Registration.addListener(bG.body,d,this.__wp,this,true);}
;}
,insertParagraphOnLinebreak:function(){return this.__wh.insertParagraphOnLinebreak();}
,execute:function(bH,bJ){var bI;bH=bH.toLowerCase();if(this._commands[bH]){if(this._commands[bH].passthrough){bI=this.__wh.execute(bH,bJ);}
else {bI=this[bH].call(this);}
;}
else {if((qx.core.Environment.get(bu)==Y)||(qx.core.Environment.get(bu)==bt)){this.__wL(bH,bJ,this.__wh.getCommandObject(bH));bI=this.__wh.execute(bH,bJ);if(!bI){this.__wj.pop();}
;}
else {bI=this.__wh.execute(bH,bJ);if(bI){this.__wL(bH,bJ,this.__wh.getCommandObject(bH));}
;}
;if(bH==a&&this.__wj.length==0){this.__wr=false;this.__wT();}
else if(bH==L&&this.__wk.length==0){this.__wq=false;this.__wT();}
;}
;this.__ws=false;return bI;}
,addUndoStep:function(bK,bL,bM){this.__wL(bK,bL,bM);}
,registerHandler:function(bO,bN,bQ,bP){this.__wl[bO]={undo:bN,redo:bQ,context:bP};}
,isUndoPossible:function(){return this.__wr;}
,undo:function(){var bT;if(this.__ws){this.__wN();}
;if(this.__wj.length>0){var bS=this.__wj.pop();if(this.__wm[bS.actionType.toLowerCase()]){switch(bS.actionType){case r:bT=this.__wv(bS);break;case y:bT=this.__wz(bS);break;case T:bT=this.__wy(bS);break;case bD:bT=this.__wu(bS);break;};}
else if(this.__wl[bS.actionType]){var bR=this.__wl[bS.actionType];bT=bR.undo.call(bR.context?bR.context:this,bS);this.__wP(bS);}
else {this.error(c+bS.actionType+A);}
;this.__wq=true;this.__wT();return bT;}
;}
,__wu:qx.core.Environment.select(bu,{"mshtml|webkit":function(bW){var bU=this.__sJ.body.innerHTML;var bX=bW.content;this.__sJ.body.innerHTML=bX;var bV=bW;bV.content=bU;this.__wP(bV);return true;}
,"default":function(cc){var cb=cc;var ca=qx.bom.element.Style;switch(cc.command){case Q:cb.parameter=[ca.get(this.__sJ.body,b)];break;case h:cb.parameter=[ca.get(this.__sJ.body,C),ca.get(this.__sJ.body,D),ca.get(this.__sJ.body,J)];break;};this.__wP(cb);if(cc.command==V){if((qx.core.Environment.get(bu)==W)){var cd=o+this.__wh.__hyperLinkId;var bY=this.__sJ.getElementById(cd);if(bY){bY.parentNode.removeChild(bY);return true;}
else {return false;}
;}
;}
else {return this.__wh.execute(cc.command,cc.value);}
;}
}),__wv:qx.core.Environment.select(bu,{"mshtml|webkit":function(ce){}
,"default":function(cf){this.__wP(cf);if((qx.core.Environment.get(bu)==W)){if(cf.command==bB&&cf.value==qx.bom.htmlarea.HtmlArea.EMPTY_DIV&&this.__ww(bB,M)){this.__wx();}
;}
;return this.__wA();}
}),__ww:function(cg,ch){if(this.__wj.length>0){var ci=this.__wj[this.__wj.length-1];return (ci.command==cg&&ci.value==ch);}
;return false;}
,__wx:function(){this.__wA();if(this.__wj.length>0){var cj=this.__wj.pop();this.__wP(cj);}
;}
,__wy:function(ck){this.__wP(ck);return this.__wA();}
,__wz:qx.core.Environment.select(bu,{"gecko":function(cl){this.__wP(cl);try{return this.__wA();}
catch(cm){if(qx.core.Environment.get(x)){this.error(bq+cm);}
;}
;}
,"mshtml|webkit":function(cn){}
,"default":function(co){this.__wP(co);return this.__wA();}
}),__wA:function(){try{return this.__sJ.execCommand(t,false,null);}
catch(e){return false;}
;}
,isRedoPossible:function(){return this.__wq;}
,redo:function(){if(this.__wq){var cq;if(this.__wk.length>0){var cr=this.__wk.pop();if(this.__wm[cr.actionType.toLowerCase()]){switch(cr.actionType){case r:cq=this.__wC(cr);break;case y:cq=this.__wI(cr);break;case T:cq=this.__wH(cr);break;case bD:cq=this.__wB(cr);break;};}
else if(this.__wl[cr.actionType]){var cp=this.__wl[cr.actionType];cq=cp.redo.call(cp.context?cp.context:this,cr);this.__wO(cr);}
else {this.error(c+cr.actionType+A);}
;this.__wr=true;this.__wT();}
;return cq;}
;}
,__wB:qx.core.Environment.select(bu,{"mshtml|webkit":function(cu){var cs=this.__sJ.body.innerHTML;var cv=cu.content;this.__sJ.body.innerHTML=cv;var ct=cu;ct.content=cs;this.__wO(ct);return true;}
,"default":function(cw){this.__wO(cw);return this.__wJ();}
}),__wC:qx.core.Environment.select(bu,{"mshtml|webkit":function(cx){}
,"default":function(cy){this.__wO(cy);var cz=this.__wJ();if((qx.core.Environment.get(bu)==W)){if(this.__wD(bB,qx.bom.htmlarea.HtmlArea.EMPTY_DIV)){var cA=this.__wE();this.__wF();if(cA!=null){this.__wG(cA);}
;}
;}
;return cz;}
}),__wD:function(cC,cD){if(this.__wk.length>0){var cB=this.__wk[this.__wk.length-1];return (cB.command==cC&&cB.value==cD);}
;return false;}
,__wE:function(){if(this.__wi==null){return null;}
;var cE=this.__wi.getSelection();var cF=cE?cE.focusNode:null;if(cF==null){return null;}
...
;}
,__wF:function(){var cH=this.__wk.pop();this.__wO(cH);this.__wJ();}
,__wG:qx.core.Environment.select(bu,{"gecko":function(cK){if(cK==this.__wi.getContentBody().lastChild){return;}
;var cL=cK.firstChild;while(cL.firstChild){cL=cL.firstChild;}
;var cI=this.__wi.getSelection();var cJ=this.__wi.getRange();if(cI&&cJ){cJ.selectNode(cL);cI.addRange(cJ);cJ.collapse(true);}
;}
,"default":(function(){}
)}),__wH:function(cM){this.__wO(cM);return this.__wJ();}
,__wI:qx.core.Environment.select(bu,{"mshtml|webkit":function(cN){}
,"default":function(cO){this.__wO(cO);return this.__wJ();}
}),__wJ:function(){try{return this.__sJ.execCommand(z,false,null);}
catch(e){return false;}
;}
,__wK:function(){this._commands={undo:{passthrough:false},redo:{passthrough:false}};this.__wh.getCommandObject(Q).customUndo=true;this.__wh.getCommandObject(h).customUndo=true;if((qx.core.Environment.get(bu)==W)){}
;}
,__wL:qx.core.Environment.select(bu,{"mshtml|webkit":function(cP,cR,cS){var cQ=this.getUndoRedoObject();cQ.commandObject=cS;cQ.command=cP;cQ.value=cR;cQ.actionType=bD;cQ.content=this.__sJ.body.innerHTML;this.__wM(cQ);}
,"default":function(cX,cV,cW){if(this.__wi==null){return;}
;var cT=this.getUndoRedoObject();cT.commandObject=cW;cT.command=cX;cT.value=cV;cT.actionType=bD;var cY=this.__wi.getSelection();if(cW.customUndo){var cU=[];switch(cX){case Q:cU.push(qx.bom.element.Style.get(this.__sJ.body,b));break;case h:cU.push(qx.bom.element.Style.get(this.__sJ.body,C),qx.bom.element.Style.get(this.__sJ.body,D),qx.bom.element.Style.get(this.__sJ.body,J));break;case V:if(cY&&!cY.isCollapsed){cT.actionType=r;}
;break;};cT.parameter=cU;}
else {if((qx.core.Environment.get(bu)==W)){if(cY&&cY.isCollapsed){switch(cX){case G:case q:case K:case bB:case bA:cT.actionType=r;break;default:return;};}
else {cT.actionType=r;}
;}
else {cT.actionType=r;}
;}
;this.__wM(cT);}
}),__wM:function(da){if(this.__ws){this.__wN();}
;this.__wO(da);this.__wq=false;this.__wk=[];this.__wT();}
,__wN:function(){var db=this.__wj[this.__wj.length-1];if(db==null||db.actionType!=y){var dc=this.getUndoRedoObject();dc.actionType=y;if((qx.core.Environment.get(bu)==Y)||(qx.core.Environment.get(bu)==bt)){dc.content=this.__wt;dc.actionType=bD;this.__wt=null;}
;this.__wO(dc);this.__ws=false;}
;}
...
,__wO:function(dd){if((qx.core.Environment.get(x))&&qx.core.Environment.get(bs)){this.debug(g);this.debug(dd.actionType+s+dd.command+s+dd.value);}
;this.__wj.push(dd);}
,__wP:function(de){if((qx.core.Environment.get(x))&&qx.core.Environment.get(bs)){this.debug(br);this.debug(de.actionType+s+de.command+s+de.value);}
;this.__wk.push(de);}
,_handleKeyPress:function(e){var df=e.getKeyIdentifier().toLowerCase();var dg=e.isCtrlPressed();switch(df){case k:case l:case O:case n:case bz:case by:case f:case u:case w:case m:case X:break;case F:case p:case P:case U:case v:case I:case bC:if(!dg){this.__wQ();}
;break;default:this.__wq=false;this.__wk=[];this.__wQ();};}
,__wQ:function(){if(!this.__ws){this.__ws=true;this.__wr=true;if((qx.core.Environment.get(bu)==Y)||(qx.core.Environment.get(bu)==bt)){this.__wt=this.__sJ.body.innerHTML;}
;this.__wT();}
;}
,__wR:null,_handleMouseDown:qx.core.Environment.select(bu,{"mshtml":function(e){var dh=e.getOriginalTarget();if(qx.dom.Node.isElement(dh)&&(qx.dom.Node.isNodeName(dh,S)||qx.dom.Node.isNodeName(dh,B))){this.__wR={node:dh,content:dh.outerHTML};}
else {this.__wR=null;}
;}
,"default":function(e){return true;}
}),_handleMouseUp:qx.core.Environment.select(bu,{"gecko":function(e){if(this.__wi==null){return;}
;var dj=this.__wi.getSelection();if(!dj){this.__wR=null;return;}
;var dl=dj.anchorNode;var dk=dl.childNodes[dj.anchorOffset];if(qx.dom.Node.isNodeName(dk,S)){if(this.__wR==null){this.__wR=dk.cloneNode(true);}
else {if(this.__wR.style.width!=dk.style.width||this.__wR.style.height!=dk.style.height){this.__wS();this.__wR=dk.cloneNode(true);}
;}
;}
else if(qx.dom.Node.isNodeName(dl,R)||qx.dom.Node.isNodeName(dl.parentNode,R)){var di=dl.parentNode;while(qx.dom.Node.isNodeName(di,B)){di=di.parentNode;}
;if(this.__wR==null){this.__wR=di.cloneNode(true);}
else {qx.event.Timer.once(function(){if(di.style.width!=this.__wR.style.width||di.style.height!=this.__wR.style.height||di.innerHTML!=this.__wR.innerHTML){this.__wS();this.__wR=di.cloneNode(true);}
;}
,this,0);}
;}
else {this.__wR=null;}
;}
,"default":function(e){var dm=qx.bom.Event.getTarget(e);if(this.__wR!=null){if(dm.nodeType==1){if(dm==this.__wR.node){if(dm.outerHTML!=this.__wR.content){this.__wR.content=dm.outerHTML;this.__wS();}
;}
else {for(var i=0,j=dm.childNodes.length;i<j;i++ ){if(dm.childNodes[i]==this.__wR.node){if(dm.childNodes[i].outerHTML!=this.__wR.content){this.__wR.content=dm.childNodes[i].outerHTML;this.__wS();}
;}
;}
;}
;}
...
;}
;}
}),__wS:qx.core.Environment.select(bu,{"mshtml|webkit":function(){this.__wL(T,null,null);}
,"default":function(){var dn=this.getUndoRedoObject();dn.actionType=T;this.__wO(dn);}
}),__wT:function(){qx.event.Timer.once(function(e){if(this.__wi!=null){var dp={undo:this.isUndoPossible()?0:-1,redo:this.isRedoPossible()?0:-1};this.__wi.fireDataEvent(bx,dp);}
;}
,this,200);}
},destruct:function(){try{qx.event.Registration.removeListener(this.__sJ.body,bw,this.__wn);qx.event.Registration.removeListener(this.__sJ,bv,this.__wo);if((qx.core.Environment.get(bu)==Y)){qx.event.Registration.removeListener(this.__sJ,d,this.__wp);}
;}
catch(e){}
;this._disposeObjects(H);this.__wi=this.__wj=this.__wk=this._commands=this.__sJ=null;this.__wm=this.__wl=null;}
});}
)();
