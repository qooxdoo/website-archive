...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Virtual_List.a77cb7acc740.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Boolean",b="one",c="selected",d="_applySpacing",f="qx.event.type.Data",g="Integer",h="_applyDragSelection",k="changeSelection",m="String",n="resize",o="demobrowser.demo.virtual.list.List",p="list",q="multi",r="row",s="_applyQuickSelection",t="single",u="_applyItemHeight",v="_applySelectionMode",w="additive",x="changeName",y="Number",z="addItem",A="removeItem",B="changeHeight",C=",";qx.Class.define(o,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.virtual.core.IWidgetCellProvider],construct:function(){qx.ui.virtual.core.Scroller.call(this,0,1,this.getItemHeight(),10);this.__Sw=new qx.ui.virtual.layer.WidgetCell(this);this.getPane().addLayer(this.__Sw);this.getPane().addListener(n,this._onResize,this);this.__nM=[];this.__cM=[];this.__oa=new qx.ui.virtual.selection.Row(this.getPane());this.__oa.addListener(k,this._onChangeSelection,this);this.__oa.attachMouseEvents();this.__oa.attachKeyEvents(this);this.__oa.attachListEvents(this);new qx.ui.virtual.behavior.Prefetch(this,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:400,maxAbove:600,minBelow:400,maxBelow:600}).set({interval:500});}
,events:{addItem:f,removeItem:f,changeValue:f,changeSelection:f},properties:{appearance:{refine:true,init:p},focusable:{refine:true,init:true},spacing:{check:g,init:0,apply:d,themeable:true},enableInlineFind:{check:a,init:true},name:{check:m,nullable:true,event:x},itemHeight:{init:24,themeable:true,check:y,apply:u},selectionMode:{check:[t,q,w,b],init:t,apply:v},dragSelection:{check:a,init:false,apply:h},quickSelection:{check:a,init:false,apply:s}},members:{__nM:null,__cM:null,__oa:null,__Sw:null,syncWidget:function(){this.update();}
,update:function(){var D=this.getPane().getRowConfig();D.setItemCount(this.__nM.length);D.resetItemSizes();for(var i=0;i<this.__nM.length;i++ ){var E=this.__nM[i].getHeight();if(E!==null){D.setItemSize(i,E);}
;}
;}
,updateSelection:function(){var F=this.__Sw.getChildren();for(var i=0;i<F.length;i++ ){var G=F[i];var H=G.getUserData(r);if(this.__oa.isItemSelected(H)){G.addState(c);}
...
,_onChangeSelection:function(e){this.updateSelection();this.fireDataEvent(k,this.__SA(e.getData()));}
,getCellWidget:function(L,I){var K=this.__nM[L];if(!K){return null;}
;var J=this.__cM.pop()||new qx.ui.form.ListItem();J.set({label:K.getLabel(),icon:K.getIcon()});if(this.__oa.isItemSelected(L)){J.addState(c);}
...
;this.setSelection(S);}
,getChildren:function(){return this.__nM;}
,hasChildren:function(){return this.__nM.length>0;}
...
,add:function(W){this.__nM.push(W);this._addHelper(W);return this;}
,remove:function(X){qx.lang.Array.remove(this.__nM,X);this._removeHelper(X);return this;}
,removeAll:function(){for(var i=0,j=this.__nM.length;i<j;i++ ){this._removeHelper(this.__nM[i]);}
;this.__nM=[];}
,indexOf:function(Y){return this.__nM.indexOf(Y);}
,addAt:function(bb,ba){qx.lang.Array.insertAt(this.__nM,bb,ba);this._addHelper(bb);}
,addBefore:function(bc,bd){qx.lang.Array.insertBefore(this.__nM,bc,bd);this._addHelper(bc);}
,addAfter:function(bf,be){qx.lang.Array.insertAfter(this.__nM,bf,be);this._addHelper(bf);}
,removeAt:function(bg){this.__nM.splice(bg,1);this._removeHelper(this.__nM[bg]);}
,__Sx:function(bh){var bi=this.__nM.indexOf(bh);if(bi<0){return null;}
else {return bi;}
;}
,__Sy:function(bk){var bj=this.__nM[bk];return bj;}
,__Sz:function(bl){var bm=[];for(var i=0;i<bl.length;i++ ){bm.push(this.__Sx(bl[i]));}
;return bm;}
,__SA:function(bo){var bn=[];for(var i=0;i<bo.length;i++ ){bn.push(this.__nM[bo[i]]);}
;return bn;}
,selectAll:function(){this.__oa.selectAll();}
,setSelected:function(bp){this.__oa.selectItem(this.__Sx(bp));}
,isSelected:function(bq){return this.__oa.isItemSelected(this.__Sx(bq));}
,addToSelection:function(br){this.__oa.addItem(this.__Sx(br));}
,removeFromSelection:function(bs){this.__oa.removeItem(this.__Sx(bs));}
,selectRange:function(bt,bu){this.__oa.selectItemRange(this.__Sx(bt),this.__Sx(bu));}
,resetSelection:function(){this.__oa.clearSelection();}
,setSelection:function(bv){this.__oa.replaceSelection(this.__Sz(bv));}
,getSelectedItem:function(){return this.__nM[this.getSelected()];}
,getSelected:function(){return this.__nM[this.__oa.getSelectedItem()];}
,getSelection:function(){return this.__SA(this.__oa.getSelection());}
,getSortedSelection:function(){return this.__SA(this.__oa.getSortedSelection());}
,isSelectionEmpty:function(){return this.__oa.isSelectionEmpty();}
,getSelectionContext:function(){return this.__oa.getSelectionContext();}
,getSelectables:function(){return this.__SA(this.__oa.getSelectables());}
,_applySelectionMode:function(bx,bw){this.__oa.setMode(bx);}
,_applyDragSelection:function(bz,by){this.__oa.setDrag(bz);}
,_applyQuickSelection:function(bB,bA){this.__oa.setQuick(bB);}
}});}
)();
...
(function(){var a="_applyInterval",b="appear",c="qx.debug",d="interval",e="qx.ui.virtual.behavior.Prefetch",f="scroll",g="_applyScroller",h="qx.ui.virtual.core.Scroller",i="__ik",j="scrollbar-x",k="Integer",l="scrollbar-y";qx.Class.define(e,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(c)){this.assertObject(n);this.assertPositiveInteger(n.minLeft);this.assertPositiveInteger(n.maxLeft);this.assertPositiveInteger(n.minRight);this.assertPositiveInteger(n.maxRight);this.assertPositiveInteger(n.minAbove);this.assertPositiveInteger(n.maxAbove);this.assertPositiveInteger(n.minBelow);this.assertPositiveInteger(n.maxBelow);}
;qx.core.Object.call(this);this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);this.__ik=new qx.event.Timer(this.getInterval());this.__ik.addListener(d,this._onInterval,this);if(m){this.setScroller(m);}
;}
,properties:{scroller:{check:h,nullable:true,init:null,apply:g},interval:{check:k,init:200,apply:a}},members:{__uX:null,__uY:null,__ik:null,__va:null,__vb:null,setPrefetchX:function(o,r,p,q){this.__uX=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__uY=[v,u,t,s];}
,_onInterval:function(){var w=this.__uX;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__uY;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__va){y.getChildControl(j).removeListenerById(this.__va);}
;if(this.__vb){y.getChildControl(l).removeListenerById(this.__vb);}
;}
;if(z){if(!z.getContentElement().getDomElement()){this.__ik.stop();z.addListenerOnce(b,this.__ik.start,this.__ik);}
else {this.__ik.restart();}
;this.__va=z.getChildControl(j).addListener(f,this.__ik.restart,this.__ik);this.__vb=z.getChildControl(l).addListener(f,this.__ik.restart,this.__ik);}
else {this.__ik.stop();}
;}
,_applyInterval:function(B,A){this.__ik.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__uX=this.__uY=null;this._disposeObjects(i);}
});}
)();
