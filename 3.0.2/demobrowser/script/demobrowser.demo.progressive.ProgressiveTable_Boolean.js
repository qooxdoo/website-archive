...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Boolean.94869c62aa7f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="\"",b="  var filters = this.filters.item(loader); ",c="Boolean",d="  this.attributes.setNamedItem(namedItem); ",e="} catch (e) { ",f="var node = this.attributes.getNamedItem('celldata'); ",g="changeTheme",h="qx.ui.progressive.renderer.table.cell.Boolean",i="decoration/table/boolean-true.png",j="var value = node.nodeValue; ",k="}",l="css.alphaimageloaderneeded",m="decoration/table/boolean-false.png",n="{",o="celldata='1' ",p="  node.nodeValue='0'; ",q="'; ",r="qx.dyntheme",s="  this.attributes.setNamedItem(node); ",t="  var loader = 'DXImageTransform.Microsoft.AlphaImageLoader'; ",u="if (value == '0') ",v="celldata='0' ",w="  node.nodeValue='1'; ",x="  this.src='",y="onclick=\"",z="  filters.sizingMethod = 'scale'; ",A="  namedItem.value = node.nodeValue; ",B="var src; ",C="try { ",D="  filters.src='",E="  var namedItem = document.createAttribute('celldata'); ",F="} ",G="else ";qx.Class.define(h,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(){qx.ui.progressive.renderer.table.cell.Icon.call(this);this.__JK();if(qx.core.Environment.get(r)){qx.theme.manager.Decoration.getInstance().addListener(g,this.__JK,this);}
;}
,properties:{allowToggle:{check:c,init:false}},members:{__JI:null,__JJ:null,__EX:null,__Fa:null,__yS:null,__yT:null,__yU:null,__yV:null,__JK:function(){var J=qx.util.AliasManager.getInstance();var K=qx.util.ResourceManager.getInstance();var I=J.resolve(i);var H=J.resolve(m);this.__JI=K.toUri(I);this.__JJ=K.toUri(H);}
,_identifyImage:function(L){var M={imageWidth:11,imageHeight:11};switch(L.cellData){case true:M.url=this.__JI;M.extras=o;break;case false:M.url=this.__JJ;M.extras=v;break;default:M.url=null;break;};if(this.getAllowToggle()){M.extras+=y+f+j+B+u+n;if(qx.core.Environment.get(l)&&/\.png$/i.test(this.__JI)){M.extras+=x+this.getBlankImage()+q+t+b+D+this.__JI+q+z;}
else {M.extras+=x+this.__JI+q;}
;M.extras+=w+F+G+n;if(qx.core.Environment.get(l)&&/\.png$/i.test(this.__JJ)){M.extras+=x+this.getBlankImage()+q+t+b+D+this.__JJ+q+z;}
else {M.extras+=x+this.__JJ+q;}
...
},destruct:function(){this.__JI=this.__JJ=null;if(qx.core.Environment.get(r)){qx.theme.manager.Decoration.getInstance().removeListener(g,this.__JK,this);}
;}
});}
)();
