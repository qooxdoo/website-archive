...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.ResizeEvent.11ce14b80b00.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="demobrowser.demo.test.ResizeEvent",c="click",d="red",f="Resize red",g="blue";qx.Class.define(b,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var i=new qx.ui.core.Widget().set({backgroundColor:d,width:80});var h=new qx.ui.core.Widget().set({backgroundColor:g});this.getRoot().add(i,{left:10,top:10});this.getRoot().add(h,{left:10,top:110});i.addListener(a,function(e){this.debug(f);h.setWidth(e.getData().width);}
);i.addListener(c,function(){i.setWidth(i.getWidth()+10);}
);}
}});}
)();
