...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Bubbling.4b60f8fe2d14.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="</th></tr>",b="demobrowser.demo.event.EventDemo",c="</th><th>",d="",e="</td><td>",f="<table><tr><th>",g="<tr><td>",h="btnClear",j="</table>",k="click",l="</td></tr>";qx.Class.define(b,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var m=document.getElementById(h);if(m){qx.bom.Element.addListener(m,k,this._clearLog,this);}
;}
,_initLogger:function(p,n,o){this.__RA=f+p.join(c)+a;this.__RB=o||50;this.__RC=n;this._clearLog();}
,_clearLog:function(){this.__RC.innerHTML=this.__RA+j;this.__RD=[];}
,_log:function(q){this.__RD.unshift(q);this.__RD=this.__RD.slice(0,this.__RB);var r=[this.__RA];for(var i=0;i<this.__RD.length;i++ ){r.push(g,this.__RD[i].join(e),l);}
;r.push(j);this.__RC.innerHTML=r.join(d);this.__RC.scrollTop=0;}
,__RA:null,__RB:null,__RC:null,__RD:null},destruct:function(){this.__RC=this.__RD=null;}
});}
)();
...
(function(){var a="logger",b="click",c="Event phase",d="capture",f="Current target",g="at target",h="div",j="Event",k="demobrowser.demo.event.Event_Bubbling",l="bubble",m="Target";qx.Class.define(k,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this._initLogger([j,m,f,c],document.getElementById(a),50);for(var i=1;i<10;i++ ){var n=document.getElementById(h+i);qx.event.Registration.addListener(n,b,this._cascadeCapture,this,true);qx.event.Registration.addListener(n,b,this._cascadeBubble,this,false);}
;}
,_cascadeCapture:function(e){this._log([e.getType(),e.getTarget().id,e.getCurrentTarget().id,e.getEventPhase()==2?g:d]);}
,_cascadeBubble:function(e){this._log([e.getType(),e.getTarget().id,e.getCurrentTarget().id,e.getEventPhase()==2?g:l]);}
}});}
)();
