...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_Scroller.0fd114901db1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__cO={};this.__gA={};}
,members:{__pG:false,__pH:false,__gA:null,__cO:null,inTouchMomentum:function(){if(qx.core.Environment.get(d)){qx.Bootstrap.warn(f+m+l);}
;return this.__pG;}
,_onTouchStart:function(e){if(this.__gA){clearTimeout(this.__gA.x);clearTimeout(this.__gA.y);}
;this.__cO={"x":0,"y":0};if(this.__pG){this.__pH=true;this.__pG=false;}
;}
,_onTouchEnd:function(e){if(this.__pH){this.__pH=false;e.stop();}
;}
,_onTouchMove:function(e){this._onTouchMoveDirectional(n,e);this._onTouchMoveDirectional(o,e);this.__pG=true;e.stop();}
...
;this.__cO[t]=e[g+p]();r.scrollBy(s);if(this.__gA[t]){clearTimeout(this.__gA[t]);this.__gA[t]=null;}
;this.__gA[t]=setTimeout(qx.lang.Function.bind(function(u){this.__gD(u,t);}
,this,s),100);}
;}
,__gD:function(v,x){this.__gA[x]=null;var y=this._isChildControlVisible(h+x);if(v==0||!y){this.__pG=false;return;}
;if(v>0){v=Math.max(0,v-3);}
else {v=Math.min(0,v+3);}
;this.__gA[x]=setTimeout(qx.lang.Function.bind(function(A,z){this.__gD(A,z);}
,this,v,x),10);var w=this.getChildControl(h+x,true);w.scrollBy(v);}
},destruct:function(){clearTimeout(this.__gA.x);clearTimeout(this.__gA.y);this.__gA=this.__cO=this.__pG=null;}
});}
)();
...
(function(){var a="mousedown",b="Boolean",c="scroll",d="focus-indicator",g="__pJ",h="mouseout",i="__pP",j="changeHorizontalScrollBarVisible",k="excluded",l="bottom",m="_applyScrollTimeout",n="changeScrollX",o="_applyTablePaneModel",p="Integer",q="scrollbar-y",r="qx.event.type.Data",s="dblclick",t="__pM",u="dataEdited",v="mousewheel",w="interval",y="qx.ui.table.pane.Scroller",z="table-scroller-focus-indicator",A="visible",B="mousemove",C="__pL",D="resize-line",E="_applyShowCellFocusIndicator",F="__pN",G="y",H="header",I="resize",J="__pI",K="vertical",L="__pO",M="__pK",N="changeScrollY",O="editing",P="appear",Q="click",R="modelChanged",S="table-scroller",T="beforeSort",U="scrollbar-x",V="__pQ",W="cellDblclick",X="mouseup",Y="horizontal",bx="cellClick",by="losecapture",bz="contextmenu",bt="col-resize",bu="disappear",bv="_applyVerticalScrollBarVisible",bw="_applyHorizontalScrollBarVisible",bD="os.scrollBarOverlayed",bE="pane",bF="cellContextmenu",bH="close",bA="__ik",bB="changeTablePaneModel",bC="x",br="qx.ui.table.pane.Model",bG="qx.ui.table.pane.CellEvent",bs="changeVerticalScrollBarVisible";qx.Class.define(y,{extend:qx.ui.core.Widget,include:qx.core.Environment.filter({"event.touch":qx.ui.core.scroll.MTouchScroll,"true":qx.ui.core.scroll.MScrollBarFactory}),construct:function(bI){qx.ui.core.Widget.call(this);this.__nt=bI;var bJ=new qx.ui.layout.Grid();bJ.setColumnFlex(0,1);bJ.setRowFlex(1,1);this._setLayout(bJ);this.__pI=this._showChildControl(H);this.__pJ=this._showChildControl(bE);this.__pK=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({minWidth:0});this._add(this.__pK,{row:0,column:0,colSpan:2});this.__pL=new qx.ui.table.pane.Clipper();this.__pL.add(this.__pI);this.__pL.addListener(by,this._onChangeCaptureHeader,this);this.__pL.addListener(B,this._onMousemoveHeader,this);this.__pL.addListener(a,this._onMousedownHeader,this);this.__pL.addListener(X,this._onMouseupHeader,this);this.__pL.addListener(Q,this._onClickHeader,this);this.__pK.add(this.__pL,{flex:1});this.__pM=new qx.ui.table.pane.Clipper();this.__pM.add(this.__pJ);this.__pM.addListener(v,this._onMousewheel,this);this.__pM.addListener(B,this._onMousemovePane,this);this.__pM.addListener(a,this._onMousedownPane,this);this.__pM.addListener(X,this._onMouseupPane,this);this.__pM.addListener(Q,this._onClickPane,this);this.__pM.addListener(bz,this._onContextMenu,this);this.__pM.addListener(s,this._onDblclickPane,this);this.__pM.addListener(I,this._onResizePane,this);if(qx.core.Environment.get(bD)){this.__pN=new qx.ui.container.Composite();this.__pN.setLayout(new qx.ui.layout.Canvas());this.__pN.add(this.__pM,{edge:0});this._add(this.__pN,{row:1,column:0});}
else {this._add(this.__pM,{row:1,column:0});}
;this.__pO=this._showChildControl(U);this.__pP=this._showChildControl(q);this.__pQ=this.getChildControl(d);this.initShowCellFocusIndicator();this.getChildControl(D).hide();this.addListener(h,this._onMouseout,this);this.addListener(P,this._onAppear,this);this.addListener(bu,this._onDisappear,this);this.__ik=new qx.event.Timer();this.__ik.addListener(w,this._oninterval,this);this.initScrollTimeout();}
,statics:{MIN_COLUMN_WIDTH:10,RESIZE_REGION_RADIUS:5,CLICK_TOLERANCE:5,HORIZONTAL_SCROLLBAR:1,VERTICAL_SCROLLBAR:2},events:{"changeScrollY":r,"changeScrollX":r,"cellClick":bG,"cellDblclick":bG,"cellContextmenu":bG,"beforeSort":r},properties:{horizontalScrollBarVisible:{check:b,init:false,apply:bw,event:j},verticalScrollBarVisible:{check:b,init:false,apply:bv,event:bs},tablePaneModel:{check:br,apply:o,event:bB},liveResize:{check:b,init:false},focusCellOnMouseMove:{check:b,init:false},selectBeforeFocus:{check:b,init:false},showCellFocusIndicator:{check:b,init:true,apply:E},contextMenuFromDataCellsOnly:{check:b,init:true},resetSelectionOnHeaderClick:{check:b,init:true},scrollTimeout:{check:p,init:100,apply:m},appearance:{refine:true,init:S}},members:{__of:null,__nt:null,__pR:null,__pS:null,__pT:null,__pU:null,__pV:null,__pW:null,__pX:null,__pY:null,__qa:null,__qb:null,__qc:null,__qd:null,__qe:false,__qf:null,__qg:null,__qh:null,__ob:null,__oc:null,__qi:null,__qj:null,__qk:null,__pO:null,__pP:null,__pI:null,__pL:null,__pJ:null,__pM:null,__pN:null,__pQ:null,__pK:null,__ik:null,getPaneInsetRight:function(){var bM=this.getTopRightWidget();var bN=bM&&bM.isVisible()&&bM.getBounds()?bM.getBounds().width+bM.getMarginLeft()+bM.getMarginRight():0;var bL=this.__pP;var bK=this.getVerticalScrollBarVisible()?this.getVerticalScrollBarWidth()+bL.getMarginLeft()+bL.getMarginRight():0;return Math.max(bN,bK);}
,setPaneWidth:function(bO){if(this.isVerticalScrollBarVisible()){bO+=this.getPaneInsetRight();}
;this.setWidth(bO);}
,_createChildControlImpl:function(bR,bQ){var bP;switch(bR){case H:bP=(this.getTable().getNewTablePaneHeader())(this);break;case bE:bP=(this.getTable().getNewTablePane())(this);break;case d:bP=new qx.ui.table.pane.FocusIndicator(this);bP.setUserBounds(0,0,0,0);bP.setZIndex(1000);bP.addListener(X,this._onMouseupFocusIndicator,this);this.__pM.add(bP);bP.show();bP.setDecorator(null);break;case D:bP=new qx.ui.core.Widget();bP.setUserBounds(0,0,0,0);bP.setZIndex(1000);this.__pM.add(bP);break;case U:bP=this._createScrollBar(Y).set({alignY:l});bP.addListener(c,this._onScrollX,this);if(this.__pN!=null){bP.setMinHeight(qx.ui.core.scroll.AbstractScrollArea.DEFAULT_SCROLLBAR_WIDTH);this.__pN.add(bP,{bottom:0,right:0,left:0});}
else {this._add(bP,{row:2,column:0});}
;break;case q:bP=this._createScrollBar(K);bP.addListener(c,this._onScrollY,this);if(this.__pN!=null){this.__pN.add(bP,{right:0,bottom:0,top:0});}
else {this._add(bP,{row:1,column:1});}
;break;};return bP||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,bR);}
,_applyHorizontalScrollBarVisible:function(bT,bS){this.__pO.setVisibility(bT?A:k);}
,_applyVerticalScrollBarVisible:function(bV,bU){this.__pP.setVisibility(bV?A:k);}
...
,_applyShowCellFocusIndicator:function(ca,bY){if(ca){this.__pQ.setDecorator(z);this._updateFocusIndicator();}
else {if(this.__pQ){this.__pQ.setDecorator(null);}
;}
;}
,getScrollY:function(){return this.__pP.getPosition();}
,setScrollY:function(scrollY,cb){this.__pP.scrollTo(scrollY);if(cb){this._updateContent();}
;}
,getScrollX:function(){return this.__pO.getPosition();}
,setScrollX:function(scrollX){this.__pO.scrollTo(scrollX);}
...
,setColumnWidth:function(ce,cd){this.__pI.setColumnWidth(ce,cd);this.__pJ.setColumnWidth(ce,cd);var cc=this.getTablePaneModel();var x=cc.getX(ce);if(x!=-1){this.updateHorScrollBarMaximum();this._updateFocusIndicator();}
;}
,onColOrderChanged:function(){this.__pI.onColOrderChanged();this.__pJ.onColOrderChanged();this.updateHorScrollBarMaximum();}
,onTableModelDataChanged:function(ci,cg,cj,ch){this.__pJ.onTableModelDataChanged(ci,cg,cj,ch);var cf=this.getTable().getTableModel().getRowCount();if(cf!=this.__of){this.updateVerScrollBarMaximum();if(this.getFocusedRow()>=cf){if(cf==0){this.setFocusedCell(null,null);}
else {this.setFocusedCell(this.getFocusedColumn(),cf-1);}
;}
;this.__of=cf;}
;}
,onSelectionChanged:function(){this.__pJ.onSelectionChanged();}
,onFocusChanged:function(){this.__pJ.onFocusChanged();}
,onTableModelMetaDataChanged:function(){this.__pI.onTableModelMetaDataChanged();this.__pJ.onTableModelMetaDataChanged();}
,_onPaneModelChanged:function(){this.__pI.onPaneModelChanged();this.__pJ.onPaneModelChanged();}
,_onResizePane:function(){this.updateHorScrollBarMaximum();this.updateVerScrollBarMaximum();this._updateContent();this.__pI._updateContent();this.__nt._updateScrollBarVisibility();}
,updateHorScrollBarMaximum:function(){var co=this.__pM.getInnerSize();if(!co){return;}
;var cl=this.getTablePaneModel().getTotalWidth();var cm=this.__pO;if(co.width<cl){var ck=Math.max(0,cl-co.width);cm.setMaximum(ck);cm.setKnobFactor(co.width/cl);var cn=cm.getPosition();cm.setPosition(Math.min(cn,ck));}
else {cm.setMaximum(0);cm.setKnobFactor(1);cm.setPosition(0);}
;}
,updateVerScrollBarMaximum:function(){var cw=this.__pM.getInnerSize();if(!cw){return;}
;var cu=this.getTable().getTableModel();var cq=cu.getRowCount();if(this.getTable().getKeepFirstVisibleRowComplete()){cq+=1;}
;var cp=this.getTable().getRowHeight();var cs=cq*cp;var cv=this.__pP;if(cw.height<cs){var cr=Math.max(0,cs-cw.height);cv.setMaximum(cr);cv.setKnobFactor(cw.height/cs);var ct=cv.getPosition();cv.setPosition(Math.min(ct,cr));}
...
,_onScrollX:function(e){var cx=e.getData();this.fireDataEvent(n,cx,e.getOldData());this.__pL.scrollToX(cx);this.__pM.scrollToX(cx);}
...
;if(qx.event.handler.MouseEmulation.ON){this.__pP.scrollBy(cA);}
else {this.__pP.scrollBySteps(cA);}
;var cy=cA!=0&&!this.__ql(this.__pP,cA);cA=e.getWheelDelta(bC);if(cA>0&&cA<1){cA=1;}
else if(cA<0&&cA>-1){cA=-1;}
;if(qx.event.handler.MouseEmulation.ON){this.__pO.scrollBy(cA);}
else {this.__pO.scrollBySteps(cA);}
;if(this.__qg&&this.getFocusCellOnMouseMove()){this._focusCellAtPagePos(this.__qg,this.__qh);}
;cy=cy||(cA!=0&&!this.__ql(this.__pO,cA));if(cy){e.stop();}
;}
,__ql:function(cC,cD){var cB=cC.getPosition();return (cD<0&&cB<=0)||(cD>0&&cB>=cC.getMaximum());}
,__qm:function(cJ){var cH=this.getTable();var cK=this.__pI.getHeaderWidgetAtColumn(this.__qa);var cE=cK.getSizeHint().minWidth;var cG=Math.max(cE,this.__qc+cJ-this.__qb);if(this.getLiveResize()){var cF=cH.getTableColumnModel();cF.setColumnWidth(this.__qa,cG,true);}
else {this.__pI.setColumnWidth(this.__qa,cG,true);var cI=this.getTablePaneModel();this._showResizeLine(cI.getColumnLeft(this.__qa)+cG);}
;this.__qb+=cG-this.__qc;this.__qc=cG;}
,__qn:function(cM){var cL=qx.ui.table.pane.Scroller.CLICK_TOLERANCE;if(this.__pI.isShowingColumnMoveFeedback()||cM>this.__pY+cL||cM<this.__pY-cL){this.__pV+=cM-this.__pY;this.__pI.showColumnMoveFeedback(this.__pU,this.__pV);var cN=this.__nt.getTablePaneScrollerAtPageX(cM);if(this.__pX&&this.__pX!=cN){this.__pX.hideColumnMoveFeedback();}
;if(cN!=null){this.__pW=cN.showColumnMoveFeedback(cM);}
else {this.__pW=null;}
;this.__pX=cN;this.__pY=cM;}
;}
...
else if(this.__pU!=null){this.__qn(cS);e.stopPropagation();}
...
;}
;}
;var cQ=cV?bt:null;this.getApplicationRoot().setGlobalCursor(cQ);this.setCursor(cQ);this.__pI.setMouseOverColumn(cO);}
...
;}
;this.__pI.setMouseOverColumn(null);}
...
;}
;}
,_startResizeHeader:function(dh,df){var dg=this.getTable().getTableColumnModel();this.__qa=dh;this.__qb=df;this.__qc=dg.getColumnWidth(this.__qa);this.__pL.capture();}
,_startMoveHeader:function(di,dj){this.__pU=di;this.__pY=dj;this.__pV=this.getTablePaneModel().getColumnLeft(di);this.__pL.capture();}
...
;}
;}
,_onMouseupFocusIndicator:function(e){if(this.__qd&&!this.__qe&&!this.isEditing()&&this.__pQ.getRow()==this.__qd.row&&this.__pQ.getColumn()==this.__qd.col){this.fireEvent(bx,qx.ui.table.pane.CellEvent,[this,e,this.__qd.row,this.__qd.col],true);this.__qe=true;}
else if(!this.isEditing()){this._onMousedownPane(e);}
;}
,_onChangeCaptureHeader:function(e){if(this.__qa!=null){this._stopResizeHeader();}
;if(this.__pU!=null){this._stopMoveHeader();}
;}
...
;this.__qa=null;this.__pL.releaseCapture();this.getApplicationRoot().setGlobalCursor(null);this.setCursor(null);if(this.isEditing()){var ds=this.__qi.getBounds().height;this.__qi.setUserBounds(0,0,this.__qc,ds);}
;}
,_stopMoveHeader:function(){var dx=this.getTable().getTableColumnModel();var dy=this.getTablePaneModel();this.__pI.hideColumnMoveFeedback();if(this.__pX){this.__pX.hideColumnMoveFeedback();}
;if(this.__pW!=null){var dA=dy.getFirstColumnX()+dy.getX(this.__pU);var dw=this.__pW;if(dw!=dA&&dw!=dA+1){var dz=dx.getVisibleColumnAtX(dA);var dv=dx.getVisibleColumnAtX(dw);var du=dx.getOverallX(dz);var dt=(dv!=null)?dx.getOverallX(dv):dx.getOverallColumnCount();if(dt>du){dt-- ;}
;dx.moveColumn(du,dt);this._updateFocusIndicator();}
;}
;this.__pU=null;this.__pW=null;this.__pL.releaseCapture();}
...
else if(this.__pU!=null){this._stopMoveHeader();e.stop();}
;}
...
;if(!this.getShowCellFocusIndicator()||dV===null||(this.__qd&&dV==this.__qd.row&&dU==this.__qd.col)){this.fireEvent(bF,qx.ui.table.pane.CellEvent,[this,e,dV,dU],true);var dR=this.getTable().getContextMenu();if(dR){if(dR.getChildren().length>0){dR.openAtMouse(e);}
else {dR.exclude();}
;e.preventDefault();}
;}
;}
...
;this.__pI.setMouseOverColumn(null);if(this.getFocusCellOnMouseMove()){this.__nt.setFocusedCell();}
;}
,_showResizeLine:function(x){var ec=this._showChildControl(D);var eb=ec.getWidth();var ed=this.__pM.getBounds();ec.setUserBounds(x-Math.round(eb/2),0,eb,ed.height);}
,_hideResizeLine:function(){this._excludeChildControl(D);}
,showColumnMoveFeedback:function(em){var en=this.getTablePaneModel();var eg=this.getTable().getTableColumnModel();var eh=this.__pJ.getContentLocation().left;var el=en.getColumnCount();var ei=0;var eq=0;var ef=eh;for(var ee=0;ee<el;ee++ ){var ep=en.getColumnAtX(ee);var eo=eg.getColumnWidth(ep);if(em<ef+eo/2){break;}
;ef+=eo;ei=ee+1;eq=ef-eh;}
;var ek=this.__pM.getContentLocation().left;var ej=this.__pM.getBounds().width;var scrollX=ek-eh;eq=qx.lang.Number.limit(eq,scrollX+2,scrollX+ej-1);this._showResizeLine(eq);return en.getFirstColumnX()+ei;}
,hideColumnMoveFeedback:function(){this._hideResizeLine();}
,_focusCellAtPagePos:function(et,er){var eu=this._getRowForPagePos(et,er);if(eu!=-1&&eu!=null){var es=this._getColumnForPageX(et);this.__nt.setFocusedCell(es,eu);}
;}
,setFocusedCell:function(ev,ew){if(!this.isEditing()){this.__pJ.setFocusedCell(ev,ew,this.__pS);this.__ob=ev;this.__oc=ew;this._updateFocusIndicator();}
;}
,getFocusedColumn:function(){return this.__ob;}
,getFocusedRow:function(){return this.__oc;}
,scrollCellVisible:function(eJ,eK){var eH=this.getTablePaneModel();var ex=eH.getX(eJ);if(ex!=-1){var eE=this.__pM.getInnerSize();if(!eE){return;}
...
,startEditing:function(){var eP=this.getTable();var eN=eP.getTableModel();var eR=this.__ob;if(!this.isEditing()&&(eR!=null)&&eN.isColumnEditable(eR)){var eQ=this.__oc;var eL=this.getTablePaneModel().getX(eR);var eM=eN.getValue(eR,eQ);this.scrollCellVisible(eL,eQ);this.__qj=eP.getTableColumnModel().getCellEditorFactory(eR);var eO={col:eR,row:eQ,xPos:eL,value:eM,table:eP};this.__qi=this.__qj.createCellEditor(eO);if(this.__qi===null){return false;}
else if(this.__qi instanceof qx.ui.window.Window){this.__qi.setModal(true);this.__qi.setShowClose(false);this.__qi.addListener(bH,this._onCellEditorModalWindowClose,this);var f=eP.getModalCellEditorPreOpenFunction();if(f!=null){f(this.__qi,eO);}
;this.__qi.open();}
else {var eS=this.__pQ.getInnerSize();this.__qi.setUserBounds(0,0,eS.width,eS.height);this.__pQ.addListener(a,function(e){this.__qd={row:this.__oc,col:this.__ob};e.stopPropagation();}
,this);this.__pQ.add(this.__qi);this.__pQ.addState(O);this.__pQ.setKeepActive(false);this.__pQ.setDecorator(z);this.__qi.focus();this.__qi.activate();}
;return true;}
;return false;}
,stopEditing:function(){if(!this.getShowCellFocusIndicator()){this.__pQ.setDecorator(null);}
;this.flushEditor();this.cancelEditing();}
,flushEditor:function(){if(this.isEditing()){var eT=this.__qj.getCellEditorValue(this.__qi);var eU=this.getTable().getTableModel().getValue(this.__ob,this.__oc);this.getTable().getTableModel().setValue(this.__ob,this.__oc,eT);this.__nt.focus();this.__nt.fireDataEvent(u,{row:this.__oc,col:this.__ob,oldValue:eU,value:eT});}
;}
...
else {this.__pQ.removeState(O);this.__pQ.setKeepActive(true);this.__qi.destroy();this.__qi=null;this.__qj=null;}
;}
;}
,_onCellEditorModalWindowClose:function(e){this.stopEditing();}
,_getColumnForPageX:function(eV){var eY=this.getTable().getTableColumnModel();var fa=this.getTablePaneModel();var eX=fa.getColumnCount();var eW=this.__pJ.getContentLocation().left;for(var x=0;x<eX;x++ ){var fc=fa.getColumnAtX(x);var fb=eY.getColumnWidth(fc);eW+=fb;if(eV<eW){return fc;}
;}
;return null;}
,_getResizeColumnForPageX:function(fe){var fh=this.getTable().getTableColumnModel();var fi=this.getTablePaneModel();var fg=fi.getColumnCount();var ff=this.__pI.getContentLocation().left;var fd=qx.ui.table.pane.Scroller.RESIZE_REGION_RADIUS;for(var x=0;x<fg;x++ ){var fk=fi.getColumnAtX(x);var fj=fh.getColumnWidth(fk);ff+=fj;if(fe>=(ff-fd)&&fe<=(ff+fd)){return fk;}
;}
;return -1;}
,_getRowForPagePos:function(fr,fs){var fl=this.__pJ.getContentLocation();if(fr<fl.left||fr>fl.right){return null;}
;if(fs>=fl.top&&fs<=fl.bottom){var fm=this.getTable().getRowHeight();var scrollY=this.__pP.getPosition();if(this.getTable().getKeepFirstVisibleRowComplete()){scrollY=Math.floor(scrollY/fm)*fm;}
...
;var fo=this.__pI.getContentLocation();if(fs>=fo.top&&fs<=fo.bottom&&fr<=fo.right){return -1;}
;return null;}
,setTopRightWidget:function(fu){var fv=this.__qk;if(fv!=null){this.__pK.remove(fv);}
;if(fu!=null){this.__pK.add(fu);}
;this.__qk=fu;}
,getTopRightWidget:function(){return this.__qk;}
,getHeader:function(){return this.__pI;}
,getTablePane:function(){return this.__pJ;}
,getVerticalScrollBarWidth:function(){var fw=this.__pP;return fw.isVisible()?(fw.getSizeHint().width||0):0;}
,getNeededScrollBars:function(fA,fB){var fM=this.__pP;var fL=fM.getSizeHint().width+fM.getMarginLeft()+fM.getMarginRight();var fG=this.__pO;var fJ=fG.getSizeHint().height+fG.getMarginTop()+fG.getMarginBottom();var fD=this.__pM.getInnerSize();var fx=fD?fD.width:0;if(this.getVerticalScrollBarVisible()){fx+=fL;}
...
,getPaneClipper:function(){return this.__pM;}
,_applyScrollTimeout:function(fP,fO){this._startInterval(fP);}
,_startInterval:function(fQ){this.__ik.setInterval(fQ);this.__ik.start();}
,_stopInterval:function(){this.__ik.stop();}
,_postponedUpdateContent:function(){this._updateContent();}
,_oninterval:qx.event.GlobalError.observeMethod(function(){if(this.__pS&&!this.__pJ._layoutPending){this.__pS=false;this._updateContent();}
;}
),_updateContent:function(){var fY=this.__pM.getInnerSize();if(!fY){return;}
;var fW=fY.height;var scrollX=this.__pO.getPosition();var scrollY=this.__pP.getPosition();var fS=this.getTable().getRowHeight();var fU=Math.floor(scrollY/fS);var fX=this.__pJ.getFirstVisibleRow();this.__pJ.setFirstVisibleRow(fU);var fT=Math.ceil(fW/fS);var fR=0;var fV=this.getTable().getKeepFirstVisibleRowComplete();if(!fV){fT++ ;fR=scrollY%fS;}
;this.__pJ.setVisibleRowCount(fT);if(fU!=fX){this._updateFocusIndicator();}
;this.__pM.scrollToX(scrollX);if(!fV){this.__pM.scrollToY(fR);}
;}
,_updateFocusIndicator:function(){var ga=this.getTable();if(!ga.getEnabled()){return;}
;this.__pQ.moveToCell(this.__ob,this.__oc);}
},destruct:function(){this._stopInterval();var gb=this.getTablePaneModel();if(gb){gb.dispose();}
;this.__qd=this.__qk=this.__nt=null;this._disposeObjects(L,i,C,t,V,J,g,M,bA,F);}
});}
)();
