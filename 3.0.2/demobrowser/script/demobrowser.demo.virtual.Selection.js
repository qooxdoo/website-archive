...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Selection.130bfacbb989.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;bd.updateLayerData();}
});bf.attachMouseEvents(bg.getPane());bf.attachKeyEvents(bg);bf.set({mode:r});bf.addItem(0);bg.setUserData(b,bf);return bg;}
...
;bp.updateLayerData();}
});bq.attachMouseEvents(br.getPane());bq.attachKeyEvents(br);bq.set({mode:r});bq.addItem(0);br.setUserData(b,bq);return br;}
...
});bB.attachMouseEvents(bC.getPane());bB.attachKeyEvents(bC);bB.set({mode:r});bB.addItem({row:0,column:0});bC.setUserData(b,bB);return bC;}
...
});bM.attachMouseEvents(bN.getPane());bM.attachKeyEvents(bN);bM.set({mode:r});bM.addItem({row:0,column:0});bN.setUserData(b,bM);return bN;}
}});}
)();
...
;this.__Fm=[];this.__Fn=[];this._isHorizontal=(w||c)==c;}
,properties:{defaultLineColor:{init:h,check:s,themeable:true},defaultLineSize:{init:1,check:t,themeable:true}},members:{__Fm:null,__Fn:null,isHorizontal:function(){return this._isHorizontal;}
...
;this.__Fm[B]=A;if(this.__Fo(B)){this.updateLayerData();}
;}
...
;this.__Fn[C]=D;if(this.__Fo(C)){this.updateLayerData();}
;}
,__Fo:function(E){if(this._isHorizontal){var I=this.getFirstColumn();var G=I+this.getColumnSizes().length-1;return E>=I&&E<=G;}
else {var H=this.getFirstRow();var F=H+this.getRowSizes().length-1;return E>=H&&E<=F;}
;}
,getLineSize:function(J){return this.__Fn[J]||this.getDefaultLineSize();}
,getLineColor:function(K){return this.__Fm[K]||this.getDefaultLineColor();}
,__Fp:function(P,M,O){var top=0;var L,N;for(var y=0;y<O.length-1;y++ ){L=this.getLineColor(M+y);N=this.getLineSize(M+y);top+=O[y];P.push(m,g,f+N+q,j,d,top-((N>1)?Math.floor(N/2):1),q,b,L,n,a);}
;}
,__Fq:function(T,Q,S){var V=0;var R,U;for(var x=0;x<S.length-1;x++ ){R=this.getLineColor(Q+x);U=this.getLineSize(Q+x);V+=S[x];T.push(m,g,k+U+q,l,u,p,V-((U>1)?Math.floor(U/2):1),q,b,R,n,a);}
;}
,_fullUpdate:function(ba,bb,X,W){var Y=[];if(this._isHorizontal){this.__Fp(Y,ba,X);}
else {this.__Fq(Y,bb,W);}
...
;this.__ea=qx.bom.Stylesheet.createElement(p);this.__Eu={};this.__mA={};}
,members:{__ea:null,__Eu:null,__mA:null,getStylesheet:function(){return this.__ea;}
,getCssClass:function(q){return this.__Eu[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__mA[r];if(!s){var s=this.__Ev();qx.bom.Stylesheet.addRule(this.__ea,k+s,r);this.__mA[r]=s;}
;this.__Eu[t]=s;return s;}
,__Ev:function(){return e+this.toHashCode()+a+(this.__Ew++ );}
,__Ew:0},destruct:function(){this.__ea=this.__Eu=this.__mA=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__ea=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__Ex={};this.__Ey={};this.__Ez={};this.__EA={};this.__iI={};this.__EB={};this.initAppearance();this.__EF();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__EC:null,__ED:null,__iI:null,__EB:null,__Ey:null,__Ex:null,__Ez:null,__EA:null,__EE:false,__ea:null,__EF:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__EC=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__EC.push(N);}
;}
;O=O.superclass;}
;}
,_getCssProperties:function(){return [b,x,m,u,B,G,A,e];}
,_applyAppearance:function(Q,P){if(P){this.__Ey={};}
;}
,_getValue:function(R){if(this.__EE){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(T,S){var U;if(this.__EE){U=this.__Ey;}
else {U=this.__Ex;}
...
;}
,_applyPadding:function(bh,bg,name){var bh=this._getValue(name);if(this.__EE){var bi=this.__EA;}
else {bi=this.__Ez;}
...
;}
,getCellProperties:function(bk,bj){this.__EG(bj);return {classes:this.getCssClasses(bk,bj),style:this.getStyles(bk,bj),attributes:this.getAttributes(bk,bj),content:this.getContent(bk,bj),insets:this.getInsets(bk,bj)};}
,getAttributes:function(bm,bl){return t;}
,getContent:function(bo,bn){return bo;}
,getCssClasses:function(br,bp){var bq=this.__ea.getCssClass(this.__ED)||t;return v+bq;}
,__EG:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__ED==bt){return;}
;this.__ED=bt;var bv=this.__iI[this.__ED];if(!bv){this.__EH();this.__EI(bs);this.__EJ(bs);this.__EK();this.__iI[this.__ED]=1;}
;this.__EL();}
,__EH:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++ ){bw.deleteThemeValue(this,bx[i]);}
;}
,__EI:function(bz){this.__Ey={};this.__EE=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var by=qx.theme.manager.Appearance.getInstance().styleFrom(bB,bz);for(var bC in by){if(by[bC]!==undefined){bA.setThemed(this,bC,by[bC]);}
;}
;this.__EE=false;}
,__EJ:function(){var bD=qx.lang.Object.getValues(this.__Ey).join(I);this.__ea.computeClassForStyles(this.__ED,bD);}
,__EK:function(){var bI=this.__EC;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++ ){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__EB[this.__ED]=bG;}
,__EL:function(){var bK=qx.util.PropertyUtil;var bJ=this.__EB[this.__ED]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bN,bM){return qx.lang.Object.getValues(this.__Ex).join(I);}
,getInsets:function(bQ,bR){var bT=this.__Ez;var bS=this.__EA;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bO=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bP=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bO,top+bP];}
},destruct:function(){this.__ea=this.__Ex=this.__Ey=this.__Ez=this.__EA=this.__iI=this.__EB=this.__EC=null;}
});}
)();
...
;var r=this.getContentElement().getDomElement();r.style.display=o;window.affe=r;r.innerHTML=B.join(e);r.style.display=d;this._height=z;}
