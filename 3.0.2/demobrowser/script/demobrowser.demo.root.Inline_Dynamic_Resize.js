...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Dynamic_Resize.3f3ffb581864.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__Cc=w;w.style.overflow=p;w.style.textAlign=r;this.__Cd=x||false;this.__Ce=v||false;this.__Cf();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==b)){this.setKeepFocus(true);}
...
,members:{__Cd:false,__Ce:false,__Cc:null,__Cf:function(){if(this.__Cd||this.__Ce){var y=qx.bom.element.Dimension.getSize(this.__Cc);if(this.__Cd&&y.width<1){throw new Error(s+this.__Cc+t+this+k);}
;if(this.__Ce){if(y.height<1){throw new Error(s+this.__Cc+t+this+g);}
;if(y.height>=1&&qx.bom.element.Style.get(this.__Cc,j,3)==f){qx.bom.element.Style.set(this.__Cc,j,y.height+h);}
;}
;qx.event.Registration.addListener(this.__Cc,a,this._onResize,this);}
;}
,_createContentElement:function(){var z=this.__Cc;if(this.__Cd||this.__Ce){var B=document.createElement(q);z.appendChild(B);}
else {B=z;}
...
,this,0);return A;}
,_onResize:function(e){var C=e.getData();if((C.oldWidth!==C.width)&&this.__Cd||(C.oldHeight!==C.height)&&this.__Ce){qx.ui.core.queue.Layout.add(this);}
;}
...
;}
,_computeSizeHint:function(){var H=this.__Cd;var E=this.__Ce;if(!H||!E){var D=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {D={};}
;var I=qx.bom.element.Dimension;if(H){var G=I.getContentWidth(this.__Cc);D.width=G;D.minWidth=G;D.maxWidth=G;}
;if(E){var F=I.getContentHeight(this.__Cc);D.height=F;D.minHeight=F;D.maxHeight=F;}
;return D;}
},defer:function(J,K){qx.ui.core.MLayoutHandling.remap(K);}
,destruct:function(){qx.event.Registration.removeListener(this.__Cc,a,this._onResize,this);this.__Cc=null;}
});}
)();
