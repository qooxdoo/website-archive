...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Html.a22923c22394.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="</div>",b="2*",c="<div style='background-color: cyan; text-align: center;'>",d="1*",e="row",f="    I'm red!",g="  </span>",h="end",i="Literal",j="  Hi there.",k="  <span style='color: red;'>",l="demobrowser.demo.progressive.ProgressiveTable_Html",m="  Hello world!",n="    &nbsp;&nbsp;&nbsp;",o="Html";qx.Class.define(l,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var x=function(B,D){var C={renderer:e,location:h,data:[B,B]};return C;}
;var y=new qx.ui.progressive.renderer.table.Widths(2);y.setWidth(0,b);y.setWidth(1,d);var s=[i,o];var u=new qx.ui.progressive.headfoot.TableHeading(y,s);var q=new qx.ui.progressive.headfoot.Progress(y,s);var w=new qx.ui.progressive.structure.Default(u,q);var p=new qx.ui.progressive.Progressive(w);var A=new qx.ui.progressive.model.Default();var v=[];var t=c+m+a;v.push(x(t));var t=c+j+k+n+f+g+a;v.push(x(t));A.addElements(v);p.setDataModel(A);var z=new qx.ui.progressive.renderer.table.Row(y);p.addRenderer(e,z);var r=new qx.ui.progressive.renderer.table.cell.String();z.addRenderer(0,r);var r=new qx.ui.progressive.renderer.table.cell.Html();z.addRenderer(1,r);this.getRoot().add(p,{edge:50});p.render();}
}});}
)();
