...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.JsonToTree.7f079579b8eb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="_applyDelegate",c="qx.core.Object",d="_applyLabelPath",f="icon",g="change",h="label",k="' twice.",l="_applyTarget",m="changeTarget",n="_applyIconPath",o="Can not reverse bind the same target property '",p="_applyLabelOptions",q="_applyChildPath",r="_applyIconOptions",s="qx.data.controller.Tree",t="String",u="Can not bind the same target property '",v="_applyModel",w="get";qx.Class.define(s,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(y,z,A,x){qx.core.Object.call(this);this.__bc={};this.__Bk=[];this.__KP={};if(A!=null){this.setChildPath(A);}
;if(x!=null){this.setLabelPath(x);}
;if(y!=null){this.setModel(y);}
;if(z!=null){this.setTarget(z);}
;}
,properties:{model:{check:c,apply:v,event:a,nullable:true,dereference:true},target:{apply:l,event:m,init:null,nullable:true,dereference:true},childPath:{check:t,apply:q,nullable:true},labelPath:{check:t,apply:d,nullable:true},iconPath:{check:t,apply:n,nullable:true},labelOptions:{apply:p,nullable:true},iconOptions:{apply:r,nullable:true},delegate:{apply:b,init:null,nullable:true}},members:{__KP:null,__bc:null,__Bk:null,__KQ:null,_applyDelegate:function(C,B){this._setConfigureItem(C,B);this._setCreateItem(C,B);this._setBindItem(C,B);}
,_applyIconOptions:function(E,D){this.__Bv();}
,_applyLabelOptions:function(G,F){this.__Bv();}
,_applyTarget:function(I,H){if(H!=undefined){this.__Fs(H);}
;if(this.getModel()!=null){this.__KT();}
;this._addChangeTargetListener(I,H);}
,_applyModel:function(K,J){this.__KT();}
,_applyChildPath:function(M,L){this.__KQ=L;this.__KT();this.__KQ=null;}
,_applyIconPath:function(O,N){this.__Bv();}
,_applyLabelPath:function(Q,P){this.__KT();}
,__KR:function(R){var T=R.getTarget();var S=this.__KP[T.toHashCode()].treeNode;var U=this.__KP[T.toHashCode()].modelNode;this.__KU(S,U);this._updateSelection();}
,__KS:function(e){var X=e.getData();var bc=e.getOldData();var V=this.__KP[bc.toHashCode()];bc.removeListenerById(V.changeListenerId);delete this.__KP[bc.toHashCode()];V.modelNode.removeListenerById(V.changeChildernListenerId);var bd=V.modelNode;var bb=qx.Class.getPropertyDefinition(V.modelNode.constructor,this.getChildPath());var Y=bb.event;var ba=bd.addListener(Y,this.__KS,this);var W=V.treeNode;this.__KP[X.toHashCode()]={modelNode:bd,treeNode:W,changeListenerId:V.changeListenerId,changeChildernListenerId:ba};this.__KU(W,bd);this._updateSelection();}
...
;return be;}
,__KT:function(){if(this.getTarget()==null||this.getChildPath()==null){return;}
...
;this.__Fs();if(this.getModel()!=null){var bg=this._createItem();bg.setModel(this.getModel());this.__zF(this.getModel(),bg);this.__KU(bg,this.getModel());this.getTarget().setRoot(bg);}
;}
,__KU:function(bn,br){if(br[w+qx.lang.String.firstUp(this.getChildPath())]==undefined){return;}
;var bj=br[w+qx.lang.String.firstUp(this.getChildPath())]();if(this.__KP[bj.toHashCode()]==undefined){var bl=bj.addListener(g,this.__KR,this);var bp=qx.Class.getPropertyDefinition(br.constructor,this.getChildPath());var bm=bp.event;var bq=br.addListener(bm,this.__KS,this);this.__KP[bj.toHashCode()]={modelNode:br,treeNode:bn,changeListenerId:bl,changeChildernListenerId:bq};}
...
;}
else {var bo=this._createItem();bo.setModel(bj.getItem(i));bn.addAt(bo,i);this.__zF(bj.getItem(i),bo);this.__KU(bo,bj.getItem(i));}
;}
;}
;for(var i=bn.getChildren().length-1;i>=bj.length;i-- ){var bk=bn.getChildren()[i];this.__KW(bk,bn);}
;}
,__Fs:function(bt){if(bt==null){bt=this.getTarget();}
;if(bt==null){return;}
;var bv=bt.getRoot();if(bv!=null){bt.setRoot(null);this.__KV(bv);var bu=bv.getModel();if(bu){this.__sl(bu);}
;bv.destroy();this.__KP={};}
;}
,__KV:function(bw){var bx=bw.getChildren()||[];for(var i=bx.length-1;i>=0;i-- ){if(bx[i].getChildren().length>0){this.__KV(bx[i]);}
;this.__KW(bx[i],bw);}
;}
,__KW:function(bz,bC){var bD=bz.getModel();var by=this.__KQ||this.getChildPath();var bA=w+qx.lang.String.firstUp(by);if(bD[bA]!=undefined){var bE=bD[bA]();var bB=this.__KP[bE.toHashCode()];bE.removeListenerById(bB.changeListenerId);bD.removeListenerById(bB.changeChildernListenerId);this.__KV(bz);delete this.__KP[bE.toHashCode()];}
;this.__sl(bD);bC.remove(bz);bz.destroy();}
...
;if(!qx.lang.Array.contains(this.__Bk,bJ)){this.__Bk.push(bJ);}
;}
...
;if(!qx.lang.Array.contains(this.__Bk,bM)){this.__Bk.push(bM);}
;}
...
;}
,__Bv:function(){var bW;for(var ca in this.__bc){bW=ca;break;}
;for(var bX in this.__bc[bW]){var bV=this.__bc[bW][bX].treeNode;var bY=qx.core.ObjectRegistry.fromHashCode(bX);this.__sl(bY);this.__zF(bY,bV);}
;}
,__zF:function(cd,cb){var cc=this.getDelegate();if(cc!=null&&cc.bindItem!=null){cc.bindItem(this,cb,cd);}
else {this.bindDefaultProperties(cb,cd);}
;}
,__sl:function(cg){for(var i=0;i<this.__Bk.length;i++ ){var ce=this.__Bk[i];var cf=this.__bc[ce][cg.toHashCode()];if(cf!=null){if(cf.id){cg.removeBinding(cf.id);cf.id=null;}
...
;this._startSelectionModification();this.__Fs();this.__KT();this._endSelectionModification();this._updateSelection();}
,_setBindItem:function(cn,cm){if(cn!=null&&cn.bindItem!=null){if(cm!=null&&cm.bindItem!=null&&cn.bindItem==cm.bindItem){return;}
;this.__KT();}
;}
},destruct:function(){this.setTarget(null);this.setModel(null);this.__bc=this.__KP=this.__Bk=null;}
});}
)();
