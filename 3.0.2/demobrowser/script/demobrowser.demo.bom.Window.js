...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.3f1acbfc6107.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="click",c="Open Native Modal Window",d="demobrowser.demo.bom.Window",f="Modal Window closed?",g="http://sourceforge.net",h="window1",i="window3",j="http://slashdot.org",k="Window closed?",l="http://qooxdoo.org",m="demobrowser/demo/html/ModalWindow.html",n="Open Faked Native Modal Window",o="window2",p="#eee",q="button";qx.Class.define(d,{extend:qx.application.Native,members:{__BM:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__BM=[l,g,j,r.toUri(m)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,b,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__BM[0],h,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,c);document.body.appendChild(s);qx.event.Registration.addListener(s,b,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__BM[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,b,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(p);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__BM[0],i,A,true,false);}
,this);}
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__la:null,__KY:null,__ik:null,__La:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__Lb:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Lc:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__Ld(H,E&&A);if(E){if(this.__Lc()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__ik==null){this.__ik=new qx.event.Timer(500);this.__ik.addListener(f,this.__Le,this);}
;this.__KY=window.open(z,name,G);this.__ik.restart();C=this.__KY;}
;}
...
;return C;}
,__Ld:function(K,O){var M;var J;var N=[];if(O&&this.__Lc()){for(var L in K){if(qx.bom.Window.__La[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__La[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__Lb[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__Le:function(){if(this.isClosed(this.__KY)){this.getBlocker().unblock();this.__ik.stop();}
;}
,getBlocker:function(){if(this.__la==null){this.__la=new qx.bom.Blocker;}
;return this.__la;}
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__dq();}
,members:{__Lf:null,__vV:null,__Lg:null,__Lh:false,__Li:10000,__Lj:0,__Lk:f,block:function(r){if(!this.__Lh){this.__Lg=r;var q=this.__Ln();this.__Lo(q);this.__Lh=true;}
;}
,unblock:function(){if(this.__Lh){this.__Lp();this.__Lh=false;}
;}
,isBlocked:function(){return this.__Lh;}
,getBlockerElement:function(){return this.__vV;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__vV,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__vV,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__vV,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__vV);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__vV,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__vV,h);}
,__dq:function(){this.__Ll();if((qx.core.Environment.get(j)==b)){this.__Lm();}
;qx.event.Registration.addListener(window,a,this.__Cg,this);}
,__Ll:function(){this.__vV=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__vV,{display:d,opacity:this.__Lj,backgroundColor:this.__Lk});this.setBlockerZIndex(this.__Li);}
,__Lm:function(){this.__Lf=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__Lf,l,false);qx.bom.element.Attribute.set(this.__Lf,i,n);qx.bom.element.Style.setStyles(this.__Lf,{display:d,opacity:this.__Lj});}
,__Ln:function(){var v={position:p};if(this.__Lr()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__Lg)+g;v.height=qx.bom.element.Dimension.getHeight(this.__Lg)+g;v.left=qx.bom.element.Location.getLeft(this.__Lg)+g;v.top=qx.bom.element.Location.getTop(this.__Lg)+g;}
;return v;}
,__Lo:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__vV,w);qx.dom.Element.insertEnd(this.__vV,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Lf,w);qx.dom.Element.insertEnd(this.__Lf,document.body);}
;}
,__Lp:function(){qx.dom.Element.remove(this.__vV);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__Lf);}
;}
,__Cg:function(e){if(this.__Lr()){this.__Lq({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__Lq(y);}
,this,0);}
;}
,__Lq:function(z){qx.bom.element.Style.setStyles(this.__vV,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__Lf,z);}
;}
,__Lr:function(){return (this.__Lg==null||qx.dom.Node.isWindow(this.__Lg)||qx.dom.Node.isDocument(this.__Lg));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__Cg,this);this.__Lf=this.__vV=this.__Lg=null;}
});}
)();
