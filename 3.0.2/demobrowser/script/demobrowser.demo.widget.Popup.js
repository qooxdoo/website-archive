...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Popup","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Popup.2c7994b5e2ea.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="click",b="#FFFAD3",c="#DFFAD3",d="Open Popup #2",f="icon/32/apps/media-photo-album.png",g="top-right",h="Open Popup #1",i="demobrowser.demo.widget.Popup",j="Hello World #1";qx.Class.define(i,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var k=new qx.ui.layout.HBox();k.setSpacing(20);var l=new qx.ui.container.Composite(k).set({padding:20});this.getRoot().add(l);l.add(this._getPopupButton1());l.add(this._getPopupButton2());}
,_getPopupButton1:function(){var m=new qx.ui.form.Button(h);var n=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:b,padding:[2,4],offset:3,offsetBottom:20});n.add(new qx.ui.basic.Atom(j,f));m.addListener(a,function(e){n.placeToMouse(e);n.show();}
,this);return m;}
,_getPopupButton2:function(){var o=new qx.ui.form.Button(d);var p=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:c,padding:[2,4],offset:3,position:g});p.add(new qx.ui.basic.Atom(j,f));o.addListener(a,function(e){p.placeToMouse(e);p.show();}
,this);return o;}
}});}
)();
