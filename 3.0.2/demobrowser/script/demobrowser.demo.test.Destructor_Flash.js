...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor_Flash.c8d0317e4570.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.test.Destructor_Flash",b="created: ",c="300px",d="interval",e="height",f="TestFlash.swf",g="400px",h="width",j="cleaned: ",k="div",m="FlashMovie";qx.Class.define(a,{extend:qx.application.Native,members:{__cN:null,__DL:0,main:function(){qx.application.Native.prototype.main.call(this);this.__cN=[];var n=new qx.event.Timer(5000);n.addListener(d,this.runTest,this);n.start();this.runTest();}
,runTest:function(){for(var i=0;i<5;i++ ){var o=qx.dom.Element.create(k);qx.bom.element.Style.set(o,h,g);qx.bom.element.Style.set(o,e,c);document.body.appendChild(o);var p=m+this.__DL;this.__DL++ ;qx.bom.Flash.create(o,{movie:f,id:p});this.debug(b+p);this.__cN.push(o);}
