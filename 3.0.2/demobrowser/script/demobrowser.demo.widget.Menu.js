...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu.5a1c61b79ede.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Online Forum",b="New",c="icon/16/actions/edit-cut.png",d="icon/16/actions/format-justify-fill.png",f="Search in files",g="C",h="changeValue",j="Left aligned",k="Undo",l="Perl",m="View",n="C Dialect",o="changeSelection",p="Info...",q="Save as...",r="Show line numbers",s="icon/16/actions/document-save.png",t="Quickstart",u="icon/16/actions/contact-new.png",v="Ctrl+N",w="icon/16/actions/edit-paste.png",x="Actions",y="Show console",z="Search",A="Help",B="Redo",C="Show status bar",D="icon/16/actions/format-justify-left.png",E="ANSI to OEM",F="Centered",G="Website 3",H="icon/22/apps/preferences-users.png",I="__SY",J="Edit",K="icon/16/actions/format-justify-center.png",L="Ctrl+O",M="icon/16/actions/document-print.png",N="icon/16/actions/go-previous.png",O="icon/16/actions/document-open.png",P="C Sharp",Q="icon/16/actions/edit-undo.png",R="Close",S="Split Button",T="Website 2",U="icon/16/actions/document-save-as.png",V="Python",W="icon/16/apps/utilities-help.png",X="Show tree",Y="Options",cM="Spaces to tabs",cN="Right aligned",cO="Action 1",cI="OEM to ANSI",cJ="Line 431",cK="JavaScript",cL="icon",cT="Action 2",cU="__Ta",cV="Folder ",cW="XML",cP="Line 313",cQ="Save",cR="Paragraph",cS="demobrowser.demo.widget.Menu",db="icon/16/actions/application-exit.png",dD="__Te",er="C Plus Plus",dc="Line 26",cX="Item ",cY="ASCII table",en="Option 1",da="Search next...",dd="__Tb",de="Line 12",df="Action 3",dk="Replace in files",dl="Uppercase",dm="Ctrl+P",dg="Topics",dh="Panes",di="Justified",dj="Ctrl+X",dr="icon/16/actions/edit-redo.png",ds="Search previous...",dt="Change selection: ",du="Back",dn="__Tc",dp="main",eo="Copy",dq=" = ",dy="__Td",dz="Paste",eq="Execute command: ",dA="Show ruler",dv="icon/16/actions/format-justify-right.png",dw="__wv",ep="icon/16/actions/go-next.png",dx="Ctrl+Z",dB="command ",dC="Option 3",dO="Next",dN="Ctrl+R",dM="Show macros",dS="Show tags",dR="Capitals",dQ="Execute button: ",dP="Format",dH="File",dG="Change checked: ",dF="Show tabs",dE="Print",dL="execute",dK="icon/16/actions/edit-copy.png",dJ="Cut",dI="Tabs to spaces",ea="Search...",dY="Line 1039",dX="Option 2",dW="Open",ee="Objective C",ed="Exit",ec="move to",eb="icon/16/actions/system-search.png",dV="Ctrl+S",dU="Syntax",dT="__wC",ei="Ctrl+C",eh="Website 1",eg="Menu Button",em="icon/16/actions/document-new.png",el="Line 30",ek="Lowercase",ej="Replace",ef="HTML";qx.Class.define(cS,{extend:qx.application.Standalone,members:{__SY:null,__Ta:null,__Tb:null,__wv:null,__wC:null,__Tc:null,__Td:null,__Te:null,main:function(){qx.application.Standalone.prototype.main.call(this);var et=new qx.ui.container.Scroll();var es=new qx.ui.container.Composite(new qx.ui.layout.Canvas);es.setPadding(20);es.setAllowStretchX(false);et.add(es);this.getRoot().add(et,{edge:0});this.createCommands();es.add(this.getMenuButton(),{left:20,top:20});es.add(this.getSplitButton(),{left:150,top:20});es.add(this.getMenuBar(),{left:20,top:100});es.add(this.getList(),{left:20,top:200});this.getRoot().setContextMenu(this.getRootContextMenu());}
,getRootContextMenu:function(){var eu=new qx.ui.menu.Menu();var ev=new qx.ui.menu.Menu();for(var i=0;i<30;i++ ){ev.add(new qx.ui.menu.Button(cV+(i+1)));}
...
,debugCheckBox:function(e){this.debug(dG+this.getLabel()+dq+e.getData());}
,createCommands:function(){this.__SY=new qx.ui.core.Command(v);this.__SY.addListener(dL,this.debugCommand);this.__Ta=new qx.ui.core.Command(L);this.__Ta.addListener(dL,this.debugCommand);this.__Tb=new qx.ui.core.Command(dV);this.__Tb.addListener(dL,this.debugCommand);this.__wv=new qx.ui.core.Command(dx);this.__wv.addListener(dL,this.debugCommand);this.__wC=new qx.ui.core.Command(dN);this.__wC.addListener(dL,this.debugCommand);this.__Tc=new qx.ui.core.Command(dj);this.__Tc.addListener(dL,this.debugCommand);this.__Td=new qx.ui.core.Command(ei);this.__Td.addListener(dL,this.debugCommand);this.__Te=new qx.ui.core.Command(dm);this.__Te.addListener(dL,this.debugCommand);this.__Te.setEnabled(false);}
,getMenuButton:function(){var ew=new qx.ui.menu.Menu;ew.add(new qx.ui.menu.RadioButton(en));ew.add(new qx.ui.menu.RadioButton(dX));ew.add(new qx.ui.menu.RadioButton(dC));var eE=new qx.ui.menu.Menu;eE.add(new qx.ui.menu.RadioButton(cO));eE.add(new qx.ui.menu.RadioButton(cT));eE.add(new qx.ui.menu.RadioButton(df));var eD=new qx.ui.form.RadioGroup;eD.add.apply(eD,ew.getChildren());eD.addListener(o,this.debugRadio);var eB=new qx.ui.form.RadioGroup;eB.add.apply(eB,eE.getChildren());eB.addListener(o,this.debugRadio);var ez=new qx.ui.menu.Menu();var eC=new qx.ui.menu.Button(k,Q,this.__wv);var eJ=new qx.ui.menu.Button(B,dr,this.__wC);var ey=new qx.ui.menu.Button(dJ,c,this.__Tc);var eG=new qx.ui.menu.Button(eo,dK,this.__Td);var eA=new qx.ui.menu.Button(dz,w,this.__Te);var ex=new qx.ui.menu.Button(Y,eb,null,ew);var eH=new qx.ui.menu.Button(x,u,null,eE);var eF=new qx.ui.menu.Button(dE,M);eC.addListener(dL,this.debugButton);eJ.addListener(dL,this.debugButton);ey.addListener(dL,this.debugButton);eG.addListener(dL,this.debugButton);eA.addListener(dL,this.debugButton);ex.addListener(dL,this.debugButton);eH.addListener(dL,this.debugButton);eF.addListener(dL,this.debugButton);ez.add(eC);ez.add(eJ);ez.addSeparator();ez.add(ey);ez.add(eG);ez.add(eA);ez.addSeparator();ez.add(ex);ez.add(eH);ez.addSeparator();ez.add(eF);var eI=new qx.ui.form.MenuButton(eg,H,ez);return eI;}
,getSplitButton:function(){var eK=new qx.ui.menu.Menu;var eO=new qx.ui.menu.Button(eh);var eM=new qx.ui.menu.Button(T);var eN=new qx.ui.menu.Button(G);eK.setMinWidth(120);eO.addListener(dL,this.debugButton);eM.addListener(dL,this.debugButton);eN.addListener(dL,this.debugButton);eK.add(eO);eK.add(eM);eK.add(eN);var eL=new qx.ui.form.SplitButton(S,H,eK);eL.addListener(dL,this.debugButton);return eL;}
,getMenuBar:function(){var eS=new qx.ui.container.Composite(new qx.ui.layout.Grow);eS.setDecorator(dp);var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setWidth(600);eS.add(toolbar);var fc=new qx.ui.toolbar.Part;var eR=new qx.ui.toolbar.Part;var eV=new qx.ui.toolbar.Part;toolbar.add(fc);toolbar.add(eR);toolbar.addSpacer();toolbar.add(eV);var fb=new qx.ui.toolbar.SplitButton(du,N,this.getBackMenu());var fe=new qx.ui.toolbar.SplitButton(dO,ep,this.getForwardMenu());var eW=new qx.ui.toolbar.Button(b,em,this.__SY);var eU=new qx.ui.toolbar.Button(dW,O,this.__Ta);var fa=new qx.ui.toolbar.Button(cQ,s,this.__Tb);fb.addListener(dL,this.debugButton);fe.addListener(dL,this.debugButton);eW.addListener(dL,this.debugButton);eU.addListener(dL,this.debugButton);fa.addListener(dL,this.debugButton);fc.add(fb);fc.add(fe);fc.addSeparator();fc.add(eW);fc.add(eU);fc.add(fa);fc.setShow(cL);var eT=new qx.ui.toolbar.MenuButton(dH);var eP=new qx.ui.toolbar.MenuButton(J);var eQ=new qx.ui.toolbar.MenuButton(z);var fd=new qx.ui.toolbar.MenuButton(m);var eY=new qx.ui.toolbar.MenuButton(dP);eT.setMenu(this.getFileMenu());eP.setMenu(this.getEditMenu());eQ.setMenu(this.getSearchMenu());fd.setMenu(this.getViewMenu());eY.setMenu(this.getFormatMenu());eR.add(eT);eR.add(eP);eR.add(eQ);eR.add(fd);eR.add(eY);var eX=new qx.ui.toolbar.MenuButton(A);eX.setMenu(this.getHelpMenu());eV.add(eX);return eS;}
,getBackMenu:function(){var fg=new qx.ui.menu.Menu;var fh=new qx.ui.menu.Button(cP);var fj=new qx.ui.menu.Button(dY);var ff=new qx.ui.menu.Button(de);var fi=new qx.ui.menu.Button(dc);fh.addListener(dL,this.debugButton);fj.addListener(dL,this.debugButton);ff.addListener(dL,this.debugButton);fi.addListener(dL,this.debugButton);fg.add(fh);fg.add(fj);fg.add(ff);fg.add(fi);return fg;}
,getForwardMenu:function(){var fk=new qx.ui.menu.Menu;var fl=new qx.ui.menu.Button(cJ);var fm=new qx.ui.menu.Button(el);fl.addListener(dL,this.debugButton);fm.addListener(dL,this.debugButton);fk.add(fl);fk.add(fm);return fk;}
,getFileMenu:function(){var fp=new qx.ui.menu.Menu;var fn=new qx.ui.menu.Button(b,em,this.__SY);var fr=new qx.ui.menu.Button(dW,O,this.__Ta);var fq=new qx.ui.menu.Button(R);var fu=new qx.ui.menu.Button(cQ,s,this.__Tb);var ft=new qx.ui.menu.Button(q,U);var fo=new qx.ui.menu.Button(dE,M);var fs=new qx.ui.menu.Button(ed,db);fn.addListener(dL,this.debugButton);fr.addListener(dL,this.debugButton);fq.addListener(dL,this.debugButton);fu.addListener(dL,this.debugButton);ft.addListener(dL,this.debugButton);fo.addListener(dL,this.debugButton);fs.addListener(dL,this.debugButton);fp.add(fn);fp.add(fr);fp.add(fq);fp.add(fu);fp.add(ft);fp.add(fo);fp.add(fs);return fp;}
,getEditMenu:function(){var fw=new qx.ui.menu.Menu;var fz=new qx.ui.menu.Button(k,Q,this.__wv);var fy=new qx.ui.menu.Button(B,dr,this.__wC);var fv=new qx.ui.menu.Button(dJ,c,this.__Tc);var fA=new qx.ui.menu.Button(eo,dK,this.__Td);var fx=new qx.ui.menu.Button(dz,w,this.__Te);fz.addListener(dL,this.debugButton);fy.addListener(dL,this.debugButton);fv.addListener(dL,this.debugButton);fA.addListener(dL,this.debugButton);fx.addListener(dL,this.debugButton);fw.add(fz);fw.add(fy);fw.addSeparator();fw.add(fv);fw.add(fA);fw.add(fx);return fw;}
,getSearchMenu:function(){var fE=new qx.ui.menu.Menu;var fC=new qx.ui.menu.Button(ea,eb);var fH=new qx.ui.menu.Button(da);var fD=new qx.ui.menu.Button(ds);var fG=new qx.ui.menu.Button(ej);var fB=new qx.ui.menu.Button(f,eb);var fF=new qx.ui.menu.Button(dk);fD.setEnabled(false);fC.addListener(dL,this.debugButton);fH.addListener(dL,this.debugButton);fD.addListener(dL,this.debugButton);fG.addListener(dL,this.debugButton);fB.addListener(dL,this.debugButton);fF.addListener(dL,this.debugButton);fE.add(fC);fE.add(fH);fE.add(fD);fE.add(fG);fE.addSeparator();fE.add(fB);fE.add(fF);return fE;}
,getViewMenu:function(){var fI=new qx.ui.menu.Menu;var fK=new qx.ui.menu.Button(dh,null,null,this.getPanesMenu());var fN=new qx.ui.menu.Button(dU,null,null,this.getSyntaxMenu());var fM=new qx.ui.menu.CheckBox(dA);var fL=new qx.ui.menu.CheckBox(r);var fJ=new qx.ui.menu.Button(cY);fM.addListener(h,this.debugCheckBox);fL.addListener(h,this.debugCheckBox);fJ.addListener(dL,this.debugButton);fI.add(fK);fI.add(fN);fI.addSeparator();fI.add(fM);fI.add(fL);fI.addSeparator();fI.add(fJ);return fI;}
,getPanesMenu:function(){var fP=new qx.ui.menu.Menu;var fR=new qx.ui.menu.CheckBox(dF);var fO=new qx.ui.menu.CheckBox(C);var fU=new qx.ui.menu.CheckBox(X);var fQ=new qx.ui.menu.CheckBox(dM);var fS=new qx.ui.menu.CheckBox(dS);var fT=new qx.ui.menu.CheckBox(y);fR.setValue(true);fO.setValue(true);fQ.setValue(true);fR.addListener(h,this.debugCheckBox);fO.addListener(h,this.debugCheckBox);fU.addListener(h,this.debugCheckBox);fQ.addListener(h,this.debugCheckBox);fS.addListener(h,this.debugCheckBox);fT.addListener(h,this.debugCheckBox);fP.add(fO);fP.add(fR);fP.addSeparator();fP.add(fU);fP.add(fQ);fP.add(fS);fP.add(fT);return fP;}
,getSyntaxMenu:function(){var ga=new qx.ui.menu.Menu;var fV=new qx.ui.menu.RadioButton(ef);var fX=new qx.ui.menu.RadioButton(cW);var fW=new qx.ui.menu.RadioButton(cK);var fY=new qx.ui.menu.Button(n,null,null,this.getSyntaxCMenu());var gd=new qx.ui.menu.RadioButton(l);var gb=new qx.ui.menu.RadioButton(V);ga.add(fV);ga.add(fX);ga.add(fW);ga.add(fY);ga.add(gd);ga.add(gb);var gc=new qx.ui.form.RadioGroup;gc.add(fV,fX,fW,gd,gb);gc.add.apply(gc,fY.getMenu().getChildren());gc.addListener(o,this.debugRadio);return ga;}
,getSyntaxCMenu:function(){var gf=new qx.ui.menu.Menu;var ge=new qx.ui.menu.RadioButton(g);var gi=new qx.ui.menu.RadioButton(P);var gg=new qx.ui.menu.RadioButton(ee);var gh=new qx.ui.menu.RadioButton(er);gf.add(ge);gf.add(gi);gf.add(gg);gf.add(gh);return gf;}
,getFormatMenu:function(){var gm=new qx.ui.menu.Menu;var gl=new qx.ui.menu.Button(cR,null,null,this.getParagraphMenu());var go=new qx.ui.menu.Button(dI);var gp=new qx.ui.menu.Button(cM);var gk=new qx.ui.menu.Button(dl);var gn=new qx.ui.menu.Button(ek);var gj=new qx.ui.menu.Button(dR);var gr=new qx.ui.menu.Button(cI);var gq=new qx.ui.menu.Button(E);go.addListener(dL,this.debugButton);gp.addListener(dL,this.debugButton);gk.addListener(dL,this.debugButton);gn.addListener(dL,this.debugButton);gj.addListener(dL,this.debugButton);gr.addListener(dL,this.debugButton);gq.addListener(dL,this.debugButton);gm.add(gl);gm.add(go);gm.add(gp);gm.addSeparator();gm.add(gk);gm.add(gn);gm.add(gj);gm.addSeparator();gm.add(gr);gm.add(gq);return gm;}
,getParagraphMenu:function(){var gs=new qx.ui.menu.Menu;var gw=new qx.ui.menu.Button(j,D);var gv=new qx.ui.menu.Button(cN,dv);var gt=new qx.ui.menu.Button(F,K);var gu=new qx.ui.menu.Button(di,d);gw.addListener(dL,this.debugButton);gv.addListener(dL,this.debugButton);gt.addListener(dL,this.debugButton);gu.addListener(dL,this.debugButton);gs.add(gw);gs.add(gv);gs.add(gt);gs.add(gu);return gs;}
,getHelpMenu:function(){var gx=new qx.ui.menu.Menu;var gz=new qx.ui.menu.Button(dg,W);var gB=new qx.ui.menu.Button(t);var gA=new qx.ui.menu.Button(a);var gy=new qx.ui.menu.Button(p);gz.addListener(dL,this.debugButton);gB.addListener(dL,this.debugButton);gA.addListener(dL,this.debugButton);gy.addListener(dL,this.debugButton);gx.add(gz);gx.add(gB);gx.addSeparator();gx.add(gA);gx.addSeparator();gx.add(gy);return gx;}
...
;return gC;}
,getContextMenu:function(){var gD=new qx.ui.menu.Menu;var gF=new qx.ui.menu.Button(dJ,c,this.__Tc);var gG=new qx.ui.menu.Button(eo,dK,this.__Td);var gE=new qx.ui.menu.Button(dz,w,this.__Te);gF.addListener(dL,this.debugButton);gG.addListener(dL,this.debugButton);gE.addListener(dL,this.debugButton);gD.add(gF);gD.add(gG);gD.add(gE);return gD;}
},destruct:function(){this._disposeObjects(I,cU,dd,dw,dT,dn,dy,dD);}
});}
)();
...
;this.__ov();}
,__ov:function(){if(this.isVisible()){if(this.getBlockBackground()){var V=this.getZIndex();this._blocker.blockContent(V-1);}
;}
...
,__ow:function(){var bn=this._getMenuBounds();if(!bn){this.addListenerOnce(o,this.__ow,this);return;}
...
;this.__ou=bp;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bq){this.getChildControl(h);if(this.__ou){this.__ou.call(this);delete this.__ou;}
;}
...
;this.__ow();}
;}
,_onMouseOver:function(e){var bt=qx.ui.menu.Manager.getInstance();bt.cancelClose(this);var bu=e.getTarget();if(bu.isEnabled()&&bu instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(bu);var bs=bu.getMenu&&bu.getMenu();if(bs){bs.setOpener(bu);bt.scheduleOpen(bs);this.__ot=bs;}
else {var bv=this.getOpenedButton();if(bv){bt.scheduleClose(bv.getMenu());}
;if(this.__ot){bt.cancelOpen(this.__ot);this.__ot=null;}
;}
;}
...
;if(this.__ot){bw.cancelOpen(this.__ot);}
;}
;}
...
(function(){var a="qx.ui.menu.Layout",b="Integer",c="_applyLayoutChange";qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:b,init:0,apply:c},spanColumn:{check:b,init:1,nullable:true,apply:c},iconColumnWidth:{check:b,init:0,themeable:true,apply:c},arrowColumnWidth:{check:b,init:0,themeable:true,apply:c}},members:{__ox:null,_computeSizeHint:function(){var q=this._getLayoutChildren();var o,g,k;var e=this.getSpanColumn();var j=this.__ox=[0,0,0,0];var n=this.getColumnSpacing();var m=0;var f=0;for(var i=0,l=q.length;i<l;i++ ){o=q[i];if(o.isAnonymous()){continue;}
...
(function(){var a="__on",b="blur",c="mousedown",d="Enter",f="Escape",g="Space",h="keydown",j="Left",k="Down",l="Up",m="singleton",n="mousewheel",o="interval",p="event.touch",q="__oo",r="Object is no menu: ",s="qx.ui.menu.Manager",t="keyup",u="keypress",v="__om",w="Right",x="qx.debug";qx.Class.define(s,{type:m,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__om=[];var y=document.body;var z=qx.event.Registration;z.addListener(window.document.documentElement,c,this._onMouseDown,this,true);z.addListener(y,n,this._onMouseWheel,this,true);z.addListener(y,h,this._onKeyUpDown,this,true);z.addListener(y,t,this._onKeyUpDown,this,true);z.addListener(y,u,this._onKeyPress,this,true);if(!qx.core.Environment.get(p)){qx.bom.Element.addListener(window,b,this.hideAll,this);}
;this.__on=new qx.event.Timer;this.__on.addListener(o,this._onOpenInterval,this);this.__oo=new qx.event.Timer;this.__oo.addListener(o,this._onCloseInterval,this);}
,members:{__op:null,__oq:null,__on:null,__oo:null,__om:null,_getChild:function(A,C,B,F){var E=A.getChildren();var length=E.length;var D;for(var i=C;i<length&&i>=0;i+=B){D=E[i];if(D.isEnabled()&&!D.isAnonymous()&&D.isVisible()){return D;}
;}
...
;G=G.getLayoutParent();}
;return false;}
,_isMenuOpener:function(I){var H=this.__om;for(var i=0;i<H.length;i++ ){if(H[i].getOpener()===I){return true;}
;}
;return false;}
...
;}
;var L=this.__om;L.push(K);K.setZIndex(1e6+L.length);}
,remove:function(M){if(qx.core.Environment.get(x)){if(!(M instanceof qx.ui.menu.Menu)){throw new Error(r+M);}
;}
;var N=this.__om;if(N){qx.lang.Array.remove(N,M);}
;}
,hideAll:function(){var O=this.__om;if(O){for(var i=O.length-1;i>=0;i-- ){O[i].exclude();}
;}
;}
,getActiveMenu:function(){var P=this.__om;return P.length>0?P[P.length-1]:null;}
,scheduleOpen:function(Q){this.cancelClose(Q);if(Q.isVisible()){if(this.__op){this.cancelOpen(this.__op);}
;}
else if(this.__op!=Q){this.__op=Q;this.__on.restartWith(Q.getOpenInterval());}
;}
,scheduleClose:function(R){this.cancelOpen(R);if(!R.isVisible()){if(this.__oq){this.cancelClose(this.__oq);}
;}
else if(this.__oq!=R){this.__oq=R;this.__oo.restartWith(R.getCloseInterval());}
;}
,cancelOpen:function(S){if(this.__op==S){this.__on.stop();this.__op=null;}
;}
,cancelClose:function(T){if(this.__oq==T){this.__oo.stop();this.__oq=null;}
;}
,_onOpenInterval:function(e){this.__on.stop();this.__op.open();this.__op=null;}
,_onCloseInterval:function(e){this.__oo.stop();this.__oq.exclude();this.__oq=null;}
...
;if(this.__om.length>0&&!this._isInMenu(U)){this.hideAll();}
;}
,__or:{"Enter":1,"Space":1},__mi:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var V=this.getActiveMenu();if(!V){return;}
;var W=e.getKeyIdentifier();if(this.__mi[W]||(this.__or[W]&&V.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var ba=this.getActiveMenu();if(!ba){return;}
;var X=e.getKeyIdentifier();var bc=this.__mi[X];var Y=this.__or[X];if(bc){switch(X){case l:this._onKeyPressUp(ba);break;case k:this._onKeyPressDown(ba);break;case j:this._onKeyPressLeft(ba);break;case w:this._onKeyPressRight(ba);break;case f:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
else if(Y){var bb=ba.getSelectedButton();if(bb){switch(X){case d:this._onKeyPressEnter(ba,bb,e);break;case g:this._onKeyPressSpace(ba,bb,e);break;};e.stopPropagation();e.preventDefault();}
;}
;}
...
;var x=this.__oy(y[0]);var w=x.getColumnSizes();var s=x.getSpacingX();var z=qx.lang.Array.sum(w)+s*(w.length-1);if(z<o){w[1]+=o-z;}
...
;}
;}
,__oy:function(B){while(!(B instanceof qx.ui.menu.Menu)){B=B.getLayoutParent();}
;return B;}
...
;var P=K.getMarginLeft()+K.getMarginRight();P=Math.max(P,this.getSpacing());var J=K.getSizeHint().width+P;this.__oG(K);G-=J;if(E&&E.getVisibility()!=o){E.setVisibility(o);G+=L;var H=E.getMarginLeft()+E.getMarginRight();G+=Math.max(H,this.getSpacing());}
;}
while(G>F);}
else if(this.__oD.length>0){do {var Q=this.__oD[0];if(Q){var P=Q.getMarginLeft()+Q.getMarginRight();P=Math.max(P,this.getSpacing());if(Q.getContentElement().getDomElement()==null){Q.syncAppearance();Q.invalidateLayoutCache();}
;var I=Q.getSizeHint().width;var O=false;if(this.__oD.length==1&&L>0){var N=P-this.getSpacing();var M=G-L+I+N;O=F>M;}
;if(F>G+I+P||O){this.__oF(Q);G+=I;if(E&&this.__oD.length==0){E.setVisibility(y);}
;}
else {return;}
;}
;}
while(F>=G&&this.__oD.length>0);}
;}
,__oF:function(R){R.setVisibility(o);this.__oD.shift();this.fireDataEvent(m,R);}
,__oG:function(S){if(!S){return;}
;this.__oD.unshift(S);S.setVisibility(y);this.fireDataEvent(A,S);}
,_getNextToHide:function(){for(var i=this.__oE.length-1;i>=0;i-- ){var T=this.__oE[i];if(T&&T.getVisibility&&T.getVisibility()==o){return T;}
;}
...
;}
;}
,setRemovePriority:function(X,W,Y){if(!Y&&this.__oE[W]!=undefined){throw new Error(v);}
;this.__oE[W]=X;}
...
;for(var i=0;i<this.__oD.length;i++ ){this.__oD[i].setVisibility(o);}
;this.__oD=[];}
;}
...
;bf.setVisibility(y);}
;}
,__oH:false,_setAllowMenuOpenHover:function(bg){this.__oH=bg;}
,_isAllowMenuOpenHover:function(){return this.__oH;}
...
,__oI:function(){var x=this.getChildrenContainer().getChildren();x=x.filter(function(y){return y.getVisibility()==k;}
...
(function(){var a="hovered",b="hover-button",c="interval",d="mouseover",f="mouseout",g="__ik",h="qx.ui.form.HoverButton",i="Integer";qx.Class.define(h,{extend:qx.ui.basic.Atom,include:[qx.ui.core.MExecutable],implement:[qx.ui.form.IExecutable],construct:function(j,k){qx.ui.basic.Atom.call(this,j,k);this.addListener(d,this._onMouseOver,this);this.addListener(f,this._onMouseOut,this);this.__ik=new qx.event.AcceleratingTimer();this.__ik.addListener(c,this._onInterval,this);}
,properties:{appearance:{refine:true,init:b},interval:{check:i,init:80},firstInterval:{check:i,init:200},minTimer:{check:i,init:20},timerDecrease:{check:i,init:2}},members:{__ik:null,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.__ik.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();this.addState(a);}
,_onMouseOut:function(e){this.__ik.stop();this.removeState(a);if(!this.isEnabled()||e.getTarget()!==this){return;}
;}
...
;event.stop();}
;}
,__ha:function(event){if(this.getEnabled()&&this.__zj(event)){if(this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,_applyEnabled:function(W,V){if(W){qx.event.Registration.addListener(document.documentElement,n,this.__zi,this);qx.event.Registration.addListener(document.documentElement,O,this.__ha,this);}
else {qx.event.Registration.removeListener(document.documentElement,n,this.__zi,this);qx.event.Registration.removeListener(document.documentElement,O,this.__ha,this);}
;}
