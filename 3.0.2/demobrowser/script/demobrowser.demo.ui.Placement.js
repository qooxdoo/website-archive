...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Placement.0b2dcc3e13af.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.ui.Placement",b="left-middle",c="right-middle",d="top-center",f="mousedown",g="Open DOM-Popup",h="DOM Popup",j="Open Popup",k="changeSelection",l="Content",m="top-left",n="bottom-right",o="right-bottom",p="right-top",q="bottom-center",r="bottom-left",s="left-bottom",t="top-right",u="DOM align control",v="domanchor",w="left-top";qx.Class.define(a,{extend:qx.application.Standalone,members:{__Ro:null,main:function(){qx.application.Standalone.prototype.main.call(this);var x=this.getRoot();this.__Ro=[r,q,n,m,d,t,p,c,o,w,b,s];x.add(this.createTestField(r),{left:20,top:20});x.add(this.createTestField(n),{right:20,top:20});x.add(this.createTestField(t),{right:20,bottom:20});x.add(this.createTestField(m),{left:20,bottom:20});x.add(this.createTestField(q),{left:400,top:20});x.add(this.createTestField(d),{left:400,bottom:20});x.add(this.createTestField(p),{left:20,top:200});x.add(this.createTestField(c),{left:20,top:275});x.add(this.createTestField(o),{left:20,top:350});x.add(this.createTestField(w),{right:20,top:200});x.add(this.createTestField(b),{right:20,top:275});x.add(this.createTestField(s),{right:20,top:350});x.add(this.createDomClick(),{left:200,top:100});}
,createTestField:function(D){var A=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var z=new qx.ui.popup.Popup(new qx.ui.layout.Grow);z.add(new qx.ui.basic.Atom(l));z.setPadding(20);var y=new qx.ui.form.SelectBox;var B=null;for(var i=0;i<this.__Ro.length;i++ ){var C=new qx.ui.form.ListItem(this.__Ro[i]);y.add(C);if(this.__Ro[i]==D){B=C;}
;}
;A.add(y);y.addListener(k,function(e){z.setPosition(e.getData()[0].getLabel());}
);y.setSelection([B]);var E=new qx.ui.form.Button(j);A.add(E);E.addListener(f,function(e){z.placeToWidget(E);z.show();}
);return A;}
,createDomClick:function(){var H=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var J=new qx.ui.basic.Label(u);H.add(J);var G=new qx.ui.popup.Popup(new qx.ui.layout.Grow);G.add(new qx.ui.basic.Atom(h));G.setPadding(20);var F=new qx.ui.form.SelectBox;for(var i=0;i<this.__Ro.length;i++ ){F.add(new qx.ui.form.ListItem(this.__Ro[i]));}
;H.add(F);F.addListener(k,function(e){G.setPosition(e.getData()[0].getLabel());}
);var I=new qx.ui.form.Button(g);H.add(I);I.addListener(f,function(e){G.placeToElement(document.getElementById(v));G.show();}
);return H;}
...
;this.addListener(n,this._onKeyInput,this);this.addListener(p,this.__nN,this);}
,properties:{appearance:{refine:true,init:v}},members:{__zb:null,_createChildControlImpl:function(D,C){var B;switch(D){case t:B=new qx.ui.core.Spacer();this._add(B,{flex:1});break;case A:B=new qx.ui.basic.Atom(z);B.setCenter(false);B.setAnonymous(true);this._add(B,{flex:1});break;case o:B=new qx.ui.basic.Image();B.setAnonymous(true);this._add(B);break;};return B||qx.ui.form.AbstractSelectBox.prototype._createChildControlImpl.call(this,D);}
...
,__nN:function(e){var F=e.getData()[0];var E=this.getChildControl(l);if(E.getSelection()[0]!=F){if(F){E.setSelection([F]);}
else {E.resetSelection();}
;}
;this.__AD();this.__AE();}
,__AD:function(){var H=this.getChildControl(l).getSelection()[0];var G=this.getChildControl(A);var I=H?H.getIcon():r;I==null?G.resetIcon():G.setIcon(I);}
,__AE:function(){var L=this.getChildControl(l).getSelection()[0];var J=this.getChildControl(A);var K=L?L.getLabel():r;var M=this.getFormat();if(M!=null){K=M.call(this,L);}
...
,_onKeyPress:function(e){var S=e.getKeyIdentifier();if(S==b||S==i){if(this.__zb){this.setSelection([this.__zb]);this.__zb=null;}
;this.toggle();}
...
;}
,_onListChangeSelection:function(e){var X=e.getData();var V=e.getOldData();if(V&&V.length>0){V[0].removeListener(h,this.__AD,this);V[0].removeListener(f,this.__AE,this);}
;if(X.length>0){var U=this.getChildControl(x);var W=this.getChildControl(l);var Y=W.getSelectionContext();if(U.isVisible()&&(Y==y||Y==k)){this.__zb=X[0];}
else {this.setSelection([X[0]]);this.__zb=null;}
;X[0].addListener(h,this.__AD,this);X[0].addListener(f,this.__AE,this);}
