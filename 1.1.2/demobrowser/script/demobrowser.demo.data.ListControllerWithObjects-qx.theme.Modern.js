...
var ba={converter:function(M){return m+M+g;
}};
var V=new qx.data.controller.List(Y,Q,z);
V.setIconOptions(ba);
V.setIconPath(d);
var T={converter:function(I){if(I){return c;
}else{return v;
}}};
var O={bindItem:function(J,K,L){J.bindDefaultProperties(K,L);
J.bindProperty(B,r,T,K,L);
}};
V.setDelegate(O);
var P=new qx.ui.form.Button(G);
P.setWidth(120);
this.getRoot().add(P,{left:180,top:80});
P.addListener(k,function(){for(var i=0;i<Y.length;i++){var H=Y.getItem(i);
H.setEmote(j);
}},this);
