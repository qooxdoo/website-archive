...
(function(){var z="mousedown",y="changeSelection",x="top-left",w="bottom-right",v="right-top",u="bottom-left",t="left-bottom",s="top-right",r="demobrowser.demo.ui.Placement",q="Open DOM-Popup",l="DOM Popup",p="Open Popup",o="Content",k="right-bottom",j="DOM align control",n="domanchor",m="left-top";
qx.Class.define(r,{extend:qx.application.Standalone,members:{__Nu:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var F=this.getRoot();
this.__Nu=[u,w,x,s,v,k,m,t];
F.add(this.createTestField(u),{left:20,top:20});
F.add(this.createTestField(w),{right:20,top:20});
F.add(this.createTestField(x),{right:20,bottom:20});
F.add(this.createTestField(s),{left:20,bottom:20});
F.add(this.createTestField(v),{left:20,top:250});
F.add(this.createTestField(t),{right:20,top:250});
F.add(this.createDomClick(),{left:200,top:100});
},createTestField:function(a){var f=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var c=new qx.ui.popup.Popup(new qx.ui.layout.Grow);
c.add(new qx.ui.basic.Atom(o));
c.setPadding(20);
var b=new qx.ui.form.SelectBox;
var g=null;

for(var i=0;i<this.__Nu.length;i++){var d=new qx.ui.form.ListItem(this.__Nu[i]);
b.add(d);

if(this.__Nu[i]==a){g=d;
}}f.add(b);
b.addListener(y,function(e){c.setPosition(e.getData()[0].getLabel());
});
b.setSelection([g]);
var h=new qx.ui.form.Button(p);
f.add(h);
h.addListener(z,function(e){c.placeToWidget(h);
c.show();
});
return f;
},createDomClick:function(){var C=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var E=new qx.ui.basic.Label(j);
C.add(E);
var B=new qx.ui.popup.Popup(new qx.ui.layout.Grow);
B.add(new qx.ui.basic.Atom(l));
B.setPadding(20);
var A=new qx.ui.form.SelectBox;

for(var i=0;i<this.__Nu.length;i++){A.add(new qx.ui.form.ListItem(this.__Nu[i]));
}C.add(A);
A.addListener(y,function(e){B.setPosition(e.getData()[0].getLabel());
});
var D=new qx.ui.form.Button(q);
C.add(D);
D.addListener(z,function(e){B.placeToElement(document.getElementById(n));
B.show();
});
return C;
