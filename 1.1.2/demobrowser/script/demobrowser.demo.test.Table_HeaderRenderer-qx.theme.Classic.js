...
(function(){var k="Name",j="hovered",i="tool tip",h="icon/16/apps/internet-feed-reader.png",g="mouseover",f="demobrowser.demo.test.Table_HeaderRenderer",d="_container",c="mouseout";
qx.Class.define(f,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Standalone.prototype.main.call(this);
this.setUp();
...
},testDefaultRenderer:function(){var s=new qx.ui.table.headerrenderer.Default();
s.setToolTip(i);
var q={name:[k],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var r=this._getNewHeaderContainer();
qx.util.Permutation.permute(q,function(a){var b=s.createHeaderCell(a);
r.add(b);
s.updateHeaderCell(a,b);
});
},testIconRenderer:function(){var p=new qx.ui.table.headerrenderer.Icon(h);
p.setToolTip(i);
var n={name:[k],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var o=this._getNewHeaderContainer();
qx.util.Permutation.permute(n,function(l){var m=p.createHeaderCell(l);
o.add(m);
p.updateHeaderCell(l,m);
});
},_getNewHeaderContainer:function(){var t=new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
t.addListener(g,function(e){e.getTarget().addState(j);
});
t.addListener(c,function(e){e.getTarget().removeState(j);
});
