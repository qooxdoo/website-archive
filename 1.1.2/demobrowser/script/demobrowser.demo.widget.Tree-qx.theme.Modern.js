...
bA.setOpen(true);
bC.add(bA);
var bs=new qx.ui.tree.TreeFolder(F);
var bq=new qx.ui.tree.TreeFolder(q);
var br=new qx.ui.tree.TreeFolder(J);
var bp=new qx.ui.tree.TreeFolder(j);
bA.add(bs,bq,br,bp);
var by=new qx.ui.tree.TreeFile(c);
var bo=new qx.ui.tree.TreeFile(b);
bq.add(by,bo);
var bB=new qx.ui.tree.TreeFolder(a);
var bt=new qx.ui.tree.TreeFolder(L);
var bw=new qx.ui.tree.TreeFolder(G);
var bv=new qx.ui.tree.TreeFolder(j);

for(var i=0;i<30;i++){bv.add(new qx.ui.tree.TreeFile(p+i));
}var bz=new qx.ui.tree.TreeFolder(n);
var bu=new qx.ui.tree.TreeFolder(E);
...
W.addListener(l,function(e){var bD=e.getData();
Q.setSelectionMode(bD?f:d);
});
