...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.table.Table_Events-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"301eb34d1ea0"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(c,{extend:qx.application.Standalone,include:demobrowser.demo.table.MUtil,members:{__Mv:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
},showDialog:function(m){if(!this.__Mv){var p=this.__Mv=new qx.ui.window.Window().set({modal:true,showMinimize:false,showMaximize:false,width:180,contentPadding:[10,10,10,10]});
p.moveTo(315,100);
...
}this.__Mv.getChildren()[1].setValue(m);
this.__Mv.open();
this.__Mv.getChildren()[2].focus();
...
var K=this._eventsWin=new qx.ui.window.Window(l).set({height:400,width:290,showClose:false,showMinimize:false,contentPadding:0});
K.setLayout(new qx.ui.layout.Canvas());
K.open();
this.getRoot().add(K,{left:670,top:10});
this._events=new qx.ui.table.model.Simple();
this._events.setColumns([q,w,d]);
this._events.setData([]);
var J=new qx.ui.table.Table(this._events);
J.getTableColumnModel().setColumnWidth(0,150);
J.getTableColumnModel().setColumnWidth(1,60);
J.getTableColumnModel().setColumnWidth(2,60);
K.add(J,{edge:0});
},createTable:function(){var P=this.createRandomRows(50);
var L=this._tableModel=new qx.ui.table.model.Simple();
L.setColumns([x,g,v,i]);
L.setData(P);
L.setColumnEditable(1,true);
L.setColumnEditable(2,true);
var Q=new qx.ui.table.Table(L);
Q.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var M=Q.getTableColumnModel();
M.setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
var R=function(e){this._events.addRows([[e.getType(),k,k,k]],0);
};
var O=function(e){this._events.addRows([[e.getType(),e.getRow(),e.getColumn()]],0);
};
var N=function(e){var S=e.getData();
this._events.addRows([[e.getType(),S.ascending?B:n,S.columnIndex]],0);
};
Q.addListener(z,R,this);
Q.addListener(j,R,this);
Q.addListener(b,R,this);
Q.addListener(a,R,this);
Q.addListener(m,O,this);
Q.addListener(r,O,this);
Q.addListener(G,O,this);
L.addListener(c,N,this);
L.addListener(t,R,this);
Q.setContextMenu(this.getContextMenu());
return Q;
},createControls:function(){var V=new qx.ui.toolbar.ToolBar();
var T,U;
U=new qx.ui.toolbar.Part();
V.add(U);
T=new qx.ui.toolbar.CheckBox(y,H).set({value:true});
U.add(T);
T.addListener(f,function(e){if(T.isValue()){this._events.setData([]);
this._eventsWin.open();
}else{this._eventsWin.close();
}},this);
return V;
},getContextMenu:function(){var W=new qx.ui.menu.Menu();
var Y=new qx.ui.menu.Button(E,h);
var ba=new qx.ui.menu.Button(p,I);
var X=new qx.ui.menu.Button(o,A);
W.add(Y);
W.add(ba);
W.add(X);
return W;
