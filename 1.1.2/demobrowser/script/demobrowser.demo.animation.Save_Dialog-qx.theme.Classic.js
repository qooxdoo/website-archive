...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.animation.Save_Dialog","qx.theme":"qx.theme.Classic"};
...
(function(){var r="execute",q="__KS",p="__KR",o="middle",n="Cancel",m="demobrowser.demo.animation.Save_Dialog",l="appear",k="Your changes will be lost if you don't save them.",j="close",h="__KU",c="center",g="Save...",f='<b "font-size:12pt;">Do you want to save the changes you made in the doc "Untitled"?</b>',b="Lorem ipsum dolor sit amet, consectetuer sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.\n\nDuis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.\n\nUt wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi",a="right",e="__KT",d="Don't save";
qx.Class.define(m,{extend:qx.application.Standalone,members:{__KR:null,__KS:null,__KT:null,__KU:null,__KV:function(){if(qx.bom.client.Engine.MSHTML){this.__KR=new qx.fx.effect.core.Fade(this.__KS.getContainerElement().getDomElement()).set({from:0,to:1});
this.__KT=new qx.fx.effect.core.Fade(this.__KS.getContainerElement().getDomElement()).set({from:1,to:0});
}else{this.__KR=new qx.fx.effect.combination.Grow(this.__KS.getContainerElement().getDomElement());
this.__KT=new qx.fx.effect.combination.Shrink(this.__KS.getContainerElement().getDomElement());
}},showDialog:function(){this.__KS.setZIndex(1);
this.__KR.start();
},hideDialog:function(){this.__KT.start();
},main:function(){qx.application.Standalone.prototype.main.call(this);
var t=this.getRoot();
this.__KU=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__KU.setLayout(new qx.ui.layout.VBox());
t.add(this.__KU,{left:40,top:40});
...
y.setRowHeight(2,10);
y.setRowAlign(3,c,o);
this.__KS=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16],zIndex:-1});
this.__KS.setLayout(y);
t.add(this.__KS,{left:65,top:125});
this.__KS.addListenerOnce(l,this.__KV,this);
var A=new qx.ui.basic.Label(f);
var u=new qx.ui.basic.Label(k);
A.setRich(true);
this.__KS.add(A,{row:0,column:0,colSpan:3});
this.__KS.add(u,{row:1,column:0,colSpan:3});
var w=[d,n,g];

for(var i=0;i<w.length;i++){var s=new qx.ui.form.Button(w[i]);
s.setAllowStretchX(false);
this.__KS.add(s,{row:3,column:i});
s.addListener(r,this.hideDialog,this);
}}},destruct:function(){this._disposeObjects(h,q,p,e);
}});
})();
