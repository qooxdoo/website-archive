...
return p;
},getBox3:function(){var g=new qx.ui.layout.HBox();
var j=new qx.ui.container.Composite(g).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
g.setSpacing(5);

for(var i=0;i<25;i++){var h=new qx.ui.core.Widget();
h.set({decorator:d,backgroundColor:c,width:5});
j.add(h,{flex:1});
}return j;
...
return n;
},getBox5:function(){var k=new qx.ui.layout.HBox();
var l=new qx.ui.container.Composite(k).set({width:300,minWidth:0,decorator:d,backgroundColor:b,allowGrowX:false});
k.setSpacing(5);
l.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:1});
l.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:2});
l.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:3});
return l;
