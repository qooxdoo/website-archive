...
r.setRowFlex(0,1);
r.setSpacing(10);
var s=new qx.ui.container.Composite(r).set({backgroundColor:g,decorator:q,padding:10,allowGrowX:false,allowGrowY:false,allowStretchX:false,allowStretchY:false});
t.add(s);
this.getRoot().add(t,{edge:0});
var x=this.getPane();
s.add(x,{row:0,column:0,colSpan:3});
var v=new qx.ui.basic.Label(h).set({backgroundColor:n,decorator:q,padding:[4,8]});
s.add(v,{row:1,column:1});
var u=false;
v.addListener(o,function(){var z=x.getChildren()[0];
z.setValue(u?p:m);
u=!u;
});
var w=new qx.ui.basic.Label(f).set({backgroundColor:n,decorator:q,padding:[4,8]});
s.add(w,{row:1,column:2});
var y=false;
w.addListener(o,function(e){if(y){x.setWidth(600);
}else{x.setWidth(300);
}y=!y;
});
},getPane:function(){var d=new qx.ui.container.Composite(new qx.ui.layout.VBox(14)).set({backgroundColor:k,width:600,decorator:q,padding:10});
var a=new qx.ui.basic.Label().set({rich:true,value:p});
d.add(a);
var b=new qx.ui.basic.Label().set({rich:true,value:j});
d.add(b);
var c=new qx.ui.basic.Label().set({rich:true,value:l});
d.add(c);
return d;
}}});
})();
