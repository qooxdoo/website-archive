...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.ScrollContainer_EdgeCaseHeight-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"3dadefd99c0c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var A="value",z="changeSelection",y="execute",x="ScrollbarX:",w="ScrollbarY:",v="Toggle content",u="blue",t="black",s="auto",r="demobrowser.demo.test.ScrollContainer_EdgeCaseHeight",l="Off",q="white",o="off",k="On",j="Content size: 300x300",n="Toggle pane",m="solid",p="Auto",i="on";
...
b.set({width:200,height:300});
this.getRoot().add(b,{left:10,top:10});
b.add(this.generateBox());
var d=new qx.ui.form.Button(n);
var h=true;
d.addListener(y,function(){b.setWidth(h?300:200);
h=!h;
});
this.getRoot().add(d,{left:330,top:20});
var c=new qx.ui.form.Button(v);
var g=true;
c.addListener(y,function(){b.getChildren()[0].setWidth(g?100:300);
g=!g;
});
this.getRoot().add(c,{left:430,top:20});
var f=this.generateScrollbarConfig(x,100);
var a=this.generateScrollbarConfig(w,120);
f.addListener(z,function(e){b.setScrollbarX(e.getData()[0].getUserData(A));
});
a.addListener(z,function(e){b.setScrollbarY(e.getData()[0].getUserData(A));
});
...
C.setMarginRight(20);
var D=new qx.ui.form.RadioButton(p);
var F=new qx.ui.form.RadioButton(k);
var E=new qx.ui.form.RadioButton(l);
D.setUserData(A,s);
F.setUserData(A,i);
E.setUserData(A,o);
D.setValue(true);
...
return H;
},generateBox:function(){var B=new qx.ui.basic.Label(j).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:u,textColor:q,padding:10,decorator:new qx.ui.decoration.Single(4,m,t)});
return B;
}}});
})();
