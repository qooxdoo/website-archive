...
qx.Class.define(g,{extend:qx.application.Standalone,members:{__Mz:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var R=t;
...
--this.__Mz;
this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__Mz+", end="+this.imageData.length);
if(this.__Mz==0){this.doLoad();
}return;
...
if(d===undefined){this.__CU=d;
}else{this.__CU=16;
}
if(e===undefined){this.__CV=e;
}else{this.__CV=16;
}},members:{__CU:null,__CV:null,_identifyImage:function(f){var j={imageWidth:this.__CU,imageHeight:this.__CV};
var k;
