...
}},_initLogger:function(n,o,p){this.__Ln=e+n.join(h)+k;
this.__Lo=p||50;
this.__Lp=o;
this._clearLog();
},_clearLog:function(){this.__Lp.innerHTML=this.__Ln+l;
this.__Lq=[];
},_log:function(q){this.__Lq.unshift(q);
this.__Lq=this.__Lq.slice(0,this.__Lo);
var r=[this.__Ln];

for(var i=0;i<this.__Lq.length;i++){r.push(d,this.__Lq[i].join(f),a);
}r.push(l);
this.__Lp.innerHTML=r.join(g);
this.__Lp.scrollTop=0;
},__Ln:null,__Lo:null,__Lp:null,__Lq:null},destruct:function(){this.__Lp=this.__Lq=null;
}});
})();
...
}qx.bom.Element.addListener(G,k,this.__Lr,this);
...
},__Lr:function(e){var K=e.getTarget().id.split(x)[1];
