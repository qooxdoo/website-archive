...
N.add(this.getBox6());
N.add(this.getBox7());
},getBox1:function(){var a=new qx.ui.layout.VBox();
var c=new qx.ui.container.Composite(a).set({decorator:n,backgroundColor:m,width:140,allowGrowY:false});
...
var v=new qx.ui.container.Composite(t).set({decorator:n,backgroundColor:m,width:140,height:300,allowGrowY:false});
...
u.setMarginTop(-10);
return v;
},getBox4:function(){var I=new qx.ui.layout.VBox();
var K=new qx.ui.container.Composite(I).set({decorator:n,backgroundColor:m,width:140,height:300,allowGrowY:false});
var M=new qx.ui.core.Widget().set({decorator:n,backgroundColor:k,maxWidth:100,alignX:h});
var L=new qx.ui.core.Widget().set({decorator:n,backgroundColor:i,maxWidth:100,alignX:j});
var J=new qx.ui.core.Widget().set({decorator:n,backgroundColor:l,maxWidth:100,alignX:g});
K.add(M,{flex:1});
K.add(L,{flex:2});
K.add(J,{flex:3});
L.setMarginTop(-10);
J.setMarginTop(-10);
return K;
},getBox5:function(){var D=new qx.ui.layout.VBox();
...
E.setHeight(0);
return F;
},getBox6:function(){var y=new qx.ui.layout.VBox();
