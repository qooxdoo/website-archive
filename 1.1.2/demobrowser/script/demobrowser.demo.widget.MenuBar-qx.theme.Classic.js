...
var cu=new qx.ui.container.Scroll();
var ct=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
ct.setPadding(20);
ct.setAllowStretchX(false);
cu.add(ct);
this.getRoot().add(cu,{edge:0});
this.createCommands();
ct.add(this.getMenuBar(),{left:20,top:20});
...
cg.add(menubar);
var cf=new qx.ui.menubar.Button(t,null,this.getFileMenu());
var ce=new qx.ui.menubar.Button(bu,null,this.getEditMenu());
var ch=new qx.ui.menubar.Button(bO,null,this.getSearchMenu());
var ck=new qx.ui.menubar.Button(bm,null,this.getViewMenu());
var cj=new qx.ui.menubar.Button(w,null,this.getFormatMenu());
var ci=new qx.ui.menubar.Button(bL,null,this.getHelpMenu());
menubar.add(cf);
menubar.add(ce);
menubar.add(ch);
menubar.add(ck);
...
menubar.add(ci);
return cg;
},getFileMenu:function(){var dq=new qx.ui.menu.Menu;
var dn=new qx.ui.menu.Button(bE,H,this._newCommand);
var ds=new qx.ui.menu.Button(V,bv,this._openCommand);
var dr=new qx.ui.menu.Button(bq);
var dv=new qx.ui.menu.Button(bW,ba,this._saveCommand);
var du=new qx.ui.menu.Button(bj,bp);
var dt=new qx.ui.menu.Button(Y,bw);
var dp=new qx.ui.menu.Button(bd,bT);
dn.addListener(bI,this.debugButton);
ds.addListener(bI,this.debugButton);
dr.addListener(bI,this.debugButton);
dv.addListener(bI,this.debugButton);
du.addListener(bI,this.debugButton);
dt.addListener(bI,this.debugButton);
...
var cS=new qx.ui.menu.Button(bz,bx,this._undoCommand);
var cR=new qx.ui.menu.Button(bJ,v,this._redoCommand);
var cO=new qx.ui.menu.Button(bf,bD,this._cutCommand);
var cT=new qx.ui.menu.Button(K,bb,this._copyCommand);
var cQ=new qx.ui.menu.Button(L,C,this._pasteCommand);
cS.addListener(bI,this.debugButton);
cR.addListener(bI,this.debugButton);
cO.addListener(bI,this.debugButton);
...
var b=new qx.ui.menu.Button(bc,bG);
var h=new qx.ui.menu.Button(bX);
var c=new qx.ui.menu.Button(bh);
var g=new qx.ui.menu.Button(E);
var a=new qx.ui.menu.Button(bC,bG);
var f=new qx.ui.menu.Button(cc);
c.setEnabled(false);
b.addListener(bI,this.debugButton);
h.addListener(bI,this.debugButton);
c.addListener(bI,this.debugButton);
g.addListener(bI,this.debugButton);
a.addListener(bI,this.debugButton);
f.addListener(bI,this.debugButton);
d.add(b);
d.add(h);
d.add(c);
d.add(g);
...
d.add(f);
return d;
},getViewMenu:function(){var da=new qx.ui.menu.Menu;
var dc=new qx.ui.menu.Button(N,null,null,this.getPanesMenu());
var df=new qx.ui.menu.Button(J,null,null,this.getSyntaxMenu());
var de=new qx.ui.menu.CheckBox(R);
var dd=new qx.ui.menu.CheckBox(bi);
var db=new qx.ui.menu.Button(F);
de.addListener(bH,this.debugCheckBox);
dd.addListener(bH,this.debugCheckBox);
db.addListener(bI,this.debugButton);
da.add(dc);
da.add(df);
da.addSeparator();
da.add(de);
...
var dj=new qx.ui.menu.CheckBox(s);
var dl=new qx.ui.menu.CheckBox(bK);
var dm=new qx.ui.menu.CheckBox(k);
var di=new qx.ui.menu.CheckBox(Q);
var dk=new qx.ui.menu.CheckBox(u);
var dg=new qx.ui.menu.CheckBox(bN);
dj.setValue(true);
dl.setValue(true);
di.setValue(true);
dj.addListener(bH,this.debugCheckBox);
dl.addListener(bH,this.debugCheckBox);
dm.addListener(bH,this.debugCheckBox);
di.addListener(bH,this.debugCheckBox);
dk.addListener(bH,this.debugCheckBox);
...
dh.add(dg);
return dh;
},getSyntaxMenu:function(){var cp=new qx.ui.menu.Menu;
var cl=new qx.ui.menu.RadioButton(D);
var cn=new qx.ui.menu.RadioButton(r);
var cm=new qx.ui.menu.RadioButton(o);
var co=new qx.ui.menu.Button(bl,null,null,this.getSyntaxCMenu());
var cs=new qx.ui.menu.RadioButton(O);
var cq=new qx.ui.menu.RadioButton(i);
cp.add(cl);
cp.add(cn);
cp.add(cm);
cp.add(co);
cp.add(cs);
cp.add(cq);
var cr=new qx.ui.form.RadioGroup;
cr.add(cl,cn,cm,cs,cq);
cr.add.apply(cr,co.getMenu().getChildren());
cr.addListener(bk,this.debugRadio);
return cp;
},getSyntaxCMenu:function(){var cV=new qx.ui.menu.Menu;
var cU=new qx.ui.menu.RadioButton(bQ);
var cY=new qx.ui.menu.RadioButton(by);
var cX=new qx.ui.menu.RadioButton(X);
var cW=new qx.ui.menu.RadioButton(cb);
cV.add(cU);
cV.add(cY);
cV.add(cX);
cV.add(cW);
return cV;
},getFormatMenu:function(){var cI=new qx.ui.menu.Menu;
var cH=new qx.ui.menu.Button(br,null,null,this.getParagraphMenu());
var cK=new qx.ui.menu.Button(G);
var cL=new qx.ui.menu.Button(l);
var cG=new qx.ui.menu.Button(bn);
var cJ=new qx.ui.menu.Button(bY);
var cF=new qx.ui.menu.Button(bU);
var cN=new qx.ui.menu.Button(n);
var cM=new qx.ui.menu.Button(bS);
...
cN.addListener(bI,this.debugButton);
...
cI.add(cM);
return cI;
},getParagraphMenu:function(){var cv=new qx.ui.menu.Menu;
var cy=new qx.ui.menu.Button(bA,bR);
var cz=new qx.ui.menu.Button(m,y);
var cw=new qx.ui.menu.Button(bs,U);
var cx=new qx.ui.menu.Button(S,bB);
