...
(function(){var y="execute",x="appear",w="changeSelection",v="Trash",u="mode",t="Windows (C:)",s="Documents (D:)",r="Add before",q="Add after",p="Add at begin",Y="Inbox",X="Desktop",W="Show open button:",V="New tree item name: ",U="auto",T="Hello",S="Presets",R="Data 123213234325345234523453453245",Q="demobrowser.demo.animation.Tree_Highlight",P="Network",F="Control",G="Sent",D="Files",E="Remove tree item",B="Add file",C="Workspace",z="Junk #",A="Tree",H="never",I="Add folder",K="Root",J="always",M="Move to parent",L="Reset tree",O="Edit",N="Remove all children";
...
var g=new qx.ui.groupbox.GroupBox(A).set({contentPadding:[4,4,4,4]});
...
},getTree:function(){var bj=new qx.ui.tree.Tree().set({width:200,height:400});
var bo=new qx.ui.tree.TreeFolder(K);
bo.setOpen(true);
bj.setRoot(bo);
var bm=new qx.ui.tree.TreeFolder(X);
bm.setOpen(true);
bo.add(bm);
var be=new qx.ui.tree.TreeFolder(D);
var bc=new qx.ui.tree.TreeFolder(C);
var bd=new qx.ui.tree.TreeFolder(P);
var bb=new qx.ui.tree.TreeFolder(v);
bm.add(be,bc,bd,bb);
var bk=new qx.ui.tree.TreeFile(t);
var ba=new qx.ui.tree.TreeFile(s);
bc.add(bk,ba);
var bn=new qx.ui.tree.TreeFolder(Y);
var bf=new qx.ui.tree.TreeFolder(S);
var bi=new qx.ui.tree.TreeFolder(G);
var bh=new qx.ui.tree.TreeFolder(v);

for(var i=0;i<100;i++){bh.add(new qx.ui.tree.TreeFile(z+i));
}var bl=new qx.ui.tree.TreeFolder(R);
var bg=new qx.ui.tree.TreeFolder(O);
bn.add(bf,bi,bh,bl,bg);
bo.add(bn);
return bj;
},getCommandFrame:function(){var bD=new qx.ui.groupbox.GroupBox(F);
bD.setLayout(new qx.ui.layout.Grid(3,5));
var bF=0;
bD.add(new qx.ui.basic.Label(V).set({paddingTop:4}),{row:bF,column:0});
this.inputItemName=new qx.ui.form.TextField(T);
bD.add(this.inputItemName,{row:bF++,column:1});
this.btnAddFolder=new qx.ui.form.Button(I);
this.btnAddFolder.addListener(y,this._addFolder,this);
bD.add(this.btnAddFolder,{row:bF++,column:0,colSpan:2});
this.btnAddFile=new qx.ui.form.Button(B);
this.btnAddFile.addListener(y,this._addFile,this);
bD.add(this.btnAddFile,{row:bF++,column:0,colSpan:2});
this.btnAddAfter=new qx.ui.form.Button(q);
this.btnAddAfter.addListener(y,this._addAfter,this);
bD.add(this.btnAddAfter,{row:bF++,column:0,colSpan:2});
this.btnAddBefore=new qx.ui.form.Button(r);
this.btnAddBefore.addListener(y,this._addBefore,this);
bD.add(this.btnAddBefore,{row:bF++,column:0,colSpan:2});
this.btnAddBegin=new qx.ui.form.Button(p);
this.btnAddBegin.addListener(y,this._addBegin,this);
bD.add(this.btnAddBegin,{row:bF++,column:0,colSpan:2});
bD.add(new qx.ui.core.Spacer(5,5),{row:bF++,column:0});
this.btnRemove=new qx.ui.form.Button(E);
this.btnRemove.addListener(y,this._removeTreeItem,this);
bD.add(this.btnRemove,{row:bF++,column:0,colSpan:2});
this.btnRemoveAll=new qx.ui.form.Button(N);
this.btnRemoveAll.addListener(y,this._removeAll,this);
bD.add(this.btnRemoveAll,{row:bF++,column:0,colSpan:2});
bD.add(new qx.ui.core.Spacer(5,5),{row:bF++,column:0});
this.btnMoveToParent=new qx.ui.form.Button(M);
this.btnMoveToParent.addListener(y,this._moveToParent,this);
bD.add(this.btnMoveToParent,{row:bF++,column:0,colSpan:2});
bD.add(new qx.ui.core.Spacer(5,5),{row:bF++,column:0});
bD.add(new qx.ui.basic.Label(W),{row:bF,column:0});
var bB=[J,H,U];
this.showOpenButtons={};
this.mgrShowRootOpen=new qx.ui.form.RadioGroup();

for(var i=0;i<bB.length;i++){var bE=bB[i];
var bC=new qx.ui.form.RadioButton(bE).set({value:bE==this._tree.getRootOpenClose()});
bC.setUserData(u,bE);
this.showOpenButtons[bE]=bC;
this.mgrShowRootOpen.add(bC);
bD.add(bC,{row:bF++,column:1});
}this.mgrShowRootOpen.addListener(w,this._onChangeShowOpen,this);
bD.add(new qx.ui.core.Spacer(5,5),{row:bF++,column:0});
this.btnReset=new qx.ui.form.Button(L);
this.btnReset.addListener(y,this._resetTree,this);
bD.add(this.btnReset,{row:bF++,column:0,colSpan:2});
this._tree.addListener(w,this._updateControls,this);
this._updateControls();
return bD;
},_addFolder:function(){var m=this._tree.getSelection()[0];
var n=new qx.ui.tree.TreeFolder(this.inputItemName.getValue());
n.addListenerOnce(x,function(){var c=new qx.fx.effect.core.Highlight(n.getContainerElement().getDomElement());
c.start();
},this);
m.setOpen(true);
m.add(n);
},_addFile:function(){var d=this._tree.getSelection()[0];
var e=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
e.addListenerOnce(x,function(){var bx=new qx.fx.effect.core.Highlight(e.getContainerElement().getDomElement());
bx.start();
},this);
d.setOpen(true);
d.add(e);
},_addBefore:function(){var bt=this._tree.getSelection()[0];
var bu=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bu.addListenerOnce(x,function(){var l=new qx.fx.effect.core.Highlight(bu.getContainerElement().getDomElement());
l.start();
},this);
bt.getParent().addBefore(bu,bt);
},_addAfter:function(){var bz=this._tree.getSelection()[0];
var bA=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bA.addListenerOnce(x,function(){var f=new qx.fx.effect.core.Highlight(bA.getContainerElement().getDomElement());
f.start();
},this);
bz.getParent().addAfter(bA,bz);
},_addBegin:function(){var a=this._tree.getSelection()[0];
var b=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
b.addListenerOnce(x,function(){var bw=new qx.fx.effect.core.Highlight(b.getContainerElement().getDomElement());
bw.start();
},this);
a.getParent().addAtBegin(b);
},_removeTreeItem:function(){var o=this._tree.getSelection()[0];
var parent=o.getParent();
parent.remove(o);
},_removeAll:function(){var bv=this._tree.getSelection()[0];
bv.removeAll();
},_moveToParent:function(){var by=this._tree.getSelection()[0];
var parent=by.getParent();
parent.remove(by);
parent.getParent().add(by);
this._updateControls();
},_onChangeShowOpen:function(){var j=this._tree.getSelection()[0];

if(j!=null){var k=this.mgrShowRootOpen.getSelection()[0].getUserData(u);
j.setOpenSymbolMode(k);
}},_resetTree:function(){this._treeGroup.remove(this._tree);
this._tree=this.getTree();
this._treeGroup.add(this._tree,{edge:0});
this._tree.addListenerOnce(x,function(){this._tree.addListener(w,this._updateControls,this);
},this);
},_updateControls:function(){var bp=this._tree.getSelection()[0];

if(!bp){this.btnAddFolder.setEnabled(false);
...
var bq=bs==-1;
var br=bp instanceof qx.ui.tree.TreeFolder;
this.btnAddFolder.setEnabled(br);
this.btnAddFile.setEnabled(br);
this.btnAddBefore.setEnabled(!bq);
this.btnAddAfter.setEnabled(!bq);
this.btnAddBegin.setEnabled(!bq);
this.btnRemove.setEnabled(!bq);
this.btnRemoveAll.setEnabled(true);
this.mgrShowRootOpen.setEnabled(br);
this.showOpenButtons[bp.getOpenSymbolMode()].setValue(true);
this.btnMoveToParent.setEnabled(bs>0);
...
qx.Class.define(d,{extend:qx.fx.Base,properties:{startColor:{init:c,check:f},endColor:{init:a,check:f},restoreBackground:{init:true,check:h},keepBackgroundImage:{init:false,check:h}},members:{__uW:null,__uX:null,__uY:null,__va:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var j=this._getElement();
this.__uW={backgroundImage:qx.bom.element.Style.get(j,g),backgroundColor:qx.bom.element.Style.get(j,i)};

if(!this.getKeepBackgroundImage()){qx.bom.element.Style.set(j,g,e);
}this.__uX=qx.util.ColorUtil.cssStringToRgb(this.getStartColor());
this.__uY=qx.util.ColorUtil.cssStringToRgb(this.getEndColor());
this.__va=[this.__uY[0]-this.__uX[0],this.__uY[1]-this.__uX[1],this.__uY[2]-this.__uX[2]];
},update:function(m){qx.fx.Base.prototype.update.call(this);
var n=[this.__uX[0]+Math.round(this.__va[0]*m),this.__uX[1]+Math.round(this.__va[1]*m),this.__uX[2]+Math.round(this.__va[2]*m)];
var o=b+qx.util.ColorUtil.rgbToHexString([n[0].toString(16),n[1].toString(16),n[2].toString(16)]);
qx.bom.element.Style.set(this._getElement(),i,o);
...
for(var k in this.__uW){qx.bom.element.Style.set(l,k,this.__uW[k]);
}}},destruct:function(){this.__uX=this.__uY=this.__va=null;
}});
})();
