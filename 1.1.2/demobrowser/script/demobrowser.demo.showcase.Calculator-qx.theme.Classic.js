...
(function(){var k="execute",j="-",i="+",h="/",g="*",f="=",d=".",c="black",b="Del",a="sans-serif",G="C",F="5",E="7",D="demobrowser.demo.showcase.Calculator",C="CE",B="__ML",A="solid",z="icon/22/apps/utilities-calculator.png",y="3",x="0",r="n",s="8",p="6",q="4",n="Calculator",o="2",l="__MM",m="Verdana",t="1",u="demobrowser.demo.showcase.CalculatorLogic",w="+/-",v="9";
qx.Class.define(D,{extend:qx.application.Standalone,members:{__ML:null,__MM:null,main:function(){qx.application.Standalone.prototype.main.call(this);
{};
this.__MM=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var K=new qx.ui.window.Window(n,z);
K.setLayout(new qx.ui.layout.VBox(16));
var M=new qx.ui.decoration.Single(1,A,c);
...
U.setLayout(bf);
this.__ML=new qx.ui.basic.Label(this.__MM.getCurrentValue().toString()).set({decorator:M,backgroundColor:"white",allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:["Verdana","sans-serif"],bold:true}),textAlign:"right"});
this.__ML.setEnabled(false);
var bg=new qx.bom.Font().set({size:14,family:[m,a],bold:true});
var ba=new qx.ui.form.Button(x).set({font:bg,minWidth:40});
var Y=new qx.ui.form.Button(t).set({font:bg,minWidth:40});
var X=new qx.ui.form.Button(o).set({font:bg,minWidth:40});
var W=new qx.ui.form.Button(y).set({font:bg,minWidth:40});
var be=new qx.ui.form.Button(q).set({font:bg,minWidth:40});
var bd=new qx.ui.form.Button(F).set({font:bg,minWidth:40});
var bc=new qx.ui.form.Button(p).set({font:bg,minWidth:40});
var bb=new qx.ui.form.Button(E).set({font:bg,minWidth:40});
var bi=new qx.ui.form.Button(s).set({font:bg,minWidth:40});
var bh=new qx.ui.form.Button(v).set({font:bg,minWidth:40});
var J=new qx.ui.form.Button(G).set({font:bg,minWidth:40});
var L=new qx.ui.form.Button(C).set({font:bg,minWidth:40});
var Q=new qx.ui.form.Button(b).set({font:bg,minWidth:40});
var P=new qx.ui.form.Button(w).set({font:bg,minWidth:40});
var S=new qx.ui.form.Button(d).set({font:bg,minWidth:40});
var O=new qx.ui.form.Button(i).set({font:bg,minWidth:40});
var V=new qx.ui.form.Button(j).set({font:bg,minWidth:40});
var T=new qx.ui.form.Button(g).set({font:bg,minWidth:40});
var R=new qx.ui.form.Button(h).set({font:bg,minWidth:40});
var N=new qx.ui.form.Button(f).set({font:bg,minWidth:40});
...
bf.setRowFlex(5,1);
bf.setRowFlex(6,1);
U.add(this.__ML,{row:0,column:0,rowSpan:0,colSpan:4});
...
K.add(U,{flex:1});
J.addListener(k,function(e){this.__MM.cleanDisplay();
this.__ML.setValue(this.__MM.getCurrentValue().toString());
},this);
L.addListener(k,function(e){this.__MM.clearEntry();

if(this.__MM.getResult()!=null){this.__ML.setValue(this.__MM.getCurrentValue().toString());
}},this);
Q.addListener(k,function(e){this.__MM.deleteNumber();
this.__ML.setValue(this.__MM.getCurrentValue().toString());
},this);
P.addListener(k,function(e){this.__MM.setSign();

if(this.__MM.getResult()!=null){this.__ML.setValue(this.__MM.getResult().toString());
}},this);
ba.addListener(k,function(e){this.__MM.setCurrentValue(0);
this.__ML.setValue(this.__MM.getCurrentValue().toFixed(this.__MM.getZeroCounter()).toString());
},this);
Y.addListener(k,function(e){this.__MM.setCurrentValue(1);
this.__ML.setValue(this.__MM.getCurrentValue().toString());
},this);
X.addListener(k,function(e){this.__MM.setCurrentValue(2);
this.__ML.setValue(this.__MM.getCurrentValue().toString());
},this);
W.addListener(k,function(e){this.__MM.setCurrentValue(3);
this.__ML.setValue(this.__MM.getCurrentValue().toString());
},this);
be.addListener(k,function(e){this.__MM.setCurrentValue(4);
this.__ML.setValue(this.__MM.getCurrentValue().toString());
},this);
bd.addListener(k,function(e){this.__MM.setCurrentValue(5);
this.__ML.setValue(this.__MM.getCurrentValue().toString());
},this);
bc.addListener(k,function(e){this.__MM.setCurrentValue(6);
this.__ML.setValue(this.__MM.getCurrentValue().toString());
},this);
bb.addListener(k,function(e){this.__MM.setCurrentValue(7);
this.__ML.setValue(this.__MM.getCurrentValue().toString());
},this);
bi.addListener(k,function(e){this.__MM.setCurrentValue(8);
this.__ML.setValue(this.__MM.getCurrentValue().toString());
},this);
bh.addListener(k,function(e){this.__MM.setCurrentValue(9);
this.__ML.setValue(this.__MM.getCurrentValue().toString());
},this);
O.addListener(k,function(e){this.__MM.calculate(i);

if(this.__MM.getResult()!=null){this.__ML.setValue(this.__MM.getResult().toString());
}this.__MM.resetCurrentValue();
},this);
V.addListener(k,function(e){this.__MM.calculate(j);

if(this.__MM.getResult()!=null){this.__ML.setValue(this.__MM.getResult().toString());
}this.__MM.resetCurrentValue();
},this);
T.addListener(k,function(e){this.__MM.calculate(g);

if(this.__MM.getResult()!=null){this.__ML.setValue(this.__MM.getResult().toString());
}this.__MM.resetCurrentValue();
},this);
R.addListener(k,function(e){this.__MM.calculate(h);

if(this.__MM.getResult()!=null){this.__ML.setValue(this.__MM.getResult().toString());
}this.__MM.resetCurrentValue();
},this);
N.addListener(k,function(e){this.__MM.calculate(f);

if(this.__MM.getResult()!=null){this.__ML.setValue(this.__MM.getResult().toString());
}this.__MM.resetCurrentValue();
},this);
S.addListener(k,function(e){this.__MM.setComma();
},this);
}},destruct:function(){this._disposeObjects(l,B);
}});
qx.Class.define(u,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
},members:{__MN:0,__MO:0,__MP:"n",__MQ:0,__MR:0,__MS:0,__MT:false,__MU:1,__MV:0,__MW:false,__MX:0,setCurrentValue:function(bj){if(this.__MT){this.__MU*=10;
this.__MN=this.__MN+(bj/this.__MU);

if(bj==0){this.__MV++;
}}else{this.__MT=false;

if(this.__MN<0){this.__MN=this.__MN*10-bj;
}else{this.__MN=this.__MN*10+bj;
}}},getZeroCounter:function(){return this.__MV;
},setComma:function(){this.__MT=true;
},getCurrentValue:function(){return this.__MN;
},resetCurrentValue:function(){this.__MN=null;
},cleanDisplay:function(){this.__MX=0;
this.__MR=0;
this.__MP="n";
this.__MV=0;
this.__MU=1;
...
this.__MO=0;
this.__MW=false;
},setResult:function(bk){this.__MO=bk;
},getResult:function(){return Math.round(this.__MO*10000000)/10000000;
},setCurrentOperation:function(I){this.__MP=I;
},getCurrentOperation:function(){return this.__MP;
},clearEntry:function(){this.__MW=false;
this.__MV=0;
this.__MU=1;
this.__MT=false;
this.__MS++;
...
if(this.__MS<2){this.__MR=this.__MO;
}
if(this.__MQ>=2){this.__MO=0;
this.__MQ=0;
}},setSign:function(){this.__MX++;

if(this.__MX%2==0){this.__MW=false;
}else{this.__MW=true;
}
if(this.__MN==null){this.__MN=this.__MO;
}this.__MN=this.__MN*(-1);

if(this.__MO==0){this.__MO=this.__MN;
}
if(this.__MO!=0){this.__MR=this.__MO;
this.__MO=this.__MN;
}},deleteNumber:function(){var bl=false;
var bo=false;

if(this.__MN<0){this.__MN=this.__MN*(-1);
bo=true;
}
if(this.__MN!=null){if(this.__MN.toString().lastIndexOf(d)!=-1){this.__MN=this.__MN*this.__MU;
bl=true;
}}var bm=this.__MN%10;
var bn=bm/10;
this.__MN=this.__MN/10;
this.__MN=this.__MN-bn;

if(bl){this.__MU/=10;
this.__MN=this.__MN/(this.__MU);
bl=false;
}
if(bo){this.__MN=this.__MN*(-1);
bo=false;
}},calculate:function(H){if(H==i||H==g||H==h||H==j||H==f){this.__MT=false;
this.__MU=1;
this.__MV=0;

if(this.__MP!=r){if(this.__MP==i){if(this.__MO==null){this.__MO=this.__MR;
}
if(this.__MW){this.__MO=this.__MR+this.__MN;
}else{this.__MO=this.__MO+this.__MN;
}this.__MN=this.__MO;
this.__MR=this.__MO;
}
if(this.__MP==j){if(this.__MO==0){this.__MO=this.__MN;
this.__MN=0;
}
if(this.__MO==null){this.__MO=this.__MR;
}
if(this.__MW){this.__MO=this.__MR-this.__MN;
}else{this.__MO=this.__MO-this.__MN;
}this.__MN=this.__MO;
...
if(this.__MP==h){if(this.__MO==0){this.__MO=this.__MN;
this.__MN=1;
}
if(this.__MO==null){this.__MO=this.__MR;
}
if(this.__MN!=null){if(this.__MN!=0){if(this.__MW){this.__MO=this.__MR/this.__MN;
}else{this.__MO=this.__MO/this.__MN;
}}else{alert("You can't divide by 0!");
}}this.__MN=this.__MO;
this.__MR=this.__MO;
}
if(this.__MP==g){if(this.__MO==0){this.__MO=1;
}
if(this.__MN==null){this.__MN=1;
}
if(this.__MO==null){this.__MO=this.__MR;
}
if(this.__MW){this.__MO=this.__MR*this.__MN;
