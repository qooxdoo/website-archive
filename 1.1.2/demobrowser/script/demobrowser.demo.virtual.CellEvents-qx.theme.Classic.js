...
var s=t.getPane();
s.addListener(i,this._onCellClick,this);
s.addListener(c,this._onContextMenu,this);
s.addListener(a,this._onDblclickPane,this);
...
this.__Mc(r);
},_onDblclickPane:function(e){var q=g+e.getRow()+m+e.getColumn()+n;
this.__Mc(q);
},__Mc:function(p){this.logger.setHtml(this.logger.getHtml()+p);
