...
(function(){var j="Stopping recurrent 2-second timer",i="Recurrent 2-second timer with limit 3:",h="\n",g="One-shot 1-second timer: ",f="__Ll",e=" ",d="demobrowser.demo.test.TimerManager",c="Recurrent 5-second timer: ",b="Start timers",a="execute";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__Ll:null,startTimers:function(){var s=qx.util.TimerManager.getInstance();
s.start(function(u,v){this.__Lm(c+v);
},5000,this,null,0);
s.start(function(k,l){this.__Lm(g+l);
},0,this,null,1000);
s.start(function(m,n){this.__Lm(i+n);

if(++m.count==3){this.__Lm(j);
s.stop(n);
}},2000,this,{count:0},2000);
},__Lm:function(t){t=Date.parse(new Date)+e+t+h;
this.__Ll.setValue(this.__Ll.getValue()+t);
