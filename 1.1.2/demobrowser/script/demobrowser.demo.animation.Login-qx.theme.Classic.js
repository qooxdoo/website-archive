...
(function(){var o="top",n="right",m="resize",l="Name",k="Password",j="__KY",h="appear",g="__KW",f="__KX",d="demobrowser.demo.animation.Login",a="50%",c="execute",b="30%";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__KW:null,__KX:null,__KY:null,checkInput:function(){this.__KW.start();
},__La:function(){this.__KW=new qx.fx.effect.combination.Shake(this.__KX.getContainerElement().getDomElement());
...
this.__KX=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__KX.setLayout(r);
this.__KX.addListener(m,function(e){var p=this.__KX.getBounds();
this.__KX.set({marginTop:Math.round(-p.height/2),marginLeft:Math.round(-p.width/2)});
},this);
this.getRoot().add(this.__KX,{left:a,top:b});
var q=[l,k];

for(var i=0;i<q.length;i++){this.__KX.add(new qx.ui.basic.Label(q[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}var s=new qx.ui.form.TextField();
var t=new qx.ui.form.PasswordField();
this.__KX.add(s.set({allowShrinkX:false,paddingTop:3}),{row:0,column:1});
this.__KX.add(t.set({allowShrinkX:false,paddingTop:3}),{row:1,column:1});
var u=this.__KY=new qx.ui.form.Button("Login");
u.setAllowStretchX(false);
this.__KX.add(u,{row:3,column:1});
u.addListener(c,this.checkInput,this);
this.__KX.addListener(h,this.__La,this);
