...
},_createWideExample:function(){var C=new qx.ui.basic.Label(o);
C.setFont(t);
this.getRoot().add(C,{left:20,top:285});
var A=new qx.ui.form.ComboBox();
A.setWidth(300);
for(var i=1;i<101;i++){var B=new qx.ui.form.ListItem(i+a);
A.add(B);
