...
u.setData(w);
var t={tableColumnModel:function(I){return new qx.ui.table.columnmodel.Resize(I);
}};
...
return x;
},createControls:function(){var G=new qx.ui.toolbar.ToolBar();
var E,F,H;
F=new qx.ui.toolbar.Part();
G.add(F);
E=new qx.ui.toolbar.Button(q,j);
E.addListener(r,function(B){var C=this.createRandomRows(10);
this._tableModel.addRows(C);
this.info("10 rows added");
},this);
F.add(E);
E=new qx.ui.toolbar.Button(p,d);
E.addListener(r,function(z){var A=this._tableModel.getRowCount();
this._tableModel.removeRows(A-10,10);
...
G.add(F);
var D=this._table;
H=new qx.ui.toolbar.CheckBox(e);
H.set({value:D.getKeepFirstVisibleRowComplete(),toolTip:new qx.ui.tooltip.ToolTip(o+b)});
H.addListener(h,function(y){D.setKeepFirstVisibleRowComplete(this.getValue());
},H);
F.add(H);
return G;
