...
},members:{getTableMock:function(){var I=this.getColumnModelMock();
var G=this.getModelMock();
var H=new qx.ui.table.selection.Model();
var J=new qx.ui.table.selection.Manager();
J.setSelectionModel(H);
var F={getTableModel:function(){return G;
},getTableColumnModel:function(){return I;
},getRowHeight:function(){return 20;
},getForceLineHeight:function(){return true;
},getSelectionModel:function(){return H;
},getDataRowRenderer:function(){return new qx.ui.table.rowrenderer.Default(F);
},updateContent:function(){},setFocusedCell:function(R,S){},getKeepFirstVisibleRowComplete:function(){return true;
},_updateScrollBarVisibility:function(){},getSelectionManager:function(){return J;
},getNewTablePaneHeader:function(l){return function(n){var o=new qx.ui.table.pane.Header(n);
return o;
};
},getNewTablePane:function(E){return function(v){return new qx.ui.table.pane.Pane(v);
};
},getEnabled:function(){return true;
}};
return F;
},getSelectionMock:function(){return {isSelectedIndex:function(m){return m==0;
...
},getColumnWidth:function(z){return 100;
...
},getPaneModelMock:function(){var P={getColumnAtX:function(x){return x;
},getColumnCount:function(){return 4;
},getX:function(Q){return Q;
...
},isColumnSortable:function(K){return true;
},getColumnName:function(L){return d+L;
},isColumnEditable:function(k){return false;
},sortByColumn:function(C,D){},getRowCount:function(){return 500;
},prefetchRows:function(){},getRowData:function(w){var y=[];

for(var i=0;i<4;i++){y.push(h+i+g+w);
}return y;
},getValue:function(t,u){return h+t+g+u;
}};
},getPaneMock:function(){return {getFirstVisibleRow:function(){return 0;
}};
},getScrollerMock:function(){var N=this.getTableMock();
var M=this.getPaneModelMock();
var O=this.getPaneMock();
return {getTable:function(){return N;
},getTablePaneModel:function(){return M;
},getTablePane:function(){return O;
}};
...
(function(){var p="",o="Hello",n="icon/16/actions/go-down.png",m="World",l="bold",k="Juhu",j="</div>",h="waiting",g="icon/16/actions/go-next.png",f="http://resources.qooxdoo.org/images/logo.gif",T="$ ",S="string",R="border: 1px dotted green",Q="inactive",P="decoration",O="multi<br>line",N="between",M="<",L="<div style='position:absolute;height:20px;width:",K="px;top:",w="qx/decoration/Modern",x="icon/16/actions/go-previous.png",u="icon",v="number",s="px'>",t="<i>italic</i>",q="0$",r="qx/icon/Tango",y="<b>bold</b>",z="icon/16/actions/go-up.png",C="boolean",B="demobrowser.demo.test.Table_CellRenderer",E="tooltip",D="red",G="icon/16/emotes/face-sad.png",F="icon/16/emotes/face-smile.png",A="left",J=">=",I="active",H="object";
qx.Class.define(B,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Native.prototype.main.call(this);
this.setUp();
...
qx.util.AliasManager.getInstance().add(P,w);
qx.util.AliasManager.getInstance().add(u,r);
},__Lb:function(ci,top,cj,ck,cl){var cm=[L,cj,K,top,s];
ck.createDataCellHtml(cl,cm);
cm.push(j);
ci.innerHTML+=cm.join(p);
},testDefaultRenderer:function(br){var bs=100;
var bu={value:[null,k,32,new Date()],styleLeft:[0],styleWidth:[bs],styleHeight:[20],style:[p]};
var bt=this._getNewTableDiv(bs);
var top=0;
qx.util.Permutation.permute(bu,function(cb){this.__Lb(bt,top,bs,br,cb);
top+=20;
},this);
},testBooleanRenderer:function(){var bY=70;
var bX=30;
var ca=new qx.ui.table.cellrenderer.Boolean();
var bV={value:[null,true,false],styleLeft:[0],styleWidth:[bY],styleHeight:[bX],style:[p]};
var bW=this._getNewTableDiv(bY);
var top=0;
qx.util.Permutation.permute(bV,function(bv){this.__Lb(bW,top,bY,ca,bv);
top+=bX;
},this);
ca.setIconFalse(G);
ca.setIconTrue(F);
qx.util.Permutation.permute(bV,function(ch){this.__Lb(bW,top,bY,ca,ch);
top+=bX;
},this);
},testDateRenderer:function(){var bI=180;
var bJ=new qx.ui.table.cellrenderer.Date();
var bL={value:new Date(),styleLeft:[0],styleWidth:[bI],styleHeight:[20],style:[p]};
var bH=qx.util.format.DateFormat;
var bK=[bH.getDateTimeInstance(),bH.getDateInstance()];
var bF=this._getNewTableDiv(bI);
var top=0;

for(var i=0;i<bK.length;i++){var bG=bK[i];
bJ.setDateFormat(bG);
this.__Lb(bF,top,bI,bJ,bL);
top+=20;
}},testNumberRenderer:function(){var bB=new qx.ui.table.cellrenderer.Number();
var bA=100;
var bD={value:Math.PI,styleLeft:[0],styleWidth:[bA],styleHeight:[20],style:[p]};
var bz=qx.util.format.NumberFormat;
var bC=[bz.getIntegerInstance(),new bz().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:T})];
var bx=this._getNewTableDiv(bA);
var top=0;

for(var i=0;i<bC.length;i++){var by=bC[i];
bB.setNumberFormat(by);
this.__Lb(bx,top,bA,bB,bD);
top+=20;
}},testImageRenderer:function(){var bT=new qx.ui.table.cellrenderer.Image();
var bR=50;
var bU={value:[null,n,z,x,g,f],styleLeft:[0],styleWidth:[bR],styleHeight:[20],style:[p],tooltip:[p,E]};
var bS=this._getNewTableDiv(bR);
var top=0;
qx.util.Permutation.permute(bU,function(cn){this.__Lb(bS,top,bR,bT,cn);
top+=20;
},this);
},testStringRenderer:function(){var bQ=new qx.ui.table.cellrenderer.String();
var bP=100;
var bO=20;
var bM={value:[null,o,m],styleLeft:[0],styleWidth:[bP],styleHeight:[bO],style:[p]};
var bN=this._getNewTableDiv(bP);
var top=0;
qx.util.Permutation.permute(bM,function(ba){this.__Lb(bN,top,bP,bQ,ba);
top+=20;
},this);
},testPasswordRenderer:function(){var bg=new qx.ui.table.cellrenderer.Password();
var bf=100;
var be=20;
var bc={value:[null,o,m],styleLeft:[0],styleWidth:[bf],styleHeight:[be],style:[p]};
var bd=this._getNewTableDiv(bf);
var top=0;
qx.util.Permutation.permute(bc,function(bw){this.__Lb(bd,top,bf,bg,bw);
top+=20;
},this);
},testHtmlRenderer:function(){var cg=new qx.ui.table.cellrenderer.Html();
var cf=100;
var ce=50;
var cc={value:[null,y,t,O],styleLeft:[0],styleWidth:[cf],styleHeight:[ce],style:[p]};
var cd=this._getNewTableDiv(cf);
var top=0;
qx.util.Permutation.permute(cc,function(U){this.__Lb(cd,top,cf,cg,U);
top+=20;
},this);
},testConditionalRenderer:function(){var bq=new qx.ui.table.cellrenderer.Conditional();
bq.addNumericCondition(M,0,null,D,null,null);
bq.addNumericCondition(J,100,A,null,null,null);
bq.addBetweenCondition(N,0,2,null,null,null,l,null);
bq.addRegex(q,null,null,l,R);
var bp=100;
var bo=20;
var bm={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[bp],table:[this.tableMock],styleHeight:[bo],style:[p]};
var bn=this._getNewTableDiv(bp);
var top=0;
qx.util.Permutation.permute(bm,function(Y){this.__Lb(bn,top,bp,bq,Y);
top+=20;
},this);
},testDynamicRenderer:function(){var bl=new qx.ui.table.cellrenderer.Dynamic();
bl.setCellRendererFactoryFunction(function(V){var X=V.value;
var W=qx.ui.table.cellrenderer;

switch(typeof X){case S:if(X.match(/^icon\//)){return new W.Image();
}else{return new W.String();
}case C:return new W.Boolean();
case v:return new W.Number();
case H:if(X instanceof Date){return new W.Date();
}return new W.Default();
}});
var bk=100;
var bj=20;
var bh={value:[null,k,new Date(),30,n,false],styleLeft:[0],styleWidth:[bk],styleHeight:[bj],table:[this.tableMock],style:[p]};
var bi=this._getNewTableDiv(bk);
var top=0;
qx.util.Permutation.permute(bh,function(bb){this.__Lb(bi,top,bk,bl,bb);
top+=20;
},this);
},testReplaceRenderer:function(){var e=new qx.ui.table.cellrenderer.Replace();
e.setReplaceMap({1:I,2:Q,3:h});
e.addReversedReplaceMap();
var d=100;
var c=20;
var a={value:[1,2,3],styleLeft:[0],styleWidth:[d],table:[this.tableMock],styleHeight:[c],style:[p]};
var b=this._getNewTableDiv(d);
var top=0;
qx.util.Permutation.permute(a,function(bE){this.__Lb(b,top,d,e,bE);
top+=20;
},this);
...
this.__Hw=qx.util.AliasManager.getInstance();
this.initIconTrue();
this.initIconFalse();
},properties:{iconTrue:{check:h,init:f,apply:g},iconFalse:{check:h,init:c,apply:b}},members:{__Hx:null,__Hy:false,__Hw:null,_applyIconTrue:function(l){this.__Hx=this.__Hw.resolve(l);
},_applyIconFalse:function(i){this.__Hy=this.__Hw.resolve(i);
},_insetY:5,_getCellStyle:function(a){return qx.ui.table.cellrenderer.AbstractImage.prototype._getCellStyle.call(this,a)+d;
},_identifyImage:function(j){var k={imageWidth:11,imageHeight:11};

switch(j.value){case true:k.url=this.__Hx;
break;
case false:k.url=this.__Hy;
break;
default:k.url=null;
break;
}return k;
...
(function(){var w="",v="==",u=">",t="between",s="<",r="regex",q="!between",p=">=",o="!=",n="<=",g="font-weight",m=";",k="text-align",f='g',e=":",j="qx.ui.table.cellrenderer.Conditional",h="color",l="font-style";
qx.Class.define(j,{extend:qx.ui.table.cellrenderer.Default,construct:function(a,b,c,d){qx.ui.table.cellrenderer.Default.call(this);
this.numericAllowed=[v,o,u,s,p,n];
this.betweenAllowed=[t,q];
this.conditions=[];
this.__wJ=a||w;
this.__wK=b||w;
this.__wL=c||w;
this.__wM=d||w;
},members:{__wJ:null,__wK:null,__wL:null,__wM:null,__wN:function(x,y){if(x[1]!=null){y[k]=x[1];
}
if(x[2]!=null){y[h]=x[2];
}
if(x[3]!=null){y[l]=x[3];
...
}},addRegex:function(P,Q,R,S,T,U){if(P!=null){var V=[r,Q,R,S,T,P,U];
}
if(V!=null){this.conditions.push(V);
}else{throw new Error("regex cannot be null!");
}},_getCellStyle:function(H){if(!this.conditions.length){return H.style||w;
}var M=H.table.getTableModel();
var i;
var O;
var I;
var K={"text-align":this.__wJ,"color":this.__wK,"font-style":this.__wL,"font-weight":this.__wM};

for(i in this.conditions){O=false;

if(qx.lang.Array.contains(this.numericAllowed,this.conditions[i][0])){if(this.conditions[i][6]==null){I=H.value;
}else{I=M.getValueById(this.conditions[i][6],H.row);
}
switch(this.conditions[i][0]){case v:if(I==this.conditions[i][5]){O=true;
}break;
case o:if(I!=this.conditions[i][5]){O=true;
}break;
case u:if(I>this.conditions[i][5]){O=true;
}break;
case s:if(I<this.conditions[i][5]){O=true;
}break;
case p:if(I>=this.conditions[i][5]){O=true;
}break;
case n:if(I<=this.conditions[i][5]){O=true;
}break;
}}else if(qx.lang.Array.contains(this.betweenAllowed,this.conditions[i][0])){if(this.conditions[i][7]==null){I=H.value;
}else{I=M.getValueById(this.conditions[i][7],H.row);
}
switch(this.conditions[i][0]){case t:if(I>=this.conditions[i][5]&&I<=this.conditions[i][6]){O=true;
}break;
case q:if(I<this.conditions[i][5]&&I>this.conditions[i][6]){O=true;
}break;
}}else if(this.conditions[i][0]==r){if(this.conditions[i][6]==null){I=H.value;
}else{I=M.getValueById(this.conditions[i][6],H.row);
}var J=new RegExp(this.conditions[i][5],f);
O=J.test(I);
}if(O==true){this.__wN(this.conditions[i],K);
}}var N=[];

for(var L in K){if(K[L]){N.push(L,e,K[L],m);
}}return N.join(w);
