...
(function(){var i="main",h="green",g="yellow",f="center",e="demobrowser.demo.layout.VBox_Margin";
...
s.add(this.getBox4());
s.add(this.getBox5());
},getBox1:function(){var p=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,allowGrowY:false});
...
o.setMarginRight(30);
return p;
},getBox2:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,allowGrowY:false});
...
var l=new qx.ui.container.Composite(j).set({decorator:i,backgroundColor:g,width:150,allowGrowY:false});
j.setSpacing(5);
j.setAlignX(f);
...
l.add(m);
l.add(k);
n.setAllowGrowX(false);
m.setAllowGrowX(false);
k.setAllowGrowX(false);
n.setMarginLeft(20);
k.setMarginRight(30);
return l;
},getBox4:function(){var y=new qx.ui.layout.VBox();
var A=new qx.ui.container.Composite(y).set({decorator:i,backgroundColor:g,width:150,allowGrowY:false});
y.setSpacing(5);
y.setAlignX(f);
var C=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var B=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var z=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
A.add(C);
A.add(B);
A.add(z);
C.setMarginLeft(20);
...
var v=new qx.ui.container.Composite(t).set({decorator:i,backgroundColor:g,width:150,allowGrowY:false});
t.setSpacing(5);
t.setAlignX(f);
var x=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var w=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
