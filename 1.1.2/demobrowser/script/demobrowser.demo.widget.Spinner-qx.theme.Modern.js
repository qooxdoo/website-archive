...
qx.Class.define(m,{extend:qx.application.Standalone,members:{addSimpleSpinner:function(y,z){var A=new qx.ui.form.Spinner();
y.add(new qx.ui.basic.Label(f),{column:0,row:z});
y.add(new qx.ui.basic.Label(s),{column:1,row:z});
y.add(A,{column:2,row:z});
y.add(new qx.ui.basic.Label(q),{column:3,row:z});
A.addListener(b,function(e){this.debug("ChangeValue: "+e.getData());
});
...
N.setWrap(true);
L.add(new qx.ui.basic.Label(k),{column:0,row:M});
L.add(new qx.ui.basic.Label(a),{column:1,row:M});
L.add(N,{column:2,row:M});
L.add(new qx.ui.basic.Label(c),{column:3,row:M});
},addSteppedSpinner:function(F,G){var H=new qx.ui.form.Spinner(-3000,0,3000).set({singleStep:25});
F.add(new qx.ui.basic.Label(l),{column:0,row:G});
F.add(new qx.ui.basic.Label(j),{column:1,row:G});
F.add(H,{column:2,row:G});
F.add(new qx.ui.basic.Label(g),{column:3,row:G});
...
},addFormattedSpinner:function(B,C){var D=new qx.ui.form.Spinner(0,200,300);
D.setSingleStep(0.5);
D.setWidth(70);
...
D.setNumberFormat(E);
B.add(new qx.ui.basic.Label(d),{column:0,row:C});
B.add(new qx.ui.basic.Label(s),{column:1,row:C});
B.add(D,{column:2,row:C});
B.add(new qx.ui.basic.Label(i),{column:3,row:C++});
