...
(function(){var w="",v="<b>HTML</b>",u="px;",t="Juhu",s="testImageCell",r="qx.theme",q="testNumberCell",p="width:",o="testHtmlCell",n="testDateCell",J="height:",I="testStringCell",H="testBooleanCellCustomImage",G="demobrowser.demo.virtual.Cells",F="testBooleanCell",E="foobar!",D="qx.theme.Modern",C="icon/32/apps/utilities-notes.png",B="medium",A="icon/16/emotes/face-sad.png",y="icon/16/apps/internet-feed-reader.png",z="icon/16/emotes/face-smile.png",x="This is a feed reader!";
...
var Q=new qx.ui.layout.HBox(5);
this.topContainer=new qx.ui.container.Composite(Q);
this.runTest(I);
this.runTest(q);
this.runTest(n);
this.runTest(o);
if(qx.core.Setting.get(r)==D){this.runTest(s);
this.runTest(F);
this.runTest(H);
}this.getRoot().add(this.topContainer,{edge:5});
},runTest:function(bf){this.setUp();
this[bf]();
...
},testStringCell:function(){var U={value:[t,v,w,null],states:[{},{selected:1}]};
var T=new qx.ui.virtual.cell.String;
qx.util.Permutation.permute(U,function(bb){var bc=this.__LX(T,bb.value,bb.states);
this.container.add(bc);
},this);
},testNumberCell:function(){var O={value:[-1.666666,0,null],format:[null,new qx.util.format.NumberFormat().set({maximumFractionDigits:2})],states:[{},{selected:1}]};
var P=new qx.ui.virtual.cell.Number();
qx.util.Permutation.permute(O,function(K){if(K.format){P.setNumberFormat(K.format);
}else{P.resetNumberFormat();
}var L=this.__LX(P,K.value,K.states);
this.container.add(L);
},this);
},testDateCell:function(){var bd={value:[new Date(),null],format:[null,new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(B))],states:[{},{selected:1}]};
var be=new qx.ui.virtual.cell.Date();
qx.util.Permutation.permute(bd,function(bi){if(bi.format){be.setDateFormat(bi.format);
}else{be.resetDateFormat();
}var bj=this.__LX(be,bi.value,bi.states);
this.container.add(bj);
},this);
},testHtmlCell:function(){var R={value:[t,v,w,null],states:[{},{selected:1}]};
var S=new qx.ui.virtual.cell.Html;
qx.util.Permutation.permute(R,function(M){var N=this.__LX(S,M.value,M.states);
this.container.add(N);
},this);
},testImageCell:function(){var bg={value:[{url:y,tooltip:x},{url:C,tooltip:E},null],states:[{},{selected:1}]};
var bh=new qx.ui.virtual.cell.Image;
qx.util.Permutation.permute(bg,function(l){var m=this.__LX(bh,l.value,l.states);
this.container.add(m);
},this);
},testBooleanCell:function(){var bo={value:[true,false,null],states:[{},{selected:1}]};
var bp=new qx.ui.virtual.cell.Boolean;
qx.util.Permutation.permute(bo,function(bk){var bl=this.__LX(bp,bk.value,bk.states);
this.container.add(bl);
},this);
},testBooleanCellCustomImage:function(){var bm={value:[true,false,null],states:[{},{selected:1}]};
var bn=new qx.ui.virtual.cell.Boolean;
bn.setIconFalse(A);
bn.setIconTrue(z);
qx.util.Permutation.permute(bm,function(a){var b=this.__LX(bn,a.value,a.states);
this.container.add(b);
},this);
},__LX:function(c,d,e){var i=100;
var g=30;
var k=new qx.ui.embed.Html().set({width:i,height:g,decorator:e.selected?null:"main"});
var f=c.getCellProperties(d,e);
var h=f.insets;
var j=["<div ","style='",this._getCellSizeStyle(i,g,h[0],h[1]),f.style,"' ","class='",f.classes,"' ",f.attributes,">",f.content,"</div>"].join("");
k.setHtml(j);
return k;
},_getCellSizeStyle:function(V,W,X,Y){var ba=w;

if(qx.bom.client.Feature.CONTENT_BOX){V-=X;
W-=Y;
}ba+=p+V+u;
ba+=J+W+u;
return ba;
...
(function(){var t="",s="px",r='" ',q="no-repeat",p='"',o='" style="',n='title="',m='<div style="',l='></div>',k="qx.ui.virtual.cell.AbstractImage",e="img",j="inline-block",h='/>',d="static",c="top",g='<img src="',f="abstract",i="string",b="-moz-inline-box";
qx.Class.define(k,{extend:qx.ui.virtual.cell.Cell,type:f,construct:function(){qx.ui.virtual.cell.Cell.call(this);
this._aliasManager=qx.util.AliasManager.getInstance();
},members:{__we:16,__wf:16,_aliasManager:null,__wg:function(u){var x=qx.util.ResourceManager.getInstance();
...
},__wh:function(I){if(typeof (I)==i){I={url:I};
...
},getContent:function(z,A){if(z===null){return t;
}var content=t;
var C=this.__wh(this._identifyImage(z));
var G=qx.bom.client.Engine.GECKO&&qx.bom.client.Engine.VERSION<1.9;
var D=C.tooltip?n+C.tooltip+p:t;
var B={width:C.width+s,height:C.height+s,display:G?b:j,verticalAlign:c,position:d};
var E=qx.bom.element.Decoration.getTagName(q,C.url);
var F=qx.bom.element.Decoration.getAttributes(C.url,q,B);
var H=qx.bom.element.Style.compile(F.style);

if(E===e){content=g+F.src+o+H+r;
content+=D+h;
}else{content=m+H+r;
content+=D+l;
}return content;
...
this.__Dh=qx.util.AliasManager.getInstance();
},properties:{appearance:{refine:true,init:a},iconTrue:{check:e,themeable:true,apply:b},iconFalse:{check:e,themeable:true,apply:d}},members:{__Di:null,__Dj:null,__Dh:null,_applyIconTrue:function(h){this.__Di=this.__Dh.resolve(h);
},_applyIconFalse:function(f){this.__Dj=this.__Dh.resolve(f);
},_identifyImage:function(g){return g==true?this.__Di:this.__Dj;
}}});
})();
