...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Destructor","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Destructor-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"c1fd586e799f"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var f="Window: ",e="__Li",d="interval",c="Label: ",b="demobrowser.demo.test.Destructor";
qx.Class.define(b,{extend:qx.application.Standalone,members:{__Lg:null,__Lh:0,__Li:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__Lg=[];
this.currentTest=this.testWindows;
this.__Li=new qx.event.Timer(1000);
this.__Li.addListener(d,this.runTest,this);
this.__Li.start();
},runTest:function(){this.__Lh++;
var j=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__Lh+" (Registry: "+j+")");
this.currentTest();
qx.ui.core.queue.Manager.flush();
var h=this.__Lg;

for(var i=0,l=h.length;i<l;i++){h[i].destroy();
}h.length=0;
qx.ui.core.queue.Manager.flush();
var j=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Done! (Registry: "+j+")");
},testLabels:function(){for(var i=0;i<250;i++){var g=new qx.ui.basic.Label(c+i);
this.getRoot().add(g,{left:50,top:50+i*20});
this.__Lg.push(g);
}},testWindows:function(){for(var i=0;i<5;i++){var a=new qx.ui.window.Window(f+i);
a.open();
this.__Lg.push(a);
