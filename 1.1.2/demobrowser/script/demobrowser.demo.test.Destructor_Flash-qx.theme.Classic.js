...
qx.Class.define(j,{extend:qx.application.Native,members:{__Lj:null,__Lk:0,main:function(){qx.application.Native.prototype.main.call(this);
this.__Lj=[];
...
q.start();
},clear:function(){var m=this.__Lj;
