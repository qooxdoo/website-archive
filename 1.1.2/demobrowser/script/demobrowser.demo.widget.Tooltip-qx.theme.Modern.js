...
},__Ls:4,__Lt:0,add:function(O){this.container.add(O,{row:Math.floor(this.__Lt/this.__Ls),column:this.__Lt%this.__Ls});
this.__Lt+=1;
},createSharedToolTip:function(){var E=new qx.ui.tooltip.ToolTip(q);
E.addListener(s,function(e){var G=a;

if(this.getOpener()==D){G+=p;
}else{G+=r;
}E.setLabel(G);
});
...
C.setToolTip(E);
this.add(C);
},createIconToolTip:function(){var z=new qx.ui.form.Button(w).set({toolTip:new qx.ui.tooltip.ToolTip(null,k)});
this.add(z);
},createToolTip:function(){var J=new qx.ui.form.Button(b).set({toolTip:new qx.ui.tooltip.ToolTip(d,k)});
this.add(J);
},createShortTimeoutToolTip:function(){var I=new qx.ui.tooltip.ToolTip(x,i);
I.setShowTimeout(50);
var H=new qx.ui.form.Button(g);
this.add(H);
H.setToolTip(I);
},createRichToolTip:function(){var N=new qx.ui.tooltip.ToolTip(o+t+m,i);
N.setWidth(200);
N.setRich(true);
N.setShowTimeout(50);
var M=new qx.ui.form.Button(y);
this.add(M);
M.setToolTip(N);
},createToolTipText:function(){var F=new qx.ui.form.Button(n).set({toolTipText:j});
this.add(F);
},createToolTipIcon:function(){var K=new qx.ui.form.Button(l).set({toolTipIcon:k});
this.add(K);
},createToolTipTextIcon:function(){var L=new qx.ui.form.Button(c).set({toolTipText:j,toolTipIcon:k});
this.add(L);
