...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.progressive.ProgressiveTable_Mouseover","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.progressive.ProgressiveTable_Mouseover-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"393a7b153f73"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var s="row",r="",q="rgb(255, 0, 0)",p="celldata",o="onmouseover='demobrowser.demo.progressive.DateCellRenderer.onmouseover(this);' ",n="Number",m="red",l="1*",k="celldata='",j="' ",d="<br>",i="demobrowser.demo.progressive.ProgressiveTable_Mouseover",g="end",c="Date",b="Move your mouse over the Date field",f="demobrowser.demo.progressive.DateCellRenderer",e="color",h="Id",a="onmouseout='demobrowser.demo.progressive.DateCellRenderer.onmouseout(this);' ";
qx.Class.define(i,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);
var F=0;
var B=function(L){var O=[];
var N=new Date().getTime();
var P=400*24*60*60*1000;

for(var Q=0;Q<L;Q++){var M=new Date(N+Math.random()*P-P/2);
O.push({renderer:s,location:g,data:[F++,Math.random()*10000,M]});
}return O;
};
var E=new qx.ui.progressive.renderer.table.Widths(3);
E.setWidth(0,100);
E.setWidth(1,l);
E.setWidth(2,300);
var y=[h,n,c];
var A=new qx.ui.progressive.headfoot.TableHeading(E,y);
var x=new qx.ui.progressive.headfoot.Progress(E,y);
var H=new qx.ui.progressive.structure.Default(A,x);
var w=new qx.ui.progressive.Progressive(H);
var G=new qx.ui.basic.Atom(b);
G.setTextColor(m);
G.setHeight(16);
G.setRich(true);
w.add(G);
var D=new qx.ui.progressive.model.Default();
var C=B(500);
D.addElements(C);
w.setDataModel(D);
var z=new qx.ui.progressive.renderer.table.Row(E);
w.addRenderer(s,z);
z.addRenderer(2,new demobrowser.demo.progressive.DateCellRenderer());
this.getRoot().add(w,{edge:50});
w.render();
}}});
qx.Class.define(f,{extend:qx.ui.progressive.renderer.table.cell.Default,statics:{onmouseover:function(t){t.__Mx=qx.bom.element.Style.get(t,e);
t.style.color=q;
t.parentNode.style.height=32;
t.__My=t.innerHTML;
var v=Date.parse(t.attributes.getNamedItem(p).nodeValue);
var u=new Date(v);
t.innerHTML=u.toUTCString()+d+u.toString();
},onmouseout:function(I){I.style.color=I.__Mx;
I.parentNode.style.height=16;
I.innerHTML=I.__My;
}},members:{_getCellExtras:function(J){var K=[];
K.push(qx.ui.progressive.renderer.table.cell.Default.prototype._getCellExtras.call(this));
K.push(k+J.cellData.toUTCString()+j);
K.push(o,a);
return K.join(r);
}}});
})();
...
(function(){var n=".qx-progressive-",m="-col-",l="px;",k="-row",j="}",h="width: ",g="0px ",f="qx-progressive-",d="px",c="  font-size: 11px;",V="padding: ",U="px ",T='',S="__El",R="end",Q="qx.client",P="div",O="  position: absolute;",N="  width : 100%;",M="__columnData",u="  border-bottom:1px solid #eeeeee;",v="",s="  top: 0px;",t="  overflow:hidden;",q=" {",r="  cursor:default;",o="  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;",p="-row {",w="resize",x="__Ei",E="start",C="relative",G="  -o-text-overflow: ellipsis;",F="mshtml",I="  border-right:1px solid #f2f2f2;",H="  white-space:nowrap;",z=';-moz-user-select:none;',L="  padding : 0px 6px 0px 6px;",K="qx.ui.progressive.renderer.table.Row",J="progressive-table-row-background-odd",y="  text-overflow:ellipsis;",A="  height: 100%;",B="progressive-table-row-background-even",D="left: ";
qx.Class.define(K,{extend:qx.ui.progressive.renderer.Abstract,construct:function(bp){qx.ui.progressive.renderer.Abstract.call(this);
this.__Eg=bp;
this.__Eh={};
this.__Ei=new qx.ui.progressive.renderer.table.cell.Default();
this.__Ej=null;
this.__Ek={};
var bq=qx.theme.manager.Color.getInstance();
this.__Ek.bgcol=[];
this.__Ek.bgcol[0]=bq.resolve(B);
this.__Ek.bgcol[1]=bq.resolve(J);
this.__El=new qx.ui.layout.HBox();
this.__El.connectToWidget(this);
},statics:{__Em:null,__En:6,__Eo:O+s+A+t+y+G+H+I+u+L+r+c+o+(qx.core.Variant.isSet(Q,F)?T:z)},properties:{defaultRowHeight:{init:16}},members:{__Ej:null,__Ep:null,__Eq:null,__Eg:null,__Eh:null,__Ei:null,__Ek:null,__El:null,join:function(bu,name){if(this.__Ej){throw new Error("Renderer is already joined to a Progressive.");
}this.__Ej=bu;
this.__Ep=name;
var bw=qx.ui.progressive.renderer.table.Row;

if(!bw.__Em){bw.__Em={};
}var bv=bu.toHashCode();

if(!bw.__Em[bv]){bw.__Em[bv]={rowstylesheet:null,cellstylesheet:[]};
var bx=n+bv+p+N+j;
bw.__Em[bv].rowstylesheet=qx.bom.Stylesheet.createElement(bx);
var by=this.__Eg.getData();

for(var i=0;i<by.length;i++){var bx=n+bv+m+i+q+bw.__Eo+j;
bw.__Em[bv].cellstylesheet[i]=qx.bom.Stylesheet.createElement(bx);
}this.__Eq=bv;
var bz=bu.getStructure().getPane();
bz.addListener(w,this._resizeColumns,this);
}},addRenderer:function(br,bs){var bt=this.__Eg.getData();

if(br<0||br>=bt.length){throw new Error("Column "+br+" out of range (max: "+(bt.length-1)+")");
}this.__Eh[br]=bs;
},removeRenderer:function(a){var b=this.__Eg.getData();

if(a<0||a>=b.length){throw new Error("Column "+a+" out of range (max: "+(b.length-1)+")");
}
if(!this.__Eh[a]){throw new Error("No existing renderer for column "+a);
}delete this.__Eh[a];
},render:function(bc,bd){var bn=bd.data;
var bi=[];
var bk;
var bj;
var bg=0;
if(bc.getRendererData()[this.__Ep].end===undefined){bc.getRendererData()[this.__Ep]={end:0,start:1,rows:0,totalHeight:0};
}var bm=document.createElement(P);
for(var i=0;i<bn.length;i++){var bh=f+this.__Eq+m+i;
bj=this.__Eh[i]||this.__Ei;
bk={state:bc,rowDiv:bm,stylesheet:bh,element:bd,dataIndex:i,cellData:bn[i],height:bg};
bi.push(bj.render(bk));
if(bk.height>bg){bg=bk.height;
}}bg=(bg>0?bg:this.getDefaultRowHeight());
var bl=bc.getRendererData()[this.__Ep];
bl.totalHeight+=bg;
bm.style.position=C;
bm.style.height=bg+d;
bm.className=f+this.__Eq+k;
bm.innerHTML=bi.join(v);
switch(bd.location){case R:var be=bl.end||0;
bm.style.backgroundColor=this.__Ek.bgcol[be];
bl.end=(be==0?1:0);
bc.getPane().getContentElement().getDomElement().appendChild(bm);
break;
case E:var bf=bc.getPane().getContentElement().getDomElement();
var bo=bf.childNodes;
if(bo.length>0){var be=bl.start;
bm.style.backgroundColor=this.__Ek.bgcol[be];
bl.start=(be==0?1:0);
bf.insertBefore(bm,bo[0]);
break;
}else{bf.appendChild(bm);
}break;
default:throw new Error("Invalid location: "+bd.location);
}++bl.rows;
},getLayoutChildren:function(){return this.__Eg.getData();
},_resizeColumns:function(e){var bH=this.__Ej.getStructure().getPane();
var bE=bH.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();
var bF=n+this.__Eq+k;
var bB=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bB.__Em[this.__Eq].rowstylesheet,bF);
var bD=h+bE+l;
qx.bom.Stylesheet.addRule(bB.__Em[this.__Eq].rowstylesheet,bF,bD);
this.__El.renderLayout(bE,100);
var bG=this.__Eg.getData();
for(var i=0,bK=0;i<bG.length;i++,bK+=bE){var bF=n+this.__Eq+m+i;
var bB=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bB.__Em[this.__Eq].cellstylesheet[i],bF);
bE=bG[i].getComputedWidth();
{};
var bC;

if(qx.bom.client.Feature.CONTENT_BOX){bC=qx.ui.progressive.renderer.table.Row.__En*2;
}else{bC=-1;
}var bJ=(bE-bC)+l;
var bI=g+qx.ui.progressive.renderer.table.Row.__En+U+g+qx.ui.progressive.renderer.table.Row.__En+l;
var bA=bK+l;
var bD=bB.__Eo+h+bJ+D+bA+V+bI;
qx.bom.Stylesheet.addRule(bB.__Em[this.__Eq].cellstylesheet[i],bF,bD);
}}},destruct:function(){var name;

for(name in this.__Eh){this.__Eh[name]=null;
}var X=qx.ui.progressive.renderer.table.Row;
var W=this.__Ej.toHashCode();

if(X.__Em&&X.__Em[W]){if(X.__Em[W].rowstylesheet){var ba=n+this.__Eq+k;
var X=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(X.__Em[this.__Eq].rowstylesheet,ba);
}if(X.__Em[W].cellstylesheet){for(var i=X.__Em[W].cellstylesheet.length-1;i>=0;i--){var ba=n+this.__Eq+m+i;
var Y=X.__Em[this.__Eq].cellstylesheet[i];
var X=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(Y,ba);
}}}
if(this.__Ej&&this.__Ej.getRendererData){var bb=this.__Ej.getRendererData();

if(bb&&bb[this.__Ep]&&bb[this.__Ep].end!==undefined){bb[this.__Ep]=null;
}}this.__Ek=this.__Eh=this.__Ej=this.__Eg=null;
this._disposeObjects(S,x,M);
}});
})();
...
for(var i=0;i<k;i++){this.__Hv[i]=new qx.ui.core.ColumnData();
}},members:{__Hv:null,getData:function(){return this.__Hv;
...
}}},setWidth:function(l,m){if(l>this.__Hv.length-1||l<0){throw new Error("Column number out of range");
}this.__Hv[l].setColumnWidth(m);
},setMinWidth:function(e,f){if(e>this.__Hv.length-1||e<0){throw new Error("Column number out of range");
}this.__Hv[e].setMinWidth(f);
},setMaxWidth:function(n,o){if(n>this.__Hv.length-1||n<0){throw new Error("Column number out of range");
}this.__Hv[n].setMaxWidth(o);
}}});
})();
...
},members:{__Dk:null,join:function(c){this.__Dk=c;
...
this.__Dn=new qx.ui.layout.HBox();
this.__Dn.connectToWidget(this);
},properties:{appearance:{refine:true,init:c}},members:{__Dl:null,__Do:null,__Dm:null,__Dn:null,join:function(j){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,j);
},getLayoutChildren:function(){if(this.__Do){return this.__Dl.getData();
...
this.__Do=true;
this.__Dn.renderLayout(g,100);
this.__Do=false;
var h=this.__Dl.getData();
for(var i=0;i<h.length;i++){this.__Dm[i].setWidth(h[i].getComputedWidth());
}}},destruct:function(){this.__Dl=this.__Dm=null;
this._disposeObjects(b);
}});
})();
(function(){var n="progressive-progressbar-indicator-undone",m="progress",l="%",k="progressive-progressbar-indicator-done",j="progressive-progressbar-percent-text",i="renderStart",h="progressive-progressbar-background",g="0%",f="qx.ui.progressive.headfoot.Progress",d="__Hs",a="__Ht",c="progressive-progressbar-percent-background",b="renderEnd";
qx.Class.define(f,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(t,u){qx.ui.progressive.headfoot.Abstract.call(this);
this.setHeight(16);
this.setPadding(0);
this.__Hr={};
var v=qx.theme.manager.Color.getInstance();
this.__Hr.background=v.resolve(h);
this.__Hr.indicatorDone=v.resolve(k);
this.__Hr.indicatorUndone=v.resolve(n);
this.__Hr.percentBackground=v.resolve(c);
this.__Hr.percentText=v.resolve(j);
this.set({backgroundColor:this.__Hr.background});
this.__Hs=new qx.ui.core.Widget();
this.__Hs.set({width:0,backgroundColor:this.__Hr.indicatorDone});
this.add(this.__Hs);
var w=new qx.ui.core.Widget();
w.set({backgroundColor:this.__Hr.indicatorUndone});
this.add(w,{flex:1});
this.__Ht=new qx.ui.basic.Atom(g);
this.__Ht.set({width:100,backgroundColor:this.__Hr.percentBackground,textColor:this.__Hr.percentText});
this.add(this.__Ht);
this.exclude();
},members:{__Hu:null,__Hr:null,__Hs:null,__Ht:null,join:function(o){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,o);
o.addListener(i,function(e){this.__Hu=e.getData().initial;
this.show();
},this);
o.addListener(m,function(e){var r=1.0-(e.getData().remaining/this.__Hu);
var s=this.getBounds();

if(s){var p=Math.floor((s.width-this.__Ht.getBounds().width)*r);
var q=Math.floor(r*100)+l;

if(!isNaN(p)){this.__Hs.setMinWidth(p);
this.__Ht.setLabel(q);
}}},this);
o.addListener(b,function(e){this.exclude();
},this);
}},destruct:function(){this.__Hr=null;
this._disposeObjects(d,a);
}});
})();
...
if(!e){this.__ES=new qx.ui.core.Widget();
this.__ET=this.__ES;
}else{this.__ES=null;
this.__ET=e;
}this.__ET.getContentElement().setStyle(b,a);
},members:{__ES:null,__ET:null,applyStructure:function(f){throw new Error("applyStructure() is abstract");
},getPane:function(){return this.__ET;
}},destruct:function(){if(this.__ES){this.__ES.dispose();
}this.__ES=this.__ET=null;
}});
})();
...
this.__Fm=c;
}if(!d){this.__Fn=new qx.ui.progressive.headfoot.Null();
this.__Fo=this.__Fn;
}else{this.__Fn=null;
this.__Fo=d;
}},members:{__Fm:null,__Fo:null,__Fl:null,__Fn:null,applyStructure:function(a){this.__Fm.join(a);
this.__Fo.join(a);
a.add(this.__Fm);
a.add(this.getPane(),{flex:1});
a.add(this.__Fo);
},getHeader:function(){return this.__Fm;
},getFooter:function(){return this.__Fo;
}},destruct:function(){if(this.__Fl){this.__Fl.dispose();
this.__Fl=null;
}
if(this.__Fn){this.__Fn.dispose();
this.__Fn=null;
}this.__Fm=this.__Fo=null;
}});
})();
...
qx.Class.define(c,{extend:qx.ui.container.Composite,construct:function(x){qx.ui.container.Composite.call(this,new qx.ui.layout.VBox());
this.__Fp={};
...
this.__Fs=false;
this.__Ft=0;
},events:{"renderStart":n,"renderEnd":n,"progress":n,"progressDetail":n},properties:{dataModel:{check:g,apply:j},batchSize:{check:k,init:20},flushWidgetQueueAfterBatch:{check:h,init:false},interElementTimeout:{check:k,init:0}},members:{__Fp:null,__Fs:null,__Fu:null,__Ft:null,__Fr:null,__Fq:null,getStructure:function(){return this.__Fq;
},addRenderer:function(name,w){this.__Fp[name]=w;
w.join(this,name);
},removeRenderer:function(name){if(!this.__Fp[name]){throw new Error("No existing renderer named "+name);
}delete this.__Fp[name];
},render:function(){if(this.__Fs){return;
}this.__Fs=true;
var o=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__Fq.getPane(),batchSize:this.getBatchSize(),rendererData:this.__Fw(),userData:{}});
this.__Fu=new Date();
if(this.__Fr){this.__Ft=o.getModel().getElementCount();
this.fireDataEvent(l,{state:o,initial:this.__Ft});
this.__Fv(o);
}else{qx.event.Timer.once(function(){this.__Ft=o.getModel().getElementCount();
this.fireDataEvent(l,{state:o,initial:this.__Ft});
this.__Fv(o);
this.__Fr=true;
},this,10);
}},_applyDataModel:function(t,u){if(u){u.removeListener(m,this.__Fx,this);
u.dispose();
}t.addListener(m,this.__Fx,this);
},__Fv:function(p){var q;
var s;
var r;

for(var i=p.getBatchSize();i>0;i--){q=p.getModel().getNextElement();

if(!q){this.debug("Render time: "+(new Date()-this.__Fu)+"ms");
this.__Fs=false;
this.fireDataEvent(b,p);
p.dispose();
return ;
}s=q.element;
r=this.__Fp[s.renderer];
r.render(p,s);
this.fireDataEvent(a,{initial:this.__Ft,remaining:q.remaining,element:s});
}this.fireDataEvent(f,{initial:this.__Ft,remaining:q.remaining});
if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();
}qx.event.Timer.once(function(){this.__Fv(p);
},this,this.getInterElementTimeout());
},__Fw:function(){var v={};

for(var name in this.__Fp){v[name]={};
}return v;
},__Fx:function(e){this.__Ft=e.getData();
this.render();
}},destruct:function(){for(var name in this.__Fp){this.__Fp[name].dispose();
}this.__Fu=this.__Fp=this.__Fq=null;
}});
})();
...
this.__FX=[];
},members:{__FX:null,addElements:function(d){this.__FX=this.__FX.concat(d);
this.fireDataEvent(b,this.__FX.length);
},addElement:function(c){this.__FX.push(c);
this.fireDataEvent(b,this.__FX.length);
},getElementCount:function(){return this.__FX.length;
},getNextElement:function(){if(this.__FX.length>0){return ({element:this.__FX.shift(),remaining:this.__FX.length});
}return null;
