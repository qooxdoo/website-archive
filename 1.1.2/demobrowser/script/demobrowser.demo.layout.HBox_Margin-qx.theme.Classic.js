...
k.add(this.getBox4());
k.add(this.getBox5());
},getBox1:function(){var q=new qx.ui.layout.HBox();
var s=new qx.ui.container.Composite(q).set({decorator:e,backgroundColor:c,allowGrowX:false});
q.setSpacing(5);
...
return n;
},getBox3:function(){var f=new qx.ui.layout.HBox();
...
i.setAllowGrowY(false);
g.setAllowGrowY(false);
j.setMarginTop(20);
...
B.setMarginTop(5);
B.setMinHeight(50);
B.setMarginBottom(20);
return C;
},getBox5:function(){var v=new qx.ui.layout.HBox();
