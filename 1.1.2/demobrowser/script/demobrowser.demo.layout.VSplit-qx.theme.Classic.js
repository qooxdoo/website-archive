...
var C=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({padding:20,allowShrinkX:false,allowShrinkY:false});
scroll.add(C);
C.add(this.getSplitPaneTwoFlexSimple(),{left:0});
C.add(this.getSplitPaneTwoFlexWithOneMin(),{left:210});
C.add(this.getSplitPaneTwoFlexWithOneMax(),{left:420});
C.add(this.getSplitPaneTwoFlexWithTwoMin(),{left:630});
C.add(this.getSplitPaneTwoFlexWithTwoMax(),{left:840});
C.add(this.getSplitPaneOneFlexSimple(),{top:550,left:0});
C.add(this.getSplitPaneOneFlexSimpleWithMax(),{top:550,left:210});
C.add(this.getSplitPaneOneFlexSimpleWithMin(),{top:550,left:420});
C.add(this.getSplitPaneAuto(),{top:550,left:630});
},getSplitPaneTwoFlexSimple:function(){var x=new qx.ui.splitpane.Pane(m);
x.setHeight(400);
x.setDecorator(l);
var w=new qx.ui.form.TextArea(k);
w.setDecorator(null);
w.setWrap(true);
x.add(w,1);
...
x.add(y,2);
return x;
},getSplitPaneTwoFlexWithOneMin:function(){var A=new qx.ui.splitpane.Pane(m);
A.setHeight(400);
A.setDecorator(l);
...
A.add(B,2);
return A;
},getSplitPaneTwoFlexWithOneMax:function(){var E=new qx.ui.splitpane.Pane(m);
E.setHeight(400);
E.setDecorator(l);
var D=new qx.ui.form.TextArea(k);
D.setDecorator(null);
D.setWrap(true);
E.add(D,1);
var F=new qx.ui.form.TextArea(f);
F.setDecorator(null);
F.setWrap(true);
F.setMaxHeight(100);
E.add(F,2);
return E;
},getSplitPaneTwoFlexWithTwoMin:function(){var r=new qx.ui.splitpane.Pane(m);
r.setHeight(400);
r.setDecorator(l);
...
q.setMinHeight(250);
r.add(q,1);
var s=new qx.ui.form.TextArea(a);
s.setDecorator(null);
s.setWrap(true);
s.setMinHeight(250);
r.add(s,2);
return r;
},getSplitPaneTwoFlexWithTwoMax:function(){var o=new qx.ui.splitpane.Pane(m);
o.setHeight(400);
o.setDecorator(l);
var n=new qx.ui.form.TextArea(e);
n.setDecorator(null);
n.setWrap(true);
n.setMaxHeight(100);
o.add(n,1);
var p=new qx.ui.form.TextArea(f);
p.setDecorator(null);
p.setWrap(true);
p.setMaxHeight(100);
o.add(p,2);
return o;
},getSplitPaneOneFlexSimple:function(){var K=new qx.ui.splitpane.Pane(m);
K.setHeight(400);
K.setDecorator(l);
var J=new qx.ui.form.TextArea(g);
J.setDecorator(null);
J.setWrap(true);
K.add(J,0);
...
K.add(L);
return K;
},getSplitPaneOneFlexSimpleWithMax:function(){var u=new qx.ui.splitpane.Pane(m);
u.setHeight(400);
u.setDecorator(l);
...
u.add(v);
return u;
},getSplitPaneOneFlexSimpleWithMin:function(){var H=new qx.ui.splitpane.Pane(m);
H.setHeight(400);
H.setDecorator(l);
var G=new qx.ui.form.TextArea(c);
G.setDecorator(null);
G.setWrap(true);
G.setMinHeight(350);
H.add(G,0);
var I=new qx.ui.form.TextArea(k);
I.setDecorator(null);
I.setWrap(true);
H.add(I);
return H;
