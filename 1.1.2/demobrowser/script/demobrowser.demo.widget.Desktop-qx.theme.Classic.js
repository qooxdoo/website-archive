...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Desktop","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Desktop-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"a31b591c06e2"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var f="demobrowser.demo.widget.Desktop",e="icon/32/actions/go-home.png",d="Window #",c="Desktop",b="main",a="background-pane";
...
var m=new qx.ui.tabview.Page(c,e);
m.setLayout(new qx.ui.layout.Grow());
h.add(m);
var j=new qx.ui.window.Manager();
var k=new qx.ui.window.Desktop(j);
k.set({decorator:b,backgroundColor:a});
m.add(k);
var g=[[300,200,30,50],[250,250,150,70],[400,300,300,60]];

for(var i=0;i<g.length;i++){var n=g[i];
var l=new qx.ui.window.Window(d+(i+1)).set({width:n[0],height:n[1],showClose:false,showMinimize:false});
l.moveTo(n[2],n[3]);
k.add(l);
l.open();
}}}});
