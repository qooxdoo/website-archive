...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.bom.Clip","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.bom.Clip-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"4dbb8538366f"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.log.Logger.debug("Clip init: "+f.left+","+f.top+"  "+f.width+","+f.height);
},set0:function(){var g=document.getElementById(b);
qx.log.Logger.debug("Setting to: 20,20  120,40");
qx.bom.element.Clip.set(g,{left:20,top:20,width:120,height:40});
