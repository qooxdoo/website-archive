...
},getNewWidget:function(){var p=new qx.ui.core.Widget().set({decorator:o,backgroundColor:c,allowGrowX:false,allowGrowY:false,height:Math.round((Math.random()*30)+30),width:Math.round((Math.random()*30)+30)});
return p;
},getColumnAlignGrid:function(){var t=new qx.ui.container.Composite().set({decorator:o,backgroundColor:n,allowGrowX:false,allowGrowY:false});
var u=new qx.ui.layout.Grid();
u.setSpacing(3);
u.setColumnAlign(0,k,l);
u.setColumnAlign(1,h,g);
u.setColumnAlign(2,j,m);
t.setLayout(u);

for(var x=0;x<3;x++){for(var y=0;y<6;y++){t.add(this.getNewWidget(),{row:y,column:x});
}}return t;
},getRowAlignGrid:function(){var a=new qx.ui.container.Composite().set({decorator:o,backgroundColor:n,allowGrowX:false,allowGrowY:false});
...
for(var x=0;x<6;x++){for(var y=0;y<3;y++){a.add(this.getNewWidget(),{row:y,column:x});
}}return a;
},getCellAlignGrid:function(){var v=new qx.ui.container.Composite().set({decorator:o,backgroundColor:n,allowGrowX:false,allowGrowY:false});
var z=new qx.ui.layout.Grid();
z.setSpacing(3);
v.setLayout(z);

for(var x=0;x<5;x++){z.setColumnAlign(x,h,g);

for(var y=0;y<5;y++){v.add(this.getNewWidget(),{row:y,column:x});
}}var w=z.getCellWidget(0,0);
w.set({alignX:k,alignY:l});
w.set({backgroundColor:f,width:20,height:20});
var w=z.getCellWidget(4,4);
w.set({alignX:j,alignY:m});
w.set({backgroundColor:f,width:20,height:20});
return v;
},getRowColumnAlignGrid:function(){var q=new qx.ui.container.Composite().set({decorator:o,backgroundColor:n,allowGrowX:false,allowGrowY:false});
var s=new qx.ui.layout.Grid();
s.setSpacing(3);
q.setLayout(s);

for(var x=0;x<5;x++){for(var y=0;y<5;y++){q.add(this.getNewWidget(),{row:y,column:x});
}}s.setColumnAlign(2,k,l);
s.setRowAlign(2,j,m);

for(var i=0;i<5;i++){s.getCellWidget(2,i).setBackgroundColor(e);
s.getCellWidget(i,2).setBackgroundColor(e);
}var r=s.getCellWidget(2,2);
r.set({backgroundColor:f,width:20,height:20});
return q;
}}});
})();
