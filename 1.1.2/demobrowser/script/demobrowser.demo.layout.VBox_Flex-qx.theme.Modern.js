...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.VBox_Flex","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.VBox_Flex-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"e7deb972aad8"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var e="main",d="green",c="yellow",b="demobrowser.demo.layout.VBox_Flex";
...
var h=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(h);
h.add(this.getBox1());
h.add(this.getBox2());
h.add(this.getBox3());
...
h.add(this.getBox5());
h.add(this.getBox6());
},getBox1:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,allowGrowY:false});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:1});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:2});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:3});
return a;
},getBox2:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,allowGrowY:false});
k.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:30}),{flex:1});
k.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:2});
k.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:100}),{flex:3});
return k;
},getBox3:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,allowGrowY:false});

for(var i=0;i<25;i++){l.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,height:5}),{flex:1});
}return l;
},getBox4:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,minHeight:300,allowGrowY:false});
g.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:60}),{flex:1});
g.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:60}),{flex:2});
g.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:60}),{flex:3});
return g;
},getBox5:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,minHeight:0,decorator:e,backgroundColor:c,allowGrowY:false});
f.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:1});
f.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:2});
f.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:3});
return f;
},getBox6:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,decorator:e,backgroundColor:c,allowGrowY:false});
j.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:1});
j.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:2});
j.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:3});
return j;
}}});
})();
...
qx.Class.define(k,{extend:qx.ui.layout.Abstract,construct:function(D,E,F,G){qx.ui.layout.Abstract.call(this);

if(D){this.setSpacingX(D);
}
if(E){this.setSpacingY(E);
}
if(F){this.setSeparatorX(F);
}
if(G){this.setSeparatorY(G);
}},properties:{sort:{check:[l,m,n],init:l,apply:j},separatorX:{check:p,nullable:true,apply:s},separatorY:{check:p,nullable:true,apply:s},connectSeparators:{check:e,init:false,apply:s},spacingX:{check:o,init:0,apply:s},spacingY:{check:o,init:0,apply:s}},members:{__qs:null,__qt:null,verifyLayoutProperty:null,_applySort:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__qu:{north:1,south:2,west:3,east:4,center:5},__qv:{1:q,2:d,3:r,4:g},__qw:function(){var t=this._getLayoutChildren();
var B,v;
var length=t.length;
var x=[];
var A=[];
...
},renderLayout:function(bo,bp){if(this._invalidChildrenCache){this.__qw();
...
}},_getSeparatorWidths:function(){var I=this.getSeparatorX(),H=this.getSeparatorY();

if(I||H){var N=qx.theme.manager.Decoration.getInstance();
}
if(I){var O=N.resolve(I);
var K=O.getInsets();
var L=K.left+K.right;
}
if(H){var P=N.resolve(H);
var J=P.getInsets();
var M=J.top+J.bottom;
}return {x:L||0,y:M||0};
},_computeSizeHint:function(){if(this._invalidChildrenCache){this.__qw();
}var T=this.__qs;
var be=this.__qt;
var length=T.length;
var X,bf;
...
if(bi.y){U-=bi.y+bj;
}for(var i=0;i<length;i++){bf=T[i];
X=bf.getSizeHint();
ba=bf.getMarginLeft()+bf.getMarginRight();
Y=bf.getMarginTop()+bf.getMarginBottom();
switch(be[i]){case 1:case 2:bc=Math.max(bc,X.width+bb+ba);
bl=Math.max(bl,X.minWidth+bm+ba);
R+=X.height+Y;
bg+=X.minHeight+Y;
U+=bj;
...
case 3:case 4:Q=Math.max(Q,X.height+R+Y);
bh=Math.max(bh,X.minHeight+bg+Y);
bb+=X.width+ba;
bm+=X.minWidth+ba;
V+=bk;
...
if(bi.y){U+=bi.y+bj;
}}}var W=Math.max(bm,bl)+V;
var bn=Math.max(bb,bc)+V;
var bd=Math.max(bh,bg)+U;
var S=Math.max(Q,R)+U;
return {minWidth:W,width:bn,minHeight:bd,height:S};
}},destruct:function(){this.__qt=this.__qs=null;
}});
})();
...
this.setWidth(null);
this._editorGroups={};
var Q=new qx.ui.decoration.Single();
Q.setLeft(1,y,i);
this.setDecorator(Q);
this.setBackgroundColor(m);
var S=new qx.ui.container.Composite().set({padding:[20,14]});
this.getChildControl(l).add(S);
this._pane=S;
var R=new qx.ui.layout.VBox().set({spacing:5});
S.setLayout(R);
S.add(this._createWidgetIndicator());
S.add(new qx.ui.basic.Label(g).set({font:k,padding:[1,0,5,0]}));
var T=qx.lang.Object.clone(demobrowser.demo.util.PropertyGroup.WIDGET_PROPERTIES);
T.value={type:x,nullable:true};
this._layoutControls=new demobrowser.demo.util.PropertyGroup(T);
S.add(this._layoutControls);
},properties:{widget:{check:r,apply:s}},members:{handleWidgetClick:function(e){var I=e.getTarget();
this.setWidget(I);
...
return E;
},_createLabel:function(U){return new qx.ui.basic.Label(U).set({font:k,allowGrowX:true,padding:[5,0,5,0]});
},_createContainer:function(L,M){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox().set({spacing:5}));
N.add(this._createLabel(L));
N.add(M);
return N;
},updateWidgetLayoutPropertyEditor:function(z){var B=z.getLayoutParent()?z.getLayoutParent()._getLayout():null;
var A=this.getWidgetLayoutPropertyEditor(B);

if(A){A.getChildren()[1].setSelected(z);
}
if(A===this._wlpe){return;
}
if(this._wlpe){this._pane.remove(this._wlpe);
}
if(!A){this._wlpe=A;
return;
}this._pane.addAfter(A,this._layoutControls);
this._wlpe=A;
},updateLayoutPropertyEditor:function(F){var H=F.getLayout?F.getLayout():null;
var G=this.getLayoutPropertyEditor(H);

if(G){G.getChildren()[1].setSelected(H);
}
if(G===this._lpe){return;
}
...
this._lpe=G;
},getWidgetLayoutPropertyEditor:function(C){if(!C){return null;
}var name=c+C.constructor.classname;
var D;

if(this._editorGroups[name]){return this._editorGroups[name];
}
switch(name){case w:case u:D=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.BOX_PROPERTIES);
break;
case v:D=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.CANVAS_PROPERTIES);
break;
case p:D=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.BASIC_PROPERTIES);
break;
case d:D=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.DOCK_PROPERTIES);
break;
case j:D=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.GRID_PROPERTIES);
break;
}
if(!D){return null;
}this._editorGroups[name]=this._createContainer(C.constructor.classname+t,D);
return this._editorGroups[name];
},getLayoutPropertyEditor:function(O){if(!O){return null;
}var name=a+O.constructor.classname;
var P;

if(this._editorGroups[name]){return this._editorGroups[name];
}
switch(name){case f:P=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.HBOX_PROPERTIES);
break;
case b:P=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.DOCK_PROPERTIES);
break;
case o:P=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.GRID_PROPERTIES);
break;
}
if(!P){return null;
}this._editorGroups[name]=this._createContainer(O.constructor.classname+q,P);
return this._editorGroups[name];
},_applyWidget:function(J,K){this._layoutControls.setSelected(J);
this._widgetIndicator.setBackgroundColor(J.getBackgroundColor());
this._widgetIndicator.setDecorator(J.getDecorator());
this._widgetIndicator.setValue(J.toString());
this.updateLayoutPropertyEditor(J);
this.updateWidgetLayoutPropertyEditor(J);
...
qx.Class.define(h,{extend:qx.ui.core.Widget,construct:function(u){qx.ui.core.Widget.call(this);
this._properties=u;
var w=new qx.ui.layout.Grid(10,5);
w.setColumnAlign(0,b,f);
w.setColumnMinWidth(0,110);
this._setLayout(w);
this.set({allowShrinkX:false,allowShrinkY:false});
var D=0;

for(var z in this._properties){var C=this._properties[z].type;
var y=this._properties[z].nullable;
this._add(new qx.ui.basic.Label(z).set({paddingTop:4}),{row:D,column:0});

if(y){var x=new qx.ui.form.CheckBox(j);
x.addListener(r,this._createOnNullPropertyChange(z),this);
this._add(x,{row:D,column:2});
this._properties[z].nullWidget=x;
}
if(C==o){var B=new qx.ui.form.Spinner().set({minimum:this._properties[z].min||0,maximum:this._properties[z].max!==undefined?this._properties[z].max:1000});
B.addListener(r,this._createOnIntPropertyChange(z),this);
this._add(B,{row:D++,column:1});
}else if(C==m){var B=new qx.ui.form.CheckBox();
B.addListener(r,this._createOnBoolPropertyChange(z),this);
this._add(B,{row:D++,column:1});
}else if(C==q){var A=this._properties[z].values;
var B=new qx.ui.form.RadioGroup();

for(var i=0;i<A.length;i++){var v=new qx.ui.form.RadioButton(A[i]);
v.setUserData(s,A[i]);
B.add(v);
this._add(v,{row:D++,column:1});
}B.addListener(c,this._createOnEnumPropertyChange(z,B),this);
}else if(C==n){var B=new qx.ui.form.TextField();
B.setLiveUpdate(true);
B.addListener(r,this._createOnIntPropertyChange(z),this);
this._add(B,{row:D++,column:1});
}this._properties[z].formItem=B;
...
}var Q=p+qx.lang.String.firstUp(name);
var P=this._properties[name].convert;

if(P){O=P(O);
}N[Q](O);
},_getProperty:function(bd,name){var be=g+qx.lang.String.firstUp(name);
return bd[be]();
},_hasProperty:function(U,name){var V=p+qx.lang.String.firstUp(name);
return (typeof (U[V])==k);
},_createOnIntPropertyChange:function(t){return function(e){var R=this.getSelected();
this._setProperty(R,t,e.getTarget().getValue());
};
},_createOnBoolPropertyChange:function(M){return function(e){var ba=this.getSelected();
this._setProperty(ba,M,e.getTarget().getValue());
};
},_createOnEnumPropertyChange:function(S,T){return function(e){var a=this.getSelected();
this._setProperty(a,S,T.getSelection()[0].getUserData(s));
};
},_createOnNullPropertyChange:function(bf){return function(e){var X=this.getSelected();
var W=e.getTarget();

if(W.getValue()){this._setProperty(X,bf,null);
this._properties[bf].formItem.setEnabled(false);
}else{var Y=null;

if(this._properties[bf].type==q){Y=this._properties[bf].formItem.getSelection()[0].getUserData(s);
}else{Y=this._properties[bf].formItem.getValue();
}this._setProperty(X,bf,Y);
this._properties[bf].formItem.setEnabled(true);
}};
},_updateControls:function(E){for(var K in this._properties){var L=this._properties[K].type;
var H=this._properties[K].formItem;
var F=this._properties[K].nullable;

if(!this._hasProperty(E,K)){H.setEnabled(false);

if(F){this._properties[K].nullWidget.setEnabled(false);
}return;
}H.setEnabled(true);
var J=this._getProperty(E,K);

if(J!==null){if(L==o){H.setValue(parseInt(J));
}else if(L==n){H.setValue(J.toString());
}else if(L==m){H.setValue(!!J);
}else if(L==q){var G=H.getItems();

for(var i=0,l=G.length;i<l;i++){var I=G[i];

if(I.getUserData(s)==J){H.setSelection([I]);
break;
}}}}
if(F){this._properties[K].nullWidget.setValue(J==null);
...
}},"edge":{type:"enum",values:["north","east","south","west","center"],nullable:false}},GRID_PROPERTIES:{"row":{type:"int",nullable:false},"column":{type:"int",nullable:false},"rowSpan":{type:"int",nullable:true},"colSpan":{type:"int",nullable:true}}},members:{_setProperty:function(k,name,l){var m=this._properties[name].convert;

if(m){l=m(l);
}var n={};
n[name]=l;
k.setLayoutProperties(n);
},_getProperty:function(e,name){return e.getLayoutProperties()[name]||null;
