...
(function(){var l="",k="execute",j="demobrowser.demo.bom.Cookie",i="Save",h="Restore",g="Delete";
qx.Class.define(j,{extend:qx.application.Standalone,statics:{COOKIE_KEY:"TextFieldContent"},members:{main:function(){qx.application.Standalone.prototype.main.call(this);
var d=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
this.getRoot().add(d,{left:20,top:20});
var b=new qx.ui.form.TextField();
d.add(b);
var a=new qx.ui.form.Button(i);
d.add(a);
a.addListener(k,function(e){if(b.getValue()!=l){qx.bom.Cookie.set(demobrowser.demo.bom.Cookie.COOKIE_KEY,b.getValue());
b.setValue(l);
}},this);
var c=new qx.ui.form.Button(h);
d.add(c);
c.addListener(k,function(e){var m=qx.bom.Cookie.get(demobrowser.demo.bom.Cookie.COOKIE_KEY);
b.setValue(m!=null?m:l);
},this);
var f=new qx.ui.form.Button(g);
d.add(f);
f.addListener(k,function(e){qx.bom.Cookie.del(demobrowser.demo.bom.Cookie.COOKIE_KEY);
b.setValue(l);
},this);
}}});
})();
