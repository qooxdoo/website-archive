...
(function(){var q="qx.data.Array",p="demobrowser.demo.data.model.Node",o="String",n="changeNames",m="changeName",l="\n",k="- ",j="",h="changeChild",g="changeColor",c="Marge",f="AFFE",e="Homer",b="__MC",a="changeName2",d="changeChildren";
qx.Class.define(p,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.setChildren(new qx.data.Array());
},properties:{children:{check:q,event:d},child:{check:p,event:h,nullable:true},names:{check:q,event:n,init:new qx.data.Array(e,c)},name:{check:o,init:f,event:m},name2:{check:o,event:a},number:{init:10,validate:b},color:{event:g,nullable:true}},members:{__MC:function(t){if(!isNaN(parseFloat(t))){if(/^\d+$/.test(t)){return;
...
for(var i=0;i<this.getChildren().length;i++){s+=l+this.getChildren().getItem(i).toString(r+1);
}return s;
}}});
})();
