...
var t=qx.bom.Iframe.create({name:n,src:c});
t.id=n;
document.body.appendChild(t);
qx.event.Registration.addListener(t,f,this.bindIFrameEvents,this);
},bindIFrameEvents:function(){var r=window.document.getElementById(n);
var q=qx.bom.Iframe.getDocument(r);
this._juhu=q.getElementById(j);
this._inner=q.getElementById(l);
...
qx.event.Registration.addListener(q.getElementById(g),d,this._onkeydown,this);

for(var i=1;i<10;i++){var p=q.getElementById(k+i);
qx.event.Registration.addListener(p,o,this._cascadeCapture,this,true);
qx.event.Registration.addListener(p,o,this._cascadeBubble,this,false);
}qx.event.Registration.addListener(q.getElementById(m),m,this._scroll,this);
