...
(function(){var j="main",i="green",h="yellow",g="center",f="right",e="demobrowser.demo.layout.HBox",d="top",c="bottom",b="middle";
...
D.add(this.getBox6());
D.add(this.getBox7());
},getBox1:function(){var v=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:h,allowGrowX:false});
v.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
v.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
v.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
return v;
},getBox2:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:h,minHeight:60,allowGrowX:false});
a.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:d}));
a.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:b}));
a.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:c}));
return a;
},getBox3:function(){var p=new qx.ui.layout.HBox();
var q=new qx.ui.container.Composite(p).set({decorator:j,backgroundColor:h,width:500,allowGrowX:false});
p.setSpacing(5);
p.setAlignX(f);
q.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
q.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
q.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
return q;
},getBox4:function(){var B=new qx.ui.layout.HBox();
var C=new qx.ui.container.Composite(B).set({decorator:j,backgroundColor:h,width:500,allowGrowX:false});
B.setSpacing(5);
B.setAlignX(g);
C.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
C.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
C.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
return C;
},getBox5:function(){var s=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:h,allowGrowX:false});
...
var m=new qx.ui.container.Composite(k).set({decorator:j,backgroundColor:h,width:500,allowGrowX:false});
k.setSpacing(5);
k.setAlignX(f);
...
var y=new qx.ui.container.Composite(w).set({decorator:j,backgroundColor:h,width:500,allowGrowX:false});
w.setSpacing(5);
w.setAlignX(g);
