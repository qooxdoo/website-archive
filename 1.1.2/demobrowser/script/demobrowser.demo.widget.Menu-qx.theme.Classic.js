...
(function(){var ds="execute",dr="changeValue",dq="icon/16/actions/edit-cut.png",dp="changeSelection",dn="icon/16/actions/edit-paste.png",dm="Copy",dl="Paste",dk="icon/16/actions/edit-copy.png",dj="Cut",di="icon/16/actions/system-search.png",cL="New",cK="Undo",cJ="icon/16/actions/document-save.png",cI="Redo",cH="icon/22/apps/preferences-users.png",cG="icon/16/actions/document-print.png",cF="icon/16/actions/document-open.png",cE="icon/16/actions/edit-undo.png",cD="Save",cC="icon/16/actions/edit-redo.png",dz="Print",dA="Open",dx="icon/16/actions/document-new.png",dy="Online Forum",dv="__LF",dw="icon/16/actions/format-justify-fill.png",dt="Search in files",du="C",dB="Left aligned",dC="Perl",db="View",da="C Dialect",dd="Info...",dc="Save as...",df="Show line numbers",de="__LG",dh="Quickstart",dg="icon/16/actions/contact-new.png",cY="Actions",cX="Show console",bt="Search",bu="Help",bv="Show status bar",bw="icon/16/actions/format-justify-left.png",bx="ANSI to OEM",by="Centered",bz="Website 3",bA="Edit",bB="icon/16/actions/format-justify-center.png",bC="__LH",dG="icon/16/actions/go-previous.png",dF="C Sharp",dE="Close",dD="Website 2",dK="icon/16/actions/document-save-as.png",dJ="Python",dI="icon/16/apps/utilities-help.png",dH="Show tree",dM="Options",dL="Spaces to tabs",cc="Right aligned",cd="Action 1",ca="OEM to ANSI",cb="Line 431",cg="JavaScript",ch="icon",ce="Action 2",cf="Folder ",bX="XML",bY="Line 313",bK="Paragraph",bJ="demobrowser.demo.widget.Menu",bM="icon/16/actions/application-exit.png",bL="C Plus Plus",bG="Line 26",bF="Item ",bI="ASCII table",bH="Option 1",bE="Search next...",bD="Line 12",cm="Action 3",cn="Replace in files",co="Uppercase",cp="Topics",ci="Panes",cj="Justified",ck="__LB",cl="Show macros",cq="Search previous...",cr="Back",bU="main",bT="__LC",bS="icon/16/actions/format-justify-right.png",bR="icon/16/actions/go-next.png",bQ="command ",bP="Option 3",bO="Next",bN="Show tags",bW="Capitals",bV="Format",cs="File",ct="Show tabs",cu="Split Button",cv="__LD",cw="Tabs to spaces",cx="Search...",cy="Line 1039",cz="Option 2",cA="Objective C",cB="Exit",cP="__LA",cO="move to",cN="Syntax",cM="Show ruler",cT="Website 1",cS="Menu Button",cR="Line 30",cQ="Lowercase",cV="Replace",cU="__LE",cW="HTML";
qx.Class.define(bJ,{extend:qx.application.Standalone,members:{__LA:null,__LB:null,__LC:null,__LD:null,__LE:null,__LF:null,__LG:null,__LH:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var eG=new qx.ui.container.Scroll();
var eF=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
eF.setPadding(20);
eF.setAllowStretchX(false);
eG.add(eF);
this.getRoot().add(eG,{edge:0});
this.createCommands();
eF.add(this.getMenuButton(),{left:20,top:20});
eF.add(this.getSplitButton(),{left:150,top:20});
eF.add(this.getMenuBar(),{left:20,top:100});
eF.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var bj=new qx.ui.menu.Menu();
var bk=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){bk.add(new qx.ui.menu.Button(cf+(i+1)));
}bj.add(new qx.ui.menu.Button(cO,null,null,bk));
bj.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){bj.add(new qx.ui.menu.Button(bQ+(i+1)));
}return bj;
...
},createCommands:function(){this.__LA=new qx.ui.core.Command("Ctrl+N");
this.__LA.addListener(ds,this.debugCommand);
this.__LB=new qx.ui.core.Command("Ctrl+O");
this.__LB.addListener(ds,this.debugCommand);
this.__LC=new qx.ui.core.Command("Ctrl+S");
this.__LC.addListener(ds,this.debugCommand);
this.__LD=new qx.ui.core.Command("Ctrl+Z");
this.__LD.addListener(ds,this.debugCommand);
this.__LE=new qx.ui.core.Command("Ctrl+R");
this.__LE.addListener(ds,this.debugCommand);
this.__LF=new qx.ui.core.Command("Ctrl+X");
this.__LF.addListener(ds,this.debugCommand);
this.__LG=new qx.ui.core.Command("Ctrl+C");
this.__LG.addListener(ds,this.debugCommand);
this.__LH=new qx.ui.core.Command("Ctrl+P");
this.__LH.addListener(ds,this.debugCommand);
this.__LH.setEnabled(false);
},getMenuButton:function(){var U=new qx.ui.menu.Menu;
U.add(new qx.ui.menu.RadioButton(bH));
U.add(new qx.ui.menu.RadioButton(cz));
U.add(new qx.ui.menu.RadioButton(bP));
var bd=new qx.ui.menu.Menu;
bd.add(new qx.ui.menu.RadioButton(cd));
bd.add(new qx.ui.menu.RadioButton(ce));
bd.add(new qx.ui.menu.RadioButton(cm));
var bc=new qx.ui.form.RadioGroup;
bc.add.apply(bc,U.getChildren());
bc.addListener(dp,this.debugRadio);
var ba=new qx.ui.form.RadioGroup;
ba.add.apply(ba,bd.getChildren());
ba.addListener(dp,this.debugRadio);
var X=new qx.ui.menu.Menu();
var bb=new qx.ui.menu.Button(cK,cE,this.__LD);
var bi=new qx.ui.menu.Button(cI,cC,this.__LE);
var W=new qx.ui.menu.Button(dj,dq,this.__LF);
var bf=new qx.ui.menu.Button(dm,dk,this.__LG);
var Y=new qx.ui.menu.Button(dl,dn,this.__LH);
var V=new qx.ui.menu.Button(dM,di,null,U);
var bg=new qx.ui.menu.Button(cY,dg,null,bd);
var be=new qx.ui.menu.Button(dz,cG);
bb.addListener(ds,this.debugButton);
bi.addListener(ds,this.debugButton);
W.addListener(ds,this.debugButton);
bf.addListener(ds,this.debugButton);
Y.addListener(ds,this.debugButton);
V.addListener(ds,this.debugButton);
bg.addListener(ds,this.debugButton);
be.addListener(ds,this.debugButton);
X.add(bb);
X.add(bi);
X.addSeparator();
X.add(W);
...
X.addSeparator();
X.add(be);
var bh=new qx.ui.form.MenuButton(cS,cH,X);
return bh;
},getSplitButton:function(){var j=new qx.ui.menu.Menu;
var n=new qx.ui.menu.Button(cT);
var l=new qx.ui.menu.Button(dD);
var m=new qx.ui.menu.Button(bz);
j.setMinWidth(120);
...
j.add(l);
j.add(m);
var k=new qx.ui.form.SplitButton(cu,cH,j);
k.addListener(ds,this.debugButton);
return k;
},getMenuBar:function(){var eu=new qx.ui.container.Composite(new qx.ui.layout.Grow);
eu.setDecorator(bU);
var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setWidth(600);
eu.add(toolbar);
var eD=new qx.ui.toolbar.Part;
var et=new qx.ui.toolbar.Part;
var ex=new qx.ui.toolbar.Part;
toolbar.add(eD);
toolbar.add(et);
toolbar.addSpacer();
toolbar.add(ex);
var eC=new qx.ui.toolbar.SplitButton(cr,dG,this.getBackMenu());
var ez=new qx.ui.toolbar.SplitButton(bO,bR,this.getForwardMenu());
var es=new qx.ui.toolbar.Button(cL,dx,this.__LA);
var ew=new qx.ui.toolbar.Button(dA,cF,this.__LB);
var eB=new qx.ui.toolbar.Button(cD,cJ,this.__LC);
eC.addListener(ds,this.debugButton);
ez.addListener(ds,this.debugButton);
es.addListener(ds,this.debugButton);
ew.addListener(ds,this.debugButton);
...
eD.add(eB);
eD.setShow(ch);
var ev=new qx.ui.toolbar.MenuButton(cs);
var er=new qx.ui.toolbar.MenuButton(bA);
var eq=new qx.ui.toolbar.MenuButton(bt);
var eE=new qx.ui.toolbar.MenuButton(db);
var eA=new qx.ui.toolbar.MenuButton(bV);
ev.setMenu(this.getFileMenu());
er.setMenu(this.getEditMenu());
eq.setMenu(this.getSearchMenu());
eE.setMenu(this.getViewMenu());
eA.setMenu(this.getFormatMenu());
et.add(ev);
et.add(er);
et.add(eq);
et.add(eE);
et.add(eA);
var ey=new qx.ui.toolbar.MenuButton(bu);
ey.setMenu(this.getHelpMenu());
ex.add(ey);
return eu;
},getBackMenu:function(){var K=new qx.ui.menu.Menu;
var L=new qx.ui.menu.Button(bY);
var N=new qx.ui.menu.Button(cy);
var J=new qx.ui.menu.Button(bD);
var M=new qx.ui.menu.Button(bG);
L.addListener(ds,this.debugButton);
N.addListener(ds,this.debugButton);
J.addListener(ds,this.debugButton);
M.addListener(ds,this.debugButton);
K.add(L);
K.add(N);
K.add(J);
K.add(M);
return K;
},getForwardMenu:function(){var bl=new qx.ui.menu.Menu;
var bm=new qx.ui.menu.Button(cb);
var bn=new qx.ui.menu.Button(cR);
bm.addListener(ds,this.debugButton);
bn.addListener(ds,this.debugButton);
bl.add(bm);
bl.add(bn);
return bl;
},getFileMenu:function(){var ek=new qx.ui.menu.Menu;
var ei=new qx.ui.menu.Button(cL,dx,this.__LA);
var em=new qx.ui.menu.Button(dA,cF,this.__LB);
var el=new qx.ui.menu.Button(dE);
var ep=new qx.ui.menu.Button(cD,cJ,this.__LC);
var eo=new qx.ui.menu.Button(dc,dK);
var en=new qx.ui.menu.Button(dz,cG);
var ej=new qx.ui.menu.Button(cB,bM);
ei.addListener(ds,this.debugButton);
em.addListener(ds,this.debugButton);
el.addListener(ds,this.debugButton);
ep.addListener(ds,this.debugButton);
eo.addListener(ds,this.debugButton);
en.addListener(ds,this.debugButton);
...
ek.add(ej);
return ek;
},getEditMenu:function(){var E=new qx.ui.menu.Menu;
var H=new qx.ui.menu.Button(cK,cE,this.__LD);
var G=new qx.ui.menu.Button(cI,cC,this.__LE);
var D=new qx.ui.menu.Button(dj,dq,this.__LF);
var I=new qx.ui.menu.Button(dm,dk,this.__LG);
var F=new qx.ui.menu.Button(dl,dn,this.__LH);
H.addListener(ds,this.debugButton);
G.addListener(ds,this.debugButton);
D.addListener(ds,this.debugButton);
I.addListener(ds,this.debugButton);
...
E.add(F);
return E;
},getSearchMenu:function(){var d=new qx.ui.menu.Menu;
var b=new qx.ui.menu.Button(cx,di);
var h=new qx.ui.menu.Button(bE);
var c=new qx.ui.menu.Button(cq);
var g=new qx.ui.menu.Button(cV);
var a=new qx.ui.menu.Button(dt,di);
var f=new qx.ui.menu.Button(cn);
c.setEnabled(false);
b.addListener(ds,this.debugButton);
h.addListener(ds,this.debugButton);
c.addListener(ds,this.debugButton);
g.addListener(ds,this.debugButton);
...
d.add(f);
return d;
},getViewMenu:function(){var x=new qx.ui.menu.Menu;
var z=new qx.ui.menu.Button(ci,null,null,this.getPanesMenu());
var C=new qx.ui.menu.Button(cN,null,null,this.getSyntaxMenu());
var B=new qx.ui.menu.CheckBox(cM);
var A=new qx.ui.menu.CheckBox(df);
var y=new qx.ui.menu.Button(bI);
B.addListener(dr,this.debugCheckBox);
A.addListener(dr,this.debugCheckBox);
y.addListener(ds,this.debugButton);
x.add(z);
x.add(C);
x.addSeparator();
...
var ee=new qx.ui.menu.CheckBox(ct);
var eg=new qx.ui.menu.CheckBox(bv);
var eh=new qx.ui.menu.CheckBox(dH);
var ed=new qx.ui.menu.CheckBox(cl);
var ef=new qx.ui.menu.CheckBox(bN);
var eb=new qx.ui.menu.CheckBox(cX);
ee.setValue(true);
eg.setValue(true);
ed.setValue(true);
ee.addListener(dr,this.debugCheckBox);
eg.addListener(dr,this.debugCheckBox);
eh.addListener(dr,this.debugCheckBox);
ed.addListener(dr,this.debugCheckBox);
ef.addListener(dr,this.debugCheckBox);
eb.addListener(dr,this.debugCheckBox);
ec.add(eg);
ec.add(ee);
ec.addSeparator();
ec.add(eh);
...
ec.add(eb);
return ec;
},getSyntaxMenu:function(){var dR=new qx.ui.menu.Menu;
var dN=new qx.ui.menu.RadioButton(cW);
var dP=new qx.ui.menu.RadioButton(bX);
var dO=new qx.ui.menu.RadioButton(cg);
var dQ=new qx.ui.menu.Button(da,null,null,this.getSyntaxCMenu());
var dU=new qx.ui.menu.RadioButton(dC);
var dS=new qx.ui.menu.RadioButton(dJ);
dR.add(dN);
dR.add(dP);
dR.add(dO);
dR.add(dQ);
dR.add(dU);
dR.add(dS);
var dT=new qx.ui.form.RadioGroup;
dT.add(dN,dP,dO,dU,dS);
dT.add.apply(dT,dQ.getMenu().getChildren());
dT.addListener(dp,this.debugRadio);
return dR;
},getSyntaxCMenu:function(){var dW=new qx.ui.menu.Menu;
var dV=new qx.ui.menu.RadioButton(du);
var ea=new qx.ui.menu.RadioButton(dF);
var dY=new qx.ui.menu.RadioButton(cA);
var dX=new qx.ui.menu.RadioButton(bL);
dW.add(dV);
dW.add(ea);
dW.add(dY);
dW.add(dX);
return dW;
},getFormatMenu:function(){var r=new qx.ui.menu.Menu;
var q=new qx.ui.menu.Button(bK,null,null,this.getParagraphMenu());
var t=new qx.ui.menu.Button(cw);
var u=new qx.ui.menu.Button(dL);
var p=new qx.ui.menu.Button(co);
var s=new qx.ui.menu.Button(cQ);
var o=new qx.ui.menu.Button(bW);
var w=new qx.ui.menu.Button(ca);
var v=new qx.ui.menu.Button(bx);
t.addListener(ds,this.debugButton);
u.addListener(ds,this.debugButton);
p.addListener(ds,this.debugButton);
s.addListener(ds,this.debugButton);
...
r.add(v);
return r;
},getParagraphMenu:function(){var bo=new qx.ui.menu.Menu;
var br=new qx.ui.menu.Button(dB,bw);
var bs=new qx.ui.menu.Button(cc,bS);
var bp=new qx.ui.menu.Button(by,bB);
var bq=new qx.ui.menu.Button(cj,dw);
br.addListener(ds,this.debugButton);
bs.addListener(ds,this.debugButton);
bp.addListener(ds,this.debugButton);
bq.addListener(ds,this.debugButton);
bo.add(br);
bo.add(bs);
bo.add(bp);
bo.add(bq);
...
var Q=new qx.ui.menu.Button(cp,dI);
var S=new qx.ui.menu.Button(dh);
var R=new qx.ui.menu.Button(dy);
var P=new qx.ui.menu.Button(dd);
Q.addListener(ds,this.debugButton);
S.addListener(ds,this.debugButton);
...
O.add(P);
return O;
},getList:function(){var T=new qx.ui.form.List;
T.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){T.add(new qx.ui.form.ListItem(bF+i));
}return T;
},getContextMenu:function(){var eH=new qx.ui.menu.Menu;
var eJ=new qx.ui.menu.Button(dj,dq,this.__LF);
var eK=new qx.ui.menu.Button(dm,dk,this.__LG);
var eI=new qx.ui.menu.Button(dl,dn,this.__LH);
eJ.addListener(ds,this.debugButton);
eK.addListener(ds,this.debugButton);
eI.addListener(ds,this.debugButton);
eH.add(eJ);
eH.add(eK);
eH.add(eI);
return eH;
}},destruct:function(){this._disposeObjects(cP,ck,bT,cv,cU,dv,de,bC);
}});
})();
