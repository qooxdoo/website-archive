...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.treevirtual.TreeVirtual_Events","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.treevirtual.TreeVirtual_Events-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"c36e77d71a37"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var y=new qx.ui.treevirtual.TreeVirtual(l);
y.setColumnWidth(0,400);
y.setAlwaysShowOpenCloseSymbol(true);
this.getRoot().add(y,{edge:30});
var D=y.getDataModel();
var A=D.addBranch(null,b,true);
var C;
D.addBranch(A,a,true);
C=D.addBranch(A,n,true);
D.addLeaf(C,v);
D.addLeaf(C,t);
D.addBranch(A,f,true);
D.addBranch(A,w,true);
var B=D.addBranch(null,c,true);
C=D.addBranch(B,d,false);

for(var i=1;i<3000;i++){D.addLeaf(C,m+i);
}D.addBranch(B,g,false);
D.addBranch(B,w,false);
D.addBranch(B,u,false);
D.addBranch(B,o,false);
D.setData();
var z=1;
y.addListener(r,function(e){alert('treeOpenWithContent ');
var x=e.getData();
D.addLeaf(x.nodeId,z.toString());
z++;
});
y.addListener(k,function(e){alert('treeClose ');
});
y.addListener(q,function(e){alert('treeOpenWhileEmpty');
var E=e.getData();
y.nodeSetHideOpenClose(E,true);
});
y.addListener(h,function(e){var F=j;
var G=e.getData();
