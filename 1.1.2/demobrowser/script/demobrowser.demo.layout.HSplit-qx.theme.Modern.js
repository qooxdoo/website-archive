...
K.setWrap(true);
J.add(K,2);
},addSplitPaneTwoFlexWithOneMin:function(){var A=new qx.ui.splitpane.Pane(p);
A.setWidth(400);
A.setHeight(60);
A.setDecorator(o);
...
B.setWrap(true);
A.add(B,2);
},addSplitPaneTwoFlexWithOneMax:function(){var b=new qx.ui.splitpane.Pane(p);
b.setWidth(400);
b.setHeight(60);
b.setDecorator(o);
...
c.setMaxWidth(100);
b.add(c,2);
},addSplitPaneTwoFlexWithTwoMin:function(){var M=new qx.ui.splitpane.Pane(p);
M.setWidth(400);
M.setHeight(60);
M.setDecorator(o);
...
L.setMinWidth(250);
M.add(L,1);
var N=new qx.ui.form.TextArea(d);
N.setDecorator(null);
N.setWrap(true);
N.setMinWidth(250);
M.add(N,2);
...
H.setMaxWidth(100);
G.add(H,2);
},addSplitPaneOneFlexSimple:function(){var u=new qx.ui.splitpane.Pane(p);
u.setWidth(400);
u.setHeight(60);
u.setDecorator(o);
this.getRoot().add(u,{left:500,top:20});
var t=new qx.ui.form.TextArea(j);
t.setDecorator(null);
t.setWrap(true);
u.add(t,0);
...
y.setWrap(true);
x.add(y);
},addSplitPaneAuto:function(){var r=new qx.ui.splitpane.Pane(p);
r.setDecorator(o);
this.getRoot().add(r,{left:500,top:340});
