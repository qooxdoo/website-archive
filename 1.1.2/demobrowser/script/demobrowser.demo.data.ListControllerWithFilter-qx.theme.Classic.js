...
for(var i=0;i<8;i++){C.push(i);
}var E=new qx.data.Array(C);
var w=new qx.ui.form.List();
this.getRoot().add(w,{left:10,top:80});
var z=new qx.data.controller.List(E,w);
var v={};
v.filter=function(I){return parseInt(I)%2==1;
};
var x={};
x.filter=function(H){return parseInt(H)%2==0;
};
var B=new qx.ui.basic.Label(b);
this.getRoot().add(B,{left:10,top:290});
var F={converter:function(r){if(r==x){return l;
}else if(r==v){return f;
}return p;
}};
z.bind(a,B,e,F);
var y=new qx.ui.form.Button(n);
y.setWidth(120);
this.getRoot().add(y,{left:130,top:80});
y.addListener(q,function(){E.push(E.length);
},this);
var D=new qx.ui.form.Button(m);
D.setWidth(120);
this.getRoot().add(D,{left:130,top:115});
D.addListener(q,function(){E.pop();
},this);
var A=new qx.ui.form.Button(o);
A.setWidth(120);
this.getRoot().add(A,{left:130,top:150});
A.addListener(q,function(){qx.log.appender.Console.show();
this.info(E.toString());
},this);
var t=new qx.ui.form.Button(k);
t.setWidth(120);
this.getRoot().add(t,{left:130,top:185});
t.addListener(q,function(){z.getDelegate()==v?z.setDelegate(x):z.setDelegate(v);
},this);
var s=new qx.ui.form.Button(j);
s.setWidth(120);
this.getRoot().add(s,{left:130,top:220});
s.addListener(q,function(){z.setDelegate(null);
},this);
var G=new qx.ui.form.Button(g);
G.setWidth(120);
this.getRoot().add(G,{left:130,top:255});
G.addListener(q,function(){E.reverse();
},this);
