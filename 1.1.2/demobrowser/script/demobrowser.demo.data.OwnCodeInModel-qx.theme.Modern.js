...
z.setLabelPath(q);
z.setIconOptions({converter:function(u){return r+u+m;
}});
z.setIconPath(k);
var A={getModelMixins:function(c){if(c==i){return demobrowser.demo.data.ItemsMixin;
}}};
var v=l;
...
qx.Mixin.define(d,{members:{sortByType:function(){var t=this.getItems();
t.sort(function(a,b){if(a.getType()>b.getType()){return 1;
