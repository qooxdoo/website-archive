...
(function(){var u="value",t="horizontal",s="first",r="second",q="both",p="main",o="Show first pane",n="demobrowser.demo.widget.SplitPane",m="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",l="Show both panes",d="__LT",k="Toggle Splitpane Orientation",h="Show second pane",c="vertical",b="_container2",g="changeSelection",f="_container1",j="execute";
qx.Class.define(n,{extend:qx.application.Standalone,members:{__LT:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var L=new qx.ui.container.Scroll();
var K=new qx.ui.container.Composite(new qx.ui.layout.Basic());
K.setAllowStretchX(false);
L.add(K);
var R=new qx.ui.splitpane.Pane(t).set({width:450,height:300});
this.__LT=R;
var U=new qx.ui.container.Composite(new qx.ui.layout.Grow).set({width:200,height:100,decorator:p});
var X=new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({padding:10,maxWidth:450,decorator:p});
var O=this.__LU();
var N=new qx.ui.form.Button(k).set({allowGrowX:false,allowGrowY:false});
N.addListener(j,this._toggle,this);
...
var V=new qx.ui.form.RadioButton(o);
var W=new qx.ui.form.RadioButton(h);
...
Q.addListener(g,this._changeVisiblity,this);
K.add(S,{left:490,top:42});
N.focus();
},_toggle:function(){var a=this.__LT.getOrientation();
this.__LT.setOrientation(a==t?c:t);
},_changeVisiblity:function(e){var Y=e.getData()[0].getUserData(u);

if(Y==q){this._container1.show();
this._container2.show();
}else if(Y==s){this._container1.show();
this._container2.exclude();
}else if(Y==r){this._container1.exclude();
this._container2.show();
}},__LU:function(){var E=new qx.ui.tree.Tree();
E.setDecorator(null);
var J=new qx.ui.tree.TreeFolder("/");
J.setOpen(true);
E.setRoot(J);
var H=new qx.ui.tree.TreeFolder("Desktop");
H.setOpen(true);
J.add(H);
var z=new qx.ui.tree.TreeFolder("Files");
var x=new qx.ui.tree.TreeFolder("Workspace");
var y=new qx.ui.tree.TreeFolder("Network");
var w=new qx.ui.tree.TreeFolder("Trash");
H.add(z,x,y,w);
var F=new qx.ui.tree.TreeFile("Windows (C:)");
var v=new qx.ui.tree.TreeFile("Documents (D:)");
x.add(F,v);
var I=new qx.ui.tree.TreeFolder("Inbox");
var A=new qx.ui.tree.TreeFolder("Presets");
var D=new qx.ui.tree.TreeFolder("Sent");
var C=new qx.ui.tree.TreeFolder("Trash");

for(var i=0;i<100;i++){C.add(new qx.ui.tree.TreeFile("Junk #"+i));
}var G=new qx.ui.tree.TreeFolder("Data");
var B=new qx.ui.tree.TreeFolder("Edit");
I.add(A,D,C,G,B);
J.add(I);
return E;
}},destruct:function(){this._disposeObjects(d,f,b);
}});
})();
