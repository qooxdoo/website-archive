...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Label","qx.theme":"qx.theme.Classic"};
...
var y=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
this.getRoot().add(y);
var z=new qx.ui.basic.Label(j).set({decorator:s,width:200});
y.add(z);
this.getRoot().add(this.createConfigureButton(z,e),{left:240,top:20});
var A=new qx.ui.basic.Label(l).set({decorator:s,rich:true});
y.add(A);
this.getRoot().add(this.createConfigureButton(A,g),{left:240,top:60});
var B=new qx.ui.basic.Label(m).set({decorator:s,width:80});
y.add(B);
var C=new qx.ui.basic.Label().set({value:h,decorator:s,rich:true,width:120});
y.add(C);
var D=new qx.ui.basic.Label(a).set({decorator:s,font:new qx.bom.Font(28,[r,q])});
y.add(D);
var E=new qx.ui.basic.Label(n).set({decorator:s,font:new qx.bom.Font(28,[r,q]),width:150});
y.add(E);
},createConfigureButton:function(u,v){var x=new qx.ui.form.Button(v);
var w;
x.addListener(i,function(){if(!w){w=this.createEditDialog(u,v);
}w.open();
},this);
return x;
