...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.HBox_NegativeMargin","qx.theme":"qx.theme.Modern"};
...
(function(){var m="main",l="yellow",k="gray",j="green",i="top",h="bottom",g="middle",f="blue",e="demobrowser.demo.layout.HBox_NegativeMargin";
...
L.add(this.getBox6());
L.add(this.getBox7());
},getBox1:function(){var s=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:m,backgroundColor:l,height:80,allowGrowX:false});
var u=new qx.ui.core.Widget().set({decorator:m,backgroundColor:f,maxHeight:50,alignY:i});
var t=new qx.ui.core.Widget().set({decorator:m,backgroundColor:j,maxHeight:50,alignY:g});
var r=new qx.ui.core.Widget().set({decorator:m,backgroundColor:k,maxHeight:50,alignY:h});
s.add(u);
s.add(t);
s.add(r);
t.setMarginLeft(-10);
r.setMarginLeft(-10);
return s;
},getBox2:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:m,backgroundColor:l,height:80,allowGrowX:false});
var q=new qx.ui.core.Widget().set({decorator:m,backgroundColor:f,maxHeight:50,alignY:i});
var p=new qx.ui.core.Widget().set({decorator:m,backgroundColor:j,maxHeight:50,alignY:g});
var n=new qx.ui.core.Widget().set({decorator:m,backgroundColor:k,maxHeight:50,alignY:h});
o.add(q);
o.add(p);
o.add(n);
p.setMarginLeft(-10);
...
n.setMarginLeft(-10);
return o;
},getBox3:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:m,backgroundColor:l,height:80,width:500,allowGrowX:false});
var d=new qx.ui.core.Widget().set({decorator:m,backgroundColor:f,maxHeight:50,alignY:i});
var c=new qx.ui.core.Widget().set({decorator:m,backgroundColor:j,maxHeight:50,alignY:g});
var a=new qx.ui.core.Widget().set({decorator:m,backgroundColor:k,maxHeight:50,alignY:h});
b.add(d,{flex:1});
b.add(c,{flex:1});
b.add(a,{flex:1});
c.setMarginLeft(-10);
a.setMarginLeft(-10);
return b;
},getBox4:function(){var E=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:m,backgroundColor:l,height:80,width:500,allowGrowX:false});
var G=new qx.ui.core.Widget().set({decorator:m,backgroundColor:f,maxHeight:50,alignY:i});
var F=new qx.ui.core.Widget().set({decorator:m,backgroundColor:j,maxHeight:50,alignY:g});
var D=new qx.ui.core.Widget().set({decorator:m,backgroundColor:k,maxHeight:50,alignY:h});
E.add(G,{flex:1});
E.add(F,{flex:2});
E.add(D,{flex:3});
F.setMarginLeft(-10);
D.setMarginLeft(-10);
return E;
},getBox5:function(){var A=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:m,backgroundColor:l,height:80,width:500,allowGrowX:false});
var C=new qx.ui.core.Widget().set({decorator:m,backgroundColor:f,maxHeight:50,alignY:i});
var B=new qx.ui.core.Widget().set({decorator:m,backgroundColor:j,maxHeight:50,alignY:g});
var z=new qx.ui.core.Widget().set({decorator:m,backgroundColor:k,maxHeight:50,alignY:h});
A.add(C,{flex:1});
A.add(B,{flex:2});
A.add(z,{flex:3});
B.setMarginLeft(-10);
...
z.setWidth(0);
return A;
},getBox6:function(){var w=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:m,backgroundColor:l,height:80,width:200,allowGrowX:false});
var y=new qx.ui.core.Widget().set({decorator:m,backgroundColor:f,maxHeight:50,alignY:i});
var x=new qx.ui.core.Widget().set({decorator:m,backgroundColor:j,maxHeight:50,alignY:g});
var v=new qx.ui.core.Widget().set({decorator:m,backgroundColor:k,maxHeight:50,alignY:h});
w.add(y,{flex:1});
w.add(x,{flex:1});
w.add(v,{flex:1});
x.setMarginLeft(-10);
v.setMarginLeft(-10);
return w;
},getBox7:function(){var I=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:m,backgroundColor:l,height:80,width:200,allowGrowX:false});
var K=new qx.ui.core.Widget().set({decorator:m,backgroundColor:f,maxHeight:50,alignY:i});
var J=new qx.ui.core.Widget().set({decorator:m,backgroundColor:j,maxHeight:50,alignY:g});
var H=new qx.ui.core.Widget().set({decorator:m,backgroundColor:k,maxHeight:50,alignY:h});
I.add(K,{flex:1});
I.add(J,{flex:2});
I.add(H,{flex:3});
J.setMarginLeft(-10);
