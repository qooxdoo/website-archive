...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.ListBinding-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"56da3b3fdcba"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
for(var i=0;i<10000;i++){g.push(b+i);
