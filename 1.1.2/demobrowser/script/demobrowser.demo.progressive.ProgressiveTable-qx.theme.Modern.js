...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.progressive.ProgressiveTable","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.progressive.ProgressiveTable-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"f5eeed36ca4a"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var m="row",l="Last item is intentionally ",k="demobrowser.demo.progressive.ProgressiveTable",j="start",i="</span>",h="Number",g="1*",f="<span style='color:red;'>",e="inserted at the top to show how ",d="it's done",a="end",c="Date",b="Id";
...
var v=0;
var r=function(z){var C=[];
var B=new Date().getTime();
var D=400*24*60*60*1000;

for(var E=0;E<z;E++){var A=new Date(B+Math.random()*D-D/2);
C.push({renderer:m,location:E==z-1?j:a,data:[v++,Math.random()*10000,A]});
}return C;
};
var u=new qx.ui.progressive.renderer.table.Widths(3);
u.setWidth(0,100);
u.setWidth(1,g);
u.setMaxWidth(1,200);
u.setWidth(2,300);
var p=[b,h,c];
var q=new qx.ui.progressive.headfoot.TableHeading(u,p);
var o=new qx.ui.progressive.headfoot.Progress(u,p);
var x=new qx.ui.progressive.structure.Default(q,o);
var n=new qx.ui.progressive.Progressive(x);
var w=new qx.ui.basic.Atom(f+l+e+d+i);
w.setRich(true);
w.setHeight(16);
n.add(w);
var t=new qx.ui.progressive.model.Default();
var s=r(500);
t.addElements(s);
n.setDataModel(t);
var y=new qx.ui.progressive.renderer.table.Row(u);
n.addRenderer(m,y);
n.set({width:500,maxWidth:500});
this.getRoot().add(n,{left:50,top:50,bottom:50});
n.render();
}}});
})();
