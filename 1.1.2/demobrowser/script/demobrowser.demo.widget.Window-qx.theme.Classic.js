...
(function(){var x="changeValue",w="execute",v="icon/16/apps/office-calendar.png",u="right",t="demobrowser.demo.widget.Window",s="Yes",r="Second Window",q="Page 1",p="bottom",o="Use move frame",bn="Show Statusbar",bm="icon/16/actions/dialog-cancel.png",bl="icon/32/status/dialog-error.png",bk="Show Close",bj="icon/32/apps/office-address-book.png",bi="Third Window",bh="icon/22/apps/utilities-calculator.png",bg="Show Maximize",bf="Allow Close",be="Use resize frame",E="No",F="resizable",C="Allow Maximize",D="value",A="The second window",B="Page 3",y="move",z="Resizable ",I="First Window",J="resize",R="Moveable",P="Demo loaded",V="Allow Minimize",T="Resizable",ba="Open Modal Dialog 2",X="Open Modal Dialog 1",L="First Modal Dialog",bd="top",bc="Movable",bb="Show Minimize",K="Basics",N="Modal",O="Do you want to fly to Berlin?",Q="Welcome to your first own Window.<br/>Have fun!",S="Application is ready",U="icon/16/apps/internet-feed-reader.png",W="Second Modal Dialog",Y="icon/16/actions/dialog-ok.png",G="Page 2",H="left",M="icon/16/apps/internet-telephony.png";
...
this.createWindow2();
this.createWindow3();
},createWindow1:function(){var bq=new qx.ui.window.Window(I,v);
bq.setLayout(new qx.ui.layout.VBox(10));
bq.setShowStatusbar(true);
bq.setStatus(P);
bq.open();
this.getRoot().add(bq,{left:20,top:20});
bq.addListener(y,function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
},this);
bq.addListener(J,function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
},this);
var bp=new qx.ui.basic.Atom(Q,bj);
bp.setRich(true);
bq.add(bp);
var bo=new qx.ui.tabview.TabView;
bq.add(bo,{flex:1});
var bt=new qx.ui.tabview.Page(q);
bo.add(bt);
var br=new qx.ui.tabview.Page(G);
bo.add(br);
var bs=new qx.ui.tabview.Page(B);
bo.add(bs);
},createWindow2:function(){var bA=new qx.ui.window.Window(r,U);
bA.setLayout(new qx.ui.layout.VBox(10));
bA.setStatus(S);
bA.open();
this.getRoot().add(bA,{left:350,top:120});
var bJ=new qx.ui.basic.Atom(A,bh);
bA.add(bJ);
var bu=new qx.ui.container.Composite;
bu.setLayout(new qx.ui.layout.HBox(10));
bA.add(bu,{flex:1});
var bC=new qx.ui.groupbox.GroupBox(K);
bC.setLayout(new qx.ui.layout.VBox(4));
bu.add(bC,{flex:1});
var bx=new qx.ui.form.CheckBox(bk);
bx.setValue(true);
bx.addListener(x,function(e){bA.setShowClose(e.getData());
});
bC.add(bx);
var bI=new qx.ui.form.CheckBox(bg);
bI.setValue(true);
bI.addListener(x,function(e){bA.setShowMaximize(e.getData());
});
bC.add(bI);
var bB=new qx.ui.form.CheckBox(bb);
bB.setValue(true);
bB.addListener(x,function(e){bA.setShowMinimize(e.getData());
});
bC.add(bB);
var bE=new qx.ui.form.CheckBox(bf);
bE.setValue(true);
bE.addListener(x,function(e){bA.setAllowClose(e.getData());
});
bC.add(bE);
var bK=new qx.ui.form.CheckBox(C);
bK.setValue(true);
bK.addListener(x,function(e){bA.setAllowMaximize(e.getData());
});
bC.add(bK);
var bz=new qx.ui.form.CheckBox(V);
bz.setValue(true);
bz.addListener(x,function(e){bA.setAllowMinimize(e.getData());
});
bC.add(bz);
var bv=new qx.ui.form.CheckBox(bn);
bv.setValue(false);
bv.addListener(x,function(e){bA.setShowStatusbar(e.getData());
});
bC.add(bv);
var bM=new qx.ui.groupbox.GroupBox(T);
bM.setLayout(new qx.ui.layout.VBox(4));
bu.add(bM,{flex:1});
var bG=new qx.ui.form.CheckBox(be);
bG.setValue(true);
bG.addListener(x,function(e){bA.setUseResizeFrame(e.getData());
});
bM.add(bG);
var bH=[bd,u,p,H];

for(var i=0;i<bH.length;i++){var bF=bH[i];
var by=new qx.ui.form.CheckBox(z+bF).set({value:true});
by.bind(D,bA,F+qx.lang.String.firstUp(bF));
bM.add(by);
}var bw=new qx.ui.groupbox.GroupBox(R);
bw.setLayout(new qx.ui.layout.VBox(4));
bu.add(bw,{flex:1});
var bD=new qx.ui.form.CheckBox(bc);
bD.setValue(true);
bD.addListener(x,function(e){bA.setMovable(e.getData());
});
bw.add(bD);
var bL=new qx.ui.form.CheckBox(o);
bL.addListener(x,function(e){bA.setUseMoveFrame(e.getData());
});
bw.add(bL);
},createWindow3:function(){var a=new qx.ui.window.Window(bi,M);
...
var c=new qx.ui.form.Button(X,v);
c.addListener(w,b.open,b);
a.add(c);
},getModalWindow1:function(){var f=new qx.ui.window.Window(L);
f.setLayout(new qx.ui.layout.VBox(10));
f.setModal(true);
f.moveTo(150,150);
this.getRoot().add(f);
var d=this.getModalWindow2();
var h=new qx.ui.form.Button(ba,v);
h.addListener(w,d.open,d);
f.add(h);
var g=new qx.ui.form.CheckBox(N);
g.setValue(true);
f.add(g);
g.addListener(x,function(e){f.setModal(e.getData());
});
return f;
},getModalWindow2:function(){var k=new qx.ui.window.Window(W);
k.setLayout(new qx.ui.layout.VBox(10));
k.setModal(true);
k.setShowClose(false);
k.moveTo(300,300);
this.getRoot().add(k);
var j=new qx.ui.basic.Atom(O,bl);
k.add(j);
var m=new qx.ui.container.Composite;
m.setLayout(new qx.ui.layout.HBox(10,u));
k.add(m);
var n=new qx.ui.form.Button(s,Y);
n.addListener(w,function(e){k.close();
});
m.add(n);
var l=new qx.ui.form.Button(E,bm);
l.addListener(w,function(e){alert("Sorry, please click 'Yes'!");
});
m.add(l);
return k;
}}});
