...
g.add(this.getBox5());
g.add(this.getBox6());
},getBox1:function(){var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:500,allowGrowX:false});
...
y.add(x,{flex:1});
return y;
},getBox2:function(){var i=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:500,allowGrowX:false});
...
i.add(k,{width:d});
i.add(j,{width:d});
i.add(h,{width:d,flex:1});
return i;
},getBox3:function(){var u=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,allowGrowX:false});
...
u.add(t,{flex:1});
return u;
},getBox4:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,allowGrowX:false});
...
m.add(o,{width:d,flex:1});
m.add(n,{width:d,flex:1});
m.add(l,{width:d,flex:1});
return m;
},getBox5:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:200,allowGrowX:false});
...
q.add(s,{width:d,flex:1});
q.add(r,{width:d,flex:1});
q.add(p,{width:d,flex:1});
return q;
