...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.VBox_Percent","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.VBox_Percent-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"8ecb2df13b9e"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
K.add(this.getBox5());
K.add(this.getBox6());
},getBox1:function(){var l=new qx.ui.layout.VBox();
var n=new qx.ui.container.Composite(l).set({decorator:f,backgroundColor:c,height:300,allowGrowY:false});
l.setSpacing(5);
...
var m=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
n.add(p,{height:b});
n.add(o,{flex:1});
n.add(m,{flex:1});
return n;
...
return i;
},getBox3:function(){var v=new qx.ui.layout.VBox();
var x=new qx.ui.container.Composite(v).set({decorator:f,backgroundColor:c,allowGrowY:false});
v.setSpacing(5);
var z=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var y=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
...
var C=new qx.ui.container.Composite(A).set({decorator:f,backgroundColor:c,allowGrowY:false});
A.setSpacing(5);
...
C.add(E,{height:d,flex:1});
C.add(D,{height:d,flex:1});
C.add(B,{height:d,flex:1});
return C;
},getBox5:function(){var F=new qx.ui.layout.VBox();
var H=new qx.ui.container.Composite(F).set({decorator:f,backgroundColor:c,height:100,allowGrowY:false});
F.setSpacing(5);
var J=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var I=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var G=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
H.add(J,{height:d,flex:1});
H.add(I,{height:d,flex:1});
H.add(G,{height:d,flex:1});
return H;
},getBox6:function(){var q=new qx.ui.layout.VBox();
var s=new qx.ui.container.Composite(q).set({decorator:f,backgroundColor:c,height:300,allowGrowY:false});
q.setSpacing(5);
...
s.add(u,{height:d,flex:1});
s.add(t,{height:d,flex:1});
s.add(r,{height:d,flex:1});
return s;
}}});
})();
