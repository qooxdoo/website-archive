...
(function(){var n="",m="cat",l="Juhu",k="mouse",j="dog",i="execute",h="rat",g="demobrowser.demo.test.Table_CellEditor",f="Add/Remove editor",e="Get value",c="_container",d="boolean";
...
},_addEditor:function(A,B){B=qx.lang.Object.clone(B);
var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
var G=A.createCellEditor(B);
var H=new qx.ui.container.Composite().set({width:200,height:20});
G.setUserBounds(0,0,200,20);
H.add(G);
C.add(H);
var E=new qx.ui.form.Button(e);
C.add(E);
E.addListener(i,function(){F.setValue(A.getCellEditorValue(G)+n);
});
var D=new qx.ui.form.Button(f);
C.add(D);
D.addListener(i,function(){G.destroy();
qx.ui.core.queue.Manager.flush();
G=A.createCellEditor(B);
G.setUserBounds(0,0,200,20);
H.add(G);
qx.ui.core.queue.Manager.flush();
});
var F=new qx.ui.basic.Label(n);
C.add(F);
this._container.add(C);
E.execute();
},testCheckBoxEditor:function(){var I={value:[true,false]};
qx.util.Permutation.permute(I,function(J){this._addEditor(new qx.ui.table.celleditor.CheckBox(),J);
},this);
},testComboBoxEditor:function(){var a={value:[n,m,h,2],table:[this.getTableMock()]};
var b=new qx.ui.table.celleditor.ComboBox();
b.setListData([j,m,k]);
qx.util.Permutation.permute(a,function(o){this._addEditor(b,o);
},this);
},testSelectBoxEditor:function(){var y={value:[n,m],table:[this.getTableMock()]};
var z=new qx.ui.table.celleditor.SelectBox();
z.setListData([j,m,k]);
qx.util.Permutation.permute(y,function(w){this._addEditor(z,w);
},this);
},testPasswordEditor:function(){var p={value:[null,10,l]};
qx.util.Permutation.permute(p,function(x){this._addEditor(new qx.ui.table.celleditor.PasswordField(),x);
},this);
},testTextfieldEditor:function(){var s={value:[null,10,l]};
qx.util.Permutation.permute(s,function(t){this._addEditor(new qx.ui.table.celleditor.TextField(),t);
},this);
},testTextfieldEditorDynamic:function(){var q={value:[true,l]};
var r=new qx.ui.table.celleditor.Dynamic();
r.setCellEditorFactoryFunction(function(v){if(typeof v.value==d){return new qx.ui.table.celleditor.CheckBox();
}else{return new qx.ui.table.celleditor.TextField();
}});
qx.util.Permutation.permute(q,function(u){this._addEditor(r,u);
},this);
