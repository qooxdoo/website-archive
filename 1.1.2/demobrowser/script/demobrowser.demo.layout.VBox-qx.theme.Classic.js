...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.VBox-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"819ad12cac45"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var B=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(B);
B.add(this.getBox1());
B.add(this.getBox2());
B.add(this.getBox3());
...
B.add(this.getBox6());
B.add(this.getBox7());
},getBox1:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,allowGrowY:false});
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return j;
},getBox2:function(){var A=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,minWidth:60,allowGrowY:false});
A.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:b}));
A.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:c}));
A.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:a}));
return A;
},getBox3:function(){var k=new qx.ui.layout.VBox();
var l=new qx.ui.container.Composite(k).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
k.setSpacing(5);
k.setAlignY(e);
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return l;
},getBox4:function(){var C=new qx.ui.layout.VBox();
var D=new qx.ui.container.Composite(C).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
C.setSpacing(5);
C.setAlignY(f);
D.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
D.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
D.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return D;
},getBox5:function(){var n=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,allowGrowY:false});
var p=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
var o=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10,marginTop:20});
var m=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
n.add(p);
n.add(o);
n.add(m);
return n;
},getBox6:function(){var q=new qx.ui.layout.VBox();
var s=new qx.ui.container.Composite(q).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
q.setSpacing(5);
q.setAlignY(e);
var u=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
var t=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10,marginTop:20});
var r=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
s.add(u);
s.add(t);
s.add(r);
return s;
},getBox7:function(){var v=new qx.ui.layout.VBox();
var x=new qx.ui.container.Composite(v).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
v.setSpacing(5);
v.setAlignY(f);
var z=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
var y=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10,marginTop:20});
var w=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
x.add(z);
x.add(y);
x.add(w);
return x;
