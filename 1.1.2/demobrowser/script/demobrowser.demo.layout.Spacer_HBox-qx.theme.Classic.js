...
var j=this.getRoot();
j.add(this.getSpacerWithoutFlex(),{left:10,top:10});
j.add(this.getSpacerWithFlex(),{left:10,top:70});
j.add(this.getAddRemoveSpacer(),{left:10,top:200});
},getSpacerWithoutFlex:function(){var h=new qx.ui.container.Composite().set({decorator:g,backgroundColor:e,allowGrowX:false});
var i=new qx.ui.layout.HBox();
i.setSpacing(5);
h.setLayout(i);
h.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}));
h.add(new qx.ui.core.Spacer(30,40));
h.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}));
h.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}));
return h;
