...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.SearchAsYouType","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.SearchAsYouType-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"a0dc4ab47ada"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
this.__MD=e;
this.filter=qx.lang.Function.bind(function(i){return i.search(this.getSearchString())!=-1;
},this);
this.__ME=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__ME:null,__MD:null,_applySearchString:function(f,g){var h=qx.util.TimerManager.getInstance();
if(this.__ME!=null){h.stop(this.__ME);
this.__ME=null;
}this.__ME=h.start(function(){this.__MD.update();
this.__ME=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__MD=null;
}});
})();
