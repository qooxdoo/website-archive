...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Button","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Button-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"f8bc738e5756"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var s="0",r="white",q="main",p="execute",o="Button A",n="#AAA",m="icon/22/actions/list-add.png",l="Button B",k="demobrowser.demo.widget.Button",j="icon/22/apps/internet-web-browser.png",g="Hover",i="icon/22/apps/media-video-player.png",h="icon/22/apps/internet-mail.png",f="changeValue",d="Toggle Button";
...
v.setPadding(20);
this.getRoot().add(v,{left:0,top:0});
this.addNormalButtons(v);
this.addToggleButton(v);
this.addRepeatButton(v);
this.addHoverButton(v);
},addNormalButtons:function(C){var D=new qx.ui.form.Button(o,i);
C.add(D);
var E=new qx.ui.form.Button(l,h);
E.setEnabled(false);
C.add(E);
},addToggleButton:function(z){var A=new qx.ui.form.ToggleButton(d,j);
A.focus();
z.add(A);
A.addListener(f,function(e){this.debug("Checked: "+e.getData());
},this);
},addRepeatButton:function(a){var b=new qx.ui.form.RepeatButton(null,m);
a.add(b);
var c=new qx.ui.basic.Label(s);
c.setDecorator(q);
c.setPadding(2,4);
c.setBackgroundColor(r);
a.add(c);
b.addListener(p,function(){var B=parseInt(c.getValue())+1;
c.setValue(B.toString());
});
},addHoverButton:function(w){var x=new qx.ui.form.HoverButton(g).set({padding:10,backgroundColor:n});
w.add(x);
var y=new qx.ui.basic.Label(s);
y.setDecorator(q);
y.setPadding(2,4);
y.setBackgroundColor(r);
w.add(y);
x.addListener(p,function(){var t=parseInt(y.getValue())+1;
y.setValue(t.toString());
});
}}});
})();
