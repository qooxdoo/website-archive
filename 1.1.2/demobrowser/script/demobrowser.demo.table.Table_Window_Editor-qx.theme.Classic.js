...
t.moveTo(300,250);
t.addListener(c,function(e){t.__Mw.focus();
t.__Mw.setTextSelection(0,t.__Mw.getValue().length);
});
t.__Mw=new qx.ui.form.TextField(q.value+j).set({allowGrowY:true});
t.add(t.__Mw);
...
return t;
},getCellEditorValue:function(B){return parseFloat(B.__Mw.getValue());
}}});
})();
