...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_CellEditor","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellEditor-qx.theme.Modern.8d3cf8362058.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__MJ={};}
,properties:{cellEditorFactoryFunction:{check:d,nullable:true,init:null}},members:{__py:null,__MJ:null,createCellEditor:function(f){var g=this.getCellEditorFactoryFunction();if(qx.core.Environment.get(a)){this.assertFunction(g,b);}
;this.__py=g(f);var h=this.__py.createCellEditor(f);this.__MJ[h.toHashCode()]=f;return h;}
...
;var j=this.__MJ[i.toHashCode()];this.__py=k(j);var l=this.__py.getCellEditorValue(i);return l;}
