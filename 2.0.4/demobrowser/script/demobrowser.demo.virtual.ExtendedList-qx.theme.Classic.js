...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.ExtendedList","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.ExtendedList-qx.theme.Classic.d25c9bc9704d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="Karl",s="name",r="<b>Displaying Checkboxes in a list</b><br/>",q="Write data to log",p="Jakob",o="Online <> Offline",n="This list display a set of persons in a list as checkbox. Every ",m="Jack",l="Dustin",k="Jim",d="Max",j="person does have a name as label and an online status as checkbox.",g="label",c="Dan",b="Tim",f="demobrowser.demo.virtual.ExtendedList",e="value",h="execute",a="online";qx.Class.define(f,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var A=[d,p,b,m,c,l,t,k];var C=[];for(var i=0;i<20;i++){var y=new demobrowser.demo.data.model.Person();y.setName(A[i%A.length]);y.setOnline(i%3==0);C.push(y);}
;var B=new qx.data.Array(C);var w=new qx.ui.list.List();w.setWidth(150);this.getRoot().add(w,{left:10,top:80});var v={configureItem:function(D){D.setPadding(3);}
,createItem:function(){return new qx.ui.form.CheckBox();}
,bindItem:function(E,F,G){E.bindProperty(s,g,null,F,G);E.bindProperty(a,e,null,F,G);E.bindPropertyReverse(a,e,null,F,G);}
};w.setDelegate(v);w.setModel(B);var u=new qx.ui.form.Button(o);u.setWidth(120);this.getRoot().add(u,{left:180,top:80});u.addListener(h,function(){for(var i=0;i<B.length;i++){B.getItem(i).toggleOnline();}
;}
,this);var z=new qx.ui.form.Button(q);z.setWidth(120);this.getRoot().add(z,{left:180,top:115});z.addListener(h,function(){qx.log.appender.Console.show();this.info(B.toString());}
,this);var x=new qx.ui.basic.Label();x.setRich(true);x.setWidth(410);x.setSelectable(true);x.setValue(r+n+j);this.getRoot().add(x,{left:10,top:10});}
}});}
)();
