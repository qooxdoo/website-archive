...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.Form","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Form-qx.theme.Classic.e7aebdfdab0b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="modelSelection[0]",i="Registration",h="male",g="Name:",f="X",e="execute",d="demobrowser.demo.data.Form",c="gender",b="-please select-",a="ok",v="middle",u="F",t="Send",s="You are sending: ",r="name",q="M",p="female",o="left",n="Ok:",m="x",k="Gender:",l="value";qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.groupbox.GroupBox(i);J.setWidth(200);this.getRoot().add(J,{left:10,top:10});var G=new qx.ui.layout.Grid();G.setSpacing(5);G.setColumnAlign(0,o,v);J.setLayout(G);var w=new qx.ui.basic.Label(g);J.add(w,{row:0,column:0});var z=new qx.ui.form.TextField();J.add(z,{row:0,column:1});var M=new qx.ui.basic.Label(k);J.add(M,{row:1,column:0});var H=new qx.ui.form.SelectBox();var I=new qx.ui.form.ListItem(b,null,f);H.add(I);var E=new qx.ui.form.ListItem(h,null,q);H.add(E);var C=new qx.ui.form.ListItem(p,null,u);H.add(C);J.add(H,{row:1,column:1});var O=new qx.ui.basic.Label(n);J.add(O,{row:2,column:0});var L=new qx.ui.form.CheckBox();J.add(L,{row:2,column:1});var D=new qx.ui.form.Button(t);J.add(D,{row:3,column:0});var y={name:null,gender:null,ok:0,hidden:m};var K=qx.data.marshal.Json.createModel(y);var B=new qx.data.controller.Object(K);B.addTarget(z,l,r,true);B.addTarget(H,j,c,true);var x={converter:function(P){return P===1;}
};var A={converter:function(Q){return Q?1:0;}
};B.addTarget(L,l,a,true,x,A);z.setRequired(true);L.setRequired(true);var N=new qx.ui.form.validation.Manager();z.setRequired(true);N.add(z);N.add(L);N.setValidator(function(R){var S=H.getSelection()[0]!==I;H.setValid(S);return S;}
);var F=function(T){if(T instanceof qx.ui.form.ListItem){return T.getLabel();}
;}
;D.addListener(e,function(){if(N.validate()){alert(s+qx.util.Serializer.toUriParameter(K,F));}
;}
,this);}
}});}
)();
