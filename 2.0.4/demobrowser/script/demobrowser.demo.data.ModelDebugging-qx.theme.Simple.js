...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.ModelDebugging","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ModelDebugging-qx.theme.Simple.3646c2db8b09.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="qx.bom.request.Jsonp",l="callback",k="open",j="dispose",i="qx.debug",h="_onNativeLoad",g="Expecting JavaScript response to call: ",f="].callback",e=" already exists",d="Callback ",a="qx.bom.request.Jsonp[",c="",b="qx.debug.io";qx.Bootstrap.define(m,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__tX();}
,members:{responseJson:null,__bV:null,__tR:null,__tS:null,__tT:null,__tU:null,__tt:null,__tV:c,open:function(n,o){if(this.__tt){return;}
;var p={},r,q,s=this;this.responseJson=null;this.__tT=false;r=this.__tR||l;q=this.__tS||this.__tV+a+this.__bV+f;if(!this.__tS){this.constructor[this.__bV]=this;}
else {if(!window[this.__tS]){this.__tU=true;window[this.__tS]=function(t){s.callback(t);}
;}
else {if(qx.core.Environment.get(b)){qx.Bootstrap.debug(qx.bom.request.Jsonp,d+this.__tS+e);}
;}
;}
;if(qx.core.Environment.get(b)){qx.Bootstrap.debug(qx.bom.request.Jsonp,g+q);}
;p[r]=q;o=qx.util.Uri.appendParamsToUrl(o,p);this.__fM(k,[n,o]);}
,callback:function(u){if(this.__tt){return;}
;this.__tT=true;if(qx.core.Environment.get(i)){u=qx.lang.Json.stringify(u);u=qx.lang.Json.parse(u);}
;this.responseJson=u;this.constructor[this.__bV]=undefined;this.__tW();}
,setCallbackParam:function(v){this.__tR=v;return this;}
,setCallbackName:function(name){this.__tS=name;return this;}
,setPrefix:function(w){this.__tV=w;}
,dispose:function(){this.__tW();this.__fM(j);}
,_onNativeLoad:function(){this.status=this.__tT?200:500;this.__fM(h);}
,__tW:function(){if(this.__tU&&window[this.__tS]){window[this.__tS]=undefined;this.__tU=false;}
;}
,__fM:function(x,y){qx.bom.request.Script.prototype[x].apply(this,y||[]);}
,__tX:function(){this.__bV=(new Date().valueOf())+(c+Math.random()).substring(2,5);}
}});}
)();
...
(function(){var m="debugModel function in qx.dev.Debug.",l="objects with properties. To see the properties, you can use the ",k="demobrowser.demo.data.ModelDebugging",j="wittemann",i="loaded",h="Every model created by the data stores consists only of qooxdoo ",g="demobrowser.demo.data.store.Twitter",f="<b>Debugging models</b><br/>",e="white",d="main",a="http://twitter.com/statuses/user_timeline/",c=".json",b="auto";qx.Class.define(k,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var p=new demobrowser.demo.data.store.Twitter(j);var n=new qx.ui.embed.Html();n.setBackgroundColor(e);n.setDecorator(d);n.setWidth(500);n.setHeight(200);n.setOverflow(b,b);this.getRoot().add(n,{left:10,top:110});p.addListener(i,function(){var q=p.getModel();this.debug(qx.dev.Debug.debugProperties(q));n.setHtml(qx.dev.Debug.debugProperties(q,10,true));}
,this);var o=new qx.ui.basic.Label();o.setRich(true);o.setWidth(500);o.setValue(f+h+l+m);this.getRoot().add(o,{left:10,top:10});}
}});qx.Class.define(g,{extend:qx.data.store.Jsonp,construct:function(r){var s=a+r+c;qx.data.store.Jsonp.call(this,s);}
});}
)();
...
;return br;}
;;return C;}
,startDisposeProfiling:qx.core.Environment.select(y,{"true":function(){this.disposeProfilingActive=true;this.__Qb=qx.core.ObjectRegistry.getNextHash();}
,"default":qx.lang.Function.empty}),stopDisposeProfiling:qx.core.Environment.select(y,{"true":function(bt){if(!this.__Qb){qx.log.Logger.error(K+this.classname+E);return [];}
;this.disposeProfilingActive=false;var bv=[];while(!qx.ui.core.queue.Dispose.isEmpty()){qx.ui.core.queue.Dispose.flush();}
;var bw=qx.core.ObjectRegistry.getNextHash();var by=qx.core.ObjectRegistry.getPostId();var bz=qx.core.ObjectRegistry.getStackTraces();for(var bu=this.__Qb;bu<bw;bu++){var bx=qx.core.ObjectRegistry.fromHashCode(bu+by);if(bx&&bx.isDisposed&&!bx.isDisposed()){if(bt&&typeof bt==g&&!bt(bx)){continue;}
