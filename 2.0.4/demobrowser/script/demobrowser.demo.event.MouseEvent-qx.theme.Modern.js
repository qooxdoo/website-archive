...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent-qx.theme.Modern.b0c1167ef335.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="mousedown",k="mouseout",j="demobrowser.demo.event.MouseEvent",h="clientX",g="dblclick",f="relatedTarget",d="button",c="capture",b="mousemove",a="pageY",C="screenX",B="logger",A="",z="_",y="mouseover",x="check_",w="click",v="Event",u="Target",t="clientY",r="mouseup",s="losecapture",p="contextmenu",q="screenY",n="pageX",o="mouse",m="change";qx.Class.define(j,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this._initLogger([u,v,d,n,a,h,t,C,q,f],document.getElementById(B),50);var D=document.getElementById(o);var F=[l,r,w,g,p,b,y,k];for(var i=0;i<F.length;i++){var G=document.getElementById(x+F[i]);if(G.checked){qx.bom.Element.addListener(D,F[i],this.logMouseEvent,this);}
;qx.bom.Element.addListener(G,m,this.__Qn,this);}
;var E=document.getElementById(c);E.checked=false;qx.bom.Element.addListener(E,m,function(e){var H=e.getTarget().checked;if(H){qx.bom.Element.capture(D);}
else {qx.bom.Element.releaseCapture(D);}
;}
,this);qx.bom.Element.addListener(D,s,function(e){E.checked=false;}
,this);}
,__Qn:function(e){var K=e.getTarget().id.split(z)[1];var I=e.getTarget().checked;var J=document.getElementById(o);if(I){qx.bom.Element.addListener(J,K,this.logMouseEvent,this);}
else {qx.bom.Element.removeListener(J,K,this.logMouseEvent,this);}
;}
,logMouseEvent:function(L){L.preventDefault();this._log([L.getTarget().id,L.getType(),L.getButton(),L.getDocumentLeft(),L.getDocumentTop(),L.getScreenLeft(),L.getScreenTop(),L.getViewportLeft(),L.getViewportTop(),L.getRelatedTarget()?L.getRelatedTarget().id:A]);}
}});}
)();
