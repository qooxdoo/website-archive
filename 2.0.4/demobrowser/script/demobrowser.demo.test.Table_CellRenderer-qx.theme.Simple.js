...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_CellRenderer","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellRenderer-qx.theme.Simple.cc6034f7277f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,__LA:function(Q,top,R,S,T){var U=["<div style='position:absolute;height:20px;width:",R,"px;top:",top,"px'>"];S.createDataCellHtml(T,U);U.push("</div>");Q.innerHTML+=U.join("");}
,testDefaultRenderer:function(V){var W=100;var Y={value:[null,D,32,new Date()],styleLeft:[0],styleWidth:[W],styleHeight:[20],style:[C]};var X=this._getNewTableDiv(W);var top=0;qx.util.Permutation.permute(Y,function(ba){this.__LA(X,top,W,V,ba);top+=20;}
,this);}
,testBooleanRenderer:function(){var be=70;var bd=30;var bf=new qx.ui.table.cellrenderer.Boolean();var bb={value:[null,true,false],styleLeft:[0],styleWidth:[be],styleHeight:[bd],style:[C]};var bc=this._getNewTableDiv(be);var top=0;qx.util.Permutation.permute(bb,function(bg){this.__LA(bc,top,be,bf,bg);top+=bd;}
,this);bf.setIconFalse(l);bf.setIconTrue(m);qx.util.Permutation.permute(bb,function(bh){this.__LA(bc,top,be,bf,bh);top+=bd;}
,this);}
,testDateRenderer:function(){var bl=180;var bm=new qx.ui.table.cellrenderer.Date();var bo={value:new Date(),styleLeft:[0],styleWidth:[bl],styleHeight:[20],style:[C]};var bk=qx.util.format.DateFormat;var bn=[bk.getDateTimeInstance(),bk.getDateInstance()];var bi=this._getNewTableDiv(bl);var top=0;for(var i=0;i<bn.length;i++){var bj=bn[i];bm.setDateFormat(bj);this.__LA(bi,top,bl,bm,bo);top+=20;}
;}
,testNumberRenderer:function(){var bt=new qx.ui.table.cellrenderer.Number();var bs=100;var bv={value:Math.PI,styleLeft:[0],styleWidth:[bs],styleHeight:[20],style:[C]};var br=qx.util.format.NumberFormat;var bu=[new br().set({maximumFractionDigits:0}),new br().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:e})];var bp=this._getNewTableDiv(bs);var top=0;for(var i=0;i<bu.length;i++){var bq=bu[i];bt.setNumberFormat(bq);this.__LA(bp,top,bs,bt,bv);top+=20;}
;}
,testImageRenderer:function(){var by=new qx.ui.table.cellrenderer.Image();var bw=50;var bz={value:[null,y,r,K,h,f],styleLeft:[0],styleWidth:[bw],styleHeight:[20],style:[C],tooltip:[C,n]};var bx=this._getNewTableDiv(bw);var top=0;qx.util.Permutation.permute(bz,function(bA){this.__LA(bx,top,bw,by,bA);top+=20;}
,this);}
,testStringRenderer:function(){var bF=new qx.ui.table.cellrenderer.String();var bE=100;var bD=20;var bB={value:[null,z,B],styleLeft:[0],styleWidth:[bE],styleHeight:[bD],style:[C]};var bC=this._getNewTableDiv(bE);var top=0;qx.util.Permutation.permute(bB,function(bG){this.__LA(bC,top,bE,bF,bG);top+=20;}
,this);}
,testPasswordRenderer:function(){var bL=new qx.ui.table.cellrenderer.Password();var bK=100;var bJ=20;var bH={value:[null,z,B],styleLeft:[0],styleWidth:[bK],styleHeight:[bJ],style:[C]};var bI=this._getNewTableDiv(bK);var top=0;qx.util.Permutation.permute(bH,function(bM){this.__LA(bI,top,bK,bL,bM);top+=20;}
,this);}
,testHtmlRenderer:function(){var bR=new qx.ui.table.cellrenderer.Html();var bQ=100;var bP=50;var bN={value:[null,E,H,a],styleLeft:[0],styleWidth:[bQ],styleHeight:[bP],style:[C]};var bO=this._getNewTableDiv(bQ);var top=0;qx.util.Permutation.permute(bN,function(bS){this.__LA(bO,top,bQ,bR,bS);top+=20;}
,this);}
,testConditionalRenderer:function(){var bX=new qx.ui.table.cellrenderer.Conditional();bX.addNumericCondition(M,0,null,o,null,null);bX.addNumericCondition(u,100,t,null,null,null);bX.addBetweenCondition(N,0,2,null,null,null,v,null);bX.addRegex(G,null,null,v,c);var bW=100;var bV=20;var bT={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[bW],table:[this.tableMock],styleHeight:[bV],style:[C]};var bU=this._getNewTableDiv(bW);var top=0;qx.util.Permutation.permute(bT,function(bY){this.__LA(bU,top,bW,bX,bY);top+=20;}
,this);}
...
);var cd=100;var cc=20;var ca={value:[null,D,new Date(),30,y,false],styleLeft:[0],styleWidth:[cd],styleHeight:[cc],table:[this.tableMock],style:[C]};var cb=this._getNewTableDiv(cd);var top=0;qx.util.Permutation.permute(ca,function(ci){this.__LA(cb,top,cd,ce,ci);top+=20;}
,this);}
,testReplaceRenderer:function(){var cn=new qx.ui.table.cellrenderer.Replace();cn.setReplaceMap({'1':x,'2':L,'3':j});cn.addReversedReplaceMap();var cm=100;var cl=20;var cj={value:[1,2,3],styleLeft:[0],styleWidth:[cm],table:[this.tableMock],styleHeight:[cl],style:[C]};var ck=this._getNewTableDiv(cm);var top=0;qx.util.Permutation.permute(cj,function(co){this.__LA(ck,top,cm,cn,co);top+=20;}
,this);}
...
(function(){var b="qx.ui.table.cellrenderer.Image",a="";qx.Class.define(b,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(c,d){qx.ui.table.cellrenderer.AbstractImage.call(this);if(c){this.__qt=c;}
;if(d){this.__qu=d;}
;this.__qv=qx.util.AliasManager.getInstance();}
,members:{__qv:null,__qu:16,__qt:16,_identifyImage:function(e){var f={imageWidth:this.__qt,imageHeight:this.__qu};if(e.value==a){f.url=null;}
else {f.url=this.__qv.resolve(e.value);}
