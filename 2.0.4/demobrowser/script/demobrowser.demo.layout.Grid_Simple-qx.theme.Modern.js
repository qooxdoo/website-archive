...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Grid_Simple-qx.theme.Modern.20b361ae84e7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="click me",j="click",i="center",h="top",g="middle",f="right",d="demobrowser.demo.layout.Grid_Simple",c="yellow",b="green",a="main";qx.Class.define(d,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(l);l.add(this.getGrid1());l.add(this.getGrid2());l.add(this.getGrid3());}
,getGrid1:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,20)).set({decorator:a,backgroundColor:c,allowGrowX:false,allowGrowY:false});m.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:0,column:0});m.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:0,column:1});m.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:1,column:0});m.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:1,column:1});return m;}
,getGrid2:function(){var p=new qx.ui.layout.Grid();p.setColumnAlign(1,i,h);p.setColumnAlign(0,f,g);p.setSpacing(5);var o=new qx.ui.container.Composite(p).set({decorator:a,backgroundColor:c,allowGrowX:false});o.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,width:150}),{row:0,column:0});var n=new qx.ui.basic.Label(k).set({decorator:a,backgroundColor:b,allowGrowX:false,width:50,height:50});o.add(n,{row:0,column:1});o.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:60,allowGrowX:false}),{row:1,column:0});o.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,height:80}),{row:1,column:1});o.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:2,column:0});o.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:2,column:1});var q=10;n.addListener(j,function(e){n.setWidth(50+q);q=-q;}
);return o;}
,getGrid3:function(){var s=new qx.ui.container.Composite().set({decorator:a,backgroundColor:c,width:400,height:300,allowShrinkX:false,allowShrinkY:false});var r=new qx.ui.layout.Grid();r.setColumnFlex(1,2);r.setRowFlex(1,3);r.setSpacing(5);s.setLayout(r);s.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:0,column:0});s.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:0,column:1});s.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:1,column:0});s.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:1,column:1});return s;}
}});}
)();
