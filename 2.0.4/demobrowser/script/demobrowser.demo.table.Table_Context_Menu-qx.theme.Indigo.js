...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Context_Menu-qx.theme.Indigo.da771fd99688.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var k=this.__Nc[l];var i=this.getTableModel();g=new qx.ui.menu.Menu();g.addListener(f,function(e){e.preventDefault();}
...
,this);this.__Nb=[];this.__Nc=[];}
,members:{__Nb:null,__Nc:null,setContextMenuHandler:function(m,n,o){this.__Nb[m]=n;this.__Nc[m]=o||this;}
,getContextMenuHandler:function(p){return this.__Nb[p];}
},destruct:function(){this.__Nb=null;this.__Nc=null;}
});}
)();
