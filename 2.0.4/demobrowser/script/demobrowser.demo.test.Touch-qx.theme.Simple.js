...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Touch","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Touch-qx.theme.Simple.ba9a9d59c3b0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;bc.add(this.__Rd(10,10,O,M));bc.add(this.__Rd(110,10,K,k));this.__Rb=this.__Re(10,110);bc.add(this.__Rb);this.__Rc=this.__Re(110,110);bc.add(this.__Rc);bc.add(this.__Rf(210,10));}
,__Rd:function(x,y,be,bf){var bg={"position":H,"left":x+L,"top":y+L,"width":D,"height":D,"backgroundColor":be,"fontFamily":B,"fontSize":A};var bh=new qx.html.Element(J,bg,{"id":bf});bh.setAttribute(F,z+bf+u);bh.addListener(Q,this.__Rg,this);bh.addListener(l,this.__Rg,this);bh.addListener(U,this.__Rg,this);bh.addListener(C,this.__Rg,this);return bh;}
,__Re:function(x,y){var bi={"position":H,"left":x+L,"top":y+L,"width":D,"fontFamily":B,"fontSize":q};return new qx.html.Element(J,bi);}
,__Rf:function(x,y){var bj={"position":H,"left":x+L,"top":y+L,"width":N,"height":N,"backgroundColor":n,"fontFamily":B,"fontSize":A};var bk=new qx.html.Element(J,bj);bk.setAttribute(F,g);bk.addListener(o,function(){window.setTimeout(function(){alert(W);}
,0);}
,this);return bk;}
,__Rg:function(e){var bl=[];bl.push(p+e.getType());bl.push(P);bl.push(f+e.isMultiTouch());bl.push(ba+e.getAllTouches().length);bl.push(j+e.getTargetTouches().length);bl.push(h+e.getChangedTargetTouches().length);bl.push(P);bl.push(V+e.getDocumentLeft()+w+e.getDocumentTop());bl.push(d+e.getScreenLeft()+w+e.getScreenTop());bl.push(T+e.getViewportLeft()+w+e.getViewportTop());bl.push(a+e.getIdentifier());var bn=e.getTarget();var bm=false;var bp=e.getTargetTouches().length>0?e.getTargetTouches():e.getChangedTargetTouches();for(var i=0;i<bp.length;i++){bm=bp[0].target==bn;if(!bm){break;}
;}
