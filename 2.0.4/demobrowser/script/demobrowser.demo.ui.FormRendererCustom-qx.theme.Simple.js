...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.FormRendererCustom","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererCustom-qx.theme.Simple.7ceb4e31b3f4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}});qx.Class.define(c,{extend:qx.ui.form.renderer.Single,members:{__Rr:0,__Rs:0,addItems:function(D,E,F,G){var J=0;if(F!=null){this._add(this._createHeader(F),{row:J,column:this.__Rr,colSpan:2});J++;}
;for(var i=0;i<D.length;i++){var I=this._createLabel(E[i],D[i]);this._add(I,{row:J,column:this.__Rr});var H=D[i];I.setBuddy(H);if(H instanceof qx.ui.form.RadioGroup){H=this._createWidgetForRadioGroup(H);}
;this._add(H,{row:J,column:this.__Rr+1});if(G[i]&&G[i].placeholder){H.setPlaceholder(G[i].placeholder);}
;J++;}
;this.__Rr+=2;this.__Rs<J?this.__Rs=J:null;}
,addButton:function(K){if(this._buttonRow==null){this._buttonRow=new qx.ui.container.Composite();this._buttonRow.setMarginTop(5);var L=new qx.ui.layout.HBox();L.setAlignX(q);L.setSpacing(5);this._buttonRow.setLayout(L);this._add(this._buttonRow,{row:this.__Rs,column:0,colSpan:this.__Rr});}
