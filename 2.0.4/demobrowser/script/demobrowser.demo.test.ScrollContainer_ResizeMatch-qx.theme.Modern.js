...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.ScrollContainer_ResizeMatch","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.ScrollContainer_ResizeMatch-qx.theme.Modern.cdabb31e5275.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="brown",e="Toggle size",d="white",c="demobrowser.demo.test.ScrollContainer_ResizeMatch",b="execute",a="Content size: 300x300";qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.container.Scroll();h.set({width:200,height:200});this.getRoot().add(h,{left:10,top:10});h.add(this.generateBox());var g=new qx.ui.form.Button(e);var i=true;g.addListener(b,function(){h.setWidth(i?300:200);h.setHeight(i?300:200);i=!i;}
);this.getRoot().add(g,{left:10,top:400});}
,generateBox:function(){var j=new qx.ui.basic.Label(a).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:f,textColor:d,padding:10});return j;}
}});}
)();
