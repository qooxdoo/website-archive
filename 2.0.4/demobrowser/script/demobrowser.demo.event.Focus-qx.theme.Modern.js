...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Focus-qx.theme.Modern.e8a9702f3e54.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var u="demobrowser.demo.event.Focus",t="mshtml",s="blur",r="focusout",q="webkit",p="1px solid black",o="Activate: ",n="FocusIn: ",m="focus",l="Window focussed",d="Deactivate: ",k="Window blurred",h="#E8ECF6",c="deactivate",b="activate",g="FocusOut: ",f="focusin",i="engine.name",a="",j="1px dotted red";qx.Class.define(u,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);qx.event.Registration.addListener(document.documentElement,b,this._onActivate,this,true);qx.event.Registration.addListener(document.documentElement,c,this._onDeactivate,this,true);qx.event.Registration.addListener(document.documentElement,f,this._onFocusIn,this);qx.event.Registration.addListener(document.documentElement,r,this._onFocusOut,this);qx.event.Registration.addListener(window,m,this._onWindowFocus,this);qx.event.Registration.addListener(window,s,this._onWindowBlur,this);}
,_onWindowFocus:function(e){this.debug(l);}
,_onWindowBlur:function(e){this.debug(k);}
,_onActivate:function(e){this.debug(o+e.getTarget());e.getTarget().style.background=h;}
,_onDeactivate:function(e){this.debug(d+e.getTarget());e.getTarget().style.background=a;}
,_onFocusIn:function(e){this.debug(n+e.getTarget());if(qx.core.Environment.get(i)==q){e.getTarget().style.border=j;}
else {e.getTarget().style.outline=j;}
;}
,_onFocusOut:function(e){this.debug(g+e.getTarget());if(qx.core.Environment.get(i)==t){e.getTarget().style.border=p;}
