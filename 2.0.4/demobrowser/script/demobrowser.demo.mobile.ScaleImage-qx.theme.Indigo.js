...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage-qx.theme.Indigo.1d5e87bcee03.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var A=qx.util.ResourceManager.getInstance().toUri(r);var x={"width":g,"height":t,"position":l,"left":n,"top":n,"background":j+A+i};this.__Eq=new qx.html.Element(m,x);this.__Eq.addListener(k,this.__DE,this);this.__Eq.addListener(a,this.__DD,this);z.add(this.__Eq);}
,__DE:function(e){if(e.isMultiTouch()){this.__QK=e.getRotation()+this.__QJ;this.__QL=e.getScale()*this.__QI;this.__Eq.setStyle("-webkit-transform","rotate("+this.__QK+"deg) scale("+this.__QL+")");}
else {var C=parseInt(e.getDocumentLeft())-(parseInt(this.__Eq.getStyle("width"))/2);var top=parseInt(e.getDocumentTop())-(parseInt(this.__Eq.getStyle("height"))/2);this.__Eq.setStyles({"left":C+"px","top":top+"px"});}
;}
,__DD:function(e){if(e.isMultiTouch()){this.__QJ=this.__QK;this.__QI=this.__QL;}
;}
}});}
)();
