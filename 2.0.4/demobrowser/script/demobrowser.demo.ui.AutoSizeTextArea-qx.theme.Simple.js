...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.AutoSizeTextArea-qx.theme.Simple.e2fceaeda917.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var p=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,10));this.getRoot().add(p,{top:20,left:20});var s=new qx.ui.basic.Label();s.setValue(a);var q=new qx.ui.form.TextArea();q.set({allowStretchY:false,value:this.__Ro()});p.add(s,{row:0,column:0});p.add(q,{row:1,column:0});s=new qx.ui.basic.Label();s.setValue(c);var w=new qx.ui.form.TextArea();w.set({allowStretchY:false,value:this.__Ro(),autoSize:true});p.add(s,{row:0,column:1});p.add(w,{row:1,column:1});s=new qx.ui.basic.Label();s.setValue(g);var x=new qx.ui.form.TextArea();x.set({allowStretchY:false,value:e,autoSize:true,minimalLineHeight:1,maxHeight:300});p.add(s,{row:0,column:2});p.add(x,{row:1,column:2});s=new qx.ui.basic.Label();s.setValue(k);var t=new qx.ui.form.TextArea();t.set({allowStretchY:false,value:this.__Ro(),autoSize:true,minHeight:200});p.add(s,{row:2,column:0});p.add(t,{row:3,column:0});s=new qx.ui.basic.Label();s.setValue(n);var r=new qx.ui.form.TextArea();r.set({allowStretchY:false,value:this.__Ro(),autoSize:true,minHeight:200,maxHeight:300});p.add(s,{row:2,column:1});p.add(r,{row:3,column:1});s=new qx.ui.basic.Label();s.setValue(l);var u=new qx.ui.form.TextArea();u.set({allowStretchY:false,value:this.__Ro(),autoSize:true,minimalLineHeight:2});var o=new qx.ui.form.CheckBox(b);o.setValue(false);o.setAllowStretchX(false);o.bind(h,u,m);p.add(s,{row:2,column:2});var v=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,10));p.add(v,{row:3,column:2});v.add(u,{row:0,column:0});v.add(o,{row:1,column:0});}
,__Ro:function(){var y=new qx.type.Array(2);for(var i=0;i<y.length;i++){y[i]=d;}
;return y.join(j);}
}});}
)();
...
(function(){var a="qx.type.Array";qx.Class.define(a,{extend:qx.type.BaseArray,construct:function(b){qx.type.BaseArray.apply(this,arguments);}
,members:{clone:qx.type.BaseArray.prototype.concat,insertAt:function(c,i){this.splice(i,0,c);return this;}
,insertBefore:function(d,e){var i=this.indexOf(e);if(i==-1){this.push(d);}
else {this.splice(i,0,d);}
;return this;}
,insertAfter:function(f,g){var i=this.indexOf(g);if(i==-1||i==(this.length-1)){this.push(f);}
else {this.splice(i+1,0,f);}
;return this;}
,removeAt:function(i){return this.splice(i,1)[0];}
,removeAll:function(){this.length=0;return this;}
,append:function(h){var j=this.__JE(h);Array.prototype.push.apply(this,j);return this;}
,prepend:function(k){var l=this.__JE(k);Array.prototype.splice.apply(this,[0,0].concat(l));return this;}
,__JE:function(m){if(qx.core.Environment.get("qx.debug")){qx.core.Assert.assertArray(m,"The parameter must be an array.");}
;var n=m;if(m instanceof qx.type.BaseArray){n=[];for(var i=0;i<m.length;i++){n[i]=m[i];}
;}
;return n;}
,remove:function(o){var i=this.indexOf(o);if(i!=-1){this.splice(i,1);return o;}
;}
,contains:function(p){return this.indexOf(p)!==-1;}
}});}
)();
