...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Carousel-qx.theme.Indigo.fdb7d4b4c18d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,get:function(bE,bF,bG){var bJ=document.getElementById(bE);var bI=bJ.innerHTML;bI=this.render(bI,bF,bG);if(bI.search(/<|>/)===-1){return document.createTextNode(bI);}
