...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Spacer_HBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Spacer_HBox-qx.theme.Simple.38f6fd3bd1d0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="demobrowser.demo.layout.Spacer_HBox",f="top",e="bottom",d="middle",c="yellow",b="green",a="main";qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var h=this.getRoot();h.add(this.getSpacerWithoutFlex(),{left:10,top:10});h.add(this.getSpacerWithFlex(),{left:10,top:70});h.add(this.getAddRemoveSpacer(),{left:10,top:200});}
,getSpacerWithoutFlex:function(){var i=new qx.ui.container.Composite().set({decorator:a,backgroundColor:c,allowGrowX:false});var j=new qx.ui.layout.HBox();j.setSpacing(5);i.setLayout(j);i.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));i.add(new qx.ui.core.Spacer(30,40));i.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));i.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));return i;}
,getSpacerWithFlex:function(){var k=new qx.ui.container.Composite().set({decorator:a,backgroundColor:c,height:100,width:400});var l=new qx.ui.layout.HBox();l.setSpacing(5);k.setLayout(l);k.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:40,alignY:f}));k.add(new qx.ui.core.Spacer(30,40),{flex:1});k.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:40,alignY:d}));k.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:40,alignY:e}));return k;}
,getAddRemoveSpacer:function(){var m=new qx.ui.container.Composite().set({decorator:a,backgroundColor:c});var o=new qx.ui.layout.HBox();o.setSpacing(5);m.setLayout(o);m.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:40,alignY:f}));m.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:40,alignY:d}));var n=new qx.ui.core.Spacer(30,40);m.add(n,{flex:1});m.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:40,alignY:e}));m.remove(n);return m;}
}});}
)();
