...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.c4c82a522a0f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;qx.log.Logger.debug(this,h+(new Date-qx.Bootstrap.LOADSTART)+a);var q=l;var r=qx.Class.getByName(q);if(r){this.__hb=new r;var p=new Date;this.__hb.main();qx.log.Logger.debug(this,m+(new Date-p)+a);var p=new Date;this.__hb.finalize();qx.log.Logger.debug(this,f+(new Date-p)+a);}
...
(function(){var ct="-",cs="src",cr="_leftComposite",cq='</div>',cp="^.*",co="filled",cn="__Ot",cm="changeValue",cl="?qxenv:demobrowser.withTests:true",ck="__OF",bC="__kH",bB="__Ox",bA="demobrowser.DemoBrowser",bz="<pre ><div class='script'>",by="_infosplit",bx='</span>=<span class="string">',bw="_history",bv="_status",bu='.html',bt="instead.",cB='<span class="html-tag-name">',cC="Demo loaded: ",cz="_searchTextField",cA="__OI",cx="f1",cy="script/demobrowser.demo",cu="noPlayground",cv='changeSelection',cD="string",cE='<div class="script">',cb="logappender",ca="_runbutton",cd="_tree",cc="f2",cf="<pre class='script'>",ce="visible",ch="__OH",cg="ig",bY="</div></pre>",bX='excluded',a="left",b="_urlWindow",c='_cmdDisposeSample',d="toolbar",f="/demo/",g="outputviews.sourcepage.html.page",h="demo/welcome.html",n='_cmdSampleInOwnWindow',o=".*",p="right-top",cI='demo/',cH="</pre>",cG="default",cF="index.html",cM="when using the file protocol. Please try the http protocol ",cL="Filter...",cK="qx.theme.Indigo",cJ="/playground/",cO="Demo Browser",cN="changeState",S="/apiviewer/",T="__OJ",Q="icon/16/actions/edit-find.png",R="__kF",W="__OE",X="http://manual.qooxdoo.org/",U="right",V="main",O='_cmdObjectSummary',P="Info",B="_prevButton",A='/',D="file:",C='_cmdNextSample',x="The security settings of your browser may prohibit AJAX ",w='&gt;',z='_cmdPrevSample',y=" Start",v="\"",q="tree1",bd='_cmdRunSample',be="__OD",bf="excluded",bg="bottom-left",Y="Failed to load demo data from the file system.\n\n",ba="runbutton",bb="__OL",bc="outputviews.sourcepage.js.page",bh="_demoView",bi="_navPart",L="?qx.theme=",K="textfield",J="mainsplit",I="app-header",H='label',G="__OG",F="_nextButton",E="app-splitpane",N="__Oy",M="?",bj=' <span class="keyword">',bk="_iframe",bl='</span>',bm="node",bn='execute',bo="<script",bp=".src.js",bq=" Demo Browser ",br='value',bs=".html",bG="horizontal",bF="javascript",bE="_",bD="qooxdoo ",bK="\n",bJ="widget",bI="http://demo.qooxdoo.org/",bH="interval",bM="modelLink",bL="tags",bT="success",bU="Couldn't load file: ",bR="~",bS=".",bP='\n',bQ="2.0.4",bN="fail",bO="value",bV=" ",bW="enabled",cj="",ci="/";qx.Class.define(bA,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);this.__kF={};var cS=new qx.ui.layout.VBox;this.setLayout(cS);this.add(this._createHeader());this.widgets={};this.tests={};this.__Os=cK;this.__OM();this.__Ot=this.__OT();this.add(this.__Ot);var cW=new qx.ui.splitpane.Pane(bG);cW.setAppearance(E);this.mainsplit=cW;var cT=new qx.ui.splitpane.Pane(bG);cT.setDecorator(null);this._infosplit=cT;this.add(cW,{flex:1});var cY=this._leftComposite=new qx.ui.container.Composite();cY.setLayout(new qx.ui.layout.VBox(3));cW.add(cY,0);{}
;var cR=new qx.ui.container.Composite();cR.setLayout(new qx.ui.layout.HBox(3));cR.setAppearance(K);cY.add(cR);var da=new qx.ui.basic.Image(Q);cR.add(da);this._searchTextField=new qx.ui.form.TextField();this._searchTextField.setLiveUpdate(true);this._searchTextField.setAppearance(bJ);this._searchTextField.setPlaceholder(cL);var cX=new qx.event.Timer(500);cX.addListener(bH,function(db){this.filter(this._searchTextField.getValue());cX.stop();}
,this);this._searchTextField.addListener(cm,function(dc){cX.restart();}
,this);cR.add(this._searchTextField,{flex:1});this._status=new qx.ui.basic.Label(cj);this._status.setAppearance(bJ);this._status.setWidth(80);this._status.setTextAlign(U);cR.add(this._status);cW.add(cT,1);this._tree=this.__OX();cY.add(this._tree,{flex:1});this.__OY();this._demoView=this.__OU();cT.add(this._demoView,2);var cP=this.__Ou=this.__OV();var cQ=this.__Ov=this.__OW();var cU=this.__Ow=new qxc.ui.logpane.LogView();cU.setDecorator(null);var cV=this.__cG=new qx.ui.container.Stack();cV.setDecorator(V);cV.add(cP);cV.add(cQ);cV.add(cU);cT.add(cV,1);cV.resetSelection();cV.exclude();this._history=qx.bom.History.getInstance();this._history.addListener(cN,function(e){var dd=e.getData().replace(bR,ci);if(this._currentSample!=dd){this.setCurrentSample(dd);}
;}
,this);this.__Ox=[this.__OD,this.__OE,this.__OH];this.__Ox.push(this.__OB);this.__Ox.push(this.__OF);this.__Ox.push(this.__OJ);this.__Oy=new qx.event.Timer(250);this.__Oy.addListener(bH,this.__Pb,this);this.__Oy.start();this.__Oz=new demobrowser.InfoWindow(this.tr(P));this.__Oz.setAutoCenter(true);}
,members:{_iframe:null,__Os:null,__Oy:null,__OA:null,_tree:null,_status:null,_searchTextField:null,__OB:null,__OC:null,__Ox:null,_versionFilter:null,_navPart:null,__OD:null,__OE:null,__OF:null,__OG:null,__OH:null,__OI:null,__OJ:null,__Ot:null,_leftComposite:null,_infosplit:null,_demoView:null,__kH:null,__kF:null,__OK:null,_urlWindow:null,__Oz:null,__cG:null,__Ou:null,__Ov:null,__Ow:null,__OL:null,defaultUrl:h,playgroundUrl:bI+bQ+cJ,__OM:function(){this._cmdObjectSummary=new qx.ui.core.Command("Ctrl+O");this._cmdObjectSummary.addListener("execute",this.__OO,this);this._cmdRunSample=new qx.ui.core.Command("F5");this._cmdRunSample.addListener("execute",this.runSample,this);this._cmdPrevSample=new qx.ui.core.Command("Ctrl+Left");this._cmdPrevSample.addListener("execute",this.playPrev,this);this._cmdNextSample=new qx.ui.core.Command("Ctrl+Right");this._cmdNextSample.addListener("execute",this.playNext,this);this._cmdSampleInOwnWindow=new qx.ui.core.Command("Ctrl+N");this._cmdSampleInOwnWindow.addListener("execute",this.__OP,this);this._cmdDisposeSample=new qx.ui.core.Command("Ctrl+D");this._cmdDisposeSample.addListener("execute",this.__OS,this);}
,__ON:function(e){var dg=e.getTarget()===this.__OL?this.__OK:this.__OL;var df=e.getData()[0];if(dg&&df){dg.setModelSelection([df.getModel()]);}
;var de=df!=null?df.getUserData("value"):"";switch(de){case "html":this.__cG.setSelection([this.__Ou]);this.__cG.show();break;case "js":this.__cG.setSelection([this.__Ov]);this.__cG.show();break;case "log":this.__cG.setSelection([this.__Ow]);this.__cG.show();break;default:this.__cG.resetSelection();this.__cG.exclude();};}
,__OO:function(){var di=this._iframe.getWindow();var dh;if(di&&di.qx){dh=di.qx.dev.ObjectSummary.getInfo();}
else {dh="Unable to access namespace. Maybe no demo loaded.";}
;var dj=new qx.ui.form.TextArea(dh);dj.setDecorator(null);dj.setAutoSize(true);dj.setMaxHeight(qx.bom.Viewport.getHeight()-100);this.__Oz.setContent(dj);this.__Oz.setWidth(400);this.__Oz.show();}
,__OP:function(){var dk=this._iframe.getSource();window.open(dk,"_blank");}
,__OQ:function(dl){var dm=!!dl;var dn=this._tree.getSelection()[0].getUserData("tags");if(dn){dm=dm&&!qx.lang.Array.contains(dn,"noPlayground");}
;this.__OB.setEnabled(dm);this.__OC=dl;}
,__OR:function(){if(this.__OC){var dr=this.__OC;var dq='{"code": '+'"'+encodeURIComponent(dr)+'"}';var dp=this.playgroundUrl+"#"+encodeURIComponent(dq);window.open(dp,"_blank");}
else {var ds=new qx.ui.basic.Label(this.tr("Could not open the Playground."));this.__Oz.setContent(ds);this.__Oz.setWidth(200);this.__Oz.show();}
;}
,__Hl:function(){window.open(bI+bQ+S);}
,__Hm:function(){var dt=(bQ.split(ct)[0]);window.open(X+dt);}
,_onHideShowTests:function(event){var dv=window.location.search;var dw=window.location.hash;var du=cF;if(dv==cj){du+=cl;}
;du+=dw;location.replace(du);}
,__OS:function(e){var dy=this._iframe.getWindow();var dx;if(dy&&dy.qx){dy.qx.core.ObjectRegistry.shutdown();dx=this.tr("Demo has been disposed.");}
else {dx=this.tr("Unable to access application.");}
;var dz=new qx.ui.basic.Label(dx);dz.setRich(true);dz.setWrap(true);this.__Oz.setContent(dz);this.__Oz.setWidth(350);this.__Oz.show();}
,__OT:function(){var dW=new qx.ui.toolbar.ToolBar();this._runbutton=new qx.ui.toolbar.Button(this.tr("Run"),"icon/22/actions/media-playback-start.png");this._runbutton.addListener("execute",this.runSample,this);this._runbutton.setToolTipText("Run the selected demo");dW.add(this._runbutton);var ea=new qx.ui.toolbar.Part();dW.add(ea);var dI=new qx.ui.toolbar.Button(this.tr("Previous"),"icon/22/actions/go-previous.png");dI.addListener("execute",this.playPrev,this);dI.setToolTipText("Run previous demo");ea.add(dI);this._prevButton=dI;var dU=new qx.ui.toolbar.Button(this.tr("Next"),"icon/22/actions/go-next.png");dU.addListener("execute",this.playNext,this);dU.setToolTipText("Run next demo");ea.add(dU);this._nextButton=dU;var dL={converter:function(ef){return ef=="visible";}
};qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dI,"enabled",dL);qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dU,"enabled",dL);var ed=this._navPart=new qx.ui.toolbar.Part();dW.add(ed);var ee=new qx.ui.toolbar.Button(this.tr("Own Window"),"icon/22/actions/edit-redo.png");ee.addListener("execute",this.__OP,this);ee.setToolTipText("Open demo in new window");this.__OD=ee;ed.add(ee);var dR=new qx.ui.toolbar.Button(this.tr("To Playground"),"icon/22/actions/application-exit.png");dR.addListener("execute",this.__OR,this);dR.setToolTipText("Open demo in the playground");dR.setEnabled(false);if(qx.core.Environment.get("browser.name")=="ie"){dR.exclude();}
;this.__OB=dR;ed.add(dR);var dD=new qx.ui.toolbar.Part();dW.add(dD);var dP=new qx.ui.toolbar.Button(this.tr("API Viewer"),"icon/22/actions/help-contents.png");dD.add(dP);dP.setToolTipText(this.tr("Open the qooxdoo API Viewer"));dP.addListener("execute",this.__Hl,this);var dB=new qx.ui.toolbar.Button(this.tr("Manual"),"icon/22/actions/help-about.png");dD.add(dB);dB.setToolTipText(this.tr("Open the qooxdoo Manual"));dB.addListener("execute",this.__Hm,this);var dX=new qx.ui.toolbar.Part;dW.add(dX);var dT=new qx.ui.menu.Menu;this.__OG=dT;var dJ=new qx.ui.menu.RadioButton("Modern Theme");var eb=new qx.ui.menu.RadioButton("Classic Theme");var ec=new qx.ui.menu.RadioButton("Simple Theme");var dY=new qx.ui.menu.RadioButton("Indigo Theme");dJ.setUserData("value","qx.theme.Modern");eb.setUserData("value","qx.theme.Classic");ec.setUserData("value","qx.theme.Simple");dY.setUserData("value","qx.theme.Indigo");dY.setValue(true);var dM=new qx.ui.form.RadioGroup(dJ,eb,ec,dY);dM.addListener("changeSelection",this.__Pf,this);dT.add(dY);dT.add(dJ);dT.add(eb);dT.add(ec);var dK=new qx.ui.toolbar.MenuButton(this.tr("Theme"),"icon/22/apps/utilities-color-chooser.png",dT);this.__OF=dX;dK.setToolTipText("Choose theme");dX.add(dK);var dN=new qx.ui.menu.Menu;var dO=new qx.ui.menu.Button(this.tr("Object Summary"));this.__OJ=dO;dO.setCommand(this._cmdObjectSummary);dN.add(dO);var dG=new qx.ui.menu.Button(this.tr("Dispose Demo"));this.__OH=dG;dG.setCommand(this._cmdDisposeSample);dN.add(dG);dN.addSeparator();var dE=new qx.ui.menu.CheckBox(this.tr("Hide/Show Tests Demos"));dE.setValue(!!qx.core.Environment.get("demobrowser.withTests"));dE.addListener("changeValue",this._onHideShowTests,this);dN.add(dE);var dH=new qx.ui.toolbar.MenuButton(this.tr("Debug"),"icon/22/apps/office-spreadsheet.png",dN);this.__OI=dH;dH.setToolTipText("Debugging options");dX.add(dH);var dQ=new qx.ui.toolbar.Part;this.__OE=dQ;dW.addSpacer();dW.add(dQ);var dV=new qx.ui.toolbar.RadioButton("HTML Code","icon/22/apps/internet-web-browser.png");dV.setToolTipText("Display HTML source");dV.setModel('html');var dF=new qx.ui.toolbar.RadioButton("JS Code","icon/22/mimetypes/executable.png");dF.setToolTipText("Display JavaScript source");dF.setModel('js');dV.setUserData("value","html");dF.setUserData("value","js");dQ.add(dV);dQ.add(dF);var dS=new qx.ui.toolbar.RadioButton("Log File","icon/22/apps/utilities-log-viewer.png");dS.setToolTipText("Display log file");dS.setUserData("value","log");dS.setModel('log');dQ.add(dS);var dA=this.__OL=new qx.ui.form.RadioGroup;dA.setAllowEmptySelection(true);dA.add(dS);dA.addListener('changeSelection',this.__ON,this);dA.add(dV,dF);dW.setOverflowHandling(true);var dC=new qx.ui.toolbar.MenuButton(null,"icon/22/actions/media-seek-forward.png");dC.setAppearance("toolbar-button");dW.add(dC);dW.setOverflowIndicator(dC);dW.setRemovePriority(dQ,6);dW.setRemovePriority(dX,5);dW.setRemovePriority(dD,4);dW.setRemovePriority(ed,3);dW.setRemovePriority(ea,2);dW.setRemovePriority(this._navPart,1);this.__kH=new qx.ui.menu.Menu();dC.setMenu(this.__kH);dW.addListener("hideItem",this._onHideItem,this);dW.addListener("showItem",this._onShowItem,this);return dW;}
,_onHideItem:function(e){var eg=e.getData();var eh=this._getMenuItems(eg);for(var i=0,l=eh.length;i<l;i++){eh[i].setVisibility(ce);if(eg===this.__OF&&!(eh[i] instanceof qx.ui.menu.Separator)){eh[i].getMenu().setPosition(p);}
;}
;}
,_onShowItem:function(e){var ei=e.getData();var ek=this._getMenuItems(ei);for(var i=0,l=ek.length;i<l;i++){ek[i].setVisibility(bf);}
;if(ei===this.__OF){var ej=ei.getMenuButtons();for(var i=0,l=ej.length;i<l;i++){ej[i].getMenu().setPosition(bg);}
;}
;}
,_getMenuItems:function(el){var en=[];if(el instanceof qx.ui.toolbar.Part){var es=el.getChildren();var er=null;var em=false;var eo=this.__kH.getChildren();if(el!=this.__OE){er=this.__kF[el.toHashCode()];if(!er){er=new qx.ui.menu.Separator();this.__kH.addBefore(er,eo[0]);this.__kF[el.toHashCode()]=er;}
;en.push(er);}
else {em=true;}
;for(var i=0,l=es.length;i<l;i++){if(es[i].getVisibility()==bX){continue;}
;var ep=this.__kF[es[i].toHashCode()];if(!ep){if(es[i] instanceof qx.ui.toolbar.RadioButton){ep=new qx.ui.menu.RadioButton(es[i].getLabel());ep.setToolTipText(es[i].getToolTipText());ep.setEnabled(es[i].getEnabled());ep.setUserData(br,es[i].getUserData(br));ep.setModel(es[i].getModel());es[i].bind(bW,ep,bW);es[i].bind(bO,ep,bO);ep.bind(bO,es[i],bO);if(!this.__OK){this.__OK=new qx.ui.form.RadioGroup();this.__OK.setAllowEmptySelection(true);this.__OK.addListener(cv,this.__ON,this);}
;this.__OK.add(ep);}
...
;;;if(em){this.__kH.add(ep);}
else {this.__kH.addBefore(ep,er);}
;this.__kF[es[i].toHashCode()]=ep;}
;en.push(ep);}
;}
;return en;}
,__OU:function(){var et=new qx.ui.embed.Iframe().set({nativeContextMenu:true});et.addListener("load",this.__Pa,this);this._iframe=et;return et;}
,__OV:function(){var eu=new qx.ui.embed.Html("<div class='script'>The sample source will be displayed here.</div>");eu.setOverflow("auto","auto");eu.setFont("monospace");eu.setBackgroundColor("white");this.widgets["outputviews.sourcepage.html.page"]=eu;eu.getContentElement().setAttribute("id","qx_srcview");return eu;}
,__OW:function(){var ew=new qx.ui.embed.Html("<div class='script'>The sample JS source will be displayed here.</div>");ew.setOverflow("auto","auto");ew.setFont("monospace");ew.setBackgroundColor("white");this.widgets["outputviews.sourcepage.js.page"]=ew;ew.getContentElement().setAttribute("id","qx_srcview");return ew;}
,__OX:function(){var ez=new qx.ui.tree.Tree();var ey=new qx.ui.tree.TreeFolder("Demos");ez.setAppearance("demo-tree");ez.setRoot(ey);this.tree=this.widgets["treeview.flat"]=ez;ez.addListener("changeSelection",this.treeGetSelection,this);ez.addListener("dblclick",function(e){qx.event.Timer.once(this.runSample,this,50);}
,this);return ez;}
,__OY:function(){var eA=new qx.ui.window.Window(this.tr("Demo Link"),"icon/22/mimetypes/text-html.png");eA.setLayout(new qx.ui.layout.VBox(10));eA.setAllowMaximize(false);eA.setAllowMinimize(false);var eD=new qx.ui.basic.Label("");eD.setSelectable(true);eD.setNativeContextMenu(true);eA.add(eD);this._urlWindow=eA;var eE=Math.ceil((qx.bom.Viewport.getWidth()/2)-250);if(eE<0){eE=0;}
...
;var fd;var ff=this._sampleToTreeNodeMap[fc];if(ff){ff.getTree().setSelection([ff]);fd=cI+fc;fd+=L+this.__Os;var fe=ff.getUserData(bL);if(fe){this.__OB.setEnabled(!qx.lang.Array.contains(fe,cu));}
;}
else {fd=this.defaultUrl;}
;if(this._iframe.getSource()==fd){this._iframe.reload();}
else {this.__OA=false;this._iframe.setSource(fd);}
;if(fd==this.defaultUrl){this.disableMenuButtons();}
else {this.enableMenuButtons();}
;this._currentSample=fc;this._currentSampleUrl=fd;}
,__Pa:function(){var fj=this._iframe.getWindow();var fp=this._iframe.getSource();if(fp!=null&&fp!=this.defaultUrl){var fi;try{fi=fj.location.href;}
catch(fr){fi=window.location.href;var fq=fi.lastIndexOf(ci);if(fq!=-1){fi=fi.substring(0,fq+1);}
;fi+=fp;}
;var fn=fi.indexOf(f)+6;var fk=fi.indexOf(M);fk=fk==-1?fi.length:fk;var fl=fi.substring(fn,fk).split(ci);var fo=String.fromCharCode(187);if(fl.length==2){var fg=fl[0];fg=fg.charAt(0).toUpperCase()+fg.substring(1);var fm=fl[1].replace(bs,cj).replace(bE,bV);fm=fm.charAt(0).toUpperCase()+fm.substring(1);var fh=bD+fo+bq+fo+bV+fg+bV+fo+bV+fm;}
else {var fh=bD+fo+bq+fo+y;}
;document.title=fh;}
;}
,__Pb:function(e){var fs=this._iframe.getWindow();try{if(fs&&fs.qx&&fs.qx.log&&fs.qx.log.appender){if(!this.__OA){this.__OA=true;this.debug(cC+this._currentSample);this.__Ow.clear();try{this.__Ow.fetch(fs.qx.log.Logger);}
catch(e){return;}
;this._history.addToHistory(this._currentSample.replace(ci,bR),document.title);if(this._currentSampleUrl!=this.defaultUrl){this.__Pc(this._currentSampleUrl);}
;}
;}
else {this.__OA=false;}
;}
catch(ft){this.__OA=false;}
;}
,filter:function(fu){var fC=new RegExp(cp+fu+o,cg);var fA=this._tree.getRoot().getItems(true,true);var fB=0;var fv=0;for(var i=0;i<fA.length;i++){var fD=fA[i];var parent=fD.getParent();var fz=fD.getUserData(bL);var fw=false;if(fz!=null){for(var j=0;j<fz.length;j++){fw=!!fz[j].match(fC);if(fw){break;}
;}
;}
...
,__Pc:function(fE){if(typeof (fE)!=cD){return;}
;var fF=new qx.io.request.Xhr(fE);fF.setTimeout(180000);fF.addListener(bT,function(fG){var content=fG.getTarget().getResponse();if(content){var fJ=content.indexOf(bo,content.indexOf(bo)+7);var fP=content.indexOf(cs,fJ);var fI=content.indexOf(v,fP+5);var fK=content.substring(fP+5,fI);var fN=fK.substring(4,fK.length-3)+bp;var u=cy;var fM=fE.split(A);var fL=fM[1];var fO=fM[2];fO=fO.substr(0,fO.indexOf(bu));u+=bS+fL+bS+fO+bp;fN=u;var fH=new qx.io.request.Xhr(fN);fH.setTimeout(18000);fH.addListener(bT,function(){var fQ=fH.getResponse();this.__OQ(fQ);if(fQ){this.widgets[bc].setHtml(this.__Pd(fQ,bF));}
;}
,this);fH.addListener(bN,function(){this.error(bU+fE);}
,this);fH.send();this.widgets[g].setHtml(this.__Pd(content));}
;}
,this);fF.addListener(bN,function(fR){this.error(bU+fE);}
,this);fF.send();}
,dataLoader:function(fS){var fT=new qx.io.request.Xhr(fS);fT.setTimeout(180000);fT.addListener(bT,function(fU){var content=fU.getTarget().getResponse();if(!content){if(window.location.protocol==D){alert(Y+x+cM+bt);}
;return;}
...
;}
;}
,__Pd:function(gg,gh){var gi=new qx.util.StringBuilder(cf);var gk=[];var gl=new qx.util.StringBuilder();var gm=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;var gj=/^\s*<\/script>\s*$/i;gg=gg.replace(/\r\n/g,bK).replace(/\r/g,bK);var gk=gg.split(bP);if(gh==bF){return bz+qx.dev.Tokenizer.javaScriptToHtml(gg)+bY;}
;for(var i=0;i<gk.length;i++){if(gm.exec(gk[i])){gi.add(this.__Pe(qx.bom.String.escape(gl.get()+gk[i])));gl.clear();}
else if(gj.exec(gk[i])){var gn=qx.dev.Tokenizer.javaScriptToHtml(gl.get());gi.add(cE,gn,cq);gl.clear();gl.add(gk[i],bP);}
else {gl.add(gk[i],bP);}
;}
;gi.add(this.__Pe(qx.bom.String.escape(gl.get())),cH);return gi.get();}
,disableMenuButtons:function(){var go=this.__Ox;for(var i=0;i<go.length;i++){go[i].setEnabled(false);}
;}
,enableMenuButtons:function(){var gp=this.__Ox;for(var i=0;i<gp.length;i++){gp[i].setEnabled(true);}
;}
,__Pe:function(gq){var gs=gq;function gr(gt){var s=new qx.util.StringBuilder(arguments[1],cB,arguments[2],bl);var gu;var gv=false;if(arguments.length-2>3){for(var i=3;i<arguments.length-2;i++){gu=arguments[i];if(gu==ci){gv=true;break;}
else {var m=/\s*([^=]+?)\s*=\s*((?!&quot;)\S+|&quot;.*?&quot;)\s*/g;var r;while((r=m.exec(gu))!=null){s.add(bj,r[1],bx,r[2].replace(/\s*$/,cj),bl);}
;}
;}
;s.add((gv?ci:cj));}
...
,__Pf:function(e){this.__Os=e.getData()[0].getUserData(bO);this.runSample();}
,_createHeader:function(){var gz=new qx.ui.layout.HBox();var gx=new qx.ui.container.Composite(gz);gx.setAppearance(I);var gA=new qx.ui.basic.Label(cO);var gy=new qxc.ui.versionlabel.VersionLabel();gy.setFont(cG);gx.add(gA);gx.add(new qx.ui.core.Spacer,{flex:1});gx.add(gy);return gx;}
},destruct:function(){this.widgets=this.tests=this._sampleToTreeNodeMap=this.tree=this.logelem=null;this._disposeObjects(J,q,a,ba,d,cx,cc,bw,cb,O,bd,z,C,n,c,ch,cA,bi,ca,be,ck,G,W,bb,cn,by,cz,bv,cd,bk,bh,bB,T,N,cr,b,F,B,R,bC);}
});}
)();
...
(function(){var m="separator-vertical",k="_applyShowLogLevel",j="Boolean",h="qxc.ui.logpane.LogView",g='',f="Debug",d="Log",c="auto",b="execute",a="icon/16/actions/edit-clear.png",I="Clear",H="__HL",G="DIV",F="middle",E="icon/16/status/dialog-information.png",D="Warning",C="Error",B="appear",A="main",z="changeLogLevel",t="Info",u="bold",r="icon/16/categories/system.png",s="icon/16/status/dialog-error.png",p="monospace",q="icon/16/status/dialog-warning.png",n="scroll",o="warn",v="error",w="info",y="white",x="debug";qx.Class.define(h,{extend:qx.ui.container.Composite,construct:function(){this.__HK=[[x,f,r],[w,t,E],[o,D,q],[v,C,s]];var M=new qx.ui.layout.VBox();M.setSeparator(m);qx.ui.container.Composite.call(this,M);this.setDecorator(A);var K=new qx.ui.basic.Label(this.tr(d)).set({font:u,padding:10,alignY:F,allowGrowX:true,allowGrowY:true});this.__Ff=new qx.ui.toolbar.ToolBar();this.__Ff.add(K);this.__Ff.addSpacer();this.__Ff.setBackgroundColor(y);var J=new qx.ui.toolbar.Button(this.tr(I),a);J.addListener(b,function(e){this.clear();}
,this);this.__Ff.add(J);this.add(this.__Ff);var L=new qx.ui.embed.Html(g);L.set({backgroundColor:y,overflowY:n,overflowX:c,font:p,padding:3});this.add(L,{flex:1});this.__HL=new qx.log.appender.Element();qx.log.Logger.unregister(this.__HL);this.__HM=document.createElement(G);this.__HL.setElement(this.__HM);L.addListenerOnce(B,function(){L.getContentElement().getDomElement().appendChild(this.__HM);}
,this);}
,properties:{showLogLevel:{check:j,apply:k,init:false},logLevel:{check:[x,w,o,v],init:x,event:z}},members:{__HM:null,__HL:null,__HK:null,__HN:null,__Ff:null,clear:function(){this.__HL.clear();}
,fetch:function(N){if(!N){N=qx.log.Logger;}
;N.register(this.__HL);N.clear();}
,getAppenderElement:function(){return this.__HM;}
,_applyShowLogLevel:function(O,P){if(!this.__HN){this.__HN=this.__HO();this.__Ff.add(this.__HN);}
;if(O){this.__HN.show();}
else {this.__HN.exclude();}
;}
,__HO:function(){var Q=new qx.ui.menu.Menu();var T=new qx.ui.toolbar.MenuButton("Log Level","icon/16/categories/system.png");T.setMenu(Q);for(var i=0,l=this.__HK.length;i<l;i++){var S=this.__HK[i];var R=new qx.ui.menu.Button(S[1],S[2]);R.setUserData("model",S[0]);R.addListener("execute",function(U){var V=U.getTarget();this.setLogLevel(V.getUserData("model"));T.setIcon(V.getIcon());}
,this);Q.add(R);}
;return T;}
},destruct:function(){this._disposeObjects(H);this.__HM=null;}
});}
)();
...
,members:{__dL:null,setElement:function(t){this.clear();if(t){qx.bom.element.Class.add(t,k);}
;this.__dL=t;}
,clear:function(){var u=this.__dL;if(u){u.innerHTML=d;}
;}
,process:function(v){var w=this.__dL;if(!w){return;}
...
(function(){var j="qx.blankpage",i="undefined",h="#",g="hidden",f="can't initialize iframe",e="qx.bom.HashHistory",d="absolute",c="interval",b="-1000px",a="";qx.Class.define(e,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this._baseUrl=null;this.__rR();}
,members:{__rO:null,__rP:null,__rQ:false,addToHistory:function(k,l){if(!qx.lang.Type.isString(k)){k=k+a;}
;if(qx.lang.Type.isString(l)){this.setTitle(l);this._titles[k]=l;}
;if(this.getState()!==k){this.setState(k);}
;}
,__rR:function(){this.__rP=this.__rS();document.body.appendChild(this.__rP);this.__rT(function(){this._baseUrl=this.__rP.contentWindow.document.location.href;this.__rU();}
,this);}
,__rS:function(){var m=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(j))+h});m.style.visibility=g;m.style.position=d;m.style.left=b;m.style.top=b;return m;}
,__rT:function(n,o,p){if(typeof p===i){p=0;}
;if(!this.__rP.contentWindow||!this.__rP.contentWindow.document){if(p>20){throw new Error(f);}
;qx.event.Timer.once(function(){this.__rT(n,o,++p);}
,this,10);return;}
;this.__rQ=true;n.call(o||window);}
,__rU:function(){qx.event.Idle.getInstance().addListener(c,this.__rW,this);}
,__rV:function(){qx.event.Idle.getInstance().removeListener(c,this.__rW,this);}
,__rW:function(){var q=this._readState();if(qx.lang.Type.isString(q)&&q!=this.getState()){this._onHistoryLoad(q);}
;}
,_readState:function(){var r=!this._getHash()?a:this._getHash().substr(1);return this._decode(r);}
,_getHash:function(){if(!this.__rQ){return;}
;return this.__rP.contentWindow.document.location.hash;}
,_writeState:function(s){this._setHash(this._encode(s));}
,_setHash:function(t){if(!this.__rP||!this._baseUrl){return;}
;var u=!this.__rP.contentWindow.document.location.hash?a:this.__rP.contentWindow.document.location.hash.substr(1);if(t!=u){this.__rP.contentWindow.document.location.hash=t;}
;}
},destruct:function(){this.__rV();this.__rP=null;}
});}
)();
...
(function(){var q="request",p="qx.bom.IframeHistory",o="engine.name",n="can't initialize iframe",m="mshtml",l="state",k='<html><body><div id="state">',j="browser.version",i="hidden",h="qx.blankpage",c="undefined",g='</div></body></html>',f="absolute",b="",a="interval",d="-1000px";qx.Class.define(p,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__sc();}
,members:{__rP:null,__rQ:false,__rX:null,__rY:null,__sa:null,_setInitialState:function(){qx.bom.History.prototype._setInitialState.call(this);this.__sa=this._getHash();}
,_setHash:function(r){qx.bom.History.prototype._setHash.call(this,r);this.__sa=this._encode(r);}
...
;}
,_setState:function(v){this.__rY=true;this.setState(v);this.__rY=false;}
,_applyState:function(w,x){if(this.__rY){return;}
;this._writeState(w);}
,_readState:function(){if(!this.__rQ){return this._decode(this._getHash());}
;var y=this.__rP.contentWindow.document;var z=y.getElementById(l);return z?this._decode(z.innerText):b;}
,_writeState:function(A){if(!this.__rQ){this.__sb();this.__rX=qx.event.Timer.once(function(){this._writeState(A);}
,this,50);return;}
;this.__sb();var A=this._encode(A);if(qx.core.Environment.get(o)==m&&qx.core.Environment.get(j)!=8){this._setHash(A);}
;var B=this.__rP.contentWindow.document;B.open();B.write(k+A+g);B.close();}
,__sb:function(){if(this.__rX){this.__rX.stop();this.__rX.dispose();}
;}
,__sc:function(){this.__rR(function(){qx.event.Idle.getInstance().addListener(a,this.__rW,this);}
);}
,__rW:function(e){var D=null;var C=this._getHash();if(!this.__se(C)){D=this.__sd(C);}
else {D=this._readState();}
;if(qx.lang.Type.isString(D)&&D!=this.getState()){this._onHistoryLoad(D);}
;}
,__sd:function(E){E=this._decode(E);this._writeState(E);return E;}
,__se:function(F){return qx.lang.Type.isString(F)&&F==this.__sa;}
,__rR:function(G){this.__rP=this.__rS();document.body.appendChild(this.__rP);this.__rT(function(){this._writeState(this.getState());if(G){G.call(this);}
;}
,this);}
,__rS:function(){var H=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(h))});H.style.visibility=i;H.style.position=f;H.style.left=d;H.style.top=d;return H;}
,__rT:function(I,J,K){if(typeof K===c){K=0;}
;if(!this.__rP.contentWindow||!this.__rP.contentWindow.document){if(K>20){throw new Error(n);}
;qx.event.Timer.once(function(){this.__rT(I,J,++K);}
,this,10);return;}
;this.__rQ=true;I.call(J||window);}
},destruct:function(){this.__rP=null;if(this.__rX){this.__rX.dispose();this.__rX=null;}
;qx.event.Idle.getInstance().removeListener(a,this.__rW,this);}
});}
)();
(function(){var d="qx.bom.NativeHistory",c="engine.name",b="hashchange",a="interval";qx.Class.define(d,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__rU();}
,members:{__rO:null,__rU:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){this.__rO=qx.lang.Function.bind(this.__rW,this);qx.bom.Event.addNativeListener(window,b,this.__rO);}
else {qx.event.Idle.getInstance().addListener(a,this.__rW,this);}
;}
,__rV:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){qx.bom.Event.removeNativeListener(window,b,this.__rO);}
else {qx.event.Idle.getInstance().removeListener(a,this.__rW,this);}
;}
,__rW:function(){var e=this._readState();if(qx.lang.Type.isString(e)&&e!=this.getState()){this._onHistoryLoad(e);}
;}
...
(function(){var g="resize",f="demobrowser.InfoWindow",e="Boolean",d="_applyContent",c="center",b="OK",a="execute";qx.Class.define(f,{extend:qx.ui.window.Window,construct:function(h,i){qx.ui.window.Window.call(this,h,i);this.setLayout(new qx.ui.layout.VBox(10));this.setMinWidth(200);this.setMaxWidth(qx.bom.Viewport.getWidth()-10);this.setMaxHeight(qx.bom.Viewport.getHeight()-10);this.setShowMinimize(false);this.setShowMaximize(false);this.add(this._getContentContainer(),{flex:1});this.add(this._makeOkButton(),{flex:0});this.addListener(g,this.__Pg,this);}
,properties:{content:{apply:d},autoCenter:{check:e,init:false}},members:{__Cp:null,_getContentContainer:function(){if(!this.__Cp){this.__Cp=new qx.ui.container.Composite(new qx.ui.layout.VBox());this.__Cp.setMinHeight(20);}
;return this.__Cp;}
...
,__Pg:function(){if(this.getAutoCenter()){this.center();}
;}
}});}
)();
...
(function(){var p="No target to insert tests",o="^",n="demobrowser.TreeDataHandler",m="ttree",l="\\.[^\\.]+$",h="demobrowser.withTests",g="depth",f="All",e=".",d="",c="test";qx.Class.define(n,{extend:qx.core.Object,construct:function(q){qx.core.Object.call(this);this.tmap=q;this.ttree=this.__Ph(q);}
,members:{__Ph:function(r){var t=r;function s(x,y){var B=y.classname;var z=B.split(e);function A(parent,D){if(!D.length){return parent;}
...
(function(){var g="qxc.ui.versionlabel.VersionLabel",f="2.0.4",e=" ",d="qooxdoo",c="versionLabel.name",b="",a="versionLabel.version";qx.Class.define(g,{extend:qx.ui.basic.Label,construct:function(h,i){if(h==undefined){h=qx.core.Environment.get(c);}
...
;}
,__sf:function(){var bi=qx.theme.manager.Color.getInstance();var bk=bi.resolve(this.getStartColor());var bj=bi.resolve(this.getEndColor());return {start:bk,end:bj};}
,_getContent:function(){if(qx.core.Environment.get(v)&&!qx.core.Environment.get(w)){var bn=this.__sf();var bq=this.getOrientation()==B?1:0;var bp=qx.util.ColorUtil.hex3StringToHex6String(bn.start);var bm=qx.util.ColorUtil.hex3StringToHex6String(bn.end);bp=bp.substring(1,bp.length);bm=bm.substring(1,bm.length);var bo=u;if(this.classname.indexOf(N)!=-1){var bl={};this._styleBoxShadow(bl);bo=e+qx.bom.element.Style.compile(bl)+b;}
...
;}
;O[A]=y;O[i]=0;O[F]=0;return this.__sg=this._generateBackgroundMarkup(O,S);}
,__sj:function(W,X,Y){var ba=this.getInsets();X-=ba.left+ba.right;Y-=ba.top+ba.bottom;var bb=ba.left-this.getWidthLeft()-this.getInnerWidthLeft();var top=ba.top-this.getWidthTop()-this.getInnerWidthTop();return {left:bb,top:top,width:X,height:Y,elementToApplyDimensions:W.firstChild};}
