...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_FocusIndicator-qx.theme.Indigo.4af31d6d03bc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var i="keypress",h="#FFE",g="demobrowser.demo.test.Table_FocusIndicator",f="Left",d="Right",c="Down",b="Up",a="main";qx.Class.define(g,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil,qx.core.MAssert],members:{main:function(){qx.application.Standalone.prototype.main.call(this);var j=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({decorator:a,backgroundColor:h,width:600,height:400});this.getRoot().add(j,{left:10,top:10});var m=new qx.ui.table.pane.FocusIndicator(this.getScrollerMock()).set({decorator:a});j.add(m);var k=6;var l=2;m.moveToCell(l,k);j.addListener(i,function(e){switch(e.getKeyIdentifier()){case f:l-=1;break;case d:l+=1;break;case b:k-=1;break;case c:k+=1;break;default:return;};l=Math.min(Math.max(0,l),5);k=Math.min(Math.max(0,k),19);m.moveToCell(l,k);}
);}
}});}
)();
