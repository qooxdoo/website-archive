...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table-qx.theme.Indigo.e4685abb4365.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g=" / ",f="horizontal",e="demobrowser.demo.virtual.Table",d="white",c="__Ru",b="#EEE",a="vertical";qx.Class.define(e,{extend:qx.application.Standalone,members:{__Ru:null,main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.virtual.core.Scroller(10000,10000,20,100);for(var i=0;i<10000;i++){h.getPane().getRowConfig().setItemSize(i,20+Math.round(Math.random()*40));h.getPane().getColumnConfig().setItemSize(i,50+Math.round(Math.random()*80));}
;this.getRoot().add(h,{edge:20});h.getPane().addLayer(new qx.ui.virtual.layer.Row(d,b));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(f));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(a));h.getPane().addLayer(new qx.ui.virtual.layer.HtmlCell(this));this.__Ru=new qx.ui.virtual.cell.Cell();}
,getCellProperties:function(j,k){return this.__Ru.getCellProperties(j+g+k);}
