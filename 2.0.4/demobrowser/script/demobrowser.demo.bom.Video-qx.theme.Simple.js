...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Video","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Video-qx.theme.Simple.20a417392948.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var u="timeupdate",t="demobrowser/demo/media/qx.ogv",s="#CCC",r="Native Controls",q="Loop",p="Mute",o="html.video.h264",n="0:00",m="html.video.ogg",l="demobrowser/demo/media/qx.m4v",d="demobrowser/demo/media/qx.webm",k="It seems that your browser doesn't support HTML5 video",h="loadeddata",c="Play/Pause",b=":",g="ended",f="0",i="demobrowser.demo.bom.Video",a="html.video.webm",j="changeValue";qx.Class.define(i,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var y=this.getRoot();var D=new qx.ui.container.Composite(new qx.ui.layout.Basic());y.add(D,{left:10,top:40});if(qx.core.Environment.get(o)){var w=qx.util.ResourceManager.getInstance().toUri(l);}
else if(qx.core.Environment.get(a)){var w=qx.util.ResourceManager.getInstance().toUri(d);}
else if(qx.core.Environment.get(m)){var w=qx.util.ResourceManager.getInstance().toUri(t);}
else {y.add(new qx.ui.basic.Label(k,{left:10,top:10}));return;}
;;var B=new qx.bom.media.Video(w);var v=new qx.ui.form.ToggleButton(c);v.addListener(j,function(e){if(B.isPaused()){B.play();}
else {B.pause();}
;}
,this);var x=new qx.ui.form.ToggleButton(r);x.addListener(j,function(e){if(B.hasControls()){B.hideControls();}
else {B.showControls();}
;}
,this);var z=new qx.ui.form.ToggleButton(p);z.addListener(j,function(e){if(B.isMuted()){B.setMuted(false);}
else {B.setMuted(true);}
;}
,this);var E=new qx.ui.form.ToggleButton(q);E.addListener(j,function(e){if(B.isLoop()){B.setLoop(false);}
else {B.setLoop(true);}
;}
,this);var C=new qx.ui.basic.Label(n);C.setTextColor(s);var A=new qx.ui.indicator.ProgressBar();A.setHeight(21);A.setWidth(220);B.addListener(h,function(){y.add(x,{left:315,top:10});y.add(v,{left:10,top:270});y.add(A,{left:90,top:272});y.add(C,{left:185,top:275});y.add(z,{left:314,top:270});y.add(E,{left:364,top:270});D.getContentElement().getDomElement().appendChild(B.getMediaObject());D.setWidth(400);D.setHeight(220);B.setWidth(D.getWidth());B.setHeight(D.getHeight());}
,this);B.addListener(u,function(){A.setMaximum(B.getDuration());var F=B.getCurrentTime();var H=Math.floor(F/60);var G=parseInt(F%60);A.setValue(F);C.setValue(H+b+(G>9?G:f+G));}
,this);B.addListener(g,function(){if(!B.isLoop()){v.resetValue();}
;}
,this);}
}});}
)();
...
(function(){var b="video",a="qx.bom.media.Video";qx.Class.define(a,{extend:qx.bom.media.Abstract,construct:function(c){this._video=document.createElement(b);if(c){this._video.src=c;}
