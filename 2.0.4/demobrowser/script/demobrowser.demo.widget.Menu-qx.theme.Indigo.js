...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu-qx.theme.Indigo.53456c7823d8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var cn="Online Forum",cm="__RL",cl="icon/16/actions/format-justify-fill.png",ck="__RO",cj="Search in files",ci="C",ch="Left aligned",cg="Perl",cf="View",ce="C Dialect",bu="Info...",bt="Save as...",bs="Show line numbers",br="Quickstart",bq="icon/16/actions/contact-new.png",bp="Ctrl+N",bo="Actions",bn="Show console",bm="Search",bl="Help",cu="Show status bar",cv="icon/16/actions/format-justify-left.png",cs="__wE",ct="ANSI to OEM",cq="Centered",cr="Website 3",co="Edit",cp="icon/16/actions/format-justify-center.png",cw="Ctrl+O",cx="icon/16/actions/go-previous.png",bS="__RM",bR="C Sharp",bU="Close",bT="Split Button",bW="Website 2",bV="icon/16/actions/document-save-as.png",bY="Python",bX="icon/16/apps/utilities-help.png",bQ="Show tree",bP="Options",a="Spaces to tabs",b="Right aligned",c="Action 1",d="OEM to ANSI",f="Line 431",g="JavaScript",h="icon",j="Action 2",k="Folder ",l="XML",cB="Line 313",cA="Paragraph",cz="demobrowser.demo.widget.Menu",cy="icon/16/actions/application-exit.png",cF="C Plus Plus",cE="Line 26",cD="Item ",cC="ASCII table",cH="Option 1",cG="Search next...",K="Line 12",L="Action 3",I="Replace in files",J="__wL",O="Uppercase",P="Ctrl+P",M="Topics",N="Panes",G="Justified",H="Ctrl+X",t="Search previous...",s="Change selection: ",v="Back",u="main",p=" = ",o="Execute command: ",r="Show ruler",q="icon/16/actions/format-justify-right.png",n="icon/16/actions/go-next.png",m="Ctrl+Z",U="__RP",V="command ",W="Option 3",X="Next",Q="Ctrl+R",R="Show macros",S="Show tags",T="Capitals",Y="Execute button: ",ba="Format",D="File",C="Change checked: ",B="Show tabs",A="Tabs to spaces",z="Search...",y="Line 1039",x="Option 2",w="Objective C",F="__RN",E="Exit",bb="move to",bc="__RQ",bd="Ctrl+S",be="Syntax",bf="Ctrl+C",bg="Website 1",bh="Menu Button",bi="Line 30",bj="Lowercase",bk="Replace",by="HTML",bx="New",bw="Undo",bv="icon/16/actions/document-save.png",bC="Redo",bB="icon/22/apps/preferences-users.png",bA="icon/16/actions/document-print.png",bz="icon/16/actions/document-open.png",bE="icon/16/actions/edit-undo.png",bD="Save",bL="icon/16/actions/edit-redo.png",bM="Print",bJ="Open",bK="icon/16/actions/document-new.png",bH="icon/16/actions/edit-cut.png",bI="changeSelection",bF="icon/16/actions/edit-paste.png",bG="Copy",bN="Paste",bO="icon/16/actions/edit-copy.png",cb="Cut",ca="icon/16/actions/system-search.png",cd="changeValue",cc="execute";qx.Class.define(cz,{extend:qx.application.Standalone,members:{__RL:null,__RM:null,__RN:null,__wE:null,__wL:null,__RO:null,__RP:null,__RQ:null,main:function(){qx.application.Standalone.prototype.main.call(this);var cJ=new qx.ui.container.Scroll();var cI=new qx.ui.container.Composite(new qx.ui.layout.Canvas);cI.setPadding(20);cI.setAllowStretchX(false);cJ.add(cI);this.getRoot().add(cJ,{edge:0});this.createCommands();cI.add(this.getMenuButton(),{left:20,top:20});cI.add(this.getSplitButton(),{left:150,top:20});cI.add(this.getMenuBar(),{left:20,top:100});cI.add(this.getList(),{left:20,top:200});this.getRoot().setContextMenu(this.getRootContextMenu());}
,getRootContextMenu:function(){var cK=new qx.ui.menu.Menu();var cL=new qx.ui.menu.Menu();for(var i=0;i<30;i++){cL.add(new qx.ui.menu.Button(k+(i+1)));}
;cK.add(new qx.ui.menu.Button(bb,null,null,cL));cK.add(new qx.ui.menu.Separator());for(var i=0;i<7;i++){cK.add(new qx.ui.menu.Button(V+(i+1)));}
;return cK;}
,debugRadio:function(e){this.debug(s+e.getData()[0].getLabel());}
,debugCommand:function(e){this.debug(o+this.getShortcut());}
,debugButton:function(e){this.debug(Y+this.getLabel());}
,debugCheckBox:function(e){this.debug(C+this.getLabel()+p+e.getData());}
,createCommands:function(){this.__RL=new qx.ui.core.Command(bp);this.__RL.addListener(cc,this.debugCommand);this.__RM=new qx.ui.core.Command(cw);this.__RM.addListener(cc,this.debugCommand);this.__RN=new qx.ui.core.Command(bd);this.__RN.addListener(cc,this.debugCommand);this.__wE=new qx.ui.core.Command(m);this.__wE.addListener(cc,this.debugCommand);this.__wL=new qx.ui.core.Command(Q);this.__wL.addListener(cc,this.debugCommand);this.__RO=new qx.ui.core.Command(H);this.__RO.addListener(cc,this.debugCommand);this.__RP=new qx.ui.core.Command(bf);this.__RP.addListener(cc,this.debugCommand);this.__RQ=new qx.ui.core.Command(P);this.__RQ.addListener(cc,this.debugCommand);this.__RQ.setEnabled(false);}
,getMenuButton:function(){var cM=new qx.ui.menu.Menu;cM.add(new qx.ui.menu.RadioButton(cH));cM.add(new qx.ui.menu.RadioButton(x));cM.add(new qx.ui.menu.RadioButton(W));var cU=new qx.ui.menu.Menu;cU.add(new qx.ui.menu.RadioButton(c));cU.add(new qx.ui.menu.RadioButton(j));cU.add(new qx.ui.menu.RadioButton(L));var cT=new qx.ui.form.RadioGroup;cT.add.apply(cT,cM.getChildren());cT.addListener(bI,this.debugRadio);var cR=new qx.ui.form.RadioGroup;cR.add.apply(cR,cU.getChildren());cR.addListener(bI,this.debugRadio);var cP=new qx.ui.menu.Menu();var cS=new qx.ui.menu.Button(bw,bE,this.__wE);var da=new qx.ui.menu.Button(bC,bL,this.__wL);var cO=new qx.ui.menu.Button(cb,bH,this.__RO);var cW=new qx.ui.menu.Button(bG,bO,this.__RP);var cQ=new qx.ui.menu.Button(bN,bF,this.__RQ);var cN=new qx.ui.menu.Button(bP,ca,null,cM);var cX=new qx.ui.menu.Button(bo,bq,null,cU);var cV=new qx.ui.menu.Button(bM,bA);cS.addListener(cc,this.debugButton);da.addListener(cc,this.debugButton);cO.addListener(cc,this.debugButton);cW.addListener(cc,this.debugButton);cQ.addListener(cc,this.debugButton);cN.addListener(cc,this.debugButton);cX.addListener(cc,this.debugButton);cV.addListener(cc,this.debugButton);cP.add(cS);cP.add(da);cP.addSeparator();cP.add(cO);cP.add(cW);cP.add(cQ);cP.addSeparator();cP.add(cN);cP.add(cX);cP.addSeparator();cP.add(cV);var cY=new qx.ui.form.MenuButton(bh,bB,cP);return cY;}
,getSplitButton:function(){var db=new qx.ui.menu.Menu;var df=new qx.ui.menu.Button(bg);var dd=new qx.ui.menu.Button(bW);var de=new qx.ui.menu.Button(cr);db.setMinWidth(120);df.addListener(cc,this.debugButton);dd.addListener(cc,this.debugButton);de.addListener(cc,this.debugButton);db.add(df);db.add(dd);db.add(de);var dc=new qx.ui.form.SplitButton(bT,bB,db);dc.addListener(cc,this.debugButton);return dc;}
,getMenuBar:function(){var dk=new qx.ui.container.Composite(new qx.ui.layout.Grow);dk.setDecorator(u);var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setWidth(600);dk.add(toolbar);var du=new qx.ui.toolbar.Part;var dj=new qx.ui.toolbar.Part;var dn=new qx.ui.toolbar.Part;toolbar.add(du);toolbar.add(dj);toolbar.addSpacer();toolbar.add(dn);var dt=new qx.ui.toolbar.SplitButton(v,cx,this.getBackMenu());var dq=new qx.ui.toolbar.SplitButton(X,n,this.getForwardMenu());var di=new qx.ui.toolbar.Button(bx,bK,this.__RL);var dm=new qx.ui.toolbar.Button(bJ,bz,this.__RM);var ds=new qx.ui.toolbar.Button(bD,bv,this.__RN);dt.addListener(cc,this.debugButton);dq.addListener(cc,this.debugButton);di.addListener(cc,this.debugButton);dm.addListener(cc,this.debugButton);ds.addListener(cc,this.debugButton);du.add(dt);du.add(dq);du.addSeparator();du.add(di);du.add(dm);du.add(ds);du.setShow(h);var dl=new qx.ui.toolbar.MenuButton(D);var dh=new qx.ui.toolbar.MenuButton(co);var dg=new qx.ui.toolbar.MenuButton(bm);var dv=new qx.ui.toolbar.MenuButton(cf);var dr=new qx.ui.toolbar.MenuButton(ba);dl.setMenu(this.getFileMenu());dh.setMenu(this.getEditMenu());dg.setMenu(this.getSearchMenu());dv.setMenu(this.getViewMenu());dr.setMenu(this.getFormatMenu());dj.add(dl);dj.add(dh);dj.add(dg);dj.add(dv);dj.add(dr);var dp=new qx.ui.toolbar.MenuButton(bl);dp.setMenu(this.getHelpMenu());dn.add(dp);return dk;}
,getBackMenu:function(){var dx=new qx.ui.menu.Menu;var dy=new qx.ui.menu.Button(cB);var dA=new qx.ui.menu.Button(y);var dw=new qx.ui.menu.Button(K);var dz=new qx.ui.menu.Button(cE);dy.addListener(cc,this.debugButton);dA.addListener(cc,this.debugButton);dw.addListener(cc,this.debugButton);dz.addListener(cc,this.debugButton);dx.add(dy);dx.add(dA);dx.add(dw);dx.add(dz);return dx;}
,getForwardMenu:function(){var dB=new qx.ui.menu.Menu;var dC=new qx.ui.menu.Button(f);var dD=new qx.ui.menu.Button(bi);dC.addListener(cc,this.debugButton);dD.addListener(cc,this.debugButton);dB.add(dC);dB.add(dD);return dB;}
,getFileMenu:function(){var dG=new qx.ui.menu.Menu;var dE=new qx.ui.menu.Button(bx,bK,this.__RL);var dI=new qx.ui.menu.Button(bJ,bz,this.__RM);var dH=new qx.ui.menu.Button(bU);var dL=new qx.ui.menu.Button(bD,bv,this.__RN);var dK=new qx.ui.menu.Button(bt,bV);var dJ=new qx.ui.menu.Button(bM,bA);var dF=new qx.ui.menu.Button(E,cy);dE.addListener(cc,this.debugButton);dI.addListener(cc,this.debugButton);dH.addListener(cc,this.debugButton);dL.addListener(cc,this.debugButton);dK.addListener(cc,this.debugButton);dJ.addListener(cc,this.debugButton);dF.addListener(cc,this.debugButton);dG.add(dE);dG.add(dI);dG.add(dH);dG.add(dL);dG.add(dK);dG.add(dJ);dG.add(dF);return dG;}
,getEditMenu:function(){var dN=new qx.ui.menu.Menu;var dQ=new qx.ui.menu.Button(bw,bE,this.__wE);var dP=new qx.ui.menu.Button(bC,bL,this.__wL);var dM=new qx.ui.menu.Button(cb,bH,this.__RO);var dR=new qx.ui.menu.Button(bG,bO,this.__RP);var dO=new qx.ui.menu.Button(bN,bF,this.__RQ);dQ.addListener(cc,this.debugButton);dP.addListener(cc,this.debugButton);dM.addListener(cc,this.debugButton);dR.addListener(cc,this.debugButton);dO.addListener(cc,this.debugButton);dN.add(dQ);dN.add(dP);dN.addSeparator();dN.add(dM);dN.add(dR);dN.add(dO);return dN;}
,getSearchMenu:function(){var dV=new qx.ui.menu.Menu;var dT=new qx.ui.menu.Button(z,ca);var dY=new qx.ui.menu.Button(cG);var dU=new qx.ui.menu.Button(t);var dX=new qx.ui.menu.Button(bk);var dS=new qx.ui.menu.Button(cj,ca);var dW=new qx.ui.menu.Button(I);dU.setEnabled(false);dT.addListener(cc,this.debugButton);dY.addListener(cc,this.debugButton);dU.addListener(cc,this.debugButton);dX.addListener(cc,this.debugButton);dS.addListener(cc,this.debugButton);dW.addListener(cc,this.debugButton);dV.add(dT);dV.add(dY);dV.add(dU);dV.add(dX);dV.addSeparator();dV.add(dS);dV.add(dW);return dV;}
,getViewMenu:function(){var ea=new qx.ui.menu.Menu;var ec=new qx.ui.menu.Button(N,null,null,this.getPanesMenu());var ef=new qx.ui.menu.Button(be,null,null,this.getSyntaxMenu());var ee=new qx.ui.menu.CheckBox(r);var ed=new qx.ui.menu.CheckBox(bs);var eb=new qx.ui.menu.Button(cC);ee.addListener(cd,this.debugCheckBox);ed.addListener(cd,this.debugCheckBox);eb.addListener(cc,this.debugButton);ea.add(ec);ea.add(ef);ea.addSeparator();ea.add(ee);ea.add(ed);ea.addSeparator();ea.add(eb);return ea;}
,getPanesMenu:function(){var eh=new qx.ui.menu.Menu;var ej=new qx.ui.menu.CheckBox(B);var el=new qx.ui.menu.CheckBox(cu);var em=new qx.ui.menu.CheckBox(bQ);var ei=new qx.ui.menu.CheckBox(R);var ek=new qx.ui.menu.CheckBox(S);var eg=new qx.ui.menu.CheckBox(bn);ej.setValue(true);el.setValue(true);ei.setValue(true);ej.addListener(cd,this.debugCheckBox);el.addListener(cd,this.debugCheckBox);em.addListener(cd,this.debugCheckBox);ei.addListener(cd,this.debugCheckBox);ek.addListener(cd,this.debugCheckBox);eg.addListener(cd,this.debugCheckBox);eh.add(el);eh.add(ej);eh.addSeparator();eh.add(em);eh.add(ei);eh.add(ek);eh.add(eg);return eh;}
,getSyntaxMenu:function(){var er=new qx.ui.menu.Menu;var en=new qx.ui.menu.RadioButton(by);var ep=new qx.ui.menu.RadioButton(l);var eo=new qx.ui.menu.RadioButton(g);var eq=new qx.ui.menu.Button(ce,null,null,this.getSyntaxCMenu());var eu=new qx.ui.menu.RadioButton(cg);var es=new qx.ui.menu.RadioButton(bY);er.add(en);er.add(ep);er.add(eo);er.add(eq);er.add(eu);er.add(es);var et=new qx.ui.form.RadioGroup;et.add(en,ep,eo,eu,es);et.add.apply(et,eq.getMenu().getChildren());et.addListener(bI,this.debugRadio);return er;}
,getSyntaxCMenu:function(){var ew=new qx.ui.menu.Menu;var ev=new qx.ui.menu.RadioButton(ci);var ez=new qx.ui.menu.RadioButton(bR);var ey=new qx.ui.menu.RadioButton(w);var ex=new qx.ui.menu.RadioButton(cF);ew.add(ev);ew.add(ez);ew.add(ey);ew.add(ex);return ew;}
,getFormatMenu:function(){var eD=new qx.ui.menu.Menu;var eC=new qx.ui.menu.Button(cA,null,null,this.getParagraphMenu());var eF=new qx.ui.menu.Button(A);var eG=new qx.ui.menu.Button(a);var eB=new qx.ui.menu.Button(O);var eE=new qx.ui.menu.Button(bj);var eA=new qx.ui.menu.Button(T);var eI=new qx.ui.menu.Button(d);var eH=new qx.ui.menu.Button(ct);eF.addListener(cc,this.debugButton);eG.addListener(cc,this.debugButton);eB.addListener(cc,this.debugButton);eE.addListener(cc,this.debugButton);eA.addListener(cc,this.debugButton);eI.addListener(cc,this.debugButton);eH.addListener(cc,this.debugButton);eD.add(eC);eD.add(eF);eD.add(eG);eD.addSeparator();eD.add(eB);eD.add(eE);eD.add(eA);eD.addSeparator();eD.add(eI);eD.add(eH);return eD;}
,getParagraphMenu:function(){var eJ=new qx.ui.menu.Menu;var eM=new qx.ui.menu.Button(ch,cv);var eN=new qx.ui.menu.Button(b,q);var eK=new qx.ui.menu.Button(cq,cp);var eL=new qx.ui.menu.Button(G,cl);eM.addListener(cc,this.debugButton);eN.addListener(cc,this.debugButton);eK.addListener(cc,this.debugButton);eL.addListener(cc,this.debugButton);eJ.add(eM);eJ.add(eN);eJ.add(eK);eJ.add(eL);return eJ;}
,getHelpMenu:function(){var eO=new qx.ui.menu.Menu;var eQ=new qx.ui.menu.Button(M,bX);var eS=new qx.ui.menu.Button(br);var eR=new qx.ui.menu.Button(cn);var eP=new qx.ui.menu.Button(bu);eQ.addListener(cc,this.debugButton);eS.addListener(cc,this.debugButton);eR.addListener(cc,this.debugButton);eP.addListener(cc,this.debugButton);eO.add(eQ);eO.add(eS);eO.addSeparator();eO.add(eR);eO.addSeparator();eO.add(eP);return eO;}
,getList:function(){var eT=new qx.ui.form.List;eT.setContextMenu(this.getContextMenu());for(var i=0;i<20;i++){eT.add(new qx.ui.form.ListItem(cD+i));}
;return eT;}
,getContextMenu:function(){var eU=new qx.ui.menu.Menu;var eW=new qx.ui.menu.Button(cb,bH,this.__RO);var eX=new qx.ui.menu.Button(bG,bO,this.__RP);var eV=new qx.ui.menu.Button(bN,bF,this.__RQ);eW.addListener(cc,this.debugButton);eX.addListener(cc,this.debugButton);eV.addListener(cc,this.debugButton);eU.add(eW);eU.add(eX);eU.add(eV);return eU;}
},destruct:function(){this._disposeObjects(cm,bS,F,cs,J,ck,U,bc);}
});}
)();
...
,_onMouseOver:function(e){e.stopPropagation();this.addState(l);delete this.__vX;}
...
;var T=this.getMenu();if(T&&T.isVisible()){this.__vX=true;return;}
;this.removeState(l);}
...
,_onChangeMenuVisibility:function(e){if(!this.getMenu().isVisible()&&this.__vX){this.removeState(l);}
;}
}});}
)();
(function(){var g="arrow",f="qx.ui.toolbar.SplitButton",e="keydown",d="toolbar-splitbutton",c="button",b="keyup",a="execute";qx.Class.define(f,{extend:qx.ui.form.SplitButton,construct:function(h,i,j,k){qx.ui.form.SplitButton.call(this,h,i,j,k);this.removeListener(e,this._onKeyDown);this.removeListener(b,this._onKeyUp);}
,properties:{appearance:{refine:true,init:d},focusable:{refine:true,init:false}},members:{_forwardStates:{hovered:true,focused:true,left:true,middle:true,right:true},_createChildControlImpl:function(l,m){var n;switch(l){case c:n=new qx.ui.toolbar.Button;n.addListener(a,this._onButtonExecute,this);this._addAt(n,0);break;case g:n=new qx.ui.toolbar.MenuButton;this._addAt(n,1);break;};return n||qx.ui.form.SplitButton.prototype._createChildControlImpl.call(this,l);}
}});}
)();
