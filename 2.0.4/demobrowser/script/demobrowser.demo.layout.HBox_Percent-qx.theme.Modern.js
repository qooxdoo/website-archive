...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.HBox_Percent","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox_Percent-qx.theme.Modern.4be1da98ec49.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="demobrowser.demo.layout.HBox_Percent",e="50%",d="yellow",c="33%",b="green",a="main";qx.Class.define(f,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(g);g.add(this.getBox1());g.add(this.getBox2());g.add(this.getBox3());g.add(this.getBox4());g.add(this.getBox5());g.add(this.getBox6());}
,getBox1:function(){var i=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:a,backgroundColor:d,width:500,allowGrowX:false});var k=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var j=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var h=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});i.add(k,{width:e});i.add(j,{flex:1});i.add(h,{flex:1});return i;}
,getBox2:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:a,backgroundColor:d,width:500,allowGrowX:false});var o=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var n=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var l=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});m.add(o,{width:c});m.add(n,{width:c});m.add(l,{width:c,flex:1});return m;}
,getBox3:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:a,backgroundColor:d,allowGrowX:false});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var r=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var p=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});q.add(s,{width:e});q.add(r,{flex:1});q.add(p,{flex:1});return q;}
,getBox4:function(){var u=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:a,backgroundColor:d,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var t=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});u.add(w,{width:c,flex:1});u.add(v,{width:c,flex:1});u.add(t,{width:c,flex:1});return u;}
,getBox5:function(){var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:a,backgroundColor:d,width:200,allowGrowX:false});var A=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var z=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var x=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});y.add(A,{width:c,flex:1});y.add(z,{width:c,flex:1});y.add(x,{width:c,flex:1});return y;}
,getBox6:function(){var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:a,backgroundColor:d,width:500,allowGrowX:false});var E=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var D=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var B=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});C.add(E,{width:c,flex:1});C.add(D,{width:c,flex:1});C.add(B,{width:c,flex:1});return C;}
}});}
)();
