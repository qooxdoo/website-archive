...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Window","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Window-qx.theme.Classic.75a0537d77f6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="demobrowser.demo.widget.Window",k="Yes",j="Second Window",h="Page 1",g="bottom",f="Use move frame",d="Show Statusbar",c="icon/16/actions/dialog-cancel.png",b="icon/32/status/dialog-error.png",a="Show Close",bf="Third Window",be="icon/22/apps/utilities-calculator.png",bd="Show Maximize",bc="Allow Close",bb="Use resize frame",ba="No",Y="resizable",X="Allow Maximize",W="value",V="The second window",s="Page 3",t="move",q="Resizable ",r="First Window",o="Resized to: ",p="resize",m="Moveable",n="Demo loaded",w="Allow Minimize",x="Moved to: ",F="Open Modal Dialog 2",D="Do you want to fly to Berlin?",M="Open Modal Dialog 1",H="Resizable",R="top",P="Movable",z="icon/32/apps/office-address-book.png",U="Sorry, please click 'Yes'!",T="Basics",S="Modal",y="icon/16/apps/internet-telephony.png",B="Welcome to your first own Window.<br/>Have fun!",C="Application is ready",E="icon/16/apps/internet-feed-reader.png",G="Second Modal Dialog",I="icon/16/actions/dialog-ok.png",N="Page 2",Q="left",u="Show Minimize",v="First Modal Dialog",A="right",L="x",K="icon/16/apps/office-calendar.png",J="execute",O="changeValue";qx.Class.define(l,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);this.createWindow1();this.createWindow2();this.createWindow3();}
,createWindow1:function(){var bi=new qx.ui.window.Window(r,K);bi.setLayout(new qx.ui.layout.VBox(10));bi.setShowStatusbar(true);bi.setStatus(n);bi.open();this.getRoot().add(bi,{left:20,top:20});bi.addListener(t,function(e){this.debug(x+e.getData().left+L+e.getData().top);}
,this);bi.addListener(p,function(e){this.debug(o+e.getData().width+L+e.getData().height);}
,this);var bh=new qx.ui.basic.Atom(B,z);bh.setRich(true);bi.add(bh);var bg=new qx.ui.tabview.TabView;bi.add(bg,{flex:1});var bl=new qx.ui.tabview.Page(h);bg.add(bl);var bj=new qx.ui.tabview.Page(N);bg.add(bj);var bk=new qx.ui.tabview.Page(s);bg.add(bk);}
,createWindow2:function(){var bs=new qx.ui.window.Window(j,E);bs.setLayout(new qx.ui.layout.VBox(10));bs.setStatus(C);bs.open();this.getRoot().add(bs,{left:350,top:120});var bB=new qx.ui.basic.Atom(V,be);bs.add(bB);var bm=new qx.ui.container.Composite;bm.setLayout(new qx.ui.layout.HBox(10));bs.add(bm,{flex:1});var bu=new qx.ui.groupbox.GroupBox(T);bu.setLayout(new qx.ui.layout.VBox(4));bm.add(bu,{flex:1});var bp=new qx.ui.form.CheckBox(a);bp.setValue(true);bp.addListener(O,function(e){bs.setShowClose(e.getData());}
);bu.add(bp);var bA=new qx.ui.form.CheckBox(bd);bA.setValue(true);bA.addListener(O,function(e){bs.setShowMaximize(e.getData());}
);bu.add(bA);var bt=new qx.ui.form.CheckBox(u);bt.setValue(true);bt.addListener(O,function(e){bs.setShowMinimize(e.getData());}
);bu.add(bt);var bw=new qx.ui.form.CheckBox(bc);bw.setValue(true);bw.addListener(O,function(e){bs.setAllowClose(e.getData());}
);bu.add(bw);var bC=new qx.ui.form.CheckBox(X);bC.setValue(true);bC.addListener(O,function(e){bs.setAllowMaximize(e.getData());}
);bu.add(bC);var br=new qx.ui.form.CheckBox(w);br.setValue(true);br.addListener(O,function(e){bs.setAllowMinimize(e.getData());}
);bu.add(br);var bn=new qx.ui.form.CheckBox(d);bn.setValue(false);bn.addListener(O,function(e){bs.setShowStatusbar(e.getData());}
);bu.add(bn);var bE=new qx.ui.groupbox.GroupBox(H);bE.setLayout(new qx.ui.layout.VBox(4));bm.add(bE,{flex:1});var by=new qx.ui.form.CheckBox(bb);by.setValue(true);by.addListener(O,function(e){bs.setUseResizeFrame(e.getData());}
);bE.add(by);var bz=[R,A,g,Q];for(var i=0;i<bz.length;i++){var bx=bz[i];var bq=new qx.ui.form.CheckBox(q+bx).set({value:true});bq.bind(W,bs,Y+qx.lang.String.firstUp(bx));bE.add(bq);}
;var bo=new qx.ui.groupbox.GroupBox(m);bo.setLayout(new qx.ui.layout.VBox(4));bm.add(bo,{flex:1});var bv=new qx.ui.form.CheckBox(P);bv.setValue(true);bv.addListener(O,function(e){bs.setMovable(e.getData());}
);bo.add(bv);var bD=new qx.ui.form.CheckBox(f);bD.addListener(O,function(e){bs.setUseMoveFrame(e.getData());}
);bo.add(bD);}
,createWindow3:function(){var bF=new qx.ui.window.Window(bf,y);bF.setLayout(new qx.ui.layout.VBox);bF.setMinWidth(200);bF.setMaxWidth(450);bF.setMaxHeight(400);bF.setAllowMaximize(false);bF.open();this.getRoot().add(bF,{left:100,top:250});var bG=this.getModalWindow1();var bH=new qx.ui.form.Button(M,K);bH.addListener(J,bG.open,bG);bF.add(bH);}
,getModalWindow1:function(){var bJ=new qx.ui.window.Window(v);bJ.setLayout(new qx.ui.layout.VBox(10));bJ.setModal(true);bJ.moveTo(150,150);this.getRoot().add(bJ);var bI=this.getModalWindow2();var bL=new qx.ui.form.Button(F,K);bL.addListener(J,bI.open,bI);bJ.add(bL);var bK=new qx.ui.form.CheckBox(S);bK.setValue(true);bJ.add(bK);bK.addListener(O,function(e){bJ.setModal(e.getData());}
);return bJ;}
,getModalWindow2:function(){var bN=new qx.ui.window.Window(G);bN.setLayout(new qx.ui.layout.VBox(10));bN.setModal(true);bN.setShowClose(false);bN.moveTo(300,300);this.getRoot().add(bN);var bM=new qx.ui.basic.Atom(D,b);bN.add(bM);var bP=new qx.ui.container.Composite;bP.setLayout(new qx.ui.layout.HBox(10,A));bN.add(bP);var bQ=new qx.ui.form.Button(k,I);bQ.addListener(J,function(e){bN.close();}
);bP.add(bQ);var bO=new qx.ui.form.Button(ba,c);bO.addListener(J,function(e){alert(U);}
);bP.add(bO);return bN;}
}});}
)();
...
(function(){var m="__qR",k="qx.event.type.Data",j="barRight",h="beforeChangeSelection",g="horizontal",f="close-button",d="Index should be less than : ",c="tabview",b="vertical",a="_applyBarPosition",E="barLeft",D="qx.ui.tabview.TabView",C="barTop",B="barBottom",A="bottom",z="button",y="qx.debug",x="changeSelection",w="Incompatible child for TabView: ",v="top",t="left",u="close",r="right",s="page",p="firstTab",q="bar",n="lastTab",o="pane";qx.Class.define(D,{extend:qx.ui.core.Widget,implement:qx.ui.core.ISingleSelection,include:[qx.ui.core.MContentPadding],construct:function(F){qx.ui.core.Widget.call(this);this.__qQ={top:C,right:j,bottom:B,left:E};this._createChildControl(q);this._createChildControl(o);var G=this.__qR=new qx.ui.form.RadioGroup;G.setWrap(false);G.addListener(x,this._onChangeSelection,this);if(F!=null){this.setBarPosition(F);}
else {this.initBarPosition();}
;}
,events:{"changeSelection":k},properties:{appearance:{refine:true,init:c},barPosition:{check:[t,r,v,A],init:v,apply:a}},members:{__qR:null,_createChildControlImpl:function(H,I){var J;switch(H){case q:J=new qx.ui.container.SlideBar();J.setZIndex(10);this._add(J);break;case o:J=new qx.ui.container.Stack;J.setZIndex(5);this._add(J,{flex:1});break;};return J||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,H);}
...
;}
;var L=K.getButton();var M=this.getChildControl(q);var O=this.getChildControl(o);K.exclude();M.add(L);O.add(K);this.__qR.add(L);K.addState(this.__qQ[this.getBarPosition()]);K.addState(n);var N=this.getChildren();if(N[0]==K){K.addState(p);}
...
;var R=P.getButton();var S=this.getChildControl(q);var U=this.getChildControl(o);P.exclude();S.addAt(R,Q);U.addAt(P,Q);this.__qR.add(R);P.addState(this.__qQ[this.getBarPosition()]);T=this.getChildren();if(Q==T.length-1){P.addState(n);}
...
;}
;Y.remove(X);bb.remove(V);this.__qR.remove(X);V.removeState(this.__qQ[this.getBarPosition()]);if(V.hasState(p)){V.removeState(p);if(ba[0]){ba[0].addState(p);}
;}
...
,__qQ:null,_applyBarPosition:function(bd,be){var bf=this.getChildControl(q);var bk=bd==t||bd==r;var bi=bd==r||bd==A;var bj=bk?qx.ui.layout.HBox:qx.ui.layout.VBox;var bm=this._getLayout();if(bm&&bm instanceof bj){}
else {this._setLayout(bm=new bj);}
;bm.setReversed(bi);bf.setOrientation(bk?b:g);var bl=this.getChildren();if(be){var bg=this.__qQ[be];bf.removeState(bg);for(var i=0,l=bl.length;i<l;i++){bl[i].removeState(bg);}
;}
;if(bd){var bh=this.__qQ[bd];bf.addState(bh);for(var i=0,l=bl.length;i<l;i++){bl[i].addState(bh);}
;}
;}
,getSelection:function(){var bn=this.__qR.getSelection();var bo=[];for(var i=0;i<bn.length;i++){bo.push(bn[i].getUserData(s));}
;return bo;}
,setSelection:function(bp){var bq=[];for(var i=0;i<bp.length;i++){bq.push(bp[i].getChildControl(z));}
;this.__qR.setSelection(bq);}
,resetSelection:function(){this.__qR.resetSelection();}
,isSelected:function(br){var bs=br.getChildControl(z);return this.__qR.isSelected(bs);}
,isSelectionEmpty:function(){return this.__qR.isSelectionEmpty();}
,getSelectables:function(bt){var bu=this.__qR.getSelectables(bt);var bv=[];for(var i=0;i<bu.length;i++){bv.push(bu[i].getUserData(s));}
;return bv;}
...
},destruct:function(){this._disposeObjects(m);this.__qQ=null;}
});}
)();
...
,__mT:function(e){var m=e.getOldData()[0];var n=e.getData()[0];if(m){if(this.isDynamic()){m.exclude();}
else {m.hide();}
;}
;if(n){n.show();}
;}
