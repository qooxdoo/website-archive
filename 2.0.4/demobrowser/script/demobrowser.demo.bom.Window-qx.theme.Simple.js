...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window-qx.theme.Simple.a356fad9528d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var q="Open Native Window",p="Open Native Modal Window",o="demobrowser.demo.bom.Window",n="Modal Window closed?",m="http://sourceforge.net",l="window1",k="window3",j="http://slashdot.org",i="Window closed?",h="http://qooxdoo.org",c="demobrowser/demo/html/ModalWindow.html",g="Open Faked Native Modal Window",f="window2",b="#eee",a="click",d="button";qx.Class.define(o,{extend:qx.application.Native,members:{__BO:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__BO=[h,m,j,r.toUri(c)];var u=qx.bom.Input.create(d);qx.bom.Input.setValue(u,q);document.body.appendChild(u);qx.event.Registration.addListener(u,a,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__BO[0],l,x);}
...
,this);var s=qx.bom.Input.create(d);qx.bom.Input.setValue(s,p);document.body.appendChild(s);qx.event.Registration.addListener(s,a,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__BO[3],f,y,true);}
...
,this);var v=qx.bom.Input.create(d);qx.bom.Input.setValue(v,g);document.body.appendChild(v);qx.event.Registration.addListener(v,a,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(b);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__BO[0],k,A,true,false);}
,this);}
...
(function(){var j="no",i="px",h="qx.bom.Window",g="Cross-Domain Scripting problem: Could not resize window!",f="' is not supported for native windows.",e="interval",d="dialogWidth",c=":",b="yes",a="dialogTop",y="qxNativeWindow",x="Cross-Domain Scripting problem: Could not move window!",w="",v="javascript:/",u="dialogLeft",t="dialogHeight",s="' is not supported for modal windows.",r="scrollbars",q=";",p="scroll",n=",",o="resizable",l="Option '",m='load',k="=";qx.Class.define(h,{statics:{__jK:null,__Nd:null,__iI:null,__Ne:{"top":a,left:u,width:d,height:t,scrollbars:p,resizable:o},__Nf:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Ng:function(){return window.showModalDialog!=null;}
,open:function(z,name,A,B,C,D,self){var H=null;if(z==null){z=v;}
;if(name==null){name=y+new Date().getTime();}
;if(C==null){C=true;}
;var E=this.__Nh(A,B&&C);if(B){if(this.__Ng()&&C){H=window.showModalDialog(z,[window.self],E);}
else {this.getBlocker().block();if(this.__iI==null){this.__iI=new qx.event.Timer(500);this.__iI.addListener(e,this.__Ni,this);}
;this.__Nd=window.open(z,name,E);this.__iI.restart();H=this.__Nd;}
;}
else {H=window.open(z,name,E);}
;if(H&&D&&(D instanceof Function)){var G=self||H;var F=qx.lang.Function.bind(D,G);qx.bom.Event.addNativeListener(H,m,function(){F();qx.bom.Event.removeNativeListener(H,m,arguments.callee);}
);}
;return H;}
,__Nh:function(I,J){var K;var N;var L=[];if(J&&this.__Ng()){for(var M in I){if(qx.bom.Window.__Ne[M]){var O=w;if(M!=r&&M!=o){O=i;}
;N=qx.bom.Window.__Ne[M]+c+I[M]+O;L.push(N);}
else {qx.log.Logger.warn(l+M+s);}
;}
;K=L.join(q);}
else {for(var M in I){if(qx.bom.Window.__Nf[M]){if(qx.lang.Type.isBoolean(I[M])){N=M+k+(I[M]?b:j);}
else {N=M+k+I[M];}
;L.push(N);}
else {qx.log.Logger.warn(l+M+f);}
;}
;K=L.join(n);}
;return K;}
,__Ni:function(){if(this.isClosed(this.__Nd)){this.getBlocker().unblock();this.__iI.stop();}
;}
,getBlocker:function(){if(this.__jK==null){this.__jK=new qx.bom.Blocker;}
;return this.__jK;}
