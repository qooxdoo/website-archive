...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor-qx.theme.Indigo.3155b9e59382.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="__iI",h="Window: ",g="interval",f="Done! (Registry: ",e="Label: ",d=" (Registry: ",c="demobrowser.demo.test.Destructor",b="Round: ",a=")";qx.Class.define(c,{extend:qx.application.Standalone,members:{__cR:null,__QY:0,__iI:null,main:function(){qx.application.Standalone.prototype.main.call(this);this.__cR=[];this.currentTest=this.testWindows;this.__iI=new qx.event.Timer(1000);this.__iI.addListener(g,this.runTest,this);this.__iI.start();}
,runTest:function(){this.__QY++;var m=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug(b+this.__QY+d+m+a);this.currentTest();qx.ui.core.queue.Manager.flush();var k=this.__cR;for(var i=0,l=k.length;i<l;i++){k[i].destroy();}
...
;}
,testWindows:function(){for(var i=0;i<5;i++){var o=new qx.ui.window.Window(h+i);o.open();this.__cR.push(o);}
;}
