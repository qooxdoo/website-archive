...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType-qx.theme.Modern.92cbed75f93e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var d="_applySearchString",c="demobrowser.demo.data.filter.SearchAsYouTypeFilter",b="String",a="";qx.Class.define(c,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__ug=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__ts=null;}
,properties:{searchString:{check:b,apply:d,init:a}},members:{__ts:null,__ug:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();if(this.__ts!=null){i.stop(this.__ts);this.__ts=null;}
;this.__ts=i.start(function(){this.__ug.update();this.__ts=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__ug=null;}
});}
)();
