...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Spacer_Grid","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Spacer_Grid-qx.theme.Simple.9777c981f597.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var d="demobrowser.demo.layout.Spacer_Grid",c="yellow",b="green",a="main";qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var f=new qx.ui.layout.VBox();f.setSpacing(10);var e=new qx.ui.container.Composite(f);e.setPadding(20);this.getRoot().add(e,{edge:0});e.add(this.getGrid1());e.add(this.getGrid2());}
,getGrid1:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:a,backgroundColor:c,allowGrowX:false,allowGrowY:false});g.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:0,column:0});g.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:0,column:1});g.add(new qx.ui.core.Spacer(0,10),{row:1,column:0});g.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:2,column:0});g.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:2,column:1});g.add(new qx.ui.core.Spacer(0,20),{row:3,column:0});g.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:4,column:0});g.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:4,column:1});return g;}
,getGrid2:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:a,backgroundColor:c,allowGrowX:false,allowGrowY:false});h.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:0,column:0});h.add(new qx.ui.core.Spacer(10,0),{row:0,column:2});h.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:0,column:3});h.add(new qx.ui.core.Spacer(30,0),{row:1,column:4});h.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:0,column:5});h.add(new qx.ui.core.Spacer(0,5),{row:1,column:0});h.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:2,column:0});h.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:2,column:3});h.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}),{row:2,column:5});return h;}
}});}
)();
