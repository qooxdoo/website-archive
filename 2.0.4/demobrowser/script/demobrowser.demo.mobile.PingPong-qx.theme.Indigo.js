...
var envinfo = {"engine.name":"webkit","locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.PingPong","qx.mobile.emulatetouch":true,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong-qx.theme.Indigo.b87833da7035.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var u="demobrowser.demo.mobile.PingPong",t="<b>This demo is supposed to be run in a WebKit-based browser.</b>",s="engine.name",r="black",q="20px",p="none",o="30px",n="qx.debug",m="0px",l="webkit",d="12px",k="innerHTML",h="green",c='Lucida Grande',b="absolute",g="touchmove",f="div",i="left",a="right",j="100%";qx.Class.define(u,{extend:qx.application.Native,members:{__Qr:null,__Qs:null,__Qt:null,__Qu:null,__Qv:5,__Qw:1,__Qx:1,__Qy:null,__Qz:null,__QA:null,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(n)){qx.log.appender.Native;qx.log.appender.Console;}
;var z={"width":j,"height":j,"backgroundColor":r,"margin":m,"userSelect":p};var C=new qx.html.Element(f,z);C.useElement(document.body);C.setRoot(true);if(qx.core.Environment.get(s)!=l){var B={"color":h,"font-family":c,"font-size":d,"position":b,"left":o,"top":q};var A=new qx.html.Element(f,B);C.add(A);A.setAttribute(k,t);return;}
;var v=this.__QE(i);C.add(v);var w=this.__QE(a);C.add(w);this.__Qs=this.__QF(i);v.add(this.__Qs);v.addListener(g,qx.lang.Function.bind(this.__DE,this,this.__Qs),this);this.__Qr=this.__QF(a);w.add(this.__Qr);w.addListener(g,qx.lang.Function.bind(this.__DE,this,this.__Qr),this);this.__Qt=this.__QG();C.add(this.__Qt);this.__Qz=this.__QH();v.add(this.__Qz);this.__QA=this.__QH();w.add(this.__QA);this.__Qy=[0,0];this.__QB();}
,__QB:function(){this.__Qt.setStyles({"left":"200px","top":"200px"});this.__Qu=new qx.event.Timer(40);this.__Qu.addListener("interval",function(){var x=(parseInt(this.__Qt.getStyle("left"))+this.__Qv*this.__Qw);var y=(parseInt(this.__Qt.getStyle("top"))+this.__Qv*this.__Qx);this.__Qt.setStyle("left",x+"px");this.__Qt.setStyle("top",y+"px");this.__QD();}
,this);this.__Qu.start();}
,__QC:function(D){this.__Qu.stop();this.__Qu.dispose();this.__Qv=5;this.__Qy[D]=this.__Qy[D]+1;this.__Qz.setAttribute("innerHTML",this.__Qy[0]);this.__QA.setAttribute("innerHTML",this.__Qy[1]);this.__QB();}
,__QD:function(){var F=this.getBoundsFor(this.__Qt);if(F.top<=0){this.__Qx=1;}
;if(F.bottom>=window.innerHeight-5){this.__Qx=-1;}
;if(F.left<=0||F.right>=window.innerWidth){this.__QC(F.left<=0?1:0);}
;var G=this.getBoundsFor(this.__Qs);if(F.left<=G.right&&F.bottom>=G.top&&F.top<=G.bottom){this.__Qw=1;this.__Qv=Math.min(this.__Qv+1,20);}
;var E=this.getBoundsFor(this.__Qr);if(F.right>=E.left&&F.bottom>=E.top&&F.top<=E.bottom){this.__Qw=-1;this.__Qv=Math.min(this.__Qv+1,20);}
;}
,__DE:function(H,e){H.setStyles({"top":(e.getDocumentTop()-50)+"px"});}
,getBoundsFor:function(I){return qx.bom.element.Location.get(I.getDomElement());}
,__QE:function(J){var K={"width":"50%","height":"100%","position":"absolute","backgroundColor":"black"};if(J=="left"){K["border-right"]="1px solid white";}
else {K["left"]="50%";K["border-left"]="1px solid white";}
;return new qx.html.Element("div",K);}
,__QF:function(L){var M={"width":"30px","height":"100px","top":"100px","position":"absolute","backgroundColor":"white"};M[L]="20px";return new qx.html.Element("div",M);}
,__QG:function(){var N={"width":"20px","height":"20px","position":"absolute","backgroundColor":"white","userSelect":"none"};return new qx.html.Element("div",N);}
,__QH:function(){var O={"width":"100%","height":"100%","textAlign":"center","fontSize":"15em","color":"#333","fontFamily":"Arial"};var P=new qx.html.Element("div",O);P.setAttribute("innerHTML","0");return P;}
}});}
)();
