...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Window-qx.theme.Indigo.1250a0d9a5d2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="resize",n="qx.ui.root.Page",m="mshtml",l="The root widget does not support decorators with 'left', or 'top' insets!",k="gecko",j="paddingLeft",i="$$widget",h="The root widget does not support 'left', or 'top' paddings!",g="left",f="paddingTop",b="qxIsRootPage",d="absolute",c="engine.name",a="div";qx.Class.define(n,{extend:qx.ui.root.Abstract,construct:function(p){this.__kr=p;qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());this.setZIndex(10000);qx.ui.core.queue.Layout.add(this);this.addListener(o,this.__jR,this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==m)){this.setKeepFocus(true);}
;}
,members:{__iI:null,__kr:null,_createContainerElement:function(){var r=this.__kr.createElement(a);this.__kr.body.appendChild(r);var q=new qx.html.Root(r);q.setStyles({position:d,textAlign:g});q.setAttribute(i,this.toHashCode());if((qx.core.Environment.get(c)==k)){q.setAttribute(b,1);}
;return q;}
...
,__jR:function(e){this.getContainerElement().setStyles({width:0,height:0});this.getContentElement().setStyles({width:0,height:0});}
...
;this.__BY=y;y.style.overflow=f;y.style.textAlign=k;this.__Ca=z||false;this.__Cb=A||false;this.__Cc();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(h)==b)){this.setKeepFocus(true);}
;var window=qx.dom.Node.getWindow(y);qx.event.Registration.addListener(window,m,this._onWindowResize,this);}
,members:{__Ca:false,__Cb:false,__BY:null,__Cc:function(){if(this.__Ca||this.__Cb){var B=qx.bom.element.Dimension.getSize(this.__BY);if(this.__Ca&&B.width<1){throw new Error(l+this.__BY+a+this+s);}
;if(this.__Cb){if(B.height<1){throw new Error(l+this.__BY+a+this+w);}
;if(B.height>=1&&qx.bom.element.Style.get(this.__BY,g,3)==x){qx.bom.element.Style.set(this.__BY,g,B.height+v);}
;}
;qx.event.Registration.addListener(this.__BY,m,this._onResize,this);}
;}
,_createContainerElement:function(){var C=this.__BY;if(this.__Ca||this.__Cb){var G=document.createElement(n);C.appendChild(G);if((qx.core.Environment.get(h)==b)&&qx.core.Environment.get(r)==6){var F=qx.dom.Node.getBodyElement(C);var E;var I;var H=false;var D=qx.dom.Hierarchy.getAncestors(C);for(var i=0,j=D.length;i<j;i++){E=D[i];if(E!=F){I=qx.bom.element.Style.get(E,u);if(I==d){H=true;break;}
;}
else {break;}
;}
...
,this,0);return J;}
,_onResize:function(e){var K=e.getData();if((K.oldWidth!==K.width)&&this.__Ca||(K.oldHeight!==K.height)&&this.__Cb){qx.ui.core.queue.Layout.add(this);}
;}
,_onWindowResize:function(){if(qx.ui.popup&&qx.ui.popup.Manager){qx.ui.popup.Manager.getInstance().hideAll();}
;if(qx.ui.menu&&qx.ui.menu.Manager){qx.ui.menu.Manager.getInstance().hideAll();}
;}
,_computeSizeHint:function(){var P=this.__Ca;var M=this.__Cb;if(!P||!M){var L=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {L={};}
;var Q=qx.bom.element.Dimension;if(P){var O=Q.getContentWidth(this.__BY);L.width=O;L.minWidth=O;L.maxWidth=O;}
;if(M){var N=Q.getContentHeight(this.__BY);L.height=N;L.minHeight=N;L.maxHeight=N;}
;return L;}
},defer:function(R,S){qx.ui.core.MLayoutHandling.remap(S);}
,destruct:function(){qx.event.Registration.removeListener(this.__BY,m,this._onResize,this);this.__BY=null;}
});}
)();
