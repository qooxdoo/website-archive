...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Environment","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Environment-qx.theme.Modern.543e8c537feb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="demobrowser.demo.bom.Environment",n="<tr><td colspan='2'>&nbsp;</td></tr>",m="",l="<tr><td colspan='2'><h2>Asynchronous checks</h2></td></tr>",k="<h2>Synchronous checks</h2>",j="<tr><td colspan='2'><b>",h=".",g="<table border='0'>",f="</b></td></tr>",e="<tr><td>",b="</td><td>",d="output",c="</table>",a="</td></tr>";qx.Class.define(o,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var u=new qx.util.StringBuilder();u.add(k);u.add(g);var v=qx.core.Environment.getChecks();var q=qx.lang.Object.getKeys(v);q.sort();var w=m;for(var i=0;i<q.length;i++){var t=q[i];var s=t.split(h)[0];if(s!=w){w=s;u.add(n);u.add(j+s+f);}
;u.add(e,t,b,qx.lang.Json.stringify(qx.core.Environment.get(t),null,2),a);}
;u.add(l);v=qx.core.Environment.getAsyncChecks();var p=qx.lang.Object.getLength(v);q=qx.lang.Object.getKeys(v);if(p){for(var i=0;i<q.length;i++){var t=q[i];qx.core.Environment.getAsync(t,function(x){u.add(e,this,b,qx.lang.Json.stringify(x,null,2),a);p--;if(p===0){u.add(c);var y=document.getElementById(d);y.innerHTML=u.get();}
;}
,t);}
;}
...
;var G=qx.bom.client.OperatingSystem.getName();return (G==c||G==e)&&qx.bom.client.Flash.__Jv(w,H);}
,getStrictSecurityModel:function(){var I=qx.bom.client.Flash.getVersion();if(I==m){return false;}
;var J=I.split(l);if(J[0]<10){return qx.bom.client.Flash.__Jv(u,I);}
else {return qx.bom.client.Flash.__Jv(d,I);}
;}
,_cachedSupportsVersion:{},__Jv:function(K,L){var O=K.split(l);var N=L||qx.bom.client.Flash.getVersion();N=N.split(l);for(var i=0;i<O.length;i++){var M=parseInt(N[i],10)-parseInt(O[i],10);if(M>0){return true;}
...
(function(){var r="ipod",q="tablet",p="g",o="xbox",n="pc",m="\.",l="mobile",k="(",j=")",i="iPhone",c="|",h="qx.bom.client.Device",f="wii",b="desktop",a="ipad",e="device.name",d="ds",g="device.type";qx.Bootstrap.define(h,{statics:{__dg:{"iPod":r,"iPad":a,"iPhone":i,"PSP":"psp","PLAYSTATION 3":"ps3","Nintendo Wii":f,"Nintendo DS":d,"XBOX":"xbox","Xbox":o},getName:function(){var u=[];for(var t in this.__dg){u.push(t);}
;var v=new RegExp(k+u.join(c).replace(/\./g,m)+j,p);var s=v.exec(navigator.userAgent);if(s&&s[1]){return qx.bom.client.Device.__dg[s[1]];}
;return n;}
