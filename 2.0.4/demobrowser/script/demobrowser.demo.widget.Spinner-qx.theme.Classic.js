...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Spinner-qx.theme.Classic.47a228caee0d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="Disabled",s="Not Editable",r="demobrowser.demo.widget.Spinner",q="ChangeValue: ",p="Stepped",o="Wrap",n="-3000",m="30",l="300",k="3000",d="changeValue",j="-30",h="Simple",c="Number format",b="right",g="100",f="left",i="0",a="middle";qx.Class.define(r,{extend:qx.application.Standalone,members:{addSimpleSpinner:function(u,v){var w=new qx.ui.form.Spinner();u.add(new qx.ui.basic.Label(h),{column:0,row:v});u.add(new qx.ui.basic.Label(i),{column:1,row:v});u.add(w,{column:2,row:v});u.add(new qx.ui.basic.Label(g),{column:3,row:v});w.addListener(d,function(e){this.debug(q+e.getData());}
);}
,addNonEditableSpinner:function(x,y){var z=new qx.ui.form.Spinner(0,50,100);z.setEditable(false);x.add(new qx.ui.basic.Label(s),{column:0,row:y});x.add(new qx.ui.basic.Label(i),{column:1,row:y});x.add(z,{column:2,row:y});x.add(new qx.ui.basic.Label(g),{column:3,row:y});}
,addWrappingSpinner:function(A,B){var C=new qx.ui.form.Spinner(-30,30,30);C.setWrap(true);A.add(new qx.ui.basic.Label(o),{column:0,row:B});A.add(new qx.ui.basic.Label(j),{column:1,row:B});A.add(C,{column:2,row:B});A.add(new qx.ui.basic.Label(m),{column:3,row:B});}
,addSteppedSpinner:function(D,E){var F=new qx.ui.form.Spinner(-3000,0,3000).set({singleStep:25});D.add(new qx.ui.basic.Label(p),{column:0,row:E});D.add(new qx.ui.basic.Label(n),{column:1,row:E});D.add(F,{column:2,row:E});D.add(new qx.ui.basic.Label(k),{column:3,row:E});}
,addDisabledSpinner:function(G,H){var I=new qx.ui.form.Spinner;I.setEnabled(false);G.add(new qx.ui.basic.Label(t),{column:0,row:H});G.add(new qx.ui.basic.Label(i),{column:1,row:H});G.add(I,{column:2,row:H});G.add(new qx.ui.basic.Label(g),{column:3,row:H++});}
,addFormattedSpinner:function(J,K){var L=new qx.ui.form.Spinner(0,200,300);L.setSingleStep(0.5);L.setWidth(70);var M=new qx.util.format.NumberFormat();M.setMinimumFractionDigits(2);M.setMaximumFractionDigits(2);L.setNumberFormat(M);J.add(new qx.ui.basic.Label(c),{column:0,row:K});J.add(new qx.ui.basic.Label(i),{column:1,row:K});J.add(L,{column:2,row:K});J.add(new qx.ui.basic.Label(l),{column:3,row:K++});}
,main:function(){qx.application.Standalone.prototype.main.call(this);var O=new qx.ui.layout.Grid(10,8);O.setColumnAlign(0,f,a);O.setColumnAlign(1,b,a);O.setColumnAlign(2,f,a);O.setColumnAlign(3,f,a);var N=new qx.ui.container.Composite(O);N.setPadding(10);this.getRoot().add(N,{left:0,top:0});this.addSimpleSpinner(N,0);this.addNonEditableSpinner(N,1);this.addWrappingSpinner(N,2);this.addSteppedSpinner(N,3);this.addDisabledSpinner(N,4);this.addFormattedSpinner(N,5);}
}});}
)();
