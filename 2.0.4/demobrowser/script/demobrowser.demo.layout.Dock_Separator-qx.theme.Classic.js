...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Dock_Separator","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Dock_Separator-qx.theme.Classic.729e48efa083.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var q="demobrowser.demo.layout.Dock_Separator",p="x",o="y",n="separator-vertical",m="yellow",l="center",k="red",j="north",i="south",h="separator-horizontal",c="west",g="east",f="green",b="fuchsia",a="orange",e="blue",d="main";qx.Class.define(q,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var s=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(s);var t=new qx.ui.layout.Dock();t.setSeparatorX(h);t.setSeparatorY(n);t.setSpacingX(5);t.setSpacingY(5);var r=new qx.ui.container.Composite(t).set({decorator:d,backgroundColor:m,allowGrowX:false});var y=new qx.ui.core.Widget().set({decorator:d,backgroundColor:k});var x=new qx.ui.core.Widget().set({decorator:d,backgroundColor:e});var w=new qx.ui.core.Widget().set({decorator:d,backgroundColor:a});var v=new qx.ui.core.Widget().set({decorator:d,backgroundColor:f});var u=new qx.ui.core.Widget().set({decorator:d,backgroundColor:b});r.add(y,{edge:j});r.add(x,{edge:c});r.add(w,{edge:i});r.add(v,{edge:g});r.add(u,{edge:l});s.add(r);var t=new qx.ui.layout.Dock();t.setSort(o);t.setSeparatorX(h);t.setSeparatorY(n);t.setSpacingX(5);t.setSpacingY(5);var r=(new qx.ui.container.Composite(t)).set({decorator:d,backgroundColor:m,allowGrowX:false});var y=new qx.ui.core.Widget().set({decorator:d,backgroundColor:k});var x=new qx.ui.core.Widget().set({decorator:d,backgroundColor:e});var w=new qx.ui.core.Widget().set({decorator:d,backgroundColor:a});var v=new qx.ui.core.Widget().set({decorator:d,backgroundColor:f});var u=new qx.ui.core.Widget().set({decorator:d,backgroundColor:b});r.add(y,{edge:j});r.add(x,{edge:c});r.add(w,{edge:i});r.add(v,{edge:g});r.add(u,{edge:l});s.add(r);var t=new qx.ui.layout.Dock();t.setSort(p);t.setSeparatorX(h);t.setSeparatorY(n);t.setSpacingX(5);t.setSpacingY(5);var r=(new qx.ui.container.Composite(t)).set({decorator:d,backgroundColor:m,allowGrowX:false});var y=new qx.ui.core.Widget().set({decorator:d,backgroundColor:k});var x=new qx.ui.core.Widget().set({decorator:d,backgroundColor:e});var w=new qx.ui.core.Widget().set({decorator:d,backgroundColor:a});var v=new qx.ui.core.Widget().set({decorator:d,backgroundColor:f});var u=new qx.ui.core.Widget().set({decorator:d,backgroundColor:b});r.add(y,{edge:j});r.add(x,{edge:c});r.add(w,{edge:i});r.add(v,{edge:g});r.add(u,{edge:l});s.add(r);var t=new qx.ui.layout.Dock();t.setSeparatorX(h);t.setSeparatorY(n);t.setSpacingX(5);t.setSpacingY(5);t.setConnectSeparators(true);var r=new qx.ui.container.Composite(t).set({decorator:d,backgroundColor:m,allowGrowX:false});var y=new qx.ui.core.Widget().set({decorator:d,backgroundColor:k});var x=new qx.ui.core.Widget().set({decorator:d,backgroundColor:e});var w=new qx.ui.core.Widget().set({decorator:d,backgroundColor:a});var v=new qx.ui.core.Widget().set({decorator:d,backgroundColor:f});var u=new qx.ui.core.Widget().set({decorator:d,backgroundColor:b});r.add(y,{edge:j});r.add(x,{edge:c});r.add(w,{edge:i});r.add(v,{edge:g});r.add(u,{edge:l});s.add(r);}
}});}
)();
