...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.List","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.List-qx.theme.Modern.dc72ea9ab9a7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var ci=qx.data.marshal.Json.createModel(cf);var ca=this.__RA=new qx.ui.list.List(ci).set({scrollbarX:A,selectionMode:Q,height:280,width:150,labelPath:x,iconPath:R,iconOptions:{converter:function(cm){return h+cm+H;}
...
,onSelectionModeChange:function(e){var cF=e.getData()[0].getUserData(w);this.__RA.setSelectionMode(cF);if(cF==K||cF==L){this.__RB.setEnabled(false);this.__RC.setEnabled(true);}
else if(cF==Q||cF==c){this.__RB.setEnabled(true);this.__RC.setEnabled(false);}
;}
,onShowModeChange:function(e){var cG=e.getData()[0].getUserData(w);this.setShowMode(cG);}
,onDragCheckChange:function(e){if(e.getData()){var cH=this.__RA.getSelectionMode();if(cH==K||cH==L){this.debug(bg);}
;}
;this.__RA.setDragSelection(e.getData());}
,onQuickCheckChange:function(e){if(e.getData()){var cI=this.__RA.getSelectionMode();if(cI==Q||cI==P){this.debug(S);}
;}
;this.__RA.setQuickSelection(e.getData());}
}});}
)();
