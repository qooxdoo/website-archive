...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.GroupedList-qx.theme.Modern.798b342b4483.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
};T.setDelegate(V);T.setSelection(this.__Dm.getSelection());return U;}
,createThirdExample:function(){var bc=new qx.ui.container.Composite(new qx.ui.layout.Canvas());var be=new qx.ui.basic.Label(z).set({font:n});bc.add(be);var bb=this.__Rz=new qx.ui.list.List().set({height:280,width:150,labelPath:p,labelOptions:{converter:function(bf,bg){return bg?bf+o+bg.getLastname():v;}
...
};bb.setDelegate(bd);bb.setSelection(this.__Dm.getSelection());return bc;}
},destruct:function(){this.__Dm.dispose();this.__Ry.dispose();this.__Rz.dispose();this.__Dm=this.__Ry=this.__Rz=null;}
});}
)();
