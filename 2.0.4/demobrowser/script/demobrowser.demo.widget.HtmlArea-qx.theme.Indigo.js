...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.HtmlArea-qx.theme.Indigo.d3c1ae7b42c3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__yU:function(e){var co=window.prompt(bl,x);this.insertHtml(co);}
,__yV:function(){var cq=new qx.ui.form.SelectBox;cq.set({toolTipText:m,focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});cq.add(new qx.ui.form.ListItem(x));var cr=[X,O,r,U,f,J,M,bz,g,ba,R];var cp;for(var i=0,j=cr.length;i<j;i++){cp=new qx.ui.form.ListItem(cr[i]);cp.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString(bU+cr[i])});cq.add(cp);}
;cq.addListener(C,function(e){var cs=e.getData()[0].getLabel();if(cs!=x){this.setFontFamily(cs);cq.setSelection([cq.getChildren()[0]]);}
;}
,this.__yO);return cq;}
,__yW:function(){var cu=new qx.ui.form.SelectBox;cu.set({toolTipText:bx,focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});cu.add(new qx.ui.form.ListItem(x));var ct;for(var i=1;i<=7;i++){ct=new qx.ui.form.ListItem(i+x);ct.set({focusable:false,keepFocus:true});cu.add(ct);}
;cu.addListener(C,function(e){var cv=e.getData()[0].getLabel();if(cv!=x){this.setFontSize(cv);cu.setSelection([cu.getChildren()[0]]);}
;}
,this.__yO);return cu;}
,__yX:function(){return [{bold:{text:l,image:D,action:this.__yO.setBold},italic:{text:bh,image:T,action:this.__yO.setItalic},underline:{text:V,image:bg,action:this.__yO.setUnderline},strikethrough:{text:Q,image:bO,action:this.__yO.setStrikeThrough},removeFormat:{text:bT,image:d,action:this.__yO.removeFormat}},{alignLeft:{text:w,image:L,action:this.__yO.setJustifyLeft},alignCenter:{text:o,image:bH,action:this.__yO.setJustifyCenter},alignRight:{text:bs,image:K,action:this.__yO.setJustifyRight},alignJustify:{text:bE,image:N,action:this.__yO.setJustifyFull}},{fontFamily:{custom:this.__yV},fontSize:{custom:this.__yW},fontColor:{text:br,image:a,action:this.__yP},textBackgroundColor:{text:bk,image:bF,action:this.__yQ}},{indent:{text:bv,image:bB,action:this.__yO.insertIndent},outdent:{text:P,image:p,action:this.__yO.insertOutdent}},{insertImage:{text:u,image:bR,action:this.__yR},insertTable:{text:bq,image:b,action:this.__yS},insertLink:{text:bm,image:F,action:this.__yT},insertHTML:{text:I,image:bC,action:this.__yU},insertHR:{text:bD,image:bK,action:this.__yO.insertHorizontalRuler}},{ol:{text:G,image:bb,action:this.__yO.insertOrderedList},ul:{text:bt,image:bL,action:this.__yO.insertUnorderedList}},{undo:{text:h,image:c,action:this.__yO.undo},redo:{text:k,image:n,action:this.__yO.redo}}];}
,__yY:function(){var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setDecorator(bN);var cw;var cx=this.__yX();for(var i=0,j=cx.length;i<j;i++){var cy=new qx.ui.toolbar.Part;toolbar.add(cy);for(var cz in cx[i]){var cA=cx[i][cz];if(cA.custom){cw=cA.custom.call(this);}
else {cw=new qx.ui.toolbar.Button(null,cA.image);cw.set({focusable:false,keepFocus:true,center:true,toolTipText:cA.text?cA.text:x});cw.addListener(y,cA.action,this.__yO);}
;cy.add(cw);}
;}
;return toolbar;}
}});}
...
},properties:{contentType:{check:t,init:k,apply:H},messengerMode:{check:P,init:false,apply:h},insertParagraphOnLinebreak:{check:P,init:true,apply:ba},insertLinebreakOnCtrlEnter:{check:P,init:true,apply:r},postProcess:{check:bc,nullable:true,init:null,apply:F},useUndoRedo:{check:P,init:true,apply:j},appearance:{refine:true,init:l},defaultFontFamily:{check:t,init:W,apply:M},defaultFontSize:{check:bf,init:4,apply:E},focusable:{refine:true,init:true}},members:{__we:null,__wc:null,__wf:null,__wd:null,__wg:null,_initBlockerElement:function(){if(!this.__wf){this.__wf=this._createBlockerElement();}
;}
,_applyContentType:function(bp,bq){if(this.__we!=null){this.__we.setContentType(bp);}
else {this.__wc[s]=bp;}
;}
,_applyMessengerMode:function(br,bs){if(this.__we!=null){this.__we.setMessengerMode(br);}
else {this.__wc[w]=br;}
;}
,_applyInsertParagraphOnLinebreak:function(bt,bu){if(this.__we!=null){this.__we.setInsertParagraphOnLinebreak(bt);}
else {this.__wc[d]=bt;}
;}
,_applyInsertLinebreakOnCtrlEnter:function(bv,bw){if(this.__we!=null){this.__we.setInsertLinebreakOnCtrlEnter(bv);}
else {this.__wc[B]=bv;}
;}
,_applyPostProcess:function(bx,by){if(this.__we!=null){this.__we.setPostProcess(bx);}
else {this.__wc[Y]=bx;}
;}
,_applyUseUndoRedo:function(bz,bA){if(this.__we!=null){this.__we.setUseUndoRedo(bz);}
else {this.__wc[C]=bz;}
;}
,_applyDefaultFontFamily:function(bB,bC){if(this.__we!=null){this.__we.setDefaultFontFamily(bB);}
else {this.__wc[U]=bB;}
;}
,_applyDefaultFontSize:function(bD,bE){if(this.__we!=null){this.__we.setDefaultFontSize(bD);}
else {this.__wc[n]=bD;}
;}
,_applyNativeContextMenu:function(bF,bG){if(this.__we!=null){this.__we.setNativeContextMenu(bF);}
else {this.__wc[be]=bF;}
;}
...
;return bH;}
,__wh:function(){this.addListenerOnce(L,this.__wi);}
,__wi:function(){var bI=this.getContentElement().getDomElement();this.__we=new qx.bom.htmlarea.HtmlArea(bI,this.__wd.content,this.__wd.styleInfo,this.__wd.source);this.__wj();this.__wk();if((qx.core.Environment.get(z)==c)){this.__wn();}
;this.addListener(L,this.forceEditable);}
,__wj:function(){for(var bJ in this.__wc){this.__we[q+bJ](this.__wc[bJ]);}
;}
...
,__wl:function(e){var bK=e.clone();this.fireEvent(bK.getType());}
,__wm:function(e){var bL=e.clone();this.fireDataEvent(bL.getType(),e.getData());}
,__wn:function(){this.__wg=qx.lang.Function.bind(this.__wo,this);var bM=this.getContainerElement().getDomElement();qx.bom.Event.addNativeListener(bM,S,this.__wg);}
,__wo:qx.event.GlobalError.observeMethod(function(e){if(this.__we&&!this.__we.isDisposed()){this.__we.invalidateEditor();}
;}
),renderLayout:function(bN,top,bO,bP){qx.ui.core.Widget.prototype.renderLayout.call(this,bN,top,bO,bP);var bR=p;var bQ=this.getInsets();if(!this.__wf){this._initBlockerElement();}
;this.__wf.setStyles({left:bQ.left+bR,top:bQ.top+bR,width:(bO-bQ.left-bQ.right)+bR,height:(bP-bQ.top-bQ.bottom)+bR});}
,getIframeObject:function(){return this.__we!=null?this.__we.getIframeObject():null;}
,getCommandManager:function(){return this.__we!=null?this.__we.getCommandManager():null;}
,setValue:function(bS){if(this.__we!=null){this.__we.setValue(bS);}
else {this.__wd.content=bS;}
;}
,getValue:function(){if(this.__we!=null){return this.__we.getValue();}
else {return this.__wd.content;}
;}
,getComputedValue:function(bT){return this.__we!=null?this.__we.getHtml(bT):null;}
,getCompleteHtml:function(){return this.__we!=null?this.__we.getCompleteHtml():null;}
,getContentDocument:function(){return this.__we!=null?this.__we.getContentDocument():null;}
,getContentBody:function(){return this.__we!=null?this.__we.getContentBody():null;}
,getContentWindow:function(){return this.__we!=null?this.__we.getContentWindow():null;}
,getWords:function(bU){return this.__we!=null?this.__we.getWords(bU):null;}
,getWordsWithElement:function(){return this.__we!=null?this.__we.getWordsWithElement():null;}
,getTextNodes:function(){return this.__we!=null?this.__we.getTextNodes():null;}
,isReady:function(){return this.__we!=null?this.__we.isReady():false;}
,forceEditable:function(){if(this.__we!=null){this.__we.forceEditable();}
;}
,isLoaded:function(){return this.__we!=null?this.__we.isLoaded():false;}
,setEditable:function(bV){if(this.__we!=null){this.__we.setEditable(bV);}
;}
,getEditable:function(){return this.__we!=null?this.__we.getEditable():false;}
,isEditable:function(){return this.__we!=null?this.__we.isEditable():false;}
,insertHtml:function(bW){return this.__we!=null?this.__we.insertHtml(bW):false;}
,removeFormat:function(){return this.__we!=null?this.__we.removeFormat():false;}
,setBold:function(){return this.__we!=null?this.__we.setBold():false;}
,setItalic:function(){return this.__we!=null?this.__we.setItalic():false;}
,setUnderline:function(){return this.__we!=null?this.__we.setUnderline():false;}
,setStrikeThrough:function(){return this.__we!=null?this.__we.setStrikeThrough():false;}
,setFontSize:function(bX){return this.__we!=null?this.__we.setFontSize(bX):false;}
,setFontFamily:function(bY){return this.__we!=null?this.__we.setFontFamily(bY):false;}
,setTextColor:function(ca){return this.__we!=null?this.__we.setTextColor(ca):false;}
,setTextBackgroundColor:function(cb){return this.__we!=null?this.__we.setTextBackgroundColor(cb):false;}
,setJustifyLeft:function(){return this.__we!=null?this.__we.setJustifyLeft():false;}
,setJustifyCenter:function(){return this.__we!=null?this.__we.setJustifyCenter():false;}
,setJustifyRight:function(){return this.__we!=null?this.__we.setJustifyRight():false;}
,setJustifyFull:function(){return this.__we!=null?this.__we.setJustifyFull():false;}
,insertIndent:function(){return this.__we!=null?this.__we.insertIndent():false;}
,insertOutdent:function(){return this.__we!=null?this.__we.insertOutdent():false;}
,insertOrderedList:function(){return this.__we!=null?this.__we.insertOrderedList():false;}
,insertUnorderedList:function(){return this.__we!=null?this.__we.insertUnorderedList():false;}
,insertHorizontalRuler:function(){return this.__we!=null?this.__we.insertHorizontalRuler():false;}
,insertImage:function(cc){return this.__we!=null?this.__we.insertImage(cc):false;}
,insertHyperLink:function(cd){return this.__we!=null?this.__we.insertHyperLink(cd):false;}
,removeBackgroundColor:function(){return this.__we!=null?this.__we.removeBackgroundColor():false;}
,setBackgroundColor:function(ce){return this.__we!=null?this.__we.setBackgroundColor(ce):false;}
,removeBackgroundImage:function(){return this.__we!=null?this.__we.removeBackgroundImage():false;}
,setBackgroundImage:function(cf,cg,ch){return this.__we!=null?this.__we.setBackgroundImage(cf,cg,ch):false;}
,selectAll:function(){return this.__we!=null?this.__we.selectAll():false;}
,undo:function(){return this.__we!=null?this.__we.undo():false;}
,redo:function(){return this.__we!=null?this.__we.redo():false;}
,resetHtml:function(){if(this.__we!=null){this.__we.resetHtml();}
;}
,getHtml:function(ci){return this.__we!=null?this.__we.getHtml(ci):null;}
,containsOnlyPlaceholder:function(){return this.__we!=null?this.__we.containsOnlyPlaceHolder():false;}
,getContextInformation:function(){return this.__we!=null?this.__we.getContextInformation():null;}
,getSelection:function(){return this.__we!=null?this.__we.getSelection():null;}
,getSelectedText:function(){return this.__we!=null?this.__we.getSelectedText():null;}
,getSelectedHtml:function(){return this.__we!=null?this.__we.getSelectedHtml():null;}
,clearSelection:function(){if(this.__we!=null){this.__we.clearSelection();}
;}
,getRange:function(){return this.__we.getRange();}
,saveRange:function(){this.__we.saveRange();}
,getSavedRange:function(){return this.__we.getSavedRange();}
,resetSavedRange:function(){this.__we.resetSavedRange();}
,getFocusNode:function(){return this.__we!=null?this.__we.getFocusNode():null;}
,block:function(){if(!this.__wf){this._initBlockerElement();}
;if(!this.getContainerElement().hasChild(this.__wf)){this.getContainerElement().add(this.__wf);}
;this.__wf.setStyle(Q,V);}
,release:function(){if(this.__wf){this.__wf.setStyle(Q,u);}
;}
,focus:function(){qx.ui.core.Widget.prototype.focus.call(this);this.__wp();}
,tabFocus:function(){qx.ui.core.Widget.prototype.tabFocus.call(this);this.__wp();}
,__wp:function(){if(this.__we!=null){qx.event.Timer.once(function(){this.__we.focusContent();}
,this,0);}
;}
},destruct:function(){this.__wc=this.__wd=null;qx.event.Registration.removeListener(document.body,O,this.block,this,true);qx.event.Registration.removeListener(document.body,K,this.release,this,true);qx.event.Registration.removeListener(document.body,J,this.release,this,true);var cj=this.getContainerElement().getDomElement();if(cj){qx.bom.Event.removeNativeListener(cj,S,this.__wg);}
;this._disposeObjects(T,X);}
});}
)();
