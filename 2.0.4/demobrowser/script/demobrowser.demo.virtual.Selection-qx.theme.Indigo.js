...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Selection","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Selection-qx.theme.Indigo.29e2b8696e81.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__IP=[];this.__IQ=[];this._isHorizontal=(i||b)==b;}
,properties:{defaultLineColor:{init:g,check:e,themeable:true},defaultLineSize:{init:1,check:d,themeable:true}},members:{__IP:null,__IQ:null,isHorizontal:function(){return this._isHorizontal;}
...
;this.__IP[l]=m;if(this.__IR(l)){this.updateLayerData();}
;}
...
;this.__IQ[n]=o;if(this.__IR(n)){this.updateLayerData();}
;}
,__IR:function(p){if(this._isHorizontal){var t=this.getFirstColumn();var r=t+this.getColumnSizes().length-1;return p>=t&&p<=r;}
else {var s=this.getFirstRow();var q=s+this.getRowSizes().length-1;return p>=s&&p<=q;}
;}
,getLineSize:function(u){return this.__IQ[u]||this.getDefaultLineSize();}
,getLineColor:function(v){return this.__IP[v]||this.getDefaultLineColor();}
,__IS:function(w,z,A){var top=0;var B,C;for(var y=0;y<A.length-1;y++){B=this.getLineColor(z+y);C=this.getLineSize(z+y);top+=A[y];w.push("<div style='","position: absolute;","height: "+C+"px;","width: 100%;","top:",top-((C>1)?Math.floor(C/2):1),"px;","background-color:",B,"'>","</div>");}
;}
,__IT:function(D,E,F){var I=0;var G,H;for(var x=0;x<F.length-1;x++){G=this.getLineColor(E+x);H=this.getLineSize(E+x);I+=F[x];D.push("<div style='","position: absolute;","width: "+H+"px;","height: 100%;","top: 0px;","left:",I-((H>1)?Math.floor(H/2):1),"px;","background-color:",G,"'>","</div>");}
;}
,_fullUpdate:function(J,K,L,M){var N=[];if(this._isHorizontal){this.__IS(N,J,L);}
else {this.__IT(N,K,M);}
...
;this.__jA=qx.bom.Stylesheet.createElement(p);this.__Jm={};this.__lH={};}
,members:{__jA:null,__Jm:null,__lH:null,getStylesheet:function(){return this.__jA;}
,getCssClass:function(q){return this.__Jm[q]||null;}
,computeClassForStyles:function(r,s){var t=this.__lH[s];if(!t){var t=this.__Jn();qx.bom.Stylesheet.addRule(this.__jA,f+t,s);this.__lH[s]=t;}
;this.__Jm[r]=t;return t;}
,__Jn:function(){return k+this.toHashCode()+o+(this.__Jo++);}
,__Jo:0},destruct:function(){this.__jA=this.__Jm=this.__lH=null;}
});}
)();
(function(){var k="backgroundColor",j="_applyTextAlign",h="px",g="_applyFont",f="_applyBackgroundColor",e="cell",d="center",c="font",b=":",a="shorthand",H="String",G="_applyAppearance",F="background-color:",E="textAlign",D="qx-cell ",C="left",B="textColor",A="text-align:",z="Font",y="right",r="_applyTextColor",s="justify",p="color:",q=";",n="qx.ui.virtual.cell.Cell",o="paddingLeft",l="Color",m="",t="paddingBottom",u="paddingTop",w="paddingRight",v="Integer",x="_applyPadding";qx.Class.define(n,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__jA=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__JF={};this.__JG={};this.__JH={};this.__JI={};this.__hA={};this.__JJ={};this.initAppearance();this.__JN();}
,properties:{appearance:{check:H,init:e,apply:G},backgroundColor:{nullable:true,check:l,apply:f,themeable:true},textColor:{nullable:true,check:l,apply:r,themeable:true},textAlign:{check:[C,d,y,s],nullable:true,themeable:true,apply:j},font:{nullable:true,apply:g,check:z,themeable:true},paddingTop:{check:v,init:0,apply:x,themeable:true},paddingRight:{check:v,nullable:true,apply:x,themeable:true},paddingBottom:{check:v,nullable:true,apply:x,themeable:true},paddingLeft:{check:v,nullable:true,apply:x,themeable:true},padding:{group:[u,w,t,o],mode:a,themeable:true}},members:{__JK:null,__JL:null,__hA:null,__JJ:null,__JG:null,__JF:null,__JH:null,__JI:null,__JM:false,__jA:null,__JN:function(){var K=qx.util.PropertyUtil;var M=qx.lang.Object.fromArray(this._getCssProperties());this.__JK=[];var J=this.constructor;while(J){var L=K.getProperties(J);for(var I in L){if(!M[I]){this.__JK.push(I);}
;}
;J=J.superclass;}
;}
,_getCssProperties:function(){return [k,B,c,E,u,w,t,o];}
,_applyAppearance:function(N,O){if(O){this.__JG={};}
;}
,_getValue:function(P){if(this.__JM){return qx.util.PropertyUtil.getThemeValue(this,P);}
else {return qx.util.PropertyUtil.getUserValue(this,P);}
;}
,_storeStyle:function(Q,R){var S;if(this.__JM){S=this.__JG;}
else {S=this.__JF;}
;if(R===null){delete S[Q];}
else {S[Q]=R;}
;}
,_applyBackgroundColor:function(T,U,name){var T=this._getValue(name);if(!T){this._storeStyle(name,null);}
else {this._storeStyle(name,F+qx.theme.manager.Color.getInstance().resolve(T));}
;}
,_applyTextColor:function(V,W,name){var V=this._getValue(name);if(!V){this._storeStyle(name,null);}
else {this._storeStyle(name,p+qx.theme.manager.Color.getInstance().resolve(V));}
;}
,_applyTextAlign:function(X,Y,name){var X=this._getValue(name);if(!X){this._storeStyle(name,null);}
else {this._storeStyle(name,A+X);}
;}
,_applyFont:function(ba,bb,name){var ba=this._getValue(name);if(!ba){this._storeStyle(name,null);}
else {var bc=qx.theme.manager.Font.getInstance().resolve(ba);this._storeStyle(name,qx.bom.element.Style.compile(bc.getStyles()));}
;}
,_applyPadding:function(bd,be,name){var bd=this._getValue(name);if(this.__JM){var bg=this.__JI;}
else {bg=this.__JH;}
;if(bd===null){delete bg[name];}
else {bg[name]=bd;}
;if(bd===null){this._storeStyle(name,null);}
else {var bf=qx.lang.String.hyphenate(name);this._storeStyle(name,bf+b+bd+h);}
;}
,getCellProperties:function(bh,bi){this.__JO(bi);return {classes:this.getCssClasses(bh,bi),style:this.getStyles(bh,bi),attributes:this.getAttributes(bh,bi),content:this.getContent(bh,bi),insets:this.getInsets(bh,bi)};}
,getAttributes:function(bj,bk){return m;}
,getContent:function(bl,bm){return bl;}
,getCssClasses:function(bn,bo){var bp=this.__jA.getCssClass(this.__JL)||m;return D+bp;}
,__JO:function(bq){if(!bq){bq={};}
;var bs=this.getAppearance();var br=bs+"-"+qx.lang.Object.getKeys(bq).sort().join(" ");if(this.__JL==br){return;}
;this.__JL=br;var bt=this.__hA[this.__JL];if(!bt){this.__JP();this.__JQ(bq);this.__JR(bq);this.__JS();this.__hA[this.__JL]=1;}
;this.__JT();}
,__JP:function(){var bu=qx.util.PropertyUtil;var bv=this._getCssProperties();for(var i=0;i<bv.length;i++){bu.deleteThemeValue(this,bv[i]);}
;}
,__JQ:function(bw){this.__JG={};this.__JM=true;var bz=this.getAppearance();var by=qx.util.PropertyUtil;var bx=qx.theme.manager.Appearance.getInstance().styleFrom(bz,bw);for(var bA in bx){if(bx[bA]!==undefined){by.setThemed(this,bA,bx[bA]);}
;}
;this.__JM=false;}
,__JR:function(){var bB=qx.lang.Object.getValues(this.__JG).join(";");this.__jA.computeClassForStyles(this.__JL,bB);}
,__JS:function(){var bG=this.__JK;var bC=qx.util.PropertyUtil;var bE={};for(var i=0;i<bG.length;i++){var bF=bG[i];var bD=bC.getThemeValue(this,bF);if(bD!==undefined){bE[bF]=bD;}
;}
;this.__JJ[this.__JL]=bE;}
,__JT:function(){var bI=qx.util.PropertyUtil;var bH=this.__JJ[this.__JL]||{};for(var bJ in bH){bI.setThemed(this,bJ,bH[bJ]);}
;}
,getStyles:function(bK,bL){return qx.lang.Object.getValues(this.__JF).join(q);}
,getInsets:function(bM,bN){var bR=this.__JH;var bQ=this.__JI;var top=(bR.paddingTop!==undefined?bR.paddingTop:bQ.paddingTop)||0;var bO=(bR.paddingRight!==undefined?bR.paddingRight:bQ.paddingRight)||0;var bP=(bR.paddingBottom!==undefined?bR.paddingBottom:bQ.paddingBottom)||0;var bS=(bR.paddingLeft!==undefined?bR.paddingLeft:bQ.paddingLeft)||0;return [bS+bO,top+bP];}
},destruct:function(){this.__jA=this.__JF=this.__JG=this.__JH=this.__JI=this.__hA=this.__JJ=this.__JK=null;}
});}
)();
