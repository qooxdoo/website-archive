...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.Offline","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline-qx.theme.Modern.48e34aacca8d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{model:{nullable:true,event:c,apply:a}},members:{_storage:null,__CC:null,_applyModel:function(j,k){if(k){k.removeListenerById(this.__CC);k.dispose();this.__CC=null;}
;if(j){this.__CC=j.addListener(b,this.__CD,this);this.__CD();}
else {this._storage.removeItem(this._key);}
;}
,__CD:function(){var l=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,l);}
...
(function(){var f="local",d="session",c="Storage",b="qx.bom.storage.Web",a="Storage full.";qx.Bootstrap.define(b,{statics:{__CE:null,__CF:null,getLocal:function(){if(this.__CE){return this.__CE;}
;return this.__CE=new qx.bom.storage.Web(f);}
,getSession:function(){if(this.__CF){return this.__CF;}
;return this.__CF=new qx.bom.storage.Web(d);}
},construct:function(g){this.__mJ=g;}
,members:{__mJ:null,getStorage:function(){return window[this.__mJ+c];}
,getLength:function(){return this.getStorage(this.__mJ).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__mJ).setItem(h,j);}
catch(e){throw new Error(a);}
;}
,getItem:function(k){var l=this.getStorage(this.__mJ).getItem(k);if(qx.lang.Type.isString(l)){l=qx.lang.Json.parse(l);}
else if(l&&l.value&&qx.lang.Type.isString(l.value)){l=qx.lang.Json.parse(l.value);}
;return l;}
,removeItem:function(m){this.getStorage(this.__mJ).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__mJ);if(!n.clear){for(var i=n.length-1;i>=0;i--){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__mJ).key(o);}
,forEach:function(p,q){var length=this.getLength();for(var i=0;i<length;i++){var r=this.getKey(i);p.call(q,r,this.getItem(r));}
;}
}});}
)();
(function(){var j="session",h="head",g="none",f="qx.bom.storage.UserData",e="div",d="local",c="#default#userdata",b="display",a="qx";qx.Bootstrap.define(f,{statics:{__CE:null,__CF:null,__bV:0,getLocal:function(){if(this.__CE){return this.__CE;}
;return this.__CE=new qx.bom.storage.UserData(d);}
,getSession:function(){if(this.__CF){return this.__CF;}
;return this.__CF=new qx.bom.storage.UserData(j);}
},construct:function(k){this.__CG=document.createElement(e);this.__CG.style[b]=g;document.getElementsByTagName(h)[0].appendChild(this.__CG);this.__CG.addBehavior(c);this.__CH=k;this.__CG.load(this.__CH);this.__sq={};this.__CI={};var l=this.__CG.getAttribute(a+qx.bom.storage.UserData.__bV);while(l!=undefined){l=qx.lang.Json.parse(l);this.__sq[l.key]=l.value;this.__CI[l.key]=a+qx.bom.storage.UserData.__bV;qx.bom.storage.UserData.__bV++;l=this.__CG.getAttribute(a+qx.bom.storage.UserData.__bV);}
;}
,members:{__CG:null,__CH:"qxtest",__sq:null,__CI:null,getStorage:function(){return this.__sq;}
,getLength:function(){return qx.Bootstrap.getKeys(this.__sq).length;}
,setItem:function(m,n){if(this.__CI[m]){var o=this.__CI[m];}
else {var o=a+qx.bom.storage.UserData.__bV;qx.bom.storage.UserData.__bV++;}
;var p=qx.lang.Json.stringify({key:m,value:n});this.__CG.setAttribute(o,p);this.__CG.save(this.__CH);this.__sq[m]=n;this.__CI[m]=o;}
,getItem:function(q){return this.__sq[q]||null;}
,removeItem:function(r){var u=this.__CI[r];if(u==undefined){return;}
;this.__CG.removeAttribute(u);qx.bom.storage.UserData.__bV--;delete this.__sq[r];delete this.__CI[r];var t=a+qx.bom.storage.UserData.__bV;if(this.__CG.getAttribute(t)){var v=this.__CG.getAttribute(a+qx.bom.storage.UserData.__bV);this.__CG.removeAttribute(t);this.__CG.setAttribute(u,v);var s=qx.lang.Json.parse(v).key;this.__CI[s]=u;}
;this.__CG.save(this.__CH);}
,clear:function(){for(var w in this.__CI){this.__CG.removeAttribute(this.__CI[w]);}
;this.__CG.save(this.__CH);this.__sq={};this.__CI={};}
,getKey:function(x){return qx.Bootstrap.getKeys(this.__sq)[x];}
,forEach:function(y,z){var length=this.getLength();for(var i=0;i<length;i++){var A=this.getKey(i);y.call(z,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__CE:null,__CF:null,getLocal:function(){if(this.__CE){return this.__CE;}
;return this.__CE=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__CF){return this.__CF;}
;return this.__CF=new qx.bom.storage.Memory();}
},construct:function(){this.__sq={};}
,members:{__sq:null,getStorage:function(){return this.__sq;}
,getLength:function(){return qx.Bootstrap.getKeys(this.__sq).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__sq[b]=c;}
,getItem:function(d){var e=this.__sq[d];if(qx.lang.Type.isString(e)){e=qx.lang.Json.parse(e);}
;return e;}
,removeItem:function(f){delete this.__sq[f];}
,clear:function(){this.__sq={};}
,getKey:function(g){var h=qx.Bootstrap.getKeys(this.__sq);return h[g];}
,forEach:function(j,k){var length=this.getLength();for(var i=0;i<length;i++){var l=this.getKey(i);j.call(k,l,this.getItem(l));}
;}
}});}
)();
(function(){var c="html.storage.local",b="html.storage.userdata",a="qx.bom.Storage";qx.Bootstrap.define(a,{statics:{__BJ:null,getLocal:function(){return this.__BJ.getLocal();}
,getSession:function(){return this.__BJ.getSession();}
},defer:function(d){if(qx.core.Environment.get(c)){d.__BJ=qx.bom.storage.Web;}
else if(qx.core.Environment.get(b)){d.__BJ=qx.bom.storage.UserData;}
else {d.__BJ=qx.bom.storage.Memory;}
;}
});}
)();
