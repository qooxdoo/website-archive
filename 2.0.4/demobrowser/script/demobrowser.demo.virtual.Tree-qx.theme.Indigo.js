...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree-qx.theme.Indigo.751a2d326635.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="Show Leafs",k="Show top level open/close icons",j="loaded",h="drop",g="File #",f="demobrowser.demo.virtual.Tree",d="Enable drag selection",c="Open mode:",b="change",a="Hide Root Node",P="Update Model",O="Control",N=" items",M="icon/48/places/folder.png",L="New Item ",K="Enable multi selection",J="copy",I="name",H="",G="changeSelection",s="Drag me:",t="single",q="Selection: ",r="children",o="Tree:",p="click",m="json/tree.json",n="none",u="double click",v="Selection:",y="Root node:",x="Toggle Height",A="item",z="execute",C="move",B="dragstart",w="mode",F="multi",E="model",D="changeValue";qx.Class.define(f,{extend:qx.application.Standalone,members:{i:0,__GQ:null,main:function(){qx.application.Standalone.prototype.main.call(this);var T=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));this.getRoot().add(T,{top:20,left:20});var R=new qx.ui.tree.VirtualTree(null,I,r).set({width:200,height:400});T.add(R);R.setDroppable(true);R.setDraggable(true);R.addListener(B,function(e){e.addType(A);e.addAction(C);}
...
;}
,this);var Q=m;var U=new qx.data.store.Json(Q);this.__GQ=U;U.bind(E,R,E);U.addListener(j,function(){R.openNode(R.getModel().getChildren().getItem(0));}
