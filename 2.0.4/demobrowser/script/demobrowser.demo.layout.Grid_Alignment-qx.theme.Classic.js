...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Grid_Alignment-qx.theme.Classic.a2cce6e53549.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="green",l="demobrowser.demo.layout.Grid_Alignment",k="gray",j="center",h="middle",g="orange",f="yellow",e="bottom",d="top",c="left",a="right",b="main";qx.Class.define(l,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var n=new qx.ui.container.Composite(new qx.ui.layout.Grid(20)).set({padding:20});scroll.add(n);n.add(this.getCellAlignGrid(),{row:0,column:0});n.add(this.getRowColumnAlignGrid(),{row:0,column:1});n.add(this.getColumnAlignGrid(),{row:0,column:2});n.add(this.getRowAlignGrid(),{row:1,column:0});}
,getNewWidget:function(){var o=new qx.ui.core.Widget().set({decorator:b,backgroundColor:m,allowGrowX:false,allowGrowY:false,height:Math.round((Math.random()*30)+30),width:Math.round((Math.random()*30)+30)});return o;}
,getColumnAlignGrid:function(){var p=new qx.ui.container.Composite().set({decorator:b,backgroundColor:f,allowGrowX:false,allowGrowY:false});var q=new qx.ui.layout.Grid();q.setSpacing(3);q.setColumnAlign(0,c,d);q.setColumnAlign(1,j,h);q.setColumnAlign(2,a,e);p.setLayout(q);for(var x=0;x<3;x++){for(var y=0;y<6;y++){p.add(this.getNewWidget(),{row:y,column:x});}
;}
;return p;}
,getRowAlignGrid:function(){var r=new qx.ui.container.Composite().set({decorator:b,backgroundColor:f,allowGrowX:false,allowGrowY:false});var s=new qx.ui.layout.Grid();s.setSpacing(3);s.setRowAlign(0,c,d);s.setRowAlign(1,j,h);s.setRowAlign(2,a,e);r.setLayout(s);for(var x=0;x<6;x++){for(var y=0;y<3;y++){r.add(this.getNewWidget(),{row:y,column:x});}
;}
;return r;}
,getCellAlignGrid:function(){var t=new qx.ui.container.Composite().set({decorator:b,backgroundColor:f,allowGrowX:false,allowGrowY:false});var v=new qx.ui.layout.Grid();v.setSpacing(3);t.setLayout(v);for(var x=0;x<5;x++){v.setColumnAlign(x,j,h);for(var y=0;y<5;y++){t.add(this.getNewWidget(),{row:y,column:x});}
;}
;var u=v.getCellWidget(0,0);u.set({alignX:c,alignY:d});u.set({backgroundColor:g,width:20,height:20});var u=v.getCellWidget(4,4);u.set({alignX:a,alignY:e});u.set({backgroundColor:g,width:20,height:20});return t;}
,getRowColumnAlignGrid:function(){var w=new qx.ui.container.Composite().set({decorator:b,backgroundColor:f,allowGrowX:false,allowGrowY:false});var A=new qx.ui.layout.Grid();A.setSpacing(3);w.setLayout(A);for(var x=0;x<5;x++){for(var y=0;y<5;y++){w.add(this.getNewWidget(),{row:y,column:x});}
;}
;A.setColumnAlign(2,c,d);A.setRowAlign(2,a,e);for(var i=0;i<5;i++){A.getCellWidget(2,i).setBackgroundColor(k);A.getCellWidget(i,2).setBackgroundColor(k);}
;var z=A.getCellWidget(2,2);z.set({backgroundColor:g,width:20,height:20});return w;}
}});}
)();
