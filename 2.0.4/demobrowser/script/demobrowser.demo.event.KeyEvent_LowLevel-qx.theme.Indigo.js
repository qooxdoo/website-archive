...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.KeyEvent_LowLevel","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.KeyEvent_LowLevel-qx.theme.Indigo.d26183146f4d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(n,o,p){this.__Qj=f+n.join(j)+l;this.__Qk=p||50;this.__Ql=o;this._clearLog();}
,_clearLog:function(){this.__Ql.innerHTML=this.__Qj+a;this.__Qm=[];}
,_log:function(q){this.__Qm.unshift(q);this.__Qm=this.__Qm.slice(0,this.__Qk);var r=[this.__Qj];for(var i=0;i<this.__Qm.length;i++){r.push(e,this.__Qm[i].join(g),b);}
;r.push(a);this.__Ql.innerHTML=r.join(h);this.__Ql.scrollTop=0;}
,__Qj:null,__Qk:null,__Ql:null,__Qm:null},destruct:function(){this.__Ql=this.__Qm=null;}
});}
)();
...
(function(){var o="logger",n="keypress",m="",l="char code",k="Ctrl",j="key identifier",h="engine.version",g="Shift",f="demobrowser.demo.event.KeyEvent_LowLevel",e="keydown",b="Event",d="Alt",c="keyup",a="key code";qx.Class.define(f,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this.debug(qx.core.Environment.get(h));this._initLogger([b,a,l,j,g,k,d],document.getElementById(o),50);var p=[e,n,c];for(var i=0;i<p.length;i++){qx.bom.Event.addNativeListener(document.documentElement,p[i],qx.lang.Function.bind(this.logKeyEvent,this));}
;}
,logKeyEvent:function(q){var r=q.type;this._log([r,q.keyCode,q.charCode,q.keyIdentifier||m,q.shiftKey,q.ctrlKey,q.altKey]);qx.bom.Event.preventDefault(q);}
}});}
)();
