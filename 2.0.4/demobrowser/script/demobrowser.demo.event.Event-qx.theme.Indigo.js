...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event-qx.theme.Indigo.03b9c7daf66b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="resize",j="Shift-Meta-F1",i="keyinput: ",h=" 1: ",g="Ctrl-A",f="inner",d="keyinput",c="scroll:",b="demobrowser.demo.event.Event",a="keydown: ",C=": ",B="logger",A="juhu",z=" (inner): ",y="mouseover",x="mouse out",w="mouseout",v="Events",u=" 2: ",t="prevent default ",r="mouse over",s="contextmenu",p="Resize:",q="keydown",n="execute",o="input",l="scroll",m="click";qx.Class.define(b,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this._initLogger([v],document.getElementById(B),50);qx.event.Registration.addListener(window,k,this._onResize,this);var D=new qx.ui.core.Command(j);D.addListener(n,function(){this.debug(D.toString());}
,this);var E=new qx.ui.core.Command(g);E.addListener(n,function(){this.debug(E.toString());}
,this);this._juhu=document.getElementById(A);this._inner=document.getElementById(f);qx.event.Registration.addListener(this._juhu,s,this._preventDefault,this);qx.event.Registration.addListener(this._inner,m,this._stopPropagation,this);qx.event.Registration.addListener(this._juhu,m,this._onclick1,this);qx.event.Registration.addListener(this._juhu,m,this._onclick2,this);qx.event.Registration.addListener(this._juhu,q,this._onclick2,this);qx.event.Registration.addListener(this._juhu,y,this._onmouseover,this);qx.event.Registration.addListener(this._juhu,w,this._onmouseout,this);qx.event.Registration.addListener(document.getElementById(o),q,this._onKeydown,this);qx.event.Registration.addListener(document.getElementById(o),d,this._onKeyinput,this);qx.event.Registration.addListener(document.getElementById(l),l,this._scroll,this);}
,_onResize:function(e){this._log([p+e]);}
,_onKeydown:function(e){this._log([a+e.getKeyIdentifier()]);}
,_onKeyinput:function(e){this._log([i+e.getCharCode()]);}
,_onmouseover:function(e){this._log([r]);}
,_onmouseout:function(e){this._log([x]);}
,_scroll:function(e){this._log([c+e.getTarget()]);}
,_preventDefault:function(e){this._log([t+e.getType()+C+e]);e.preventDefault();}
,_stopPropagation:function(e){this._log([e.getType()+z+e]);e.stopPropagation();}
,_onclick1:function(e){this._log([e.getType()+h+e]);qx.event.Registration.removeListener(this._juhu,m,this._onclick1);}
,_onclick2:function(e){this._log([e.getType()+u+e]);}
