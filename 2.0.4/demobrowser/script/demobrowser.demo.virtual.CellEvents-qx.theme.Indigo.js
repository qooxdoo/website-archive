...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents-qx.theme.Indigo.a03db2d8cc46.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var n="logger",m='<p style="color:green;">You clicked on cell ',l="",k="cellClick",j='<p style="color:yellow;">You rightclicked cell ',i='<p style="color:red;">You double clicked cell ',h="demobrowser.demo.virtual.CellEvents",g="main",f="cellDblclick",d="cellContextmenu",a="layer",c='</p>',b=' / ';qx.Class.define(h,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var p=new qx.ui.virtual.core.Scroller(20,20,40,40).set({width:400,height:300});this.layer=new qx.test.ui.virtual.layer.LayerSimple(this);var o=p.getPane();o.addListener(k,this._onCellClick,this);o.addListener(d,this._onContextMenu,this);o.addListener(f,this._onDblclickPane,this);o.addLayer(this.layer);this.logger=new qx.ui.embed.Html().set({width:400,height:300,html:l,decorator:g});this.getRoot().add(p,{left:20,top:10});this.getRoot().add(this.logger,{left:450,top:10});}
,_onCellClick:function(e){var q=m+e.getRow()+b+e.getColumn()+c;this.__Rt(q);}
,_onContextMenu:function(e){var r=j+e.getRow()+b+e.getColumn()+c;this.__Rt(r);}
,_onDblclickPane:function(e){var s=i+e.getRow()+b+e.getColumn()+c;this.__Rt(s);}
,__Rt:function(t){this.logger.setHtml(this.logger.getHtml()+t);}
},destruct:function(){this._disposeObjects(a,n);}
});}
)();
...
(function(){var l=" / ",k="top:",j="<div style='position:absolute;",i="width:",h="height:",g="'>",f="qx.test.ui.virtual.layer.LayerSimple",e="</div>",d="left:",c="html",a="",b="px;";qx.Class.define(f,{extend:qx.ui.virtual.layer.Abstract,members:{getCellHtml:function(m,n,o,top,p,q){var content=m+l+n;return [j,d,o,b,k,top,b,i,p,b,h,q,b,g,content,e].join(a);}
,_fullUpdate:function(r,s,t,u){var z=[];var A=0;var top=0;var C=r;var B=s;for(var x=0;x<t.length;x++){var A=0;var B=s;var v=t[x];for(var y=0;y<u.length;y++){var w=u[y];z[z.length]=this.getCellHtml(C,B,A,top,w,v);B++;A+=w;}
;top+=v;C++;}
;this.getContentElement().setAttribute(c,z.join(a));}
}});}
)();
