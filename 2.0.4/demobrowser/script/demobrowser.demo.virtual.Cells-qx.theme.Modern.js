...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells-qx.theme.Modern.dd1f6ac9b2b1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,members:{__qp:16,__qq:16,_aliasManager:null,__qs:function(w){var z=qx.util.ResourceManager.getInstance();var y=qx.io.ImageLoader;var x,A;if(z.has(w)){x=z.getImageWidth(w),A=z.getImageHeight(w);}
else if(y.isLoaded(w)){x=y.getWidth(w);A=y.getHeight(w);}
else {x=this.__qp;A=this.__qq;}
;return {width:x,height:A};}
,__JU:function(B){if(typeof (B)=="string"){B={url:B};}
...
(function(){var e="_applyIconFalse",d="qx.ui.virtual.cell.Boolean",c="_applyIconTrue",b="cell-boolean",a="String";qx.Class.define(d,{extend:qx.ui.virtual.cell.AbstractImage,construct:function(){qx.ui.virtual.cell.AbstractImage.call(this);this.__zh=qx.util.AliasManager.getInstance();}
,properties:{appearance:{refine:true,init:b},iconTrue:{check:a,themeable:true,apply:c},iconFalse:{check:a,themeable:true,apply:e}},members:{__Kx:null,__Ky:null,__zh:null,_applyIconTrue:function(f){this.__Kx=this.__zh.resolve(f);}
,_applyIconFalse:function(g){this.__Ky=this.__zh.resolve(g);}
,_identifyImage:function(h){return h==true?this.__Kx:this.__Ky;}
}});}
)();
