...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Element_2","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_2-qx.theme.Classic.1428d57c9ba6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="backgroundColor",i="demobrowser.demo.test.Element_2",h="color",g="Show inner element",f="Internal move while hidden -> show again",e="fontSize",d="Create five elements (2 hidden)",c="el2",b="Make complex hidden element visible",a="el4",z="Internal move while hidden",y="Create document",x="test",w="#ccc",v="20px",u="el5",t="red",s="el4_3",r="doc",q="Make simple hidden element visible",o="el3",p="el1",m="text",n="el4_2",k="el4_1",l="id";qx.Class.define(i,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);this.info(y);var A=new qx.html.Root(document.getElementById(x));A.setAttribute(l,r);this.info(d);var G=new qx.html.Element;G.setAttribute(l,p);var E=new qx.html.Element;E.setAttribute(l,c);var F=new qx.html.Element;F.setAttribute(l,o);var H=new qx.html.Element;H.setAttribute(l,a);var I=new qx.html.Element;I.setAttribute(l,u);A.add(G,E,F,H,I);E.exclude();H.exclude();qx.html.Element.flush();this.info(q);E.include();qx.html.Element.flush();this.info(b);var B=new qx.html.Element;B.setAttribute(l,k);var D=new qx.html.Element;D.setAttribute(l,n);D.setStyle(h,t);D.setAttribute(m,n);D.exclude();var C=new qx.html.Element;C.setAttribute(l,s);H.add(B,D,C);H.include();qx.html.Element.flush();this.info(g);D.include();qx.html.Element.flush();this.info(z);H.exclude();C.moveTo(0);H.remove(D);B.setStyle(e,v);B.setAttribute(m,k);H.setStyle(j,w);qx.html.Element.flush();this.info(f);H.include();qx.html.Element.flush();}
}});}
)();
