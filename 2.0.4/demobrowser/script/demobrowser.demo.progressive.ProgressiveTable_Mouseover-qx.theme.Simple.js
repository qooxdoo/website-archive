...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Mouseover-qx.theme.Simple.cece94b65991.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}});qx.Class.define(b,{extend:qx.ui.progressive.renderer.table.cell.Default,statics:{onmouseover:function(L){L.__QM=qx.bom.element.Style.get(L,f);L.style.color=r;L.parentNode.style.height=32;L.__QN=L.innerHTML;var N=Date.parse(L.attributes.getNamedItem(q).nodeValue);var M=new Date(N);L.innerHTML=M.toUTCString()+j+M.toString();}
,onmouseout:function(O){O.style.color=O.__QM;O.parentNode.style.height=16;O.innerHTML=O.__QN;}
