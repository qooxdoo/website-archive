...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Flow","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Flow-qx.theme.Modern.91fdbba0eee3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var b="No more lines to compute",a="qx.ui.layout.LineSizeIterator";qx.Class.define(a,{extend:Object,construct:function(c,d){this.__dY=c;this.__JV=d;this.__JW=c.length>0;this.__JX=0;}
,members:{__dY:null,__JV:null,__JW:null,__JX:null,computeNextLine:function(e){var e=e||Infinity;if(!this.__JW){throw new Error(b);}
;var p=this.__dY;var n=0;var g=0;var o=[];var k=[];for(var i=this.__JX;i<p.length;i++){var m=p[i];var q=m.getSizeHint();var j=this.__JY(i);var h=q.width+j;var f=i==this.__JX;if(!f&&g+h>e){this.__JX=i;break;}
;var l=q.height+m.getMarginTop()+m.getMarginBottom();o.push(m);k.push(j);g+=h;n=Math.max(n,l);if(m.getLayoutProperties().lineBreak){this.__JX=i+1;break;}
;}
;if(i>=p.length){this.__JW=false;}
;return {height:n,width:g,children:o,gapsBefore:k};}
,__JY:function(r){var s=r==this.__JX;if(s){return this.__dY[r].getMarginLeft();}
else {return Math.max(this.__dY[r-1].getMarginRight(),this.__dY[r].getMarginLeft(),this.__JV);}
;}
,hasMoreLines:function(){return this.__JW;}
}});}
)();
