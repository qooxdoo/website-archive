...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_Conditional","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Conditional-qx.theme.Modern.d8b9b58883cc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="1100EE",i="3300CC",h="2200DD",g="end",f="880077",e="Number 1",d="4400BB",c="0099FF",b="DD0022",a="center",G="660099",F="0066FF",E="AA0055",D="EE0011",C="990066",B="770088",A="BB0044",z="0000FF",y="right",w="00CCFF",q="bold",s="CC0033",o="demobrowser.demo.progressive.ProgressiveTable_Conditional",p="5500AA",m="FF0000",n="Number 2",k="0033FF",l="ID",t="row",u="",v=">";qx.Class.define(o,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var L=function(R){var S=[];for(var T=0;T<R;T++){var x=Math.random()*1000;S.push({renderer:t,location:g,data:[T,x,x]});}
;return S;}
;var O=new qx.ui.progressive.renderer.table.Widths(3);var J=[l,e,n];var K=new qx.ui.progressive.headfoot.TableHeading(O,J);var I=new qx.ui.progressive.headfoot.Progress(O,J);var Q=new qx.ui.progressive.structure.Default(K,I);var H=new qx.ui.progressive.Progressive(Q);var N=new qx.ui.progressive.model.Default();var M=L(100);N.addElements(M);H.setDataModel(N);var P=new qx.ui.progressive.renderer.table.Row(O);H.addRenderer(t,P);var r=new qx.ui.progressive.renderer.table.cell.Conditional(y,u,u,u);r.addNumericCondition(v,0,null,m,null,null);r.addNumericCondition(v,50,null,D,null,null);r.addNumericCondition(v,100,null,b,null,null);r.addNumericCondition(v,150,null,s,null,null);r.addNumericCondition(v,200,null,A,null,null);r.addNumericCondition(v,250,null,E,null,null);r.addNumericCondition(v,300,null,C,null,null);r.addNumericCondition(v,350,null,f,null,null);r.addNumericCondition(v,400,null,B,null,null);r.addNumericCondition(v,450,null,G,null,null);r.addNumericCondition(v,500,null,p,null,null);r.addNumericCondition(v,550,null,d,null,null);r.addNumericCondition(v,600,null,i,null,null);r.addNumericCondition(v,650,null,h,null,null);r.addNumericCondition(v,700,null,j,null,null);r.addNumericCondition(v,750,null,z,null,null);r.addNumericCondition(v,800,null,k,null,null);r.addNumericCondition(v,850,null,F,null,null);r.addNumericCondition(v,900,null,c,null,null);r.addNumericCondition(v,950,a,w,null,q);P.addRenderer(2,r);this.getRoot().add(H,{edge:50});H.render();}
}});}
)();
...
(function(){var v="regex cannot be null!",u="font-weight",t="Condition not recognized or value1/value2 is null!",s="Condition not recognized or value is null!",r="text-align",q='g',p="qx.ui.progressive.renderer.table.cell.Conditional",o=":",n=";",m="color",e="font-style",l="==",h=">",c="between",b="regex",g="<",f="!between",j=">=",a="!=",k="<=",d="";qx.Class.define(p,{extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(w,x,y,z){qx.ui.progressive.renderer.table.cell.Abstract.call(this);this.__Ks=[l,a,h,g,j,k];this.__Kt=[c,f];this.__Ku=[];this.__zc=w||d;this.__zd=x||d;this.__ze=y||d;this.__zf=z||d;}
,members:{__Ks:null,__Kt:null,__Ku:null,__zc:null,__zd:null,__ze:null,__zf:null,__zg:function(A,B){if(A.align){B[r]=A.align;}
;if(A.color){B[m]=A.color;}
;if(A.style){B[e]=A.style;}
;if(A.weight){B[u]=A.weight;}
;}
,addNumericCondition:function(C,D,E,F,G,H,I){if(!qx.lang.Array.contains(this.__Ks,C)||D==null){throw new Error(s);}
;this.__Ku.push({condition:C,align:E,color:F,style:G,weight:H,value1:D,target:I});}
,addBetweenCondition:function(J,K,L,M,N,O,P,Q){if(!qx.lang.Array.contains(this.__Kt,J)||K==null||L==null){throw new Error(t);}
;this.__Ku.push({condition:J,align:M,color:N,style:O,weight:P,value1:K,value2:L,target:Q});}
,addRegex:function(R,S,T,U,V,W){if(!R){throw new Error(v);}
;this.__Ku.push({condition:b,align:S,color:T,style:U,weight:V,regex:R,target:W});}
,_getCellStyle:function(X){if(this.__Ku.length==0){return X.style||d;}
;var i;var bc;var Y;var bb={"text-align":this.__zc,"color":this.__zd,"font-style":this.__ze,"font-weight":this.__zf};for(i=0;i<this.__Ku.length;i++){var bf=this.__Ku[i];bc=false;if(qx.lang.Array.contains(this.__Ks,bf.condition)){if(bf.target==null){Y=X.cellData;}
else {Y=X.element.data[bf.target];}
;switch(bf.condition){case l:if(Y==bf.value1){bc=true;}
;break;case a:if(Y!=bf.value1){bc=true;}
;break;case h:if(Y>bf.value1){bc=true;}
;break;case g:if(Y<bf.value1){bc=true;}
;break;case j:if(Y>=bf.value1){bc=true;}
;break;case k:if(Y<=bf.value1){bc=true;}
;break;};}
else if(qx.lang.Array.contains(this.__Kt,bf.condition)){if(bf.target==null){Y=X.cellData;}
else {Y=X.element.data[bf.target];}
;switch(bf.condition){case c:if(Y>=bf.value1&&Y<=bf.value2){bc=true;}
;break;case f:if(Y<bf.value1&&Y>bf.value2){bc=true;}
;break;};}
else if(bf.condition==b){if(bf.target==null){Y=X.cellData;}
else {Y=X.element.data[bf.target];}
;var ba=new RegExp(bf.value1,q);bc=ba.test(Y);}
;;if(bc){this.__zg(bf,bb);}
;var bd=[];for(var be in bb){if(bb[be]){bd.push(be,o,bb[be],n);}
;}
;}
;return bd.join(d);}
