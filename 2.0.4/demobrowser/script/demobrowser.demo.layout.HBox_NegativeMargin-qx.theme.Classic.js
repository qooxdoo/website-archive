...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.HBox_NegativeMargin","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox_NegativeMargin-qx.theme.Classic.bec6069a4183.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var i="demobrowser.demo.layout.HBox_NegativeMargin",h="yellow",g="gray",f="green",e="top",d="bottom",c="middle",b="blue",a="main";qx.Class.define(i,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(j);j.add(this.getBox1());j.add(this.getBox2());j.add(this.getBox3());j.add(this.getBox4());j.add(this.getBox5());j.add(this.getBox6());j.add(this.getBox7());}
,getBox1:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:a,backgroundColor:h,height:80,allowGrowX:false});var n=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:50,alignY:e});var m=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxHeight:50,alignY:c});var k=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxHeight:50,alignY:d});l.add(n);l.add(m);l.add(k);m.setMarginLeft(-10);k.setMarginLeft(-10);return l;}
,getBox2:function(){var p=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:a,backgroundColor:h,height:80,allowGrowX:false});var r=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:50,alignY:e});var q=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxHeight:50,alignY:c});var o=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxHeight:50,alignY:d});p.add(r);p.add(q);p.add(o);q.setMarginLeft(-10);q.setMarginRight(20);o.setMarginLeft(-10);return p;}
,getBox3:function(){var t=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:a,backgroundColor:h,height:80,width:500,allowGrowX:false});var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:50,alignY:e});var u=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxHeight:50,alignY:c});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxHeight:50,alignY:d});t.add(v,{flex:1});t.add(u,{flex:1});t.add(s,{flex:1});u.setMarginLeft(-10);s.setMarginLeft(-10);return t;}
,getBox4:function(){var x=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:a,backgroundColor:h,height:80,width:500,allowGrowX:false});var z=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:50,alignY:e});var y=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxHeight:50,alignY:c});var w=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxHeight:50,alignY:d});x.add(z,{flex:1});x.add(y,{flex:2});x.add(w,{flex:3});y.setMarginLeft(-10);w.setMarginLeft(-10);return x;}
,getBox5:function(){var B=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:a,backgroundColor:h,height:80,width:500,allowGrowX:false});var D=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:50,alignY:e});var C=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxHeight:50,alignY:c});var A=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxHeight:50,alignY:d});B.add(D,{flex:1});B.add(C,{flex:2});B.add(A,{flex:3});C.setMarginLeft(-10);A.setMarginLeft(-10);D.setWidth(0);C.setWidth(0);A.setWidth(0);return B;}
,getBox6:function(){var F=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:a,backgroundColor:h,height:80,width:200,allowGrowX:false});var H=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:50,alignY:e});var G=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxHeight:50,alignY:c});var E=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxHeight:50,alignY:d});F.add(H,{flex:1});F.add(G,{flex:1});F.add(E,{flex:1});G.setMarginLeft(-10);E.setMarginLeft(-10);return F;}
,getBox7:function(){var J=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:a,backgroundColor:h,height:80,width:200,allowGrowX:false});var L=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:50,alignY:e});var K=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxHeight:50,alignY:c});var I=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxHeight:50,alignY:d});J.add(L,{flex:1});J.add(K,{flex:2});J.add(I,{flex:3});K.setMarginLeft(-10);I.setMarginLeft(-10);return J;}
}});}
)();
