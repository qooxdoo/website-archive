...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.CheckBox-qx.theme.Indigo.353a27c6577b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="",n=", ",m="demobrowser.demo.widget.CheckBox",l="Bathing togs",k="Are you sure you need nothing for the beach?",j="_checkBoxes",h="OK",g="Towel",f="You need these things for the beach: ",d="Sun Oil",a="Beer",c="What do you need for the beach?",b="execute";qx.Class.define(m,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var t=new qx.ui.basic.Label(c);var r=new qx.ui.layout.VBox();r.setSpacing(10);var q=new qx.ui.container.Composite(r);q.setPadding(20);this.getRoot().add(q,{left:0,top:0});q.add(t);var p=new qx.ui.form.CheckBox(d);var w=new qx.ui.form.CheckBox(g);var u=new qx.ui.form.CheckBox(a);var v=new qx.ui.form.CheckBox(l);this._checkBoxes=[p,w,u,v];q.add(p);q.add(w);q.add(u);q.add(v);var s=new qx.ui.form.Button(h);s.addListener(b,this._onExecute,this);s.setAllowGrowX(false);q.add(s);}
,_onExecute:function(e){var y=this._checkBoxes;var x=0;var z=o;for(var i=0;i<y.length;i++){if(y[i].getValue()){x++;z+=(y[i].getLabel()+n);}
;}
;if(x>0){z=z.substring(0,z.length-2);alert(f+z);}
else {alert(k);}
;}
