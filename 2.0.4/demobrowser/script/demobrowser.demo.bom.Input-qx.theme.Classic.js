...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Input","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Input-qx.theme.Classic.f737aabe0088.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="Changed selectbox1: ",k="text",j="Change (Single): ",h="file",g="Changed checkbox 1: ",f="Changed selectbox3: ",d="Changed radio: ",c="Changed file select: ",b="val2",a="Change (Multi): ",C="demobrowser.demo.bom.Input",B=" = ",A="Changed checkbox 2: ",z="textarea",y="val1",x="Changed selectbox2: ",w="Input (Multi): ",v="Input (Single): ",u="radio1",t="radio",r="input",s="checkbox",p="VAL",q="option",n="select",o="Value ",m="change";qx.Class.define(C,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var K=qx.bom.Input.create(k);qx.event.Registration.addListener(K,r,function(e){this.debug(v+e.getData());}
,this);qx.event.Registration.addListener(K,m,function(e){this.debug(j+e.getData());}
,this);var F=qx.bom.Input.create(z);qx.event.Registration.addListener(F,r,function(e){this.debug(w+e.getData());}
,this);qx.event.Registration.addListener(F,m,function(e){this.debug(a+e.getData());}
,this);document.body.appendChild(K);document.body.appendChild(F);var J=qx.bom.Input.create(s);var N=qx.bom.Input.create(s,{checked:true});qx.event.Registration.addListener(J,m,function(e){this.debug(g+e.getData());}
,this);qx.event.Registration.addListener(N,m,function(e){this.debug(A+e.getData());}
,this);document.body.appendChild(J);document.body.appendChild(N);var M=qx.bom.Input.create(t,{name:u,value:y,checked:true});var O=qx.bom.Input.create(t,{name:u,value:b});function E(e){this.debug(d+e.getTarget().name+B+e.getData());}
;qx.event.Registration.addListener(M,m,E,this);qx.event.Registration.addListener(O,m,E,this);document.body.appendChild(M);document.body.appendChild(O);var D=qx.bom.Input.create(n);var L;for(var i=0;i<10;i++){L=document.createElement(q);L.value=p+i;L.appendChild(document.createTextNode(o+i));D.appendChild(L);}
;qx.event.Registration.addListener(D,m,function(e){this.debug(l+e.getData());}
,this);document.body.appendChild(D);var H=qx.bom.Input.create(n,{size:3});var L;for(var i=0;i<10;i++){L=document.createElement(q);L.value=p+i;L.appendChild(document.createTextNode(o+i));H.appendChild(L);}
;qx.event.Registration.addListener(H,m,function(e){this.debug(x+e.getData());}
,this);document.body.appendChild(H);var I=qx.bom.Input.create(n,{size:3,multiple:true});var L;for(var i=0;i<10;i++){L=document.createElement(q);L.value=p+i;L.appendChild(document.createTextNode(o+i));I.appendChild(L);}
;qx.event.Registration.addListener(I,m,function(e){this.debug(f+e.getData());}
,this);document.body.appendChild(I);var G=qx.bom.Input.create(h);qx.event.Registration.addListener(G,m,function(e){this.debug(c+e.getData());}
