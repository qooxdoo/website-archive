...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.MouseEvent_LowLevel","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent_LowLevel-qx.theme.Simple.f72210b5cf09.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="demobrowser.demo.event.MouseEvent_LowLevel",k="mouseout",j="mousedown",h="clientX",g="dblclick",f="relatedTarget",d="button",c="mousemove",b="screenX",a="logger",y="",x="_",w="mouseover",v="check_",u="click",t="Event",s="Target",r="clientY",q="mouseup",p="contextmenu",n="change",o="screenY",m="mouse";qx.Class.define(l,{extend:demobrowser.demo.event.EventDemo,members:{__Qo:null,main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this.__Qo=qx.lang.Function.bind(this.logMouseEvent,this);this._initLogger([s,t,d,h,r,b,o,f],document.getElementById(a),50);var z=document.getElementById(m);var A=[j,q,u,g,p,c,w,k];for(var i=0;i<A.length;i++){var B=document.getElementById(v+A[i]);if(B.checked){qx.bom.Event.addNativeListener(z,A[i],this.__Qo);}
;qx.bom.Event.addNativeListener(B,n,qx.lang.Function.bind(this.__Qn,this));}
;}
,__Qn:function(e){var F=qx.bom.Event.getTarget(e);var E=F.id.split(x)[1];var C=F.checked;var D=document.getElementById(m);if(C){qx.bom.Event.addNativeListener(D,E,this.__Qo);}
else {qx.bom.Event.removeNativeListener(D,E,this.__Qo);}
;}
