...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Html-qx.theme.Indigo.aa5155caab98.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="2*",n="1*",m="    I'm red!",l="  </span>",k="end",j="Literal",i="  Hi there.",h="  <span style='color: red;'>",g="demobrowser.demo.progressive.ProgressiveTable_Html",f="  Hello world!",c="    &nbsp;&nbsp;&nbsp;",e="Html",d="</div>",b="<div style='background-color: cyan; text-align: center;'>",a="row";qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var y=function(B,C){var D={renderer:a,location:k,data:[B,B]};return D;}
;var x=new qx.ui.progressive.renderer.table.Widths(2);x.setWidth(0,o);x.setWidth(1,n);var s=[j,e];var u=new qx.ui.progressive.headfoot.TableHeading(x,s);var q=new qx.ui.progressive.headfoot.Progress(x,s);var A=new qx.ui.progressive.structure.Default(u,q);var p=new qx.ui.progressive.Progressive(A);var w=new qx.ui.progressive.model.Default();var v=[];var t=b+f+d;v.push(y(t));var t=b+i+h+c+m+l+d;v.push(y(t));w.addElements(v);p.setDataModel(w);var z=new qx.ui.progressive.renderer.table.Row(x);p.addRenderer(a,z);var r=new qx.ui.progressive.renderer.table.cell.String();z.addRenderer(0,r);var r=new qx.ui.progressive.renderer.table.cell.Html();z.addRenderer(1,r);this.getRoot().add(p,{edge:50});p.render();}
}});}
)();
...
,members:{__nO:null,renderLayout:function(f,top,g,h){this.__nO=g;}
,getComputedWidth:function(){return this.__nO;}
...
,members:{__Jz:null,join:function(c){this.__Jz=c;}
...
(function(){var f="resize",d="progressive-table-header",c="_layout",b="qx.ui.progressive.headfoot.TableHeading",a="progressive-table-header-cell";qx.Class.define(b,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(g,h){qx.ui.progressive.headfoot.Abstract.call(this);this.__Jw=g;var k=g.getData();this.__FH=[];for(var i=0;i<k.length;i++){var l=new qx.ui.basic.Atom(h[i]);l.setAppearance(a);this.add(l);this.__FH[i]=l;}
;var j=new qx.ui.core.Widget();j.set({height:16,appearance:a,minWidth:0,width:0});this.add(j,{flex:1});this.addListener(f,this._resizeColumns,this);this.__nQ=new qx.ui.layout.HBox();this.__nQ.connectToWidget(this);}
,properties:{appearance:{refine:true,init:d}},members:{__Jw:null,__Kz:null,__FH:null,__nQ:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);}
,getLayoutChildren:function(){if(this.__Kz){return this.__Jw.getData();}
else {return qx.ui.progressive.headfoot.Abstract.prototype.getLayoutChildren.call(this);}
;}
,_resizeColumns:function(e){var n=this.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();this.__Kz=true;this.__nQ.renderLayout(n,100);this.__Kz=false;var o=this.__Jw.getData();for(var i=0;i<o.length;i++){this.__FH[i].setWidth(o[i].getComputedWidth());}
;}
},destruct:function(){this.__Jw=this.__FH=null;this._disposeObjects(c);}
});}
)();
(function(){var n="progressive-progressbar-indicator-undone",m="__Me",l="progress",k="%",j="progressive-progressbar-indicator-done",i="progressive-progressbar-percent-text",h="renderStart",g="progressive-progressbar-background",f="0%",d="qx.ui.progressive.headfoot.Progress",a="__Mf",c="progressive-progressbar-percent-background",b="renderEnd";qx.Class.define(d,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(o,p){qx.ui.progressive.headfoot.Abstract.call(this);this.setHeight(16);this.setPadding(0);this.__JA={};var q=qx.theme.manager.Color.getInstance();this.__JA.background=q.resolve(g);this.__JA.indicatorDone=q.resolve(j);this.__JA.indicatorUndone=q.resolve(n);this.__JA.percentBackground=q.resolve(c);this.__JA.percentText=q.resolve(i);this.set({backgroundColor:this.__JA.background});this.__Me=new qx.ui.core.Widget();this.__Me.set({width:0,backgroundColor:this.__JA.indicatorDone});this.add(this.__Me);var r=new qx.ui.core.Widget();r.set({backgroundColor:this.__JA.indicatorUndone});this.add(r,{flex:1});this.__Mf=new qx.ui.basic.Atom(f);this.__Mf.set({width:100,backgroundColor:this.__JA.percentBackground,textColor:this.__JA.percentText});this.add(this.__Mf);this.exclude();}
,members:{__Mg:null,__JA:null,__Me:null,__Mf:null,join:function(s){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,s);s.addListener(h,function(e){this.__Mg=e.getData().initial;this.show();}
...
,this);}
},destruct:function(){this.__JA=null;this._disposeObjects(m,a);}
});}
)();
(function(){var e="applyStructure() is abstract",d="abstract",c="qx.ui.progressive.structure.Abstract",b="overflowY",a="auto";qx.Class.define(c,{type:d,extend:qx.core.Object,construct:function(f){qx.core.Object.call(this);if(!f){this.__Fa=new qx.ui.core.Widget();this.__AK=this.__Fa;}
else {this.__Fa=null;this.__AK=f;}
;this.__AK.getContentElement().setStyle(b,a);}
,members:{__Fa:null,__AK:null,applyStructure:function(g){throw new Error(e);}
,getPane:function(){return this.__AK;}
},destruct:function(){if(this.__Fa){this.__Fa.dispose();}
;this.__Fa=this.__AK=null;}
});}
)();
(function(){var a="qx.ui.progressive.structure.Default";qx.Class.define(a,{extend:qx.ui.progressive.structure.Abstract,construct:function(b,c,d){qx.ui.progressive.structure.Abstract.call(this,d);if(!b){this.__Kp=new qx.ui.progressive.headfoot.Null();this.__oX=this.__Kp;}
else {this.__Kp=null;this.__oX=b;}
;if(!c){this.__Kq=new qx.ui.progressive.headfoot.Null();this.__Kr=this.__Kq;}
else {this.__Kq=null;this.__Kr=c;}
;}
,members:{__oX:null,__Kr:null,__Kp:null,__Kq:null,applyStructure:function(e){this.__oX.join(e);this.__Kr.join(e);e.add(this.__oX);e.add(this.getPane(),{flex:1});e.add(this.__Kr);}
,getHeader:function(){return this.__oX;}
,getFooter:function(){return this.__Kr;}
},destruct:function(){if(this.__Kp){this.__Kp.dispose();this.__Kp=null;}
;if(this.__Kq){this.__Kq.dispose();this.__Kq=null;}
;this.__oX=this.__Kr=null;}
});}
)();
...
;z=x.element;y=this.__FI[z.renderer];y.render(w,z);this.fireDataEvent(g,{initial:this.__Lv,remaining:x.remaining,element:z});}
...
,__Ly:function(){var A={};for(var name in this.__FI){A[name]={};}
;return A;}
,__Lz:function(e){this.__Lv=e.getData();this.render();}
},destruct:function(){for(var name in this.__FI){this.__FI[name].dispose();}
;this.__Lw=this.__FI=this.__Ls=null;}
});}
)();
...
(function(){var b="qx.ui.progressive.model.Default",a="dataAvailable";qx.Class.define(b,{extend:qx.ui.progressive.model.Abstract,construct:function(){qx.ui.progressive.model.Abstract.call(this);this.__Cw=[];}
,members:{__Cw:null,addElements:function(c){this.__Cw=this.__Cw.concat(c);this.fireDataEvent(a,this.__Cw.length);}
,addElement:function(d){this.__Cw.push(d);this.fireDataEvent(a,this.__Cw.length);}
,getElementCount:function(){return this.__Cw.length;}
,getNextElement:function(){if(this.__Cw.length>0){return ({element:this.__Cw.shift(),remaining:this.__Cw.length});}
;return null;}
...
(function(){var l="px",k="px ",j="padding: ",h="end",g="__Jy",f="div",d="qx.tableResizeDebug",c="  width : 100%;",b=" {",a="__columnData",O="Renderer is already joined to a Progressive.",N="css.boxmodel",M="col ",L="qx.debug",K="Invalid location: ",J="relative",I="-row {",H="resize",G="start",F="",s=": width=",t="content",q="qx.ui.progressive.renderer.table.Row",r="progressive-table-row-background-odd",o="progressive-table-row-background-even",p="__nQ",m="left: ",n="No existing renderer for column ",u=")",v=" out of range (max: ",y="}",x="width: ",A="0px ",z="qx-progressive-",C="Column ",B="-row",w="-col-",E="px;",D=".qx-progressive-";qx.Class.define(q,{extend:qx.ui.progressive.renderer.Abstract,construct:function(P){qx.ui.progressive.renderer.Abstract.call(this);this.__Jw=P;this.__Jx={};this.__Jy=new qx.ui.progressive.renderer.table.cell.Default();this.__Jz=null;this.__JA={};var Q=qx.theme.manager.Color.getInstance();this.__JA.bgcol=[];this.__JA.bgcol[0]=Q.resolve(o);this.__JA.bgcol[1]=Q.resolve(r);this.__nQ=new qx.ui.layout.HBox();this.__nQ.connectToWidget(this);}
,statics:{__nf:null,__JB:6,__JC:"  position: absolute;"+"  top: 0px;"+"  height: 100%;"+"  overflow:hidden;"+(qx.core.Environment.get("css.textoverflow")?qx.lang.String.hyphenate(qx.core.Environment.get("css.textoverflow"))+':ellipsis;':"")+"  white-space:nowrap;"+"  border-right:1px solid #f2f2f2;"+"  border-bottom:1px solid #eeeeee;"+"  padding : 0px 6px 0px 6px;"+"  cursor:default;"+"  font-size: 11px;"+"  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;"+(qx.core.Environment.get("css.userselect")?qx.lang.String.hyphenate(qx.core.Environment.get("css.userselect"))+':'+qx.core.Environment.get("css.userselect.none")+';':'')},properties:{defaultRowHeight:{init:16}},members:{__Jz:null,__BL:null,__JD:null,__Jw:null,__Jx:null,__Jy:null,__JA:null,__nQ:null,join:function(R,name){if(this.__Jz){throw new Error(O);}
;this.__Jz=R;this.__BL=name;var T=qx.ui.progressive.renderer.table.Row;if(!T.__nf){T.__nf={};}
;var S=R.toHashCode();if(!T.__nf[S]){T.__nf[S]={rowstylesheet:null,cellstylesheet:[]};var U=D+S+I+c+y;T.__nf[S].rowstylesheet=qx.bom.Stylesheet.createElement(U);var V=this.__Jw.getData();for(var i=0;i<V.length;i++){var U=D+S+w+i+b+T.__JC+y;T.__nf[S].cellstylesheet[i]=qx.bom.Stylesheet.createElement(U);}
;this.__JD=S;var W=R.getStructure().getPane();W.addListener(H,this._resizeColumns,this);}
;}
,addRenderer:function(X,Y){var ba=this.__Jw.getData();if(X<0||X>=ba.length){throw new Error(C+X+v+(ba.length-1)+u);}
;this.__Jx[X]=Y;}
,removeRenderer:function(bb){var bc=this.__Jw.getData();if(bb<0||bb>=bc.length){throw new Error(C+bb+v+(bc.length-1)+u);}
;if(!this.__Jx[bb]){throw new Error(n+bb);}
;delete this.__Jx[bb];}
,render:function(bd,be){var bo=be.data;var bj=[];var bl;var bk;var bh=0;if(bd.getRendererData()[this.__BL].end===undefined){bd.getRendererData()[this.__BL]={end:0,start:1,rows:0,totalHeight:0};}
;var bn=document.createElement(f);for(var i=0;i<bo.length;i++){var bi=z+this.__JD+w+i;bk=this.__Jx[i]||this.__Jy;bl={state:bd,rowDiv:bn,stylesheet:bi,element:be,dataIndex:i,cellData:bo[i],height:bh};bj.push(bk.render(bl));if(bl.height>bh){bh=bl.height;}
;}
;bh=(bh>0?bh:this.getDefaultRowHeight());var bm=bd.getRendererData()[this.__BL];bm.totalHeight+=bh;bn.style.position=J;bn.style.height=bh+l;bn.className=z+this.__JD+B;bn.innerHTML=bj.join(F);switch(be.location){case h:var bf=bm.end||0;bn.style.backgroundColor=this.__JA.bgcol[bf];bm.end=(bf==0?1:0);bd.getPane().getContentElement().getDomElement().appendChild(bn);break;case G:var bg=bd.getPane().getContentElement().getDomElement();var bp=bg.childNodes;if(bp.length>0){var bf=bm.start;bn.style.backgroundColor=this.__JA.bgcol[bf];bm.start=(bf==0?1:0);bg.insertBefore(bn,bp[0]);break;}
else {bg.appendChild(bn);}
;break;default:throw new Error(K+be.location);};++bm.rows;}
,getLayoutChildren:function(){return this.__Jw.getData();}
,_resizeColumns:function(e){var bx=this.__Jz.getStructure().getPane();var bu=bx.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();var bv=D+this.__JD+B;var br=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(br.__nf[this.__JD].rowstylesheet,bv);var bt=x+bu+E;qx.bom.Stylesheet.addRule(br.__nf[this.__JD].rowstylesheet,bv,bt);this.__nQ.renderLayout(bu,100);var bw=this.__Jw.getData();for(var i=0,bA=0;i<bw.length;i++,bA+=bu){var bv=D+this.__JD+w+i;var br=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(br.__nf[this.__JD].cellstylesheet[i],bv);bu=bw[i].getComputedWidth();if(qx.core.Environment.get(L)){if(qx.core.Environment.get(d)){this.debug(M+i+s+bu);}
;}
;var bs;if(qx.core.Environment.get(N)==t){bs=qx.ui.progressive.renderer.table.Row.__JB*2;}
else {bs=-1;}
;var bz=(bu-bs)+E;var by=A+qx.ui.progressive.renderer.table.Row.__JB+k+A+qx.ui.progressive.renderer.table.Row.__JB+E;var bq=bA+E;var bt=br.__JC+x+bz+m+bq+j+by;qx.bom.Stylesheet.addRule(br.__nf[this.__JD].cellstylesheet[i],bv,bt);}
;}
},destruct:function(){var name;for(name in this.__Jx){this.__Jx[name]=null;}
;var bC=qx.ui.progressive.renderer.table.Row;var bB=this.__Jz.toHashCode();if(bC.__nf&&bC.__nf[bB]){if(bC.__nf[bB].rowstylesheet){var bE=D+this.__JD+B;var bC=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bC.__nf[this.__JD].rowstylesheet,bE);}
;if(bC.__nf[bB].cellstylesheet){for(var i=bC.__nf[bB].cellstylesheet.length-1;i>=0;i--){var bE=D+this.__JD+w+i;var bD=bC.__nf[this.__JD].cellstylesheet[i];var bC=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bD,bE);}
;}
;}
;if(this.__Jz&&this.__Jz.getRendererData){var bF=this.__Jz.getRendererData();if(bF&&bF[this.__BL]&&bF[this.__BL].end!==undefined){bF[this.__BL]=null;}
;}
;this.__JA=this.__Jx=this.__Jz=this.__Jw=null;this._disposeObjects(p,g,a);}
});}
)();
...
(function(){var a="qx.ui.progressive.renderer.table.cell.String";qx.Class.define(a,{extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(){qx.ui.progressive.renderer.table.cell.Abstract.call(this);}
,members:{_getContentHtml:function(b){return qx.bom.String.escape(b.cellData);}
}});}
)();
(function(){var a="qx.ui.progressive.renderer.table.cell.Html";qx.Class.define(a,{extend:qx.ui.progressive.renderer.table.cell.Abstract});}
)();
