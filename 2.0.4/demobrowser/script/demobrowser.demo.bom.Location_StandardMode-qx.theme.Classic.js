...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Location_StandardMode","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Location_StandardMode-qx.theme.Classic.2c388ed6d9d1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="borderBottomWidth",o="list",n='#',m="css.boxmodel",k="mode",j="borderTopWidth",h="borderLeftWidth",g="a",f="border",e="div",b="borderRightWidth",d="demobrowser.demo.bom.Location_StandardMode",c="moveable",a="px";qx.Class.define(d,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var q=document.getElementById(o).getElementsByTagName(g);for(var i=0,l=q.length;i<l;i++){q[i].onclick=demobrowser.demo.bom.Location_StandardMode.jump;}
;}
...
;var t=this.href;var v=t.substr(t.indexOf(n)+1);var s=document.getElementById(v);var location=qx.bom.element.Location.get(s,document.getElementById(k).value);var u=document.getElementById(c);u.style.left=location.left+a;u.style.top=location.top+a;if(qx.core.Environment.get(m)==f){u.style.width=(location.right-location.left)+a;u.style.height=(location.bottom-location.top)+a;}
else {u.style.width=(location.right-location.left-r(u,h)-r(u,b))+a;u.style.height=(location.bottom-location.top-r(u,j)-r(u,p))+a;}
;return false;}
,randomize:function(){var y=document.body.getElementsByTagName(e);for(var i=0,l=y.length;i<l;i++){if(y[i].id&&y[i].id!=c){y[i].style.margin=Math.round(Math.random()*10)+a;y[i].style.padding=Math.round(Math.random()*10)+a;y[i].style.borderWidth=Math.round(Math.random()*10)+a;}
;}
;}
}});}
)();
