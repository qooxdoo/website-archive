...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox-qx.theme.Classic.eedcdd22b3bf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var i="demobrowser.demo.layout.HBox",h="top",g="bottom",f="middle",e="center",d="right",c="yellow",b="green",a="main";qx.Class.define(i,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(j);j.add(this.getBox1());j.add(this.getBox2());j.add(this.getBox3());j.add(this.getBox4());j.add(this.getBox5());j.add(this.getBox6());j.add(this.getBox7());}
,getBox1:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:a,backgroundColor:c,allowGrowX:false});k.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));k.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));k.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));return k;}
,getBox2:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:a,backgroundColor:c,minHeight:60,allowGrowX:false});l.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:40,alignY:h}));l.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:40,alignY:f}));l.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:40,alignY:g}));return l;}
,getBox3:function(){var m=new qx.ui.layout.HBox();var n=new qx.ui.container.Composite(m).set({decorator:a,backgroundColor:c,width:500,allowGrowX:false});m.setSpacing(5);m.setAlignX(d);n.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));n.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));n.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));return n;}
,getBox4:function(){var o=new qx.ui.layout.HBox();var p=new qx.ui.container.Composite(o).set({decorator:a,backgroundColor:c,width:500,allowGrowX:false});o.setSpacing(5);o.setAlignX(e);p.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));p.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));p.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));return p;}
,getBox5:function(){var r=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:a,backgroundColor:c,allowGrowX:false});var t=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var q=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});r.add(t);r.add(s);r.add(q);t.setMarginRight(10);s.setMarginLeft(20);s.setMarginRight(10);q.setMarginRight(10);return r;}
,getBox6:function(){var u=new qx.ui.layout.HBox();var w=new qx.ui.container.Composite(u).set({decorator:a,backgroundColor:c,width:500,allowGrowX:false});u.setSpacing(5);u.setAlignX(d);var y=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var x=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});w.add(y);w.add(x);w.add(v);y.setMarginRight(10);x.setMarginLeft(20);x.setMarginRight(10);v.setMarginRight(10);return w;}
,getBox7:function(){var z=new qx.ui.layout.HBox();var B=new qx.ui.container.Composite(z).set({decorator:a,backgroundColor:c,width:500,allowGrowX:false});z.setSpacing(5);z.setAlignX(e);var D=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var C=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var A=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});B.add(D);B.add(C);B.add(A);D.setMarginRight(10);C.setMarginLeft(20);C.setMarginRight(10);A.setMarginRight(10);return B;}
}});}
)();
