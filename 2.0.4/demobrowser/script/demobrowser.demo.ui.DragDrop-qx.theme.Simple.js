...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.DragDrop","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.DragDrop-qx.theme.Simple.081d32ce11fe.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="drag",k="TextArea Target",j="solid",h="Reorderable",g="qx.ui.form.ListItem",f="droprequest",d="#33508D",c="Source",b="Related of droprequest: ",a="__Dm",C="demobrowser.demo.ui.DragDrop",B="Simple Target",A="Enable drag",z="\n",y="dragend",x="icon/16/places/folder.png",w="dragstart",v="Item ",u="copy",t="Related of drop: ",r="move",s="multi",p="dragover",q="drop",n="value",o="items";qx.Class.define(C,{extend:qx.application.Standalone,members:{__Dm:null,__Rp:null,main:function(){qx.application.Standalone.prototype.main.call(this);var O=this.getRoot();var I=new qx.ui.container.Scroll();var D=new qx.ui.layout.Basic();var G=new qx.ui.container.Composite(D).set({allowStretchY:false,allowStretchX:false});I.add(G);O.add(I,{edge:0});var N=new qx.ui.basic.Label(c);G.add(N,{left:20,top:20});var L=new qx.ui.form.List;L.setDraggable(true);L.setSelectionMode(s);G.add(L,{left:20,top:40});for(var i=0;i<20;i++){L.add(new qx.ui.form.ListItem(v+i,x));}
...
;}
);var J=new qx.ui.basic.Label(k);G.add(J,{left:260,top:20});var M=new qx.ui.form.TextArea;M.setDroppable(true);M.setHeight(100);G.add(M,{left:260,top:40});M.addListener(q,function(e){this.debug(t+e.getRelatedTarget());this.setValue(e.getData(n).replace(/,/g,z));}
);M.addListener(p,function(e){if(!e.supportsType(n)){e.preventDefault();}
;}
);var K=new qx.ui.basic.Label(h);G.add(K,{left:500,top:20});var E=this.__Dm=new qx.ui.form.List;E.setDraggable(true);E.setDroppable(true);E.setSelectionMode(s);G.add(E,{left:500,top:40});for(var i=0;i<20;i++){E.add(new qx.ui.form.ListItem(v+i,x));}
...
);E.addListener(m,function(e){var X=e.getOriginalTarget();if(X instanceof qx.ui.form.ListItem){qx.core.Init.getApplication().__Rp=X;}
...
;}
);E.addListener(q,function(e){this.__Rq(e.getOriginalTarget());}
,this);F.addListener(q,function(e){this.__Rq(this.__Rp);}
,this);}
,__Rq:function(Y){if(Y.classname!=g){return;}
;var ba=this.__Dm.getSortedSelection();for(var i=0,l=ba.length;i<l;i++){this.__Dm.addBefore(ba[i],Y);this.__Dm.addToSelection(ba[i]);}
;}
},destruct:function(){this._disposeObjects(a);}
});}
)();
