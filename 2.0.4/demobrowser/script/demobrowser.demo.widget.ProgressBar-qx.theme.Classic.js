...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.ProgressBar","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ProgressBar-qx.theme.Classic.dc5fa4eefd15.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="black",j="%)",i="Completed: ",h="change",g="demobrowser.demo.widget.ProgressBar",f=" (",d="changeValue",c="green",b="Completed: 0 (0%)",a="complete";qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var q=this.getRoot();var l=new qx.ui.layout.VBox();var n=new qx.ui.container.Composite(l);var o=new qx.ui.indicator.ProgressBar(0,200);var p=new qx.ui.form.Slider().set({minimum:0,maximum:200});var m=new qx.ui.basic.Label();q.add(n,{left:0,top:0});n.add(o);n.add(p);n.add(m);l.setSpacing(10);n.setPadding(20);m.setValue(b);p.addListener(d,function(e){o.setValue(e.getData());}
);o.addListener(h,function(e){m.setValue(i+o.getValue()+f+e.getData()+j);m.setTextColor(k);}
);o.addListener(a,function(e){m.setTextColor(c);}
);}
}});}
)();
...
;}
,properties:{appearance:{refine:true,init:g}},events:{complete:d,change:b},members:{__xf:0,__Li:100,getValue:function(){return this.__xf;}
,setValue:function(l){var m=this.getMaximum();if(!qx.lang.Type.isNumber(l)||!isFinite(l)){return;}
;if(l<0){l=0;}
;if(l>m){l=m;}
;this.__xf=l;this._changeProgress(l/m);return l;}
,getMaximum:function(){return this.__Li;}
,setMaximum:function(n){var o=n;var p=this.getValue();if(!qx.lang.Type.isNumber(o)||!isFinite(o)||o<=0){return;}
;if(o<p){o=p;}
;this.__Li=o;this._changeProgress(p/o);return o;}
