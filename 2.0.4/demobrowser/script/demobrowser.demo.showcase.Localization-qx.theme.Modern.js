...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.showcase.Localization","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.showcase.Localization-qx.theme.Modern.1a0957bfa9cf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="icon/16/actions/edit-find.png",n="Locale information",m="Ctrl+V",l="icon/16/actions/edit-cut.png",k="<table style='font-size:11px'><tr><td>",j="Del",h="Date medium:",g="</td></tr></table>",f="Open Color Popup",d="en",bt="changeValue",bs="Time format long:",br="mousedown",bq="Format of %1:",bp="Locale:",bo="F3",bn="Undo",bm="Date short:",bl="Date full:",bk="Date format short:",v="changeLocale",w="#23F3C1",t="qx.debug",u="Time long:",r="Ctrl+Z",s="Choose a locale:",p="wide",q="Ctrl+X",D="changeSelection",E="middle",P="Delete",M="Select All",X="Date long:",S="icon/16/actions/edit-copy.png",bg="A date:",bd="Date format medium:",I="Date format full:",bj="Week start:",bi="Ctrl+F",bh="icon/16/actions/edit-paste.png",H="icon/16/actions/edit-delete.png",K="Date format long:",L="right",O="main",Q="Search",T="Locale Information",ba="Redo",bf="Ctrl+C",x="demobrowser.demo.showcase.Localization",y="Time short:",J="Ctrl+A",W="Search Again",V="Localized ComboBox:",U="Time format short:",bc="Territory code:",bb="Ctrl+Y",R="Colors",Y="Command Menu (keyboard shortcuts)",a="Form Elements",be="</td></tr><td>",z="</td><td>",A="Cut",N="medium",b="Copy",c="full",G="Paste",B="short",C="long",F="";qx.Class.define(x,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);if((qx.core.Environment.get(t))){qx.log.appender.Native;qx.log.appender.Console;}
;var bP=new qx.ui.layout.Grid(10,10);bP.setColumnFlex(0,1);bP.setColumnFlex(1,1);bP.setRowFlex(3,1);bP.setColumnAlign(0,L,E);var bF=new qx.ui.window.Window(this.tr(a)).set({showClose:false,showMinimize:false});bF.setLayout(bP);bF.moveTo(50,50);bF.open();var bY=qx.locale.Manager.getInstance();var bI=bY.getAvailableLocales().sort();var bB=bY.getLocale();var bX=new qx.ui.basic.Label(this.tr(s));bF.add(bX,{row:0,column:0});var bA=new qx.ui.form.SelectBox();var bL=null;for(var i=0;i<bI.length;i++){var bQ=new qx.ui.form.ListItem(bI[i]);bA.add(bQ);if((!bL&&bI[i]==d)||bI[i]==bB){bL=bQ;}
;}
;bA.addListener(D,function(e){var cc=e.getData()[0].getLabel();qx.locale.Manager.getInstance().setLocale(cc);}
);if(bL){bA.setSelection([bL]);}
;bF.add(bA,{row:0,column:1});bF.add(new qx.ui.basic.Label(this.tr(V)),{row:1,column:0});var bD=new qx.ui.form.ComboBox();bD.add(new qx.ui.form.ListItem(this.tr(A)));bD.add(new qx.ui.form.ListItem(this.tr(G)));bD.add(new qx.ui.form.ListItem(this.tr(b)));bF.add(bD,{row:1,column:1});var ca=new qx.ui.basic.Label(this.tr(bg));bF.add(ca,{row:2,column:0});var bz=new qx.ui.form.DateField();bz.setValue(new Date);bF.add(bz,{row:2,column:1});var bE=new qx.ui.control.DateChooser;bF.add(bE,{row:3,column:0,colSpan:2});var bv=new qx.ui.core.Command(r);var bG=new qx.ui.core.Command(bb);var bu=new qx.ui.core.Command(q);var bW=new qx.ui.core.Command(bf);var cb=new qx.ui.core.Command(m);var bS=new qx.ui.core.Command(j);var bR=new qx.ui.core.Command(J);var bC=new qx.ui.core.Command(bi);var bw=new qx.ui.core.Command(bo);var bH=new qx.ui.menu.Menu;bH.add(new qx.ui.menu.Button(this.tr(bn),null,bv));bH.add(new qx.ui.menu.Button(this.tr(ba),null,bG));bH.add(new qx.ui.menu.Separator());bH.add(new qx.ui.menu.Button(this.tr(A),l,bu));bH.add(new qx.ui.menu.Button(this.tr(b),S,bW));bH.add(new qx.ui.menu.Button(this.tr(G),bh,cb));bH.add(new qx.ui.menu.Button(this.tr(P),H,bS));bH.add(new qx.ui.menu.Button(this.tr(M),null,bR));bH.add(new qx.ui.menu.Separator());bH.add(new qx.ui.menu.Button(this.tr(Q),null,bC));bH.add(new qx.ui.menu.Button(this.tr(W),null,bw));var by=new qx.ui.form.MenuButton(this.tr(Y),null,bH);bF.add(by,{row:4,column:0,colSpan:2});var bV=new qx.ui.control.ColorPopup();bV.exclude();bV.setValue(w);var bT=new qx.ui.form.Button(this.tr(f));bT.addListener(br,function(e){bV.placeToMouse(e);bV.show();}
);bF.add(bT,{row:5,column:0});var bJ=new qx.ui.core.Widget().set({decorator:O});bF.add(bJ,{row:5,column:1});bV.addListener(bt,function(e){bJ.setBackgroundColor(e.getData());}
);var bO=new qx.ui.window.Window(R).set({width:400,showClose:false,showMinimize:false});bO.setLayout(new qx.ui.layout.Canvas());bO.moveTo(150,300);bO.open();var bK=new qx.ui.control.ColorSelector;bO.add(bK);var bx=new qx.ui.window.Window(T,o).set({showClose:false,showMinimize:false});bx.setLayout(new qx.ui.layout.Grow());bx.moveTo(300,150);bx.open();var bM=new qx.ui.groupbox.GroupBox(this.tr(n));bM.setLayout(new qx.ui.layout.Grow());bx.add(bM);var bN=new qx.ui.basic.Label().set({rich:true,allowGrowX:true});bM.add(bN);var bU=[];bU.push(k);for(var i=0;i<15;i++){bU.push(F);bU.push(z);bU.push(F);bU.push(be);}
;bU.push(F);bU.push(z);bU.push(F);bU.push(g);this.updateLocaleInformation=function(){var i=0;bU[(i++*2)+1]=this.tr(bp);bU[(i++*2)+1]=qx.locale.Manager.getInstance().getLocale();bU[(i++*2)+1]=this.tr(bc);bU[(i++*2)+1]=qx.locale.Manager.getInstance().getTerritory();bU[(i++*2)+1]=this.tr(bk);bU[(i++*2)+1]=qx.locale.Date.getDateFormat(B);bU[(i++*2)+1]=this.tr(bm);bU[(i++*2)+1]=(new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(B))).format(new Date());bU[(i++*2)+1]=this.tr(bd);bU[(i++*2)+1]=qx.locale.Date.getDateFormat(N);bU[(i++*2)+1]=this.tr(h);bU[(i++*2)+1]=(new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(N))).format(new Date());bU[(i++*2)+1]=this.tr(K);bU[(i++*2)+1]=qx.locale.Date.getDateFormat(C);bU[(i++*2)+1]=this.tr(X);bU[(i++*2)+1]=(new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(C))).format(new Date());bU[(i++*2)+1]=this.tr(I);bU[(i++*2)+1]=qx.locale.Date.getDateFormat(c);bU[(i++*2)+1]=this.tr(bl);bU[(i++*2)+1]=(new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(c))).format(new Date());bU[(i++*2)+1]=this.tr(U);bU[(i++*2)+1]=qx.locale.Date.getTimeFormat(B);bU[(i++*2)+1]=this.tr(y);bU[(i++*2)+1]=(new qx.util.format.DateFormat(qx.locale.Date.getTimeFormat(B))).format(new Date());bU[(i++*2)+1]=this.tr(bs);bU[(i++*2)+1]=qx.locale.Date.getTimeFormat(C);bU[(i++*2)+1]=this.tr(u);bU[(i++*2)+1]=(new qx.util.format.DateFormat(qx.locale.Date.getTimeFormat(C))).format(new Date());bU[(i++*2)+1]=this.tr(bj);bU[(i++*2)+1]=qx.locale.Date.getDayName(p,qx.locale.Date.getWeekStart());bU[(i++*2)+1]=this.tr(bq,10000.12);bU[(i++*2)+1]=(new qx.util.format.NumberFormat()).format(10000.12);bN.setValue(bU.join(F));}
;qx.locale.Manager.getInstance().addListener(v,this.updateLocaleInformation,this);this.updateLocaleInformation();}
}});}
)();
...
(function(){var f="vertical",e="under",d="above",c="qx.ui.core.selection.Widget",b="left",a="right";qx.Class.define(c,{extend:qx.ui.core.selection.Abstract,construct:function(g){qx.ui.core.selection.Abstract.call(this);this.__ks=g;}
,members:{__ks:null,_isSelectable:function(h){return this._isItemSelectable(h)&&h.getLayoutParent()===this.__ks;}
,_selectableToHashCode:function(j){return j.$$hash;}
,_styleSelectable:function(k,m,n){n?k.addState(m):k.removeState(m);}
,_capture:function(){this.__ks.capture();}
,_releaseCapture:function(){this.__ks.releaseCapture();}
,_isItemSelectable:function(o){if(this._userInteraction){return o.isVisible()&&o.isEnabled();}
else {return o.isVisible();}
;}
,_getWidget:function(){return this.__ks;}
,_getLocation:function(){var p=this.__ks.getContentElement().getDomElement();return p?qx.bom.element.Location.get(p):null;}
,_getDimension:function(){return this.__ks.getInnerSize();}
...
,_scrollItemIntoView:function(w){this.__ks.scrollChildIntoView(w);}
,getSelectables:function(x){var y=false;if(!x){y=this._userInteraction;this._userInteraction=true;}
;var B=this.__ks.getChildren();var z=[];var A;for(var i=0,l=B.length;i<l;i++){A=B[i];if(this._isItemSelectable(A)){z.push(A);}
;}
;this._userInteraction=y;return z;}
,_getSelectableRange:function(C,D){if(C===D){return [C];}
;var H=this.__ks.getChildren();var E=[];var G=false;var F;for(var i=0,l=H.length;i<l;i++){F=H[i];if(F===C||F===D){if(G){E.push(F);break;}
else {G=true;}
;}
;if(G&&this._isItemSelectable(F)){E.push(F);}
;}
;return E;}
,_getFirstSelectable:function(){var I=this.__ks.getChildren();for(var i=0,l=I.length;i<l;i++){if(this._isItemSelectable(I[i])){return I[i];}
;}
;return null;}
,_getLastSelectable:function(){var J=this.__ks.getChildren();for(var i=J.length-1;i>0;i--){if(this._isItemSelectable(J[i])){return J[i];}
;}
;return null;}
,_getRelatedSelectable:function(K,L){var O=this.__ks.getOrientation()===f;var N=this.__ks.getChildren();var M=N.indexOf(K);var P;if((O&&L===d)||(!O&&L===b)){for(var i=M-1;i>=0;i--){P=N[i];if(this._isItemSelectable(P)){return P;}
;}
;}
...
(function(){var l="mousedown",k="qx.event.type.Data",j=", because it is not a child element!",h="_applyDragSelection",g="Could not add + ",f="mousemove",d="Could not test if ",c="Could not remove ",b="addItem",a=" from selection, because it is not a child element!",D="multi",C="_applyQuickSelection",B="mouseover",A=" is selected, because it is not a child element!",z="__dB",y="_applySelectionMode",x="additive",w="mouseup",v="keypress",u="losecapture",s="Could not select ",t="removeItem",q=" to selection, because it is not a child element!",r="qx.ui.core.MMultiSelectionHandling",o="Boolean",p="one",m="changeSelection",n="single";qx.Mixin.define(r,{construct:function(){var F=this.SELECTION_MANAGER;var E=this.__dB=new F(this);this.addListener(l,E.handleMouseDown,E);this.addListener(w,E.handleMouseUp,E);this.addListener(B,E.handleMouseOver,E);this.addListener(f,E.handleMouseMove,E);this.addListener(u,E.handleLoseCapture,E);this.addListener(v,E.handleKeyPress,E);this.addListener(b,E.handleAddItem,E);this.addListener(t,E.handleRemoveItem,E);E.addListener(m,this._onSelectionChange,this);}
,events:{"changeSelection":k},properties:{selectionMode:{check:[n,D,x,p],init:n,apply:y},dragSelection:{check:o,init:false,apply:h},quickSelection:{check:o,init:false,apply:C}},members:{__dB:null,selectAll:function(){this.__dB.selectAll();}
,isSelected:function(G){if(!qx.ui.core.Widget.contains(this,G)){throw new Error(d+G+A);}
;return this.__dB.isItemSelected(G);}
,addToSelection:function(H){if(!qx.ui.core.Widget.contains(this,H)){throw new Error(g+H+q);}
;this.__dB.addItem(H);}
,removeFromSelection:function(I){if(!qx.ui.core.Widget.contains(this,I)){throw new Error(c+I+a);}
;this.__dB.removeItem(I);}
,selectRange:function(J,K){this.__dB.selectItemRange(J,K);}
,resetSelection:function(){this.__dB.clearSelection();}
,setSelection:function(L){for(var i=0;i<L.length;i++){if(!qx.ui.core.Widget.contains(this,L[i])){throw new Error(s+L[i]+j);}
;}
;if(L.length===0){this.resetSelection();}
else {var M=this.getSelection();if(!qx.lang.Array.equals(M,L)){this.__dB.replaceSelection(L);}
;}
;}
,getSelection:function(){return this.__dB.getSelection();}
,getSortedSelection:function(){return this.__dB.getSortedSelection();}
,isSelectionEmpty:function(){return this.__dB.isSelectionEmpty();}
,getSelectionContext:function(){return this.__dB.getSelectionContext();}
,_getManager:function(){return this.__dB;}
,getSelectables:function(N){return this.__dB.getSelectables(N);}
,invertSelection:function(){this.__dB.invertSelection();}
,_getLeadItem:function(){var O=this.__dB.getMode();if(O===n||O===p){return this.__dB.getSelectedItem();}
else {return this.__dB.getLeadItem();}
;}
,_applySelectionMode:function(P,Q){this.__dB.setMode(P);}
,_applyDragSelection:function(R,S){this.__dB.setDrag(R);}
,_applyQuickSelection:function(T,U){this.__dB.setQuick(T);}
...
(function(){var m="qx.ui.form.List",k="text",j="Boolean",h="one",g="addChildWidget",f="_applySpacing",d="Enter",c="Integer",b="action",a="keyinput",A="addItem",z="removeChildWidget",y="_applyOrientation",x="__mt",w="single",v="keypress",u="list",t="label",s="pane",r="removeItem",p="qx.event.type.Data",q="vertical",n="",o="horizontal";qx.Class.define(m,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IForm,qx.ui.form.IModelSelection],include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MMultiSelectionHandling,qx.ui.form.MForm,qx.ui.form.MModelSelection],construct:function(B){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__mt=this._createListItemContainer();this.__mt.addListener(g,this._onAddChild,this);this.__mt.addListener(z,this._onRemoveChild,this);this.getChildControl(s).add(this.__mt);if(B){this.setOrientation(o);}
else {this.initOrientation();}
;this.addListener(v,this._onKeyPress);this.addListener(a,this._onKeyInput);this.__Bh=n;}
,events:{addItem:p,removeItem:p},properties:{appearance:{refine:true,init:u},focusable:{refine:true,init:true},orientation:{check:[o,q],init:q,apply:y},spacing:{check:c,init:0,apply:f,themeable:true},enableInlineFind:{check:j,init:true}},members:{__Bh:null,__Bi:null,__mt:null,SELECTION_MANAGER:qx.ui.core.selection.ScrollArea,getChildrenContainer:function(){return this.__mt;}
...
,_applyOrientation:function(C,D){var E=C===o;var F=E?new qx.ui.layout.HBox():new qx.ui.layout.VBox();var content=this.__mt;content.setLayout(F);content.setAllowGrowX(!E);content.setAllowGrowY(E);this._applySpacing(this.getSpacing());}
,_applySpacing:function(G,H){this.__mt.getLayout().setSpacing(G);}
...
;if(((new Date).valueOf()-this.__Bi)>1000){this.__Bh=n;}
...
,__mT:function(e){var E=e.getData()[0];var D=this.getChildControl(l);if(D.getSelection()[0]!=E){if(E){D.setSelection([E]);}
else {D.resetSelection();}
;}
;this.__AP();this.__AQ();}
,__AP:function(){var G=this.getChildControl("list").getSelection()[0];var H=this.getChildControl("atom");var F=G?G.getIcon():"";F==null?H.resetIcon():H.setIcon(F);}
,__AQ:function(){var K=this.getChildControl("list").getSelection()[0];var L=this.getChildControl("atom");var J=K?K.getLabel():"";var I=this.getFormat();if(I!=null){J=I.call(this,K);}
...
,_onKeyPress:function(e){var R=e.getKeyIdentifier();if(R==k||R==h){if(this.__zn){this.setSelection([this.__zn]);this.__zn=null;}
;this.toggle();}
...
,_onListMouseDown:function(e){if(this.__zn){this.setSelection([this.__zn]);this.__zn=null;}
;}
,_onListChangeSelection:function(e){var T=e.getData();var W=e.getOldData();if(W&&W.length>0){W[0].removeListener(s,this.__AP,this);W[0].removeListener(t,this.__AQ,this);}
;if(T.length>0){var V=this.getChildControl(n);var U=this.getChildControl(l);var X=U.getSelectionContext();if(V.isVisible()&&(X==w||X==g)){this.__zn=T[0];}
else {this.setSelection([T[0]]);this.__zn=null;}
;T[0].addListener(s,this.__AP,this);T[0].addListener(t,this.__AQ,this);}
...
,this);}
,properties:{appearance:{refine:true,init:w},placeholder:{check:c,nullable:true,apply:u}},events:{"changeValue":g},members:{__zn:null,__zo:null,_applyPlaceholder:function(y,z){this.getChildControl(m).setPlaceholder(y);}
...
,_setPreselectedItem:function(){if(this.__zn){var J=this.__zn.getLabel();if(this.getFormat()!=null){J=this.getFormat().call(this,this.__zn);}
;if(J&&J.translate){J=J.translate();}
;this.setValue(J);this.__zn=null;}
;}
,_onListChangeSelection:function(e){var K=e.getData();if(K.length>0){var M=this.getChildControl(n);var L=M.getSelectionContext();if(L==d||L==i){this.__zn=K[0];}
else {var N=K[0].getLabel();if(this.getFormat()!=null){N=this.getFormat().call(this,K[0]);}
;if(N&&N.translate){N=N.translate();}
;this.setValue(N);this.__zn=null;}
;}
;}
...
,events:{"changeValue":f},properties:{dateFormat:{check:k,apply:H},placeholder:{check:a,nullable:true,apply:A},appearance:{refine:true,init:B},focusable:{refine:true,init:true},width:{refine:true,init:120}},statics:{__zp:null,__zq:null,getDefaultDateFormatter:function(){var K=qx.locale.Date.getDateFormat(E).toString();if(K==this.__zp){return this.__zq;}
;if(this.__zq){this.__zq.dispose();}
;this.__zq=new qx.util.format.DateFormat(K,qx.locale.Manager.getInstance().getLocale());this.__zp=K;return this.__zq;}
},members:{__zr:null,_forwardStates:{focused:true,invalid:true},_setDefaultDateFormat:function(){this.setDateFormat(qx.ui.form.DateField.getDefaultDateFormatter());}
,_addLocaleChangeLeistener:function(){if(qx.core.Environment.get(l)){this.__zr=qx.locale.Manager.getInstance().addListener(d,function(){this._setDefaultDateFormat();}
,this);}
;}
...
},destruct:function(){if(qx.core.Environment.get(l)){if(this.__zr){qx.locale.Manager.getInstance().removeListenerById(this.__zr);}
;}
;}
});}
)();
...
else {var bv=(bs==null)?-1:bs.getDate();for(var i=0;i<6*7;i++){var bu=this.__zl[i];if(bu.hasState(v)){if(bu.hasState(J)){bu.removeState(J);}
;}
...
;this.__zk=this.__zl=this.__zm=null;}
});}
)();
...
(function(){var m="-",l="PageUp",k="Escape",j="qx.event.type.Data",h="_applyShortcut",g="PrintScreen",f="NumLock",d="5",c="8",b="execute",S="Meta",R="0",Q="2",P="Shift",O="You can only specify one non modifier key!",N="3",M="/",L="Delete",K="String",J="changeEnabled",t="*",u="qx.bom.Shortcut",r="6",s="4",p="1",q="Alt",n="Not a valid key name for a shortcut: ",o="PageDown",v="Whitespaces are not allowed within shortcuts",w="_applyEnabled",B="7",A="a",D="z",C="9",F="Boolean",E="+",y="short",I="keydown",H="",G="Control",x="keypress",z="Unidentified";qx.Class.define(u,{extend:qx.core.Object,construct:function(T){qx.core.Object.call(this);this.__zs={};this.__zt=null;if(T!=null){this.setShortcut(T);}
;this.initEnabled();}
,events:{"execute":j},properties:{enabled:{init:true,check:F,event:J,apply:w},shortcut:{check:K,apply:h,nullable:true},autoRepeat:{check:F,init:false}},members:{__zs:H,__zt:H,execute:function(U){this.fireDataEvent(b,U);}
,__zu:function(event){if(this.getEnabled()&&this.__zv(event)){if(!this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,__eL:function(event){if(this.getEnabled()&&this.__zv(event)){if(this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,_applyEnabled:function(V,W){if(V){qx.event.Registration.addListener(document.documentElement,I,this.__zu,this);qx.event.Registration.addListener(document.documentElement,x,this.__eL,this);}
else {qx.event.Registration.removeListener(document.documentElement,I,this.__zu,this);qx.event.Registration.removeListener(document.documentElement,x,this.__eL,this);}
;}
,_applyShortcut:function(X,Y){if(X){if(X.search(/[\s]+/)!=-1){var bc=v;this.error(bc);throw new Error(bc);}
;this.__zs={"Control":false,"Shift":false,"Meta":false,"Alt":false};this.__zt=null;var ba;var a=[];while(X.length>0&&ba!=-1){ba=X.search(/[-+]+/);a.push((X.length==1||ba==-1)?X:X.substring(0,ba));X=X.substring(ba+1);}
;var bb=a.length;for(var i=0;i<bb;i++){var bd=this.__zx(a[i]);switch(bd){case G:case P:case S:case q:this.__zs[bd]=true;break;case z:var bc=n+a[i];this.error(bc);throw bc;default:if(this.__zt){var bc=O;this.error(bc);throw bc;}
;this.__zt=bd;};}
;}
;return true;}
,__zv:function(e){var be=this.__zt;if(!be){return;}
;if((!this.__zs.Shift&&e.isShiftPressed())||(this.__zs.Shift&&!e.isShiftPressed())||(!this.__zs.Control&&e.isCtrlPressed())||(this.__zs.Control&&!e.isCtrlPressed())||(!this.__zs.Meta&&e.isMetaPressed())||(this.__zs.Meta&&!e.isMetaPressed())||(!this.__zs.Alt&&e.isAltPressed())||(this.__zs.Alt&&!e.isAltPressed())){return false;}
;if(be==e.getKeyIdentifier()){return true;}
;return false;}
,__zw:{esc:k,ctrl:G,print:g,del:L,pageup:l,pagedown:o,numlock:f,numpad_0:R,numpad_1:p,numpad_2:Q,numpad_3:N,numpad_4:s,numpad_5:d,numpad_6:r,numpad_7:B,numpad_8:c,numpad_9:C,numpad_divide:M,numpad_multiply:t,numpad_minus:m,numpad_plus:E},__zx:function(bf){var bg=qx.event.util.Keyboard;var bh=z;if(bg.isValidKeyIdentifier(bf)){return bf;}
;if(bf.length==1&&bf>=A&&bf<=D){return bf.toUpperCase();}
;bf=bf.toLowerCase();var bh=this.__zw[bf]||qx.lang.String.firstUp(bf);if(bg.isValidKeyIdentifier(bh)){return bh;}
else {return z;}
;}
,toString:function(){var bk=this.__zt;var bj=[];for(var bi in this.__zs){if(this.__zs[bi]){bj.push(qx.locale.Key.getKeyName(y,bi));}
;}
;if(bk){bj.push(qx.locale.Key.getKeyName(y,bk));}
;return bj.join(E);}
},destruct:function(){this.setEnabled(false);this.__zs=this.__zt=null;}
});}
)();
...
(function(){var m="mousedown",l="__MU",k="teal",h="maroon",g="qx.ui.control.ColorPopup",f="#666",d="changeValue",c="#333",b="#000",a="yellow",W="changeGreen",V="colorpopup",U="_applyValue",T="blue",S="changeRed",R="field#",Q="#CCC",P="Color Selector",O="changeVisibility",N="__MV",t="changeBlue",u="mouseover",r="Cancel",s="#FFF",p="right",q="Open ColorSelector",n="mouseout",o="#999",v="Automatic",w="Basic Colors",D="Preview (Old/New)",B="visible",H="Recent Colors",F="OK",J="field",I="green",y="red",M="preview-pane",L="selector-button",K="colorselector-cancelbutton",x="auto-button",z="colorselector-okbutton",A="Number",C="execute",E="selected-preview",G="current-preview";qx.Class.define(g,{extend:qx.ui.popup.Popup,implement:[qx.ui.form.IColorForm],construct:function(){qx.ui.popup.Popup.call(this);this.setLayout(new qx.ui.layout.VBox(5));this._createChildControl(x);this._createBoxes();this._createChildControl(M);this._createChildControl(L);this.addListener(O,this._onChangeVisibility,this);}
,properties:{appearance:{refine:true,init:V},value:{nullable:true,apply:U,event:d},red:{check:A,init:null,nullable:true,event:S},green:{check:A,init:null,nullable:true,event:W},blue:{check:A,init:null,nullable:true,event:t}},members:{__MS:1e5,__MT:null,__MU:null,__MV:null,__MW:"recent",__MX:12,_createChildControlImpl:function(X,Y){var ba;switch(X){case J:ba=new qx.ui.core.Widget;ba.addListener(m,this._onFieldMouseDown,this);ba.addListener(u,this._onFieldMouseOver,this);ba.addListener(n,this._onFieldMouseOut,this);break;case x:ba=new qx.ui.form.Button(this.tr(v));ba.setAllowStretchX(true);ba.addListener(C,this._onAutomaticBtnExecute,this);this.add(ba);break;case L:ba=new qx.ui.form.Button(this.tr(q));ba.addListener(C,this._onSelectorButtonExecute,this);this.add(ba);break;case M:ba=new qx.ui.groupbox.GroupBox(this.tr(D));ba.setLayout(new qx.ui.layout.HBox);ba.add(this._createChildControl(E,true),{flex:1});ba.add(this._createChildControl(G,true),{flex:1});this.add(ba);break;case E:ba=new qx.ui.container.Composite(new qx.ui.layout.Basic);break;case G:ba=new qx.ui.container.Composite(new qx.ui.layout.Basic);break;case z:ba=new qx.ui.form.Button(this.tr(F));ba.addListener(C,this._onColorSelectorOk,this);break;case K:ba=new qx.ui.form.Button(this.tr(r));ba.addListener(C,this._onColorSelectorCancel,this);break;};return ba||qx.ui.popup.Popup.prototype._createChildControlImpl.call(this,X);}
,_createBoxes:function(){this.__MT={};var bc=this._tables;var bf,bb,bd;var j=0;for(var be in bc){bf=bc[be];bb=new qx.ui.groupbox.GroupBox(bf.label);bb.setLayout(new qx.ui.layout.HBox);this.__MT[be]=bb;this.add(bb);for(var i=0;i<this.__MX;i++){bd=this.getChildControl(R+(j++));bd.setBackgroundColor(bf.values[i]||null);bb.add(bd);}
;}
;}
,_createColorSelector:function(){if(this.__MV){return;}
;var bg=new qx.ui.window.Window(this.tr(P));this.__MU=bg;bg.setLayout(new qx.ui.layout.VBox(16));bg.setResizable(false);bg.moveTo(20,20);this.__MV=new qx.ui.control.ColorSelector;bg.add(this.__MV);var bh=new qx.ui.container.Composite(new qx.ui.layout.HBox(8,p));bg.add(bh);var bj=this._createChildControl(K);var bi=this._createChildControl(z);bh.add(bj);bh.add(bi);}
,_applyValue:function(bk,bl){if(bk===null){this.setRed(null);this.setGreen(null);this.setBlue(null);}
else {var bm=qx.util.ColorUtil.stringToRgb(bk);this.setRed(bm[0]);this.setGreen(bm[1]);this.setBlue(bm[2]);}
;this.getChildControl(E).setBackgroundColor(bk);this._rotatePreviousColors();}
,_rotatePreviousColors:function(){if(!this._tables){return;}
;var bp=this._tables[this.__MW].values;var bq=this.__MT[this.__MW];if(!bp){return;}
;var br=this.getValue();if(!br){return;}
;var bo=bp.indexOf(br);if(bo!=-1){qx.lang.Array.removeAt(bp,bo);}
else if(bp.length==this.__MX){bp.shift();}
;bp.push(br);var bn=bq.getChildren();for(var i=0;i<bn.length;i++){bn[i].setBackgroundColor(bp[i]||null);}
;}
,_onFieldMouseDown:function(e){var bs=this.getChildControl(G).getBackgroundColor();this.setValue(bs);if(bs){this.hide();}
;}
,_onFieldMouseOver:function(e){this.getChildControl(G).setBackgroundColor(e.getTarget().getBackgroundColor());}
,_onFieldMouseOut:function(e){var bw=this.getRed();var bv=this.getGreen();var bt=this.getBlue();var bu=null;if(bw!==null||bv!==null||bt!==null){var bu=qx.util.ColorUtil.rgbToRgbString([bw,bv,bt]);}
;this.getChildControl(G).setBackgroundColor(bu);}
,_onAutomaticBtnExecute:function(){this.setValue(null);this.hide();}
,_onSelectorButtonExecute:function(){this._createColorSelector();this.exclude();var bz=this.getRed();var by=this.getGreen();var bx=this.getBlue();if(bz===null||by===null||bx===null){bz=255;by=255;bx=255;}
;this.__MV.setRed(bz);this.__MV.setGreen(by);this.__MV.setBlue(bx);this.__MU.open();}
,_onColorSelectorOk:function(){var bA=this.__MV;this.setValue(qx.util.ColorUtil.rgbToRgbString([bA.getRed(),bA.getGreen(),bA.getBlue()]));this.__MU.close();}
,_onColorSelectorCancel:function(){this.__MU.close();}
,_onChangeVisibility:function(e){if(this.getVisibility()==B){var bE=this.getRed();var bD=this.getGreen();var bB=this.getBlue();var bC=null;if(bE!==null||bD!==null||bB!==null){var bC=qx.util.ColorUtil.rgbToRgbString([bE,bD,bB]);}
;this.getChildControl(E).setBackgroundColor(bC);this.getChildControl(G).setBackgroundColor(bC);}
;}
,_tables:{core:{label:w,values:[b,c,f,o,Q,s,y,I,T,a,k,h]},recent:{label:H,values:[]}}},destruct:function(){this._disposeObjects(l,N);this._tables=this.__MT=null;}
});}
)();
...
(function(){var f="qx.ui.layout.Basic",e="' is not supported by the Basic layout!",d="qx.debug",c="top",b="left",a="The property '";qx.Class.define(f,{extend:qx.ui.layout.Abstract,members:{verifyLayoutProperty:qx.core.Environment.select(d,{"true":function(g,name,h){this.assert(name==b||name==c,a+name+e);this.assertInteger(h);}
,"false":null}),renderLayout:function(j,k){var p=this._getLayoutChildren();var m,o,n,q,top;for(var i=0,l=p.length;i<l;i++){m=p[i];o=m.getSizeHint();n=m.getLayoutProperties();q=(n.left||0)+m.getMarginLeft();top=(n.top||0)+m.getMarginTop();m.renderLayout(q,top,o.width,o.height);}
;}
,_computeSizeHint:function(){var w=this._getLayoutChildren();var t,y,u;var x=0,v=0;var r,s;for(var i=0,l=w.length;i<l;i++){t=w[i];y=t.getSizeHint();u=t.getLayoutProperties();r=y.width+(u.left||0)+t.getMarginLeft()+t.getMarginRight();s=y.height+(u.top||0)+t.getMarginTop()+t.getMarginBottom();if(r>x){x=r;}
;if(s>v){v=s;}
;}
;return {width:x,height:v};}
}});}
)();
(function(){var p="_applyBlue",o="Missing backgroundColor value for field: ",n="Hex",m="Presets",l="colorbucket",k="qx.event.type.Data",h="Details",g="decoration/colorselector/brightness-handle.gif",f="_applyBrightness",d="_applyHue",by="decoration/colorselector/huesaturation-handle.gif",bx="Visual",bw="_applyGreen",bv="colorselector",bu="colorbucket#",bt="appear",bs="RGB",br="_applySaturation",bq="Preview (Old/New)",bp="qx.ui.control.ColorSelector",w="HSB",x="FFFFFF",u="decoration/colorselector/huesaturation-field.jpg",v="decoration/colorselector/brightness-field.png",s="x",t="_applyRed",q="visual-pane",r="input-field-set",E="mousewheel",F="qx.event.type.Event",S="mousemove",O="preview-field-set",bb="y",V="preset-grid",bl="#",bg="hex-field-composite",J="control-pane",bo="rgb-spinner-composite",bn="mouseup",bm="hsb-spinner-composite",I="preset-field-set",L="control-bar",N="redModifier",Q="blueModifier",T="Integer",W="saturationModifier",bd="hueModifier",bi="middle",y="Number",z="greenModifier",K="brightness-pane",ba="brightnessModifier",Y="hsb-spinner-saturation",X="hue-saturation-field",bf="hsb-spinner-brightness",be="rgb-spinner-red",U="preview-content-new",bc="preview-content-old",a="hue-saturation-pane",bh="rgb-spinner-green",A="rgb-spinner-blue",B="brightnessField",P="hex-field",b="hsb-spinner-hue",c="mousedown",H="hueSaturationField",C="brightness-field",D="changeValue",G="hexField",R="hsbSpinner",bk="rgbSpinner",bj="hue-saturation-handle",M="brightness-handle";qx.Class.define(bp,{extend:qx.ui.core.Widget,implement:[qx.ui.form.IColorForm],construct:function(){qx.ui.core.Widget.call(this);this._setLayout(new qx.ui.layout.VBox());this._createChildControl(L);this.addListener(bt,this._onAppear,this);}
,events:{"dialogok":F,"dialogcancel":F,"changeValue":k},properties:{appearance:{refine:true,init:bv},red:{check:T,init:255,apply:t},green:{check:T,init:255,apply:bw},blue:{check:T,init:255,apply:p},hue:{check:y,init:0,apply:d},saturation:{check:y,init:0,apply:br},brightness:{check:y,init:100,apply:f}},members:{__IE:null,__IF:["maroon","red","orange","yellow","olive","purple","fuchsia","lime","green","navy","blue","aqua","teal","black","#333","#666","#999","#BBB","#EEE","white"],__IG:"",__IH:0,__II:0,__IJ:0,__mF:true,__IK:false,_createChildControlImpl:function(bz,bA){var bB;switch(bz){case L:bB=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));bB.add(this.getChildControl(J));bB.add(this.getChildControl(q));this._add(bB);break;case q:bB=new qx.ui.groupbox.GroupBox(this.tr(bx));bB.setLayout(new qx.ui.layout.HBox(10));bB.add(this.getChildControl(a));bB.add(this.getChildControl(K));break;case J:bB=new qx.ui.container.Composite(new qx.ui.layout.VBox(0));bB.add(this.getChildControl(I));bB.add(this.getChildControl(r));bB.add(this.getChildControl(O),{flex:1});break;case a:bB=new qx.ui.container.Composite(new qx.ui.layout.Canvas());bB.setAllowGrowY(false);bB.addListener(E,this._onHueSaturationPaneMouseWheel,this);bB.add(this.getChildControl(X));bB.add(this.getChildControl(bj),{left:0,top:256});break;case X:bB=new qx.ui.basic.Image(u);bB.addListener(c,this._onHueSaturationFieldMouseDown,this);break;case bj:bB=new qx.ui.basic.Image(by);bB.addListener(c,this._onHueSaturationFieldMouseDown,this);bB.addListener(bn,this._onHueSaturationHandleMouseUp,this);bB.addListener(S,this._onHueSaturationHandleMouseMove,this);break;case K:bB=new qx.ui.container.Composite(new qx.ui.layout.Canvas());bB.setAllowGrowY(false);bB.addListener(E,this._onBrightnessPaneMouseWheel,this);bB.add(this.getChildControl(C));bB.add(this.getChildControl(M));break;case C:bB=new qx.ui.basic.Image(v);bB.addListener(c,this._onBrightnessFieldMouseDown,this);break;case M:bB=new qx.ui.basic.Image(g);bB.addListener(c,this._onBrightnessHandleMouseDown,this);bB.addListener(bn,this._onBrightnessHandleMouseUp,this);bB.addListener(S,this._onBrightnessHandleMouseMove,this);break;case I:bB=new qx.ui.groupbox.GroupBox(this.tr(m));bB.setLayout(new qx.ui.layout.Grow());bB.add(this.getChildControl(V));break;case l:bB=new qx.ui.core.Widget();bB.addListener(c,this._onColorFieldClick,this);break;case V:bG=new qx.ui.layout.Grid(3,3);bB=new qx.ui.container.Composite(bG);var bH;var bF;for(var i=0;i<2;i++){for(var j=0;j<10;j++){bF=i*10+j;bH=this.getChildControl(bu+bF);bH.setBackgroundColor(this.__IF[bF]);bB.add(bH,{column:j,row:i});}
;}
;break;case r:bB=new qx.ui.groupbox.GroupBox(this.tr(h));var bG=new qx.ui.layout.VBox();bG.setSpacing(10);bB.setLayout(bG);bB.add(this.getChildControl(bg));bB.add(this.getChildControl(bo));bB.add(this.getChildControl(bm));break;case O:bB=new qx.ui.groupbox.GroupBox(this.tr(bq));var bG=new qx.ui.layout.HBox(10);bB.setLayout(bG);bB.add(this.getChildControl(bc),{flex:1});bB.add(this.getChildControl(U),{flex:1});break;case bg:var bE=new qx.ui.layout.HBox(4);bE.setAlignY(bi);bB=new qx.ui.container.Composite(bE);var bJ=new qx.ui.basic.Label(this.tr(n));bJ.setWidth(30);bB.add(bJ);var bI=new qx.ui.basic.Label(bl);bB.add(bI);bB.add(this.getChildControl(P));break;case P:bB=new qx.ui.form.TextField(x);bB.setMaxLength(6);bB.setFilter(/[0-9A-Fa-f]/);bB.setWidth(55);bB.addListener(D,this._onHexFieldChange,this);break;case bo:var bE=new qx.ui.layout.HBox(4);bE.setAlignY(bi);bB=new qx.ui.container.Composite(bE);var bC=new qx.ui.basic.Label(this.tr(bs));bC.setWidth(30);bB.add(bC);bB.add(this.getChildControl(be));bB.add(this.getChildControl(bh));bB.add(this.getChildControl(A));break;case be:bB=new qx.ui.form.Spinner(0,255,255);bB.setWidth(50);bB.addListener(D,this._setRedFromSpinner,this);break;case bh:bB=new qx.ui.form.Spinner(0,255,255);bB.setWidth(50);bB.addListener(D,this._setGreenFromSpinner,this);break;case A:bB=new qx.ui.form.Spinner(0,255,255);bB.setWidth(50);bB.addListener(D,this._setBlueFromSpinner,this);break;case bm:var bE=new qx.ui.layout.HBox(4);bE.setAlignY(bi);bB=new qx.ui.container.Composite(bE);var bD=new qx.ui.basic.Label(this.tr(w));bD.setWidth(30);bB.add(bD);bB.add(this.getChildControl(b));bB.add(this.getChildControl(Y));bB.add(this.getChildControl(bf));break;case b:bB=new qx.ui.form.Spinner(0,0,360);bB.setWidth(50);bB.addListener(D,this._setHueFromSpinner,this);break;case Y:bB=new qx.ui.form.Spinner(0,0,100);bB.setWidth(50);bB.addListener(D,this._setSaturationFromSpinner,this);break;case bf:bB=new qx.ui.form.Spinner(0,100,100);bB.setWidth(50);bB.addListener(D,this._setBrightnessFromSpinner,this);break;case bc:bB=new qx.ui.core.Widget();break;case U:bB=new qx.ui.core.Widget();break;};return bB||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,bz);}
,setValue:function(bK){var bL;if(bK==null){this.__mF=true;bL=[255,255,255];}
else {bL=qx.util.ColorUtil.stringToRgb(bK);this.__mF=false;}
;this.__IK=true;this.setRed(bL[0]);this.setGreen(bL[1]);this.__IK=false;this.setBlue(bL[2]);}
,getValue:function(){return this.__mF?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__mF=true;this.__IK=true;this.setRed(255);this.setGreen(255);this.__IK=false;this.setBlue(255);}
,__mH:function(){if(!this.__IK){this.__mF=false;this.fireDataEvent(D,this.getValue());}
;}
,_applyRed:function(bM,bN){if(this.__IE===null){this.__IE=N;}
;if(this.__IE!==bk){this.getChildControl(be).setValue(bM);}
;if(this.__IE!==G){this._setHexFromRgb();}
;switch(this.__IE){case bk:case G:case N:this._setHueFromRgb();};this._setPreviewFromRgb();this.__mH();if(this.__IE===N){this.__IE=null;}
;}
,_applyGreen:function(bO,bP){if(this.__IE===null){this.__IE=z;}
;if(this.__IE!==bk){this.getChildControl(bh).setValue(bO);}
;if(this.__IE!==G){this._setHexFromRgb();}
;switch(this.__IE){case bk:case G:case z:this._setHueFromRgb();};this._setPreviewFromRgb();this.__mH();if(this.__IE===z){this.__IE=null;}
;}
,_applyBlue:function(bQ,bR){if(this.__IE===null){this.__IE=Q;}
;if(this.__IE!==bk){this.getChildControl(A).setValue(bQ);}
;if(this.__IE!==G){this._setHexFromRgb();}
;switch(this.__IE){case bk:case G:case Q:this._setHueFromRgb();};this._setPreviewFromRgb();this.__mH();if(this.__IE===Q){this.__IE=null;}
;}
,_applyHue:function(bS,bT){if(this.__IE===null){this.__IE=bd;}
;if(this.__IE!==R){this.getChildControl(b).setValue(bS);}
;if(this.__IE!==H){if(this.getChildControl(bj).getBounds()){this.getChildControl(bj).setDomLeft(Math.round(bS/1.40625)+this.getChildControl(a).getPaddingLeft());}
else {this.getChildControl(bj).setLayoutProperties({left:Math.round(bS/1.40625)});}
;}
;switch(this.__IE){case R:case H:case bd:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__IE===bd){this.__IE=null;}
;}
,_applySaturation:function(bU,bV){if(this.__IE===null){this.__IE=W;}
;if(this.__IE!==R){this.getChildControl(Y).setValue(bU);}
;if(this.__IE!==H){this._setBrightnessGradiant();if(this.getChildControl(bj).getBounds()){this.getChildControl(bj).setDomTop(256-Math.round(bU*2.56)+this.getChildControl(a).getPaddingTop());}
else {this.getChildControl(bj).setLayoutProperties({top:256-Math.round(bU*2.56)});}
;}
;switch(this.__IE){case R:case H:case W:this._setRgbFromHue();};if(this.__IE===W){this.__IE=null;}
;}
,_applyBrightness:function(bW,bX){if(this.__IE===null){this.__IE=ba;}
;if(this.__IE!==R){this.getChildControl(bf).setValue(bW);}
;if(this.__IE!==B){var bY=256-Math.round(bW*2.56);if(this.getChildControl(M).getBounds()){this.getChildControl(M).setDomTop(bY+this.getChildControl(K).getPaddingTop());}
else {this.getChildControl(M).setLayoutProperties({top:bY});}
;}
;switch(this.__IE){case R:case B:case ba:this._setRgbFromHue();};if(this.__IE===ba){this.__IE=null;}
;}
,_onBrightnessHandleMouseDown:function(e){this.getChildControl(M).capture();this.__IG=M;var cc=this.getChildControl(C).getContainerLocation();var cb=this.getChildControl(M).getContainerLocation();var ca=this.getChildControl(C).getBounds();this.__IH=cc.top+(e.getDocumentTop()-cb.top)-ca.top;e.stopPropagation();}
,_onBrightnessHandleMouseUp:function(e){this.getChildControl(M).releaseCapture();this.__IG=null;}
,_onBrightnessHandleMouseMove:function(e){if(this.__IG===M){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldMouseDown:function(e){var location=this.getChildControl(C).getContainerLocation();var cd=this.getChildControl(M).getBounds();this.__IH=location.top+(cd.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(M).capture();this.__IG=M;}
,_onBrightnessPaneMouseWheel:function(e){this.setBrightness(qx.lang.Number.limit(this.getBrightness()-e.getWheelDelta(bb),0,100));e.stop();}
,_setBrightnessOnFieldEvent:function(e){var ce=qx.lang.Number.limit(e.getDocumentTop()-this.__IH,0,256);this.__IE=B;if(this.getChildControl(M).getBounds()){this.getChildControl(M).setDomTop(ce);}
else {this.getChildControl(M).setLayoutProperties({top:ce});}
;this.setBrightness(100-Math.round(ce/2.56));this.__IE=null;}
,_onHueSaturationHandleMouseUp:function(e){if(this.__IG){e.stopPropagation();this.getChildControl(bj).releaseCapture();this.__IG=null;}
;}
,_onHueSaturationHandleMouseMove:function(e){if(this.__IG===bj){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldMouseDown:function(e){var location=this.getChildControl(X).getContainerLocation();var cf=this.getChildControl(bj).getBounds();var cg=this.getChildControl(X).getBounds();this.__II=location.top+(cf.height/2)-cg.top;this.__IJ=location.left+(cf.width/2)-cg.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(bj).capture();this.__IG=bj;}
,_onHueSaturationPaneMouseWheel:function(e){this.setSaturation(qx.lang.Number.limit(this.getSaturation()-e.getWheelDelta(bb),0,100));this.setHue(qx.lang.Number.limit(this.getHue()+e.getWheelDelta(s),0,360));e.stop();}
,_setHueSaturationOnFieldEvent:function(e){var ci=qx.lang.Number.limit(e.getDocumentTop()-this.__II,0,256);var ch=qx.lang.Number.limit(e.getDocumentLeft()-this.__IJ,0,256);this.getChildControl(bj).setDomPosition(ch,ci);this.__IE=H;this.setSaturation(100-Math.round(ci/2.56));this.setHue(Math.round(ch*1.40625));this.__IE=null;}
,_setRedFromSpinner:function(){if(this.__IE!==null){return;}
;this.__IE=bk;this.setRed(this.getChildControl(be).getValue());this.__IE=null;}
,_setGreenFromSpinner:function(){if(this.__IE!==null){return;}
;this.__IE=bk;this.setGreen(this.getChildControl(bh).getValue());this.__IE=null;}
,_setBlueFromSpinner:function(){if(this.__IE!==null){return;}
;this.__IE=bk;this.setBlue(this.getChildControl(A).getValue());this.__IE=null;}
,_setHueFromSpinner:function(){if(this.__IE!==null){return;}
;this.__IE=R;this.setHue(this.getChildControl(b).getValue());this.__IE=null;}
,_setSaturationFromSpinner:function(){if(this.__IE!==null){return;}
;this.__IE=R;this.setSaturation(this.getChildControl(Y).getValue());this.__IE=null;}
,_setBrightnessFromSpinner:function(){if(this.__IE!==null){return;}
;this.__IE=R;this.setBrightness(this.getChildControl(bf).getValue());this.__IE=null;}
,_onHexFieldChange:function(e){if(this.__IE!==null){return;}
;try{var ck=this.getChildControl(P);var cj=qx.util.ColorUtil.hexStringToRgb(bl+ck.getValue());}
catch(cl){return;}
;this.__IE=G;this.setRed(cj[0]);this.setGreen(cj[1]);this.setBlue(cj[2]);this.__IE=null;}
,_setHexFromRgb:function(){var cm=qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);cm=cm.substring(1,cm.length);this.getChildControl(P).setValue(cm);}
,_onColorFieldClick:function(e){var cn=e.getTarget().getBackgroundColor();if(!cn){return this.error(o+e.getTarget());}
;var co=qx.util.ColorUtil.stringToRgb(cn);this.setRed(co[0]);this.setGreen(co[1]);this.setBlue(co[2]);}
,_setHueFromRgb:function(){switch(this.__IE){case R:case H:case B:break;default:var cp=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(cp[0]);this.setSaturation(cp[1]);this.setBrightness(cp[2]);};}
,_setRgbFromHue:function(){switch(this.__IE){case bk:case G:break;default:var cq=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(cq[0]);this.setGreen(cq[1]);this.setBlue(cq[2]);};}
,_setPreviewFromRgb:function(){var cr=qx.util.ColorUtil.rgbToRgbString([this.getRed(),this.getGreen(),this.getBlue()]);this.getChildControl(U).setBackgroundColor(cr);}
,setPreviousColor:function(cs,ct,cu){var cv=qx.util.ColorUtil.rgbToRgbString([cs,ct,cu]);this.getChildControl(bc).setBackgroundColor(cv);this.setRed(cs);this.setGreen(ct);this.setBlue(cu);}
,_setBrightnessGradiant:function(){var cw=qx.util.ColorUtil;var cx=cw.hsbToRgb([this.getHue(),this.getSaturation(),255]);var cy=cw.rgbToRgbString(cx);this.getChildControl(C).setBackgroundColor(cy);}
,_onAppear:function(e){var cz=qx.util.ColorUtil.rgbToRgbString([this.getRed(),this.getGreen(),this.getBlue()]);this.getChildControl(bc).setBackgroundColor(cz);this.getChildControl(U).setBackgroundColor(cz);}
}});}
)();
