...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.table.Table_Conditional","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Conditional-qx.theme.Classic.8b5b1508d8f1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="#3300CC",i="#BB0044",h="#FF0000",g="icon/16/actions/dialog-ok.png",f="Number 1",e="center",d="Table using conditional cell renderer",c="#DD0022",b="#1100EE",a="demobrowser.demo.table.Table_Conditional",H="#880077",G="#660099",F="#CC0033",E="#AA0055",D="#0000FF",C="#0099FF",B="#5500AA",A="right",z="#990066",y="#00CCFF",q="#EE0011",r="bold",o="#770088",p="#4400BB",m="icon/16/actions/dialog-cancel.png",n="#0033FF",k="Number 2",l="#2200DD",s="#0066FF",t="ID",v="Image",u="",w=">";qx.Class.define(a,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return d;}
,createTable:function(){var J=new qx.ui.table.model.Simple();J.setColumns([t,f,k,v]);var I=[g,m];var K=[];for(var P=0;P<100;P++){var x=Math.random()*1000;K.push([P,x,x,I[Math.floor(x)%2]]);}
;J.setData(K);J.setColumnEditable(1,true);J.setColumnEditable(2,true);var M=new qx.ui.table.Table(J);M.setMetaColumnCounts([1,-1]);var N=qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION;M.getSelectionModel().setSelectionMode(N);var O=new qx.ui.table.cellrenderer.Conditional(A,u,u,u);O.addNumericCondition(w,0,null,h,null,null);O.addNumericCondition(w,50,null,q,null,null);O.addNumericCondition(w,100,null,c,null,null);O.addNumericCondition(w,150,null,F,null,null);O.addNumericCondition(w,200,null,i,null,null);O.addNumericCondition(w,250,null,E,null,null);O.addNumericCondition(w,300,null,z,null,null);O.addNumericCondition(w,350,null,H,null,null);O.addNumericCondition(w,400,null,o,null,null);O.addNumericCondition(w,450,null,G,null,null);O.addNumericCondition(w,500,null,B,null,null);O.addNumericCondition(w,550,null,p,null,null);O.addNumericCondition(w,600,null,j,null,null);O.addNumericCondition(w,650,null,l,null,null);O.addNumericCondition(w,700,null,b,null,null);O.addNumericCondition(w,750,null,D,null,null);O.addNumericCondition(w,800,null,n,null,null);O.addNumericCondition(w,850,null,s,null,null);O.addNumericCondition(w,900,null,C,null,null);O.addNumericCondition(w,950,e,y,null,r);M.getTableColumnModel().setDataCellRenderer(2,O);var L=new qx.ui.table.cellrenderer.Image();M.getTableColumnModel().setDataCellRenderer(3,L);return M;}
}});}
)();
