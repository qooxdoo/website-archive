...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Blocker-qx.theme.Indigo.d51fca1ea471.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return h;}
,__qK:function(G){var H=function(){qx.bom.Event.removeNativeListener(G,a,H);G.$$url=qx.bom.Iframe.queryCurrentUrl(G);}
...
,members:{__Nj:null,__wf:null,__Nk:null,__Nl:false,__Nm:10000,__Nn:0,__No:p,block:function(q){if(!this.__Nl){this.__Nk=q;var r=this.__Nr();this.__Ns(r);this.__Nl=true;}
;}
,unblock:function(){if(this.__Nl){this.__Nt();this.__Nl=false;}
;}
,isBlocked:function(){return this.__Nl;}
,getBlockerElement:function(){return this.__wf;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__wf,h,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__wf,h);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__wf,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__wf);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__wf,c,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__wf,c);}
,__bf:function(){this.__Np();if((qx.core.Environment.get(d)==f)){this.__Nq();}
;qx.event.Registration.addListener(window,i,this.__jR,this);}
,__Np:function(){this.__wf=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__wf,{display:g,opacity:this.__Nn,backgroundColor:this.__No});this.setBlockerZIndex(this.__Nm);}
,__Nq:function(){this.__Nj=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__Nj,n,false);qx.bom.element.Attribute.set(this.__Nj,o,l);qx.bom.element.Style.setStyles(this.__Nj,{display:g,opacity:this.__Nn});}
,__Nr:function(){var v={position:j};if(this.__Nv()){v.left=b;v.top=b;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+a;v.height=qx.bom.Document.getHeight()+a;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__Nk)+a;v.height=qx.bom.element.Dimension.getHeight(this.__Nk)+a;v.left=qx.bom.element.Location.getLeft(this.__Nk)+a;v.top=qx.bom.element.Location.getTop(this.__Nk)+a;}
;return v;}
,__Ns:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__wf,w);qx.dom.Element.insertEnd(this.__wf,x);if((qx.core.Environment.get(d)==f)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Nj,w);qx.dom.Element.insertEnd(this.__Nj,document.body);}
;}
,__Nt:function(){qx.dom.Element.remove(this.__wf);if((qx.core.Environment.get(d)==f)){qx.dom.Element.remove(this.__Nj);}
;}
,__jR:function(e){if(this.__Nv()){this.__Nu({width:b,height:b});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+a,height:qx.bom.Document.getHeight()+a};this.__Nu(y);}
,this,0);}
;}
,__Nu:function(z){qx.bom.element.Style.setStyles(this.__wf,z);if((qx.core.Environment.get(d)==f)){qx.bom.element.Style.setStyles(this.__Nj,z);}
;}
,__Nv:function(){return (this.__Nk==null||qx.dom.Node.isWindow(this.__Nk)||qx.dom.Node.isDocument(this.__Nk));}
},destruct:function(){qx.event.Registration.removeListener(window,i,this.__jR,this);this.__Nj=this.__wf=this.__Nk=null;}
});}
)();
