...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Flash","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Flash-qx.theme.Modern.e8b9314ad086.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="demobrowser/demo/flash/fo_tester.swf",n="this is passed in via FlashVars",m="div",l="position",k="demobrowser.demo.bom.Flash",j="left",i="opaque",h="movie",g="top",f="bottom",c="right",e="noscale",d="#FF6600",b="absolute",a="20px";qx.Class.define(k,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var s=qx.dom.Element.create(m);qx.bom.element.Style.set(s,l,b);qx.bom.element.Style.set(s,g,a);qx.bom.element.Style.set(s,f,a);qx.bom.element.Style.set(s,c,a);qx.bom.element.Style.set(s,j,a);document.body.appendChild(s);var p=qx.util.ResourceManager.getInstance().toUri(o);var r={flashVarText:n};var q={bgcolor:d,scale:e,wmode:i};qx.bom.Flash.create(s,{movie:p,id:h},r,q);}
}});}
)();
...
;}
;}
;var x=this.__KM(s,t,v,w);this._flashObjects[t.id]=x;return x;}
,destroy:qx.core.Environment.select(d,{"mshtml":function(y,z){y=this.__KH(y);if(y.readyState==4){this.__KI(y);}
else {if(!z){z=window;}
;qx.bom.Event.addNativeListener(z,k,function(){qx.bom.Flash.__KI(y);}
);}
;}
,"default":function(A,B){A=this.__KH(A);if(A.parentNode){A.parentNode.removeChild(A);}
;delete this._flashObjects[A.id];}
}),__KH:function(C){if(!C){throw new Error("DOM element is null or undefined!");}
...
;return C;}
,__KI:qx.core.Environment.select("engine.name",{"mshtml":qx.event.GlobalError.observeMethod(function(D){for(var i in D){if(typeof D[i]=="function"){D[i]=null;}
;}
;if(D.parentNode){D.parentNode.removeChild(D);}
;delete this._flashObjects[D.id];}
),"default":null}),__KJ:qx.event.GlobalError.observeMethod(function(){for(var E in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[E]);}
;window.__KK=function(){}
;window.__KL=function(){}
;qx.bom.Event.removeNativeListener(window,"beforeunload",qx.bom.Flash.__KJ);}
),__KM:qx.core.Environment.select("engine.name",{"mshtml":function(F,G,H,I){H.movie=G.data;delete G.data;delete G.classid;var J="";for(name in H){J+='<param name="'+name+'" value="'+H[name]+'" />';}
...
})},defer:function(Q){if((qx.core.Environment.get(d)==o)){qx.bom.Event.addNativeListener(window,m,Q.__KJ);}
;}
});}
)();
