...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Flickr-qx.theme.Modern.27232c180abd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}});qx.Class.define(C,{extend:qx.data.store.Jsonp,construct:function(R){this.setCallbackName(v);qx.data.store.Jsonp.call(this,this.__Qa(R));}
,members:{searchForTag:function(S){if(S!=l){this.setUrl(this.__Qa(S));}
;}
,__Qa:function(T){if(!T){return;}
