$=["","qx.client","auto","Boolean","solid","undefined","left","right","string","border-dark-shadow","none","top",';',"bottom","Integer","qx.event.type.Event","String","set","horizontal","mouseup",".","middle","mousedown","singleton","keydown","gecko","hidden","vertical","mshtml","0px","border-light","object","width","height",'computed=this.',":","function","px","100%","scroll",";","center","overflow","style",'=value;',"Number","1*","selected","0","pressed","other","boolean","keypress","on",'this.',"error","number","/","inset","white","borderTopWidth","absolute","abandoned","load","abstract","borderLeftWidth","default","outset","background",")","effect","minWidth","maxWidth","maxHeight","Color","minHeight","mousemove","init"," ","qx.event.type.MouseEvent","CSS1Compat","%","off",'</span>',"opera","icon","over",'if(this.',",","mouseover",'}',"statuspane.systeminfo","click","reset","position","webkit","overflowX",'"',"overflowY","test","both","scrollY","get","locationX","Left","inherit","Right","Enter","shorthand",'delete this.',"locationY","*","unstyle","Theme","border-light-shadow","fixed","div","fontSize","border-dark","unload",'!==undefined)',"interval","treeview","scrollX","qx.event.type.DataEvent","]","keyup","input","label","ie4+","button","treeview.flat","text-field","filter","modelLink","treeview.full","text","refresh","gray","groove","qx.ui.popup.ToolTipManager","barBottom","qx.ui.menu.Manager","marginTop","display","Space","progresspane.progressbar","marginLeft","barTop","dragging","dark-shadow","qx.ui.core.Widget","1px","dblclick","-moz-scrollbars-none","mouseout","qx.event.type.DragEvent","(","&","qx.ui.popup.PopupManager","dotted","qx.event.type.FocusEvent","list","double","\n",'return this.','else if(this.',"qx.event.type.KeyEvent","dashed","_","normal","A","qx.resourceUri","outset-thin","black","#C1ECFF",": ","inset-thin","text-selected","appear","iframe","lineHeight","ridge","resize","checked","hand","field",'!==undefined){',"marginBottom","paddingLeft","50%","$","paddingTop","Up","widget","NumLock","left-reversed","execute","this.","failure","contextmenu","transparent","Tahoma","top-reversed","Liberation Sans","depth","barLeft","marginRight",'=true;',"middle-reversed","static/image/blank.gif","boxSizing","center-reversed",'old=this.',"Lucida Grande","paddingBottom","box-sizing","completed","text-disabled","color","Bitstream Vera Sans","button-abandoned","focus","border-box","-","_applyClip","barRight","Down","textAlign","paddingRight","qx.ui.popup.ToolTip","changeSelection","window-captionbar-button","blur","safari2","Verdana","_applyText","beforeunload","border","col-resize","date-chooser-title","focusin","_applyLabel","borderBottomWidth","parent","toolbar.runbutton","list-view-content-cell-text","dragover","date-chooser","padding","dragenter","changeSelected","qx.ui.embed.IframeManager","Home","body","justify","_applyIcon","9","id","static",'tree',"changeShow","focusout","changeChecked","disappear",'","',"only_plus","mousewheel","-moz-scrollbars-vertical","  ","}","bold","borderRightWidth","table-header-border","Label","statuspane.current","-moz-scrollbars-horizontal","_pane","n-resize","_applyTextAlign","Full Tree",'typeof value === "number" && isFinite(value)',"pointer","button-view-pane","Tab","lastChild",')',"row-resize","only_minus","qx.ui.form.Button","PageUp","underline","qx.ui.menu.Menu","qx.event.handler.DragAndDropHandler","</div>","qx.ui.core.Parent","tree-folder","PageDown","=''",'",value);',"down",'',"statuspane.number","widgets","html","End","Object","Classic","start","+","e-resize","zIndex","_childrenQueue","_labelObject","%)","icon/16/apps/graphics-snapshot.png","_compute","F1","qx.testNameSpace","treeClose","appearances","cursor","tab-view-pane"," - ","_applyChecked","indexOf","Insert","qx.application.Gui","qx.Class","win","_element","nw-resize","F2","ellipsis","__init$","#9d1111","</span>","tab-view-button","fontStyle","[^\\.0-9]","-webkit-box-sizing","'","value","styleTop","plus","F12","dragleave","log","list-view-content-cell","mshtml|webkit","F3","tab-view-border",":content-box;","up","meta","./resource","gecko|opera|webkit","tabIndex","_manager","_applyName","F11","opacity","qx.ui.embed.Flash","lead","overflow:","Delete","styleRight","outline","styleLeft","Windows","F4","windowresize","_applySource",":border-box;","barVertical","MozUserSelect","line","F10","backgroundRepeat","clipHeight","italic","_invalidate","treeview.bsb1",'  </div>',"colorRight","Assertion Failure","_applySelected","fontWeight",'if(old===computed)return value;',"KhtmlUserSelect","noComputed","F5","qx.ui.selection.RadioManager","Tests","]);","dragstart",'else ','<span class="objectBox-number">',"-moz-box-sizing","removeChild","treeOpenWhileEmpty","button-view-bar","colors","changeSource","alignLeft","character","tree-element-label","Ready","|","treeOpenWithContent",'";',"colorBottom","Escape","F6","tree-folder-icon","spinner-button","DOMMouseScroll","qx.staticUri","widthBottom",'undefined',"testrunner/image/method_public18.gif","drag","qx.allowUrlSettings","cross","Array","whiteSpace","first","qx.io.image.Preloader","toggle","colorTop","disabled","F7","-khtml-box-sizing","]\n","MozOpacity","header","0 none","qx.theme.ClassicRoyale","popup","qx.enableAspect","ne-resize","static/image/dotted_white.gif","testrunner/image/yellow_diamond_hollow18.gif","margin","_recompute","focused","dragdrop","F8","&#","toolbar","(a[","0%","backgroundImage","text/css","qx.allowUrlVariants","alignRight","F9","hasComputed","minus","styleBottom","widthRight","progresspane.fail_cnt","before","dragexit","{","toString","clipTop","qx.ui.pageview.AbstractPage","tree","menu-button","g","qx.event.type.ChangeEvent","anchor",'.$$properties.',"changeState","qx.log.appender.Native","button-view","fonts",'if(computed===undefined)computed=null;',"Gecko","textDecoration","qx.ui.pageview.AbstractButton","draggesture","Function","fontFamily","widthTop","end","Margin","v","success",":constructor","_iconObject","event","Backtrace:","Padding","<br>","icons","backgroundColor","_applyEnabled","qx.testPageUri","tooltip-text","innerText","barHorizontal","concat","tooltip","qx.core.Object",'!(',"progresspane.succ_cnt","textContent","_objects","PrintScreen","Z","ignore","__user$","readonly","return this.","head","tree-folder-label","slice","Test '","tree-element-icon","qx.event.handler.FocusHandler","_applyOrientation","WebkitUserSelect","clipLeft",'@import "',"borders"," (","userSelect","testrunner/image/class18.gif","#36a618","();","widthLeft","clipWidth","qx.client.NativeWindow",'if(old===undefined)old=null;',"qx.isSource","widget/arrows/down.gif","colorLeft","lastIndexOf","list-view-header-border","All","tree-element","\r\n","_focusHandler","Border",'    * { box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box }',"_valueOriginalTarget","Pause","qx.ui.core.Font","qx.util.Normalization","Linux","borderBottomStyle","Font","_applyCursor","qx.Interface","qx.ui.tree.TreeFolder","a","f1",'value !== null && window.document','    <input id="marker" type="button" value="Add divider"/> &#160; &#160; Filter: <input name="filter" id="filter" type="text" value="',"qx.ui.form.TextField",')a[i].',"_applyFocusRoot","_applySplitterSize","<div class='version'>qooxdoo ","localeCompare",'    html, body, input, pre{ font-size: 11px; font-family: Tahoma, sans-serif; line-height : 1 }','var inherit=prop.$$inherit;',"_applyLocale","styleFloat","addAtEnd","_image","pixelBottom"," (nightly)","testrunner.runner.TestAppender","_cachedVisibleChildren","_testResults","nowrap","removeAll","qx.html.Dimension","_applyFont","Use getValue() instead!","_applySpacing","iPod","frameWindow","Macintosh","_hideTimer","progress","list-view-header","Gray() Alpha(Opacity=30)","testrunner.runner.TestHandler","__inherit$","testSuiteUrl","Alpha(Opacity=0)","changeBorderTheme","Use removeHtmlProperty instead","_applySize","qx.bom.client.Engine","testrunner/image/colorstrip.gif","testrunner.runner.Tree","_box","qx.core.Log.debug","this.removeStyleProperty('padding","qx.application.IApplication","MacPPC","quote","Tabled Results","qx.application","_applyColorBottom"," &nbsp;","qx.ui.splitpane.SplitPane","__onload","DEBUG","qx.logAppender","qx.event.handler.EventHandler","progresspane","Win32","qx.iconTheme","forEach","table-header","button-view-page","1.0",'  <div id="control">',"autoComplete",' is not (yet) ready!");',"addAfter","changeElement","(measure start) ","progid:DXImageTransform.Microsoft.AlphaImageLoader(src='","Height","qx.version","treeview.bsb2","qx.log.appender.Window","_layoutChanges","changeParent","_applyMarginBottom","_applySelectable","_applyPreloader","Flat tree view (only one level of containers)","radio-view-button-checked","<br/>","tab-view-button-checked","cursor:","line-left","extend","Pixel","_applyBackgroundImage","f2","100px","changeTextColor","borderBottom",'computed=value;',"qx.boxModelCorrection"," WARN:  ","startTest","__states",'return value;',"(0%)"," DEBUG: ","change","_horizontalLayout","changeAnonymous","testrunner.test","qx.locale.Manager","_applyFailCnt","_applyOpen","toolbar-button","qx.io.image.Manager","OmniWeb","_applyMinHeight","ms",'!',"&lt;","tree-icon","Parameter to 'update' function must be a string representing a fraction or a percentage.","_showTimer","qx.ui.basic.Inline","line-through","_list",'if(!clazz.$$propertiesAttached)qx.core.Property.attach(clazz);',"</h3>","changeActiveChild","U","_applyShowInterval","var a=arguments[0] instanceof Array?arguments[0]:arguments;","_hideTimeStamp","qx.theme.classic.color.Royale","C","_applyValue","\n\nClick OK to continue debugging.",'value !== null && value.$$type === "Mixin"',"_applyBoundToWidget","icon/16/places/folder.png","qx.ui.pageview.AbstractPane","qx.dom.Element","split","target","_applyBackgroundRepeat","Log window message: Starting error recording, any errors below this line will prevent the log window from closing",'=computed;',"qx.ui.popup.Popup","Type","list-view",'string',"qx.io.Alias","changeValue",']._autoCloseWindow()}catch(ex){}">',"<hr/>","_applyBottom",":constructor wrapper","_applyRootOpenClose",'value !== null && value.$$type === "Interface"',"qx.Mixin","_applyBorder","beforeAppear",'">',"changeText","_applyRight","Use qx.Class.define instead","__cache","_check","window-inactive-caption-text","o","_indentObject","qx.ui.layout.BoxLayout","_applyMaxHeight","Galeon","force","after","userFocus","widget/splitpane/knob-horizontal.png","widget/arrows/up.gif","parentPaddingBottom","Control","qx.lang.Generics","8","warn","changeLeadItem",'  <div id="lines">',"6","client-document-blocker","push","qx.core.Log.error","qx.log.DefaultFilter","list-view-border","Log window message: Stopping error recording, discarding ","_selectedItems","hasOwnProperty","qx.ui.basic.Image","Unidentified","list-view-header-cell-hover","_atom","_icons","qx.bom.element.BoxSizing","ttree","toolbar-part-handle-line",'_treeRowStructureFields',"radio-view-bar",'typeof value === "number" && isFinite(value) && value%1 === 0',"_knob",'!(value instanceof ','value !== null && qx.theme.manager.Font.getInstance().isDynamic(value)',"html,body { margin:0;border:0;padding:0; } ","Log","icon/16/actions/view-pane-tree.png","_applyStretchChildrenOrthogonalAxis","<img style=\"position:absolute;top:0px;left:","pixelHeight","qx.ui.pageview.AbstractBar"," !important","_lastMouseDownDispatchTarget",'(backup);',"_applyFirstSize","[Mixin ","__all","_applyFocused","lines","Selected Test: ","qx.ui.tree.Tree",'if(computed===inherit){',"qx.bom.element.Overflow","qx.log.Filter","__event","_applyScrolling","borderTop",'<body onload="qx = opener.qx;" onunload="try{qx.log.WindowAppender._registeredAppenders[',"Number of Tests: ","sort","verticalAlign","qx.ui.pageview.tabview.TabView","AppleWebKit/",'  </style>',"safari","this.length = 0;","_applyPaddingTop","button-view-button","unknown","Now running: ","qx.ui.layout.impl.LayoutImpl",';}',"qx.deprecationWarnings","qx.fontTheme","\\\"","unshift","tab-view-bar",'!==undefined&&',"iconSelected","qx.core.Log.info","Null","changeFont","_applyOverflow","<span>","radio-view-pane",'value instanceof Date',"/static","static/html/blank.html","sessionlog","borderLeftStyle","7","Failed: ","qx.aspects","widgetLinkFlat",'if((computed===undefined||computed===inherit)&&','character',"_applyHideInterval","_applyReadOnly","BODY","Bitstream Vera Sans Mono",'(value);',"Value","changeHtml","qx.OO","changeColorTheme"," errors have been recorded, keeping log window open.</b>","a=qx.lang.Array.fromShortHand(qx.lang.Array.fromArguments(a));","(passed time: ",">>> ",'_labelObject','<span class="objectBox-function">',"last","_resetRuntime","_handle","qooxdoo","splitpane-knob","_applyButton",'    hr { border: 0 none; border-bottom: 1px solid #ccc; margin: 8px 0; padding: 0; height: 1px }',"Reloading test suite...","scrolling","substring","[object Error]","qx.ui.pageview.buttonview.ButtonView","reloadswitch","match",'#',"https://","icon/16/status/folder-open.png",'value !== null && value.$$type === "Class"',"_blocked","_applyAutoSync","<span style=\"text-decoration:underline\">","  at ","Scroll","__borderObject","icon/16/devices/video-display.png",'typeof value === "string" && qx.util.ColorUtil.isValid(value)',"_blockData","__",'var a=this.getChildren();if(a)for(var i=0,l=a.length;i<l;i++){',"qx.ui.layout.impl.VerticalBoxLayoutImpl","debug","_applyAppearance","_blockerNode","_styleProperties","_applyOpacity","qx.html.Offset","widget/window/restore.gif","reverseChildrenOrder",",height=","qxvariant",'if(mixins[i].$$constructor){mixins[i].$$constructor.apply(this,arguments);}}}',"Alpha(Opacity=","check-box-group-box-legend","viewer","<div style='float:left;width:","charAt","_applyBorderTheme","line-bottom","qx.ui.pageview.buttonview.Button","\\$1","parentPaddingRight","_applyZIndex","')","tab-view-button-hover","_aliases","check-box","px\" src=\"",'var backup=computed;',"_applyPaddingLeft","qx.core.LegacyProperty","true","_lastUpDownType",'for(var i=0,l=mixins.length;i<l;i++){',"_applyFontTheme","Please use getKeyIdentifier() instead.","_applyTabIndex",'if(this.classname===',"start_plus","changeAppearance","qx.debug","https:",'if(value!==inherit)',"changeBarPosition",'if(a[i].',"(!this.","font-size:","qx.locale.LocalizedString","4","changeBackgroundColor","changeRight","[Interface ","please use getText() instead.","_translationCatalog","static/stringbuilder/helper.html","qx.theme.manager.Color","Progress:","splitpane-slider","remove","borderTopStyle","stylesheet","__useinit$",'Undefined value is not allowed!',"Interface","qx.bom.element.Style","overflow-x",'Is invalid!',"colorInnerBottom","netnewswire","qx.ui.layout.HorizontalBoxLayout","qx.theme.classic.Widget","': ","&gt;","client-document","borderRightStyle","widget/cursors/copy.gif",'</span></td>',"widget/menu/checkbox.gif","_markerBtn","_applyMaxLength","Firefox","img","_showTimeStamp","qx.lang.Core","_htmlAttributes",'){',"qx.minLogLevel","anonymous: ","MozBoxSizing"," (#","Use getUseDoubleClick instead","_closeButtonImage","testrunner.runner.Application","0.0","info","__onmouseevent","=((v==null)?0:v)+'px'","_valueDomEvent","_applyColorInnerBottom","qx.ui.toolbar.CheckBox","_applyLeft","tests","_applyAnchorItem"," Test Runner","_borderElement","tool-tip","[object ","qx.appearanceTheme","__onwindowblur","clip","Mozilla","Log window message: <b>Note: ",'</span></td></tr>',"0.0.0","/widget/Windows",'var prop=qx.core.Property;',"changeBottom","width=500,height=250,dependent=yes,resizable=yes,status=no,location=no,menubar=no,toolbar=no,scrollbars=no",'<table>',"widget/table/selectColumnOrder.png","bold-large","icon/16/actions/view-refresh.png","_applyCloseButtonImage","beforeDisappear",'if(clazz.$$includes){var mixins=clazz.$$flatIncludes;',"_layoutImpl","5","_applyShowCloseButton","_cached",'<span class="selectorId">#',')prop.error(this,5,"',"qx.theme.manager.Icon","Windows Royale","qx.core.Version","toLocaleUpperCase","return this.join('');",'\", "',"_applyStepStatus","&nbsp;&nbsp;","Width","qx.theme.manager.Border","widget/window/minimize.gif","pixelWidth","_applyVerticalChildrenAlign","group-box","qx.log.Logger","_applyWrap","  [not readable: ","ae","initial","_computed","tab-view","_applyTheme","0x","_applyShowStepStatus"," ms) ","_applyPage","omniweb","icon/16/actions/media-playback-start.png","addAt",'!==inherit){',"changeOpen","qx.util.range.IntegerRange","changeFocused","changeTheme","qx.eventMonitorNoListeners","statuspane","Classic Royale",'X',"end_minus","CapsLock","widget/menu/radiobutton.gif",'value !== null && (qx.locale.Manager.getInstance().isDynamic(value) || typeof value === "string")',"_fields","_applyIconWidth","_lastMouseEventDate","_applyGlobalCursor","_applyStyleBottom","MaxWidth","image","valueOf","_applyInterval","galeon","join","removeDom","Courier New","qx.html.StyleSheet","_appenderArr","AppleWebKit","Legacy properties are deprecated","Use setHtmlProperty instead","_remappingChildTable","qx.ui.core.ClientDocument","qx.util.manager.Object","right-reversed","toolbar-part-handle",">","other gecko","qx.util.Compare","no","qx.ui.groupbox.GroupBox","qx.ui.basic.Atom","Percent","_applyBackgroundColor","combo-box-button","qx.colorTheme","http://",'.classname)this.$$initialized=true;',"widget/arrows/next.gif","_valueData",'else{',"qx.core.Init","_applyHorizontalChildrenAlign","Ae",'<span class="selectorTag">',"2","1px dotted",'#lines { width: 100%; height: expression((document.body.offsetHeight - 30) + "px"); }',"changeCapture","map","O","__theme$",'value !== null && value.nodeType !== undefined',"add","\\.[^\\.]+$","_filterArr",'></iframe>',"widget/window/close.gif","rgb(",'computed=undefined;delete this.',"RealPlayer","icon/16/actions/view-pane-text.png","Apps","font-style:","qx.core.Log.assert","_applyMarginTop",'return retval;',"_applyVisibility",'if(computed===undefined||computed===inherit){',"_applyPcntStatus","splice","<h1>","pcntStatus","<h3>","_applyMaxWidth","Succeeded: ",'typeof value === "string"',"divider-vertical","changeZIndex","qx.theme.classic.font.Default",'if(value!==null)',"--- Object: ",'typeof value === "string" && value.length > 0','&gt;</div><div class="nodeChildren">',"create","Run selected test(s)","_inlineEvents",")+;)|[^&","_applyIconTheme","_applyWidthRight","qx.lang.Object","_window","changeLocale",'throw new Error("Property ',"visibility","_valueManager",'value !== null && qx.theme.manager.Border.getInstance().isDynamic(value)',"MacIntel","_applyFocusHandler","qx.core.Log.log","Top","qx.core.Log.warn","command","</div><span style='float:left'>&hellip;</span>","_applyMnemonic","_applyDisplay","_document","textarea","Meta","windowblur","_attachedWidget","Test backend application URL","qx.ui.tree.SelectionManager","__user$excludeSpecificTreeLines","start_minus","Stack trace: <div class='trace'>","_timer","mozBoxSizing",'name="',"qx.dom.String","ue","table-pane","_applyHtml","iPhone","unix","3","changeFontTheme",'<span class="objectBox-null">',"body {}","&nbsp;","search","qx.core.Aspect","window-active-caption"," errors.",'<iframe onload="parent.qx.ui.embed.Iframe.load(this)" ',"mac","qx.ui.core.Border",'Requires exactly one argument!',"_divDataSets","widget/window/maximize.gif","Win",'if(value===null)prop.error(this,4,"',"_widget","overflow-y","Flat Tree","stepStatus","_applyManager","Parsed","_previousParentFolder","qx.bom.Document","qx.ui.toolbar.ToolBar",'value !== null && value.$$type === "Theme"',"_lastKeyCode",'    pre { margin: 0; padding: 4px 8px; font-family: Consolas, "Bitstream Vera Sans Mono", monospace; }',"MSIE","qx.html.Entity","_applyCaptureWidget","anonymous","file:","Reload","_lastMouseDown",'</span>=&quot;<span class="nodeValue">',"cssFloat","toolbar-part","qx.ui.tree.TreeRowStructure",'!(value && qx.Class.hasInterface(value.constructor, ',"' started.","qx.ui.basic.Label",".gif","Use getUseTreeLines instead","[Theme ","runbutton","bar","qx.ui.popup.PopupAtom","group-box-legend","beforeInsertDom","_applyAutoCloseWithErrors","(0/0)","_legendObject","qx.io.image.PreloaderSystem","testrunner.runner.ProgressBar","Use getHideNode instead","_applyBarColor","qx.html.EventRegistration","_innerStyle","icon/16/actions/document-new.png","verticalChildrenAlign","please use setText() instead.",")+>)|(&([^;]|","qx.bom.element.Location","Ue","_applyStyleRight",'===value)return value;',"-1","Object is null","_applyMenu","<html><head><title>","_splitter","=[not readable: ","end_plus"," in method ","i","qx.ui.basic.Terminator","_applyColorRight","_iframeNode","_applyWidthBottom","Preparing...",'if(value===undefined)prop.error(this,2,"',"_oldParent","_applyItalic","widget/splitpane/knob-vertical.png","Running tests...",'value=this.',"/100","splitpane-splitter","toolbar=no,scrollbars=no,resizable=yes,","widget/cursors/move.gif",'<span class="objectBox-selector">',"qx.ui.selection.SelectionManager","complete","qx.ui.tree.AbstractTreeElement","_applyHideFocus","progid:DXImageTransform.Microsoft.Shadow(color='Gray', Direction=135, Strength=4)"," messages removed)","qx.ui.embed.HtmlEmbed","_applyShowKnob","bottom-reversed","commandLine","qx.core.Log.dir","qx.core.MUserData",'value instanceof RegExp',"_logEventQueue","toolbar-separator-line","qx.event.type.DomEvent","System Status: ","__ondragevent","_valueOldValue","changeEnabled","_applyLoaded","())","_applyParent","qx.core.Variant","qx.core.Target","&quot;","/source/class/","qx.util.manager.MConnectedObject","__listeners","beforeRemoveDom","addBefore","_applyMarginLeft","Enabled auto-reload","qx.log.LogEventProcessor","pixelTop","&#39;","_applyElement","_applyBarPosition",' of an instance of ',"_firstArea","qx.theme.classic.Border","text-decoration:","_applyShow","_applyFocusedChild",'<div class="objectBox-element">',"changeWidth","widget/table/ascending.png","widget/cursors/alias.gif","testrunner.runner.TestRunner","_parentLogger",'    #lines{ top: 30px; left: 0; right: 0; bottom: 0; position: absolute; overflow: auto; }',"_applySuccCnt","'>","hull","Error message is: <br />","qx.lang.Array","html/QooxdooTest.html","_applyColorLeft",'</div><div class="objectBox-element">&lt;/<span class="nodeTag">',"#134275 url(","qx.ui.splitpane.SplitPaneSplitter","toLocaleLowerCase","changeFocusedChild","KDE","_children","Run Test","Loading...","qx.ui.splitpane.SplitPaneKnob","qx.ui.pageview.tabview.Pane","yes","_modify","qx.ui.pageview.tabview.Page","</title></head>","every","\\\\","addChild","changeValidator","_slider","__font",'<td class="propertyNameCell"><span class="propertyName">',"_change","_applyIconPosition","changeDisplay","_applyWidth","_applyColorInnerRight",'/&gt;</div>',"changeMaxHeight","Consolas","qx.locale.MTranslation","changeMinHeight",'return null;',"unselectable","' failed: ","_remappingChildTarget","' id='testResult","1","_applyWidgetTheme","html { border:0 none; } ","dir","Test Results","', ((v==null)?0:v)+'px')","atom","_value",'_indentObject',"qx.preloaderTimeout","changeShowCloseButton","shift","qx.theme.manager.Appearance","parentPaddingLeft","addAtBegin","org.w3c.dom.svg","Current stack trace","qx.ui.pageview.buttonview.Pane",'Null value is not allowed!',"pixelLeft","qx.util.StringBuilder","toolbar-separator","file://","qx.event.handler.KeyEventHandler","Alt","Backspace"," with incoming value '","link",'Could not change or apply init value after constructing phase!',"No target to insert tests",': ',"qxsetting","orientation","changeOverflow","qx.ui.toolbar.Part","__stateMap","testrunner","keyinput",'value instanceof Function',"_htmlProperties","...","__intervalHandler","qx.log.appender.FireBug","_valueCurrentTarget","qx.core.Log.dirxml","dragend","__oninput","_applySpellCheck","width=","toLowerCase",'<span class="objectBox-string">&quot;'," of class ",") top left repeat-x","icon/16/actions/dialog-cancel.png","cross_plus","_applyMinWidth","qx.client.Command","\" />","Win64","changeIconTheme","_applyCommand","/icon/Nuvola","_blocker","qx.html.Iframe",'", computed, old);',"borderRight",",top=","_applyAlignTabsToLeft","widget/cursors/nodrop.gif","1px 0",'value !== null && typeof value === "object"',"_applyShowPcntStatus",'value instanceof Array',"qx.ui.splitpane.HorizontalSplitPane","_applyFrameName","_applyAlwaysShowPlusMinusSymbol",'<tr>',"__visible","qx.ui.layout.impl.HorizontalBoxLayoutImpl","_filterTextWords","testrunner/image/yellow_diamond_full18.gif",",left=","qx_log_","_applyTextColor",'&nbsp;<span class="nodeName">',"__manager","_applyColorInnerTop","pixelRight","} ","MozUserFocus","qx.theme.manager.Widget","_applyMarginRight","_applyStyleLeft","#0000FF","Flex","Results should go into a table here.","WebkitBoxSizing","font-family:",'var computed, old=this.',"_applyHeight","qx.core.Log","_lastMouseEventType","qx.theme.icon.Nuvola",'    html, body{ padding: 0; margin: 0; border : 0 none; }',"_modalNativeWindow","_isErroneous","[Class ","resizer","_applyWidthTop","_style","changeLeft","Reload test backend application","_valueDomTarget","changeTop","changeAnchorItem","menu","__onselectevent","font-weight:","_bar",'</span>&quot;','<span class="objectBox-object">',"this.setStyleProperty('padding","windowfocus",'</div>',"BSD","qx.core.Log.clear","_connectedObjects","qx.Theme","qx.ui.pageview.tabview.Bar","gif","Always reload test backend before testing","_applyHideNode","_applyUseTreeLines","_valueValue","</h1>","testrunner.AssertionError","qx.ui.toolbar.MenuButton","endTest",'&quot;</span>',"qx.util.Validation","qx.util.ColorUtil","_valueTarget","qx.ui.window.Window","tree1","borderLeft","cross_minus","Reload before Test","horizontalChildrenAlign"," INFO:  ","_applyTop","script","changeGlobalCursor","()","reloadbutton","toUpperCase",'var pa=this.getParent();if(pa)computed=pa.',"_dynamic"," logRow-","firstChild","reverse","KhtmlBoxSizing","changeHeight","ss","return this.length === 0;","qx.theme","qx.ui.selection.Selection","insertDom","oe","_applyFamily","stretchChildrenOrthogonalAxis","empty","The test '","qx.borderTheme",'value !== null && value.type !== undefined',"testrunner.MAssert","Error: Could not get a reference to the sheet object",'value !== null && value.nodeType === 1 && value.attributes','value !== null && typeof value === "object" && !(value instanceof Array) && !(value instanceof qx.core.Object)',"qx.ui.embed.Iframe",'(computed, old);',"?",'</table>',"qx.ui.pageview.AbstractPageView","is",'()</span>','value !== null && value.nodeType === 9 && value.documentElement',"testrunner.resourceUri","replace","#FFEEEE","_applySecondSize","_applyPaddingBottom","qx.ui.pageview.buttonview.Page","table-header-cell",".apply(this._remappingChildTarget, arguments)","_registry","^","closetab","*{","qx.ui.toolbar.PartHandle","420","[","qx.log.MLogging",'old=computed=this.',"_applyColorTheme","widgetLinkFull","qx.core.Client","qx.ui.toolbar.Separator","qx.ui.pageview.buttonview.Bar","qx.theme.manager.Meta","changeSpacing","_applyIconHeight",'&lt;<span class="nodeTag">',"removeAt","shiira",'===undefined)return;',"_applyActiveChild","substr","MaxHeight",'<span class="selectorClass">.',"null","_modalWidgets",'Does not allow any arguments!',"qx.dom.Node","firefox","__storage","changeVisibility","colorInnerTop","realplayer","other webkit","px;overflow:hidden;white-space:nowrap'>","splitpane","_lastMouseDownDomTarget","_isPng","Element","_applyUseAdvancedFlexAllocation","dirxml","tmap"," ---\n","qx.html.String",'))',"button-hover","_filterInput",'var retval=clazz.$$original.apply(this,arguments);',"camino",'    #control { top: 0; left: 0; right: 0; padding: 4px 8px; background: #eee; border-bottom: 1px solid #ccc; height: 30px }',"qx.ui.core.ClientDocumentBlocker"," ERROR: ","widget/arrows/down_small.gif","divider-horizontal","testrunner.runner.TestResultView","u","qx.client.Timer","_valueRelatedTarget","[object Object]","qx.lang.Function","qx.dev.StackTrace","qx.core.Setting","line-right","Liberation Sans Mono","testrunner.title","_globalCursorStyleSheet","widget/table/descending.png","children","Oe","/static/log/log.html","_applyAppearanceTheme","content-box",'if(','value instanceof Error','anonymous',"qx.core.Property","Full tree view","changeMenu","Error in property ","loader","<","<div class='testResult ","MinWidth","this._style.","_applyExcludeSpecificTreeLines","tree-label","_applyStyleTop","&amp;","<br />","marker"," (r","qx.ui.layout.CanvasLayout",'else if(computed===undefined)',"qx.core.Log.timeEnd","?testclass=","qx.widgetTheme","spacing",'else this.',"visible","Bottom","explorer","qx.core.Log.time","colorInnerLeft","large"," FATAL: ","Safari","hideFocus","_applyDisabledIcon","_applyPaddingRight","changeBorder",'&gt;</span></div>',"en","__userData","' had an error: ","_applyWidthLeft","--- End of object ---","_logLinesDiv","logRow",'var clazz=arguments.callee.constructor;',"_inputElement","__onwindowresize","window-active-caption-text","iphone","changeMinWidth",'var computed, old;','}else{',"_secondArea","_isCreated",'<td><span class="propertyValue">',"window-inactive-caption","qx.util.manager.Value","qx.core.Bootstrap","toLocaleString","parentPaddingTop","horizontalAlign","qx.enableApplicationLayout","_jobQueue","some",'</body></html>',"_containerObject","widget/arrows/up_small.gif","qx.ui.toolbar.Button",'typeof value === "boolean"',"changeDirection","Mixin","charCodeAt","testrunner/css/testrunner.css","qx.theme.classic.Appearance","])*)(","qx.lang.Number","Tests selected","',sizingMethod='scale')","[\xE4\xF6\xFC\xDF\xC4\xD6\xDC]","changeTabIndex","qx.lang.String","_renderRuntime","_applyCapture","_appender",'.checkMap[value]===undefined','.check.call(this, value)',"Nuvola","overline","qx.html.ScrollIntoView","_applyReverseChildrenOrder","_applyDecoration","qx.widgetDebugId","=","rect(","colorInnerRight","_isLoaded","_applyCurrentToolTip","_items","__onwindowfocus","qx.ui.layout.VerticalBoxLayout","_applyPlaceBarOnTop","konqueror","Auto","table-header-cell-hover","pop","BackgroundImageCache","isPrototypeOf","X11",'_iconObject',"NetNewsWire","qx.compatibility","_applyColorInnerLeft","^(((<([^>]|","qx.bom.Viewport","tab-view-page","group-box-frame","url(","_applyBarWidth","img{","_applyBold","changeWidgetTheme",'    <pre id="log" wrap="wrap"></pre>','this.createDispatchChangeEvent("',"Shift","_applyColorTop","html,body{width:100%;height:100%;overflow:hidden;}","changeOpenMenu","qx.log.appender.Abstract","qx.html.Style","testrunner.runner.TestResultData","Clear","testrunner/image/package18.gif","qx.locale.Locale","useAdvancedFlexAllocation","return this._remappingChildTarget.","changeOrientation","qx.ui.pageview.tabview.Button","__oninterval","_applyLeadItem","qx.ui.basic.HorizontalSpacer","Shiira","qx.theme.manager.Font","changeMaxWidth","MinHeight","qx.ui.splitpane.SplitPaneSlider","qx.io.image.PreloaderManager","Camino","table-focus-indicator","qx.ui.layout.impl.CanvasLayoutImpl","qx.ui.tree.TreeFile","mainsplit","_commands","logappender","s",'  <style type="text/css">','<div class="nodeText">',"_frameObject","monospace","changeAppearanceTheme"," ["];if(!window.qxsettings)qxsettings={};
...
/* ID: qx.lang.Core */
qx.Class.define($[952]);
if(!Error.prototype.toString||Error.prototype.toString()==$[850]){Error.prototype.toString=function(){return this.message;
};
...
}if(!String.prototype.quote){String.prototype.quote=function(){return $[97]+this.replace(/\\/g,
$[1331]).replace(/\"/g,
$[803])+$[97];
};
}
...
__init:function(){if(window.qxsettings){for(var $0 in qxsettings){if(($0.split($[20])).length<2){throw new Error('Malformed settings key "'+$0+'". Must be following the schema "namespace.key".');
}
if(!this.__settings[$0]){this.__settings[$0]={};
...
__loadUrlSettings:function(){if(this.get($[422])!=true){return;
}var $0=document.location.search.slice(1).split($[158]);
for(var $1=0;$1<$0.length;$1++){var $2=$0[$1].split($[35]);
if($2.length!=3||$2[0]!=$[1383]){continue;
}var $3=$2[1];
if(!this.__settings[$3]){this.__settings[$3]={};
}this.__settings[$3].value=decodeURIComponent($2[2]);
}}},
defer:function($0){$0.define($[422],
false);
$0.define($[454],
false);
$0.define($[172],
...
__loadUrlVariants:function(){if(qx.core.Setting.get($[454])!=true){return;
}var $0=document.location.search.slice(1).split($[158]);
for(var $1=0;$1<$0.length;$1++){var $2=$0[$1].split($[35]);
if($2.length!=3||$2[0]!=$[879]){continue;
}var $3=$2[1];
...
if($1.indexOf($[408])<0){$3=this.get($0)===$1;
}else{var $4=$1.split($[408]);
for(var $5=0,
...
__isValidArray:function($0){return typeof $0===$[31]&&$0!==null&&$0 instanceof Array;
},
__isValidObject:function($0){return typeof $0===$[31]&&$0!==null&&!($0 instanceof Array);
},
...
wrap:function($0,
$1,
$2){if(!qx.core.Setting.get($[439])){return $1;
}var $3=[];
var $4=[];
for(var $5=0;$5<this.__registry.length;$5++){var $6=this.__registry[$5];
if($0.match($6.re)&&($2==$6.type||$6.type==$[111])){var $7=$6.pos;
if($7==$[462]){$3.push($6.fcn);
}else{$4.push($6.fcn);
}}}
...
$1,
$2,
$3){if($0!=$[462]&&$0!=$[729]){throw new Error("Unknown position: '"+$0+"'");
}this.__registry.push({pos:$0,
type:$1,
re:$2,
fcn:$3});
}},
defer:function(){qx.core.Setting.define($[439],
false);
}});
...
/* ID: qx.core.Client */
qx.Class.define($[1557],
{statics:{__init:function(){var $0=window.location.protocol===$[1197];
...
var $d=null;
var $e;
if(window.opera&&/Opera[\s\/]([0-9\.]*)/.test($1)){$6=$[84];
$7=RegExp.$1;
$5=$[84];
$7=$7.substring(0,
3)+$[20]+$7.substring(3);
$c=$1.indexOf($[1193])!==-1?$[28]:$1.indexOf($[979])!==-1?$[25]:null;
}else if(typeof $2===$[8]&&$2===$[1320]&&/KHTML\/([0-9-\.]*)/.test($1)){$6=$[95];
$5=$[1722];
$7=$[1551];
}else if($1.indexOf($[1057])!=-1&&/AppleWebKit\/([^ ]+)/.test($1)){$6=$[95];
$7=RegExp.$1;
$d=$7.indexOf($[309])!=-1;
var $f=RegExp($[339]).exec($7);
if($f){$7=$7.slice(0,
$f.index);
}
if($1.indexOf($[1652])!=-1){$5=$[793];
}else if($1.indexOf($[669])!=-1){$5=$[1026];
}else if($1.indexOf($[1761])!=-1){$5=$[1565];
}else if($1.indexOf($[1730])!=-1){$5=$[937];
}else if($1.indexOf($[1099])!=-1){$5=$[1579];
}else{$5=$[1580];
}
if($d){$5+=$[574];
}}else if(window.controllers&&typeof $3===$[8]&&$3===$[479]&&/rv\:([^\);]+)(\)|;)/.test($1)){$6=$[25];
$7=RegExp.$1;
if($1.indexOf($[949])!=-1){$5=$[1575];
}else if($1.indexOf($[1767])!=-1){$5=$[1595];
}else if($1.indexOf($[727])!=-1){$5=$[1051];
}else{$5=$[1066];
}}else if(/MSIE\s+([^\);]+)(\)|;)/.test($1)){$6=$[28];
$7=RegExp.$1;
$5=$[1647];
}
if($7){$e=$7.split($[20]);
...
var $h=document.compatMode!==$[80];
var $i=$[1658];
var $j=($6==$[28]?navigator.userLanguage:navigator.language).toLowerCase();
var $k=null;
var $l=$j.indexOf($[224]);
...
var $q=false;
var $r=false;
if($4.indexOf($[369])!=-1||$4.indexOf($[617])!=-1||$4.indexOf($[1410])!=-1){$n=true;
$m=$[329];
}else if($4.indexOf($[586])!=-1||$4.indexOf($[605])!=-1||$4.indexOf($[1136])!=-1){$o=true;
$m=$[1174];
}else if($4.indexOf($[1728])!=-1||$4.indexOf($[551])!=-1||$4.indexOf($[1476])!=-1){$p=true;
$m=$[1163];
}else if($4.indexOf($[1162])!=-1||$4.indexOf($[584])!=-1){$q=true;
$m=$[1669];
}else{$r=true;
$m=$[50];
}var $s=false;
...
var $v=false;
if($6==$[28]){$s=true;
}if(document.implementation&&document.implementation.hasFeature){if(document.implementation.hasFeature($[1367],
$[622])){$t=$u=true;
}}this._runsLocally=$0;
this._engineName=$6;
this._engineNameMshtml=$6===$[28];
this._engineNameGecko=$6===$[25];
this._engineNameOpera=$6===$[84];
this._engineNameWebkit=$6===$[95];
...
}if(!$1.hasOwnProperty($[645])&&!$1.type){$1.type=$[259];
}{};
...
genericToString:function(){return $[1458]+this.classname+$[125];
},
...
$6.basename=$c;
if(!$6.hasOwnProperty($[465])){$6.toString=this.genericToString;
}
...
}if($3.init!==undefined){$0.prototype[$[334]+$5]=$3.init;
...
var $5;
if($2===$[23]){$4.getInstance=this.getInstance;
}$4.$$original=$0;
$0.wrapper=$4;
return $4;
}},
...
genericToString:function(){return $[774]+this.name+$[125];
},
__registry:{},
__allowedKeys:null,
__validateConfig:function(){}}});
...
for(var $5 in $3){if(typeof $3[$5]===$[36]){if(typeof $4[$5]!==$[36]){throw new Error('Implementation of method "'+$5+'" is missing in class "'+$0.classname+'" required by interface "'+$1.name+'"');
}if($2===true&&!qx.Class.hasInterface($0,
$1)){$4[$5]=this.__wrapInterfaceMember($1,
$4[$5],
$5,
$3[$5]);
}}else{if(typeof $4[$5]===undefined){if(typeof $4[$5]!==$[36]){throw new Error('Implementation of member "'+$5+'" is missing in class "'+$0.classname+'" required by interface "'+$1.name+'"');
...
genericToString:function(){return $[920]+this.name+$[125];
},
__registry:{},
...
destruct:function(){this._disposeFields($[1659]);
}});
...
}$1[$[102]+$3]=function(){if(this[$4]==null){this[$4]=this[$5]();
}return this[$4];
};
$1[$[381]+$3]=function(){if(this[$4]!=null){this[$4]=null;
if($0.addToQueueRuntime){this.addToQueueRuntime($0.name);
}}};
$1[$[444]+$3]=function(){var $7=this[$4];
var $8=this[$5]();
if($8!=$7){this[$4]=$8;
this[$6]($8,
$7);
...
$1[$[102]+$3].self=$1.constructor;
$1[$[381]+$3].self=$1.constructor;
$1[$[444]+$3].self=$1.constructor;
},
addProperty:function($0,
$1){qx.log.Logger.deprecatedMethodWarning(arguments.callee,
$[1058]);
if(typeof $0!==$[31]){throw new Error("AddProperty: Param should be an object!");
}
if(typeof $0.name!==$[8]){throw new Error("AddProperty: Malformed input parameters: name needed!");
}if($0.dispose===undefined&&($0.type==$[36]||$0.type==$[31])){$0.dispose=true;
...
var $2=qx.core.Property.$$store.user[$0.name]=$[513]+$0.name;
var $3=$[660]+$0.method;
var $4=$[1327]+$0.implMethod;
var $5=$[721]+$0.implMethod;
var $6=qx.core.Property.$$method;
if(!$6.set[$0.name]){$6.set[$0.name]=$[17]+$0.method;
$6.get[$0.name]=$[102]+$0.method;
$6.reset[$0.name]=$[93]+$0.method;
}$1[$2]=$0.defaultValue;
$1[$[102]+$0.method]=function(){return this[$2];
};
$1[$[728]+$0.method]=function($7){return this[$2]=$7;
};
$1[$[93]+$0.method]=function(){return this[$[17]+$0.method]($0.defaultValue);
};
if($0.type===$[51]){$1[$[428]+$0.method]=function($7){return this[$[17]+$0.method](!this[$2]);
};
}
if($0.allowMultipleArguments||$0.hasConvert||$0.hasInstance||$0.hasClassName||$0.hasPossibleValues||$0.hasUnitDetection||$0.addToQueue||$0.addToQueueRuntime||$0.addToStateQueue){$1[$[17]+$0.method]=function($7){if($0.allowMultipleArguments&&arguments.length>1){$7=qx.lang.Array.fromArguments(arguments);
...
}else{$1[$[17]+$0.method]=function($7){var $8=this[$2];
if($7===$8){return $7;
}
if(!($0.allowNull&&$7==null)){if($0.hasType&&typeof $7!==$0.type){throw new Error("Attention! The value \""+$7+"\" is an invalid value for the property \""+$0.name+"\" which must be typeof \""+$0.type+"\" but is typeof \""+typeof $7+"\"!");
}}if(this[$5]){try{$7=this[$5]($7,
...
}$1[$[17]+$0.method].self=$1.constructor;
if(typeof $0.getAlias===$[8]){$1[$0.getAlias]=$1[$[102]+$0.method];
}if(typeof $0.setAlias===$[8]){$1[$0.setAlias]=$1[$[17]+$0.method];
}}}});
...
$4;
if($1.charAt(0)===$[169]){if($1.charAt(1)===$[169]){$3=$[867];
...
if($1.inheritable||$1.apply||$1.event||$1.deferredInit){$6.init[$5]=$2+$[77]+$3;
...
if($1.inheritable){$6.refresh[$5]=$2+$[137]+$3;
...
if($1.themeable){$6.style[$5]=$2+$[43]+$3;
...
if($1.check===$[3]){$4[$2+$[428]+$3]=new Function($[515]+$6.set[$5]+$[914]+$6.get[$5]+$[1278]);
$4[$2+$[1535]+$3]=new Function($[515]+$6.get[$5]+$[1504]);
}},
__errors:{0:$[1380],
1:$[1176],
2:$[931],
...
var $6=$[1625]+$2+$[1403]+$5+$[1239]+this.$$method[$3][$2]+$[1378]+$4+$[940];
$0.printStackTrace();
...
if($4.deferredInit&&$4.init===undefined){$6.push($[166],
this.$$store.init[$2],
$[120]);
$6.push($[165],
this.$$store.init[$2],
...
if($4.init!==undefined){$6.push($[165],
this.$$store.init[$2],
$[12]);
}else if($4.inheritable||$4.nullable){$6.push($[1347]);
}else{$6.push($[1132],
$2,
$[1295],
$1.classname,
...
var $6=$1.prototype;
var $7=[];
var $8=$3===$[17]||$3===$[43]||($3===$[77]&&$5.init===undefined);
var $9=$3===$[93]||$3===$[112];
var $a=$5.apply||$5.event||$5.inheritable;
if($3===$[43]||$3===$[112]){var $b=this.$$store.theme[$2];
}else if($3===$[77]){var $b=this.$$store.init[$2];
}else{var $b=this.$$store.user[$2];
}{if(!$5.nullable||$5.check||$5.inheritable){$7.push($[984]);
}if($3===$[17]){$7.push($[1246]+$2+$[265]+$3+$[299]);
}};
if($8){if($5.transform){$7.push($[1251],
$5.transform,
$[829]);
}}if($a){if($8){$7.push($[87],
$b,
...
$b,
$[1566]);
}}if($5.inheritable){$7.push($[568]);
}if($8&&(false||$3===$[17])){if(!$5.nullable){$7.push($[1180]+$2+$[265]+$3+$[299]);
}if($5.check!==undefined){if($5.nullable){$7.push($[1119]);
}if($5.inheritable){$7.push($[911]);
}$7.push($[1619]);
if(this.__checks[$5.check]!==undefined){$7.push($[506],
this.__checks[$5.check],
$[286]);
}else if(qx.Class.isDefined($5.check)){$7.push($[761],
$5.check,
$[286]);
}else if(qx.Interface.isDefined($5.check)){$7.push($[1204],
$5.check,
$[1591]);
}else if(typeof $5.check===$[36]){$7.push($[672],
$1.classname,
$[473],
$2);
$7.push($[1706]);
}else if(typeof $5.check===$[8]){$7.push($[506],
$5.check,
$[286]);
...
}$7.push($[999]+$2+$[265]+$3+$[299]);
}}
if(!$a){if($3===$[17]){$7.push($[54],
this.$$store.user[$2],
$[44]);
}else if($3===$[93]){$7.push($[87],
this.$$store.user[$2],
$[120]);
$7.push($[109],
this.$$store.user[$2],
$[12]);
}else if($3===$[43]){$7.push($[54],
this.$$store.theme[$2],
$[44]);
}else if($3===$[112]){$7.push($[87],
this.$$store.theme[$2],
$[120]);
$7.push($[109],
this.$$store.theme[$2],
$[12]);
}else if($3===$[77]&&$8){$7.push($[54],
this.$$store.init[$2],
$[44]);
}}else{if($5.inheritable){$7.push($[1450],
this.$$store.inherit[$2],
$[12]);
}else{$7.push($[1671]);
}$7.push($[87],
this.$$store.user[$2],
$[187]);
if($3===$[17]){if(!$5.inheritable){$7.push($[213],
this.$$store.user[$2],
$[12]);
}$7.push($[34],
this.$$store.user[$2],
$[44]);
}else if($3===$[93]){if(!$5.inheritable){$7.push($[213],
this.$$store.user[$2],
$[12]);
}$7.push($[109],
this.$$store.user[$2],
...
$[208]);
$7.push($[90]);
}else{if($5.inheritable){$7.push($[34],
this.$$store.user[$2],
$[12]);
}else{$7.push($[1554],
this.$$store.user[$2],
...
if($5.themeable){$7.push($[166],
this.$$store.theme[$2],
$[187]);
if(!$5.inheritable){$7.push($[213],
this.$$store.theme[$2],
$[12]);
}
if($3===$[17]){$7.push($[34],
...
$[208]);
$7.push($[90]);
}else if($3===$[77]){if($8){$7.push($[54],
this.$$store.init[$2],
$[44]);
}$7.push($[34],
this.$$store.theme[$2],
$[12]);
}else if($3===$[137]){$7.push($[34],
this.$$store.theme[$2],
$[12]);
}$7.push($[90]);
}$7.push($[166],
...
if($3===$[77]){if($8){$7.push($[34],
this.$$store.init[$2],
$[44]);
}else{$7.push($[34],
this.$$store.init[$2],
$[12]);
}}else if($3===$[17]||$3===$[43]||$3===$[137]){$7.push($[109],
this.$$store.useinit[$2],
$[12]);
if($3===$[17]){$7.push($[34],
this.$$store.user[$2],
...
$7.push($[478]);
$7.push($[535]);
}else if($a){if($3!==$[17]&&$3!==$[43]){$7.push($[478]);
}$7.push($[388]);
$7.push($[535]);
}if($a){if($5.apply){$7.push($[54],
$5.apply,
$[1531]);
}if($5.event){$7.push($[1743],
$5.event,
$[1416]);
}if($5.inheritable&&$6.getChildren){$7.push($[868]);
$7.push($[913],
...
format:function($0,
$1){var $2=$0;
for(var $3=0;$3<$1.length;$3++){$2=$2.replace(new RegExp($[81]+($3+1),
$[470]),
$1[$3]);
}return $2;
},
...
toString:function(){if(this.classname){return $[975]+this.classname+$[125];
}return $[1605];
},
base:function($0,
...
this._logFormatted($3.length?$3:[$[385]],
$[55]);
throw $1?$1:$[385];
}},
...
}if(qx.core.Setting){var $0=qx.core.Setting.get($[172])+$[1616];
...
this._consoleLog=$1.getElementById($[347]);
this._commandLine=$1.getElementById($[1266]);
...
_syncLayout:function(){this._consoleLog.style.height=(qx.bom.Viewport.getHeight(this._consoleWindow)-42)+$[37];
},
...
if(!window.confirm($1+$[176]+$0.join($[0])+$[690])){this._unloadCancelled=true;
...
$1){var $2=this._consoleLog.ownerDocument.createElement($[116]);
$2.className=$[1664]+($1?$[1509]+$1:$[0]);
...
if($7&&typeof ($7)==$[31]){var $8=$0[++$4];
$7.appender($8,
$2);
}else this._appendText($7,
$2);
}
for(var $6=$4+1;$6<$0.length;++$6){this._appendText($[78],
$2);
var $8=$0[$6];
...
var $7=$4[3]?parseInt($4[3]):($4[4]==$[20]?-1:0);
$1.push($0.substr(0,
$4[0][0]==$[81]?$4.index:$4.index+1));
$1.push({appender:$6,
precision:$7});
...
_escapeHTML:function($0){function $1($2){switch($2){case $[1627]:return $[673];
case $[1065]:return $[941];
case $[158]:return $[1634];
case $[341]:return $[1292];
case $[97]:return $[1282];
}return $[1532];
...
$1);
else if($0==null)this._appendNull($[1571],
$1);
else if(typeof $0==$[8])this._appendString($0,
$1);
else if(typeof $0==$[56])this._appendInteger($0,
$1);
else if($0.toString)this._appendText($0.toString(),
$1);
else if(typeof $0==$[36])this._appendFunction($0,
$1);
else if($0.nodeType==1)this._appendSelector($0,
$1);
else if(typeof $0==$[31])this._appendObjectFormatted($0,
$1);
...
$[83]);
if($0.className)$1.push($[1570],
this._escapeHTML($0.className),
$[83]);
$1.push($[83]);
},
_appendNode:function($0,
$1){if($0.nodeType==1){$1.push($[1301],
$[1563],
...
}else if($0.nodeType==3){$1.push($[1776],
this._escapeHTML($0.nodeValue),
$[1475]);
}},
_addEvent:function($0,
$1,
$2){if(document.all)$0.attachEvent($[53]+$1,
$2);
...
$1,
$2){if(document.all)$0.detachEvent($[53]+$1,
$2);
...
return $1.compatMode===$[80]?$1.documentElement.clientWidth:$1.body.clientWidth;
}}),
...
"default":function($0){var $1=($0||window).document;
return $1.compatMode===$[80]?$1.documentElement.clientHeight:$1.body.clientHeight;
}}),
...
genericToString:function(){return $[1209]+this.name+$[125];
},
...
}var $3=$[492]+qx.core.Object.toHashCode($1)+($2?$[191]+qx.core.Object.toHashCode($2):$[0]);
...
if(typeof $1!==$[36]){throw new Error("qx.core.Target: removeEventListener("+$0+"): '"+$1+"' is not a function!");
}var $4=$[492]+qx.core.Object.toHashCode($1)+($2?$[191]+qx.core.Object.toHashCode($2):$[0]);
...
$3.call($4,
$0);
}}}if($0.getBubbles()&&!$0.getPropagationStopped()&&typeof (this.getParent)==$[36]){var $6=this.getParent();
if($6&&!$6.getDisposed()&&$6.getEnabled()){$6._dispatchEvent($0);
}}}},
destruct:function(){this._disposeObjectDeep($[1285],
2);
}});
...
destruct:function(){this._disposeFields($[547],
$[1493],
$[1604],
$[1395]);
}});
...
defaultValue:false},
data:{_fast:true}},
destruct:function(){this._disposeFields($[1078]);
}});
...
destruct:function(){this._disposeFields($[1485],
$[1275]);
}});
...
destruct:function(){this._disposeFields($[1094]);
}});
...
while($3.length<6){$3=$[48]+$3;
}$2+=$3;
if(this.getUseLongFormat()){switch($0.level){case $1.LEVEL_DEBUG:$2+=$[659];
break;
case $1.LEVEL_INFO:$2+=$[1500];
break;
case $1.LEVEL_WARN:$2+=$[654];
break;
case $1.LEVEL_ERROR:$2+=$[1598];
break;
case $1.LEVEL_FATAL:$2+=$[1651];
break;
}}else{$2+=$[176];
}var $4=$[0];
for(var $5=0;$5<$0.indent;$5++){$4+=$[269];
}$2+=$4;
if(this.getUseLongFormat()){$2+=$0.logger.getName();
if($0.instanceId!=null){$2+=$[1552]+$0.instanceId+$[125];
}$2+=$[176];
...
}}catch(exc){$2+=$4+$[1016]+exc+$[433];
}$7.sort();
for(var $5=0;$5<$7.length;$5++){try{$2+=$4+$[269]+$7[$5]+$[1713]+$6[$7[$5]]+$[164];
}catch(exc){$2+=$4+$[269]+$7[$5]+$[1237]+exc+$[433];
}}$2+=$4+$[1662];
}}if($0.throwable!=null){var $9=$0.throwable;
if($9.name==null){$2+=$[176]+$9;
}else{$2+=$[176]+$9.name;
}
if($9.message!=null){$2+=$[323]+$9.message;
}
if($9.number!=null){$2+=$[958]+$9.number+$[69];
}var $a=qx.dev.StackTrace.getStackTraceFromError($9);
}
if($0.trace){var $a=$0.trace;
}
if($a&&$a.length>0){$2+=$[164];
for(var $5=0;$5<$a.length;$5++){$2+=$[861]+$a[$5]+$[164];
}}return $2;
}}});
...
properties:{maxMessages:{check:$[14],
init:500},
popUnder:{check:$[3],
init:false},
...
init:true,
apply:$[1215]},
windowWidth:{check:$[14],
init:600},
windowHeight:{check:$[14],
init:350},
windowLeft:{check:$[14],
nullable:true},
windowTop:{check:$[14],
...
}var $4=$[1254]+$[1400]+$0+$[878]+$1+$[1433]+$2+$[1418]+$3;
...
$[28])?$[1086]:$[301];
$0.open();
$0.write($[1235]+this._name+$[1329]+$[786]+this._id+$[707]+$[1775]+$[567]+$[1455]+$[546]+$[1307]+$[1596]+$[1192]+$[846]+$1+$[792]+$[623]+$[560]+this._filterText+$[716]+$[383]+$[739]+$[1742]+$[383]+$[1685]);
$0.close();
this._logElem=$0.getElementById($[347]);
this._markerBtn=$0.getElementById($[1636]);
this._filterInput=$0.getElementById($[133]);
this._logLinesDiv=$0.getElementById($[777]);
var $2=this;
this._markerBtn.onclick=function(){$2._showMessageInLog($[708]);
};
...
}else{this._showMessageInLog($[980]+this._errorsPreventingAutoCloseCount+$[834]);
}},
...
}else{var $1=this._logWindow.document.createElement($[116]);
if($0.level>=qx.log.Logger.LEVEL_ERROR){$1.style.backgroundColor=$[1540];
if(!this.getAutoCloseWithErrors()){this._errorsPreventingAutoCloseCount+=1;
}}else if($0.level==qx.log.Logger.LEVEL_DEBUG){$1.style.color=$[138];
}var $2;
...
if(this._removedMessageCount!=null){this._logElem.firstChild.innerHTML=$[157]+this._removedMessageCount+$[1262];
}this._logLinesDiv.scrollTop=this._logLinesDiv.scrollHeight;
}},
setFilterText:function($0){if($0==null){$0=$[0];
}this._filterText=$0;
$0=$0.toUpperCase();
this._filterTextWords=$0.split($[78]);
...
}$0.elem.style[$[144]]=($1?$[0]:$[10]);
},
_applyAutoCloseWithErrors:function($0,
$1){if(!$0&&$1){this._errorsPreventingAutoCloseCount=0;
this._showMessageInLog($[699]);
}else if($0&&!$1){this._showMessageInLog($[746]+this._errorsPreventingAutoCloseCount+$[1172]);
}}},
...
this);
this.__event=new qx.event.type.Event($[121]);
},
events:{"interval":$[15]},
...
_oninterval:function(){if(this.getEnabled()&&this.hasEventListeners($[121])){this.dispatchEvent(this.__event,
false);
}}},
destruct:function(){if(this.__intervalHandler){window.clearInterval(this.__intervalHandler);
}this._disposeFields($[1393],
$[1758],
$[783]);
}});
...
members:{appendLogEvent:function($0){if(typeof console!=$[419]){var $1=qx.log.Logger;
...
{extend:qx.log.appender.Abstract,
construct:function(){arguments.callee.base.call(this);
if(typeof console!=$[419]&&console.debug&&!console.emu){this._appender=new qx.log.appender.FireBug;
...
destruct:function(){this._disposeObjects($[1704]);
}});
...
measure:function($0,
$1,
$2){if(this._lastMeasureTime==null){$0=$[628]+$0;
...
settings:{"qx.logAppender":$[475],
"qx.minLogLevel":200},
defer:function($0){$0.ROOT_LOGGER=new $0("root",
null);
$0.ROOT_LOGGER.setMinLevel(qx.core.Setting.get($[955]));
$0.ROOT_LOGGER.addAppender(new (qx.Class.getByName(qx.core.Setting.get($[614]))));
},
destruct:function(){this._disposeFields($[1306],
$[1056]);
}});
...
"webkit":function($0){if($0.sourceURL&&$0.line){return [this.__fileNameToClassName($0.sourceURL)+$[35]+$0.line];
}},
...
getFunctionName:function($0){if($0.$$original){return $0.classname+$[710];
}
if($0.wrapper){return $0.wrapper.classname+$[490];
}
if($0.classname){return $0.classname+$[490];
}
if($0.mixin){for(var $1 in $0.mixin.$$members){if($0.mixin.$$members[$1]==$0){return $0.mixin.name+$[35]+$1;
}}for(var $1 in $0.mixin){if($0.mixin[$1]==$0){return $0.mixin.name+$[35]+$1;
}}}
if($0.self){var $2=$0.self.constructor;
if($2){for(var $1 in $2.prototype){if($2.prototype[$1]==$0){return $2.classname+$[35]+$1;
}}for(var $1 in $2){if($2[$1]==$0){return $2.classname+$[35]+$1;
}}}}var $3=$0.toString().match(/(function\s*\w*\(.*?\))/);
if($3&&$3.length>=1&&$3[1]){return $3[1];
}var $3=$0.toString().match(/(function\s*\(.*?\))/);
if($3&&$3.length>=1&&$3[1]){return $[956]+$3[1];
}return $[1621];
},
__fileNameToClassName:function($0){var $1=$[1283];
var $2=$0.indexOf($1);
...
function($1){var $2={"  ":$[610],
"\n":$[495]};
return $2[$1]||$1;
});
},
toText:function($0){return qx.html.String.unescape($0.replace(/\s+|<([^>])+>/gi,
function($1){if(/\s+/.test($1)){return $[78];
}else if(/^<BR|^<br/gi.test($1)){return $[164];
}else{return $[0];
}}));
}}});
...
}else{if($2.charAt(0)==$[854]){if($2.charAt(1).toUpperCase()==$[1037]){$4=$2.substring(2);
if($4.match(/^[0-9A-Fa-f]+$/gi)){$3=String.fromCharCode(parseInt($[1022]+$4));
...
check:function($0){if(typeof $0==$[36]){throw new Error("The application property takes an application instance as parameter "+"and no longer a class/constructor. You may have to fix your 'index.html'.");
...
{};
if(!this.getApplication()){var $2=qx.Class.getByName(qx.core.Setting.get($[608]));
...
svn:0,
folder:$[0],
toString:function(){return this.major+$[20]+this.minor+(this.revision==0?$[0]:$[20]+this.revision)+(this.state==$[0]?$[0]:$[224]+this.state)+(this.svn==0?$[0]:$[1637]+this.svn+$[69])+(this.folder==$[0]?$[0]:$[1780]+this.folder+$[125]);
},
__init:function(){var $0=qx.core.Setting.get($[631]).split($[78]);
var $1=$0.shift();
var $2=$0.join($[78]);
...
213,
217],
"list-view-header-cell-hover":$[59],
"date-chooser":$[59],
...
$2){{};
var $3=$1.toHashCode();
var $4=$[488]+$3+$[191]+qx.core.Object.toHashCode($0);
...
destruct:function(){this._disposeFields($[1546],
$[1508],
$[1478]);
}});
...
members:{_addStatic:function(){this.add($[259],
qx.core.Setting.isSet($[417])?qx.core.Setting.get($[417]):qx.core.Setting.get($[172])+$[815]);
},
_preprocess:function($0){var $1=this._dynamic;
if($1[$0]===false){return $0;
}else if($1[$0]===undefined){if($0.charAt(0)===$[57]||$0.charAt(0)===$[20]||$0.indexOf($[1075])===0||$0.indexOf($[855])===0||$0.indexOf($[1374])===0){$1[$0]=false;
return $0;
}var $2=$0.substring(0,
$0.indexOf($[57]));
...
$[28])){if(window.location.protocol===$[910]){if($3.match(/^\/\//)!=null){$4=window.location.protocol;
}else if($3.match(/^\.\//)!=null&&qx.core.Setting.get($[536])){$3=$[57]+$0.substring(0,
$2.length);
$4=document.URL.substring(0,
document.URL.lastIndexOf($[57]));
}else{$4=window.location.href.substring(0,
window.location.href.lastIndexOf($[57])+1);
...
$6.indexOf($[57]))===$0){$2[$6]=$1+$6.substring($0.length);
$5[$6]=true;
...
destruct:function(){this._disposeFields($[894]);
}});
...
qx.Theme.define($[939],
{title:$[369],
widgets:{uri:qx.core.Setting.get($[172])+$[983]}});




/* ID: qx.theme.classic.Appearance */
qx.Theme.define($[1694],
{title:$[307],
appearances:{"empty":{},
"widget":{},
"image":{},
"atom":{},
"popup":{},
"cursor-dnd-move":{style:function($0){return {source:$[1255]};
}},
"cursor-dnd-copy":{style:function($0){return {source:$[944]};
}},
"cursor-dnd-alias":{style:function($0){return {source:$[1304]};
}},
"cursor-dnd-nodrop":{style:function($0){return {source:$[1420]};
}},
"label":{style:function($0){return {textColor:$0.disabled?$[218]:$[5]};
}},
"client-document":{style:function($0){return {backgroundColor:$[68],
textColor:$[136],
font:$[66]};
}},
"client-document-blocker":{style:function($0){return {cursor:$[66],
backgroundImage:$[210]};
}},
"tool-tip":{include:$[438],
style:function($0){return {backgroundColor:$[504],
textColor:$[500],
border:$[504],
padding:[1,
3,
...
"iframe":{style:function($0){return {border:$[58]};
}},
"check-box":{style:function($0){return {padding:[2,
3]};
}},
"radio-button":{include:$[895]},
"button":{style:function($0){if($0.pressed||$0.checked||$0.abandoned){var $1=$[58];
}else{var $1=$[67];
}
...
4];
}return {backgroundColor:$0.abandoned?$[221]:$0.over?$[1592]:$[130],
border:$1,
padding:$2};
}},
"toolbar":{style:function($0){return {border:$[173],
backgroundColor:$[68]};
}},
"toolbar-part":{},
...
"toolbar-button":{style:function($0){if($0.pressed||$0.checked||$0.abandoned){var $1=$[177];
var $2=[3,
2,
1,
4];
}else if($0.over){var $1=$[173];
var $2=[2,
3];
}else{var $1=$[5];
var $2=[3,
...
border:$1,
padding:$2,
verticalChildrenAlign:$[21],
backgroundColor:$0.abandoned?$[221]:$[130],
backgroundImage:$0.checked&&!$0.over?$[441]:null};
}},
"button-view":{style:function($0){return {border:$[150]};
}},
"button-view-pane":{style:function($0){return {backgroundColor:$[283],
padding:10};
}},
"button-view-page":{},
...
$3=$[2];
$2=null;
}return {backgroundColor:$0.checked?$[283]:$[5],
iconPosition:$[11],
margin:$1,
width:$2,
height:$3,
...
"tab-view-bar":{},
"tab-view-pane":{style:function($0){return {backgroundColor:$[322],
...
"radio-view":{include:$[476]},
"radio-view-pane":{style:function($0){return {backgroundColor:$[813]};
}},
"radio-view-page":{},
"radio-view-bar":{style:function($0){return {backgroundColor:$[758],
padding:[1,
0],
border:$0.barTop?qx.ui.core.Border.fromConfig({bottom:[1,
$[4],
$[9]]}):qx.ui.core.Border.fromConfig({top:[1,
$[4],
$[9]]})};
}},
...
$2=[3,
7];
}return {backgroundColor:$0.checked?$[640]:$[5],
iconPosition:$[6],
margin:[0,
1],
width:$[2],
...
padding:1,
border:$0.maximized?$[5]:$[67]};
}},
"window-captionbar":{style:function($0){return {padding:[1,
2,
2],
verticalChildrenAlign:$[21],
backgroundColor:$0.active?$[1171]:$[1676],
textColor:$0.active?$[1668]:$[722]};
}},
"window-resize-frame":{style:function($0){return {border:$[150]};
}},
"window-captionbar-icon":{style:function($0){return {marginRight:2};
}},
"window-captionbar-title":{style:function($0){return {cursor:$[66],
font:$[271],
marginRight:2};
}},
"window-captionbar-button":{include:$[130],
...
"window-captionbar-minimize-button":{include:$[232],
style:function($0){return {icon:$[1010]};
}},
"window-captionbar-restore-button":{include:$[232],
style:function($0){return {icon:$[876]};
}},
"window-captionbar-maximize-button":{include:$[232],
style:function($0){return {icon:$[1178]};
}},
"window-captionbar-close-button":{include:$[232],
style:function($0){return {marginLeft:2,
icon:$[1096]};
}},
"window-statusbar":{style:function($0){return {border:$[177]};
}},
...
"resizer":{style:function($0){return {border:$[67]};
}},
"resizer-frame":{style:function($0){return {border:$[150]};
}},
"menu":{style:function($0){return {backgroundColor:$[1467],
border:$[67],
padding:1};
}},
"menu-layout":{},
...
textColor:$0.over?$[178]:$[5]};
}},
"menu-button-arrow":{style:function($0){return {source:$[1077]};
}},
"menu-check-box":{include:$[469],
style:function($0){return {icon:$0.checked?$[946]:$[210]};
}},
"menu-radio-button":{include:$[469],
style:function($0){return {icon:$0.checked?$[1040]:$[210]};
}},
...
"list":{style:function($0){return {border:$[177],
backgroundColor:$[162]};
}},
...
textColor:$0.selected?$[178]:$[5]};
}},
"text-field":{style:function($0){return {border:$[58],
padding:[1,
3],
textColor:$0.disabled?$[218]:$[5],
backgroundColor:$[186]};
}},
"text-area":{include:$[132]},
"combo-box":{style:function($0){return {border:$[58],
backgroundColor:$[186]};
}},
"combo-box-list":{include:$[162],
style:function($0){return {border:$[5],
overflow:$[101]};
}},
"combo-box-popup":{include:$[162],
style:function($0){return {maxHeight:150,
border:$[150]};
}},
"combo-box-text-field":{include:$[132],
style:function($0){return {border:$[5],
backgroundColor:$[201]};
}},
"combo-box-button":{include:$[130],
...
"combo-box-ex":{style:function($0){return {border:$[58],
backgroundColor:$[186]};
}},
"combo-box-ex-list":{include:$[162],
style:function($0){return {border:$[5],
edge:0};
}},
"combo-box-ex-text-field":{include:$[132],
style:function($0){return {border:$[5],
minWidth:30,
width:100,
backgroundColor:$[201]};
}},
"combo-box-ex-popup":{include:$[162],
style:function($0){return {border:$[1459]};
}},
"combo-box-ex-button":{include:$[1073]},
"treevirtual-focus-indicator":{include:$[1522]},
...
"tree-element-label":{include:$[128],
style:function($0){return {marginLeft:3,
height:15,
padding:2,
backgroundColor:$0.selected?$[47]:$[5],
textColor:$0.disabled?$[218]:($0.selected?$[178]:$[5])};
}},
"tree-folder":{include:$[542]},
"tree-folder-icon":{include:$[520]},
"tree-folder-label":{include:$[406]},
"tree":{include:$[296]},
"tree-icon":{include:$[414]},
"tree-label":{include:$[517]},
...
6],
spacing:4,
backgroundColor:$0.over?$[751]:$[5],
paddingBottom:$0.over?0:2,
border:$0.over?new qx.ui.core.Border.fromConfig({bottom:[2,
$[4],
$[70]]}):$[5]};
}},
"list-view-header-cell-arrow-up":{style:function($0){return {source:$[732]};
}},
"list-view-header-cell-arrow-down":{style:function($0){return {source:$[537]};
}},
"list-view-header-separator":{style:function($0){return {backgroundColor:$[540],
width:1,
marginTop:1,
marginBottom:1};
}},
"list-view-content-cell":{style:function($0){return {cursor:$[66],
backgroundColor:$0.selected?$[47]:$[5],
textColor:$0.selected?$[178]:$[5],
...
"list-view-content-cell-image":{include:$[348],
style:function($0){return {paddingLeft:6,
paddingRight:6};
}},
"list-view-content-cell-text":{include:$[348],
style:function($0){return {overflow:$[26],
paddingLeft:6,
paddingRight:6};
}},
"list-view-content-cell-html":{include:$[246]},
"list-view-content-cell-icon-html":{include:$[246]},
"list-view-content-cell-link":{include:$[246]},
...
"radio-button-group-box-legend":{include:$[882]},
"spinner":{style:function($0){return {border:$[58],
backgroundColor:$[186]};
}},
"spinner-text-field":{include:$[132],
style:function($0){return {backgroundColor:$[201]};
}},
"spinner-button":{style:function($0){return {width:16,
backgroundColor:$[68],
paddingLeft:3,
border:$0.pressed||$0.checked||$0.abandoned?$[58]:$[67]};
}},
"spinner-button-up":{include:$[415],
style:function($0){return {source:$[1687]};
}},
"spinner-button-down":{include:$[415],
...
"datechooser-toolbar-button":{style:function($0){var $1={backgroundColor:$0.abandoned?$[221]:$[130],
backgroundImage:($0.checked&&!$0.over)?$[441]:null,
spacing:4,
width:$[2],
verticalChildrenAlign:$[21]};
if($0.pressed||$0.checked||$0.abandoned){$1.border=$[177];
}else if($0.over){$1.border=$[173];
}else{$1.border=$[5];
}
...
"datechooser-monthyear":{style:function($0){return {font:$[1650],
textAlign:$[41],
verticalAlign:$[21]};
}},
...
font:$[989],
textAlign:$[41],
textColor:$0.weekend?$[240]:$[248],
backgroundColor:$0.weekend?$[248]:$[240]};
}},
"datechooser-day":{style:function($0){return {textAlign:$[41],
verticalAlign:$[21],
border:$0.today?$[174]:$[5],
textColor:$0.selected?$[178]:$0.otherMonth?$[218]:$[5],
backgroundColor:$0.selected?$[47]:$[5],
padding:[2,
4]};
}},
...
"table-editor-textfield":{include:$[132],
style:function($0){return {border:$[5],
padding:[0,
2]};
}},
"table-pane":{style:function($0){return {backgroundColor:$[1160]};
}},
...
"table-menubar-button":{style:function($0){if($0.pressed||$0.checked||$0.abandoned){var $1=$[177];
var $2=[3,
2,
1,
4];
...
border:$1,
backgroundColor:$2,
icon:$0.sorted?($0.sortedAscending?$[1303]:$[1613]):null,
horizontalChildrenAlign:$[6]};
}},
"splitpane":{style:function($0){return {overflow:$[26],
splitterSize:8,
backgroundColor:$[68]};
}},
"splitpane-splitter":{style:function($0){return {cursor:$0.horizontal?$[239]:$[287]};
}},
...
"scrollbar-blocker":{style:function($0){return {backgroundColor:$[174],
opacity:0.2};
}}}});
...
qx.Theme.define($[1454],
{title:$[1707],
icons:{uri:qx.core.Setting.get($[172])+$[1413]}});
...
construct:function(){arguments.callee.base.call(this);
this._layoutChanges={};
if(qx.core.Setting.get($[1712])){this._generateHtmlId();
}},
...
}if(qx.Class.isDefined($[677])){for($0 in $5){$1=$5[$0];
...
var $6=$4==null?$5.indexOf($0)+$2:$4===$[426]?0:$5.length-1;
var $7=$5[$6];
...
__initApplyMethods:function($0){var $1=$[1702];
var $2=$[841];
var $3=$[1630];
var $4=$[965];
var $5=$[488];
...
$a+$7[$b]+$4);
$0[$9+$7[$b]]=new Function($a+$7[$b]+$[298]);
}var $c=$1+$[494];
var $d=$2+$[494];
var $e=$3+$[249];
if(qx.core.Variant.isSet($[1],
...
$e+$7[$b]+$4);
$0[$d+$7[$b]]=new Function($e+$7[$b]+$[298]);
}}else{for(var $b=0;$b<4;$b++){$0[$c+$7[$b]]=new Function($5,
$[1473]+$7[$b]+$[1357]);
$0[$d+$7[$b]]=new Function($[603]+$7[$b]+$[892]);
}}for(var $b=0;$b<$6.length;$b++){$0[$1+$7[$b]]=new Function($5,
$3+$6[$b]+$4);
$0[$2+$7[$b]]=new Function($3+$6[$b]+$[298]);
}},
TYPE_NULL:0,
TYPE_PIXEL:1,
TYPE_PERCENT:2,
...
TYPE_FLEX:4,
layoutPropertyTypes:{},
__initLayoutProperties:function($0){var $1=[$[32],
$[33],
$[71],
$[72],
$[75],
...
$5,
$6;$2<$3;$2++){$4=$1[$2];
$5=$[1019]+qx.lang.String.toFirstUp($4);
$6=$5+$[702];
...
initScrollbarWidth:function(){var $0=document.createElement($[116]);
var $1=$0.style;
$1.height=$1.width=$[649];
$1.overflow=$[39];
...
nullable:true,
init:null},
backgroundImage:{check:$[16],
nullable:true,
apply:$[647],
themeable:true},
backgroundRepeat:{check:$[16],
nullable:true,
apply:$[698],
themeable:true},
overflow:{check:[$[26],
...
$[789]],
themeable:true},
clipLocation:{group:[$[524],
$[466]]},
clipDimension:{group:[$[533],
$[379]]},
clip:{group:[$[524],
$[466],
$[533],
...
$1){this._unitDetectionPixelPercent($[7],
$0);
this.addToQueue($[7]);
},
...
$1){this._unitDetectionPixelPercentAuto($[71],
$0);
this.addToQueue($[71]);
},
_applyMaxWidth:function($0,
$1){this._unitDetectionPixelPercentAuto($[72],
$0);
this.addToQueue($[72]);
},
...
$1){this._unitDetectionPixelPercentAuto($[75],
$0);
this.addToQueue($[75]);
},
_applyMaxHeight:function($0,
$1){this._unitDetectionPixelPercentAuto($[73],
$0);
this.addToQueue($[73]);
},
...
$[144])!=$[10]&&qx.html.Style.getStyleProperty($0,
$[1133])!=$[26]&&$0.offsetWidth>0&&$0.offsetHeight>0);
},
...
if(typeof this._insertIndex==$[56]){qx.lang.Array.insertAt($0.getChildren(),
this,
this._insertIndex);
...
return this._handleDisplayable($[244]);
},
_applyDisplay:function($0,
$1){return this._handleDisplayable($[144]);
},
_handleDisplayable:function($0){var $1=this._computeDisplayable();
if(this._isDisplayable==$1&&!($1&&$0==$[244])){return true;
...
$2.addToJobQueue($[1332]);
}this.addToLayoutChanges($[1018]);
...
_beforeAppear:function(){this.createDispatchEvent($[715]);
},
_afterAppear:function(){this._isSeeable=true;
this.createDispatchEvent($[179]);
},
_beforeDisappear:function(){this.removeState($[86]);
if(qx.Class.isDefined($[289])){this.removeState($[49]);
this.removeState($[62]);
}this.createDispatchEvent($[992]);
},
_afterDisappear:function(){this._isSeeable=false;
this.createDispatchEvent($[264]);
},
_isSeeable:false,
...
_beforeInsertDom:function(){this.createDispatchEvent($[1214]);
},
_afterInsertDom:function(){this.createDispatchEvent($[1518]);
},
_beforeRemoveDom:function(){this.createDispatchEvent($[1286]);
},
_afterRemoveDom:function(){this.createDispatchEvent($[1053]);
},
_applyVisibility:function($0,
$1){if($0){if(this._isDisplayable){this._beforeAppear();
}this.removeStyleProperty($[144]);
if(this._isDisplayable){this._afterAppear();
}}else{if(this._isDisplayable){this._beforeDisappear();
}this.setStyleProperty($[144],
$[10]);
...
_createElementImpl:function(){this.setElement(this.getTopLevelWidget().getDocumentElement().createElement($[116]));
},
...
$e=$d.length;
if($1.paddingLeft){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[1365]);
}}
if($1.paddingRight){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[890]);
}}
if($1.paddingTop){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[1680]);
}}
if($1.paddingBottom){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[733]);
}}}
...
switch(this.getOverflow()){case $[39]:case $[101]:$0+=qx.ui.core.Widget.SCROLLBAR_SIZE;
break;
case $[2]:break;
}return $0;
},
...
switch(this.getOverflow()){case $[39]:case $[123]:$0+=qx.ui.core.Widget.SCROLLBAR_SIZE;
break;
case $[2]:break;
}return $0;
},
...
switch(typeof $0){case $[56]:return isNaN($0)?qx.ui.core.Widget.TYPE_NULL:qx.ui.core.Widget.TYPE_PIXEL;
case $[8]:return $0.indexOf($[81])!=-1?qx.ui.core.Widget.TYPE_PERCENT:$0.indexOf($[111])!=-1?qx.ui.core.Widget.TYPE_FLEX:qx.ui.core.Widget.TYPE_NULL;
...
switch(typeof $0){case $[56]:return isNaN($0)?qx.ui.core.Widget.TYPE_NULL:qx.ui.core.Widget.TYPE_PIXEL;
case $[8]:return $0.indexOf($[81])!=-1?qx.ui.core.Widget.TYPE_PERCENT:qx.ui.core.Widget.TYPE_NULL;
}return qx.ui.core.Widget.TYPE_NULL;
},
...
if($b!=this[$7]){switch($0){case $[71]:case $[72]:case $[32]:case $[6]:case $[7]:this._invalidateHasPercentX();
break;
case $[73]:case $[75]:case $[33]:case $[11]:case $[13]:this._invalidateHasPercentY();
break;
}}if($c!=this[$8]){switch($0){case $[71]:case $[72]:case $[32]:this._invalidateHasAutoX();
break;
case $[75]:case $[73]:case $[33]:this._invalidateHasAutoY();
break;
}}if($d!=this[$9]){switch($0){case $[32]:this._invalidateHasFlexX();
break;
case $[33]:this._invalidateHasFlexY();
break;
}}},
...
if($a!=this[$7]){switch($0){case $[71]:case $[72]:case $[32]:case $[6]:case $[7]:this._invalidateHasPercentX();
break;
case $[75]:case $[73]:case $[33]:case $[11]:case $[13]:this._invalidateHasPercentY();
break;
}}if($b!=this[$8]){switch($0){case $[71]:case $[72]:case $[32]:this._invalidateHasAutoX();
break;
case $[75]:case $[73]:case $[33]:this._invalidateHasAutoY();
break;
}}},
...
if($9!=this[$7]){switch($0){case $[71]:case $[72]:case $[32]:case $[6]:case $[7]:this._invalidateHasPercentX();
break;
case $[75]:case $[73]:case $[33]:case $[11]:case $[13]:this._invalidateHasPercentY();
break;
}}},
...
{"mshtml":function($0){},
"default":function($0){if($0.focused){if(!qx.event.handler.FocusHandler.mouseFocus&&!this.getHideFocus()){this.setStyleProperty($[367],
$[1085]);
}}else{this.setStyleProperty($[367],
$[10]);
}}}),
...
_generateHtmlId:function(){var $0=this.classname+$[20]+qx.ui.core.Widget._idCounter++;
this.debug("setting autogenerated HTML id to "+$0);
this.setHtmlProperty($[258],
$0);
},
...
_applyEnabled:function($0,
$1){if($0===false){this.addState($[430]);
this.removeState($[86]);
if(qx.Class.isDefined($[289])){this.removeState($[62]);
this.removeState($[49]);
}}else{this.removeState($[430]);
}},
...
$1){if($0==null){this.removeStyleProperty($[311]);
}else{this.setStyleProperty($[311],
$0);
}},
_applyTabIndex:qx.core.Variant.select($[1],
{"mshtml":function($0,
$1){this.setHtmlProperty($[357],
$0<0?-1:1);
},
"gecko":function($0,
$1){this.setStyleProperty($[1441],
($0<0?$[512]:$[170]));
},
"default":function($0,
$1){this.setStyleProperty($[730],
($0<0?$[512]:$[170]));
this.setHtmlProperty($[357],
$0<0?-1:1);
}}),
...
$1){},
"gecko":function($0,
$1){if($0){this.removeStyleProperty($[375]);
}else{this.setStyleProperty($[375],
$[10]);
}},
"webkit":function($0,
$1){if($0){this.removeStyleProperty($[523]);
this.removeStyleProperty($[389]);
}else{this.setStyleProperty($[523],
$[10]);
this.setStyleProperty($[389],
$[10]);
}},
"default":function($0,
$1){if($0){return this.removeStyleProperty($[528]);
}else{this.setStyleProperty($[528],
$[10]);
}}}),
_applyOpacity:qx.core.Variant.select($[1],
{"mshtml":function($0,
$1){if($0==null||$0>=1||$0<0){this.removeStyleProperty($[133]);
}else{this.setStyleProperty($[133],
($[881]+Math.round($0*100)+$[69]));
}},
"default":function($0,
$1){if($0==null||$0>1){if(qx.core.Variant.isSet($[1],
$[25])){this.removeStyleProperty($[434]);
}this.removeStyleProperty($[361]);
}else{$0=qx.lang.Number.limit($0,
0,
1);
if(qx.core.Variant.isSet($[1],
$[25])){this.setStyleProperty($[434],
$0);
}this.setStyleProperty($[361],
$0);
}}}),
...
$1){if($0){this.setStyleProperty($[321],
this.__cursorMap[$0]||$0);
}else{this.removeStyleProperty($[321]);
}},
...
_styleBackgroundImage:function($0){$0?this.setStyleProperty($[452],
$[1737]+$0+$[69]):this.removeStyleProperty($[452]);
},
_applyBackgroundRepeat:function($0,
$1){$0?this.setStyleProperty($[378],
$0):this.removeStyleProperty($[378]);
},
...
var $4,
$5;
if($0==null){$4=($2==null?$[2]:$2+$[37]);
$0=$[2];
}else{$4=($2==null?$[2]:$0+$2+$[37]);
$0=$0+$[37];
}
if($1==null){$5=($3==null?$[2]:$3+$[37]);
$1=$[2];
}else{$5=($3==null?$[2]:$1+$3+$[37]);
$1=$1+$[37];
}return this.setStyleProperty($[978],
($[1714]+$1+$[88]+$4+$[88]+$5+$[88]+$0+$[69]));
},
_applyOverflow:qx.core.Variant.select($[1],
{"default":function($0,
$1){var $2=$0;
var $3=$[42];
switch($0){case $[123]:$3=$[96];
$2=$[39];
break;
case $[101]:$3=$[98];
$2=$[39];
...
switch($0){case $[123]:this.setStyleProperty($[98],
$[26]);
break;
case $[101]:this.setStyleProperty($[96],
$[26]);
break;
...
$1){var $2=$0;
var $3=$[42];
switch($2){case $[123]:case $[101]:$2=$[39];
break;
}this._renderOverflow($3,
$2,
$0,
...
_styleBackgroundColor:function($0){$0?this.setStyleProperty($[497],
$0):this.removeStyleProperty($[497]);
},
...
}else{if($1===$[6]||$1===$[7]){this.__reflowBorderX($0);
...
var $1=this._borderElement=document.createElement($[116]);
var $2=$0.style;
var $3=this._innerStyle=$1.style;
if(qx.core.Variant.isSet($[1],
$[28])){}else{$3.width=$3.height=$[38];
}$3.position=$[61];
for(var $4 in this._styleProperties){switch($4){case $[311]:case $[133]:case $[144]:break;
default:$3[$4]=this._styleProperties[$4];
$2[$4]=$[0];
}}
for(var $4 in this._htmlProperties){switch($4){case $[1348]:$1.unselectable=this._htmlProperties[$4];
}}while($0.firstChild){$1.appendChild($0.firstChild);
}$0.appendChild($1);
}}),
_applyPaddingTop:function($0,
$1){this.addToQueue($[192]);
this._invalidateFrameHeight();
},
...
/* ID: qx.html.Style */
qx.Class.define($[1749],
{statics:{getStylePropertySure:qx.lang.Object.select((document.defaultView&&document.defaultView.getComputedStyle)?$[457]:$[390],
...
getStyleProperty:qx.lang.Object.select((document.defaultView&&document.defaultView.getComputedStyle)?$[457]:$[390],
{"hasComputed":function($0,
...
qx.Class.define($[1055],
{statics:{includeFile:function($0){var $1=document.createElement($[1379]);
$1.type=$[453];
$1.rel=$[929];
$1.href=$0;
var $2=document.getElementsByTagName($[516])[0];
$2.appendChild($1);
},
createElement:qx.lang.Object.select(document.createStyleSheet?$[129]:$[50],
{"ie4+":function($0){var $1=document.createStyleSheet();
if($0){$1.cssText=$0;
}return $1;
},
"other":function($0){var $1=document.createElement($[43]);
$1.type=$[453];
$1.appendChild(document.createTextNode($0||$[1167]));
document.getElementsByTagName($[516])[0].appendChild($1);
if($1.sheet){return $1.sheet;
}else{var $2=document.styleSheets;
for(var $3=$2.length-1;$3>=0;$3--){if($2[$3].ownerNode==$1){return $2[$3];
}}}throw $[1527];
}}),
addRule:qx.lang.Object.select(document.createStyleSheet?$[129]:$[50],
{"ie4+":function($0,
$1,
$2){$0.addRule($1,
$2);
},
"other":qx.lang.Object.select(qx.core.Client.getInstance().isSafari2()?$[234]:$[50],
{"safari2+":function($0,
$1,
$2){if(!$0._qxRules){$0._qxRules={};
}
if(!$0._qxRules[$1]){var $3=document.createTextNode($1+$[464]+$2+$[270]);
$0.ownerNode.appendChild($3);
$0._qxRules[$1]=$3;
}},
"other":function($0,
$1,
$2){$0.insertRule($1+$[464]+$2+$[270],
$0.cssRules.length);
}})}),
removeRule:qx.lang.Object.select(document.createStyleSheet?$[129]:$[50],
{"ie4+":function($0,
$1){var $2=$0.rules;
var $3=$2.length;
...
removeAllRules:qx.lang.Object.select(document.createStyleSheet?$[129]:$[50],
...
addImport:qx.lang.Object.select(document.createStyleSheet?$[129]:$[50],
{"ie4+":function($0,
$1){$0.addImport($1);
},
"other":qx.lang.Object.select(qx.core.Client.getInstance().isSafari2()?$[234]:$[50],
{"safari2+":function($0,
$1){$0.ownerNode.appendChild(document.createTextNode($[525]+$1+$[410]));
},
"other":function($0,
$1){$0.insertRule($[525]+$1+$[410],
$0.cssRules.length);
}})}),
removeImport:qx.lang.Object.select(document.createStyleSheet?$[129]:$[50],
{"ie4+":function($0,
$1){var $2=$0.imports;
var $3=$2.length;
...
removeAllImports:qx.lang.Object.select(document.createStyleSheet?$[129]:$[50],
...
properties:{focusHandler:{check:$[521],
apply:$[1137],
nullable:true},
activeChild:{check:$[151],
apply:$[1567],
event:$[682],
nullable:true},
focusedChild:{check:$[151],
apply:$[1300],
event:$[1319],
nullable:true},
...
$1){if($0){this.addEventListener($[52],
this._onfocuskeyevent);
if(this.getTabIndex()<1){this.setTabIndex(1);
}this.setHideFocus(true);
this.setActiveChild(this);
}else{this.removeEventListener($[24],
this._onfocuskeyevent);
this.removeEventListener($[52],
this._onfocuskeyevent);
this.setTabIndex(-1);
...
$1){var $2=$0!=null;
var $3=$1!=null;
if(qx.Class.isDefined($[159])&&$2){var $4=qx.ui.popup.PopupManager.getInstance();
if($4){$4.update($0);
}}
if($3){if($1.hasEventListeners($[262])){var $5=new qx.event.type.FocusEvent($[262],
$1);
if($2){$5.setRelatedTarget($0);
}$1.dispatchEvent($5);
$5.dispose();
}}
if($2){if($0.hasEventListeners($[241])){var $5=new qx.event.type.FocusEvent($[241],
$0);
...
var $5=new qx.event.type.FocusEvent($[233],
$1);
if($2){$5.setRelatedTarget($0);
}$1.dispatchEvent($5);
if(qx.Class.isDefined($[140])){var $4=qx.ui.popup.ToolTipManager.getInstance();
if($4){$4.handleBlur($5);
}}$5.dispose();
}
...
var $5=new qx.event.type.FocusEvent($[222],
$0);
if($3){$5.setRelatedTarget($1);
}$0.dispatchEvent($5);
if(qx.Class.isDefined($[140])){var $4=qx.ui.popup.ToolTipManager.getInstance();
...
$[84])){$1._layoutChildOrig=$1._layoutChild;
...
destruct:function(){this._disposeObjectDeep($[1321],
1);
this._disposeObjects($[994],
$[544]);
this._disposeFields($[312],
$[312],
$[1060],
$[1350],
$[576]);
...
$0);
this.setTarget($1);
switch($0){case $[241]:case $[262]:this.setBubbles(true);
...
getRelatedOriginalTargetObjectFromEvent:function($0){return qx.event.handler.EventHandler.getOriginalTargetObject($0.relatedTarget||($0.type==$[89]?$0.fromElement:$0.toElement));
},
...
if(!$1){if($0.type==$[89]){$1=$0.fromElement;
}else{$1=$0.toElement;
...
$3,
$4);
if($1==$[24]){this._checkKeyEventMatch($8);
}
if($7!=null&&$7.getEnabled()){switch($4){case $[412]:case $[284]:if(qx.Class.isDefined($[142])){qx.ui.menu.Manager.getInstance().update($7,
$1);
}break;
}if(!this.getAllowClientSelectAll()){if($0.ctrlKey&&$4==$[171]){switch($5.tagName.toLowerCase()){case $[127]:case $[1146]:case $[180]:break;
default:qx.event.handler.EventHandler.stopDomEvent($0);
}}}$7.dispatchEvent($8);
if(qx.Class.isDefined($[293])){qx.event.handler.DragAndDropHandler.getInstance().handleKeyEvent($8);
}}$8.dispose();
},
...
var $2=$0.type;
if($2==$[76]){if(this._mouseIsDown&&$0.button==0){this._onmouseevent_post($0,
$[19],
$1);
this._mouseIsDown=false;
}}else{if($2==$[22]){this._mouseIsDown=true;
...
$[22],
$1);
}else if($2==$[153]&&this._lastMouseEventType==$[19]&&((new Date).valueOf()-this._lastMouseEventDate)<250){this._onmouseevent_post($0,
$[92],
$1);
}
switch($2){case $[22]:case $[19]:case $[92]:case $[153]:case $[200]:this._lastMouseEventType=$2;
this._lastMouseEventDate=(new Date).valueOf();
this._lastMouseDown=$2==$[22];
...
var $2=$0.type;
switch($2){case $[416]:$2=$[267];
break;
case $[92]:case $[153]:if($0.which!==1){return;
}}this._onmouseevent_post($0,
$2,
$1);
}}),
...
$1,
$2){var $3=false;
switch($1){case $[22]:this._lastMouseDownDomTarget=$0;
...
$1,
$5);
}if($1==$[200]&&!this.getAllowClientContextMenu()){qx.event.handler.EventHandler.stopDomEvent($0);
}if($a&&$1==$[22]){qx.event.handler.FocusHandler.mouseFocus=true;
...
$b.setActiveChild($6);
}}switch($1){case $[89]:case $[155]:$8=qx.event.handler.EventHandler.getRelatedTargetObjectFromEvent($0);
if($8==$6){return;
...
$3,
$0);
}else{if($1==$[89]){if(qx.Class.isDefined($[140])){qx.ui.popup.ToolTipManager.getInstance().handleMouseOver($3);
}}}$3.dispose();
$3=null;
qx.ui.core.Widget.flushGlobalQueues();
...
$4,
$5,
$6){switch($0){case $[22]:if(qx.Class.isDefined($[159])){qx.ui.popup.PopupManager.getInstance().update($1);
}
if(qx.Class.isDefined($[142])){qx.ui.menu.Manager.getInstance().update($1,
$0);
}
if(qx.Class.isDefined($[252])){qx.ui.embed.IframeManager.getInstance().handleMouseDown($5);
}break;
case $[19]:if(qx.Class.isDefined($[142])){qx.ui.menu.Manager.getInstance().update($1,
$0);
}
if(qx.Class.isDefined($[252])){qx.ui.embed.IframeManager.getInstance().handleMouseUp($5);
}break;
case $[89]:if(qx.Class.isDefined($[140])){qx.ui.popup.ToolTipManager.getInstance().handleMouseOver($5);
}break;
case $[155]:if(qx.Class.isDefined($[140])){qx.ui.popup.ToolTipManager.getInstance().handleMouseOut($5);
}break;
}this._ignoreWindowBlur=$0===$[22];
if(qx.Class.isDefined($[293])&&$1){qx.event.handler.DragAndDropHandler.getInstance().handleMouseEvent($5);
}},
...
if(qx.Class.isDefined($[159])){qx.ui.popup.PopupManager.getInstance().update();
}if(qx.Class.isDefined($[142])){qx.ui.menu.Manager.getInstance().update();
}if(qx.Class.isDefined($[293])){qx.event.handler.DragAndDropHandler.getInstance().globalCancelDrag();
}qx.ui.core.ClientDocument.getInstance().createDispatchEvent($[1148]);
},
_onwindowfocus:function($0){if(this._focused){return;
}this._focused=true;
qx.ui.core.ClientDocument.getInstance().createDispatchEvent($[1474]);
},
_onwindowresize:function($0){qx.ui.core.ClientDocument.getInstance().createDispatchEvent($[371]);
}},
destruct:function(){this.detachEvents();
this._disposeObjectDeep($[1772],
1);
this._disposeFields($[964],
$[1274],
$[1468],
$[977],
$[1719],
$[1667]);
this._disposeFields($[1453],
$[1199],
$[1044],
$[1583],
$[771]);
...
var $2=0;
var $3=$0.type;
if(!(this._lastUpDownType[$1]==$[24]&&$3==$[24])){this._idealKeyHandler($1,
$2,
$3,
$0);
}if($3==$[24]){if(this._isNonPrintableKeyCode($1)||$1==8||$1==9){this._idealKeyHandler($1,
$2,
$[52],
$0);
...
if(!(this._lastUpDownType[$4]==$[52]&&$3==$[24])){this._idealKeyHandler($1,
$2,
$3,
$0);
...
if($2==$[126]||$2==$[24]){$3=this._charCode2KeyCode[$0.charCode]||$0.keyCode;
...
if(!(this._lastUpDownType[$3]==$[24]&&$2==$[24])){this._idealKeyHandler($3,
$1,
$2,
$0);
}if($2==$[24]){if(this._isNonPrintableKeyCode($3)||$3==8||$3==9){this._idealKeyHandler($3,
$1,
$[52],
$0);
...
if($3==$[126]||$3==$[24]){$1=this._charCode2KeyCode[$0.charCode]||$0.keyCode;
...
_specialCharCodeMap:{8:$[1377],
9:$[284],
13:$[107],
27:$[412],
32:$[145]},
_keyCodeToIdentifierMap:{16:$[1744],
17:$[734],
18:$[1376],
20:$[1039],
224:$[1147],
...
91:$[1179],
93:$[1101]},
_numpadToCharCode:{96:$[48].charCodeAt(0),
97:$[1352].charCodeAt(0),
98:$[1084].charCodeAt(0),
99:$[1164].charCodeAt(0),
100:$[917].charCodeAt(0),
101:$[995].charCodeAt(0),
102:$[740].charCodeAt(0),
103:$[819].charCodeAt(0),
104:$[736].charCodeAt(0),
105:$[257].charCodeAt(0),
106:$[111].charCodeAt(0),
107:$[309].charCodeAt(0),
109:$[224].charCodeAt(0),
110:$[88].charCodeAt(0),
111:$[57].charCodeAt(0)},
_charCodeA:$[171].charCodeAt(0),
_charCodeZ:$[511].charCodeAt(0),
_charCode0:$[48].charCodeAt(0),
...
if($0>=$[48]&&$0<=$[257]){return true;
}
if($0>=$[171]&&$0<=$[511]){return true;
}
switch($0){case $[309]:case $[224]:case $[111]:case $[57]:return true;
...
if(qx.core.Variant.isSet($[1],
$[28])){$1._charCode2KeyCode={13:13,
27:27};
}else if(qx.core.Variant.isSet($[1],
$[25])){$1._keyCodeFix={12:$1._identifierToKeyCode($[195])};
}else if(qx.core.Variant.isSet($[1],
$[95])){$1._charCode2KeyCode={63289:$1._identifierToKeyCode($[195]),
63276:$1._identifierToKeyCode($[290]),
63277:$1._identifierToKeyCode($[297]),
63275:$1._identifierToKeyCode($[305]),
63273:$1._identifierToKeyCode($[253]),
63234:$1._identifierToKeyCode($[104]),
63232:$1._identifierToKeyCode($[193]),
63235:$1._identifierToKeyCode($[106]),
63233:$1._identifierToKeyCode($[227]),
63272:$1._identifierToKeyCode($[365]),
63302:$1._identifierToKeyCode($[326]),
63236:$1._identifierToKeyCode($[317]),
63237:$1._identifierToKeyCode($[332]),
63238:$1._identifierToKeyCode($[350]),
63239:$1._identifierToKeyCode($[370]),
63240:$1._identifierToKeyCode($[391]),
63241:$1._identifierToKeyCode($[413]),
63242:$1._identifierToKeyCode($[431]),
63243:$1._identifierToKeyCode($[447]),
63244:$1._identifierToKeyCode($[456]),
63245:$1._identifierToKeyCode($[377]),
63246:$1._identifierToKeyCode($[360]),
63247:$1._identifierToKeyCode($[345]),
63248:$1._identifierToKeyCode($[510]),
3:$1._identifierToKeyCode($[107]),
12:$1._identifierToKeyCode($[195]),
13:$1._identifierToKeyCode($[107])};
}else if(qx.core.Variant.isSet($[1],
$[84])){$1._lastKeyCode=null;
}},
destruct:function(){this._detachEvents();
this._disposeFields($[901],
$[1191]);
}});
...
destruct:function(){this._disposeFields($[966],
$[1464]);
}});
...
{"mshtml":function(){if(this.getType()==$[92]){return true;
...
2:$[7],
1:$[21]}}),
_computeButton:function(){switch(this.getDomEvent().type){case $[92]:case $[153]:return $[6];
case $[200]:return $[7];
default:return this.__buttons[this.getDomEvent().button]||$[10];
}},
...
destruct:function(){this._disposeObjectDeep($[509]);
}});
...
destruct:function(){this._disposeFields($[1181]);
}});
...
limit:function($0,
$1,
$2){if(typeof $2===$[56]&&$0>$2){return $2;
}else if(typeof $1===$[56]&&$0<$1){return $1;
}else{return $0;
}}}});
...
if(qx.Class.isDefined($[1494])&&$0 instanceof qx.ui.window.Window){this._modalWidgets.push($0);
var $1=$0.getZIndex();
this._getBlocker().setZIndex($1);
$0.setZIndex($1+1);
}else if(qx.Class.isDefined($[534])&&$0 instanceof qx.client.NativeWindow){this._modalNativeWindow=$0;
this._getBlocker().setZIndex(1e7);
}},
release:function($0){if($0){if(qx.Class.isDefined($[534])&&$0 instanceof qx.client.NativeWindow){this._modalNativeWindow=null;
...
_onwindowresize:function($0){if(qx.Class.isDefined($[159])){qx.ui.popup.PopupManager.getInstance().update();
}this._recomputeInnerWidth();
this._recomputeInnerHeight();
qx.ui.core.Widget.flushGlobalQueues();
},
...
defer:function(){if(qx.core.Setting.get($[653])){var $0=qx.core.Client.getInstance().getEngineBoxSizingAttributes();
var $1=$0.join($[373])+$[373];
var $2=$0.join($[352])+$[352];
qx.html.StyleSheet.createElement($[763]+$[1354]+$[1549]+$1+$[1440]+$[1739]+$2+$[270]);
}
if(qx.core.Setting.get($[1682])){qx.html.StyleSheet.createElement($[1746]);
}},
destruct:function(){this._disposeObjects($[1414]);
this._disposeFields($[1130],
$[1145],
$[1572],
$[1456],
$[1612]);
...
}if(this._initialLayoutDone){this.addToJobQueue($[63]);
}},
...
properties:{appearanceTheme:{check:$[113],
nullable:true,
apply:$[1617],
event:$[1779]}},
...
destruct:function(){this._disposeFields($[720],
$[1387]);
}});
...
getMetaThemes:function(){return this.__queryThemes($[354]);
},
getColorThemes:function(){return this.__queryThemes($[402]);
},
getBorderThemes:function(){return this.__queryThemes($[526]);
},
getFontThemes:function(){return this.__queryThemes($[477]);
},
getWidgetThemes:function(){return this.__queryThemes($[303]);
},
getIconThemes:function(){return this.__queryThemes($[496]);
},
getAppearanceThemes:function(){return this.__queryThemes($[320]);
}},
settings:{"qx.theme":$[437],
"qx.colorTheme":null,
"qx.borderTheme":null,
"qx.fontTheme":null,
"qx.widgetTheme":null,
...
{type:$[23],
extend:qx.util.manager.Value,
properties:{colorTheme:{check:$[113],
nullable:true,
apply:$[1555],
event:$[833]}},
...
rgbToRgbString:function($0){return $[1097]+$0[0]+$[88]+$0[1]+$[88]+$0[2]+$[69];
},
...
qx.Class.define($[1009],
{type:$[23],
extend:qx.util.manager.Value,
properties:{borderTheme:{check:$[113],
nullable:true,
apply:$[886],
event:$[595]}},
...
switch($3){case $[139]:case $[182]:case $[58]:case $[67]:case $[4]:case $[160]:case $[168]:case $[163]:case $[10]:$1.setStyle($3);
break;
...
_applyStyleRight:function(){this.__informManager($[7]);
},
_applyStyleBottom:function(){this.__informManager($[13]);
},
...
{"gecko":function($0){var $1=$0._style;
$1.borderTopWidth=this.__widthTop||$[29];
$1.borderTopColor=this.__colorTop||$[0];
if(this.__complexTop){$1.borderTopStyle=$[4];
$1.MozBorderTopColors=this.__colorTop+$[78]+this.__colorInnerTop;
}else{$1.borderTopStyle=this.getStyleTop()||$[10];
...
$2=$0._innerStyle;
}$1.borderBottomWidth=$2.borderBottomWidth=$[152];
...
}else{$1.borderBottomWidth=this.__widthBottom||$[29];
$1.borderBottomStyle=this.getStyleBottom()||$[10];
$1.borderBottomColor=this.__colorBottom||$[0];
if($2){$2.borderBottomWidth=$2.borderBottomStyle=$2.borderBottomColor=$[0];
}}}}),
renderLeft:qx.core.Variant.select($[1],
{"gecko":function($0){var $1=$0._style;
$1.borderLeftWidth=this.__widthLeft||$[29];
$1.borderLeftColor=this.__colorLeft||$[0];
if(this.__complexLeft){$1.borderLeftStyle=$[4];
$1.MozBorderLeftColors=this.__colorLeft+$[78]+this.__colorInnerLeft;
}else{$1.borderLeftStyle=this.getStyleLeft()||$[10];
...
$2=$0._innerStyle;
}$1.borderLeftWidth=$2.borderLeftWidth=$[152];
$1.borderLeftStyle=$2.borderLeftStyle=$[4];
$1.borderLeftColor=this.__colorLeft;
$2.borderLeftColor=this.__colorInnerLeft;
}else{$1.borderLeftWidth=this.__widthLeft||$[29];
$1.borderLeftStyle=this.getStyleLeft()||$[10];
$1.borderLeftColor=this.__colorLeft||$[0];
...
{type:$[23],
extend:qx.util.manager.Value,
properties:{fontTheme:{check:$[113],
nullable:true,
apply:$[903],
event:$[1165]}},
...
var $3=[];
var $4;
for(var $5=0;$5<$2.length;$5++){switch($4=$2[$5]){case $[271]:$1.setBold(true);
break;
case $[380]:$1.setItalic(true);
break;
case $[291]:$1.setDecoration($[291]);
break;
...
reset:function($0){$0.removeStyleProperty($[484]);
$0.removeStyleProperty($[117]);
$0.removeStyleProperty($[387]);
$0.removeStyleProperty($[338]);
$0.removeStyleProperty($[480]);
},
...
$1){this.__size=$0===null?null:$0+$[37];
},
_applyFamily:function($0,
$1){var $2=$[0];
for(var $3=0,
$4=$0.length;$3<$4;$3++){if($0[$3].indexOf($[78])>0){$2+=$[97]+$0[$3]+$[97];
}else{$2+=$0[$3];
}
if($3!=$4-1){$2+=$[88];
}}this.__family=$2;
...
$1){this.__bold=$0===null?null:$0?$[271]:$[170];
},
_applyItalic:function($0,
$1){this.__italic=$0===null?null:$0?$[380]:$[170];
},
_applyDecoration:function($0,
$1){this.__decoration=$0===null?null:$0;
},
render:function($0){$0.setStyleProperty($[484],
this.__family);
$0.setStyleProperty($[117],
this.__size);
$0.setStyleProperty($[387],
this.__bold);
$0.setStyleProperty($[338],
this.__italic);
$0.setStyleProperty($[480],
this.__decoration);
},
...
generateStyle:function(){return (this.__family?$[1449]+this.__family.replace(/\"/g,
$[341])+$[40]:$[0])+(this.__size?$[915]+this.__size+$[40]:$[0])+(this.__weight?$[1469]+this.__weight+$[40]:$[0])+(this.__style?$[1102]+this.__style+$[40]:$[0])+(this.__decoration?$[1298]+this.__decoration+$[40]:$[0]);
}}});
...
{type:$[23],
extend:qx.core.Target,
properties:{iconTheme:{check:$[113],
nullable:true,
apply:$[1127],
event:$[1411]}},
...
{type:$[23],
extend:qx.core.Target,
properties:{widgetTheme:{check:$[113],
nullable:true,
apply:$[1353],
event:$[1741]}},
...
$1){if($1.getKeyIdentifier()!=$[284]){return;
}$1.stopPropagation();
$1.preventDefault();
...
destruct:function(){this._disposeFields($[1149]);
}});
...
$4-=this.__num($2,
$[60]);
if($1.compatMode===$[80]){$3+=this.__num($2,
$[147]);
$4+=this.__num($2,
$[143]);
}return {left:$3,
...
var $2=$1.offsetLeft;
var $3=$1.offsetTop;
if(qx.bom.element.BoxSizing.get($1)!==$[223]){$2+=this.__num($1,
$[65]);
$3+=this.__num($1,
$[60]);
if(!$0.getBoundingClientRect){var $4;
while($0){if(this.__style($0,
$[94])===$[61]||this.__style($0,
$[94])===$[115]){$4=true;
break;
}$0=$0.offsetParent;
}
...
var $3=$2.left;
var $4=$2.top;
if($1.compatMode===$[80]){$3-=this.__num($0,
$[65]);
$4-=this.__num($0,
$[60]);
...
$[42])!=$[1645]){$2+=this.__num($0.parentNode,
$[65]);
...
if($1){if($1==$[249]||$1==$[39]){var $9=qx.bom.element.Overflow.getX($0);
if($9==$[39]||$9==$[2]){$7+=$0.scrollWidth-$0.offsetWidth+this.__num($0,
$[65])+this.__num($0,
$[272]);
}var $a=qx.bom.element.Overflow.getY($0);
if($a==$[39]||$a==$[2]){$8+=$0.scrollHeight-$0.offsetHeight+this.__num($0,
$[60])+this.__num($0,
$[243]);
}}
switch($1){case $[249]:$3+=this.__num($0,
$[189]);
$4+=this.__num($0,
$[192]);
$7-=this.__num($0,
...
$8-=this.__num($0,
$[215]);
case $[39]:$3-=$0.scrollLeft;
$4-=$0.scrollTop;
$7-=$0.scrollLeft;
$8-=$0.scrollTop;
case $[238]:$3+=this.__num($0,
$[65]);
$4+=this.__num($0,
$[60]);
$7-=this.__num($0,
...
"default":function($0){return $0.getAttribute($[43]);
}}),
COMPUTED_MODE:1,
CASCADED_MODE:2,
LOCAL_MODE:3,
...
var $2=$[0];
if($1){for(var $3=0,
$4=$1.length;$3<$4;$3++){$2+=$1[$3]+$[35]+$0+$[40];
}}return $2;
}}),
get:qx.core.Variant.select($[1],
{"mshtml":function($0){if(qx.bom.Document.isStandardMode(qx.dom.Node.getDocument($0))){if(!this.__usesNativeBorderBox($0)){return $[1618];
}}return $[223];
},
...
{statics:{isQuirksMode:function($0){return ($0||window).document.compatMode!==$[80];
},
isStandardMode:function($0){return ($0||window).document.compatMode===$[80];
},
getWidth:function($0){var $1=($0||window).document;
var $2=qx.bom.Viewport.getWidth($0);
var $3=$1.compatMode===$[80]?$1.documentElement.scrollWidth:$1.body.scrollWidth;
return Math.max($3,
$2);
},
getHeight:function($0){var $1=($0||window).document;
var $2=qx.bom.Viewport.getHeight($0);
var $3=$1.compatMode===$[80]?$1.documentElement.scrollHeight:$1.body.scrollHeight;
return Math.max($3,
$2);
}}});
...
compileX:function($0){return this._compile($[934],
$0);
},
compileY:function($0){return this._compile($[1182],
$0);
},
...
destruct:function(){this._disposeFields($[775],
$[1429]);
}});
...
$[94]);
if($3!=$[61]&&$3!=$[115]){$1-=qx.html.Style.getBorderLeft($2);
}if($4!=$[61]&&$4!=$[115]){while($2){$2=$2.parentNode;
if(!$2||typeof $2.tagName!==$[8]){break;
}var $5=qx.html.Style.getStyleProperty($2,
$[94]);
if($5==$[61]||$5==$[115]){$1-=qx.html.Style.getBorderLeft($2)+qx.html.Style.getPaddingLeft($2);
break;
}}}return $1;
},
...
var $4=qx.html.Style.getStyleProperty($2,
$[94]);
if($3!=$[61]&&$3!=$[115]){$1-=qx.html.Style.getBorderTop($2);
}if($4!=$[61]&&$4!=$[115]){while($2){$2=$2.parentNode;
if(!$2||typeof $2.tagName!==$[8]){break;
}var $5=qx.html.Style.getStyleProperty($2,
$[94]);
if($5==$[61]||$5==$[115]){$1-=qx.html.Style.getBorderTop($2)+qx.html.Style.getPaddingTop($2);
break;
}}}return $1;
},
...
$[42])){case $[39]:case $[2]:case $[276]:$5=true;
break;
default:switch(qx.html.Style.getStyleProperty($6,
$[96])){case $[39]:case $[2]:$5=true;
break;
default:$5=false;
}}
...
if($6.tagName.toLowerCase()==$[254]){break;
}$6=$6.offsetParent;
}return true;
},
scrollY:function($0,
...
while($6){switch(qx.html.Style.getStyleProperty($6,
$[42])){case $[39]:case $[2]:case $[268]:$5=true;
break;
default:switch(qx.html.Style.getStyleProperty($6,
$[98])){case $[39]:case $[2]:$5=true;
break;
default:$5=false;
}}
...
}this._timer=new qx.client.Timer(qx.core.Setting.get($[1361]));
this._timer.addEventListener($[121],
this.__oninterval,
this);
if($1){this.addEventListener($[217],
$1,
$2||null);
}},
events:{"completed":$[15]},
members:{_stopped:false,
start:function(){if(qx.lang.Object.isEmpty(this._list)){this.createDispatchEvent($[217]);
return;
}
...
$1.addEventListener($[63],
this.__onload,
this);
$1.addEventListener($[55],
this.__onerror,
this);
}}this._check();
},
...
destruct:function(){this._disposeFields($[509]);
}});
...
if(this.hasEventListeners($[63])){this.dispatchEvent(new qx.event.type.Event($[63]),
true);
}},
...
qx.io.Alias.getInstance().add($[1388],
qx.core.Setting.get($[1538]));
qx.html.StyleSheet.includeFile(qx.io.Alias.getInstance().resolve($[1693]));
...
settings:{"testrunner.resourceUri":$[355]},
destruct:function(){this._disposeObjects($[883]);
}});
...
properties:{orientation:{check:[$[18],
$[27]],
init:$[18],
apply:$[522],
event:$[1756]},
...
defaultValue:null}},
members:{_createLayoutImpl:function(){return this.getOrientation()==$[27]?new qx.ui.layout.impl.VerticalBoxLayoutImpl(this):new qx.ui.layout.impl.HorizontalBoxLayoutImpl(this);
},
...
$1){this._layoutHorizontal=$0==$[18];
this._layoutVertical=$0==$[27];
...
if(($0.getHorizontalAlign()||this.getWidget().getHorizontalChildrenAlign())==$[41]){$0.addToLayoutChanges($[103]);
}return $1||$2;
},
updateChildOnInnerHeightChange:function($0){if(this.getWidget().getVerticalChildrenAlign()==$[21]){$0.addToLayoutChanges($[110]);
...
}if($0.spacing||$0.orientation||$0.reverseChildrenOrder||$0.verticalChildrenAlign){$3._addChildrenToLayoutQueue($[110]);
}
if($0.horizontalChildrenAlign){$3._addChildrenToLayoutQueue($[103]);
}
...
}switch($2.getLayoutMode()){case $[13]:case $[203]:while(($5=$3[++$6])&&$6<$1){$5.addToLayoutChanges($[110]);
}break;
case $[21]:case $[209]:while($5=$3[++$6]){$5.addToLayoutChanges($[110]);
}break;
default:$6+=$1;
while($5=$3[++$6]){$5.addToLayoutChanges($[110]);
}}},
updateChildrenOnMoveChild:function($0,
$1,
...
var $5=Math.max($1,
$2)+1;
for(var $6=$4;$6<$5;$6++){$3[$6].addToLayoutChanges($[110]);
}},
flushChildrenQueue:function($0){var $1=this.getWidget(),
...
switch($1.getLayoutMode()){case $[13]:case $[203]:for(var $5=$3-1;$5>=0&&!$0[$2[$5].toHashCode()];$5--){}for(var $6=0;$6<=$5;$6++){$1._layoutChild($4=$2[$6]);
}break;
case $[21]:case $[209]:$5=-1;
...
layoutChild_locationY:function($0,
$1){var $2=this.getWidget();
if($2.getFirstVisibleChild()==$0){switch($2.getLayoutMode()){case $[13]:case $[203]:var $3=$2.getPaddingBottom()+$2.getAccumulatedChildrenOuterHeight()-$0.getOuterHeight();
break;
case $[21]:case $[209]:var $3=$2.getPaddingTop()+Math.round(($2.getInnerHeight()-$2.getAccumulatedChildrenOuterHeight())/2);
break;
default:var $3=$2.getPaddingTop();
}}else{var $4=$0.getPreviousVisibleSibling();
switch($2.getLayoutMode()){case $[13]:case $[203]:var $3=$4._cachedLocationVertical-$0.getOuterHeight()-$2.getSpacing();
break;
default:var $3=$4._cachedLocationVertical+$4.getOuterHeight()+$2.getSpacing();
}}$0._cachedLocationVertical=$3;
switch(this.getWidget().getLayoutMode()){case $[13]:case $[1265]:case $[209]:$3+=!$0._computedBottomTypeNull?$0.getBottomValue():!$0._computedTopTypeNull?-($0.getTopValue()):0;
$0._resetRuntimeTop();
...
var $4=$3==$[41]?Math.round(($2.getInnerWidth()-$0.getOuterWidth())/2):0;
if($3==$[7]){$4+=$2.getPaddingRight();
...
qx.Class.define($[1491],
{statics:{isValid:function($0){switch(typeof $0){case $[5]:return false;
case $[31]:return $0!==null;
case $[8]:return $0!==$[0];
case $[56]:return !isNaN($0);
case $[36]:case $[51]:return true;
}return false;
},
...
case $[8]:return $0===$[0];
case $[56]:return isNaN($0);
case $[36]:case $[51]:return false;
}return true;
},
isValidNumber:function($0){return typeof $0===$[56]&&!isNaN($0);
},
isInvalidNumber:function($0){return typeof $0!==$[56]||isNaN($0);
},
isValidString:function($0){return typeof $0===$[8]&&$0!==$[0];
},
isInvalidString:function($0){return typeof $0!==$[8]||$0===$[0];
},
isValidArray:function($0){return typeof $0===$[31]&&$0!==null&&$0 instanceof Array;
},
isInvalidArray:function($0){return typeof $0!==$[31]||$0===null||!($0 instanceof Array);
},
isValidObject:function($0){return typeof $0===$[31]&&$0!==null&&!($0 instanceof Array);
},
isInvalidObject:function($0){return typeof $0!==$[31]||$0===null||$0 instanceof Array;
},
isValidNode:function($0){return typeof $0===$[31]&&$0!==null;
},
isInvalidNode:function($0){return typeof $0!==$[31]||$0===null;
},
isValidElement:function($0){return typeof $0===$[31]&&$0!==null||$0.nodeType!==1;
},
isInvalidElement:function($0){return typeof $0!==$[31]||$0===null||$0.nodeType!==1;
},
isValidFunction:function($0){return typeof $0===$[36];
},
isInvalidFunction:function($0){return typeof $0!==$[36];
},
isValidBoolean:function($0){return typeof $0===$[51];
},
isInvalidBoolean:function($0){return typeof $0!==$[51];
},
...
updateChildOnInnerWidthChange:function($0){if(this.getWidget().getHorizontalChildrenAlign()==$[41]){$0.addToLayoutChanges($[103]);
...
if(($0.getVerticalAlign()||this.getWidget().getVerticalChildrenAlign())==$[21]){$0.addToLayoutChanges($[110]);
}return $1||$2;
},
...
var $3=this.getWidget();
if($0.orientation){$1=$2=true;
}if($0.spacing||$0.orientation||$0.reverseChildrenOrder||$0.horizontalChildrenAlign){$3._addChildrenToLayoutQueue($[103]);
}
if($0.verticalChildrenAlign){$3._addChildrenToLayoutQueue($[110]);
}
...
}switch($2.getLayoutMode()){case $[7]:case $[196]:while(($5=$3[++$6])&&$6<$1){$5.addToLayoutChanges($[103]);
}break;
case $[41]:case $[212]:while($5=$3[++$6]){$5.addToLayoutChanges($[103]);
}break;
default:$6+=$1;
while($5=$3[++$6]){$5.addToLayoutChanges($[103]);
}}},
updateChildrenOnMoveChild:function($0,
$1,
$2){var $3=this.getWidget().getVisibleChildren();
...
var $5=Math.max($1,
$2)+1;
for(var $6=$4;$6<$5;$6++){$3[$6].addToLayoutChanges($[103]);
}},
flushChildrenQueue:function($0){var $1=this.getWidget(),
$2=$1.getVisibleChildren(),
$3=$2.length,
...
switch($1.getLayoutMode()){case $[7]:case $[196]:for(var $5=$3-1;$5>=0&&!$0[$2[$5].toHashCode()];$5--){}for(var $6=0;$6<=$5;$6++){$1._layoutChild($4=$2[$6]);
}break;
case $[41]:case $[212]:$5=-1;
while($4=$2[++$5]){$1._layoutChild($4);
}break;
default:$5=-1;
var $7=false;
...
layoutChild_locationX:function($0,
$1){var $2=this.getWidget();
if($2.getFirstVisibleChild()==$0){switch($2.getLayoutMode()){case $[7]:case $[196]:var $3=$2.getPaddingRight()+$2.getAccumulatedChildrenOuterWidth()-$0.getOuterWidth();
break;
case $[41]:case $[212]:var $3=$2.getPaddingLeft()+Math.round(($2.getInnerWidth()-$2.getAccumulatedChildrenOuterWidth())/2);
break;
default:var $3=$2.getPaddingLeft();
}}else{var $4=$0.getPreviousVisibleSibling();
switch($2.getLayoutMode()){case $[7]:case $[196]:var $3=$4._cachedLocationHorizontal-$0.getOuterWidth()-$2.getSpacing();
break;
default:var $3=$4._cachedLocationHorizontal+$4.getOuterWidth()+$2.getSpacing();
}}$0._cachedLocationHorizontal=$3;
switch($2.getLayoutMode()){case $[7]:case $[1063]:case $[212]:$3+=!$0._computedRightTypeNull?$0.getRightValue():!$0._computedLeftTypeNull?-($0.getLeftValue()):0;
$0._resetRuntimeLeft();
...
var $4=$3==$[21]?Math.round(($2.getInnerHeight()-$0.getOuterHeight())/2):0;
if($3==$[13]){$4+=$2.getPaddingBottom();
...
$3.add($8);
this.widgets[$[122]].getBar().getManager().addEventListener($[251],
function($9){if($9.getData().getUserData($[260]).getSelectedElement()==null){this.widgets[$[245]].setEnabled(false);
}},
this);
this.widgets[$[382]].setChecked(true);
...
$a.addToDocument();
this.setZIndex(5);
$a.addEventListener($[63],
this.ehIframeOnLoad,
this);
},
properties:{succCnt:{check:$[14],
init:0,
apply:$[1308]},
failCnt:{check:$[14],
init:0,
apply:$[665]}},
members:{load:function(){this.iframe.setSource(this.__testSuiteUrl);
},
__makeHeader:function(){var $0=new qx.ui.embed.HtmlEmbed($[1110]+$[812]+qx.core.Setting.get($[1611])+$[972]+$[336]+$[1486]+$[565]+qx.core.Version.toString()+$[294]);
$0.setHtmlProperty($[258],
$[435]);
$0.setStyleProperty($[68],
$[1316]+qx.io.Alias.getInstance().resolve($[599])+$[1404]);
$0.setHeight(70);
return $0;
},
__makeToolbar:function(){var $0=new qx.ui.toolbar.ToolBar;
this.runbutton=new qx.ui.toolbar.Button($[1322],
$[1027]);
$0.add(this.runbutton);
this.widgets[$[245]]=this.runbutton;
this.runbutton.addEventListener($[197],
this.runTest,
this);
this.runbutton.setToolTip(new qx.ui.popup.ToolTip($[1124]));
$0.add(new qx.ui.toolbar.Separator);
var $1=qx.core.Setting.get($[499]);
var $2=qx.core.Setting.get($[318]);
this.__testSuiteUrl=$1+$[1641]+$2;
this.testSuiteUrl=new qx.ui.form.TextField(this.__testSuiteUrl);
$0.add(this.testSuiteUrl);
this.testSuiteUrl.setToolTip(new qx.ui.popup.ToolTip($[1150]));
this.testSuiteUrl.set({width:300,
marginRight:5,
marginTop:2});
this.testSuiteUrl.addEventListener($[24],
function($3){if($3.getKeyIdentifier()==$[107]){this.reloadTestSuite();
}},
this);
this.reloadbutton=new qx.ui.toolbar.Button($[1198],
$[990]);
$0.add(this.reloadbutton);
this.reloadbutton.setToolTip(new qx.ui.popup.ToolTip($[1463]));
this.reloadbutton.addEventListener($[197],
this.reloadTestSuite,
this);
$0.add((new qx.ui.basic.HorizontalSpacer).set({width:$[46]}));
var $4=new qx.ui.toolbar.Part();
$4.setVerticalChildrenAlign($[21]);
$0.add($4);
this.reloadswitch=new qx.ui.toolbar.CheckBox($[1498],
$[442]);
$4.add(this.reloadswitch);
this.reloadswitch.setShow($[100]);
this.reloadswitch.setToolTip(new qx.ui.popup.ToolTip($[1482]));
this.reloadswitch.addEventListener($[263],
function($3){if(this.reloadswitch.getChecked()){this.reloadswitch.setIcon($[1432]);
}else{this.reloadswitch.setIcon($[442]);
}},
this);
return $0;
},
...
$0.set({height:$[46]});
var $1=new qx.ui.pageview.tabview.Button($[1356],
$[864]);
var $2=new qx.ui.pageview.tabview.Button($[764],
$[315]);
$1.setChecked(true);
$0.getBar().add($1,
$2);
var $3=new qx.ui.pageview.tabview.Page($1);
$3.set({padding:[5]});
var $4=new qx.ui.pageview.tabview.Page($2);
$4.set({padding:[5]});
$0.getPane().add($3,
$4);
var $5=new testrunner.runner.TestResultView();
this.f1=$5;
$3.add($5);
$5.set({overflow:$[2],
height:$[38],
...
width:$[38],
spacing:20});
this.f2=new qx.ui.embed.HtmlEmbed($[301]);
$6.add(this.f2);
this.f2.setHtmlProperty($[258],
$[817]);
...
border:$[150],
padding:10});
var $7=new qx.ui.form.Button($[1751]);
$6.add($7);
$7.addEventListener($[197],
function($8){this.f2.setHtml($[0]);
},
this);
...
var $9=new qx.ui.pageview.tabview.Button($[607],
$[315]);
var $a=new qx.ui.pageview.tabview.Page($9);
$a.set({padding:[5]});
$0.getPane().add($a);
var $b=new qx.ui.embed.HtmlEmbed($[1447]);
$a.add($b);
return $0;
},
...
$0.setBorder($[1609]);
this.widgets[$[122]]=$0;
var $1=new qx.ui.pageview.buttonview.Button($[280],
$[765]);
$0.getBar().add($1);
this.widgets[$[382]]=$1;
$1.setShow($[85]);
$1.setToolTip(new qx.ui.popup.ToolTip($[1623]));
var $2=new qx.ui.pageview.buttonview.Page($1);
$0.getPane().add($2);
$0.getPane().setPadding(0);
$0.getPane().setBackgroundColor($[59]);
var $3=new qx.ui.tree.Tree($[393]);
$2.add($3);
this.tree=$3;
this.widgets[$[135]]=$3;
$1.setUserData($[260],
...
edge:0,
padding:5});
$3.getManager().addEventListener($[231],
this.treeGetSelection,
this);
var $4=new qx.ui.pageview.buttonview.Button($[1183],
$[1100]);
$0.getBar().add($4);
this.widgets[$[632]]=$4;
$4.setShow($[85]);
$4.setToolTip(new qx.ui.popup.ToolTip($[639]));
var $5=new qx.ui.pageview.buttonview.Page($4);
$0.getPane().add($5);
var $6=new qx.ui.tree.Tree($[393]);
$5.add($6);
this.tree1=$6;
this.widgets[$[131]]=$6;
$4.setUserData($[260],
...
edge:0,
padding:5});
$6.getManager().addEventListener($[231],
this.treeGetSelection,
this);
this.tree={};
var $7=this;
this.tree.getSelectedElement=function(){var $8=$7.widgets[$[122]].getBar().getManager().getSelected();
var $9;
if($8.getLabel()==$[280]){$9=$7.widgets[$[135]].getSelectedElement();
}else{$9=$7.widgets[$[131]].getSelectedElement();
}return $9;
};
return $0;
},
__makeProgress:function(){var $0=new qx.ui.layout.HorizontalBoxLayout();
$0.set({height:$[2],
padding:[10],
spacing:10,
width:$[38]});
var $1=new testrunner.runner.ProgressBar();
$0.add($1);
$1.set({showStepStatus:true,
showPcntStatus:true,
barColor:$[530]});
this.widgets[$[616]]=$0;
this.widgets[$[146]]=$1;
$0.add(new qx.ui.toolbar.Separator);
$0.add(new qx.ui.basic.Label($[820]));
var $2=new qx.ui.basic.Label($[48]);
$0.add($2);
$2.set({backgroundColor:$[175]});
$0.add(new qx.ui.basic.Label($[1114]));
var $3=new qx.ui.basic.Label($[48]);
$0.add($3);
$3.set({backgroundColor:$[175]});
this.widgets[$[507]]=$3;
this.widgets[$[461]]=$2;
return $0;
},
__makeStatus:function(){var $0=new qx.ui.layout.HorizontalBoxLayout();
$0.set({padding:[10],
spacing:10,
height:$[2],
width:$[38]});
$0.add(new qx.ui.basic.Label($[778]));
var $1=new qx.ui.basic.Label($[0]);
$0.add($1);
$1.set({backgroundColor:$[175]});
this.widgets[$[275]]=$1;
$0.add(new qx.ui.basic.Label($[787]));
var $2=new qx.ui.basic.Label($[0]);
$0.add($2);
$2.set({backgroundColor:$[175]});
this.widgets[$[302]]=$2;
$0.add((new qx.ui.basic.HorizontalSpacer).set({width:$[46]}));
$0.add(new qx.ui.basic.Label($[1273]));
var $3=new qx.ui.basic.Label($[0]);
$0.add($3);
$3.set({width:150});
this.widgets[$[91]]=$3;
this.widgets[$[91]].setText($[1323]);
return $0;
},
treeGetSelection:function($0){if(!this.tree.getSelectedElement()){return;
}var $1=this.tree.getSelectedElement();
var $2=$1.getUserData($[134]);
this.tests.selected=this.tests.handler.getFullName($2);
this.widgets[$[275]].setText(this.tests.selected);
this.tests.selected_cnt=this.tests.handler.testCount($2);
this.widgets[$[302]].setText(this.tests.selected_cnt+$[0]);
this.widgets[$[245]].resetEnabled();
var $3=this.widgets[$[122]].getBar().getManager().getSelected();
if($3.getLabel()==$[280]){if($2.widgetLinkFlat){this.widgets[$[131]].setSelectedElement($2.widgetLinkFlat);
if($2.widgetLinkFlat instanceof qx.ui.tree.TreeFolder){$2.widgetLinkFlat.open();
}}else{this.widgets[$[131]].getManager().deselectAll();
}}else{this.widgets[$[135]].setSelectedElement($2.widgetLinkFull);
if($2.widgetLinkFull instanceof qx.ui.tree.TreeFolder){$2.widgetLinkFull.open();
}}this.widgets[$[91]].setText($[1697]);
},
leftReloadTree:function($0){function $1($2,
$3){var $4=$3.getChildren();
var $5;
var $6;
var $4=qx.lang.Array.copy($4);
for(var $7=0;$7<$4.length;$7++){var $8=$4[$7];
var $9=$8.label.charAt(0);
if($9.toUpperCase()===$9){$8.__type=2;
}else if($8.hasChildren()){$8.__type=4;
}else{$8.__type=1;
}}$4.sort(function($a,
$b){if($a.__type!=$b.__type){return $b.__type-$a.__type;
}return $a.label>$b.label?1:-1;
});
for(var $7=0;$7<$4.length;$7++){var $8=$4[$7];
var $9=$8.label.charAt(0);
if($8.__type===2){$6=$[529];
}else if($8.__type===4){$6=$[1752];
}else{$6=$[420];
}
if($8.hasChildren()){$5=new qx.ui.tree.TreeFolder($8.label,
$6);
$1($5,
$8);
}else{$5=new qx.ui.tree.TreeFile($8.label,
$6);
}$2.add($5);
$5.setUserData($[134],
$8);
$8.widgetLinkFull=$5;
if($i.tests.handler.getFullName($8)==$i.tests.selected){$n=$8;
}}}function $c($2,
$3){var $d=$3.getIterator($[205]);
var $8;
while($8=$d()){if($8.type&&$8.type==$[99]);
else{if($h.hasTests($8)){var $e=$h.getFullName($8);
var $5=new qx.ui.tree.TreeFolder($e,
$[529]);
$2.add($5);
$5.setUserData($[134],
$8);
...
for(var $7=0;$7<$4.length;$7++){if($4[$7].type&&$4[$7].type==$[99]){var $f=new qx.ui.tree.TreeFile($4[$7].label,
$[420]);
$5.add($f);
$f.setUserData($[134],
$4[$7]);
$4[$7].widgetLinkFlat=$f;
if($i.tests.handler.getFullName($4[$7])==$i.tests.selected){$n=$4[$7];
}}}}}}}var $g=this.tests.handler.ttree;
var $h=this.tests.handler;
var $i=this;
this.widgets[$[275]].setText($[0]);
this.widgets[$[302]].setText($[0]);
this.widgets[$[122]].setEnabled(false);
var $j=this.widgets[$[135]];
var $k=this.widgets[$[131]];
var $l=[$j,
$k];
var $m=this.widgets[$[122]].getBar().getManager().getSelected();
for(var $7=0;$7<$l.length;$7++){$l[$7].resetSelected();
$l[$7].destroyContent();
$l[$7].setUserData($[134],
$g);
}$g.widgetLinkFull=$j;
...
$c(this.widgets[$[131]],
$g);
this.widgets[$[122]].setEnabled(true);
if($n){if($n.widgetLinkFull){this.widgets[$[135]].setSelectedElement($n.widgetLinkFull);
if($n.widgetLinkFull instanceof qx.ui.tree.TreeFolder){$n.widgetLinkFull.open();
}}
if($n.widgetLinkFlat){this.widgets[$[131]].setSelectedElement($n.widgetLinkFlat);
if($n.widgetLinkFlat instanceof qx.ui.tree.TreeFolder){$n.widgetLinkFlat.open();
}}}},
runTest:function($0){this.toolbar.setEnabled(false);
this.widgets[$[91]].setText($[1245]);
this.resetGui();
var $1=this.widgets[$[146]];
this.appender($[798]+this.tests.selected);
var $2=this.tests.selected_cnt;
var $3=1;
var $4;
var $5=this;
var $6=[];
var $7=[];
var $8=this.tests.handler;
function $9(){var $4=new $5.frameWindow.testrunner.TestResult();
$4.addEventListener($[655],
function($0){var $a=$0.getData();
$5.currentTestData=new testrunner.runner.TestResultData($a.getFullName());
$5.f1.addTestResult($5.currentTestData);
$5.appender($[519]+$a.getFullName()+$[1205]);
},
$5);
$4.addEventListener($[199],
function($0){var $b=$0.getData().exception;
var $a=$0.getData().test;
$5.currentTestData.setException($b);
$5.currentTestData.setState($[199]);
$1.setBarColor($[335]);
var $c=$5.getFailCnt();
$5.setFailCnt(++$c);
$5.appender($[519]+$a.getFullName()+$[1349]+$b.getMessage()+$[323]+$b.getComment());
$5.widgets[$[146]].update(String($3+$[57]+$2));
$3++;
},
$5);
$4.addEventListener($[55],
function($0){var $b=$0.getData().exception;
$5.currentTestData.setException($b);
$5.currentTestData.setState($[55]);
$1.setBarColor($[335]);
var $c=$5.getFailCnt();
$5.setFailCnt(++$c);
$5.appender($[1523]+$0.getData().test.getFullName()+$[1660]+$b,
$b);
$5.widgets[$[146]].update(String($3+$[57]+$2));
$3++;
},
$5);
$4.addEventListener($[1489],
function($0){var $d=$5.currentTestData.getState();
if($d==$[308]){$5.currentTestData.setState($[489]);
var $c=$5.getSuccCnt();
$5.setSuccCnt(++$c);
$5.widgets[$[146]].update(String($3+$[57]+$2));
$3++;
...
$5);
return $4;
}function $e(){$5.widgets[$[91]].setText($[1250]);
$5.toolbar.setEnabled(false);
if($6.length){var $a=$6[0];
$5.loader.runTests($4,
$a[0],
$a[1]);
$6=$6.slice(1,
$6.length);
qx.client.Timer.once($e,
this,
100);
}else{$5.toolbar.setEnabled(true);
if($5.tests.firstrun){$5.reloadswitch.setChecked(true);
$5.tests.firstrun=false;
$5.widgets[$[91]].setText($[1289]);
}else{$5.widgets[$[91]].setText($[407]);
}}}function $f($g){var $6=[];
var $h=$8.getPath($g);
var $i=$h.join($[20]);
if($g.hasChildren()){var $j=$g.getChildren();
for(var $k=0;$k<$j.length;$k++){if($j[$k].hasChildren()){$6=$6.concat($f($j[$k]));
}else{$6.push([$i,
$j[$k].label]);
}}}else{$6.push([$i,
$g.label]);
}return $6;
}var $l=this.tree.getSelectedElement();
if($l){var $m=$l.getUserData($[134]);
}else{alert("Please select a test node from the tree!");
return;
}var $6=$f($m);
if(this.reloadswitch.getChecked()){this.tests.run_pending=function(){$4=$9();
if(!$4){$5.debug("Alarm: no testResult!");
}else{$e();
}};
this.reloadTestSuite();
}else{$4=$9();
...
reloadTestSuite:function($0){var $1=this.iframe.getSource();
var $2=this.testSuiteUrl.getValue();
this.toolbar.setEnabled(false);
this.widgets[$[91]].setText($[847]);
this.resetGui();
qx.client.Timer.once(function(){if($1==$2){this.iframe.reload();
}else{this.iframe.setSource($2);
}},
this,
0);
},
ehIframeOnLoad:function($0){var $1=this.iframe;
this.frameWindow=$1.getContentWindow();
...
var $2=this.loader.getTestDescriptions();
this.tests.handler=new testrunner.runner.TestHandler($2);
...
}this.widgets[$[91]].setText($[407]);
},
resetGui:function(){this.resetProgress();
this.resetTabView();
},
resetProgress:function(){var $0=this.widgets[$[146]];
$0.reset();
$0.setBarColor($[530]);
this.setSuccCnt(0);
this.setFailCnt(0);
...
_applySuccCnt:function($0){this.widgets[$[507]].setText($0+$[0]);
},
_applyFailCnt:function($0){this.widgets[$[461]].setText($0+$[0]);
},
appender:function($0){}},
destruct:function(){this._disposeFields($[303],
$[970],
$[468],
$[585]);
this._disposeObjects($[435],
$[1771],
$[6],
$[1210],
$[593],
...
settings:{"testrunner.title":$[843]},
defer:function(){qx.core.Setting.define($[499],
$[1313]);
qx.core.Setting.define($[318],
$[663]);
}});
...
firstSize:{apply:$[773],
init:$[46]},
secondSize:{apply:$[1541],
init:$[46]},
splitterSize:{check:$[14],
init:4,
apply:$[564],
themeable:true}},
...
switch($1){case $[18]:this._splitter.removeEventListener($[22],
this._onSplitterMouseDownX,
this);
this._splitter.removeEventListener($[76],
...
this._onSplitterMouseDownX,
this);
this._knob.removeEventListener($[76],
this._onSplitterMouseMoveX,
this);
this._knob.removeEventListener($[19],
this._onSplitterMouseUpX,
this);
this._splitter.removeState($[18]);
this._knob.removeState($[18]);
this._firstArea.setWidth(null);
this._secondArea.setWidth(null);
this._splitter.setWidth(null);
break;
case $[27]:this._splitter.removeEventListener($[22],
...
switch($0){case $[18]:this._splitter.addEventListener($[76],
this._onSplitterMouseMoveX,
this);
...
this._onSplitterMouseUpX,
this);
this._knob.addEventListener($[76],
this._onSplitterMouseMoveX,
this);
...
this._onSplitterMouseUpX,
this);
this._splitter.addState($[18]);
this._knob.addState($[18]);
break;
case $[27]:this._splitter.addEventListener($[22],
this._onSplitterMouseDownY,
this);
this._splitter.addEventListener($[76],
this._onSplitterMouseMoveY,
this);
this._splitter.addEventListener($[19],
this._onSplitterMouseUpY,
...
_syncFirstSize:function(){switch(this.getOrientation()){case $[18]:this._firstArea.setWidth(this.getFirstSize());
break;
case $[27]:this._firstArea.setHeight(this.getFirstSize());
break;
}},
_syncSecondSize:function(){switch(this.getOrientation()){case $[18]:this._secondArea.setWidth(this.getSecondSize());
break;
case $[27]:this._secondArea.setHeight(this.getSecondSize());
break;
}},
_syncSplitterSize:function(){switch(this.getOrientation()){case $[18]:this._splitter.setWidth(this.getSplitterSize());
break;
case $[27]:this._splitter.setHeight(this.getSplitterSize());
break;
}},
_onSplitterMouseDownX:function($0){if(!$0.isLeftButtonPressed()){return;
}this._commonMouseDown();
this.getTopLevelWidget().setGlobalCursor($[239]);
this._slider.addState($[149]);
this._knob.addState($[149]);
...
this.getTopLevelWidget().setGlobalCursor($[287]);
this._slider.addState($[149]);
this._knob.addState($[149]);
...
this._slider.removeState($[149]);
this._knob.removeState($[149]);
},
...
$1){this.setFirstSize($0+$[111]);
this.setSecondSize($1+$[111]);
},
...
destruct:function(){this._disposeObjects($[601],
$[1296],
$[1673],
$[1236],
$[1334],
...
{extend:qx.ui.layout.CanvasLayout,
construct:function($0){arguments.callee.base.call(this);
this.setAppearance($[926]);
this.setStyleProperty($[117],
$[29]);
this.setStyleProperty($[181],
$[29]);
this.hide();
this._pane=$0;
this.initZIndex();
...
init:1e8}},
destruct:function(){this._disposeObjects($[277]);
}});
...
$1,
$2){arguments.callee.base.call(this);
this._blank=qx.io.Alias.getInstance().resolve($[210]);
...
$1){if($1){$1.removeEventListener($[63],
this._onload,
this);
$1.removeEventListener($[55],
this._onerror,
this);
}
...
}else{$0.addEventListener($[63],
this._onload,
this);
$0.addEventListener($[55],
this._onerror,
this);
...
$[95])){this._image=document.createElement($[950]);
}else{this._image=new Image;
}this._image.style.border=$[436];
...
$0.style.filter=$[629]+$2+$[1698];
}else{$0.src=$2;
$0.style.filter=this.getEnabled()?$[0]:$[590];
}},
...
destruct:function(){this._disposeObjects($[1217],
$[1777]);
}});
...
}if(qx.Class.isDefined($[362])&&$4!=null&&$2!=null&&$3!=null&&qx.ui.embed.Flash.getPlayerVersion().getMajor()>0){this._flashMode=true;
this.setIcon($4);
...
_createIcon:function(){if(this._flashMode&&qx.Class.isDefined($[362])){var $0=this._iconObject=new qx.ui.embed.Flash(this.getIcon());
...
$1){switch($0){case $[11]:case $[13]:this.setOrientation($[27]);
this.setReverseChildrenOrder($0==$[13]);
break;
default:this.setOrientation($[18]);
this.setReverseChildrenOrder($0==$[7]);
break;
}},
...
_handleLabel:function(){switch(this.getShow()){case $[128]:case $[100]:case $[105]:this._labelIsVisible=!!this.getLabel();
break;
...
_handleIcon:function(){switch(this.getShow()){case $[85]:case $[100]:case $[105]:this._iconIsVisible=!!this.getIcon();
break;
...
if(!$0){$0=document.createElement($[116]);
var $1=$0.style;
$1.width=$1.height=$[2];
$1.visibility=$[26];
$1.position=$[61];
...
$1){$0===null?this.removeStyleProperty($[228]):this.setStyleProperty($[228],
$0);
},
_applyFont:function($0,
...
_styleTextColor:function($0){$0?this.setStyleProperty($[219],
$0):this.removeStyleProperty($[219]);
},
_applyWrap:function($0,
$1){$0==null?this.removeStyleProperty($[425]):this.setStyleProperty($[425],
$0?$[170]:$[578]);
},
...
if($1===$[2]){$1=qx.util.Validation.isValidString($0)&&$0.match(/<.*>/)?$[304]:$[136];
}
switch($1){case $[136]:var $2=qx.html.String.escape($0).replace(/(^ | $)/g,
$[1168]).replace(/  /g,
$[1007]);
this._isHtml=$2!==$0;
this._content=$2;
break;
case $[304]:this._isHtml=true;
this._content=$0;
break;
}
...
$1){this._mnemonicTest=$0?new RegExp($[1733]+$0+$[1227]+$0+$[1126]+$0+$[1695]+$0+$[69],
$[1240]):null;
if(this._isCreated){this._renderContent();
}},
...
if(this.getMnemonic()){if(this._mnemonicTest.test($0)){$0=RegExp.$1+$[860]+RegExp.$7+$[336]+RegExp.rightContext;
this._isHtml=true;
}else{$0+=$[527]+this.getMnemonic()+$[69];
}}var $2=$1.style;
if(this.getTextOverflow()&&!this.getWrap()){if(this.getInnerWidth()<this.getPreferredInnerWidth()){$2.overflow=$[26];
if(qx.core.Variant.isSet($[1],
$[349])){$2.textOverflow=$[333];
}else if(qx.core.Variant.isSet($[1],
$[84])){$2.OTextOverflow=$[333];
}else{$0=this.__patchTextOverflow($0,
this.getInnerWidth());
this._isHtml=true;
}}else{$2.overflow=$[0];
if(qx.core.Variant.isSet($[1],
$[349])){$2.textOverflow=$[0];
}else if(qx.core.Variant.isSet($[1],
$[84])){$2.OTextOverflow=$[0];
}}}
...
properties:{locale:{check:$[16],
nullable:true,
apply:$[569],
event:$[1131]}},
members:{_defaultLocale:$[688],
getLanguage:function(){return this._language;
},
getTerritory:function(){return this.getLocale().split($[169])[1]||$[0];
},
...
$1){this.addTranslation($0.substring($0.lastIndexOf($[20])+1),
$1);
},
...
destruct:function(){this._disposeFields($[922]);
}});
...
getTextContent:qx.lang.Object.select(qx.core.Client.getInstance().supportsTextContent()?$[508]:qx.core.Client.getInstance().supportsInnerText()?$[501]:$[66],
...
setTextContent:qx.lang.Object.select(qx.core.Client.getInstance().supportsTextContent()?$[508]:qx.core.Client.getInstance().supportsInnerText()?$[501]:$[66],
...
return $0?$0.readyState==$[1258]:false;
},
...
$[25])&&!this._blockerNode.parentNode))){this._getBlockerParent().appendChild(this._blockerNode);
}},
release:function(){if(this._blockerNode&&(this._blockerNode.parentElement||(qx.core.Variant.isSet($[1],
$[25])&&this._blockerNode.parentNode))){this._getBlockerParent().removeChild(this._blockerNode);
}},
...
$[28])){var $1=$0?$[1157]+$0+$[97]:$[301];
var $2=qx.ui.embed.Iframe._element=document.createElement($[1173]+$1+$[1095]);
}else{var $2=qx.ui.embed.Iframe._element=document.createElement($[180]);
...
$2.border=$[48];
$2.unselectable=$[53];
$2.allowTransparency=$[900];
$2.style.position=$[61];
$2.style.top=0;
$2.style.left=0;
return $2;
},
_generateBlockerElement:function(){var $0=qx.ui.embed.Iframe._blocker=document.createElement($[116]);
var $1=$0.style;
if(qx.core.Variant.isSet($[1],
$[28])){$1.backgroundColor=$[59];
$1.filter=$[594];
}$1.position=$[61];
$1.top=0;
$1.left=0;
...
if($0==null||$0===$[0]){$0=qx.io.Alias.getInstance().resolve($[816]);
}this._isLoaded=false;
...
_syncScrolling:function(){this.getIframeNode().setAttribute($[848],
this.getScrolling());
},
...
return $1?$1.getElementsByTagName($[254])[0]:null;
}}});
...
qx.Class.define($[1263],
{extend:qx.ui.basic.Terminator,
construct:function($0){arguments.callee.base.call(this);
if($0!=null){this.setHtml($0);
}},
properties:{html:{check:$[16],
init:$[0],
apply:$[1161],
event:$[831]},
textAlign:{check:[$[6],
...
_onkeypress:function($0){switch($0.getKeyIdentifier()){case $[104]:return this._onkeypress_left();
case $[106]:return this._onkeypress_right();
}},
...
this._onmouseup);
this.addEventListener($[24],
this._onkeydown);
this.addEventListener($[126],
this._onkeyup);
},
properties:{appearance:{refine:true,
init:$[130]},
...
if(!$2){this.addState($[86]);
if($1){this.execute();
}}},
_onkeydown:function($0){switch($0.getKeyIdentifier()){case $[107]:case $[145]:this.removeState($[62]);
this.addState($[49]);
$0.stopPropagation();
}},
_onkeyup:function($0){switch($0.getKeyIdentifier()){case $[107]:case $[145]:if(this.hasState($[49])){this.removeState($[62]);
this.removeState($[49]);
this.execute();
$0.stopPropagation();
}}}}});
...
$1.setLeft($3.left);
switch(this.getDirection()){case $[353]:$1.setBottom($3.top);
$1.setTop(null);
break;
case $[300]:$1.setTop($3.bottom);
$1.setBottom(null);
break;
}this.addState($[49]);
...
$1.removeEventListener($[179],
this._onmenuappear,
this);
$1.removeEventListener($[264],
this._onmenudisappear,
this);
}
if($0){$0.setOpener(this);
$0.addEventListener($[179],
this._onmenuappear,
this);
$0.addEventListener($[264],
this._onmenudisappear,
this);
}},
_onmousedown:function($0){if($0.getTarget()!=this||!$0.isLeftButtonPressed()){return;
...
inheritable:true,
event:$[261]}},
destruct:function(){this._disposeObjects($[842]);
}});
...
init:true},
restrictToPageLeft:{check:$[14],
init:0},
restrictToPageRight:{check:$[14],
init:0},
restrictToPageTop:{check:$[14],
init:0},
restrictToPageBottom:{check:$[14],
init:0}},
...
if(qx.Class.isDefined($[142])){var $1=qx.lang.Object.getValues(qx.ui.menu.Manager.getInstance().getAll());
...
if(qx.Class.isDefined($[230])&&$0 instanceof qx.ui.popup.ToolTip&&!($1 instanceof qx.ui.popup.ToolTip)){continue;
}$1.hide();
}}}});
...
qx.Class.define($[550],
{statics:{__umlautsRegExp:new RegExp($[1699],
$[470]),
__umlautsShortData:{"\xC4":$[171],
"\xD6":$[1089],
"\xDC":$[683],
"\xE4":$[557],
"\xF6":$[723],
...
destruct:function(){this._disposeObjects($[752]);
}});
...
hideOnHover:{check:$[3],
init:true},
mousePointerOffsetX:{check:$[14],
init:1},
mousePointerOffsetY:{check:$[14],
init:20},
showInterval:{check:$[14],
init:1000,
apply:$[684]},
hideInterval:{check:$[14],
init:4000,
apply:$[825]},
boundToWidget:{check:$[151],
apply:$[692]}},
...
{type:$[23],
extend:qx.util.manager.Object,
properties:{currentToolTip:{check:$[230],
nullable:true,
apply:$[1717]}},
...
this);
this.addEventListener($[233],
this._onblur);
this.addEventListener($[222],
this._onfocus);
...
_syncFieldWidth:function(){this._inputElement.style.width=this.getInnerWidth()+$[37];
},
_syncFieldHeight:function(){this._inputElement.style.height=(this.getInnerHeight()-2)+$[37];
},
_applyCursor:function($0,
...
if($1){if($1==$[282]&&qx.core.Client.getInstance().isMshtml()){$0.cursor=$[185];
}else{$0.cursor=$1;
}}else{$0.cursor=$[0];
}},
_applyTextAlign:function($0,
...
if($0){this.addState($[514]);
}else{this.removeState($[514]);
}},
_applyTextColor:function($0,
$1){qx.theme.manager.Color.getInstance().connect(this._styleTextColor,
this,
...
{"mshtml":function($0){if(!this._inValueProperty&&$0.propertyName===$[342]){this.createDispatchDataEvent($[127],
...
$1){$0?this.addState($[184]):this.removeState($[184]);
},
_onmouseup:function($0){this.setCapture(false);
if(!this.hasState($[62])){this.addState($[86]);
...
destruct:function(){this._disposeObjects($[1470],
$[277]);
}});
...
$1){var $2=this._bar;
$2.setHorizontalChildrenAlign($0?$[6]:$[7]);
...
destruct:function(){this._disposeObjects($[358]);
}});
...
destruct:function(){this._disposeObjectDeep($[1718],
1);
}});
...
$0);
}}$0?this.addState($[184]):this.removeState($[184]);
var $3=this.getPage();
...
_onmouseover:function($0){this.addState($[86]);
},
_onmouseout:function($0){this.removeState($[86]);
},
...
apply:$[996],
event:$[1362]},
closeButtonImage:{check:$[16],
init:$[1405],
apply:$[991]}},
members:{_onkeydown:function($0){var $1=$0.getKeyIdentifier();
if($1==$[107]||$1==$[145]){this.setChecked(true);
}},
_onkeypress:function($0){switch($0.getKeyIdentifier()){case $[104]:var $1=this.getPreviousActiveSibling();
if($1&&$1!=this){delete qx.event.handler.FocusHandler.mouseFocus;
$1.setFocused(true);
$1.setChecked(true);
}break;
case $[106]:var $2=this.getNextActiveSibling();
if($2&&$2!=this){delete qx.event.handler.FocusHandler.mouseFocus;
$2.setFocused(true);
$2.setChecked(true);
}break;
}},
_ontabclose:function($0){this.createDispatchDataEvent($[1548],
this);
$0.stopPropagation();
},
_applyChecked:function($0,
...
if($0){this._closeButtonImage.addEventListener($[92],
this._ontabclose,
this);
this.add(this._closeButtonImage);
}else{this.remove(this._closeButtonImage);
this._closeButtonImage.removeEventListener($[92],
this._ontabclose,
this);
}},
...
_renderAppearance:function(){if(this.getView()){this.isFirstVisibleChild()?this.addState($[1510]):this.removeState($[285]);
this.isLastVisibleChild()?this.addState($[285]):this.removeState($[285]);
this.getView().getAlignTabsToLeft()?this.addState($[404]):this.removeState($[404]);
!this.getView().getAlignTabsToLeft()?this.addState($[455]):this.removeState($[455]);
this.getView().getPlaceBarOnTop()?this.addState($[148]):this.removeState($[148]);
!this.getView().getPlaceBarOnTop()?this.addState($[141]):this.removeState($[141]);
}arguments.callee.base.call(this);
}},
destruct:function(){this._disposeObjects($[960]);
}});
...
__createResultHtml:function($0){var $1=new qx.util.StringBuilder();
$1.add($[1628],
$0.getState(),
$[1351],
$0.toHashCode(),
...
$0.getName(),
$[681]);
if($0.getState()==$[199]||$0.getState()==$[55]){$1.add($[1311],
$0.getMessage(),
$[1635]);
if($0.getStackTrace().length>0){$1.add($[1154],
$0.getStackTrace(),
$[294]);
}}$1.add($[294]);
return $1.get();
},
addTestResult:function($0){this._testResults.push($0);
$0.addEventListener($[474],
function(){this.__onStateChange($0);
},
this);
var $1=this.getElement();
if($1){$1.innerHTML=this.__createResultHtml($0)+$1.innerHTML;
}},
__onStateChange:function($0){this.setHtml(this.__createHtml());
},
clear:function(){for(var $0=0;$0<this._testResults.length;$0++){this._testResults[$0].dispose();
}this._testResults=[];
this.setHtml($[0]);
}},
destruct:function(){this._disposeFields($[577]);
}});
...
{"mshtml":function(){qx.core.Init.getInstance().addEventListener($[63],
this.__onload,
this);
},
"default":null}),
__onload:qx.core.Variant.select($[1],
{"mshtml":function(){this._frame=document.createElement($[180]);
this._frame.style.visibility=$[26];
this._frame.src=qx.io.Alias.getInstance().resolve($[923]);
...
$1.add=$1.push;
$1.toString=$1.get=new Function($[1004]);
$1.clear=$1.init=new Function($[794]);
$1.isEmpty=new Function($[1515]);
...
init:false}},
members:{appendLogEvent:function($0){var $1=$0.logger.getName();
if($0.instanceId!=null){$1+=$[527]+$0.instanceId+$[69];
}$1+=$[1382];
this.target.setHtml(this.target.getHtml()+$1+this.formatLogEvent($0)+$[641]);
}},
destruct:function(){this._disposeObjects($[697]);
}});
...
$3.setHeight(null);
$3.setWidth($[46]);
this.setOrientation($[18]);
break;
case $[7]:$2.moveSelfToEnd();
$2.setWidth($[2]);
$2.setHeight(null);
$2.setOrientation($[27]);
$3.setHeight(null);
...
qx.Class.define($[1559],
{extend:qx.ui.pageview.AbstractBar,
properties:{appearance:{refine:true,
init:$[401]}},
members:{getWheelDelta:function($0){var $1=$0.getWheelDelta();
switch(this.getParent().getBarPosition()){case $[6]:case $[7]:$1*=-1;
}return $1;
},
_renderAppearance:function(){if(this.getParent()){var $0=this.getParent().getBarPosition();
$0===$[6]?this.addState($[206]):this.removeState($[206]);
$0===$[7]?this.addState($[226]):this.removeState($[226]);
$0===$[11]?this.addState($[148]):this.removeState($[148]);
$0===$[13]?this.addState($[141]):this.removeState($[141]);
}arguments.callee.base.call(this);
}}});
...
$0===$[11]||$0===$[13]?this.addState($[502]):this.removeState($[502]);
$0===$[6]||$0===$[7]?this.addState($[374]):this.removeState($[374]);
}arguments.callee.base.call(this);
}}});
...
appearance:{refine:true,
init:$[796]}},
members:{_onkeypress:function($0){switch(this.getView().getBarPosition()){case $[11]:case $[13]:switch($0.getKeyIdentifier()){case $[104]:var $1=true;
break;
case $[106]:var $1=false;
break;
default:return;
}break;
case $[6]:case $[7]:switch($0.getKeyIdentifier()){case $[193]:var $1=true;
break;
case $[227]:var $1=false;
break;
default:return;
}break;
default:return;
...
this._labelObject.setStyleProperty($[181],
$[38]);
this._labelObject.setMode($[136]);
arguments.callee.base.call(this);
...
}this._iconObject.setAppearance($[520]);
this._labelObject.setAppearance($[406]);
this.addEventListener($[22],
this._onmousedown);
this.addEventListener($[19],
this._onmouseup);
...
getParentFolder:function(){if(this.getParent()&&typeof (this.getParent().getParent)==$[36]){return this.getParent().getParent();
}return null;
},
...
destruct:function(){this._disposeObjects($[724],
$[491],
$[313]);
...
$1){if(typeof $1==$[51]){$0.setAnonymous($1);
}this._fields.push($0);
},
getLabelObject:function(){return this._labelObject;
},
...
destruct:function(){this._disposeFields($[753]);
this._disposeObjects($[1360],
$[1729],
$[838]);
this._disposeObjectDeep($[1042],
1);
}});
...
this._iconObject.setAppearance($[414]);
this._labelObject.setAppearance($[517]);
this.addEventListener($[153],
this._ondblclick);
...
events:{"treeOpenWithContent":$[124],
"treeOpenWhileEmpty":$[124],
"treeClose":$[124]},
properties:{appearance:{refine:true,
init:$[296]},
icon:{refine:true,
...
if(this.hasContent()){if(this.getTree().hasEventListeners($[409])){this.getTree().dispatchEvent(new qx.event.type.DataEvent($[409],
this),
true);
}this.getTopLevelWidget().setGlobalCursor($[588]);
qx.client.Timer.once(this._openCallback,
this,
0);
}else{if(this.getTree().hasEventListeners($[400])){this.getTree().dispatchEvent(new qx.event.type.DataEvent($[400],
this),
true);
}this.setOpen(true);
}},
...
}if($1.hasEventListeners($[319])){$1.dispatchEvent(new qx.event.type.DataEvent($[319],
this),
true);
...
if(!this._horizontalLayout){this.setOrientation($[27]);
...
this._horizontalLayout.setAppearance(this instanceof qx.ui.tree.Tree?$[468]:$[296]);
this.setAppearance($[194]);
...
var $6=$5[$3-$1-1];
if($1==$2){if(this.hasContent()||this.getAlwaysShowPlusMinusSymbol()){if(!$0){return this.getOpen()?$[458]:$[344];
}if($4==1){var $7=this.getParentFolder();
if($7&&!$7._horizontalLayout.getVisibility()&&this.isFirstChild()){if(this.isLastChild()||$6===true){return this.getOpen()?$[288]:$[266];
}else{return this.getOpen()?$[1153]:$[907];
}}}
if($6===true){return this.getOpen()?$[288]:$[266];
}else if(this.isLastChild()){return this.getOpen()?$[1038]:$[1238];
}else{return this.getOpen()?$[1497]:$[1406];
}}else if($0&&!($6===true)){return this.isLastChild()?$[486]:$[423];
...
this._iconObject.setAppearance($[674]);
this._labelObject.setAppearance($[1632]);
this.setOpen(true);
this.addToFolder();
this.addEventListener($[24],
this._onkeydown);
...
tabIndex:{refine:true,
init:1},
excludeSpecificTreeLines:{check:$[424],
init:[],
apply:$[1631]},
hideNode:{check:$[3],
init:false,
...
getExcludeSpecificTreeLines:function(){return qx.lang.Array.clone(this[$[1152]]);
},
...
switch($0.getKeyIdentifier()){case $[107]:$0.preventDefault();
if(qx.ui.tree.Tree.isTreeFolder($2)){return $2.toggle();
}break;
case $[104]:$0.preventDefault();
...
getIndentSymbol:function($0,
$1,
$2){if($1==$2&&(this.hasContent()||this.getAlwaysShowPlusMinusSymbol())){if(!$0){return this.getOpen()?$[458]:$[344];
}else{return this.getOpen()?$[288]:$[266];
}}else{return null;
}}},
destruct:function(){this._disposeObjects($[358]);
}});
...
events:{"changeSelection":$[124]},
properties:{boundedWidget:{check:$[151],
nullable:true},
...
var $2=this.getFireChange();
this.setFireChange(false);
if($0.getKeyIdentifier()==$[171]&&$0.isCtrlPressed()){if(this.getMultiSelection()){this._selectAll();
...
}else if($0.getKeyIdentifier()==$[145]){if(this._selectedItems.contains($4)){this.renderItemSelectionState($4,
false);
...
}switch($0.getKeyIdentifier()){case $[253]:return this.getHome(this.getLeadItem());
case $[305]:return this.getEnd(this.getLeadItem());
case $[227]:return this.getDown(this.getLeadItem());
case $[193]:return this.getUp(this.getLeadItem());
case $[104]:return this.getLeft(this.getLeadItem());
case $[106]:return this.getRight(this.getLeadItem());
case $[290]:return this.getPageUp(this.getLeadItem())||this.getHome(this.getLeadItem());
case $[297]:return this.getPageDown(this.getLeadItem())||this.getEnd(this.getLeadItem());
case $[145]:if($0.isCtrlPressed()){return this.getLeadItem();
}}return null;
},
_dispatchChange:function(){if(!this.getFireChange()){return;
}
if(this.hasEventListeners($[231])){this.dispatchEvent(new qx.event.type.DataEvent($[231],
...
destruct:function(){this._disposeObjects($[747]);
}});
...
destruct:function(){this._disposeFields($[1576],
$[1437]);
}});
...
var $5=$4[$3-$1-1];
if($0&&!($5===true)){if($1==$2){return this.isLastChild()?$[486]:$[423];
}else{return $[376];
}}return null;
},
...
this.bar.set({height:$[38],
width:$[451],
backgroundColor:$[1445]});
this.bar.setStyleProperty($[117],
0);
this.stepStatus=new qx.ui.basic.Label($[1216]);
this.add(this.stepStatus);
if(!this.isShowStepStatus()){this.stepStatus.setDisplay(false);
}this.pcntStatus=new qx.ui.basic.Label($[658]);
this.add(this.pcntStatus);
if(!this.isShowPcntStatus()){this.pcntStatus.setDisplay(false);
}},
properties:{status:{check:$[14]},
label:{check:$[16],
apply:$[242]},
barWidth:{check:$[14],
apply:$[1738]},
...
var $0=new qx.util.range.IntegerRange(0,
100,
5);
var $1;
function $2(){for(var $1=0;$1<10000000;$1++){}}
while(($1=$0.next())!=null){this.debug("Running i: "+$1);
this.update(String($1)+$[81]);
$2();
...
this.bar.setWidth($[451]);
},
update:function($0){var $1=$[675];
var $2,
$3;
if(typeof ($0)!=$[704]){throw new Error($1);
}
if($0.indexOf($[57])>-1){quot=$0.split($[57]);
if((quot.length!=2)||(isNaN(quot[0]=parseInt(quot[0])))||(isNaN(quot[1]=parseInt(quot[1])))||(quot[0]<=0)||(quot[1]<=0)||(quot[0]>quot[1])){throw new Error($1);
}else{$2=Math.round(quot[0]/quot[1]*100);
this.bar.setWidth($2+$[81]);
qx.ui.core.Widget.flushGlobalQueues();
this.stepStatus.setText($[157]+$0+$[69]);
this.pcntStatus.setText($[157]+$2+$[314]);
}}else if($0[$0.length-1]=$[81]){var $4=parseInt($0.slice(0,
$0.length-1));
if($4==NaN||($4<0||$4>100)){throw new Error($1);
}else{this.bar.setWidth($4+$[81]);
qx.ui.core.Widget.flushGlobalQueues();
this.pcntStatus.setText($[157]+$4+$[314]);
$2=$4+$[1252];
this.stepStatus.setText($[157]+$2+$[69]);
}}else{throw new Error($1);
}return true;
},
_applyLabel:function($0){this.label.setText($0);
},
_applyBarWidth:function($0){this.hull.setWidth($0);
},
_applyShowStepStatus:function($0){if($0){this.stepStatus.setDisplay(true);
}else{this.stepStatus.setDisplay(false);
}},
_applyStepStatus:function($0){if(this.isShowStepStatus()){this.stepStatus.setText($0);
}},
_applyShowPcntStatus:function($0){if($0){this.pcntStatus.setDisplay(true);
}else{this.pcntStatus.setDisplay(false);
}},
_applyPcntStatus:function($0){if(this.isShowPcntStatus()){this.pcntStatus.setText($0);
}},
_applyBarColor:function($0){this.bar.setBackgroundColor($0);
}},
destruct:function(){this._disposeObjects($[128],
$[1310],
$[1211],
$[1184],
$[1111]);
...
members:{next:function(){var $0=this.curr;
if($0!=null){if(this.asc){if((this.curr+this.incr)<=this.stop){this.curr+=this.incr;
}else{this.curr=null;
...
"opera":function(){if(this.getException()){var $0=this.getException().message;
if($0.indexOf($[493])<0){return this.getException().toString();
}else{return qx.lang.String.trim($0.split($[493])[0]);
}}else{return $[0];
}}}),
getStackTrace:function(){var $0=this.getException();
var $1=[];
if(typeof ($0.getStackTrace)==$[36]){$1=$0.getStackTrace();
}else{$1=qx.dev.StackTrace.getStackTraceFromError($0);
}while($1.length>0){var $2=$1[0];
if($2.indexOf($[1487])==0||$2.indexOf($[328])==0||$2.indexOf($[1526])==0||$2.indexOf($[1502])==0){$1.shift();
}else{break;
}}return $1.join($[495]);
}}});
...
$6);
if(!$d){throw new Exception($[1381]);
}$h.readTree($4,
$d);
}var $3=new testrunner.runner.Tree($[541]);
var $h=this;
...
readTree:function($0,
$1){var $2=arguments[1]||new testrunner.runner.Tree($0.classname);
var $1;
for(var $3=0;$3<$0.tests.length;$3++){$1=new testrunner.runner.Tree($0.tests[$3]);
$1.type=$[99];
$2.add($1);
}if($0.children&&$0.children.length){for(var $3=0;$3<$0.children.length;$3++){$2.add(readTree($0.children[$3]));
}}return $2;
},
...
getChildren:function($0){if($0==$[541]){var $1=this.tmap;
var $2=[];
...
isClass:function($0){if($0.type&&$0.type==$[99]){return false;
}else{return true;
}},
hasTests:function($0){if(!this.isClass($0))return false;
else{var $1=$0.getChildren();
for(var $2=0;$2<$1.length;$2++){if($1[$2].type&&$1[$2].type==$[99])return true;
}return false;
}},
...
if($0.type&&$0.type==$[99]){$1=$1.concat($0.label);
}return $1.join($[20]);
},
testCount:function($0){if($0.type&&$0.type==$[99]){return 1;
}else{var $1=0;
var $2=$0.getIterator($[205]);
var $3;
while($3=$2()){if($3.type&&$3.type==$[99]){$1++;
}}return $1;
}}},
destruct:function(){this._disposeFields($[1588]);
this._disposeObjects($[755]);
}});
...
destruct:function(){this._disposeObjects($[1556],
$[822],
$[244]);
this._disposeObjectDeep($[1614],
1);
},
...
cldr_number_decimal_separator:$[20],
cldr_number_group_separator:$[88],
cldr_pm:"pm",
cldr_quotationEnd:"’",
cldr_quotationStart:"‘",
