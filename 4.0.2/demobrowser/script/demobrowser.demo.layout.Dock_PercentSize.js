...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Dock_PercentSize.5b98e1719b50.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="east",b="yellow",c="center",d="red",e="north",f="south",g="50%",h="west",i="x",j="green",k="fuchsia",l="orange",m="main",n="y",o="blue",p="demobrowser.demo.layout.Dock_PercentSize";qx.Class.define(p,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var r=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(r);var q=new qx.ui.container.Composite(new qx.ui.layout.Dock()).set({decorator:m,backgroundColor:b,width:450,height:250,allowGrowX:false});var x=new qx.ui.core.Widget().set({decorator:m,backgroundColor:d});var w=new qx.ui.core.Widget().set({decorator:m,backgroundColor:o});var v=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});var u=new qx.ui.core.Widget().set({decorator:m,backgroundColor:j});var t=new qx.ui.core.Widget().set({decorator:m,backgroundColor:k});q.add(x,{edge:e});q.add(w,{edge:h,width:g});q.add(v,{edge:f,height:g});q.add(u,{edge:a});q.add(t,{edge:c});r.add(q);var s=new qx.ui.layout.Dock();s.setSort(n);var q=(new qx.ui.container.Composite(s)).set({decorator:m,backgroundColor:b,width:450,height:250,allowGrowX:false});var x=new qx.ui.core.Widget().set({decorator:m,backgroundColor:d});var w=new qx.ui.core.Widget().set({decorator:m,backgroundColor:o});var v=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});var u=new qx.ui.core.Widget().set({decorator:m,backgroundColor:j});var t=new qx.ui.core.Widget().set({decorator:m,backgroundColor:k});q.add(x,{edge:e});q.add(w,{edge:h,width:g});q.add(v,{edge:f,height:g});q.add(u,{edge:a});q.add(t,{edge:c});r.add(q);var s=new qx.ui.layout.Dock();s.setSort(i);var q=(new qx.ui.container.Composite(s)).set({decorator:m,backgroundColor:b,width:450,height:250,allowGrowX:false});var x=new qx.ui.core.Widget().set({decorator:m,backgroundColor:d});var w=new qx.ui.core.Widget().set({decorator:m,backgroundColor:o});var v=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});var u=new qx.ui.core.Widget().set({decorator:m,backgroundColor:j});var t=new qx.ui.core.Widget().set({decorator:m,backgroundColor:k});q.add(x,{edge:e});q.add(w,{edge:h,width:g});q.add(v,{edge:f,height:g});q.add(u,{edge:a});q.add(t,{edge:c});r.add(q);}
}});}
)();
