...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.d0d7ce6d3a37.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__IO].values;var bo=this.__IK[this.__IO];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__IP){bn.shift();}
...
;this.__IM.setRed(bx);this.__IM.setGreen(bw);this.__IM.setBlue(bv);this.__IL.open();}
,_onColorSelectorOk:function(){var by=this.__IM;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__IL.close();}
,_onColorSelectorCancel:function(){this.__IL.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__IL){this.__IL.destroy();this.__IM.destroy();this.__IN.destroy();}
;this._tables=this.__IK=null;}
});}
)();
...
;this.__Cz=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__Cz=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__pr?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__pr=true;this.__Cz=true;this.setRed(255);this.setGreen(255);this.__Cz=false;this.setBlue(255);}
,__pt:function(){if(!this.__Cz){this.__pr=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dc,db){if(this.__Ct===null){this.__Ct=bU;}
;if(this.__Ct!==cK){this.getChildControl(m).setValue(dc);}
;if(this.__Ct!==n){this._setHexFromRgb();}
;switch(this.__Ct){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pt();if(this.__Ct===bU){this.__Ct=null;}
;}
,_applyGreen:function(de,dd){if(this.__Ct===null){this.__Ct=cq;}
;if(this.__Ct!==cK){this.getChildControl(O).setValue(de);}
;if(this.__Ct!==n){this._setHexFromRgb();}
;switch(this.__Ct){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pt();if(this.__Ct===cq){this.__Ct=null;}
;}
,_applyBlue:function(dg,df){if(this.__Ct===null){this.__Ct=d;}
;if(this.__Ct!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__Ct!==n){this._setHexFromRgb();}
;switch(this.__Ct){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pt();if(this.__Ct===d){this.__Ct=null;}
;}
,_applyHue:function(di,dh){if(this.__Ct===null){this.__Ct=cr;}
;if(this.__Ct!==F){this.getChildControl(cu).setValue(di);}
;if(this.__Ct!==R){if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomLeft(Math.round(di/1.40625)+this.getChildControl(cc).getPaddingLeft());}
else {this.getChildControl(V).setLayoutProperties({left:Math.round(di/1.40625)});}
;}
;switch(this.__Ct){case F:case R:case cr:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__Ct===cr){this.__Ct=null;}
;}
,_applySaturation:function(dk,dj){if(this.__Ct===null){this.__Ct=s;}
;if(this.__Ct!==F){this.getChildControl(cx).setValue(dk);}
;if(this.__Ct!==R){this._setBrightnessGradiant();if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomTop(256-Math.round(dk*2.56)+this.getChildControl(cc).getPaddingTop());}
else {this.getChildControl(V).setLayoutProperties({top:256-Math.round(dk*2.56)});}
;}
;switch(this.__Ct){case F:case R:case s:this._setRgbFromHue();};if(this.__Ct===s){this.__Ct=null;}
;}
,_applyBrightness:function(dn,dm){if(this.__Ct===null){this.__Ct=c;}
;if(this.__Ct!==F){this.getChildControl(bT).setValue(dn);}
;if(this.__Ct!==P){var dl=256-Math.round(dn*2.56);if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dl+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cM).setLayoutProperties({top:dl});}
;}
;switch(this.__Ct){case F:case P:case c:this._setRgbFromHue();};if(this.__Ct===c){this.__Ct=null;}
;}
,_onBrightnessHandlePointerDown:function(e){this.getChildControl(cM).capture();this.__Cv=cM;var dr=this.getChildControl(cf).getContentLocation();var dq=this.getChildControl(cM).getContentLocation();var dp=this.getChildControl(cf).getBounds();this.__Cw=dr.top+(e.getDocumentTop()-dq.top)-dp.top;e.stopPropagation();}
,_onBrightnessHandlePointerUp:function(e){this.getChildControl(cM).releaseCapture();this.__Cv=null;}
,_onBrightnessHandlePointerMove:function(e){if(this.__Cv===cM){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldPointerDown:function(e){var location=this.getChildControl(cf).getContentLocation();var ds=this.getChildControl(cM).getBounds();this.__Cw=location.top+(ds.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cM).capture();this.__Cv=cM;}
...
,_setBrightnessOnFieldEvent:function(e){var dt=qx.lang.Number.limit(e.getDocumentTop()-this.__Cw,0,256);this.__Ct=P;if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dt);}
else {this.getChildControl(cM).setLayoutProperties({top:dt});}
;this.setBrightness(100-Math.round(dt/2.56));this.__Ct=null;}
,_onHueSaturationHandlePointerUp:function(e){if(this.__Cv){e.stopPropagation();this.getChildControl(V).releaseCapture();this.__Cv=null;}
;}
,_onHueSaturationHandlePointerMove:function(e){if(this.__Cv===V){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldPointerDown:function(e){var location=this.getChildControl(ca).getContentLocation();var du=this.getChildControl(V).getBounds();var dv=this.getChildControl(ca).getBounds();this.__Cx=location.top+(du.height/2)-dv.top;this.__Cy=location.left+(du.width/2)-dv.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(V).capture();this.__Cv=V;}
...
,_setHueSaturationOnFieldEvent:function(e){var dy=qx.lang.Number.limit(e.getDocumentTop()-this.__Cx,0,256);var dx=qx.lang.Number.limit(e.getDocumentLeft()-this.__Cy,0,256);this.getChildControl(V).setDomPosition(dx,dy);this.__Ct=R;this.setSaturation(100-Math.round(dy/2.56));this.setHue(Math.round(dx*1.40625));this.__Ct=null;}
,_setRedFromSpinner:function(){if(this.__Ct!==null){return;}
;this.__Ct=cK;this.setRed(this.getChildControl(m).getValue());this.__Ct=null;}
,_setGreenFromSpinner:function(){if(this.__Ct!==null){return;}
;this.__Ct=cK;this.setGreen(this.getChildControl(O).getValue());this.__Ct=null;}
,_setBlueFromSpinner:function(){if(this.__Ct!==null){return;}
;this.__Ct=cK;this.setBlue(this.getChildControl(cG).getValue());this.__Ct=null;}
,_setHueFromSpinner:function(){if(this.__Ct!==null){return;}
;this.__Ct=F;this.setHue(this.getChildControl(cu).getValue());this.__Ct=null;}
,_setSaturationFromSpinner:function(){if(this.__Ct!==null){return;}
;this.__Ct=F;this.setSaturation(this.getChildControl(cx).getValue());this.__Ct=null;}
,_setBrightnessFromSpinner:function(){if(this.__Ct!==null){return;}
;this.__Ct=F;this.setBrightness(this.getChildControl(bT).getValue());this.__Ct=null;}
,_onHexFieldChange:function(e){if(this.__Ct!==null){return;}
;try{var dA=this.getChildControl(cD);var dz=qx.util.ColorUtil.hexStringToRgb(J+dA.getValue());}
catch(dB){return;}
;this.__Ct=n;this.setRed(dz[0]);this.setGreen(dz[1]);this.setBlue(dz[2]);this.__Ct=null;}
...
,_setHueFromRgb:function(){switch(this.__Ct){case F:case R:case P:break;default:var dF=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dF[0]);this.setSaturation(dF[1]);this.setBrightness(dF[2]);};}
,_setRgbFromHue:function(){switch(this.__Ct){case cK:case n:break;default:var dG=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dG[0]);this.setGreen(dG[1]);this.setBlue(dG[2]);};}
