...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.Cursor","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Cursor.4aafc35374cc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="nw-resize",b="main",c="#DDD",d="w-resize",e="text",f="#555",g="se-resize",h="crosshair",j="sw-resize",k="n-resize",l="default",m="s-resize",n="nesw-resize",o="pointer",p="help ",q="demobrowser.demo.ui.Cursor",r="move",s="ne-resize",t="e-resize",u="nwse-resize",v="wait";qx.Class.define(q,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var y=new qx.ui.container.Scroll();var w=new qx.ui.layout.HBox();w.setSpacing(10);var x=new qx.ui.container.Composite(w);x.setPadding(20);y.add(x);this.getRoot().add(y,{edge:0});x.add(this.getGrid1());}
,getGrid1:function(){var A=new qx.ui.container.Composite().set({textColor:c});var z=new qx.ui.layout.Grid();z.setSpacing(20);A.setLayout(z);var B=[l,h,o,r,k,s,t,g,m,j,d,a,n,u,e,v,p];var i=0;for(var i=0;i<B.length;i++ ){A.add(new qx.ui.basic.Label(B[i]).set({decorator:b,backgroundColor:f,cursor:B[i],padding:5,height:100,width:100}),{row:Math.floor(i/5),column:i%5});}
;return A;}
}});}
)();
