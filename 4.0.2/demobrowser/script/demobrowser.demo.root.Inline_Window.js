...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Window.4c7050adacfc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__zu=w;w.style.overflow=p;w.style.textAlign=r;this.__zv=x||false;this.__zw=v||false;this.__zx();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==b)){this.setKeepFocus(true);}
...
,members:{__zv:false,__zw:false,__zu:null,__zx:function(){if(this.__zv||this.__zw){var y=qx.bom.element.Dimension.getSize(this.__zu);if(this.__zv&&y.width<1){throw new Error(s+this.__zu+t+this+k);}
;if(this.__zw){if(y.height<1){throw new Error(s+this.__zu+t+this+g);}
;if(y.height>=1&&qx.bom.element.Style.get(this.__zu,j,3)==f){qx.bom.element.Style.set(this.__zu,j,y.height+h);}
;}
;qx.event.Registration.addListener(this.__zu,a,this._onResize,this);}
;}
,_createContentElement:function(){var z=this.__zu;if(this.__zv||this.__zw){var B=document.createElement(q);z.appendChild(B);}
else {B=z;}
...
,this,0);return A;}
,_onResize:function(e){var C=e.getData();if((C.oldWidth!==C.width)&&this.__zv||(C.oldHeight!==C.height)&&this.__zw){qx.ui.core.queue.Layout.add(this);}
;}
...
;}
,_computeSizeHint:function(){var H=this.__zv;var E=this.__zw;if(!H||!E){var D=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {D={};}
;var I=qx.bom.element.Dimension;if(H){var G=I.getContentWidth(this.__zu);D.width=G;D.minWidth=G;D.maxWidth=G;}
;if(E){var F=I.getContentHeight(this.__zu);D.height=F;D.minHeight=F;D.maxHeight=F;}
;return D;}
},defer:function(J,K){qx.ui.core.MLayoutHandling.remap(K);}
,destruct:function(){qx.event.Registration.removeListener(this.__zu,a,this._onResize,this);this.__zu=null;}
});}
)();
(function(){var a="resize",b="__ju",c="interval",d="body",f="qx.event.handler.ElementResize";qx.Class.define(f,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);this.__fz=g;this.__zy={};this.__ju=new qx.event.Timer(200);this.__ju.addListener(c,this._onInterval,this);}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__zy:null,__fz:null,__ju:null,canHandleEvent:function(i,h){return i.tagName.toLowerCase()!==d;}
,registerEvent:function(m,n,j){var l=qx.core.ObjectRegistry.toHashCode(m);var k=this.__zy;if(!k[l]){k[l]={element:m,width:qx.bom.element.Dimension.getWidth(m),height:qx.bom.element.Dimension.getHeight(m)};this.__ju.start();}
;}
,unregisterEvent:function(r,s,o){var q=qx.core.ObjectRegistry.toHashCode(r);var p=this.__zy;if(p[q]){delete p[q];if(qx.lang.Object.isEmpty(p)){this.__ju.stop();}
;}
;}
...
;}
;}
},destruct:function(){this.__fz=this.__zy=null;this._disposeObjects(b);}
