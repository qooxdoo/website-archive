...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Finder.7bfb42c79930.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Abstract method call",b="abstract",c="*",d="",e="-webkit-tap-highlight-color: transparent;",f="-ms-touch-select: none;",g="qx.application.AbstractGui",h="-webkit-touch-callout: none;",i="-webkit-tap-highlight-color: rgba(0,0,0,0);";qx.Class.define(g,{type:b,extend:qx.core.Object,implement:[qx.application.IApplication],include:qx.locale.MTranslation,members:{__fK:null,_createRootWidget:function(){throw new Error(a);}
,getRoot:function(){return this.__fK;}
,main:function(){qx.theme.manager.Meta.getInstance().initialize();qx.ui.tooltip.Manager.getInstance();var j=[h,f,i,e].join(d);qx.ui.style.Stylesheet.getInstance().addRule(c,j);this.__fK=this._createRootWidget();window.scrollTo(0,0);}
,finalize:function(){this.render();}
,render:function(){qx.ui.core.queue.Manager.flush();}
,close:function(k){}
,terminate:function(){}
},destruct:function(){this.__fK=null;}
});}
)();
...
;this.__kX=null;}
;}
,_isFontValid:function(){if(!qx.bom.webfonts.Validator.__kY){this.__cP();}
...
;}
,__cP:function(){var N=qx.bom.webfonts.Validator;if(!N.__la){N.__la={sans:this._getHelperElement(N.COMPARISON_FONTS.sans),serif:this._getHelperElement(N.COMPARISON_FONTS.serif)};}
...
;}
,properties:{alignX:{check:[o,j,p],init:o,apply:c},alignY:{check:[n,b,g],init:n,apply:c},spacing:{check:q,init:0,apply:c},separator:{check:a,nullable:true,apply:c},reversed:{check:k,init:false,apply:e}},members:{__nw:null,__nx:null,__ny:null,__fW:null,_applyReversed:function(){this._invalidChildrenCache=true;this._applyLayoutChange();}
,__nz:function(){var B=this._getLayoutChildren();var length=B.length;var y=false;var w=this.__nw&&this.__nw.length!=length&&this.__nx&&this.__nw;var z;var x=w?this.__nw:new Array(length);var A=w?this.__nx:new Array(length);if(this.getReversed()){B=B.concat().reverse();}
...
;}
;if(!w){this.__nw=x;this.__nx=A;}
;this.__ny=y;this.__fW=B;delete this._invalidChildrenCache;}
...
;}
,"false":null}),renderLayout:function(U,O,T){if(this._invalidChildrenCache){this.__nz();}
;var K=this.__fW;var length=K.length;var W=qx.ui.layout.Util;var S=this.getSpacing();var Y=this.getSeparator();if(Y){var H=W.computeHorizontalSeparatorGaps(K,S,Y);}
else {var H=W.computeHorizontalGaps(K,S,true);}
;var i,V,Q,P;var X=[];var L=H;for(i=0;i<length;i+=1){P=this.__nw[i];Q=P!=null?Math.floor((U-H)*P):K[i].getSizeHint().width;X.push(Q);L+=Q;}
;if(this.__ny&&L!=U){var N={};var R,F;for(i=0;i<length;i+=1){R=this.__nx[i];if(R>0){M=K[i].getSizeHint();N[i]={min:M.minWidth,value:X[i],max:M.maxWidth,flex:R};}
;}
...
;}
,_computeSizeHint:function(){if(this._invalidChildrenCache){this.__nz();}
;var bs=qx.ui.layout.Util;var bf=this.__fW;var bk=0,bl=0,be=0;var bi=0,bj=0;var bp,bg,br;for(var i=0,l=bf.length;i<l;i+=1){bp=bf[i];bg=bp.getSizeHint();bl+=bg.width;var bo=this.__nx[i];var bh=this.__nw[i];if(bo){bk+=bg.minWidth;}
...
},destruct:function(){this.__nw=this.__nx=this.__fW=null;}
});}
)();
...
;}
,properties:{rich:{check:d,init:false,event:J,apply:L},wrap:{check:d,init:true,apply:j},value:{check:y,apply:t,event:k,nullable:true},buddy:{check:f,apply:w,nullable:true,init:null,dereference:true},textAlign:{check:[P,u,G,I],nullable:true,themeable:true,apply:c,event:i},appearance:{refine:true,init:N},selectable:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false},allowShrinkY:{refine:true,init:false}},members:{__mc:null,__md:null,__me:null,__mf:null,__mg:null,_getContentHint:function(){if(this.__md){this.__mh=this.__mi();delete this.__md;}
...
;}
,__mh:{width:0,height:0},_applyFont:function(bc,bb){if(bb&&this.__mc&&this.__mg){this.__mc.removeListenerById(this.__mg);this.__mg=null;}
;var ba;if(bc){this.__mc=qx.theme.manager.Font.getInstance().resolve(bc);if(this.__mc instanceof qx.bom.webfonts.WebFont){this.__mg=this.__mc.addListener(h,this._onWebFontStatusChange,this);}
...
,__mi:function(bf){var be=qx.bom.Label;var bh=this.getFont();var bd=bh?this.__mc.getStyles():qx.bom.Font.getDefaultStyles();var content=this.getValue()||R;var bg=this.getRich();if(this.__mg){this.__mj();}
...
;}
;}
,_applyBuddy:function(bk,bj){if(bj!=null){bj.removeBinding(this.__me);this.__me=null;this.removeListenerById(this.__mf);this.__mf=null;}
;if(bk!=null){this.__me=bk.bind(x,this,x);this.__mf=this.addListener(Q,function(){if(bk.isFocusable()){bk.focus.apply(bk);}
...
;}
,_applyValue:function(br,bq){this.getContentElement().setValue(br);this.__md=true;qx.ui.core.queue.Layout.add(this);}
},destruct:function(){if(qx.core.Environment.get(E)){qx.locale.Manager.getInstance().removeListener(O,this._onChangeLocale,this);}
;if(this.__me!=null){var bs=this.getBuddy();if(bs!=null&&!bs.isDisposed()){bs.removeBinding(this.__me);}
;}
;if(this.__mc&&this.__mg){this.__mc.removeListenerById(this.__mg);}
;this.__mc=this.__me=null;}
});}
)();
(function(){var a="value",b="qx.html.Label",c="The label mode cannot be modified after initial creation",d='hidden';qx.Class.define(b,{extend:qx.html.Element,members:{__mk:null,_applyProperty:function(name,e){qx.html.Element.prototype._applyProperty.call(this,name,e);if(name==a){var f=this.getDomElement();qx.bom.Label.setValue(f,e);}
;}
,_createDomElement:function(){var h=this.__mk;var g=qx.bom.Label.create(this._content,h);g.style.overflow=d;return g;}
...
;j=!!j;if(this.__mk==j){return this;}
;this.__mk=j;return this;}
,setValue:function(l){this._setProperty(a,l);return this;}
,getValue:function(){return this._getProperty(a);}
}});}
)();
(function(){var a="text",b="px",c="http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul",d="crop",e="nowrap",f="end",g="div",h="100%",i="auto",j="0",k="css.textoverflow",l="html.xul",m="value",n="visible",o="qx.bom.Label",p="",q="ellipsis",r="normal",s="inherit",t="block",u="label",v="-1000px",w="hidden",x="absolute";qx.Bootstrap.define(o,{statics:{__ml:{fontFamily:1,fontSize:1,fontWeight:1,fontStyle:1,lineHeight:1},__mm:function(){var y=this.__mo(false);document.body.insertBefore(y,document.body.firstChild);return this._textElement=y;}
,__mn:function(){var z=this.__mo(true);document.body.insertBefore(z,document.body.firstChild);return this._htmlElement=z;}
,__mo:function(C){var A=qx.dom.Element.create(g);var B=A.style;B.width=B.height=i;B.left=B.top=v;B.visibility=w;B.position=x;B.overflow=n;B.display=t;if(C){B.whiteSpace=r;}
else {B.whiteSpace=e;if(!qx.core.Environment.get(k)&&qx.core.Environment.get(l)){var D=document.createElementNS(c,u);var B=D.style;B.padding=j;B.margin=j;B.width=i;for(var E in this.__ml){B[E]=s;}
;A.appendChild(D);}
;}
;return A;}
,__mp:function(G){var F={};if(G){F.whiteSpace=r;}
else if(!qx.core.Environment.get(k)&&qx.core.Environment.get(l)){F.display=t;}
else {F.overflow=w;F.whiteSpace=e;F[qx.core.Environment.get(k)]=q;}
;return F;}
,create:function(content,K,J){if(!J){J=window;}
;var H=J.document.createElement(g);if(K){H.useHtml=true;}
else if(!qx.core.Environment.get(k)&&qx.core.Environment.get(l)){var L=J.document.createElementNS(c,u);var I=L.style;I.cursor=s;I.color=s;I.overflow=w;I.maxWidth=h;I.padding=j;I.margin=j;I.width=i;for(var M in this.__ml){L.style[M]=s;}
;L.setAttribute(d,f);H.appendChild(L);}
else {qx.bom.element.Style.setStyles(H,this.__mp(K));}
;if(content){this.setValue(H,content);}
;return H;}
,setValue:function(O,N){N=N||p;if(O.useHtml){O.innerHTML=N;}
else if(!qx.core.Environment.get(k)&&qx.core.Environment.get(l)){O.firstChild.setAttribute(m,N);}
else {qx.bom.element.Attribute.set(O,a,N);}
;}
,getValue:function(P){if(P.useHtml){return P.innerHTML;}
else if(!qx.core.Environment.get(k)&&qx.core.Environment.get(l)){return P.firstChild.getAttribute(m)||p;}
else {return qx.bom.element.Attribute.get(P,a);}
;}
,getHtmlSize:function(content,Q,R){var S=this._htmlElement||this.__mn();S.style.width=R!=undefined?R+b:i;S.innerHTML=content;return this.__mq(S,Q);}
,getTextSize:function(U,T){var V=this._textElement||this.__mm();if(!qx.core.Environment.get(k)&&qx.core.Environment.get(l)){V.firstChild.setAttribute(m,U);}
else {qx.bom.element.Attribute.set(V,a,U);}
;return this.__mq(V,T);}
,__mq:function(bb,W){var X=this.__ml;if(!W){W={};}
;for(var ba in X){bb.style[ba]=W[ba]||p;}
;var Y=qx.bom.element.Dimension.getSize(bb);Y.width++ ;return Y;}
}});}
)();
...
(function(){var a="_applyActiveWindow",b="changeModal",c="changeVisibility",d="__fz",f="__oD",g="changeActive",h="qx.ui.window.MDesktop",i="qx.ui.window.Window";qx.Mixin.define(h,{properties:{activeWindow:{check:i,apply:a,init:null,nullable:true}},members:{__oD:null,__fz:null,getWindowManager:function(){if(!this.__fz){this.setWindowManager(new qx.ui.window.Window.DEFAULT_MANAGER_CLASS());}
;return this.__fz;}
,supportsMaximize:function(){return true;}
,setWindowManager:function(j){if(this.__fz){this.__fz.setDesktop(null);}
;j.setDesktop(this);this.__fz=j;}
...
;}
,_backupActiveWidget:function(){var O=qx.event.Registration.getManager(window).getHandler(qx.event.handler.Focus);this.__lh.push(qx.ui.core.Widget.getWidgetByElement(O.getActive()));this.__li.push(qx.ui.core.Widget.getWidgetByElement(O.getFocus()));if(this._widget.isFocusable()){this._widget.focus();}
;}
,_restoreActiveWidget:function(){var Q;var P=this.__li.length;if(P>0){Q=this.__li.pop();if(Q&&!Q.isDisposed()&&Q.isFocusable()){Q.focus();}
;}
;var R=this.__lh.length;if(R>0){Q=this.__lh.pop();if(Q&&!Q.isDisposed()){Q.activate();}
;}
;}
...
,members:{__oG:null,__oH:null,__oI:null,__oJ:null,connectTo:function(m){m.addListener(a,this.__gK,this);m.addListener(j,this._onFocusIn,this,true);m.addListener(b,this._onFocusOut,this,true);m.addListener(c,this._onActivate,this,true);m.addListener(h,this._onDeactivate,this,true);}
...
;}
,__gK:function(e){if(e.getKeyIdentifier()!=d){return;}
;if(!this.__oJ){return;}
...
;}
,_computeSizeHint:function(){var I=qx.bom.Viewport.getWidth(this.__cx);var J=qx.bom.Viewport.getHeight(this.__cx);return {minWidth:I,width:I,maxWidth:I,minHeight:J,height:J,maxHeight:J};}
...
,__oV:function(e){var M=e.getOriginalTarget();while(M&&M.style){var Q=qx.bom.element.Style.get(M,v)!==s&&qx.bom.element.Style.get(M,v)!==o;var P=qx.bom.element.Style.get(M,c)===d;var O=qx.bom.element.Style.get(M,z)!=x;var N=qx.bom.element.Style.get(M,m)!=x;if(Q||P||N||O){return;}
;M=M.parentNode;}
;e.preventDefault();}
},destruct:function(){this.__cx=this.__oU=null;}
});}
)();
...
(function(){var a="indexOf",b="addAfter",c="add",d="addBefore",e="_",f="addAt",g="hasChildren",h="removeAt",i="removeAll",j="getChildren",k="remove",l="qx.ui.core.MRemoteChildrenHandling";qx.Mixin.define(l,{members:{__nP:function(q,m,o,n){var p=this.getChildrenContainer();if(p===this){q=e+q;}
;return (p[q])(m,o,n);}
,getChildren:function(){return this.__nP(j);}
,hasChildren:function(){return this.__nP(g);}
,add:function(s,r){return this.__nP(c,s,r);}
,remove:function(t){return this.__nP(k,t);}
,removeAll:function(){return this.__nP(i);}
,indexOf:function(u){return this.__nP(a,u);}
,addAt:function(x,v,w){this.__nP(f,x,v,w);}
,addBefore:function(y,A,z){this.__nP(d,y,A,z);}
,addAfter:function(D,B,C){this.__nP(b,D,B,C);}
,removeAt:function(E){return this.__nP(h,E);}
}});}
)();
...
(function(){var a="qx.ui.window.Manager",b="__rI";qx.Class.define(a,{extend:qx.core.Object,implement:qx.ui.window.IWindowManager,members:{__rI:null,setDesktop:function(c){this.__rI=c;this.updateStack();}
,getDesktop:function(){return this.__rI;}
,changeActiveWindow:function(d,e){if(d){this.bringToFront(d);d.setActive(true);}
;if(e){e.resetActive();}
;}
,_minZIndex:1e5,updateStack:function(){qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(){this.__rI.forceUnblock();var h=this.__rI.getWindows();var g=this._minZIndex;var m=g+h.length*2;var j=g+h.length*4;var k=null;for(var i=0,l=h.length;i<l;i++ ){var f=h[i];if(!f.isVisible()){continue;}
;k=k||f;if(f.isModal()){f.setZIndex(j);this.__rI.blockContent(j-1);j+=2;k=f;}
else if(f.isAlwaysOnTop()){f.setZIndex(m);m+=2;}
else {f.setZIndex(g);g+=2;}
;if(!k.isModal()&&f.isActive()||f.getZIndex()>k.getZIndex()){k=f;}
;}
;this.__rI.setActiveWindow(k);}
,bringToFront:function(o){var n=this.__rI.getWindows();var p=qx.lang.Array.remove(n,o);if(p){n.push(o);this.updateStack();}
;}
,sendToBack:function(r){var q=this.__rI.getWindows();var s=qx.lang.Array.remove(q,r);if(s){q.unshift(r);this.updateStack();}
;}
},destruct:function(){this._disposeObjects(b);}
});}
)();
(function(){var a="pointerup",b="__rJ",c="Boolean",d="__rK",f="losecapture",g="move",h="qx.ui.core.MMovable",i="The move handle could not be redefined!",j="pointerdown",k="maximized",l="pointermove",m="roll",n="move-frame";qx.Mixin.define(h,{properties:{movable:{check:c,init:true},useMoveFrame:{check:c,init:false}},members:{__rJ:null,__rK:null,__rL:null,__rM:null,__rN:null,__rO:null,__rP:null,__rQ:false,__rR:null,__rS:0,_activateMoveHandle:function(o){if(this.__rJ){throw new Error(i);}
;this.__rJ=o;o.addListener(j,this._onMovePointerDown,this);o.addListener(a,this._onMovePointerUp,this);o.addListener(l,this._onMovePointerMove,this);o.addListener(f,this.__rW,this);}
,__rT:function(){var p=this.__rK;if(!p){p=this.__rK=new qx.ui.core.Widget();p.setAppearance(n);p.exclude();qx.core.Init.getApplication().getRoot().add(p);}
;return p;}
,__rU:function(){var location=this.getContentLocation();var r=this.getBounds();var q=this.__rT();q.setUserBounds(location.left,location.top,r.width,r.height);q.show();q.setZIndex(this.getZIndex()+1);}
,__rV:function(e){var t=this.__rL;var s=Math.max(t.left,Math.min(t.right,e.getDocumentLeft()));var v=Math.max(t.top,Math.min(t.bottom,e.getDocumentTop()));var u=this.__rM+s;var w=this.__rN+v;return {viewportLeft:parseInt(u,10),viewportTop:parseInt(w,10),parentLeft:parseInt(u-this.__rO,10),parentTop:parseInt(w-this.__rP,10)};}
,_onMoveRoll:function(e){e.stop();}
,_onMovePointerDown:function(e){if(!this.getMovable()||this.hasState(k)){return;}
;this.addListener(m,this._onMoveRoll,this);var parent=this.getLayoutParent();var x=parent.getContentLocation();var z=parent.getBounds();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(!parent.isBlocked()){this.__rR=parent.getBlockerColor();this.__rS=parent.getBlockerOpacity();parent.setBlockerColor(null);parent.setBlockerOpacity(1);parent.blockContent(this.getZIndex()-1);this.__rQ=true;}
;}
;this.__rL={left:x.left,top:x.top,right:x.left+z.width,bottom:x.top+z.height};var y=this.getContentLocation();this.__rO=x.left;this.__rP=x.top;this.__rM=y.left-e.getDocumentLeft();this.__rN=y.top-e.getDocumentTop();this.addState(g);this.__rJ.capture();if(this.getUseMoveFrame()){this.__rU();}
;e.stop();}
,_onMovePointerMove:function(e){if(!this.hasState(g)){return;}
;var B=this.__rV(e);if(this.getUseMoveFrame()){this.__rT().setDomPosition(B.viewportLeft,B.viewportTop);}
else {var A=this.getLayoutParent().getInsets();this.setDomPosition(B.parentLeft-(A.left||0),B.parentTop-(A.top||0));}
;e.stopPropagation();}
,_onMovePointerUp:function(e){if(this.hasListener(m,this._onMoveRoll,this)){this.removeListener(m,this._onMoveRoll,this);}
;if(!this.hasState(g)){return;}
;this.removeState(g);var parent=this.getLayoutParent();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(this.__rQ){parent.unblock();parent.setBlockerColor(this.__rR);parent.setBlockerOpacity(this.__rS);this.__rR=null;this.__rS=0;this.__rQ=false;}
;}
;this.__rJ.releaseCapture();var D=this.__rV(e);var C=this.getLayoutParent().getInsets();this.setLayoutProperties({left:D.parentLeft-(C.left||0),top:D.parentTop-(C.top||0)});if(this.getUseMoveFrame()){this.__rT().exclude();}
;e.stopPropagation();}
,__rW:function(e){if(!this.hasState(g)){return;}
;this.removeState(g);if(this.getUseMoveFrame()){this.__rT().exclude();}
;}
},destruct:function(){this._disposeObjects(d,b);this.__rL=null;}
});}
)();
(function(){var a="resetPaddingRight",b="setPaddingTop",c="_applyContentPadding",d="setPaddingBottom",e="resetThemed",f="contentPaddingRight",g="Integer",h="contentPaddingLeft",i="setThemedPaddingLeft",j="resetPaddingTop",k="shorthand",l="setThemedPaddingRight",m="setThemed",n="setPaddingRight",o="contentPaddingBottom",p="resetPaddingBottom",q="qx.ui.core.MContentPadding",r="resetPaddingLeft",s="setThemedPaddingTop",t="setPaddingLeft",u="setThemedPaddingBottom",v="contentPaddingTop";qx.Mixin.define(q,{properties:{contentPaddingTop:{check:g,init:0,apply:c,themeable:true},contentPaddingRight:{check:g,init:0,apply:c,themeable:true},contentPaddingBottom:{check:g,init:0,apply:c,themeable:true},contentPaddingLeft:{check:g,init:0,apply:c,themeable:true},contentPadding:{group:[v,f,o,h],mode:k,themeable:true}},members:{__mP:{contentPaddingTop:b,contentPaddingRight:n,contentPaddingBottom:d,contentPaddingLeft:t},__mQ:{contentPaddingTop:s,contentPaddingRight:l,contentPaddingBottom:u,contentPaddingLeft:i},__mR:{contentPaddingTop:j,contentPaddingRight:a,contentPaddingBottom:p,contentPaddingLeft:r},_applyContentPadding:function(z,w,name,y){var A=this._getContentPaddingTarget();if(z==null){var x=this.__mR[name];A[x]();}
else {if(y==m||y==e){var B=this.__mQ[name];A[B](z);}
else {var B=this.__mP[name];A[B](z);}
;}
;}
}});}
)();
(function(){var a="Boolean",b="w-resize",c="touch",d="sw-resize",f="n-resize",g="resizableRight",h="ne-resize",i="se-resize",j="Integer",k="e-resize",l="resizableLeft",m="move",n="shorthand",o="maximized",p="resize",q="nw-resize",r="pointerup",s="pointerdown",t="qx.ui.core.MResizable",u="losecapture",v="resize-frame",w="resizableBottom",x="s-resize",y="pointermove",z="resizableTop",A="pointerout";qx.Mixin.define(t,{construct:function(){var content=this.getContentElement();content.addListener(s,this.__sk,this,true);content.addListener(r,this.__sl,this);content.addListener(y,this.__sn,this);content.addListener(A,this.__so,this);content.addListener(u,this.__sm,this);var B=content.getDomElement();if(B==null){B=window;}
;this.__rX=qx.event.Registration.getManager(B).getHandler(qx.event.handler.DragDrop);}
,properties:{resizableTop:{check:a,init:true},resizableRight:{check:a,init:true},resizableBottom:{check:a,init:true},resizableLeft:{check:a,init:true},resizable:{group:[z,g,w,l],mode:n},resizeSensitivity:{check:j,init:5},useResizeFrame:{check:a,init:true}},members:{__rX:null,__rY:null,__sa:null,__sb:null,__sc:null,__sd:null,__se:null,RESIZE_TOP:1,RESIZE_BOTTOM:2,RESIZE_LEFT:4,RESIZE_RIGHT:8,_getResizeFrame:function(){var C=this.__rY;if(!C){C=this.__rY=new qx.ui.core.Widget();C.setAppearance(v);C.exclude();qx.core.Init.getApplication().getRoot().add(C);}
;return C;}
,__sf:function(){var location=this.getContentLocation();var D=this._getResizeFrame();D.setUserBounds(location.left,location.top,location.right-location.left,location.bottom-location.top);D.show();D.setZIndex(this.getZIndex()+1);}
,__sg:function(e){var F=this.__sa;var E=this.getSizeHint();var I=this.__se;var H=this.__sd;var J=H.width;var G=H.height;var L=H.left;var top=H.top;var K;if((F&this.RESIZE_TOP)||(F&this.RESIZE_BOTTOM)){K=Math.max(I.top,Math.min(I.bottom,e.getDocumentTop()))-this.__sc;if(F&this.RESIZE_TOP){G-=K;}
else {G+=K;}
;if(G<E.minHeight){G=E.minHeight;}
else if(G>E.maxHeight){G=E.maxHeight;}
;if(F&this.RESIZE_TOP){top+=H.height-G;}
;}
;if((F&this.RESIZE_LEFT)||(F&this.RESIZE_RIGHT)){K=Math.max(I.left,Math.min(I.right,e.getDocumentLeft()))-this.__sb;if(F&this.RESIZE_LEFT){J-=K;}
else {J+=K;}
...
,__sh:{'1':f,'2':x,'4':b,'8':k,'5':q,'6':d,'9':h,'10':i},__si:function(e){var location=this.getContentLocation();var O=this.getResizeSensitivity();var N=e.getDocumentLeft();var P=e.getDocumentTop();var M=this.__sj(location,N,P,O);if(M>0){M=M|this.__sj(location,N,P,O*2);}
;this.__sa=M;}
,__sj:function(location,T,R,S){var Q=0;if(this.getResizableTop()&&Math.abs(location.top-R)<S&&T>location.left-S&&T<location.right+S){Q+=this.RESIZE_TOP;}
...
;return Q;}
,__sk:function(e){if(!this.__sa||!this.getEnabled()||e.getPointerType()==c){return;}
;this.addState(p);this.__sb=e.getDocumentLeft();this.__sc=e.getDocumentTop();var location=this.getContentLocation();var V=this.getBounds();this.__sd={top:location.top,left:location.left,width:location.right-location.left,height:location.bottom-location.top,bounds:qx.lang.Object.clone(V)};var parent=this.getLayoutParent();var W=parent.getContentLocation();var U=parent.getBounds();this.__se={left:W.left,top:W.top,right:W.left+U.width,bottom:W.top+U.height};if(this.getUseResizeFrame()){this.__sf();}
;this.capture();e.stop();}
,__sl:function(e){if(!this.hasState(p)||!this.getEnabled()||e.getPointerType()==c){return;}
;if(this.getUseResizeFrame()){this._getResizeFrame().exclude();}
;var X=this.__sg(e);this.setWidth(X.width);this.setHeight(X.height);if(this.getResizableLeft()||this.getResizableTop()){this.setLayoutProperties({left:X.parentLeft,top:X.parentTop});}
;this.__sa=0;this.removeState(p);this.resetCursor();this.getApplicationRoot().resetGlobalCursor();this.releaseCapture();e.stopPropagation();}
,__sm:function(e){if(!this.__sa){return;}
...
;}
,__sn:function(e){if(!this.getEnabled()||e.getPointerType()==c){return;}
;if(this.hasState(p)){var ba=this.__sg(e);if(this.getUseResizeFrame()){var Y=this._getResizeFrame();Y.setUserBounds(ba.viewportLeft,ba.viewportTop,ba.width,ba.height);}
...
;}
;e.stopPropagation();}
else if(!this.hasState(o)&&!this.__rX.isSessionActive()){this.__si(e);var bd=this.__sa;var bc=this.getApplicationRoot();if(bd){var bb=this.__sh[bd];this.setCursor(bb);bc.setGlobalCursor(bb);}
else if(this.getCursor()){this.resetCursor();bc.resetGlobalCursor();}
;}
;}
,__so:function(e){if(e.getPointerType()==c){return;}
;if(this.getCursor()&&!this.hasState(p)){this.resetCursor();this.getApplicationRoot().resetGlobalCursor();}
;}
},destruct:function(){if(this.__rY!=null&&!qx.core.ObjectRegistry.inShutDown){this.__rY.destroy();this.__rY=null;}
;this.__rX=null;}
});}
)();
...
;var br=this.getLayoutProperties();this.__sq=br.left===undefined?0:br.left;this.__sp=br.top===undefined?0:br.top;this.setLayoutProperties({left:null,top:null,edge:0});this.addState(F);this._updateCaptionBar();this.fireEvent(Q);}
;}
;}
,minimize:function(){if(!this.isVisible()){return;}
;if(this.fireNonBubblingEvent(b,qx.event.type.Event,[false,true])){var bs=this.getLayoutProperties();this.__sq=bs.left===undefined?0:bs.left;this.__sp=bs.top===undefined?0:bs.top;this.removeState(F);this.hide();this.fireEvent(v);}
;}
...
;var bt=this.__sq;var top=this.__sp;this.setLayoutProperties({edge:null,left:bt,top:top});this.removeState(F);this._updateCaptionBar();this.fireEvent(S);}
;}
...
;if(v){this.setSeparator(v);}
;}
,properties:{alignY:{check:[k,o,f],init:k,apply:b},alignX:{check:[m,c,r],init:m,apply:b},spacing:{check:p,init:0,apply:b},separator:{check:a,nullable:true,apply:b},reversed:{check:s,init:false,apply:d}},members:{__nC:null,__nx:null,__ny:null,__fW:null,_applyReversed:function(){this._invalidChildrenCache=true;this._applyLayoutChange();}
,__nz:function(){var B=this._getLayoutChildren();var length=B.length;var x=false;var w=this.__nC&&this.__nC.length!=length&&this.__nx&&this.__nC;var z;var y=w?this.__nC:new Array(length);var A=w?this.__nx:new Array(length);if(this.getReversed()){B=B.concat().reverse();}
...
;}
;if(!w){this.__nC=y;this.__nx=A;}
;this.__ny=x;this.__fW=B;delete this._invalidChildrenCache;}
...
;}
,"false":null}),renderLayout:function(V,N,Y){if(this._invalidChildrenCache){this.__nz();}
;var K=this.__fW;var length=K.length;var U=qx.ui.layout.Util;var T=this.getSpacing();var bb=this.getSeparator();if(bb){var H=U.computeVerticalSeparatorGaps(K,T,bb);}
else {var H=U.computeVerticalGaps(K,T,true);}
;var i,ba,G,O;var P=[];var W=H;for(i=0;i<length;i+=1){O=this.__nC[i];G=O!=null?Math.floor((N-H)*O):K[i].getSizeHint().height;P.push(G);W+=G;}
;if(this.__ny&&W!=N){var M={};var S,F;for(i=0;i<length;i+=1){S=this.__nx[i];if(S>0){L=K[i].getSizeHint();M[i]={min:L.minHeight,value:P[i],max:L.maxHeight,flex:S};}
;}
...
;}
,_computeSizeHint:function(){if(this._invalidChildrenCache){this.__nz();}
;var be=qx.ui.layout.Util;var bs=this.__fW;var bh=0,bi=0,bq=0;var bj=0,bk=0;var bo,bf,br;for(var i=0,l=bs.length;i<l;i+=1){bo=bs[i];bf=bo.getSizeHint();bi+=bf.height;var bn=this.__nx[i];var bg=this.__nC[i];if(bn){bh+=bf.minHeight;}
...
},destruct:function(){this.__nC=this.__nx=this.__fW=null;}
});}
)();
...
;throw new Error(n);}
,getSelection:function(){return qx.lang.Object.getValues(this.__fD);}
,getSortedSelection:function(){var bU=this.getSelectables();var bT=qx.lang.Object.getValues(this.__fD);bT.sort(function(a,b){return bU.indexOf(a)-bU.indexOf(b);}
);return bT;}
,isItemSelected:function(bV){var bW=this._selectableToHashCode(bV);return this.__fD[bW]!==undefined;}
,isSelectionEmpty:function(){return qx.lang.Object.isEmpty(this.__fD);}
...
;this._fireChange();}
,_setLeadItem:function(cb){var ca=this.__nk;if(ca!==null){this._styleSelectable(ca,u,false);}
;if(cb!==null){this._styleSelectable(cb,u,true);}
;this.__nk=cb;}
,getLeadItem:function(){return this.__nk;}
,_setAnchorItem:function(cd){var cc=this.__nl;if(cc!=null){this._styleSelectable(cc,I,false);}
...
;this._fireChange();}
,handlePointerOver:function(event){if(this.__nn!=null&&this.__nn!=this._getScroll().top){this.__nn=null;return;}
...
;var cD=event.isCtrlPressed()||(qx.core.Environment.get(c)==E&&event.isMetaPressed());var cA=event.isShiftPressed();if(this.isItemSelected(cB)&&!cA&&!cD&&!this.getDrag()){this.__nm=cB;this._userInteraction=false;return;}
else {this.__nm=null;}
;this._scrollItemIntoView(cB);var cC=this.getMode();if(this.getDrag()&&cC!==bu&&cC!==h&&!cA&&!cD&&event.getPointerType()==F){this._setAnchorItem(cB);this._setLeadItem(cB);this.__na=this._getLocation();this.__mW=this._getScroll();this.__nb=event.getDocumentLeft()+this.__mW.left;this.__nc=event.getDocumentTop()+this.__mW.top;this.__nd=true;this._capture();}
;this._fireChange(bD);this._userInteraction=false;}
,handleTap:function(event){this._userInteraction=true;var cH=event.isCtrlPressed()||(qx.core.Environment.get(c)==E&&event.isMetaPressed());var cE=event.isShiftPressed();if(!cH&&!cE&&this.__nm!=null){this._userInteraction=false;var cF=this._getSelectableFromPointerEvent(event);if(cF===null||!this.isItemSelected(cF)){return;}
;}
...
,handlePointerMove:function(event){if(!this.__nd){return;}
;this.__ne=event.getDocumentLeft();this.__nf=event.getDocumentTop();this._userInteraction=true;var cI=this.__ne+this.__mW.left;if(cI>this.__nb){this.__ng=1;}
else if(cI<this.__nb){this.__ng=-1;}
else {this.__ng=0;}
;var cJ=this.__nf+this.__mW.top;if(cJ>this.__nc){this.__nh=1;}
else if(cJ<this.__nc){this.__nh=-1;}
else {this.__nh=0;}
;var location=this.__na;if(this.__ne<location.left){this.__mT=this.__ne-location.left;}
...
;if(!this.__mV){this.__mV=new qx.event.Timer(100);this.__mV.addListener(G,this._onInterval,this);}
;this.__mV.start();this._autoSelect();event.stopPropagation();this._userInteraction=false;}
...
;if(this.__ni){this._fireChange(bD);}
;delete this.__nd;delete this.__mX;delete this.__mY;this._releaseCapture();if(this.__mV){this.__mV.stop();}
;}
,_onInterval:function(e){this._scrollBy(this.__mT,this.__mU);this.__mW=this._getScroll();this._autoSelect();}
,_autoSelect:function(){var cT=this._getDimension();var cM=Math.max(0,Math.min(this.__ne-this.__na.left,cT.width))+this.__mW.left;var cL=Math.max(0,Math.min(this.__nf-this.__na.top,cT.height))+this.__mW.top;if(this.__mX===cM&&this.__mY===cL){return;}
;this.__mX=cM;this.__mY=cL;var cQ=this._getAnchorItem();var cO=cQ;var cR=this.__ng;var cU,cN;while(cR!==0){cU=cR>0?this._getRelatedSelectable(cO,t):this._getRelatedSelectable(cO,W);if(cU!==null){cN=this._getSelectableLocationX(cU);if((cR>0&&cN.left<=cM)||(cR<0&&cN.right>=cM)){cO=cU;continue;}
;}
;break;}
;var cS=this.__nh;var cV,cP;while(cS!==0){cV=cS>0?this._getRelatedSelectable(cO,z):this._getRelatedSelectable(cO,bB);if(cV!==null){cP=this._getSelectableLocationY(cV);if((cS>0&&cP.top<=cL)||(cS<0&&cP.bottom>=cL)){cO=cV;continue;}
;}
;break;}
...
;this._fireChange(bw);}
,__no:{Home:1,Down:1,Right:1,PageDown:1,End:1,Up:1,Left:1,PageUp:1},handleKeyPress:function(event){this._userInteraction=true;var dd,dc;var df=event.getKeyIdentifier();var de=this.getMode();var cY=event.isCtrlPressed()||(qx.core.Environment.get(c)==E&&event.isMetaPressed());var da=event.isShiftPressed();var db=false;if(df===A&&cY){if(de!==bu&&de!==h){this._selectAllItems();db=true;}
;}
...
;db=true;}
;}
else if(this.__no[df]){db=true;if(de===bu||de==h){dd=this._getSelectedItem();}
...
;}
;break;};this.__nn=this._getScroll().top;this._scrollItemIntoView(dc);}
;}
...
;}
,_clearSelection:function(){var di=this.__fD;for(var dj in di){this._removeFromSelection(di[dj]);}
;this.__fD={};}
,_selectItemRange:function(dk,dp,dm){var dq=this._getSelectableRange(dk,dp);if(!dm){var dn=this.__fD;var dr=this.__np(dq);for(var dl in dn){if(!dr[dl]){this._removeFromSelection(dn[dl]);}
;}
;}
...
;}
,__np:function(dw){var dx={};var dv;for(var i=0,l=dw.length;i<l;i++ ){dv=dw[i];dx[this._selectableToHashCode(dv)]=dv;}
;return dx;}
,_getSelectedItem:function(){for(var dy in this.__fD){return this.__fD[dy];}
;return null;}
,_setSelectedItem:function(dA){if(this._isSelectable(dA)){var dz=this.__fD;var dB=this._selectableToHashCode(dA);if(!dz[dB]||(dz.length>=2)){this._clearSelection();this._addToSelection(dA);}
;}
;}
,_addToSelection:function(dC){var dD=this._selectableToHashCode(dC);if(this.__fD[dD]==null&&this._isSelectable(dC)){this.__fD[dD]=dC;this._styleSelectable(dC,R,true);this.__ni=true;}
;}
,_toggleInSelection:function(dE){var dF=this._selectableToHashCode(dE);if(this.__fD[dF]==null){this.__fD[dF]=dE;this._styleSelectable(dE,R,true);}
else {delete this.__fD[dF];this._styleSelectable(dE,R,false);}
;this.__ni=true;}
,_removeFromSelection:function(dG){var dH=this._selectableToHashCode(dG);if(this.__fD[dH]!=null){delete this.__fD[dH];this._styleSelectable(dG,R,false);this.__ni=true;}
;}
...
;}
;var dP=dK[0];var dI=dO;var dM=this.__fD;for(var dN in dM){if(dJ[dN]){delete dJ[dN];}
...
;if(!dL){return false;}
;this._scrollItemIntoView(dI);this._setLeadItem(dP);this._setAnchorItem(dP);this.__ni=true;this._fireChange();}
,_fireChange:function(dQ){if(this.__ni){this.__nj=dQ||null;this.fireDataEvent(bA,this.getSelection());delete this.__ni;}
;}
...
;return dS;}
;return null;}
},destruct:function(){this._disposeObjects(U);this.__fD=this.__nm=this.__nl=null;this.__nk=null;}
});}
)();
(function(){var a="vertical",b="under",c="above",d="qx.ui.core.selection.Widget",e="left",f="right";qx.Class.define(d,{extend:qx.ui.core.selection.Abstract,construct:function(g){qx.ui.core.selection.Abstract.call(this);this.__mb=g;}
,members:{__mb:null,_isSelectable:function(h){return this._isItemSelectable(h)&&h.getLayoutParent()===this.__mb;}
...
;}
,_getWidget:function(){return this.__mb;}
,_getLocation:function(){var p=this.__mb.getContentElement().getDomElement();return p?qx.bom.element.Location.get(p):null;}
...
,_scrollItemIntoView:function(w){this.__mb.scrollChildIntoView(w);}
,getSelectables:function(x){var y=false;if(!x){y=this._userInteraction;this._userInteraction=true;}
;var B=this.__mb.getChildren();var z=[];var A;for(var i=0,l=B.length;i<l;i++ ){A=B[i];if(this._isItemSelectable(A)){z.push(A);}
;}
;this._userInteraction=y;return z;}
,_getSelectableRange:function(C,D){if(C===D){return [C];}
;var H=this.__mb.getChildren();var E=[];var G=false;var F;for(var i=0,l=H.length;i<l;i++ ){F=H[i];if(F===C||F===D){if(G){E.push(F);break;}
else {G=true;}
;}
;if(G&&this._isItemSelectable(F)){E.push(F);}
;}
;return E;}
,_getFirstSelectable:function(){var I=this.__mb.getChildren();for(var i=0,l=I.length;i<l;i++ ){if(this._isItemSelectable(I[i])){return I[i];}
;}
;return null;}
,_getLastSelectable:function(){var J=this.__mb.getChildren();for(var i=J.length-1;i>0;i-- ){if(this._isItemSelectable(J[i])){return J[i];}
;}
;return null;}
,_getRelatedSelectable:function(N,O){var L=this.__mb.getOrientation()===a;var P=this.__mb.getChildren();var K=P.indexOf(N);var M;if((L&&O===c)||(!L&&O===e)){for(var i=K-1;i>=0;i-- ){M=P[i];if(this._isItemSelectable(M)){return M;}
;}
;}
...
;this.__fz.removeItem(I);}
,selectRange:function(J,K){this.__fz.selectItemRange(J,K);}
,resetSelection:function(){this.__fz.clearSelection();}
,setSelection:function(L){for(var i=0;i<L.length;i++ ){if(!qx.ui.core.Widget.contains(this,L[i])){throw new Error(z+L[i]+g);}
;}
;if(L.length===0){this.resetSelection();}
else {var M=this.getSelection();if(!qx.lang.Array.equals(M,L)){this.__fz.replaceSelection(L);}
;}
;}
...
,getSelectables:function(N){return this.__fz.getSelectables(N);}
,invertSelection:function(){this.__fz.invertSelection();}
,_getLeadItem:function(){var O=this.__fz.getMode();if(O===r||O===b){return this.__fz.getSelectedItem();}
else {return this.__fz.getLeadItem();}
;}
,_applySelectionMode:function(Q,P){this.__fz.setMode(Q);}
,_applyDragSelection:function(S,R){this.__fz.setDrag(S);}
,_applyQuickSelection:function(U,T){this.__fz.setQuick(U);}
...
,splice:function(I,K,M){var Q=this.__lS.length;var L=this.__lS.splice.apply(this.__lS,arguments);if(this.__lS.length!=Q){this.__lT();}
...
;this.__lU(I+(arguments.length-2)-K,this.length);if(O||G){var J=[];for(var i=2;i<arguments.length;i++ ){J[i-2]=arguments[i];}
...
;var R=this.__lS.concat();this.__lS.sort.apply(this.__lS,arguments);if(qx.lang.Array.equals(this.__lS,R)===true){return;}
;this.__lU(0,this.length);this.fireDataEvent(o,{start:0,end:this.length-1,type:c,added:[],removed:[]},null);this.fireDataEvent(r,{value:this.__lS,name:n+(this.length-1),old:R,item:this});}
,unshift:function(T){for(var i=arguments.length-1;i>=0;i-- ){this.__lS.unshift(arguments[i]);this.__lT();this.__lU(0,this.length);this.fireDataEvent(r,{value:[this.__lS[0]],name:p,old:[this.__lS[1]],item:this});this.fireDataEvent(o,{start:0,end:this.length-1,type:b,added:[arguments[i]],removed:[]},null);}
;return this.length;}
,toArray:function(){return this.__lS;}
,getItem:function(U){return this.__lS[U];}
,setItem:function(V,X){var W=this.__lS[V];if(W===X){return;}
;this.__lS[V]=X;this._registerEventChaining(X,W,V);if(this.length!=this.__lS.length){this.__lT();}
...
,indexOf:function(Y){return this.__lS.indexOf(Y);}
,lastIndexOf:function(ba){return this.__lS.lastIndexOf(ba);}
,toString:function(){if(this.__lS!=null){return this.__lS.toString();}
;return f;}
,contains:function(bb){return this.__lS.indexOf(bb)!==-1;}
...
;var bo=this.getLength();var bn=this.__lS.concat();this.__lS.length=0;this.__lT();this.fireDataEvent(r,{value:[],name:n+(bo-1),old:bn,item:this});this.fireDataEvent(o,{start:0,end:bo-1,type:g,removed:bn,added:[]},null);return bn;}
...
;Array.prototype.push.apply(this.__lS,bp);for(var i=0;i<bp.length;i++ ){this._registerEventChaining(bp[i],null,this.__lS.length+i);}
;var bq=this.length;this.__lT();var name=bq==(this.length-1)?bq:bq+a+(this.length-1);this.fireDataEvent(r,{value:bp,name:name+f,old:[],item:this});this.fireDataEvent(o,{start:bq,end:this.length-1,type:b,added:bp,removed:[]},null);}
...
,forEach:function(bx,by){for(var i=0;i<this.__lS.length;i++ ){bx.call(by,this.__lS[i],i,this);}
;}
,filter:function(bz,self){return new qx.data.Array(this.__lS.filter(bz,self));}
,map:function(bA,self){return new qx.data.Array(this.__lS.map(bA,self));}
,some:function(bB,self){return this.__lS.some(bB,self);}
,every:function(bC,self){return this.__lS.every(bC,self);}
,reduce:function(bE,bD){return this.__lS.reduce(bE,bD);}
,reduceRight:function(bG,bF){return this.__lS.reduceRight(bG,bF);}
,__lT:function(){var bH=this.length;this.length=this.__lS.length;this.fireDataEvent(s,this.length,bH);}
,__lU:function(bJ,bI){for(var i=bJ;i<bI;i++ ){this._registerEventChaining(this.__lS[i],this.__lS[i],i);}
;}
},destruct:function(){for(var i=0;i<this.__lS.length;i++ ){var bK=this.__lS[i];this._applyEventPropagation(null,bK,i);if(this.isAutoDisposeItems()&&bK&&bK instanceof qx.core.Object){bK.dispose();}
;}
;this.__lS=null;}
});}
)();
...
(function(){var a="mouse",b="scrollbar-y",c="qx.ui.core.scroll.MRoll",d="pointerdown",f="scrollbar-x",g="roll";qx.Mixin.define(c,{members:{__mF:null,_addRollHandling:function(){this.addListener(g,this._onRoll,this);this.addListener(d,this._onPointerDownForRoll,this);}
...
,_onPointerDownForRoll:function(e){this.__mF=e.getPointerId();}
,_onRoll:function(e){if(e.getPointerType()==a){return;}
;if(this.__mF&&e.getMomentum()){qx.event.Registration.getManager(e.getOriginalTarget()).getHandler(qx.event.handler.Gesture).gestureCancel(this.__mF);e.stopMomentum();this.__mF=null;return;}
;this.__mF=null;var k=this._isChildControlVisible(f);var l=this._isChildControlVisible(b);var q=l?this.getChildControl(b,true):null;var p=k?this.getChildControl(f,true):null;var m=e.getDelta().y;var h=e.getDelta().x;var j=!l;var o=!k;if(q){if(m!==0){q.scrollBy(parseInt(m,10));}
...
(function(){var a="x",b="Float",c="qx.ui.core.MDragDropScrolling",d="",f="). Must be: 'left', 'right', 'top' or 'bottom'",g="bottom",h="interval",i="dragend",j="scrollbar-",k="drag",l="Invalid edge type given (",m="top",n="left",o="right",p="Integer",q="y";qx.Mixin.define(c,{construct:function(){this.addListener(k,this.__mJ,this);this.addListener(i,this.__mK,this);this.__mG=[n,o];this.__mH=[m,g];}
,properties:{dragScrollThresholdX:{check:p,init:30},dragScrollThresholdY:{check:p,init:30},dragScrollSlowDownFactor:{check:b,init:0.1}},members:{__mI:null,__mG:null,__mH:null,_findScrollableParent:function(r){var s=r;if(s===null){return null;}
...
;}
,_getAxis:function(z){if(this.__mG.indexOf(z)!==-1){return a;}
else if(this.__mH.indexOf(z)!==-1){return q;}
else {throw new Error(l+z+f);}
;}
,_getThresholdByEdgeType:function(A){if(this.__mG.indexOf(A)!==-1){return this.getDragScrollThresholdX();}
else if(this.__mH.indexOf(A)!==-1){return this.getDragScrollThresholdY();}
;}
...
;var O=R.getBounds(),N=S===a?O.width:O.height,Q=this._calculateScrollAmount(N,P);if(this._isScrollbarExceedingMaxPos(R,S,Q)){this.__mI.stop();}
;R.scrollBy(Q);}
,__mJ:function(e){if(this.__mI){this.__mI.stop();}
;var V=e.getOriginalTarget();if(!V){return;}
;var T;if(this._isScrollable(V)){T=V;}
else {T=this._findScrollableParent(V);}
;while(T){var X=this._getBounds(T),U=e.getDocumentLeft(),Y=e.getDocumentTop(),bb={"left":X.left-U,"right":X.right-U,"top":X.top-Y,"bottom":X.bottom-Y},W=null,bc=d,ba=0;W=this._getEdgeType(bb,this.getDragScrollThresholdX(),this.getDragScrollThresholdY());if(!W){T=this._findScrollableParent(T);continue;}
;bc=this._getAxis(W);if(this._isScrollbarVisible(T,bc)){ba=this._calculateThresholdExceedance(bb[W],this._getThresholdByEdgeType(W));if(this.__mI){this.__mI.dispose();}
;this.__mI=new qx.event.Timer(50);this.__mI.addListener(h,function(bd,bf,be){this._scrollBy(bd,bf,be);}
.bind(this,T,bc,ba));this.__mI.start();e.stopPropagation();return;}
else {T=this._findScrollableParent(T);}
;}
;}
,__mK:function(e){if(this.__mI){this.__mI.stop();}
;}
},destruct:function(){if(this.__mI){this.__mI.dispose();}
;}
});}
)();
...
,_getContentHint:function(){var J=qx.bom.element.Scroll.getScrollbarWidth();return {width:this.__mL?100:J,maxWidth:this.__mL?null:J,minWidth:this.__mL?null:J,height:this.__mL?J:100,maxHeight:this.__mL?J:null,minHeight:this.__mL?J:null};}
...
,_applyPosition:function(N){var content=this.getContentElement();if(this.__mL){content.scrollToX(N);}
else {content.scrollToY(N);}
;}
,_applyOrientation:function(Q,O){var P=this.__mL=Q===w;this.set({allowGrowX:P,allowShrinkX:P,allowGrowY:!P,allowShrinkY:!P});if(P){this.replaceState(n,w);}
...
,_updateScrollBar:function(){var S=this.__mL;var T=this.getBounds();if(!T){return;}
...
,scrollTo:function(W,V){this.stopScrollAnimation();if(V){var X=this.getPosition();this.__mN=new qx.bom.AnimationFrame();this.__mN.on(d,function(ba){var Y=parseInt(ba/V*(W-X)+X);this.updatePosition(Y);}
,this);this.__mN.on(f,function(){this.setPosition(Math.max(0,Math.min(this.getMaximum(),W)));this.__mN=null;this.fireEvent(p);}
,this);this.__mN.startSequence(V);}
...
,stopScrollAnimation:function(){if(this.__mN){this.__mN.cancelSequence();this.__mN=null;}
;}
,_onScroll:function(e){var bh=this.getContentElement();var bi=this.__mL?bh.getScrollX():bh.getScrollY();this.setPosition(bi);}
...
;var bw=this.__mL;var bu=this.getChildControl(P);var bv=bw?G:L;var bA=bw?e.getDocumentLeft():e.getDocumentTop();var bC=this.getDecorator();bC=qx.theme.manager.Decoration.getInstance().resolve(bC);if(bw){var bz=bC?bC.getInsets().left:0;var by=(this.getPaddingLeft()||0)+bz;}
...
,_onPointerUp:function(e){if(this.__xP){this.releaseCapture();delete this.__xP;this.__xU.stop();this._fireValue();delete this.__xQ;this.getChildControl(P).removeState(c);if(e.getType()===B){var bE;var bF;var bD;if(this.__mL){bE=e.getDocumentLeft()-(this._valueToPosition(this.getValue())+this.__xM);bD=qx.bom.element.Location.get(this.getContentElement().getDomElement())[L];bF=e.getDocumentTop()-(bD+this.getChildControl(P).getBounds().top);}
...
;}
,_onPointerMove:function(e){if(this.__xP){var bH=this.__mL?e.getDocumentLeft():e.getDocumentTop();var bG=bH-this.__xQ;this.slideTo(this._positionToValue(bG));}
...
;this.slideTo(bI);}
,_onUpdate:function(e){var bL=this.getInnerSize();var bM=this.getChildControl(P).getBounds();var bK=this.__mL?E:x;this._updateKnobSize();this.__xX=bL[bK]-bM[bK];this.__xO=bM[bK];this._updateKnobPosition();}
,__mL:false,__xX:0,__xY:function(e){var bN=this.__mL;var bU=bN?e.getDocumentLeft():e.getDocumentTop();var bX=this.__xM;var bO=this.__xN;var bY=this.__xO;var bV=bU-bX;if(bU>=bO){bV-=bY;}
...
,_setKnobPosition:function(ck){var ci=this.getChildControl(P);var cj=this.getDecorator();cj=qx.theme.manager.Decoration.getInstance().resolve(cj);var content=ci.getContentElement();if(this.__mL){if(cj&&cj.getPadding()){ck+=cj.getPadding().left;}
...
;if(this.__mL){this.getChildControl(P).setWidth(Math.round(cm*cl.width));}
...
,stopSlideAnimation:function(){if(this.__mN){this.__mN.cancelSequence();this.__mN=null;}
;}
...
;return cw;}
,__yb:function(cy,cx){cy=this.__ya(cy);var cz=this.getValue();this.__mN=new qx.bom.AnimationFrame();this.__mN.on(i,function(cA){this.setValue(parseInt(cA/cx*(cy-cz)+cz));}
,this);this.__mN.on(j,function(){this.setValue(cy);this.__mN=null;this.fireEvent(O);}
,this);this.__mN.startSequence(cx);}
,_applyOrientation:function(cD,cC){var cB=this.getChildControl(P);this.__mL=cD===N;if(this.__mL){this.removeState(C);cB.removeState(C);this.addState(N);cB.addState(N);cB.setLayoutProperties({top:0,right:null,bottom:0});}
...
else {if(this.__mL){this.getChildControl(P).resetWidth();}
...
,events:{update:m,scrollAnimationEnd:m},properties:{scrollX:{check:j,apply:g,event:f,init:0},scrollY:{check:l,apply:h,event:b,init:0}},members:{__mO:null,add:function(r){var s=this._getChildren()[0];if(s){this._remove(s);s.removeListener(a,this._onUpdate,this);}
...
;this.stopScrollAnimation();if(L){var N=this.getScrollX();this.__mO=new qx.bom.AnimationFrame();this.__mO.on(o,function(){this.setScrollX(O);this.__mO=null;this.fireEvent(c);}
,this);this.__mO.on(i,function(Q){var P=parseInt(Q/L*(O-N)+N);this.setScrollX(P);}
,this);this.__mO.startSequence(L);}
else {this.setScrollX(O);}
;}
,scrollToY:function(U,R){var S=this.getScrollMaxY();if(U<0){U=0;}
else if(U>S){U=S;}
;this.stopScrollAnimation();if(R){var T=this.getScrollY();this.__mO=new qx.bom.AnimationFrame();this.__mO.on(o,function(){this.setScrollY(U);this.__mO=null;this.fireEvent(c);}
,this);this.__mO.on(i,function(W){var V=parseInt(W/R*(U-T)+T);this.setScrollY(V);}
,this);this.__mO.startSequence(R);}
...
,stopScrollAnimation:function(){if(this.__mO){this.__mO.cancelSequence();this.__mO=null;}
;}
...
(function(){var a="qx.ui.form.List",b="text",c="Boolean",d="one",f="addChildWidget",g="__nD",h="_applySpacing",j="Enter",k="Integer",m="action",n="keyinput",o="qx.event.type.Data",p="addItem",q="vertical",r="removeChildWidget",s="",t="_applyOrientation",u="single",v="keypress",w="list",x="horizontal",y="label",z="pane",A="removeItem";qx.Class.define(a,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IForm,qx.ui.form.IModelSelection],include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MMultiSelectionHandling,qx.ui.form.MForm,qx.ui.form.MModelSelection],construct:function(B){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__nD=this._createListItemContainer();this.__nD.addListener(f,this._onAddChild,this);this.__nD.addListener(r,this._onRemoveChild,this);this.getChildControl(z).add(this.__nD);if(B){this.setOrientation(x);}
else {this.initOrientation();}
;this.addListener(v,this._onKeyPress);this.addListener(n,this._onKeyInput);this.__yn=s;}
,events:{addItem:o,removeItem:o},properties:{appearance:{refine:true,init:w},focusable:{refine:true,init:true},orientation:{check:[x,q],init:q,apply:t},spacing:{check:k,init:0,apply:h,themeable:true},enableInlineFind:{check:c,init:true}},members:{__yn:null,__yo:null,__nD:null,SELECTION_MANAGER:qx.ui.core.selection.ScrollArea,getChildrenContainer:function(){return this.__nD;}
...
,_applyOrientation:function(F,C){var D=F===x;var E=D?new qx.ui.layout.HBox():new qx.ui.layout.VBox();var content=this.__nD;content.setLayout(E);content.setAllowGrowX(!D);content.setAllowGrowY(D);this._applySpacing(this.getSpacing());}
,_applySpacing:function(H,G){this.__nD.getLayout().setSpacing(H);}
...
;if(((new Date).valueOf()-this.__yo)>1000){this.__yn=s;}
;this.__yn+=e.getChar();var K=this.findItemByLabelFuzzy(this.__yn);if(K){this.setSelection([K]);}
;this.__yo=(new Date).valueOf();}
...
;if(this.getSelection()==null){this.__yp=new qx.data.Array();this.setSelection(this.__yp);}
;}
,properties:{selection:{check:b,event:f,apply:d,init:null}},events:{"changeSelection":h},members:{_modifingSelection:0,__yq:null,__yr:null,__yp:null,_applySelection:function(k,j){if(this.__yr!=undefined&&j!=undefined){j.removeListenerById(this.__yr);}
;this.__yr=k.addListener(a,this.__ys,this);this._updateSelection();}
,__ys:function(){this._updateSelection();}
,_changeTargetSelection:function(){if(this.getTarget()==null){return;}
;if(!this.__yt()&&!this.__yu()){return;}
;if(this._inSelectionModification()){return;}
;var m=this.getTarget().getSelection();var l=this.getSelection();if(l==null){l=new qx.data.Array();this.__yp=l;this.setSelection(l);}
...
,_addChangeTargetListener:function(p,o){if(this.__yq!=undefined&&o!=undefined){o.removeListenerById(this.__yq);}
;if(p!=null){if(this.__yt()||this.__yu()){this.__yq=p.addListener(f,this._changeTargetSelection,this);}
;}
;}
,_updateSelection:function(){if(!this.getTarget()){return;}
;this._startSelectionModification();if(this.__yt()){var s=[];for(var i=0;i<this.getSelection().length;i++ ){var t=this.getSelection().getItem(i);var u=this.__yv(t);if(u!=null){s.push(u);}
;}
...
;}
;}
else if(this.__yu()){var r=this.getSelection().getItem(this.getSelection().length-1);if(r!==undefined){this.__tb(r);this.getSelection().splice(0,this.getSelection().getLength()-1).dispose();}
else {this.getTarget().resetSelection();}
;}
;this._endSelectionModification();}
,__yt:function(){var v=this.getTarget().constructor;return qx.Class.implementsInterface(v,qx.ui.core.IMultiSelection);}
,__yu:function(){var w=this.getTarget().constructor;return qx.Class.implementsInterface(w,qx.ui.core.ISingleSelection);}
,__tb:function(x){var y=this.__yv(x);if(y==null){return;}
;if(this.__yt()){this.getTarget().addToSelection(y);}
else if(this.__yu()){this.getTarget().setSelection([y]);}
;}
,__yv:function(z){var A=this.getTarget().getSelectables(true);for(var i=0;i<A.length;i++ ){if(A[i].getModel()==z){return A[i];}
;}
;return null;}
...
},destruct:function(){if(this.__yp){this.__yp.dispose();}
;}
});}
)();
...
(function(){var a="changeModel",b="_applyLabelOptions",c="_applyLabelPath",d="changeTarget",e="_applyModel",f="change",g="icon",h="ReverseBindingId",k="qx.data.controller.List",m="_applyIconPath",n="BindingId",o="_applyDelegate",p="",q="changeDelegate",r="_applyTarget",s="]",t="qx.data.IListData",u="model[",v="model",w="label",x="String",y="_applyIconOptions",z=".";qx.Class.define(k,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(A,B,C){qx.core.Object.call(this);this.__xd=[];this.__yw=[];this.__yx=[];this.__yy={};if(C!=null){this.setLabelPath(C);}
;if(A!=null){this.setModel(A);}
;if(B!=null){this.setTarget(B);}
;}
,properties:{model:{check:t,apply:e,event:a,nullable:true,dereference:true},target:{apply:r,event:d,nullable:true,init:null,dereference:true},labelPath:{check:x,apply:c,nullable:true},iconPath:{check:x,apply:m,nullable:true},labelOptions:{apply:b,nullable:true},iconOptions:{apply:y,nullable:true},delegate:{apply:o,event:q,init:null,nullable:true}},members:{__yz:null,__xd:null,__yy:null,__yw:null,__yx:null,__yA:null,__yB:null,update:function(){this.__yD();this.__yH();this._updateSelection();}
,_applyDelegate:function(E,D){this._setConfigureItem(E,D);this._setFilter(E,D);this._setCreateItem(E,D);this._setBindItem(E,D);}
,_applyIconOptions:function(G,F){this.__yH();}
,_applyLabelOptions:function(I,H){this.__yH();}
,_applyIconPath:function(K,J){this.__yH();}
,_applyLabelPath:function(M,L){this.__yH();}
,_applyModel:function(P,N){if(N!=undefined){if(this.__yz!=undefined){N.removeListenerById(this.__yz);}
;}
;if(this.getSelection()!=undefined&&this.getSelection().length>0){this.getSelection().splice(0,this.getSelection().length).dispose();}
;if(P!=null){this.__yz=P.addListener(f,this.__yC,this);this.__xk();this.__yD();if(N==null){this._changeTargetSelection();}
else {this.__yA=true;qx.ui.core.queue.Widget.add(this);}
;}
else {var O=this.getTarget();if(O!=null){var length=O.getChildren().length;for(var i=0;i<length;i++ ){this.__yG();}
;}
;}
;}
...
;if(S!=null){if(this.getModel()!=null){for(var i=0;i<this.__xd.length;i++ ){this.__yF(this.__yJ(i));}
;}
;}
;}
,__yC:function(){this.__yB=true;qx.ui.core.queue.Widget.add(this);if(this.__xd.length!=this.getModel().getLength()){this.update();}
;}
,syncWidget:function(){if(this.__yA){this._changeTargetSelection();}
;if(this.__yB){this._updateSelection();}
;this.__yB=this.__yA=null;}
,__yD:function(){if(this.getTarget()==null){return;}
;this.__xk();var U=this.__xd.length;var T=this.getTarget().getChildren().length;if(U>T){for(var j=T;j<U;j++ ){this.__yF(this.__yJ(j));}
;}
else if(U<T){for(var j=T;j>U;j-- ){this.__yG();}
;}
;this.__yA=true;qx.ui.core.queue.Widget.add(this);}
,__yE:function(){var V=this.getModel();if(V!=null){V.removeListenerById(this.__yz);this.__yz=V.addListener(f,this.__yC,this);}
;}
...
;return W;}
,__yF:function(Y){var ba=this._createItem();this._bindListItem(ba,Y);this.getTarget().add(ba);}
,__yG:function(){this._startSelectionModification();var bc=this.getTarget().getChildren();var bb=bc.length-1;var bd=bc[bb];this._removeBindingsFrom(bd);this.getTarget().removeAt(bb);bd.destroy();this._endSelectionModification();}
...
;}
,bindProperty:function(bo,br,bp,bn,bm){if(bp!=null){var bp=qx.lang.Object.clone(bp);this.__yy[br]=bp.onUpdate;delete bp.onUpdate;}
else {bp={};this.__yy[br]=null;}
;bp.onUpdate=qx.lang.Function.bind(this._onBindingSet,this,bm);bp.ignoreConverter=v;var bq=u+bm+s;if(bo!=null&&bo!=p){bq+=z+bo;}
;var bs=this.bind(bq,bn,br,bp);bn.setUserData(br+n,bs);if(!qx.lang.Array.contains(this.__yw,br)){this.__yw.push(br);}
;}
,bindPropertyReverse:function(by,bv,bw,bx,bt){var bu=u+bt+s;if(by!=null&&by!=p){bu+=z+by;}
;var bz=bx.bind(bv,this,bu,bw);bx.setUserData(by+h,bz);if(!qx.lang.Array.contains(this.__yx,by)){this.__yx.push(by);}
;}
,_onBindingSet:function(bA,bB,bC){if(this.getModel()==null||this._inSelectionModification()){return;}
;for(var i=0;i<this.__yw.length;i++ ){if(this.__yy[this.__yw[i]]!=null){this.__yy[this.__yw[i]]();}
;}
;}
,_removeBindingsFrom:function(bD){for(var i=0;i<this.__yw.length;i++ ){var bE=bD.getUserData(this.__yw[i]+n);if(bE!=null){this.removeBinding(bE);}
;}
;for(var i=0;i<this.__yx.length;i++ ){var bE=bD.getUserData(this.__yx[i]+h);if(bE!=null){bD.removeBinding(bE);}
;}
;}
,__yH:function(){if(this.getTarget()==null||this.getModel()==null){return;}
;var bF=this.getTarget().getChildren();for(var i=0;i<bF.length;i++ ){this._removeBindingsFrom(bF[i]);this._bindListItem(bF[i],this.__yJ(i));}
;this.__yE();}
...
,_setFilter:function(bR,bP){if((bR==null||bR.filter==null)&&(bP!=null&&bP.filter!=null)){this.__yI();}
...
;var bQ=this.__xd;this.__xk();if(bQ.length>this.__xd.length){for(var j=bQ.length;j>this.__xd.length;j-- ){this.getTarget().removeAt(j-1).destroy();}
;}
else if(bQ.length<this.__xd.length){for(var j=bQ.length;j<this.__xd.length;j++ ){var bT=this._createItem();this.getTarget().add(bT);}
;}
;var bS=this.getTarget().getChildren();for(var i=0;i<bS.length;i++ ){this._bindListItem(bS[i],this.__yJ(i));}
;this.__yE();this._endSelectionModification();this._updateSelection();}
,__yI:function(){this.__xk();this.__yD();this.__yH();this.__yB=true;qx.ui.core.queue.Widget.add(this);}
,__xk:function(){var bW=this.getModel();if(bW==null){return;}
;var bX=this.getDelegate();if(bX!=null){var bV=bX.filter;}
;this.__xd=[];for(var i=0;i<bW.getLength();i++ ){if(bV==null||bV(bW.getItem(i))){this.__xd.push(i);}
;}
;}
,__yJ:function(bY){return this.__xd[bY];}
},destruct:function(){this.__xd=this.__yy=this.__yw=null;this.__yx=null;qx.ui.core.queue.Widget.remove(this);}
});}
)();
...
(function(){var a="changeModel",b="__on",c="application/json",d="json",e="aborted",f="loaded",g="qx.event.type.Data",h="error",i="fail",j="receiving",k="queued",l="changeState",m="success",n="String",o="changePhase",p="sending",q="_marshaler",r="completed",s="failed",t="qx.data.store.Json",u="configured",v="changeUrl",w="timeout",x="_applyUrl";qx.Class.define(t,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);this._marshaler=new qx.data.marshal.Json(z);this._delegate=z;if(y!=null){this.setUrl(y);}
;}
,events:{"loaded":g,"error":g},properties:{model:{nullable:true,event:a},state:{check:[u,k,p,j,r,e,w,s],init:u,event:l},url:{check:n,apply:x,event:v,nullable:true}},members:{_marshaler:null,_delegate:null,__on:null,_applyUrl:function(B,A){if(B!=null){B=qx.util.AliasManager.getInstance().resolve(B);B=qx.util.ResourceManager.getInstance().toUri(B);this._createRequest(B);}
;}
,_getRequest:function(){return this.__on;}
,_setRequest:function(C){this.__on=C;}
,_createRequest:function(D){if(this.__on){this.__on.dispose();this.__on=null;}
...
;this.fireDataEvent(f,this.getModel());if(this.__on){this.__on.dispose();this.__on=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__on!=null){this._disposeObjects(b);}
...
},members:{__tw:null,__tx:function(z){return Object.keys(z).sort().join(a);}
,toClass:function(A,B){this.__ty(A,B,null,0);}
,__ty:function(N,I,C,K){if(!qx.lang.Type.isObject(N)||!!N.$$isString||N instanceof qx.core.Object){if(N instanceof Array||qx.Bootstrap.getClass(N)==h){for(var i=0;i<N.length;i++ ){this.__ty(N[i],I,C+o+i+m,K+1);}
;}
;return;}
;var E=this.__tx(N);if(this.__tC(E,C,K)){return;}
;for(var M in N){this.__ty(N[M],I,M,K+1);}
;if(qx.Class.isDefined(s+E)){return;}
;if(this.__tw&&this.__tw.getModelClass&&this.__tw.getModelClass(E,N,C,K)!=null){return;}
;var O={};var F={__tz:this.__tz};for(var M in N){if(this.__tw&&this.__tw.getPropertyMapping){M=this.__tw.getPropertyMapping(M,E);}
...
;if(this.__tw&&this.__tw.getValidationRule){var H=this.__tw.getValidationRule(E,M);if(H){O[M].validate=k+M;F[k+M]=H;}
;}
;}
;if(this.__tw&&this.__tw.getModelSuperClass){var L=this.__tw.getModelSuperClass(E,C,K)||qx.core.Object;}
else {var L=qx.core.Object;}
;var G=[];if(this.__tw&&this.__tw.getModelMixins){var J=this.__tw.getModelMixins(E,C,K);if(!qx.lang.Type.isArray(J)){if(J!=null){G=[J];}
;}
else {G=J;}
;}
;if(I){G.push(qx.data.marshal.MEventBubbling);}
;var D={extend:L,include:G,properties:O,members:F,destruct:this.__tA};qx.Class.define(s+E,D);}
,__tA:function(){var P=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var Q in P){this.__tz(this.get(P[Q].name));}
;}
,__tz:function(R){if(!(R instanceof qx.core.Object)){return;}
;if(R.isDisposed()){return;}
;R.dispose();}
,__tB:function(S,W,X,V){var Y;if(this.__tw&&this.__tw.getModelClass){Y=this.__tw.getModelClass(S,W,X,V);}
;if(Y!=null){return (new Y());}
else {var U=s+S;var T=qx.Class.getByName(U);if(!T){throw new Error(b+U+l);}
;return (new T());}
;}
,__tC:function(ba,bd,bb){var bc=this.__tw;return bc&&bc.ignore&&bc.ignore(ba,bd,bb);}
,toModel:function(be){return this.__tD(be,null,0);}
,__tD:function(bo,bg,bl){var bk=qx.lang.Type.isObject(bo);var bf=bo instanceof Array||qx.Bootstrap.getClass(bo)==h;if((!bk&&!bf)||!!bo.$$isString||bo instanceof qx.core.Object){return bo;}
else if(this.__tC(this.__tx(bo),bg,bl)){return bo;}
else if(bf){var bp=new qx.data.Array();bp.setAutoDisposeItems(true);for(var i=0;i<bo.length;i++ ){bp.push(this.__tD(bo[i],bg+o+i+m,bl+1));}
;return bp;}
else if(bk){var bh=this.__tx(bo);var bn=this.__tB(bh,bo,bg,bl);for(var bm in bo){var bi=bm;if(this.__tw&&this.__tw.getPropertyMapping){bi=this.__tw.getPropertyMapping(bm,bh);}
;var bq=bi.replace(/-|\.|\s+/g,d);if((qx.core.Environment.get(t))&&qx.core.Environment.get(e)){if(bq!=bi){this.warn(c+bm+n+bi+v);}
;}
;bi=bq;var bj=p+qx.lang.String.firstUp(bi);if(bn[bj]){bn[bj](this.__tD(bo[bm],bm,bl+1));}
;}
;return bn;}
;throw new Error(j);}
...
;this.__nW={};var P=this._transport=this._createTransport();this._setPhase(G);this.__ua=qx.lang.Function.bind(this._onReadyStateChange,this);this.__ub=qx.lang.Function.bind(this._onLoad,this);this.__uc=qx.lang.Function.bind(this._onLoadEnd,this);this.__ud=qx.lang.Function.bind(this._onAbort,this);this.__ue=qx.lang.Function.bind(this._onTimeout,this);this.__uf=qx.lang.Function.bind(this._onError,this);P.onreadystatechange=this.__ua;P.onload=this.__ub;P.onloadend=this.__uc;P.onabort=this.__ud;P.ontimeout=this.__ue;P.onerror=this.__uf;}
...
,nullable:true},authentication:{check:k,nullable:true}},members:{__ua:null,__ub:null,__uc:null,__ud:null,__ue:null,__uf:null,__ug:null,__uh:null,__ui:null,__nW:null,__uj:null,_transport:null,_createTransport:function(){throw new Error(E);}
...
;this.__uh=true;this.__ui=s;this._transport.abort();}
,_setRequestHeaders:function(){var X=this._transport,W=this._getAllRequestHeaders();for(var Y in W){X.setRequestHeader(Y,W[Y]);}
;}
,_getAllRequestHeaders:function(){var ba={};qx.lang.Object.mergeWith(ba,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(ba,this.__uk());qx.lang.Object.mergeWith(ba,this.__uj);qx.lang.Object.mergeWith(ba,this.__nW);return ba;}
,__uk:function(){var bc=this.getAuthentication(),bb={};if(bc){bc.getAuthHeaders().forEach(function(bd){bb[bd.key]=bd.value;}
);return bb;}
;}
,setRequestHeader:function(be,bf){this.__nW[be]=bf;}
,getRequestHeader:function(bg){return this.__nW[bg];}
,removeRequestHeader:function(bh){if(this.__nW[bh]){delete this.__nW[bh];}
;}
,getTransport:function(){return this._transport;}
,getReadyState:function(){return this._transport.readyState;}
,getPhase:function(){return this.__ui;}
...
,getResponse:function(){return this.__ug;}
,_setResponse:function(bl){var bk=bl;if(this.__ug!==bl){this.__ug=bl;this.fireEvent(H,qx.event.type.Data,[this.__ug,bk]);}
;}
,_onReadyStateChange:function(){var bm=this.getReadyState();if(qx.core.Environment.get(f)){this.debug(B+bm);}
;this.fireEvent(D);if(this.__uh){return;}
;if(bm===3){this._setPhase(p);}
;if(this.isDone()){this.__ul();}
;}
,__ul:function(){if(qx.core.Environment.get(f)){this.debug(A+this.getStatus());}
...
,_setPhase:function(bo){var bp=this.__ui;if(qx.core.Environment.get(m)){qx.core.Assert.assertString(bo);qx.core.Assert.assertMatch(bo,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__ui=bo;this.fireDataEvent(c,bo,bp);}
...
;var A=z[h+qx.lang.String.firstUp(name)]();if(qx.lang.Type.isArray(A)){var D=qx.data&&qx.data.IListData&&qx.Class.hasInterface(A&&A.constructor,qx.data.IListData);for(var i=0;i<A.length;i++ ){var F=D?A.getItem(i):A[i];E+=this.__um(name,F,C);}
;}
else if(qx.lang.Type.isDate(A)&&y!=null){E+=this.__um(name,y.format(A),C);}
else {E+=this.__um(name,A,C);}
;}
;return E.substring(0,E.length-1);}
,__um:function(name,I,G){if(I&&I.$$type==o){I=I.classname;}
...
(function(){var a="Retry open native request with method: ",b="activex",c="No XHR support available.",d="If-None-Match",f="xhr",g="If-Modified-Since",h="engine.version",i="onunload",j="GET",k="-1",l="qx.debug.io",m="Open native request with method: ",n="error",o="loadend",p="load",q="Received native readyState: ",r="abort",s=", url: ",t="browser.documentmode",u="",v="readystatechange",w="Microsoft.XMLHTTP",x="Already disposed",y="browser.version",z="opera",A="qx.bom.request.Xhr",B="on",C="gecko",D="If-Match",E="mshtml",F="engine.name",G="Microsoft.XMLDOM",H="file:",I="Send native request",J="If-Range",K="Content-Type",L="io.xhr",M="Not enough arguments",N="timeout",O="undefined",P=", async: ",Q="Native XHR object doesn't support overrideMimeType.";qx.Bootstrap.define(A,{extend:Object,construct:function(){var R=qx.Bootstrap.bind(this.__uB,this);if(qx.event&&qx.event.GlobalError&&qx.event.GlobalError.observeMethod){this.__uo=qx.event.GlobalError.observeMethod(R);}
else {this.__uo=R;}
;this.__up=qx.Bootstrap.bind(this.__uA,this);this.__ue=qx.Bootstrap.bind(this.__uF,this);this.__uz();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__uq=qx.Bootstrap.bind(this.__uI,this);window.attachEvent(i,this.__uq);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":A,"error":A,"loadend":A,"timeout":A,"abort":A,"load":A},members:{readyState:0,responseText:u,responseXML:null,status:0,statusText:u,timeout:0,open:function(W,S,T,V,U){this.__uK();if(typeof S===O){throw new Error(M);}
else if(typeof W===O){W=j;}
;this.__uh=false;this.__ur=false;this.__us=false;this.__ut=S;if(typeof T==O){T=true;}
;this.__uu=T;if(!this.__uJ()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__uz();}
;this.__uw.onreadystatechange=this.__uo;try{if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,m+W+s+S+P+T);}
;this.__uw.open(W,S,T,V,U);}
catch(X){if(!qx.util.Request.isCrossDomain(S)){throw X;}
;if(!this.__uu){this.__uv=X;}
;if(this.__uu){if(window.XDomainRequest){this.readyState=4;this.__uw=new XDomainRequest();this.__uw.onerror=qx.Bootstrap.bind(function(){this._emit(v);this._emit(n);this._emit(o);}
,this);if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,a+W+s+S+P+T);}
;this.__uw.open(W,S,T,V,U);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__uy){return;}
;this.readyState=4;this._emit(v);this._emit(n);this._emit(o);}
,this));}
;}
;if(qx.core.Environment.get(F)===E&&qx.core.Environment.get(t)<9&&this.__uw.readyState>0){this.__uw.setRequestHeader(g,k);}
;if(qx.core.Environment.get(F)===C&&parseInt(qx.core.Environment.get(h),10)<2&&!this.__uu){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(v);}
;}
,setRequestHeader:function(Y,ba){this.__uK();if(Y==D||Y==g||Y==d||Y==J){this.__us=true;}
;this.__uw.setRequestHeader(Y,ba);return this;}
,send:function(bb){this.__uK();if(!this.__uu&&this.__uv){throw this.__uv;}
;if(qx.core.Environment.get(F)===z&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__ux=window.setTimeout(this.__ue,this.timeout);}
;bb=typeof bb==O?null:bb;try{if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,I);}
;this.__uw.send(bb);}
catch(bd){if(!this.__uu){throw bd;}
;if(this._getProtocol()===H){this.readyState=2;this.__uC();var bc=this;window.setTimeout(function(){if(bc.__uy){return;}
;bc.readyState=3;bc.__uC();bc.readyState=4;bc.__uC();}
);}
;}
;if(qx.core.Environment.get(F)===C&&!this.__uu){this.__uB();}
;this.__ur=true;return this;}
,abort:function(){this.__uK();this.__uh=true;this.__uw.abort();if(this.__uw){this.readyState=this.__uw.readyState;}
;return this;}
...
,getResponseHeader:function(bg){this.__uK();return this.__uw.getResponseHeader(bg);}
,getAllResponseHeaders:function(){this.__uK();return this.__uw.getAllResponseHeaders();}
,overrideMimeType:function(bh){this.__uK();if(this.__uw.overrideMimeType){this.__uw.overrideMimeType(bh);}
else {throw new Error(Q);}
;return this;}
,getRequest:function(){return this.__uw;}
,dispose:function(){if(this.__uy){return false;}
;window.clearTimeout(this.__ux);if(window.detachEvent){window.detachEvent(i,this.__uq);}
;try{this.__uw.onreadystatechange;}
catch(bj){return false;}
;var bi=function(){}
;this.__uw.onreadystatechange=bi;this.__uw.onload=bi;this.__uw.onerror=bi;this.abort();this.__uw=null;this.__uy=true;return true;}
,isDisposed:function(){return !!this.__uy;}
...
,_getProtocol:function(){var bl=this.__ut;var bm=/^(\w+:)\/\//;if(bl!==null&&bl.match){var bn=bl.match(bm);if(bn&&bn[1]){return bn[1];}
;}
;return window.location.protocol;}
,__uw:null,__uu:null,__uo:null,__up:null,__uq:null,__ue:null,__ur:null,__ut:null,__uh:null,__fy:null,__uy:null,__ux:null,__uv:null,__us:null,__uz:function(){this.__uw=this._createNativeXhr();this.__uw.onreadystatechange=this.__uo;if(this.__uw.onabort){this.__uw.onabort=this.__up;}
;this.__uy=this.__ur=this.__uh=false;}
,__uA:function(){if(!this.__uh){this.abort();}
;}
,__uB:function(){var bo=this.__uw,bp=true;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,q+bo.readyState);}
;if(this.readyState==bo.readyState){return;}
;this.readyState=bo.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__uh&&!this.__ur){return;}
;if(!this.__uu&&(bo.readyState==2||bo.readyState==3)){return;}
...
;if(bp){this.__uG();this.__uH();}
;}
;this.__uC();if(this.readyState==qx.bom.request.Xhr.DONE){if(bo){bo.onreadystatechange=function(){}
;}
;}
;}
,__uC:function(){var br=this;if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__ux);}
;if(qx.core.Environment.get(F)==E&&qx.core.Environment.get(t)<8){if(this.__uu&&!this.__ur&&this.readyState>=qx.bom.request.Xhr.LOADING){if(this.readyState==qx.bom.request.Xhr.LOADING){return;}
;if(this.readyState==qx.bom.request.Xhr.DONE){window.setTimeout(function(){if(br.__uy){return;}
;br.readyState=3;br._emit(v);br.readyState=4;br._emit(v);br.__uD();}
);return;}
;}
;}
;this._emit(v);if(this.readyState===qx.bom.request.Xhr.DONE){this.__uD();}
;}
,__uD:function(){if(this.__fy){this._emit(N);if(qx.core.Environment.get(F)===z){this._emit(n);}
;this.__fy=false;}
else {if(this.__uh){this._emit(r);}
else {if(this.__uE()){this._emit(n);}
else {this._emit(p);}
;}
;}
;this._emit(o);}
,__uE:function(){var bs;if(this._getProtocol()===H){bs=!this.responseText;}
else {bs=!this.statusText;}
;return bs;}
,__uF:function(){var bt=this.__uw;this.readyState=qx.bom.request.Xhr.DONE;this.__fy=true;bt.abort();this.responseText=u;this.responseXML=null;this.__uC();}
,__uG:function(){var bu=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===H&&this.status===0&&bu){if(!this.__uE()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(F)===z){if(bu&&this.__us&&!this.__uh&&this.status===0){this.status=304;}
;}
;}
,__uH:function(){if(qx.core.Environment.get(F)==E&&(this.getResponseHeader(K)||u).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bv=new window.ActiveXObject(G);bv.async=false;bv.validateOnParse=false;bv.loadXML(this.responseText);this.responseXML=bv;}
;}
,__uI:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__uJ:function(){var name=qx.core.Environment.get(F);var bw=qx.core.Environment.get(y);return !(name==E&&bw<9||name==C&&bw<3.5);}
,__uK:function(){if(this.__uy){throw new Error(x);}
;}
...
;}
,statics:{PARSER:{json:qx.lang.Json.parse,xml:qx.xml.Document.fromString}},members:{__un:null,parse:function(h,g){var f=this._getParser(g);if(typeof f===a){if(h!==c){return f.call(this,h);}
;}
;return h;}
,setParser:function(i){if(typeof qx.util.ResponseParser.PARSER[i]===a){return this.__un=qx.util.ResponseParser.PARSER[i];}
;if(qx.core.Environment.get(d)){qx.core.Assert.assertFunction(i);}
;return this.__un=i;}
,_getParser:function(k){var j=this.__un,m=c,l=c;if(j){return j;}
