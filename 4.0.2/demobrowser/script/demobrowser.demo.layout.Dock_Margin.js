...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Dock_Margin","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Dock_Margin.1722ac97497e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="east",b="yellow",c="center",d="red",e="bottom",f="north",g="south",h="west",i="x",j="green",k="demobrowser.demo.layout.Dock_Margin",l="fuchsia",m="orange",n="main",o="y",p="blue";qx.Class.define(k,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var r=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(r);var q=new qx.ui.container.Composite(new qx.ui.layout.Dock(3,10)).set({decorator:n,backgroundColor:b,allowGrowX:false});var x=new qx.ui.core.Widget().set({decorator:n,backgroundColor:d});var w=new qx.ui.core.Widget().set({decorator:n,backgroundColor:p,marginLeft:20});var v=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,marginTop:20});var u=new qx.ui.core.Widget().set({decorator:n,backgroundColor:j,maxHeight:20,alignY:e});var t=new qx.ui.core.Widget().set({decorator:n,backgroundColor:l});q.add(x,{edge:f});q.add(w,{edge:h});q.add(v,{edge:g});q.add(u,{edge:a});q.add(t,{edge:c});r.add(q);var s=new qx.ui.layout.Dock(3,10);s.setSort(o);var q=(new qx.ui.container.Composite(s)).set({decorator:n,backgroundColor:b,allowGrowX:false});var x=new qx.ui.core.Widget().set({decorator:n,backgroundColor:d});var w=new qx.ui.core.Widget().set({decorator:n,backgroundColor:p,marginLeft:20});var v=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,marginTop:20});var u=new qx.ui.core.Widget().set({decorator:n,backgroundColor:j,maxHeight:20,alignY:e});var t=new qx.ui.core.Widget().set({decorator:n,backgroundColor:l});q.add(x,{edge:f});q.add(w,{edge:h});q.add(v,{edge:g});q.add(u,{edge:a});q.add(t,{edge:c});r.add(q);var s=new qx.ui.layout.Dock(3,10);s.setSort(i);var q=(new qx.ui.container.Composite(s)).set({decorator:n,backgroundColor:b,allowGrowX:false});var x=new qx.ui.core.Widget().set({decorator:n,backgroundColor:d});var w=new qx.ui.core.Widget().set({decorator:n,backgroundColor:p,marginLeft:20});var v=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,marginTop:20});var u=new qx.ui.core.Widget().set({decorator:n,backgroundColor:j,maxHeight:20,alignY:e});var t=new qx.ui.core.Widget().set({decorator:n,backgroundColor:l});q.add(x,{edge:f});q.add(w,{edge:h});q.add(v,{edge:g});q.add(u,{edge:a});q.add(t,{edge:c});r.add(q);}
}});}
)();
