...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Flickr.27dfa165b4ab.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var M=this.__yk(),L=this.__ye,N=this;if(this.timeout>0){this.__fw=window.setTimeout(this.__ue,this.timeout);}
...
;if(this.__fw){window.clearTimeout(this.__fw);}
;this.__uy=true;}
;}
,isDisposed:function(){return !!this.__uy;}
...
,__yg:null,__ye:null,__ut:n,__yc:null,__yd:null,__ue:null,__fw:null,__uh:null,__uy:null,__yh:function(){this.readyState=0;this.status=0;this.statusText=n;}
...
,members:{responseJson:null,__cj:null,__uL:null,__uM:null,__uN:null,__uO:null,__uP:null,__uy:null,__uQ:e,open:function(t,p){if(this.__uy){return;}
;var r={},q,s,o=this;this.responseJson=null;this.__uN=false;q=this.__uL||b;s=this.__uM||this.__uQ+n+this.__cj+m;if(!this.__uM){this.constructor[this.__cj]=this;}
...
;r[q]=s;this.__uP=p=qx.util.Uri.appendParamsToUrl(p,r);this.__go(c,[t,p]);}
...
;this.responseJson=v;this.constructor[this.__cj]=undefined;this.__uR();}
...
,dispose:function(){this.__uR();this.__go(d);}
,_onNativeLoad:function(){this.status=this.__uN?200:500;this.__go(i);}
,__uR:function(){if(this.__uO&&window[this.__uM]){window[this.__uM]=undefined;this.__uO=false;}
;}
,__go:function(z,y){qx.bom.request.Script.prototype[z].apply(this,y||[]);}
,__uS:function(){this.__cj=f+(new Date().valueOf())+(e+Math.random()).substring(2,5);}
}});}
)();
...
}});qx.Class.define(n,{extend:qx.data.store.Jsonp,construct:function(R){this.setCallbackName(z);qx.data.store.Jsonp.call(this,this.__OU(R));}
,members:{searchForTag:function(S){if(S!=t){this.setUrl(this.__OU(S));}
;}
,__OU:function(U){if(!U){return;}
