...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Label.0f71800be823.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Big Long Label Cutted",b="My First Long Label Cutted",c="Verdana",d="sans-serif",e="rich label",f="top",g="native context menu",h="text label",i="configure rich label",j="demobrowser.demo.widget.Label",k="selectable",l="rich",m="value",n="nativeContextMenu",o="right",p="configure text label",q="A long label text with auto-wrapping. This also may contain <b style='color:red'>rich HTML</b> markup.",r="main",s="Big Long Label",t="execute";qx.Class.define(j,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var u=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});this.getRoot().add(u);var v=new qx.ui.basic.Label(h).set({decorator:r,width:200});u.add(v);this.getRoot().add(this.createConfigureButton(v,p),{left:240,top:20});var w=new qx.ui.basic.Label(e).set({decorator:r,rich:true});u.add(w);this.getRoot().add(this.createConfigureButton(w,i),{left:240,top:60});var x=new qx.ui.basic.Label(b).set({decorator:r,width:80});u.add(x);var y=new qx.ui.basic.Label().set({value:q,decorator:r,rich:true,width:120});u.add(y);var z=new qx.ui.basic.Label(s).set({decorator:r,font:new qx.bom.Font(28,[c,d])});u.add(z);var A=new qx.ui.basic.Label(a).set({decorator:r,font:new qx.bom.Font(28,[c,d]),width:150});u.add(A);}
,createConfigureButton:function(C,E){var D=new qx.ui.form.Button(E);var B;D.addListener(t,function(){if(!B){B=this.createEditDialog(C,E);}
;B.open();}
,this);return D;}
,createEditDialog:function(F,K){var I=new qx.ui.window.Window(K).set({allowMinimize:false,showMinimize:false,allowMaximize:false,showMaximize:false});I.moveTo(350,20);var G=new qx.ui.layout.Grid(10,10);G.setColumnFlex(1,1);G.setColumnAlign(0,o,f);I.setLayout(G);var L=new qx.data.controller.Object(F);I.add(new qx.ui.basic.Label(m).set({paddingTop:5}),{row:0,column:0});var H=new qx.ui.form.TextArea().set({liveUpdate:true});L.addTarget(H,m,m,true);I.add(H,{row:0,column:1});I.add(new qx.ui.basic.Label(k),{row:1,column:0});var J=new qx.ui.form.CheckBox();L.addTarget(J,m,k,true);I.add(J,{row:1,column:1});I.add(new qx.ui.basic.Label(g),{row:2,column:0});var J=new qx.ui.form.CheckBox();L.addTarget(J,m,n,true);I.add(J,{row:2,column:1});I.add(new qx.ui.basic.Label(l),{row:3,column:0});var J=new qx.ui.form.CheckBox().set({enabled:false});L.addTarget(J,m,l);I.add(J,{row:3,column:1});return I;}
}});}
)();
