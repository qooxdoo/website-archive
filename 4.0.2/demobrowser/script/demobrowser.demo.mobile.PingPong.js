...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.8a10b02f2a70.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__Pp=this.__Pt(L);U.add(this.__Pp);var Q=this.__Pt(A);U.add(Q);this.__Pg=this.__Pu(L);this.__Pp.add(this.__Pg);this.__Pp.addListener(M,qx.lang.Function.bind(this.__AA,this),this);this.__Pf=this.__Pu(A);Q.add(this.__Pf);Q.addListener(M,qx.lang.Function.bind(this.__AA,this),this);this.__Ph=this.__Pv();U.add(this.__Ph);this.__Pn=this.__Pw();this.__Pp.add(this.__Pn);this.__Po=this.__Pw();Q.add(this.__Po);this.__Pm=[0,0];this.__Pq();}
,__Pq:function(){this.__Ph.setStyles({"left":k,"top":k});this.__Pi=new qx.event.Timer(40);this.__Pi.addListener(n,function(){var x=(parseInt(this.__Ph.getStyle(L))+this.__Pj*this.__Pk);var y=(parseInt(this.__Ph.getStyle(z))+this.__Pj*this.__Pl);this.__Ph.setStyle(L,x+c);this.__Ph.setStyle(z,y+c);this.__Ps();}
,this);this.__Pi.start();}
,__Pr:function(V){this.__Pi.stop();this.__Pi.dispose();this.__Pj=5;this.__Pm[V]=this.__Pm[V]+1;this.__Pn.setAttribute(w,this.__Pm[0]);this.__Po.setAttribute(w,this.__Pm[1]);this.__Pq();}
,__Ps:function(){var X=this.getBoundsFor(this.__Ph);if(X.top<=0){this.__Pl=1;}
;if(X.bottom>=window.innerHeight-5){this.__Pl=-1;}
;if(X.left<=0||X.right>=window.innerWidth){this.__Pr(X.left<=0?1:0);}
;var Y=this.getBoundsFor(this.__Pg);if(X.left<=Y.right&&X.bottom>=Y.top&&X.top<=Y.bottom){this.__Pk=1;this.__Pj=Math.min(this.__Pj+1,20);}
;var W=this.getBoundsFor(this.__Pf);if(X.right>=W.left&&X.bottom>=W.top&&X.top<=W.bottom){this.__Pk=-1;this.__Pj=Math.min(this.__Pj+1,20);}
;}
,__AA:function(e){var ba;if(qx.dom.Hierarchy.contains(this.__Pp.getDomElement(),e.getTarget())){ba=this.__Pg;}
else {ba=this.__Pf;}
...
,__Pt:function(bd){var bc={"width":C,"height":h,"position":N,"backgroundColor":a};if(bd==L){bc[J]=u;}
else {bc[L]=C;bc[d]=u;}
;return new qx.html.Element(g,bc);}
,__Pu:function(bf){var be={"width":l,"height":t,"top":t,"position":N,"backgroundColor":K};be[bf]=F;return new qx.html.Element(g,be);}
,__Pv:function(){var bg={"width":F,"height":F,"position":N,"backgroundColor":K,"userSelect":I};return new qx.html.Element(g,bg);}
,__Pw:function(){var bh={"width":h,"height":h,"textAlign":r,"fontSize":H,"color":b,"fontFamily":B};var bi=new qx.html.Element(g,bh);bi.setAttribute(w,j);return bi;}
}});}
)();
