...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.d842f43d0f4e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="qx.util.TimerManager",b="interval",c="singleton";qx.Class.define(a,{extend:qx.core.Object,type:c,statics:{__FN:[],__FO:{},__ux:0},members:{__FP:false,start:function(g,f,h,d,j){if(!j){j=f||0;}
;var e=(new Date()).getTime()+j;this.self(arguments).__FO[ ++this.self(arguments).__ux]={callback:g,userData:d||null,expireAt:e,recurTime:f,context:h||this};this.__FQ(e,this.self(arguments).__ux);return this.self(arguments).__ux;}
