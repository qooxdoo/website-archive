...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event.352919a9bab0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;event.stop();}
;}
,__gK:function(event){if(this.getEnabled()&&this.__tQ(event)){if(this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,_applyEnabled:function(W,V){if(W){qx.event.Registration.addListener(document.documentElement,n,this.__tP,this);qx.event.Registration.addListener(document.documentElement,O,this.__gK,this);}
else {qx.event.Registration.removeListener(document.documentElement,n,this.__tP,this);qx.event.Registration.removeListener(document.documentElement,O,this.__gK,this);}
;}
