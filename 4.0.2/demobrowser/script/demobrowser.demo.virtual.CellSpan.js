...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellSpan.7710fd013091.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,getCellProperties:function(s,q){var r=(s+q)%2==0?c:h;this.__PN.setBackgroundColor(r);return this.__PN.getCellProperties(s+a+q);}
...
;this.__dM=qx.bom.Stylesheet.createElement(p);this.__BL={};this.__ml={};}
,members:{__dM:null,__BL:null,__ml:null,getStylesheet:function(){return this.__dM;}
,getCssClass:function(q){return this.__BL[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__ml[r];if(!s){var s=this.__BM();qx.bom.Stylesheet.addRule(this.__dM,k+s,r);this.__ml[r]=s;}
;this.__BL[t]=s;return s;}
,__BM:function(){return e+this.toHashCode()+a+(this.__BN++ );}
,__BN:0},destruct:function(){this.__dM=this.__BL=this.__ml=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__dM=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__BO={};this.__BP={};this.__BQ={};this.__BR={};this.__iy={};this.__BS={};this.initAppearance();this.__BW();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__BT:null,__BU:null,__iy:null,__BS:null,__BP:null,__BO:null,__BQ:null,__BR:null,__BV:false,__dM:null,__BW:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__BT=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__BT.push(N);}
;}
;O=O.superclass;}
;}
...
,getCssClasses:function(br,bp){var bq=this.__dM.getCssClass(this.__BU)||t;return v+bq;}
,__BX:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__BU==bt){return;}
;this.__BU=bt;var bv=this.__iy[this.__BU];if(!bv){this.__BY();this.__Ca(bs);this.__Cb(bs);this.__Cc();this.__iy[this.__BU]=1;}
;this.__Cd();}
...
;}
;this.__BV=false;}
,__Cb:function(){var bD=qx.lang.Object.getValues(this.__BP).join(I);this.__dM.computeClassForStyles(this.__BU,bD);}
...
},destruct:function(){this.__dM=this.__BO=this.__BP=this.__BQ=this.__BR=this.__iy=this.__BS=this.__BT=null;}
});}
)();
...
,properties:{anonymous:{refine:true,init:true}},members:{__iG:null,__bH:null,__xp:null,__xq:null,__wP:null,__qe:null,getFirstRow:function(){return this.__xp;}
...
;if(this.__iG.fullUpdate||this.__iG.updateLayerWindow&&this.__iG.updateLayerData){this._fullUpdate.apply(this,this.__bH);}
else if(this.__iG.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bH);}
else if(this.__iG.updateLayerData&&this.__wP){this._updateLayerData();}
;if(this.__iG.fullUpdate||this.__iG.updateLayerWindow){var d=this.__bH;this.__xp=d[0];this.__xq=d[1];this.__wP=d[2];this.__qe=d[3];}
;this.__iG={};}
...
,fullUpdate:function(p,q,o,n){this.__bH=arguments;this.__iG.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bH=arguments;this.__iG.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__iG=this.__bH=this.__wP=this.__qe=null;}
});}
)();
...
(function(){var a="</div>",b="top:",c="",d=">",e="_spanManager",f="<div ",g="' ",h="qx.ui.virtual.layer.HtmlCellSpan",j="style='",k="px;",m="class='",n="x",o="left:",p="html";qx.Class.define(h,{extend:qx.ui.virtual.layer.HtmlCell,construct:function(r,s,q){qx.ui.virtual.layer.HtmlCell.call(this,r);this._spanManager=new qx.ui.virtual.layer.CellSpanManager(s,q);}
,members:{setCellSpan:function(z,t,u,v){var w=z+n+t;this._spanManager.removeCell(w);if(u>1||v>1){this._spanManager.addCell(w,z,t,u,v);}
;qx.ui.core.queue.Widget.add(this);}
,__If:function(G,A,C,H,top,F,D){var B=this._cellProvider.getCellProperties(A,C);var E=B.insets||[0,0];G.push(f,j,o,H,k,b,top,k,this._getCellSizeStyle(F,D,E[0],E[1]),B.style||c,g,m,B.classes||c,g,B.attributes||c,d,B.content||c,a);}
,_fullUpdate:function(P,K,T,N){var S=[];var M=this._spanManager.findCellsInWindow(P,K,T.length,N.length);if(M.length>0){var O=this._spanManager.getCellBounds(M,P,K);var I=this._spanManager.computeCellSpanMap(M,P,K,T.length,N.length);for(var i=0,l=M.length;i<l;i++ ){var R=M[i];var J=O[i];this.__If(S,R.firstRow,R.firstColumn,J.left,J.top,J.width,J.height);}
;}
else {I=[];for(var i=0;i<T.length;i++ ){I[P+i]=[];}
;}
;var U=0;var top=0;var W=P;var L=K;for(var x=0;x<T.length;x++ ){var U=0;var L=K;var Q=T[x];for(var y=0;y<N.length;y++ ){var V=N[y];if(!I[W][L]){this.__If(S,W,L,U,top,V,Q);}
;L++ ;U+=V;}
;top+=Q;W++ ;}
;this.getContentElement().setAttribute(p,S.join(c));}
},destruct:function(){this._disposeObjects(e);}
});}
)();
(function(){var c="lastColumn",d="change",f="qx.debug",g="firstColumn",h="firstRow",j="qx.ui.virtual.layer.CellSpanManager",k="lastRow";qx.Class.define(j,{extend:qx.core.Object,construct:function(n,m){qx.core.Object.call(this);if(qx.core.Environment.get(f)){this.assertInstance(n,qx.ui.virtual.core.Axis);this.assertInstance(m,qx.ui.virtual.core.Axis);}
;this._cells={};this._invalidateSortCache();this._invalidatePositionCache();n.addListener(d,this._onRowConfigChange,this);m.addListener(d,this._onColumnConfigChange,this);this._rowConfig=n;this._columnConfig=m;}
,members:{addCell:function(r,s,o,p,q){this._cells[r]={firstRow:s,lastRow:s+p-1,firstColumn:o,lastColumn:o+q-1,id:r};this._invalidateSortCache();}
,removeCell:function(t){delete (this._cells[t]);this._invalidateSortCache();}
,_invalidateSortCache:function(){this._sorted={};}
,_getSortedCells:function(v){if(this._sorted[v]){return this._sorted[v];}
;var u=this._sorted[v]=qx.lang.Object.getValues(this._cells);u.sort(function(a,b){return a[v]<b[v]?-1:1;}
);return u;}
,_findCellsInRange:function(D,x,y){var z=this._getSortedCells(D);if(z.length==0){return {};}
;var B=0;var w=z.length-1;while(true){var E=B+((w-B)>>1);var A=z[E];if(A[D]>=x&&(E==0||z[E-1][D]<x)){break;}
;if(A[D]>=x){w=E-1;}
else {B=E+1;}
;if(B>w){return {};}
;}
;var C={};var A=z[E];while(A&&A[D]>=x&&A[D]<=y){C[A.id]=A;A=z[E++ ];}
;return C;}
,findCellsInWindow:function(I,H,J,F){var M={};if(J>0){var L=I+J-1;qx.lang.Object.mergeWith(M,this._findCellsInRange(h,I,L));qx.lang.Object.mergeWith(M,this._findCellsInRange(k,I,L));}
;var K={};if(F>0){var G=H+F-1;qx.lang.Object.mergeWith(K,this._findCellsInRange(g,H,G));qx.lang.Object.mergeWith(K,this._findCellsInRange(c,H,G));}
;return this.__Dq(K,M);}
,__Dq:function(P,N){var O=[];for(var Q in P){if(N[Q]){O.push(N[Q]);}
;}
;return O;}
...
,_getRowPosition:function(S){var R=this._rowPos[S];if(R!==undefined){return R;}
;R=this._rowPos[S]=this._rowConfig.getItemPosition(S);return R;}
...
,getCellBounds:function(ba,bc,bd){var bb=[];for(var i=0,l=ba.length;i<l;i++ ){bb.push(this._getSingleCellBounds(ba[i],bc,bd));}
;return bb;}
,computeCellSpanMap:function(bk,bl,bj,bo,be){var bf=[];if(bo<=0){return bf;}
;var bs=bl+bo-1;for(var i=bl;i<=bs;i++ ){bf[i]=[];}
;if(be<=0){return bf;}
;var bi=bj+be-1;for(var i=0,l=bk.length;i<l;i++ ){var bm=bk[i];var bq=Math.max(bl,bm.firstRow);var bp=Math.min(bs,bm.lastRow);var bh;for(var bn=bq;bn<=bp;bn++ ){bh=bf[bn];var bg=Math.max(bj,bm.firstColumn);var br=Math.min(bi,bm.lastColumn);for(var bt=bg;bt<=br;bt++ ){bh[bt]=1;}
;}
;}
;return bf;}
},destruct:function(){this._rowConfig.removeListener(d,this._onRowConfigChange,this);this._columnConfig.removeListener(d,this._onColumnConfigChange,this);this._cells=this._sorted=this._rowPos=this._columnPos=this._rowConfig=this._columnConfig=null;}
});}
)();
(function(){var a="cell.rowspan",b="x",c="cell.column",d="cell.colspan",e="qx.ui.virtual.layer.WidgetCellSpan",f="_spanManager",g="_cellLayer",h="cell.spanning",j="cell.row";qx.Class.define(e,{extend:qx.ui.virtual.layer.Abstract,include:[qx.ui.core.MChildrenHandling],construct:function(m,n,k){qx.ui.virtual.layer.Abstract.call(this);this.setZIndex(12);this._spanManager=new qx.ui.virtual.layer.CellSpanManager(n,k);this._cellProvider=m;this.__xC=[];this._cellLayer=new qx.ui.virtual.layer.WidgetCell(this.__HX());this._cellLayer.setZIndex(0);this._setLayout(new qx.ui.layout.Grow());this._add(this._cellLayer);}
,properties:{anonymous:{refine:true,init:false}},members:{getRenderedCellWidget:function(t,q){var o=this._cellLayer.getRenderedCellWidget(t,q);if(!o||o.getUserData(h)){var s=this._getChildren();for(var i=0,l=s.length;i<l;i++ ){var r=s[i];if(r==this._cellLayer){continue;}
;var p={row:r.getUserData(j),column:r.getUserData(c),rowSpan:r.getUserData(a),colSpan:r.getUserData(d)};if(p.row<=t&&t<p.row+p.rowSpan&&p.column<=q&&q<p.column+p.colSpan){return r;}
;}
;return null;}
;return o;}
,__xC:null,setCellSpan:function(y,u,v,w){var x=y+b+u;this._spanManager.removeCell(x);if(v>1||w>1){this._spanManager.addCell(x,y,u,v,w);}
;qx.ui.core.queue.Widget.add(this);}
,__HX:function(){var self=this;var B=this._cellProvider;var A=this.__xC;var z={getCellWidget:function(E,C){if(!self._spanMap[E][C]){var D=B.getCellWidget(E,C);}
else {var D=A.pop();if(!D){D=new qx.ui.core.Spacer();D.setUserData(h,1);}
;}
;return D;}
,poolCellWidget:function(F){if(F.getUserData(h)){A.push(F);}
else {B.poolCellWidget(F);}
;}
};return z;}
,__HY:function(I,J,H,G){this._cells=this._spanManager.findCellsInWindow(I,J,H,G);if(this._cells.length>0){this._bounds=this._spanManager.getCellBounds(this._cells,I,J);this._spanMap=this._spanManager.computeCellSpanMap(this._cells,I,J,H,G);}
else {this._bounds=[];this._spanMap=[];for(var i=0;i<H;i++ ){this._spanMap[I+i]=[];}
;}
;}
,__Ia:function(){var O=this.getChildren();for(var i=O.length-1;i>=0;i-- ){var N=O[i];if(N!==this._cellLayer){this._cellProvider.poolCellWidget(N);this._remove(N);}
;}
;for(var i=0,l=this._cells.length;i<l;i++ ){var M=this._cells[i];var K=this._bounds[i];var L=this._cellProvider.getCellWidget(M.firstRow,M.firstColumn);if(L){L.setUserBounds(K.left,K.top,K.width,K.height);L.setUserData(j,M.firstRow);L.setUserData(c,M.firstColumn);L.setUserData(a,M.lastRow-M.firstRow+1);L.setUserData(d,M.lastColumn-M.firstColumn+1);this._add(L);}
;}
;}
,_fullUpdate:function(Q,S,R,P){this.__HY(Q,S,R.length,P.length);this.__Ia();this._cellLayer.fullUpdate(Q,S,R,P);}
,_updateLayerWindow:function(U,W,V,T){this.__HY(U,W,V.length,T.length);this.__Ia();this._cellLayer.updateLayerWindow(U,W,V,T);}
},destruct:function(){var X=this._getChildren();for(var i=0;i<X.length;i++ ){X[i].dispose();}
;this._disposeObjects(f,g);this._cellProvider=this.__xC=this._cells=this._bounds=this._spanMap=null;}
});}
)();
...
,properties:{anonymous:{refine:true,init:false}},events:{updated:c},members:{__xC:null,getRenderedCellWidget:function(q,n){var j=this.getColumnSizes().length;var p=this.getRowSizes().length;var o=this.getFirstRow();var m=this.getFirstColumn();if(q<o||q>=o+p||n<m||n>=m+j){return null;}
...
;}
;}
,_fullUpdate:function(A,v,D,z){var B=this._cellProvider;var G=this._getChildren();for(var i=0;i<G.length;i++ ){var E=G[i];if(E.getUserData(g)){this.__xC.push(E);}
...
;}
;}
;var J=this._cellProvider;var N=this._getChildren();for(var i=0;i<N.length;i++ ){if(!W[i]){var T=N[i];if(T.getUserData(g)){this.__xC.push(T);}
