...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.showcase.Browser.8585582bfc52.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,__pY:{"Enter":1,"Space":1},__no:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var V=this.getActiveMenu();if(!V){return;}
;var W=e.getKeyIdentifier();if(this.__no[W]||(this.__pY[W]&&V.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var ba=this.getActiveMenu();if(!ba){return;}
;var X=e.getKeyIdentifier();var bc=this.__no[X];var Y=this.__pY[X];if(bc){switch(X){case k:this._onKeyPressUp(ba);break;case j:this._onKeyPressDown(ba);break;case h:this._onKeyPressLeft(ba);break;case x:this._onKeyPressRight(ba);break;case d:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
...
,__qd:function(){var br=this._getMenuBounds();if(!br){this.addListenerOnce(o,this.__qd,this);return;}
;var bq=this.getLayoutParent().getBounds().height;var top=this.getLayoutProperties().top;var bs=this.getLayoutProperties().left;if(top<0){this._assertSlideBar(function(){this.setHeight(br.height+top);this.moveTo(bs,0);}
);}
else if(top===0){var bo=this._placementTarget;var bp=bo.top||bo.getBounds().top;this._assertSlideBar(function(){this.setHeight(bp);}
);this.moveTo(bs,0);}
else if(top+br.height>bq){this._assertSlideBar(function(){this.setHeight(bq-top);}
);}
else {this.setHeight(null);}
;}
,_assertSlideBar:function(bt){if(this.hasChildControl(h)){return bt.call(this);}
;this.__qb=bt;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bu){this.getChildControl(h);if(this.__qb){this.__qb.call(this);delete this.__qb;}
;}
,_onResize:function(){if(this.isVisible()){var bv=this._placementTarget;if(!bv){return;}
else if(bv instanceof qx.ui.core.Widget){this.placeToWidget(bv,true);}
else if(bv.top!==undefined){this.placeToPoint(bv);}
else {throw new Error(A+bv);}
;this.__qd();}
;}
,_onPointerOver:function(e){var bx=qx.ui.menu.Manager.getInstance();bx.cancelClose(this);var by=e.getTarget();if(by.isEnabled()&&by instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(by);var bw=by.getMenu&&by.getMenu();if(bw){bw.setOpener(by);bx.scheduleOpen(bw);this.__qa=bw;}
else {var bz=this.getOpenedButton();if(bz){bx.scheduleClose(bz.getMenu());}
;if(this.__qa){bx.cancelOpen(this.__qa);this.__qa=null;}
;}
;}
else if(!this.getOpenedButton()){this.resetSelectedButton();}
;}
,_onPointerOut:function(e){var bA=qx.ui.menu.Manager.getInstance();if(!qx.ui.core.Widget.contains(this,e.getRelatedTarget())){var bB=this.getOpenedButton();bB?this.setSelectedButton(bB):this.resetSelectedButton();if(bB){bA.cancelClose(bB.getMenu());}
;if(this.__qa){bA.cancelOpen(this.__qa);}
;}
;}
...
;this._getIframeElement().addListener(h,this.__CA,this);}
...
,__CA:function(e){var r=e.getData();if(r){this.setSource(r);}
;this.fireDataEvent(h,r);}
}});}
)();
(function(){var a="no",b="Boolean",c="px",d="event.help",f="gecko",g="auto",h="_applyScrollbar",i="Unable to set 'nativeHelp' property, possibly due to security restrictions",j="qx.debug",k="DOMNodeInserted",l="load",m="_applyNativeHelp",n="yes",o="scrolling",p="/",q="help",r="pointerup",s="appear",t="pointerdown",u="engine.name",v="block",w="qx.ui.embed.Iframe",x="losecapture",y="contextmenu",z="__CE",A="none",B="iframe",C="display";qx.Class.define(w,{extend:qx.ui.embed.AbstractIframe,construct:function(D){if(D!=null){this.__CD=D;}
;qx.ui.embed.AbstractIframe.call(this,D);qx.event.Registration.addListener(document.body,t,this.block,this,true);qx.event.Registration.addListener(document.body,r,this.release,this,true);qx.event.Registration.addListener(document.body,x,this.release,this,true);this.__CE=this._createBlockerElement();if((qx.core.Environment.get(u)==f)){this.addListenerOnce(s,function(e){var E=this.getContentElement().getDomElement();qx.bom.Event.addNativeListener(E,k,this._onDOMNodeInserted);}
);this._onDOMNodeInserted=qx.lang.Function.listener(this._syncSourceAfterDOMMove,this);}
;}
,properties:{appearance:{refine:true,init:B},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:b,init:false,apply:m},scrollbar:{check:[g,a,n],nullable:true,themeable:true,apply:h}},members:{__CD:null,__CE:null,renderLayout:function(J,top,H,F){qx.ui.embed.AbstractIframe.prototype.renderLayout.call(this,J,top,H,F);var I=c;var G=this.getInsets();this.__CE.setStyles({"left":(J+G.left)+I,"top":(top+G.top)+I,"width":(H-G.left-G.right)+I,"height":(F-G.top-G.bottom)+I});}
,_createContentElement:function(){var K=new qx.html.Iframe(this.__CD);K.addListener(l,this._onIframeLoad,this);return K;}
...
,block:function(){this.__CE.setStyle(C,v);}
,release:function(){this.__CE.setStyle(C,A);}
...
,setLayoutParent:function(parent){qx.ui.embed.AbstractIframe.prototype.setLayoutParent.call(this,parent);if(parent){this.getLayoutParent().getContentElement().add(this.__CE);}
;}
},destruct:function(){if(this.getLayoutParent()&&this.__CE.getParent()){this.getLayoutParent().getContentElement().remove(this.__CE);}
;this._disposeObjects(z);qx.event.Registration.removeListener(document.body,t,this.block,this,true);qx.event.Registration.removeListener(document.body,r,this.release,this,true);qx.event.Registration.removeListener(document.body,x,this.release,this,true);}
});}
)();
(function(){var a="source",b="element",c="name",d="qx.event.type.Event",f="iframe",g="qx.html.Iframe",h="navigate",i="qx.event.type.Data";qx.Class.define(g,{extend:qx.html.Element,construct:function(j,k,l){qx.html.Element.call(this,f,k,l);this.setSource(j);this.addListener(h,this.__CA,this);qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(b);}
...
;}
,__CA:function(e){var v=e.getData();if(v){this.setSource(v);}
;}
}});}
)();
...
;return d;}
,__ok:function(I){var H=function(){qx.bom.Event.removeNativeListener(I,j,H);I.$$url=qx.bom.Iframe.queryCurrentUrl(I);}
