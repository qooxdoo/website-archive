...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.bb29071fbd92.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__oU=document||window.document;this.__HJ();var self=this;qx.bom.Event.addNativeListener(this.__oU,this.__du,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__oU:null,__HH:null,__HI:null,__du:null,__HJ:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__oU[m]!=undefined){this.__HH=m;this.__du=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__oU[m]!=undefined){this.__HI=m;break;}
;}
;if(this.__HH==null){this.__HH=k;this.__du=c;}
;if(this.__HI==null){this.__HI=b;}
;}
,isHidden:function(){return !!this.__oU[this.__HH];}
,getVisibilityState:function(){return this.__oU[this.__HI]||d;}
}});}
)();
