...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.HBox_Percent","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox_Percent.1356c86cffc8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="yellow",b="33%",c="green",d="demobrowser.demo.layout.HBox_Percent",e="main",f="50%";qx.Class.define(d,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(g);g.add(this.getBox1());g.add(this.getBox2());g.add(this.getBox3());g.add(this.getBox4());g.add(this.getBox5());g.add(this.getBox6());}
,getBox1:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:e,backgroundColor:a,width:500,allowGrowX:false});var k=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});var j=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});var i=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});h.add(k,{width:f});h.add(j,{flex:1});h.add(i,{flex:1});return h;}
,getBox2:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:e,backgroundColor:a,width:500,allowGrowX:false});var o=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});var n=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});var m=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});l.add(o,{width:b});l.add(n,{width:b});l.add(m,{width:b,flex:1});return l;}
,getBox3:function(){var p=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:e,backgroundColor:a,allowGrowX:false});var s=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});var r=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});var q=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});p.add(s,{width:f});p.add(r,{flex:1});p.add(q,{flex:1});return p;}
,getBox4:function(){var t=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:e,backgroundColor:a,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});var v=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});var u=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});t.add(w,{width:b,flex:1});t.add(v,{width:b,flex:1});t.add(u,{width:b,flex:1});return t;}
,getBox5:function(){var x=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:e,backgroundColor:a,width:200,allowGrowX:false});var A=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});var z=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});var y=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});x.add(A,{width:b,flex:1});x.add(z,{width:b,flex:1});x.add(y,{width:b,flex:1});return x;}
,getBox6:function(){var B=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:e,backgroundColor:a,width:500,allowGrowX:false});var E=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});var D=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});var C=new qx.ui.core.Widget().set({decorator:e,backgroundColor:c});B.add(E,{width:b,flex:1});B.add(D,{width:b,flex:1});B.add(C,{width:b,flex:1});return B;}
}});}
)();
