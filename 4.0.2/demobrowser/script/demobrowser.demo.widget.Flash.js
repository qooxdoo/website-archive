...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.871c460dc042.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="__Qb",c="Flash Player Version",d="right",f="qooxdoo is the best!",g="Message from Flash:",h="execute",i="Simple demo with FlashVars",j="__FV",k="__Qd",l="bgcolor",m="demobrowser.demo.widget.Flash",n="demobrowser/demo/flash/TestFlash.swf",o="1) no pop-up or advertising blocker is activated.\n",p="Send to Flash",q="demobrowser/demo/flash/FlashVersion.swf",r="No message.",s="Flash:",t="<b>qooxdoo:</b>",u="__cx",v="demobrowser.demo.widget.Flash.sendMessage",w="demobrowser.demo.widget.Flash.flashReady",x="Couldn't connect to Flash Player! Please make sure that:\n",y="demobrowser/demo/flash/fo_tester.swf",z="this is passed in via FlashVars",A="Two way communication (ActionScript <-> JavaScript)",B="__Qc",C="Message to Flash:",D="Show Flash Player version",E="noscale",F="#FF6600";qx.Class.define(m,{extend:qx.application.Standalone,members:{__cx:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(i);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(A);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cx=this.createWindow();G.add(this.__cx,{top:20,left:20});}
...
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:z};var M=new qx.ui.embed.Flash(y).set({scale:E,variables:L});M.getContentElement().setParam(l,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(D);O.addListener(h,function(){this.__cx.open();}
,this);N.add(O);return N;}
,__FV:null,__Qb:null,__Qc:null,__Qd:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(t).set({rich:true}));Q.add(new qx.ui.basic.Label(g));this.__Qb=new qx.ui.form.TextArea(r);this.__Qb.setEnabled(false);Q.add(this.__Qb,{flex:1});Q.add(new qx.ui.basic.Label(C));this.__Qc=new qx.ui.form.TextArea(f);Q.add(this.__Qc,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,d));this.__Qd=new qx.ui.form.Button(p);this.__Qd.setEnabled(false);this.__Qd.addListener(h,function(e){this.__FV.getFlashElement().sendMessage(this.__Qc.getValue());}
,this);S.add(this.__Qd);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(s).set({rich:true}));this.__FV=new qx.ui.embed.Flash(n);this.__FV.setVariables({init:w});P.add(this.__FV,{flex:1});return R;}
,sendMessage:function(T){this.__Qb.setValue(T);}
,initFlash:function(){if(this.__FV.getFlashElement().setup){this.__FV.getFlashElement().setup(v);this.__Qd.setEnabled(true);}
else {alert(x+o+a);}
;}
...
},destruct:function(){this._disposeObjects(b,B,k,j,u);}
});}
)();
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__FL){this.__FL=new Date().getTime();}
;var bp=new Date().getTime()-this.__FL;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__FL=null;}
;}
else {this.fireEvent(p);this.__FL=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__FM(c,bB);}
,_applyScale:function(bD,bC){this.__FM(h,bD);}
,_applyWmode:function(bF,bE){this.__FM(m,bF);}
,_applyPlay:function(bH,bG){this.__FM(I,bH);}
,_applyLoop:function(bJ,bI){this.__FM(s,bJ);}
,_applyMenu:function(bL,bK){this.__FM(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__FM(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__FM(z,bP);}
,__FM:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__FS={};this.__FT={};this.__FU={};}
,members:{__FS:null,__FU:null,__FT:null,__FV:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__FV=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__FT,this.__FS);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__FV){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__FV){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__FT;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__FV){throw new Error(d);}
;this.__FT=t;}
,getAttributes:function(){return this.__FU;}
...
else if(this.__FV){throw new Error(j);}
;if(v===null||v===undefined){delete this.__FU[u];}
else {this.__FU[u]=v;}
;}
,getParams:function(){return this.__FS;}
...
;}
;}
;if(this.__FV){throw new Error(l);}
;if(x===null||x===undefined){delete this.__FS[w];}
else {this.__FS[w]=x;}
;}
,getFlashElement:function(){return this.__FV;}
},destruct:function(){if(this.__FV){qx.bom.Flash.destroy(this.__FV);}
;this.__FS=this.__FT=this.__FU=null;}
});}
)();
