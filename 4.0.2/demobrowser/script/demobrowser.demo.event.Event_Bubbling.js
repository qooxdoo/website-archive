...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.Event_Bubbling","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Bubbling.33b57790d864.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="logger",b="Event phase",c="capture",d="Current target",f="at target",g="div",h="Event",j="tap",k="demobrowser.demo.event.Event_Bubbling",l="bubble",m="Target";qx.Class.define(k,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this._initLogger([h,m,d,b],document.getElementById(a),50);for(var i=1;i<10;i++ ){var n=document.getElementById(g+i);qx.event.Registration.addListener(n,j,this._cascadeCapture,this,true);qx.event.Registration.addListener(n,j,this._cascadeBubble,this,false);}
;}
,_cascadeCapture:function(e){this._log([e.getType(),e.getTarget().id,e.getCurrentTarget().id,e.getEventPhase()==2?f:c]);}
,_cascadeBubble:function(e){this._log([e.getType(),e.getTarget().id,e.getCurrentTarget().id,e.getEventPhase()==2?f:l]);}
}});}
)();
