...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.79cfce9d2773.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
else {this.getBlocker().block();if(this.__ju==null){this.__ju=new qx.event.Timer(500);this.__ju.addListener(f,this.__Jn,this);}
;this.__Ji=window.open(z,name,G);this.__ju.restart();C=this.__Ji;}
;}
...
;M=N.join(y);}
;return M;}
,__Jn:function(){if(this.isClosed(this.__Ji)){this.getBlocker().unblock();this.__ju.stop();}
;}
,getBlocker:function(){if(this.__lg==null){this.__lg=new qx.bom.Blocker;}
;return this.__lg;}
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__cP();}
,members:{__Jo:null,__CE:null,__Jp:null,__Jq:false,__Jr:10000,__Js:0,__Jt:f,block:function(r){if(!this.__Jq){this.__Jp=r;var q=this.__Jw();this.__Jx(q);this.__Jq=true;}
;}
,unblock:function(){if(this.__Jq){this.__Jy();this.__Jq=false;}
;}
,isBlocked:function(){return this.__Jq;}
,getBlockerElement:function(){return this.__CE;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__CE,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__CE,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__CE,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__CE);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__CE,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__CE,h);}
,__cP:function(){this.__Ju();if((qx.core.Environment.get(j)==b)){this.__Jv();}
;qx.event.Registration.addListener(window,a,this.__yK,this);}
,__Ju:function(){this.__CE=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__CE,{display:d,opacity:this.__Js,backgroundColor:this.__Jt});this.setBlockerZIndex(this.__Jr);}
...
;return v;}
,__Jx:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__CE,w);qx.dom.Element.insertEnd(this.__CE,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Jo,w);qx.dom.Element.insertEnd(this.__Jo,document.body);}
;}
,__Jy:function(){qx.dom.Element.remove(this.__CE);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__Jo);}
;}
...
,this,0);}
;}
,__Jz:function(z){qx.bom.element.Style.setStyles(this.__CE,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__Jo,z);}
;}
,__JA:function(){return (this.__Jp==null||qx.dom.Node.isWindow(this.__Jp)||qx.dom.Node.isDocument(this.__Jp));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__yK,this);this.__Jo=this.__CE=this.__Jp=null;}
});}
)();
