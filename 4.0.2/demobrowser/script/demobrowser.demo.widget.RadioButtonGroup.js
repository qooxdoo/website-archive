...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.RadioButtonGroup","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.RadioButtonGroup.94f0af66256f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="female",b="<strong>Grid:</strong>",c="<strong>Vertical:</strong>",d="2,1",e="1,0",f="demobrowser.demo.widget.RadioButtonGroup",g="male",h="Red",j="Green",k="0,1",l="1,1",m="1,2",n="Blue",o="<strong>Horizontal:</strong>";qx.Class.define(f,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var s=new qx.ui.basic.Label(c);s.setRich(true);this.getRoot().add(s,{left:10,top:10});var p=new qx.ui.form.RadioButtonGroup();p.setLayout(new qx.ui.layout.VBox(2));this.addButtons(p,[h,j,n]);this.getRoot().add(p,{left:100,top:10});var u=new qx.ui.basic.Label(o);u.setRich(true);this.getRoot().add(u,{left:10,top:70});var r=new qx.ui.form.RadioButtonGroup();r.setLayout(new qx.ui.layout.HBox(5));this.addButtons(r,[a,g]);this.getRoot().add(r,{left:100,top:70});var q=new qx.ui.basic.Label(b);q.setRich(true);this.getRoot().add(q,{left:10,top:100});var t=new qx.ui.form.RadioButtonGroup();t.setLayout(new qx.ui.layout.Grid(10,10));t.add(new qx.ui.form.RadioButton(k),{row:0,column:1});t.add(new qx.ui.form.RadioButton(e),{row:1,column:0});t.add(new qx.ui.form.RadioButton(l),{row:1,column:1});t.add(new qx.ui.form.RadioButton(m),{row:1,column:2});t.add(new qx.ui.form.RadioButton(d),{row:2,column:1});this.getRoot().add(t,{left:100,top:100});}
...
,removeAll:function(){var y=this.__nO.getItems();for(var i=y.length-1;i>=0;i-- ){this.__nO.remove(y[i]);}
