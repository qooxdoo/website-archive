...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Animation_3d.92d60a64ce8e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="pointerout",b="360deg",c="infinite",d="css.transform.3d",e="demobrowser.demo.animation.Animation_3d",f="",g="preserve-3d",h="container",i="pointerover",j="45deg",k="parent",l="0deg",m="flat",n="50px",o="center top",p="css.animation",q="-100px",r='label',s="20deg",t="CSS animations not supported, sorry!";qx.Class.define(e,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(p)==null||!qx.core.Environment.get(d)){document.body.innerHTML=f;var w=document.createElement(r);w.innerHTML=t;document.body.appendChild(w);return;}
;var u={duration:10000,repeat:c,keyFrames:{'0':{rotate:[null,l]},'100':{rotate:[null,b]}}};var parent=document.getElementById(k);qx.bom.element.Animation.animate(parent,u);qx.bom.element.Transform.setStyle(parent,g);qx.bom.element.Transform.transform(parent.children[0],{translate:[null,null,q],rotate:[null,j]});qx.bom.element.Transform.transform(parent.children[1],{translate:[null,null,n],rotate:[s]});qx.bom.element.Transform.setOrigin(parent.children[1],o);var v=document.getElementById(h);qx.bom.element.Transform.setPerspective(v,500);qxWeb(v).on(i,function(){qx.bom.element.Transform.setStyle(parent,m);}
);qxWeb(v).on(a,function(){qx.bom.element.Transform.setStyle(parent,g);}
);}
}});}
)();
