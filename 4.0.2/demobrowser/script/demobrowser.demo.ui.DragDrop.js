...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.DragDrop.1f36371b1f28.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
);var N=new qx.ui.basic.Label(m);I.add(N,{left:600,top:20});var G=this.__JW=new qx.ui.form.List();G.setDraggable(true);G.setDroppable(true);G.setSelectionMode(u);I.add(G,{left:600,top:40});for(var i=0;i<20;i++ ){G.add(new qx.ui.form.ListItem(D+i,h));}
...
;}
);G.addListener(g,function(e){this.__PI(e.getOriginalTarget(),e.getDragTarget());}
,this);H.addListener(g,function(e){this.__PI(this.__PH);}
,this);}
,__PI:function(bi,bg){if(bi.classname!=n){return;}
;var bh=this.__JW.getSortedSelection();if(bh.length===0){bh=[bg];}
else if(bh.indexOf(bg)==-1){bh=[bg];}
;for(var i=0,l=bh.length;i<l;i++ ){this.__JW.addBefore(bh[i],bi);}
;}
