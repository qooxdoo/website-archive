...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ToolBar.f60354fde234.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="icon/16/actions/format-justify-right.png",b="Label only",c="enabled",d="22px",f="icon/22/actions/format-justify-center.png",g="icon/16/actions/edit-cut.png",h="icon/22/actions/format-text-underline.png",j="32px",k="excluded",l="Left",m="icon/22/actions/edit-cut.png",n="icon/22/actions/format-justify-left.png",o="showItem",p="48px",q="Show:",r="icon/22/actions/edit-paste.png",s="New",t="demobrowser.demo.widget.ToolBar",u="icon/22/actions/document-new.png",v="value",w="visible",x="icon/16/actions/edit-copy.png",y="changeSelection",z="More...",A="icon/22/actions/help-contents.png",B="icon/16/actions/format-justify-center.png",C="icon/22/actions/edit-copy.png",D="icon",E="Cut",F="icon/22/actions/format-justify-right.png",G="Center",H="icon/16/actions/edit-paste.png",I="on",J="Help",K="Copy",L="Paste",M="icon/16/actions/format-justify-left.png",N="label",O="Label and Icon",P="overflowHandling",Q="both",R="Icon Size:",S="icon/16/actions/document-new.png",T="Toggle",U="Right",V="Icon only",W="Overflow handling:",X="hideItem";qx.Class.define(t,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var bu=new qx.ui.container.Composite(new qx.ui.layout.VBox(20));bu.setPadding(20);this.getRoot().add(bu,{edge:0});toolbar=new qx.ui.toolbar.ToolBar();toolbar.setSpacing(5);bu.add(toolbar);var bA=new qx.ui.toolbar.Part();var bd=new qx.ui.toolbar.Button(s,u);var bi=new qx.ui.toolbar.Button(K,C);var be=new qx.ui.toolbar.Button(E,m);var bx=new qx.ui.toolbar.Button(L,r);bA.add(bd);bA.add(new qx.ui.toolbar.Separator());bA.add(bi);bA.add(be);bA.add(bx);toolbar.add(bA);var bB=new qx.ui.toolbar.Part();var bb=new qx.ui.toolbar.CheckBox(T,h);bB.add(bb);toolbar.add(bB);var bC=new qx.ui.toolbar.Part();var bp=new qx.ui.toolbar.RadioButton(l,n);var bo=new qx.ui.toolbar.RadioButton(G,f);var bn=new qx.ui.toolbar.RadioButton(U,F);bC.add(bp);bC.add(bo);bC.add(bn);toolbar.add(bC);var bD=new qx.ui.form.RadioGroup(bp,bo,bn);bD.setAllowEmptySelection(true);toolbar.addSpacer();var bs=new qx.ui.toolbar.MenuButton(z);toolbar.add(bs);toolbar.setOverflowIndicator(bs);var Y=new qx.ui.toolbar.Button(J,A);toolbar.add(Y);var bh=[bd,bi,be,bx,bb,bp,bo,bn,Y];toolbar.setRemovePriority(bA,4);toolbar.setRemovePriority(bC,3);toolbar.setRemovePriority(bB,2);var ba=new qx.ui.menu.Menu();bs.setMenu(ba);var bd=new qx.ui.menu.Button(s,S);var bq=new qx.ui.menu.Separator();var bi=new qx.ui.menu.Button(K,x);var be=new qx.ui.menu.Button(E,g);var bx=new qx.ui.menu.Button(L,H);ba.add(bd);ba.add(bq);ba.add(bi);ba.add(be);ba.add(bx);var bj=new qx.ui.menu.Separator();var bp=new qx.ui.menu.RadioButton(l);var bo=new qx.ui.menu.RadioButton(G);var bn=new qx.ui.menu.RadioButton(U);bp.setIcon(M);bo.setIcon(B);bn.setIcon(a);ba.add(bj);ba.add(bp);ba.add(bo);ba.add(bn);var br=ba.getChildren();for(var i=0;i<br.length;i++ ){br[i].setVisibility(k);}
;var bc=function(bF,bG){var bH=[];if(bF==bA){bH.push(bd,bq,bi,be,bx);}
else if(bF==bC){bH.push(bj,bp,bo,bn);}
;for(var i=0;i<bH.length;i++ ){bH[i].setVisibility(bG);}
;}
;toolbar.addListener(o,function(e){bc(e.getData(),k);}
,this);toolbar.addListener(X,function(e){bc(e.getData(),w);}
,this);var bk=new qx.ui.layout.Grid();bk.setSpacing(10);var bw=new qx.ui.container.Composite(bk);bu.add(bw);var bm=new qx.ui.form.RadioButton(d);bm.setValue(true);var bE=new qx.ui.form.RadioButton(j);var bl=new qx.ui.form.RadioButton(p);var bt=new qx.ui.form.RadioGroup();bt.add(bm,bE,bl);bw.add(new qx.ui.basic.Label(R),{row:0,column:0});bw.add(bm,{row:0,column:1});bw.add(bE,{row:0,column:2});bw.add(bl,{row:0,column:3});bt.addListener(y,function(e){var bK=e.getData()[0];var bJ,bL,bI;for(var i=0;i<bh.length;i++ ){bJ=bh[i];bI=bJ.getIcon();if(bK==bm){bL=22;}
else if(bK==bE){bL=32;}
else if(bK==bl){bL=48;}
;bI=bI.replace(/22|32|48/g,bL);bJ.setIcon(bI);}
;}
,this);var bg=new qx.ui.form.RadioButton(O);bg.setValue(true);var bz=new qx.ui.form.RadioButton(V);var bf=new qx.ui.form.RadioButton(b);var bv=new qx.ui.form.RadioGroup();bv.add(bg,bz,bf);bw.add(new qx.ui.basic.Label(q),{row:1,column:0});bw.add(bg,{row:1,column:1});bw.add(bz,{row:1,column:2});bw.add(bf,{row:1,column:3});bv.addListener(y,function(e){if(e.getData()[0]==bg){toolbar.setShow(Q);}
else if(e.getData()[0]==bz){toolbar.setShow(D);}
else if(e.getData()[0]==bf){toolbar.setShow(N);}
;}
,this);var by=new qx.ui.form.CheckBox(I);bw.add(new qx.ui.basic.Label(W),{row:2,column:0});bw.add(by,{row:2,column:1});by.bind(v,toolbar,P);by.bind(v,bv,c,{converter:function(bM){return !bM;}
});}
}});}
)();
...
;var P=K.getMarginLeft()+K.getMarginRight();P=Math.max(P,this.getSpacing());var J=K.getSizeHint().width+P;this.__qu(K);G-=J;if(E&&E.getVisibility()!=o){E.setVisibility(o);G+=L;var H=E.getMarginLeft()+E.getMarginRight();G+=Math.max(H,this.getSpacing());}
;}
while(G>F);}
else if(this.__qr.length>0){do {var Q=this.__qr[0];if(Q){var P=Q.getMarginLeft()+Q.getMarginRight();P=Math.max(P,this.getSpacing());if(Q.getContentElement().getDomElement()==null){Q.syncAppearance();Q.invalidateLayoutCache();}
;var I=Q.getSizeHint().width;var O=false;if(this.__qr.length==1&&L>0){var N=P-this.getSpacing();var M=G-L+I+N;O=F>M;}
;if(F>G+I+P||O){this.__qt(Q);G+=I;if(E&&this.__qr.length==0){E.setVisibility(y);}
;}
else {return;}
;}
;}
while(F>=G&&this.__qr.length>0);}
;}
,__qt:function(R){R.setVisibility(o);this.__qr.shift();this.fireDataEvent(m,R);}
,__qu:function(S){if(!S){return;}
;this.__qr.unshift(S);S.setVisibility(y);this.fireDataEvent(A,S);}
,_getNextToHide:function(){for(var i=this.__qs.length-1;i>=0;i-- ){var T=this.__qs[i];if(T&&T.getVisibility&&T.getVisibility()==o){return T;}
;}
...
;}
;}
,setRemovePriority:function(X,W,Y){if(!Y&&this.__qs[W]!=undefined){throw new Error(v);}
;this.__qs[W]=X;}
...
;for(var i=0;i<this.__qr.length;i++ ){this.__qr[i].setVisibility(o);}
;this.__qr=[];}
;}
...
;bf.setVisibility(y);}
;}
,__qv:false,_setAllowMenuOpenHover:function(bg){this.__qv=bg;}
...
(function(){var a="blur",b="__qg",c="Enter",d="Escape",f="Space",g="keydown",h="Left",j="Down",k="Up",l="singleton",m="qx.debug",n="interval",o="roll",p="event.touch",q="__qf",r="Object is no menu: ",s="__oK",t="pointerdown",u="qx.ui.menu.Manager",v="keyup",w="keypress",x="contextmenu",y="Right";qx.Class.define(u,{type:l,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__oK=[];var z=document.body;var A=qx.event.Registration;A.addListener(window.document.documentElement,t,this._onPointerDown,this,true);A.addListener(z,o,this._onRoll,this,true);A.addListener(z,g,this._onKeyUpDown,this,true);A.addListener(z,v,this._onKeyUpDown,this,true);A.addListener(z,w,this._onKeyPress,this,true);if(!qx.core.Environment.get(p)){qx.bom.Element.addListener(window,a,this.hideAll,this);}
;this.__qf=new qx.event.Timer();this.__qf.addListener(n,this._onOpenInterval,this);this.__qg=new qx.event.Timer();this.__qg.addListener(n,this._onCloseInterval,this);}
,members:{__qh:null,__qi:null,__qf:null,__qg:null,__oK:null,_getChild:function(B,D,C,G){var F=B.getChildren();var length=F.length;var E;for(var i=D;i<length&&i>=0;i+=C){E=F[i];if(E.isEnabled()&&!E.isAnonymous()&&E.isVisible()){return E;}
;}
...
;H=H.getLayoutParent();}
;return false;}
,_isMenuOpener:function(J){var I=this.__oK;for(var i=0;i<I.length;i++ ){if(I[i].getOpener()===J){return true;}
;}
;return false;}
,_getMenuButton:function(K){while(K){if(K instanceof qx.ui.menu.AbstractButton){return K;}
;K=K.getLayoutParent();}
;return null;}
,add:function(L){if(qx.core.Environment.get(m)){if(!(L instanceof qx.ui.menu.Menu)){throw new Error(r+L);}
;}
;var M=this.__oK;M.push(L);L.setZIndex(1e6+M.length);}
,remove:function(N){if(qx.core.Environment.get(m)){if(!(N instanceof qx.ui.menu.Menu)){throw new Error(r+N);}
;}
;var O=this.__oK;if(O){qx.lang.Array.remove(O,N);}
;}
,hideAll:function(){var P=this.__oK;if(P){for(var i=P.length-1;i>=0;i-- ){P[i].exclude();}
;}
;}
,getActiveMenu:function(){var Q=this.__oK;return Q.length>0?Q[Q.length-1]:null;}
,scheduleOpen:function(R){this.cancelClose(R);if(R.isVisible()){if(this.__qh){this.cancelOpen(this.__qh);}
;}
else if(this.__qh!=R){this.__qh=R;this.__qf.restartWith(R.getOpenInterval());}
;}
,scheduleClose:function(S){this.cancelOpen(S);if(!S.isVisible()){if(this.__qi){this.cancelClose(this.__qi);}
;}
else if(this.__qi!=S){this.__qi=S;this.__qg.restartWith(S.getCloseInterval());}
;}
,cancelOpen:function(T){if(this.__qh==T){this.__qf.stop();this.__qh=null;}
;}
,cancelClose:function(U){if(this.__qi==U){this.__qg.stop();this.__qi=null;}
;}
,_onOpenInterval:function(e){this.__qf.stop();this.__qh.open();this.__qh=null;}
,_onCloseInterval:function(e){this.__qg.stop();this.__qi.exclude();this.__qi=null;}
,preventContextMenuOnce:function(){qx.event.Registration.addListener(document.body,x,this.__qj,this,true);}
,__qj:function(e){var V=e.getTarget();V=qx.ui.core.Widget.getWidgetByElement(V,true);if(this._isInMenu(V)){e.stopPropagation();e.preventDefault();}
;qx.event.Registration.removeListener(document.body,x,this.__qj,this,true);}
...
;if(this.__oK.length>0&&!this._isInMenu(W)){this.hideAll();}
;}
,__qk:{"Enter":1,"Space":1},__nF:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var X=this.getActiveMenu();if(!X){return;}
;var Y=e.getKeyIdentifier();if(this.__nF[Y]||(this.__qk[Y]&&X.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var bc=this.getActiveMenu();if(!bc){return;}
;var ba=e.getKeyIdentifier();var be=this.__nF[ba];var bb=this.__qk[ba];if(be){switch(ba){case k:this._onKeyPressUp(bc);break;case j:this._onKeyPressDown(bc);break;case h:this._onKeyPressLeft(bc);break;case y:this._onKeyPressRight(bc);break;case d:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
else if(bb){var bd=bc.getSelectedButton();if(bd){switch(ba){case c:this._onKeyPressEnter(bc,bd,e);break;case f:this._onKeyPressSpace(bc,bd,e);break;};e.stopPropagation();e.preventDefault();}
;}
;}
...
;}
,_onRoll:function(e){var bK=e.getTarget();bK=qx.ui.core.Widget.getWidgetByElement(bK,true);if(this.__oK.length>0&&!this._isInMenu(bK)&&!this._isMenuOpener(bK)&&!e.getMomentum()){this.hideAll();}
;}
},destruct:function(){var bM=qx.event.Registration;var bL=document.body;bM.removeListener(window.document.documentElement,t,this._onPointerDown,this,true);bM.removeListener(bL,g,this._onKeyUpDown,this,true);bM.removeListener(bL,v,this._onKeyUpDown,this,true);bM.removeListener(bL,w,this._onKeyPress,this,true);this._disposeObjects(q,b);this._disposeArray(s);}
});}
)();
...
;this.__qn();}
,__qn:function(){if(this.isVisible()){if(this.getBlockBackground()){var V=this.getZIndex();this._blocker.blockContent(V-1);}
;}
...
,__qo:function(){var bn=this._getMenuBounds();if(!bn){this.addListenerOnce(n,this.__qo,this);return;}
...
;this.__qm=bp;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bq){this.getChildControl(h);if(this.__qm){this.__qm.call(this);delete this.__qm;}
;}
...
else {throw new Error(y+br);}
;this.__qo();}
;}
,_onPointerOver:function(e){var bt=qx.ui.menu.Manager.getInstance();bt.cancelClose(this);var bu=e.getTarget();if(bu.isEnabled()&&bu instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(bu);var bs=bu.getMenu&&bu.getMenu();if(bs){bs.setOpener(bu);bt.scheduleOpen(bs);this.__ql=bs;}
else {var bv=this.getOpenedButton();if(bv){bt.scheduleClose(bv.getMenu());}
;if(this.__ql){bt.cancelOpen(this.__ql);this.__ql=null;}
;}
;}
else if(!this.getOpenedButton()){this.resetSelectedButton();}
;}
,_onPointerOut:function(e){var bw=qx.ui.menu.Manager.getInstance();if(!qx.ui.core.Widget.contains(this,e.getRelatedTarget())){var bx=this.getOpenedButton();bx?this.setSelectedButton(bx):this.resetSelectedButton();if(bx){bw.cancelClose(bx.getMenu());}
;if(this.__ql){bw.cancelOpen(this.__ql);}
;}
;}
...
(function(){var a="qx.ui.menu.Layout",b="Integer",c="_applyLayoutChange";qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:b,init:0,apply:c},spanColumn:{check:b,init:1,nullable:true,apply:c},iconColumnWidth:{check:b,init:0,themeable:true,apply:c},arrowColumnWidth:{check:b,init:0,themeable:true,apply:c}},members:{__qp:null,_computeSizeHint:function(){var q=this._getLayoutChildren();var o,g,k;var e=this.getSpanColumn();var j=this.__qp=[0,0,0,0];var n=this.getColumnSpacing();var m=0;var f=0;for(var i=0,l=q.length;i<l;i++ ){o=q[i];if(o.isAnonymous()){continue;}
...
,getColumnSizes:function(){return this.__qp||null;}
...
;var x=this.__qq(y[0]);var w=x.getColumnSizes();var s=x.getSpacingX();var z=qx.lang.Array.sum(w)+s*(w.length-1);if(z<o){w[1]+=o-z;}
...
;}
;}
,__qq:function(B){while(!(B instanceof qx.ui.menu.Menu)){B=B.getLayoutParent();}
;return B;}
...
,__qw:function(){var y=this.getChildrenContainer().getChildren();y=y.filter(function(z){return z.getVisibility()==k;}
