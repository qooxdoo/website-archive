...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Atom","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Atom.cdd72638c53a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Icon Top",b="Wider Atom",c="Icon Bottom",d="bottom",e="Atom With Long Label",f="icon/32/actions/go-previous.png",g="#E6FAED",h="Atom Without Label",i="icon/32/actions/go-next.png",j="icon/32/actions/go-up.png",k="icon/32/apps/internet-feed-reader.png",l="Icon Left",m="demobrowser.demo.widget.Atom",n="icon",o="icon/32/actions/go-down.png",p="left",q="icon/32/apps/utilities-notes.png",r="top",s="right",t="main",u="#FAF8E6",v="Atom Without Icon",w="Higher Atom",x="#EAE6FA",y="label",z="#E6EDFA",A="Icon Right";qx.Class.define(m,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var B=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));this.getRoot().add(B,{left:20,top:20});B.add(new qx.ui.basic.Atom(l,f).set({backgroundColor:g,decorator:t,iconPosition:p,padding:5,allowGrowY:false}));B.add(new qx.ui.basic.Atom(a,j).set({backgroundColor:g,decorator:t,iconPosition:r,padding:5,allowGrowY:false}));B.add(new qx.ui.basic.Atom(A,i).set({backgroundColor:g,decorator:t,iconPosition:s,padding:5,allowGrowY:false}));B.add(new qx.ui.basic.Atom(c,o).set({backgroundColor:g,decorator:t,iconPosition:d,padding:5,allowGrowY:false}));B.add(new qx.ui.core.Spacer().set({width:40}));B.add(new qx.ui.basic.Atom(h,k).set({backgroundColor:u,decorator:t,show:n,padding:5,allowGrowY:false}));B.add(new qx.ui.basic.Atom(v,k).set({backgroundColor:u,decorator:t,show:y,padding:5,allowGrowY:false}));var D=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));this.getRoot().add(D,{left:20,top:150});D.add(new qx.ui.basic.Atom(e).set({backgroundColor:z,decorator:t,padding:5,width:100,allowGrowY:false}));D.add(new qx.ui.basic.Atom(e,k).set({backgroundColor:z,decorator:t,padding:5,width:150,allowGrowY:false}));D.add(new qx.ui.basic.Atom(e,k).set({backgroundColor:x,decorator:t,iconPosition:r,padding:5,width:100,allowGrowY:false}));var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));this.getRoot().add(C,{left:20,top:250});C.add(new qx.ui.basic.Atom(b).set({backgroundColor:z,decorator:t,center:true,padding:5,width:100,allowGrowY:false}));C.add(new qx.ui.basic.Atom(b,q).set({backgroundColor:z,decorator:t,center:true,padding:5,width:140,allowGrowY:false}));C.add(new qx.ui.basic.Atom(w,q).set({backgroundColor:z,decorator:t,iconPosition:r,center:true,padding:5,height:100,allowGrowY:false}));}
}});}
)();
