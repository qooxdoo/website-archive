...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.PageVisibility","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.6b9bd32406d3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a=" --- ",b="change",c="red",d="</span> | ",e=";'>",f="<br>",g="green",h="----------- visibility change event -----------",i="state:",j="hidden: <span style='color:",k="demobrowser.demo.bom.PageVisibility",l="log";qx.Class.define(k,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var m=new qx.bom.PageVisibility();var n=this.log;m.on(b,function(){n(h);}
);setInterval(function(){var o=m.isHidden();n(+(new Date())+a+j+(o?c:g)+e+o+d+i+m.getVisibilityState());}
,1000);}
,log:function(p){var q=document.getElementById(l);q.innerHTML=p+f+document.getElementById(l).innerHTML;}
}});}
)();
...
;return this.$$instance;}
},construct:function(document){this.__pf=document||window.document;this.__HS();var self=this;qx.bom.Event.addNativeListener(this.__pf,this.__dx,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__pf:null,__HQ:null,__HR:null,__dx:null,__HS:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__pf[m]!=undefined){this.__HQ=m;this.__dx=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__pf[m]!=undefined){this.__HR=m;break;}
;}
;if(this.__HQ==null){this.__HQ=k;this.__dx=c;}
;if(this.__HR==null){this.__HR=b;}
;}
,isHidden:function(){return !!this.__pf[this.__HQ];}
,getVisibilityState:function(){return this.__pf[this.__HR]||d;}
}});}
)();
