...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.fbbc3d05e410.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__IU].values;var bo=this.__IQ[this.__IU];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__IV){bn.shift();}
...
;this.__IS.setRed(bx);this.__IS.setGreen(bw);this.__IS.setBlue(bv);this.__IR.open();}
,_onColorSelectorOk:function(){var by=this.__IS;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__IR.close();}
,_onColorSelectorCancel:function(){this.__IR.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__IR){this.__IR.destroy();this.__IS.destroy();this.__IT.destroy();}
;this._tables=this.__IQ=null;}
});}
)();
...
,setValue:function(da){var cY;if(da==null){this.__pB=true;cY=[255,255,255];}
else {cY=qx.util.ColorUtil.stringToRgb(da);this.__pB=false;}
;this.__CD=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__CD=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__pB?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__pB=true;this.__CD=true;this.setRed(255);this.setGreen(255);this.__CD=false;this.setBlue(255);}
,__pD:function(){if(!this.__CD){this.__pB=false;this.fireDataEvent(f,this.getValue());}
;}
...
;switch(this.__Cx){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pD();if(this.__Cx===bU){this.__Cx=null;}
;}
,_applyGreen:function(de,dd){if(this.__Cx===null){this.__Cx=cq;}
;if(this.__Cx!==cK){this.getChildControl(O).setValue(de);}
;if(this.__Cx!==n){this._setHexFromRgb();}
;switch(this.__Cx){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pD();if(this.__Cx===cq){this.__Cx=null;}
;}
,_applyBlue:function(dg,df){if(this.__Cx===null){this.__Cx=d;}
;if(this.__Cx!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__Cx!==n){this._setHexFromRgb();}
;switch(this.__Cx){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pD();if(this.__Cx===d){this.__Cx=null;}
;}
