...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.6ebd93122ad7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="__Qj",c="__Ql",d="Flash Player Version",f="right",g="qooxdoo is the best!",h="Message from Flash:",i="execute",j="Simple demo with FlashVars",k="bgcolor",l="__cz",m="demobrowser.demo.widget.Flash",n="demobrowser/demo/flash/TestFlash.swf",o="1) no pop-up or advertising blocker is activated.\n",p="Send to Flash",q="demobrowser/demo/flash/FlashVersion.swf",r="No message.",s="__Qk",t="Flash:",u="<b>qooxdoo:</b>",v="__Fm",w="demobrowser.demo.widget.Flash.sendMessage",x="demobrowser.demo.widget.Flash.flashReady",y="Couldn't connect to Flash Player! Please make sure that:\n",z="demobrowser/demo/flash/fo_tester.swf",A="this is passed in via FlashVars",B="Two way communication (ActionScript <-> JavaScript)",C="Message to Flash:",D="Show Flash Player version",E="noscale",F="#FF6600";qx.Class.define(m,{extend:qx.application.Standalone,members:{__cz:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(j);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(B);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cz=this.createWindow();G.add(this.__cz,{top:20,left:20});}
,createWindow:function(){var K=new qx.ui.window.Window(d).set({width:300,height:200,contentPadding:[0,0,0,0]});K.setLayout(new qx.ui.layout.Canvas());K.add(new qx.ui.embed.Flash(q),{edge:0});return K;}
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:A};var M=new qx.ui.embed.Flash(z).set({scale:E,variables:L});M.getContentElement().setParam(k,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(D);O.addListener(i,function(){this.__cz.open();}
,this);N.add(O);return N;}
,__Fm:null,__Qj:null,__Qk:null,__Ql:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(u).set({rich:true}));Q.add(new qx.ui.basic.Label(h));this.__Qj=new qx.ui.form.TextArea(r);this.__Qj.setEnabled(false);Q.add(this.__Qj,{flex:1});Q.add(new qx.ui.basic.Label(C));this.__Qk=new qx.ui.form.TextArea(g);Q.add(this.__Qk,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,f));this.__Ql=new qx.ui.form.Button(p);this.__Ql.setEnabled(false);this.__Ql.addListener(i,function(e){this.__Fm.getFlashElement().sendMessage(this.__Qk.getValue());}
,this);S.add(this.__Ql);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(t).set({rich:true}));this.__Fm=new qx.ui.embed.Flash(n);this.__Fm.setVariables({init:x});P.add(this.__Fm,{flex:1});return R;}
,sendMessage:function(T){this.__Qj.setValue(T);}
,initFlash:function(){if(this.__Fm.getFlashElement().setup){this.__Fm.getFlashElement().setup(w);this.__Ql.setEnabled(true);}
else {alert(y+o+a);}
;}
},statics:{__Qm:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__Qm=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__Qm.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__Qm.initFlash();}
},destruct:function(){this._disposeObjects(b,s,c,v,l);}
});}
)();
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__Fc){this.__Fc=new Date().getTime();}
;var bp=new Date().getTime()-this.__Fc;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__Fc=null;}
;}
else {this.fireEvent(p);this.__Fc=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__Fd(c,bB);}
,_applyScale:function(bD,bC){this.__Fd(h,bD);}
,_applyWmode:function(bF,bE){this.__Fd(m,bF);}
,_applyPlay:function(bH,bG){this.__Fd(I,bH);}
,_applyLoop:function(bJ,bI){this.__Fd(s,bJ);}
,_applyMenu:function(bL,bK){this.__Fd(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__Fd(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__Fd(z,bP);}
,__Fd:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__Fj={};this.__Fk={};this.__Fl={};}
,members:{__Fj:null,__Fl:null,__Fk:null,__Fm:null,_createDomElement:function(){return qx.dom.Element.create(i);}
...
;if(this.__Fm){throw new Error(d);}
;this.__Fk=t;}
...
else if(this.__Fm){throw new Error(j);}
;if(v===null||v===undefined){delete this.__Fl[u];}
else {this.__Fl[u]=v;}
;}
...
;}
;}
;if(this.__Fm){throw new Error(l);}
;if(x===null||x===undefined){delete this.__Fj[w];}
else {this.__Fj[w]=x;}
;}
...
;}
;}
;var O=this.__Fs(P,R,Q,M);this._flashObjects[R.id]=O;return O;}
,destroy:function(T,S){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){T=this.__Fn(T);if(T.readyState==4){this.__Fo(T);}
else {if(!S){S=window;}
;qx.bom.Event.addNativeListener(S,p,function(){qx.bom.Flash.__Fo(T);}
);}
;}
else {T=this.__Fn(T);if(T.parentNode){T.parentNode.removeChild(T);}
;delete this._flashObjects[T.id];}
;}
,__Fn:function(U){if(!U){throw new Error(z);}
;if(U.tagName.toLowerCase()!==L){U=U.firstChild;}
;if(!U||U.tagName.toLowerCase()!==L){throw new Error(A);}
;return U;}
,__Fo:qx.core.Environment.select(D,{"mshtml":qx.event.GlobalError.observeMethod(function(V){for(var i in V){if(typeof V[i]==b){V[i]=null;}
;}
;if(V.parentNode){V.parentNode.removeChild(V);}
;delete this._flashObjects[V.id];}
),"default":null}),__Fp:qx.event.GlobalError.observeMethod(function(){for(var W in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[W]);}
;window.__Fq=function(){}
;window.__Fr=function(){}
;qx.bom.Event.removeNativeListener(window,F,qx.bom.Flash.__Fp);}
),__Fs:function(bb,bd,bc,X){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){bc.movie=bd.data;delete bd.data;delete bd.classid;var Y=u;for(var name in bc){Y+=m+name+J+bc[name]+E;}
...
},defer:function(bf){if(qx.core.Environment.get(D)==v){qx.bom.Event.addNativeListener(window,F,bf.__Fp);}
;}
});}
)();
(function(){var a="qx.util.TimerManager",b="interval",c="singleton";qx.Class.define(a,{extend:qx.core.Object,type:c,statics:{__Fe:[],__Ff:{},__uA:0},members:{__Fg:false,start:function(g,f,h,d,j){if(!j){j=f||0;}
;var e=(new Date()).getTime()+j;this.self(arguments).__Ff[ ++this.self(arguments).__uA]={callback:g,userData:d||null,expireAt:e,recurTime:f,context:h||this};this.__Fh(e,this.self(arguments).__uA);return this.self(arguments).__uA;}
,stop:function(k){var l=this.self(arguments).__Fe;var length=l.length;for(var i=0;i<length;i++ ){if(l[i]==k){l.splice(i,1);break;}
;}
;delete this.self(arguments).__Ff[k];if(l.length==0&&this.__Fg){qx.event.Idle.getInstance().removeListener(b,this.__Fi,this);this.__Fg=false;}
;}
,__Fh:function(m,p){var o=this.self(arguments).__Fe;var n=this.self(arguments).__Ff;var length=o.length;for(var i=0;i<length;i++ ){if(n[o[i]].expireAt>m){o.splice(i,0,p);break;}
;}
;if(o.length==length){o.push(p);}
;if(!this.__Fg){qx.event.Idle.getInstance().addListener(b,this.__Fi,this);this.__Fg=true;}
;}
,__Fi:function(){var r=(new Date()).getTime();var t=this.self(arguments).__Fe;var s=this.self(arguments).__Ff;while(t.length>0&&s[t[0]].expireAt<=r){var v=t.shift();var q=s[v];q.callback.call(q.context,q.userData,v);if(q.recurTime&&s[v]){var u=(new Date()).getTime();q.expireAt=u+q.recurTime;this.__Fh(q.expireAt,v);}
else {delete s[v];}
;}
;if(t.length==0&&this.__Fg){qx.event.Idle.getInstance().removeListener(b,this.__Fi,this);this.__Fg=false;}
;}
}});}
)();
