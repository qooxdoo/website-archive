...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Bubbling.4d56944f0724.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__Pe=f+p.join(c)+a;this.__Pf=o||50;this.__Pg=n;this._clearLog();}
,_clearLog:function(){this.__Pg.innerHTML=this.__Pe+k;this.__Ph=[];}
,_log:function(q){this.__Ph.unshift(q);this.__Ph=this.__Ph.slice(0,this.__Pf);var r=[this.__Pe];for(var i=0;i<this.__Ph.length;i++ ){r.push(g,this.__Ph[i].join(e),l);}
;r.push(k);this.__Pg.innerHTML=r.join(d);this.__Pg.scrollTop=0;}
,__Pe:null,__Pf:null,__Pg:null,__Ph:null},destruct:function(){this.__Pg=this.__Ph=null;}
});}
)();
