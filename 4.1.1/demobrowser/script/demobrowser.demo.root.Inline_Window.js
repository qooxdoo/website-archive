...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Inline_Window","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Window.a78d8024883c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="qx.ui.root.Page",c="engine.name",d="mshtml",f="gecko",g="paddingLeft",h="$$widget",i="The root widget does not support 'left', or 'top' paddings!",j="div",k="left",l="paddingTop",m="qxIsRootPage",n="absolute";qx.Class.define(b,{extend:qx.ui.root.Abstract,construct:function(o){this.__pf=o;qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());this.setZIndex(10000);qx.ui.core.queue.Layout.add(this);this.addListener(a,this.__yQ,this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==d)){this.setKeepFocus(true);}
;}
,members:{__eg:null,__pf:null,_createContentElement:function(){var q=this.__pf.createElement(j);this.__pf.body.appendChild(q);var p=new qx.html.Root(q);p.setStyles({position:n,textAlign:k});p.setAttribute(h,this.toHashCode());if((qx.core.Environment.get(c)==f)){p.setAttribute(m,1);}
;return p;}
...
,__yQ:function(e){this.getContentElement().setStyles({width:0,height:0});}
...
(function(){var a="demobrowser.demo.root.Inline_Window",b="Add window",c="Window #",d="isle",f="Add modal window",g="Modal Window #",h="white",i="main",j="execute";qx.Class.define(a,{extend:qx.application.Inline,members:{main:function(){qx.application.Inline.prototype.main.call(this);var n=new qx.ui.root.Inline(document.getElementById(d)).set({decorator:i,padding:10,backgroundColor:h});n.setLayout(new qx.ui.layout.HBox(10));var k=new qx.ui.form.Button(b);var m=1;k.addListener(j,function(e){var o=new qx.ui.window.Window(c+m++ ).set({width:200,height:150});o.moveTo(m*15,m*15);o.open();}
);n.add(k);var l=new qx.ui.form.Button(f);l.addListener(j,this.newModalWindow,this);n.add(l);}
,cModWin:1,newModalWindow:function(){var p=new qx.ui.window.Window(g+this.cModWin++ ).set({modal:true});p.moveTo(300+this.cModWin*15,this.cModWin*15);p.setLayout(new qx.ui.layout.HBox());var q=new qx.ui.form.Button(f);q.addListener(j,this.newModalWindow,this);p.add(q);p.open();}
}});}
)();
...
;this.__zA=w;w.style.overflow=p;w.style.textAlign=r;this.__zB=x||false;this.__zC=v||false;this.__zD();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==b)){this.setKeepFocus(true);}
...
,members:{__zB:false,__zC:false,__zA:null,__zD:function(){if(this.__zB||this.__zC){var y=qx.bom.element.Dimension.getSize(this.__zA);if(this.__zB&&y.width<1){throw new Error(s+this.__zA+t+this+k);}
;if(this.__zC){if(y.height<1){throw new Error(s+this.__zA+t+this+g);}
;if(y.height>=1&&qx.bom.element.Style.get(this.__zA,j,3)==f){qx.bom.element.Style.set(this.__zA,j,y.height+h);}
;}
;qx.event.Registration.addListener(this.__zA,a,this._onResize,this);}
;}
,_createContentElement:function(){var z=this.__zA;if(this.__zB||this.__zC){var B=document.createElement(q);z.appendChild(B);}
else {B=z;}
...
,this,0);return A;}
,_onResize:function(e){var C=e.getData();if((C.oldWidth!==C.width)&&this.__zB||(C.oldHeight!==C.height)&&this.__zC){qx.ui.core.queue.Layout.add(this);}
;}
...
;}
,_computeSizeHint:function(){var H=this.__zB;var E=this.__zC;if(!H||!E){var D=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {D={};}
;var I=qx.bom.element.Dimension;if(H){var G=I.getContentWidth(this.__zA);D.width=G;D.minWidth=G;D.maxWidth=G;}
;if(E){var F=I.getContentHeight(this.__zA);D.height=F;D.minHeight=F;D.maxHeight=F;}
;return D;}
},defer:function(J,K){qx.ui.core.MLayoutHandling.remap(K);}
,destruct:function(){qx.event.Registration.removeListener(this.__zA,a,this._onResize,this);this.__zA=null;}
});}
)();
(function(){var a="resize",b="__eg",c="interval",d="body",f="qx.event.handler.ElementResize";qx.Class.define(f,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);this.__gz=g;this.__zE={};this.__eg=new qx.event.Timer(200);this.__eg.addListener(c,this._onInterval,this);}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__zE:null,__gz:null,__eg:null,canHandleEvent:function(i,h){return i.tagName.toLowerCase()!==d;}
,registerEvent:function(m,n,j){var l=qx.core.ObjectRegistry.toHashCode(m);var k=this.__zE;if(!k[l]){k[l]={element:m,width:qx.bom.element.Dimension.getWidth(m),height:qx.bom.element.Dimension.getHeight(m)};this.__eg.start();}
;}
,unregisterEvent:function(r,s,o){var q=qx.core.ObjectRegistry.toHashCode(r);var p=this.__zE;if(p[q]){delete p[q];if(qx.lang.Object.isEmpty(p)){this.__eg.stop();}
;}
;}
,_onInterval:function(e){var u=this.__zE;for(var x in u){var y=u[x];var t=y.element;var w=qx.bom.element.Dimension.getWidth(t);var v=qx.bom.element.Dimension.getHeight(t);if(y.height!==v||y.width!==w){qx.event.Registration.fireNonBubblingEvent(t,a,qx.event.type.Data,[{width:w,oldWidth:y.width,height:v,oldHeight:y.height}]);y.width=w;y.height=v;}
;}
;}
},destruct:function(){this.__gz=this.__zE=null;this._disposeObjects(b);}
