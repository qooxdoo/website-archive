...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererDouble.48febde2aa24.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,getItems:function(){var y={};for(var i=0;i<this.__vs.length;i++ ){var z=this.__vs[i];for(var j=0;j<z.names.length;j++ ){var name=z.names[j];y[name]=z.items[j];}
;}
;return y;}
...
;}
;return false;}
,reset:function(){for(var i=0;i<this.__mh.length;i++ ){var j=this.__mh[i];this.__vJ(j.item,j.init);}
;}
...
else if(this.__vD(n)||this.__vL(n)){n.setSelection(o);}
;}
,redefine:function(){for(var i=0;i<this.__mh.length;i++ ){var p=this.__mh[i].item;this.__mh[i].init=this.__vK(p);}
;}
...
else if(this.__vD(s)||this.__vL(s)){return s.getSelection();}
;}
...
(function(){var a="Boolean",b="_applyValid",c="",d="changeRequired",f="__nY",g="changeValid",h="changeInvalidMessage",j="changeSelection",k="_applyInvalidMessage",l="String",m="qx.ui.form.RadioButtonGroup",n="qx.event.type.Data";qx.Class.define(m,{extend:qx.ui.core.Widget,include:[qx.ui.core.MLayoutHandling,qx.ui.form.MModelSelection],implement:[qx.ui.form.IForm,qx.ui.core.ISingleSelection,qx.ui.form.IModelSelection],construct:function(o){qx.ui.core.Widget.call(this);if(o==null){this.setLayout(new qx.ui.layout.VBox(4));}
else {this.setLayout(o);}
;this.__nY=new qx.ui.form.RadioGroup();this.__nY.addListener(j,function(e){this.fireDataEvent(j,e.getData(),e.getOldData());}
,this);}
,properties:{valid:{check:a,init:true,apply:b,event:g},required:{check:a,init:false,event:d},invalidMessage:{check:l,init:c,event:h,apply:k},requiredInvalidMessage:{check:l,nullable:true,event:h}},events:{"changeSelection":n},members:{__nY:null,_applyInvalidMessage:function(r,p){var q=this._getChildren();for(var i=0;i<q.length;i++ ){q[i].setInvalidMessage(r);}
;}
,_applyValid:function(u,s){var t=this._getChildren();for(var i=0;i<t.length;i++ ){t[i].setValid(u);}
;}
,getRadioGroup:function(){return this.__nY;}
,getChildren:function(){return this._getChildren();}
,add:function(w,v){this.__nY.add(w);this._add(w,v);}
,remove:function(x){this.__nY.remove(x);this._remove(x);}
,removeAll:function(){var y=this.__nY.getItems();for(var i=y.length-1;i>=0;i-- ){this.__nY.remove(y[i]);}
;return this._removeAll();}
,getSelection:function(){return this.__nY.getSelection();}
,setSelection:function(z){this.__nY.setSelection(z);}
,resetSelection:function(){this.__nY.resetSelection();}
,isSelected:function(A){return this.__nY.isSelected(A);}
,isSelectionEmpty:function(){return this.__nY.isSelectionEmpty();}
,getSelectables:function(B){return this.__nY.getSelectables(B);}
