...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Placeholder.9eee5fe73c89.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
;return B;}
,getAncestors:function(E){return this.__zP(null,E);}
,getAncestorsUntil:function(G,F){return this.__zP(G,F);}
,__zP:function(I,J){var H=[];for(var i=0;i<this.length;i++ ){var parent=qx.dom.Element.getParentElement(this[i]);while(parent){var K=[parent];if(I&&qx.bom.Selector.matches(I,K).length>0){break;}
...
;return be;}
,getNextAll:function(bh){var bg=qx.module.Traversing.__zT(this,f,bh);return qxWeb.$init(bg,qxWeb);}
...
;return bn;}
,getPrevAll:function(bq){var bp=qx.module.Traversing.__zT(this,k,bq);return qxWeb.$init(bp,qxWeb);}
...
,getSiblings:function(bx){var bw=qx.module.Traversing.__zT(this,n,bx);return qxWeb.$init(bw,qxWeb);}
...
,__zQ:function(bE){if(bE instanceof qxWeb){return bE[0];}
else if(qx.Bootstrap.isString(bE)){return qxWeb(bE)[0];}
;return bE;}
,isElement:function(bF){return qx.dom.Node.isElement(qx.module.Traversing.__zQ(bF));}
,isNode:function(bG){return qx.dom.Node.isNode(qx.module.Traversing.__zQ(bG));}
,isNodeName:function(bI,bH){return qx.dom.Node.isNodeName(qx.module.Traversing.__zQ(bI),bH);}
...
,getWindow:function(bL){return qx.dom.Node.getWindow(qx.module.Traversing.__zQ(bL));}
...
,getDocument:function(bO){return qx.dom.Node.getDocument(qx.module.Traversing.__zQ(bO));}
,getNodeName:function(bP){return qx.dom.Node.getName(qx.module.Traversing.__zQ(bP));}
,getNodeText:function(bQ){return qx.dom.Node.getText(qx.module.Traversing.__zQ(bQ));}
,isBlockNode:function(bR){return qx.dom.Node.isBlockNode(qx.module.Traversing.__zQ(bR));}
,equalNodes:function(cb,cd){cb=qx.module.Traversing.__zR(cb);cd=qx.module.Traversing.__zR(cd);if(!cb||!cd){return false;}
...
;}
;if(ca){var bS=qx.module.Traversing.__zS(cb);var cc=qx.module.Traversing.__zS(cd);for(var bU in bS){if(bS[bU]!==cc[bU]){return false;}
;}
;}
...
,appendTo:function(parent){parent=qx.module.Manipulating.__zU(parent);for(var i=0,l=parent.length;i<l;i++ ){this._forEachElement(function(r,j){if(i==0){qx.dom.Element.insertEnd(this[j],parent[i]);}
else {qx.dom.Element.insertEnd(this.eq(j).clone(true)[0],parent[i]);}
;}
);}
;return this;}
,insertBefore:function(s){s=qx.module.Manipulating.__zU(s);for(var i=0,l=s.length;i<l;i++ ){this._forEachElement(function(t,u){if(i==0){qx.dom.Element.insertBefore(t,s[i]);}
else {qx.dom.Element.insertBefore(this.eq(u).clone(true)[0],s[i]);}
;}
);}
;return this;}
,insertAfter:function(v){v=qx.module.Manipulating.__zU(v);for(var i=0,l=v.length;i<l;i++ ){for(var j=this.length-1;j>=0;j-- ){if(!this[j]||this[j].nodeType!==1){continue;}
;if(i==0){qx.dom.Element.insertAfter(this[j],v[i]);}
else {qx.dom.Element.insertAfter(this.eq(j).clone(true)[0],v[i]);}
;}
;}
;return this;}
,__zU:function(x){if(!qx.lang.Type.isArray(x)){var w=qxWeb(x);x=w.length>0?w:[x];}
;return x.filter(function(y){return (y&&(y.nodeType===1||y.nodeType===11));}
);}
,wrap:function(z){z=qx.module.Manipulating.__zV(z);if(z.length==0){return this;}
;this._forEachElement(function(A){var B=z.eq(0).clone(true);qx.dom.Element.insertAfter(B[0],A);var C=qx.module.Manipulating.__zW(B[0]);qx.dom.Element.insertEnd(A,C);}
);return this;}
,__zV:function(F){var D;if(qx.lang.Type.isArray(F)){D=qxWeb(F);}
else {var E=qx.bom.Html.clean([F]);if(E.length>0&&qx.dom.Node.isElement(E[0])){D=qxWeb(E);}
else {D=qxWeb(F);}
;}
;return D;}
,__zW:function(G){if(G.childNodes.length==0){return G;}
;for(var i=0,l=G.childNodes.length;i<l;i++ ){if(G.childNodes[i].nodeType===1){return this.__zW(G.childNodes[i]);}
;}
;return G;}
...
;return U.scrollTop;}
,_animationDescription:{scrollLeft:{duration:700,timing:c,keep:100,keyFrames:{'0':{},'100':{scrollLeft:1}}},scrollTop:{duration:700,timing:c,keep:100,keyFrames:{'0':{},'100':{scrollTop:1}}}},__zX:function(W,X,V){var Y=qx.lang.Object.clone(qx.module.Manipulating._animationDescription[W],true);Y.keyFrames[100][W]=X;return this.animate(Y,V);}
,setScrollLeft:function(bb,bc){var Node=qx.dom.Node;if(bc&&qx.bom.element&&qx.bom.element.AnimationJs){qx.module.Manipulating.__zX.bind(this,a,bb,bc)();}
...
;}
;return this;}
,setScrollTop:function(be,bf){var Node=qx.dom.Node;if(bf&&qx.bom.element&&qx.bom.element.AnimationJs){qx.module.Manipulating.__zX.bind(this,d,be,bf)();}
...
;var J=L.getProperty(qx.module.Placeholder.PLACEHOLDER_NAME);if(!J){J=qx.module.Placeholder.__IX(L);}
;var K=L.isRendered();var M=J.isRendered();if(K&&!M){L.before(J);}
else if(!K&&M){J.remove();return this;}
;qx.module.Placeholder.__IW(L);}
;}
;return this;}
,__IW:function(T){var U=T.getAttribute(o);var Q=T.getProperty(qx.module.Placeholder.PLACEHOLDER_NAME);var S=T.getStyle(A);var P=parseInt(T.getStyle(p))+2*parseInt(T.getStyle(m));var R=parseInt(T.getStyle(y))+2*parseInt(T.getStyle(E));Q.setHtml(U).setStyles({display:T.getValue()==t?g:z,zIndex:S==j?1:S+1,textAlign:T.getStyle(n),width:(T.getWidth()-P-4)+d,height:(T.getHeight()-R-4)+d,left:T.getPosition().left+d,top:T.getPosition().top+d,fontFamily:T.getStyle(l),fontStyle:T.getStyle(H),fontVariant:T.getStyle(f),fontWeight:T.getStyle(q),fontSize:T.getStyle(c),paddingTop:(parseInt(T.getStyle(y))+2)+d,paddingRight:(parseInt(T.getStyle(m))+2)+d,paddingBottom:(parseInt(T.getStyle(E))+2)+d,paddingLeft:(parseInt(T.getStyle(p))+2)+d});}
,__IX:function(V){var W=qxWeb.create(b).setStyles({position:G,color:r,overflow:D,pointerEvents:z});V.setProperty(qx.module.Placeholder.PLACEHOLDER_NAME,W);V.on(w,function(X){var Y=X.getProperty(qx.module.Placeholder.PLACEHOLDER_NAME);Y.setStyle(x,X.getValue()==t?g:z);}
