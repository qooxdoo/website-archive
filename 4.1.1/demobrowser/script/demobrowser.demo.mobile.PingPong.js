...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.397a4b934f31.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__Pw=this.__PA(L);U.add(this.__Pw);var Q=this.__PA(A);U.add(Q);this.__Pn=this.__PB(L);this.__Pw.add(this.__Pn);this.__Pw.addListener(M,qx.lang.Function.bind(this.__AG,this),this);this.__Pm=this.__PB(A);Q.add(this.__Pm);Q.addListener(M,qx.lang.Function.bind(this.__AG,this),this);this.__Po=this.__PC();U.add(this.__Po);this.__Pu=this.__PD();this.__Pw.add(this.__Pu);this.__Pv=this.__PD();Q.add(this.__Pv);this.__Pt=[0,0];this.__Px();}
,__Px:function(){this.__Po.setStyles({"left":k,"top":k});this.__Pp=new qx.event.Timer(40);this.__Pp.addListener(n,function(){var x=(parseInt(this.__Po.getStyle(L))+this.__Pq*this.__Pr);var y=(parseInt(this.__Po.getStyle(z))+this.__Pq*this.__Ps);this.__Po.setStyle(L,x+c);this.__Po.setStyle(z,y+c);this.__Pz();}
,this);this.__Pp.start();}
,__Py:function(V){this.__Pp.stop();this.__Pp.dispose();this.__Pq=5;this.__Pt[V]=this.__Pt[V]+1;this.__Pu.setAttribute(w,this.__Pt[0]);this.__Pv.setAttribute(w,this.__Pt[1]);this.__Px();}
,__Pz:function(){var X=this.getBoundsFor(this.__Po);if(X.top<=0){this.__Ps=1;}
;if(X.bottom>=window.innerHeight-5){this.__Ps=-1;}
;if(X.left<=0||X.right>=window.innerWidth){this.__Py(X.left<=0?1:0);}
;var Y=this.getBoundsFor(this.__Pn);if(X.left<=Y.right&&X.bottom>=Y.top&&X.top<=Y.bottom){this.__Pr=1;this.__Pq=Math.min(this.__Pq+1,20);}
;var W=this.getBoundsFor(this.__Pm);if(X.right>=W.left&&X.bottom>=W.top&&X.top<=W.bottom){this.__Pr=-1;this.__Pq=Math.min(this.__Pq+1,20);}
;}
,__AG:function(e){var ba;if(qx.dom.Hierarchy.contains(this.__Pw.getDomElement(),e.getTarget())){ba=this.__Pn;}
else {ba=this.__Pm;}
...
,__PA:function(bd){var bc={"width":C,"height":h,"position":N,"backgroundColor":a};if(bd==L){bc[J]=u;}
else {bc[L]=C;bc[d]=u;}
;return new qx.html.Element(g,bc);}
,__PB:function(bf){var be={"width":l,"height":t,"top":t,"position":N,"backgroundColor":K};be[bf]=F;return new qx.html.Element(g,be);}
,__PC:function(){var bg={"width":F,"height":F,"position":N,"backgroundColor":K,"userSelect":I};return new qx.html.Element(g,bg);}
,__PD:function(){var bh={"width":h,"height":h,"textAlign":r,"fontSize":H,"color":b,"fontFamily":B};var bi=new qx.html.Element(g,bh);bi.setAttribute(w,j);return bi;}
}});}
)();
