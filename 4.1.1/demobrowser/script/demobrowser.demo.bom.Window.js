...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.78688b88b4fe.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__lr:null,__Jp:null,__eg:null,__Jq:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__Jr:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Js:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__Jt(H,E&&A);if(E){if(this.__Js()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__eg==null){this.__eg=new qx.event.Timer(500);this.__eg.addListener(f,this.__Ju,this);}
;this.__Jp=window.open(z,name,G);this.__eg.restart();C=this.__Jp;}
;}
...
;return C;}
,__Jt:function(K,O){var M;var J;var N=[];if(O&&this.__Js()){for(var L in K){if(qx.bom.Window.__Jq[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__Jq[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__Jr[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__Ju:function(){if(this.isClosed(this.__Jp)){this.getBlocker().unblock();this.__eg.stop();}
;}
...
;return d;}
,__ou:function(I){var H=function(){qx.bom.Event.removeNativeListener(I,j,H);I.$$url=qx.bom.Iframe.queryCurrentUrl(I);}
...
,members:{__Jv:null,__CI:null,__Jw:null,__Jx:false,__Jy:10000,__Jz:0,__JA:f,block:function(r){if(!this.__Jx){this.__Jw=r;var q=this.__JD();this.__JE(q);this.__Jx=true;}
;}
,unblock:function(){if(this.__Jx){this.__JF();this.__Jx=false;}
;}
,isBlocked:function(){return this.__Jx;}
...
,__cR:function(){this.__JB();if((qx.core.Environment.get(j)==b)){this.__JC();}
;qx.event.Registration.addListener(window,a,this.__yQ,this);}
,__JB:function(){this.__CI=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__CI,{display:d,opacity:this.__Jz,backgroundColor:this.__JA});this.setBlockerZIndex(this.__Jy);}
,__JC:function(){this.__Jv=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__Jv,l,false);qx.bom.element.Attribute.set(this.__Jv,i,n);qx.bom.element.Style.setStyles(this.__Jv,{display:d,opacity:this.__Jz});}
...
else {v.width=qx.bom.element.Dimension.getWidth(this.__Jw)+g;v.height=qx.bom.element.Dimension.getHeight(this.__Jw)+g;v.left=qx.bom.element.Location.getLeft(this.__Jw)+g;v.top=qx.bom.element.Location.getTop(this.__Jw)+g;}
;return v;}
,__JE:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__CI,w);qx.dom.Element.insertEnd(this.__CI,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Jv,w);qx.dom.Element.insertEnd(this.__Jv,document.body);}
;}
,__JF:function(){qx.dom.Element.remove(this.__CI);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__Jv);}
;}
,__yQ:function(e){if(this.__JH()){this.__JG({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__JG(y);}
,this,0);}
;}
,__JG:function(z){qx.bom.element.Style.setStyles(this.__CI,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__Jv,z);}
;}
,__JH:function(){return (this.__Jw==null||qx.dom.Node.isWindow(this.__Jw)||qx.dom.Node.isDocument(this.__Jw));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__yQ,this);this.__Jv=this.__CI=this.__Jw=null;}
});}
)();
