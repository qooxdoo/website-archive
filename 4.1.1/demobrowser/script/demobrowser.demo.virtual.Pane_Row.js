...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Pane_Row.9488b5796ee8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="bold",b="demobrowser.demo.virtual.Pane_Row",c="table-scroller-header",d="Even/Odd Colors",e="Custom Colors",f="white",g="Even/Odd & Custom Colors",h="#EEE";qx.Class.define(b,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var j=new qx.ui.layout.Grid(5,0);j.setRowFlex(1,1);j.setColumnFlex(0,1);j.setColumnFlex(1,1);j.setColumnFlex(2,1);var l=new qx.ui.container.Composite(j);this.getRoot().add(l,{edge:0});l.add(new qx.ui.basic.Label(d).set({font:a,decorator:c,padding:3,allowGrowX:true}),{row:0,column:0});var m=new qx.ui.virtual.core.Scroller(100,10000,60,100);m.getPane().addLayer(new qx.ui.virtual.layer.Row(f,h));l.add(m,{row:1,column:0});l.add(new qx.ui.basic.Label(e).set({font:a,decorator:c,padding:3,allowGrowX:true}),{row:0,column:1});var m=new qx.ui.virtual.core.Scroller(100,10000,60,100);var k=new qx.ui.virtual.layer.Row();for(var i=0;i<10000;i++ ){k.setColor(i,qx.util.ColorUtil.randomColor());}
;m.getPane().addLayer(k);l.add(m,{row:1,column:1});l.add(new qx.ui.basic.Label(g).set({font:a,decorator:c,padding:3,allowGrowX:true}),{row:0,column:2});var m=new qx.ui.virtual.core.Scroller(100,10000,60,100);var k=new qx.ui.virtual.layer.Row(f,h);for(var i=0;i<10000;i++ ){if(Math.random()>0.7){k.setColor(i,qx.util.ColorUtil.randomColor());}
;}
;m.getPane().addLayer(k);l.add(m,{row:1,column:2});}
}});}
)();
...
(function(){var a="scrollY",b="The method 'getItemRight' is not implemented!",c="update",d="scrollX",f="The method 'getItemLeft' is not implemented!",g="The method 'getItemBottom' is not implemented!",h="The method 'getItemTop' is not implemented!",i="pane",j="os.scrollBarOverlayed",k="qx.ui.virtual.core.Scroller";qx.Class.define(k,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(o,l,n,m){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__wK=new qx.ui.virtual.core.Pane(o,l,n,m);this.__wK.addListener(c,this._computeScrollbars,this);this.__wK.addListener(d,this._onScrollPaneX,this);this.__wK.addListener(a,this._onScrollPaneY,this);if(qx.core.Environment.get(j)){this._add(this.__wK,{edge:0});}
else {this._add(this.__wK,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__wK:null,getPane:function(){return this.__wK;}
,_createChildControlImpl:function(q,p){if(q==i){return this.__wK;}
...
,_onScrollBarX:function(e){this.__wK.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__wK.setScrollY(e.getData());}
},destruct:function(){this.__wK.dispose();this.__wK=null;}
});}
)();
(function(){var a="scrollY",b="__wL",c="__wT",d="cellTap",f="qx.event.type.Data",g="change",h="qx.debug",j="qx.event.type.Event",k="cellContextmenu",l="dbltap",m="resize",n="cellDbltap",o="scrollX",p="appear",q="__wS",r="pointerdown",s="qx.ui.virtual.core.Pane",t="qx.ui.virtual.core.CellEvent",u="update",v="contextmenu",w="__wM",x="tap";qx.Class.define(s,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__wL=new qx.ui.virtual.core.Axis(A,B);this.__wM=new qx.ui.virtual.core.Axis(z,y);this.__wN=0;this.__wO=0;this.__wP=0;this.__wQ=0;this.__wR={};this.__jh={};this.__wS=new qx.ui.container.Composite();this.__wS.setUserBounds(0,0,0,0);this._add(this.__wS);this.__wT=[];this.__wL.addListener(g,this.fullUpdate,this);this.__wM.addListener(g,this.fullUpdate,this);this.addListener(m,this._onResize,this);this.addListenerOnce(p,this._onAppear,this);this.addListener(r,this._onPointerDown,this);this.addListener(x,this._onTap,this);this.addListener(l,this._onDbltap,this);this.addListener(v,this._onContextmenu,this);}
,events:{cellTap:t,cellContextmenu:t,cellDbltap:t,update:j,scrollX:f,scrollY:f},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__wL:null,__wM:null,__wN:null,__wO:null,__wP:null,__wQ:null,__wR:null,__jh:null,__wS:null,__wT:null,__wU:null,__qp:null,__wV:null,__wW:null,getRowConfig:function(){return this.__wL;}
,getColumnConfig:function(){return this.__wM;}
,getChildren:function(){return [this.__wS];}
,addLayer:function(C){if(qx.core.Environment.get(h)){this.assertInterface(C,qx.ui.virtual.core.ILayer);}
;this.__wT.push(C);C.setUserBounds(0,0,0,0);this.__wS.add(C);}
,getLayers:function(){return this.__wT;}
,getVisibleLayers:function(){var D=[];for(var i=0;i<this.__wT.length;i++ ){var E=this.__wT[i];if(E.isVisible()){D.push(E);}
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__wM.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__wL.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(J){var H=this.getScrollMaxY();if(J<0){J=0;}
else if(J>H){J=H;}
;if(this.__wN!==J){var I=this.__wN;this.__wN=J;this._deferredUpdateScrollPosition();this.fireDataEvent(a,J,I);}
;}
,getScrollY:function(){return this.__wN;}
,setScrollX:function(M){var K=this.getScrollMaxX();if(M<0){M=0;}
else if(M>K){M=K;}
;if(M!==this.__wO){var L=this.__wO;this.__wO=M;this._deferredUpdateScrollPosition();this.fireDataEvent(o,M,L);}
;}
,getScrollX:function(){return this.__wO;}
,getScrollSize:function(){return {width:this.__wM.getTotalSize(),height:this.__wL.getTotalSize()};}
...
,this,0);}
,this);return;}
;var R=this.__wL.getItemPosition(P);var O=R+this.__wL.getItemSize(P);var N=this.getScrollY();if(R<N){this.setScrollY(R);}
...
,this,0);}
,this);return;}
;var U=this.__wM.getItemPosition(S);var T=U+this.__wM.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
...
;bf=this.__wL.getItemAtPosition(this.getScrollY()+bc-bd.top);be=this.__wM.getItemAtPosition(this.getScrollX()+bb-bd.left);if(!bf||!be){return null;}
...
;var bn=this.__wO+bl.width;var bo=this.__wQ-bn;if(this.__wO-this.__wR.left<Math.min(this.__wO,bj)||this.__wR.right-bn<Math.min(bo,bk)){var bp=Math.min(this.__wO,bm);var bh=Math.min(bo,bi);this._setLayerWindow(bg,this.__wO-bp,this.__wN,bl.width+bp+bh,bl.height,false);}
;}
,prefetchY:function(bz,bv,br,bu){var bq=this.getVisibleLayers();if(bq.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bs=this.__wN+bw.height;var bt=this.__wP-bs;if(this.__wN-this.__wR.top<Math.min(this.__wN,bz)||this.__wR.bottom-bs<Math.min(bt,br)){var by=Math.min(this.__wN,bv);var bx=Math.min(bt,bu);this._setLayerWindow(bq,this.__wO,this.__wN-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContentElement().getDomElement()){this.__wU=true;this._updateScrollPosition();this.__wU=null;this.fireEvent(u);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onPointerDown:function(e){this.__wW=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onTap:function(e){this.__wX(e,d);}
,_onContextmenu:function(e){this.__wX(e,k);}
,_onDbltap:function(e){this.__wX(e,n);}
,__wX:function(e,bC){var bB=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bB){return;}
;var bA=this.__wW;if(bA==null||bA.row!==bB.row||bA.column!==bB.column){return;}
...
;this.__jh={};}
,_setLayerWindow:function(bE,bT,top,bP,bL,bV){var bK=this.__wL.getItemAtPosition(top);if(bK){var bN=bK.index;var bR=this.__wL.getItemSizes(bN,bL+bK.offset);var bM=qx.lang.Array.sum(bR);var bU=top-bK.offset;var bQ=top-bK.offset+bM;}
else {var bN=0;var bR=[];var bM=0;var bU=0;var bQ=0;}
;var bF=this.__wM.getItemAtPosition(bT);if(bF){var bJ=bF.index;var bH=this.__wM.getItemSizes(bJ,bP+bF.offset);var bO=qx.lang.Array.sum(bH);var bS=bT-bF.offset;var bI=bT-bF.offset+bO;}
else {var bJ=0;var bH=[];var bO=0;var bS=0;var bI=0;}
;this.__wR={top:bU,bottom:bQ,left:bS,right:bI};this.__wS.setUserBounds((this.getPaddingLeft()||0)+(this.__wR.left-this.__wO),(this.getPaddingTop()||0)+(this.__wR.top-this.__wN),bO,bM);this.__qp=bH;this.__wV=bR;for(var i=0;i<this.__wT.length;i++ ){var bG=this.__wT[i];bG.setUserBounds(0,0,bO,bM);if(bV){bG.fullUpdate(bN,bJ,bR,bH);}
else {bG.updateLayerWindow(bN,bJ,bR,bH);}
;}
;}
,__wY:function(){if(this.__wU){return;}
;var bW=this.getScrollSize();if(this.__wP!==bW.height||this.__wQ!==bW.width){this.__wP=bW.height;this.__wQ=bW.width;this.fireEvent(u);}
;}
...
,_fullUpdate:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__wY();return;}
;var bY=this.getBounds();if(!bY){return;}
;this._setLayerWindow(bX,this.__wO,this.__wN,bY.width,bY.height,true);this.__wY();}
,_deferredUpdateScrollPosition:function(){this.__jh._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__wY();return;}
;var cc=this.getBounds();if(!cc){return;}
;var cb={top:this.__wN,bottom:this.__wN+cc.height,left:this.__wO,right:this.__wO+cc.width};if(this.__wR.top<=cb.top&&this.__wR.bottom>=cb.bottom&&this.__wR.left<=cb.left&&this.__wR.right>=cb.right){this.__wS.setUserBounds((this.getPaddingLeft()||0)+(this.__wR.left-cb.left),(this.getPaddingTop()||0)+(this.__wR.top-cb.top),this.__wR.right-this.__wR.left,this.__wR.bottom-this.__wR.top);}
else {this._setLayerWindow(ca,this.__wO,this.__wN,cc.width,cc.height,false);}
;this.__wY();}
},destruct:function(){this._disposeArray(c);this._disposeObjects(b,w,q);this.__wR=this.__jh=this.__qp=this.__wV=null;}
});}
)();
...
,events:{"change":e},members:{__xa:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__xa=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__xa=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__xa=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__xa=null;this.fireNonBubblingEvent(c);}
,__xb:function(){if(this.__xa){return this.__xa;}
;var s=this.defaultItemSize;var q=this.itemCount;var y=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<q){y.push(p);}
;}
;if(y.length==0){var u=[{startIndex:0,endIndex:q-1,firstItemSize:s,rangeStart:0,rangeEnd:q*s-1}];this.__xa=u;return u;}
...
;var z=u[u.length-1];var w=(q-z.startIndex-1)*s;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=q-1;this.__xa=u;return u;}
,__xc:function(F){var B=this.__xa||this.__xb();var C=0;var A=B.length-1;while(true){var E=C+((A-C)>>1);var D=B[E];if(D.rangeEnd<F){C=E+1;}
else if(D.rangeStart>F){A=E-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(K){if(K<0||K>=this.getTotalSize()){return null;}
;var J=this.__xc(K);var L=J.rangeStart;var G=J.startIndex;var I=J.firstItemSize;if(L+I>K){return {index:G,offset:K-L};}
else {var H=this.defaultItemSize;return {index:G+1+Math.floor((K-L-I)/H),offset:(K-L-I)%H};}
;}
,__xd:function(M){var O=this.__xa||this.__xb();var P=0;var N=O.length-1;while(true){var R=P+((N-P)>>1);var Q=O[R];if(Q.endIndex<M){P=R+1;}
else if(Q.startIndex>M){N=R-1;}
else {return Q;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__xd(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__xa||this.__xb();return U[U.length-1].rangeEnd+1;}
...
;}
;return W;}
},destruct:function(){this.customSizes=this.__xa=null;}
});}
)();
...
,properties:{anonymous:{refine:true,init:true}},members:{__jh:null,__bJ:null,__xv:null,__xw:null,__wV:null,__qp:null,getFirstRow:function(){return this.__xv;}
,getFirstColumn:function(){return this.__xw;}
,getRowSizes:function(){return this.__wV||[];}
,getColumnSizes:function(){return this.__qp||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__jh.fullUpdate||this.__jh.updateLayerWindow&&this.__jh.updateLayerData){this._fullUpdate.apply(this,this.__bJ);}
else if(this.__jh.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bJ);}
else if(this.__jh.updateLayerData&&this.__wV){this._updateLayerData();}
;if(this.__jh.fullUpdate||this.__jh.updateLayerWindow){var d=this.__bJ;this.__xv=d[0];this.__xw=d[1];this.__wV=d[2];this.__qp=d[3];}
;this.__jh={};}
,_updateLayerData:function(){this._fullUpdate(this.__xv,this.__xw,this.__wV,this.__qp);}
...
,fullUpdate:function(p,q,o,n){this.__bJ=arguments;this.__jh.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bJ=arguments;this.__jh.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__jh=this.__bJ=this.__wV=this.__qp=null;}
});}
)();
