...
this.initWidgets();
this.loadData();
},members:{__LT:null,initWidgets:function(){var g=this._widgets;
var h=this.__LT=new qx.ui.list.List().set({height:280,width:150,labelPath:"firstname",labelOptions:{converter:function(j,k){return k?k.getLastname()+", "+j:"no model...";
}}});
g.push(h);
this.add(h);
