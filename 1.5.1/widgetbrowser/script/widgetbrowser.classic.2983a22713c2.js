...
(function(){var k="Toolbar Button",j="Menu MenuButton",h="Menu RadioButton",g="Toolbar SplitButton",f="Toolbar RadioButton",e="icon/16/actions/document-new.png",d="Menu MenuCheckBox",c="widgetbrowser.pages.ToolBar",b="Left",a="MenuBar & Menu",y="Toolbar CheckBox",x="Toolbar MenuButton",w="ToolBar & Menu",v="icon/16/actions/format-justify-center.png",u="icon/16/actions/go-previous.png",t="icon/16/actions/format-text-underline.png",s="icon",r="Menu (with slidebar)",q="Center",p="main",n="icon/16/actions/format-justify-left.png",o="appear",l="Toggle",m="Menubar Button";
qx.Class.define(c,{extend:widgetbrowser.pages.AbstractPage,construct:function(){widgetbrowser.pages.AbstractPage.call(this);
this.initWidgets();
},members:{initWidgets:function(){var z;
z=new qx.ui.basic.Label(w);
this.add(z,{left:0,top:0});
this.add(this.getToolBar(),{left:0,top:20});
this.add(this.getMenuWithSlideBar(),{left:0,top:70});
z=new qx.ui.basic.Label(a);
this.add(z,{left:0,top:210});
...
var J=new qx.ui.toolbar.Button(k,e);
J.setToolTip(new qx.ui.tooltip.ToolTip(k));
this._widgets.push(J);
var A=new qx.ui.toolbar.CheckBox(l,t);
A.setToolTip(new qx.ui.tooltip.ToolTip(y));
this._widgets.push(A);
var G=new qx.ui.toolbar.RadioButton(b,n);
G.setToolTip(new qx.ui.tooltip.ToolTip(f));
this._widgets.push(G);
var F=new qx.ui.toolbar.RadioButton(q,v);
F.setToolTip(new qx.ui.tooltip.ToolTip(f));
this._widgets.push(F);
...
for(var i=0;i<3;i++){T=new qx.ui.menubar.Button(m,null,this.getButtonMenu());
...
W.addListener(o,function(){V.openAtPoint({left:0,top:20});
});
