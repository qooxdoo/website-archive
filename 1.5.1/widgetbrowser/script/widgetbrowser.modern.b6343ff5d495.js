...
}},members:{__db:null,_getDefaultInsets:function(){return this._getDefaultInsetsForBorder();
},_isInitialized:function(){return !!this.__db;
},getMarkup:function(j){if(this.__db){return this.__db;
}var k={};
this._styleBorder(k);
return this.__db=this._generateMarkup(k);
