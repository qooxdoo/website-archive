...
this.__sJ=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
this.add(this.__sJ);
this.initWidgets();
},members:{__sJ:null,initWidgets:function(){var Q=this._widgets;
var P;
...
}},properties:{appearance:{refine:true,init:f}},events:{complete:c,change:a},members:{__us:0,__ut:100,getValue:function(){return this.__us;
...
this.__uu(l/m);
return l;
},getMaximum:function(){return this.__ut;
...
},__uu:function(t){var v=this.getChildControl(i);
