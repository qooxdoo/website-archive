...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Placement-qx.theme.Classic.d47123bb478b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="demobrowser.demo.ui.Placement",d="qx.core.BaseInit",c="engine.name",b="os.name",a="engine.version";
...
qx.Class.define(o,{extend:qx.application.Standalone,members:{__DW:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var r=this.getRoot();
this.__DW=["bottom-left","bottom-right","top-left","top-right","right-top","right-bottom","left-top","left-bottom"];
...
for(var i=0;i<this.__DW.length;i++){var v=new qx.ui.form.ListItem(this.__DW[i]);
t.add(v);

if(this.__DW[i]==s){x=v;
}}w.add(t);
...
for(var i=0;i<this.__DW.length;i++){z.add(new qx.ui.form.ListItem(this.__DW[i]));
}B.add(z);
