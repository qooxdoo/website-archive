...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Audio","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Audio-qx.theme.Classic.4917e7ad615e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.bom.Audio";
...
(function(){var r="changeValue",q="timeupdate",p="html.audio.mp3",o="Play/Pause",n="html.audio.ogg",m="#CCC",l="Loop",k="It seems that your browser doesn't support HTML5 audio",j="0:00",i="loadeddata",c="demobrowser/demo/media/knock.ogg",h="Mute",g=":",b="ended",a="0",f="demobrowser.demo.bom.Audio",d="demobrowser/demo/media/knock.mp3";
...
var v=this.getRoot();
var t=new qx.ui.container.Composite(new qx.ui.layout.Basic());
v.add(t,{left:10,top:40});

if(qx.core.Environment.get(p)){var w=qx.util.ResourceManager.getInstance().toUri(d);
}else if(qx.core.Environment.get(n)){var w=qx.util.ResourceManager.getInstance().toUri(c);
}else{v.add(new qx.ui.basic.Label(k,{left:10,top:10}));
return;
}var z=new qx.bom.media.Audio(w);
var s=new qx.ui.form.ToggleButton(o);
s.addListener(r,function(e){if(z.isPaused()){z.play();
}else{z.pause();
}},this);
var u=new qx.ui.form.ToggleButton(h);
u.addListener(r,function(e){if(z.isMuted()){z.setMuted(false);
}else{z.setMuted(true);
}},this);
var A=new qx.ui.form.ToggleButton(l);
A.addListener(r,function(e){if(z.isLoop()){z.setLoop(false);
}else{z.setLoop(true);
}},this);
var y=new qx.ui.basic.Label(j);
y.setTextColor(m);
var x=new qx.ui.indicator.ProgressBar();
x.setHeight(21);
x.setWidth(220);
z.addListener(i,function(){v.add(s,{left:10,top:10});
v.add(x,{left:90,top:12});
v.add(y,{left:185,top:15});
v.add(u,{left:314,top:10});
v.add(A,{left:364,top:10});
t.getContentElement().getDomElement().appendChild(z.getMediaObject());
t.setWidth(400);
t.setHeight(100);
},this);
z.addListener(q,function(){x.setMaximum(z.getDuration());
var B=z.getCurrentTime();
var D=Math.floor(B/60);
var C=parseInt(B%60);
x.setValue(B);
y.setValue(D+g+(C>9?C:a+C));
},this);
z.addListener(b,function(){if(!z.isLoop()){s.resetValue();
}},this);
}},destruct:function(){}});
})();
...
if(g!=null){this.setValue(g);
}},properties:{appearance:{refine:true,init:d}},events:{complete:b,change:a},members:{__uM:0,__JG:100,getValue:function(){return this.__uM;
...
this.__JH(i/j);
return i;
},getMaximum:function(){return this.__JG;
...
},__JH:function(q){var s=this.getChildControl("progress");
