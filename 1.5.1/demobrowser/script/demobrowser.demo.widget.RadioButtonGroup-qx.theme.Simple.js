...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.RadioButtonGroup","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.RadioButtonGroup-qx.theme.Simple.2852551e1a42.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.widget.RadioButtonGroup",b="os.name",a="engine.version";
...
(function(){var o="female",n="<strong>Grid:</strong>",m="<strong>Vertical:</strong>",l="2,1",k="1,0",j="demobrowser.demo.widget.RadioButtonGroup",h="male",g="Red",f="Green",e="0,1",b="1,1",d="1,2",c="Blue",a="<strong>Horizontal:</strong>";
...
s.setRich(true);
this.getRoot().add(s,{left:10,top:10});
var p=new qx.ui.form.RadioButtonGroup();
p.setLayout(new qx.ui.layout.VBox(2));
this.addButtons(p,[g,f,c]);
this.getRoot().add(p,{left:100,top:10});
var u=new qx.ui.basic.Label(a);
u.setRich(true);
this.getRoot().add(u,{left:10,top:70});
var r=new qx.ui.form.RadioButtonGroup();
r.setLayout(new qx.ui.layout.HBox(5));
this.addButtons(r,[o,h]);
this.getRoot().add(r,{left:100,top:70});
var q=new qx.ui.basic.Label(n);
q.setRich(true);
this.getRoot().add(q,{left:10,top:100});
var t=new qx.ui.form.RadioButtonGroup();
t.setLayout(new qx.ui.layout.Grid(10,10));
t.add(new qx.ui.form.RadioButton(e),{row:0,column:1});
t.add(new qx.ui.form.RadioButton(k),{row:1,column:0});
t.add(new qx.ui.form.RadioButton(b),{row:1,column:1});
t.add(new qx.ui.form.RadioButton(d),{row:1,column:2});
t.add(new qx.ui.form.RadioButton(l),{row:2,column:1});
this.getRoot().add(t,{left:100,top:100});
