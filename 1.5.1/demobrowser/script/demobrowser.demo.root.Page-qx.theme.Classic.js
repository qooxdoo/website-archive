...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Page","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Page-qx.theme.Classic.5303326d4450.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.root.Page",b="os.name",a="engine.version";
...
qx.Class.define(j,{extend:qx.ui.root.Abstract,construct:function(n){this.__kv=n;
qx.ui.root.Abstract.call(this);
...
}},members:{__iY:null,__kv:null,_createContainerElement:function(){var p=this.__kv.createElement(l);
this.__kv.body.appendChild(p);
...
qx.Class.define(e,{extend:qx.application.Inline,members:{main:function(){qx.application.Inline.prototype.main.call(this);
