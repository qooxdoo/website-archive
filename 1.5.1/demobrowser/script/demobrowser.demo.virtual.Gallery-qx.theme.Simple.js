...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Gallery","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Gallery-qx.theme.Simple.ef616ca2eee7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.virtual.Gallery";
...
(function(){var l="",k="selected",j="cell",h="layer",g="icon",f="#f3f3f3",d="label",c="Gallery (HTML - divs)",b="manager",a="default",P="demobrowser.demo.virtual.Gallery",O="demobrowser.demo.virtual.WidgetGallery",N="text-align: center;",M="__Oq",L="auto",K="color: white; background-color: #00398D;",J="user-desktop.png",I="<img src='",H="'></img>",G="group",s="resize",t="folder.png",q="vertical",r="multi",o="network-server.png",p="user-trash.png",m="off",n="top",u="icon/32/places/",v="horizontal",y="demobrowser.demo.virtual.AbstractGallery",x="abstract",A="position: absolute;",z="demobrowser.demo.virtual.HtmlGallery",C="Gallery (widgets)",B="<br>",w="Icon #",F="network-workgroup.png",E="text-selected",D="demobrowser.demo.virtual.GalleryCell";
...
S.set({scrollbarX:m,scrollbarY:L});
...
this.__Oq=new demobrowser.demo.virtual.GalleryCell();
...
if(bx){this.__Oq.updateStates(bz,{selected:1});
}else{this.__Oq.updateStates(bz,{});
...
}var bF=this.__Oq.getCellWidget(bG,bE);
bF.setUserData(j,bD);
return bF;
},poolCellWidget:function(bH){this.__Oq.pool(bH);
}},destruct:function(){this._disposeObjects(M,h);
}});
...
var bR=bS?K:l;
return {style:[A,N,this._fontCss,bR].join(l),content:[I,bT.resolvedIcon,H,B,bT.label].join(l)};
...
(function(){var l="scroll",k="scrollbar-x",j="scrollbar-y",i="_applyInterval",h="appear",g="qx.debug",f="interval",e="qx.ui.virtual.behavior.Prefetch",d="_applyScroller",c="qx.ui.virtual.core.Scroller",a="__iY",b="Integer";
...
}},properties:{scroller:{check:c,nullable:true,init:null,apply:d},interval:{check:b,init:200,apply:i}},members:{__wN:null,__wO:null,__iY:null,__wP:null,__wQ:null,setPrefetchX:function(o,p,q,r){this.__wN=[o,p,q,r];
},setPrefetchY:function(s,t,u,v){this.__wO=[s,t,u,v];
},_onInterval:function(){var w=this.__wN;
...
qx.ui.core.queue.Manager.flush();
}},_applyScroller:function(y,z){if(z){if(this.__wP){z.getChildControl(k).removeListenerById(this.__wP);
}
if(this.__wQ){z.getChildControl(j).removeListenerById(this.__wQ);
}}
if(y){if(!y.getContainerElement().getDomElement()){this.__iY.stop();
y.addListenerOnce(h,this.__iY.start,this.__iY);
}else{this.__iY.restart();
}this.__wP=y.getChildControl(k).addListener(l,this.__iY.restart,this.__iY);
this.__wQ=y.getChildControl(j).addListener(l,this.__iY.restart,this.__iY);
}else{this.__iY.stop();
}},_applyInterval:function(A,B){this.__iY.setInterval(A);
...
},properties:{defaultLineColor:{init:e,check:c,themeable:true},defaultLineSize:{init:1,check:b,themeable:true}},members:{__IQ:null,__IR:null,isHorizontal:function(){return this._isHorizontal;
...
if(this.__IS(l)){this.updateLayerData();
...
if(this.__IS(n)){this.updateLayerData();
}},__IS:function(p){if(this._isHorizontal){var t=this.getFirstColumn();
var r=t+this.getColumnSizes().length-1;
return p>=t&&p<=r;
}else{var s=this.getFirstRow();
var q=s+this.getRowSizes().length-1;
return p>=s&&p<=q;
}},getLineSize:function(u){return this.__IR[u]||this.getDefaultLineSize();
},getLineColor:function(v){return this.__IQ[v]||this.getDefaultLineColor();
},__IT:function(w,z,A){var top=0;
var B,C;
...
if(this._isHorizontal){this.__IT(N,J,L);
}else{this.__IU(N,K,M);
