...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.ScrollContainer_EdgeCaseWidth","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.ScrollContainer_EdgeCaseWidth-qx.theme.Classic.763e022200bb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.test.ScrollContainer_EdgeCaseWidth";
...
(function(){var t="value",s="changeSelection",r="execute",q="ScrollbarX:",p="ScrollbarY:",o="Toggle content",n="blue",m="black",l="auto",k="Off",d="white",j="demobrowser.demo.test.ScrollContainer_EdgeCaseWidth",h="off",c="On",b="Content size: 300x300",g="Toggle pane",f="solid",i="Auto",a="on";
...
v.set({width:300,height:200});
this.getRoot().add(v,{left:10,top:10});
v.add(this.generateBox());
var x=new qx.ui.form.Button(g);
var A=true;
x.addListener(r,function(){v.setHeight(A?300:200);
A=!A;
});
this.getRoot().add(x,{left:330,top:20});
var w=new qx.ui.form.Button(o);
var z=true;
w.addListener(r,function(){v.getChildren()[0].setHeight(z?100:300);
z=!z;
});
this.getRoot().add(w,{left:430,top:20});
var y=this.generateScrollbarConfig(q,100);
var u=this.generateScrollbarConfig(p,120);
y.addListener(s,function(e){v.setScrollbarX(e.getData()[0].getUserData(t));
});
u.addListener(s,function(e){v.setScrollbarY(e.getData()[0].getUserData(t));
});
},generateScrollbarConfig:function(B,top){var F=new qx.ui.container.Composite(new qx.ui.layout.HBox(6));
var B=new qx.ui.basic.Label(B);
B.setMarginRight(20);
var C=new qx.ui.form.RadioButton(i);
var E=new qx.ui.form.RadioButton(c);
var D=new qx.ui.form.RadioButton(k);
C.setUserData(t,l);
E.setUserData(t,a);
D.setUserData(t,h);
C.setValue(true);
var G=new qx.ui.form.RadioGroup(C,E,D);
F.add(B);
F.add(C);
F.add(E);
F.add(D);
this.getRoot().add(F,{left:330,top:top});
return G;
},generateBox:function(){var H=new qx.ui.basic.Label(b).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:n,textColor:d,padding:10,decorator:new qx.ui.decoration.Single(4,f,m)});
return H;
},__De:null}});
})();
