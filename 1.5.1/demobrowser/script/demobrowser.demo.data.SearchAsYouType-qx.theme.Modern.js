...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.SearchAsYouType","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType-qx.theme.Modern.5d9b43f6f5d8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.data.SearchAsYouType",b="os.name",a="engine.version";
...
(function(){var q="searchString",p="Bart",o="<b>Search As You Type List</b><br/>",n="Marge",m="Maggy",l="Skinner",k="Moe",j="Smithers",h="Type a name and the list will show only the matching results (case-sensitive).",g="Lisa",c=" ",f="Homer",e="Nelson",b="Flanders",a="changeValue",d="demobrowser.demo.data.SearchAsYouType";
...
var w=[p,g,f,n,k,j,e,b,m,l];
var z=[];

for(var i=0;i<60;i++){z.push(w[i%10]+c+i);
}var y=new qx.data.Array(z);
var r=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
this.getRoot().add(r,{top:10,left:10});
var x=new qx.ui.form.TextField();
x.setLiveUpdate(true);
r.add(x);
var u=new qx.ui.form.List();
r.add(u);
var v=new qx.data.controller.List(y,u);
var t=new demobrowser.demo.data.filter.SearchAsYouTypeFilter(v);
v.setDelegate(t);
x.bind(a,t,q);
...
(function(){var d="_applySearchString",c="demobrowser.demo.data.filter.SearchAsYouTypeFilter",b="String",a="";
qx.Class.define(c,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);
this.__st=e;
this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;
},this);
this.__tt=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__tt:null,__st:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();
if(this.__tt!=null){i.stop(this.__tt);
this.__tt=null;
}this.__tt=i.start(function(){this.__st.update();
this.__tt=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__st=null;
}});
})();
