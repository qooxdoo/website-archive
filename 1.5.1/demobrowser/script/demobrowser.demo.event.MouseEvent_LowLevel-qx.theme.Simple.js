...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.MouseEvent_LowLevel","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent_LowLevel-qx.theme.Simple.ae3fad0f233e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.event.MouseEvent_LowLevel",b="os.name",a="engine.version";
...
(function(){var l="mouse",k="demobrowser.demo.event.MouseEvent_LowLevel",j="mouseout",h="mousedown",g="clientX",f="dblclick",d="relatedTarget",c="button",b="mousemove",a="screenX",y="logger",x="",w="_",v="mouseover",u="check_",t="click",s="Event",r="Target",q="clientY",p="mouseup",n="contextmenu",o="change",m="screenY";
qx.Class.define(k,{extend:demobrowser.demo.event.EventDemo,members:{__Ng:null,main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);
this.__Ng=qx.lang.Function.bind(this.logMouseEvent,this);
this._initLogger([r,s,c,g,q,a,m,d],document.getElementById(y),50);
var z=document.getElementById(l);
var A=[h,p,t,f,n,b,v,j];

for(var i=0;i<A.length;i++){var B=document.getElementById(u+A[i]);

if(B.checked){qx.bom.Event.addNativeListener(z,A[i],this.__Ng);
}qx.bom.Event.addNativeListener(B,o,qx.lang.Function.bind(this.__Nf,this));
}},__Nf:function(e){var F=qx.bom.Event.getTarget(e);
var E=F.id.split(w)[1];
var C=F.checked;
var D=document.getElementById(l);

if(C){qx.bom.Event.addNativeListener(D,E,this.__Ng);
}else{qx.bom.Event.removeNativeListener(D,E,this.__Ng);
}},logMouseEvent:function(G){qx.bom.Event.preventDefault(G);
this._log([qx.bom.Event.getTarget(G).id,G.type,G.button,G.clientX,G.clientY,G.screenX,G.screenY,qx.bom.Event.getRelatedTarget(G)?qx.bom.Event.getRelatedTarget(G).id:x]);
}}});
})();
