...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.HtmlArea-qx.theme.Classic.af4cb3bc8f41.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(bG,{extend:qx.application.Standalone,members:{__ww:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
ca.setWidthTop(0);
this.__ww=new qx.ui.embed.HtmlArea(cc,null,F);
this.__ww.set({width:600,height:400,decorator:ca});
...
},__wx:function(e){var ce=window.prompt(bt,bx);
this.setTextColor(ce);
},__wy:function(e){var cf=window.prompt(bf,bx);
this.setTextBackgroundColor(cf);
},__wz:function(e){var cg={src:qx.util.ResourceManager.getInstance().toUri(bL),border:0,title:bw,alt:bw};
this.insertImage(cg);
},__wA:function(e){var ch=R+U+bz+bD+K+bv+bz+b+s+bv+c+M;
this.insertHtml(ch);
},__wB:function(e){var cj=new qx.ui.window.Window(H);
...
cj.open();
this.saveRange();
},__wC:function(e){var co=window.prompt(bq,bB);
this.insertHtml(co);
},__wD:function(){var cq=new qx.ui.form.SelectBox;
...
return cq;
},__wE:function(){var cu=new qx.ui.form.SelectBox;
...
return cu;
},__wF:function(){return [{bold:{text:bS,image:p,action:this.__ww.setBold},italic:{text:ba,image:W,action:this.__ww.setItalic},underline:{text:x,image:Y,action:this.__ww.setUnderline},strikethrough:{text:y,image:bV,action:this.__ww.setStrikeThrough},removeFormat:{text:I,image:bP,action:this.__ww.removeFormat}},{alignLeft:{text:n,image:t,action:this.__ww.setJustifyLeft},alignCenter:{text:O,image:bl,action:this.__ww.setJustifyCenter},alignRight:{text:bb,image:q,action:this.__ww.setJustifyRight},alignJustify:{text:bk,image:B,action:this.__ww.setJustifyFull}},{fontFamily:{custom:this.__wD},fontSize:{custom:this.__wE},fontColor:{text:d,image:k,action:this.__wx},textBackgroundColor:{text:bj,image:bn,action:this.__wy}},{indent:{text:be,image:bu,action:this.__ww.insertIndent},outdent:{text:z,image:T,action:this.__ww.insertOutdent}},{insertImage:{text:r,image:G,action:this.__wz},insertTable:{text:f,image:l,action:this.__wA},insertLink:{text:a,image:E,action:this.__wB},insertHTML:{text:D,image:bm,action:this.__wC},insertHR:{text:bp,image:bo,action:this.__ww.insertHorizontalRuler}},{ol:{text:u,image:bH,action:this.__ww.insertOrderedList},ul:{text:bc,image:br,action:this.__ww.insertUnorderedList}},{undo:{text:bM,image:m,action:this.__ww.undo},redo:{text:bT,image:P,action:this.__ww.redo}}];
...
cw.addListener(bA,cA.action,this.__ww);
}cy.add(cw);
}}return toolbar;
}}});
})();
