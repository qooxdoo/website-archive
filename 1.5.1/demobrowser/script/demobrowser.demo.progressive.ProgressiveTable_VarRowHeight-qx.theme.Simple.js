...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_VarRowHeight-qx.theme.Simple.d65d9761c169.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(d,{extend:qx.application.Standalone,members:{__NG:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var A=p;
...
--this.__NG;
this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__NG+", end="+this.imageData.length);
if(this.__NG==0){this.doLoad();
}return;
...
(function(){var u="px'",t='" ',s='src="',r="mshtml",q="vertical-align:middle;",p="text-align:center;",o="abstract",n="",m='<img ',l=" height='",e='" style="filter:',k=" style='padding-top:2px;'",h=" title='",c="engine.name",b="qx.ui.progressive.renderer.table.cell.Icon",g="'",f=" width='",i=">",a="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",j="qx/static/blank.gif",d="',sizingMethod='scale')";
qx.Class.define(b,{type:o,extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(){qx.ui.progressive.renderer.table.cell.Abstract.call(this);
var v=qx.util.AliasManager.getInstance();
var w=qx.util.ResourceManager.getInstance();
var x=v.resolve(j);
this.__HE=w.toUri(x);
},members:{__HE:null,getBlankImage:function(){return this.__HE;
...
var D=this.__HF(B);
C.push(m);
if((qx.core.Environment.get(c)==r)&&/\.png$/i.test(D.url)){C.push(s,this.__HE,e,a,D.url,d,t);
}else{C.push(s,D.url,t);
}if(D.imageWidth){C.push(f,D.imageWidth,u);
}if(D.imageHeight){C.push(l,D.imageHeight,u);
}C.push(k);
if(D.tooltip){C.push(h,D.tooltip,g);
}if(D.extras){C.push(D.extras);
}C.push(i);
return C.join(n);
},__HF:function(E){var F=this._identifyImage(E);
if(F==null||typeof F=="string"){F={url:F,tooltip:null};
}if(F.url==null){F.url=this.__HE;
}return F;
}}});
})();
...
if(d===undefined){this.__rc=d;
}else{this.__rc=16;
}
if(e===undefined){this.__rd=e;
}else{this.__rd=16;
}},members:{__rc:null,__rd:null,_identifyImage:function(f){var j={imageWidth:this.__rc,imageHeight:this.__rd};
var k;
