...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellEditor-qx.theme.Modern.2ff05ee43229.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
},properties:{cellEditorFactoryFunction:{check:b,nullable:true,init:null}},members:{__qh:null,__Lx:null,createCellEditor:function(f){var g=this.getCellEditorFactoryFunction();

if(qx.core.Environment.get(c)){this.assertFunction(g,d);
}this.__qh=g(f);
var h=this.__qh.createCellEditor(f);
this.__Lx[h.toHashCode()]=f;
return h;
...
}var j=this.__Lx[i.toHashCode()];
this.__qh=k(j);
var l=this.__qh.getCellEditorValue(i);
return l;
