...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.DragDrop-qx.theme.Simple.b3fe33efc88c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="drop",k="value",j="items",h="move",g="multi",f="dragover",d="icon/16/places/folder.png",c="dragstart",b="Item ",a="copy",A="drag",z="TextArea Target",y="__BK",x="solid",w="Reorderable",v="qx.ui.form.ListItem",u="droprequest",t="#33508D",s="Source",r="demobrowser.demo.ui.DragDrop",p="Simple Target",q="Enable drag",n="\n",o="dragend";
qx.Class.define(r,{extend:qx.application.Standalone,members:{__BK:null,__Oi:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var M=this.getRoot();
...
}var N=new qx.ui.form.CheckBox(q);
N.setValue(true);
...
J.addListener(u,function(e){this.debug("Related of droprequest: "+e.getRelatedTarget());
...
var I=new qx.ui.basic.Label(w);
E.add(I,{left:500,top:20});
var C=this.__BK=new qx.ui.form.List;
C.setDraggable(true);
C.setDroppable(true);
...
D.setDecorator(new qx.ui.decoration.Single().set({top:[1,x,t]}));
D.setHeight(0);
D.setOpacity(0.5);
D.setZIndex(100);
...
if(V instanceof qx.ui.form.ListItem){qx.core.Init.getApplication().__Oi=V;
}
...
C.addListener(m,function(e){this.__Oj(e.getOriginalTarget());
},this);
D.addListener(m,function(e){this.__Oj(this.__Oi);
},this);
},__Oj:function(W){if(W.classname!=v){return;
}var X=this.__BK.getSortedSelection();

for(var i=0,l=X.length;i<l;i++){this.__BK.addBefore(X[i],W);
this.__BK.addToSelection(X[i]);
