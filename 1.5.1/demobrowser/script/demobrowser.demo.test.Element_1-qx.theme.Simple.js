...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Element_1","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_1-qx.theme.Simple.bd70f8018741.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.test.Element_1";
...
(function(){var m="id",k="100px",j="after2",h="text",g="hello",f="el3b",e="height",d="sans-serif",c="<b>hello</b>",b="color",B="demobrowser.demo.test.Element_1",A="18px",z="blue",y="before2",x="el2b",w="html",v="el2a",u="width",t="after1",s="test",q="el3a",r="bold",o="doc",p="before1",n="el1";
qx.Class.define(B,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
var D=new qx.html.Root(document.getElementById(s));
D.setAttribute(m,o);
this.info("Basics");
var L=new qx.html.Element;
var I=new qx.html.Element;
var K=new qx.html.Element;
var E=new qx.html.Element;
var C=new qx.html.Element;
L.setAttribute(m,n);
I.setAttribute(m,v);
K.setAttribute(m,x);
E.setAttribute(m,q);
...
E.setAttribute(w,c);
C.setAttribute(h,g);
C.setStyles({fontWeight:r,fontSize:A,fontFamily:d});
L.setStyle(b,z);
L.setStyle(u,k).setStyle(e,k);
...
for(var i=1,l=a.length;i<l;i++){a[i].moveTo(0);
}qx.html.Element.flush();
this.info("Rotation");
M.moveAfter(N);
qx.html.Element.flush();
