...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Tree_Columns","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Columns-qx.theme.Classic.119595da98d0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.virtual.Tree_Columns";
...
(function(){var k="checked",j="Trash",h="size",g="mode",f="date",e="Windows (C:)",d="Documents (D:)",c="Inbox",b="Desktop",a="Personal",H="-rw-r--r--",G="Presets",F="Network",E="light",D="Sent",C="children",B="Big",A="Files",z="icon/16/status/dialog-information.png",y="",r=" 2010",s="Workspace",p="demobrowser.demo.virtual.Tree_Columns",q="Spam",n="Data",o="May ",l="Root",m="label",t="Lists",u="kb",w="Item ",v="Edit",x="leadIcon";
...
I.setAllowStretchX(false);
J.add(I);
this.getRoot().add(J,{edge:0});
var K=new qx.ui.tree.VirtualTree(null,m,C).set({width:600,height:500});
I.add(K,{left:20,top:48});
var M={label:l,children:[{label:b,children:[{label:A},{label:s,children:[{label:e},{label:d}]},{label:F},{label:j}]},{label:c,children:[{label:G},{label:D},{label:j},{label:n},{label:v},{label:t},{label:a},{label:B,children:[]},{label:q}]}]};

for(var i=0;i<50;i++){M.children[1].children[7].children[i]={label:w+i};
}this.extendData(M);
var L=qx.data.marshal.Json.createModel(M,true);
this.configureTriState(L);
K.setModel(L);
K.setDelegate(this);
},extendData:function(N){N.date=o+Math.round(Math.random()*30+1)+r;
N.size=Math.round(Math.random()*100)+u;
N.light=Math.floor(Math.random()*4)==0;
N.mode=H;
N.checked=Math.random()>=0.5;

if(N.children){for(var i=0;i<N.children.length;i++){this.extendData(N.children[i]);
}}},configureTriState:function(O){O.getModel=function(){return this;
};

if(O.getChildren!=null){var P=O.getChildren();

for(var i=0;i<P.getLength();i++){var Q=P.getItem(i);
this.configureTriState(Q);
O.bind(k,Q,k,{converter:function(R,S){if(R===null){return S.getChecked();
}return R;
}});
Q.bind(k,O,k,{converter:function(T,parent){var W=parent.getChildren().toArray();
var U=W.every(function(X){return X.getChecked();
});
...
}}},bindItem:function(ba,bb,bc){ba.bindDefaultProperties(bb,bc);
ba.bindProperty(h,h,null,bb,bc);
ba.bindProperty(k,k,null,bb,bc);
ba.bindPropertyReverse(k,k,null,bb,bc);
ba.bindProperty(f,f,null,bb,bc);
ba.bindProperty(g,g,null,bb,bc);
ba.bindProperty(E,x,{converter:function(bd){return bd?z:y;
}},bb,bc);
...
(function(){var l="dblclick",k="cellDblclick",j="cellClick",h="Boolean",g="click",f="String",d="one",c="qx.event.type.Data",b="updated",a="changeBubble",N="changeModel",M="_applyLabelOptions",L="_applyOpenMode",K="qx.core.Object",J="Space",I="Left",H="Integer",G="_applyModel",F="_applyShowTopLevelOpenCloseIcons",E="_applyLabelPath",s="changeOpenMode",t="qx.debug",q="changeDelegate",r="virtual-tree",o="_applyChildProperty",p="_applyIconPath",m="_applyDelegate",n="_applyHideRoot",u="close",v="_applyRowHeight",y="Right",x="Enter",A="qx.ui.tree.VirtualTree",z="keypress",C="none",B="_applyShowLeafs",w="_applyIconOptions",D=".";
...
},_getDataFromRow:function(bc){return this.__yc.getItem(bc);
...
},getLevel:function(be){return this.__HO[be];
...
},_applyModel:function(bD,bE){this.__HN=[];

if(bD!=null){if(qx.core.Environment.get(t)){if(!qx.Class.hasMixin(bD.constructor,qx.data.marshal.MEventBubbling)){this.warn("The model item doesn't support the Mixin 'qx.data."+"marshal.MEventBubbling'. Therefore the tree can not update "+"the view automatically on model changes.");
...
if(qx.lang.String.startsWith(bI,this.getChildProperty())){this.__HR();
...
}}},_beforeApplySelection:function(bP){if(bP.length===0&&this.getSelectionMode()===d){var bQ=this.__HW();
var bR=this.getLookupTable().indexOf(bQ);

if(bR>=0){bP.push(bR);
}}},_afterApplySelection:function(){var bS=this.getSelection();

if(bS.getLength()>0&&this.getSelectionMode()===d){this.__HV(bS.getItem(0));
}else{this.__HQ=[];
...
if(this.isNodeOpen(bV)){var bT=this.__HS(bV,bU);
bW=bW.concat(bT);
...
if(this.isNode(cd)){this.__HO.push(bY);
ca.push(cd);

if(this.isNodeOpen(cd)){var cb=this.__HS(cd,bY);
ca=ca.concat(cb);
}}else{if(this.isShowLeafs()){this.__HO.push(bY);
ca.push(cd);
}}}return ca;
},__HT:function(ce){if(!qx.lang.Array.contains(this.__HN,ce)){this.__HN.push(ce);
this.fireDataEvent("open",ce);
}},__HU:function(cf,cg){if(cf===cg){this.__HT(cg);
return true;
}
...
var ch=this.__HU(cj,cg);

if(ch===true){this.__HT(cj);
return true;
}}return false;
},__yi:function(){this.getPane().getRowConfig().setItemCount(this.__yc.getLength());
this.getPane().fullUpdate();
},getParent:function(ck){var cm=this.__yc.indexOf(ck);
...
if(cl<cn){return this.__yc.getItem(cm);
}}return null;
},__HV:function(co){this.__HQ=[];
...
(function(){var p="value",o="String",n="checked",m="source",l="changeLeadIcon",k="changeSize",j="changeMode",i="changeDate",h="changeChecked",g="icon/16/places/user-desktop.png",c="size",f="leadIcon",e="date",b="mode",a="demobrowser.demo.virtual.tree.TreeItem",d="Boolean";
qx.Class.define(a,{extend:qx.ui.tree.VirtualTreeItem,properties:{leadIcon:{check:o,event:l,nullable:true},checked:{check:d,event:h,nullable:true},size:{check:o,event:k,nullable:true},date:{check:o,event:i,nullable:true},mode:{check:o,event:j,nullable:true}},members:{__Ov:null,__Ow:null,__Ox:null,__Oy:null,__fq:null,_addWidgets:function(){var q=this.__Ov=new qx.ui.basic.Image();
this.bind(f,q,m);
q.setWidth(16);
this.addWidget(q);
this.addSpacer();
...
this.addIcon();
this.setIcon(g);
var r=this.__Ow=new qx.ui.form.CheckBox();
this.bind(n,r,p);
r.bind(p,this,n);
...
var s=this.__Ox=new qx.ui.basic.Label();
this.bind(c,s,p);
s.setWidth(50);
this.addWidget(s);
s=this.__Oy=new qx.ui.basic.Label();
this.bind(e,s,p);
s.setWidth(150);
this.addWidget(s);
s=this.__fq=new qx.ui.basic.Label();
this.bind(b,s,p);
s.setWidth(80);
this.addWidget(s);
}}});
