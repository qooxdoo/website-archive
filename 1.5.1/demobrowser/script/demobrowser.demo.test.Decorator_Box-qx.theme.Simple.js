...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Decorator_Box","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Decorator_Box-qx.theme.Simple.4cb8ddc43226.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.test.Decorator_Box";
...
if(k){this.__kI(k,m);
}if(l!=null){this.__kH.setInsets(l);
}}else{this.__kH=new qx.ui.decoration.BoxDiv(k,l,m);
}},properties:{baseImage:{check:b,nullable:true,apply:e}},members:{__kH:null,_isHorizontal:null,_setOrientation:function(n){this._isHorizontal=n==i;
},getMarkup:function(){return this.__kH.getMarkup();
},resize:function(o,p,q){this.__kH.resize(o,p,q);
},tint:function(r,s){},getInsets:function(){return this.__kH.getInsets();
},_applyInsets:function(t,u,name){var v=g+qx.lang.String.firstUp(name);
this.__kH[v](t);
},_applyBaseImage:function(w,x){if(this.__kH instanceof qx.ui.decoration.BoxDiv){this.__kH.setBaseImage(w);
}else{this.__kI(w);
}},__kI:function(y){this.__kH.setBorderImage(y);
...
this.__kH.setSlice([0,z,0,H]);
}else{var A=B.getImageHeight(C+d+D);
var G=B.getImageHeight(C+c+D);
this.__kH.setSlice([G,0,A,0]);
}}},destruct:function(){this.__kG=this.__AH=this.__AI=null;
}});
})();
...
}},properties:{baseImage:{check:g,nullable:true,apply:b}},members:{__kG:null,__AH:null,__AI:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__kG;
...
}}}},tint:function(E,F){},_applyBaseImage:function(G,H){if(qx.core.Environment.get(h)){if(this.__kG){throw new Error("This decorator is already in-use. Modification is not possible anymore!");
...
var L=N[1];
var J=N[2];
var O=this.__AH={t:L+"-t"+J,b:L+"-b"+J,c:L+"-c"+J,l:L+"-l"+J,r:L+"-r"+J};
this.__AI={top:I.getImageHeight(O.t),bottom:I.getImageHeight(O.b),left:I.getImageWidth(O.l),right:I.getImageWidth(O.r)};
}}},destruct:function(){this.__kG=this.__AH=this.__AI=null;
}});
})();
