...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.MultiPageForm","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.MultiPageForm-qx.theme.Modern.bfd60ab9ab4e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.ui.MultiPageForm";
...
(function(){var r="value",q="execute",p="changeBubble",o="name",n="password",m="enabled",l="Birthdate:",k="valid",j="email",i="next",c="back",h="Email:",g="birthdate",b="demobrowser.demo.ui.MultiPageForm",a="Name:",f="Password:",d="submit";
...
var J=new qx.ui.container.Stack();
this.getRoot().add(J,{left:10,top:10});
var v=new qx.ui.layout.Grid();
v.setSpacing(5);
var K=new qx.ui.container.Composite(v);
J.add(K);
var s=new qx.ui.basic.Label(a);
K.add(s,{row:0,column:0});
var name=new qx.ui.form.TextField();
name.setRequired(true);
K.add(name,{row:0,column:1});
var w=new qx.ui.basic.Label(f);
K.add(w,{row:1,column:0});
var H=new qx.ui.form.PasswordField();
H.setRequired(true);
K.add(H,{row:1,column:1});
var A=new qx.ui.form.Button(i);
K.add(A,{row:2,column:1});
A.addListener(q,J.next,J);
var x=new qx.ui.layout.Grid();
x.setSpacing(5);
var I=new qx.ui.container.Composite(x);
J.add(I);
var E=new qx.ui.basic.Label(h);
I.add(E,{row:0,column:0});
var B=new qx.ui.form.TextField();
I.add(B,{row:0,column:1});
var t=new qx.ui.basic.Label(l);
I.add(t,{row:1,column:0});
var z=new qx.ui.form.DateField();
z.setRequired(true);
I.add(z,{row:1,column:1});
var u=new qx.ui.form.Button(c);
I.add(u,{row:2,column:0});
u.addListener(q,J.previous,J);
var y=new qx.ui.form.Button(d);
y;
I.add(y,{row:2,column:1});
var F={name:null,password:null,email:null,birthdate:null};
var G=qx.data.marshal.Json.createModel(F,true);
var C=new qx.data.controller.Object(G);
C.addTarget(name,r,o,true);
C.addTarget(H,r,n,true);
C.addTarget(B,r,j,true);
C.addTarget(z,r,g,true);
y.addListener(q,function(){alert(qx.util.Serializer.toUriParameter(G));
},this);
var D=new qx.ui.form.validation.Manager();
D.add(name);
D.add(H);
D.add(B,qx.util.Validate.email());
D.add(z);
G.addListener(p,function(e){D.validate();
},this);
D.validate();
D.bind(k,y,m);
}}});
...
}},properties:{model:{check:f,event:g,apply:b,nullable:true,dereference:true}},members:{__fL:null,__bl:null,_applyModel:function(k,l){for(var i=0;i<this.__fL.length;i++){var t=this.__fL[i][0];
var q=this.__fL[i][1];
var o=this.__fL[i][2];
var r=this.__fL[i][3];
var s=this.__fL[i][4];
...
}}}}},addTarget:function(u,v,w,x,y,z){this.__fL.push([u,v,w,x,y,z]);
...
if(this.__bl[I]==undefined){this.__bl[I]=[];
}this.__bl[I].push([G,H,B,C,E,F]);
},removeTarget:function(J,K,L){this.__zm(J,K,L,this.getModel());
for(var i=0;i<this.__fL.length;i++){if(this.__fL[i][0]==J&&this.__fL[i][1]==K&&this.__fL[i][2]==L){this.__fL.splice(i,1);
}}},__zm:function(M,N,O,P){if(!(M instanceof qx.core.Object)){return ;
}var Q=this.__bl[M.toHashCode()];
