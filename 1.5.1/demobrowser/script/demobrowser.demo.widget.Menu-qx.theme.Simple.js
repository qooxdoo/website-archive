...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Menu","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu-qx.theme.Simple.f2bdbfd44edf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var cc="execute",cb="changeValue",ca="icon/16/actions/edit-cut.png",bY="changeSelection",bX="icon/16/actions/edit-paste.png",bW="Copy",bV="Paste",bU="icon/16/actions/edit-copy.png",bT="Cut",bS="icon/16/actions/system-search.png",bu="New",bt="Undo",bs="icon/16/actions/document-save.png",br="Redo",bq="icon/22/apps/preferences-users.png",bp="icon/16/actions/document-print.png",bo="icon/16/actions/document-open.png",bn="icon/16/actions/edit-undo.png",bm="Save",bl="icon/16/actions/edit-redo.png",cj="Print",ck="Open",ch="icon/16/actions/document-new.png",ci="Online Forum",cf="icon/16/actions/format-justify-fill.png",cg="Search in files",cd="C",ce="__OF",cl="Left aligned",cm="Perl",bL="View",bK="C Dialect",bN="Info...",bM="Save as...",bP="Show line numbers",bO="Quickstart",bR="icon/16/actions/contact-new.png",bQ="__OH",bJ="Actions",bI="Show console",a="Search",b="Help",c="Show status bar",d="icon/16/actions/format-justify-left.png",f="ANSI to OEM",g="Centered",h="Website 3",j="__OI",k="Edit",l="icon/16/actions/format-justify-center.png",cq="icon/16/actions/go-previous.png",cp="C Sharp",co="Close",cn="Website 2",cu="icon/16/actions/document-save-as.png",ct="Python",cs="icon/16/apps/utilities-help.png",cr="Show tree",cw="Options",cv="Spaces to tabs",K="Right aligned",L="Action 1",I="OEM to ANSI",J="Line 431",O="JavaScript",P="icon",M="Action 2",N="Folder ",G="XML",H="Line 313",t="Paragraph",s="demobrowser.demo.widget.Menu",v="icon/16/actions/application-exit.png",u="C Plus Plus",p="Line 26",o="Item ",r="ASCII table",q="Option 1",n="Search next...",m="Line 12",U="Action 3",V="Replace in files",W="Uppercase",X="Topics",Q="Panes",R="Justified",S="__ut",T="Show macros",Y="Search previous...",ba="__OE",D="Back",C="main",B="__um",A="__OD",z="icon/16/actions/format-justify-right.png",y="icon/16/actions/go-next.png",x="Ctrl+Z",w="command ",F="Option 3",E="Next",bb="Ctrl+R",bc="Show tags",bd="Capitals",be="Format",bf="File",bg="Show tabs",bh="Split Button",bi="Tabs to spaces",bj="Search...",bk="Line 1039",by="Option 2",bx="Objective C",bw="Exit",bv="move to",bC="Syntax",bB="__OG",bA="Show ruler",bz="Website 1",bE="Menu Button",bD="Line 30",bG="Lowercase",bH="Replace",bF="HTML";
qx.Class.define(s,{extend:qx.application.Standalone,members:{__OD:null,__OE:null,__OF:null,__um:null,__ut:null,__OG:null,__OH:null,__OI:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var cy=new qx.ui.container.Scroll();
var cx=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
cx.setPadding(20);
cx.setAllowStretchX(false);
cy.add(cx);
this.getRoot().add(cy,{edge:0});
this.createCommands();
cx.add(this.getMenuButton(),{left:20,top:20});
cx.add(this.getSplitButton(),{left:150,top:20});
cx.add(this.getMenuBar(),{left:20,top:100});
cx.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var cz=new qx.ui.menu.Menu();
var cA=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){cA.add(new qx.ui.menu.Button(N+(i+1)));
}cz.add(new qx.ui.menu.Button(bv,null,null,cA));
cz.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){cz.add(new qx.ui.menu.Button(w+(i+1)));
}return cz;
...
},createCommands:function(){this.__OD=new qx.ui.core.Command("Ctrl+N");
this.__OD.addListener(cc,this.debugCommand);
this.__OE=new qx.ui.core.Command("Ctrl+O");
this.__OE.addListener(cc,this.debugCommand);
this.__OF=new qx.ui.core.Command("Ctrl+S");
this.__OF.addListener(cc,this.debugCommand);
this.__um=new qx.ui.core.Command(x);
this.__um.addListener(cc,this.debugCommand);
this.__ut=new qx.ui.core.Command(bb);
this.__ut.addListener(cc,this.debugCommand);
this.__OG=new qx.ui.core.Command("Ctrl+X");
this.__OG.addListener(cc,this.debugCommand);
this.__OH=new qx.ui.core.Command("Ctrl+C");
this.__OH.addListener(cc,this.debugCommand);
this.__OI=new qx.ui.core.Command("Ctrl+P");
this.__OI.addListener(cc,this.debugCommand);
this.__OI.setEnabled(false);
},getMenuButton:function(){var cB=new qx.ui.menu.Menu;
cB.add(new qx.ui.menu.RadioButton(q));
cB.add(new qx.ui.menu.RadioButton(by));
cB.add(new qx.ui.menu.RadioButton(F));
var cJ=new qx.ui.menu.Menu;
cJ.add(new qx.ui.menu.RadioButton(L));
cJ.add(new qx.ui.menu.RadioButton(M));
cJ.add(new qx.ui.menu.RadioButton(U));
var cI=new qx.ui.form.RadioGroup;
cI.add.apply(cI,cB.getChildren());
cI.addListener(bY,this.debugRadio);
var cG=new qx.ui.form.RadioGroup;
cG.add.apply(cG,cJ.getChildren());
cG.addListener(bY,this.debugRadio);
var cE=new qx.ui.menu.Menu();
var cH=new qx.ui.menu.Button(bt,bn,this.__um);
var cO=new qx.ui.menu.Button(br,bl,this.__ut);
var cD=new qx.ui.menu.Button(bT,ca,this.__OG);
var cL=new qx.ui.menu.Button(bW,bU,this.__OH);
var cF=new qx.ui.menu.Button(bV,bX,this.__OI);
var cC=new qx.ui.menu.Button(cw,bS,null,cB);
var cM=new qx.ui.menu.Button(bJ,bR,null,cJ);
var cK=new qx.ui.menu.Button(cj,bp);
cH.addListener(cc,this.debugButton);
cO.addListener(cc,this.debugButton);
cD.addListener(cc,this.debugButton);
cL.addListener(cc,this.debugButton);
cF.addListener(cc,this.debugButton);
cC.addListener(cc,this.debugButton);
cM.addListener(cc,this.debugButton);
cK.addListener(cc,this.debugButton);
cE.add(cH);
cE.add(cO);
cE.addSeparator();
cE.add(cD);
...
cE.addSeparator();
cE.add(cK);
var cN=new qx.ui.form.MenuButton(bE,bq,cE);
return cN;
},getSplitButton:function(){var cP=new qx.ui.menu.Menu;
var cT=new qx.ui.menu.Button(bz);
var cR=new qx.ui.menu.Button(cn);
var cS=new qx.ui.menu.Button(h);
cP.setMinWidth(120);
cT.addListener(cc,this.debugButton);
cR.addListener(cc,this.debugButton);
cS.addListener(cc,this.debugButton);
cP.add(cT);
cP.add(cR);
cP.add(cS);
var cQ=new qx.ui.form.SplitButton(bh,bq,cP);
cQ.addListener(cc,this.debugButton);
return cQ;
},getMenuBar:function(){var cY=new qx.ui.container.Composite(new qx.ui.layout.Grow);
cY.setDecorator(C);
...
toolbar.addSpacer();
toolbar.add(dc);
var dh=new qx.ui.toolbar.SplitButton(D,cq,this.getBackMenu());
var de=new qx.ui.toolbar.SplitButton(E,y,this.getForwardMenu());
var cW=new qx.ui.toolbar.Button(bu,ch,this.__OD);
var db=new qx.ui.toolbar.Button(ck,bo,this.__OE);
var dg=new qx.ui.toolbar.Button(bm,bs,this.__OF);
dh.addListener(cc,this.debugButton);
de.addListener(cc,this.debugButton);
cW.addListener(cc,this.debugButton);
db.addListener(cc,this.debugButton);
dg.addListener(cc,this.debugButton);
di.add(dh);
di.add(de);
di.addSeparator();
di.add(cW);
...
di.add(dg);
di.setShow(P);
var da=new qx.ui.toolbar.MenuButton(bf);
var cV=new qx.ui.toolbar.MenuButton(k);
var cU=new qx.ui.toolbar.MenuButton(a);
var dj=new qx.ui.toolbar.MenuButton(bL);
var df=new qx.ui.toolbar.MenuButton(be);
da.setMenu(this.getFileMenu());
cV.setMenu(this.getEditMenu());
cU.setMenu(this.getSearchMenu());
dj.setMenu(this.getViewMenu());
df.setMenu(this.getFormatMenu());
cX.add(da);
cX.add(cV);
cX.add(cU);
cX.add(dj);
cX.add(df);
var dd=new qx.ui.toolbar.MenuButton(b);
dd.setMenu(this.getHelpMenu());
dc.add(dd);
return cY;
},getBackMenu:function(){var dl=new qx.ui.menu.Menu;
var dm=new qx.ui.menu.Button(H);
var dp=new qx.ui.menu.Button(bk);
var dk=new qx.ui.menu.Button(m);
var dn=new qx.ui.menu.Button(p);
dm.addListener(cc,this.debugButton);
dp.addListener(cc,this.debugButton);
dk.addListener(cc,this.debugButton);
dn.addListener(cc,this.debugButton);
dl.add(dm);
dl.add(dp);
dl.add(dk);
dl.add(dn);
return dl;
},getForwardMenu:function(){var dq=new qx.ui.menu.Menu;
var dr=new qx.ui.menu.Button(J);
var ds=new qx.ui.menu.Button(bD);
dr.addListener(cc,this.debugButton);
ds.addListener(cc,this.debugButton);
dq.add(dr);
dq.add(ds);
return dq;
},getFileMenu:function(){var dv=new qx.ui.menu.Menu;
var dt=new qx.ui.menu.Button(bu,ch,this.__OD);
var dx=new qx.ui.menu.Button(ck,bo,this.__OE);
var dw=new qx.ui.menu.Button(co);
var dA=new qx.ui.menu.Button(bm,bs,this.__OF);
var dz=new qx.ui.menu.Button(bM,cu);
var dy=new qx.ui.menu.Button(cj,bp);
var du=new qx.ui.menu.Button(bw,v);
dt.addListener(cc,this.debugButton);
dx.addListener(cc,this.debugButton);
dw.addListener(cc,this.debugButton);
dA.addListener(cc,this.debugButton);
dz.addListener(cc,this.debugButton);
dy.addListener(cc,this.debugButton);
du.addListener(cc,this.debugButton);
dv.add(dt);
dv.add(dx);
dv.add(dw);
dv.add(dA);
...
dv.add(du);
return dv;
},getEditMenu:function(){var dC=new qx.ui.menu.Menu;
var dF=new qx.ui.menu.Button(bt,bn,this.__um);
var dE=new qx.ui.menu.Button(br,bl,this.__ut);
var dB=new qx.ui.menu.Button(bT,ca,this.__OG);
var dG=new qx.ui.menu.Button(bW,bU,this.__OH);
var dD=new qx.ui.menu.Button(bV,bX,this.__OI);
dF.addListener(cc,this.debugButton);
dE.addListener(cc,this.debugButton);
dB.addListener(cc,this.debugButton);
dG.addListener(cc,this.debugButton);
dD.addListener(cc,this.debugButton);
dC.add(dF);
dC.add(dE);
dC.addSeparator();
dC.add(dB);
...
dC.add(dD);
return dC;
},getSearchMenu:function(){var dK=new qx.ui.menu.Menu;
var dI=new qx.ui.menu.Button(bj,bS);
var dN=new qx.ui.menu.Button(n);
var dJ=new qx.ui.menu.Button(Y);
var dM=new qx.ui.menu.Button(bH);
var dH=new qx.ui.menu.Button(cg,bS);
var dL=new qx.ui.menu.Button(V);
dJ.setEnabled(false);
dI.addListener(cc,this.debugButton);
dN.addListener(cc,this.debugButton);
dJ.addListener(cc,this.debugButton);
dM.addListener(cc,this.debugButton);
dH.addListener(cc,this.debugButton);
dL.addListener(cc,this.debugButton);
dK.add(dI);
dK.add(dN);
dK.add(dJ);
dK.add(dM);
...
dK.add(dL);
return dK;
},getViewMenu:function(){var dO=new qx.ui.menu.Menu;
var dQ=new qx.ui.menu.Button(Q,null,null,this.getPanesMenu());
var dT=new qx.ui.menu.Button(bC,null,null,this.getSyntaxMenu());
var dS=new qx.ui.menu.CheckBox(bA);
var dR=new qx.ui.menu.CheckBox(bP);
var dP=new qx.ui.menu.Button(r);
dS.addListener(cb,this.debugCheckBox);
dR.addListener(cb,this.debugCheckBox);
dP.addListener(cc,this.debugButton);
dO.add(dQ);
dO.add(dT);
dO.addSeparator();
...
dO.add(dP);
return dO;
},getPanesMenu:function(){var dV=new qx.ui.menu.Menu;
var dX=new qx.ui.menu.CheckBox(bg);
var ea=new qx.ui.menu.CheckBox(c);
var eb=new qx.ui.menu.CheckBox(cr);
var dW=new qx.ui.menu.CheckBox(T);
var dY=new qx.ui.menu.CheckBox(bc);
var dU=new qx.ui.menu.CheckBox(bI);
dX.setValue(true);
ea.setValue(true);
dW.setValue(true);
dX.addListener(cb,this.debugCheckBox);
ea.addListener(cb,this.debugCheckBox);
eb.addListener(cb,this.debugCheckBox);
dW.addListener(cb,this.debugCheckBox);
dY.addListener(cb,this.debugCheckBox);
dU.addListener(cb,this.debugCheckBox);
dV.add(ea);
dV.add(dX);
dV.addSeparator();
dV.add(eb);
...
dV.add(dU);
return dV;
},getSyntaxMenu:function(){var eg=new qx.ui.menu.Menu;
var ec=new qx.ui.menu.RadioButton(bF);
var ee=new qx.ui.menu.RadioButton(G);
var ed=new qx.ui.menu.RadioButton(O);
var ef=new qx.ui.menu.Button(bK,null,null,this.getSyntaxCMenu());
var ej=new qx.ui.menu.RadioButton(cm);
var eh=new qx.ui.menu.RadioButton(ct);
eg.add(ec);
eg.add(ee);
eg.add(ed);
eg.add(ef);
eg.add(ej);
eg.add(eh);
var ei=new qx.ui.form.RadioGroup;
ei.add(ec,ee,ed,ej,eh);
ei.add.apply(ei,ef.getMenu().getChildren());
ei.addListener(bY,this.debugRadio);
return eg;
},getSyntaxCMenu:function(){var el=new qx.ui.menu.Menu;
var ek=new qx.ui.menu.RadioButton(cd);
var eo=new qx.ui.menu.RadioButton(cp);
var en=new qx.ui.menu.RadioButton(bx);
var em=new qx.ui.menu.RadioButton(u);
el.add(ek);
el.add(eo);
el.add(en);
el.add(em);
return el;
},getFormatMenu:function(){var es=new qx.ui.menu.Menu;
var er=new qx.ui.menu.Button(t,null,null,this.getParagraphMenu());
var eu=new qx.ui.menu.Button(bi);
var ev=new qx.ui.menu.Button(cv);
var eq=new qx.ui.menu.Button(W);
var et=new qx.ui.menu.Button(bG);
var ep=new qx.ui.menu.Button(bd);
var ex=new qx.ui.menu.Button(I);
var ew=new qx.ui.menu.Button(f);
eu.addListener(cc,this.debugButton);
ev.addListener(cc,this.debugButton);
eq.addListener(cc,this.debugButton);
et.addListener(cc,this.debugButton);
ep.addListener(cc,this.debugButton);
ex.addListener(cc,this.debugButton);
...
es.add(ew);
return es;
},getParagraphMenu:function(){var ey=new qx.ui.menu.Menu;
var eB=new qx.ui.menu.Button(cl,d);
var eC=new qx.ui.menu.Button(K,z);
var ez=new qx.ui.menu.Button(g,l);
var eA=new qx.ui.menu.Button(R,cf);
eB.addListener(cc,this.debugButton);
eC.addListener(cc,this.debugButton);
ez.addListener(cc,this.debugButton);
eA.addListener(cc,this.debugButton);
ey.add(eB);
ey.add(eC);
ey.add(ez);
ey.add(eA);
return ey;
},getHelpMenu:function(){var eD=new qx.ui.menu.Menu;
var eF=new qx.ui.menu.Button(X,cs);
var eH=new qx.ui.menu.Button(bO);
var eG=new qx.ui.menu.Button(ci);
var eE=new qx.ui.menu.Button(bN);
eF.addListener(cc,this.debugButton);
eH.addListener(cc,this.debugButton);
eG.addListener(cc,this.debugButton);
eE.addListener(cc,this.debugButton);
eD.add(eF);
eD.add(eH);
eD.addSeparator();
eD.add(eG);
...
eD.add(eE);
return eD;
},getList:function(){var eI=new qx.ui.form.List;
eI.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){eI.add(new qx.ui.form.ListItem(o+i));
}return eI;
},getContextMenu:function(){var eJ=new qx.ui.menu.Menu;
var eL=new qx.ui.menu.Button(bT,ca,this.__OG);
var eM=new qx.ui.menu.Button(bW,bU,this.__OH);
var eK=new qx.ui.menu.Button(bV,bX,this.__OI);
eL.addListener(cc,this.debugButton);
eM.addListener(cc,this.debugButton);
eK.addListener(cc,this.debugButton);
eJ.add(eL);
eJ.add(eM);
eJ.add(eK);
return eJ;
}},destruct:function(){this._disposeObjects(A,ba,ce,B,S,bB,bQ,j);
}});
})();
