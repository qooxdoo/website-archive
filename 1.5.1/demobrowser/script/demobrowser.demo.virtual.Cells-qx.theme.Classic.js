...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells-qx.theme.Classic.f1a0a1abc5db.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.virtual.Cells";
...
qx.util.Permutation.permute(E,function(F){var G=this.__Kk(D,F.value,F.states);
...
}var K=this.__Kk(I,J.value,J.states);
...
}var O=this.__Kk(M,N.value,N.states);
this.container.add(O);
},this);
},testHtmlCell:function(){var P={value:[f,h,j,null],states:[{},{selected:1}]};
var Q=new qx.ui.virtual.cell.Html;
qx.util.Permutation.permute(P,function(R){var S=this.__Kk(Q,R.value,R.states);
...
qx.util.Permutation.permute(T,function(V){var W=this.__Kk(U,V.value,V.states);
...
qx.util.Permutation.permute(X,function(ba){var bb=this.__Kk(Y,ba.value,ba.states);
...
bd.setIconFalse(n);
bd.setIconTrue(l);
qx.util.Permutation.permute(bc,function(be){var bf=this.__Kk(bd,be.value,be.states);
this.container.add(bf);
},this);
},__Kk:function(bg,bh,bi){var bm=100;
var bk=30;
...
var o=n+qx.bom.element.Style.compile({position:a,overflow:f,cursor:i,textOverflow:h,userSelect:j})+e;

if(!(qx.core.Environment.get(l)==m)){o+=n+qx.bom.element.BoxSizing.compile(d)+g;
}this.__GI=qx.bom.Stylesheet.createElement(o);
this.__GJ={};
this.__jI={};
},members:{__GI:null,__GJ:null,__jI:null,getStylesheet:function(){return this.__GI;
},getCssClass:function(p){return this.__GJ[p]||null;
},computeClassForStyles:function(q,r){var s=this.__jI[r];

if(!s){var s=this.__GK();
qx.bom.Stylesheet.addRule(this.__GI,b+s,r);
this.__jI[r]=s;
}this.__GJ[q]=s;
return s;
},__GK:function(){return "qx-cell-"+this.toHashCode()+"-"+(this.__GL++);
},__GL:0},destruct:function(){this.__GI=this.__GJ=this.__jI=null;
}});
})();
...
this.__GI=qx.ui.virtual.cell.CellStylesheet.getInstance();
this.__GR={};
this.__GS={};
this.__GT={};
this.__GU={};
...
for(var K in N){if(!O[K]){this.__GW.push(K);
}}L=L.superclass;
}},_getCssProperties:function(){return [J,l,C,q,d,c,e,h];
},_applyAppearance:function(P,Q){if(Q){this.__GS={};
}},_getValue:function(R){if(this.__GY){return qx.util.PropertyUtil.getThemeValue(this,R);
}else{return qx.util.PropertyUtil.getUserValue(this,R);
}},_storeStyle:function(S,T){var U;

if(this.__GY){U=this.__GS;
}else{U=this.__GR;
}
...
}},getCellProperties:function(bj,bk){this.__Hb(bk);
...
},getCssClasses:function(bp,bq){var br=this.__GI.getCssClass(this.__GX)||f;
return n+br;
},__Hb:function(bs){if(!bs){bs={};
}var bu=this.getAppearance();
var bt=bu+a+qx.lang.Object.getKeys(bs).sort().join(x);

if(this.__GX==bt){return;
}this.__GX=bt;
var bv=this.__ie[this.__GX];

if(!bv){this.__Hc();
this.__Hd(bs);
this.__He(bs);
this.__Hf();
this.__ie[this.__GX]=1;
}this.__Hg();
},__Hc:function(){var bw=qx.util.PropertyUtil;
var bx=this._getCssProperties();

for(var i=0;i<bx.length;i++){bw.deleteThemeValue(this,bx[i]);
}},__Hd:function(by){this.__GS={};
this.__GY=true;
...
},__He:function(){var bD=qx.lang.Object.getValues(this.__GS).join(b);
this.__GI.computeClassForStyles(this.__GX,bD);
},__Hf:function(){var bI=this.__GW;
...
}}this.__GV[this.__GX]=bG;
},__Hg:function(){var bK=qx.util.PropertyUtil;
var bJ=this.__GV[this.__GX]||{};

for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);
}},getStyles:function(bM,bN){return qx.lang.Object.getValues(this.__GR).join(b);
},getInsets:function(bO,bP){var bT=this.__GT;
var bS=this.__GU;
...
return [bU+bQ,top+bR];
}},destruct:function(){this.__GI=this.__GR=this.__GS=this.__GT=this.__GU=this.__ie=this.__GV=this.__GW=null;
}});
})();
...
},members:{__qX:16,__qY:16,_aliasManager:null,__rb:function(w){var z=qx.util.ResourceManager.getInstance();
...
},__Ho:function(B){if(typeof (B)==d){B={url:B};
...
var I=this.__Ho(this._identifyImage(F));
...
},properties:{appearance:{refine:true,init:a},iconTrue:{check:e,themeable:true,apply:b},iconFalse:{check:e,themeable:true,apply:d}},members:{__Jl:null,__Jm:null,__xW:null,_applyIconTrue:function(f){this.__Jl=this.__xW.resolve(f);
},_applyIconFalse:function(g){this.__Jm=this.__xW.resolve(g);
},_identifyImage:function(h){return h==true?this.__Jl:this.__Jm;
}}});
})();
