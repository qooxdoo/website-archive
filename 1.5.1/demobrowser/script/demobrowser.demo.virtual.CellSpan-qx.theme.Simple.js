...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellSpan-qx.theme.Simple.d54856d576e0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.virtual.CellSpan",b="os.name",a="engine.version";
...
(function(){var j="yellow",i="bold",h="table-scroller-header",g="green",f="__On",e=" / ",d="Widget Cells",c="demobrowser.demo.virtual.CellSpan",b="HTML Cells",a="x";
qx.Class.define(c,{extend:qx.application.Standalone,members:{__On:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
this.__On=new qx.ui.virtual.cell.Cell();
...
this.__On.setBackgroundColor(s);
return this.__On.getCellProperties(q+e+r);
...
},__Kk:function(A,B,C,D,top,E,F){var H=this._cellProvider.getCellProperties(B,C);
var G=H.insets||[0,0];
...
var W=R[i];
this.__Kk(U,S.firstRow,S.firstColumn,W.left,W.top,W.width,W.height);
}}else{O=[];
...
if(!O[N][T]){this.__Kk(U,N,T,V,top,P,M);
}T++;
V+=P;
}top+=M;
N++;
...
}return this.__Gk(J,M);
},__Gk:function(N,O){var P=[];
...
this.__yH=[];
this._cellLayer=new qx.ui.virtual.layer.WidgetCell(this.__Gh());
...
},__yH:null,setCellSpan:function(u,v,w,x){var y=u+d+v;
this._spanManager.removeCell(y);

if(w>1||x>1){this._spanManager.addCell(y,u,v,w,x);
}qx.ui.core.queue.Widget.add(this);
},__Gh:function(){var self=this;
...
return z;
},__Gi:function(G,H,I,J){this._cells=this._spanManager.findCellsInWindow(G,H,I,J);
...
}}},__Gj:function(){var O=this.getChildren();
...
this._add(L);
}}},_fullUpdate:function(P,Q,R,S){this.__Gi(P,Q,R.length,S.length);
this.__Gj();
this._cellLayer.fullUpdate(P,Q,R,S);
},_updateLayerWindow:function(T,U,V,W){this.__Gi(T,U,V.length,W.length);
this.__Gj();
...
this._cellProvider=this.__yH=this._cells=this._bounds=this._spanMap=null;
}});
})();
