...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.showcase.Maps","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.showcase.Maps-qx.theme.Classic.41c45a00525e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.showcase.Maps";
...
(function(){var j="appear",i="main",h="Google Maps",g="<b>",f="center_changed",e="Karlsruhe",d="Yahoo Maps",c="</b>",b="demobrowser.demo.showcase.Maps",a='zIndex';
...
var k=this._createYahooMap();
var l=this._createGoogleMap();
this.getRoot().add(this._createMapContainer(d,k),{left:20,top:20});
this.getRoot().add(this._createMapContainer(h,l),{left:490,top:20});
},_createMapContainer:function(m,n){var p=new qx.ui.container.Composite();
p.setLayout(new qx.ui.layout.VBox().set({spacing:10}));
p.setWidth(450);
p.setHeight(400);
var o=new qx.ui.basic.Label(g+m+c).set({rich:true});
p.add(o);
p.add(n);
return p;
},_createYahooMap:function(){var q=new qx.ui.core.Widget().set({width:450,height:400,decorator:i});
q.addListenerOnce(j,function(){var r=new YMap(q.getContentElement().getDomElement());
r.addTypeControl();
r.setMapType(YAHOO_MAP_REG);
r.drawZoomAndCenter(e,5);
});
return q;
},_createGoogleMap:function(){var s=new qx.ui.core.Widget().set({width:450,height:400});
s.setDecorator(i);
s.addListenerOnce(j,function(){var t=new google.maps.Map(s.getContentElement().getDomElement(),{zoom:13,mapTypeId:google.maps.MapTypeId.ROADMAP});
google.maps.event.addListenerOnce(t,f,function(){window.setTimeout(function(){var u=s.getContentElement().getStyle(a);
s.getContentElement().getDomElement().style.zIndex=u;
},500);
});
