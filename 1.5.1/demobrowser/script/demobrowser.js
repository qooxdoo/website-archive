...
var envinfo = {"qx.allowUrlSettings":true,"qx.application":"demobrowser.Application","qx.contrib":false,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.variants":true,"qx.revision":"exported","qx.theme":"demobrowser.Theme","qx.version":"1.5.1"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"demobrowser":{"resourceUri":"resource","sourceUri":"script","version":"trunk"},"qx":{"resourceUri":"resource","sourceUri":"script","version":"1.5.1"},"qxc.ui.logpane":{"resourceUri":"resource","sourceUri":"script","version":"trunk"}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.56e89a323ffc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="os.name",j="os.version",h="css.borderradius",g="default",f="browser.quirksmode",e="browser.name",d="qx.allowUrlSettings",c="event.pointer",b="io.ssl",a="locale.variant",Y="css.textoverflow",X="html.xul",W="html.classlist",V="css.boxshadow",U="event.touch",T="os.scrollBarOverlayed",S="io.maxrequests",R="css.gradients",Q="browser.documentmode",P="ecmascript.objectcount",r="locale",s="engine.version",p="engine.name",q="css.rgba",n="css.boxmodel",o="css.placeholder",l="|",m="browser.version",v="qx.core.Environment",w="qx.debug.databinding",D="qx.optimization.basecalls",B="qx.debug.dispose",H="qx.optimization.variables",F="true",L="qx.optimization.privates",J="qx.aspects",y="qx.debug",O="qx.dynamicmousewheel",N=":",M="qxenv",x="qx.optimization.strings",z="qx.optimization.comments",A="qx.optimization.variants",C="qx.mobile.emulatetouch",E="qx.dynlocale",G="false",I="&",K="qx.mobile.nativescroll",t="qx.allowUrlVariants",u="qx.propertyDebugLevel";
qx.Bootstrap.define(v,{statics:{_checks:{},_asyncChecks:{},__j:{},get:function(ba){if(this.__j[ba]!=undefined){return this.__j[ba];
...
if(this.__j[bd]!=undefined){window.setTimeout(function(){be.call(self,bg.__j[bd]);
},0);
return;
}var bf=this._asyncChecks[bd];

if(bf){bf(function(bh){bg.__j[bd]=bh;
be.call(self,bh);
});
return;
...
qx.Bootstrap.trace(this);
}},select:function(bi,bj){return this.__k(this.get(bi),bj);
},selectAsync:function(bk,bl,self){this.getAsync(bk,function(bm){var bn=this.__k(bk,bl);
bn.call(self,bm);
},this);
},__k:function(bo,bp){var br=bp[bo];

if(bp.hasOwnProperty(bo)){return br;
}for(var bq in bp){if(bq.indexOf(l)!=-1){var bs=bq.split(l);
...
},__l:function(){if(qx&&qx.$$environment){for(var bz in qx.$$environment){var by=qx.$$environment[bz];
this._checks[bz]=this.__n(by);
}}},__m:function(){if(window.document&&window.document.location){var bA=window.document.location.search.slice(1).split(I);
...
}this._checks[bD]=this.__n(bB);
}}},__n:function(bE){return qx.Bootstrap.bind(function(bF){return bF;
},null,bE);
...
if(this.useCheck(T)){this._checks[T]=qx.bom.client.Scroll.scrollBarOverlayed;
...
if(this.useCheck(W)){this._checks[W]=qx.bom.client.Html.getClassList;
}
if(this.useCheck(X)){this._checks[X]=qx.bom.client.Html.getXul;
}if(this.useCheck(Y)){this._checks[Y]=qx.bom.client.Css.getTextOverflow;
}
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.Application",b="os.name",a="engine.version";
...
}},properties:{locale:{check:c,nullable:true,apply:j,event:h}},members:{__iq:g,__ir:null,__is:null,__in:null,__io:null,__ip:null,getLanguage:function(){return this.__is;
...
(function(){var f="demobrowser.Application",e="viewer",d="qx.debug",c="script/demodata.json",b="demobrowser/css/sourceview.css",a="demobrowser/css/style.css";
...
(function(){var cg="visible",cf="excluded",ce="enabled",cd="execute",cc="current",cb="",ca="/",bY="value",bX="tags",bW="category",bC="1.5.1",bB="modelLink",bA="all",bz="interval",by="node",bx="horizontal",bw='execute',bv="_blank",bu='value',bt="html",cn="noPlayground",co="~",cl="widget",cm="http://demo.qooxdoo.org/",cj="separator-vertical",ck="request",ch="Demos",ci="-",cp="^.*",cq="filled",bP="changeValue",bO="?qxenv:demobrowser.withTests:true",bR="__Me",bQ="demobrowser.DemoBrowser",bT="__Mt",bS="_infosplit",bV="http://manual.qooxdoo.org/",bU="_history",bN="__Mm",bM="_leftComposite",a="_status",b="Ctrl+N",c="completed",d="failed",f="_searchTextField",g="f1",h="__Ml",n="Ctrl+O",o='changeSelection',p='"',cu="logappender",ct="_runbutton",cs=".html",cr="__Mk",cz="_tree",cy="#",cx="f2",cv="_demoView",cB="_stopbutton",cA="ig",S="Unable to access namespace. Maybe no demo loaded.",T='excluded',Q='"}',R="_urlWindow",W='_cmdDisposeSample',X="__Ma",U="toolbar",V="__Mq",O="tree1",P="demo/welcome.html",B='_cmdSampleInOwnWindow',A=".*",D="right-top",C="background-splitpane",x='demo/',w="__mw",z="index.html",y="Filter...",v="/playground/",q="__Mp",bd='label',be='{"code": ',bf="/apiviewer/",bg="icon/16/actions/edit-find.png",Y="_",ba="qooxdoo ",bb="right",bc="main",bh='_cmdObjectSummary',bi="Info",L="js",K="_prevButton",J="file:",I='_cmdNextSample',H="left",G=".",F='_cmdPrevSample',E="Ctrl+Left",N='_cmdRunSample',M="__mu",bj="F5",bk="__Mf",bl="bottom-left",bm="__Mo",bn=" ",bo="runbutton",bp="Ctrl+Right",bq="_navPart",br="?qx.theme=",bs="textfield",bG="Ctrl+D",bF="mainsplit",bE="Could not open the Playground.",bD="app-header",bK="Demo Browser",bJ="_nextButton",bI="__Mn",bH="log",bL="_iframe";
qx.Class.define(bQ,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);
this.__mu={};
var cF=new qx.ui.layout.VBox;
cF.setSeparator(cj);
this.setLayout(cF);
this.add(this._createHeader());
this.widgets={};
this.tests={};
this.__LY="qx.theme.Modern";
this.__Mu();
this.__Ma=this.__MB();
this.add(this.__Ma);
var cJ=new qx.ui.splitpane.Pane(bx);
this.mainsplit=cJ;
var cG=new qx.ui.splitpane.Pane(bx);
cG.setDecorator(null);
this._infosplit=cG;
this.add(cJ,{flex:1});
var cL=this._leftComposite=new qx.ui.container.Composite();
cL.setLayout(new qx.ui.layout.VBox(3));
cL.setBackgroundColor(C);
cJ.add(cL,0);
var cE=new qx.ui.container.Composite();
cE.setLayout(new qx.ui.layout.HBox(3));
cE.setAppearance(bs);
cL.add(cE);
var cM=new qx.ui.basic.Image(bg);
cE.add(cM);
this._searchTextField=new qx.ui.form.TextField();
this._searchTextField.setLiveUpdate(true);
this._searchTextField.setAppearance(cl);
this._searchTextField.setPlaceholder(y);
var cK=new qx.event.Timer(500);
cK.addListener(bz,function(cN){this.filter(this._searchTextField.getValue());
cK.stop();
},this);
this._searchTextField.addListener(bP,function(cO){cK.restart();
},this);
cE.add(this._searchTextField,{flex:1});
this._status=new qx.ui.basic.Label(cb);
this._status.setAppearance(cl);
this._status.setWidth(80);
this._status.setTextAlign(bb);
cE.add(this._status);
cJ.add(cG,1);
this._tree=this.__MF();
cL.add(this._tree,{flex:1});
this.__MG();
this._demoView=this.__MC();
{cG.add(this._demoView,2);
};
var cC=this.__Mb=this.__MD();
var cD=this.__Mc=this.__ME();
var cH=this.__Md=new qxc.ui.logpane.LogView();
var cI=this.__cb=new qx.ui.container.Stack;
cI.setDecorator(bc);
cI.add(cC);
cI.add(cD);
cI.add(cH);
...
this._history.addListener(ck,function(e){var cP=e.getData().replace(co,ca);

if(this._currentSample!=cP){this.setCurrentSample(cP);
}},this);
this.__Me=[this.__Mk,this.__Ml,this.__Mo];
{this.__Me.push(this.__Mi);
this.__Me.push(this.__Mm);
this.__Me.push(this.__Mq);
};
this.__Mf=new qx.event.Timer(250);
this.__Mf.addListener(bz,this.__MI,this);
this.__Mf.start();
this.__Mg=new demobrowser.InfoWindow(this.tr(bi));
this.__Mg.setAutoCenter(true);
},properties:{playDemos:{check:[bA,bW,cc],init:cc}},members:{_iframe:null,__LY:null,__Mf:null,__Mh:null,_tree:null,_status:null,_searchTextField:null,__Mi:null,__Mj:null,__Me:null,_versionFilter:null,_navPart:null,__Mk:null,__Ml:null,__Mm:null,__Mn:null,__Mo:null,__Mp:null,__Mq:null,__Ma:null,_leftComposite:null,_infosplit:null,_demoView:null,__Mr:null,__mw:null,__mu:null,__Ms:null,_urlWindow:null,__Mg:null,__cb:null,__Mb:null,__Mc:null,__Md:null,__Mt:null,defaultUrl:P,playgroundUrl:cm+bC+v,__Mu:function(){this._cmdObjectSummary=new qx.ui.core.Command(n);
this._cmdObjectSummary.addListener(cd,this.__Mw,this);
this._cmdRunSample=new qx.ui.core.Command(bj);
this._cmdRunSample.addListener(cd,this.runSample,this);
this._cmdPrevSample=new qx.ui.core.Command(E);
this._cmdPrevSample.addListener(cd,this.playPrev,this);
this._cmdNextSample=new qx.ui.core.Command(bp);
this._cmdNextSample.addListener(cd,this.playNext,this);
this._cmdSampleInOwnWindow=new qx.ui.core.Command(b);
this._cmdSampleInOwnWindow.addListener(cd,this.__Mx,this);
this._cmdDisposeSample=new qx.ui.core.Command(bG);
this._cmdDisposeSample.addListener(cd,this.__MA,this);
},__Mv:function(e){var cS=e.getTarget()===this.__Mt?this.__Ms:this.__Mt;
var cR=e.getData()[0];

if(cS&&cR){cS.setModelSelection([cR.getModel()]);
}var cQ=cR!=null?cR.getUserData(bY):cb;

switch(cQ){case bt:this.__cb.setSelection([this.__Mb]);
this.__cb.show();
break;
case L:this.__cb.setSelection([this.__Mc]);
this.__cb.show();
break;
case bH:this.__cb.setSelection([this.__Md]);
this.__cb.show();
break;
default:this.__cb.resetSelection();
this.__cb.exclude();
}},__Mw:function(){var cU=this._iframe.getWindow();
var cT;

if(cU&&cU.qx){cT=cU.qx.dev.ObjectSummary.getInfo();
}else{cT=S;
}var cV=new qx.ui.form.TextArea(cT);
cV.setDecorator(null);
cV.setAutoSize(true);
cV.setMaxHeight(qx.bom.Viewport.getHeight()-100);
this.__Mg.setContent(cV);
this.__Mg.setWidth(400);
this.__Mg.show();
},__Mx:function(){var cW=this._iframe.getSource();
window.open(cW,bv);
},__My:function(cX){var cY=!!cX;
var da=this._tree.getSelection()[0].getUserData(bX);

if(da){cY=cY&&!qx.lang.Array.contains(da,cn);
}this.__Mi.setEnabled(cY);
this.__Mj=cX;
},__Mz:function(){if(this.__Mj){var dd=this.__Mj;
var dc=be+p+encodeURIComponent(dd)+Q;
var db=this.playgroundUrl+cy+encodeURIComponent(dc);
window.open(db,bv);
}else{var de=new qx.ui.basic.Label(this.tr(bE));
this.__Mg.setContent(de);
this.__Mg.setWidth(200);
this.__Mg.show();
}},__Fv:function(){window.open(cm+bC+bf);
},__Fw:function(){var df=(bC.split(ci)[0]);
window.open(bV+df);
},_onHideShowTests:function(event){var dh=window.location.search;
var di=window.location.hash;
var dg=z;

if(dh==cb){dg+=bO;
}dg+=di;
location.replace(dg);
},__MA:function(e){var dk=this._iframe.getWindow();
var dj;

if(dk&&dk.qx){dk.qx.core.ObjectRegistry.shutdown();
dj=this.tr("Demo has been disposed.");
}else{dj=this.tr("Unable to access application.");
}var dl=new qx.ui.basic.Label(dj);
dl.setRich(true);
dl.setWrap(true);
this.__Mg.setContent(dl);
this.__Mg.setWidth(350);
this.__Mg.show();
},__MB:function(){var dI=new qx.ui.toolbar.ToolBar();
this._navPart=new qx.ui.toolbar.Part();
dI.add(this._navPart);
...
var self=this;
window.setTimeout(function(){self._stopbutton.setVisibility("excluded");
},0);
this._stopbutton.addListenerOnce("appear",function(dQ){var dR=this._stopbutton.getSizeHint();
this._stopbutton.setMinWidth(dR.width);
this._runbutton.setMinWidth(dR.width);
},this);
var dK=new qx.ui.toolbar.Part();
dI.add(dK);
var dv=new qx.ui.toolbar.Button(this.tr("Previous"),"icon/22/actions/go-previous.png");
dv.addListener("execute",this.playPrev,this);
dv.setToolTipText("Run previous demo");
dK.add(dv);
this._prevButton=dv;
var dG=new qx.ui.toolbar.Button(this.tr("Next"),"icon/22/actions/go-next.png");
dG.addListener("execute",this.playNext,this);
dG.setToolTipText("Run next demo");
dK.add(dG);
this._nextButton=dG;
var dy={converter:function(dS){return dS=="visible";
}};
qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dv,"enabled",dy);
qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dG,"enabled",dy);
var dN=this._navPart=new qx.ui.toolbar.Part();
dI.add(dN);
var dO=new qx.ui.toolbar.Button(this.tr("Own Window"),"icon/22/actions/edit-redo.png");
dO.addListener("execute",this.__Mx,this);
dO.setToolTipText("Open demo in new window");
this.__Mk=dO;
dN.add(dO);
{var dD=new qx.ui.toolbar.Button(this.tr("To Playground"),"icon/22/actions/application-exit.png");
dD.addListener("execute",this.__Mz,this);
dD.setToolTipText("Open demo in the playground");
dD.setEnabled(false);
if(qx.core.Environment.get("browser.name")=="ie"){dD.exclude();
}this.__Mi=dD;
dN.add(dD);
var dq=new qx.ui.toolbar.Part();
dI.add(dq);
var dB=new qx.ui.toolbar.Button(this.tr("API Viewer"),"icon/22/actions/help-contents.png");
dq.add(dB);
dB.setToolTipText(this.tr("Open the qooxdoo API Viewer"));
dB.addListener("execute",this.__Fv,this);
var dn=new qx.ui.toolbar.Button(this.tr("Manual"),"icon/22/actions/help-about.png");
dq.add(dn);
dn.setToolTipText(this.tr("Open the qooxdoo Manual"));
dn.addListener("execute",this.__Fw,this);
};
var dJ=new qx.ui.toolbar.Part;
dI.add(dJ);
{var dF=new qx.ui.menu.Menu;
this.__Mn=dF;
var dw=new qx.ui.menu.RadioButton("Modern Theme");
var dL=new qx.ui.menu.RadioButton("Classic Theme");
var dM=new qx.ui.menu.RadioButton("Simple Theme");
dw.setUserData("value","qx.theme.Modern");
dw.setValue(true);
dL.setUserData("value","qx.theme.Classic");
dM.setUserData("value","qx.theme.Simple");
var dz=new qx.ui.form.RadioGroup(dw,dL,dM);
dz.addListener("changeSelection",this.__MM,this);
dF.add(dw);
dF.add(dL);
dF.add(dM);
var dx=new qx.ui.toolbar.MenuButton(this.tr("Theme"),"icon/22/apps/utilities-color-chooser.png",dF);
this.__Mm=dx;
dx.setToolTipText("Choose theme");
dJ.add(dx);
};
var dA=new qx.ui.menu.Menu;
{var dP=new qx.ui.menu.Button(this.tr("Object Summary"));
this.__Mq=dP;
dP.setCommand(this._cmdObjectSummary);
dA.add(dP);
};
var dt=new qx.ui.menu.Button(this.tr("Dispose Demo"));
this.__Mo=dt;
dt.setCommand(this._cmdDisposeSample);
dA.add(dt);
{dA.addSeparator();
var dr=new qx.ui.menu.CheckBox(this.tr("Hide/Show Tests Demos"));
dr.setValue(!!qx.core.Environment.get("demobrowser.withTests"));
dr.addListener("changeValue",this._onHideShowTests,this);
dA.add(dr);
};
var du=new qx.ui.toolbar.MenuButton(this.tr("Debug"),"icon/22/apps/office-spreadsheet.png",dA);
this.__Mp=du;
du.setToolTipText("Debugging options");
dJ.add(du);
var dC=new qx.ui.toolbar.Part;
this.__Ml=dC;
dI.addSpacer();
dI.add(dC);
{var dH=new qx.ui.toolbar.RadioButton("HTML Code","icon/22/apps/internet-web-browser.png");
dH.setToolTipText("Display HTML source");
dH.setModel('html');
var ds=new qx.ui.toolbar.RadioButton("JS Code","icon/22/mimetypes/executable.png");
ds.setToolTipText("Display JavaScript source");
ds.setModel('js');
dH.setUserData("value","html");
ds.setUserData("value","js");
dC.add(dH);
dC.add(ds);
};
...
dE.setModel('log');
dC.add(dE);
var dm=this.__Mt=new qx.ui.form.RadioGroup;
dm.setAllowEmptySelection(true);
dm.add(dE);
dm.addListener('changeSelection',this.__Mv,this);
{dm.add(dH,ds);
};
dI.setOverflowHandling(true);
var dp=new qx.ui.toolbar.MenuButton(null,"icon/22/actions/media-seek-forward.png");
dp.setAppearance("toolbar-button");
dI.add(dp);
dI.setOverflowIndicator(dp);
dI.setRemovePriority(dC,6);
dI.setRemovePriority(dJ,5);
dI.setRemovePriority(dq,4);
dI.setRemovePriority(dN,3);
dI.setRemovePriority(dK,2);
dI.setRemovePriority(this._navPart,1);
this.__mw=new qx.ui.menu.Menu();
dp.setMenu(this.__mw);
dI.addListener("hideItem",this._onHideItem,this);
dI.addListener("showItem",this._onShowItem,this);
return dI;
},_onHideItem:function(e){var dT=e.getData();
var dU=this._getMenuItems(dT);

for(var i=0,l=dU.length;i<l;i++){dU[i].setVisibility(cg);

if(dT===this.__Mm&&!(dU[i] instanceof qx.ui.menu.Separator)){dU[i].getMenu().setPosition(D);
}}},_onShowItem:function(e){var dV=e.getData();
var dX=this._getMenuItems(dV);

for(var i=0,l=dX.length;i<l;i++){dX[i].setVisibility(cf);
}
if(dV===this.__Mm){var dW=dV.getMenuButtons();

for(var i=0,l=dW.length;i<l;i++){dW[i].getMenu().setPosition(bl);
}}},_getMenuItems:function(dY){var eb=[];

if(dY instanceof qx.ui.toolbar.Part){var eg=dY.getChildren();
var ef=null;
var ea=false;
var ec=this.__mw.getChildren();

if(dY!=this.__Ml){ef=this.__mu[dY.toHashCode()];

if(!ef){ef=new qx.ui.menu.Separator();
this.__mw.addBefore(ef,ec[0]);
this.__mu[dY.toHashCode()]=ef;
}eb.push(ef);
}else{ea=true;
}
for(var i=0,l=eg.length;i<l;i++){if(eg[i].getVisibility()==T){continue;
}var ed=this.__mu[eg[i].toHashCode()];

if(!ed){if(eg[i] instanceof qx.ui.toolbar.RadioButton){ed=new qx.ui.menu.RadioButton(eg[i].getLabel());
ed.setToolTipText(eg[i].getToolTipText());
ed.setEnabled(eg[i].getEnabled());
ed.setUserData(bu,eg[i].getUserData(bu));
ed.setModel(eg[i].getModel());
eg[i].bind(ce,ed,ce);
eg[i].bind(bY,ed,bY);
ed.bind(bY,eg[i],bY);

if(!this.__Ms){this.__Ms=new qx.ui.form.RadioGroup();
this.__Ms.setAllowEmptySelection(true);
this.__Ms.addListener(o,this.__Mv,this);
}this.__Ms.add(ed);
}else if(eg[i] instanceof qx.ui.toolbar.MenuButton){ed=new qx.ui.menu.Button(eg[i].getLabel().translate(),eg[i].getIcon(),eg[i].getCommand(),eg[i].getMenu());
ed.setToolTipText(eg[i].getToolTipText());
ed.setEnabled(eg[i].getEnabled());
eg[i].bind(ce,ed,ce);
}else if(eg[i] instanceof qx.ui.toolbar.Button){ed=new qx.ui.menu.Button(eg[i].getLabel().translate(),eg[i].getIcon());
ed.getChildControl(bd,false).setRich(true);
ed.setTextColor(eg[i].getTextColor());
ed.setToolTipText(eg[i].getToolTipText());
ed.setEnabled(eg[i].getEnabled());
eg[i].bind(ce,ed,ce);
var ee=qx.event.Registration.getManager(eg[i]).getListeners(eg[i],bw);

if(ee&&ee.length>0){for(var j=0,k=ee.length;j<k;j++){ed.addListener(bw,qx.lang.Function.bind(ee[j].handler,ee[j].context));
}}}else if(eg[i] instanceof qx.ui.toolbar.CheckBox){ed=new qx.ui.menu.CheckBox(eg[i].getLabel());
ed.setToolTipText(eg[i].getToolTipText());
ed.setEnabled(eg[i].getEnabled());
eg[i].bind(ce,ed,ce);
}else{ed=new qx.ui.menu.Separator();
}
if(ea){this.__mw.add(ed);
}else{this.__mw.addBefore(ed,ef);
}this.__mu[eg[i].toHashCode()]=ed;
}eb.push(ed);
}}return eb;
},__MC:function(){var eh=new qx.ui.embed.Iframe().set({nativeContextMenu:true});
eh.addListener("load",this.__MH,this);
this._iframe=eh;
return eh;
},__MD:function(){var ei=new qx.ui.embed.Html("<div class='script'>The sample source will be displayed here.</div>");
ei.setOverflow("auto","auto");
ei.setFont("monospace");
ei.setBackgroundColor("white");
this.widgets["outputviews.sourcepage.html.page"]=ei;
ei.getContentElement().setAttribute("id","qx_srcview");
return ei;
},__ME:function(){var ej=new qx.ui.embed.Html("<div class='script'>The sample JS source will be displayed here.</div>");
ej.setOverflow("auto","auto");
ej.setFont("monospace");
ej.setBackgroundColor("white");
this.widgets["outputviews.sourcepage.js.page"]=ej;
ej.getContentElement().setAttribute("id","qx_srcview");
return ej;
},__MF:function(){var el=new qx.ui.tree.Tree();
var ek=new qx.ui.tree.TreeFolder("Demos");
el.setAppearance("demo-tree");
el.setRoot(ek);
el.setSelection([ek]);
this.tree=this.widgets["treeview.flat"]=el;
el.addListener("changeSelection",this.treeGetSelection,this);
el.addListener("dblclick",function(e){qx.event.Timer.once(this.runSample,this,50);
},this);
return el;
},__MG:function(){var em=new qx.ui.window.Window(this.tr("Demo Link"),"icon/22/mimetypes/text-html.png");
em.setLayout(new qx.ui.layout.VBox(10));
em.setAllowMaximize(false);
em.setAllowMinimize(false);
var ep=new qx.ui.basic.Label("");
ep.setSelectable(true);
ep.setNativeContextMenu(true);
em.add(ep);
this._urlWindow=em;
var eq=Math.ceil((qx.bom.Viewport.getWidth()/2)-250);
...
this.getApplicationRoot().add(em);
var en=new qx.ui.menu.Menu();
var eo=new qx.ui.menu.Button(this.tr("Get Demo Link"),"icon/22/mimetypes/text-html.png");
eo.addListener("execute",function(e){var es=this.tree.getSelection()[0];
var eu=es.getUserData("modelLink");
var er=this.tests.handler.getFullName(eu);
er=er.replace(".","~");
var et=location.protocol+"//"+location.host+location.pathname+"#"+er;
this._urlWindow.getChildren()[0].setValue(et);
this._urlWindow.open();
},this);
en.add(eo);
this._tree.setContextMenu(en);
},treeGetSelection:function(e){var ew=this.tree.getSelection()[0];
var ey=ew.getUserData(bB);
this.tests.selected=this.tests.handler.getFullName(ey);
},leftReloadTree:function(e){this._sampleToTreeNodeMap={};
var ez=this._sampleToTreeNodeMap;
var eF=null;
var eI=null;
var eH;
{eH=/\?autorun=true/.test(location.href);
};
var eE=this._history.getState();
var eC=eE.match(/([^~]+)~/);

if(eC){eF=eC[1];
}else{var eA=eE.match(/([^~][\w]*)/);

if(eA){eF=eA[1];

if(eH){this.setPlayDemos(bW);
}}else{eF=ch;

if(eH){this.setPlayDemos(bA);
}}}function eG(eJ,eK){var eO=eK.getChildren();
var t;

for(var i=0;i<eO.length;i++){var eL=eO[i];

if(eL.hasChildren()){t=new qx.ui.tree.TreeFolder(eB.polish(eL.label));
t.setUserData(cq,false);
t.setUserData(by,eL);
eG(t,t.getUserData(by));

if(eL.label==eF){eI=t;
t.setOpen(true);
}}else{if(!eL.type){continue;
}t=new qx.ui.tree.TreeFile(eB.polish(eL.label));
var eN=eL.pwd().slice(1).join(ca)+ca+eL.label;

if(eL.tags){var j,m,eM;
t.setUserData(bX,eL.tags);
}ez[eN]=t;
}eJ.add(t);
t.setUserData(bB,eL);
eL.widgetLinkFull=t;
}}var eD=this.tests.handler.ttree;
var eB=this;
this.tree.setUserData(bB,eD);
this.tree.getRoot().setOpen(true);
eG(this.tree.getRoot(),eD);

if(eI!=null){this.tree.setSelection([eI]);
}},runSample:function(e){if(e&&(e.getType()===cd||e.getType()===bz)){if(this.tests.selected===cb){this.setPlayDemos(bA);
}else if(this.tests.selected.indexOf(bt)>0){if(this.__Mr){this.__Mr.stop();
}this.setPlayDemos(cc);
}else{this.setPlayDemos(bW);
}}this._runbutton.setVisibility(cf);
this._stopbutton.setVisibility(cg);

if(this.tests.selected!=cb){var eP=this.tests.selected.replace(G,ca);
this.setCurrentSample(eP);
}else{this.playNext();
}},stopSample:function(e){this.setPlayDemos(cc);
this._nextButton.setEnabled(true);
this._prevButton.setEnabled(true);
this._stopbutton.setVisibility(cf);
this._runbutton.setVisibility(cg);
},setCurrentSample:function(eQ){if(!eQ){return;
}
if(!this._sampleToTreeNodeMap){return;
}var eR;
var eT=this._sampleToTreeNodeMap[eQ];

if(eT){eT.getTree().setSelection([eT]);
eR=x+eQ;
{eR+=br+this.__LY;
};
var eS=eT.getUserData(bX);

if(eS){this.__Mi.setEnabled(!qx.lang.Array.contains(eS,cn));
}}else{eR=this.defaultUrl;
}
if(this._iframe.getSource()==eR){this._iframe.reload();
}else{this.__Mh=false;
this._iframe.setSource(eR);
}if(eR==this.defaultUrl){this.disableMenuButtons();
}else{this.enableMenuButtons();
}this._currentSample=eQ;
this._currentSampleUrl=eR;
},__MH:function(){var eX=this._iframe.getWindow();
var fe=this._iframe.getSource();

if(fe!=null&&fe!=this.defaultUrl){var eW;

try{eW=eX.location.href;
}catch(fg){eW=window.location.href;
var ff=eW.lastIndexOf("/");

if(ff!=-1){eW=eW.substring(0,ff+1);
}eW+=fe;
}var fc=eW.indexOf("/demo/")+6;
var eY=eW.indexOf("?");
eY=eY==-1?eW.length:eY;
var fa=eW.substring(fc,eY).split("/");
var fd=String.fromCharCode(187);

if(fa.length==2){var eU=fa[0];
eU=eU.charAt(0).toUpperCase()+eU.substring(1);
var fb=fa[1].replace(".html","").replace("_"," ");
fb=fb.charAt(0).toUpperCase()+fb.substring(1);
var eV="qooxdoo "+fd+" Demo Browser "+fd+" "+eU+" "+fd+" "+fb;
}else{var eV="qooxdoo "+fd+" Demo Browser "+fd+" Start";
}document.title=eV;
}if(this.getPlayDemos()!="current"){if(!fb){this.playNext();
}else{var self=this;
this.__Mr=qx.event.Timer.once(this.playNext,self,5000);
this._nextButton.setEnabled(false);
this._prevButton.setEnabled(false);
}}else{this._stopbutton.setVisibility("excluded");
this._runbutton.setVisibility("visible");
}},__MI:function(e){var fh=this._iframe.getWindow();

try{if(fh&&fh.qx&&fh.qx.log&&fh.qx.log.appender){if(!this.__Mh){this.__Mh=true;
this.debug("Demo loaded: "+this._currentSample);
this.__Md.clear();

try{this.__Md.fetch(fh.qx.log.Logger);
}catch(e){return ;
}this._history.addToHistory(this._currentSample.replace("/","~"),document.title);
if(this._currentSampleUrl!=this.defaultUrl){this.__MJ(this._currentSampleUrl);
}}}else{this.__Mh=false;
}}catch(fi){this.__Mh=false;
}},filter:function(fj){var fr=new RegExp(cp+fj+A,cA);
var fp=this._tree.getRoot().getItems(true,true);
var fq=0;
var fk=0;

for(var i=0;i<fp.length;i++){var fs=fp[i];
var parent=fs.getParent();
var fo=fs.getUserData(bX);
var fl=false;

if(fo!=null){for(var j=0;j<fo.length;j++){fl=!!fo[j].match(fr);

if(fl){break;
}}}
if(fs.getChildren().length==0){fk++;
}
if((fl||(fs.getLabel().search(fr)!=-1)||(parent.getLabel().search(fr)!=-1))){if(fs.getChildren().length==0){fq++;
}fs.show();
fs.getParent().setOpen(true);
fs.getParent().show();
}else{fs.exclude();
}}if(fj==cb){var fn=this._tree.getRoot().getItems(false,true);
var fm=this._tree.getSelection();
for(var i=0;i<fn.length;i++){if(fn[i]==fm[0]||fn[i]==fm[0].getParent()){continue;
}fn[i].setOpen(false);
}}this._status.setValue(fq+ca+fk);
},__MJ:function(ft){if(typeof (ft)!="string"){return;
}var fu=new qx.io.remote.Request(ft);
fu.setTimeout(180000);
fu.setProhibitCaching(false);
fu.addListener("completed",function(fv){var content=fv.getContent();
if(content){{var fy=content.indexOf("<script",content.indexOf("<script")+7);
var fE=content.indexOf("src",fy);
var fx=content.indexOf("\"",fE+5);
var fz=content.substring(fE+5,fx);
var fC=fz.substring(4,fz.length-3)+".src.js";
var u="script/demobrowser.demo";
var fB=ft.split('/');
var fA=fB[1];
var fD=fB[2];
fD=fD.substr(0,fD.indexOf('.html'));
u+="."+fA+"."+fD+".src.js";
fC=u;
var fw=new qx.io.remote.Request(fC);
fw.setTimeout(180000);
fw.setProhibitCaching(false);
fw.addListener("completed",function(fF){var fG=fF.getContent();
this.__My(fG);

if(fG){this.widgets["outputviews.sourcepage.js.page"].setHtml(this.__MK(fG,"javascript"));
}},this);
fw.addListener("failed",function(fH){this.error("Couldn't load file: "+ft);
},this);
fw.send();
this.widgets["outputviews.sourcepage.html.page"].setHtml(this.__MK(content));
};
}},this);
fu.addListener("failed",function(fI){this.error("Couldn't load file: "+ft);
},this);
fu.send();
},dataLoader:function(fJ){var fK=new qx.io.remote.Request(fJ);
fK.setTimeout(180000);
fK.setProhibitCaching(false);
fK.addListener(c,function(fL){var content=fL.getContent();
if(!content){if(window.location.protocol==J){alert("Failed to load demo data from the file system.\n\n"+"The security settings of your browser may prohibit AJAX "+"when using the file protocol. Please try the http protocol "+"instead.");
}return;
}var fM=eval(content);
qx.event.Timer.once(function(){this.tests.handler=new demobrowser.TreeDataHandler(fM);
this.leftReloadTree();
var fN=this._history.getState();

if(fN){this.setCurrentSample(fN.replace(co,ca));
}else{this.setCurrentSample(this.defaultUrl);
}},this,0);
},this);
fK.addListener(d,function(fO){this.error("Couldn't load file: "+fJ);
},this);
fK.send();
},playPrev:function(e){this.setPlayDemos(cc);
var fS=this.tree.getSelection()[0];

if(fS){var fP=this.tree.getPreviousNodeOf(fS,false);

if(!fP||fP==this.tree.getRoot()){return;
}
while(fP.isVisible&&!fP.isVisible()){fP=this.tree.getPreviousNodeOf(fP,false);
}
if(fP.getParent()==this.tree.getRoot()){var fR=this.tree.getPreviousNodeOf(fP,false);

while(fR.isVisible&&!fR.isVisible()){fR=this.tree.getPreviousNodeOf(fR,false);
}
if(fR.getParent()==this.tree.getRoot()){fR.setOpen(true);
var fQ=this.tree.getPreviousNodeOf(fP,false);

while(fQ.isVisible&&!fQ.isVisible()){fQ=this.tree.getPreviousNodeOf(fQ,false);
}
if(fR!==fQ){fP=fQ;
}}else{fP=fR;
}}
if(!fP||fP===fS){this._stopbutton.setVisibility(cf);
this._runbutton.setVisibility(cg);
return;
}else{this.tree.setSelection([fP]);
this.runSample();
}}},playNext:function(e){this._nextButton.setEnabled(true);
this._prevButton.setEnabled(true);
var fV=this.tree.getSelection()[0];

if(fV){var fT=this.tree.getNextNodeOf(fV);

if(!fT){this.setPlayDemos(cc);
this._stopbutton.setVisibility(cf);
this._runbutton.setVisibility(cg);
return;
}
if(fT.getParent()==this.tree.getRoot()){if(this.getPlayDemos()==bW){if(fT!=fV&&fT!=fV.getParent()){this.setPlayDemos(cc);
this._stopbutton.setVisibility(cf);
this._runbutton.setVisibility(cg);
return;
}}fT.setOpen(true);
fT=this.tree.getNextNodeOf(fT);
}
if(!fT){this._stopbutton.setVisibility(cf);
this._runbutton.setVisibility(cg);
return;
}
while(!fT.isVisible()){var fU=this.tree.getNextNodeOf(fT);

if(!fU){this._stopbutton.setVisibility(cf);
this._runbutton.setVisibility(cg);
return;
}
if(fU.getParent()==this.tree.getRoot()){fT.setOpen(true);
var fU=this.tree.getNextNodeOf(fU);
}fT=fU;
}
if(fT){this.tree.setSelection([fT]);
this.runSample();
}else{this._stopbutton.setVisibility(cf);
this._runbutton.setVisibility(cg);
}}},__MK:function(fW,fX){var fY=new qx.util.StringBuilder("<pre class='script'>");
var gb=[];
var gc=new qx.util.StringBuilder();
var gd=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;
var ga=/^\s*<\/script>\s*$/i;
fW=fW.replace(/\r\n/g,"\n").replace(/\r/g,"\n");
var gb=fW.split('\n');
if(fX=="javascript"){return "<pre ><div class='script'>"+qx.dev.Tokenizer.javaScriptToHtml(fW)+"</div></pre>";
}
for(var i=0;i<gb.length;i++){if(gd.exec(gb[i])){fY.add(this.__ML(qx.bom.String.escape(gc.get()+gb[i])));
gc.clear();
}else if(ga.exec(gb[i])){var ge=qx.dev.Tokenizer.javaScriptToHtml(gc.get());
fY.add('<div class="script">',ge,'</div>');
gc.clear();
gc.add(gb[i],'\n');
}else{gc.add(gb[i],'\n');
}}fY.add(this.__ML(qx.bom.String.escape(gc.get())),"</pre>");
return fY.get();
},disableMenuButtons:function(){var gf=this.__Me;

for(var i=0;i<gf.length;i++){gf[i].setEnabled(false);
}},enableMenuButtons:function(){var gg=this.__Me;

for(var i=0;i<gg.length;i++){gg[i].setEnabled(true);
}},__ML:function(gh){var gj=gh;
function gi(gk){var s=new qx.util.StringBuilder(arguments[1],'<span class="html-tag-name">',arguments[2],'</span>');
var gl;
var gm=false;
if(arguments.length-2>3){for(var i=3;i<arguments.length-2;i++){gl=arguments[i];
...
while((r=m.exec(gl))!=null){s.add(' <span class="keyword">',r[1],'</span>=<span class="string">',r[2].replace(/\s*$/,""),'</span>');
}}}s.add((gm?"/":""));
}s.add('&gt;');
return s.get();
}gj=gj.replace(/(&lt;\/?)([a-zA-Z]+)(.*?)(\/?)&gt;/g,gi);
return gj;
},polish:function(gn){return gn.replace(cs,cb).replace(Y,bn);
},__MM:function(e){this.__LY=e.getData()[0].getUserData("value");
this.runSample();
},_createHeader:function(){var gq=new qx.ui.layout.HBox();
var go=new qx.ui.container.Composite(gq);
go.setAppearance(bD);
var gr=new qx.ui.basic.Label(bK);
var gp=new qx.ui.basic.Label(ba+bC);
go.add(gr);
go.add(new qx.ui.core.Spacer,{flex:1});
go.add(gp);
return go;
}},destruct:function(){this.widgets=this.tests=this._sampleToTreeNodeMap=this.tree=this.logelem=null;
this._disposeObjects(bF,O,H,bo,U,g,cx,bU,cu,bh,N,F,I,B,W,bm,q,bq,ct,cB,cr,bN,bI,h,bT,X,bS,f,a,cz,bL,cv,bR,V,bk,bM,R,bJ,K,M,w);
}});
})();
...
(function(){var m="debug",k="warn",j="execute",h="error",g="info",f="model",d="icon/16/categories/system.png",c="separator-vertical",b="_applyShowLogLevel",a="Boolean",J="qxc.ui.logpane.LogView",I='',H="Debug",G="Log",F="auto",E="icon/16/actions/edit-clear.png",D="Clear",C="__Gc",B="DIV",A="icon/16/status/dialog-information.png",t="Warning",u="Log Level",r="Error",s="appear",p="main",q="changeLogLevel",n="Info",o="bold",v="icon/16/status/dialog-error.png",w="monospace",y="icon/16/status/dialog-warning.png",x="white",z="scroll";
qx.Class.define(J,{extend:qx.ui.container.Composite,construct:function(){this.__Gb=[[m,H,d],[g,n,A],[k,t,y],[h,r,v]];
var N=new qx.ui.layout.VBox();
N.setSeparator(c);
qx.ui.container.Composite.call(this,N);
this.setDecorator(p);
var L=new qx.ui.basic.Label(this.tr(G)).set({font:o,padding:6,allowGrowX:true,allowGrowY:true});
this.__EC=new qx.ui.toolbar.ToolBar();
this.__EC.add(L);
this.__EC.addSpacer();
...
this.add(M,{flex:1});
this.__Gc=new qx.log.appender.Element();
qx.log.Logger.unregister(this.__Gc);
this.__Gd=document.createElement(B);
this.__Gc.setElement(this.__Gd);
M.addListenerOnce(s,function(){M.getContentElement().getDomElement().appendChild(this.__Gd);
},this);
},properties:{showLogLevel:{check:a,apply:b,init:false},logLevel:{check:[m,g,k,h],init:m,event:q}},members:{__Gd:null,__Gc:null,__Gb:null,__Ge:null,__EC:null,clear:function(){this.__Gc.clear();
},fetch:function(O){if(!O){O=qx.log.Logger;
}O.register(this.__Gc);
O.clear();
},getAppenderElement:function(){return this.__Gd;
},_applyShowLogLevel:function(P,Q){if(!this.__Ge){this.__Ge=this.__Gf();
this.__EC.add(this.__Ge);
}
if(P){this.__Ge.show();
}else{this.__Ge.exclude();
}},__Gf:function(){var R=new qx.ui.menu.Menu();
var U=new qx.ui.toolbar.MenuButton(u,d);
U.setMenu(R);

for(var i=0,l=this.__Gb.length;i<l;i++){var T=this.__Gb[i];
...
qx.log.Logger.register(this);
},members:{__eN:null,setElement:function(t){this.clear();
if(t){qx.bom.element.Class.add(t,j);
}this.__eN=t;
},clear:function(){var u=this.__eN;
if(u){u.innerHTML=q;
}},process:function(v){var w=this.__eN;
...
}},properties:{title:{check:k,event:g,nullable:true,apply:c},state:{check:k,event:d,nullable:true,apply:e}},members:{__se:null,_applyState:function(n,o){this._writeState(n);
...
if(this.__se[u]!=null){this.setTitle(this.__se[u]);
...
this.__sg();
},members:{__sf:null,__sg:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){this.__sf=qx.lang.Function.bind(this.__si,this);
qx.bom.Event.addNativeListener(window,d,this.__sf);
}else{qx.event.Idle.getInstance().addListener(c,this.__si,this);
}},__sh:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){qx.bom.Event.removeNativeListener(window,d,this.__sf);
}else{qx.event.Idle.getInstance().removeListener(c,this.__si,this);
}},__si:function(){var e=this._readState();
...
this.__sm();
},members:{__sj:null,__sk:false,__sl:null,_setInitialState:function(){qx.bom.History.prototype._setInitialState.call(this);
this.__sl=this._getHash();
},_setHash:function(o){qx.bom.History.prototype._setHash.call(this,o);
this.__sl=this._encode(o);
},_readState:function(){if(!this.__sk){return this._decode(this._getHash());
}var p=this.__sj.contentWindow.document;
...
try{var s=this.__sj.contentWindow.document;
s.open();
s.write(f+r+d);
s.close();
}catch(t){}},__sm:function(){this.__sp(function(){qx.event.Idle.getInstance().addListener(n,this.__si,this);
});
},__si:function(e){var v=null;
var u=this._getHash();

if(!this.__so(u)){v=this.__sn(u);
}else{v=this._readState();
}
if(qx.lang.Type.isString(v)&&v!=this.getState()){this._onHistoryLoad(v);
}},__sn:function(w){w=this._decode(w);
this._writeState(w);
return w;
},__so:function(x){return qx.lang.Type.isString(x)&&x==this.__sl;
},__sp:function(y){this.__sj=this.__sq();
document.body.appendChild(this.__sj);
this.__sr(function(){this._writeState(this.getState());

if(y){y.call(this);
}},this);
},__sq:function(){var z=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(h)});
z.style.visibility=a;
z.style.position=b;
z.style.left=m;
z.style.top=m;
return z;
},__sr:function(A,B,C){if(typeof C===c){C=0;
}
if(!this.__sj.contentWindow||!this.__sj.contentWindow.document){if(C>20){throw new Error("can't initialize iframe");
}qx.event.Timer.once(function(){this.__sr(A,B,++C);
},this,10);
return;
}this.__sk=true;
A.call(B||window);
}},destruct:function(){this.__sj=null;
qx.event.Idle.getInstance().addListener(n,this.__si,this);
}});
}})();
...
(function(){var g="resize",f="demobrowser.InfoWindow",e="Boolean",d="_applyContent",c="center",b="OK",a="execute";
qx.Class.define(f,{extend:qx.ui.window.Window,construct:function(h,i){qx.ui.window.Window.call(this,h,i);
...
this.addListener(g,this.__MN,this);
},properties:{content:{apply:d},autoCenter:{check:e,init:false}},members:{__Bh:null,_getContentContainer:function(){if(!this.__Bh){this.__Bh=new qx.ui.container.Composite(new qx.ui.layout.VBox());
this.__Bh.setMinHeight(20);
}return this.__Bh;
},clear:function(){this._getContentContainer().removeAll();
},_makeOkButton:function(){var j=new qx.ui.form.Button(this.tr(b));
j.addListener(a,function(k){this.close();
},this);
j.setAllowStretchX(false);
j.setMinWidth(60);
j.setAlignX(c);
return j;
},_applyContent:function(l,m){this.clear();
this._getContentContainer().add(l);
},center:function(){var x=Math.floor((qx.bom.Viewport.getWidth()/2)-(this.getBounds().width/2));
var y=Math.floor((qx.bom.Viewport.getHeight()/2)-(this.getBounds().height/2));
x=x>=0?x:0;
y=y>=0?y:0;
this.moveTo(x,y);
},__MN:function(){if(this.getAutoCenter()){this.center();
}}}});
})();
...
(function(){var o="test",n="",m="^",l="demobrowser.TreeDataHandler",h="ttree",g="All",f="\\.[^\\.]+$",e=".",d="demobrowser.withTests",c="depth";
qx.Class.define(l,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);
this.tmap=p;
this.ttree=this.__MO(p);
},members:{__MO:function(q){var s=q;
function r(w,x){var A=x.classname;
var y=A.split(".");
function z(parent,C){if(!C.length){return parent;
}else{var D=C[0];
var E=C.slice(1,C.length);
var F=null;
var G=null;
var H=parent.getChildren();

for(var i=0;i<H.length;i++){if(H[i].label==D){G=H[i];
break;
}}if(G==null){G=new demobrowser.Tree(D);
parent.add(G);
}F=z(G,E);
return F;
}}var B=z(w,y);

if(!B){throw new Error("No target to insert tests");
}t.readTree(x,B);
}function u(a,b){return (a.classname<b.classname)?-1:(a.classname>b.classname)?1:0;
}var v=new demobrowser.Tree("All");
var t=this;
s.sort(u);

for(var i=0;i<s.length;i++){r(v,s[i]);
}return v;
},readTree:function(I,J){var M=arguments[1]||new demobrowser.Tree(I.classname);
var J;
function O(a,b){return (a.name<b.name)?-1:(a.name>b.name)?1:0;
}
if(I.tests){I.tests.sort(O);

for(var j=0;j<I.tests.length;j++){var L=I.tests[j].tags;
var K=false;

if(!qx.core.Environment.get(d)){for(var k=0;k<L.length;k++){if(L[k]===o){K=true;
break;
}}}
if(!K){J=new demobrowser.Tree(I.tests[j].name);
J.tags=I.tests[j].tags;
J.type=o;
J.desc=I.tests[j].desc;
J.manifest=I.tests[j].manifest;
M.add(J);
}}}if(I.children&&I.children.length){for(var j=0;j<I.children.length;j++){var N=this.readTree(I.children[j]);
M.add(N);
}}return M;
},getRoot:function(){if(!this.Root){var Q={classname:n,tests:[]};
var P=this.tmap;

for(var i=0;i<this.tmap.length;i++){if(Q.classname.length>P[i].classname.length){Q=P[i];
}}this.Root=Q;
}return this.Root.classname;
},getChilds:function(R){var S=[];
var U=this.tmap;
var T=m+R+f;
var V=new RegExp(T);

for(var i=0;i<U.length;i++){if(U[i].classname.match(V)){S.push(U[i]);
}}return S;
},getTests:function(W){var X=this.tmap;

for(var i=0;i<X.length;i++){if(X[i].classname==W){return X[i].tests;
}}return [];
},getPath:function(Y){if(!Y){return n;
}var ba=Y.pwd();
ba.shift();
if(this.isClass(Y)){ba=ba.concat(Y.label);
}return ba;
},getChildren:function(bb){if(bb==g){var bc=this.tmap;
var bd=[];

for(var i=0;i<bc.length;i++){bd.push(bc[i].classname);
}return bd;
}else if(this.isClass(bb)){return this.getTests(bb);
}else{return [];
}},isClass:function(be){if(be.type&&be.type==o){return false;
}else{return true;
}},hasTests:function(bf){if(!this.isClass(bf)){return false;
}else{var bg=bf.getChildren();

for(var i=0;i<bg.length;i++){if(bg[i].type&&bg[i].type==o){return true;
}}return false;
}},classFromTest:function(bh){var bi=n;
var bj=[];
classloop:
for(var i=0;i<this.tmap.length;i++){for(var j=0;j<this.tmap[i].tests.length;j++){if(this.tmap[i].tests[j]==bh){bi=this.tmap[i].classname;
break classloop;
}}}return bi;
},getFullName:function(bk){if(!bk){return n;
}var bl=this.getPath(bk);

if(bk.type&&bk.type==o){bl=bl.concat(bk.label);
}return bl.join(e);
},getPreviousNode:function(bm){var bn=bm.getPrevSibling();

if(bn){return bn;
}},getNextNode:function(bo){var bp=bo.getNextSibling();

if(bp){return bp;
}},testCount:function(bq){if(bq.type&&bq.type==o){return 1;
}else{var br=0;
var bt=bq.getIterator(c);
var bs;

while(bs=bt()){if(bs.type&&bs.type==o){br++;
}}return br;
}}},environment:{"demobrowser.withTests":false},destruct:function(){this.tmap=null;
