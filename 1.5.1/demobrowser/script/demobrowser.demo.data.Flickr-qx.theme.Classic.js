...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Flickr-qx.theme.Classic.629426b7d1e9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.data.store.Jsonp.call(this,this.__Na(R));
},members:{searchForTag:function(S){if(S!=h){this.setUrl(this.__Na(S));
}},__Na:function(T){if(!T){return;
}var U=u+T;
U+=m;
return U;
}}});
