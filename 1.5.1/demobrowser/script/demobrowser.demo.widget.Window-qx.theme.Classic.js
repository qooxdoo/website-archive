...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Window-qx.theme.Classic.8e7c1ac1847b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
br.add(bl);
var bx=new qx.ui.form.CheckBox(U);
bx.setValue(true);
bx.addListener(l,function(e){bo.setShowMaximize(e.getData());
});
br.add(bx);
var bq=new qx.ui.form.CheckBox(A);
bq.setValue(true);
bq.addListener(l,function(e){bo.setShowMinimize(e.getData());
});
br.add(bq);
var bt=new qx.ui.form.CheckBox(T);
bt.setValue(true);
bt.addListener(l,function(e){bo.setAllowClose(e.getData());
});
br.add(bt);
var bz=new qx.ui.form.CheckBox(t);
bz.setValue(true);
bz.addListener(l,function(e){bo.setAllowMaximize(e.getData());
});
br.add(bz);
var bn=new qx.ui.form.CheckBox(D);
bn.setValue(true);
...
br.add(bj);
var bA=new qx.ui.groupbox.GroupBox(J);
bA.setLayout(new qx.ui.layout.VBox(4));
bi.add(bA,{flex:1});
var bv=new qx.ui.form.CheckBox(S);
bv.setValue(true);
bv.addListener(l,function(e){bo.setUseResizeFrame(e.getData());
});
bA.add(bv);
var bw=[z,h,b,u];

for(var i=0;i<bw.length;i++){var bu=bw[i];
var bm=new qx.ui.form.CheckBox(m+bu).set({value:true});
bm.bind(q,bo,s+qx.lang.String.firstUp(bu));
bA.add(bm);
}var bk=new qx.ui.groupbox.GroupBox(x);
bk.setLayout(new qx.ui.layout.VBox(4));
bi.add(bk,{flex:1});
var bs=new qx.ui.form.CheckBox(Q);
bs.setValue(true);
bs.addListener(l,function(e){bo.setMovable(e.getData());
});
bk.add(bs);
var bp=new qx.ui.form.CheckBox(a);
bp.addListener(l,function(e){bo.setUseMoveFrame(e.getData());
});
bk.add(bp);
},createWindow3:function(){var bB=new qx.ui.window.Window(W,v);
...
bB.add(bD);
},getModalWindow1:function(){var bF=new qx.ui.window.Window(L);
bF.setLayout(new qx.ui.layout.VBox(10));
bF.setModal(true);
bF.moveTo(150,150);
this.getRoot().add(bF);
var bE=this.getModalWindow2();
var bH=new qx.ui.form.Button(H,j);
bH.addListener(k,bE.open,bE);
bF.add(bH);
var bG=new qx.ui.form.CheckBox(y);
bG.setValue(true);
bF.add(bG);
