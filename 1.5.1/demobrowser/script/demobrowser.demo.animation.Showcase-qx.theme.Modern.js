...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Showcase","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Showcase-qx.theme.Modern.712b47503e76.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.animation.Showcase",b="os.name",a="engine.version";
...
(function(){var k="setup",j="finish",h="execute",g="Shrink",f="19,66,117",e="#134275",d="#7CFC00",c="Drop out",b="Fold in",a="backgroundColor",M="Attention effects",L="Vanish effects",K="Grow",J="out",I="block",H="in",G="Base effects",F="Puff",E="default",D="Shake",s="testImg",t="Drop in",q="Fold out",r="ColorFlow",o="Toggle Background",p="Toggle Size",m="Toggle Opacity",n="testDiv",u="Pulsate",v="Switch Off",y="spring",x="bold",A="Toggle Position",z="_vBoxes",C="demobrowser.demo.animation.Showcase",B="south",w="display";
qx.Class.define(C,{extend:qx.application.Standalone,members:{_toggleEnable:function(){var status=(this._vBoxes[0].getEnabled()===false);
...
var bm=this.getRoot();
this._vBoxes=[];
var bb=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
bb.setWidth(150);
var bn={gbxBase:new qx.ui.groupbox.GroupBox(G),gbxAttention:new qx.ui.groupbox.GroupBox(M),gbxVanish:new qx.ui.groupbox.GroupBox(L)};
var bn={gbxBase:new qx.ui.groupbox.GroupBox(G),gbxAttention:new qx.ui.groupbox.GroupBox(M),gbxVanish:new qx.ui.groupbox.GroupBox(L)};

for(var bj in bn){bn[bj].setLayout(new qx.ui.layout.Grow);
}var W=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));
W.set({minWidth:120});
this._vBoxes.push(W);
var bh=new qx.ui.form.Button(m);
var be=new qx.ui.form.Button(p);
var br=new qx.ui.form.Button(A);
var O=new qx.ui.form.Button(o);
W.add(bh);
W.add(be);
W.add(br);
W.add(O);
bn.gbxBase.add(W);
var bd=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));
bd.set({minWidth:120});
this._vBoxes.push(bd);
var X=new qx.ui.form.Button(D);
var bl=new qx.ui.form.Button(r);
var Q=new qx.ui.form.Button(u);
bd.add(X);
bd.add(bl);
bd.add(Q);
bn.gbxAttention.add(bd);
var bf=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));
bf.set({minWidth:120});
this._vBoxes.push(bf);
var S=new qx.ui.form.Button(F);
var V=new qx.ui.form.Button(c);
var U=new qx.ui.form.Button(v);
var bu=new qx.ui.form.Button(g);
var P=new qx.ui.form.Button(b);
bf.add(S);
bf.add(V);
bf.add(bu);
bf.add(U);
...
for(var bj in bn){bb.add(bn[bj]);
}bm.add(bb);
var bq=new qx.fx.effect.core.Fade(this._demoElement);
bq.addListener(k,function(){this._toggleEnable();
},this);
bq.addListener(j,function(){this._toggleEnable();
},this);
bh.addListener(h,function(){var status=qx.bom.element.Style.get(this._demoElement,w);
bq.set({from:(status==I)?1:0,to:(status==I)?0:1});
bq.start();
},this);
var bg=new qx.fx.effect.core.Scale(this._demoImage);
bg.addListener(k,function(){this._toggleEnable();
},this);
bg.addListener(j,function(){this._toggleEnable();
},this);
be.addListener(h,function(){var status=qx.bom.element.Dimension.getWidth(this._demoImage);
bg.set({scaleTo:((status>240)?80:120),duration:0.5});
bg.start();
},this);
var bk=new qx.fx.effect.core.Move(this._demoElement);
bk.addListener(k,function(){this._toggleEnable();
},this);
bk.addListener(j,function(){this._toggleEnable();
},this);
br.addListener(h,function(){var status=qx.bom.element.Location.getLeft(this._demoElement);
bk.set({duration:1,x:(status<300)?300:-300,y:(status<300)?100:-100,transition:y});
bk.start();
},this);
var N=new qx.fx.effect.core.Highlight(this._demoElement);
N.addListener(k,function(){this._toggleEnable();
},this);
N.addListener(j,function(){this._toggleEnable();
},this);
O.addListener(h,function(){var status=qx.util.ColorUtil.cssStringToRgb(qx.bom.element.Style.get(this._demoElement,a)).toString();
N.set({startColor:(status==f)?e:d,endColor:(status==f)?d:e,restoreBackground:false});
N.start();
},this);
var T=new qx.fx.effect.combination.Shake(this._demoElement);
T.addListener(k,function(){this._toggleEnable();
},this);
T.addListener(j,function(){this._toggleEnable();
},this);
X.addListener(h,function(){T.start();
});
var Y=new qx.fx.effect.combination.ColorFlow(this._demoElement);
Y.addListener(k,function(){this._toggleEnable();
},this);
Y.addListener(j,function(){this._toggleEnable();
},this);
bl.addListener(h,function(){var status=qx.util.ColorUtil.cssStringToRgb(qx.bom.element.Style.get(this._demoElement,a)).toString();
Y.set({restoreBackground:false,startColor:(status==f)?e:d,endColor:(status==f)?d:e});
Y.start();
},this);
var bs=new qx.fx.effect.combination.Pulsate(this._demoElement);
bs.addListener(k,function(){this._toggleEnable();
},this);
bs.addListener(j,function(){this._toggleEnable();
},this);
Q.addListener(h,function(){bs.start();
});
var bt=new qx.fx.effect.combination.Puff(this._demoImage);
bt.setModifyDisplay(false);
bt.addListener(k,function(){this._toggleEnable();
},this);
bt.addListener(j,function(){this._toggleEnable();
},this);
S.addListener(h,function(){bt.start();
});
var bc=new qx.fx.effect.combination.Shrink(this._demoImage);
var bi=new qx.fx.effect.combination.Grow(this._demoImage);
var ba=bc;
bc.addListener(k,function(){this._toggleEnable();
},this);
bc.addListener(j,function(){this._toggleEnable();

if(bu.getLabel()==g){bu.setLabel(K);
ba=bi;
}else{bu.setLabel(g);
ba=bc;
}},this);
bi.addListener(k,function(){this._toggleEnable();
},this);
bi.addListener(j,function(){this._toggleEnable();
...
bu.addListener(h,function(){ba.start();
});
var bo=new qx.fx.effect.combination.Drop(this._demoElement);
bo.set({direction:B,yAmount:90});
bo.addListener(k,function(){this._toggleEnable();
},this);
bo.addListener(j,function(){this._toggleEnable();

if(V.getLabel()==c){V.setLabel(t);
bo.setMode(H);
}else{V.setLabel(c);
bo.setMode(J);
}},this);
V.addListener(h,function(){bo.start();
});
var R=new qx.fx.effect.combination.Fold(this._demoElement);
R.addListener(k,function(){this._toggleEnable();
},this);
R.addListener(j,function(){this._toggleEnable();
qx.lang.Function.delay(function(){if(P.getLabel()==b){P.setLabel(q);
R.setMode(J);
}else{P.setLabel(b);
R.setMode(H);
}},100,this);
},this);
P.addListener(h,function(){R.start();
});
var bp=new qx.fx.effect.combination.Switch(this._demoElement);
bp.setModifyDisplay(false);
bp.addListener(k,function(){this._toggleEnable();
},this);
bp.addListener(j,function(){this._toggleEnable();
},this);
U.addListener(h,function(){bp.start();
});

for(var bj in bn){bn[bj].setFont(x);
bb.add(bn[bj]);
}
for(var i=0;i<this._vBoxes.length;i++){this._vBoxes[i].setFont(E);
}}},destruct:function(){this._demoElement=this._demoImage=null;
...
this.__AY=qx.fx.Base.EffectState.IDLE;
this.__eN=u;
},events:{"setup":s,"update":s,"finish":s},properties:{duration:{init:0.5,check:t,apply:g},fps:{init:100,check:t},sync:{init:false,check:o},from:{init:0,check:t},to:{init:1,check:t},delay:{init:0.0,check:t},queue:{check:i,dereference:true},transition:{init:q,check:[q,f,c,k,p,d,h,j,b,m,e]}},statics:{EffectState:{IDLE:'idle',PREPARING:'preparing',RUNNING:'running'}},members:{__AY:null,__Ba:null,__Bb:null,__Bc:null,__Bd:null,__Be:null,__Bf:null,__Bg:null,__eN:null,_getElement:function(){return this.__eN;
},_setElement:function(v){this.__eN=v;
},_applyDuration:function(w,x){},init:function(){this.__AY=qx.fx.Base.EffectState.PREPARING;
this.__Ba=0;
this.__Bb=this.getDelay()*1000+(new Date().getTime());
this.__Bc=this.__Bb+(this.getDuration()*1000);
this.__Bd=this.getTo()-this.getFrom();
this.__Be=this.__Bc-this.__Bb;
this.__Bf=this.getFps()*this.getDuration();
...
},start:function(){if(this.__AY!=qx.fx.Base.EffectState.IDLE){return false;
}this.init();
...
this.afterFinish();
},render:function(z){if(this.__AY==qx.fx.Base.EffectState.PREPARING){this.__AY=qx.fx.Base.EffectState.RUNNING;
...
if(this.__AY==qx.fx.Base.EffectState.RUNNING){this.__Bg=qx.fx.Transition.get(this.getTransition())(z)*this.__Bd+this.getFrom();
this.beforeUpdateInternal();
this.beforeUpdate();
this.update(this.__Bg);
this.afterUpdateInternal();
this.afterUpdate();

if(this.hasListener(r)){this.fireEvent(r);
}}},loop:function(A){if(A>=this.__Bb){if(A>=this.__Bc){this.end();
}var C=(A-this.__Bb)/this.__Be;
var B=Math.round(C*this.__Bf);
if(B>this.__Ba){this.render(C);
this.__Ba=B;
}}},cancel:function(){if(!this.getSync()){this.getQueue().remove(this);
}this.__AY=qx.fx.Base.EffectState.IDLE;
},resetState:function(){this.__AY=qx.fx.Base.EffectState.IDLE;
},isActive:function(){return this.__AY===qx.fx.Base.EffectState.RUNNING||this.__AY===qx.fx.Base.EffectState.PREPARING;
}},destruct:function(){this.__eN=this.__AY=null;
}});
})();
(function(){var e="__default",d="qx.fx.queue.Manager",c="__fM",b="singleton",a="object";
qx.Class.define(d,{extend:qx.core.Object,type:b,construct:function(){qx.core.Object.call(this);
this.__fM={};
},members:{__fM:null,getQueue:function(f){if(typeof (this.__fM[f])==a){return this.__fM[f];
}else{return this.__fM[f]=new qx.fx.queue.Queue;
...
this.__AO=[];
},properties:{limit:{init:Infinity,check:a}},members:{__AP:null,__AO:null,add:function(c){var d=new Date().getTime();
c._startOn+=d;
c._finishOn+=d;

if(this.__AO.length<this.getLimit()){this.__AO.push(c);
}else{c.resetState();
}
if(!this.__AP){this.__AP=qx.lang.Function.periodical(this.loop,15,this);
}},remove:function(e){qx.lang.Array.remove(this.__AO,e);

if(this.__AO.length==0){window.clearInterval(this.__AP);
delete this.__AP;
}},loop:function(){var f=new Date().getTime();

for(var i=0,g=this.__AO.length;i<g;i++){this.__AO[i]&&this.__AO[i].loop(f);
...
(function(){var p='px',o="Boolean",n="Number",m="fontSize",l="mshtml",k="engine.name",j="Array",i="qx.fx.effect.core.Scale",h="12px",g='pt',c='em',f='%',e="100%",b="string",a="absolute";
qx.Class.define(i,{extend:qx.fx.Base,construct:function(q){qx.fx.Base.call(this,q);
this.__GB=qx.fx.effect.core.Scale.originalStyle;
this.__GC=qx.fx.effect.core.Scale.fontTypes;
},properties:{scaleX:{init:true,check:o},scaleY:{init:true,check:o},scaleContent:{init:true,check:o},scaleFromCenter:{init:true,check:o},scaleFrom:{init:100.0,check:n},scaleTo:{init:100,check:n},restoreAfterFinish:{init:false,check:o},alternateDimensions:{init:[],check:j}},statics:{originalStyle:{'top':null,'left':null,'width':null,'height':null,'fontSize':null},fontTypes:{'em':c,'px':p,'%':f,'pt':g}},members:{__GD:null,__Ej:null,__Ei:null,__GE:null,__GF:null,__GG:null,__GH:null,__GB:null,__GC:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var v=this._getElement();
this.__GD=qx.bom.element.Style.get(v,"position");

for(var t in this.__GB){this.__GB[t]=v.style[t];
}this.__Ej=qx.bom.element.Location.getTop(v);
this.__Ei=qx.bom.element.Location.getLeft(v);

try{var u=qx.bom.element.Style.get(v,m);
}catch(w){if(typeof (u)!=b){u=(qx.core.Environment.get(k)==l)?h:e;
}}
for(var r in this.__GC){if(u.indexOf(r)>0){this.__GE=parseFloat(u);
this.__GF=r;
break;
}}this.__GG=(this.getScaleTo()-this.getScaleFrom())/100;
var s=this.getAlternateDimensions();

if(s.length==0){this.__GH=[v.offsetWidth,v.offsetHeight];
}else{this.__GH=s;
}},update:function(x){var z=this._getElement();
qx.fx.Base.prototype.update.call(this);
var y=(this.getScaleFrom()/100.0)+(this.__GG*x);

if(this.getScaleContent()&&this.__GE){qx.bom.element.Style.set(z,m,this.__GE*y+this.__GF);
}this._setDimensions(this.__GH[0]*y,this.__GH[1]*y);
},finish:function(){qx.fx.Base.prototype.finish.call(this);
var C=this._getElement();

if(this.getRestoreAfterFinish()){for(var A in this.__GB){var B=this.__GB[A];
qx.bom.element.Style.set(C,A,B);
}}},_setDimensions:function(D,E){var d={};
var I=this._getElement();
var G=this.getScaleX();
var H=this.getScaleY();

if(G){d.width=Math.round(D)+p;
}
if(H){d.height=Math.round(E)+p;
}
if(this.getScaleFromCenter()){var J=(D-this.__GH[0])/2;
var K=(E-this.__GH[1])/2;

if(this.__GD==a){if(H){d.top=this.__Ej-K+p;
}
if(G){d.left=this.__Ei-J+p;
}}else{if(H){d.top=-K+p;
}
if(G){d.left=-J+p;
}}}
for(var F in d){qx.bom.element.Style.set(I,F,d[F]);
}}},destruct:function(){this.__GH=this.__GB=this.__GC=null;
}});
})();
(function(){var i="position",h="px",g="relative",f="Number",e="absolute",d="top",c="left",b='absolute',a="qx.fx.effect.core.Move";
qx.Class.define(a,{extend:qx.fx.Base,properties:{mode:{init:g,check:[g,e]},x:{init:0,check:f},y:{init:0,check:f}},members:{__Eg:null,__Eh:null,__Ei:null,__Ej:null,__Ek:null,setup:function(){var j=this._getElement();
qx.fx.Base.prototype.setup.call(this);

if(j.parentNode){this.__Ei=qx.bom.element.Location.getLeft(j)-qx.bom.element.Location.getLeft(j.parentNode);
this.__Ej=qx.bom.element.Location.getTop(j)-qx.bom.element.Location.getTop(j.parentNode);
}else{this.__Ei=qx.bom.element.Location.getLeft(j);
this.__Ej=qx.bom.element.Location.getTop(j);
}this.__Ek=qx.bom.element.Style.get(j,i);
qx.bom.element.Style.set(j,i,e);

if(this.getMode()==b){this.__Eg=this.getX()-this.__Ei;
this.__Eh=this.getY()-this.__Ej;
}else{this.__Eg=this.getX();
this.__Eh=this.getY();
}},update:function(k){var m=this._getElement();
qx.fx.Base.prototype.update.call(this);
var l=Math.round(this.__Eg*k+this.__Ei);
var top=Math.round(this.__Eh*k+this.__Ej);
qx.bom.element.Style.set(m,c,l+h);
qx.bom.element.Style.set(m,d,top+h);
},afterFinishInternal:function(){qx.bom.element.Style.set(this._getElement(),i,this.__Ek);
}}});
})();
...
qx.Class.define(e,{extend:qx.fx.Base,properties:{startColor:{init:d,check:h},endColor:{init:a,check:h},restoreBackground:{init:true,check:i},keepBackgroundImage:{init:false,check:i}},members:{__GN:null,__GO:null,__GP:null,__GQ:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var j=this._getElement();
this.__GN={backgroundImage:qx.bom.element.Style.get(j,"backgroundImage"),backgroundColor:qx.bom.element.Style.get(j,"backgroundColor")};

if(!this.getKeepBackgroundImage()){qx.bom.element.Style.set(j,b,f);
}this.__GO=qx.util.ColorUtil.cssStringToRgb(this.getStartColor());
this.__GP=qx.util.ColorUtil.cssStringToRgb(this.getEndColor());
this.__GQ=[this.__GP[0]-this.__GO[0],this.__GP[1]-this.__GO[1],this.__GP[2]-this.__GO[2]];
},update:function(k){qx.fx.Base.prototype.update.call(this);
var l=[this.__GO[0]+Math.round(this.__GQ[0]*k),this.__GO[1]+Math.round(this.__GQ[1]*k),this.__GO[2]+Math.round(this.__GQ[2]*k)];
...
for(var n in this.__GN){qx.bom.element.Style.set(o,n,this.__GN[n]);
}}},destruct:function(){this.__GO=this.__GP=this.__GQ=null;
}});
})();
(function(){var e="horizontal",d="vertical",c="qx.fx.effect.combination.Shake",b="__AO",a="Number";
qx.Class.define(c,{extend:qx.fx.Base,construct:function(f){qx.fx.Base.call(this,f);
this.__AO=[new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f)];
},properties:{direction:{init:e,check:[e,d]},duration:{init:0.5,refine:true},distance:{init:20,check:a}},members:{__AO:null,start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var g=parseFloat(this.getDistance());
var h=parseFloat(this.getDuration())/10.0;

if(this.getDirection()==e){this.__AO[0].set({x:g,y:0,duration:h});
this.__AO[1].set({x:-g*2,y:0,duration:h*2});
this.__AO[2].set({x:g*2,y:0,duration:h*2});
this.__AO[3].set({x:-g*2,y:0,duration:h*2});
this.__AO[4].set({x:g*2,y:0,duration:h*2});
this.__AO[5].set({x:-g,y:0,duration:h*2});
}else if(this.getDirection()==d){this.__AO[0].set({y:g,x:0,duration:h});
this.__AO[1].set({y:-g*2,x:0,duration:h*2});
this.__AO[2].set({y:g*2,x:0,duration:h*2});
this.__AO[3].set({y:-g*2,x:0,duration:h*2});
this.__AO[4].set({y:g*2,x:0,duration:h*2});
this.__AO[5].set({y:-g,x:0,duration:h*2});
}var k=this.__AO;

for(var i=0,j=this.__AO.length;i<j;i++){this.__AO[i].id=i;

if(i<5){this.__AO[i].afterFinishInternal=function(){k[this.id+1].start();
};
}}this.__AO[0].start();
}},destruct:function(){this._disposeArray(b);
}});
})();
(function(){var r="linear",q="Number",p="reverse",o="Boolean",n="none",m="wobble",l="flicker",k="pulse",j="sinodial",i="easeOutQuad",c="spring",h="easeInQuad",f="full",b="Color",a="#ffffff",e="__GM",d="qx.fx.effect.combination.ColorFlow",g="#ffffaa";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(s){qx.fx.Base.call(this,s);
this.__GM=[new qx.fx.effect.core.Highlight(s),new qx.fx.effect.core.Highlight(s)];
},properties:{startColor:{init:a,check:b},endColor:{init:g,check:b},forwardTransition:{init:r,check:[r,h,i,j,p,l,m,k,c,n,f]},backwardTransition:{init:r,check:[r,h,i,j,p,l,m,k,c,n,f]},forwardDuration:{init:1.0,check:q},backwardDuration:{init:1.0,check:q},delayBetween:{init:0.3,check:q},restoreBackground:{init:true,check:o},keepBackgroundImage:{init:false,check:o}},members:{__GN:null,__GM:null,start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var t=this._getElement();
this.setDuration(this.getForwardDuration()+this.getDelayBetween()+this.getBackwardDuration());
this.__GN={backgroundImage:qx.bom.element.Style.get(t,"backgroundImage"),backgroundColor:qx.bom.element.Style.get(t,"backgroundColor")};
this.__GM[0].set({startColor:this.getStartColor(),endColor:this.getEndColor(),duration:this.getForwardDuration(),transition:this.getForwardTransition(),restoreBackground:false,keepBackgroundImage:this.getKeepBackgroundImage()});
this.__GM[1].set({startColor:this.getEndColor(),endColor:this.getStartColor(),duration:this.getBackwardDuration(),transition:this.getBackwardTransition(),restoreBackground:this.getRestoreBackground(),keepBackgroundImage:this.getKeepBackgroundImage(),delay:this.getDelayBetween()});
var self=this;
this.__GM[0].afterFinishInternal=function(){self.__GM[1].start();
};
this.__GM[0].start();
}},destruct:function(){this._disposeArray(e);
}});
})();
(function(){var e="opacity",d="__IK",c="qx.fx.effect.combination.Pulsate",b="__IL",a="sinodial";
qx.Class.define(c,{extend:qx.fx.Base,construct:function(f){qx.fx.Base.call(this,f);
var g=this.getDuration()/6;
var h=0;
this.__IK=[new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f)];

for(var i=0,l=this.__IK.length;i<l;i++){this.__IK[i].set({duration:g,to:((h%2)!=0)?1:0,from:((h%2)!=0)?0:1,transition:a,modifyDisplay:false});
h++;
}},properties:{duration:{init:2,refine:true}},members:{__nJ:null,__IK:null,__IL:null,__IM:false,beforeSetup:function(){this.__nJ=qx.bom.element.Style.get(this._getElement(),e);
...
for(var i=0,l=this.__IK.length;i<l;i++){this.__IK[i].id=j;
this.__IL.push(this.__IK[i]);
this.__IK[i].afterFinishInternal=function(){qx.lang.Array.remove(self.__IL,this);
if(this.id<5){self.__IK[this.id+1].start();
}else{if(self.__IM){self.end();
}}};
j++;
}this.__IK[0].start();
},end:function(){if(this.__IL.length==0){qx.fx.Base.prototype.end.call(this);
}else{this.__IM=true;
}},afterFinish:function(){qx.bom.element.Style.set(this._getElement(),e,this.__nJ);
},_applyDuration:function(k,m){var n=k/6;

for(var i=0,l=this.__IK.length;i<l;i++){this.__IK[i].set({duration:n});
}},cancel:function(){for(var i=0,l=this.__IL.length;i<l;i++){this.__IL[i].cancel();
}qx.fx.Base.prototype.cancel.call(this);
}},destruct:function(){this._disposeArray(d);
this._disposeArray(b);
}});
})();
(function(){var i="__Gz",h="opacity",g="Boolean",f="none",e="qx.fx.effect.combination.Puff",d="_effects",c="__GA",b="__Jh",a="display";
qx.Class.define(e,{extend:qx.fx.Base,construct:function(j){qx.fx.Base.call(this,j);
this.__Gz=new qx.fx.effect.core.Scale(j);
this.__Jh=new qx.fx.effect.core.Fade(j);
this.__GA=new qx.fx.effect.core.Parallel(this.__Gz,this.__Jh);
},properties:{modifyDisplay:{init:true,check:g}},members:{__Jh:null,__Gz:null,__GA:null,afterFinishInternal:function(){if(this.getModifyDisplay()){qx.bom.element.Style.set(this._getElement(),a,f);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var l=this._getElement();
var k={opacity:qx.bom.element.Style.get(l,h)};
this.__Jh.afterFinishInternal=function(){var n=this._getElement();

for(var m in k){qx.bom.element.Style.set(n,m,k[m]);
}};
this.__Gz.set({scaleTo:200,sync:true,scaleFromCenter:true,scaleContent:true,restoreAfterFinish:true});
this.__Jh.set({sync:true,to:0.0,modifyDisplay:false});
this.__GA.setDuration(this.getDuration());
this.__GA.start();
}},destruct:function(){this._disposeArray(d);
this._disposeObjects(c,i,b);
}});
})();
(function(){var b="qx.fx.effect.core.Parallel",a="__AO";
qx.Class.define(b,{extend:qx.fx.Base,construct:function(c){qx.fx.Base.call(this);
this.__AO=arguments;
},members:{__AO:null,finish:function(){qx.fx.Base.prototype.finish.call(this);
var d=this.__AO;
...
(function(){var j="sinodial",i="none",h="overflow",g="flicker",f="center",e="pulse",d="spring",c="full",b="wobble",a="easeOutQuad",E="easeInQuad",D="reverse",C="linear",B="Boolean",A="px",z='bottom-left',y='top-left',x='bottom-right',w="bottom-right",v="__GA",q="bottom-left",r="visible",o="qx.fx.effect.combination.Shrink",p="top-left",m="top-right",n='top-right',k="__Gy",l="__Gz",s='center',t="hidden",u="display";
qx.Class.define(o,{extend:qx.fx.Base,construct:function(F){qx.fx.Base.call(this,F);
this.__Gy=new qx.fx.effect.core.Move(F);
this.__Gz=new qx.fx.effect.core.Scale(F);
this.__GA=new qx.fx.effect.core.Parallel(this.__Gy,this.__Gz);
},properties:{direction:{init:f,check:[p,m,q,w,f]},moveTransition:{init:j,check:[C,E,a,j,D,g,b,e,d,i,c]},scaleTransition:{init:j,check:[C,E,a,j,D,g,b,e,d,i,c]},modifyDisplay:{init:true,check:B}},members:{__GN:null,__Gy:null,__Gz:null,__GA:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
...
var I=this._getElement();
qx.bom.element.Style.set(I,h,r);
var H;

for(var G in this.__GN){H=this.__GN[G];
...
var J,K;
this.__GN={top:qx.bom.element.Location.getTop(L,"scroll"),left:qx.bom.element.Location.getLeft(L,"scroll"),width:qx.bom.element.Dimension.getContentWidth(L),height:qx.bom.element.Dimension.getContentHeight(L),opacity:qx.bom.element.Style.get(L,"opacity")};

switch(this.getDirection()){case y:J=K=0;
break;
case n:J=this.__GN.width;
K=0;
break;
case z:J=0;
K=this.__GN.height;
break;
case x:J=this.__GN.width;
K=this.__GN.height;
break;
case s:J=this.__GN.width/2;
K=this.__GN.height/2;
break;
}this.__Gy.set({x:J,y:K,sync:true,transition:this.getMoveTransition()});
this.__Gz.set({scaleTo:0,sync:true,transition:this.getScaleTransition(),restoreAfterFinish:true});
this.__GA.setDuration(this.getDuration());
this.__GA.start();
}},destruct:function(){this._disposeObjects(k,l,v);
}});
})();
(function(){var j="sinodial",i="px",h="flicker",g="0px",f="center",e="pulse",d="spring",c="full",b="wobble",a="easeOutQuad",J="easeInQuad",I="reverse",H="none",G="overflow",F="linear",E="height",D='bottom-left',C='top-left',B='bottom-right',A="bottom-right",q="__GA",r="qx.fx.effect.combination.Grow",o="bottom-left",p="visible",m="width",n="top-left",k="top",l="top-right",s='top-right',t="__Gy",v="__Gz",u="block",x='center',w="hidden",z="left",y="display";
qx.Class.define(r,{extend:qx.fx.Base,construct:function(K){qx.fx.Base.call(this,K);
this.__Gy=new qx.fx.effect.core.Move(K);
this.__Gz=new qx.fx.effect.core.Scale(K);
this.__GA=new qx.fx.effect.core.Parallel(this.__Gy,this.__Gz);
},properties:{direction:{init:f,check:[n,l,o,A,f]},scaleTransition:{init:j,check:[F,J,a,j,I,h,b,e,d,H,c]},moveTransition:{init:j,check:[F,J,a,j,I,h,b,e,d,H,c]}},members:{__Gz:null,__Gy:null,__GA:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
...
this.__Gz.afterFinishInternal=function(){var S;
var T=this._getElement();
...
break;
}this.__Gy.set({x:P,y:Q,sync:true,transition:this.getMoveTransition()});
this.__Gz.set({scaleTo:100,sync:true,scaleFrom:0,scaleFromCenter:false,transition:this.getScaleTransition(),alternateDimensions:[N.width,N.height]});
...
this.__GA.setDuration(this.getDuration());
this.__GA.start();
}},destruct:function(){this._disposeObjects(t,v,q);
}});
})();
(function(){var u="out",t="px",s="south",r="Number",q="north-west",p="west",o="in",n="north",m="south-east",l="south-west",e="east",k="north-east",h="display",c="top",b="Boolean",g="block",f="left",i="__GA",a="__Jh",j="__Gy",d="qx.fx.effect.combination.Drop";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(v){qx.fx.Base.call(this,v);
this.__Gy=new qx.fx.effect.core.Move(v);
this.__Jh=new qx.fx.effect.core.Fade(v);
this.__GA=new qx.fx.effect.core.Parallel(this.__Gy,this.__Jh);
},properties:{direction:{init:s,check:[s,p,e,n,l,m,k,q]},xAmount:{init:100,check:r},yAmount:{init:100,check:r},mode:{init:u,check:[o,u]},modifyDisplay:{init:true,check:b}},members:{__Jh:null,__Gy:null,__GA:null,start:function(){qx.fx.Base.prototype.start.call(this);
var A=this._getElement();
qx.bom.element.Style.set(A,h,g);
...
if(this.getMode()==o){qx.bom.element.Style.set(A,c,(z.top-w.y)+t);
qx.bom.element.Style.set(A,f,(z.left-w.x)+t);
}this.__Gy.set(w);
this.__Jh.afterFinishInternal=function(){for(var B in z){qx.bom.element.Style.set(A,B,z[B]+t);
}};
this.__Jh.set({duration:Math.min(0.5,this.getDuration()),sync:true,from:(this.getMode()==u)?1:0,to:(this.getMode()==u)?0:1,modifyDisplay:true});
this.__GA.setDuration(this.getDuration());
this.__GA.start();
}},destruct:function(){this._disposeObjects(j,a,i);
}});
})();
(function(){var q="display",p="in",o="overflow",n="block",m="none",l="visible",k="0px",j="hidden",i="visiblity",h="Boolean",c="height",g="width",f="px",b="qx.fx.effect.combination.Fold",a="__KR",e="__KQ",d="out";
qx.Class.define(b,{extend:qx.fx.Base,construct:function(r){qx.fx.Base.call(this,r);
},properties:{modifyDisplay:{init:true,check:h},mode:{init:p,check:[p,d]}},members:{__KQ:null,__KR:null,__GN:null,afterFinish:function(){var s=this._getElement();

if((this.getModifyDisplay())&&(this.getMode()==p)){qx.bom.element.Style.set(s,q,n);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var t=this._getElement();
var self=this;
this.__KQ=new qx.fx.effect.core.Scale(t);
this.__KR=new qx.fx.effect.core.Scale(t);
this.__KQ.afterFinishInternal=function(){self.__KR.start();
};
this.__KR.afterFinishInternal=function(){self._cleanUp();
};
this.__GN=this._getStyle();
qx.bom.element.Style.set(t,o,j);

if(this.getMode()==p){this.__KQ.set({scaleTo:5,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
this.__KR.set({scaleTo:5,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
}else{this.__KQ.set({scaleTo:100,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:true,alternateDimensions:[this.__GN.width,this.__GN.height]});
this.__KR.set({scaleTo:100,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:false,alternateDimensions:[this.__GN.width,this.__GN.height]});
...
for(var u in this.__GN){v=this.__GN[u];
...
(function(){var j="off",i="overflow",h="Boolean",g="qx.fx.effect.combination.Switch",f="none",e="flicker",d="__Gz",c="__Je",b="hidden",a="display";
qx.Class.define(g,{extend:qx.fx.Base,construct:function(k){qx.fx.Base.call(this,k);
this.setTransition(e);
var l=this.__Gz=new qx.fx.effect.core.Scale(k);
this.__Gz.beforeSetup=function(){qx.bom.element.Style.set(k,i,b);
};
this.__Je=new qx.fx.effect.core.Fade(k);
this.__Je.afterFinishInternal=function(){l.start();
};
},properties:{duration:{init:0.5,refine:true},from:{init:0.0,refine:true},to:{init:1.0,refine:true},modifyDisplay:{init:true,check:h},mode:{init:j,check:[j]}},members:{__Gz:null,__Je:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var n=this._getElement();
var m=qx.bom.element.Style.get(n,i);
this.__Gz.afterFinishInternal=function(){qx.bom.element.Style.set(n,i,m);
};
},afterFinish:function(){if(this.getModifyDisplay()&&(this.getMode()==j)){qx.bom.element.Style.set(this._getElement(),a,f);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}
if(this.getMode()==j){this.__Gz.set({scaleTo:1.0,duration:this.getDuration()/2,scaleFromCenter:true,scaleX:false,scaleContent:false,restoreAfterFinish:true});
this.__Je.set({duration:this.getDuration()/2,from:this.getFrom(),to:1});
}else{}this.__Je.start();
},_applyDuration:function(o,p){this.__Gz.setDuration(o/2);
this.__Je.setDuration(o/2);
