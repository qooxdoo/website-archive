...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.ScaleImage","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage-qx.theme.Modern.157a4fbdce20.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.mobile.ScaleImage";
...
(function(){var k="div",j="50px",i="absolute",h="touchmove",g="url(",f=")",d="green",c="200px",b="30px",a="qx.debug",x="12px",w="event.touch",v="touchend",u='Lucida Grande',t="innerHTML",s="qx.mobile.emulatetouch",r="59px",q="engine.name",p="demobrowser/demo/mobile/qooxdoo-logo.png",o="20px",m="webkit",n="demobrowser.demo.mobile.ScaleImage",l="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>";
qx.Class.define(n,{extend:qx.application.Native,members:{__Dp:null,__NA:1,__NB:0,__NC:0,__ND:0,main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(a)){qx.log.appender.Native;
qx.log.appender.Console;
}var A=new qx.html.Element(k);
A.useElement(document.body);
A.setRoot(true);

if(qx.core.Environment.get(q)!=m||(!qx.core.Environment.get(w)&&qx.core.Environment.get(s)==false)){var z={"color":d,"position":i,"font-family":u,"font-size":x,"left":b,"top":o};
var C=new qx.html.Element(k,z);
A.add(C);
C.setAttribute(t,l);
return;
}var B=qx.util.ResourceManager.getInstance().toUri(p);
var y={"width":c,"height":r,"position":i,"left":j,"top":j,"background":g+B+f};
this.__Dp=new qx.html.Element(k,y);
this.__Dp.addListener(h,this.__CA,this);
this.__Dp.addListener(v,this.__Cz,this);
A.add(this.__Dp);
},__CA:function(e){if(e.isMultiTouch()){this.__NC=e.getRotation()+this.__NB;
this.__ND=e.getScale()*this.__NA;
this.__Dp.setStyle("-webkit-transform","rotate("+this.__NC+"deg) scale("+this.__ND+")");
}else{var D=parseInt(e.getDocumentLeft())-(parseInt(this.__Dp.getStyle("width"))/2);
var top=parseInt(e.getDocumentTop())-(parseInt(this.__Dp.getStyle("height"))/2);
this.__Dp.setStyles({"left":D+"px","top":top+"px"});
}},__Cz:function(e){if(e.isMultiTouch()){this.__NB=this.__NC;
this.__NA=this.__ND;
}}}});
})();
