...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Element_3","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_3-qx.theme.Classic.25b5bb9072c7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.test.Element_3",b="os.name",a="engine.version";
...
(function(){var i="text",h="blur",g="demobrowser.demo.test.Element_3",f="focus",d="type",c="test",b="input",a="focusin";
qx.Class.define(g,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
var j=new qx.html.Root(document.getElementById(c));
var k=new qx.html.Element(b);
k.setAttribute(d,i);
k.focus();
k.addListener(f,function(e){qx.log.Logger.debug("Element focused");
});
k.addListener(h,function(e){qx.log.Logger.debug("Element blurred");
});
qx.bom.Element.addListener(document.documentElement,a,function(e){qx.log.Logger.debug("FocusIn: ",e.getTarget());
});
j.add(k);
