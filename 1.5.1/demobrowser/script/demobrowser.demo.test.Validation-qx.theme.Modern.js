...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Validation-qx.theme.Modern.2c14b62113a3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.test.Validation",b="os.name",a="engine.version";
...
S.setRich(true);
S.setWidth(250);
S.setValue(w+z+a+r+l);
this.getRoot().add(S,{left:280,top:10});
}}});
qx.Class.define(n,{extend:qx.core.Object,properties:{name:{init:v,validate:E},age:{init:18,validate:qx.util.Validate.number()},gender:{init:g,validate:qx.util.Validate.inArray([g,f])}},members:{__Ob:function(W){if(W.length<2){throw new qx.core.ValidationError(C+I+W+O);
}}}});
})();
