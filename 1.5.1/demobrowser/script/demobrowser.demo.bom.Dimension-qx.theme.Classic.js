...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Dimension","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Dimension-qx.theme.Classic.cdf9617d4040.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.bom.Dimension",b="os.name",a="engine.version";
...
for(var i=1;i<1000;i++){var g=document.getElementById(c+i);

if(!g){break;
}var k=e+i+b+h(g)+a+j(g);
this.debug(k);
}function h(l){var m=qx.bom.element.Dimension;
return m.getWidth(l)+f+m.getHeight(l);
}function j(n){var o=qx.bom.element.Dimension;
