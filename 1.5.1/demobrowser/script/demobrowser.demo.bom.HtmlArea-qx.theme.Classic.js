...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.HtmlArea","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.HtmlArea-qx.theme.Classic.2e6332cec508.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.bom.HtmlArea",b="os.name",a="engine.version";
...
(function(){var ca="0px",bY="div",bX="outline",bW="mshtml",bV="hideFocus",bU="none",bT="engine.name",bS="true",bR="16px",bQ="840px",bv="left",bu="<tr>",bt="<option value=''></option>",bs="1px solid #AAA",br="'>",bq="value='",bp="#",bo="</option>",bn="qooxdoo logo",bm="change",ch="select",ci="</tr>",cf="clear:both",cg="Insert Table",cd="Color (Hex): ",ce="Georgia",cb="<p>This low-level widget can be used separately at ",cc="http://",cj="BgColor (Hex): ",ck="Indent More",bJ="Change font family",bI="demobrowser/demo/icons/htmlarea/format-fill-color.png",bL="Align Right",bK="Format Italic",bN="qx/icon/Oxygen/16/actions/format-text-underline.png",bM="350px",bP='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',bO="white",bH="buttons at the toolbar.</p>",bG="demobrowser/demo/icons/htmlarea/format-list-ordered.png",a="qx/icon/Oxygen/16/actions/format-indent-more.png",b="Comic Sans MS",c="Tahoma",d="20px 20px",f="float",g="<h1>HtmlArea low-level widget</h1>",h="<td>First Row, First cell</td>",k="demobrowser/demo/icons/htmlarea/qooxdoo_logo.png",l="Align Left",m="qx/icon/Oxygen/16/actions/format-justify-center.png",co="input",cn="Align Justify",cm="demobrowser/demo/icons/htmlarea/insert-text.png",cl="Insert Horizontal Ruler",cs="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",cr="demobrowser/demo/icons/htmlarea/format-list-unordered.png",cq="HTML Code:",cp="Set Text Background Color",cu="Insert Link",ct="on",L="You can play around with this widget by hitting the ",M="<td>Second Row, First cell</td>",J="</tbody>",K="Set Text Color",P="demobrowser/demo/icons/htmlarea/format-text-color.png",Q="traditional web pages / single-page applications.<br/> ",N="demobrowser/demo/icons/htmlarea/insert-table.png",O="qx/icon/Oxygen/16/actions/edit-undo.png",H="qx/icon/Oxygen/16/actions/edit-clear.png",I="Arial Black",u="Impact",t="Change font size",w="Link: ",v="Redo Last Undo Step",q="Format Bold",p="off",s="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",r="br",o="marginRight",n="image",V="<option qxKeepFocus='on' qxSelectable='off'",W="click",X="<option qxKeepFocus='on' qxSelectable='off' ",Y="Remove Format",R="blank.html",S="qx/icon/Oxygen/16/actions/insert-image.png",T="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",U="</table>",ba="<td>First Row, Second cell</td>",bb="Insert HTML Code",E="qx/icon/Oxygen/16/actions/insert-link.png",D="Insert Ordered List",C="demobrowser.demo.bom.HtmlArea",B="qx/icon/Oxygen/16/actions/format-justify-left.png",A="Courier",z="Courier New",y="4px",x="qx/icon/Oxygen/16/actions/format-justify-right.png",G="qx/icon/Oxygen/16/actions/format-text-bold.png",F="<td>Second Row, Second cell</td>",bc="Insert Image",bd="qx/icon/Oxygen/16/actions/format-indent-less.png",be="<tbody>",bf="Times New Roman",bg="",bh="Align Center",bi="qx/icon/Oxygen/16/actions/edit-redo.png",bj="Lucida Console",bk="innerHTML",bl="Undo Last Change",bz="qx/icon/Oxygen/16/actions/format-text-italic.png",by="Arial",bx="qx/icon/Oxygen/16/actions/format-justify-fill.png",bw="Verdana",bD="Indent Less",bC="Format Strikethrough",bB="Format Underline",bA="<table border='1'>",bF="Inserted Unordered List",bE="It is the foundation for the UI widget component.</p>";
qx.Class.define(C,{extend:qx.application.Native,members:{__Ex:null,__MV:null,__MW:null,__ww:null,__jz:null,main:function(){qx.application.Native.prototype.main.call(this);
this.__Ex=qx.bom.Element.create(bY);
qx.bom.element.Style.setStyles(this.__Ex,{margin:d});
var cx=qx.bom.Element.create(bY);
qx.bom.element.Style.setStyles(cx,{width:bQ,padding:ca,margin:ca});
var cw=g+cb+Q+bE+T+L+bH;
qx.bom.element.Attribute.set(cx,bk,cw);
this.__MV=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__MV,{width:bQ,padding:ca,margin:ca,lineHeight:ca,border:bs});
this.__MW=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__MW,{width:bQ,height:bM,border:bs,borderTop:ca,backgroundColor:bO});
qx.dom.Element.insertEnd(this.__MW,this.__Ex);
var cv=bP;
this.__ww=new qx.bom.htmlarea.HtmlArea(this.__MW,cv,null,R);
this.__wG();
qx.dom.Element.insertBegin(this.__MV,this.__Ex);
qx.dom.Element.insertBegin(cx,this.__Ex);
qx.dom.Element.insertBegin(this.__Ex,document.body);
},__MX:function(e){var cy=window.prompt("FontSize: ","");
this.setFontSize(parseInt(cy));
},__wx:function(e){var cz=window.prompt(cd,bp);
this.setTextColor(cz);
},__wy:function(e){var cA=window.prompt(cj,bp);
this.setTextBackgroundColor(cA);
},__wz:function(e){var cB={src:qx.util.ResourceManager.getInstance().toUri(k),border:0,title:bn,alt:bn};
this.insertImage(cB);
},__wA:function(e){var cC=bA+be+bu+h+ba+ci+bu+M+F+ci+J+U;
this.insertHtml(cC);
},__wB:function(e){var cD=window.prompt(w,cc);
this.insertHyperLink(cD);
},__wC:function(e){var cE=window.prompt(cq,bg);
this.insertHtml(cE);
},__wD:function(){var cG=qx.bom.Element.create(bY);
qx.bom.element.Style.setStyles(cG,{"float":bv});
var cI;
var cH=qx.bom.Element.create(ch,{title:bJ});

if(qx.core.Environment.get(bT)==bW){qx.bom.element.Attribute.set(cH,bV,bS);
}else{qx.bom.element.Style.set(cH,bX,bU);
}cI=qx.bom.Collection.html(bt);
qx.dom.Element.insertEnd(cI[0],cH);
var cJ=[c,bw,bf,by,I,z,A,ce,u,b,bj];
var cF;
var cK;

for(var i=0,j=cJ.length;i<j;i++){cF=V+bq+cJ[i]+br+cJ[i]+bo;
cK=qx.bom.Collection.html(cF);

if(qx.core.Environment.get(bT)==bW){qx.bom.element.Attribute.set(cK[0],bV,bS);
}else{qx.bom.element.Style.set(cK[0],bX,bU);
...
return cG;
},__wE:function(){var cO=qx.bom.Element.create(bY);
qx.bom.element.Style.setStyles(cO,{"marginRight":bR,"float":bv});
var cQ;
var cP=qx.bom.Element.create(ch,{title:t});

if(qx.core.Environment.get(bT)==bW){qx.bom.element.Attribute.set(cP,bV,bS);
}else{qx.bom.element.Style.set(cP,bX,bU);
}cQ=qx.bom.Collection.html(bt);
qx.dom.Element.insertEnd(cQ[0],cP);
var cR;
var cN;

for(var i=1;i<=7;i++){cN=X+bq+i+br+i+bo;
cR=qx.bom.Collection.html(cN);

if(qx.core.Environment.get(bT)==bW){qx.bom.element.Attribute.set(cR[0],bV,bS);
}else{qx.bom.element.Style.set(cR[0],bX,bU);
...
return cO;
},__wG:function(){var cV=[{bold:{text:q,image:G,action:this.__ww.setBold},italic:{text:bK,image:bz,action:this.__ww.setItalic},underline:{text:bB,image:bN,action:this.__ww.setUnderline},strikethrough:{text:bC,image:s,action:this.__ww.setStrikeThrough},removeFormat:{text:Y,image:H,action:this.__ww.removeFormat}},{alignLeft:{text:l,image:B,action:this.__ww.setJustifyLeft},alignCenter:{text:bh,image:m,action:this.__ww.setJustifyCenter},alignRight:{text:bL,image:x,action:this.__ww.setJustifyRight},alignJustify:{text:cn,image:bx,action:this.__ww.setJustifyFull}},{fontFamily:{custom:this.__wD},fontSize:{custom:this.__wE},fontColor:{text:K,image:P,action:this.__wx},textBackgroundColor:{text:cp,image:bI,action:this.__wy}},{indent:{text:ck,image:a,action:this.__ww.insertIndent},outdent:{text:bD,image:bd,action:this.__ww.insertOutdent}},{insertImage:{text:bc,image:S,action:this.__wz},insertTable:{text:cg,image:N,action:this.__wA},insertLink:{text:cu,image:E,action:this.__wB},insertHTML:{text:bb,image:cm,action:this.__wC},insertHR:{text:cl,image:cs,action:this.__ww.insertHorizontalRuler}},{ol:{text:D,image:bG,action:this.__ww.insertOrderedList},ul:{text:bF,image:cr,action:this.__ww.insertUnorderedList}},{undo:{text:bl,image:O,action:this.__ww.undo},redo:{text:v,image:bi,action:this.__ww.redo}}];
var cX,dc,cU,da;

for(var i=0,j=cV.length;i<j;i++){dc={};
dc[o]=i==j-1?ca:bR;
dc[f]=bv;
cX=qx.bom.Element.create(bY);
...
da={type:n,src:qx.util.ResourceManager.getInstance().toUri(cW),title:db.text,qxKeepFocus:ct,qxSelectable:p};
cU=qx.bom.Element.create(co,da);
qx.bom.element.Style.setStyles(cU,{width:bR,height:bR,padding:y});

if(qx.core.Environment.get(bT)==bW){qx.bom.element.Attribute.set(cU,bV,bS);
}else{qx.bom.element.Style.set(cU,bX,bU);
}qx.event.Registration.addListener(cU,W,db.action,this.__ww);
}qx.dom.Element.insertEnd(cU,cX);
}qx.dom.Element.insertEnd(cX,this.__MV);
}qx.dom.Element.insertEnd(qx.bom.Element.create(r,{style:cf}),this.__MV);
}}});
})();
...
this.__uL=qx.bom.htmlarea.HtmlArea.__uN(eD);
if(qx.lang.Type.isString(eC)){this.__uM=eC;
...
},__uP:function(eP,eQ,eR,eS){var eX=[];

switch(eP.nodeType){case 1:case 11:var i;
var eV=eP.tagName.toLowerCase();
var fa={};
var eT={};
var closed=(!(eP.hasChildNodes()||qx.bom.htmlarea.HtmlArea.__uQ(eP)));

if(eQ){if((qx.core.Environment.get(dT)==dR)){if(eV==dt&&eP.className&&eP.className==A){for(i=eP.firstChild;i;i=i.nextSibling){eX.push(qx.bom.htmlarea.HtmlArea.__uP(i,true,eR,eS));
}return eX.join(dS);
...
}if(fa.style!==undefined){eT=qx.bom.htmlarea.HtmlArea.__uO(fa.style);
delete fa.style;
...
}}for(i=eP.firstChild;i;i=i.nextSibling){eX.push(qx.bom.htmlarea.HtmlArea.__uP(i,true,eR,eS));
}if(eQ&&!closed&&eV){eX.push(cJ,eV,O);
}break;
case 3:eX.push(eR?eP.data:qx.bom.htmlarea.HtmlArea.__uR(eP.data));
break;
case 8:eX.push(bL,eP.data,bV);
break;
}return eX.join(dS);
},closingTags:cH,__uQ:function(fc){return (qx.bom.htmlarea.HtmlArea.closingTags.indexOf(dK+fc.tagName+dK)!=-1);
},__uR:function(s){s=s.replace(/&/ig,dD);
s=s.replace(/</ig,cQ);
s=s.replace(/>/ig,dj);
...
}},properties:{contentType:{check:P,init:l},messengerMode:{check:cu,init:false},insertParagraphOnLinebreak:{check:cu,init:true},insertLinebreakOnCtrlEnter:{check:cu,init:true},postProcess:{check:bf,nullable:true,init:null},useUndoRedo:{check:cu,init:true},nativeContextMenu:{check:cu,init:false},defaultFontFamily:{check:P,init:bT},defaultFontSize:{check:cY,init:4}},members:{__jz:null,__cR:false,__uS:false,__uT:false,__uU:false,__uV:false,__tX:null,__uW:null,__uX:null,__uY:null,__sj:null,__uL:null,__va:null,__vb:null,__vc:false,__vd:false,__ve:function(fj){if(qx.dom.Node.isElement(fj)&&qx.dom.Node.isNodeName(fj,dt)){this.__jz=fj;
}},_createAndAddIframe:function(fk){this.__sj=qx.bom.Iframe.create();
qx.bom.Iframe.setSource(this.__sj,fk);
if((qx.core.Environment.get(dT)==dR)){qx.bom.element.Attribute.set(this.__sj,ep,ca);
}else{qx.bom.element.Style.set(this.__sj,ef,eh);
}qx.bom.element.Style.setStyles(this.__sj,{width:q,height:q});
...
},_addIframeLoadListener:function(){qx.event.Registration.addListener(this.__sj,bk,this._loaded,this);
},__vf:function(){this.__va={"xhtml":{doctype:cV+dG+z+ei+ce+cN,html:ej+bN,meta:b,style:qx.core.Environment.select(dT,{"mshtml":cc+dI,"default":dm+eo}),contentStyle:dJ,body:em,footer:N}};
},__uM:dS,getIframeObject:function(){return this.__sj;
},getCommandManager:function(){return this.__tX;
},setValue:function(fl){if(qx.lang.Type.isString(fl)){this.__uM=fl;
var fm=this._getIframeDocument();

if(fm&&fm.body){fm.body.innerHTML=this.__vg(fl);
}}},__vg:function(fn){var fq=dS;
...
var fo=dc+C+this.getDefaultFontFamily()+y+bj+fp+bM+this.getDefaultFontSize()+y+fq+fn+fr+dd+bz+g;
return fo;
},getValue:function(){return this.__uM;
},getComputedValue:function(fs){return this.getHtml(fs);
},getCompleteHtml:function(){var fu=this.__va[this.getContentType()];
var ft=fu.html+t+fu.meta+bt+fu.contentStyle+bs+r;
ft+=K+this.__vh()+bO;
ft+=this.getHtml()+N;
return ft;
},__vh:function(){var fx=[bA,G,dl,bK,Y,be,D,m,dF,cv,f,bS,dh,bX];
...
},__vi:0,__vj:function(){var fS=this._getIframeDocument();
if(!fS){this.__vi++;

if(this.__vi>5){this.error('cant load HtmlArea. Document is not available. '+fS);
this.fireDataEvent(dV);
}else{if(qx.core.Environment.get(cs)){this.error('document not available, try again...');
}qx.event.Timer.once(function(){this.__vj();
},this,0);
}}else{this.__vi=0;
...
return;
}if((qx.core.Environment.get(dT)==dR)){this.__vj();
...
if(!(qx.core.Environment.get(dT)==dO)){this.__vo();
}if(!(qx.core.Environment.get(dT)==dR)){this.setEditable(true);
}this.__cR=true;
this.__tX=fT;
...
this.__vu(true);
}}},"default":qx.lang.Function.empty}),invalidateEditor:qx.core.Environment.select(dT,{"gecko":function(){this.__uT=false;
this.__cR=false;
this.__uS=true;
},"default":function(){}}),__vk:qx.core.Environment.select(dT,{"gecko":function(){this.__vn();
this.__vo();
...
this.__uS=false;
this.fireEvent(cA);
},"default":function(){}}),__vl:function(fV){var fX=dS;
...
},__vm:function(ga){var gb=qx.core.Environment.get(dT)==dQ?dy:dS;
var gc=this.__va[this.getContentType()];
var gd=t+gc.meta+bt+gb+gc.style+gc.contentStyle+this.__uL+bs+r;
var content=gc.body+ga;
return gc.html+gd+content+gc.footer;
},__vn:function(){var gf=this.__vg(this.getValue());

if(qx.lang.Type.isString(gf)){var ge=this._getIframeDocument();

try{ge.open(bY,true);
ge.write(this.__vm(gf));
ge.close();
...
this.__vr();
this.__vq();
},__vp:function(){var gh=qx.event.Registration;
...
},__vq:function(){var gk=qx.event.Registration;
...
},__vr:function(){var gn=qx.event.Registration;
...
},__vs:function(){if(this.__uW==null){this.__uW={execute:function(go,gp){this.stackedCommands=true;
this.commandStack.push({command:go,value:gp});
},commandStack:[],stackedCommands:false};
}this.__uW.stackedCommands=false;
return this.__uW;
},__vt:function(){var gq=this.__uW;

if(gq!=null&&gq.stackedCommands){var gr=gq.commandStack;

if(gr!=null){for(var i=0,j=gr.length;i<j;i++){this.__tX.execute(gr[i].command,gr[i].value);
}}}},__vu:function(gs){var gt=this._getIframeDocument();

if(this.__uT&&gt){try{if((qx.core.Environment.get(dT)==dQ)){gt.designMode=(gs!==false)?x:ds;
}gt.designMode=(gs!==false)?ds:x;
}catch(e){}}},setEditable:function(gu){if(this.__uT){this.__vu(true);
...
}catch(gx){if(!this.__cR){this.error("Failed to enable rich edit functionality");
...
},__vv:false,_handleKeyUp:function(e){var gy=e.getKeyIdentifier().toLowerCase();
this.__uX=e;

if((qx.core.Environment.get(cs))&&qx.core.Environment.get(cl)){this.debug(e.getType()+" | "+gy);
}if(qx.core.Environment.get(dT)==dR||qx.core.Environment.get(dT)==dP){if(this.__vv){switch(gy){case cr:if(this.getInsertLinebreakOnCtrlEnter()){if((qx.core.Environment.get(dT)==dP)){this.__vw();
e.preventDefault();
e.stopPropagation();
}else{var gz=this.__vG(this.getSelection());

if(gz){gz.collapse(true);
gz.pasteHTML(H);
}}this.__vB();
}break;
case bv:this.__vv=false;
return;
break;
}}}else if((qx.core.Environment.get(dT)==dQ)){switch(gy){case cp:case cn:case bu:case et:case ee:case eu:case U:case dq:case dx:this.__uV=(this.getFocusNode()==this.getContentBody().firstChild);
break;
}}},__vw:function(){var gA=this.getSelection();
var gB=dS;
if(gA&&(gA.focusNode.textContent==dS||gA.focusNode.parentElement.tagName==cO)){gB=bH;
}this.__tX.execute(ec,gB+qx.bom.htmlarea.HtmlArea.simpleLinebreak);
},_handleKeyDown:qx.core.Environment.select(dT,{"mshtml|webkit":function(e){var gC=e.getKeyIdentifier().toLowerCase();

if((qx.core.Environment.get(cs))&&qx.core.Environment.get(cl)){}if(this.__vv&&(gC==M||gC==dn||gC==dU||gC==bp||gC==du||gC==u)){e.preventDefault();
e.stopPropagation();
}if(gC==bv){this.__vv=true;
...
}if(this.__vc){var gN=!((qx.core.Environment.get(dT)==dR)&&gD==cr)||!((qx.core.Environment.get(dT)==dQ)&&gD==cr);
...
if((qx.core.Environment.get(dT)==dQ)){if(this.__vE()){this.insertHtml(bh);
this.__vB();
return;
}this.insertHtml(cg);
...
}if((qx.core.Environment.get(dT)==dR)){if(!this.getInsertParagraphOnLinebreak()){if(this.__tX.execute(ec,qx.bom.htmlarea.HtmlArea.simpleLinebreak)){this.__vB();
e.preventDefault();
e.stopPropagation();
...
return;
}while(!qx.dom.Node.isNodeName(gE,ea)){if(qx.dom.Node.isNodeName(gE,bB)){this.__vB();
return;
}gE=gE.parentNode;
...
this.__vB();
this.__vc=true;
}}else if((qx.core.Environment.get(dT)==dP)){if(this.getInsertParagraphOnLinebreak()&&gG){this.__vw();
e.preventDefault();
e.stopPropagation();
this.__vB();
}}break;
case bu:if(qx.core.Environment.get(dT)==dQ&&qx.core.Environment.get(ck)<1.9&&gG){var gM=this.getSelection();
if(gM&&gM.focusNode==gH.body.firstChild){if(this.__uV){if(gM.focusOffset!=0){gM.extend(gM.focusNode,0);
}}}}this.__vB();
break;
...
break;
case cp:case cn:case et:case ee:case eu:case U:case dq:case dx:this.__vB();
break;
case dU:if(gF){this.__vx(bQ,true);
}break;
case du:case u:if(gF){this.__vx(cI,true);
}break;
case bp:if(gF){this.__vx(bP,true);
}break;
case M:if(gF&&!gG){this.__vx(bG,true);
}else if(gF&&gG){this.__vx(w,true);
}break;
case dn:if(gF){this.__vx(w,true);
}break;
case dA:if(gF){this.selectAll();
}break;
}this.__uX=null;
},__vx:function(gO,gP){var gR=null;
...
if(gP){this.__uX.preventDefault();
...
this.__vB();
},_handleMouseUpOnDocument:qx.core.Environment.select(dT,{"mshtml":qx.lang.Function.empty,"default":function(e){if(!this.__vd){qx.bom.Element.activate(this.getContentBody());
}this.__vd=false;
}}),_handleContextMenuEvent:function(e){if(!this.getNativeContextMenu()){var gV=e.getViewportLeft();
var gU=e.getViewportTop();
var gW=qx.bom.element.Location.getLeft(this.__jz)+gV;
var gX=qx.bom.element.Location.getTop(this.__jz)+gU;
...
},insertHtml:function(gY){return this.__tX.execute(ec,gY);
},removeFormat:function(){var ha=this.__tX.execute(dC);
this.__tX.execute(ey,this.getDefaultFontSize());
this.__tX.execute(bC,this.getDefaultFontFamily());
return ha;
},setBold:function(){return this.__tX.execute(dw);
},setItalic:function(){return this.__tX.execute(dY);
},setUnderline:function(){return this.__tX.execute(dW);
},setStrikeThrough:function(){return this.__tX.execute(cj);
},setFontSize:function(hb){return this.__tX.execute(ey,hb);
},setFontFamily:function(hc){return this.__tX.execute(bC,hc);
},setTextColor:function(hd){return this.__tX.execute(bd,hd);
},setTextBackgroundColor:function(he){return this.__tX.execute(bg,he);
},setJustifyLeft:function(){return this.__tX.execute(h);
},setJustifyCenter:function(){return this.__tX.execute(cf);
},setJustifyRight:function(){return this.__tX.execute(bx);
},setJustifyFull:function(){return this.__tX.execute(cy);
},insertIndent:function(){return this.__tX.execute(cS);
},insertOutdent:function(){return this.__tX.execute(V);
},insertOrderedList:function(){return this.__tX.execute(en);
},insertUnorderedList:function(){return this.__tX.execute(cX);
},insertHorizontalRuler:function(){return this.__tX.execute(df);
},insertImage:function(hf){return this.__tX.execute(dB,hf);
},insertHyperLink:function(hg){return this.__tX.execute(bi,hg);
},removeBackgroundColor:function(){this.__tX.execute(dr,bl);
},setBackgroundColor:function(hh){this.__tX.execute(dr,hh);
},removeBackgroundImage:function(){this.__tX.execute(p);
},setBackgroundImage:function(hi,hj,hk){return this.__tX.execute(p,[hi,hj,hk]);
},selectAll:function(){return this.__tX.execute(bm);
},undo:function(){if(this.getUseUndoRedo()){return this.__tX.execute(ew);
}else{return true;
}},redo:function(){if(this.getUseUndoRedo()){return this.__tX.execute(dv);
}else{return true;
}},resetHtml:function(){var hl=this._getIframeDocument();
while(hl.body.firstChild){hl.body.removeChild(hl.body.firstChild);
}if(qx.core.Environment.get(dT)==dQ){hl.body.innerHTML=dH;
...
}return qx.bom.htmlarea.HtmlArea.__uP(hp.body,false,ho,this.getPostProcess());
...
}},__vz:qx.core.Environment.select(dT,{"gecko":function(){var hx=this.getContentBody().childNodes;
...
}}}),__vA:qx.core.Environment.select(dT,{"gecko|webkit":function(){this.getContentDocument().body.innerHTML=this.__vg(dS);
...
},__vB:function(){qx.event.Timer.once(function(e){var hC=this.__vC();
...
hF=hT.textAlign==cn;
hQ=hT.textAlign==eA;
}else{hD=hT.getPropertyValue(n)==dY;
...
if(!hW){return dS;
}else{return this.__vD(hW);
}},__vD:qx.core.Environment.select(dT,{"mshtml":function(hX){if(!hX){return dS;
...
}}}),__vE:qx.core.Environment.select(dT,{"gecko":function(){var ig=this.getSelection();
var ih=this.getFocusNode();
return ig&&this.isSelectionCollapsed()&&ih!=null&&qx.dom.Node.isText(ih)&&ig.anchorOffset<ih.length;
},"default":function(){return false;
}}),__vF:qx.core.Environment.select(dT,{"gecko":function(){return qx.dom.Node.isElement(this.getFocusNode());
},"default":function(){return false;
}}),getRange:function(){return this.__vG(this.getSelection());
},__vG:qx.core.Environment.select(dT,{"mshtml":function(ii){var ij=this._getIframeDocument();
...
}}}),saveRange:qx.core.Environment.select(dT,{"mshtml":function(){this.__vb=this.getRange();
},"default":function(){}}),getSavedRange:qx.core.Environment.select(dT,{"mshtml":function(){return this.__vb;
},"default":function(){}}),resetSavedRange:qx.core.Environment.select(dT,{"mshtml":function(){this.__vb=null;
},"default":function(){}}),getFocusNode:qx.core.Environment.select(dT,{"mshtml":function(){var ip=this.getSelection();
var iq;

switch(ip.type){case cW:case S:iq=this.__vG(ip);

if(iq){iq.collapse(false);
return iq.parentElement();
}else{return null;
}break;
case B:iq=this.__vG(ip);
...
if((qx.core.Environment.get(dT)==dR)){qx.bom.Iframe.setSource(this.__sj,db);
}}catch(ix){}
if(this.__tX instanceof qx.core.Object){this._disposeObjects(d);
}else{this.__tX=null;
...
(function(){var cw="engine.name",cv="",cu="legacy-font-size",ct="mshtml",cs="inserthtml",cr="qx.debug",cq='color',cp="text-decoration",co=';',cn="__vV",bx="p",bw="span",bv="transparent",bu="id",bt="InsertHtml",bs='">',br="child",bq="gecko",bp="font-family",bo="text-align",cD='text-decoration',cE="BackColor",cB="FontSize",cC="/>",cz="<img ",cA="</font>",cx="backgroundPosition",cy="font-size",cF="__vW",cG='|',bV="string",bU="background-color",bX="backgroundRepeat",bW="font",ca=":",bY="='",cc=" ",cb=";",bT="body",bS="px",a="backgroundImage",b="Control",c="__paragraph__",d=':',f="qx.bom.htmlarea.HtmlArea.debug",g="size",h="' ",m="webkit",n="textDecoration",o="BODY",cS="undefined",cR="__wc",cQ="_moz",cP="top",cW="formatBlock",cV="insertParagraph",cU="li",cT='<span style="',cY="__wk",cX="no-repeat",N=' <a href="',O="FONT",L="__wp",M="|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",R="</span>",S="__placeholder__",P='font-family:',Q="<p style='",J="outdent",K="__wb",w='</a> ',v="InsertImage",y="__resetHtml",x="FontName",s="bold",r="blockquote",u="__ws",t="underline",q="style",p="qx.bom.htmlarea.manager.Command",X="'><br class='webkit-block-placeholder' />",Y="a",ba='"',bb="<span></span>",T="type",U="CreateLink",V="italic",W="__wm",bc="qx_link",bd="none",G='"></span>',F="Italic",E="fontStyle",D="__wu",C="InsertUnorderedList",B="OL",A='text-align:',z="Bold",I="ForeColor",H="url(",be='" ',bf="repeat repeat-x repeat-y no-repeat",bg='</p>',bh="<hr />",bi="__wl",bj='<font style="',bk="IMG",bl="__wt",bm='<p id="',bn="StrikeThrough",bB="LI",bA="__getHtml",bz='>',by='" size="',bF="Indent",bE="HiliteColor",bD="br",bC="fontWeight",bH="Copy",bG="__vR",bO="Paste",bP="__wo",bM="color",bN="RemoveFormat",bK="__wv",bL='',bI='style="',bJ="JustifyCenter",bQ="_moz_dirty",bR="__wn",cg="JustifyLeft",cf="JustifyRight",ci="Underline",ch="SelectAll",ck="Cut",cj="selectall",cm="line-through",cl=")",ce="href",cd='<span id="',cL="__vY",cM="UL",cN="JustifyFull",cO="Outdent",cH="indent",cI="backgroundColor",cJ="__wq",cK="InsertOrderedList";
...
this.__vJ=0;
},statics:{__vK:M,__vL:bf},members:{__kv:null,__tY:null,__vM:false,__vH:null,__vI:null,__vJ:null,setContentDocument:function(db){this.__kv=db;
},getCommandObject:function(dc){if(this._commands[dc]){return this._commands[dc];
}else{return null;
}},__uB:function(){this._commands={bold:{useBuiltin:false,identifier:z,method:u},italic:{useBuiltin:false,identifier:F,method:bl},underline:{useBuiltin:false,identifier:ci,method:D},strikethrough:{useBuiltin:false,identifier:bn,method:bK},fontfamily:{useBuiltin:true,identifier:x,method:null},fontsize:{useBuiltin:false,identifier:cB,method:cY},textcolor:{useBuiltin:true,identifier:I,method:null},textbackgroundcolor:{useBuiltin:false,identifier:null,method:bi},backgroundcolor:{useBuiltin:false,identifier:null,method:W},backgroundimage:{useBuiltin:false,identifier:null,method:bR},justifyleft:{useBuiltin:false,identifier:cg,method:cn},justifyright:{useBuiltin:false,identifier:cf,method:cn},justifycenter:{useBuiltin:false,identifier:bJ,method:cn},justifyfull:{useBuiltin:false,identifier:cN,method:cn},indent:{useBuiltin:true,identifier:bF,method:null},outdent:{useBuiltin:true,identifier:cO,method:null},copy:{useBuiltin:true,identifier:bH,method:null},cut:{useBuiltin:true,identifier:ck,method:null},paste:{useBuiltin:true,identifier:bO,method:null},insertorderedlist:{useBuiltin:false,identifier:cK,method:cF},insertunorderedlist:{useBuiltin:false,identifier:C,method:cF},inserthorizontalrule:{useBuiltin:false,identifier:bt,method:cR},insertimage:{useBuiltin:false,identifier:v,method:cL},inserthyperlink:{useBuiltin:false,identifier:U,method:K},selectall:{useBuiltin:false,identifier:ch,method:bP},selectedtext:{useBuiltin:false,identifier:null,method:L},selectedhtml:{useBuiltin:false,identifier:null,method:cJ},inserthtml:{useBuiltin:false,identifier:bt,method:bG},resethtml:{useBuiltin:false,identifier:null,method:y},gethtml:{useBuiltin:false,identifier:null,method:bA},removeformat:{useBuiltin:true,identifier:bN,method:null}};
},execute:function(dd,de){if(!this.__tY.isReady()){this.error("editor not ready! '"+dd+"':'"+de+"'");
return false;
}dd=dd.toLowerCase();
de=de!=null?de:null;
if(this._commands[dd]){var df;
var dg=this._commands[dd];
if(!((qx.core.Environment.get(cw)==m)&&(dd==cH||dd==J))){if(this.__vN()){this.__vO();
}}if(dg.useBuiltin){df=this.__vP(dg.identifier,false,de);
...
break;
}}}else if(Node.isNodeName(dh,bT)){di=true;
}}return di||!dk;
},__vO:function(){this.__vP(cW,false,bx);
},__vP:function(dl,dm,dn){try{var dr=this.__kv;
var dp=false;
var dq=this.__tY.getRange();
this.__kv.body.focus();
if((qx.core.Environment.get(cw)==ct)){if(dl!=cj){dq.select();
if(((dq.text)&&(dq.text.length>0))||((dq.length==1)&&(dq.item(0))&&(dq.item(0).tagName==bk))){dr=dq;
}else{dr=this.__kv;
}}if(((qx.core.Environment.get(cw)==ct))&&(this.__vH[dl])){if(dq.text==cv){dp=true;
}}}var ds=dr.execCommand(dl,dm,dn);

if(dp&&dq.text!=cv){dq.collapse();
}
if((qx.core.Environment.get(cr))&&qx.core.Environment.get(f)){this.debug("execCommand "+dl+" with value "+dn+" succeded");
}this.__vM=false;
}catch(dt){if((qx.core.Environment.get(cr))&&qx.core.Environment.get(f)){this.debug("execCommand "+dl+" with value "+dn+" failed");
}return false;
}return ds;
},__vQ:qx.core.Environment.select(cw,{"mshtml":function(){var dv=this.__tY;
var du=dv.getSavedRange()!=null?dv.getSavedRange():dv.getRange();
return du;
},"default":function(){return this.__tY.getRange();
}}),__vR:qx.core.Environment.select(cw,{"mshtml":function(dw,dx){var dA;
if(dw==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__vU();
}else{this.__kv.body.focus();
var dz=this.__tY.getSelection();
var dy=this.__vQ();
if(dy&&dz&&dz.type!=b){try{dy.pasteHTML(dw);
dy.collapse(false);
dy.select();
dA=true;
...
return dA;
}},"default":function(dB,dC){this.__kv.body.focus();
return this.__kv.execCommand(dC.identifier,false,dB);
}}),insertParagraphOnLinebreak:qx.core.Environment.select(cw,{"gecko":function(){var dK=this.__wf();
var dO=this.__vS(dK);
var dG=this.__wd(dK);
var dL=S+Date.parse(new Date());
var dM=c+Date.parse(new Date());
var dE=bL;
var dI=cd+dL+G;
dE+=dI;
dE+=bm+dM+be+dO+bz;
...
this.execute(cs,dE);
this.__vT();
qx.bom.element.Attribute.reset(this.__kv.getElementById(dL),bu);
var dJ=this.__kv.getElementById(dM);

if(dJ.previousSibling.innerHTML==dI){var dD=this.__we();
var dH=this.__kv.createElement(bD);
var dF=this.__kv.createAttribute(bQ);
dF.nodeValue=cv;
dH.setAttributeNode(dF);
var dN=this.__kv.createAttribute(T);
dN.nodeValue=cQ;
...
for(var dR in dP){if(dS[dR]){dQ+=dR+ca+dP[dR]+cb;
}}this.__tY.insertHtml(Q+dQ+X);
},"default":qx.lang.Function.empty}),__vS:qx.core.Environment.select(cw,{"gecko":function(dT){var dY=bI;
var dX=dT.child;
if(dX[bo]){dY+=A+dX[bo]+co;
delete dT.child[bo];
}if(dX[bp]){dY+=P+dX[bp]+co;
delete dT.child[bp];
...
for(var dV in dX){if(dW[dV]||dU[dV]){dY+=dV+d+dX[dV]+co;
delete dT.child[dV];
}}dY+=ba;
return dY;
},"default":function(){return cv;
}}),__vT:qx.core.Environment.select(cw,{"gecko":function(){var eh=this.__tY.getSelection();
...
if(qx.lang.String.startsWith(ee,c)&&ee==ei){var eg=ef.nextSibling;
var ec=this.__tY.getRange();
ec.selectNode(eg);
eh.addRange(ec);
var eb=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;
this.__tY.getCommandManager().addUndoStep(cs,eb,this.getCommandObject(cs));
this.execute(cs,eb);
var ed=this.__tY.getRange();

if(ea){while(ea&&ea.firstChild&&qx.dom.Node.isElement(ea.firstChild)){ea=ea.firstChild;
}}ed.selectNode(ea);
eh.addRange(ed);
ed.collapse(true);
}},"default":qx.lang.Function.empty}),__vU:qx.core.Environment.select(cw,{"mshtml":function(){var ej=this.__tY.getRange();
...
}}),__vV:function(ek,el){var em=(qx.core.Environment.get(cw)==ct)?this.__tY.getRange():this.__kv;
return em.execCommand(el.identifier,false,ek);
},__vW:function(en,eo){if((qx.core.Environment.get(cw)==ct)){var ep=this.__tY.getFocusNode();
this.__vX(ep);
}this.__kv.body.focus();
var eq=this.__kv.execCommand(eo.identifier,false,en);

if((qx.core.Environment.get(cw)==m)){var ep=this.__tY.getFocusNode();
this.__vX(ep.parentNode);
}return eq;
},__vX:function(er){var es=[];
...
}},__vY:qx.core.Environment.select(cw,{"gecko":function(et,eu){if(et.src){this.__kv.execCommand(eu.identifier,false,et.src);
delete et.src;
var eI=this.__tY.getSelection();
if(eI){var eH=eI.anchorNode;
var eC=eI.anchorOffset;
var ez=eH.childNodes[eC-1];
var eF;

for(var eB in et){eF=this.__kv.createAttribute(eB);
eF.nodeValue=et[eB];
...
eE=false;
}var ey=this.__kv.createDocumentFragment();
var eJ;

if(eE&&ew!=null){var eA=this.__wa(ew);
ey.appendChild(eA.root);
eJ=eA.inline;
}else{eJ=this.__kv.createElement(bw);
ey.appendChild(eJ);
}var eG=this.__kv.createTextNode(cv);
eJ.appendChild(eG);
var eD=ez.parentNode;
if(ez==eD.lastChild){eD.appendChild(ey);
}else{eD.insertBefore(ey,ez.nextSibling);
}var ev=this.__tY.getRange();
...
var eN=this.__tY.getSelection();
var eO=this.__vQ();
if(eN&&eN.type!=b){try{eO.select();
eO.pasteHTML(eQ);
eP=true;
...
return this.__kv.execCommand(bt,false,eU);
}else{return false;
}}}),__wa:function(eV){while(eV.firstChild&&eV.firstChild.nodeType==1){eV=eV.firstChild;
}var fa=this.__wf(eV);
var fe,eX,fc;
var eW=cv;
var parent=null;
...
while(fb){fd=this.__kv.createElement(fb[cu]?bW:bw);
eX=this.__kv.createAttribute(q);
fd.setAttributeNode(eX);
for(var eY in fb){if(eY!=br&&eY!=cu){eW+=eY+ca+fb[eY]+cb;
}else if(eY==cu){fc=this.__kv.createAttribute(g);
fc.nodeValue=fb[eY];
...
},__wb:qx.core.Environment.select(cw,{"gecko|opera":function(ff,fg){var fm=this.__tY.getSelection();
var fj=this.__tY.getRange();
if(fm.isCollapsed){var fi=bc+(++this.__vJ);
var fn=this.__kv.createElement(Y);
var fk=this.__kv.createAttribute(ce);
var fh=this.__kv.createAttribute(bu);
var fl=this.__kv.createTextNode(ff);
fh.nodeValue=fi;
...
fm.collapseToEnd();
return true;
}else{return this.__kv.execCommand(fg.identifier,false,ff);
...
}else{fr=this.__vR(N+fo+bs+fo+w,fp);
}this.__tY.resetSavedRange();
return fr;
}catch(e){if(qx.core.Environment.get(cr)){this.error("inserthyperlink failed!");
}return false;
}},"default":function(ft,fu){return this.__kv.execCommand(fu.identifier,false,ft);
}}),__wc:function(fv,fw){var fx=bh;
if((qx.core.Environment.get(cw)==bq)){fx+=this.__wd();
}return this.__vR(fx,fw);
},__wd:function(fy){var fC=cv;
var fB=cT;
var fA=[];
var fF=typeof fy!==cS?fy:this.__wf();
var fD=fF.child;
var fE=false;
...
for(var fz in fD){fC+=(fz!=br&&fz!=cu)?fz+d+fD[fz]+co:cv;
}fC+=fE?by+fD[cu]+bs:bs;
fA.unshift(fE?cA:R);
fD=fD.child;
}if(fA.length==1&&fA[0]==cA){fC+=bb;
}for(var i=0,j=fA.length;i<j;i++){fC+=fA[i];
}return fC;
},__we:function(){var fH=this.__kv.createDocumentFragment();
var fM=this.__wf();
var parent=fH;
var fK=fM.child;
var fI;
...
},getCurrentStyles:function(fT){if(fT==null){var fV=this.__tY.getSelection();
...
var fU=this.__wg(fY);
var fX=this.__wh(fU,fY);
return fX;
},__wg:function(ga){var gd={};
var gb,gc;
...
},__wh:function(ge,gf){var gk=gf[0];
var gi=this.__tY.getContentWindow().getComputedStyle(gk,null);
var gg;
var gj={};

for(var gh in ge){if(gh!=cu){gg=gi.getPropertyValue(gh);
}else{gg=ge[gh];
}if(gh==bU&&gg==bv){gj[gh]=this.__wj(gf);
}else if(gh==cp){gj[gh]=this.__wi(gf);
}else{gj[gh]=gg;
}}return gj;
},__wi:function(gl){var go,gq,gm;
var gp=[];
var gn=this.__tY.getContentWindow();

for(var i=0,j=gl.length;i<j;i++){gm=gn.getComputedStyle(gl[i],null);
go=gm.getPropertyValue(cp);
gq=gm.getPropertyValue(bM);
if(go!=bd){gp.push({'text-decoration':go,'color':gq});
}}return gp;
},__wj:function(gr){var gt,gs,gu;

for(var i=0;i<gr.length;i++){gt=gr[i];
gs=this.__tY.getContentWindow().getComputedStyle(gt,null);
gu=gs.getPropertyValue(bU);
if(gu!=bv){return gu;
}}},__wk:function(gv,gw){var gI=this.__tY.getSelection();
var gD=((qx.core.Environment.get(cw)==ct))?this.__tY.getRange():gD=gI.getRangeAt(0);
var gE=[];
var gH;
var gC=[B,cM];
var gx,i,j,gF;
gF=((qx.core.Environment.get(cw)==ct))?gD.parentElement():gD.commonAncestorContainer;
if(gF.tagName==o){for(var i=0;i<gC.length;i++){gx=gF.getElementsByTagName(gC[i]);
...
gH=((qx.core.Environment.get(cw)==ct))?((gz==gF)||(gF.tagName==o)):gI.containsNode(gz,false);
for(j=0;j<gz.childNodes.length;j++){var gB=gz.childNodes[j];
if(gH||(gI.focusNode.nodeValue&&qx.dom.Hierarchy.contains(gB,gI.focusNode)&&(gI.focusOffset==gI.focusNode.nodeValue.length))||(qx.dom.Hierarchy.contains(gB,gI.anchorNode)&&(gI.anchorOffset==0))||(gI.containsNode(gB,false))){gB.style.fontSize=(this.__vI[gv]||gv)+bS;
}}}}else{var gA=((qx.core.Environment.get(cw)==ct))?gF:gI.focusNode;
var gG=qx.dom.Hierarchy.getAncestors(gA);

for(i=0;i<gG.length;i++){if(gG[i].tagName==bB){if((((qx.core.Environment.get(cw)==bq))&&((gI.anchorOffset==0)&&(gI.focusNode.nodeValue&&(gI.focusOffset==gI.focusNode.nodeValue.length))&&qx.dom.Hierarchy.contains(gG[i].firstChild,gI.anchorNode)&&qx.dom.Hierarchy.contains(gG[i].lastChild,gI.focusNode)))||(((qx.core.Environment.get(cw)==ct))&&(gD.htmlText==gG[i].innerHTML))){gG[i].style.fontSize=(this.__vI[gv]||gv)+bS;
}break;
}}}if((qx.core.Environment.get(cw)==ct)){this.__kv.body.focus();
this.__tY.getRange().select();
return this.__kv.execCommand(cB,false,gv);
}else if((qx.core.Environment.get(cw)==bq)){var parent=gD.commonAncestorContainer;
if(parent.nodeType===1){var gy=parent.getElementsByTagName(bw);

for(i=0;i<gy.length;i++){if(gy[i].style.fontSize){gy[i].style.fontSize=null;
}}}}return this.__kv.execCommand(cB,false,gv);
},__wl:qx.core.Environment.select(cw,{"mshtml":function(gJ,gK){this.__kv.body.focus();
return this.__kv.execCommand(cE,false,gJ);
},"gecko|opera":function(gL,gM){this.__kv.body.focus();
return this.__kv.execCommand(bE,false,gL);
},"webkit":function(gN,gO){var gP=this.__tY.getSelection();
var gQ=this.__tY.getRange();
if(!gP||!gP.isCollapsed){this.__kv.body.focus();
this.__kv.execCommand(cE,false,gN);
...
}}gQ.setStart(gP.anchorNode,gP.anchorNode.nodeValue.charAt(gT)==cc?gT+1:gT);
...
gP.collapseToEnd();
return true;
}}}),__wm:function(gU,gV){gU=gU!=null&&typeof gU==bV?gU:bv;
qx.bom.element.Style.set(this.__kv.body,cI,gU);
return true;
},__wn:function(gW,gX){var gY,hb,ha;
...
hb=gW[1];
ha=gW[2];
}if(gY==null||typeof gY!=bV){qx.bom.element.Style.set(this.__kv.body,a,cv);
qx.bom.element.Style.set(this.__kv.body,bX,cv);
qx.bom.element.Style.set(this.__kv.body,cx,cv);
return true;
}else{if(gY.search(/^url.*\(/)==-1){gY=H+gY+cl;
}}if(hb!=null&&!qx.lang.String.contains(hc.__vL,hb)){if(qx.core.Environment.get(cr)){this.error("The value '"+hb+"' is not allowed for parameter 'repeat'. Possible values are '"+hc.__vL+"'");
}return false;
}else{hb=cX;
}
if(ha!=null){if(qx.lang.Type.isString(ha)&&!qx.lang.String.contains(hc.__vK,cG+ha+cG)){if(qx.core.Environment.get(cr)){this.error("The value '"+ha+"' is not allowed for parameter 'position'. Possible values are '"+hc.__vK+"'");
}return false;
}else{if(qx.lang.Type.isArray(ha)&&ha.length==2){ha=ha[0]+cc+ha[1];
...
}qx.bom.element.Style.set(this.__kv.body,a,gY);
qx.bom.element.Style.set(this.__kv.body,bX,hb);
qx.bom.element.Style.set(this.__kv.body,cx,ha);
return true;
},__wo:qx.core.Environment.select(cw,{"mshtml":function(hd,he){var hf=this.__kv.body.createTextRange();
hf.select();
return true;
},"default":function(hg,hh){return this.__vP(hh.identifier,false,hg);
}}),__wp:function(){return this.__tY.getSelectedText();
},__wq:function(){return this.__tY.getSelectedHtml();
},__wr:function(hi,hj){var hn=this.__tY.getFocusNode();
...
while(hl.length>0){if(Node.getName(hm)==bx||Node.getName(hm)==bT){break;
}if(hk.get(hm,hi,hk.LOCAL_MODE)==hj){hk.reset(hm,hi);
return true;
}hm=hl.shift();
}}return false;
},__ws:qx.core.Environment.select(cw,{"gecko":function(ho,hp){if(this.__wr(bC,s)){return true;
}else{return this.__vP(hp.identifier,false,ho);
}},"default":function(hq,hr){return this.__vP(hr.identifier,false,hq);
}}),__wt:qx.core.Environment.select(cw,{"gecko":function(hs,ht){if(this.__wr(E,V)){return true;
}else{return this.__vP(ht.identifier,false,hs);
}},"default":function(hu,hv){return this.__vP(hv.identifier,false,hu);
}}),__wu:qx.core.Environment.select(cw,{"gecko":function(hw,hx){if(this.__wr(n,t)){return true;
}else{return this.__vP(hx.identifier,false,hw);
}},"default":function(hy,hz){return this.__vP(hz.identifier,false,hy);
}}),__wv:qx.core.Environment.select(cw,{"gecko":function(hA,hB){if(this.__wr(n,cm)){return true;
}else{return this.__vP(hB.identifier,false,hA);
}},"default":function(hC,hD){return this.__vP(hD.identifier,false,hC);
}})},destruct:function(){this.__kv=this.__tY=this._commands=null;
this.__vH=this.__vI=null;
}});
})();
(function(){var m="engine.name",l="Command",k="mshtml",h="gecko",g="Custom",f="Content",d="Internal",c="inserthtml",b="backgroundimage",a="qx.debug",bi="backgroundcolor",bh="webkit",bg="backgroundColor",bf="mousedown",be="table",bd="backgroundImage",bc="backgroundRepeat",bb="p",ba="backgroundPosition",Y="td",t="img",u="inserthyperlink",r="mouseup",s="keypress",p="qx.bom.htmlarea.HtmlArea.debug",q="undo",n="pageup",o="b",x="control",y="shift",G="end",E="right",O="qx_link",J="__tX",U="insertunorderedlist",S="Undo",A="pagedown",X="k",W="home",V="a",z="insertorderedlist",C="y",D="justifyright",F="redo",H="insertParagraph",K="qx.bom.htmlarea.manager.UndoRedo",P="left",T="i",v="u",w="enter",B="Redo",N="insertimage",M="z",L="undoRedoState",R="down",Q="up",I="body";
...
}},members:{__uh:false,__ui:false,__uj:false,__ud:null,__uc:null,__tX:null,__kv:null,__ua:null,__ub:null,__tY:null,__ue:null,__uf:null,__ug:null,__uk:null,setContentDocument:function(bl){this.__kv=bl;
this.__tX.setContentDocument(bl);
qx.event.Registration.addListener(bl.body,s,this.__ue,this);
qx.event.Registration.addListener(bl.body,r,this.__uf,this);

if((qx.core.Environment.get(m)==k)){qx.event.Registration.addListener(bl.body,bf,this.__ug,this,true);
}},insertParagraphOnLinebreak:function(){return this.__tX.insertParagraphOnLinebreak();
},execute:function(bm,bn){var bo;
bm=bm.toLowerCase();
if(this._commands[bm]){if(this._commands[bm].passthrough){bo=this.__tX.execute(bm,bn);
}else{bo=this[bm].call(this);
}}else{if((qx.core.Environment.get(m)==k)||(qx.core.Environment.get(m)==bh)){this.__uC(bm,bn,this.__tX.getCommandObject(bm));
bo=this.__tX.execute(bm,bn);
if(!bo){this.__ua.pop();
}}else{bo=this.__tX.execute(bm,bn);

if(bo){this.__uC(bm,bn,this.__tX.getCommandObject(bm));
}}
if(bm==q&&this.__ua.length==0){this.__ui=false;
this.__uK();
}else if(bm==F&&this.__ub.length==0){this.__uh=false;
this.__uK();
}}this.__uj=false;
return bo;
},addUndoStep:function(bp,bq,br){this.__uC(bp,bq,br);
},registerHandler:function(bs,bt,bu,bv){this.__uc[bs]={undo:bt,redo:bu,context:bv};
},isUndoPossible:function(){return this.__ui;
},undo:function(){var by;

if(this.__uj){this.__uE();
}if(this.__ua.length>0){var bx=this.__ua.pop();

if(this.__ud[bx.actionType.toLowerCase()]){switch(bx.actionType){case l:by=this.__um(bx);
break;
case f:by=this.__uq(bx);
break;
case d:by=this.__up(bx);
break;
case g:by=this.__ul(bx);
break;
}}else if(this.__uc[bx.actionType]){var bw=this.__uc[bx.actionType];
...
this.__uK();
return by;
}},__ul:qx.core.Environment.select(m,{"mshtml|webkit":function(bz){var bA=this.__kv.body.innerHTML;
var bC=bz.content;
this.__kv.body.innerHTML=bC;
var bB=bz;
bB.content=bA;
this.__uG(bB);
return true;
...
switch(bD.command){case bi:bH.parameter=[bG.get(this.__kv.body,bg)];
break;
case b:bH.parameter=[bG.get(this.__kv.body,bd),bG.get(this.__kv.body,bc),bG.get(this.__kv.body,ba)];
break;
}this.__uG(bH);
if(bD.command==u){if((qx.core.Environment.get(m)==h)){var bF=O+this.__tX.__hyperLinkId;
var bE=this.__kv.getElementById(bF);

if(bE){bE.parentNode.removeChild(bE);
return true;
}else{return false;
}}}else{return this.__tX.execute(bD.command,bD.value);
}}}),__um:qx.core.Environment.select(m,{"mshtml|webkit":function(bI){},"default":function(bJ){this.__uG(bJ);

if((qx.core.Environment.get(m)==h)){if(bJ.command==c&&bJ.value==qx.bom.htmlarea.HtmlArea.EMPTY_DIV&&this.__un(c,H)){this.__uo();
}}return this.__ur();
}}),__un:function(bK,bL){if(this.__ua.length>0){var bM=this.__ua[this.__ua.length-1];
return (bM.command==bK&&bM.value==bL);
}return false;
},__uo:function(){this.__ur();

if(this.__ua.length>0){var bN=this.__ua.pop();
this.__uG(bN);
}},__up:function(bO){this.__uG(bO);
return this.__ur();
},__uq:qx.core.Environment.select(m,{"gecko":function(bP){this.__uG(bP);

try{return this.__ur();
}catch(bQ){if(qx.core.Environment.get(a)){this.error("execCommand failed! Details: "+bQ);
}}},"mshtml|webkit":function(bR){},"default":function(bS){this.__uG(bS);
return this.__ur();
}}),__ur:function(){try{return this.__kv.execCommand(S,false,null);
}catch(e){return false;
}},isRedoPossible:function(){return this.__uh;
},redo:function(){if(this.__uh){var bU;
if(this.__ub.length>0){var bV=this.__ub.pop();

if(this.__ud[bV.actionType.toLowerCase()]){switch(bV.actionType){case l:bU=this.__ut(bV);
break;
case f:bU=this.__uz(bV);
break;
case d:bU=this.__uy(bV);
break;
case g:bU=this.__us(bV);
break;
}}else if(this.__uc[bV.actionType]){var bT=this.__uc[bV.actionType];
...
}},__us:qx.core.Environment.select(m,{"mshtml|webkit":function(bW){var bX=this.__kv.body.innerHTML;
var ca=bW.content;
this.__kv.body.innerHTML=ca;
var bY=bW;
bY.content=bX;
this.__uF(bY);
return true;
},"default":function(cb){this.__uF(cb);
return this.__uA();
}}),__ut:qx.core.Environment.select(m,{"mshtml|webkit":function(cc){},"default":function(cd){this.__uF(cd);
var ce=this.__uA();

if((qx.core.Environment.get(m)==h)){if(this.__uu(c,qx.bom.htmlarea.HtmlArea.EMPTY_DIV)){var cf=this.__uv();
this.__uw();

if(cf!=null){this.__ux(cf);
}}}return ce;
}}),__uu:function(cg,ch){if(this.__ub.length>0){var ci=this.__ub[this.__ub.length-1];
return (ci.command==cg&&ci.value==ch);
}return false;
},__uv:function(){if(this.__tY==null){return null;
}var cj=this.__tY.getSelection();
...
}},__uw:function(){var cm=this.__ub.pop();
this.__uF(cm);
this.__uA();
},__ux:qx.core.Environment.select(m,{"gecko":function(cn){if(cn==this.__tY.getContentBody().lastChild){return;
}var cq=cn.firstChild;

while(cq.firstChild){cq=cq.firstChild;
}var co=this.__tY.getSelection();
var cp=this.__tY.getRange();

if(co&&cp){cp.selectNode(cq);
co.addRange(cp);
cp.collapse(true);
}},"default":qx.lang.Function.empty}),__uy:function(cr){this.__uF(cr);
return this.__uA();
},__uz:qx.core.Environment.select(m,{"mshtml|webkit":function(cs){},"default":function(ct){this.__uF(ct);
return this.__uA();
}}),__uA:function(){try{return this.__kv.execCommand(B,false,null);
}catch(e){return false;
}},__uB:function(){this._commands={undo:{passthrough:false},redo:{passthrough:false}};
this.__tX.getCommandObject(bi).customUndo=true;
this.__tX.getCommandObject(b).customUndo=true;

if((qx.core.Environment.get(m)==h)){}},__uC:qx.core.Environment.select(m,{"mshtml|webkit":function(cu,cv,cw){var cx=this.getUndoRedoObject();
cx.commandObject=cw;
cx.command=cu;
cx.value=cv;
cx.actionType=g;
cx.content=this.__kv.body.innerHTML;
this.__uD(cx);
},"default":function(cy,cz,cA){if(this.__tY==null){return;
}var cC=this.getUndoRedoObject();
cC.commandObject=cA;
cC.command=cy;
cC.value=cz;
cC.actionType=g;
var cB=this.__tY.getSelection();

if(cA.customUndo){var cD=[];

switch(cy){case bi:cD.push(qx.bom.element.Style.get(this.__kv.body,bg));
break;
case b:cD.push(qx.bom.element.Style.get(this.__kv.body,bd),qx.bom.element.Style.get(this.__kv.body,bc),qx.bom.element.Style.get(this.__kv.body,ba));
break;
...
}}),__uD:function(cE){if(this.__uj){this.__uE();
}this.__uF(cE);
this.__uh=false;
this.__ub=[];
this.__uK();
},__uE:function(){var cF=this.__ua[this.__ua.length-1];

if(cF==null||cF.actionType!=f){var cG=this.getUndoRedoObject();
cG.actionType=f;

if((qx.core.Environment.get(m)==k)||(qx.core.Environment.get(m)==bh)){cG.content=this.__uk;
cG.actionType=g;
this.__uk=null;
}this.__uF(cG);
this.__uj=false;
...
},__uF:function(cH){if((qx.core.Environment.get(a))&&qx.core.Environment.get(p)){this.debug("ADD TO UNDO STACK");
this.debug(cH.actionType+" "+cH.command+" "+cH.value);
}this.__ua.push(cH);
},__uG:function(cI){if((qx.core.Environment.get(a))&&qx.core.Environment.get(p)){this.debug("ADD TO REDO STACK");
...
case V:case o:case T:case v:case X:case C:case M:if(!cK){this.__uH();
}break;
...
}},__uI:null,_handleMouseDown:qx.core.Environment.select(m,{"mshtml":function(e){var cL=e.getOriginalTarget();

if(qx.dom.Node.isElement(cL)&&(qx.dom.Node.isNodeName(cL,t)||qx.dom.Node.isNodeName(cL,be))){this.__uI={node:cL,content:cL.outerHTML};
}else{this.__uI=null;
...
if(!cN){this.__uI=null;
return;
}var cM=cN.anchorNode;
var cO=cM.childNodes[cN.anchorOffset];
if(qx.dom.Node.isNodeName(cO,t)){if(this.__uI==null){this.__uI=cO.cloneNode(true);
}else{if(this.__uI.style.width!=cO.style.width||this.__uI.style.height!=cO.style.height){this.__uJ();
...
}if(this.__uI==null){this.__uI=cP.cloneNode(true);
}else{qx.event.Timer.once(function(){if(cP.style.width!=this.__uI.style.width||cP.style.height!=this.__uI.style.height||cP.innerHTML!=this.__uI.innerHTML){this.__uJ();
this.__uI=cP.cloneNode(true);
}},this,0);
}}else{this.__uI=null;
}},"default":function(e){var cQ=qx.bom.Event.getTarget(e);

if(this.__uI!=null){if(cQ.nodeType==1){if(cQ==this.__uI.node){if(cQ.outerHTML!=this.__uI.content){this.__uI.content=cQ.outerHTML;
this.__uJ();
}}else{for(var i=0,j=cQ.childNodes.length;i<j;i++){if(cQ.childNodes[i]==this.__uI.node){if(cQ.childNodes[i].outerHTML!=this.__uI.content){this.__uI.content=cQ.childNodes[i].outerHTML;
this.__uJ();
}}}}}else{this.__uI=null;
...
cR.actionType=d;
this.__uF(cR);
}}),__uK:function(){qx.event.Timer.once(function(e){if(this.__tY!=null){var cS={undo:this.isUndoPossible()?0:-1,redo:this.isRedoPossible()?0:-1};
this.__tY.fireDataEvent(L,cS);
}},this,200);
}},destruct:function(){try{qx.event.Registration.removeListener(this.__kv.body,s,this.__ue);
qx.event.Registration.removeListener(this.__kv,r,this.__uf);
