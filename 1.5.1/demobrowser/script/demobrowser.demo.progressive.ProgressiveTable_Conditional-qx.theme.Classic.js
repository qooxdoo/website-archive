...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Conditional-qx.theme.Classic.a419348361d2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__xT=v||s;
this.__xU=w||s;
},members:{__Li:null,__Lk:null,__Lj:null,__xR:null,__xS:null,__xT:null,__xU:null,__xV:function(x,y){if(x.align){y[h]=x.align;
}
...
}},addNumericCondition:function(z,A,B,C,D,E,F){if(!qx.lang.Array.contains(this.__Li,z)||A==null){throw new Error("Condition not recognized or value is null!");
}this.__Lj.push({condition:z,align:B,color:C,style:D,weight:E,value1:A,target:F});
},addBetweenCondition:function(G,H,I,J,K,L,M,N){if(!qx.lang.Array.contains(this.__Lk,G)||H==null||I==null){throw new Error("Condition not recognized or value1/value2 is null!");
}this.__Lj.push({condition:G,align:J,color:K,style:L,weight:M,value1:H,value2:I,target:N});
},addRegex:function(O,P,Q,R,S,T){if(!O){throw new Error("regex cannot be null!");
}this.__Lj.push({condition:o,align:P,color:Q,style:R,weight:S,regex:O,target:T});
},_getCellStyle:function(U){if(this.__Lj.length==0){return U.style||s;
}var i;
var Y;
var V;
var X={"text-align":this.__xR,"color":this.__xS,"font-style":this.__xT,"font-weight":this.__xU};

for(i=0;i<this.__Lj.length;i++){var bc=this.__Lj[i];
Y=false;

if(qx.lang.Array.contains(this.__Li,bc.condition)){if(bc.target==null){V=U.cellData;
...
}}else if(qx.lang.Array.contains(this.__Lk,bc.condition)){if(bc.target==null){V=U.cellData;
}else{V=U.element.data[bc.target];
}
...
}},destruct:function(){this.__Li=this.__Lk=this.__Lj=null;
}});
})();
