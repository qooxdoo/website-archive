...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Blocker","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Blocker-qx.theme.Simple.654a334a41c9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.bom.Blocker";
...
(function(){var l="resize",k="backgroundColor",j="px",i="zIndex",h="0px",g="mshtml",f="block",d="transparent",c="engine.name",b="div",a="qx.bom.Blocker";
qx.Class.define(a,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__bk();
},members:{__It:null,__tM:null,__Iu:null,__Iv:false,__Iw:10000,__Ix:0,__Iy:d,block:function(m){if(!this.__Iv){this.__Iu=m;
var n=this.__IB();
this.__IC(n);
this.__Iv=true;
}},unblock:function(){if(this.__Iv){this.__ID();
this.__Iv=false;
}},isBlocked:function(){return this.__Iv;
},getBlockerElement:function(){return this.__tM;
},setBlockerColor:function(o){qx.bom.element.Style.set(this.__tM,k,o);
},getBlockerColor:function(){return qx.bom.element.Style.get(this.__tM,k);
},setBlockerOpacity:function(p){qx.bom.element.Opacity.set(this.__tM,p);
},getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__tM);
},setBlockerZIndex:function(q){qx.bom.element.Style.set(this.__tM,i,q);
},getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__tM,i);
},__bk:function(){this.__Iz();

if((qx.core.Environment.get(c)==g)){this.__IA();
}qx.event.Registration.addListener(window,l,this.__jW,this);
},__Iz:function(){this.__tM=qx.bom.Element.create(b);
qx.bom.element.Style.setStyles(this.__tM,{display:f,opacity:this.__Ix,backgroundColor:this.__Iy});
this.setBlockerZIndex(this.__Iw);
},__IA:function(){this.__It=qx.bom.Iframe.create();
qx.bom.element.Attribute.set(this.__It,"allowTransparency",false);
qx.bom.element.Attribute.set(this.__It,"src","javascript:false;");
qx.bom.element.Style.setStyles(this.__It,{display:"block",opacity:this.__Ix});
},__IB:function(){var r={position:"absolute"};

if(this.__IF()){r.left="0px";
r.top="0px";
r.right=null;
r.bottom=null;
r.width=qx.bom.Document.getWidth()+"px";
r.height=qx.bom.Document.getHeight()+"px";
}else{r.width=qx.bom.element.Dimension.getWidth(this.__Iu)+"px";
r.height=qx.bom.element.Dimension.getHeight(this.__Iu)+"px";
r.left=qx.bom.element.Location.getLeft(this.__Iu)+"px";
r.top=qx.bom.element.Location.getTop(this.__Iu)+"px";
}return r;
},__IC:function(s){var t=document.body;
qx.bom.element.Style.setStyles(this.__tM,s);
qx.dom.Element.insertEnd(this.__tM,t);

if((qx.core.Environment.get("engine.name")=="mshtml")){s.zIndex=this.getBlockerZIndex()-1;
qx.bom.element.Style.setStyles(this.__It,s);
qx.dom.Element.insertEnd(this.__It,document.body);
}},__ID:function(){qx.dom.Element.remove(this.__tM);

if((qx.core.Environment.get("engine.name")=="mshtml")){qx.dom.Element.remove(this.__It);
}},__jW:function(e){if(this.__IF()){this.__IE({width:h,height:h});
qx.event.Timer.once(function(){var u={width:qx.bom.Document.getWidth()+j,height:qx.bom.Document.getHeight()+j};
this.__IE(u);
},this,0);
}},__IE:function(v){qx.bom.element.Style.setStyles(this.__tM,v);

if((qx.core.Environment.get("engine.name")=="mshtml")){qx.bom.element.Style.setStyles(this.__It,v);
}},__IF:function(){return (this.__Iu==null||qx.dom.Node.isWindow(this.__Iu)||qx.dom.Node.isDocument(this.__Iu));
}},destruct:function(){qx.event.Registration.removeListener(window,l,this.__jW,this);
this.__It=this.__tM=this.__Iu=null;
}});
})();
