...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.AutoSizeTextArea","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.AutoSizeTextArea-qx.theme.Simple.6f84614d44de.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.ui.AutoSizeTextArea";
...
q.set({allowStretchY:false,value:this.__Oh()});
p.add(s,{row:0,column:0});
p.add(q,{row:1,column:0});
s=new qx.ui.basic.Label();
s.setValue(c);
var w=new qx.ui.form.TextArea();
w.set({allowStretchY:false,value:this.__Oh(),autoSize:true});
...
t.set({allowStretchY:false,value:this.__Oh(),autoSize:true,minHeight:200});
p.add(s,{row:2,column:0});
p.add(t,{row:3,column:0});
s=new qx.ui.basic.Label();
s.setValue(n);
var r=new qx.ui.form.TextArea();
r.set({allowStretchY:false,value:this.__Oh(),autoSize:true,minHeight:200,maxHeight:300});
p.add(s,{row:2,column:1});
p.add(r,{row:3,column:1});
s=new qx.ui.basic.Label();
s.setValue(l);
var u=new qx.ui.form.TextArea();
u.set({allowStretchY:false,value:this.__Oh(),autoSize:true,minimalLineHeight:2});
...
},__Oh:function(){var y=new qx.type.Array(2);
