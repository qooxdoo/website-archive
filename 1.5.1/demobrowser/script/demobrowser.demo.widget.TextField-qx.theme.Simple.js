...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.TextField","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.TextField-qx.theme.Simple.9962dd77f167.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.widget.TextField";
...
var I=new qx.ui.container.Composite(new qx.ui.layout.HBox());
this.getRoot().add(I);
var u=new qx.ui.layout.VBox();
u.setSpacing(10);
var J=new qx.ui.container.Composite(u);
J.setPadding(20);
I.add(J);
...
J.add(x);
var A=new qx.ui.form.TextArea(f);
J.add(A);
var E=new qx.ui.form.TextArea(i);
E.setWrap(false);
J.add(E);
var H=new qx.ui.form.TextArea(n);
H.setFont(s);
J.add(H);
var C=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
C.setPadding(20);
var B=new qx.ui.form.Button(h);
B.addListener(t,function(){w.toggleLiveUpdate();
});
C.add(B);
var F=new qx.ui.form.Button(q);
var G=false;
F.addListener(t,function(){J.setEnabled(G);
G=!G;
});
C.add(F);
C.add(new qx.ui.core.Spacer(null,20));
var K=k+c;
var M=new qx.ui.basic.Label(K);
M.setRich(true);
C.add(M);
var D=new qx.ui.form.Button(m);
D.addListener(t,function(){this.debug("Sending content: "+w.getValue());
});
C.add(D);
var z=new qx.ui.form.Button(p);
z.setFocusable(false);
z.setKeepFocus(true);
z.addListener(t,function(){this.debug("Sending selection: "+w.getTextSelection());
});
C.add(z);
var L=new qx.ui.form.Button(g);
L.setFocusable(false);
L.setKeepFocus(true);
L.addListener(t,function(){this.debug("Sending selection: "+w.getTextSelectionStart());
});
C.add(L);
