...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Inline","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline-qx.theme.Classic.12d015f368d0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var u="resize",t="engine.name",s="relative",r="mshtml",q="height",p="",o="px",n="position",m="qx.debug",l="engine.version",c="qx.ui.root.Inline",k="$$widget",g="hidden",b="div",a="left",f="opera",d="appear",h="Please use a DOM element to create an inline root.";
...
qx.ui.core.queue.Layout.add(this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
if((qx.core.Environment.get(t)==f)){this.setSelectable(true);
}if((qx.core.Environment.get(t)==r)){this.setKeepFocus(true);
}var window=qx.dom.Node.getWindow(v);
qx.event.Registration.addListener(window,u,this._onWindowResize,this);
},members:{__kU:false,__kV:false,__kT:null,__kW:function(){if(this.__kU||this.__kV){var y=qx.bom.element.Dimension.getSize(this.__kT);

if(this.__kU&&y.width<1){throw new Error("The root element "+this.__kT+" of "+this+" needs a width when its width size should be used!");
}
if(this.__kV){if(y.height<1){throw new Error("The root element "+this.__kT+" of "+this+" needs a height when its height size should be used!");
}if(y.height>=1&&qx.bom.element.Style.get(this.__kT,q,3)==p){qx.bom.element.Style.set(this.__kT,q,y.height+o);
}}qx.event.Registration.addListener(this.__kT,u,this._onResize,this);
}},_createContainerElement:function(){var z=this.__kT;

if(this.__kU||this.__kV){var D=document.createElement(b);
z.appendChild(D);
if((qx.core.Environment.get(t)==r)&&qx.core.Environment.get(l)==6){var C=qx.dom.Node.getBodyElement(z);
var B;
var F;
var E=false;
...
if((H.oldWidth!==H.width)&&this.__kU||(H.oldHeight!==H.height)&&this.__kV){qx.ui.core.queue.Layout.add(this);
}},_onWindowResize:function(){if(qx.ui.popup&&qx.ui.popup.Manager){qx.ui.popup.Manager.getInstance().hideAll();
}if(qx.ui.menu&&qx.ui.menu.Manager){qx.ui.menu.Manager.getInstance().hideAll();
}},_computeSizeHint:function(){var M=this.__kU;
var J=this.__kV;
...
if(M){var L=N.getContentWidth(this.__kT);
I.width=L;
I.minWidth=L;
I.maxWidth=L;
}
if(J){var K=N.getContentHeight(this.__kT);
I.height=K;
I.minHeight=K;
I.maxHeight=K;
}return I;
}},defer:function(O,P){qx.ui.core.MLayoutHandling.remap(P);
},destruct:function(){qx.event.Registration.removeListener(this.__kT,u,this._onResize,this);
this.__kT=null;
}});
})();
