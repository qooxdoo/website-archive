...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.table.Table_Huge","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Huge-qx.theme.Simple.3dc6d3c9c50d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.table.Table_Huge";
...
(function(){var f="x",e="_tableModel",d="Cell ",c="Table",b="demobrowser.demo.table.Table_Huge",a="Column ";
qx.Class.define(b,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return c;
},COL_COUNT:50,ROW_COUNT:10000,createRandomRows:function(g){var j=[];

for(var k=0;k<g;k++){var h=[];

for(var i=0;i<this.COL_COUNT;i++){h.push(d+i+f+k);
}j.push(h);
}return j;
},createTable:function(){var m=this.createRandomRows(this.ROW_COUNT);
var l=this._tableModel=new qx.ui.table.model.Simple();
var o=[];

for(var i=0;i<this.COL_COUNT;i++){o.push(a+i);
}l.setColumns(o);
l.setData(m);
var n=new qx.ui.table.Table(l);
return n;
