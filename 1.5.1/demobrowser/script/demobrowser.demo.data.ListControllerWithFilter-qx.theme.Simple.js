...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.ListControllerWithFilter","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ListControllerWithFilter-qx.theme.Simple.31395f018b0a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.data.ListControllerWithFilter";
...
(function(){var q="execute",p="Show all numbers.",o="Write data to log",n="Add an item",m="Remove an item",l="Show only even numbers.",k="Odd / Even filter",j="Remove filter",h="<b>Filtered List</b><br/>",g="Reverse order",c="demobrowser.demo.data.ListControllerWithFilter",f="Show only odd numbers.",e="value",b="init",a="delegate",d="List showing numbered items, bound to a data array.";
...
for(var i=0;i<8;i++){B.push(i);
}var D=new qx.data.Array(B);
var v=new qx.ui.form.List();
this.getRoot().add(v,{left:10,top:80});
var y=new qx.data.controller.List(D,v);
var u={};
u.filter=function(G){return parseInt(G)%2==1;
};
var w={};
w.filter=function(H){return parseInt(H)%2==0;
};
var A=new qx.ui.basic.Label(b);
this.getRoot().add(A,{left:10,top:290});
var E={converter:function(I){if(I==w){return l;
}else if(I==u){return f;
}return p;
}};
y.bind(a,A,e,E);
var x=new qx.ui.form.Button(n);
x.setWidth(120);
this.getRoot().add(x,{left:130,top:80});
x.addListener(q,function(){D.push(D.length);
},this);
var C=new qx.ui.form.Button(m);
C.setWidth(120);
this.getRoot().add(C,{left:130,top:115});
C.addListener(q,function(){D.pop();
},this);
var z=new qx.ui.form.Button(o);
z.setWidth(120);
this.getRoot().add(z,{left:130,top:150});
z.addListener(q,function(){qx.log.appender.Console.show();
this.info(D.toString());
},this);
var s=new qx.ui.form.Button(k);
s.setWidth(120);
this.getRoot().add(s,{left:130,top:185});
s.addListener(q,function(){y.getDelegate()==u?y.setDelegate(w):y.setDelegate(u);
},this);
var r=new qx.ui.form.Button(j);
r.setWidth(120);
this.getRoot().add(r,{left:130,top:220});
r.addListener(q,function(){y.setDelegate(null);
},this);
var F=new qx.ui.form.Button(g);
F.setWidth(120);
this.getRoot().add(F,{left:130,top:255});
F.addListener(q,function(){D.reverse();
},this);
var t=new qx.ui.basic.Label();
t.setRich(true);
t.setWidth(200);
t.setValue(h+d);
this.getRoot().add(t,{left:20,top:10});
}}});
})();
