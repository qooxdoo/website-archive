...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash-qx.theme.Simple.027a46c7f440.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="execute",j="Flash Player Version",i="__OB",h="right",g="Message from Flash:",f="Simple demo with FlashVars",d="__Ig",c="__Oz",b="bgcolor",a="demobrowser.demo.widget.Flash",A="demobrowser/demo/flash/TestFlash.swf",z="demobrowser/demo/flash/FlashVersion.swf",y="No message.",x="Flash:",w="<b>qooxdoo:</b>",v="__OA",u="demobrowser.demo.widget.Flash.sendMessage",t="demobrowser.demo.widget.Flash.flashReady",s="demobrowser/demo/flash/fo_tester.swf",r="this is passed in via FlashVars",p="Two way communication (ActionScript <-> JavaScript)",q="__cu",n="Message to Flash:",o="Show Flash Player version",l="noscale",m="#FF6600";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__cu:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var B=new qx.ui.tabview.TabView();
B.setContentPadding([8,8,8,8]);
var E=this.getRoot();
E.add(B,{edge:0});
var C=new qx.ui.tabview.Page(f);
C.setLayout(new qx.ui.layout.Canvas());
C.add(this.createFlashDemo1(),{edge:0});
B.add(C);
var D=new qx.ui.tabview.Page(p);
D.setLayout(new qx.ui.layout.Canvas());
D.add(this.createFlashDemo2(),{edge:0});
B.add(D);
this.__cu=this.createWindow();
E.add(this.__cu,{top:20,left:20});
},createWindow:function(){var F=new qx.ui.window.Window(j).set({width:300,height:200,contentPadding:[0,0,0,0]});
F.setLayout(new qx.ui.layout.Canvas());
F.add(new qx.ui.embed.Flash(z),{edge:0});
return F;
},createFlashDemo1:function(){var I=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var G={flashVarText:r};
var H=new qx.ui.embed.Flash(s).set({scale:l,variables:G});
H.getContentElement().setParam(b,m);
I.add(H,{flex:1});
var J=new qx.ui.form.Button(o);
J.addListener(k,function(){this.__cu.open();
},this);
I.add(J);
return I;
},__Ig:null,__Oz:null,__OA:null,__OB:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);
var M=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
var L=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
M.add(L,{flex:1});
L.add(new qx.ui.basic.Label(w).set({rich:true}));
L.add(new qx.ui.basic.Label(g));
this.__Oz=new qx.ui.form.TextArea(y);
this.__Oz.setEnabled(false);
L.add(this.__Oz,{flex:1});
L.add(new qx.ui.basic.Label(n));
this.__OA=new qx.ui.form.TextArea("qooxdoo is the best!");
L.add(this.__OA,{flex:1});
var N=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,h));
this.__OB=new qx.ui.form.Button("Send to Flash");
this.__OB.setEnabled(false);
this.__OB.addListener(k,function(e){this.__Ig.getFlashElement().sendMessage(this.__OA.getValue());
},this);
N.add(this.__OB);
L.add(N);
var K=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
M.add(K,{flex:1});
K.add(new qx.ui.basic.Label(x).set({rich:true}));
this.__Ig=new qx.ui.embed.Flash(A);
this.__Ig.setVariables({init:t});
K.add(this.__Ig,{flex:1});
return M;
},sendMessage:function(O){this.__Oz.setValue(O);
},initFlash:function(){if(this.__Ig.getFlashElement().setup){this.__Ig.getFlashElement().setup(u);
this.__OB.setEnabled(true);
...
}}},statics:{__OC:null,setCallBackInstance:function(P){demobrowser.demo.widget.Flash.__OC=P;
},sendMessage:function(Q){demobrowser.demo.widget.Flash.__OC.sendMessage(Q);
},flashReady:function(){demobrowser.demo.widget.Flash.__OC.initFlash();
}},destruct:function(){this._disposeObjects(c,v,i,d,q);
}});
})();
...
if(bh!=d&&bh!=null&&bh!=b){if(!this.isLoaded()){if(!this.__IV){this.__IV=new Date().getTime();
}var bi=new Date().getTime()-this.__IV;
...
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(bt,bu){this.__IW(a,bt);
},_applyScale:function(bv,bw){this.__IW(X,bv);
},_applyWmode:function(bx,by){this.__IW(S,bx);
},_applyPlay:function(bz,bA){this.__IW(L,bz);
},_applyLoop:function(bB,bC){this.__IW(m,bB);
},_applyMenu:function(bD,bE){this.__IW(k,bD);
},_applyAllowScriptAccess:function(bF,bG){this.__IW(n,bF);
},_applyLiveConnect:function(bH,bI){this.__IW(v,bH);
},__IW:function(bJ,bK){this.getContentElement().setParam(bJ,bK);
qx.ui.core.queue.Layout.add(this);
}}});
})();
...
if(this.__Ig){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(c,j);
},setId:function(k){if(qx.core.Environment.get(g)){qx.core.Assert.assertString(k,f);
}
if(this.__Ig){throw new Error("The id cannot be modified after initial creation");
...
if(this.__Ig){throw new Error("The variables cannot be modified after initial creation");
}this.__Ie=l;
...
if(this.__Ig){throw new Error("The attributes cannot be modified after initial creation");
}
if(n===null||n===undefined){delete this.__If[m];
}else{this.__If[m]=n;
...
if(this.__Ig){throw new Error("The params cannot be modified after initial creation");
}
if(p===null||p===undefined){delete this.__Id[o];
}else{this.__Id[o]=p;
