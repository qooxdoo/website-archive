...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Destructor_Flash","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor_Flash-qx.theme.Modern.8b4236f9db9b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(j,{extend:qx.application.Native,members:{__cN:null,__NR:0,main:function(){qx.application.Native.prototype.main.call(this);
this.__cN=[];
...
o.start();
},clear:function(){var p=this.__cN;
...
}}}var L=this.__Im(G,H,J,K);
this._flashObjects[H.id]=L;
return L;
},destroy:qx.core.Environment.select(k,{"mshtml":function(M,N){M=this.__Ih(M);

if(M.readyState==4){this.__Ii(M);
}else{if(!N){N=window;
}qx.bom.Event.addNativeListener(N,w,function(){qx.bom.Flash.__Ii(M);
});
}},"default":function(O,P){O=this.__Ih(O);

if(O.parentNode){O.parentNode.removeChild(O);
}delete this._flashObjects[O.id];
}}),__Ih:function(Q){if(!Q){throw new Error("DOM element is null or undefined!");
}
...
},__Ii:qx.core.Environment.select(k,{"mshtml":qx.event.GlobalError.observeMethod(function(R){for(var i in R){if(typeof R[i]==b){R[i]=null;
}}
if(R.parentNode){R.parentNode.removeChild(R);
}delete this._flashObjects[R.id];
}),"default":null}),__Ij:qx.event.GlobalError.observeMethod(function(){for(var S in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[S]);
}window.__Ik=function(){};
window.__Il=function(){};
qx.bom.Event.removeNativeListener(window,e,qx.bom.Flash.__Ij);
}),__Im:qx.core.Environment.select(k,{"mshtml":function(T,U,V,W){V.movie=U.data;
delete U.data;
delete U.classid;
var X=q;
...
return be;
}})},defer:function(bf){if((qx.core.Environment.get(k)==n)){qx.bom.Event.addNativeListener(window,e,bf.__Ij);
}}});
})();
