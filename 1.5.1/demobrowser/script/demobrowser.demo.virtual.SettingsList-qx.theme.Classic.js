...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.SettingsList","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.SettingsList-qx.theme.Classic.36520de7f607.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.virtual.SettingsList";
...
(function(){var p="value",o="checked",n="name",m="label",l="group.checked",k="#ddd",j="Fruits",h="Apple",g="Carrot",f="Vegetables",b="demobrowser.demo.virtual.SettingsList",d="changeValue",c="Orange",a="Potato";
qx.Class.define(b,{extend:qx.application.Standalone,members:{__cN:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var r=[];
var s=[h,c,a,g];

for(var i=0;i<s.length;i++){r[i]={name:s[i],checked:i<2,group:null};
}this.__cN=qx.data.marshal.Json.createModel(r,true);
var t=[];

for(var i=0;i<2;i++){t[i]={name:null,checked:false};
}t=qx.data.marshal.Json.createModel(t,true);
t.getItem(0).setName(j);
t.getItem(1).setName(f);
this.__cN.toArray().forEach(function(u,v){v=v<2?0:1;
u.setGroup(t.getItem(v));
});
var q=new qx.ui.list.List();
q.setWidth(150);
this.getRoot().add(q,{left:20,top:20});
q.setDelegate(this);
q.setModel(this.__cN);
...
},configureGroupItem:function(x){x.setBackgroundColor(k);
x.setTriState(true);
x.addListener(d,function(e){if(x.getValue()===null){return;
}var y=e.getData();
this.__cN.forEach(function(z){if(x.getLabel()==z.getGroup().getName()){z.setChecked(y);
}});
},this);
},bindItem:function(A,B,C){A.bindProperty(n,m,null,B,C);
A.bindProperty(o,p,null,B,C);
A.bindPropertyReverse(o,p,null,B,C);
var D=this.__cN;
A.bindPropertyReverse(l,p,{converter:function(E,F){var H=F.getItem(C);
var J=H.getGroup();
var G=D.toArray().filter(function(L){return L.getGroup()==J;
});
var K=G.every(function(M){return M.getChecked();
});
var I=G.some(function(N){return N.getChecked();
});
if(I){return K?true:null;
}else{return false;
}}},B,C);
},bindGroupItem:function(O,P,Q){O.bindProperty(n,m,null,P,Q);
O.bindProperty(o,p,null,P,Q);
O.bindPropertyReverse(o,p,null,P,Q);
...
(function(){var w="appear",v="qx.ui.virtual.core.CellEvent",u="update",t="change",s="qx.event.type.Data",r="qx.ui.virtual.core.Pane",q="resize",p="click",o="scrollX",n="dblclick",f="contextmenu",m="qx.debug",j="cellClick",c="__yw",b="__yD",h="__yv",g="qx.event.type.Event",k="scrollY",a="__yC",l="cellDblclick",d="cellContextmenu";
qx.Class.define(r,{extend:qx.ui.core.Widget,construct:function(x,y,z,A){qx.ui.core.Widget.call(this);
this.__yv=new qx.ui.virtual.core.Axis(z,x);
this.__yw=new qx.ui.virtual.core.Axis(A,y);
this.__yx=0;
this.__yy=0;
this.__yz=0;
this.__yA=0;
...
this._add(this.__yC);
this.__yD=[];
this.__yv.addListener(t,this.fullUpdate,this);
this.__yw.addListener(t,this.fullUpdate,this);
...
for(var i=0;i<this.__yD.length;i++){var D=this.__yD[i];

if(D.isVisible()){C.push(D);
}}return C;
},getScrollMaxX:function(){var E=this.getInnerSize();

if(E){return Math.max(0,this.__yw.getTotalSize()-E.width);
}return 0;
},getScrollMaxY:function(){var F=this.getInnerSize();

if(F){return Math.max(0,this.__yv.getTotalSize()-F.height);
}return 0;
...
if(this.__yx!==G){var I=this.__yx;
this.__yx=G;
this._deferredUpdateScrollPosition();
this.fireDataEvent(k,G,I);
...
if(J!==this.__yy){var L=this.__yy;
this.__yy=J;
this._deferredUpdateScrollPosition();
...
return;
}var Q=this.__yv.getItemPosition(M);
var O=Q+this.__yv.getItemSize(M);
...
return;
}var T=this.__yw.getItemPosition(R);
var S=T+this.__yw.getItemSize(R);
...
}bc=this.__yv.getItemAtPosition(this.getScrollY()+bb-be.top);
bd=this.__yw.getItemAtPosition(this.getScrollX()+ba-be.left);
...
if(!bl){return;
}var bm=this.__yy+bl.width;
var bn=this.__yA-bm;

if(this.__yy-this.__yB.left<Math.min(this.__yy,bf)||this.__yB.right-bm<Math.min(bn,bh)){var bo=Math.min(this.__yy,bg);
var bk=Math.min(bn,bi);
this._setLayerWindow(bj,this.__yy-bo,this.__yx,bl.width+bo+bk,bl.height,false);
...
if(!bw){return;
}var bu=this.__yx+bw.height;
var bv=this.__yz-bu;

if(this.__yx-this.__yB.top<Math.min(this.__yx,bp)||this.__yB.bottom-bu<Math.min(bv,br)){var by=Math.min(this.__yx,bq);
var bx=Math.min(bv,bs);
this._setLayerWindow(bt,this.__yy,this.__yx-by,bw.width,bw.height+by+bx,false);
}},_onResize:function(){if(this.getContainerElement().getDomElement()){this.__yE=true;
this._updateScrollPosition();
this.__yE=null;
this.fireEvent(u);
}},_onAppear:function(){this.fullUpdate();
},_onClick:function(e){this.__yF(e,j);
},_onContextmenu:function(e){this.__yF(e,d);
},_onDblclick:function(e){this.__yF(e,l);
},__yF:function(e,bz){var bA=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());
...
},_setLayerWindow:function(bB,bC,top,bD,bE,bF){var bK=this.__yv.getItemAtPosition(top);

if(bK){var bM=bK.index;
var bQ=this.__yv.getItemSizes(bM,bE+bK.offset);
...
var bS=0;
var bP=0;
}var bO=this.__yw.getItemAtPosition(bC);

if(bO){var bI=bO.index;
var bH=this.__yw.getItemSizes(bI,bD+bO.offset);
...
var bR=0;
var bJ=0;
}this.__yB={top:bS,bottom:bP,left:bR,right:bJ};
this.__yC.setUserBounds(this.__yB.left-this.__yy,this.__yB.top-this.__yx,bN,bL);
this.__pe=bH;
this.__yu=bQ;

for(var i=0;i<this.__yD.length;i++){var bG=this.__yD[i];
...
if(this.__yz!==bT.height||this.__yA!==bT.width){this.__yz=bT.height;
this.__yA=bT.width;
this.fireEvent(u);
...
if(bU.length==0){this.__yG();
return;
}
if(!this.getContainerElement().getDomElement()){return ;
}var bV=this.getBounds();
this._setLayerWindow(bU,this.__yy,this.__yx,bV.width,bV.height,true);
this.__yG();
...
if(bW.length==0){this.__yG();
return;
}var bY=this.getBounds();

if(!bY){return ;
}var bX={top:this.__yx,bottom:this.__yx+bY.height,left:this.__yy,right:this.__yy+bY.width};

if(this.__yB.top<=bX.top&&this.__yB.bottom>=bX.bottom&&this.__yB.left<=bX.left&&this.__yB.right>=bX.right){this.__yC.setUserBounds(this.__yB.left-bX.left,this.__yB.top-bX.top,this.__yB.right-this.__yB.left,this.__yB.bottom-this.__yB.top);
}else{this._setLayerWindow(bW,this.__yy,this.__yx,bY.width,bY.height,false);
}this.__yG();
}},destruct:function(){this._disposeArray(b);
this._disposeObjects(h,c,a);
...
this.customSizes={};
},events:{"change":e},members:{__zc:null,getDefaultItemSize:function(){return this.defaultItemSize;
...
this.__zc=u;
return u;
},__ze:function(A){var B=this.__zc||this.__zd();
var C=0;
var E=B.length-1;
...
}},__zf:function(M){var N=this.__zc||this.__zd();
var O=0;
var Q=N.length-1;
...
}},getTotalSize:function(){var U=this.__zc||this.__zd();
...
this.__yH=[];
},properties:{anonymous:{refine:true,init:false}},events:{updated:b},members:{__yH:null,getRenderedCellWidget:function(j,k){var l=this.getColumnSizes().length;
...
}},_getSpacer:function(){var r=this.__yH.pop();
...
if(E.getUserData(g)){this.__yH.push(E);
...
if(W.getUserData(g)){this.__yH.push(W);
