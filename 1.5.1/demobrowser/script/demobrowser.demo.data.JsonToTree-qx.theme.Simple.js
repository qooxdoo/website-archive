...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.JsonToTree","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.JsonToTree-qx.theme.Simple.68c1e9675f1f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.data.JsonToTree";
...
(function(){var m="qx.debug",k="visible",j="excluded",h="qx.ui.tree.core.AbstractTreeItem",g="open",f="abstract",e="__fa",d="addItem",c="removeItem",b="Invalid child index: ",a="__nh";
...
this.__fa=[];
},properties:{parent:{check:h,nullable:true}},members:{__fa:null,__nh:null,getTree:function(){var p=this;
...
}}},getChildrenContainer:function(){if(!this.__nh){this.__nh=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?k:j});
}return this.__nh;
...
}},addAt:function(Q,R){if(qx.core.Environment.get(m)){this.assert(R<=this.__fa.length&&R>=0,b+R);
}
if(R==this.__fa.length){this.add(Q);
return;
}var V=Q.getParent();
...
}qx.lang.Array.insertAt(this.__fa,Q,R);

if(!U){this.__ni();
}
if(this.getTree()){Q.recursiveAddToWidgetQueue();
qx.ui.core.queue.Widget.add(this);
}},addBefore:function(W,X){if(qx.core.Environment.get(m)){this.assert(this.__fa.indexOf(X)>=0);
}var Y=W.getParent();

if(Y){Y.remove(W);
}this.addAt(W,this.__fa.indexOf(X));
},addAfter:function(ba,bb){if(qx.core.Environment.get(m)){this.assert(this.__fa.indexOf(bb)>=0);
}var bc=ba.getParent();

if(bc){bc.remove(ba);
}this.addAt(ba,this.__fa.indexOf(bb)+1);
},addAtBegin:function(bd){this.addAt(bd,0);
},remove:function(be){for(var i=0,l=arguments.length;i<l;i++){var bi=arguments[i];

if(this.__fa.indexOf(bi)==-1){this.warn("Cannot remove treeitem '"+bi+"'. It is not a child of this tree item.");
return;
...
}}qx.lang.Array.remove(this.__fa,bi);
bi.setParent(null);
bf.remove(bi);
}var bg=this.getTree();
...
},removeAt:function(bj){var bk=this.__fa[bj];

if(bk){this.remove(bk);
}},removeAll:function(){var bl=this.__fa.concat();
...
}},properties:{model:{check:p,apply:d,event:r,nullable:true,dereference:true},target:{apply:k,event:c,init:null,nullable:true,dereference:true},childPath:{check:t,apply:b,nullable:true},labelPath:{check:t,apply:o,nullable:true},iconPath:{check:t,apply:h,nullable:true},labelOptions:{apply:g,nullable:true},iconOptions:{apply:a,nullable:true},delegate:{apply:q,init:null,nullable:true}},members:{__Cj:null,__bl:null,__zY:null,__Ck:null,_applyDelegate:function(y,z){this._setConfigureItem(y,z);
this._setCreateItem(y,z);
this._setBindItem(y,z);
},_applyIconOptions:function(A,B){this.__Ak();
},_applyLabelOptions:function(C,D){this.__Ak();
},_applyTarget:function(E,F){if(F!=undefined){this.__Cp(F);
}if(this.getModel()!=null){this.__Cn();
}this._addChangeTargetListener(E,F);
},_applyModel:function(G,H){this.__Cn();
},_applyChildPath:function(I,J){this.__Ck=J;
this.__Cn();
this.__Ck=null;
},_applyIconPath:function(K,L){this.__Ak();
},_applyLabelPath:function(M,N){this.__Cn();
},__Cl:function(O){var Q=O.getTarget();
var P=this.__Cj[Q.toHashCode()].treeNode;
var R=this.__Cj[Q.toHashCode()].modelNode;
this.__Co(P,R);
this._updateSelection();
},__Cm:function(e){var Y=e.getData();
var U=e.getOldData();
var V=this.__Cj[U.toHashCode()];
U.removeListenerById(V.changeListenerId);
delete this.__Cj[U.toHashCode()];
...
var S=X.event;
var W=ba.addListener(S,this.__Cm,this);
var T=V.treeNode;
this.__Cj[Y.toHashCode()]={modelNode:ba,treeNode:T,changeListenerId:V.changeListenerId,changeChildernListenerId:W};
this.__Co(T,ba);
this._updateSelection();
...
},__Cn:function(){if(this.getTarget()==null||this.getChildPath()==null){return;
...
this.__yq(this.getModel(),bd);
this.__Co(bd,this.getModel());
}},__Co:function(be,bf){if(bf[s+qx.lang.String.firstUp(this.getChildPath())]==undefined){return;
}var bo=bf[s+qx.lang.String.firstUp(this.getChildPath())]();
if(this.__Cj[bo.toHashCode()]==undefined){var bj=bo.addListener(m,this.__Cl,this);
var bn=qx.Class.getPropertyDefinition(bf.constructor,this.getChildPath());
var bk=bn.event;
var bl=bf.addListener(bk,this.__Cm,this);
this.__Cj[bo.toHashCode()]={modelNode:bf,treeNode:be,changeListenerId:bj,changeChildernListenerId:bl};
...
be.addAt(bm,i);
this.__yq(bo.getItem(i),bm);
this.__Co(bm,bo.getItem(i));
}}}for(var i=be.getChildren().length-1;i>=bo.length;i--){var bi=be.getChildren()[i];
this.__Cr(bi,be);
}},__Cp:function(bq){if(bq==null){bq=this.getTarget();
}if(bq==null){return;
}var bs=bq.getRoot();
...
this.__Cj={};
}},__Cq:function(bt){var bu=bt.getChildren()||[];
for(var i=bu.length-1;i>=0;i--){if(bu[i].getChildren().length>0){this.__Cq(bu[i]);
}this.__Cr(bu[i],bt);
}},__Cr:function(bv,bw){var by=bv.getModel();
var bA=this.__Ck||this.getChildPath();
var bB=s+qx.lang.String.firstUp(bA);
if(by[bB]!=undefined){var bz=by[bB]();
var bx=this.__Cj[bz.toHashCode()];
bz.removeListenerById(bx.changeListenerId);
by.removeListenerById(bx.changeChildernListenerId);
this.__Cq(bv);
delete this.__Cj[bz.toHashCode()];
}this.__rP(by);
bw.remove(bv);
bv.destroy();
},bindProperty:function(bC,bD,bE,bF,bG){var bI=bG.bind(bC,bF,bD,bE);
if(this.__bl[bD]==null){this.__bl[bD]={};
}var bH=this.__bl[bD];
...
}if(!qx.lang.Array.contains(this.__zY,bD)){this.__zY.push(bD);
}},bindPropertyReverse:function(bJ,bK,bL,bM,bN){var bP=bM.bind(bK,bN,bJ,bL);
if(this.__bl[bK]==null){this.__bl[bK]={};
}var bO=this.__bl[bK];
...
}if(!qx.lang.Array.contains(this.__zY,bK)){this.__zY.push(bK);
...
}},__Ak:function(){var bT;

for(var bV in this.__bl){bT=bV;
break;
}for(var bS in this.__bl[bT]){var bW=this.__bl[bT][bS].treeNode;
var bU=qx.core.ObjectRegistry.fromHashCode(bS);
this.__rP(bU);
this.__yq(bU,bW);
}},__yq:function(bX,bY){var ca=this.getDelegate();
if(ca!=null&&ca.bindItem!=null){ca.bindItem(this,bY,bX);
}else{this.bindDefaultProperties(bY,bX);
}},__rP:function(cb){for(var i=0;i<this.__zY.length;i++){var cd=this.__zY[i];
var cc=this.__bl[cd][cb.toHashCode()];
...
cc.reverseId=null;
}delete this.__bl[cd][cb.toHashCode()];
...
this.setModel(null);
this.__bl=this.__Cj=this.__zY=null;
}});
})();
