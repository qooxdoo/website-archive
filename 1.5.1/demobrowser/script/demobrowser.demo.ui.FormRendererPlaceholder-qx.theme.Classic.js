...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.FormRendererPlaceholder","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererPlaceholder-qx.theme.Classic.b1daa49df968.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.ui.FormRendererPlaceholder",b="os.name",a="engine.version";
...
},properties:{wrap:{check:d,init:true,apply:x},appearance:{refine:true,init:g},singleStep:{check:c,init:20},minimalLineHeight:{check:c,apply:v,init:4},autoSize:{check:d,apply:r,init:false}},members:{__xD:null,__xE:null,__xF:null,setValue:function(D){D=qx.ui.form.AbstractField.prototype.setValue.call(this,D);
this.__xG();
return D;
...
if(F!=scrollY){e.stop();
}},__xG:function(){if(this.isAutoSize()){var I=this.__xH();

if(I){this.__xF=this.__xF||this._getAreaHeight();
...
},_setAreaHeight:function(L){if(this._getAreaHeight()!==L){this.__xE=L;
qx.ui.core.queue.Layout.add(this);
qx.ui.core.queue.Manager.flush();
this.__xK();
}},_getScrolledAreaHeight:function(){var N=this.__xH();
...
this.__xJ(P);
return P;
},__xJ:function(S){S=S.getDomElement();
...
},_applyAutoSize:function(V,W){if(qx.core.Environment.get(z)){this.__xL();
}
if(V){this.__xG();
...
if(qx.core.Environment.get(z)){this.__xL();
}
if(X===this.getMaxHeight()){this.__xG();
...
if(this.isAutoSize()){bb.height=this.__xE||bb.height;
}return bb;
}}});
})();
...
qx.Class.define(b,{statics:{__ms:/\s+/g,__mt:/^\s+|\s+$/g,add:qx.lang.Object.select(qx.core.Environment.get(t)?r:s,{"native":function(u,name){u.classList.add(name);
return name;
...
return N.className=N.className.replace(P,q).replace(this.__mt,q).replace(this.__ms,p);
...
if(w&&w.nodeType){return this.__xv([w]);
}else{return w;
}}return null;
};
};
...
},__xr:/^[^<]*(<(.|\s)+>)[^>]*$|^#([\w-]+)$/,create:function(G,H){var J=qx.bom.Collection;
if(G.nodeType){return new J(G);
}else if(typeof G==="string"){var I=J.__xr.exec(G);
...
},__xt:/^.[^:#\[\.,]*$/,not:function(ba){if(this.__xt.test(ba)){var bb=qx.bom.Selector.matches(":not("+ba+")",this);
return this.__xv(bb);
...
return this.__xv(qx.lang.Array.unique(bl));
...
if(this.length===1){return this.__xv(bs.query(bq,this[0]));
}else{var br=[];

for(var i=0,l=this.length;i<l;i++){br.push.apply(br,bs.query(bq,this[i]));
}return this.__xv(qx.lang.Array.unique(br));
...
},nextAll:function(bw){return this.__xu("getNextSiblings",bw);
...
},prevAll:function(bA){return this.__xu("getPreviousSiblings",bA);
...
},parents:function(bD){return this.__xu("getAncestors",bD);
},siblings:function(bE){return this.__xu("getSiblings",bE);
},__xu:function(bF,bG){var bI=[];
...
},__xv:function(bK){var bL=new qx.bom.Collection;
bL.__xs=this;
...
},__xw:function(bM,bN){var bS=this[0];
...
},__xx:function(bX,bY){var cb=qx.bom.Selector;
...
},append:function(ce){return this.__xw(arguments,this.__xy);
},prepend:function(cf){return this.__xw(arguments,this.__xz);
},__xy:function(cg,ch){cg.appendChild(ch);
},__xz:function(ci,cj){ci.insertBefore(cj,ci.firstChild);
},appendTo:function(ck){return this.__xx(arguments,"append");
},prependTo:function(cl){return this.__xx(arguments,"prepend");
},before:function(cm){return this.__xw(arguments,this.__xA);
},after:function(cn){return this.__xw(arguments,this.__xB);
},__xA:function(co,cp){co.parentNode.insertBefore(cp,co);
},__xB:function(cq,cr){cq.parentNode.insertBefore(cr,cq.nextSibling);
},insertBefore:function(cs){return this.__xx(arguments,"before");
},insertAfter:function(ct){return this.__xx(arguments,"after");
...
}cu.map(this.__xC).append(this);
}return this;
},__xC:function(cw){while(cw.firstChild){cw=cw.firstChild;
}return cw;
...
},replaceAll:function(cz){return this.__xx(arguments,"replaceWith");
