...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.CellEvents","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents-qx.theme.Modern.58f3f3cd9dce.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.virtual.CellEvents";
...
(function(){var n='</p>',m=' / ',l="logger",k='<p style="color:green;">You clicked on cell ',j="",i="cellClick",h='<p style="color:yellow;">You rightclicked cell ',g='<p style="color:red;">You double clicked cell ',f="demobrowser.demo.virtual.CellEvents",d="main",a="cellDblclick",c="cellContextmenu",b="layer";
...
var p=new qx.ui.virtual.core.Scroller(20,20,40,40).set({width:400,height:300});
this.layer=new qx.test.ui.virtual.layer.LayerSimple(this);
var o=p.getPane();
o.addListener(i,this._onCellClick,this);
o.addListener(c,this._onContextMenu,this);
o.addListener(a,this._onDblclickPane,this);
o.addLayer(this.layer);
this.logger=new qx.ui.embed.Html().set({width:400,height:300,html:j,decorator:d});
this.getRoot().add(p,{left:20,top:10});
this.getRoot().add(this.logger,{left:450,top:10});
},_onCellClick:function(e){var q=k+e.getRow()+m+e.getColumn()+n;
this.__Om(q);
},_onContextMenu:function(e){var r=h+e.getRow()+m+e.getColumn()+n;
this.__Om(r);
},_onDblclickPane:function(e){var s=g+e.getRow()+m+e.getColumn()+n;
this.__Om(s);
},__Om:function(t){this.logger.setHtml(this.logger.getHtml()+t);
}},destruct:function(){this._disposeObjects(b,l);
}});
})();
...
(function(){var l="px;",k="",j=" / ",i="top:",h="<div style='position:absolute;",g="width:",f="height:",e="'>",d="qx.test.ui.virtual.layer.LayerSimple",c="</div>",a="left:",b="html";
qx.Class.define(d,{extend:qx.ui.virtual.layer.Abstract,members:{getCellHtml:function(m,n,o,top,p,q){var content=m+j+n;
return [h,a,o,l,i,top,l,g,p,l,f,q,l,e,content,c].join(k);
},_fullUpdate:function(r,s,t,u){var z=[];
var A=0;
var top=0;
var C=r;
var B=s;

for(var x=0;x<t.length;x++){var A=0;
var B=s;
var v=t[x];

for(var y=0;y<u.length;y++){var w=u[y];
z[z.length]=this.getCellHtml(C,B,A,top,w,v);
B++;
A+=w;
}top+=v;
C++;
}this.getContentElement().setAttribute(b,z.join(k));
}}});
})();
