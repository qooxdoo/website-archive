...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.SingleValueBinding","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SingleValueBinding-qx.theme.Classic.d668691803c6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.data.SingleValueBinding",b="engine.version",a="os.name";
...
(function(){var q="qx.data.Array",p="demobrowser.demo.data.model.Node",o="String",n="changeNames",m="changeName",l="- ",k="",j="changeChild",h="changeColor",g="Marge",c="AFFE",f="Homer",e="\n",b="__MY",a="changeName2",d="changeChildren";
qx.Class.define(p,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.setChildren(new qx.data.Array());
},properties:{children:{check:q,event:d},child:{check:p,event:j,nullable:true},names:{check:q,event:n,init:new qx.data.Array(f,g)},name:{check:o,init:c,event:m},name2:{check:o,event:a},number:{init:10,validate:b},color:{event:h,nullable:true}},members:{__MY:function(r){if(!isNaN(parseFloat(r))){if(/^\d+$/.test(r)){return;
...
for(var i=0;i<s;i++){t+=l;
}t+=this.getName();

for(var i=0;i<this.getChildren().length;i++){t+=e+this.getChildren().getItem(i).toString(s+1);
}return t;
}}});
})();
