...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Spacer_HBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Spacer_HBox-qx.theme.Modern.b28b1678a764.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.layout.Spacer_HBox";
...
(function(){var g="main",f="green",e="yellow",d="top",c="bottom",b="middle",a="demobrowser.demo.layout.Spacer_HBox";
...
var h=this.getRoot();
h.add(this.getSpacerWithoutFlex(),{left:10,top:10});
h.add(this.getSpacerWithFlex(),{left:10,top:70});
h.add(this.getAddRemoveSpacer(),{left:10,top:200});
},getSpacerWithoutFlex:function(){var i=new qx.ui.container.Composite().set({decorator:g,backgroundColor:e,allowGrowX:false});
var j=new qx.ui.layout.HBox();
j.setSpacing(5);
i.setLayout(j);
i.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}));
i.add(new qx.ui.core.Spacer(30,40));
i.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}));
i.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}));
return i;
},getSpacerWithFlex:function(){var k=new qx.ui.container.Composite().set({decorator:g,backgroundColor:e,height:100,width:400});
var l=new qx.ui.layout.HBox();
l.setSpacing(5);
k.setLayout(l);
k.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:d}));
k.add(new qx.ui.core.Spacer(30,40),{flex:1});
k.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:b}));
k.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:c}));
return k;
},getAddRemoveSpacer:function(){var m=new qx.ui.container.Composite().set({decorator:g,backgroundColor:e});
var o=new qx.ui.layout.HBox();
o.setSpacing(5);
m.setLayout(o);
m.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:d}));
m.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:b}));
var n=new qx.ui.core.Spacer(30,40);
m.add(n,{flex:1});
m.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:c}));
m.remove(n);
return m;
}}});
})();
