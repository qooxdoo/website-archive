...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.ElementResize-qx.theme.Simple.a6da2e813afc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="resize",d="interval",c="__iY",b="body",a="qx.event.handler.ElementResize";
qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);
this.__eD=g;
this.__kX={};
this.__iY=new qx.event.Timer(200);
this.__iY.addListener(d,this._onInterval,this);
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__kX:null,__eD:null,__iY:null,canHandleEvent:function(h,i){return h.tagName.toLowerCase()!==b;
...
if(qx.lang.Object.isEmpty(r)){this.__iY.stop();
}}},_onInterval:function(e){var u=this.__kX;
...
y.width=w;
y.height=v;
}}}},destruct:function(){this.__eD=this.__kX=null;
