...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Destructor","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor-qx.theme.Classic.bf326bc31bfe.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var e="Window: ",d="interval",c="Label: ",b="__iY",a="demobrowser.demo.test.Destructor";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__cN:null,__NQ:0,__iY:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__cN=[];
this.currentTest=this.testWindows;
this.__iY=new qx.event.Timer(1000);
this.__iY.addListener(d,this.runTest,this);
this.__iY.start();
},runTest:function(){this.__NQ++;
var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__NQ+" (Registry: "+g+")");
this.currentTest();
...
},testLabels:function(){for(var i=0;i<250;i++){var h=new qx.ui.basic.Label(c+i);
