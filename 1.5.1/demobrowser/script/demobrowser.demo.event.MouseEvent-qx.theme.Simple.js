...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.MouseEvent","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent-qx.theme.Simple.5b1958034a77.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.event.MouseEvent";
...
}},_initLogger:function(n,o,p){this.__Nb=e+n.join(h)+k;
this.__Nc=p||50;
this.__Nd=o;
this._clearLog();
},_clearLog:function(){this.__Nd.innerHTML=this.__Nb+l;
this.__Ne=[];
},_log:function(q){this.__Ne.unshift(q);
this.__Ne=this.__Ne.slice(0,this.__Nc);
var r=[this.__Nb];

for(var i=0;i<this.__Ne.length;i++){r.push(d,this.__Ne[i].join(f),a);
}r.push(l);
this.__Nd.innerHTML=r.join(g);
this.__Nd.scrollTop=0;
},__Nb:null,__Nc:null,__Nd:null,__Ne:null},destruct:function(){this.__Nd=this.__Ne=null;
}});
})();
...
}qx.bom.Element.addListener(G,k,this.__Nf,this);
...
},__Nf:function(e){var K=e.getTarget().id.split(x)[1];
