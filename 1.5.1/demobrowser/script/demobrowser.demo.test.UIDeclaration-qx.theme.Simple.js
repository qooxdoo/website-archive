...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.UIDeclaration-qx.theme.Simple.44ae8b204a6c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__Ai(D,C);
},__Ai:function(E,F){var G=new F.clazz();
...
}}},__Oa:function(L,M){if(M.type===j){L.addGroupHeader(M.label);
return;
