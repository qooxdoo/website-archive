...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.ModelDebugging","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ModelDebugging-qx.theme.Classic.a4fa68800983.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Bootstrap.define(b,{construct:function(){this.__sN();
...
},members:{readyState:null,status:null,statusText:null,timeout:null,__sI:null,open:function(m,n){if(this.__sL){return;
}this.__sN();
this.__sJ=null;
this.__sK=n;
...
},setRequestHeader:function(o,p){if(this.__sL){return;
}var q={};

if(this.readyState!==1){throw new Error("Invalid state");
}q[o]=p;
this.__sK=qx.util.Uri.appendParamsToUrl(this.__sK,q);
},send:function(){if(this.__sL){return;
}var t=this.__sS(),r=this.__sH,s=this;
...
window.setTimeout(function(){s.__sO(2);
s.__sO(3);
});
...
this.__sT();
this.onabort();
},onreadystatechange:function(){},onload:function(){},onloadend:function(){},onerror:function(){},onabort:function(){},ontimeout:function(){},getResponseHeader:function(u){if(this.__sL){return;
}
...
this.__sI=v;
},dispose:function(){var w=this.__sM;

if(!this.__sL){if(w){w.onload=w.onreadystatechange=null;
this.__sT();
}
...
}},_onNativeLoad:function(){var z=this.__sM,x=this.__sI,y=this;
if(this.__sJ){return;
...
if(this.__eA){window.clearTimeout(this.__eA);
}window.setTimeout(function(){y.__sP();
y.__sO(4);
y.onload();
y.onloadend();
});
...
this.onerror();
this.onloadend();
},__sM:null,__sH:null,__sK:i,__sE:null,__sF:null,__sG:null,__eA:null,__sJ:null,__sL:null,__sN:function(){this.readyState=0;
this.status=0;
this.statusText=i;
},__sO:function(A){this.readyState=A;
this.onreadystatechange();
...
},__sR:function(){var C=qx.core.Environment.get(k)===j&&qx.core.Environment.get(h)<9;
var B=qx.core.Environment.get(k)===d;
return !(C||B);
},__sS:function(){var D=this.__sM=document.createElement(e);
D.src=this.__sK;
D.onerror=this.__sF;
D.onload=this.__sE;
if(qx.core.Environment.get(k)===j&&qx.core.Environment.get(h)<9){D.onreadystatechange=this.__sE;
}return D;
},__sT:function(){var E=this.__sM;

if(E&&E.parentNode){this.__sH.removeChild(E);
...
this.__tI();
},members:{responseJson:null,__co:null,__tC:null,__tD:null,__tE:null,__tF:null,__sL:null,open:function(k,l){if(this.__sL){return;
}var m={},o,n,p=this;
this.responseJson=null;
this.__tE=false;
o=this.__tC||h;
n=this.__tD||a+this.__co+b;
if(!this.__tD){this.constructor[this.__co]=this;
}else{if(!window[this.__tD]){this.__tF=true;
window[this.__tD]=function(q){p.callback(q);
};
}else{if(qx.core.Environment.get(j)){qx.log.Logger.debug(qx.bom.request.Jsonp,"Callback "+this.__tD+" already exists");
}}}
...
this.__tH(g,[k,l]);
},callback:function(r){if(this.__sL){return;
}this.__tE=true;
...
this.__tG();
},setCallbackParam:function(s){this.__tC=s;
...
this.__tF=false;
}},__tH:function(t,u){qx.bom.request.Script.prototype[t].apply(this,u||[]);
},__tI:function(){this.__co=(new Date().valueOf())+(e+Math.random()).substring(2,5);
}}});
})();
...
this.__LF=qx.core.ObjectRegistry.getNextHash();
},"default":qx.lang.Function.empty}),stopDisposeProfiling:qx.core.Environment.select(f,{"true":function(br){if(!this.__LF){qx.log.Logger.error("Call "+this.classname+".startDisposeProfiling first.");
return [];
...
for(var bs=this.__LF;bs<bu;bs++){var bv=qx.core.ObjectRegistry.fromHashCode(bs+bw);
