...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.WebStorage","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.WebStorage-qx.theme.Classic.c6e5272ee1d6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.bom.WebStorage";
...
(function(){var j="click",i="",h="demobrowser.demo.bom.WebStorage",g="Save",f="value",d="Clear",c="changeSelection",b="Remove",a="key";
...
var k=new qx.ui.form.TextField(a);
var p=new qx.ui.form.TextField(f);
var r=new qx.ui.form.Button(g);
var n=new qx.ui.form.Button(d);
var q=new qx.ui.form.Button(b);
var o=new qx.ui.form.List();
o.set({height:280,width:245});
l.add(k,{left:20,top:20});
l.add(p,{left:120,top:20});
l.add(r,{left:220,top:18});
l.add(o,{left:20,top:50});
l.add(q,{left:20,top:330});
l.add(n,{left:220,top:330});
var s=qx.bom.storage.Local.getInstance();
r.addListener(j,function(){var u=k.getValue();
var t=p.getValue();
s.setItem(u,t);

if(!o.findItem(u)){o.add(new qx.ui.form.ListItem(u));
}k.setValue(i);
p.setValue(i);
o.resetSelection();
k.focus();
},this);
q.addListener(j,function(){var v=o.getSelection()[0];

if(v){s.removeItem(v);
o.remove(v);
}},this);
n.addListener(j,function(){s.clear();
o.removeAll();
},this);
o.addListener(c,function(e){var x=e.getData();
var w=x[0];

if(w){var z=w.getLabel();
var y=s.getItem(z);
k.setValue(z);
p.setValue(y);
}});
...
(function(){var j="storage",h="mshtml",g="engine.name",f="browser.documentmode",d="abstract",c="qx.bom.storage.Abstract",b="Storage",a="qx.event.type.Data";
