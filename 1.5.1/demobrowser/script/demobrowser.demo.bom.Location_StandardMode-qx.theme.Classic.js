...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Location_StandardMode","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Location_StandardMode-qx.theme.Classic.eba2d8ca52cd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.bom.Location_StandardMode";
...
(function(){var p="px",o="moveable",n="borderBottomWidth",m="list",k='#',j="css.boxmodel",h="mode",g="borderTopWidth",f="borderLeftWidth",e="a",b="border",d="div",c="borderRightWidth",a="demobrowser.demo.bom.Location_StandardMode";
qx.Class.define(a,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
var q=document.getElementById(m).getElementsByTagName(e);

for(var i=0,l=q.length;i<l;i++){q[i].onclick=demobrowser.demo.bom.Location_StandardMode.jump;
}}},statics:{jump:function(event){if(!event){event=window.event;
}event.returnValue=false;

if(event.preventDefault){event.preventDefault();
}function r(w,x){return parseInt(qx.bom.element.Style.get(w,x,qx.bom.element.Style.COMPUTED_MODE,false),10);
}var t=this.href;
var v=t.substr(t.indexOf(k)+1);
var s=document.getElementById(v);
var location=qx.bom.element.Location.get(s,document.getElementById(h).value);
var u=document.getElementById(o);
u.style.left=location.left+p;
u.style.top=location.top+p;

if(qx.core.Environment.get(j)==b){u.style.width=(location.right-location.left)+p;
u.style.height=(location.bottom-location.top)+p;
}else{u.style.width=(location.right-location.left-r(u,f)-r(u,c))+p;
u.style.height=(location.bottom-location.top-r(u,g)-r(u,n))+p;
}return false;
},randomize:function(){var y=document.body.getElementsByTagName(d);

for(var i=0,l=y.length;i<l;i++){if(y[i].id&&y[i].id!=o){y[i].style.margin=Math.round(Math.random()*10)+p;
y[i].style.padding=Math.round(Math.random()*10)+p;
y[i].style.borderWidth=Math.round(Math.random()*10)+p;
}}}}});
})();
