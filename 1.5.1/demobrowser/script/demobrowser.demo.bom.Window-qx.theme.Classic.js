...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Window","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window-qx.theme.Classic.254c206ad55b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="click",l="button",k="Open Native Window",j="Open Native Modal Window",i="demobrowser.demo.bom.Window",h="Modal Window closed?",g="window1",f="Window closed?",d="Open Faked Native Modal Window",c="window3",a="window2",b="#eee";
qx.Class.define(i,{extend:qx.application.Native,members:{__AB:null,main:function(){qx.application.Native.prototype.main.call(this);
var n=qx.util.ResourceManager.getInstance();
this.__AB=["http://qooxdoo.org","http://sourceforge.net","http://slashdot.org",n.toUri("demobrowser/demo/html/ModalWindow.html")];
var q=qx.bom.Input.create(l);
qx.bom.Input.setValue(q,k);
document.body.appendChild(q);
qx.event.Registration.addListener(q,m,function(e){var t={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};
this.window1=qx.bom.Window.open(this.__AB[0],g,t);
},this);
var p=qx.bom.Input.create(l);
qx.bom.Input.setValue(p,f);
document.body.appendChild(p);
qx.event.Registration.addListener(p,m,function(e){alert(qx.bom.Window.isClosed(this.window1));
},this);
var o=qx.bom.Input.create(l);
qx.bom.Input.setValue(o,j);
document.body.appendChild(o);
qx.event.Registration.addListener(o,m,function(e){var u={width:400,height:200,top:200,left:100,scrollbars:false};
this.window2=qx.bom.Window.open(this.__AB[3],a,u,true);
},this);
var s=qx.bom.Input.create(l);
qx.bom.Input.setValue(s,h);
document.body.appendChild(s);
qx.event.Registration.addListener(s,m,function(e){alert(qx.bom.Window.isClosed(this.window2));
},this);
var r=qx.bom.Input.create(l);
qx.bom.Input.setValue(r,d);
document.body.appendChild(r);
qx.event.Registration.addListener(r,m,function(e){var w={width:800,height:600,top:200,left:100,scrollbars:false};
var v=qx.bom.Window.getBlocker();
v.setBlockerColor(b);
v.setBlockerOpacity(0.5);
this.window3=qx.bom.Window.open(this.__AB[0],c,w,true,false);
},this);
...
qx.Class.define(m,{statics:{__jP:null,__In:null,__iY:null,__Io:{"top":f,left:d,width:k,height:q,scrollbars:a,resizable:s},__Ip:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Iq:function(){return window.showModalDialog!=null;
...
if(x==null){x=true;
}var z=this.__Ir(v,w&&x);

if(w){if(this.__Iq()&&x){C=window.showModalDialog(u,[window.self],z);
}else{this.getBlocker().block();

if(this.__iY==null){this.__iY=new qx.event.Timer(500);
this.__iY.addListener(l,this.__Is,this);
}this.__In=window.open(u,name,z);
this.__iY.restart();
C=this.__In;
...
},__Ir:function(D,E){var F;
var I;
var G=[];

if(E&&this.__Iq()){for(var H in D){if(qx.bom.Window.__Io[H]){var J=n;

if(H!=h&&H!=s){J=j;
}I=qx.bom.Window.__Io[H]+c+D[H]+J;
G.push(I);
}else{qx.log.Logger.warn("Option '"+H+"' is not supported for modal windows.");
}}F=G.join(b);
}else{for(var H in D){if(qx.bom.Window.__Ip[H]){if(qx.lang.Type.isBoolean(D[H])){I=H+r+(D[H]?o:p);
}else{I=H+r+D[H];
}G.push(I);
}else{qx.log.Logger.warn("Option '"+H+"' is not supported for native windows.");
}}F=G.join(i);
}return F;
},__Is:function(){if(this.isClosed(this.__In)){this.getBlocker().unblock();
this.__iY.stop();
}},getBlocker:function(){if(this.__jP==null){this.__jP=new qx.bom.Blocker;
}return this.__jP;
