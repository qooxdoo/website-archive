...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SplitPane-qx.theme.Simple.4fe25814e1ac.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var w="value",v="horizontal",u="first",t="second",s="both",r="main",q="offset",p="Show first pane",o="demobrowser.demo.widget.SplitPane",n="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",f="Show both panes",m="Toggle Splitpane Orientation",j="Offset (",c="Show second pane",b="_container2",h="vertical",g="__zg",k="):",a="changeSelection",l="_container1",d="execute";
qx.Class.define(o,{extend:qx.application.Standalone,members:{__zg:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
var L=new qx.ui.form.RadioButton(c);
...
},_toggle:function(){var O=this.__zg.getOrientation();
this.__zg.setOrientation(O==v?h:v);
...
this._container2.show();
}},__OJ:function(){var ba=new qx.ui.tree.Tree();
...
bf.add(be);
return ba;
}},destruct:function(){this._disposeObjects(g,l,b);
}});
})();
