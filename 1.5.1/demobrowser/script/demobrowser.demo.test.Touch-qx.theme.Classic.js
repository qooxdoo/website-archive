...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Touch-qx.theme.Classic.8e49d97643b5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.test.Touch";
...
qx.Class.define(f,{extend:qx.application.Native,members:{__NT:null,__NU:null,main:function(){qx.application.Native.prototype.main.call(this);
...
w.setAttribute(c,m);
return;
}v.add(this.__NV(10,10,s,a));
v.add(this.__NV(110,10,d,q));
this.__NT=this.__NW(10,110);
v.add(this.__NT);
this.__NU=this.__NW(110,110);
v.add(this.__NU);
v.add(this.__NX(210,10));
},__NV:function(x,y,z,A){var B={"position":"absolute","left":x+"px","top":y+"px","width":"90px","height":"90px","backgroundColor":z,"fontFamily":"Arial","fontSize":"12px"};
var C=new qx.html.Element("div",B,{"id":A});
C.setAttribute("innerHTML","<b>Touch me:<br>"+A+"</b>");
C.addListener("touchstart",this.__NY,this);
C.addListener("touchmove",this.__NY,this);
C.addListener("touchend",this.__NY,this);
C.addListener("touchcancel",this.__NY,this);
return C;
},__NW:function(x,y){var D={"position":"absolute","left":x+"px","top":y+"px","width":"90px","fontFamily":"Arial","fontSize":"9px"};
return new qx.html.Element("div",D);
},__NX:function(x,y){var E={"position":"absolute","left":x+"px","top":y+"px","width":"55px","height":"55px","backgroundColor":"red","fontFamily":"Arial","fontSize":"12px"};
