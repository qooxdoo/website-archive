...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveLoader","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveLoader-qx.theme.Modern.91efda046df3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="pane",k="lastTab",j="bar",h="page",g="firstTab",f="close",d="right",c="bottom",b="button",a="qx.debug",C="changeSelection",B="top",A="left",z="qx.event.type.Data",y="barRight",x="beforeChangeSelection",w="__rz",v="close-button",u="tabview",t="vertical",r="_applyBarPosition",s="barLeft",p="horizontal",q="qx.ui.tabview.TabView",n="barTop",o="barBottom";
...
this.__ry={top:n,right:y,bottom:o,left:s};
this._createChildControl(j);
this._createChildControl(m);
var E=this.__rz=new qx.ui.form.RadioGroup;
E.setWrap(false);
E.addListener(C,this._onChangeSelection,this);
if(D!=null){this.setBarPosition(D);
}else{this.initBarPosition();
}},events:{"changeSelection":z},properties:{appearance:{refine:true,init:u},barPosition:{check:[A,d,B,c],init:B,apply:r}},members:{__rz:null,_createChildControlImpl:function(F,G){var H;
...
M.add(I);
this.__rz.add(J);
I.addState(this.__ry[this.getBarPosition()]);
I.addState(k);
...
S.addAt(N,O);
this.__rz.add(P);
N.addState(this.__ry[this.getBarPosition()]);
R=this.getChildren();
...
Y.remove(T);
this.__rz.remove(V);
T.removeState(this.__ry[this.getBarPosition()]);
...
},__ry:null,_applyBarPosition:function(bb,bc){var bd=this.getChildControl(j);
var bi=bb==A||bb==d;
var bg=bb==d||bb==c;
...
if(bc){var be=this.__ry[bc];
bd.removeState(be);
for(var i=0,l=bj.length;i<l;i++){bj[i].removeState(be);
}}
if(bb){var bf=this.__ry[bb];
bd.addState(bf);
for(var i=0,l=bj.length;i<l;i++){bj[i].addState(bf);
}}},getSelection:function(){var bl=this.__rz.getSelection();
var bm=[];
