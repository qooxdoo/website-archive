...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Boolean-qx.theme.Modern.41c1adda00e8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__xX=J.toUri(H);
this.__xY=J.toUri(G);
},properties:{allowToggle:{check:E,init:false}},members:{__xX:null,__xY:null,__Li:null,__Lj:null,__xR:null,__xS:null,__xT:null,__xU:null,_identifyImage:function(K){var L={imageWidth:11,imageHeight:11};

switch(K.cellData){case true:L.url=this.__xX;
L.extras=w;
break;
...
if((qx.core.Environment.get(b)==c)&&/\.png$/i.test(this.__xX)){L.extras+=i+this.getBlankImage()+j+e+h+a+this.__xX+j+d;
}else{L.extras+=i+this.__xX+j;
}L.extras+=m+v+u+f;

if((qx.core.Environment.get(b)==c)&&/\.png$/i.test(this.__xY)){L.extras+=i+this.getBlankImage()+j+e+h+a+this.__xY+j+d;
}else{L.extras+=i+this.__xY+j;
}L.extras+=q+g;
