...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.WebWorker","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.WebWorker-qx.theme.Simple.592e22bf53e5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.bom.WebWorker";
...
this.__IG=qx.core.Environment.get("html.webworker");
this.__IG?this.__II(f):this.__IJ(f);
},events:{"message":b,"error":b},members:{_worker:null,_handleErrorBound:null,_handleMessageBound:null,__IG:true,__IH:null,__II:function(g){this._worker=new window.Worker(g);
...
},__IJ:function(h){var j=this;
var i=new qx.bom.request.Xhr();
i.onload=function(){j.__IH=(function(){var k=function(e){j.fireDataEvent('message',e);
};
...
if(this.__IG){this._worker.postMessage(l);
}else{setTimeout(function(){try{m.__IH.onmessage&&m.__IH.onmessage({data:l});
...
}},destruct:function(){if(this.__IG){qx.bom.Event.removeNativeListener(this._worker,c,this._handleMessageBound);
qx.bom.Event.removeNativeListener(this._worker,d,this._handleErrorBound);

if(this._worker){this._worker.terminate();
this._worker=null;
}}else{if(this.__IH){this.__IH=null;
}}}});
})();
