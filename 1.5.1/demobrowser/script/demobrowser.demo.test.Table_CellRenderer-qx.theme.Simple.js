...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellRenderer-qx.theme.Simple.75a9dde80da9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.test.Table_CellRenderer",b="engine.version",a="os.name";
...
(function(){var k="",j="Hello",h="icon/16/actions/go-down.png",g="World",f="icon",e="bold",d="Juhu",c="</div>",b="qx/icon/Oxygen",a="waiting",R="icon/16/actions/go-next.png",Q="http://resources.qooxdoo.org/images/logo.gif",P="$ ",O="string",N="border: 1px dotted green",M="inactive",L="decoration",K="multi<br>line",J="between",I="<",r="<div style='position:absolute;height:20px;width:",s="px;top:",p="icon/16/actions/go-previous.png",q="number",n="px'>",o="Classic",l="<i>italic</i>",m="0$",t="qx/icon/Tango",u="<b>bold</b>",A="icon/16/actions/go-up.png",z="qx/decoration/",C="boolean",B="demobrowser.demo.test.Table_CellRenderer",E="tooltip",D="red",w="icon/16/emotes/face-sad.png",H="left",G="icon/16/emotes/face-smile.png",F="qx.theme.Simple",v=">=",x="active",y="object";
...
var T=F;
var S=/\.([a-z]+)$/i.exec(T)[1];
qx.util.AliasManager.getInstance().add(L,z+S);

if(S==o){qx.util.AliasManager.getInstance().add(f,b);
}else{qx.util.AliasManager.getInstance().add(f,t);
}},__Kk:function(U,top,V,W,X){var Y=[r,V,s,top,n];
W.createDataCellHtml(X,Y);
Y.push(c);
U.innerHTML+=Y.join(k);
},testDefaultRenderer:function(ba){var bb=100;
var bd={value:[null,d,32,new Date()],styleLeft:[0],styleWidth:[bb],styleHeight:[20],style:[k]};
var bc=this._getNewTableDiv(bb);
var top=0;
qx.util.Permutation.permute(bd,function(be){this.__Kk(bc,top,bb,ba,be);
top+=20;
},this);
},testBooleanRenderer:function(){var bi=70;
var bh=30;
var bj=new qx.ui.table.cellrenderer.Boolean();
var bf={value:[null,true,false],styleLeft:[0],styleWidth:[bi],styleHeight:[bh],style:[k]};
var bg=this._getNewTableDiv(bi);
var top=0;
qx.util.Permutation.permute(bf,function(bk){this.__Kk(bg,top,bi,bj,bk);
top+=bh;
},this);
bj.setIconFalse(w);
bj.setIconTrue(G);
qx.util.Permutation.permute(bf,function(bl){this.__Kk(bg,top,bi,bj,bl);
top+=bh;
},this);
},testDateRenderer:function(){var bp=180;
var bq=new qx.ui.table.cellrenderer.Date();
var bs={value:new Date(),styleLeft:[0],styleWidth:[bp],styleHeight:[20],style:[k]};
var bo=qx.util.format.DateFormat;
var br=[bo.getDateTimeInstance(),bo.getDateInstance()];
var bm=this._getNewTableDiv(bp);
var top=0;

for(var i=0;i<br.length;i++){var bn=br[i];
bq.setDateFormat(bn);
this.__Kk(bm,top,bp,bq,bs);
top+=20;
}},testNumberRenderer:function(){var bx=new qx.ui.table.cellrenderer.Number();
var bw=100;
var bz={value:Math.PI,styleLeft:[0],styleWidth:[bw],styleHeight:[20],style:[k]};
var bv=qx.util.format.NumberFormat;
var by=[new bv().set({maximumFractionDigits:0}),new bv().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:P})];
var bt=this._getNewTableDiv(bw);
var top=0;

for(var i=0;i<by.length;i++){var bu=by[i];
bx.setNumberFormat(bu);
this.__Kk(bt,top,bw,bx,bz);
top+=20;
}},testImageRenderer:function(){var bC=new qx.ui.table.cellrenderer.Image();
var bA=50;
var bD={value:[null,h,A,p,R,Q],styleLeft:[0],styleWidth:[bA],styleHeight:[20],style:[k],tooltip:[k,E]};
var bB=this._getNewTableDiv(bA);
var top=0;
qx.util.Permutation.permute(bD,function(bE){this.__Kk(bB,top,bA,bC,bE);
top+=20;
},this);
},testStringRenderer:function(){var bJ=new qx.ui.table.cellrenderer.String();
var bI=100;
var bH=20;
var bF={value:[null,j,g],styleLeft:[0],styleWidth:[bI],styleHeight:[bH],style:[k]};
var bG=this._getNewTableDiv(bI);
var top=0;
qx.util.Permutation.permute(bF,function(bK){this.__Kk(bG,top,bI,bJ,bK);
top+=20;
},this);
},testPasswordRenderer:function(){var bP=new qx.ui.table.cellrenderer.Password();
var bO=100;
var bN=20;
var bL={value:[null,j,g],styleLeft:[0],styleWidth:[bO],styleHeight:[bN],style:[k]};
var bM=this._getNewTableDiv(bO);
var top=0;
qx.util.Permutation.permute(bL,function(bQ){this.__Kk(bM,top,bO,bP,bQ);
top+=20;
},this);
},testHtmlRenderer:function(){var bV=new qx.ui.table.cellrenderer.Html();
var bU=100;
var bT=50;
var bR={value:[null,u,l,K],styleLeft:[0],styleWidth:[bU],styleHeight:[bT],style:[k]};
var bS=this._getNewTableDiv(bU);
var top=0;
qx.util.Permutation.permute(bR,function(bW){this.__Kk(bS,top,bU,bV,bW);
top+=20;
},this);
},testConditionalRenderer:function(){var cc=new qx.ui.table.cellrenderer.Conditional();
cc.addNumericCondition(I,0,null,D,null,null);
cc.addNumericCondition(v,100,H,null,null,null);
cc.addBetweenCondition(J,0,2,null,null,null,e,null);
cc.addRegex(m,null,null,e,N);
var cb=100;
var ca=20;
var bX={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[cb],table:[this.tableMock],styleHeight:[ca],style:[k]};
var bY=this._getNewTableDiv(cb);
var top=0;
qx.util.Permutation.permute(bX,function(cd){this.__Kk(bY,top,cb,cc,cd);
top+=20;
},this);
},testDynamicRenderer:function(){var ci=new qx.ui.table.cellrenderer.Dynamic();
ci.setCellRendererFactoryFunction(function(cj){var cl=cj.value;
var ck=qx.ui.table.cellrenderer;

switch(typeof cl){case O:if(cl.match(/^icon\//)){return new ck.Image();
}else{return new ck.String();
}case C:return new ck.Boolean();
case q:return new ck.Number();
case y:if(cl instanceof Date){return new ck.Date();
}return new ck.Default();
}});
var ch=100;
var cg=20;
var ce={value:[null,d,new Date(),30,h,false],styleLeft:[0],styleWidth:[ch],styleHeight:[cg],table:[this.tableMock],style:[k]};
var cf=this._getNewTableDiv(ch);
var top=0;
qx.util.Permutation.permute(ce,function(cm){this.__Kk(cf,top,ch,ci,cm);
top+=20;
},this);
},testReplaceRenderer:function(){var cs=new qx.ui.table.cellrenderer.Replace();
cs.setReplaceMap({1:x,2:M,3:a});
cs.addReversedReplaceMap();
var cq=100;
var cp=20;
var cn={value:[1,2,3],styleLeft:[0],styleWidth:[cq],table:[this.tableMock],styleHeight:[cp],style:[k]};
var co=this._getNewTableDiv(cq);
var top=0;
qx.util.Permutation.permute(cn,function(ct){this.__Kk(co,top,cq,cs,ct);
top+=20;
},this);
