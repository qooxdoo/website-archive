...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.VBox_Percent","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox_Percent-qx.theme.Classic.0c148aca5cdd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.layout.VBox_Percent",b="os.name",a="engine.version";
...
(function(){var f="main",e="green",d="33%",c="yellow",b="50%",a="demobrowser.demo.layout.VBox_Percent";
...
var g=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(g);
g.add(this.getBox1());
g.add(this.getBox2());
g.add(this.getBox3());
...
g.add(this.getBox5());
g.add(this.getBox6());
},getBox1:function(){var h=new qx.ui.layout.VBox();
var j=new qx.ui.container.Composite(h).set({decorator:f,backgroundColor:c,height:300,allowGrowY:false});
h.setSpacing(5);
var l=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var k=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var i=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
j.add(l,{height:b});
j.add(k,{flex:1});
j.add(i,{flex:1});
return j;
},getBox2:function(){var m=new qx.ui.layout.VBox();
var o=new qx.ui.container.Composite(m).set({decorator:f,backgroundColor:c,height:300,allowGrowY:false});
m.setSpacing(5);
var q=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var p=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var n=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
o.add(q,{height:d});
o.add(p,{height:d});
o.add(n,{height:d,flex:1});
return o;
},getBox3:function(){var r=new qx.ui.layout.VBox();
var t=new qx.ui.container.Composite(r).set({decorator:f,backgroundColor:c,allowGrowY:false});
r.setSpacing(5);
var v=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var u=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var s=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
t.add(v,{height:b});
t.add(u,{flex:1});
t.add(s,{flex:1});
return t;
},getBox4:function(){var w=new qx.ui.layout.VBox();
var y=new qx.ui.container.Composite(w).set({decorator:f,backgroundColor:c,allowGrowY:false});
w.setSpacing(5);
var A=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var z=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var x=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
y.add(A,{height:d,flex:1});
y.add(z,{height:d,flex:1});
y.add(x,{height:d,flex:1});
return y;
},getBox5:function(){var B=new qx.ui.layout.VBox();
var D=new qx.ui.container.Composite(B).set({decorator:f,backgroundColor:c,height:100,allowGrowY:false});
B.setSpacing(5);
var F=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var E=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var C=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
D.add(F,{height:d,flex:1});
D.add(E,{height:d,flex:1});
D.add(C,{height:d,flex:1});
return D;
},getBox6:function(){var G=new qx.ui.layout.VBox();
var I=new qx.ui.container.Composite(G).set({decorator:f,backgroundColor:c,height:300,allowGrowY:false});
G.setSpacing(5);
var K=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var J=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var H=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
I.add(K,{height:d,flex:1});
I.add(J,{height:d,flex:1});
I.add(H,{height:d,flex:1});
return I;
}}});
})();
