...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Flow","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Flow-qx.theme.Classic.4d2c532446eb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.layout.Flow",b="os.name",a="engine.version";
...
(function(){var q="icon/48/devices/computer.png",p="7th a wide, short button",o="1. First Button",n="Flow Layout with line breaks",m="Number 6",l="demobrowser.demo.layout.Flow",k="Flow Layout",j="center",h="20px Margins around the great big 5th button!",g="top",c="bottom",f="3rd really, really, really long Button",e="middle",b="Number 4",a="item #",d="2. Second longer Button...";
...
},_createGalleryWindow:function(r,top){var s=new qx.ui.window.Window(k).set({contentPadding:0,width:200});
s.setLayout(new qx.ui.layout.Grow());
var u=new qx.ui.container.Scroll();
s.add(u);
var t=new qx.ui.container.Composite(new qx.ui.layout.Flow()).set({allowShrinkY:false});
u.add(t);

for(var i=0;i<30;i++){t.add(new qx.ui.basic.Atom(a+(i+1),q).set({iconPosition:g,width:60,padding:5}));
}s.moveTo(r,top);
s.open();
},_createLineBreakWindow:function(v,top){var E=new qx.ui.layout.Flow();
E.setAlignX(j);
var w=new qx.ui.window.Window(n).set({contentPadding:0,width:500,height:200,layout:E});
var F=q;
var z=new qx.ui.form.Button(o,F);
w.add(z);
var y=new qx.ui.form.Button(d,F);
w.add(y,{lineBreak:true});
var x=new qx.ui.form.Button(f,F);
x.setHeight(100);
w.add(x);
var D=new qx.ui.form.Button(b,F);
D.setAlignY(c);
w.add(D);
var C=new qx.ui.form.Button(h);
C.setHeight(100);
C.setMargin(20);
w.add(C,{lineBreak:true});
var B=new qx.ui.form.Button(m,F);
B.setAlignY(e);
w.add(B);
var A=new qx.ui.form.Button(p,F);
A.setMaxHeight(20);
w.add(A);
w.moveTo(v,top);
w.open();
...
(function(){var o="_applyLayoutChange",n="left",m="center",l="top",k="Integer",j="lineBreak",h="' is not supported by the flow layout!",g="middle",f="qx.debug",e="bottom",b="qx.ui.layout.Flow",d="right",c="The property '",a="Boolean";
qx.Class.define(b,{extend:qx.ui.layout.Abstract,construct:function(p,q,r){qx.ui.layout.Abstract.call(this);

if(p){this.setSpacingX(p);
}
if(q){this.setSpacingY(q);
}
if(r){this.setAlignX(r);
}},properties:{alignX:{check:[n,m,d],init:n,apply:o},alignY:{check:[l,g,e],init:l,apply:o},spacingX:{check:k,init:0,apply:o},spacingY:{check:k,init:0,apply:o},reversed:{check:a,init:false,apply:o}},members:{verifyLayoutProperty:qx.core.Environment.select(f,{"true":function(s,name,t){this.assertEquals(j,name,c+name+h);
},"false":null}),connectToWidget:function(u){qx.ui.layout.Abstract.prototype.connectToWidget.call(this,u);
u.setAllowShrinkY(false);
},renderLayout:function(v,w){var A=this._getLayoutChildren();

if(this.getReversed()){A=A.concat().reverse();
}var x=new qx.ui.layout.LineSizeIterator(A,this.getSpacingX());
var y=0;

while(x.hasMoreLines()){var z=x.computeNextLine(v);
this.__Kd(z,y,v);
y+=z.height+this.getSpacingY();
}},__Kd:function(B,C,D){var F=qx.ui.layout.Util;
var I=0;

if(this.getAlignX()!=n){I=D-B.width;

if(this.getAlignX()==m){I=Math.round(I/2);
}}
...
}},_computeSizeHint:function(){return this.__Ke(Infinity);
},hasHeightForWidth:function(){return true;
},getHeightForWidth:function(K){return this.__Ke(K).height;
},__Ke:function(L){var M=new qx.ui.layout.LineSizeIterator(this._getLayoutChildren(),this.getSpacingX());
var Q=0;
var N=0;
var O=0;

while(M.hasMoreLines()){var P=M.computeNextLine(L);
O+=1;
N=Math.max(N,P.width);
Q+=P.height;
}return {width:N,height:Q+this.getSpacingY()*(O-1)};
}}});
})();
(function(){var a="qx.ui.layout.LineSizeIterator";
qx.Class.define(a,{extend:Object,construct:function(b,c){this.__fa=b;
this.__HY=c;
this.__Ia=b.length>0;
this.__Ib=0;
},members:{__fa:null,__HY:null,__Ia:null,__Ib:null,computeNextLine:function(d){var d=d||Infinity;

if(!this.__Ia){throw new Error("No more lines to compute");
}var o=this.__fa;
var m=0;
var f=0;
var n=[];
...
for(var i=this.__Ib;i<o.length;i++){var l=o[i];
var p=l.getSizeHint();
var h=this.__Ic(i);
var g=p.width+h;
var e=i==this.__Ib;

if(!e&&f+g>d){this.__Ib=i;
break;
...
if(l.getLayoutProperties().lineBreak){this.__Ib=i+1;
break;
}}
if(i>=o.length){this.__Ia=false;
}return {height:m,width:f,children:n,gapsBefore:j};
},__Ic:function(q){var r=q==this.__Ib;

if(r){return this.__fa[q].getMarginLeft();
}else{return Math.max(this.__fa[q-1].getMarginRight(),this.__fa[q].getMarginLeft(),this.__HY);
}},hasMoreLines:function(){return this.__Ia;
}}});
})();
