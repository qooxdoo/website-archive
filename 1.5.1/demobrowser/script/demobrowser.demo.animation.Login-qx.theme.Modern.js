...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Login-qx.theme.Modern.9a44f0dea09b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.animation.Login";
...
(function(){var o="top",n="right",m="resize",l="Name",k="Password",j="__MP",h="__Ex",g="appear",f="__Bj",d="demobrowser.demo.animation.Login",a="50%",c="execute",b="30%";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__Bj:null,__Ex:null,__MP:null,checkInput:function(){this.__Bj.start();
},__MQ:function(){this.__Bj=new qx.fx.effect.combination.Shake(this.__Ex.getContainerElement().getDomElement());
...
this.__Ex=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__Ex.setLayout(q);
this.__Ex.addListener(m,function(e){var u=this.__Ex.getBounds();
this.__Ex.set({marginTop:Math.round(-u.height/2),marginLeft:Math.round(-u.width/2)});
},this);
this.getRoot().add(this.__Ex,{left:a,top:b});
var p=[l,k];

for(var i=0;i<p.length;i++){this.__Ex.add(new qx.ui.basic.Label(p[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}var r=new qx.ui.form.TextField();
var s=new qx.ui.form.PasswordField();
this.__Ex.add(r.set({allowShrinkX:false,paddingTop:3}),{row:0,column:1});
this.__Ex.add(s.set({allowShrinkX:false,paddingTop:3}),{row:1,column:1});
var t=this.__MP=new qx.ui.form.Button("Login");
t.setAllowStretchX(false);
this.__Ex.add(t,{row:3,column:1});
t.addListener(c,this.checkInput,this);
this.__Ex.addListener(g,this.__MQ,this);
