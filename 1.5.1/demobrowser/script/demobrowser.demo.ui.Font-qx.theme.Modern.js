...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.Font","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Font-qx.theme.Modern.d718ab9e6c3a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.ui.Font",b="os.name",a="engine.version";
...
(function(){var o="execute",n="demobrowser.demo.ui.Font",m="24px sans-serif",l="red",k="Serif, 16px",j="24px serif",i="16px serif",h="Hello World",g="Sans Serif, 24px",f="Sans Serif, 16px",c="Sans Serif, 24px bold",e="24px sans-serif bold",d="solid",b="Serif, 24px",a="16px sans-serif";
...
var q=new qx.ui.basic.Label(h).set({decorator:new qx.ui.decoration.Single(1,d,l)});
this.getRoot().add(q,{left:20,top:20});
var p=new qx.ui.container.Composite(new qx.ui.layout.VBox().set({spacing:10}));
this.getRoot().add(p,{left:200,top:20});
var t=new qx.ui.form.Button(k);
p.add(t);
var u=new qx.ui.form.Button(b);
p.add(u);
var v=new qx.ui.form.Button(f);
p.add(v);
var r=new qx.ui.form.Button(g);
p.add(r);
var s=new qx.ui.form.Button(c);
p.add(s);
t.addListener(o,function(){q.setFont(qx.bom.Font.fromString(i));
});
u.addListener(o,function(){q.setFont(qx.bom.Font.fromString(j));
});
v.addListener(o,function(){q.setFont(qx.bom.Font.fromString(a));
});
r.addListener(o,function(){q.setFont(qx.bom.Font.fromString(m));
});
s.addListener(o,function(){q.setFont(qx.bom.Font.fromString(e));
});
}}});
})();
