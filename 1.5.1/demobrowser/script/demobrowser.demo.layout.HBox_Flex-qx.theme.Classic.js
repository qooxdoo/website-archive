...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.HBox_Flex","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox_Flex-qx.theme.Classic.8a513042516d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.layout.HBox_Flex";
...
(function(){var d="main",c="green",b="yellow",a="demobrowser.demo.layout.HBox_Flex";
...
var e=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(e);
e.add(this.getBox1());
e.add(this.getBox2());
e.add(this.getBox3());
...
e.add(this.getBox5());
e.add(this.getBox6());
},getBox1:function(){var f=new qx.ui.layout.HBox();
var g=new qx.ui.container.Composite(f).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
f.setSpacing(5);
g.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:1});
g.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
g.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:3});
return g;
},getBox2:function(){var h=new qx.ui.layout.HBox();
var j=new qx.ui.container.Composite(h).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
h.setSpacing(5);
j.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:30}),{flex:1});
j.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
j.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:150}),{flex:3});
return j;
},getBox3:function(){var k=new qx.ui.layout.HBox();
var m=new qx.ui.container.Composite(k).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
k.setSpacing(5);

for(var i=0;i<25;i++){var l=new qx.ui.core.Widget();
l.set({decorator:d,backgroundColor:c,width:5});
m.add(l,{flex:1});
}return m;
},getBox4:function(){var n=new qx.ui.layout.HBox();
var o=new qx.ui.container.Composite(n).set({width:600,minWidth:600,decorator:d,backgroundColor:b,allowGrowX:false});
n.setSpacing(5);
o.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:1});
o.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:2});
o.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:3});
return o;
},getBox5:function(){var p=new qx.ui.layout.HBox();
var q=new qx.ui.container.Composite(p).set({width:300,minWidth:0,decorator:d,backgroundColor:b,allowGrowX:false});
p.setSpacing(5);
q.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:1});
q.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:2});
q.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:3});
return q;
},getBox6:function(){var r=new qx.ui.layout.HBox();
var s=new qx.ui.container.Composite(r).set({width:300,decorator:d,backgroundColor:b,allowGrowX:false});
r.setSpacing(5);
s.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:1});
s.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:2});
s.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:3});
return s;
}}});
})();
