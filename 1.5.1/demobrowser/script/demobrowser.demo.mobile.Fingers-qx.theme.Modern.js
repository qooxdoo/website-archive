...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.Fingers","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.Fingers-qx.theme.Modern.8538686a9b16.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(v,{extend:qx.application.Native,members:{__Nh:null,__Ni:null,main:function(){qx.application.Native.prototype.main.call(this);
...
this.__Nh[i]=parseInt(M.target.style.left)-M.pageX;
this.__Ni[i]=parseInt(M.target.style.top)-M.pageY;
}},_onTouchMove:function(e){var P=e.getAllTouches();

for(var i=0;i<P.length;i++){var O=P[i];

if(P.target==document.body){continue;
}qx.bom.element.Style.setStyles(O.target,{"left":(O.pageX+this.__Nh[i])+l,"top":(O.pageY+this.__Ni[i])+l});
}e.stop();
}}});
})();
