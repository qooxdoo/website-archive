...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Complex","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex-qx.theme.Simple.d58093159ef2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.virtual.Complex";
...
this.__lj=[];
},members:{_pool:null,__lj:null,getCellData:function(s,t){if(!this.__lj[s]){this.__lj[s]=[];
}
if(!this.__lj[s][t]){this.__lj[s][t]={label:this.__Oo(),icon:this.__Op()};
}return this.__lj[s][t];
},getCellWidget:function(u,v){var w;

if(v%2==0){w=this._pool.atom.pop();

if(!w){w=new qx.ui.basic.Atom();
w.addListener(c,function(){var x=this.__Op();
w.setIcon(x);
this.__lj[u][v].icon=x;
},this);
...
}},__Oo:function(){var name=m;

for(var j=0;j<10;j++){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);
}return name;
},__Op:function(){var z=n;
var B=k;
var C=[l,g,h,b,d];
var A=Math.floor(Math.random()*4);
return (z+16+e+B+C[A]);
}},destruct:function(){this._pool=this.__lj=null;
}});
})();
