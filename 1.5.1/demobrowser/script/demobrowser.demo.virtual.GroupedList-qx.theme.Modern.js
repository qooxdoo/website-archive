...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.GroupedList","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.GroupedList-qx.theme.Modern.49463e80a1bd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.virtual.GroupedList";
...
(function(){var l="model.persons",k="bold",j="model",i="persons.json</a> and binds the created model to all list widgets. ",h="demobrowser.demo.virtual.GroupedList",g="firstname",f="Friends",e="json/persons.json",d="by first name and groups it by the 'group' model property. The ",c="third list is configured  to use a customized group item for rendering.",E="Grouped by last name:",D="<b>Grouped List</b><br/>",C="Raw List:",B="The second list sorts the items by last name and groups the items ",A="Colleagues",z="icon",y="#005E00",x="Loads the json file <a href='json/persons.json' target='_blank'>",w="The first list shows only the row data and uses a converter for the ",v="Grouped by group:",s="icon/16/emotes/face-laugh.png",t="by the first letter of the last name. The third list sorts the items ",q="label",r="icon/16/categories/system.png",o="no model...",p="icon/16/categories/office.png",m=" ",n="white",u="label that concatenates the first and last name. ";
qx.Class.define(h,{extend:qx.application.Standalone,members:{__BK:null,__LT:null,__Or:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var I=this.createFirstExample();
var K=this.createSecondExample();
var J=this.createThirdExample();
this.loadData();
var F=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
this.getRoot().add(F,{edge:20});
var G=new qx.ui.basic.Label();
G.setRich(true);
G.setWidth(470);
G.setSelectable(true);
G.setValue(D+x+i+w+u+B+t+d+c);
F.add(G);
var H=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
F.add(H,{flex:1});
H.add(I);
H.add(K);
H.add(J);
},loadData:function(){var L=e;
var M=new qx.data.store.Json(L);
M.bind(l,this.__BK,j);
M.bind(l,this.__LT,j);
M.bind(l,this.__Or,j);
},createFirstExample:function(){var O=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var P=new qx.ui.basic.Label(C).set({font:k});
O.add(P);
var N=this.__BK=new qx.ui.list.List().set({height:280,width:150,labelPath:"firstname",labelOptions:{converter:function(Q,R){return R?Q+" "+R.getLastname():"no model...";
}}});
O.add(N,{top:20});
return O;
},createSecondExample:function(){var T=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var V=new qx.ui.basic.Label(E).set({font:k});
T.add(V);
var S=this.__LT=new qx.ui.list.List().set({height:280,width:150,labelPath:"firstname",labelOptions:{converter:function(W,X){return X?X.getLastname()+", "+W:"no model...";
}}});
T.add(S,{top:20});
var U={sorter:function(a,b){a=a.getLastname();
b=b.getLastname();
return a>b?1:a<b?-1:0;
},group:function(Y){return Y.getLastname().charAt(0).toUpperCase();
}};
S.setDelegate(U);
S.setSelection(this.__BK.getSelection());
return T;
},createThirdExample:function(){var bb=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var bd=new qx.ui.basic.Label(v).set({font:k});
bb.add(bd);
var ba=this.__Or=new qx.ui.list.List().set({height:280,width:150,labelPath:g,labelOptions:{converter:function(be,bf){return bf?be+m+bf.getLastname():o;
}}});
bb.add(ba,{top:20});
var bc={sorter:function(a,b){a=a.getLastname();
b=b.getLastname();
return a>b?1:a<b?-1:0;
},group:function(bg){return bg.getGroup?bg.getGroup():null;
},createGroupItem:function(){return new qx.ui.form.ListItem();
},configureGroupItem:function(bh){bh.setBackgroundColor(y);
bh.setTextColor(n);
},bindGroupItem:function(bi,bj,bk){bi.bindProperty(null,q,null,bj,bk);
bi.bindProperty(null,z,{converter:function(bl){switch(bl){case f:return s;
case A:return p;
default:return r;
}}},bj,bk);
}};
ba.setDelegate(bc);
ba.setSelection(this.__BK.getSelection());
return bb;
}},destruct:function(){this.__BK.dispose();
this.__LT.dispose();
this.__Or.dispose();
this.__BK=this.__LT=this.__Or=null;
}});
})();
