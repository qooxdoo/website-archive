...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.List-qx.theme.Simple.af8682f36f17.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(T,{extend:qx.application.Standalone,properties:{showMode:{init:bm,check:[bs,br,bm],event:bb}},members:{__Os:null,__Ot:null,__Ou:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var bO=this.getRoot();
...
var bW=this.__Os=new qx.ui.list.List(cf).set({scrollbarX:s,selectionMode:bp,height:280,width:150,labelPath:bs,iconPath:br,iconOptions:{converter:function(cj){return bK+cj+p;
}}});
bR.add(bW,{top:20});
var bV=this;
...
var bY=this.__Ot=new qx.ui.form.CheckBox(bg);
var cd=this.__Ou=new qx.ui.form.CheckBox(d).set({enabled:false});
...
this.__Os.setSelectionMode(cC);

if(cC==bl||cC==bq){this.__Ot.setEnabled(false);
this.__Ou.setEnabled(true);
}else if(cC==bp||cC==bG){this.__Ot.setEnabled(true);
this.__Ou.setEnabled(false);
}},onShowModeChange:function(e){var cD=e.getData()[0].getUserData(bt);
this.setShowMode(cD);
},onDragCheckChange:function(e){if(e.getData()){var cE=this.__Os.getSelectionMode();
...
},onQuickCheckChange:function(e){if(e.getData()){var cF=this.__Os.getSelectionMode();
