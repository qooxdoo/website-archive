...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.PingPong","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong-qx.theme.Modern.b030bdaf068e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="demobrowser.demo.mobile.PingPong",d="qx.core.BaseInit",c="engine.name",b="os.name",a="engine.version";
...
(function(){var k="div",j="left",i="100%",h="innerHTML",g="20px",f="absolute",d="touchmove",c="black",b="px",a="200px",N="30px",M="100px",L="1px solid white",K="top",J="right",I="50%",H="none",G="white",F="#333",E="border-left",r="green",s="demobrowser.demo.mobile.PingPong",p="0",q="qx.debug",n="interval",o="0px",l="12px",m="15em",t="event.touch",u="center",z='Lucida Grande',w="qx.mobile.emulatetouch",B="Arial",A="engine.name",D="webkit",C="border-right",v="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>";
qx.Class.define(s,{extend:qx.application.Native,members:{__Nj:null,__Nk:null,__Nl:null,__Nm:null,__Nn:5,__No:1,__Np:1,__Nq:null,__Nr:null,__Ns:null,main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(q)){qx.log.appender.Native;
qx.log.appender.Console;
}var Q={"width":i,"height":i,"backgroundColor":c,"margin":o,"userSelect":H};
var T=new qx.html.Element(k,Q);
T.useElement(document.body);
T.setRoot(true);

if(qx.core.Environment.get(A)!=D||(!qx.core.Environment.get(t)&&qx.core.Environment.get(w)==false)){var S={"color":r,"font-family":z,"font-size":l,"position":f,"left":N,"top":g};
var R=new qx.html.Element(k,S);
T.add(R);
R.setAttribute(h,v);
return;
}var O=this.__Nw(j);
...
var P=this.__Nw(J);
T.add(P);
this.__Nk=this.__Nx(j);
O.add(this.__Nk);
O.addListener(d,qx.lang.Function.bind(this.__CA,this,this.__Nk),this);
this.__Nj=this.__Nx(J);
P.add(this.__Nj);
P.addListener(d,qx.lang.Function.bind(this.__CA,this,this.__Nj),this);
this.__Nl=this.__Ny();
T.add(this.__Nl);
this.__Nr=this.__Nz();
O.add(this.__Nr);
...
this.__Nq=[0,0];
this.__Nt();
},__Nt:function(){this.__Nl.setStyles({"left":a,"top":a});
this.__Nm=new qx.event.Timer(40);
this.__Nm.addListener(n,function(){var x=(parseInt(this.__Nl.getStyle(j))+this.__Nn*this.__No);
var y=(parseInt(this.__Nl.getStyle(K))+this.__Nn*this.__Np);
this.__Nl.setStyle(j,x+b);
this.__Nl.setStyle(K,y+b);
this.__Nv();
},this);
this.__Nm.start();
},__Nu:function(U){this.__Nm.stop();
this.__Nm.dispose();
this.__Nn=5;
this.__Nq[U]=this.__Nq[U]+1;
this.__Nr.setAttribute(h,this.__Nq[0]);
this.__Ns.setAttribute(h,this.__Nq[1]);
this.__Nt();
},__Nv:function(){var W=this.getBoundsFor(this.__Nl);
if(W.top<=0){this.__Np=1;
}if(W.bottom>=window.innerHeight-5){this.__Np=-1;
}if(W.left<=0||W.right>=window.innerWidth){this.__Nu(W.left<=0?1:0);
}var X=this.getBoundsFor(this.__Nk);

if(W.left<=X.right&&W.bottom>=X.top&&W.top<=X.bottom){this.__No=1;
this.__Nn=Math.min(this.__Nn+1,20);
}var V=this.getBoundsFor(this.__Nj);

if(W.right>=V.left&&W.bottom>=V.top&&W.top<=V.bottom){this.__No=-1;
this.__Nn=Math.min(this.__Nn+1,20);
}},__CA:function(Y,e){Y.setStyles({"top":(e.getDocumentTop()-50)+"px"});
},getBoundsFor:function(ba){return qx.bom.element.Location.get(ba.getDomElement());
},__Nw:function(bb){var bc={"width":I,"height":i,"position":f,"backgroundColor":c};

if(bb==j){bc[C]=L;
}else{bc[j]=I;
bc[E]=L;
}return new qx.html.Element(k,bc);
},__Nx:function(bd){var be={"width":N,"height":M,"top":M,"position":f,"backgroundColor":G};
be[bd]=g;
return new qx.html.Element(k,be);
},__Ny:function(){var bf={"width":g,"height":g,"position":f,"backgroundColor":G,"userSelect":H};
return new qx.html.Element(k,bf);
},__Nz:function(){var bg={"width":i,"height":i,"textAlign":u,"fontSize":m,"color":F,"fontFamily":B};
var bh=new qx.html.Element(k,bg);
bh.setAttribute(h,p);
return bh;
}}});
})();
