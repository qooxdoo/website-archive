...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.TimerManager","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.TimerManager-qx.theme.Modern.f24f19b6dedf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="Stopping recurrent 2-second timer",g="Recurrent 2-second timer with limit 3:",f="One-shot 1-second timer: ",e="__FW",d="demobrowser.demo.test.TimerManager",c="Recurrent 5-second timer: ",b="Start timers",a="execute";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__FW:null,startTimers:function(){var i=qx.util.TimerManager.getInstance();
i.start(function(j,k){this.__NS(c+k);
},5000,this,null,0);
i.start(function(l,m){this.__NS(f+m);
},0,this,null,1000);
i.start(function(n,o){this.__NS(g+o);

if(++n.count==3){this.__NS(h);
i.stop(o);
}},2000,this,{count:0},2000);
},__NS:function(p){p=Date.parse(new Date)+" "+p+"\n";
this.__FW.setValue(this.__FW.getValue()+p);
