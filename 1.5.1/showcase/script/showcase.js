...
var envinfo = {"qx.application":"showcase.Application","qx.debug":false,"qx.optimization.basecalls":true,"qx.optimization.comments":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.variants":true,"qx.revision":"exported","qx.theme":"showcase.theme.Theme","qx.version":"1.5.1"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"qx":{"resourceUri":"resource","sourceUri":"script","version":"1.5.1"},"qxc.application.formdemo":{"resourceUri":"resource","sourceUri":"script","version":"trunk"},"qxc.application.twitterdemo":{"resourceUri":"resource","sourceUri":"script","version":"trunk"},"showcase":{"resourceUri":"resource","sourceUri":"script","version":"trunk"}};
...
qx.$$loader = {
  ...
  packages : {"1":{"uris":["__out__:showcase.ce6282fe1308.js"]},"2":{"uris":["__out__:showcase.187bd0f56f87.js"]},"4":{"uris":["__out__:showcase.9a9e0f73ceac.js"]},"16":{"uris":["__out__:showcase.4797837e759f.js"]},"130":{"uris":["__out__:showcase.a9be3bab01b4.js"]},"131":{"uris":["__out__:showcase.fbc4a300e280.js"]},"256":{"uris":["__out__:showcase.607b04961564.js"]},"386":{"uris":["__out__:showcase.f9673e5308ad.js"]},"512":{"uris":["__out__:showcase.113ae29e46ba.js"]},"514":{"uris":["__out__:showcase.1f900dee2d0a.js"]},"789":{"uris":["__out__:showcase.1d72c9b3441a.js"]},"899":{"uris":["__out__:showcase.1da15f0f3617.js"]},"1024":{"uris":["__out__:showcase.4718c4eaf046.js"]},"1923":{"uris":["__out__:showcase.ad1871132efe.js"]},"2015":{"uris":["__out__:showcase.2dc4dbcff714.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
...
if(this.__j[be]!=undefined){window.setTimeout(function(){bf.call(self,bh.__j[be]);
},0);
return;
}var bg=this._asyncChecks[be];

if(bg){bg(function(bi){bh.__j[be]=bi;
bf.call(self,bi);
});
return;
...
qx.Bootstrap.trace(this);
}},select:function(bj,bk){return this.__k(this.get(bj),bk);
},selectAsync:function(bl,bm,self){this.getAsync(bl,function(bn){var bo=this.__k(bl,bm);
bo.call(self,bn);
},this);
},__k:function(bp,bq){var bs=bq[bp];
...
},__l:function(){if(qx&&qx.$$environment){for(var bA in qx.$$environment){var bz=qx.$$environment[bA];
this._checks[bA]=this.__n(bz);
}}},__m:function(){if(window.document&&window.document.location){var bB=window.document.location.search.slice(1).split(L);
...
}this._checks[bE]=this.__n(bC);
}}},__n:function(bF){return qx.Bootstrap.bind(function(bG){return bG;
},null,bF);
...
if(this.useCheck(U)){this._checks[U]=qx.bom.client.Scroll.scrollBarOverlayed;
...
this.set({name:j,part:o,icon:e,contentClass:f,description:showcase.page.DescriptionBuilder.build(j,this.__Au,null,this.__Av,this.__Aw,this.__Ax,this.__Ay)});
},members:{__Au:v+q+g+t+a+c+i,__Av:{"States":h+p,"Decorators":k+b+n},__Aw:{"pages/gui_toolkit/ui_theming.html":j,"pages/gui_toolkit/ui_appearance.html":s,"pages/gui_toolkit/ui_custom_themes.html":d,"pages/gui_toolkit/ui_decorators.html":m},__Ax:{"#ui~Decoration.html":u},__Ay:{"#qx.theme":l}}});
})();
...
}},properties:{baseImage:{check:d,nullable:true,apply:f}},members:{__kG:null,__AH:null,__AI:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__kG;
...
var K=M[1];
var I=M[2];
var N=this.__AH={t:K+"-t"+I,b:K+"-b"+I,c:K+"-c"+I,l:K+"-l"+I,r:K+"-r"+I};
this.__AI={top:H.getImageHeight(N.t),bottom:H.getImageHeight(N.b),left:H.getImageWidth(N.l),right:H.getImageWidth(N.r)};
...
(function(){var r="HTML Editor",q="showcase/htmleditor/icon.png",p=" and as a qooxdoo widget. It offers events, allowing easy implementation of a toolbar ",o="Overview HTML Editing",n=" cross-browser HTML editing capabilities and is available both as a low-level component",m="HTML Area",l="Low-Level editor",k="supplement. The UI controls of the toolbar can be used to interact ",j="MenuBar",i="htmleditor",c="The Html Editor, embedded here in a window with menu bar and toolbar, provides basic",h="You can insert HTML tables, images, hyperlinks, ...",f="with the HTML editing component.",b="Editor widget",a="showcase.page.htmleditor.Content",e="showcase.page.htmleditor.Page",d="Menu",g="Toolbar";
qx.Class.define(e,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:r,part:i,icon:q,contentClass:a,description:showcase.page.DescriptionBuilder.build(r,this.__Au,this.__AJ,this.__Av,this.__Aw,this.__Ax,this.__Ay)});
},members:{__Au:c+n+p+k+f,__AJ:{"Text Formatting":"Format some text with underline, bold, italic, ...","Alignment":"Align the text on the right side.","Lists":"Insert a numbered or bullet point list.","Redo/Undo":"Try reverting your changes by using the undo button."},__Av:{"Inserting":h},__Aw:{"pages/gui_toolkit/ui_html_editing.html":o},__Ax:{"#bom~HtmlArea.html":l,"#widget~HtmlArea.html":b},__Ay:{"#qx.bom.htmlarea":m,"#qx.ui.toolbar":g,"#qx.ui.menubar":j,"#qx.ui.menu":d}}});
})();
(function(){var j="Form",i="Form Controller for Binding",h="Form showcase",g="Data bound form",f="widgets. The widgets are grouped by type.",e="Double column form renderer",d="Multi page form",c="showcase.page.form.Content",b="Custom form renderer",a="Form Renderer",v="Form validation",u="form",t="This form demo shows the complete set of form ",s="showcase/form/icon.png",r="Data binding form controller",q="showcase.page.form.Page",p="Default form renderer",o="Form handling",n="Complete set of form widgets.",m="Try cycling through the widgets by pressing the tab key.",k="Form renderer using placeholders",l="Form Package";
qx.Class.define(q,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:j,part:u,icon:s,contentClass:c,description:showcase.page.DescriptionBuilder.build(j,this.__Au,this.__AJ,this.__Av,this.__Aw,this.__Ax,this.__Ay)});
},members:{__Au:t+f,__AJ:{"Selection":"Open the select box to see the list of selectables.","Text":"The placeholder disappears once you start to type in a text field.","Buttons":"Hold the repeat button to see the value increase.","MenuButton":"Click the \"MenuButton\" to open the menu."},__Av:{"Widgets":n,"Keyboard Navigation":m},__Aw:{"pages/gui_toolkit/ui_form_handling.html":o},__Ax:{"#ui~FormRenderer.html":p,"#ui~FormRendererCustom.html":b,"#ui~FormRendererDouble.html":e,"#ui~FormRendererPlaceholder.html":k,"#ui~FormValidator.html":v,"#ui~MultiPageForm.html":d,"#showcase~Form.html":h,"#data~FormController.html":r,"#data~Form.html":g},__Ay:{"#qx.ui.form":l,"#qx.ui.form.renderer":a,"#qx.data.controller.Form":i}}});
})();
...
(function(){var s="resize",r="engine.name",q="relative",p="mshtml",o="height",n="",m="px",l="position",k="engine.version",h="qx.ui.root.Inline",c="$$widget",g="opera",f="div",b="left",a="hidden",d="appear";
qx.Class.define(h,{extend:qx.ui.root.Abstract,include:[qx.ui.core.MLayoutHandling],construct:function(t,u,v){this.__kT=t;
t.style.overflow=a;
t.style.textAlign=b;
this.__kU=u||false;
this.__kV=v||false;
...
qx.ui.core.queue.Layout.add(this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
if((qx.core.Environment.get(r)==g)){this.setSelectable(true);
}if((qx.core.Environment.get(r)==p)){this.setKeepFocus(true);
}var window=qx.dom.Node.getWindow(t);
qx.event.Registration.addListener(window,s,this._onWindowResize,this);
},members:{__kU:false,__kV:false,__kT:null,__kW:function(){if(this.__kU||this.__kV){var w=qx.bom.element.Dimension.getSize(this.__kT);

if(this.__kU&&w.width<1){throw new Error("The root element "+this.__kT+" of "+this+" needs a width when its width size should be used!");
}
if(this.__kV){if(w.height<1){throw new Error("The root element "+this.__kT+" of "+this+" needs a height when its height size should be used!");
}if(w.height>=1&&qx.bom.element.Style.get(this.__kT,o,3)==n){qx.bom.element.Style.set(this.__kT,o,w.height+m);
}}qx.event.Registration.addListener(this.__kT,s,this._onResize,this);
}},_createContainerElement:function(){var x=this.__kT;

if(this.__kU||this.__kV){var B=document.createElement(f);
x.appendChild(B);
if((qx.core.Environment.get(r)==p)&&qx.core.Environment.get(k)==6){var A=qx.dom.Node.getBodyElement(x);
var z;
var D;
var C=false;
...
if((F.oldWidth!==F.width)&&this.__kU||(F.oldHeight!==F.height)&&this.__kV){qx.ui.core.queue.Layout.add(this);
}},_onWindowResize:function(){if(qx.ui.popup&&qx.ui.popup.Manager){qx.ui.popup.Manager.getInstance().hideAll();
}if(qx.ui.menu&&qx.ui.menu.Manager){qx.ui.menu.Manager.getInstance().hideAll();
}},_computeSizeHint:function(){var K=this.__kU;
var H=this.__kV;
...
if(K){var J=L.getContentWidth(this.__kT);
G.width=J;
G.minWidth=J;
G.maxWidth=J;
}
if(H){var I=L.getContentHeight(this.__kT);
G.height=I;
G.minHeight=I;
G.maxHeight=I;
}return G;
}},defer:function(M,N){qx.ui.core.MLayoutHandling.remap(N);
},destruct:function(){qx.event.Registration.removeListener(this.__kT,s,this._onResize,this);
this.__kT=null;
}});
})();
...
(function(){var j="Table",i="Column auto sizing",h="Table with 10000 rows and 50 columns",g="Filtered Table Model",f="in that the table data can be of any length (e.g. hundreds of thousands",e="The table is a very powerful widget. It is “virtual” ",d="Custom cell renderers like the boolean cell renderer can be configured.",c="Windowed cell editor",b="Table selection modes",a="table",y="showcase.page.table.Page",x="Cell editors",w="Remote table model",v="Custom header renderers as shown in the “Explicit” column can be used.",u="Table with a fixed first column",t=" rendered. The data you currently see is fetched from a ",s="Conditional cell renderer",r="<a href='http://developer.yahoo.com/yql/' target='_blank'>YQL</a> ",q="Basic table",p=" of rows or more) yet only the rows which are actually being viewed are",n="showcase/table/icon.png",o="service so it's always up to date.",l="Table events",m="Column context menus",k="showcase.page.table.Content";
qx.Class.define(y,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:j,part:a,icon:n,contentClass:k,description:showcase.page.DescriptionBuilder.build(j,this.__Au,this.__AJ,this.__Av,this.__Aw,this.__Ax,this.__Ay)});
},members:{__Au:e+f+p+t+r+o,__AJ:{"Sorting":"Click on the column header to sort the column.","Reordering":"Drag the column header to reorder.","Column Resizing":"Drag the column header separator to resize the columns.","Hide Columns":"Use the column drop-down menu in the upper right corner.","Table Resize":"Resize the window to see the table resize."},__Av:{"Cell Renderer":d,"Header Renderer":v},__Aw:{"pages/widget/table_remote_model.html":w},__Ax:{"#table~Table.html":q,"#table~Table_Cell_Editor.html":x,"#table~Table_Conditional.html":s,"#table~Table_Context_Menu.html":m,"#table~Table_Events.html":l,"#table~Table_Filtered_Model.html":g,"#table~Table_Huge.html":h,"#table~Table_Meta_Columns.html":u,"#table~Table_Resize_Columns.html":i,"#table~Table_Selection.html":b,"#table~Table_Window_Editor.html":c},__Ay:{"#qx.ui.table.Table":j}}});
})();
(function(){var m="Drag &amp; Drop",l="showcase.page.dragdrop.Page",k="right displays the shopping cart. The main idea of this demo is to ",j="Drag &amp; Drop with lists",i="showcase/dragdrop/icon.png",h="Widget Drag Event",g="Drag & Drop",f="dragdrop",e="showcase.page.dragdrop.Content",d="illustrate the drag & drop feature.",a="The list on the left contains all available items while the list on the ",c="Drag&amp;Drop Cursor",b="These two list widgets simulate a shopping system. ";
qx.Class.define(l,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:g,part:f,icon:i,contentClass:e,description:showcase.page.DescriptionBuilder.build(m,this.__Au,this.__AJ,this.__Av,this.__Aw,this.__Ax,this.__Ay)});
},members:{__Au:b+a+k+d,__AJ:{"Drag":"Try moving an item to the cart.","Reorder":"You can reorder both lists.","Move":"You can also move items back to the shop."},__Av:null,__Aw:{"pages/gui_toolkit/ui_dragdrop.html":m},__Ax:{"#ui~DragDrop.html":j},__Ay:{"#qx.ui.core.Widget~drag":h,"#qx.ui.core.DragDropCursor":c}}});
})();
...
(function(){var s="1.5.1",r="http://demo.qooxdoo.org/",q="<h1>",p="</div>",o="<p>",n="",m="</p>",l="<h2>Demos</h2>",k="showcase.page.DescriptionBuilder",j="</h1>",d="<div id='description'>",i="http://manual.qooxdoo.org/",g="<h2>Api</h2>",c="/demobrowser/",b="/",f="/apiviewer/",e="<h2>Features</h2>",h="<h2>Documentation</h2>",a="<h2>Try This</h2>";
qx.Class.define(k,{statics:{_demoPrefix:r+s+c,_apiPrefix:r+s+f,_manualPrefix:i+s+b,build:function(t,u,v,w,x,y,z){var A=[];
A.push(d,q,t,j,o,u,m);

if(v){A.push(a,this.__AN(v));
}
if(w){A.push(e,this.__AN(w));
}
if(x){A.push(h,this.__AM(this._manualPrefix,x));
}
if(y){A.push(l,this.__AM(this._demoPrefix,y));
}
if(z){A.push(g,this.__AM(this._apiPrefix,z));
}A.push(p);
return A.join(n);
},__AM:function(B,C){var D=["<ul>"];

for(var E in C){D.push("<li><a href='",B,E,"' target='_blank'>",C[E],"</a></li>");
}D.push("</ul>");
return D.join("");
},__AN:function(F){var G=["<ul>"];
...
(function(){var p="Internationalization",o="and comprises locale information of virtually every country in the world.",n=" locales in its user interface. qooxdoo has full translation support ",m="files, as defined by GNU <em>gettext</em> tools. Many ",l="open source tools can process those translation files.",k="showcase.page.i18n.Page",j="Localization demo",i="showcase/i18n/icon.png",h="Languages",g="Translation data is extracted into standard <em>.po</em> ",c='Internationalization (or \"I18N\" for short) is all about making',f=" a system support different natural languages and",e="showcase.page.i18n.Content",b="i18n",a="All widgets are designed in a way that allows for locale switching in the running application.",d="Locale Package";
qx.Class.define(k,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:h,part:b,icon:i,contentClass:e,description:showcase.page.DescriptionBuilder.build(p,this.__Au,this.__AJ,this.__Av,this.__Aw,this.__Ax,this.__Ay)});
},members:{__Au:c+f+n+o,__AJ:{"Change the language":"Hit one of the flag buttons on the top to change "+"the language. All labels on the page will be translated, including "+"labels in standard qooxdoo widgets like the calendar.","Change the country":"The first select box on the left lets you change the country code. "+"The country code defines things like date or number formats. Try "+"changing the country code from <em>United States</em> to "+"<em>Great Britain</em>. You will see that e.g. the start of the week "+"changes from Sunday to Monday.","Open the command menu":"The command menu button in the lower left opens a popup menu. Even the "+"keyboard shortcuts are localized."},__Av:{"Standards based translation":g+m+l,"CLDR":"Localisation data like date and time formats are taken from the "+"<a href='http://cldr.unicode.org/'>Unicode Common Locale Data Repository</a> (CLDR). This "+"guarantees that qooxdoo uses the standardized data for even the smallest "+"countries.","Live locale switching":a},__Aw:{"pages/development/internationalization.html":p},__Ax:{"#showcase~Localization.html":j},__Ay:{"#qx.locale":d}}});
})();
(function(){var u="Virtual List",t="You can bind model values with the rendered widget.",s=" advantages when there is a huge amount of model items to render",r=" because the virtual infrastructure only creates widgets for visible",q="showcase/virtuallist/icon.png",p="Filtering example",o="List overview",n="List delegate",m="You can sort the list with a custom algorithm.",l="virtuallist",e="showcase.page.virtuallist.Content",k="You can use a filter to hide model items.",h=" items and reuses them. This saves both creation time and memory.",c="Custom rendering example",b=" multi selection).",g="You can configure the used widgets or create your own.",f="Grouping example",i="showcase.page.virtuallist.Page",a="Using the virtual infrastructure has considerable",j="You can define a group for each mode item.",d="You can use different selection modes (single selection,";
qx.Class.define(i,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:u,part:l,icon:q,contentClass:e,description:showcase.page.DescriptionBuilder.build(u,this.__Au,this.__AJ,this.__Av,this.__Aw,this.__Ax,this.__Ay)});
},members:{__Au:a+s+r+h,__AJ:{"Close Group":"Click on the arrow of a group item to close the group.","Change User Data":"Select a user and change values for e.g. status.","Add User":"Press the add user button and enter name and group.","Delete User":"Select a user and press the delete button."},__Av:{"Filtering":k,"Sorting":m,"Grouping":j,"Selection":d+b,"Data Binding":t,"Custom Rendering":g},__Aw:{"pages/widget/virtuallist.html":u},__Ax:{"#virtual~List.html":o,"#virtual~ListWithFilter.html":p,"#virtual~ExtendedList.html":c,"#virtual~GroupedList.html":f},__Ay:{"#qx.ui.list.List":u,"#qx.ui.list.core.IListDelegate":n}}});
})();
...
if(j){this.__kI(j,l);
}if(k!=null){this.__kH.setInsets(k);
}}else{this.__kH=new qx.ui.decoration.BoxDiv(j,k,l);
}},properties:{baseImage:{check:b,nullable:true,apply:e}},members:{__kH:null,_isHorizontal:null,_setOrientation:function(m){this._isHorizontal=m==h;
},getMarkup:function(){return this.__kH.getMarkup();
},resize:function(n,o,p){this.__kH.resize(n,o,p);
},tint:function(q,r){},getInsets:function(){return this.__kH.getInsets();
},_applyInsets:function(s,t,name){var u=f+qx.lang.String.firstUp(name);
this.__kH[u](s);
},_applyBaseImage:function(v,w){if(this.__kH instanceof qx.ui.decoration.BoxDiv){this.__kH.setBaseImage(v);
}else{this.__kI(v);
}},__kI:function(x){this.__kH.setBorderImage(x);
...
(function(){var j="Data Binding",i="Form Binding Demo",h="The data is loaded from twitter in real time via JSONP.",g="binding. The demo fetches the data and binds the result to the list. ",f="JSONP Data Store",e="showcase/databinding/icon.png",d="Single Value Binding Demo",c="showcase.page.databinding.Content",b="showcase.page.databinding.Page",a="Data Binding Package",y="Controller",x="Twitter offers a REST / JSONP API, making it a perfect match for data ",w="Data Stores",v="data",u="The twitter demo illustrates the use of data binding. ",t="Tree Binding Demo",s="Data Binding Concepts",r="Object Controller",q="A binding connects the model to the list view.",p="Flickr Foto Search",n="List Binding Demo",o="List Controller",l="Clicking on a tweet will invoke a second binding which displays the ",m="selected tweet in the detail view right beside the list.",k="Fundamental Layer";
qx.Class.define(b,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:j,part:v,icon:e,contentClass:c,description:showcase.page.DescriptionBuilder.build(j,this.__Au,this.__AJ,this.__Av,this.__Aw,this.__Ax,this.__Ay)});
},members:{__Au:u+x+g+l+m,__AJ:{"Detail View":"Clicking a tweet in the list shows the details.","Change Tweet":"Enter your twitter username in the text field and press \"Show\" to see your recent tweets."},__Av:{"Loading Data":h,"Binding":q},__Aw:{"pages/data_binding/data_binding.html":s,"pages/data_binding/single_value_binding.html":k,"pages/data_binding/controller.html":y,"pages/data_binding/stores.html":w},__Ax:{"#data~SingleValueBinding.html":d,"#data~ListControllerWith3Widgets.html":n,"#data~TreeController.html":t,"#data~FormController.html":i,"#data~Flickr.html":p},__Ay:{"#qx.data":a,"#qx.data.store.Jsonp":f,"#qx.data.controller.List":o,"#qx.data.controller.Object":r}}});
})();
...
(function(){var r="Tree",q="Configurable Tree",p="The two tree views display some hierarchical data ",o="Each tree item has a configurable label and icon.",n="showcase.page.tree.Page",m="Tree folders can display additional information in separate columns.",l="Tree filled with Data from a JSON file.",k="including folders, icons and labels. The tree in the right window has ",j="Tree using Data Binding",i="Tree using Data Binding with configuration",c="Tree displays scrollbars if necessary.",h="some additional infomation attached to each item.",f="showcase.page.tree.Content",b="showcase/tree/icon.png",a="Tree Package",e="The Tree Widget",d="Multi Column Tree",g="tree";
qx.Class.define(n,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:r,part:g,icon:b,contentClass:f,description:showcase.page.DescriptionBuilder.build(r,this.__Au,this.__AJ,this.__Av,this.__Aw,this.__Ax,this.__Ay)});
},members:{__Au:p+k+h,__AJ:{"Expand":"Try expanding some folders by using the arrow icon or double clicking.","Resize":"Resize the window to make the tree scrollbars appear.","Selection":"Select multiple items, e.g. by holding the Shift key."},__Av:{"Configurable":o,"Scrolling":c,"Multi Columns":m},__Aw:{"pages/widget/tree.html":e},__Ax:{"#widget~Tree.html":q,"#widget~Tree_Columns.html":d,"#data~TreeController.html":j,"#data~JsonToTree.html":l,"#data~ExtendedTree.html":i},__Ay:{"#qx.ui.tree":a}}});
})();
...
(function(){var k="complete",j="display",h="_applySelectedPage",g="Boolean",f="showcase/images/welcome.png",e="showcase.Application",d="stack",c="showcase/images/loading66.gif",b="selection[0]",a="selection[0].readyState",I="none",H="value",G="__nw",F="__Bk",E="__Bi",D="selection[0].description",C="showcase",B="name",A="icon",z="selectedPage",r="showcase.Page",s="state",p="_applyShowLoadIndicator",q="en_US",n="page-preview",o="50%",l="mshtml",m="engine.name",t="update",u="block",w="selection[0].part",v="showLoadIndicator",y="__Bj",x="__cb";
qx.Class.define(e,{extend:qx.application.Inline,properties:{selectedPage:{check:r,apply:h,nullable:true},showLoadIndicator:{check:g,init:false,apply:p}},members:{__cb:null,__Bh:null,__Bi:null,__nw:null,__Bj:null,__Bk:null,main:function(){qx.application.Inline.prototype.main.call(this);
...
this.__cb=new qx.ui.container.Stack();
this.__cb.set({appearance:d,maxWidth:600,allowGrowX:false});
J.add(this.__cb,{row:T,column:0});
var N=new qx.ui.basic.Image(f).set({allowGrowX:true,allowGrowY:true,allowShrinkX:true,padding:[5,0,0,180]});
this.__cb.add(N);
this.__Bi=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var Q=new qx.ui.basic.Image(c).set({marginLeft:-33});
this.__Bi.add(Q,{left:o,top:200});
this.__cb.add(this.__Bi);
this.__nw=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
this.__cb.add(this.__nw);
this.__Bk=new showcase.ui.Description();
J.add(this.__Bk,{row:T++,column:1});
this.__Bk.exclude();
...
S.setIconPath(A);
S.bind(b,this,z);
S.bind(D,this.__Bk,H);
S.bind(a,this,v,{converter:function(U){return U!==k;
}});
...
}}},_applyShowLoadIndicator:function(W){if(W){this.__cb.setSelection([this.__Bi]);
}else{this.__cb.setSelection([this.__nw]);
...
this.__Bl();
}}},_showPage:function(bb){this.__Bk.show();
bb.load(function(bc){if(this.getSelectedPage()==bc){var bd=bc.getContent().getView();
this.__nw.add(bd,{edge:0});
bd.show();
this.__Bm(bd);
}},this);
},__Bl:function(){if(this.__Bj){this.__Bj.cancel();
this.__Bj.dispose();
this.__Bj=null;
}},__Bm:function(be){if(qx.core.Environment.get(m)==l){return;
}be.getContentElement().setStyle(j,I,true);
this.__Bl();
qx.event.Timer.once(function(){var bf=be.getContentElement().getDomElement();
this.__Bj=new qx.fx.effect.core.Fade(bf);
this.__Bj.set({from:0,to:1});
this.__Bj.addListenerOnce(t,function(){be.getContentElement().setStyle(j,u);
},this);
this.__Bj.start();
},this,0);
}},destruct:function(){this._disposeObjects(x,E,G,F,y);
}});
})();
...
},properties:{appearance:{refine:true,init:k},allowGrowX:{refine:true,init:false},nativeContextMenu:{init:true,refine:true},allowGrowY:{refine:true,init:true}},members:{__Bn:function(){var D=[A,t,i,C,u,z,j,n,a,i,j,s,B,j,y,b,v,f,h,j,d,e,g,q,l,h,j,x,m,j,p,i,j,c,w,j];
...
},members:{__sx:null,__sy:null,_createView:function(){var bt=new qx.ui.layout.Grid();
bt.setRowFlex(1,1);
...
bn.addListener(f,this.__sB,this);
bn.addListener(g,this.__sA,this);
bn.addListener(h,this.__sz,this);
bn.addListener(k,this.__sD,this);
bn.addListener(j,this.__sC,this);
...
bs.addListener(f,this.__sB,this);
bs.addListener(g,this.__sA,this);
bs.addListener(h,this.__sz,this);
bs.addListener(k,this.__sD,this);
bs.addListener(j,this.__sC,this);
...
return bu;
},__sz:function(e){var bw=e.getData(m);
...
}}},__sA:function(e){var bA=e.getTarget();
var bz=bA.getSelection().concat();
e.addData(m,bz);
},__sB:function(e){e.addType(m);
e.addAction(z);
var bB=e.getTarget().getSelection()[0];
this.__sx.set({label:bB.getLabel(),icon:bB.getIcon(),width:bB.getBounds().width});
},__sC:function(e){this.__sy&&this.__sy.removeState(n);
this.__sx.setDomPosition(-1000,-1000);
},__sD:function(e){var bC=e.getOriginalTarget();

if(bC instanceof qx.ui.form.ListItem){if(bC!=this.__sy){this.__sy&&this.__sy.removeState(n);
bC.addState(n);
this.__sy=bC;
}}else{this.__sy&&this.__sy.removeState(n);
}this.__sx.setDomPosition(e.getDocumentLeft()+15,e.getDocumentTop()+15);
}}});
})();
