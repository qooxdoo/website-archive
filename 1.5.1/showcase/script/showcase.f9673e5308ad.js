...
},members:{__io:null,__st:null,_createView:function(){var bO=new qx.ui.layout.Grid(10,15);
bO.setColumnFlex(0,1);
bO.setColumnFlex(1,1);
var bN=new qx.ui.container.Composite(bO).set({padding:10});
bN.add(this.__su(),{row:0,column:0,colSpan:2});
bN.add(this.__sv(),{row:1,column:0});
bN.add(this.__sw(),{row:1,column:1});
return bN;
},__su:function(){var bQ=new qx.ui.form.RadioButtonGroup(new qx.ui.layout.HBox(10).set({alignX:bL}));
var bR=this.__io=qx.data.marshal.Json.createModel([{language:bC,selected:null,countries:[{code:z,name:bF},{code:N,name:I}]},{language:P,selected:null,countries:[{code:by,name:bt},{code:bG,name:ba}]},{language:c,selected:null,countries:[{code:U,name:b},{code:X,name:bf}]},{language:k,selected:null,countries:[{code:h,name:bv}]},{language:S,selected:null,countries:[{code:q,name:O}]}]);
...
this.__st.bind(bg,this,L);
return bQ;
},setCountry:function(bT){if(bT){var bU=this.__st.getSelection().getItem(0);
...
}},__sv:function(){var ck=new qx.ui.layout.Grid(10,10);
...
this.__st.bind(M,cj,bB);
this.__st.bind(W,cj,bp);
cj.bind(bp,this.__st,W);
...
return ch;
},__sw:function(){var ct=new qx.ui.groupbox.GroupBox(this.tr(w),y).set({width:0,minWidth:0,allowGrowY:true});
