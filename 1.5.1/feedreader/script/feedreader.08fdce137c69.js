...
(function(){var m="separator-vertical",l="Posts",k="bold",j="_applyLoading",i="center",h="feedreader.view.List",g="__cb",f="single",e="__BK",d="middle",a="feedreader/images/loading66.gif",c="__Bi",b="Boolean";
...
this._add(this.__cb,{flex:1});
this.__BK=new qx.ui.form.List();
this.__BK.setDecorator(null);
this.__BK.setSelectionMode(f);
this.__BK.setPadding(0);
this.__BK.setMargin(0);
this.__cb.add(this.__BK);
this.__Bi=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,i));
var n=new qx.ui.basic.Image(a);
n.setAlignY(d);
this.__Bi.add(n);
this.__cb.add(this.__Bi);
},properties:{loading:{check:b,init:false,apply:j}},members:{__cb:null,__BK:null,__Bi:null,_applyLoading:function(q,r){if(q){this.__cb.setSelection([this.__Bi]);
}else{this.__cb.setSelection([this.__BK]);
}},getList:function(){return this.__BK;
}},destruct:function(){this._disposeObjects(e,g,c);
}});
})();
...
if(!feedreader.view.Article.__BL){feedreader.view.Article.__BL=true;
...
(function(){var l="execute",k="settings",j="loading",h="main",g="addfeed",f="selection[0]",d="north",c="new",b="changeModel",a="__BW",V="__BQ",U="__BU",T="article",S="__BY",R="__Ca",Q="F1",P="selection[0].state",O="partLoaded",N="Control+A",M="loaded",s="icon/22/places/folder.png",t="feedreader/images/loading22.gif",q="error",r="change",o="user",p="__Cb",m="enabled",n="__BS",u="__BV",v="__BR",C="__BX",A="state",G="__Cd",E="Control+D",I="icon/22/actions/process-stop.png",H="selection[0].articles",x="static",L="icon/22/apps/internet-feed-reader.png",K="model",J="feedreader.Application",w="Control+P",y="__Cc",z="__pG",B="Control+R",D="feedreader.model.Feed",F="__BT";
qx.Class.define(J,{extend:qx.application.Standalone,members:{__BQ:null,__BR:null,__BH:null,__BS:null,__pG:null,__BT:null,__BU:null,__BV:null,__BW:null,__BX:null,__BY:null,__Ca:null,__Cb:null,__Cc:null,__Cd:null,__Ce:false,__Cf:false,main:function(){qx.application.Standalone.prototype.main.call(this);
qx.io.PartLoader.getInstance().addListener(O,function(e){this.debug("part loaded: "+e.getData().getName());
},this);
...
this.__Cb=Y.getFeedFolder();
this.__Cd=Y.getStaticFeedFolder();
this.__Cc=Y.getUserFeedFolder();
this._setUpBinding();
this.__BS.getRoot().setOpen(true);
this.__BS.getRoot().getChildren()[0].setOpen(true);
this.__BS.getRoot().getChildren()[1].setOpen(true);
this.__BS.setHideRoot(true);
this.__BQ.getSelection().push(this.__Cd.getFeeds().getItem(0));
this.reload();
},_setUpBinding:function(){var ba={converter:this._state2iconConverter};
this.__BQ=new qx.data.controller.Tree(this.__Cb,this.__BS,"feeds","title");
this.__BQ.setIconOptions(ba);
this.__BQ.setIconPath(A);
this.__BR=new qx.data.controller.List(null,this.__BU.getList(),"title");
this.__BQ.bind(H,this.__BR,K);
this.__BR.bind(f,this.__BY,T);
this.__BR.getSelection().addListener(r,this._listControllerChange,this);
this.__BR.addListener(b,this._treeControllerChange,this);
var bb={converter:this._state2loadingConverter};
this.__BQ.bind(P,this.__BU,j,bb);
bb={converter:this._category2enabledConverter};
this.__BQ.bind(f,this.__BT.getRemoveButton(),m,bb);
},_category2enabledConverter:function(bc){return !!bc&&bc.getCategory()==o;
},_state2iconConverter:function(bd){if(bd==c||bd==j){return t;
}else if(bd==M){return L;
}else if(bd==q){return I;
}return s;
},_state2loadingConverter:function(be){if(be==c||be==j){return true;
}return false;
},_listControllerChange:function(bf){var bg=this.__BQ.getSelection().getItem(0);
var bh=this.__BR.getSelection().getItem(0);
if(bh!=undefined){bg.setSelectedArticle(bh);
}},_treeControllerChange:function(bi){var bj=this.__BQ.getSelection().getItem(0);
if(bj!=null&&bj.classname==D&&bj.getSelectedArticle()!=null&&bj.getArticles().contains(bj.getSelectedArticle())){qx.event.Timer.once(function(){this.__BR.getSelection().push(bj.getSelectedArticle());
},this,0);
}else{this.__BU.getList().scrollToY(0);
...
bl.add(this.__pG,{edge:d});
this.__BT=new feedreader.view.ToolBar(this);
bl.add(this.__BT,{edge:d});
this.__BV=new qx.ui.splitpane.Pane();
bl.add(this.__BV);
this.__BS=new qx.ui.tree.Tree();
this.__BS.setWidth(250);
this.__BS.setDecorator(h);
this.__BS.setPadding(0);
this.__BV.add(this.__BS,0);
this.__BW=new qx.ui.splitpane.Pane("vertical");
this.__BW.setDecorator(null);
this.__BV.add(this.__BW,1);
this.__BU=new feedreader.view.List(this.__Cb);
this.__BU.setHeight(200);
this.__BU.setDecorator(h);
this.__BW.add(this.__BU,0);
this.__BY=new feedreader.view.Article();
this.__BY.setDecorator(h);
this.__BW.add(this.__BY,1);
},_initializeCommands:function(){var bm={};
bm.reload=new qx.ui.core.Command(B);
bm.reload.addListener(l,this.reload,this);
bm.about=new qx.ui.core.Command(Q);
bm.about.addListener(l,this.showAbout,this);
bm.preferences=new qx.ui.core.Command(w);
bm.preferences.addListener(l,this.showPreferences,this);
bm.addFeed=new qx.ui.core.Command(N);
...
this.__BH=bm;
},getCommand:function(bn){return this.__BH[bn];
},addFeed:function(bo,bp,bq){var br=new feedreader.model.Feed(bo,bp,bq);
this.__Cc.getFeeds().push(br);
var bs=feedreader.io.FeedLoader.getInstance();
bs.load(br);
},removeFeed:function(){var bt=this.__BQ.getSelection().getItem(0);
if(bt&&bt.getCategory&&bt.getCategory()!==x){var bu=this.__Cc.getFeeds();
for(var i=0;i<bu.length;i++){if(bt===bu.getItem(i)){bu.splice(i,1);
return;
}}}},reload:function(){var bv=feedreader.io.FeedLoader.getInstance();
bv.loadAll(this.__Cb);
this.__BY.setArticle(null);
},showPreferences:function(){if(!this.__Cf){this.__BT.signalLoading(k,true);
}qx.io.PartLoader.require([k],function(){this.__Cf=true;
if(!this.__BX){this.__BX=new feedreader.view.PreferenceWindow();
this.getRoot().add(this.__BX);
}this.__BX.center();
this.__BX.open();
this.__BT.signalLoading(k,false);
},this);
},showAbout:function(){alert(this.tr("FeedReader (qooxdoo powered)"));
},showAddFeed:function(){if(!this.__Ce){this.__BT.signalLoading(g,true);
}qx.io.PartLoader.require([g],function(){this.__Ce=true;
if(!this.__Ca){this.__Ca=new feedreader.view.AddFeedWindow(this);
this.getRoot().add(this.__Ca);
}this.__Ca.center();
this.__Ca.open();
this.__BT.signalLoading(g,false);
},this);
}},destruct:function(){this.__BH=null;
this._disposeObjects(F,U,S,n,p,u,a,z,G,y,V,v,C,R);
}});
})();
...
(function(){var k="enabled",j="originalIcon",i="__mw",h=")",g="Remove feed",f="Preferences",d="excluded",c="addFeed",b="removeFeed",a="icon/22/actions/help-about.png",H="Reload the feeds. (%1)",G="Help",F="visible",E="feedreader.view.ToolBar",D="icon/22/actions/media-seek-forward.png",C="toolbar-button",B="Add feed",A="addfeed",z="icon/22/actions/view-refresh.png",y="(",r="reload",s="showItem",p="settings",q="about",n="icon/22/actions/dialog-cancel.png",o="Reload",l="preferences",m="icon/22/actions/dialog-ok.png",t="icon/22/apps/preferences-theme.png",u="__Ch",w="hideItem",v="Open preferences window.",x="feedreader/images/loading22.gif";
qx.Class.define(E,{extend:qx.ui.toolbar.ToolBar,construct:function(I){qx.ui.toolbar.ToolBar.call(this);
this.__mu={};
this.__Cg=new qx.ui.toolbar.Button(this.tr(B),m);
this.__Cg.setCommand(I.getCommand(c));
this.add(this.__Cg);
this.__Ch=new qx.ui.toolbar.Button(this.tr(g),n);
this.__Ch.setCommand(I.getCommand(b));
this.__Ch.setEnabled(false);
this.add(this.__Ch);
this.addSeparator();
var L=new qx.ui.toolbar.Button(this.tr(o),z);
var J=I.getCommand(r);
L.setCommand(J);
L.setToolTipText(this.tr(H,J.toString()));
this.add(L);
this.addSeparator();
this.__Ci=new qx.ui.toolbar.Button(this.tr(f),t);
this.__Ci.setCommand(I.getCommand(l));
this.__Ci.setToolTipText(this.tr(v));
this.add(this.__Ci);
this.addSpacer();
...
},members:{__Ch:null,__mw:null,__mu:null,__Cg:null,__Ci:null,getRemoveButton:function(){return this.__Ch;
...
Q.setVisibility(d);
},_getMenuItem:function(S){var T=this.__mu[S.toHashCode()];
...
this.__mu[S.toHashCode()]=T;
}return T;
},signalLoading:function(U,V){if(U==A){var W=this.__Cg;
}else if(U==p){var W=this.__Ci;
}else{return ;
