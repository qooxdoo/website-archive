...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Animation.4d0f84938e70.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="swipe",b="pinch",c="event.dispatchevent",d="longtap",e="rotate",f="track",g="trackstart",h="trackend",i="tap",j="qx.module.event.GestureHandler",k="roll",l="dbltap";qx.Bootstrap.define(j,{statics:{TYPES:[i,d,a,l,f,g,h,k,e,b],register:function(n,m){if(!n.__CV){n.__CV=0;}
...
;n.__CV++ ;}
,unregister:function(o){if(o.$$gestureHandler){o.__CV-- ;if(o.__CV===0){o.$$gestureHandler.dispose();o.$$gestureHandler=null;}
;}
;}
...
;}
;return B;}
,getAncestors:function(E){return this.__mv(null,E);}
,getAncestorsUntil:function(G,F){return this.__mv(G,F);}
,__mv:function(I,J){var H=[];for(var i=0;i<this.length;i++ ){var parent=qx.dom.Element.getParentElement(this[i]);while(parent){var K=[parent];if(I&&qx.bom.Selector.matches(I,K).length>0){break;}
...
;return be;}
,getNextAll:function(bh){var bg=qx.module.Traversing.__mz(this,f,bh);return qxWeb.$init(bg,qxWeb);}
...
;return bn;}
,getPrevAll:function(bq){var bp=qx.module.Traversing.__mz(this,k,bq);return qxWeb.$init(bp,qxWeb);}
...
,getSiblings:function(bx){var bw=qx.module.Traversing.__mz(this,n,bx);return qxWeb.$init(bw,qxWeb);}
...
,__mw:function(bE){if(bE instanceof qxWeb){return bE[0];}
else if(qx.Bootstrap.isString(bE)){return qxWeb(bE)[0];}
;return bE;}
,isElement:function(bF){return qx.dom.Node.isElement(qx.module.Traversing.__mw(bF));}
,isNode:function(bG){return qx.dom.Node.isNode(qx.module.Traversing.__mw(bG));}
,isNodeName:function(bI,bH){return qx.dom.Node.isNodeName(qx.module.Traversing.__mw(bI),bH);}
...
,getWindow:function(bL){return qx.dom.Node.getWindow(qx.module.Traversing.__mw(bL));}
...
,getDocument:function(bO){return qx.dom.Node.getDocument(qx.module.Traversing.__mw(bO));}
,getNodeName:function(bP){return qx.dom.Node.getName(qx.module.Traversing.__mw(bP));}
,getNodeText:function(bQ){return qx.dom.Node.getText(qx.module.Traversing.__mw(bQ));}
,isBlockNode:function(bR){return qx.dom.Node.isBlockNode(qx.module.Traversing.__mw(bR));}
,equalNodes:function(cb,cd){cb=qx.module.Traversing.__mx(cb);cd=qx.module.Traversing.__mx(cd);if(!cb||!cd){return false;}
...
;}
;if(ca){var bS=qx.module.Traversing.__my(cb);var cc=qx.module.Traversing.__my(cd);for(var bU in bS){if(bS[bU]!==cc[bU]){return false;}
;}
;}
...
;}
;var Y,bb=[];for(var i=0,l=X.length;i<l;i++ ){Y=X[i];if(typeof Y===k){Y=this.__mu(Y,bc);}
...
,appendTo:function(parent){parent=qx.module.Manipulating.__mA(parent);for(var i=0,l=parent.length;i<l;i++ ){this._forEachElement(function(r,j){if(i==0){qx.dom.Element.insertEnd(this[j],parent[i]);}
else {qx.dom.Element.insertEnd(this.eq(j).clone(true)[0],parent[i]);}
;}
);}
;return this;}
,insertBefore:function(s){s=qx.module.Manipulating.__mA(s);for(var i=0,l=s.length;i<l;i++ ){this._forEachElement(function(t,u){if(i==0){qx.dom.Element.insertBefore(t,s[i]);}
else {qx.dom.Element.insertBefore(this.eq(u).clone(true)[0],s[i]);}
;}
);}
;return this;}
,insertAfter:function(v){v=qx.module.Manipulating.__mA(v);for(var i=0,l=v.length;i<l;i++ ){for(var j=this.length-1;j>=0;j-- ){if(!this[j]||this[j].nodeType!==1){continue;}
;if(i==0){qx.dom.Element.insertAfter(this[j],v[i]);}
else {qx.dom.Element.insertAfter(this.eq(j).clone(true)[0],v[i]);}
;}
;}
;return this;}
,__mA:function(x){if(!qx.lang.Type.isArray(x)){var w=qxWeb(x);x=w.length>0?w:[x];}
;return x.filter(function(y){return (y&&(y.nodeType===1||y.nodeType===11));}
);}
,wrap:function(z){z=qx.module.Manipulating.__mB(z);if(z.length==0){return this;}
;this._forEachElement(function(A){var B=z.eq(0).clone(true);qx.dom.Element.insertAfter(B[0],A);var C=qx.module.Manipulating.__mC(B[0]);qx.dom.Element.insertEnd(A,C);}
);return this;}
,__mB:function(F){var D;if(qx.lang.Type.isArray(F)){D=qxWeb(F);}
else {var E=qx.bom.Html.clean([F]);if(E.length>0&&qx.dom.Node.isElement(E[0])){D=qxWeb(E);}
else {D=qxWeb(F);}
;}
;return D;}
,__mC:function(G){if(G.childNodes.length==0){return G;}
;for(var i=0,l=G.childNodes.length;i<l;i++ ){if(G.childNodes[i].nodeType===1){return this.__mC(G.childNodes[i]);}
;}
;return G;}
...
;return U.scrollTop;}
,_animationDescription:{scrollLeft:{duration:700,timing:c,keep:100,keyFrames:{'0':{},'100':{scrollLeft:1}}},scrollTop:{duration:700,timing:c,keep:100,keyFrames:{'0':{},'100':{scrollTop:1}}}},__mD:function(W,X,V){var Y=qx.lang.Object.clone(qx.module.Manipulating._animationDescription[W],true);Y.keyFrames[100][W]=X;return this.animate(Y,V);}
,setScrollLeft:function(bb,bc){var Node=qx.dom.Node;if(bc&&qx.bom.element&&qx.bom.element.AnimationJs){qx.module.Manipulating.__mD.bind(this,a,bb,bc)();}
...
;}
;return this;}
,setScrollTop:function(be,bf){var Node=qx.dom.Node;if(bf&&qx.bom.element&&qx.bom.element.AnimationJs){qx.module.Manipulating.__mD.bind(this,d,be,bf)();}
