...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.SlideBar","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SlideBar.282a830ec0c9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="display.png",b="drive-optical.png",c="computer.png",d="audio-card.png",f="battery.png",g="main",h="Toggle size",j="icon/48/devices/",k="drive-harddisk.png",l="changeValue",m="camera-web.png",n="network-wired.png",o="input-keyboard.png",p="camera-photo.png",q="network-wireless.png",r="audio-input-microphone.png",s="demobrowser.demo.widget.SlideBar";qx.Class.define(s,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var u=new qx.ui.container.SlideBar();u.set({width:300});u.setLayout(new qx.ui.layout.HBox(3));var v=[d,r,f,p,m,c,a,k,b,o,n,q];for(var i=0;i<v.length;i++ ){u.add((new qx.ui.basic.Image(j+v[i])).set({decorator:g,padding:4}));}
;var t=new qx.ui.form.ToggleButton(h);t.addListener(l,function(e){u.setWidth(e.getData()?800:300);}
);this.getRoot().add(t,{left:20,top:100});this.getRoot().add(u,{left:20,top:20});}
}});}
)();
