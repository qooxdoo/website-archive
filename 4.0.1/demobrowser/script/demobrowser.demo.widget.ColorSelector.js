...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorSelector.8b914e7e8399.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,setValue:function(da){var cY;if(da==null){this.__nF=true;cY=[255,255,255];}
else {cY=qx.util.ColorUtil.stringToRgb(da);this.__nF=false;}
;this.__wA=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__wA=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__nF?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__nF=true;this.__wA=true;this.setRed(255);this.setGreen(255);this.__wA=false;this.setBlue(255);}
,__nH:function(){if(!this.__wA){this.__nF=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dc,db){if(this.__wu===null){this.__wu=bU;}
;if(this.__wu!==cK){this.getChildControl(m).setValue(dc);}
;if(this.__wu!==n){this._setHexFromRgb();}
;switch(this.__wu){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__nH();if(this.__wu===bU){this.__wu=null;}
;}
,_applyGreen:function(de,dd){if(this.__wu===null){this.__wu=cq;}
;if(this.__wu!==cK){this.getChildControl(O).setValue(de);}
;if(this.__wu!==n){this._setHexFromRgb();}
;switch(this.__wu){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__nH();if(this.__wu===cq){this.__wu=null;}
;}
,_applyBlue:function(dg,df){if(this.__wu===null){this.__wu=d;}
;if(this.__wu!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__wu!==n){this._setHexFromRgb();}
;switch(this.__wu){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__nH();if(this.__wu===d){this.__wu=null;}
;}
,_applyHue:function(di,dh){if(this.__wu===null){this.__wu=cr;}
;if(this.__wu!==F){this.getChildControl(cu).setValue(di);}
;if(this.__wu!==R){if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomLeft(Math.round(di/1.40625)+this.getChildControl(cc).getPaddingLeft());}
else {this.getChildControl(V).setLayoutProperties({left:Math.round(di/1.40625)});}
;}
;switch(this.__wu){case F:case R:case cr:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__wu===cr){this.__wu=null;}
;}
,_applySaturation:function(dk,dj){if(this.__wu===null){this.__wu=s;}
;if(this.__wu!==F){this.getChildControl(cx).setValue(dk);}
;if(this.__wu!==R){this._setBrightnessGradiant();if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomTop(256-Math.round(dk*2.56)+this.getChildControl(cc).getPaddingTop());}
else {this.getChildControl(V).setLayoutProperties({top:256-Math.round(dk*2.56)});}
;}
;switch(this.__wu){case F:case R:case s:this._setRgbFromHue();};if(this.__wu===s){this.__wu=null;}
;}
,_applyBrightness:function(dn,dm){if(this.__wu===null){this.__wu=c;}
;if(this.__wu!==F){this.getChildControl(bT).setValue(dn);}
;if(this.__wu!==P){var dl=256-Math.round(dn*2.56);if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dl+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cM).setLayoutProperties({top:dl});}
;}
;switch(this.__wu){case F:case P:case c:this._setRgbFromHue();};if(this.__wu===c){this.__wu=null;}
;}
,_onBrightnessHandlePointerDown:function(e){this.getChildControl(cM).capture();this.__ww=cM;var dr=this.getChildControl(cf).getContentLocation();var dq=this.getChildControl(cM).getContentLocation();var dp=this.getChildControl(cf).getBounds();this.__wx=dr.top+(e.getDocumentTop()-dq.top)-dp.top;e.stopPropagation();}
,_onBrightnessHandlePointerUp:function(e){this.getChildControl(cM).releaseCapture();this.__ww=null;}
,_onBrightnessHandlePointerMove:function(e){if(this.__ww===cM){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldPointerDown:function(e){var location=this.getChildControl(cf).getContentLocation();var ds=this.getChildControl(cM).getBounds();this.__wx=location.top+(ds.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cM).capture();this.__ww=cM;}
...
,_setBrightnessOnFieldEvent:function(e){var dt=qx.lang.Number.limit(e.getDocumentTop()-this.__wx,0,256);this.__wu=P;if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dt);}
else {this.getChildControl(cM).setLayoutProperties({top:dt});}
;this.setBrightness(100-Math.round(dt/2.56));this.__wu=null;}
,_onHueSaturationHandlePointerUp:function(e){if(this.__ww){e.stopPropagation();this.getChildControl(V).releaseCapture();this.__ww=null;}
;}
,_onHueSaturationHandlePointerMove:function(e){if(this.__ww===V){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldPointerDown:function(e){var location=this.getChildControl(ca).getContentLocation();var du=this.getChildControl(V).getBounds();var dv=this.getChildControl(ca).getBounds();this.__wy=location.top+(du.height/2)-dv.top;this.__wz=location.left+(du.width/2)-dv.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(V).capture();this.__ww=V;}
...
,_setHueSaturationOnFieldEvent:function(e){var dy=qx.lang.Number.limit(e.getDocumentTop()-this.__wy,0,256);var dx=qx.lang.Number.limit(e.getDocumentLeft()-this.__wz,0,256);this.getChildControl(V).setDomPosition(dx,dy);this.__wu=R;this.setSaturation(100-Math.round(dy/2.56));this.setHue(Math.round(dx*1.40625));this.__wu=null;}
,_setRedFromSpinner:function(){if(this.__wu!==null){return;}
;this.__wu=cK;this.setRed(this.getChildControl(m).getValue());this.__wu=null;}
,_setGreenFromSpinner:function(){if(this.__wu!==null){return;}
;this.__wu=cK;this.setGreen(this.getChildControl(O).getValue());this.__wu=null;}
,_setBlueFromSpinner:function(){if(this.__wu!==null){return;}
;this.__wu=cK;this.setBlue(this.getChildControl(cG).getValue());this.__wu=null;}
,_setHueFromSpinner:function(){if(this.__wu!==null){return;}
;this.__wu=F;this.setHue(this.getChildControl(cu).getValue());this.__wu=null;}
,_setSaturationFromSpinner:function(){if(this.__wu!==null){return;}
;this.__wu=F;this.setSaturation(this.getChildControl(cx).getValue());this.__wu=null;}
,_setBrightnessFromSpinner:function(){if(this.__wu!==null){return;}
;this.__wu=F;this.setBrightness(this.getChildControl(bT).getValue());this.__wu=null;}
,_onHexFieldChange:function(e){if(this.__wu!==null){return;}
;try{var dA=this.getChildControl(cD);var dz=qx.util.ColorUtil.hexStringToRgb(J+dA.getValue());}
catch(dB){return;}
;this.__wu=n;this.setRed(dz[0]);this.setGreen(dz[1]);this.setBlue(dz[2]);this.__wu=null;}
...
,_setHueFromRgb:function(){switch(this.__wu){case F:case R:case P:break;default:var dF=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dF[0]);this.setSaturation(dF[1]);this.setBrightness(dF[2]);};}
,_setRgbFromHue:function(){switch(this.__wu){case cK:case n:break;default:var dG=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dG[0]);this.setGreen(dG[1]);this.setBlue(dG[2]);};}
