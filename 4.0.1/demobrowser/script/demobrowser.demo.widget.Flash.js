...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.83538a7b7cf2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="__cv",c="Flash Player Version",d="right",f="qooxdoo is the best!",g="Message from Flash:",h="execute",i="Simple demo with FlashVars",j="bgcolor",k="demobrowser.demo.widget.Flash",l="demobrowser/demo/flash/TestFlash.swf",m="__Pb",n="1) no pop-up or advertising blocker is activated.\n",o="Send to Flash",p="demobrowser/demo/flash/FlashVersion.swf",q="No message.",r="Flash:",s="<b>qooxdoo:</b>",t="demobrowser.demo.widget.Flash.sendMessage",u="demobrowser.demo.widget.Flash.flashReady",v="Couldn't connect to Flash Player! Please make sure that:\n",w="demobrowser/demo/flash/fo_tester.swf",x="this is passed in via FlashVars",y="Two way communication (ActionScript <-> JavaScript)",z="__Pa",A="__Pc",B="Message to Flash:",C="__Dx",D="Show Flash Player version",E="noscale",F="#FF6600";qx.Class.define(k,{extend:qx.application.Standalone,members:{__cv:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(i);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(y);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cv=this.createWindow();G.add(this.__cv,{top:20,left:20});}
,createWindow:function(){var K=new qx.ui.window.Window(c).set({width:300,height:200,contentPadding:[0,0,0,0]});K.setLayout(new qx.ui.layout.Canvas());K.add(new qx.ui.embed.Flash(p),{edge:0});return K;}
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:x};var M=new qx.ui.embed.Flash(w).set({scale:E,variables:L});M.getContentElement().setParam(j,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(D);O.addListener(h,function(){this.__cv.open();}
,this);N.add(O);return N;}
,__Dx:null,__Pa:null,__Pb:null,__Pc:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(s).set({rich:true}));Q.add(new qx.ui.basic.Label(g));this.__Pa=new qx.ui.form.TextArea(q);this.__Pa.setEnabled(false);Q.add(this.__Pa,{flex:1});Q.add(new qx.ui.basic.Label(B));this.__Pb=new qx.ui.form.TextArea(f);Q.add(this.__Pb,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,d));this.__Pc=new qx.ui.form.Button(o);this.__Pc.setEnabled(false);this.__Pc.addListener(h,function(e){this.__Dx.getFlashElement().sendMessage(this.__Pb.getValue());}
,this);S.add(this.__Pc);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(r).set({rich:true}));this.__Dx=new qx.ui.embed.Flash(l);this.__Dx.setVariables({init:u});P.add(this.__Dx,{flex:1});return R;}
,sendMessage:function(T){this.__Pa.setValue(T);}
,initFlash:function(){if(this.__Dx.getFlashElement().setup){this.__Dx.getFlashElement().setup(t);this.__Pc.setEnabled(true);}
else {alert(v+n+a);}
;}
},statics:{__Pd:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__Pd=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__Pd.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__Pd.initFlash();}
},destruct:function(){this._disposeObjects(z,m,A,C,b);}
});}
)();
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__Ds){this.__Ds=new Date().getTime();}
;var bp=new Date().getTime()-this.__Ds;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__Ds=null;}
;}
else {this.fireEvent(p);this.__Ds=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__Dt(c,bB);}
,_applyScale:function(bD,bC){this.__Dt(h,bD);}
,_applyWmode:function(bF,bE){this.__Dt(m,bF);}
,_applyPlay:function(bH,bG){this.__Dt(I,bH);}
,_applyLoop:function(bJ,bI){this.__Dt(s,bJ);}
,_applyMenu:function(bL,bK){this.__Dt(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__Dt(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__Dt(z,bP);}
,__Dt:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__Du={};this.__Dv={};this.__Dw={};}
,members:{__Du:null,__Dw:null,__Dv:null,__Dx:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__Dx=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__Dv,this.__Du);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__Dx){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__Dx){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__Dv;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__Dx){throw new Error(d);}
;this.__Dv=t;}
,getAttributes:function(){return this.__Dw;}
...
else if(this.__Dx){throw new Error(j);}
;if(v===null||v===undefined){delete this.__Dw[u];}
else {this.__Dw[u]=v;}
;}
,getParams:function(){return this.__Du;}
...
;}
;}
;if(this.__Dx){throw new Error(l);}
;if(x===null||x===undefined){delete this.__Du[w];}
else {this.__Du[w]=x;}
;}
,getFlashElement:function(){return this.__Dx;}
},destruct:function(){if(this.__Dx){qx.bom.Flash.destroy(this.__Dx);}
;this.__Du=this.__Dv=this.__Dw=null;}
});}
)();
...
;}
;}
;var O=this.__DD(P,R,Q,M);this._flashObjects[R.id]=O;return O;}
,destroy:function(T,S){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){T=this.__Dy(T);if(T.readyState==4){this.__Dz(T);}
else {if(!S){S=window;}
;qx.bom.Event.addNativeListener(S,p,function(){qx.bom.Flash.__Dz(T);}
);}
;}
else {T=this.__Dy(T);if(T.parentNode){T.parentNode.removeChild(T);}
;delete this._flashObjects[T.id];}
;}
,__Dy:function(U){if(!U){throw new Error(z);}
;if(U.tagName.toLowerCase()!==L){U=U.firstChild;}
;if(!U||U.tagName.toLowerCase()!==L){throw new Error(A);}
;return U;}
,__Dz:qx.core.Environment.select(D,{"mshtml":qx.event.GlobalError.observeMethod(function(V){for(var i in V){if(typeof V[i]==b){V[i]=null;}
;}
;if(V.parentNode){V.parentNode.removeChild(V);}
;delete this._flashObjects[V.id];}
),"default":null}),__DA:qx.event.GlobalError.observeMethod(function(){for(var W in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[W]);}
;window.__DB=function(){}
;window.__DC=function(){}
;qx.bom.Event.removeNativeListener(window,F,qx.bom.Flash.__DA);}
),__DD:function(bb,bd,bc,X){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){bc.movie=bd.data;delete bd.data;delete bd.classid;var Y=u;for(var name in bc){Y+=m+name+J+bc[name]+E;}
...
},defer:function(bf){if(qx.core.Environment.get(D)==v){qx.bom.Event.addNativeListener(window,F,bf.__DA);}
;}
});}
)();
(function(){var a="qx.util.TimerManager",b="interval",c="singleton";qx.Class.define(a,{extend:qx.core.Object,type:c,statics:{__DE:[],__DF:{},__sl:0},members:{__DG:false,start:function(g,f,h,d,j){if(!j){j=f||0;}
;var e=(new Date()).getTime()+j;this.self(arguments).__DF[ ++this.self(arguments).__sl]={callback:g,userData:d||null,expireAt:e,recurTime:f,context:h||this};this.__DH(e,this.self(arguments).__sl);return this.self(arguments).__sl;}
,stop:function(k){var l=this.self(arguments).__DE;var length=l.length;for(var i=0;i<length;i++ ){if(l[i]==k){l.splice(i,1);break;}
;}
;delete this.self(arguments).__DF[k];if(l.length==0&&this.__DG){qx.event.Idle.getInstance().removeListener(b,this.__DI,this);this.__DG=false;}
;}
,__DH:function(m,p){var o=this.self(arguments).__DE;var n=this.self(arguments).__DF;var length=o.length;for(var i=0;i<length;i++ ){if(n[o[i]].expireAt>m){o.splice(i,0,p);break;}
;}
;if(o.length==length){o.push(p);}
;if(!this.__DG){qx.event.Idle.getInstance().addListener(b,this.__DI,this);this.__DG=true;}
;}
,__DI:function(){var r=(new Date()).getTime();var t=this.self(arguments).__DE;var s=this.self(arguments).__DF;while(t.length>0&&s[t[0]].expireAt<=r){var v=t.shift();var q=s[v];q.callback.call(q.context,q.userData,v);if(q.recurTime&&s[v]){var u=(new Date()).getTime();q.expireAt=u+q.recurTime;this.__DH(q.expireAt,v);}
else {delete s[v];}
;}
;if(t.length==0&&this.__DG){qx.event.Idle.getInstance().removeListener(b,this.__DI,this);this.__DG=false;}
;}
}});}
)();
