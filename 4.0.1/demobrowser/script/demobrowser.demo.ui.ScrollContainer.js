...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.ScrollContainer","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.ScrollContainer.db5691118334.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="scrollAnimationYEnd",b="Scroll down",c="Toggle size",d="demobrowser.demo.ui.ScrollContainer",e="blue",f="red",g="execute",h="Animate down";qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var j=new qx.ui.container.Scroll();j.set({width:300,height:200});j.add(this.generateBoxes());this.getRoot().add(j,{left:10,top:50});var i=new qx.ui.form.Button(c);var k=true;i.addListener(g,function(){j.setWidth(k?800:300);k=!k;}
);this.getRoot().add(i,{left:10,top:10});var scroll=new qx.ui.form.Button(b);scroll.addListener(g,function(){j.scrollByY(150);}
);this.getRoot().add(scroll,{left:110,top:10});var l=new qx.ui.form.Button(h);l.addListener(g,function(){j.scrollByY(150,300);l.setEnabled(false);}
);this.getRoot().add(l,{left:210,top:10});j.addListener(a,function(){l.setEnabled(true);}
);}
,generateBoxes:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.Grid());for(var y=0;y<20;y++ ){for(var x=0;x<10;x++ ){m.add((new qx.ui.core.Widget()).set({backgroundColor:((x+y)%2==0)?f:e,width:60,allowShrinkY:false,allowShrinkX:false,height:60}),{column:x,row:y});}
;}
;return m;}
}});}
)();
