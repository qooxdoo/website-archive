...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Blocker.df13f9edbde9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__eo();}
,members:{__Hm:null,__wI:null,__Hn:null,__Ho:false,__Hp:10000,__Hq:0,__Hr:f,block:function(r){if(!this.__Ho){this.__Hn=r;var q=this.__Hu();this.__Hv(q);this.__Ho=true;}
;}
,unblock:function(){if(this.__Ho){this.__Hw();this.__Ho=false;}
;}
...
,__eo:function(){this.__Hs();if((qx.core.Environment.get(j)==b)){this.__Ht();}
;qx.event.Registration.addListener(window,a,this.__zF,this);}
,__Hs:function(){this.__wI=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__wI,{display:d,opacity:this.__Hq,backgroundColor:this.__Hr});this.setBlockerZIndex(this.__Hp);}
,__Ht:function(){this.__Hm=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__Hm,l,false);qx.bom.element.Attribute.set(this.__Hm,i,n);qx.bom.element.Style.setStyles(this.__Hm,{display:d,opacity:this.__Hq});}
,__Hu:function(){var v={position:p};if(this.__Hy()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__Hn)+g;v.height=qx.bom.element.Dimension.getHeight(this.__Hn)+g;v.left=qx.bom.element.Location.getLeft(this.__Hn)+g;v.top=qx.bom.element.Location.getTop(this.__Hn)+g;}
;return v;}
,__Hv:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__wI,w);qx.dom.Element.insertEnd(this.__wI,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Hm,w);qx.dom.Element.insertEnd(this.__Hm,document.body);}
;}
,__Hw:function(){qx.dom.Element.remove(this.__wI);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__Hm);}
;}
,__zF:function(e){if(this.__Hy()){this.__Hx({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__Hx(y);}
,this,0);}
;}
,__Hx:function(z){qx.bom.element.Style.setStyles(this.__wI,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__Hm,z);}
;}
,__Hy:function(){return (this.__Hn==null||qx.dom.Node.isWindow(this.__Hn)||qx.dom.Node.isDocument(this.__Hn));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__zF,this);this.__Hm=this.__wI=this.__Hn=null;}
});}
)();
