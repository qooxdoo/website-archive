...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SplitPane.71ce54774868.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="first",b="Show first pane",c="Documents (D:)",d="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",f="Windows (C:)",g="Toggle Splitpane Orientation",h="__xN",j="Inbox",k="Desktop",l="Trash",m="both",n="_container1",o="execute",p="):",q="Presets",r="Network",s="value",t="changeSelection",u="Sent",v="Offset (",w="/",x="offset",y="Files",z="_container2",A="vertical",B="Workspace",C="Junk #",D="second",E="main",F="Data",G="horizontal",H="Show both panes",I="Show second pane",J="demobrowser.demo.widget.SplitPane",K="Edit";qx.Class.define(J,{extend:qx.application.Standalone,members:{__xN:null,main:function(){qx.application.Standalone.prototype.main.call(this);var M=new qx.ui.container.Scroll();var L=new qx.ui.container.Composite(new qx.ui.layout.Basic());L.setAllowStretchX(false);M.add(L);var T=new qx.ui.splitpane.Pane(G).set({width:450,height:300});this.__xN=T;var X=new qx.ui.container.Composite(new qx.ui.layout.Grow).set({width:200,height:100,decorator:E});var W=new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({padding:10,maxWidth:450,decorator:E});var P=this.__Pm();var O=new qx.ui.form.Button(g).set({allowGrowX:false,allowGrowY:false});O.addListener(o,this._toggle,this);var R=new qx.ui.basic.Label(d);R.setRich(true);X.add(P);W.add(O);W.add(R);this._container1=X;this._container2=W;T.add(X,0);T.add(W,1);L.add(T,{left:20,top:40});this.getRoot().add(M,{edge:0});var N=new qx.ui.layout.VBox(5);var U=new qx.ui.container.Composite(N);var Y=new qx.ui.form.RadioButton(b);var ba=new qx.ui.form.RadioButton(I);var bb=new qx.ui.form.RadioButton(H);Y.setUserData(s,a);ba.setUserData(s,D);bb.setUserData(s,m);bb.setValue(true);U.add(Y);U.add(ba);U.add(bb);var Q=new qx.ui.form.RadioGroup(Y,ba,bb);Q.addListener(t,this._changeVisiblity,this);L.add(U,{left:490,top:42});O.focus();var S=new qx.ui.basic.Label();this.getRoot().add(S,{left:490,top:120});var V=new qx.ui.form.Slider().set({minimum:0,maximum:30,value:6,width:100});this.getRoot().add(V,{left:490,top:140});V.bind(s,T,x);V.bind(s,S,s,{converter:function(bc){return v+bc+p;}
});}
,_toggle:function(){var bd=this.__xN.getOrientation();this.__xN.setOrientation(bd==G?A:G);}
,_changeVisiblity:function(e){var be=e.getData()[0].getUserData(s);if(be==m){this._container1.show();this._container2.show();}
else if(be==a){this._container1.show();this._container2.exclude();}
else if(be==D){this._container1.exclude();this._container2.show();}
;}
,__Pm:function(){var bo=new qx.ui.tree.Tree();bo.setDecorator(null);var bt=new qx.ui.tree.TreeFolder(w);bt.setOpen(true);bo.setRoot(bt);var br=new qx.ui.tree.TreeFolder(k);br.setOpen(true);bt.add(br);var bj=new qx.ui.tree.TreeFolder(y);var bh=new qx.ui.tree.TreeFolder(B);var bi=new qx.ui.tree.TreeFolder(r);var bg=new qx.ui.tree.TreeFolder(l);br.add(bj,bh,bi,bg);var bp=new qx.ui.tree.TreeFile(f);var bf=new qx.ui.tree.TreeFile(c);bh.add(bp,bf);var bs=new qx.ui.tree.TreeFolder(j);var bk=new qx.ui.tree.TreeFolder(q);var bn=new qx.ui.tree.TreeFolder(u);var bm=new qx.ui.tree.TreeFolder(l);for(var i=0;i<100;i++ ){bm.add(new qx.ui.tree.TreeFile(C+i));}
;var bq=new qx.ui.tree.TreeFolder(F);var bl=new qx.ui.tree.TreeFolder(K);bs.add(bk,bn,bm,bq,bl);bt.add(bs);return bo;}
},destruct:function(){this._disposeObjects(h,n,z);}
});}
)();
...
(function(){var a="slider",b="splitter",c="px",d="Integer",f="height",g="move",h="maxHeight",i="resize",j="pointerup",k="vertical",l="width",m="_applyOrientation",n="_applyOffset",o="splitpane",p="qx.ui.splitpane.Pane",q="pointerdown",r="top",s="minHeight",t="knob",u="horizontal",v="minWidth",w="appear",z="losecapture",A="left",B="pointermove",C="maxWidth",D="pointerout";qx.Class.define(p,{extend:qx.ui.core.Widget,construct:function(E){qx.ui.core.Widget.call(this);this.__gI=[];if(E){this.setOrientation(E);}
else {this.initOrientation();}
;this.__lL.addListener(q,this._onPointerDown,this);this.__lL.addListener(j,this._onPointerUp,this);this.__lL.addListener(B,this._onPointerMove,this);this.__lL.addListener(D,this._onPointerOut,this);this.__lL.addListener(z,this._onPointerUp,this);}
,properties:{appearance:{refine:true,init:o},offset:{check:d,init:6,apply:n},orientation:{init:u,check:[u,k],apply:m}},members:{__mP:null,__mQ:false,__mR:null,__mS:null,__mT:null,__mU:null,__mV:null,__gI:null,__lL:null,_createChildControlImpl:function(H,G){var F;switch(H){case a:F=new qx.ui.splitpane.Slider(this);F.exclude();this._add(F,{type:H});break;case b:F=new qx.ui.splitpane.Splitter(this);this._add(F,{type:H});F.addListener(g,this.__mW,this);break;};return F||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,H);}
,__mW:function(e){this.__mY(e.getData());}
,__mX:function(K){this.__lL=new qx.ui.splitpane.Blocker(K);this.getContentElement().add(this.__lL);var I=this.getChildControl(b);var J=I.getWidth();if(!J){I.addListenerOnce(w,function(){this.__mY();}
,this);}
;I.addListener(i,function(e){var L=e.getData();if(L.height==0||L.width==0){this.__lL.hide();}
else {this.__lL.show();}
;}
,this);}
,getBlocker:function(){return this.__lL;}
,_applyOrientation:function(Q,N){var R=this.getChildControl(a);var M=this.getChildControl(b);this.__mT=Q===u;if(!this.__lL){this.__mX(Q);}
;this.__lL.setOrientation(Q);var P=this._getLayout();if(P){P.dispose();}
;var O=Q===k?new qx.ui.splitpane.VLayout:new qx.ui.splitpane.HLayout;this._setLayout(O);M.removeState(N);M.addState(Q);M.getChildControl(t).removeState(N);M.getChildControl(t).addState(Q);R.removeState(N);R.addState(Q);qx.ui.core.queue.Manager.flush();this.__mY();}
,_applyOffset:function(T,S){this.__mY();}
,__mY:function(V){var U=this.getChildControl(b);var ba=this.getOffset();var bb=U.getBounds();var Y=U.getContentElement().getDomElement();if(!Y){return;}
;if(this.__mT){var X=null;if(V){X=V.width;}
else if(bb){X=bb.width;}
;var bc=V&&V.left;if(X){if(isNaN(bc)){bc=qx.bom.element.Location.getPosition(Y).left;}
;this.__lL.setWidth(ba,X);this.__lL.setLeft(ba,bc);}
;}
...
;this.__lL.setHeight(ba,W);this.__lL.setTop(ba,top);}
;}
;}
,add:function(be,bd){if(bd==null){this._add(be);}
else {this._add(be,{flex:bd});}
;this.__gI.push(be);}
,remove:function(bf){this._remove(bf);qx.lang.Array.remove(this.__gI,bf);}
,getChildren:function(){return this.__gI;}
,_onPointerDown:function(e){if(!e.isLeftPressed()){return;}
;var bg=this.getChildControl(b);var bj=bg.getContentLocation();var bh=this.getContentLocation();this.__mP=this.__mT?e.getDocumentLeft()-bj.left+bh.left:e.getDocumentTop()-bj.top+bh.top;var bi=this.getChildControl(a);var bk=bg.getBounds();bi.setUserBounds(bk.left,bk.top,bk.width,bk.height);bi.setZIndex(bg.getZIndex()+1);bi.show();this.__mQ=true;this.__lL.capture();e.stop();}
,_onPointerMove:function(e){this._setLastPointerPosition(e.getDocumentLeft(),e.getDocumentTop());if(this.__mQ){this.__na();var bl=this.getChildControl(a);var bm=this.__mU;if(this.__mT){bl.setDomLeft(bm);this.__lL.setStyle(A,(bm-this.getOffset())+c);}
else {bl.setDomTop(bm);this.__lL.setStyle(r,(bm-this.getOffset())+c);}
;e.stop();}
;}
,_onPointerOut:function(e){this._setLastPointerPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onPointerUp:function(e){if(!this.__mQ){return;}
;this._finalizeSizes();var bn=this.getChildControl(a);bn.exclude();this.__mQ=false;this.releaseCapture();e.stop();}
,_finalizeSizes:function(){var br=this.__mU;var bo=this.__mV;if(br==null){return;}
...
else {if(this.__mT){bs.setWidth(br);bq.setWidth(bo);}
else {bs.setHeight(br);bq.setHeight(bo);}
;}
;}
,__na:function(){if(this.__mT){var bx=v,bE=l,by=C,bC=this.__mR;}
else {var bx=s,bE=f,by=h,bC=this.__mS;}
;var bD=this._getChildren();var bv=bD[2].getSizeHint();var bA=bD[3].getSizeHint();var bB=bD[2].getBounds()[bE]+bD[3].getBounds()[bE];var bz=bC-this.__mP;var bw=bB-bz;if(bz<bv[bx]){bw-=bv[bx]-bz;bz=bv[bx];}
else if(bw<bA[bx]){bz-=bA[bx]-bw;bw=bA[bx];}
;if(bz>bv[by]){bw+=bz-bv[by];bz=bv[by];}
else if(bw>bA[by]){bz+=bw-bA[by];bw=bA[by];}
;this.__mU=bz;this.__mV=bw;}
,_isActiveDragSession:function(){return this.__mQ;}
,_setLastPointerPosition:function(x,y){this.__mR=x;this.__mS=y;}
},destruct:function(){this.__gI=null;}
});}
)();
...
(function(){var a="open",b="abstract",c="__pO",d="__gI",e="qx.debug",f="'. It is not a child of this tree item.",g="addItem",h="visible",j="excluded",k="removeItem",m="Invalid child index: ",n="Cannot remove treeitem '",o="qx.ui.tree.core.AbstractTreeItem";qx.Class.define(o,{extend:qx.ui.tree.core.AbstractItem,type:b,construct:function(p){qx.ui.tree.core.AbstractItem.call(this,p);this.__gI=[];}
,properties:{parent:{check:o,nullable:true}},members:{__gI:null,__pO:null,getTree:function(){var r=this;while(r.getParent()){r=r.getParent();}
...
;}
;}
,getChildrenContainer:function(){if(!this.__pO){this.__pO=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?h:j});}
;return this.__pO;}
,hasChildrenContainer:function(){return this.__pO;}
,getParentChildrenContainer:function(){if(this.getParent()){return this.getParent().getChildrenContainer();}
else if(this.getLayoutParent()){return this.getLayoutParent();}
else {return null;}
;}
,getChildren:function(){return this.__gI;}
,hasChildren:function(){return this.__gI?this.__gI.length>0:false;}
...
;}
,__EU:function(){if(this.getParentChildrenContainer()){this.getParentChildrenContainer()._addAfter(this.getChildrenContainer(),this);}
;}
...
;this.__gI.push(Q);if(!N){this.__EU();}
;if(P){Q.recursiveAddToWidgetQueue();P.fireNonBubblingEvent(g,qx.event.type.Data,[Q]);}
;}
;if(P){qx.ui.core.queue.Widget.add(this);}
;}
,addAt:function(X,T){if(qx.core.Environment.get(e)){this.assert(T<=this.__gI.length&&T>=0,m+T);}
;if(T==this.__gI.length){this.add(X);return;}
;var W=X.getParent();if(W){W.remove(X);}
;var U=this.getChildrenContainer();X.setParent(this);var V=this.hasChildren();var S=this.__gI[T];U.addBefore(X,S);if(X.hasChildren()){U.addAfter(X.getChildrenContainer(),X);}
;qx.lang.Array.insertAt(this.__gI,X,T);if(!V){this.__EU();}
;if(this.getTree()){X.recursiveAddToWidgetQueue();qx.ui.core.queue.Widget.add(this);}
;}
,addBefore:function(Y,bb){if(qx.core.Environment.get(e)){this.assert(this.__gI.indexOf(bb)>=0);}
;var ba=Y.getParent();if(ba){ba.remove(Y);}
;this.addAt(Y,this.__gI.indexOf(bb));}
,addAfter:function(bd,bc){if(qx.core.Environment.get(e)){this.assert(this.__gI.indexOf(bc)>=0);}
;var be=bd.getParent();if(be){be.remove(bd);}
;this.addAt(bd,this.__gI.indexOf(bc)+1);}
,addAtBegin:function(bf){this.addAt(bf,0);}
,remove:function(bk){for(var i=0,l=arguments.length;i<l;i++ ){var bj=arguments[i];if(this.__gI.indexOf(bj)==-1){this.warn(n+bj+f);return;}
...
;}
;qx.lang.Array.remove(this.__gI,bj);bj.setParent(null);bg.remove(bj);}
;var bh=this.getTree();if(bh){bh.fireNonBubblingEvent(k,qx.event.type.Data,[bj]);}
;qx.ui.core.queue.Widget.add(this);}
,removeAt:function(bl){var bm=this.__gI[bl];if(bm){this.remove(bm);}
;}
,removeAll:function(){var bn=this.__gI.concat();for(var i=this.__gI.length-1;i>=0;i-- ){this.remove(this.__gI[i]);}
;return bn;}
...
(function(){var a="Enter",b="_applyOpenMode",c="excluded",d="Space",f="Left",g="Boolean",h="changeOpenMode",j="_applyRootOpenClose",k="visible",l="changeSelection",m="__pp",n="qx.ui.tree.Tree",o="qx.event.type.Data",p="qx.ui.tree.core.AbstractTreeItem",q="tree",r="dbltap",s="_applyHideRoot",t="changeRoot",u="_applyRoot",v="keypress",w="none",x="pane",y="tap",z="Right";qx.Class.define(n,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IModelSelection,qx.ui.form.IForm],include:[qx.ui.core.MMultiSelectionHandling,qx.ui.core.MContentPadding,qx.ui.form.MModelSelection,qx.ui.form.MForm],construct:function(){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__pp=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({allowShrinkY:false,allowGrowX:true});this.getChildControl(x).add(this.__pp);this.initOpenMode();this.initRootOpenClose();this.addListener(l,this._onChangeSelection,this);this.addListener(v,this._onKeyPress,this);}
,events:{addItem:o,removeItem:o},properties:{openMode:{check:[y,r,w],init:r,apply:b,event:h,themeable:true},root:{check:p,init:null,nullable:true,event:t,apply:u},hideRoot:{check:g,init:false,apply:s},rootOpenClose:{check:g,init:false,apply:j},appearance:{refine:true,init:q},focusable:{refine:true,init:true}},members:{__pp:null,SELECTION_MANAGER:qx.ui.tree.selection.SelectionManager,getChildrenContainer:function(){return this.__pp;}
