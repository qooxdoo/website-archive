...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.aee9ade15709.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__mq=document||window.document;this.__Fv();var self=this;qx.bom.Event.addNativeListener(this.__mq,this.__he,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__mq:null,__Ft:null,__Fu:null,__he:null,__Fv:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__mq[m]!=undefined){this.__Ft=m;this.__he=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__mq[m]!=undefined){this.__Fu=m;break;}
;}
;if(this.__Ft==null){this.__Ft=k;this.__he=c;}
;if(this.__Fu==null){this.__Fu=b;}
;}
,isHidden:function(){return !!this.__mq[this.__Ft];}
,getVisibilityState:function(){return this.__mq[this.__Fu]||d;}
}});}
)();
