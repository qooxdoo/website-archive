...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.RadioButtonGroup.e87bceaa483d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Boolean",b="_applyValid",c="",d="changeRequired",f="changeValid",g="changeInvalidMessage",h="__tq",j="changeSelection",k="_applyInvalidMessage",l="String",m="qx.ui.form.RadioButtonGroup",n="qx.event.type.Data";qx.Class.define(m,{extend:qx.ui.core.Widget,include:[qx.ui.core.MLayoutHandling,qx.ui.form.MModelSelection],implement:[qx.ui.form.IForm,qx.ui.core.ISingleSelection,qx.ui.form.IModelSelection],construct:function(o){qx.ui.core.Widget.call(this);if(o==null){this.setLayout(new qx.ui.layout.VBox(4));}
else {this.setLayout(o);}
;this.__tq=new qx.ui.form.RadioGroup();this.__tq.addListener(j,function(e){this.fireDataEvent(j,e.getData(),e.getOldData());}
,this);}
,properties:{valid:{check:a,init:true,apply:b,event:f},required:{check:a,init:false,event:d},invalidMessage:{check:l,init:c,event:g,apply:k},requiredInvalidMessage:{check:l,nullable:true,event:g}},events:{"changeSelection":n},members:{__tq:null,_applyInvalidMessage:function(r,p){var q=this._getChildren();for(var i=0;i<q.length;i++ ){q[i].setInvalidMessage(r);}
;}
,_applyValid:function(u,s){var t=this._getChildren();for(var i=0;i<t.length;i++ ){t[i].setValid(u);}
;}
,getRadioGroup:function(){return this.__tq;}
,getChildren:function(){return this._getChildren();}
,add:function(w,v){this.__tq.add(w);this._add(w,v);}
,remove:function(x){this.__tq.remove(x);this._remove(x);}
,removeAll:function(){var y=this.__tq.getItems();for(var i=0;i<y.length;i++ ){this.__tq.remove(y[i]);}
;return this._removeAll();}
,getSelection:function(){return this.__tq.getSelection();}
,setSelection:function(z){this.__tq.setSelection(z);}
,resetSelection:function(){this.__tq.resetSelection();}
,isSelected:function(A){return this.__tq.isSelected(A);}
,isSelectionEmpty:function(){return this.__tq.isSelectionEmpty();}
,getSelectables:function(B){return this.__tq.getSelectables(B);}
},destruct:function(){this._disposeObjects(h);}
});}
)();
