...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.PointerEvent.c3870d6e1838.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__NV=f+p.join(c)+a;this.__NW=o||50;this.__NX=n;this._clearLog();}
,_clearLog:function(){this.__NX.innerHTML=this.__NV+k;this.__NY=[];}
,_log:function(q){this.__NY.unshift(q);this.__NY=this.__NY.slice(0,this.__NW);var r=[this.__NV];for(var i=0;i<this.__NY.length;i++ ){r.push(g,this.__NY[i].join(e),l);}
;r.push(k);this.__NX.innerHTML=r.join(d);this.__NX.scrollTop=0;}
...
;qx.bom.Element.addListener(I,k,this.__Oa,this);}
...
,this);}
,__Oa:function(e){var O=e.getTarget().id.split(u)[1];var M=e.getTarget().checked;var N=document.getElementById(n);if(M){qx.bom.Element.addListener(N,O,this.logPointerEvent,this);}
