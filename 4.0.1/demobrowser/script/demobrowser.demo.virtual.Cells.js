...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells.feb8f1f77d67.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,testStringCell:function(){var J={value:[A,p,r,null],states:[{},{selected:1}]};var I=new qx.ui.virtual.cell.String;qx.util.Permutation.permute(J,function(L){var K=this.__FQ(I,L.value,L.states);this.container.add(K);}
,this);}
...
;var O=this.__FQ(N,P.value,P.states);this.container.add(O);}
,this);}
...
;var S=this.__FQ(R,T.value,T.states);this.container.add(S);}
,this);}
,testHtmlCell:function(){var U={value:[A,p,r,null],states:[{},{selected:1}]};var V=new qx.ui.virtual.cell.Html;qx.util.Permutation.permute(U,function(X){var W=this.__FQ(V,X.value,X.states);this.container.add(W);}
,this);}
,testImageCell:function(){var Y={value:[{url:C,tooltip:E},{url:w,tooltip:u},null],states:[{},{selected:1}]};var ba=new qx.ui.virtual.cell.Image;qx.util.Permutation.permute(Y,function(bc){var bb=this.__FQ(ba,bc.value,bc.states);this.container.add(bb);}
,this);}
,testBooleanCell:function(){var bd={value:[true,false,null],states:[{},{selected:1}]};var be=new qx.ui.virtual.cell.Boolean;qx.util.Permutation.permute(bd,function(bg){var bf=this.__FQ(be,bg.value,bg.states);this.container.add(bf);}
,this);}
,testBooleanCellCustomImage:function(){var bh={value:[true,false,null],states:[{},{selected:1}]};var bi=new qx.ui.virtual.cell.Boolean;bi.setIconFalse(B);bi.setIconTrue(D);qx.util.Permutation.permute(bh,function(bk){var bj=this.__FQ(bi,bk.value,bk.states);this.container.add(bj);}
,this);}
,__FQ:function(bn,bo,bq){var br=100;var bp=30;var bt=new qx.ui.embed.Html().set({width:br,height:bp,decorator:bq.selected?null:z});var bm=bn.getCellProperties(bo,bq);var bl=bm.insets;var bs=[d,F,this._getCellSizeStyle(br,bp,bl[0],bl[1]),bm.style,e,g,bm.classes,e,bm.attributes,l,bm.content,c].join(r);bt.setHtml(bs);return bt;}
...
;if(this.getGroupingUsed()){var B=G;G=m;var J;for(J=B.length;J>3;J-=3){G=m+qx.locale.Number.getGroupSeparator(this.__jV)+B.substring(J-3,J)+G;}
;G=B.substring(0,J)+G;}
;var D=this.getPrefix()?this.getPrefix():m;var A=this.getPostfix()?this.getPostfix():m;var H=D+(C?a:m)+G;if(F.length>0){H+=m+qx.locale.Number.getDecimalSeparator(this.__jV)+F;}
;H+=A;return H;}
,parse:function(T){var P=qx.lang.String.escapeRegexpChars(qx.locale.Number.getGroupSeparator(this.__jV)+m);var N=qx.lang.String.escapeRegexpChars(qx.locale.Number.getDecimalSeparator(this.__jV)+m);var L=new RegExp(d+qx.lang.String.escapeRegexpChars(this.getPrefix())+p+n+P+c+j+N+u+qx.lang.String.escapeRegexpChars(this.getPostfix())+t);var O=L.exec(T);if(O==null){throw new Error(e+T+f);}
...
,members:{__zP:16,__zQ:16,_aliasManager:null,__zS:function(v){var w=qx.util.ResourceManager.getInstance();var u=qx.io.ImageLoader;var t,x;if(w.has(v)){t=w.getImageWidth(v),x=w.getImageHeight(v);}
else if(u.isLoaded(v)){t=u.getWidth(v);x=u.getHeight(v);}
else {t=this.__zP;x=this.__zQ;}
;return {width:t,height:x};}
,__Bs:function(z){if(typeof (z)==r){z={url:z};}
...
(function(){var a="_applyIconFalse",b="qx.ui.virtual.cell.Boolean",c="_applyIconTrue",d="String",e="cell-boolean";qx.Class.define(b,{extend:qx.ui.virtual.cell.AbstractImage,construct:function(){qx.ui.virtual.cell.AbstractImage.call(this);this.__Dm=qx.util.AliasManager.getInstance();}
,properties:{appearance:{refine:true,init:e},iconTrue:{check:d,themeable:true,apply:c},iconFalse:{check:d,themeable:true,apply:a}},members:{__Dn:null,__Do:null,__Dm:null,_applyIconTrue:function(f){this.__Dn=this.__Dm.resolve(f);}
,_applyIconFalse:function(g){this.__Do=this.__Dm.resolve(g);}
,_identifyImage:function(h){return h==true?this.__Dn:this.__Do;}
}});}
)();
