...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.bddc4e377238.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{model:{nullable:true,event:d,apply:g}},members:{_storage:null,__AT:null,_applyModel:function(l,k){if(k){k.removeListenerById(this.__AT);k.dispose();this.__AT=null;}
;if(l){this.__AT=l.addListener(f,this.__AU,this);this.__AU();}
else {this._storage.removeItem(this._key);}
;}
,__AU:function(){var m=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,m);}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__AV:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__AW:null,__AX:null,getLocal:function(){if(this.__AW){return this.__AW;}
;return this.__AW=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__AX){return this.__AX;}
;return this.__AX=new qx.bom.storage.Web(b);}
},construct:function(g){this.__nI=g;}
,members:{__nI:null,getStorage:function(){return window[this.__nI+c];}
,getLength:function(){return this.getStorage(this.__nI).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__nI).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__nI).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__nI).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__nI);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__nI).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__AW:null,__AX:null,__ch:0,getLocal:function(){if(this.__AW){return this.__AW;}
;return this.__AW=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__AX){return this.__AX;}
;return this.__AX=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__AY=document.createElement(f);this.__AY.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__AY);this.__AY.addBehavior(j);this.__Ba=m;this.__AY.load(this.__Ba);this.__fp={};this.__Bb={};var l=this.__AY.getAttribute(d+qx.bom.storage.UserData.__ch);while(l!=undefined){l=qx.lang.Json.parse(l);this.__fp[l.key]=l.value;this.__Bb[l.key]=d+qx.bom.storage.UserData.__ch;qx.bom.storage.UserData.__ch++ ;l=this.__AY.getAttribute(d+qx.bom.storage.UserData.__ch);}
;}
,members:{__AY:null,__Ba:h,__fp:null,__Bb:null,getStorage:function(){return this.__fp;}
,getLength:function(){return Object.keys(this.__fp).length;}
,setItem:function(n,p){if(this.__Bb[n]){var o=this.__Bb[n];}
else {var o=d+qx.bom.storage.UserData.__ch;qx.bom.storage.UserData.__ch++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__AY.setAttribute(o,q);this.__AY.save(this.__Ba);this.__fp[n]=p;this.__Bb[n]=o;}
,getItem:function(r){return this.__fp[r]||null;}
,removeItem:function(v){var u=this.__Bb[v];if(u==undefined){return;}
;this.__AY.removeAttribute(u);qx.bom.storage.UserData.__ch-- ;delete this.__fp[v];delete this.__Bb[v];var t=d+qx.bom.storage.UserData.__ch;if(this.__AY.getAttribute(t)){var w=this.__AY.getAttribute(d+qx.bom.storage.UserData.__ch);this.__AY.removeAttribute(t);this.__AY.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__Bb[s]=u;}
;this.__AY.save(this.__Ba);}
,clear:function(){for(var x in this.__Bb){this.__AY.removeAttribute(this.__Bb[x]);}
;this.__AY.save(this.__Ba);this.__fp={};this.__Bb={};}
,getKey:function(y){return Object.keys(this.__fp)[y];}
,forEach:function(z,B){var length=this.getLength();for(var i=0;i<length;i++ ){var A=this.getKey(i);z.call(B,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__AW:null,__AX:null,getLocal:function(){if(this.__AW){return this.__AW;}
;return this.__AW=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__AX){return this.__AX;}
;return this.__AX=new qx.bom.storage.Memory();}
},construct:function(){this.__fp={};}
,members:{__fp:null,getStorage:function(){return this.__fp;}
,getLength:function(){return Object.keys(this.__fp).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__fp[b]=c;}
,getItem:function(e){var d=this.__fp[e];if(qx.lang.Type.isString(d)){d=qx.lang.Json.parse(d);}
;return d;}
,removeItem:function(f){delete this.__fp[f];}
,clear:function(){this.__fp={};}
,getKey:function(h){var g=Object.keys(this.__fp);return g[h];}
