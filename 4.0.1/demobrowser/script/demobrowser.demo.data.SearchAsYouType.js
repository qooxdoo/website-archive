...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.8ee4f1a24713.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="_applySearchString",b="demobrowser.demo.data.filter.SearchAsYouTypeFilter",c="String",d="";qx.Class.define(b,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__Hz=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__sl=null;}
,properties:{searchString:{check:c,apply:a,init:d}},members:{__sl:null,__Hz:null,_applySearchString:function(h,g){var i=qx.util.TimerManager.getInstance();if(this.__sl!=null){i.stop(this.__sl);this.__sl=null;}
;this.__sl=i.start(function(){this.__Hz.update();this.__sl=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__Hz=null;}
});}
)();
