...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.34aad8c5ece3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__GL].values;var bo=this.__GH[this.__GL];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__GM){bn.shift();}
...
;this.__GJ.setRed(bx);this.__GJ.setGreen(bw);this.__GJ.setBlue(bv);this.__GI.open();}
,_onColorSelectorOk:function(){var by=this.__GJ;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__GI.close();}
,_onColorSelectorCancel:function(){this.__GI.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__GI){this.__GI.destroy();this.__GJ.destroy();this.__GK.destroy();}
;this._tables=this.__GH=null;}
});}
)();
