...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.MenuBar","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.MenuBar.00ac567304e8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Online Forum",b="New",c="icon/16/actions/edit-cut.png",d="icon/16/actions/format-justify-fill.png",f="Search in files",g="C",h="changeValue",i="Left aligned",j="Undo",k="_openCommand",l="Uppercase",m="View",n="C Dialect",o="changeSelection",p="enabled",q="Save as...",r="Show line numbers",s="Search previous...",t="Quickstart",u="Cut",v="Ctrl+N",w="icon/16/actions/edit-paste.png",x="Show console",y="Search",z="Help",A="_redoCommand",B="Redo",C="Show status bar",D="icon/16/actions/format-justify-left.png",E="ANSI to OEM",F="Centered",G="Paragraph",H="Edit",I="Ctrl+O",J="icon/16/actions/document-print.png",K="icon/16/actions/document-open.png",L="C Sharp",M="icon/16/actions/edit-undo.png",N="Close",O="execute",P="icon/16/actions/document-save-as.png",Q="Python",R="icon/16/apps/utilities-help.png",S="Show tree",T="Spaces to tabs",U="Right aligned",V="OEM to ANSI",W="JavaScript",X="demobrowser.demo.widget.MenuBar",Y="_copyCommand",cj="XML",ck="Save",cl="_undoCommand",cf="Capitals",cg="icon/16/actions/application-exit.png",ch="C Plus Plus",ci="_saveCommand",cq="Lowercase",cr="Search next...",cs="_newCommand",ct="Replace in files",cm="Perl",cn="Ctrl+P",co="Topics",cp="Panes",cx="Justified",cW="Ctrl+X",cX="Show macros",cy="Change selection: ",cu="Show ruler",cv="Enabled",df="Copy",cw=" = ",cz="Paste",cA="_pasteCommand",cB="Execute command: ",cF="icon/16/actions/format-justify-right.png",dg="Ctrl+Z",cG="Ctrl+R",cC="icon/16/actions/edit-redo.png",cD="Show tags",de="Info...",cE="Execute button: ",cK="Format",cL="File",cM="Change checked: ",cN="Show tabs",cH="value",cI="Print",dh="icon/16/actions/document-save.png",cJ="icon/16/actions/edit-copy.png",cR="Search...",cS="icon/16/actions/format-justify-center.png",dj="Open",cT="_cutCommand",cO="Objective C",cP="Exit",di="icon/16/actions/system-search.png",cQ="Ctrl+S",cU="Syntax",cV="Ctrl+C",db="icon/16/actions/document-new.png",da="Tabs to spaces",cY="ASCII table",dd="Replace",dc="HTML";qx.Class.define(X,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var dn=new qx.ui.container.Scroll();var dm=new qx.ui.container.Composite(new qx.ui.layout.Canvas);dm.setPadding(20);dm.setAllowStretchX(false);dn.add(dm);this.getRoot().add(dn,{edge:0});this.createCommands();var dk=this.getMenuBar();dm.add(dk,{left:20,top:50});var dl=new qx.ui.form.ToggleButton(cv);dl.setValue(true);dm.add(dl,{left:20,top:10});dl.bind(cH,dk,p);}
,debugRadio:function(e){this.debug(cy+e.getData()[0].getLabel());}
,debugCommand:function(e){this.debug(cB+this.getShortcut());}
,debugButton:function(e){this.debug(cE+this.getLabel());}
,debugCheckBox:function(e){this.debug(cM+this.getLabel()+cw+e.getData());}
,createCommands:function(){this._newCommand=new qx.ui.core.Command(v);this._newCommand.addListener(O,this.debugCommand);this._openCommand=new qx.ui.core.Command(I);this._openCommand.addListener(O,this.debugCommand);this._saveCommand=new qx.ui.core.Command(cQ);this._saveCommand.addListener(O,this.debugCommand);this._undoCommand=new qx.ui.core.Command(dg);this._undoCommand.addListener(O,this.debugCommand);this._redoCommand=new qx.ui.core.Command(cG);this._redoCommand.addListener(O,this.debugCommand);this._cutCommand=new qx.ui.core.Command(cW);this._cutCommand.addListener(O,this.debugCommand);this._copyCommand=new qx.ui.core.Command(cV);this._copyCommand.addListener(O,this.debugCommand);this._pasteCommand=new qx.ui.core.Command(cn);this._pasteCommand.addListener(O,this.debugCommand);this._pasteCommand.setEnabled(false);}
,getMenuBar:function(){var dr=new qx.ui.container.Composite(new qx.ui.layout.Grow);var menubar=new qx.ui.menubar.MenuBar;menubar.setWidth(600);dr.add(menubar);var ds=new qx.ui.menubar.Button(cL,null,this.getFileMenu());var dp=new qx.ui.menubar.Button(H,null,this.getEditMenu());var dq=new qx.ui.menubar.Button(y,null,this.getSearchMenu());var dv=new qx.ui.menubar.Button(m,null,this.getViewMenu());var du=new qx.ui.menubar.Button(cK,null,this.getFormatMenu());var dt=new qx.ui.menubar.Button(z,null,this.getHelpMenu());menubar.add(ds);menubar.add(dp);menubar.add(dq);menubar.add(dv);menubar.add(du);menubar.add(dt);return dr;}
,getFileMenu:function(){var dy=new qx.ui.menu.Menu;var dw=new qx.ui.menu.Button(b,db,this._newCommand);var dA=new qx.ui.menu.Button(dj,K,this._openCommand);var dz=new qx.ui.menu.Button(N);var dD=new qx.ui.menu.Button(ck,dh,this._saveCommand);var dC=new qx.ui.menu.Button(q,P);var dx=new qx.ui.menu.Button(cI,J);var dB=new qx.ui.menu.Button(cP,cg);dw.addListener(O,this.debugButton);dA.addListener(O,this.debugButton);dz.addListener(O,this.debugButton);dD.addListener(O,this.debugButton);dC.addListener(O,this.debugButton);dx.addListener(O,this.debugButton);dB.addListener(O,this.debugButton);dy.add(dw);dy.add(dA);dy.add(dz);dy.add(dD);dy.add(dC);dy.add(dx);dy.add(dB);return dy;}
,getEditMenu:function(){var dF=new qx.ui.menu.Menu;var dI=new qx.ui.menu.Button(j,M,this._undoCommand);var dH=new qx.ui.menu.Button(B,cC,this._redoCommand);var dE=new qx.ui.menu.Button(u,c,this._cutCommand);var dJ=new qx.ui.menu.Button(df,cJ,this._copyCommand);var dG=new qx.ui.menu.Button(cz,w,this._pasteCommand);dI.addListener(O,this.debugButton);dH.addListener(O,this.debugButton);dE.addListener(O,this.debugButton);dJ.addListener(O,this.debugButton);dG.addListener(O,this.debugButton);dF.add(dI);dF.add(dH);dF.addSeparator();dF.add(dE);dF.add(dJ);dF.add(dG);return dF;}
,getSearchMenu:function(){var dN=new qx.ui.menu.Menu;var dL=new qx.ui.menu.Button(cR,di);var dQ=new qx.ui.menu.Button(cr);var dM=new qx.ui.menu.Button(s);var dP=new qx.ui.menu.Button(dd);var dK=new qx.ui.menu.Button(f,di);var dO=new qx.ui.menu.Button(ct);dM.setEnabled(false);dL.addListener(O,this.debugButton);dQ.addListener(O,this.debugButton);dM.addListener(O,this.debugButton);dP.addListener(O,this.debugButton);dK.addListener(O,this.debugButton);dO.addListener(O,this.debugButton);dN.add(dL);dN.add(dQ);dN.add(dM);dN.add(dP);dN.addSeparator();dN.add(dK);dN.add(dO);return dN;}
,getViewMenu:function(){var dR=new qx.ui.menu.Menu;var dT=new qx.ui.menu.Button(cp,null,null,this.getPanesMenu());var dW=new qx.ui.menu.Button(cU,null,null,this.getSyntaxMenu());var dV=new qx.ui.menu.CheckBox(cu);var dU=new qx.ui.menu.CheckBox(r);var dS=new qx.ui.menu.Button(cY);dV.addListener(h,this.debugCheckBox);dU.addListener(h,this.debugCheckBox);dS.addListener(O,this.debugButton);dR.add(dT);dR.add(dW);dR.addSeparator();dR.add(dV);dR.add(dU);dR.addSeparator();dR.add(dS);return dR;}
,getPanesMenu:function(){var dY=new qx.ui.menu.Menu;var eb=new qx.ui.menu.CheckBox(cN);var dX=new qx.ui.menu.CheckBox(C);var ee=new qx.ui.menu.CheckBox(S);var ea=new qx.ui.menu.CheckBox(cX);var ec=new qx.ui.menu.CheckBox(cD);var ed=new qx.ui.menu.CheckBox(x);eb.setValue(true);dX.setValue(true);ea.setValue(true);eb.addListener(h,this.debugCheckBox);dX.addListener(h,this.debugCheckBox);ee.addListener(h,this.debugCheckBox);ea.addListener(h,this.debugCheckBox);ec.addListener(h,this.debugCheckBox);ed.addListener(h,this.debugCheckBox);dY.add(dX);dY.add(eb);dY.addSeparator();dY.add(ee);dY.add(ea);dY.add(ec);dY.add(ed);return dY;}
,getSyntaxMenu:function(){var ej=new qx.ui.menu.Menu;var ef=new qx.ui.menu.RadioButton(dc);var eh=new qx.ui.menu.RadioButton(cj);var eg=new qx.ui.menu.RadioButton(W);var ei=new qx.ui.menu.Button(n,null,null,this.getSyntaxCMenu());var em=new qx.ui.menu.RadioButton(cm);var ek=new qx.ui.menu.RadioButton(Q);ej.add(ef);ej.add(eh);ej.add(eg);ej.add(ei);ej.add(em);ej.add(ek);var el=new qx.ui.form.RadioGroup;el.add(ef,eh,eg,em,ek);el.add.apply(el,ei.getMenu().getChildren());el.addListener(o,this.debugRadio);return ej;}
,getSyntaxCMenu:function(){var eo=new qx.ui.menu.Menu;var en=new qx.ui.menu.RadioButton(g);var er=new qx.ui.menu.RadioButton(L);var ep=new qx.ui.menu.RadioButton(cO);var eq=new qx.ui.menu.RadioButton(ch);eo.add(en);eo.add(er);eo.add(ep);eo.add(eq);return eo;}
,getFormatMenu:function(){var ev=new qx.ui.menu.Menu;var eu=new qx.ui.menu.Button(G,null,null,this.getParagraphMenu());var ex=new qx.ui.menu.Button(da);var ey=new qx.ui.menu.Button(T);var et=new qx.ui.menu.Button(l);var ew=new qx.ui.menu.Button(cq);var es=new qx.ui.menu.Button(cf);var eA=new qx.ui.menu.Button(V);var ez=new qx.ui.menu.Button(E);ex.addListener(O,this.debugButton);ey.addListener(O,this.debugButton);et.addListener(O,this.debugButton);ew.addListener(O,this.debugButton);es.addListener(O,this.debugButton);eA.addListener(O,this.debugButton);ez.addListener(O,this.debugButton);ev.add(eu);ev.add(ex);ev.add(ey);ev.addSeparator();ev.add(et);ev.add(ew);ev.add(es);ev.addSeparator();ev.add(eA);ev.add(ez);return ev;}
,getParagraphMenu:function(){var eB=new qx.ui.menu.Menu;var eF=new qx.ui.menu.Button(i,D);var eE=new qx.ui.menu.Button(U,cF);var eC=new qx.ui.menu.Button(F,cS);var eD=new qx.ui.menu.Button(cx,d);eF.addListener(O,this.debugButton);eE.addListener(O,this.debugButton);eC.addListener(O,this.debugButton);eD.addListener(O,this.debugButton);eB.add(eF);eB.add(eE);eB.add(eC);eB.add(eD);return eB;}
,getHelpMenu:function(){var eG=new qx.ui.menu.Menu;var eI=new qx.ui.menu.Button(co,R);var eK=new qx.ui.menu.Button(t);var eJ=new qx.ui.menu.Button(a);var eH=new qx.ui.menu.Button(de);eI.addListener(O,this.debugButton);eK.addListener(O,this.debugButton);eJ.addListener(O,this.debugButton);eH.addListener(O,this.debugButton);eG.add(eI);eG.add(eK);eG.addSeparator();eG.add(eJ);eG.addSeparator();eG.add(eH);return eG;}
},destruct:function(){this._disposeObjects(cs,k,ci,cl,A,cT,Y,cA);}
});}
)();
...
(function(){var a=" array contains ",b="__gm",c="qx.ui.core.MSingleSelectionHandling",d=" items!",f="changeSelection",g="changeSelected",h="Could only select one item, but the selection",i="qx.event.type.Data";qx.Mixin.define(c,{events:{"changeSelection":i},members:{__gm:null,getSelection:function(){var j=this.__nU().getSelected();if(j){return [j];}
else {return [];}
;}
,setSelection:function(k){switch(k.length){case 0:this.resetSelection();break;case 1:this.__nU().setSelected(k[0]);break;default:throw new Error(h+a+k.length+d);};}
,resetSelection:function(){this.__nU().resetSelected();}
,isSelected:function(l){return this.__nU().isSelected(l);}
,isSelectionEmpty:function(){return this.__nU().isSelectionEmpty();}
,getSelectables:function(m){return this.__nU().getSelectables(m);}
,_onChangeSelected:function(e){var o=e.getData();var n=e.getOldData();o==null?o=[]:o=[o];n==null?n=[]:n=[n];this.fireDataEvent(f,o,n);}
,__nU:function(){if(this.__gm==null){var p=this;this.__gm=new qx.ui.core.SingleSelectionManager({getItems:function(){return p._getItems();}
,isItemSelectable:function(q){if(p._isItemSelectable){return p._isItemSelectable(q);}
else {return q.isVisible();}
;}
});this.__gm.addListener(g,this._onChangeSelected,this);}
;this.__gm.setAllowEmptySelection(this._isAllowEmptySelection());return this.__gm;}
},destruct:function(){this._disposeObjects(b);}
});}
)();
(function(){var a=", because it is not a child element!",b="__nV",c="Boolean",d="__nW",e="qx.ui.core.SingleSelectionManager",f="qx.debug",g="__nX",h="Invalid selectionProvider!",j="Could not check if ",k=" is selected,",l="Could not select ",m="changeSelected",n=" because it is not a child element!",o="qx.event.type.Data";qx.Class.define(e,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);if(qx.core.Environment.get(f)){qx.core.Assert.assertInterface(p,qx.ui.core.ISingleSelectionProvider,h);}
;this.__nV=p;}
,events:{"changeSelected":o},properties:{allowEmptySelection:{check:c,init:true,apply:g}},members:{__nW:null,__nV:null,getSelected:function(){return this.__nW;}
,setSelected:function(q){if(!this.__oa(q)){throw new Error(l+q+a);}
;this.__nY(q);}
,resetSelected:function(){this.__nY(null);}
,isSelected:function(r){if(!this.__oa(r)){throw new Error(j+r+k+n);}
;return this.__nW===r;}
,isSelectionEmpty:function(){return this.__nW==null;}
,getSelectables:function(t){var s=this.__nV.getItems();var u=[];for(var i=0;i<s.length;i++ ){if(this.__nV.isItemSelectable(s[i])){u.push(s[i]);}
;}
;if(!t){for(var i=u.length-1;i>=0;i-- ){if(!u[i].getEnabled()){u.splice(i,1);}
;}
;}
;return u;}
,__nX:function(w,v){if(!w){this.__nY(this.__nW);}
;}
,__nY:function(x){var A=this.__nW;var y=x;if(y!=null&&A===y){return;}
;if(!this.isAllowEmptySelection()&&y==null){var z=this.getSelectables(true)[0];if(z){y=z;}
;}
;this.__nW=y;this.fireDataEvent(m,y,A);}
,__oa:function(B){var C=this.__nV.getItems();for(var i=0;i<C.length;i++ ){if(C[i]===B){return true;}
;}
;return false;}
},destruct:function(){if(this.__nV.toHashCode){this._disposeObjects(b);}
else {this.__nV=null;}
...
(function(){var a="_applyAllowEmptySelection",b="_applyInvalidMessage",c="qx.ui.form.RadioGroup",d="Boolean",f="_applyValid",g="",h="changeRequired",j="__rP",k="changeValid",m="changeEnabled",n="changeInvalidMessage",o="changeSelection",p="changeValue",q="_applyEnabled",r="String";qx.Class.define(c,{extend:qx.core.Object,implement:[qx.ui.core.ISingleSelection,qx.ui.form.IForm,qx.ui.form.IModelSelection],include:[qx.ui.core.MSingleSelectionHandling,qx.ui.form.MModelSelection],construct:function(s){qx.core.Object.call(this);this.__rP=[];this.addListener(o,this.__ob,this);if(s!=null){this.add.apply(this,arguments);}
;}
,properties:{enabled:{check:d,apply:q,event:m,init:true},wrap:{check:d,init:true},allowEmptySelection:{check:d,init:false,apply:a},valid:{check:d,init:true,apply:f,event:k},required:{check:d,init:false,event:h},invalidMessage:{check:r,init:g,event:n,apply:b},requiredInvalidMessage:{check:r,nullable:true,event:n}},members:{__rP:null,getItems:function(){return this.__rP;}
,add:function(u){var v=this.__rP;var t;for(var i=0,l=arguments.length;i<l;i++ ){t=arguments[i];if(qx.lang.Array.contains(v,t)){continue;}
...
;}
,remove:function(w){var x=this.__rP;if(qx.lang.Array.contains(x,w)){qx.lang.Array.remove(x,w);if(w.getGroup()===this){w.resetGroup();}
...
;}
,_applyInvalidMessage:function(A,z){for(var i=0;i<this.__rP.length;i++ ){this.__rP[i].setInvalidMessage(A);}
;}
,_applyValid:function(C,B){for(var i=0;i<this.__rP.length;i++ ){this.__rP[i].setValid(C);}
;}
,_applyEnabled:function(F,E){var D=this.__rP;if(F==null){for(var i=0,l=D.length;i<l;i++ ){D[i].resetEnabled();}
;}
...
;}
,selectNext:function(){var J=this.getSelection()[0];var K=this.__rP;var I=K.indexOf(J);if(I==-1){return;}
...
,selectPrevious:function(){var M=this.getSelection()[0];var N=this.__rP;var L=N.indexOf(M);if(L==-1){return;}
...
,_isItemSelectable:function(O){return this.__rP.indexOf(O)!=-1;}
,__ob:function(e){var Q=e.getData()[0];var P=e.getOldData()[0];if(P){P.setValue(false);}
...
(function(){var b="-",c="PageUp",d="Escape",f="Boolean",g="+",h="qx.event.type.Data",j="_applyShortcut",k="PrintScreen",l="NumLock",m="short",n="keydown",o="5",p="8",q="execute",r="Meta",s="0",t="",u="2",v="Control",w="Shift",x="You can only specify one non modifier key!",y="3",z="Unidentified",A="/",B="Delete",C="String",D="changeEnabled",E="*",F="qx.bom.Shortcut",G="6",H="4",I="1",J="Alt",K="Not a valid key name for a shortcut: ",L="PageDown",M="Whitespaces are not allowed within shortcuts",N="_applyEnabled",O="keypress",P="7",Q="a",R="z",S="9";qx.Class.define(F,{extend:qx.core.Object,construct:function(T){qx.core.Object.call(this);this.__zV={};this.__zW=null;if(T!=null){this.setShortcut(T);}
;this.initEnabled();}
,events:{"execute":h},properties:{enabled:{init:true,check:f,event:D,apply:N},shortcut:{check:C,apply:j,nullable:true},autoRepeat:{check:f,init:false}},members:{__zV:t,__zW:t,execute:function(U){this.fireDataEvent(q,U);}
,__zX:function(event){if(this.getEnabled()&&this.__zY(event)){if(!this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,__hP:function(event){if(this.getEnabled()&&this.__zY(event)){if(this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,_applyEnabled:function(W,V){if(W){qx.event.Registration.addListener(document.documentElement,n,this.__zX,this);qx.event.Registration.addListener(document.documentElement,O,this.__hP,this);}
else {qx.event.Registration.removeListener(document.documentElement,n,this.__zX,this);qx.event.Registration.removeListener(document.documentElement,O,this.__hP,this);}
;}
,_applyShortcut:function(bb,Y){if(bb){if(bb.search(/[\s]+/)!=-1){var bc=M;this.error(bc);throw new Error(bc);}
;this.__zV={"Control":false,"Shift":false,"Meta":false,"Alt":false};this.__zW=null;var X;var a=[];while(bb.length>0&&X!=-1){X=bb.search(/[-+]+/);a.push((bb.length==1||X==-1)?bb:bb.substring(0,X));bb=bb.substring(X+1);}
;var ba=a.length;for(var i=0;i<ba;i++ ){var bd=this.__Ab(a[i]);switch(bd){case v:case w:case r:case J:this.__zV[bd]=true;break;case z:var bc=K+a[i];this.error(bc);throw bc;default:if(this.__zW){var bc=x;this.error(bc);throw bc;}
;this.__zW=bd;};}
;}
;return true;}
,__zY:function(e){var be=this.__zW;if(!be){return false;}
;if((!this.__zV.Shift&&e.isShiftPressed())||(this.__zV.Shift&&!e.isShiftPressed())||(!this.__zV.Control&&e.isCtrlPressed())||(this.__zV.Control&&!e.isCtrlPressed())||(!this.__zV.Meta&&e.isMetaPressed())||(this.__zV.Meta&&!e.isMetaPressed())||(!this.__zV.Alt&&e.isAltPressed())||(this.__zV.Alt&&!e.isAltPressed())){return false;}
;if(be==e.getKeyIdentifier()){return true;}
;return false;}
,__Aa:{esc:d,ctrl:v,print:k,del:B,pageup:c,pagedown:L,numlock:l,numpad_0:s,numpad_1:I,numpad_2:u,numpad_3:y,numpad_4:H,numpad_5:o,numpad_6:G,numpad_7:P,numpad_8:p,numpad_9:S,numpad_divide:A,numpad_multiply:E,numpad_minus:b,numpad_plus:g},__Ab:function(bg){var bf=qx.event.util.Keyboard;var bh=z;if(bf.isValidKeyIdentifier(bg)){return bg;}
;if(bg.length==1&&bg>=Q&&bg<=R){return bg.toUpperCase();}
;bg=bg.toLowerCase();var bh=this.__Aa[bg]||qx.lang.String.firstUp(bg);if(bf.isValidKeyIdentifier(bh)){return bh;}
else {return z;}
;}
,toString:function(){var bj=this.__zW;var bk=[];for(var bi in this.__zV){if(this.__zV[bi]){bk.push(qx.locale.Key.getKeyName(m,bi));}
;}
;if(bj){bk.push(qx.locale.Key.getKeyName(m,bj));}
;return bk.join(g);}
},destruct:function(){this.setEnabled(false);this.__zV=this.__zW=null;}
});}
)();
...
;var P=K.getMarginLeft()+K.getMarginRight();P=Math.max(P,this.getSpacing());var J=K.getSizeHint().width+P;this.__tn(K);G-=J;if(E&&E.getVisibility()!=o){E.setVisibility(o);G+=L;var H=E.getMarginLeft()+E.getMarginRight();G+=Math.max(H,this.getSpacing());}
;}
while(G>F);}
else if(this.__tk.length>0){do {var Q=this.__tk[0];if(Q){var P=Q.getMarginLeft()+Q.getMarginRight();P=Math.max(P,this.getSpacing());if(Q.getContentElement().getDomElement()==null){Q.syncAppearance();Q.invalidateLayoutCache();}
;var I=Q.getSizeHint().width;var O=false;if(this.__tk.length==1&&L>0){var N=P-this.getSpacing();var M=G-L+I+N;O=F>M;}
;if(F>G+I+P||O){this.__tm(Q);G+=I;if(E&&this.__tk.length==0){E.setVisibility(y);}
;}
else {return;}
;}
;}
while(F>=G&&this.__tk.length>0);}
;}
,__tm:function(R){R.setVisibility(o);this.__tk.shift();this.fireDataEvent(m,R);}
,__tn:function(S){if(!S){return;}
;this.__tk.unshift(S);S.setVisibility(y);this.fireDataEvent(A,S);}
,_getNextToHide:function(){for(var i=this.__tl.length-1;i>=0;i-- ){var T=this.__tl[i];if(T&&T.getVisibility&&T.getVisibility()==o){return T;}
;}
...
;}
;}
,setRemovePriority:function(X,W,Y){if(!Y&&this.__tl[W]!=undefined){throw new Error(v);}
;this.__tl[W]=X;}
...
;for(var i=0;i<this.__tk.length;i++ ){this.__tk[i].setVisibility(o);}
;this.__tk=[];}
;}
...
;bf.setVisibility(y);}
;}
,__to:false,_setAllowMenuOpenHover:function(bg){this.__to=bg;}
,_isAllowMenuOpenHover:function(){return this.__to;}
...
;}
,_onPointerDown:function(e){qx.ui.form.Button.prototype._onPointerDown.call(this,e);if(e.getButton()!=n){return;}
;var B=this.getMenu();if(B){if(!B.isVisible()){this.open();}
else {B.exclude();}
;e.stopPropagation();}
;}
,_onPointerUp:function(e){qx.ui.form.Button.prototype._onPointerUp.call(this,e);e.stopPropagation();}
,_onPointerOver:function(e){this.addState(c);}
,_onPointerOut:function(e){this.removeState(c);}
...
(function(){var a="blur",b="Enter",c="Escape",d="Space",f="keydown",g="Left",h="Down",j="Up",k="__ln",l="qx.debug",m="interval",n="__sU",o="roll",p="event.touch",q="singleton",r="Object is no menu: ",s="pointerdown",t="qx.ui.menu.Manager",u="keyup",v="keypress",w="__sV",x="Right";qx.Class.define(t,{type:q,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__ln=[];var y=document.body;var z=qx.event.Registration;z.addListener(window.document.documentElement,s,this._onPointerDown,this,true);z.addListener(y,o,this._onRoll,this,true);z.addListener(y,f,this._onKeyUpDown,this,true);z.addListener(y,u,this._onKeyUpDown,this,true);z.addListener(y,v,this._onKeyPress,this,true);if(!qx.core.Environment.get(p)){qx.bom.Element.addListener(window,a,this.hideAll,this);}
;this.__sU=new qx.event.Timer();this.__sU.addListener(m,this._onOpenInterval,this);this.__sV=new qx.event.Timer();this.__sV.addListener(m,this._onCloseInterval,this);}
,members:{__sW:null,__sX:null,__sU:null,__sV:null,__ln:null,_getChild:function(A,C,B,F){var E=A.getChildren();var length=E.length;var D;for(var i=C;i<length&&i>=0;i+=B){D=E[i];if(D.isEnabled()&&!D.isAnonymous()&&D.isVisible()){return D;}
;}
...
;G=G.getLayoutParent();}
;return false;}
,_isMenuOpener:function(I){var H=this.__ln;for(var i=0;i<H.length;i++ ){if(H[i].getOpener()===I){return true;}
;}
;return false;}
,_getMenuButton:function(J){while(J){if(J instanceof qx.ui.menu.AbstractButton){return J;}
;J=J.getLayoutParent();}
;return null;}
,add:function(K){if(qx.core.Environment.get(l)){if(!(K instanceof qx.ui.menu.Menu)){throw new Error(r+K);}
;}
;var L=this.__ln;L.push(K);K.setZIndex(1e6+L.length);}
,remove:function(M){if(qx.core.Environment.get(l)){if(!(M instanceof qx.ui.menu.Menu)){throw new Error(r+M);}
;}
;var N=this.__ln;if(N){qx.lang.Array.remove(N,M);}
;}
,hideAll:function(){var O=this.__ln;if(O){for(var i=O.length-1;i>=0;i-- ){O[i].exclude();}
;}
;}
,getActiveMenu:function(){var P=this.__ln;return P.length>0?P[P.length-1]:null;}
,scheduleOpen:function(Q){this.cancelClose(Q);if(Q.isVisible()){if(this.__sW){this.cancelOpen(this.__sW);}
;}
else if(this.__sW!=Q){this.__sW=Q;this.__sU.restartWith(Q.getOpenInterval());}
;}
,scheduleClose:function(R){this.cancelOpen(R);if(!R.isVisible()){if(this.__sX){this.cancelClose(this.__sX);}
;}
else if(this.__sX!=R){this.__sX=R;this.__sV.restartWith(R.getCloseInterval());}
;}
,cancelOpen:function(S){if(this.__sW==S){this.__sU.stop();this.__sW=null;}
;}
,cancelClose:function(T){if(this.__sX==T){this.__sV.stop();this.__sX=null;}
;}
,_onOpenInterval:function(e){this.__sU.stop();this.__sW.open();this.__sW=null;}
,_onCloseInterval:function(e){this.__sV.stop();this.__sX.exclude();this.__sX=null;}
,_onPointerDown:function(e){var U=e.getTarget();U=qx.ui.core.Widget.getWidgetByElement(U,true);if(U==null){this.hideAll();return;}
;if(U.getMenu&&U.getMenu()&&U.getMenu().isVisible()){return;}
;if(this.__ln.length>0&&!this._isInMenu(U)){this.hideAll();}
;}
,__sY:{"Enter":1,"Space":1},__pn:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var V=this.getActiveMenu();if(!V){return;}
;var W=e.getKeyIdentifier();if(this.__pn[W]||(this.__sY[W]&&V.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var ba=this.getActiveMenu();if(!ba){return;}
;var X=e.getKeyIdentifier();var bc=this.__pn[X];var Y=this.__sY[X];if(bc){switch(X){case j:this._onKeyPressUp(ba);break;case h:this._onKeyPressDown(ba);break;case g:this._onKeyPressLeft(ba);break;case x:this._onKeyPressRight(ba);break;case c:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
else if(Y){var bb=ba.getSelectedButton();if(bb){switch(X){case b:this._onKeyPressEnter(ba,bb,e);break;case d:this._onKeyPressSpace(ba,bb,e);break;};e.stopPropagation();e.preventDefault();}
;}
;}
...
;}
;}
,_onKeyPressEnter:function(bC,bD,e){if(bD.hasListener(v)){var bE=e.clone();bE.setBubbles(false);bE.setTarget(bD);bD.dispatchEvent(bE);}
;this.hideAll();}
,_onKeyPressSpace:function(bF,bG,e){if(bG.hasListener(v)){var bH=e.clone();bH.setBubbles(false);bH.setTarget(bG);bG.dispatchEvent(bH);}
;}
,_onRoll:function(e){var bI=e.getTarget();bI=qx.ui.core.Widget.getWidgetByElement(bI,true);if(this.__ln.length>0&&!this._isInMenu(bI)&&!this._isMenuOpener(bI)&&!e.getMomentum()){this.hideAll();}
;}
},destruct:function(){var bK=qx.event.Registration;var bJ=document.body;bK.removeListener(window.document.documentElement,s,this._onPointerDown,this,true);bK.removeListener(bJ,f,this._onKeyUpDown,this,true);bK.removeListener(bJ,u,this._onKeyUpDown,this,true);bK.removeListener(bJ,v,this._onKeyPress,this,true);this._disposeObjects(n,w);this._disposeArray(k);}
});}
)();
...
(function(){var a="Boolean",b="pointerover",c="qx.ui.core.Widget",d="excluded",f="selected",g="Integer",h="slidebar",j="menu",k="qx.debug",l="visible",m="_applySelectedButton",n="_applySpacingY",o="resize",p="_blocker",q="_applyCloseInterval",r="_applyBlockerColor",s="The menu instance needs a configured 'opener' widget!",t="_applyIconColumnWidth",u="Please use '_onPointerOver' instead.",v="qx.ui.menu.Menu",w="_applyOpenedButton",x="Color",y="Number",z="_applyArrowColumnWidth",A="Unknown target: ",B="_applySpacingX",C="_applyBlockerOpacity",D="Could not open menu instance because 'opener' widget is not visible",E="_applyOpenInterval",F="pointerout";qx.Class.define(v,{extend:qx.ui.core.Widget,include:[qx.ui.core.MPlacement,qx.ui.core.MRemoteChildrenHandling],construct:function(){qx.ui.core.Widget.call(this);this._setLayout(new qx.ui.menu.Layout);var G=this.getApplicationRoot();G.add(this);this.addListener(b,this._onPointerOver);this.addListener(F,this._onPointerOut);this.addListener(o,this._onResize,this);G.addListener(o,this._onResize,this);this._blocker=new qx.ui.core.Blocker(G);this.initVisibility();this.initKeepFocus();this.initKeepActive();}
,properties:{appearance:{refine:true,init:j},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false},visibility:{refine:true,init:d},keepFocus:{refine:true,init:true},keepActive:{refine:true,init:true},spacingX:{check:g,apply:B,init:0,themeable:true},spacingY:{check:g,apply:n,init:0,themeable:true},iconColumnWidth:{check:g,init:0,themeable:true,apply:t},arrowColumnWidth:{check:g,init:0,themeable:true,apply:z},blockerColor:{check:x,init:null,nullable:true,apply:r,themeable:true},blockerOpacity:{check:y,init:1,apply:C,themeable:true},selectedButton:{check:c,nullable:true,apply:m},openedButton:{check:c,nullable:true,apply:w},opener:{check:c,nullable:true},openInterval:{check:g,themeable:true,init:250,apply:E},closeInterval:{check:g,themeable:true,init:250,apply:q},blockBackground:{check:a,themeable:true,init:false}},members:{__ta:null,__tb:null,_blocker:null,open:function(){if(this.getOpener()!=null){var H=this.placeToWidget(this.getOpener(),true);if(H){this.__td();this.show();this._placementTarget=this.getOpener();}
else {this.warn(D);}
;}
else {this.warn(s);}
;}
,openAtMouse:function(e){if(qx.core.Environment.get(k)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,u);}
;this.openAtPointer(e);}
,openAtPointer:function(e){this.placeToPointer(e);this.__td();this.show();this._placementTarget={left:e.getDocumentLeft(),top:e.getDocumentTop()};}
,openAtPoint:function(I){this.placeToPoint(I);this.__td();this.show();this._placementTarget=I;}
,addSeparator:function(){this.add(new qx.ui.menu.Separator);}
,getColumnSizes:function(){return this._getMenuLayout().getColumnSizes();}
,getSelectables:function(){var J=[];var K=this.getChildren();for(var i=0;i<K.length;i++ ){if(K[i].isEnabled()){J.push(K[i]);}
;}
;return J;}
,_applyIconColumnWidth:function(M,L){this._getMenuLayout().setIconColumnWidth(M);}
,_applyArrowColumnWidth:function(O,N){this._getMenuLayout().setArrowColumnWidth(O);}
,_applySpacingX:function(Q,P){this._getMenuLayout().setColumnSpacing(Q);}
,_applySpacingY:function(S,R){this._getMenuLayout().setSpacing(S);}
,_applyVisibility:function(V,U){qx.ui.core.Widget.prototype._applyVisibility.call(this,V,U);var T=qx.ui.menu.Manager.getInstance();if(V===l){T.add(this);var W=this.getParentMenu();if(W){W.setOpenedButton(this.getOpener());}
;}
else if(U===l){T.remove(this);var W=this.getParentMenu();if(W&&W.getOpenedButton()==this.getOpener()){W.resetOpenedButton();}
;this.resetOpenedButton();this.resetSelectedButton();}
;this.__tc();}
,__tc:function(){if(this.isVisible()){if(this.getBlockBackground()){var X=this.getZIndex();this._blocker.blockContent(X-1);}
;}
else {if(this._blocker.isBlocked()){this._blocker.unblock();}
;}
;}
,getParentMenu:function(){var Y=this.getOpener();if(!Y||!(Y instanceof qx.ui.menu.AbstractButton)){return null;}
;if(Y&&Y.getContextMenu()===this){return null;}
;while(Y&&!(Y instanceof qx.ui.menu.Menu)){Y=Y.getLayoutParent();}
;return Y;}
,_applySelectedButton:function(bb,ba){if(ba){ba.removeState(f);}
;if(bb){bb.addState(f);}
;}
,_applyOpenedButton:function(bd,bc){if(bc&&bc.getMenu()){bc.getMenu().exclude();}
;if(bd){bd.getMenu().open();}
;}
,_applyBlockerColor:function(bf,be){this._blocker.setColor(bf);}
,_applyBlockerOpacity:function(bh,bg){this._blocker.setOpacity(bh);}
,getChildrenContainer:function(){return this.getChildControl(h,true)||this;}
,_createChildControlImpl:function(bk,bj){var bi;switch(bk){case h:var bi=new qx.ui.menu.MenuSlideBar();var bm=this._getLayout();this._setLayout(new qx.ui.layout.Grow());var bl=bi.getLayout();bi.setLayout(bm);bl.dispose();var bn=qx.lang.Array.clone(this.getChildren());for(var i=0;i<bn.length;i++ ){bi.add(bn[i]);}
;this.removeListener(o,this._onResize,this);bi.getChildrenContainer().addListener(o,this._onResize,this);this._add(bi);break;};return bi||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,bk);}
...
,__td:function(){var bp=this._getMenuBounds();if(!bp){this.addListenerOnce(o,this.__td,this);return;}
;var bo=this.getLayoutParent().getBounds().height;var top=this.getLayoutProperties().top;var bq=this.getLayoutProperties().left;if(top<0){this._assertSlideBar(function(){this.setHeight(bp.height+top);this.moveTo(bq,0);}
);}
else if(top+bp.height>bo){this._assertSlideBar(function(){this.setHeight(bo-top);}
);}
else {this.setHeight(null);}
;}
,_assertSlideBar:function(br){if(this.hasChildControl(h)){return br.call(this);}
;this.__tb=br;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bs){this.getChildControl(h);if(this.__tb){this.__tb.call(this);delete this.__tb;}
;}
,_onResize:function(){if(this.isVisible()){var bt=this._placementTarget;if(!bt){return;}
else if(bt instanceof qx.ui.core.Widget){this.placeToWidget(bt,true);}
else if(bt.top!==undefined){this.placeToPoint(bt);}
else {throw new Error(A+bt);}
;this.__td();}
;}
,_onPointerOver:function(e){var bv=qx.ui.menu.Manager.getInstance();bv.cancelClose(this);var bw=e.getTarget();if(bw.isEnabled()&&bw instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(bw);var bu=bw.getMenu&&bw.getMenu();if(bu){bu.setOpener(bw);bv.scheduleOpen(bu);this.__ta=bu;}
else {var bx=this.getOpenedButton();if(bx){bv.scheduleClose(bx.getMenu());}
;if(this.__ta){bv.cancelOpen(this.__ta);this.__ta=null;}
;}
;}
else if(!this.getOpenedButton()){this.resetSelectedButton();}
;}
,_onPointerOut:function(e){var by=qx.ui.menu.Manager.getInstance();if(!qx.ui.core.Widget.contains(this,e.getRelatedTarget())){var bz=this.getOpenedButton();bz?this.setSelectedButton(bz):this.resetSelectedButton();if(bz){by.cancelClose(bz.getMenu());}
;if(this.__ta){by.cancelOpen(this.__ta);}
;}
;}
...
(function(){var a="qx.ui.menu.Layout",b="Integer",c="_applyLayoutChange";qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:b,init:0,apply:c},spanColumn:{check:b,init:1,nullable:true,apply:c},iconColumnWidth:{check:b,init:0,themeable:true,apply:c},arrowColumnWidth:{check:b,init:0,themeable:true,apply:c}},members:{__te:null,_computeSizeHint:function(){var q=this._getLayoutChildren();var o,g,k;var e=this.getSpanColumn();var j=this.__te=[0,0,0,0];var n=this.getColumnSpacing();var m=0;var f=0;for(var i=0,l=q.length;i<l;i++ ){o=q[i];if(o.isAnonymous()){continue;}
...
,getColumnSizes:function(){return this.__te||null;}
},destruct:function(){this.__te=null;}
});}
)();
...
,properties:{blockToolTip:{refine:true,init:true},label:{check:k,apply:x,nullable:true,event:c},menu:{check:q,apply:f,nullable:true,dereference:true,event:v},icon:{check:k,apply:s,themeable:true,nullable:true,event:b},showCommandLabel:{check:a,apply:j,themeable:true,init:true,event:t}},members:{_createChildControlImpl:function(B,A){var z;switch(B){case n:z=new qx.ui.basic.Image;z.setAnonymous(true);this._add(z,{column:0});break;case u:z=new qx.ui.basic.Label;z.setAnonymous(true);this._add(z,{column:1});break;case d:z=new qx.ui.basic.Label;z.setAnonymous(true);if(!this.getShowCommandLabel()){z.exclude();}
...
;if(this._isChildControlVisible(u)){var G=this.getChildControl(u);D=G.getMarginLeft()+G.getSizeHint().width+G.getMarginRight();}
...
;}
,_applyLabel:function(R,Q){if(R){this._showChildControl(u).setValue(R);}
...
;var x=this.__tf(y[0]);var w=x.getColumnSizes();var s=x.getSpacingX();var z=qx.lang.Array.sum(w)+s*(w.length-1);if(z<o){w[1]+=o-z;}
...
;}
;}
,__tf:function(B){while(!(B instanceof qx.ui.menu.Menu)){B=B.getLayoutParent();}
;return B;}
...
(function(){var a="hovered",b="hover-button",c="pointerover",d="interval",f="__kh",g="qx.ui.form.HoverButton",h="Integer",i="pointerout";qx.Class.define(g,{extend:qx.ui.basic.Atom,include:[qx.ui.core.MExecutable],implement:[qx.ui.form.IExecutable],construct:function(j,k){qx.ui.basic.Atom.call(this,j,k);this.addListener(c,this._onPointerOver,this);this.addListener(i,this._onPointerOut,this);this.__kh=new qx.event.AcceleratingTimer();this.__kh.addListener(d,this._onInterval,this);}
,properties:{appearance:{refine:true,init:b},interval:{check:h,init:80},firstInterval:{check:h,init:200},minTimer:{check:h,init:20},timerDecrease:{check:h,init:2}},members:{__kh:null,_onPointerOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.__kh.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();this.addState(a);}
,_onPointerOut:function(e){this.__kh.stop();this.removeState(a);if(!this.isEnabled()||e.getTarget()!==this){return;}
;}
...
(function(){var a="hovered",b="inherit",c="pressed",d="mouse",f="qx.ui.menubar.Button",g="keydown",h="menubar-button",i="keyup";qx.Class.define(f,{extend:qx.ui.form.MenuButton,construct:function(k,l,j){qx.ui.form.MenuButton.call(this,k,l,j);this.removeListener(g,this._onKeyDown);this.removeListener(i,this._onKeyUp);}
,properties:{appearance:{refine:true,init:h},show:{refine:true,init:b},focusable:{refine:true,init:false}},members:{getMenuBar:function(){var parent=this;while(parent){if(parent instanceof qx.ui.toolbar.ToolBar){return parent;}
;parent=parent.getLayoutParent();}
;return null;}
,open:function(m){qx.ui.form.MenuButton.prototype.open.call(this,m);var menubar=this.getMenuBar();if(menubar){menubar._setAllowMenuOpenHover(true);}
;}
,_onMenuChange:function(e){var n=this.getMenu();var menubar=this.getMenuBar();if(n.isVisible()){this.addState(c);if(menubar){menubar.setOpenMenu(n);}
;}
else {this.removeState(c);if(menubar&&menubar.getOpenMenu()==n){menubar.resetOpenMenu();menubar._setAllowMenuOpenHover(false);}
;}
;}
,_onPointerUp:function(e){qx.ui.form.MenuButton.prototype._onPointerUp.call(this,e);var o=this.getMenu();if(o&&o.isVisible()&&!this.hasState(c)){this.addState(c);}
;}
,_onPointerOver:function(e){this.addState(a);if(this.getMenu()&&e.getPointerType()==d){var menubar=this.getMenuBar();if(menubar&&menubar._isAllowMenuOpenHover()){qx.ui.menu.Manager.getInstance().hideAll();menubar._setAllowMenuOpenHover(true);if(this.isEnabled()){this.open();}
;}
;}
;}
}});}
...
;}
,properties:{appearance:{refine:true,init:b}},members:{_onTap:function(e){if(e.isLeftPressed()){this.execute();if(this.getMenu()){this.getMenu().open();return;}
;}
...
,__tp:function(){var y=this.getChildrenContainer().getChildren();y=y.filter(function(z){return z.getVisibility()==k;}
...
(function(){var a="qx.ui.menubar.MenuBar",b="menubar";qx.Class.define(a,{extend:qx.ui.toolbar.ToolBar,properties:{appearance:{refine:true,init:b}}});}
)();
...
,_onExecute:function(e){this.toggleValue();}
,_onTap:function(e){if(e.isLeftPressed()){this.execute();}
else {if(this.getContextMenu()){return;}
;}
;qx.ui.menu.Manager.getInstance().hideAll();}
,_onKeyPress:function(e){this.execute();}
