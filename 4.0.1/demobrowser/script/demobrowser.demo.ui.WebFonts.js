...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.WebFonts","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.WebFonts.3acbeb20c12f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser/demo/fonts/fineliner_script-webfont.woff",b="Cras interdum sollicitudin ante. Sed placerat scelerisque magna. Vestibulum ",c="demobrowser/demo/fonts/fineliner_script-webfont.ttf",d="demobrowser/demo/fonts/fineliner_script-webfont.eot",e="sans-serif",f="Select Font",g="demobrowser/demo/fonts/tobec___-webfont.eot",h="FinelinerScriptRegular",j="qx.debug",k="demobrowser/demo/fonts/yanonekaffeesatz-regular-webfont.woff",m="rutrum nibh a eros. Cum sociis natoque penatibus et magnis dis parturient ",n="changeSelection",o="demobrowser/demo/fonts/tobec___-webfont.ttf",p="YanoneKaffeesatzRegular",q="Lorem ipsum dolor sit amet, consectetuer adipiscing elit.",r="fontId",s="Nam lectus justo, porttitor ac, ullamcorper ac, cursus in, ante. Duis mi ante,",t="demobrowser.demo.ui.WebFonts",u="ToBeContinuedRegular",v="demobrowser/demo/fonts/tobec___-webfont.woff",w="sodales in, auctor vel, vehicula eget, sapien. Proin iaculis dui vitae leo. ",x="demobrowser/demo/fonts/yanonekaffeesatz-regular-webfont.ttf",y="bold",z="The quick brown fox jumps over the lazy dog",A="label",B="demobrowser/demo/fonts/yanonekaffeesatz-regular-webfont.eot",C="montes, nascetur ridiculus mus.",D="Integer blandit tempus leo. Morbi turpis. Suspendisse turpis. Nulla eget leo.";qx.Class.define(t,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);if(qx.core.Environment.get(j)){qx.log.appender.Native;qx.log.appender.Console;}
;var J={"webFont0":{size:16,family:[e],sources:[{family:h,source:[d,c,a]}]},"webFont1":{size:13,family:[e],sources:[{family:u,source:[g,o,v]}]},"webFont2":{size:16,family:[e],sources:[{family:p,source:[B,x,k]}]}};var E={};for(var G in J){E[G]=new qx.bom.webfonts.WebFont().set(J[G]);}
;var F=z;var P=q+s+w+D+b+m+C;var Q=[];var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));this.getRoot().add(S,{edge:10});var R=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));S.add(R);var K=new qx.ui.basic.Label(f);K.setFont(y);R.add(K);var L=new qx.ui.form.SelectBox();L.setMinWidth(300);for(var G in E){var I=new qx.ui.form.ListItem(E[G].getFamily()[0]);I.getChildControl(A).setFont(E[G]);I.setUserData(r,G);L.add(I);}
;L.addListener(n,function(T){var U=T.getData()[0];var V=U.getUserData(r);for(var i=0,l=Q.length;i<l;i++ ){Q[i].setFont(E[V]);}
;}
,this);R.add(L);var O=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));S.add(O);var M=new qx.ui.basic.Label(F);Q.push(M);M.setFont(E.webFont0);O.add(M);var N=new qx.ui.form.TextField(F);Q.push(N);N.setFont(E.webFont0);O.add(N);var H=new qx.ui.form.TextArea(P);Q.push(H);H.setFont(E.webFont0);O.add(H);}
}});}
)();
...
(function(){var a="popupOpen",b="PageUp",c="blur",d="one",f="Escape",g="_applyMaxListHeight",h="Function",i="",j="Abstract method: _onListPointerDown()",k="visible",l="changeSelection",m="middle",n="Abstract method: _onListChangeSelection()",o="changeVisibility",p="resize",q="list",r="qx.ui.form.AbstractSelectBox",s="pointerdown",t="keypress",u="PageDown",v="abstract",w="popup",x="Number",y="tap";qx.Class.define(r,{extend:qx.ui.core.Widget,include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.form.MForm],implement:[qx.ui.form.IForm],type:v,construct:function(){qx.ui.core.Widget.call(this);var z=new qx.ui.layout.HBox();this._setLayout(z);z.setAlignY(m);this.addListener(t,this._onKeyPress);this.addListener(c,this._onBlur,this);this.addListener(p,this._onResize,this);}
,properties:{focusable:{refine:true,init:true},width:{refine:true,init:120},maxListHeight:{check:x,apply:g,nullable:true,init:200},format:{check:h,init:function(A){return this._defaultFormat(A);}
,nullable:true}},members:{_createChildControlImpl:function(D,C){var B;switch(D){case q:B=new qx.ui.form.List().set({focusable:false,keepFocus:true,height:null,width:null,maxHeight:this.getMaxListHeight(),selectionMode:d,quickSelection:true});B.addListener(l,this._onListChangeSelection,this);B.addListener(s,this._onListPointerDown,this);break;case w:B=new qx.ui.popup.Popup(new qx.ui.layout.VBox);B.setAutoHide(false);B.setKeepActive(true);B.addListener(y,this.close,this);B.add(this.getChildControl(q));B.addListener(o,this._onPopupChangeVisibility,this);break;};return B||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,D);}
,_applyMaxListHeight:function(F,E){this.getChildControl(q).setMaxHeight(F);}
,getChildrenContainer:function(){return this.getChildControl(q);}
,open:function(){var G=this.getChildControl(w);G.placeToWidget(this,true);G.show();}
,close:function(){this.getChildControl(w).hide();}
,toggle:function(){var H=this.getChildControl(w).isVisible();if(H){this.close();}
else {this.open();}
;}
,_defaultFormat:function(I){var K=I?I.getLabel():i;var J=I?I.getRich():false;if(J){K=K.replace(/<[^>]+?>/g,i);K=qx.bom.String.unescape(K);}
;return K;}
,_onBlur:function(e){this.close();}
,_onKeyPress:function(e){var L=e.getKeyIdentifier();var M=this.getChildControl(w);if(M.isHidden()&&(L==u||L==b)){e.stopPropagation();}
else if(!M.isHidden()&&L==f){this.close();e.stop();}
else {this.getChildControl(q).handleKeyPress(e);}
;}
,_onResize:function(e){this.getChildControl(w).setMinWidth(e.getData().width);}
,_onListChangeSelection:function(e){throw new Error(n);}
,_onListPointerDown:function(e){throw new Error(j);}
,_onPopupChangeVisibility:function(e){e.getData()==k?this.addState(a):this.removeState(a);}
}});}
)();
...
,properties:{appearance:{refine:true,init:t}},members:{__ps:null,_createChildControlImpl:function(B,A){var z;switch(B){case s:z=new qx.ui.core.Spacer();this._add(z,{flex:1});break;case y:z=new qx.ui.basic.Atom(v);z.setCenter(false);z.setAnonymous(true);this._add(z,{flex:1});break;case n:z=new qx.ui.basic.Image();z.setAnonymous(true);this._add(z);break;};return z||qx.ui.form.AbstractSelectBox.prototype._createChildControlImpl.call(this,B);}
,_forwardStates:{focused:true},_getItems:function(){return this.getChildrenContainer().getChildren();}
,_isAllowEmptySelection:function(){return this.getChildrenContainer().getSelectionMode()!==d;}
,__ob:function(e){var D=e.getData()[0];var C=this.getChildControl(l);if(C.getSelection()[0]!=D){if(D){C.setSelection([D]);}
else {C.resetSelection();}
;}
;this.__pt();this.__pu();}
,__pt:function(){var F=this.getChildControl(l).getSelection()[0];var E=this.getChildControl(y);var G=F?F.getIcon():q;G==null?E.resetIcon():E.setIcon(G);}
,__pu:function(){var J=this.getChildControl(l).getSelection()[0];var H=this.getChildControl(y);var I=J?J.getLabel():q;var K=this.getFormat();if(K!=null){I=K.call(this,J);}
;if(I&&I.translate){I=I.translate();}
;I==null?H.resetLabel():H.setLabel(I);}
,_onPointerOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;if(this.hasState(j)){this.removeState(j);this.addState(c);}
;this.addState(a);}
,_onPointerOut:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.removeState(a);if(this.hasState(c)){this.removeState(c);this.addState(j);}
;}
,_onTap:function(e){this.toggle();}
,_onKeyPress:function(e){var L=e.getKeyIdentifier();if(L==b||L==i){if(this.__ps){this.setSelection([this.__ps]);this.__ps=null;}
;this.toggle();}
else {qx.ui.form.AbstractSelectBox.prototype._onKeyPress.call(this,e);}
;}
,_onKeyInput:function(e){var M=e.clone();M.setTarget(this._list);M.setBubbles(false);this.getChildControl(l).dispatchEvent(M);}
,_onListPointerDown:function(e){if(this.__ps){this.setSelection([this.__ps]);this.__ps=null;}
;}
,_onListChangeSelection:function(e){var Q=e.getData();var O=e.getOldData();if(O&&O.length>0){O[0].removeListener(h,this.__pt,this);O[0].removeListener(g,this.__pu,this);}
;if(Q.length>0){var N=this.getChildControl(u);var P=this.getChildControl(l);var R=P.getSelectionContext();if(N.isVisible()&&(R==p||R==k)){this.__ps=Q[0];}
else {this.setSelection([Q[0]]);this.__ps=null;}
;Q[0].addListener(h,this.__pt,this);Q[0].addListener(g,this.__pu,this);}
else {this.resetSelection();}
;}
,_onPopupChangeVisibility:function(e){qx.ui.form.AbstractSelectBox.prototype._onPopupChangeVisibility.call(this,e);var T=this.getChildControl(u);if(!T.isVisible()){var V=this.getChildControl(l);if(V.hasChildren()){V.setSelection(this.getSelection());}
;}
else {var S=T.getLayoutLocation(this);var X=qx.bom.Viewport.getHeight();var W=S.top;var Y=X-S.bottom;var U=W>Y?W:Y;var ba=this.getMaxListHeight();var V=this.getChildControl(l);if(ba==null||ba>U){V.setMaxHeight(U);}
...
;var cn=this.getContentElement();if(ci&&this.__nE){if(this.__nE){var ck=this.getInsets();this._getPlaceholderElement().setStyles({paddingTop:ck.top+cp,paddingRight:ck.right+cp,paddingBottom:ck.bottom+cp,paddingLeft:ck.left+cp});}
;}
;if(cm||co.margin){if(this.__nE){var ck=this.getInsets();this._getPlaceholderElement().setStyles({"width":(innerWidth-ck.left-ck.right)+cp,"height":(innerHeight-ck.top-ck.bottom)+cp});}
;cn.setStyles({"width":innerWidth+cp,"height":innerHeight+cp});this._renderContentElement(innerHeight,cn);}
;if(co.position){if(this.__nE){this._getPlaceholderElement().setStyles({"left":cq+cp,"top":top+cp});}
;}
;}
...
;return cs;}
,_applyEnabled:function(cv,cu){qx.ui.core.Widget.prototype._applyEnabled.call(this,cv,cu);this.getContentElement().setEnabled(cv);if(this.__nE){if(cv){this._showPlaceholder();}
else {this._removePlaceholder();}
;}
else {var ct=this.getContentElement();ct.setAttribute(A,cv?this.getPlaceholder():P);}
;}
,__nG:{width:16,height:16},_getContentHint:function(){return {width:this.__nG.width*10,height:this.__nG.height||16};}
,_applyFont:function(cy,cx){if(cx&&this.__lv&&this.__lz){this.__lv.removeListenerById(this.__lz);this.__lz=null;}
;var cw;if(cy){this.__lv=qx.theme.manager.Font.getInstance().resolve(cy);if(this.__lv instanceof qx.bom.webfonts.WebFont){this.__lz=this.__lv.addListener(z,this._onWebFontStatusChange,this);}
;cw=this.__lv.getStyles();}
...
;if(this.__nE){delete cw[r];this._getPlaceholderElement().setStyles(cw);}
;if(cy){this.__nG=qx.bom.Label.getTextSize(m,cw);}
else {delete this.__nG;}
;qx.ui.core.queue.Layout.add(this);}
...
,_getTextSize:function(){return this.__nG;}
,_onHtmlInput:function(e){var cF=e.getData();var cE=true;this.__nF=false;if(this.__iQ&&this.__iQ===cF){cE=false;}
...
;}
;if(cE){this.fireDataEvent(q,cF,this.__iQ);this.__iQ=cF;if(this.getLiveUpdate()){this.__nH(cF);}
;}
;}
,_onWebFontStatusChange:function(cJ){if(cJ.getData().valid===true){var cI=this.__lv.getStyles();this.__nG=qx.bom.Label.getTextSize(m,cI);qx.ui.core.queue.Layout.add(this);}
;}
,__nH:function(cL){var cK=this.__iP;this.__iP=cL;if(cK!=cL){this.fireNonBubblingEvent(bR,qx.event.type.Data,[cL,cK]);}
;}
,setValue:function(cP){if(cP===null){if(this.__nF){return cP;}
;cP=P;this.__nF=true;}
else {this.__nF=false;if(this.__nE){this._removePlaceholder();}
;}
;if(qx.lang.Type.isString(cP)){var cO=this.getContentElement();if(cO.getValue()!=cP){var cM=cO.getValue();cO.setValue(cP);var cN=this.__nF?null:cP;this.__iP=cM;this.__nH(cN);this.__iQ=this.__iP;}
;if(this.__nE){this._showPlaceholder();}
;return cP;}
;throw new Error(l+cP);}
,getValue:function(){var cQ=this.getContentElement().getValue();return this.__nF?null:cQ;}
,resetValue:function(){this.setValue(null);}
,_onChangeContent:function(e){this.__nF=e.getData()===null;this.__nH(e.getData());}
...
,setLayoutParent:function(parent){qx.ui.core.Widget.prototype.setLayoutParent.call(this,parent);if(this.__nE){if(parent){this.getLayoutParent().getContentElement().add(this._getPlaceholderElement());}
...
.bind(this),0);}
,_removePlaceholder:function(){if(this.hasState(v)){if(this.__nE){this._getPlaceholderElement().setStyle(R,bY);}
;this.removeState(v);}
;}
,_syncPlaceholder:function(){if(this.hasState(v)&&this.__nE){this._getPlaceholderElement().setStyle(R,E);}
;}
...
;if(!this.__nE&&qx.ui.form.AbstractField.__dk){qx.bom.Stylesheet.removeSheet(qx.ui.form.AbstractField.__dk);qx.ui.form.AbstractField.__dk=null;qx.ui.form.AbstractField.__nD();}
;}
,_applyPlaceholder:function(cY,cX){if(this.__nE){this._getPlaceholderElement().setValue(cY);if(cY!=null){this.addListener(u,this._removePlaceholder,this);this.addListener(cc,this._showPlaceholder,this);this._showPlaceholder();}
...
;this._placeholder=this.__lv=null;if(qx.core.Environment.get(Y)){qx.locale.Manager.getInstance().removeListener(bT,this._onChangeLocale,this);}
;if(this.__lv&&this.__lz){this.__lv.removeListenerById(this.__lz);}
...
;qx.html.Element.call(this,t,q,r);this.__nI=s;}
,members:{__nI:null,__nJ:null,__nK:null,_createDomElement:function(){return qx.bom.Input.create(this.__nI);}
...
;}
,setEnabled:function(w){this.__nK=w;this.setAttribute(l,w===false);if(qx.core.Environment.get(a)==g){if(!w){this.setStyles({"userModify":m,"userSelect":d});}
else {this.setStyles({"userModify":null,"userSelect":this.__nJ?null:d});}
;}
;}
,setSelectable:qx.core.Environment.select(a,{"webkit":function(x){this.__nJ=x;qx.html.Element.prototype.setSelectable.call(this,this.__nK&&x);}
...
,setWrap:function(C,D){if(this.__nI===n){this._setProperty(c,C,D);}
else {throw new Error(e);}
;return this;}
,getWrap:function(){if(this.__nI===n){return this._getProperty(c);}
else {throw new Error(e);}
;}
}});}
)();
...
,properties:{wrap:{check:b,init:true,apply:f},appearance:{refine:true,init:j},singleStep:{check:i,init:20},minimalLineHeight:{check:i,apply:h,init:4},autoSize:{check:b,apply:w,init:false}},members:{__nL:null,__nM:null,__nN:null,setValue:function(M){M=qx.ui.form.AbstractField.prototype.setValue.call(this,M);this.__nO();return M;}
...
;}
,__nO:function(){if(this.isAutoSize()){var R=this.__nP();if(R&&this.getBounds()){this.__nN=this.__nN||this._getAreaHeight();var T=this._getScrolledAreaHeight();if(this.getMaxHeight()){var P=this.getInsets();var Q=-P.top+this.getMaxHeight()-P.bottom;if(T>Q){this.getContentElement().setStyle(I,k);}
else {this.getContentElement().setStyle(I,H);}
;}
;var S=Math.max(T,this.__nN);this._setAreaHeight(S);}
else {this.getContentElement().addListenerOnce(x,function(){this.__nO();}
,this);}
;}
;}
,_getAreaHeight:function(){return this.getInnerSize().height;}
,_setAreaHeight:function(U){if(this._getAreaHeight()!==U){this.__nM=U;qx.ui.core.queue.Layout.add(this);qx.ui.core.queue.Manager.flush();this.__nS();}
;}
,_getScrolledAreaHeight:function(){var W=this.__nP();var V=W.getDomElement();if(V){if(!V.parentNode){qx.html.Element.flush();return this._getScrolledAreaHeight();}
...
;this.__nR(W);if(qx.core.Environment.get(C)==B&&qx.core.Environment.get(s)==8){if(!V.scrollTop){qx.html.Element.flush();}
;}
;return V.scrollTop;}
;}
,__nP:function(){this.__nL=this.__nL||this.__nQ();return this.__nL;}
,__nQ:function(){var ba,Y,bb,X;ba=this.getContentElement();if(!ba.getDomElement()){return null;}
;bb=qx.bom.Element.clone(ba.getDomElement());X=new qx.html.Input(j);X.useElement(bb);Y=X;Y.setStyles({position:K,top:0,left:o,height:0,overflow:H},true);Y.removeAttribute(G);Y.removeAttribute(z);Y.setAttribute(y,g);Y.setValue(ba.getValue()||t);Y.insertBefore(ba);this.__nR(Y);return Y;}
,__nR:function(bc){bc=bc.getDomElement();if(bc){bc.scrollTop=10000;}
;}
...
,_applyAutoSize:function(bh,bg){if(qx.core.Environment.get(m)){this.__nT();}
;if(bh){this.__nO();this.addListener(a,this.__nO,this);if(!this.getBounds()){this.addListenerOnce(x,function(){this.getContentElement().setStyle(I,H);}
);}
else {this.getContentElement().setStyle(I,H);}
;}
else {this.removeListener(a,this.__nO);this.getContentElement().setStyle(I,k);}
;}
,_applyDimension:function(bi){qx.ui.form.AbstractField.prototype._applyDimension.call(this);if(qx.core.Environment.get(m)){this.__nT();}
;if(bi===this.getMaxHeight()){this.__nO();}
;}
,__nS:function(){var content=this.getContentElement();var bk=content.getDomElement();var bj=content.getStyle(u);content.setStyle(u,parseInt(bj,10)+1000+c,true);if(bk){qx.bom.element.Dimension.getWidth(bk);}
;content.setStyle(u,bj,true);}
,__nT:function(){if(this.isAutoSize()&&this.getHeight()){this.warn(n+J+v);}
;}
,_getContentHint:function(){var bl=qx.ui.form.AbstractField.prototype._getContentHint.call(this);bl.height=bl.height*this.getMinimalLineHeight();bl.width=this._getTextSize().width*20;if(this.isAutoSize()){bl.height=this.__nM||bl.height;}
;return bl;}
},destruct:function(){this.setAutoSize(false);if(this.__nL){this.__nL.dispose();}
;}
});}
)();
