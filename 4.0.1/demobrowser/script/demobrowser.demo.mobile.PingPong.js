...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.a6e0f72644dc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__Oo=this.__Os(L);U.add(this.__Oo);var Q=this.__Os(A);U.add(Q);this.__Of=this.__Ot(L);this.__Oo.add(this.__Of);this.__Oo.addListener(M,qx.lang.Function.bind(this.__pG,this),this);this.__Oe=this.__Ot(A);Q.add(this.__Oe);Q.addListener(M,qx.lang.Function.bind(this.__pG,this),this);this.__Og=this.__Ou();U.add(this.__Og);this.__Om=this.__Ov();this.__Oo.add(this.__Om);this.__On=this.__Ov();Q.add(this.__On);this.__Ol=[0,0];this.__Op();}
,__Op:function(){this.__Og.setStyles({"left":k,"top":k});this.__Oh=new qx.event.Timer(40);this.__Oh.addListener(n,function(){var x=(parseInt(this.__Og.getStyle(L))+this.__Oi*this.__Oj);var y=(parseInt(this.__Og.getStyle(z))+this.__Oi*this.__Ok);this.__Og.setStyle(L,x+c);this.__Og.setStyle(z,y+c);this.__Or();}
,this);this.__Oh.start();}
,__Oq:function(V){this.__Oh.stop();this.__Oh.dispose();this.__Oi=5;this.__Ol[V]=this.__Ol[V]+1;this.__Om.setAttribute(w,this.__Ol[0]);this.__On.setAttribute(w,this.__Ol[1]);this.__Op();}
,__Or:function(){var X=this.getBoundsFor(this.__Og);if(X.top<=0){this.__Ok=1;}
;if(X.bottom>=window.innerHeight-5){this.__Ok=-1;}
;if(X.left<=0||X.right>=window.innerWidth){this.__Oq(X.left<=0?1:0);}
;var Y=this.getBoundsFor(this.__Of);if(X.left<=Y.right&&X.bottom>=Y.top&&X.top<=Y.bottom){this.__Oj=1;this.__Oi=Math.min(this.__Oi+1,20);}
;var W=this.getBoundsFor(this.__Oe);if(X.right>=W.left&&X.bottom>=W.top&&X.top<=W.bottom){this.__Oj=-1;this.__Oi=Math.min(this.__Oi+1,20);}
;}
,__pG:function(e){var ba;if(qx.dom.Hierarchy.contains(this.__Oo.getDomElement(),e.getTarget())){ba=this.__Of;}
else {ba=this.__Oe;}
...
,__Os:function(bd){var bc={"width":C,"height":h,"position":N,"backgroundColor":a};if(bd==L){bc[J]=u;}
else {bc[L]=C;bc[d]=u;}
;return new qx.html.Element(g,bc);}
,__Ot:function(bf){var be={"width":l,"height":t,"top":t,"position":N,"backgroundColor":K};be[bf]=F;return new qx.html.Element(g,be);}
,__Ou:function(){var bg={"width":F,"height":F,"position":N,"backgroundColor":K,"userSelect":I};return new qx.html.Element(g,bg);}
,__Ov:function(){var bh={"width":h,"height":h,"textAlign":r,"fontSize":H,"color":b,"fontFamily":B};var bi=new qx.html.Element(g,bh);bi.setAttribute(w,j);return bi;}
}});}
)();
