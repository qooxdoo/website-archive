...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Canvas_Fixed","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Canvas_Fixed.17d400a02c12.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="black",b="teal",c="red",d="demobrowser.demo.layout.Canvas_Fixed",e="green",f="yellow",g="orange",h="solid",i="blue";qx.Class.define(d,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var q=new qx.ui.decoration.Decorator().set({width:3,style:h,color:a});var p=new qx.ui.core.Widget().set({backgroundColor:c,decorator:q});var o=new qx.ui.core.Widget().set({backgroundColor:i,decorator:q});var n=new qx.ui.core.Widget().set({backgroundColor:e,decorator:q});var m=new qx.ui.core.Widget().set({backgroundColor:f,decorator:q});var l=new qx.ui.core.Widget().set({backgroundColor:g,decorator:q});var k=new qx.ui.core.Widget().set({backgroundColor:b,decorator:q});var j=new qx.ui.container.Composite(new qx.ui.layout.Canvas());j.setPadding(10);j.add(p,{left:10,top:10,right:10,bottom:10});j.add(o,{left:30,top:30,right:30});j.add(n,{left:50,top:50,bottom:50});j.add(m,{left:70,top:70});j.add(l,{top:50,right:50});j.add(k,{right:50,bottom:50});this.getRoot().add(j,{edge:0});}
}});}
)();
