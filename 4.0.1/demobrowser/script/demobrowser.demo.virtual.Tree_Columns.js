...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Columns.6d41fd5f4ca9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="scrollY",b="__xU",c="cellTap",d="qx.event.type.Data",f="change",g="qx.debug",h="qx.event.type.Event",j="cellContextmenu",k="dbltap",l="resize",m="cellDbltap",n="scrollX",o="__xT",p="__xO",q="__xP",r="appear",s="pointerdown",t="qx.ui.virtual.core.Pane",u="qx.ui.virtual.core.CellEvent",v="update",w="contextmenu",x="tap";qx.Class.define(t,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__xO=new qx.ui.virtual.core.Axis(A,B);this.__xP=new qx.ui.virtual.core.Axis(z,y);this.__pC=0;this.__pB=0;this.__xQ=0;this.__xR=0;this.__xS={};this.__jG={};this.__xT=new qx.ui.container.Composite();this.__xT.setUserBounds(0,0,0,0);this._add(this.__xT);this.__xU=[];this.__xO.addListener(f,this.fullUpdate,this);this.__xP.addListener(f,this.fullUpdate,this);this.addListener(l,this._onResize,this);this.addListenerOnce(r,this._onAppear,this);this.addListener(s,this._onPointerDown,this);this.addListener(x,this._onTap,this);this.addListener(k,this._onDbltap,this);this.addListener(w,this._onContextmenu,this);}
,events:{cellTap:u,cellContextmenu:u,cellDbltap:u,update:h,scrollX:d,scrollY:d},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__xO:null,__xP:null,__pC:null,__pB:null,__xQ:null,__xR:null,__xS:null,__jG:null,__xT:null,__xU:null,__xV:null,__te:null,__uj:null,__xW:null,getRowConfig:function(){return this.__xO;}
...
;if(this.__pC!==J){var I=this.__pC;this.__pC=J;this._deferredUpdateScrollPosition();this.fireDataEvent(a,J,I);}
;}
,getScrollY:function(){return this.__pC;}
,setScrollX:function(M){var K=this.getScrollMaxX();if(M<0){M=0;}
else if(M>K){M=K;}
;if(M!==this.__pB){var L=this.__pB;this.__pB=M;this._deferredUpdateScrollPosition();this.fireDataEvent(n,M,L);}
;}
,getScrollX:function(){return this.__pB;}
,getScrollSize:function(){return {width:this.__xP.getTotalSize(),height:this.__xO.getTotalSize()};}
,scrollRowIntoView:function(P){var Q=this.getBounds();if(!Q){this.addListenerOnce(r,function(){qx.event.Timer.once(function(){this.scrollRowIntoView(P);}
,this,0);}
,this);return;}
...
;}
,scrollColumnIntoView:function(S){var V=this.getBounds();if(!V){this.addListenerOnce(r,function(){qx.event.Timer.once(function(){this.scrollColumnIntoView(S);}
,this,0);}
,this);return;}
...
;}
,scrollCellIntoView:function(X,ba){var Y=this.getBounds();if(!Y){this.addListenerOnce(r,function(){qx.event.Timer.once(function(){this.scrollCellIntoView(X,ba);}
,this,0);}
,this);return;}
...
;var bn=this.__pB+bl.width;var bo=this.__xR-bn;if(this.__pB-this.__xS.left<Math.min(this.__pB,bj)||this.__xS.right-bn<Math.min(bo,bk)){var bp=Math.min(this.__pB,bm);var bh=Math.min(bo,bi);this._setLayerWindow(bg,this.__pB-bp,this.__pC,bl.width+bp+bh,bl.height,false);}
;}
,prefetchY:function(bz,bv,br,bu){var bq=this.getVisibleLayers();if(bq.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bs=this.__pC+bw.height;var bt=this.__xQ-bs;if(this.__pC-this.__xS.top<Math.min(this.__pC,bz)||this.__xS.bottom-bs<Math.min(bt,br)){var by=Math.min(this.__pC,bv);var bx=Math.min(bt,bu);this._setLayerWindow(bq,this.__pB,this.__pC-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContentElement().getDomElement()){this.__xV=true;this._updateScrollPosition();this.__xV=null;this.fireEvent(v);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onPointerDown:function(e){this.__xW=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onTap:function(e){this.__xX(e,c);}
,_onContextmenu:function(e){this.__xX(e,j);}
,_onDbltap:function(e){this.__xX(e,m);}
...
,syncWidget:function(bD){if(this.__jG._fullUpdate){this._fullUpdate();}
else if(this.__jG._updateScrollPosition){this._updateScrollPosition();}
;this.__jG={};}
...
;this.__xS={top:bU,bottom:bQ,left:bS,right:bI};this.__xT.setUserBounds((this.getPaddingLeft()||0)+(this.__xS.left-this.__pB),(this.getPaddingTop()||0)+(this.__xS.top-this.__pC),bO,bM);this.__te=bH;this.__uj=bR;for(var i=0;i<this.__xU.length;i++ ){var bG=this.__xU[i];bG.setUserBounds(0,0,bO,bM);if(bV){bG.fullUpdate(bN,bJ,bR,bH);}
else {bG.updateLayerWindow(bN,bJ,bR,bH);}
;}
;}
,__xY:function(){if(this.__xV){return;}
;var bW=this.getScrollSize();if(this.__xQ!==bW.height||this.__xR!==bW.width){this.__xQ=bW.height;this.__xR=bW.width;this.fireEvent(v);}
;}
,fullUpdate:function(){this.__jG._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__jG._fullUpdate;}
,_fullUpdate:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__xY();return;}
;var bY=this.getBounds();if(!bY){return;}
;this._setLayerWindow(bX,this.__pB,this.__pC,bY.width,bY.height,true);this.__xY();}
,_deferredUpdateScrollPosition:function(){this.__jG._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
...
;var cb={top:this.__pC,bottom:this.__pC+cc.height,left:this.__pB,right:this.__pB+cc.width};if(this.__xS.top<=cb.top&&this.__xS.bottom>=cb.bottom&&this.__xS.left<=cb.left&&this.__xS.right>=cb.right){this.__xT.setUserBounds((this.getPaddingLeft()||0)+(this.__xS.left-cb.left),(this.getPaddingTop()||0)+(this.__xS.top-cb.top),this.__xS.right-this.__xS.left,this.__xS.bottom-this.__xS.top);}
else {this._setLayerWindow(ca,this.__pB,this.__pC,cc.width,cc.height,false);}
;this.__xY();}
},destruct:function(){this._disposeArray(b);this._disposeObjects(p,q,o);this.__xS=this.__jG=this.__te=this.__uj=null;}
});}
)();
...
,events:{"change":e},members:{__ya:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__ya=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__ya=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__ya=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__ya=null;this.fireNonBubblingEvent(c);}
,__yb:function(){if(this.__ya){return this.__ya;}
;var s=this.defaultItemSize;var q=this.itemCount;var y=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<q){y.push(p);}
;}
;if(y.length==0){var u=[{startIndex:0,endIndex:q-1,firstItemSize:s,rangeStart:0,rangeEnd:q*s-1}];this.__ya=u;return u;}
...
;var z=u[u.length-1];var w=(q-z.startIndex-1)*s;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=q-1;this.__ya=u;return u;}
,__yc:function(F){var B=this.__ya||this.__yb();var C=0;var A=B.length-1;while(true){var E=C+((A-C)>>1);var D=B[E];if(D.rangeEnd<F){C=E+1;}
else if(D.rangeStart>F){A=E-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(K){if(K<0||K>=this.getTotalSize()){return null;}
;var J=this.__yc(K);var L=J.rangeStart;var G=J.startIndex;var I=J.firstItemSize;if(L+I>K){return {index:G,offset:K-L};}
else {var H=this.defaultItemSize;return {index:G+1+Math.floor((K-L-I)/H),offset:(K-L-I)%H};}
;}
,__yd:function(M){var O=this.__ya||this.__yb();var P=0;var N=O.length-1;while(true){var R=P+((N-P)>>1);var Q=O[R];if(Q.endIndex<M){P=R+1;}
else if(Q.startIndex>M){N=R-1;}
else {return Q;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__yd(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__ya||this.__yb();return U[U.length-1].rangeEnd+1;}
...
;}
;return W;}
},destruct:function(){this.customSizes=this.__ya=null;}
});}
)();
...
,properties:{selection:{check:d,event:n,apply:h,nullable:false,deferredInit:true},selectionMode:{check:[l,f,p,a],init:l,apply:o},dragSelection:{check:b,init:false,apply:k},quickSelection:{check:b,init:false,apply:m}},events:{"changeSelection":q},members:{_manager:null,__ye:false,__yf:false,__xD:null,_initSelectionManager:function(){var self=this;var r={isItemSelectable:function(s){return self._provider.isSelectable(s);}
...
,_onChangeSelection:function(e){if(this.__yf==true){return;}
;this.__ye=true;var F=this.getSelection();var H=[];for(var i=0;i<F.getLength();i++ ){var G=F.getItem(i);var I=this._getSelectables();var E=-1;if(I!=null){E=I.indexOf(G);}
...
;this.__ye=false;}
,_onManagerChangeSelection:function(e){if(this.__ye==true){return;}
;this.__yf=true;this.__xI();this.__yf=false;}
,__xI:function(){if(this.__yh()){return;}
;var L=this._manager.getSelection();var M=[];for(var i=0;i<L.length;i++ ){var N=this._getDataFromRow(L[i]);if(N!=null){M.push(N);}
;}
;this.__yg(M);}
,__yg:function(Q){var P=this.getSelection();if(Q.length>0){var O=[0,P.getLength()];O=O.concat(Q);var R=P.splice.apply(P,O);R.dispose();}
else {P.removeAll();}
;}
,__yh:function(){var T=this.getSelection();var V=this._manager.getSelection();if(T.getLength()!==V.length){return false;}
...
,this);}
,getLookupTable:function(){return this.__yj;}
,_reverseLookup:function(bl){return bl;}
,_getDataFromRow:function(bm){return this.__yj.getItem(bm);}
,_getSelectables:function(){return this.__yj;}
,getOpenNodes:function(){return this.__zk;}
,isNode:function(bn){return qx.ui.tree.core.Util.isNode(bn,this.getChildProperty());}
,getLevel:function(bo){return this.__zl[bo];}
,hasChildren:function(bp){return qx.ui.tree.core.Util.hasChildren(bp,this.getChildProperty(),!this.isShowLeafs());}
,_getContentPaddingTarget:function(){return this.getPane();}
,_applyRowHeight:function(br,bq){this.getPane().getRowConfig().setDefaultItemSize(br);}
,_applyOpenMode:function(bt,bs){var bu=this.getPane();if(bt===C){bu.addListener(E,this._onOpen,this);}
else if(bt===V){bu.addListener(v,this._onOpen,this);}
;if(bs===C){bu.removeListener(E,this._onOpen,this);}
else if(bs===V){bu.removeListener(v,this._onOpen,this);}
;}
,_applyHideRoot:function(bw,bv){this.buildLookupTable();}
,_applyShowTopLevelOpenCloseIcons:function(by,bx){this.buildLookupTable();}
,_applyShowLeafs:function(bA,bz){this.buildLookupTable();}
,_applyChildProperty:function(bC,bB){this._provider.setChildProperty(bC);}
,_applyLabelPath:function(bE,bD){this._provider.setLabelPath(bE);}
,_applyIconPath:function(bG,bF){this._provider.setIconPath(bG);}
...
,_applyModel:function(bM,bL){this.__zk=[];if(bM!=null){if(qx.core.Environment.get(w)){if(!qx.Class.hasMixin(bM.constructor,qx.data.marshal.MEventBubbling)){this.warn(H+h+k);}
;}
;bM.addListener(J,this._onChangeBubble,this);this.__zp(bM);}
;if(bL!=null){bL.removeListener(J,this._onChangeBubble,this);}
;this.__zn();}
,_applyDelegate:function(bO,bN){this._provider.setDelegate(bO);this.buildLookupTable();}
,_onChangeBubble:function(event){var bT=event.getData();var bQ=bT.name;var bP=bQ.lastIndexOf(W);if(bP!=-1){bQ=bQ.substr(bP+1,bQ.length);}
;if(qx.lang.String.startsWith(bQ,this.getChildProperty())){var bR=bT.item;if(qx.Class.isSubClassOf(bR.constructor,qx.data.Array)){if(bP===-1){bR=this.getModel();}
else {var bS=bT.name.substr(0,bP);bR=qx.data.SingleValueBinding.resolvePropertyChain(this.getModel(),bS);}
;}
;if(this.__yj.indexOf(bR)!=-1){this.__zn();}
;}
;}
,_onUpdated:function(event){if(this.__gT==null){this.__gT=new qx.util.DeferredCall(function(){qx.ui.core.queue.Widget.add(this);}
,this);}
;this.__gT.schedule();}
,_onOpen:function(event){var bV=event.getRow();var bU=this.__yj.getItem(bV);if(this.isNode(bU)){if(this.isNodeOpen(bU)){this.closeNode(bU);}
else {this.openNode(bU);}
;}
;}
,_onKeyPress:function(e){var bW=this.getSelection();if(bW.getLength()>0){var bY=bW.getItem(0);var bX=this.isNode(bY);switch(e.getKeyIdentifier()){case n:if(bX&&this.isNodeOpen(bY)){this.closeNode(bY);}
else {var parent=this.getParent(bY);if(parent!=null){bW.splice(0,1,parent);}
;}
;break;case L:if(bX&&!this.isNodeOpen(bY)){this.openNode(bY);}
else {if(bX){var ca=bY.get(this.getChildProperty());if(ca!=null&&ca.getLength()>0){bW.splice(0,1,ca.getItem(0));}
;}
;}
;break;case M:case m:if(!bX){return;}
;if(this.isNodeOpen(bY)){this.closeNode(bY);}
else {this.openNode(bY);}
;break;};}
;}
,_beforeApplySelection:function(cc){if(cc.length===0&&this.getSelectionMode()===g){var cb=this.__zs();var cd=this.getLookupTable().indexOf(cb);if(cd>=0){cc.push(cd);}
;}
;}
,_afterApplySelection:function(){var ce=this.getSelection();if(ce.getLength()>0&&this.getSelectionMode()===g){this.__zr(ce.getItem(0));}
else {this.__zm=[];}
;}
,__zn:function(){this.buildLookupTable();this._applyDefaultSelection();}
,buildLookupTable:function(){if(this.getModel()!=null&&(this.getChildProperty()==null||this.getLabelPath()==null)){throw new Error(Q+f);}
;this._itemWidth=0;var ci=[];this.__zl=[];var cg=-1;var ch=this.getModel();if(ch!=null){if(!this.isHideRoot()){cg++ ;ci.push(ch);this.__zl.push(cg);}
;if(this.isNodeOpen(ch)){var cf=this.__zo(ch,cg);ci=ci.concat(cf);}
;}
;if(!qx.lang.Array.equals(this.__yj.toArray(),ci)){this._provider.removeBindings();this.__yj.removeAll();this.__yj.append(ci);this.__yp();this._updateSelection();}
;}
,__zo:function(cj,co){var cn=[];co++ ;if(!this.isNode(cj)){return cn;}
;var cr=cj.get(this.getChildProperty());if(cr==null){return cn;}
;cr=cr.copy();var cp=this.getDelegate();var cm=qx.util.Delegate.getMethod(cp,o);var cl=qx.util.Delegate.getMethod(cp,K);if(cl!=null){cr.sort(cl);}
;for(var i=0;i<cr.getLength();i++ ){var cq=cr.getItem(i);if(cm&&!cm(cq)){continue;}
;if(this.isNode(cq)){this.__zl.push(co);cn.push(cq);if(this.isNodeOpen(cq)){var ck=this.__zo(cq,co);cn=cn.concat(ck);}
;}
else {if(this.isShowLeafs()){this.__zl.push(co);cn.push(cq);}
;}
;}
;cr.dispose();return cn;}
,__zp:function(cs){if(!qx.lang.Array.contains(this.__zk,cs)){this.__zk.push(cs);this.fireDataEvent(t,cs);}
;}
,__zq:function(ct,cu){if(ct===cu){this.__zp(cu);return true;}
;if(!this.isNode(ct)){return false;}
;var cx=ct.get(this.getChildProperty());if(cx==null){return false;}
;for(var i=0;i<cx.getLength();i++ ){var cw=cx.getItem(i);var cv=this.__zq(cw,cu);if(cv===true){this.__zp(cw);return true;}
;}
;return false;}
,__yp:function(){this.getPane().getRowConfig().setItemCount(this.__yj.getLength());this.getPane().fullUpdate();}
,getParent:function(cz){var cA=this.__yj.indexOf(cz);if(cA<0){return null;}
;var cB=this.__zl[cA];while(cA>0){cA-- ;var cy=this.__zl[cA];if(cy<cB){return this.__yj.getItem(cA);}
;}
;return null;}
,__zr:function(cC){this.__zm=[];var parent=this.getParent(cC);while(parent!=null){this.__zm.unshift(parent);parent=this.getParent(parent);}
;}
,__zs:function(){if(this.__zm==null){return this.getModel();}
;var cD=this.getLookupTable();var parent=this.__zm.pop();while(parent!=null){if(cD.contains(parent)){return parent;}
;parent=this.__zm.pop();}
;return this.getModel();}
},destruct:function(){var cF=this.getPane();if(cF!=null){if(cF.hasListener(E)){cF.removeListener(E,this._onOpen,this);}
;if(cF.hasListener(v)){cF.removeListener(v,this._onOpen,this);}
;}
;if(!qx.core.ObjectRegistry.inShutDown&&this.__gT!=null){this.__gT.cancel();this.__gT.dispose();}
;var cE=this.getModel();if(cE!=null){cE.removeListener(J,this._onChangeBubble,this);}
;this._layer.removeListener(R,this._onUpdated,this);this._layer.destroy();this._provider.dispose();this.__yj.dispose();this._layer=this._provider=this.__yj=this.__zk=this.__gT=null;}
});}
)();
...
(function(){var a="BindingIds",b="model",c="",d="changeDelegate",f="virtual-tree-file",g="label",h="appearance",i="icon",j="bindItem",k=".length",l="]",m="virtual-tree-folder",n="[",o=".",p="String",q="qx.ui.tree.core.MWidgetController";qx.Mixin.define(q,{construct:function(){this.__xu=[];}
,properties:{labelPath:{check:p,nullable:true},iconPath:{check:p,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},childProperty:{check:p,nullable:true},delegate:{event:d,init:null,nullable:true}},members:{__xu:null,bindDefaultProperties:function(r,s){this.bindProperty(c,b,null,r,s);this.bindProperty(this.getLabelPath(),g,this.getLabelOptions(),r,s);try{this.bindProperty(this.getChildProperty()+k,h,{converter:function(){return m;}
},r,s);}
catch(t){r.setAppearance(f);}
;if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),i,this.getIconOptions(),r,s);}
;}
,bindProperty:function(x,A,y,w,u){var z=this.__xv(u,x);var v=this._tree.getLookupTable();var B=v.bind(z,w,A,y);this.__xw(w,B);}
,bindPropertyReverse:function(I,E,G,H,C){var F=this.__xv(C,I);var D=this._tree.getLookupTable();var J=H.bind(E,D,F,G);this.__xw(H,J);}
,removeBindings:function(){while(this.__xu.length>0){var K=this.__xu.pop();this._removeBindingsFrom(K);}
;}
,_bindItem:function(M,N){var L=qx.util.Delegate.getMethod(this.getDelegate(),j);if(L!=null){L(this,M,N);}
else {this.bindDefaultProperties(M,N);}
;}
,_removeBindingsFrom:function(O){var P=this.__xx(O);while(P.length>0){var Q=P.pop();try{this._tree.getLookupTable().removeBinding(Q);}
catch(e){O.removeBinding(Q);}
;}
;if(qx.lang.Array.contains(this.__xu,O)){qx.lang.Array.remove(this.__xu,O);}
;}
,__xv:function(S,T){var R=n+S+l;if(T!=null&&T!=c){R+=o+T;}
;return R;}
,__xw:function(V,W){var U=this.__xx(V);if(!qx.lang.Array.contains(U,W)){U.push(W);}
;if(!qx.lang.Array.contains(this.__xu,V)){this.__xu.push(V);}
;}
,__xx:function(X){var Y=X.getUserData(a);if(Y==null){Y=[];X.setUserData(a,Y);}
;return Y;}
},destruct:function(){this.__xu=null;}
});}
)();
...
;var o=this._renderer.getCellWidget();o.setOpen(p&&this._tree.isNodeOpen(s));o.addListener(a,this.__zt,this);o.setUserData(b,this.getChildProperty());o.setUserData(g,this._tree.isShowLeafs());if(this._tree.getSelection().contains(s)){this._styleSelectabled(o);}
...
,poolCellWidget:function(u){u.removeListener(a,this.__zt,this);this._removeBindingsFrom(u);this._renderer.pool(u);this._onPool(u);}
...
,__zt:function(event){var K=event.getTarget();var L=K.getUserData(k);var J=this._tree.getLookupTable().getItem(L);if(event.getData()){this._tree.openNode(J);}
else {this._tree.closeNode(J);}
;}
},destruct:function(){this.removeBindings();this._renderer.dispose();this._tree=this._renderer=null;}
});}
)();
(function(){var a="qx.ui.virtual.layer.Abstract",b="abstract",c="Abstract method '_fullUpdate' called!";qx.Class.define(a,{extend:qx.ui.core.Widget,type:b,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__jG={};}
,properties:{anonymous:{refine:true,init:true}},members:{__jG:null,__bG:null,__uh:null,__ui:null,__uj:null,__te:null,getFirstRow:function(){return this.__uh;}
,getFirstColumn:function(){return this.__ui;}
,getRowSizes:function(){return this.__uj||[];}
,getColumnSizes:function(){return this.__te||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__jG.fullUpdate||this.__jG.updateLayerWindow&&this.__jG.updateLayerData){this._fullUpdate.apply(this,this.__bG);}
else if(this.__jG.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bG);}
else if(this.__jG.updateLayerData&&this.__uj){this._updateLayerData();}
;if(this.__jG.fullUpdate||this.__jG.updateLayerWindow){var d=this.__bG;this.__uh=d[0];this.__ui=d[1];this.__uj=d[2];this.__te=d[3];}
;this.__jG={};}
,_updateLayerData:function(){this._fullUpdate(this.__uh,this.__ui,this.__uj,this.__te);}
,_fullUpdate:function(g,i,h,f){throw new Error(c);}
,_updateLayerWindow:function(k,m,l,j){this._fullUpdate(k,m,l,j);}
,updateLayerData:function(){this.__jG.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(p,q,o,n){this.__bG=arguments;this.__jG.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bG=arguments;this.__jG.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__jG=this.__bG=this.__uj=this.__te=null;}
});}
)();
...
(function(){var a="created",b="qx.ui.virtual.cell.AbstractWidget",c="cell.states",d="abstract method call",e="qx.event.type.Data";qx.Class.define(b,{extend:qx.core.Object,implement:[qx.ui.virtual.cell.IWidgetCell],construct:function(){qx.core.Object.call(this);this.__cK=[];}
,events:{"created":e},members:{__cK:null,_createWidget:function(){throw new Error(d);}
...
,pool:function(p){this.__cK.push(p);}
,_cleanupPool:function(){var q=this.__cK.pop();while(q){q.destroy();q=this.__cK.pop();}
;}
,__xB:function(){var r=this.__cK.shift();if(r==null){r=this._createWidget();this.fireDataEvent(a,r);}
;return r;}
},destruct:function(){this._cleanupPool();this.__cK=null;}
});}
)();
...
,addSpacer:function(){if(!this.__zw){this.__zw=new qx.ui.core.Spacer();}
else {this._remove(this.__zw);}
;this._add(this.__zw);}
,addOpenButton:function(){this._add(this.getChildControl(l));}
,_onChangeOpen:function(e){if(this.isOpenable()){this.setOpen(e.getData());}
;}
,addIcon:function(){var L=this.getChildControl(t);if(this.__zv){this._remove(L);}
;this._add(L);this.__zv=true;}
,addLabel:function(M){var N=this.getChildControl(D);if(this.__zu){this._remove(N);}
;if(M){this.setLabel(M);}
else {N.setValue(this.getLabel());}
;this._add(N);this.__zu=true;}
,_applyIcon:function(P,O){if(!this.__zy()){this.__zz(P);}
else if(!this.isOpen()){this.__zz(P);}
;}
,_applyIconOpened:function(R,Q){if(this.isOpen()){if(this.__zx()&&this.__zy()){this.__zz(R);}
else if(!this.__zx()&&this.__zy()){this.__zz(R);}
;}
;}
...
;var X;if(W){X=this.__zy()?this.getIconOpened():null;}
else {X=this.getIcon();}
;if(X){this.__zz(X);}
;W?this.addState(u):this.removeState(u);}
,__zx:function(){return qx.util.PropertyUtil.getUserValue(this,t);}
,__zy:function(){return qx.util.PropertyUtil.getUserValue(this,v);}
,__zz:function(Y){var ba=this.getChildControl(t,true);if(ba){ba.setSource(Y);}
;}
...
;}
;if(this.__zw){this.__zw.setWidth((this.getLevel()+1)*this.getIndent()-bf);}
;}
...
(function(){var a="source",b="changeLeadIcon",c="changeSize",d="changeMode",e="changeDate",f="checked",g="changeChecked",h="icon/16/places/user-desktop.png",i="value",j="size",k="leadIcon",l="date",m="mode",n="demobrowser.demo.virtual.tree.TreeItem",o="String",p="Boolean";qx.Class.define(n,{extend:qx.ui.tree.VirtualTreeItem,properties:{leadIcon:{check:o,event:b,nullable:true},checked:{check:p,event:g,nullable:true},size:{check:o,event:c,nullable:true},date:{check:o,event:e,nullable:true},mode:{check:o,event:d,nullable:true}},members:{__OV:null,__OW:null,__OX:null,__OY:null,__iz:null,_addWidgets:function(){var q=this.__OV=new qx.ui.basic.Image();this.bind(k,q,a);q.setWidth(16);this.addWidget(q);this.addSpacer();this.addOpenButton();this.addIcon();this.setIcon(h);var r=this.__OW=new qx.ui.form.CheckBox();this.bind(f,r,i);r.bind(i,this,f);r.setFocusable(false);r.setTriState(true);r.setMarginRight(4);this.addWidget(r);this.addLabel();this.addWidget(new qx.ui.core.Spacer(),{flex:1});var s=this.__OX=new qx.ui.basic.Label();this.bind(j,s,i);s.setWidth(50);this.addWidget(s);s=this.__OY=new qx.ui.basic.Label();this.bind(l,s,i);s.setWidth(150);this.addWidget(s);s=this.__iz=new qx.ui.basic.Label();this.bind(m,s,i);s.setWidth(80);this.addWidget(s);}
}});}
)();
